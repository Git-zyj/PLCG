...
short var_9 = (short)-7128;
unsigned long long int var_14 = 7199725328060295626ULL;
unsigned int var_15 = 3326728276U;
int zero = 0;
signed char var_18 = (signed char)-25;
unsigned short var_19 = (unsigned short)55133;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 17; ++i_0) 
        for (size_t i_1 = 0; i_1 < 17; ++i_1) 
            arr_6 [i_0] [i_1] = (unsigned short)27584;
}
