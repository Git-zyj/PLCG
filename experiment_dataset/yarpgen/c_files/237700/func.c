...
#define min(a,b) \
    ({ __typeof__ (a) _a = (a); \
       ...
       _a < _b ? _a : _b; })
void test() {
    var_20 = ((/* implicit */unsigned short) (unsigned char)207);
    /* LoopSeq 1 */
    /* vectorizable */
    for (signed char i_0 = 0; i_0 < 22; i_0 += 1) 
    {
        var_21 = ((/* implicit */unsigned short) max((var_21), (((/* implicit */unsigned short) (short)-32743))));
        var_22 = ((/* implicit */unsigned char) max((var_22), (((/* implicit */unsigned char) var_19))));
    }
}
