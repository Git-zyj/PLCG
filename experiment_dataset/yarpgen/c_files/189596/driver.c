...
long long int var_0 = 9138086383884403090LL;
_Bool var_1 = (_Bool)0;
signed char var_3 = (signed char)82;
unsigned char var_7 = (unsigned char)61;
unsigned short var_8 = (unsigned short)65076;
int var_10 = 2050592558;
int zero = 0;
unsigned short var_11 = (unsigned short)45114;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 21; ++i_0) 
        arr_6 [i_0] = (i_0 % 2 == 0) ? (signed char)105 : (signed char)-66;
    for (size_t i_0 = 0; i_0 < 21; ++i_0) 
        for (size_t i_1 = 0; i_1 < 21; ++i_1) 
            arr_8 [i_0] [i_1] = 18195510315331201478ULL;
    for (size_t i_0 = 0; i_0 < 21; ++i_0) 
