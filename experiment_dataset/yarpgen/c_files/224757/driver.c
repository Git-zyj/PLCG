...
long long int var_5 = -242931791519295980LL;
unsigned long long int var_6 = 7082200206044659370ULL;
signed char var_8 = (signed char)-80;
int zero = 0;
unsigned char var_10 = (unsigned char)124;
unsigned int var_11 = 117477545U;
...
void init() {
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
        for (size_t i_1 = 0; i_1 < 19; ++i_1) 
            arr_0 [i_0] [i_1] = 7066250935684203886LL;
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
        for (size_t i_1 = 0; i_1 < 19; ++i_1) 
