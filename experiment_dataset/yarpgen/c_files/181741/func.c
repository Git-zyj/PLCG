...
void test() {
    ...
    for (int i_0 = 1; i_0 < 19; i_0 += 4) 
    {
        ...
        {
            {
                var_19 = ((/* implicit */unsigned int) ((((/* implicit */_Bool) (unsigned short)2074)) ? (((((/* implicit */_Bool) arr_2 [i_0])) ? (arr_2 [i_0]) : (arr_2 [i_0]))) : (((/* implicit */long long int) ((4294967290U) >> (((1280247407) - (1280247396))))))));
                var_20 = ((/* implicit */signed char) (-(((unsigned int) (-2147483647 - 1)))));
            }
        } 
    } 
}
