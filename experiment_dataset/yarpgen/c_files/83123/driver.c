...
_Bool var_2 = (_Bool)0;
int var_4 = 1344345567;
int var_8 = -133655787;
int zero = 0;
unsigned long long int var_18 = 4708661719753659311ULL;
long long int var_19 = 2125613662137370542LL;
signed char var_20 = (signed char)26;
int var_21 = -1544354862;
signed char var_22 = (signed char)-105;
signed char var_23 = (signed char)111;
_Bool var_24 = (_Bool)1;
unsigned short var_25 = (unsigned short)47041;
        ...
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            for (size_t i_2 = 0; i_2 < 18; ++i_2) 
                for (size_t i_3 = 0; i_3 < 18; ++i_3) 
                    arr_8 [i_0] [i_1] [i_2] [i_3] = 1417825754782573369ULL;
}
