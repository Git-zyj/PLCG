...
unsigned short var_4 = (unsigned short)48344;
_Bool var_6 = (_Bool)1;
short var_7 = (short)-6299;
unsigned short var_13 = (unsigned short)24717;
int zero = 0;
unsigned short var_17 = (unsigned short)21314;
int var_18 = 200738308;
unsigned short var_19 = (unsigned short)52908;
unsigned short var_20 = (unsigned short)37732;
unsigned int var_21 = 2488822485U;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            for (size_t i_2 = 0; i_2 < 11; ++i_2) 
                arr_16 [i_0] [i_1] [i_2] = 1916048477U;
}
