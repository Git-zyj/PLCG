...
void test() {
    ...
    {
        var_11 = ((/* implicit */unsigned long long int) (!(((/* implicit */_Bool) ((unsigned long long int) arr_0 [i_0] [i_0])))));
        var_12 = ((/* implicit */_Bool) min((var_12), (((/* implicit */_Bool) ((((/* implicit */_Bool) arr_1 [i_0])) ? (arr_1 [i_0]) : (arr_1 [i_0]))))));
    }
    for (_Bool i_1 = 0; i_1 < 0; i_1 += 1) 
    {
        var_13 = ((/* implicit */unsigned char) min((var_0), (((/* implicit */short) (signed char)(-127 - 1)))));
        arr_5 [i_1] = arr_2 [i_1];
    }
