...
unsigned long long int var_3 = 1774302533967245515ULL;
int zero = 0;
signed char var_11 = (signed char)34;
unsigned char var_12 = (unsigned char)227;
signed char var_13 = (signed char)-37;
unsigned long long int var_14 = 15918984933293065306ULL;
_Bool arr_1 [18] [18] ;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        arr_2 [i_0] = 3047927753309455162LL;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            arr_3 [i_0] [i_1] = 1603602239;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        arr_4 [i_0] = (signed char)104;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            arr_5 [i_0] [i_1] = (i_0 % 2 == 0) ? (unsigned char)46 : (unsigned char)187;
