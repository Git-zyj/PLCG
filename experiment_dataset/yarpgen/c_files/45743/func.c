        ...
        {
            {
                ...
                for (long long int i_2 = 1; i_2 < 21; i_2 += 1) 
                {
                    for (int i_3 = 0; i_3 < 24; i_3 += 2) 
                    {
                        ...
                        {
                            {
                                var_15 = ((/* implicit */unsigned char) arr_12 [i_3] [i_3] [i_3] [i_3] [i_3]);
                                var_16 = ((/* implicit */unsigned int) (~(var_9)));
                                arr_13 [i_0] [i_0] [i_2 + 2] [i_3] [i_0] = ((/* implicit */int) min((((/* implicit */signed char) ((((((/* implicit */int) (unsigned char)255)) >> (((((/* implicit */int) (unsigned char)164)) - (139))))) != (((/* implicit */int) (unsigned short)0))))), (((signed char) arr_11 [i_4 - 1] [i_4] [i_0] [i_4 + 3] [i_4 + 1]))));
                            }
                        } 
                    } 
                } 
                var_17 = ((/* implicit */signed char) min((var_17), (((/* implicit */signed char) var_5))));
                var_18 = (+(min((((/* implicit */unsigned int) ((short) var_11))), (max((arr_5 [i_0]), (((/* implicit */unsigned int) var_12)))))));
            }
        } 
    } 
    var_19 = (unsigned char)78;
}
