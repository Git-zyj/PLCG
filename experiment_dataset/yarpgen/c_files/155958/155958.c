...
void test() {
    ...
    for (int i_0 = 1; i_0 < 11;i_0 += 1)
    {
        ...
        {
            {
                arr_4 [i_1] [i_1] [i_1] = min((arr_0 [i_0]), -1);
                arr_5 [i_1] = ((((arr_1 [i_1 + 2] [i_0 - 1]) ? (arr_1 [i_1 - 1] [i_0 + 3]) : var_9)) / (min((arr_1 [i_1 - 1] [i_0 - 1]), (arr_1 [i_1 + 1] [i_0 + 3]))));
            }
        }
    }
    var_13 = var_8;
    var_14 = max(var_1, ((var_2 ? ((2147483627 ? -931971598 : 2147483647)) : (!var_8))));
    #pragma endscop
}
