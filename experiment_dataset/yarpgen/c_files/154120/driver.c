...
unsigned short var_2 = (unsigned short)46106;
int var_4 = -1839363466;
int var_6 = 1933259696;
unsigned char var_8 = (unsigned char)52;
short var_9 = (short)-25165;
int zero = 0;
unsigned long long int var_13 = 7085649421179084332ULL;
unsigned char var_14 = (unsigned char)135;
int var_15 = 110073050;
signed char var_16 = (signed char)-78;
long long int var_17 = 6773479428319109014LL;
short arr_0 [20] ;
_Bool arr_1 [20] [20] ;
...
void init() {
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        arr_0 [i_0] = (short)26939;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            arr_1 [i_0] [i_1] = (_Bool)1;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        arr_2 [i_0] = (unsigned short)30234;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
