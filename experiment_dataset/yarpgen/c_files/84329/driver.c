...
unsigned long long int var_0 = 14443029911491825947ULL;
unsigned short var_4 = (unsigned short)49377;
int zero = 0;
signed char var_18 = (signed char)-20;
unsigned long long int var_19 = 13658310859713700754ULL;
signed char var_20 = (signed char)-6;
unsigned int var_21 = 1301955160U;
signed char var_22 = (signed char)20;
unsigned short var_23 = (unsigned short)51327;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            for (size_t i_2 = 0; i_2 < 20; ++i_2) 
                arr_6 [i_0] [i_1] [i_2] = (i_0 % 2 == 0) ? 1437980550U : 1521405108U;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
