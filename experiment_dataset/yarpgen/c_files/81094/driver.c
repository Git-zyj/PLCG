...
unsigned short var_7 = (unsigned short)27846;
unsigned char var_10 = (unsigned char)238;
unsigned int var_13 = 1668105133U;
int zero = 0;
unsigned int var_17 = 1587023602U;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        for (size_t i_1 = 0; i_1 < 22; ++i_1) 
            arr_6 [i_0] [i_1] = 5337058354243571644LL;
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        arr_12 [i_0] = (i_0 % 2 == 0) ? 1032634457U : 615224683U;
}
