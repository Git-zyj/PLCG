...
int zero = 0;
short var_15 = (short)-21398;
long long int var_16 = -4835855732388817098LL;
short var_17 = (short)7357;
unsigned long long int var_18 = 15161570363691512225ULL;
unsigned short var_19 = (unsigned short)35683;
short arr_3 [24] ;
unsigned char arr_5 [24] [24] [24] ;
void init() {
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        arr_3 [i_0] = (short)-23301;
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
