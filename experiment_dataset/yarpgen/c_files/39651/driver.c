...
_Bool var_4 = (_Bool)1;
long long int var_5 = 6679171746241341400LL;
unsigned char var_6 = (unsigned char)249;
int var_7 = -1911429664;
short var_10 = (short)22385;
unsigned int var_15 = 2251361775U;
int zero = 0;
unsigned long long int var_16 = 16346502081361002153ULL;
short var_17 = (short)23089;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        arr_4 [i_0] = (i_0 % 2 == 0) ? (signed char)-79 : (signed char)-113;
