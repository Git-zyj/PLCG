...
int var_13 = 324008088;
unsigned char var_17 = (unsigned char)130;
int zero = 0;
unsigned int var_20 = 3683152081U;
int var_21 = 1103800794;
signed char var_22 = (signed char)99;
unsigned char var_23 = (unsigned char)199;
unsigned long long int var_24 = 5459902532622699863ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            arr_1 [i_0] [i_1] = (short)10267;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            arr_3 [i_0] [i_1] = 4238299901U;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            arr_4 [i_0] [i_1] = (_Bool)0;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        arr_5 [i_0] = (unsigned short)50874;
}
