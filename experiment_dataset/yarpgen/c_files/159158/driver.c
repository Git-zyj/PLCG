...
unsigned long long int var_0 = 13165787886620434309ULL;
signed char var_3 = (signed char)-55;
int var_5 = 817743356;
short var_6 = (short)4503;
_Bool var_7 = (_Bool)0;
signed char var_8 = (signed char)-11;
short var_11 = (short)28619;
unsigned short var_15 = (unsigned short)5452;
int zero = 0;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        for (size_t i_1 = 0; i_1 < 16; ++i_1) 
            arr_5 [i_0] [i_1] = (i_1 % 2 == 0) ? (short)24743 : (short)22280;
}
