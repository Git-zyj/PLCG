...
short var_3 = (short)9427;
unsigned char var_6 = (unsigned char)246;
unsigned char var_7 = (unsigned char)215;
unsigned int var_8 = 2453140898U;
unsigned char var_10 = (unsigned char)74;
int zero = 0;
unsigned int var_12 = 102112537U;
unsigned int var_13 = 132807180U;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        for (size_t i_1 = 0; i_1 < 13; ++i_1) 
            for (size_t i_2 = 0; i_2 < 13; ++i_2) 
                arr_13 [i_0] [i_1] [i_2] = 2087607194U;
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        arr_14 [i_0] = (i_0 % 2 == 0) ? (unsigned char)158 : (unsigned char)175;
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        for (size_t i_1 = 0; i_1 < 14; ++i_1) 
            arr_5 [i_0] [i_1] = (short)31389;
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        for (size_t i_1 = 0; i_1 < 13; ++i_1) 
            arr_16 [i_0] [i_1] = (i_1 % 2 == 0) ? (unsigned char)194 : (unsigned char)210;
}
