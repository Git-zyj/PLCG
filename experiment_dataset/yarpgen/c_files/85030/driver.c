...
unsigned long long int var_2 = 14260533099936476600ULL;
unsigned char var_3 = (unsigned char)155;
unsigned long long int var_11 = 5506583209797692593ULL;
unsigned long long int var_15 = 3659494917850431557ULL;
int zero = 0;
    ...
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        for (size_t i_1 = 0; i_1 < 13; ++i_1) 
            for (size_t i_2 = 0; i_2 < 13; ++i_2) 
                arr_5 [i_0] [i_1] [i_2] = 1683883189204255451ULL;
}
