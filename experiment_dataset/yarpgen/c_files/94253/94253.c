            ...
            {
                {
                    ...
                    for (int i_3 = 0; i_3 < 10;i_3 += 1)
                    {
                        ...
                        {
                            var_12 -= ((~(arr_8 [i_0] [i_1] [2] [i_4])));
                            arr_11 [i_4] [i_0] [i_0] [i_1] [i_0] = ((!(arr_4 [i_2] [i_2])));
                        }
                        for (int i_5 = 2; i_5 < 9;i_5 += 1)
                        {
                            var_13 = (arr_8 [i_0] [i_5 - 2] [i_5] [i_3]);
                            var_14 += arr_12 [i_5 - 2] [i_5] [i_5] [i_5 - 2] [i_3];
                            var_15 = (~((~(arr_10 [i_0] [i_1] [i_5 - 2] [i_0] [i_5 - 2] [i_1] [i_0]))));
                        }
                        arr_16 [i_3] [i_3] [i_2] [i_1] [1] [i_0] = (!3684124354847029485);
                        arr_17 [i_3] [i_3] [i_3] [i_3] = -8955;
                    }
                    var_16 *= (arr_7 [i_0] [9] [i_1] [5]);
                }
            }
        }
    }
