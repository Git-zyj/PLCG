...
long long int var_14 = 5841378863442972777LL;
int var_15 = 1411237228;
unsigned long long int var_16 = 4342838747171313461ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
        for (size_t i_1 = 0; i_1 < 15; ++i_1) 
            arr_4 [i_0] [i_1] = (i_1 % 2 == 0) ? (short)23837 : (short)30862;
}
