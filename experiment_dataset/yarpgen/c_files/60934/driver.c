...
unsigned long long int var_11 = 6275024673495727944ULL;
unsigned int var_12 = 1702046205U;
unsigned long long int var_14 = 14172339340850080661ULL;
int zero = 0;
signed char var_16 = (signed char)106;
unsigned char var_17 = (unsigned char)32;
signed char var_18 = (signed char)88;
unsigned short var_19 = (unsigned short)36960;
int var_20 = 1662183499;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
        for (size_t i_1 = 0; i_1 < 19; ++i_1) 
            arr_9 [i_0] [i_1] = 16464654017164931299ULL;
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
        for (size_t i_1 = 0; i_1 < 19; ++i_1) 
            for (size_t i_2 = 0; i_2 < 19; ++i_2) 
                arr_5 [i_0] [i_1] [i_2] = (i_0 % 2 == 0) ? (signed char)10 : (signed char)-9;
}
