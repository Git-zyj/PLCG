...
void test() {
    var_17 += 9273459;
    var_18 = ((/* implicit */int) max((((max((9273459), (-458832617))) < (max((var_5), (var_15))))), (((((/* implicit */int) ((9273459) != (var_16)))) != (min((var_10), (var_13)))))));
    var_19 = 1073741824;
    /* LoopSeq 1 */
    /* vectorizable */
    for (int i_0 = 0; i_0 < 18; i_0 += 4) 
    {
        var_20 = ((/* implicit */int) min((var_20), (((((/* implicit */_Bool) arr_1 [i_0])) ? (var_16) : (-377440431)))));
        arr_2 [i_0] [i_0] = ((int) 127);
    }
}
