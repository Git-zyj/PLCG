...
unsigned short var_7 = (unsigned short)25518;
unsigned int var_10 = 3785678291U;
int zero = 0;
signed char var_16 = (signed char)-76;
unsigned short var_17 = (unsigned short)25910;
signed char var_18 = (signed char)-79;
_Bool var_19 = (_Bool)0;
unsigned short var_20 = (unsigned short)23093;
signed char var_21 = (signed char)14;
unsigned short var_22 = (unsigned short)908;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        arr_4 [i_0] = (unsigned short)16137;
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
