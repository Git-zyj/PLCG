...
#define min(a,b) \
    ({ __typeof__ (a) _a = (a); \
       ...
       _a < _b ? _a : _b; })
void test() {
    var_17 *= ((/* implicit */_Bool) ((((/* implicit */_Bool) var_1)) ? (((/* implicit */int) var_11)) : (((/* implicit */int) (!(((/* implicit */_Bool) var_13)))))));
    /* LoopNest 2 */
        ...
        {
            {
                ...
                arr_5 [i_1] = ((/* implicit */unsigned short) ((((unsigned long long int) var_0)) ^ (((/* implicit */unsigned long long int) ((unsigned int) (-(var_0)))))));
            }
        } 
    } 
