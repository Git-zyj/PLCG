...
int var_4 = 1947921432;
long long int var_6 = 6105738023814349103LL;
unsigned char var_8 = (unsigned char)134;
unsigned int var_10 = 1317752003U;
unsigned char var_13 = (unsigned char)241;
signed char var_14 = (signed char)51;
long long int var_15 = 2815042304657575986LL;
int zero = 0;
unsigned char var_18 = (unsigned char)126;
unsigned int var_19 = 1037772067U;
short var_20 = (short)-29955;
    ...
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            for (size_t i_2 = 0; i_2 < 18; ++i_2) 
                arr_5 [i_0] [i_1] [i_2] = 4981586251617769493LL;
}
