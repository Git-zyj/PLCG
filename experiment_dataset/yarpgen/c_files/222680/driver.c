...
unsigned long long int var_7 = 9030312582750379677ULL;
unsigned char var_9 = (unsigned char)233;
unsigned long long int var_10 = 753332024803408349ULL;
int zero = 0;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        for (size_t i_1 = 0; i_1 < 12; ++i_1) 
            arr_5 [i_0] [i_1] = (unsigned short)21236;
}
