...
unsigned long long int var_17 = 14038817377395888642ULL;
int zero = 0;
long long int var_19 = -6887937276992369497LL;
_Bool var_20 = (_Bool)0;
signed char var_21 = (signed char)31;
signed char var_22 = (signed char)-123;
unsigned long long int var_23 = 1490583684491333820ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
        arr_12 [i_0] = (i_0 % 2 == 0) ? 1293981747295341472ULL : 15715435025826680844ULL;
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
        for (size_t i_1 = 0; i_1 < 15; ++i_1) 
            for (size_t i_2 = 0; i_2 < 15; ++i_2) 
                arr_13 [i_0] [i_1] [i_2] = (i_2 % 2 == 0) ? (signed char)(-127 - 1) : (signed char)7;
}
