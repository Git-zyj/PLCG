...
unsigned short var_0 = (unsigned short)9640;
unsigned long long int var_4 = 17416452557087808990ULL;
unsigned char var_6 = (unsigned char)235;
signed char var_8 = (signed char)-87;
signed char var_9 = (signed char)-115;
int var_11 = -676515877;
int zero = 0;
unsigned char var_12 = (unsigned char)34;
unsigned short var_13 = (unsigned short)18345;
unsigned int var_14 = 3491186300U;
