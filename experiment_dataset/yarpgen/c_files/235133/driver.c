...
unsigned long long int var_9 = 7551982537174975432ULL;
short var_12 = (short)-21312;
int zero = 0;
signed char var_14 = (signed char)-35;
unsigned long long int var_15 = 15400741867262319927ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        arr_16 [i_0] = (i_0 % 2 == 0) ? (signed char)78 : (signed char)-72;
}
