...
int zero = 0;
unsigned short var_16 = (unsigned short)41862;
long long int var_17 = 8381314486324952720LL;
short var_18 = (short)16389;
signed char var_19 = (signed char)-72;
int var_20 = -1074009596;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        for (size_t i_1 = 0; i_1 < 13; ++i_1) 
            arr_5 [i_0] [i_1] = (i_0 % 2 == 0) ? (unsigned short)40250 : (unsigned short)50416;
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        arr_6 [i_0] = (i_0 % 2 == 0) ? (_Bool)0 : (_Bool)1;
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        arr_7 [i_0] = (unsigned short)29273;
}
