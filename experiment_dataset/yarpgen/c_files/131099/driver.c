...
unsigned long long int var_16 = 2437448314813915309ULL;
int zero = 0;
unsigned long long int var_19 = 3764105136107323078ULL;
signed char var_20 = (signed char)69;
short var_21 = (short)17011;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            arr_6 [i_0] [i_1] = -4257691996183126885LL;
}
