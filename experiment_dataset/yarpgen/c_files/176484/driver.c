...
unsigned long long int var_3 = 16870162344492349487ULL;
unsigned long long int var_4 = 997994549376640533ULL;
int var_5 = -1739758834;
_Bool var_6 = (_Bool)0;
unsigned long long int var_7 = 3894540859945460736ULL;
unsigned char var_9 = (unsigned char)248;
unsigned char var_11 = (unsigned char)254;
_Bool var_12 = (_Bool)0;
unsigned short var_16 = (unsigned short)22313;
int zero = 0;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 17; ++i_0) 
        arr_4 [i_0] = 11657682487479104979ULL;
}
