...
unsigned long long int var_1 = 13996746183462409797ULL;
_Bool var_2 = (_Bool)1;
_Bool var_3 = (_Bool)1;
signed char var_4 = (signed char)-8;
unsigned long long int var_6 = 1888813264244841769ULL;
_Bool var_7 = (_Bool)1;
_Bool var_8 = (_Bool)1;
unsigned long long int var_9 = 14166809941128394661ULL;
signed char var_10 = (signed char)-15;
int zero = 0;
signed char var_11 = (signed char)94;
unsigned long long int var_12 = 8862317302161856399ULL;
    ...
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
            for (size_t i_2 = 0; i_2 < 25; ++i_2) 
                arr_2 [i_0] [i_1] [i_2] = (signed char)52;
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
            arr_3 [i_0] [i_1] = 761265185599928917ULL;
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
