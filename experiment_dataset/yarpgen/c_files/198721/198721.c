...
void test() {
    #pragma scop
    var_19 = 12755531632761281308;

    for (int i_0 = 0; i_0 < 20;i_0 += 1)
    {
        var_20 *= (max(6827, (((-(arr_0 [i_0] [i_0]))))));
        var_21 = ((((((arr_1 [i_0] [i_0]) ? ((12755531632761281290 ? 15 : (arr_3 [i_0]))) : (-20 && -35)))) ? 5691212440948270307 : (((~(-9223372036854775807 - 1))))));
    }
    #pragma endscop
}
