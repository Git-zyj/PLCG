...
unsigned long long int var_8 = 16251497916086284363ULL;
int zero = 0;
signed char var_13 = (signed char)-98;
unsigned long long int var_14 = 12119569096241307582ULL;
signed char var_15 = (signed char)71;
short var_16 = (short)26385;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
            arr_1 [i_0] [i_1] = 8821259374370579316ULL;
}
