...
void test() {
    #pragma scop
    var_12 = ((((min((!var_5), (var_0 >= 1168941429)))) >= (((((var_6 ? var_1 : var_7))) ? (!var_4) : (1168941438 == 3126025834)))));
    /* LoopNest 2 */
        ...
        {
            {
                ...
                var_13 = (((max((1506477998 - 716159906), (4294967277 + var_5))) + (!-1729455925)));
            }
        }
    }
    var_14 += (2427101170 + (!var_5));
    #pragma endscop
}
