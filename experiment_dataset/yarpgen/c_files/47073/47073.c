...
void test() {
    ...
    for (int i_0 = 0; i_0 < 13;i_0 += 1)
    {
        ...
        {
            {
                var_18 = ((31543 | ((var_14 ? (arr_3 [i_0] [i_0] [i_0]) : -106))));
                var_19 = (arr_0 [i_0]);
                var_20 += (((max((arr_2 [i_0] [i_1]), (var_15 * 0))) <= ((((arr_0 [i_0]) ? (arr_0 [i_0]) : (arr_0 [4]))))));
                arr_5 [i_0] [i_0] = ((min((arr_3 [i_0] [i_1] [i_1]), ((min((arr_2 [i_1] [i_0]), var_5))))));
            }
        }
    }
    #pragma endscop
