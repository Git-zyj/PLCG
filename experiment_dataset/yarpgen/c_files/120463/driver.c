...
unsigned short var_1 = (unsigned short)24937;
unsigned long long int var_2 = 2519251587249444380ULL;
unsigned char var_4 = (unsigned char)69;
signed char var_7 = (signed char)28;
int zero = 0;
unsigned char var_12 = (unsigned char)208;
unsigned int var_13 = 3929495204U;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        for (size_t i_1 = 0; i_1 < 14; ++i_1) 
            arr_6 [i_0] [i_1] = (i_1 % 2 == 0) ? (unsigned short)18300 : (unsigned short)63061;
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        for (size_t i_1 = 0; i_1 < 14; ++i_1) 
            arr_7 [i_0] [i_1] = (i_1 % 2 == 0) ? (_Bool)0 : (_Bool)0;
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        arr_8 [i_0] = (i_0 % 2 == 0) ? 1744600588459997588LL : 1790984006326500848LL;
}
