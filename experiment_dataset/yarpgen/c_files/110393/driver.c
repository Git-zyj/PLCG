...
_Bool var_8 = (_Bool)1;
short var_12 = (short)1327;
int zero = 0;
int var_16 = 1945527443;
signed char var_17 = (signed char)29;
unsigned int var_18 = 1162165668U;
_Bool var_19 = (_Bool)0;
unsigned short var_20 = (unsigned short)56391;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
        for (size_t i_1 = 0; i_1 < 15; ++i_1) 
            arr_3 [i_0] [i_1] = (unsigned short)64582;
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        for (size_t i_1 = 0; i_1 < 16; ++i_1) 
            arr_4 [i_0] [i_1] = (signed char)39;
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        arr_5 [i_0] = (unsigned short)36992;
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
