...
short var_8 = (short)16278;
short var_10 = (short)-15523;
unsigned char var_12 = (unsigned char)221;
int zero = 0;
long long int var_13 = 5374948283042039990LL;
unsigned char var_14 = (unsigned char)4;
int var_15 = -1243946012;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        for (size_t i_1 = 0; i_1 < 12; ++i_1) 
            arr_2 [i_0] [i_1] = (unsigned char)89;
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        arr_4 [i_0] = (unsigned char)153;
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        arr_5 [i_0] = (short)25880;
}
