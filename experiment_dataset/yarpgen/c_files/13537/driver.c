...
_Bool var_6 = (_Bool)1;
int zero = 0;
unsigned int var_16 = 1725555916U;
unsigned long long int var_17 = 14324414394872783503ULL;
short var_18 = (short)-24974;
unsigned long long int var_19 = 988546731409894850ULL;
short var_20 = (short)17691;
short var_21 = (short)7680;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        arr_1 [i_0] = 2537705428U;
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        arr_3 [i_0] = (short)-23490;
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        for (size_t i_1 = 0; i_1 < 24; ++i_1) 
            arr_5 [i_0] [i_1] = (i_0 % 2 == 0) ? (signed char)-47 : (signed char)-63;
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        for (size_t i_1 = 0; i_1 < 24; ++i_1) 
