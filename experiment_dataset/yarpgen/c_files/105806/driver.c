...
long long int var_1 = -1391424207290225035LL;
_Bool var_2 = (_Bool)1;
signed char var_3 = (signed char)11;
unsigned int var_4 = 3287389382U;
unsigned char var_5 = (unsigned char)163;
short var_6 = (short)-31475;
unsigned long long int var_8 = 13433085572953268844ULL;
int zero = 0;
...
void init() {
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        for (size_t i_1 = 0; i_1 < 12; ++i_1) 
            arr_0 [i_0] [i_1] = -2953060644424385682LL;
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        for (size_t i_1 = 0; i_1 < 12; ++i_1) 
            arr_1 [i_0] [i_1] = (short)14393;
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        arr_2 [i_0] = (_Bool)0;
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        for (size_t i_1 = 0; i_1 < 12; ++i_1) 
            for (size_t i_2 = 0; i_2 < 12; ++i_2) 
                arr_5 [i_0] [i_1] [i_2] = 931906249U;
}
