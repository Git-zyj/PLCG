...
short var_2 = (short)8415;
unsigned char var_6 = (unsigned char)49;
_Bool var_11 = (_Bool)0;
int zero = 0;
long long int var_12 = -2884926765478047405LL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        arr_1 [i_0] = -1201887473627295181LL;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            arr_2 [i_0] [i_1] = (i_1 % 2 == 0) ? (short)22311 : (short)-2143;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        arr_3 [i_0] = (i_0 % 2 == 0) ? (short)-11398 : (short)11876;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
