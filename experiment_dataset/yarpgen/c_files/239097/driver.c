...
short var_5 = (short)-25617;
long long int var_6 = 4420752716286819566LL;
signed char var_8 = (signed char)125;
_Bool var_10 = (_Bool)0;
short var_17 = (short)-6506;
int zero = 0;
unsigned char var_18 = (unsigned char)4;
unsigned char var_19 = (unsigned char)58;
signed char var_20 = (signed char)116;
unsigned int var_21 = 1926989323U;
int var_22 = -595829864;
unsigned long long int var_23 = 9524771848889104779ULL;
long long int var_24 = -2070700818726097610LL;
int var_25 = -1327895502;
unsigned short var_26 = (unsigned short)38957;
short arr_0 [10] [10] ;
_Bool arr_3 [10] ;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
        for (size_t i_1 = 0; i_1 < 19; ++i_1) 
            for (size_t i_2 = 0; i_2 < 19; ++i_2) 
                for (size_t i_3 = 0; i_3 < 19; ++i_3) 
                    arr_11 [i_0] [i_1] [i_2] [i_3] = 482060456;
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
        for (size_t i_1 = 0; i_1 < 19; ++i_1) 
            for (size_t i_2 = 0; i_2 < 19; ++i_2) 
                for (size_t i_3 = 0; i_3 < 19; ++i_3) 
    ...
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
        for (size_t i_1 = 0; i_1 < 19; ++i_1) 
            arr_17 [i_0] [i_1] = (i_0 % 2 == 0) ? -51798249 : 1397320834;
}
