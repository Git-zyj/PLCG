...
void test() {
    ...
    {
        arr_4 [i_0] = (min(((max((max(0, 3728624589)), 3728624589))), (max(var_8, (arr_2 [i_0 - 1])))));
        /* LoopNest 3 */
                ...
                {
                    {
                        ...
                        arr_16 [i_0 + 1] [i_0 + 1] [i_0 + 1] [1] = (min(((-(arr_10 [i_1 + 1] [i_0 + 1]))), (min((arr_10 [i_1 - 1] [i_0 + 1]), (arr_10 [i_1 + 1] [i_0 - 1])))));
                    }
                }
            }
        }
