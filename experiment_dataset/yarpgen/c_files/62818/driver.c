...
unsigned long long int var_12 = 16419587551778588337ULL;
int zero = 0;
unsigned short var_15 = (unsigned short)65377;
int var_16 = -1257371815;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        for (size_t i_1 = 0; i_1 < 24; ++i_1) 
            arr_12 [i_0] [i_1] = (unsigned short)22545;
}
