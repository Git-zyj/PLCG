...
unsigned long long int var_2 = 7310048698861331624ULL;
_Bool var_7 = (_Bool)0;
int zero = 0;
long long int var_10 = 3179437474173383498LL;
...
void init() {
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        arr_0 [i_0] = (i_0 % 2 == 0) ? (short)27759 : (short)-8991;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
