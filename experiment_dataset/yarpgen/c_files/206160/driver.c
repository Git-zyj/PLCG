...
unsigned int var_3 = 3908441393U;
signed char var_4 = (signed char)13;
int var_5 = 1233710034;
signed char var_8 = (signed char)-54;
unsigned int var_12 = 3037369772U;
int zero = 0;
signed char var_13 = (signed char)-64;
unsigned int var_14 = 4108938388U;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        arr_1 [i_0] = 386766328U;
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        for (size_t i_1 = 0; i_1 < 22; ++i_1) 
            for (size_t i_2 = 0; i_2 < 22; ++i_2) 
                arr_2 [i_0] [i_1] [i_2] = (short)-20746;
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        arr_5 [i_0] = 15384155104499917016ULL;
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        for (size_t i_1 = 0; i_1 < 22; ++i_1) 
            arr_6 [i_0] [i_1] = (unsigned short)5163;
}
