...
long long int var_6 = -1416116290083329608LL;
_Bool var_7 = (_Bool)0;
short var_8 = (short)7129;
short var_10 = (short)-21271;
short var_12 = (short)-26159;
unsigned char var_15 = (unsigned char)175;
unsigned long long int var_18 = 15104487291586528174ULL;
int zero = 0;
unsigned long long int var_19 = 7857565248096540686ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        for (size_t i_1 = 0; i_1 < 13; ++i_1) 
            arr_5 [i_0] [i_1] = (short)10863;
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        arr_6 [i_0] = (_Bool)0;
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        for (size_t i_1 = 0; i_1 < 13; ++i_1) 
            for (size_t i_2 = 0; i_2 < 13; ++i_2) 
                arr_7 [i_0] [i_1] [i_2] = 13966744464888285377ULL;
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        for (size_t i_1 = 0; i_1 < 13; ++i_1) 
            for (size_t i_2 = 0; i_2 < 13; ++i_2) 
