...
void test() {
    ...
    for (int i_0 = 0; i_0 < 22;i_0 += 1)
    {
        ...
        {
            {
                arr_5 [i_0] [i_0] [15] = (arr_4 [i_1 + 1]);
                arr_6 [i_0] [i_0] [i_1] |= (((arr_3 [i_1 - 1] [i_1 + 1] [i_1 + 1]) ? (min((min(var_4, var_18)), (((3039655019277219592 ? 3432 : (arr_2 [i_1 - 1])))))) : (min(((15346157422972145 ^ (arr_3 [i_0] [i_1] [i_1]))), -15346157422972146))));
            }
        }
    }
    #pragma endscop
