...
long long int var_12 = -3575132908908415303LL;
unsigned char var_17 = (unsigned char)73;
int zero = 0;
short var_19 = (short)6975;
int var_20 = 808425281;
unsigned char var_21 = (unsigned char)106;
unsigned char var_22 = (unsigned char)206;
int var_23 = 1925134625;
unsigned short var_24 = (unsigned short)43376;
unsigned short var_25 = (unsigned short)39574;
int var_26 = -253494605;
int var_27 = 1099840777;
_Bool arr_0 [14] ;
int arr_4 [14] [14] ;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        for (size_t i_1 = 0; i_1 < 14; ++i_1) 
            for (size_t i_2 = 0; i_2 < 14; ++i_2) 
                arr_11 [i_0] [i_1] [i_2] = (short)11668;
