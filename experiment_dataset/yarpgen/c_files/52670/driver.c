...
unsigned long long int var_5 = 739196098898072908ULL;
signed char var_9 = (signed char)31;
unsigned int var_11 = 2137358822U;
short var_13 = (short)6742;
signed char var_16 = (signed char)24;
int zero = 0;
short var_19 = (short)1218;
int var_20 = -290289257;
unsigned short var_21 = (unsigned short)3700;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        for (size_t i_1 = 0; i_1 < 24; ++i_1) 
            for (size_t i_2 = 0; i_2 < 24; ++i_2) 
                arr_9 [i_0] [i_1] [i_2] = -3983495818822866857LL;
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        for (size_t i_1 = 0; i_1 < 24; ++i_1) 
