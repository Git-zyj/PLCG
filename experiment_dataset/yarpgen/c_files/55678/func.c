...
void test() {
    ...
    var_11 = (unsigned char)50;
    /* LoopSeq 1 */
    /* vectorizable */
    for (long long int i_0 = 4; i_0 < 19; i_0 += 1) 
    {
        arr_2 [i_0] = ((/* implicit */long long int) (+(arr_1 [i_0 - 4] [i_0])));
        var_12 = ((/* implicit */short) ((((/* implicit */_Bool) (signed char)112)) ? (((/* implicit */unsigned int) ((/* implicit */int) (!(((/* implicit */_Bool) arr_0 [i_0])))))) : (((((/* implicit */_Bool) var_7)) ? (((/* implicit */unsigned int) ((/* implicit */int) (signed char)-112))) : (arr_1 [i_0] [i_0])))));
    }
}
