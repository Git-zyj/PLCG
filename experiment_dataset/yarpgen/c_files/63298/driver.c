...
_Bool var_7 = (_Bool)0;
_Bool var_8 = (_Bool)0;
long long int var_9 = -7554280379338478844LL;
...
long long int var_20 = -1912269654060955493LL;
long long int var_21 = 2911875056750209539LL;
_Bool arr_0 [11] ;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            for (size_t i_2 = 0; i_2 < 11; ++i_2) 
                arr_11 [i_0] [i_1] [i_2] = 3757808127931749855LL;
}
