...
int var_13 = 1537037566;
int zero = 0;
long long int var_14 = -3921577611066822037LL;
unsigned char var_15 = (unsigned char)117;
signed char var_16 = (signed char)-40;
signed char var_17 = (signed char)92;
unsigned short var_18 = (unsigned short)47117;
int arr_1 [20] [20] ;
long long int arr_2 [20] [20] [20] ;
void init() {
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            arr_1 [i_0] [i_1] = 352472444;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            for (size_t i_2 = 0; i_2 < 20; ++i_2) 
                arr_2 [i_0] [i_1] [i_2] = 3128294100799143319LL;
}
