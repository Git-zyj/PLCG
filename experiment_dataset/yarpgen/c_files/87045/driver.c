...
_Bool var_0 = (_Bool)1;
long long int var_1 = -3087463900726055659LL;
unsigned short var_3 = (unsigned short)43827;
unsigned char var_4 = (unsigned char)93;
unsigned char var_6 = (unsigned char)148;
short var_7 = (short)-3475;
signed char var_9 = (signed char)-16;
_Bool var_11 = (_Bool)1;
int zero = 0;
short var_12 = (short)27463;
unsigned long long int var_13 = 86051438873248240ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 21; ++i_0) 
        arr_7 [i_0] = (unsigned short)12199;
    for (size_t i_0 = 0; i_0 < 21; ++i_0) 
        for (size_t i_1 = 0; i_1 < 21; ++i_1) 
            for (size_t i_2 = 0; i_2 < 21; ++i_2) 
