...
void test() {
    ...
    for (int i_0 = 0; i_0 < 0;i_0 += 1)
    {
        for (int i_1 = 0; i_1 < 10;i_1 += 1)
        {
            ...
            {
                {
                    arr_8 [i_0 + 1] [i_0 + 1] = (arr_4 [i_2 - 1] [i_2 + 1] [i_2 - 1]);
                    arr_9 [i_1] = (((!((max((arr_1 [i_0 + 1]), (arr_5 [i_0] [i_0 + 1] [6])))))) ? -2290216767 : ((~(arr_6 [i_0 + 1] [i_2 - 2] [i_2 - 2] [i_2 - 2]))));
                }
            }
        }
    }
    var_18 = var_3;
    var_19 = -2456201261331596075;
    #pragma endscop
}
