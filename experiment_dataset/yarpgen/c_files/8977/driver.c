...
unsigned int var_0 = 2854859539U;
long long int var_1 = 2123807811894660888LL;
...
int var_7 = 1685762515;
int var_8 = 256346048;
_Bool var_9 = (_Bool)1;
unsigned char var_10 = (unsigned char)255;
int zero = 0;
int var_11 = -2050257875;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 21; ++i_0) 
        arr_9 [i_0] = 14810784213410715856ULL;
    for (size_t i_0 = 0; i_0 < 21; ++i_0) 
        for (size_t i_1 = 0; i_1 < 21; ++i_1) 
            arr_10 [i_0] [i_1] = (short)-8037;
}
