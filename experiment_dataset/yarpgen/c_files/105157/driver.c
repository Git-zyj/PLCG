...
unsigned short var_0 = (unsigned short)63411;
signed char var_2 = (signed char)-88;
_Bool var_5 = (_Bool)1;
signed char var_6 = (signed char)107;
unsigned short var_8 = (unsigned short)3715;
_Bool var_10 = (_Bool)0;
int zero = 0;
unsigned int var_11 = 649393080U;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
            arr_6 [i_0] [i_1] = (i_0 % 2 == 0) ? 688424882 : 1382075390;
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
