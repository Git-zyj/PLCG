...
unsigned long long int var_2 = 5648538867305134265ULL;
signed char var_3 = (signed char)-41;
unsigned int var_5 = 2293152999U;
unsigned char var_9 = (unsigned char)36;
int zero = 0;
unsigned int var_10 = 2108190533U;
signed char var_11 = (signed char)36;
unsigned int var_12 = 843499345U;
unsigned long long int var_13 = 2301673141721106832ULL;
    ...
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
            for (size_t i_2 = 0; i_2 < 10; ++i_2) 
                arr_5 [i_0] [i_1] [i_2] = (i_1 % 2 == 0) ? (unsigned char)159 : (unsigned char)115;
}
