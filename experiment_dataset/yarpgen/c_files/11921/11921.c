...
void test() {
    ...
    for (int i_0 = 0; i_0 < 14;i_0 += 1)
    {
        ...
        {
            {
                var_13 = max(((58876 ? 2147483647 : -2147483624)), 7437);
                arr_5 [i_0] &= ((11423796523351779702 ? -7438 : (arr_4 [i_0] [i_1] [i_1])));
            }
        }
    }
    var_14 = min(((-((4294967295 >> (((((-2147483647 - 1) - -2147483618)) + 38)))))), var_5);
    #pragma endscop
}
