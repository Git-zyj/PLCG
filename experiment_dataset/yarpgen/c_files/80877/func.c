...
#define min(a,b) \
    ({ __typeof__ (a) _a = (a); \
       ...
       _a < _b ? _a : _b; })
void test() {
    var_16 = ((/* implicit */unsigned short) (+(((((/* implicit */_Bool) var_3)) ? (((/* implicit */int) var_5)) : (((/* implicit */int) var_6))))));
    /* LoopSeq 1 */
    for (int i_0 = 0; i_0 < 25; i_0 += 2) 
    {
        var_17 = ((/* implicit */unsigned long long int) max((var_17), (((/* implicit */unsigned long long int) var_12))));
        arr_3 [i_0] = ((/* implicit */unsigned int) ((((/* implicit */int) ((var_9) == (arr_1 [i_0])))) < ((+(arr_1 [i_0])))));
    }
}
