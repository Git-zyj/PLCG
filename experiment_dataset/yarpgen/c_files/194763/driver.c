...
unsigned long long int var_1 = 17293461082803414492ULL;
short var_2 = (short)-32548;
unsigned char var_3 = (unsigned char)45;
signed char var_4 = (signed char)-33;
int var_5 = -1210197628;
signed char var_6 = (signed char)-96;
long long int var_7 = -2390301043841053053LL;
unsigned char var_8 = (unsigned char)11;
int var_9 = -1304346584;
short var_10 = (short)-32228;
unsigned char var_11 = (unsigned char)190;
long long int var_12 = -6169132986600335435LL;
int zero = 0;
long long int var_13 = 3022508732315537024LL;
unsigned long long int var_14 = 17564941591194924507ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            for (size_t i_2 = 0; i_2 < 20; ++i_2) 
                for (size_t i_3 = 0; i_3 < 20; ++i_3) 
                    arr_11 [i_0] [i_1] [i_2] [i_3] = 933377218678592012LL;
}
