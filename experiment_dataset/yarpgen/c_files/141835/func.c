...
void test() {
    ...
    {
        arr_2 [i_0] = ((/* implicit */unsigned short) ((((/* implicit */_Bool) (short)32751)) ? (((/* implicit */int) var_3)) : (((/* implicit */int) (short)-32751))));
        arr_3 [i_0] [i_0] = ((/* implicit */unsigned char) (-(((/* implicit */int) arr_0 [i_0]))));
    }
