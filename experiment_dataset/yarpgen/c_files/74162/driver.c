...
unsigned long long int var_6 = 2766700114208646873ULL;
unsigned char var_7 = (unsigned char)122;
unsigned short var_8 = (unsigned short)40230;
int zero = 0;
unsigned short var_12 = (unsigned short)29933;
...
void init() {
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        arr_0 [i_0] = (unsigned short)14981;
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
