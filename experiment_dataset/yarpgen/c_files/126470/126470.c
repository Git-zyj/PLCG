...
void test() {
    #pragma scop
    var_17 = ((((min(var_1, 7647704201387426764))) ? var_1 : (max(var_2, (max(var_0, -7647704201387426764))))));

    for (int i_0 = 0; i_0 < 21;i_0 += 1)
    {
        arr_2 [i_0] [i_0] |= (arr_1 [i_0]);
        var_18 = ((-(min((max((arr_0 [i_0] [15]), (arr_1 [i_0]))), (((var_5 << (((arr_0 [i_0] [i_0]) - 17544909540718203963)))))))));
    }
    #pragma endscop
}
