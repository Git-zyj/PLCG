...
short var_5 = (short)4334;
unsigned short var_12 = (unsigned short)10040;
signed char var_13 = (signed char)-28;
short var_19 = (short)14383;
int zero = 0;
unsigned long long int var_20 = 2591347275414014815ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
        for (size_t i_1 = 0; i_1 < 19; ++i_1) 
            arr_3 [i_0] [i_1] = (unsigned short)25048;
}
