...
long long int var_21 = -2604025700309984223LL;
unsigned short var_22 = (unsigned short)25028;
unsigned int var_23 = 86143493U;
long long int var_24 = -7553856841864000744LL;
...
void init() {
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        for (size_t i_1 = 0; i_1 < 12; ++i_1) 
            arr_0 [i_0] [i_1] = -256480746612546865LL;
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        for (size_t i_1 = 0; i_1 < 12; ++i_1) 
            for (size_t i_2 = 0; i_2 < 12; ++i_2) 
                arr_3 [i_0] [i_1] [i_2] = 10498898548269643641ULL;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            arr_6 [i_0] [i_1] = (unsigned short)29348;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
