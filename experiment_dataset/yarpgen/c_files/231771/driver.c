...
int var_9 = 842437506;
long long int var_10 = 8722098957365508702LL;
short var_11 = (short)-28284;
long long int var_12 = -7849037817196083929LL;
signed char var_13 = (signed char)24;
int zero = 0;
_Bool var_18 = (_Bool)0;
unsigned char var_19 = (unsigned char)33;
signed char var_20 = (signed char)106;
int var_21 = 1077742447;
short var_22 = (short)3454;
int var_23 = 1539077318;
unsigned char var_24 = (unsigned char)246;
unsigned int var_25 = 382751400U;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        arr_5 [i_0] = 3431077056940385058LL;
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
            ...
            for (size_t i_2 = 0; i_2 < 23; ++i_2) 
                for (size_t i_3 = 0; i_3 < 23; ++i_3) 
                    for (size_t i_4 = 0; i_4 < 23; ++i_4) 
                        arr_14 [i_0] [i_1] [i_2] [i_3] [i_4] = (unsigned short)31103;
}
