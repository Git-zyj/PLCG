...
void test() {
    ...
    for (int i_0 = 1; i_0 < 13;i_0 += 1)
    {
        ...
        for (int i_1 = 0; i_1 < 1;i_1 += 1)
        {
            ...
            arr_5 [i_0] [i_0] = ((((min(((((arr_1 [i_0]) ? var_1 : (arr_3 [i_0] [1] [i_1])))), (min((arr_1 [i_0]), (arr_2 [i_0])))))) && (arr_0 [i_0] [i_0])));
        }
        arr_6 [i_0 + 1] [i_0] = ((var_13 + ((((arr_3 [i_0 - 1] [i_0 - 1] [i_0 - 1]) % (arr_3 [i_0 - 1] [i_0] [i_0 - 1]))))));
    }
    var_19 = var_11;
    var_20 = ((-(~34359672832)));
    #pragma endscop
