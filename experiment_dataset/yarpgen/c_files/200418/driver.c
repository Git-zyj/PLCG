...
unsigned short var_0 = (unsigned short)50916;
int var_3 = -1938126809;
unsigned char var_9 = (unsigned char)54;
short var_10 = (short)1233;
int zero = 0;
unsigned char var_19 = (unsigned char)181;
long long int var_20 = -214511357899599748LL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
            for (size_t i_2 = 0; i_2 < 10; ++i_2) 
                arr_7 [i_0] [i_1] [i_2] = 1132133971;
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
            arr_8 [i_0] [i_1] = (i_0 % 2 == 0) ? (unsigned short)56115 : (unsigned short)49633;
}
