...
int var_15 = 886469890;
int var_16 = -1219355577;
int zero = 0;
long long int var_18 = 3322271308183751213LL;
unsigned int var_19 = 2424972171U;
unsigned char var_20 = (unsigned char)185;
int var_21 = 1017694400;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        arr_5 [i_0] = 3315618909728770484LL;
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        for (size_t i_1 = 0; i_1 < 16; ++i_1) 
