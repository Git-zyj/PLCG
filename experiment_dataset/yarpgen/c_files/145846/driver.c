...
unsigned short var_13 = (unsigned short)14737;
int zero = 0;
unsigned char var_16 = (unsigned char)136;
unsigned short var_17 = (unsigned short)56534;
int var_18 = 1141228723;
_Bool var_19 = (_Bool)0;
_Bool var_20 = (_Bool)1;
int var_21 = -160305534;
signed char var_22 = (signed char)-62;
signed char var_23 = (signed char)-87;
unsigned short var_24 = (unsigned short)30121;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        for (size_t i_1 = 0; i_1 < 12; ++i_1) 
            arr_1 [i_0] [i_1] = 14395080883650612100ULL;
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        arr_2 [i_0] = (unsigned short)60640;
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
