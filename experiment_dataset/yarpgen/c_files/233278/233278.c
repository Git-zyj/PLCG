...
void test() {
    ...
    {
        var_25 = ((arr_5 [i_1]) ? ((((arr_6 [i_1]) && -997704377))) : (!1354692650));
        ...
        for (int i_2 = 0; i_2 < 19;i_2 += 1)
        {
            for (int i_3 = 0; i_3 < 19;i_3 += 1)
            {
                ...
                {
                    {
                        var_27 = (min(var_27, (((arr_8 [i_1]) + (arr_9 [i_4] [i_2] [i_4] [i_4])))));
                        arr_15 [i_3] [i_2] [i_3] [13] [i_4] = ((arr_6 [i_1]) ? (arr_6 [i_2]) : -997704375);
                        arr_16 [i_1] [i_1] [i_3] [i_4] [i_4] [i_4] = (2147483646 ? 180250004 : -997704377);
