...
short var_2 = (short)14195;
unsigned char var_3 = (unsigned char)246;
int var_8 = -1988898384;
unsigned long long int var_11 = 15302343162308743209ULL;
short var_13 = (short)-17372;
unsigned short var_14 = (unsigned short)23926;
unsigned short var_15 = (unsigned short)59918;
int zero = 0;
unsigned char var_17 = (unsigned char)110;
short var_18 = (short)-13709;
unsigned char var_19 = (unsigned char)75;
short var_20 = (short)29913;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
            arr_6 [i_0] [i_1] = 3593145584360107302LL;
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
            for (size_t i_2 = 0; i_2 < 25; ++i_2) 
                arr_8 [i_0] [i_1] [i_2] = 2697532027355591831ULL;
}
