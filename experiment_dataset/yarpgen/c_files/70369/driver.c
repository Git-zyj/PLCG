...
unsigned long long int var_0 = 9308299160735022705ULL;
int var_2 = -575118551;
short var_8 = (short)-24699;
int zero = 0;
long long int var_16 = 4647690403672680013LL;
                ...
                for (size_t i_3 = 0; i_3 < 25; ++i_3) 
                    for (size_t i_4 = 0; i_4 < 25; ++i_4) 
                        for (size_t i_5 = 0; i_5 < 25; ++i_5) 
                            arr_9 [i_0] [i_1] [i_2] [i_3] [i_4] [i_5] = (short)-6372;
}
