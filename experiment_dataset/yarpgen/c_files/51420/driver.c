...
int var_2 = -1974635289;
int var_3 = -1107774890;
unsigned int var_7 = 2196132959U;
unsigned char var_13 = (unsigned char)72;
signed char var_15 = (signed char)-19;
int zero = 0;
int var_16 = -434169191;
unsigned char var_17 = (unsigned char)102;
signed char var_18 = (signed char)90;
signed char var_19 = (signed char)1;
short var_20 = (short)-1049;
unsigned int var_21 = 2359647690U;
signed char arr_2 [16] ;
_Bool arr_3 [16] [16] ;
void init() {
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        arr_2 [i_0] = (i_0 % 2 == 0) ? (signed char)46 : (signed char)-44;
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
