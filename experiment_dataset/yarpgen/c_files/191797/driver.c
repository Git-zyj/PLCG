...
int var_0 = -1984170851;
long long int var_4 = 856363666897141315LL;
unsigned char var_5 = (unsigned char)69;
int var_7 = 1615276031;
short var_9 = (short)29971;
int zero = 0;
long long int var_10 = 419905467380176119LL;
int var_11 = 1593999883;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        for (size_t i_1 = 0; i_1 < 24; ++i_1) 
            for (size_t i_2 = 0; i_2 < 24; ++i_2) 
                arr_10 [i_0] [i_1] [i_2] = 2174013137U;
}
