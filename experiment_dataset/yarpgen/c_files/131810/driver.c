...
unsigned long long int var_0 = 3797371906265222573ULL;
unsigned short var_1 = (unsigned short)20906;
int var_3 = -992342506;
...
unsigned int var_10 = 3695657897U;
int zero = 0;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
            arr_19 [i_0] [i_1] = (i_1 % 2 == 0) ? -4259789722557052173LL : 6903341391627179314LL;
}
