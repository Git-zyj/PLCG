...
short var_11 = (short)-1939;
unsigned char var_12 = (unsigned char)163;
unsigned short var_15 = (unsigned short)34138;
unsigned char var_16 = (unsigned char)73;
int zero = 0;
long long int var_18 = -6924403666566653756LL;
int var_19 = 59776798;
short var_20 = (short)-9693;
signed char var_21 = (signed char)-33;
int var_22 = -1387340054;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
        for (size_t i_1 = 0; i_1 < 15; ++i_1) 
            arr_5 [i_0] [i_1] = (unsigned short)56960;
}
