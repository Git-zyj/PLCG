...
void test() {
    ...
    {
        arr_4 [i_0] = ((/* implicit */unsigned long long int) ((((/* implicit */_Bool) var_4)) ? (((/* implicit */int) arr_3 [i_0])) : (var_2)));
        arr_5 [i_0] [i_0] = ((/* implicit */_Bool) ((((/* implicit */long long int) arr_0 [i_0] [i_0])) + (var_4)));
    }
}
