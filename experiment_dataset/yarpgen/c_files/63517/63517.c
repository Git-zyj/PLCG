...
void test() {
    ...
    for (int i_0 = 1; i_0 < 22;i_0 += 1)
    {
        ...
        {
            {
                arr_5 [i_0] = (min(1687642635, (min(((((arr_2 [i_1]) ? (arr_0 [i_0]) : (arr_3 [i_0] [i_1])))), (arr_4 [i_0] [i_0] [i_1])))));
                arr_6 [i_0] = ((((!(arr_1 [i_0 + 1]))) ? (min((arr_1 [i_1]), (arr_1 [i_0 + 1]))) : (((((arr_1 [i_0]) + 9223372036854775807)) >> (548729028 - 548728976)))));
            }
        }
    }
    var_12 = var_7;
