...
unsigned int var_0 = 2061911258U;
unsigned char var_1 = (unsigned char)53;
signed char var_3 = (signed char)-22;
int var_4 = 144180925;
signed char var_5 = (signed char)34;
unsigned long long int var_6 = 17062377607544838358ULL;
unsigned int var_8 = 1092419571U;
unsigned int var_9 = 4149263503U;
int zero = 0;
unsigned char var_10 = (unsigned char)151;
short var_11 = (short)23458;
unsigned short var_12 = (unsigned short)59276;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        for (size_t i_1 = 0; i_1 < 13; ++i_1) 
            arr_3 [i_0] [i_1] = 2309866302726390412ULL;
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        arr_4 [i_0] = 283045471;
}
