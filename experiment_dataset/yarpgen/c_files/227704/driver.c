...
int var_5 = -2105536368;
int zero = 0;
signed char var_20 = (signed char)-94;
unsigned char var_21 = (unsigned char)238;
unsigned long long int var_22 = 18229688612419413781ULL;
unsigned char var_23 = (unsigned char)170;
unsigned short var_24 = (unsigned short)15602;
    ...
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        for (size_t i_1 = 0; i_1 < 22; ++i_1) 
            for (size_t i_2 = 0; i_2 < 22; ++i_2) 
                arr_4 [i_0] [i_1] [i_2] = 13293770079285722659ULL;
}
