...
void test() {
    ...
    for (unsigned char i_0 = 1; i_0 < 12; i_0 += 3) 
    {
        ...
        {
            {
                var_17 = ((/* implicit */_Bool) ((((/* implicit */_Bool) ((((/* implicit */_Bool) var_10)) ? (var_10) : (((/* implicit */unsigned long long int) ((/* implicit */int) var_9)))))) ? (((/* implicit */int) var_8)) : (((var_14) ? (((/* implicit */int) var_14)) : (((/* implicit */int) var_3))))));
