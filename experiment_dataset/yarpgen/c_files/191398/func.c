...
void test() {
    ...
    for (_Bool i_0 = 0; i_0 < 1; i_0 += 1) 
    {
        ...
        var_17 = ((/* implicit */int) min((var_17), (((/* implicit */int) ((short) (short)-1)))));
    }
    var_18 = ((/* implicit */short) max((var_18), (((/* implicit */short) ((((/* implicit */_Bool) var_9)) ? (((/* implicit */int) var_8)) : (((/* implicit */int) var_11)))))));
}
