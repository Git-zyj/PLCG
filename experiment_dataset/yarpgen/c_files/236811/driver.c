...
unsigned long long int var_12 = 9054879729393201949ULL;
long long int var_13 = 7332910811502581687LL;
long long int var_14 = 3272050138135404904LL;
unsigned long long int arr_2 [24] [24] ;
signed char arr_4 [24] [24] ;
void init() {
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        for (size_t i_1 = 0; i_1 < 24; ++i_1) 
            arr_2 [i_0] [i_1] = 4502201321470490717ULL;
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        for (size_t i_1 = 0; i_1 < 24; ++i_1) 
