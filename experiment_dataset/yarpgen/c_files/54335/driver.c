...
short var_6 = (short)-25571;
unsigned char var_10 = (unsigned char)172;
int zero = 0;
signed char var_12 = (signed char)-36;
signed char var_13 = (signed char)7;
short var_14 = (short)9712;
unsigned short var_15 = (unsigned short)43641;
unsigned short var_16 = (unsigned short)46772;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        for (size_t i_1 = 0; i_1 < 12; ++i_1) 
            arr_1 [i_0] [i_1] = -5984427141671504597LL;
}
