...
short var_11 = (short)-16310;
signed char var_13 = (signed char)20;
short var_16 = (short)-23065;
int var_19 = 1166796342;
int zero = 0;
_Bool var_20 = (_Bool)0;
int var_21 = 987457732;
int var_22 = 45044448;
int arr_0 [19] ;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
        for (size_t i_1 = 0; i_1 < 19; ++i_1) 
            arr_3 [i_0] [i_1] = 32812010U;
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
        arr_6 [i_0] = (signed char)75;
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
        for (size_t i_1 = 0; i_1 < 19; ++i_1) 
            for (size_t i_2 = 0; i_2 < 19; ++i_2) 
                arr_7 [i_0] [i_1] [i_2] = (i_1 % 2 == 0) ? 23460232U : 3036105589U;
}
