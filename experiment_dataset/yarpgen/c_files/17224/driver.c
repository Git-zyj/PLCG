...
_Bool var_0 = (_Bool)1;
_Bool var_1 = (_Bool)0;
int var_5 = 1100136745;
_Bool var_6 = (_Bool)1;
int var_9 = -406765785;
unsigned char var_10 = (unsigned char)48;
unsigned long long int var_13 = 10737679203976635643ULL;
signed char var_14 = (signed char)-46;
_Bool var_15 = (_Bool)0;
_Bool var_17 = (_Bool)0;
int zero = 0;
unsigned short var_19 = (unsigned short)11840;
unsigned long long int var_20 = 15492348198092921989ULL;
unsigned char var_21 = (unsigned char)253;
short var_22 = (short)14415;
short var_23 = (short)-12415;
signed char var_24 = (signed char)-12;
unsigned long long int var_25 = 16270353893811676745ULL;
...
void init() {
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        for (size_t i_1 = 0; i_1 < 22; ++i_1) 
            arr_1 [i_0] [i_1] = 6089712171355122053ULL;
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        for (size_t i_1 = 0; i_1 < 22; ++i_1) 
            arr_2 [i_0] [i_1] = (i_1 % 2 == 0) ? 10366656453868124375ULL : 3919898708977110708ULL;
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        arr_5 [i_0] = (i_0 % 2 == 0) ? (unsigned char)121 : (unsigned char)194;
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        for (size_t i_1 = 0; i_1 < 22; ++i_1) 
    ...
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            for (size_t i_2 = 0; i_2 < 18; ++i_2) 
                for (size_t i_3 = 0; i_3 < 18; ++i_3) 
                    arr_27 [i_0] [i_1] [i_2] [i_3] = 14978277962089762249ULL;
}
