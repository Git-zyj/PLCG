...
short var_2 = (short)-24237;
_Bool var_3 = (_Bool)1;
long long int var_12 = 6509706213242456334LL;
int zero = 0;
unsigned char var_18 = (unsigned char)52;
short var_19 = (short)14843;
unsigned char var_20 = (unsigned char)117;
unsigned short var_21 = (unsigned short)56811;
unsigned long long int var_22 = 14107868682022936753ULL;
unsigned char var_23 = (unsigned char)254;
signed char var_24 = (signed char)-79;
signed char var_25 = (signed char)3;
unsigned long long int var_26 = 2995629761171546189ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            arr_7 [i_0] [i_1] = 1308815234;
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
        arr_2 [i_0] = 3394097305U;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            for (size_t i_2 = 0; i_2 < 20; ++i_2) 
                for (size_t i_3 = 0; i_3 < 20; ++i_3) 
                    arr_15 [i_0] [i_1] [i_2] [i_3] = -6834415808939331668LL;
}
