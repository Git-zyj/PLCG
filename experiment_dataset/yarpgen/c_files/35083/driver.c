...
unsigned long long int var_4 = 6971033591059074974ULL;
signed char var_8 = (signed char)-109;
unsigned long long int var_9 = 13011860869153518249ULL;
int zero = 0;
unsigned int var_16 = 480240726U;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 21; ++i_0) 
        for (size_t i_1 = 0; i_1 < 21; ++i_1) 
            for (size_t i_2 = 0; i_2 < 21; ++i_2) 
                arr_16 [i_0] [i_1] [i_2] = (unsigned short)9680;
}
