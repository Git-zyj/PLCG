...
_Bool var_1 = (_Bool)1;
short var_5 = (short)-2480;
unsigned char var_9 = (unsigned char)61;
unsigned char var_10 = (unsigned char)21;
int zero = 0;
unsigned int var_12 = 988611009U;
unsigned long long int var_13 = 8074262982899724839ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
        arr_5 [i_0] = 10113240317635983711ULL;
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
