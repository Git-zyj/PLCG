...
void test() {
    #pragma scop
    var_15 = (((var_7 ? 33538048 : 33538047)));
    /* LoopNest 2 */
    for (int i_0 = 0; i_0 < 22;i_0 += 1)
    {
        ...
        {
            {
                arr_6 [i_1] = (max((23 - 1714902295), ((((min((-32767 - 1), var_2))) ? (((40595 & (arr_5 [i_0] [i_1])))) : ((0 ? (arr_3 [i_1]) : var_5))))));
                arr_7 [i_0] [i_1] [i_1 + 2] = ((!(arr_4 [i_1 + 1] [i_1 + 2])));
            }
        }
    }
    #pragma endscop
