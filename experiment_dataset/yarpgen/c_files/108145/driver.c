...
int zero = 0;
int var_14 = 1044296813;
unsigned char var_15 = (unsigned char)164;
unsigned int var_16 = 551683757U;
unsigned short var_17 = (unsigned short)44160;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            arr_3 [i_0] [i_1] = (unsigned short)26575;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            arr_5 [i_0] [i_1] = (i_1 % 2 == 0) ? -1333811094 : -1989119431;
}
