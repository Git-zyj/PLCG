...
unsigned int var_9 = 1063648598U;
unsigned int var_11 = 2110037108U;
unsigned int var_14 = 947150260U;
int zero = 0;
signed char var_18 = (signed char)-96;
signed char var_19 = (signed char)86;
unsigned int var_20 = 4192348594U;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        arr_1 [i_0] = (i_0 % 2 == 0) ? (signed char)-28 : (signed char)-84;
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        arr_2 [i_0] = (i_0 % 2 == 0) ? 999255684U : 178370615U;
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            arr_3 [i_0] [i_1] = 2635385941U;
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
