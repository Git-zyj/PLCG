...
long long int var_1 = 3105278593923291564LL;
short var_3 = (short)17969;
...
int var_16 = 1200125248;
int zero = 0;
int var_17 = -1074435787;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        arr_8 [i_0] = (i_0 % 2 == 0) ? (unsigned char)226 : (unsigned char)183;
}
