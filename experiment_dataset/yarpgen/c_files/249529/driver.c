...
short var_0 = (short)16940;
signed char var_5 = (signed char)-53;
unsigned int var_9 = 3011872061U;
short var_10 = (short)11323;
unsigned int var_12 = 4196642232U;
short var_14 = (short)3423;
int zero = 0;
short var_15 = (short)-2520;
unsigned int var_16 = 1087035047U;
short var_17 = (short)5400;
signed char var_18 = (signed char)52;
unsigned int var_19 = 758081580U;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
            arr_3 [i_0] [i_1] = 3350103602549476225ULL;
    ...
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        arr_9 [i_0] = (i_0 % 2 == 0) ? (signed char)58 : (signed char)13;
}
