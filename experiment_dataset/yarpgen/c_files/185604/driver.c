...
unsigned int var_5 = 746155493U;
_Bool var_6 = (_Bool)0;
signed char var_7 = (signed char)-11;
int var_8 = -1632204380;
signed char var_9 = (signed char)70;
int zero = 0;
unsigned int var_10 = 1915906405U;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            arr_3 [i_0] [i_1] = 6106233618615837599ULL;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            arr_6 [i_0] [i_1] = -1605029535;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            arr_7 [i_0] [i_1] = (i_0 % 2 == 0) ? 5065294895501404281ULL : 7363164570174986189ULL;
}
