...
int zero = 0;
unsigned int var_10 = 2767747021U;
unsigned char var_11 = (unsigned char)249;
unsigned short var_12 = (unsigned short)46956;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        arr_1 [i_0] = (short)30797;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            arr_2 [i_0] [i_1] = (short)2675;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            arr_3 [i_0] [i_1] = (i_1 % 2 == 0) ? 12917129590186973302ULL : 9457511851154269788ULL;
}
