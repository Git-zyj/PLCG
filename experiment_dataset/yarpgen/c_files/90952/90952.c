...
void test() {
    ...
    for (int i_0 = 0; i_0 < 14;i_0 += 1)
    {
        ...
        {
            {
                var_16 = (min(-4543657052096899148, ((-(arr_1 [i_0] [i_0])))));
                var_17 = min((((~((min(56549, var_7)))))), (min(-6555780532703841638, -6555780532703841638)));
                var_18 = min((((((var_10 || (arr_1 [i_1] [i_0]))) && var_8))), -6008);
