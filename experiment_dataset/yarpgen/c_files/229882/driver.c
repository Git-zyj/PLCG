...
int var_0 = -1761286954;
unsigned char var_1 = (unsigned char)148;
_Bool var_4 = (_Bool)1;
unsigned char var_5 = (unsigned char)29;
_Bool var_6 = (_Bool)1;
_Bool var_7 = (_Bool)1;
int var_8 = -1226283695;
int var_9 = 1527691601;
int var_10 = -1752894226;
int var_12 = -1526361561;
    ...
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        for (size_t i_1 = 0; i_1 < 22; ++i_1) 
            for (size_t i_2 = 0; i_2 < 22; ++i_2) 
                arr_4 [i_0] [i_1] [i_2] = (i_0 % 2 == 0) ? (unsigned char)249 : (unsigned char)185;
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        for (size_t i_1 = 0; i_1 < 22; ++i_1) 
            for (size_t i_2 = 0; i_2 < 22; ++i_2) 
