...
unsigned long long int var_2 = 3638516045191856398ULL;
unsigned short var_3 = (unsigned short)4140;
unsigned short var_14 = (unsigned short)3407;
int zero = 0;
int var_16 = -820815530;
