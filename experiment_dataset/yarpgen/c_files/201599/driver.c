...
int var_0 = -157475882;
unsigned short var_1 = (unsigned short)37635;
short var_6 = (short)-20767;
signed char var_11 = (signed char)-11;
signed char var_15 = (signed char)115;
unsigned int var_16 = 1735143060U;
unsigned int var_17 = 2594745847U;
int zero = 0;
signed char var_19 = (signed char)-101;
signed char var_20 = (signed char)-104;
unsigned short var_21 = (unsigned short)16365;
int var_22 = -93417380;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
            arr_5 [i_0] [i_1] = (unsigned short)2195;
}
