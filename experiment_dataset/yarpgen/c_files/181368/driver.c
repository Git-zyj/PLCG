...
unsigned long long int var_4 = 11423453506923843875ULL;
unsigned char var_5 = (unsigned char)63;
signed char var_7 = (signed char)-102;
long long int var_9 = 8125081130318942025LL;
int zero = 0;
signed char var_12 = (signed char)18;
unsigned long long int var_13 = 11247630054545128032ULL;
unsigned long long int var_14 = 3272480425562466001ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            arr_6 [i_0] [i_1] = 2003437416;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        arr_7 [i_0] = (short)-9925;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            for (size_t i_2 = 0; i_2 < 20; ++i_2) 
