...
unsigned int var_5 = 3699757986U;
unsigned char var_7 = (unsigned char)93;
unsigned int var_8 = 4159274339U;
signed char var_10 = (signed char)70;
unsigned long long int var_11 = 14037941184394656936ULL;
long long int var_12 = 6696637489802277910LL;
int zero = 0;
unsigned char var_13 = (unsigned char)195;
signed char var_14 = (signed char)82;
unsigned long long int var_15 = 6318178536926032601ULL;
...
void init() {
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            arr_1 [i_0] [i_1] = 16658162872069076070ULL;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
    ...
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            for (size_t i_2 = 0; i_2 < 18; ++i_2) 
                arr_6 [i_0] [i_1] [i_2] = (i_1 % 2 == 0) ? (unsigned char)220 : (unsigned char)159;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            for (size_t i_2 = 0; i_2 < 18; ++i_2) 
