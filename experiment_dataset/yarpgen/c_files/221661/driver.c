...
int zero = 0;
unsigned int var_12 = 3803655711U;
signed char var_13 = (signed char)13;
unsigned long long int var_14 = 13575298466290838665ULL;
...
void init() {
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        arr_0 [i_0] = 5794971902993430947LL;
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        arr_1 [i_0] = 335272839592125049ULL;
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
