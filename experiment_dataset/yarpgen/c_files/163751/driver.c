...
int var_1 = -269076585;
unsigned long long int var_2 = 16050364360952303959ULL;
unsigned char var_3 = (unsigned char)143;
short var_7 = (short)-759;
int zero = 0;
unsigned char var_10 = (unsigned char)78;
_Bool var_11 = (_Bool)0;
signed char var_12 = (signed char)-99;
int var_13 = -1750592806;
unsigned int var_14 = 1168208194U;
...
void init() {
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        for (size_t i_1 = 0; i_1 < 22; ++i_1) 
            arr_1 [i_0] [i_1] = (unsigned short)9837;
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
