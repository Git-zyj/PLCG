...
void test() {
    ...
    for (int i_0 = 0; i_0 < 19;i_0 += 1)
    {
        for (int i_1 = 0; i_1 < 19;i_1 += 1)
        {
            ...
            {
                {
                    arr_7 [i_0] [i_0] [14] &= (((((arr_5 [i_0] [i_1] [15] [i_2]) ? (arr_5 [i_0] [i_1] [i_2] [i_2]) : (arr_3 [i_2])))) ? (arr_2 [i_0] [i_0]) : (arr_3 [i_0]));
                    ...
                    for (int i_3 = 2; i_3 < 16;i_3 += 1)
                    {
                        ...
                        {
                            {
                                arr_15 [i_0] [i_0] [14] [i_2] [i_3] [i_4] = (arr_5 [i_4] [i_2] [i_1] [i_0]);
                                arr_16 [i_0] [i_3] [i_2] [i_3] [i_2] = arr_3 [i_0];
                                arr_17 [i_0] [i_1] = (((arr_12 [i_4] [i_2] [i_1] [i_0]) && var_2));
                            }
                        }
                    }
                }
    ...
    var_18 = (var_2 ? var_4 : var_14);
    var_19 = min((var_12 | var_11), ((var_5 ? var_14 : var_3)));
    var_20 = var_13;
    #pragma endscop
}
