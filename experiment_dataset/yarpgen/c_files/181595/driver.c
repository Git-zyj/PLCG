...
_Bool var_0 = (_Bool)1;
_Bool var_4 = (_Bool)1;
unsigned int var_5 = 1274010291U;
unsigned char var_6 = (unsigned char)83;
int var_7 = 1480818461;
unsigned int var_9 = 170428737U;
unsigned char var_10 = (unsigned char)184;
int zero = 0;
int var_11 = 892680191;
int var_12 = 2118557764;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        for (size_t i_1 = 0; i_1 < 16; ++i_1) 
            for (size_t i_2 = 0; i_2 < 16; ++i_2) 
                arr_6 [i_0] [i_1] [i_2] = (i_2 % 2 == 0) ? (unsigned short)15397 : (unsigned short)7683;
}
