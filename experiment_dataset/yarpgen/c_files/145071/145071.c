...
void test() {
    ...
    for (int i_0 = 0; i_0 < 21;i_0 += 1)
    {
        for (int i_1 = 3; i_1 < 20;i_1 += 1)
        {
            ...
            {
                {
                    arr_7 [i_1] [i_1] [i_2] [i_1] = (((((arr_6 [i_1] [i_1 - 2] [i_1 + 1] [i_1 - 3]) ? 44 : (arr_6 [i_1] [i_1 - 2] [i_1 + 1] [i_1 - 3])))) ? (~44) : (arr_6 [i_1] [i_1] [i_1] [i_1]));
                    arr_8 [i_1] [i_2] = (~4503599627370496);
                }
            }
        }
    }
    var_17 = (((((-(var_0 - 58)))) ? -118862848 : (var_8 ^ var_0)));
    #pragma endscop
}
