...
long long int var_1 = -8049339087923200417LL;
signed char var_2 = (signed char)-8;
unsigned int var_9 = 3441970463U;
int zero = 0;
unsigned char var_13 = (unsigned char)143;
signed char var_14 = (signed char)-110;
long long int var_15 = 2126569989235419059LL;
_Bool var_16 = (_Bool)0;
short var_17 = (short)31923;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        arr_5 [i_0] = (_Bool)0;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        arr_6 [i_0] = 8155831217342082445LL;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            for (size_t i_2 = 0; i_2 < 20; ++i_2) 
