...
void test() {
    ...
    for (int i_0 = 0; i_0 < 14; i_0 += 1) 
    {
        for (long long int i_1 = 0; i_1 < 14; i_1 += 1) 
        {
            for (long long int i_2 = 0; i_2 < 14; i_2 += 1) 
            {
                {
                    var_18 = arr_7 [i_0];
                    var_19 = ((/* implicit */short) (!(((/* implicit */_Bool) 1706120893))));
    ...
    var_21 = ((/* implicit */unsigned int) ((((/* implicit */_Bool) max((((/* implicit */unsigned long long int) ((short) 2251799813685248ULL))), (var_6)))) ? (((/* implicit */int) var_0)) : (((/* implicit */int) max((((/* implicit */unsigned short) (!(((/* implicit */_Bool) 1953976988U))))), (var_13))))));
}
