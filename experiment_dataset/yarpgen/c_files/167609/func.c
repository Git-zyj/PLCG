...
void test() {
    ...
    for (int i_0 = 2; i_0 < 19; i_0 += 3) 
    {
        ...
        {
            {
                arr_4 [(short)1] [i_0 + 1] [i_1] = ((/* implicit */long long int) (~(((/* implicit */int) (unsigned short)64439))));
                var_16 = ((/* implicit */unsigned int) (+((~(max((((/* implicit */unsigned long long int) var_14)), (var_9)))))));
            }
        } 
    } 
    var_17 = var_3;
