                        ...
                        {
                            {
                                ...
                                var_20 = (arr_12 [i_4 - 2] [i_1] [i_0] [i_1] [i_0]);
                            }
                        }
                    }
                    arr_16 [i_2] [i_1] = (arr_8 [i_0] [i_1] [i_0] [i_2]);
                }
            }
        }
        arr_17 [i_0] = (arr_14 [i_0]);
        var_21 -= (arr_9 [i_0] [i_0] [i_0 + 1] [i_0 + 2]);
        var_22 *= (arr_6 [i_0 - 1] [i_0]);
        var_23 = (max(var_23, (arr_5 [i_0 - 2])));
    }
    var_24 = var_15;
    #pragma endscop
}
