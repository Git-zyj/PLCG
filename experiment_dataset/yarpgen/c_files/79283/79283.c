...
void test() {
    #pragma scop
    var_20 += min(var_8, (((var_5 != var_1) ? (max(var_8, var_17)) : (var_7 - var_13))));

    for (int i_0 = 1; i_0 < 12;i_0 += 1)
    {
        var_21 ^= (((arr_1 [i_0 - 1]) ? (arr_1 [i_0 - 1]) : ((-(arr_1 [i_0 + 1])))));
        arr_3 [i_0] = (min(((+(min((arr_1 [i_0]), (arr_0 [i_0] [i_0]))))), ((~(arr_0 [i_0 + 1] [i_0 + 1])))));
    }
    #pragma endscop
}
