...
long long int var_5 = -8234760923886977309LL;
...
int var_13 = -890742899;
int var_14 = 204902741;
unsigned long long int var_15 = 15324443909085931068ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            arr_3 [i_0] [i_1] = (unsigned short)44757;
}
