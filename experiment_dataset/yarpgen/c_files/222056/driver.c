...
unsigned short var_5 = (unsigned short)8300;
unsigned char var_9 = (unsigned char)62;
unsigned short var_14 = (unsigned short)45277;
int var_19 = 914168747;
int zero = 0;
int var_20 = 1742827086;
unsigned char var_21 = (unsigned char)109;
_Bool var_22 = (_Bool)1;
signed char var_23 = (signed char)102;
signed char var_24 = (signed char)-29;
unsigned short var_25 = (unsigned short)13901;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 21; ++i_0) 
        for (size_t i_1 = 0; i_1 < 21; ++i_1) 
            arr_3 [i_0] [i_1] = (unsigned short)24808;
    for (size_t i_0 = 0; i_0 < 21; ++i_0) 
        for (size_t i_1 = 0; i_1 < 21; ++i_1) 
            for (size_t i_2 = 0; i_2 < 21; ++i_2) 
                arr_4 [i_0] [i_1] [i_2] = (short)9080;
    for (size_t i_0 = 0; i_0 < 21; ++i_0) 
        for (size_t i_1 = 0; i_1 < 21; ++i_1) 
