...
long long int var_8 = 8155797241825389978LL;
signed char var_9 = (signed char)-2;
unsigned long long int var_10 = 15586974733030207865ULL;
int zero = 0;
unsigned char var_13 = (unsigned char)112;
unsigned long long int var_14 = 3839634198763597064ULL;
unsigned long long int var_15 = 13283821276698582550ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
        for (size_t i_1 = 0; i_1 < 15; ++i_1) 
            for (size_t i_2 = 0; i_2 < 15; ++i_2) 
                for (size_t i_3 = 0; i_3 < 15; ++i_3) 
                    arr_11 [i_0] [i_1] [i_2] [i_3] = (i_0 % 2 == 0) ? (unsigned char)14 : (unsigned char)239;
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
        for (size_t i_1 = 0; i_1 < 15; ++i_1) 
            arr_16 [i_0] [i_1] = (i_1 % 2 == 0) ? (signed char)-24 : (signed char)-56;
}
