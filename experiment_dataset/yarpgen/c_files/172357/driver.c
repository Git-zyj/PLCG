...
unsigned int var_12 = 1852046767U;
int zero = 0;
int var_18 = 1272093340;
unsigned long long int var_19 = 10125251154672615977ULL;
short var_20 = (short)-14643;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        arr_15 [i_0] = 17726124555717399802ULL;
}
