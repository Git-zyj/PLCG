...
unsigned short var_5 = (unsigned short)32615;
signed char var_7 = (signed char)-94;
int zero = 0;
long long int var_10 = 5190861337647879790LL;
short var_11 = (short)4586;
short var_12 = (short)-27302;
unsigned long long int var_13 = 16786930535278342082ULL;
...
void init() {
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        for (size_t i_1 = 0; i_1 < 12; ++i_1) 
            arr_0 [i_0] [i_1] = 1416272915033459903ULL;
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        for (size_t i_1 = 0; i_1 < 12; ++i_1) 
