...
unsigned long long int var_0 = 246288626911293096ULL;
...
unsigned short var_16 = (unsigned short)61298;
unsigned int var_17 = 971131377U;
unsigned int var_18 = 3157193059U;
unsigned long long int var_19 = 10413073103858761525ULL;
unsigned long long int arr_5 [20] [20] ;
signed char arr_7 [20] [20] [20] [20] ;
void init() {
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            arr_5 [i_0] [i_1] = 8531817682397435490ULL;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
