...
int zero = 0;
unsigned long long int var_10 = 7352695422142478006ULL;
unsigned char var_11 = (unsigned char)80;
signed char var_12 = (signed char)-121;
unsigned short var_13 = (unsigned short)40128;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
        for (size_t i_1 = 0; i_1 < 19; ++i_1) 
            for (size_t i_2 = 0; i_2 < 19; ++i_2) 
                arr_8 [i_0] [i_1] [i_2] = (i_1 % 2 == 0) ? -3270807980752483806LL : -3805222870731901753LL;
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
        for (size_t i_1 = 0; i_1 < 19; ++i_1) 
            for (size_t i_2 = 0; i_2 < 19; ++i_2) 
                arr_9 [i_0] [i_1] [i_2] = (i_1 % 2 == 0) ? -68599517 : -2009207378;
}
