...
void test() {
    ...
    for (int i_0 = 0; i_0 < 23;i_0 += 1)
    {
        ...
        for (int i_1 = 0; i_1 < 23;i_1 += 1)
        {
            ...
            {
                {
                    arr_6 [i_0] [i_2] = ((((min(var_4, (arr_2 [18])))) && -var_7));
                    arr_7 [i_0] [i_0] [i_0] = (min((min(255, (min(var_7, 64)))), var_4));
                    arr_8 [i_0] [i_0] [i_1] [i_2] = (arr_5 [i_0] [i_0] [i_1] [i_1]);
                }
            }
        }
        var_13 &= (min(238099542, 2334840015));
    }
    var_14 = (min(var_14, ((((min((min(var_7, var_6)), var_8)) - var_9)))));
    #pragma endscop
}
