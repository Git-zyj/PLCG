...
void test() {
    ...
    for (int i_0 = 0; i_0 < 15;i_0 += 1)
    {
        ...
        {
            {
                var_16 = (((1037860308 ? (max(1368333030, (arr_3 [i_1] [3]))) : (((arr_0 [i_0]) ? (arr_2 [i_0]) : -227756987)))) / 1540947396);
                var_17 = (~(arr_2 [i_0]));
                var_18 = var_0;
            }
        }
    ...
    {
        arr_6 [i_2] = max(((~(arr_4 [i_2]))), ((1625311089 ? 1477106264 : -796465759)));
        arr_7 [i_2] = (((max(2006361050, 917420044)) >= var_2));
    }
    #pragma endscop
}
