...
short var_2 = (short)3192;
unsigned long long int var_4 = 13259071542158417406ULL;
long long int var_5 = 4783903099729005805LL;
_Bool var_6 = (_Bool)0;
unsigned char var_7 = (unsigned char)245;
long long int var_12 = -7672603509495330034LL;
signed char var_18 = (signed char)-126;
int zero = 0;
unsigned long long int var_20 = 16458408373906961313ULL;
_Bool var_21 = (_Bool)0;
signed char var_22 = (signed char)55;
unsigned char var_23 = (unsigned char)250;
short var_24 = (short)21375;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
        for (size_t i_1 = 0; i_1 < 19; ++i_1) 
            arr_14 [i_0] [i_1] = (unsigned short)8142;
}
