...
unsigned int var_6 = 1611002374U;
int zero = 0;
unsigned long long int var_10 = 13125553551696299462ULL;
short var_11 = (short)27580;
unsigned long long int var_12 = 9937974831583132639ULL;
signed char var_13 = (signed char)-121;
short var_14 = (short)12283;
unsigned long long int var_15 = 12753056695873385273ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        for (size_t i_1 = 0; i_1 < 13; ++i_1) 
            for (size_t i_2 = 0; i_2 < 13; ++i_2) 
                arr_16 [i_0] [i_1] [i_2] = (short)26356;
}
