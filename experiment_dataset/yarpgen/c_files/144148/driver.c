...
long long int var_2 = 5575069417509233064LL;
unsigned int var_4 = 3097812687U;
unsigned long long int var_6 = 11593836574070649594ULL;
long long int var_8 = 3680995177656413123LL;
short var_12 = (short)-4116;
int zero = 0;
unsigned int var_13 = 3742402300U;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        for (size_t i_1 = 0; i_1 < 14; ++i_1) 
            for (size_t i_2 = 0; i_2 < 14; ++i_2) 
                arr_6 [i_0] [i_1] [i_2] = (i_2 % 2 == 0) ? (unsigned short)17631 : (unsigned short)48402;
}
