...
void test() {
    ...
    {
        var_17 = (i_0 % 2 == zero) ? ((((((-154092379 + 2147483647) >> (((arr_2 [i_0] [i_0]) - 75)))) > (-1 == 1689892944)))) : ((((((-154092379 + 2147483647) >> (((((arr_2 [i_0] [i_0]) - 75)) + 138)))) > (-1 == 1689892944))));
        /* LoopNest 2 */
            ...
            {
                {
                    ...
                    for (int i_6 = 0; i_6 < 16;i_6 += 1)
                    {
                        ...
                        {
                            {
                                var_22 = ((-(max(2683807202, 1779427596))));
                                var_23 = var_9;
                            }
                        }
                    }
