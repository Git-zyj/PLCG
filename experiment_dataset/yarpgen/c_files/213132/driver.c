...
unsigned int var_1 = 4277933884U;
...
int zero = 0;
unsigned int var_10 = 598458222U;
_Bool var_11 = (_Bool)1;
unsigned char arr_8 [24] ;
long long int arr_9 [24] ;
void init() {
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        arr_8 [i_0] = (i_0 % 2 == 0) ? (unsigned char)193 : (unsigned char)5;
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        arr_9 [i_0] = (i_0 % 2 == 0) ? 7317282253854557478LL : -5286332008262406941LL;
}
