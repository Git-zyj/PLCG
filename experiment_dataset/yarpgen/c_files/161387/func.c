...
#define min(a,b) \
    ({ __typeof__ (a) _a = (a); \
       ...
       _a < _b ? _a : _b; })
void test() {
    var_13 = max((min((0ULL), (15126284992964681658ULL))), (max((8482413634894724311ULL), (9964330438814827305ULL))));
    /* LoopNest 2 */
        ...
        {
            {
                ...
                var_14 = ((/* implicit */unsigned long long int) min((var_14), (arr_1 [i_0])));
