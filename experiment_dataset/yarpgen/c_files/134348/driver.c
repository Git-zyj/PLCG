...
long long int var_4 = 8111715435680567112LL;
int var_5 = 966146809;
unsigned char var_7 = (unsigned char)65;
unsigned char var_8 = (unsigned char)148;
unsigned char var_9 = (unsigned char)75;
long long int var_10 = -7128962676566996331LL;
long long int var_11 = 9079918122277859335LL;
long long int var_12 = 3419188213259645679LL;
unsigned char var_13 = (unsigned char)101;
int zero = 0;
unsigned short var_14 = (unsigned short)57003;
long long int var_15 = -5666585722277787395LL;
signed char var_16 = (signed char)95;
int var_17 = -1040237483;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
            for (size_t i_2 = 0; i_2 < 10; ++i_2) 
                arr_17 [i_0] [i_1] [i_2] = (unsigned short)45850;
}
