...
void test() {
    ...
    for (int i_0 = 0; i_0 < 20;i_0 += 1)
    {
        for (int i_1 = 0; i_1 < 20;i_1 += 1)
        {
            ...
            {
                {
                    var_12 = ((((((arr_0 [i_0]) <= var_4))) < ((((arr_0 [i_1]) != (((arr_3 [i_0] [i_1]) ? var_7 : (arr_5 [i_0] [i_0] [i_0] [i_0]))))))));
                    arr_7 [i_0] [i_0] [i_2] = ((-(arr_5 [i_0] [i_1] [i_0] [i_0])));
                    arr_8 [7] [7] [i_0] |= ((-((((arr_5 [i_2] [i_2] [i_2] [i_2]) && var_0)))));
                }
            }
        }
    }
