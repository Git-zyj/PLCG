...
void test() {
    ...
    for (signed char i_0 = 2; i_0 < 20; i_0 += 1) 
    {
        for (long long int i_1 = 0; i_1 < 22; i_1 += 1) 
        {
            ...
            {
                {
                    var_21 = ((/* implicit */int) arr_2 [i_0] [i_1] [i_2]);
                    var_22 = ((/* implicit */unsigned long long int) max((var_22), (((/* implicit */unsigned long long int) (-(((((/* implicit */int) arr_3 [i_0 + 2] [i_2 - 2] [i_2 - 1])) * (((/* implicit */int) (unsigned short)20523)))))))));
                }
            } 
        } 
    } 
