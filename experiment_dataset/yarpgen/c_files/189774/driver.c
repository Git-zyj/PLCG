...
long long int var_0 = 1309596101514356085LL;
unsigned int var_1 = 503690827U;
signed char var_6 = (signed char)44;
short var_7 = (short)-15822;
short var_10 = (short)-7895;
int zero = 0;
unsigned long long int var_11 = 8860522426533375746ULL;
short var_12 = (short)-16468;
unsigned char var_13 = (unsigned char)2;
unsigned char var_14 = (unsigned char)87;
unsigned short var_15 = (unsigned short)9032;
signed char var_16 = (signed char)100;
short var_17 = (short)7401;
unsigned short var_18 = (unsigned short)4979;
unsigned int var_19 = 1541247203U;
long long int var_20 = -1453317751563985015LL;
short arr_0 [14] [14] ;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        for (size_t i_1 = 0; i_1 < 14; ++i_1) 
            arr_10 [i_0] [i_1] = 12561559930079193377ULL;
}
