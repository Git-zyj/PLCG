...
unsigned int var_1 = 40383165U;
unsigned char var_4 = (unsigned char)132;
signed char var_11 = (signed char)-81;
short var_13 = (short)25700;
unsigned long long int var_17 = 12509841277677613467ULL;
int zero = 0;
int var_19 = 1260990159;
short var_20 = (short)-15375;
unsigned long long int var_21 = 7432732492125217052ULL;
    ...
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            for (size_t i_2 = 0; i_2 < 11; ++i_2) 
                for (size_t i_3 = 0; i_3 < 11; ++i_3) 
                    for (size_t i_4 = 0; i_4 < 11; ++i_4) 
                        arr_14 [i_0] [i_1] [i_2] [i_3] [i_4] = (unsigned char)174;
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            arr_15 [i_0] [i_1] = 15487721732439587449ULL;
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            arr_16 [i_0] [i_1] = 4581733167214942763LL;
}
