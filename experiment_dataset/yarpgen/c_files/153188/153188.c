...
void test() {
    ...
    {
        arr_3 [i_0] = ((~(((arr_0 [i_0] [i_0]) ? var_11 : (arr_0 [i_0] [i_0])))));
        arr_4 [i_0] = ((+(((arr_2 [i_0] [i_0]) ? var_14 : (arr_2 [i_0] [i_0])))));
        arr_5 [i_0] = 57215;
        var_15 += ((((((arr_0 [i_0] [i_0]) < (arr_0 [i_0] [i_0])))) ^ ((max((arr_1 [i_0] [i_0]), (arr_0 [i_0] [i_0]))))));
    }
    var_16 -= var_8;
    #pragma endscop
}
