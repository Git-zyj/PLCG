...
long long int var_2 = 4495216965934866621LL;
int var_3 = -292442032;
int var_6 = 1598841367;
int zero = 0;
signed char var_14 = (signed char)62;
unsigned char var_15 = (unsigned char)103;
int var_16 = -1619549156;
long long int var_17 = -8297659285200416648LL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
            arr_5 [i_0] [i_1] = (i_0 % 2 == 0) ? (unsigned char)226 : (unsigned char)28;
}
