...
long long int var_0 = 5427891280999992498LL;
signed char var_3 = (signed char)118;
unsigned long long int var_7 = 2548859762253446706ULL;
unsigned char var_11 = (unsigned char)118;
unsigned long long int var_12 = 18062048190687169358ULL;
int zero = 0;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        arr_1 [i_0] = 7685466011959904582ULL;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
