...
int var_16 = -1984599182;
unsigned long long int var_17 = 5937568274240118667ULL;
unsigned int var_18 = 1504398857U;
short arr_0 [18] ;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        arr_6 [i_0] = (unsigned short)37756;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
