...
void test() {
    ...
    for (unsigned short i_0 = 0; i_0 < 21; i_0 += 2) 
    {
        ...
        {
            {
                arr_5 [(_Bool)1] [(_Bool)1] [(_Bool)1] = ((/* implicit */long long int) (-((+(((((/* implicit */_Bool) var_10)) ? (((/* implicit */unsigned long long int) (-9223372036854775807LL - 1LL))) : (18446744073709551583ULL)))))));
                var_18 = ((/* implicit */short) (~(885447936U)));
            }
        } 
    } 
