...
unsigned short var_0 = (unsigned short)37206;
long long int var_1 = -3151768028829430103LL;
unsigned int var_2 = 2968126525U;
unsigned char var_6 = (unsigned char)200;
int zero = 0;
unsigned int var_15 = 974152180U;
