...
unsigned short var_8 = (unsigned short)49791;
_Bool var_10 = (_Bool)0;
int zero = 0;
short var_11 = (short)-7010;
int var_12 = 1054071543;
_Bool var_13 = (_Bool)1;
short var_14 = (short)19435;
short var_15 = (short)27139;
unsigned short var_16 = (unsigned short)32882;
    ...
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            for (size_t i_2 = 0; i_2 < 18; ++i_2) 
                arr_6 [i_0] [i_1] [i_2] = -5863759202368228891LL;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
