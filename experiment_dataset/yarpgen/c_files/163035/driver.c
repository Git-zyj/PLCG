...
unsigned int var_6 = 4247733461U;
unsigned int var_7 = 3756610898U;
unsigned char var_9 = (unsigned char)102;
int zero = 0;
unsigned short var_11 = (unsigned short)32295;
unsigned char var_12 = (unsigned char)145;
int var_13 = 332192282;
unsigned short var_14 = (unsigned short)16289;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
            for (size_t i_2 = 0; i_2 < 10; ++i_2) 
                arr_6 [i_0] [i_1] [i_2] = 8045349443548166242ULL;
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
            for (size_t i_2 = 0; i_2 < 10; ++i_2) 
                arr_7 [i_0] [i_1] [i_2] = (unsigned short)26920;
}
