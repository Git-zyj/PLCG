...
unsigned int var_10 = 2402050437U;
unsigned char var_11 = (unsigned char)166;
int zero = 0;
signed char var_15 = (signed char)13;
int var_16 = 1926524973;
signed char var_17 = (signed char)-69;
_Bool var_18 = (_Bool)1;
long long int var_19 = -4776320950362231549LL;
long long int arr_6 [23] [23] ;
void init() {
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        for (size_t i_1 = 0; i_1 < 23; ++i_1) 
            arr_6 [i_0] [i_1] = (i_1 % 2 == 0) ? -2963359445920489638LL : 6274254956949255211LL;
}
