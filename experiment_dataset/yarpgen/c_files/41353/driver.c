...
_Bool var_5 = (_Bool)0;
unsigned long long int var_11 = 5989060582699628195ULL;
int zero = 0;
unsigned long long int var_19 = 6939796818536384376ULL;
unsigned char var_20 = (unsigned char)242;
unsigned short var_21 = (unsigned short)7835;
