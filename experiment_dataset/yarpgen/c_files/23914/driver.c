...
int var_0 = 1693981040;
long long int var_1 = -1164849022505629736LL;
signed char var_4 = (signed char)76;
long long int var_6 = -4598246455273695438LL;
unsigned long long int var_7 = 10341736630094129474ULL;
long long int var_8 = 438803112231727479LL;
_Bool var_9 = (_Bool)1;
long long int var_10 = 5975016681699693135LL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
            for (size_t i_2 = 0; i_2 < 25; ++i_2) 
                arr_5 [i_0] [i_1] [i_2] = 2017372415864226907ULL;
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        arr_6 [i_0] = 14331376688832037497ULL;
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
            for (size_t i_2 = 0; i_2 < 25; ++i_2) 
