...
void test() {
    ...
    for (int i_0 = 4; i_0 < 18;i_0 += 1)
    {
        for (int i_1 = 0; i_1 < 20;i_1 += 1)
        {
            ...
            {
                {
                    arr_6 [i_0] [i_1] [i_2] [i_2] = (((((!(arr_4 [i_0] [i_0] [i_0] [i_2]))) ? (min((arr_0 [i_1] [i_0]), 2097151)) : ((-530721822 ? var_0 : -2097156)))) | 2039852863);
                    arr_7 [i_2] [i_1] [i_0 + 2] = ((!(!var_4)));
                    var_17 ^= ((!((!(arr_0 [i_0 + 1] [i_2 + 1])))));
                    var_18 = -395372549;
                }
            }
        }
