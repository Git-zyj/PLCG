...
void test() {
    ...
    for (short i_0 = 1; i_0 < 14; i_0 += 4) 
    {
        ...
        var_18 = ((/* implicit */_Bool) ((((/* implicit */_Bool) ((((/* implicit */unsigned int) ((/* implicit */int) (short)16421))) / (var_3)))) ? (((((/* implicit */int) arr_0 [11LL])) & (((/* implicit */int) var_10)))) : (((/* implicit */int) arr_0 [i_0 + 2]))));
    }
}
