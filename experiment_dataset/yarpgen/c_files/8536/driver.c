...
unsigned int var_9 = 1419036695U;
int zero = 0;
signed char var_14 = (signed char)-111;
unsigned char var_15 = (unsigned char)101;
unsigned long long int var_16 = 16828288744767846383ULL;
long long int arr_2 [20] ;
unsigned long long int arr_4 [20] [20] ;
unsigned short arr_5 [20] [20] ;
void init() {
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        arr_2 [i_0] = -4114580191621600534LL;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            arr_4 [i_0] [i_1] = 14485687507654973934ULL;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            arr_5 [i_0] [i_1] = (unsigned short)50442;
}
