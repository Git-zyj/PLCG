...
unsigned int var_3 = 34456066U;
unsigned char var_4 = (unsigned char)241;
unsigned char var_5 = (unsigned char)148;
short var_6 = (short)-26712;
int zero = 0;
unsigned char var_14 = (unsigned char)57;
short var_15 = (short)-18459;
int var_16 = -518314173;
short var_17 = (short)-14176;
_Bool arr_0 [17] [17] ;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 17; ++i_0) 
        for (size_t i_1 = 0; i_1 < 17; ++i_1) 
            arr_2 [i_0] [i_1] = -14140328;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        arr_6 [i_0] = (i_0 % 2 == 0) ? (unsigned char)208 : (unsigned char)75;
}
