...
void test() {
    ...
    for (int i_0 = 0; i_0 < 13; i_0 += 1) 
    {
        ...
        {
            {
                var_16 = ((unsigned long long int) 7697614725969001247LL);
                var_17 ^= ((/* implicit */long long int) (-(((/* implicit */int) ((((/* implicit */long long int) 8184)) <= (arr_4 [i_1 - 1] [i_1 + 1] [i_1 - 1]))))));
            }
        } 
    } 
    var_18 = ((/* implicit */long long int) max((var_18), (-849672446313181133LL)));
}
