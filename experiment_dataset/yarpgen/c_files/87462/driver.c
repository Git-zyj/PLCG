...
int var_17 = -1139154387;
long long int var_18 = 8474760115094127434LL;
unsigned long long int arr_2 [13] [13] ;
unsigned long long int arr_4 [13] ;
void init() {
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        for (size_t i_1 = 0; i_1 < 13; ++i_1) 
            arr_2 [i_0] [i_1] = 866043310040310958ULL;
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        arr_4 [i_0] = (i_0 % 2 == 0) ? 15865042618396945030ULL : 9861117294041616330ULL;
}
