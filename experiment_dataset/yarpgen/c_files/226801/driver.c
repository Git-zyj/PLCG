...
short var_1 = (short)-23978;
signed char var_3 = (signed char)-60;
int zero = 0;
int var_11 = -1269026437;
unsigned short var_12 = (unsigned short)56883;
unsigned int var_13 = 2624366403U;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        for (size_t i_1 = 0; i_1 < 16; ++i_1) 
            arr_1 [i_0] [i_1] = (unsigned short)14234;
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        for (size_t i_1 = 0; i_1 < 16; ++i_1) 
            arr_3 [i_0] [i_1] = 2055281073U;
}
