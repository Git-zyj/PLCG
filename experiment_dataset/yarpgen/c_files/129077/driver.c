...
long long int var_6 = -2290259013823837909LL;
signed char var_7 = (signed char)6;
unsigned long long int var_9 = 13069550647734963288ULL;
unsigned char var_10 = (unsigned char)218;
int var_13 = -1321992538;
short var_14 = (short)-14561;
int zero = 0;
int var_15 = 1598732975;
int var_16 = -787355147;
short var_17 = (short)-17552;
int var_18 = -717130365;
_Bool arr_5 [18] [18] ;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        arr_6 [i_0] = (i_0 % 2 == 0) ? 14875068875704873577ULL : 14085356886395992459ULL;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
