...
unsigned long long int var_0 = 2731479522565973796ULL;
short var_1 = (short)12250;
signed char var_2 = (signed char)-109;
int var_3 = 1529178260;
signed char var_4 = (signed char)64;
int var_5 = -1141760571;
...
unsigned long long int var_18 = 9006373205117366074ULL;
signed char var_19 = (signed char)84;
short var_20 = (short)-10295;
        ...
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
            for (size_t i_2 = 0; i_2 < 10; ++i_2) 
                for (size_t i_3 = 0; i_3 < 10; ++i_3) 
                    arr_10 [i_0] [i_1] [i_2] [i_3] = 10006162354191164339ULL;
}
