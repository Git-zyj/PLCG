...
unsigned long long int var_9 = 10175388967883957436ULL;
long long int var_11 = 6040706726022599944LL;
unsigned int var_13 = 2204485295U;
signed char var_15 = (signed char)49;
unsigned char var_17 = (unsigned char)133;
int zero = 0;
int var_18 = -2092186191;
long long int var_19 = -3932322833836141183LL;
unsigned char var_20 = (unsigned char)79;
int var_21 = 844546450;
long long int var_22 = 5077911395489627679LL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
            arr_8 [i_0] [i_1] = 3838551464641433091ULL;
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
            for (size_t i_2 = 0; i_2 < 10; ++i_2) 
    ...
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        arr_13 [i_0] = -8978135109694703943LL;
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
            for (size_t i_2 = 0; i_2 < 10; ++i_2) 
