...
unsigned short var_0 = (unsigned short)38717;
unsigned short var_1 = (unsigned short)13207;
signed char var_3 = (signed char)-54;
unsigned char var_4 = (unsigned char)151;
unsigned int var_10 = 197673738U;
...
long long int var_19 = 5719460292346666448LL;
short arr_3 [16] [16] ;
unsigned int arr_4 [16] [16] [16] ;
void init() {
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        for (size_t i_1 = 0; i_1 < 16; ++i_1) 
            arr_3 [i_0] [i_1] = (short)-17265;
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        for (size_t i_1 = 0; i_1 < 16; ++i_1) 
            for (size_t i_2 = 0; i_2 < 16; ++i_2) 
                arr_4 [i_0] [i_1] [i_2] = 525309739U;
}
