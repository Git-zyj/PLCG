...
void test() {
    #pragma scop
    var_14 = ((~(39439 ^ 1400640940)));
    var_15 = ((var_1 < ((-297387888 ? var_13 : var_7))));
    var_16 = ((0 ? var_5 : 1124573412458389396));
    /* LoopNest 2 */
    for (int i_0 = 0; i_0 < 1;i_0 += 1)
    {
        ...
        {
            {
                arr_5 [i_0] = (min(1, 12867294642699910048));
                arr_6 [i_0] [i_0] = 295636724;
            }
        }
    }
    #pragma endscop
