...
unsigned short var_1 = (unsigned short)4965;
long long int var_4 = 5816649765977091213LL;
signed char var_6 = (signed char)(-127 - 1);
unsigned char var_7 = (unsigned char)133;
int var_11 = -145309763;
int zero = 0;
signed char var_13 = (signed char)-71;
int var_14 = -35243278;
int var_15 = -1166180716;
unsigned char var_16 = (unsigned char)215;
short var_17 = (short)21761;
short var_18 = (short)-26558;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        for (size_t i_1 = 0; i_1 < 12; ++i_1) 
            arr_2 [i_0] [i_1] = 3452224760963425862ULL;
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        for (size_t i_1 = 0; i_1 < 12; ++i_1) 
            arr_3 [i_0] [i_1] = (unsigned short)36494;
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        for (size_t i_1 = 0; i_1 < 12; ++i_1) 
