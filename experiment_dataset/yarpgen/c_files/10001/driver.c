...
unsigned long long int var_2 = 3363597761582922986ULL;
unsigned char var_3 = (unsigned char)82;
unsigned char var_7 = (unsigned char)51;
long long int var_11 = 3682842208619625802LL;
short var_14 = (short)-20163;
int var_15 = -1636762190;
unsigned char var_16 = (unsigned char)53;
unsigned int var_17 = 3851520144U;
int zero = 0;
signed char var_20 = (signed char)121;
unsigned char var_21 = (unsigned char)134;
unsigned char var_22 = (unsigned char)196;
unsigned short var_23 = (unsigned short)28684;
signed char var_24 = (signed char)31;
long long int var_25 = 2872112493937123547LL;
...
void init() {
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        arr_1 [i_0] = 4777431047504119258ULL;
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
    ...
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        for (size_t i_1 = 0; i_1 < 12; ++i_1) 
            for (size_t i_2 = 0; i_2 < 12; ++i_2) 
                arr_6 [i_0] [i_1] [i_2] = 14441799074381514093ULL;
}
