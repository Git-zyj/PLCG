...
void test() {
    ...
    {
        var_16 = var_7;
        var_17 = ((/* implicit */unsigned long long int) max((var_17), (((/* implicit */unsigned long long int) ((signed char) var_5)))));
        var_18 = ((/* implicit */unsigned char) max((var_18), (((/* implicit */unsigned char) var_8))));
        var_19 = ((/* implicit */signed char) min((var_19), (((/* implicit */signed char) ((((/* implicit */int) ((unsigned char) (short)-19076))) & (((/* implicit */int) (short)-19076)))))));
    }
}
