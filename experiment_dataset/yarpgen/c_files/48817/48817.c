...
void test() {
    ...
    for (int i_0 = 0; i_0 < 1;i_0 += 1)
    {
        ...
        {
            {
                var_20 += (((arr_4 [i_0] [i_1] [i_1]) + (((min((arr_3 [i_0]), (arr_5 [i_1]))) % (arr_2 [i_0] [i_0])))));
                var_21 = (((((arr_3 [i_0]) || ((!(arr_2 [i_0] [i_1 - 1]))))) && ((min((min((arr_5 [i_0]), var_4)), (!var_18))))));
                arr_6 [i_1] [i_1] = ((~(((((arr_4 [i_1] [i_1 - 1] [i_1]) + 9223372036854775807)) >> (var_7 + 146611520)))));
            }
        }
    }
    #pragma endscop
