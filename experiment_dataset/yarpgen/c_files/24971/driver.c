...
unsigned long long int var_13 = 10491719636851284672ULL;
signed char var_15 = (signed char)95;
int zero = 0;
unsigned int var_19 = 738286322U;
unsigned long long int var_20 = 15591380901721923338ULL;
int var_21 = -1120270583;
unsigned int var_22 = 3752219666U;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
        for (size_t i_1 = 0; i_1 < 19; ++i_1) 
            arr_6 [i_0] [i_1] = 8695243310201069024LL;
}
