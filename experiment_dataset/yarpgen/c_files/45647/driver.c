...
unsigned long long int var_6 = 15824117031948176170ULL;
signed char var_9 = (signed char)-60;
int var_12 = -1199247707;
int zero = 0;
unsigned short var_16 = (unsigned short)7249;
unsigned long long int var_17 = 9614283843496635854ULL;
int var_18 = -1293420729;
