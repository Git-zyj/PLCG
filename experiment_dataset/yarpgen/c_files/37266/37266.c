...
void test() {
    ...
    for (int i_0 = 3; i_0 < 20;i_0 += 1)
    {
        ...
        {
            {
                arr_7 [i_1] [i_0] [i_0 - 1] = (min((min(-922608783, (arr_6 [i_0] [i_0] [i_0]))), (min((arr_6 [i_0 - 1] [i_1] [i_1]), 922608808))));
                var_19 = (max(var_19, ((((((-(arr_2 [i_0 + 3])))) || (((arr_6 [i_0 + 1] [i_0 + 2] [i_0 + 2]) < (min((arr_0 [i_0]), (arr_6 [i_0] [i_0] [i_0]))))))))));
                var_20 = (arr_6 [i_0] [i_0] [11]);
            }
        }
    }
    var_21 = 922608774;
