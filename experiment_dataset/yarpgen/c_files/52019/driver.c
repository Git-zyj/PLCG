...
unsigned long long int var_4 = 12579938378149532674ULL;
unsigned long long int var_9 = 6404634118356630824ULL;
unsigned char var_12 = (unsigned char)105;
int zero = 0;
_Bool var_13 = (_Bool)0;
unsigned char var_14 = (unsigned char)41;
int var_15 = -950480562;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        arr_4 [i_0] = (i_0 % 2 == 0) ? 2093038712U : 879565412U;
}
