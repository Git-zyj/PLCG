...
_Bool var_1 = (_Bool)1;
unsigned short var_2 = (unsigned short)58484;
_Bool var_9 = (_Bool)0;
unsigned long long int var_14 = 17732664048014364220ULL;
unsigned long long int var_16 = 17179013794827280974ULL;
int zero = 0;
unsigned char var_20 = (unsigned char)186;
signed char var_21 = (signed char)55;
unsigned char var_22 = (unsigned char)232;
unsigned long long int var_23 = 853416767222542963ULL;
