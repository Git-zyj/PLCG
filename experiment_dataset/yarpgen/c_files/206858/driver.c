...
unsigned short var_5 = (unsigned short)1821;
_Bool var_9 = (_Bool)0;
unsigned short var_10 = (unsigned short)37644;
short var_12 = (short)13821;
long long int var_14 = 7634885947942645204LL;
unsigned char var_15 = (unsigned char)176;
long long int var_18 = -7132480626719875163LL;
int zero = 0;
unsigned char var_19 = (unsigned char)23;
unsigned char var_20 = (unsigned char)152;
unsigned int var_21 = 3886549902U;
unsigned int var_22 = 1726460701U;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 21; ++i_0) 
        for (size_t i_1 = 0; i_1 < 21; ++i_1) 
            for (size_t i_2 = 0; i_2 < 21; ++i_2) 
                arr_5 [i_0] [i_1] [i_2] = 1896233283U;
    for (size_t i_0 = 0; i_0 < 21; ++i_0) 
        arr_6 [i_0] = 811085075038265444LL;
    for (size_t i_0 = 0; i_0 < 21; ++i_0) 
        for (size_t i_1 = 0; i_1 < 21; ++i_1) 
            for (size_t i_2 = 0; i_2 < 21; ++i_2) 
