...
void test() {
    #pragma scop
    var_16 = ((-1890480602 ? -1890480595 : (!1)));
    /* LoopNest 2 */
    for (int i_0 = 0; i_0 < 22;i_0 += 1)
    {
        ...
        {
            {
                arr_5 [i_0] [i_1] [i_1] = ((((((arr_0 [i_0]) - ((max((arr_3 [i_0] [i_1] [i_0]), 0)))))) && ((((arr_4 [i_1] [i_0] [i_0]) ? (arr_4 [i_0] [i_1] [i_1]) : var_10)))));
                arr_6 [i_0] [i_1] = (arr_2 [i_0] [i_1]);
            }
        }
    }
    #pragma endscop
