...
unsigned short var_5 = (unsigned short)44694;
signed char var_6 = (signed char)89;
unsigned int var_9 = 2516579544U;
signed char var_10 = (signed char)122;
short var_11 = (short)11988;
int var_15 = 1810892459;
int zero = 0;
unsigned char var_17 = (unsigned char)225;
short var_18 = (short)3243;
unsigned int var_19 = 3358912384U;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
        for (size_t i_1 = 0; i_1 < 19; ++i_1) 
            arr_6 [i_0] [i_1] = 2096059405950773865ULL;
}
