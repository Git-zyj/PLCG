...
unsigned short var_2 = (unsigned short)57680;
int var_4 = 1595192254;
long long int var_5 = -5724307878750417307LL;
_Bool var_13 = (_Bool)1;
int zero = 0;
signed char var_16 = (signed char)22;
short var_17 = (short)1022;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        arr_4 [i_0] = (short)19143;
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        for (size_t i_1 = 0; i_1 < 22; ++i_1) 
            for (size_t i_2 = 0; i_2 < 22; ++i_2) 
                arr_5 [i_0] [i_1] [i_2] = 2023026818U;
}
