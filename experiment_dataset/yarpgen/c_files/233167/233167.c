...
void test() {
    ...
    for (int i_0 = 0; i_0 < 23;i_0 += 1)
    {
        ...
        {
            {
                arr_4 [i_0] [i_0] = ((((((arr_3 [i_1] [i_0]) ? 21558 : (arr_0 [i_0] [i_0])))) ? (arr_2 [i_0] [i_1]) : ((((((((arr_0 [i_0] [i_1]) != 3964387596)))) > 330579722)))));
                arr_5 [i_0] [i_0] = ((3964387608 ? (min((max((arr_0 [i_1] [i_1]), 0)), (!0))) : (arr_1 [i_0] [i_0])));
                var_17 = -14;
            }
        }
    }
