...
void test() {
    ...
    for (int i_0 = 2; i_0 < 18;i_0 += 1)
    {
        for (int i_1 = 0; i_1 < 21;i_1 += 1)
        {
            ...
            {
                {
                    var_10 = (min(var_10, (((((((min((arr_1 [i_1]), (arr_3 [i_0] [i_1]))) | var_1))) ? ((max(14207, -24074))) : (arr_3 [i_0] [i_1]))))));
                    var_11 = (min(var_11, (((6 ? 3709352841105467164 : 255)))));
                }
            }
        }
    }
    var_12 = 6840326428248156038;
    #pragma endscop
}
