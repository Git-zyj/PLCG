...
long long int var_1 = 8944398901048432079LL;
int var_3 = 1498736969;
unsigned char var_11 = (unsigned char)156;
unsigned char var_14 = (unsigned char)7;
long long int var_18 = 3837229172109141916LL;
int zero = 0;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        for (size_t i_1 = 0; i_1 < 22; ++i_1) 
            arr_6 [i_0] [i_1] = (i_1 % 2 == 0) ? (signed char)-96 : (signed char)32;
}
