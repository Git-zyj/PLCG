...
unsigned short var_1 = (unsigned short)12778;
unsigned short var_4 = (unsigned short)61241;
unsigned int var_9 = 3275032413U;
int zero = 0;
unsigned short var_18 = (unsigned short)12327;
short var_19 = (short)23236;
signed char var_20 = (signed char)69;
unsigned char var_21 = (unsigned char)151;
_Bool var_22 = (_Bool)1;
unsigned short var_23 = (unsigned short)47293;
short var_24 = (short)29728;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            arr_1 [i_0] [i_1] = 6532063081022954090ULL;
    ...
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            arr_6 [i_0] [i_1] = 18209710005554356462ULL;
}
