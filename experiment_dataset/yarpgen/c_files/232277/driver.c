...
unsigned int var_1 = 879277850U;
signed char var_6 = (signed char)124;
long long int var_8 = -3924855759870144218LL;
int zero = 0;
signed char var_10 = (signed char)-98;
signed char var_11 = (signed char)-94;
unsigned long long int var_12 = 12928866110961513623ULL;
    ...
    for (size_t i_0 = 0; i_0 < 17; ++i_0) 
        for (size_t i_1 = 0; i_1 < 17; ++i_1) 
            for (size_t i_2 = 0; i_2 < 17; ++i_2) 
                arr_8 [i_0] [i_1] [i_2] = (i_2 % 2 == 0) ? -4641911883437093164LL : -9159761435405453431LL;
}
