...
void test() {
    ...
    for (unsigned int i_0 = 0; i_0 < 20; i_0 += 3) 
    {
        ...
        {
            {
                var_17 = ((/* implicit */short) ((signed char) arr_2 [i_1] [i_1]));
                var_18 = ((/* implicit */signed char) (+((-(arr_2 [7] [i_1])))));
            }
        } 
    } 
    var_19 = ((/* implicit */signed char) ((((/* implicit */unsigned int) ((/* implicit */int) (unsigned short)27015))) | (0U)));
}
