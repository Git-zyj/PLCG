...
void test() {
    ...
    var_12 = ((/* implicit */unsigned long long int) (+(((/* implicit */int) (!(((/* implicit */_Bool) ((((/* implicit */int) var_2)) / (((/* implicit */int) var_5))))))))));
    /* LoopSeq 1 */
    for (signed char i_0 = 1; i_0 < 24; i_0 += 3) 
    {
        arr_2 [i_0] = ((/* implicit */unsigned short) ((((/* implicit */unsigned long long int) ((/* implicit */int) (_Bool)1))) <= (20ULL)));
        var_13 = ((/* implicit */unsigned int) min((var_13), (((/* implicit */unsigned int) (+(((/* implicit */int) (signed char)-67)))))));
    }
