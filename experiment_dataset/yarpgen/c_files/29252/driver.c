...
unsigned int var_2 = 2590377160U;
long long int var_4 = 1808027770127737538LL;
unsigned char var_5 = (unsigned char)140;
_Bool var_7 = (_Bool)1;
unsigned char var_8 = (unsigned char)172;
unsigned char var_9 = (unsigned char)184;
unsigned long long int var_10 = 12653742194562834955ULL;
int zero = 0;
_Bool var_11 = (_Bool)0;
unsigned short var_12 = (unsigned short)40391;
signed char var_13 = (signed char)-45;
_Bool var_14 = (_Bool)0;
unsigned long long int var_15 = 1310140735863324625ULL;
...
void init() {
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        arr_1 [i_0] = 586428996U;
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        for (size_t i_1 = 0; i_1 < 23; ++i_1) 
            for (size_t i_2 = 0; i_2 < 23; ++i_2) 
                arr_4 [i_0] [i_1] [i_2] = (unsigned short)41718;
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        for (size_t i_1 = 0; i_1 < 23; ++i_1) 
            arr_6 [i_0] [i_1] = (short)-14120;
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        for (size_t i_1 = 0; i_1 < 23; ++i_1) 
