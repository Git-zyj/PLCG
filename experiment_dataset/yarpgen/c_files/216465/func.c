...
void test() {
    ...
    for (int i_0 = 0; i_0 < 19; i_0 += 1) 
    {
        for (int i_1 = 1; i_1 < 17; i_1 += 2) 
        {
            ...
            {
                {
                    arr_8 [i_2 + 2] [i_1] [i_2 - 2] = ((int) (~(-1067326169)));
                    arr_9 [i_0] [i_1 + 1] [i_2] = ((arr_4 [4] [i_1 - 1]) / (((((((/* implicit */_Bool) arr_5 [14])) ? (var_11) : (var_10))) * (((arr_5 [i_0]) / (arr_2 [i_0] [i_1 + 1]))))));
                }
            } 
        } 
    } 
    var_17 = ((int) max((691800851), (var_7)));
}
