...
unsigned short var_0 = (unsigned short)39235;
unsigned char var_3 = (unsigned char)189;
short var_4 = (short)-13023;
unsigned char var_9 = (unsigned char)222;
unsigned int var_10 = 2847983239U;
int zero = 0;
short var_13 = (short)26131;
long long int var_14 = 7718368310672730054LL;
        ...
        for (size_t i_1 = 0; i_1 < 24; ++i_1) 
            for (size_t i_2 = 0; i_2 < 24; ++i_2) 
                for (size_t i_3 = 0; i_3 < 24; ++i_3) 
                    arr_8 [i_0] [i_1] [i_2] [i_3] = (unsigned short)61714;
}
