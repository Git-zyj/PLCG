...
void test() {
    #pragma scop
    var_14 = (((((-540 ? (min(629001201, 58314)) : -629001198))) ? (var_12 - var_0) : var_1));

    for (int i_0 = 0; i_0 < 11;i_0 += 1)
    {
        arr_2 [i_0] [i_0] = arr_0 [i_0] [i_0];
        var_15 ^= (arr_0 [i_0] [i_0]);
        var_16 = ((((min(17607846631793324926, 162))) ? 3724439744 : (arr_0 [i_0] [i_0])));
    }
    for (int i_1 = 0; i_1 < 13;i_1 += 1)
    {
        arr_5 [i_1] &= (arr_4 [i_1] [i_1]);
        arr_6 [1] = (min(((min((arr_4 [i_1] [i_1]), 566))), 65080));
    }
    #pragma endscop
}
