...
int var_0 = 982706176;
unsigned int var_1 = 2321180770U;
int var_2 = -222577512;
signed char var_5 = (signed char)-120;
_Bool var_6 = (_Bool)0;
unsigned long long int var_7 = 17893303057059959384ULL;
int zero = 0;
signed char var_10 = (signed char)-11;
int var_11 = -1906805474;
_Bool var_12 = (_Bool)1;
int var_13 = -604205729;
_Bool arr_0 [23] ;
int arr_4 [23] [23] ;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        for (size_t i_1 = 0; i_1 < 23; ++i_1) 
            arr_4 [i_0] [i_1] = (i_1 % 2 == 0) ? -2113469804 : -801534374;
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        for (size_t i_1 = 0; i_1 < 23; ++i_1) 
