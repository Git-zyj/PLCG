        ...
        {
            {
                ...
                var_19 += ((/* implicit */int) (!(((/* implicit */_Bool) min((min((793054273), (1524341300))), (max((266767968), (-793054284))))))));
                var_20 &= (-(min((-793054297), ((+(-793054274))))));
                var_21 = max((min((min((arr_4 [i_1] [8]), (var_10))), (((/* implicit */int) (!(((/* implicit */_Bool) 1394045368))))))), (max((max((-793054274), (-471675606))), (max((var_4), (var_4))))));
            }
        } 
    } 
    var_22 = ((/* implicit */int) max((var_22), (((/* implicit */int) (!(((/* implicit */_Bool) (~(min((var_8), (var_7)))))))))));
    var_23 = (~((~(434602528))));
}
