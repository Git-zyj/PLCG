...
long long int var_0 = -8261474565500337182LL;
long long int var_1 = 2904818726552968303LL;
...
long long int var_6 = -2479408411047015066LL;
long long int var_7 = -5531286937575065189LL;
unsigned char var_8 = (unsigned char)212;
int zero = 0;
unsigned long long int var_11 = 10940012588653019604ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
        for (size_t i_1 = 0; i_1 < 19; ++i_1) 
            arr_7 [i_0] [i_1] = (i_0 % 2 == 0) ? (unsigned char)96 : (unsigned char)211;
}
