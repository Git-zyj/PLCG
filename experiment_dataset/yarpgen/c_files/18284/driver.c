...
int var_13 = 1494906097;
int zero = 0;
long long int var_20 = -5829170456219437269LL;
unsigned int var_21 = 322006187U;
_Bool arr_0 [18] [18] ;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            arr_6 [i_0] [i_1] = 4755152572770556141ULL;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        arr_8 [i_0] = (unsigned char)36;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        arr_10 [i_0] = (i_0 % 2 == 0) ? 1824954891 : -1307572851;
}
