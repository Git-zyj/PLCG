...
int var_9 = -411525463;
int zero = 0;
int var_10 = 570783660;
long long int var_11 = -1798880621735600038LL;
unsigned char var_12 = (unsigned char)92;
long long int var_13 = -5001634064344074047LL;
unsigned int var_14 = 2963769888U;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
        for (size_t i_1 = 0; i_1 < 19; ++i_1) 
            arr_4 [i_0] [i_1] = 1168820809U;
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
        for (size_t i_1 = 0; i_1 < 19; ++i_1) 
            arr_5 [i_0] [i_1] = -3458380350904246862LL;
}
