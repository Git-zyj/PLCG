...
short var_1 = (short)29684;
_Bool var_2 = (_Bool)1;
signed char var_6 = (signed char)21;
unsigned char var_7 = (unsigned char)77;
signed char var_9 = (signed char)-80;
long long int var_15 = 504780552508118752LL;
int zero = 0;
short var_17 = (short)-12483;
int var_18 = 708117429;
unsigned short var_19 = (unsigned short)56707;
short var_20 = (short)14208;
    ...
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
        for (size_t i_1 = 0; i_1 < 15; ++i_1) 
            for (size_t i_2 = 0; i_2 < 15; ++i_2) 
                arr_7 [i_0] [i_1] [i_2] = -6323793991317948985LL;
}
