...
_Bool var_9 = (_Bool)1;
int zero = 0;
unsigned long long int var_10 = 4387603394496463319ULL;
unsigned short var_11 = (unsigned short)17168;
unsigned short var_12 = (unsigned short)8542;
_Bool arr_0 [15] ;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
        arr_3 [i_0] = (unsigned short)39353;
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
