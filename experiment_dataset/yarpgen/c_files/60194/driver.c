...
unsigned int var_0 = 3356632727U;
int var_4 = -490522974;
unsigned int var_5 = 302904981U;
...
long long int var_15 = -2642468782569527215LL;
int zero = 0;
unsigned short var_18 = (unsigned short)54337;
int var_19 = 877957656;
int var_20 = -2010530243;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        for (size_t i_1 = 0; i_1 < 24; ++i_1) 
            for (size_t i_2 = 0; i_2 < 24; ++i_2) 
                for (size_t i_3 = 0; i_3 < 24; ++i_3) 
                    arr_9 [i_0] [i_1] [i_2] [i_3] = (i_1 % 2 == 0) ? 8067901418862594816LL : 4372372179171161734LL;
}
