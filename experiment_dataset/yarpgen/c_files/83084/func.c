...
void test() {
    ...
    for (signed char i_0 = 2; i_0 < 19; i_0 += 4) 
    {
        ...
        {
            {
                var_20 = ((/* implicit */unsigned char) ((((((/* implicit */int) (signed char)-1)) + (2147483647))) << (((((int) arr_1 [i_0 - 2] [i_0 + 1])) - (1)))));
                var_21 = ((/* implicit */unsigned char) max(((~(((/* implicit */int) var_3)))), (((arr_3 [i_1 - 1] [i_1 + 2] [i_1 + 3]) + (max((940268584), (arr_3 [i_0] [i_0] [i_0])))))));
            }
        } 
    } 
}
