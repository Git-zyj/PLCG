...
unsigned long long int var_2 = 12892450163146725506ULL;
unsigned char var_4 = (unsigned char)108;
unsigned short var_5 = (unsigned short)34694;
int var_8 = 677395368;
unsigned char var_9 = (unsigned char)23;
int zero = 0;
short var_11 = (short)26609;
int var_12 = 1776385116;
int var_13 = 571771994;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        for (size_t i_1 = 0; i_1 < 23; ++i_1) 
            arr_5 [i_0] [i_1] = (unsigned short)25632;
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        for (size_t i_1 = 0; i_1 < 23; ++i_1) 
            for (size_t i_2 = 0; i_2 < 23; ++i_2) 
                arr_6 [i_0] [i_1] [i_2] = -918446229;
}
