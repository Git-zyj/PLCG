...
#define min(a,b) \
    ({ __typeof__ (a) _a = (a); \
       ...
       _a < _b ? _a : _b; })
void test() {
    var_13 = ((/* implicit */int) (!(((/* implicit */_Bool) ((var_9) ? (((/* implicit */int) (_Bool)1)) : (((/* implicit */int) (!((_Bool)1)))))))));
    /* LoopNest 2 */
        ...
        {
            {
                ...
                arr_5 [i_0] [i_0] = ((/* implicit */unsigned long long int) ((short) arr_1 [i_0]));
            }
        } 
    } 
    var_14 = ((/* implicit */int) (short)9608);
}
