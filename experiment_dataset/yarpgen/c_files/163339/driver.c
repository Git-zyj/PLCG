...
_Bool var_0 = (_Bool)1;
unsigned int var_1 = 795405438U;
int var_3 = -1820017945;
int var_6 = 1181879724;
_Bool var_9 = (_Bool)0;
short var_12 = (short)-13850;
int zero = 0;
int var_17 = -1061581116;
unsigned char var_18 = (unsigned char)86;
unsigned char var_19 = (unsigned char)203;
short var_20 = (short)10425;
short var_21 = (short)19798;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        arr_6 [i_0] = 2234131289U;
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        for (size_t i_1 = 0; i_1 < 24; ++i_1) 
            for (size_t i_2 = 0; i_2 < 24; ++i_2) 
                arr_7 [i_0] [i_1] [i_2] = 2608567117U;
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        for (size_t i_1 = 0; i_1 < 24; ++i_1) 
            arr_8 [i_0] [i_1] = (unsigned char)119;
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        arr_9 [i_0] = 5164197422754864949ULL;
}
