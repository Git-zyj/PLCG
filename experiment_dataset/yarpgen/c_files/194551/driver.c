...
_Bool var_6 = (_Bool)0;
unsigned int var_7 = 2783541991U;
unsigned int var_8 = 4180519590U;
_Bool var_9 = (_Bool)0;
unsigned int var_11 = 1166535550U;
_Bool var_12 = (_Bool)1;
unsigned long long int var_14 = 1522081260679436718ULL;
int zero = 0;
_Bool var_15 = (_Bool)1;
_Bool var_16 = (_Bool)1;
signed char var_17 = (signed char)-51;
_Bool var_18 = (_Bool)0;
unsigned long long int var_19 = 11918337440782623611ULL;
long long int var_20 = -8698585367798449620LL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            for (size_t i_2 = 0; i_2 < 18; ++i_2) 
                arr_7 [i_0] [i_1] [i_2] = 3336124354U;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        arr_10 [i_0] = (i_0 % 2 == 0) ? (_Bool)1 : (_Bool)0;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        arr_5 [i_0] = (i_0 % 2 == 0) ? (signed char)121 : (signed char)-104;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            for (size_t i_2 = 0; i_2 < 18; ++i_2) 
