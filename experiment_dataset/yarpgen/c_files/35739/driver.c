...
unsigned int var_1 = 2673005625U;
long long int var_3 = 9160317789866175436LL;
unsigned short var_6 = (unsigned short)46441;
_Bool var_11 = (_Bool)1;
int zero = 0;
int var_16 = -536841267;
unsigned char var_17 = (unsigned char)151;
signed char var_18 = (signed char)-23;
signed char var_19 = (signed char)53;
int var_20 = 711639257;
...
void init() {
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        arr_1 [i_0] = -568855989978543242LL;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
