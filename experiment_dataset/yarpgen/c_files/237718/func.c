...
#define min(a,b) \
    ({ __typeof__ (a) _a = (a); \
       ...
       _a < _b ? _a : _b; })
void test() {
    var_13 -= ((/* implicit */long long int) max((var_10), (((/* implicit */signed char) (!(((/* implicit */_Bool) var_1)))))));
    /* LoopNest 3 */
    for (unsigned short i_0 = 0; i_0 < 17; i_0 += 1) 
    {
        for (int i_1 = 3; i_1 < 16; i_1 += 1) 
        {
            ...
            {
                {
                    var_14 = ((/* implicit */unsigned long long int) min((var_14), (((/* implicit */unsigned long long int) arr_1 [i_1]))));
                    var_15 |= ((/* implicit */int) arr_3 [i_1 - 3] [i_1 + 1]);
                }
            } 
        } 
    } 
