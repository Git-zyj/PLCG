...
_Bool var_1 = (_Bool)1;
unsigned int var_2 = 115612222U;
int var_3 = -2054233946;
signed char var_4 = (signed char)-54;
_Bool var_5 = (_Bool)1;
signed char var_6 = (signed char)79;
unsigned long long int var_7 = 4160869224600368373ULL;
unsigned int var_9 = 3296401133U;
unsigned short var_11 = (unsigned short)56711;
unsigned long long int var_14 = 6067446101441545994ULL;
_Bool var_15 = (_Bool)1;
int zero = 0;
unsigned char var_16 = (unsigned char)69;
int var_17 = -1283945016;
unsigned short var_18 = (unsigned short)29235;
        ...
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            for (size_t i_2 = 0; i_2 < 11; ++i_2) 
                for (size_t i_3 = 0; i_3 < 11; ++i_3) 
                    arr_7 [i_0] [i_1] [i_2] [i_3] = 544727318U;
}
