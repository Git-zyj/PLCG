...
void test() {
    ...
    {
        arr_3 [i_0] = ((/* implicit */unsigned short) ((((/* implicit */_Bool) var_3)) ? (((/* implicit */int) (!(((/* implicit */_Bool) 2162102824U))))) : (((/* implicit */int) ((short) var_4)))));
        arr_4 [i_0] [i_0] = ((/* implicit */unsigned char) var_14);
    }
    var_15 = ((/* implicit */unsigned int) 4003135631168076607LL);
