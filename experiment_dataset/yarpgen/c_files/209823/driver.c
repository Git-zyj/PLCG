...
unsigned short var_1 = (unsigned short)13595;
unsigned long long int var_2 = 8899161985999192900ULL;
unsigned long long int var_4 = 8547200331594466613ULL;
_Bool var_6 = (_Bool)0;
signed char var_7 = (signed char)-74;
short var_8 = (short)11089;
int zero = 0;
unsigned char var_11 = (unsigned char)201;
int var_12 = 2079649262;
unsigned short var_13 = (unsigned short)21001;
_Bool arr_2 [21] ;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 21; ++i_0) 
        arr_7 [i_0] = 9707882780504770142ULL;
}
