...
unsigned int var_2 = 1495282684U;
unsigned char var_3 = (unsigned char)207;
int var_4 = -1503163946;
signed char var_7 = (signed char)-125;
signed char var_8 = (signed char)98;
long long int var_9 = 5046167841704764685LL;
short var_10 = (short)-11504;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
            arr_4 [i_0] [i_1] = 16072728347644344684ULL;
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
    ...
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
            for (size_t i_2 = 0; i_2 < 25; ++i_2) 
                arr_10 [i_0] [i_1] [i_2] = 11055017509666902127ULL;
}
