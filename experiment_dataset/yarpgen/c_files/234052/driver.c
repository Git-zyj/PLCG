...
unsigned int var_3 = 815398895U;
int var_6 = 1348725695;
_Bool var_7 = (_Bool)1;
_Bool var_10 = (_Bool)1;
int zero = 0;
signed char var_11 = (signed char)-92;
unsigned int var_12 = 3591707156U;
unsigned char var_13 = (unsigned char)73;
unsigned long long int var_14 = 16039464089547648455ULL;
...
void init() {
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            arr_1 [i_0] [i_1] = (short)3694;
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        arr_3 [i_0] = -633402673;
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        for (size_t i_1 = 0; i_1 < 13; ++i_1) 
            arr_4 [i_0] [i_1] = 3114077708U;
}
