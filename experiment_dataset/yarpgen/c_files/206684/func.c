...
void test() {
    ...
    {
        arr_3 [i_0] = ((-1274263290) == (((/* implicit */int) (short)-17949)));
        arr_4 [i_0] [i_0] = ((/* implicit */unsigned short) 1274263266);
        arr_5 [i_0] = ((/* implicit */signed char) 1274263292);
        arr_6 [i_0] = ((/* implicit */long long int) -1274263285);
    }
}
