...
void test() {
    ...
    for (int i_0 = 0; i_0 < 14;i_0 += 1)
    {
        ...
        arr_3 [i_0] = ((!(((-((min(28747, (arr_1 [i_0] [i_0])))))))));
        arr_4 [i_0] [i_0] = ((~(((arr_0 [i_0] [i_0]) ? 547804159 : (arr_0 [i_0] [i_0])))));
        arr_5 [i_0] = (((arr_0 [i_0] [i_0]) ? (((((arr_0 [i_0] [i_0]) || (arr_0 [i_0] [i_0]))))) : (arr_1 [i_0] [i_0])));
    }
    var_20 = ((var_3 ? (!var_12) : var_18));
    #pragma endscop
}
