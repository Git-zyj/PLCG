...
short var_0 = (short)-29775;
short var_2 = (short)-18835;
unsigned short var_3 = (unsigned short)32203;
unsigned short var_8 = (unsigned short)25969;
short var_11 = (short)-31204;
int zero = 0;
long long int var_13 = -2413109019650993681LL;
signed char var_14 = (signed char)39;
int var_15 = 1453606863;
...
void init() {
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        arr_0 [i_0] = (_Bool)0;
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        arr_1 [i_0] = 4320019692150782328LL;
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        arr_3 [i_0] = (_Bool)0;
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
