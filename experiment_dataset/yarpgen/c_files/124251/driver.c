...
unsigned short var_3 = (unsigned short)25501;
short var_4 = (short)5712;
int var_6 = 964937125;
unsigned char var_7 = (unsigned char)84;
signed char var_9 = (signed char)-8;
int zero = 0;
int var_10 = -1793096003;
signed char var_11 = (signed char)21;
_Bool var_12 = (_Bool)0;
unsigned int var_13 = 3201483414U;
unsigned short var_14 = (unsigned short)32739;
unsigned long long int var_15 = 5552848396168390297ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
        for (size_t i_1 = 0; i_1 < 15; ++i_1) 
            arr_2 [i_0] [i_1] = 7800406611528050285LL;
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
        for (size_t i_1 = 0; i_1 < 15; ++i_1) 
            for (size_t i_2 = 0; i_2 < 15; ++i_2) 
                for (size_t i_3 = 0; i_3 < 15; ++i_3) 
    ...
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
        for (size_t i_1 = 0; i_1 < 15; ++i_1) 
            arr_9 [i_0] [i_1] = (i_1 % 2 == 0) ? 1502265253 : 1112222067;
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
        arr_10 [i_0] = 1309096058U;
}
