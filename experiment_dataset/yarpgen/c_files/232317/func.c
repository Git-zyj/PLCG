...
void test() {
    ...
    for (short i_0 = 0; i_0 < 14; i_0 += 4) 
    {
        for (int i_1 = 0; i_1 < 14; i_1 += 4) 
        {
            ...
            {
                {
                    arr_8 [i_0] [i_0] [i_2] = ((/* implicit */unsigned int) arr_4 [i_0]);
                    var_15 = ((/* implicit */int) (-(max((((/* implicit */unsigned int) ((((/* implicit */_Bool) var_1)) ? (((/* implicit */int) var_9)) : (((/* implicit */int) (signed char)-14))))), (var_4)))));
                }
            } 
        } 
    } 
    var_16 -= ((/* implicit */short) max((var_12), (((/* implicit */unsigned long long int) var_10))));
}
