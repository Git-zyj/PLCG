...
unsigned short var_9 = (unsigned short)28652;
int var_10 = -339856326;
long long int var_11 = -5128916725262158396LL;
int zero = 0;
unsigned short var_14 = (unsigned short)50764;
unsigned short var_15 = (unsigned short)1376;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            arr_6 [i_0] [i_1] = 9927484091067979882ULL;
}
