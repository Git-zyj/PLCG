...
short var_0 = (short)19181;
unsigned int var_9 = 3411699522U;
_Bool var_12 = (_Bool)0;
signed char var_14 = (signed char)-6;
int zero = 0;
unsigned long long int var_19 = 11746249787357165207ULL;
short var_20 = (short)24810;
unsigned char var_21 = (unsigned char)194;
unsigned long long int var_22 = 17911541170025201589ULL;
int var_23 = -61117636;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
            arr_1 [i_0] [i_1] = 17665191231598942346ULL;
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        arr_2 [i_0] = (_Bool)0;
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
