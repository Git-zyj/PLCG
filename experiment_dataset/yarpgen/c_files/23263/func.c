...
void test() {
    ...
    for (unsigned long long int i_0 = 0; i_0 < 23; i_0 += 4) 
    {
        ...
        {
            {
                var_14 = ((/* implicit */unsigned int) ((((/* implicit */_Bool) (unsigned short)8)) ? (3407463508098834970ULL) : (15039280565610716646ULL)));
                var_15 = ((/* implicit */long long int) min((4611686018427387904ULL), (3407463508098834969ULL)));
            }
        } 
    } 
}
