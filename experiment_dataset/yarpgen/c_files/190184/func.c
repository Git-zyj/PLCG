...
void test() {
    ...
    for (int i_0 = 0; i_0 < 24; i_0 += 3) 
    {
        ...
        {
            {
                var_20 |= ((/* implicit */int) ((arr_1 [i_0] [i_1]) <= ((+(1795505591)))));
                var_21 |= arr_2 [i_1] [7] [i_1];
                var_22 = ((/* implicit */int) min((var_22), (arr_2 [i_0] [i_0] [i_0])));
            }
        } 
    } 
    var_23 = var_8;
    ...
    for (int i_2 = 0; i_2 < 20; i_2 += 1) /* same iter space */
    {
        ...
        var_25 = ((/* implicit */int) (!(((/* implicit */_Bool) (+(arr_5 [i_2]))))));
    }
    for (int i_3 = 0; i_3 < 20; i_3 += 1) /* same iter space */
    {
        ...
        for (int i_4 = 0; i_4 < 20; i_4 += 4) 
        {
            ...
            {
                {
                    var_26 = max((var_13), ((~(((int) var_17)))));
                    var_27 = ((/* implicit */int) ((((/* implicit */_Bool) ((max((var_17), (arr_4 [5]))) & (((int) arr_2 [i_5] [1] [i_3]))))) && (((/* implicit */_Bool) ((((var_13) > (var_11))) ? (((/* implicit */int) ((((/* implicit */_Bool) var_5)) && (((/* implicit */_Bool) arr_1 [i_3] [i_5]))))) : (arr_4 [i_4]))))));
                }
            } 
        } 
        var_28 ^= var_19;
            ...
            {
                {
                    ...
                    var_30 = ((/* implicit */int) (!(((/* implicit */_Bool) max((var_15), (arr_17 [i_7] [i_7 + 3] [i_7 + 3] [i_7 + 3]))))));
                }
            } 
        } 
    }
