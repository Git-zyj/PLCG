...
unsigned int var_0 = 2131340466U;
...
int zero = 0;
long long int var_18 = 1000128953740920760LL;
unsigned short var_19 = (unsigned short)58290;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
        arr_8 [i_0] = (i_0 % 2 == 0) ? 509212153507594664ULL : 18252568759290720552ULL;
}
