...
short var_2 = (short)21953;
_Bool var_4 = (_Bool)1;
_Bool var_5 = (_Bool)1;
_Bool var_6 = (_Bool)1;
short var_7 = (short)29910;
...
unsigned long long int var_17 = 12678124790251900797ULL;
short var_18 = (short)17857;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 17; ++i_0) 
        for (size_t i_1 = 0; i_1 < 17; ++i_1) 
            for (size_t i_2 = 0; i_2 < 17; ++i_2) 
                arr_9 [i_0] [i_1] [i_2] = 17099268723096180700ULL;
}
