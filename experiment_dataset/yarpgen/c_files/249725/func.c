...
void test() {
    ...
    {
        var_18 = ((/* implicit */unsigned long long int) min((77066710U), (((/* implicit */unsigned int) (short)18775))));
        arr_3 [i_0] = ((/* implicit */unsigned int) (_Bool)1);
        var_19 = ((/* implicit */unsigned long long int) (~(((/* implicit */int) ((((/* implicit */_Bool) (-(-1079416850)))) && (var_12))))));
    }
}
