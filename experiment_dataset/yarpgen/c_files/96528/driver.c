...
_Bool var_0 = (_Bool)1;
unsigned long long int var_3 = 3697599836714999197ULL;
signed char var_4 = (signed char)-56;
unsigned char var_8 = (unsigned char)84;
signed char var_9 = (signed char)50;
_Bool var_11 = (_Bool)1;
int zero = 0;
short var_13 = (short)-28847;
unsigned int var_14 = 2310776756U;
short var_15 = (short)31141;
...
void init() {
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        for (size_t i_1 = 0; i_1 < 14; ++i_1) 
            arr_0 [i_0] [i_1] = -4287325342503516797LL;
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
