...
unsigned int var_2 = 3563410933U;
signed char var_11 = (signed char)105;
signed char var_17 = (signed char)30;
int zero = 0;
unsigned char var_18 = (unsigned char)5;
int var_19 = 2103280847;
int var_20 = -1399883761;
long long int var_21 = 2411526429872970299LL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        arr_3 [i_0] = 1025521240;
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        for (size_t i_1 = 0; i_1 < 24; ++i_1) 
            arr_4 [i_0] [i_1] = (unsigned char)116;
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        for (size_t i_1 = 0; i_1 < 24; ++i_1) 
            arr_7 [i_0] [i_1] = 7504281896148953806LL;
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        for (size_t i_1 = 0; i_1 < 24; ++i_1) 
