...
short var_5 = (short)18596;
signed char var_6 = (signed char)-93;
long long int var_7 = -994450039394999790LL;
int zero = 0;
_Bool var_12 = (_Bool)0;
unsigned int var_13 = 1627547708U;
short var_14 = (short)7497;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
            for (size_t i_2 = 0; i_2 < 10; ++i_2) 
                arr_10 [i_0] [i_1] [i_2] = (i_2 % 2 == 0) ? 2871022261U : 1948159957U;
}
