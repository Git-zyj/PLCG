...
int var_4 = -2081975157;
unsigned char var_5 = (unsigned char)184;
int var_6 = 994571280;
unsigned char var_8 = (unsigned char)39;
signed char var_10 = (signed char)114;
_Bool var_11 = (_Bool)0;
int var_12 = -263871408;
int var_13 = 1648465775;
unsigned short var_14 = (unsigned short)10199;
int var_15 = 1683216932;
short var_18 = (short)21289;
int var_19 = 814818912;
int zero = 0;
int var_20 = 1826415279;
_Bool var_21 = (_Bool)0;
unsigned int var_22 = 4175899642U;
...
void init() {
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
            arr_0 [i_0] [i_1] = (unsigned short)64880;
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
