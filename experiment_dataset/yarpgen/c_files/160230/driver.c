...
unsigned int var_2 = 2437883603U;
unsigned int var_4 = 1270573439U;
signed char var_5 = (signed char)-81;
short var_6 = (short)-8959;
short var_17 = (short)-24795;
int zero = 0;
short var_19 = (short)-22593;
        ...
        for (size_t i_1 = 0; i_1 < 17; ++i_1) 
            for (size_t i_2 = 0; i_2 < 17; ++i_2) 
                for (size_t i_3 = 0; i_3 < 17; ++i_3) 
                    arr_13 [i_0] [i_1] [i_2] [i_3] = -2497940556343510578LL;
}
