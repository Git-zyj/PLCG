...
int var_0 = 1778913119;
long long int var_1 = 7160067319688312776LL;
unsigned int var_2 = 4034439800U;
unsigned int var_3 = 2005763812U;
unsigned char var_6 = (unsigned char)235;
unsigned char var_8 = (unsigned char)123;
int zero = 0;
unsigned char var_11 = (unsigned char)54;
int var_12 = 185881847;
int var_13 = 307270267;
int arr_0 [22] ;
int arr_5 [22] [22] [22] ;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        arr_8 [i_0] = (unsigned short)17448;
}
