...
void test() {
    ...
    {
        var_12 = ((/* implicit */long long int) (-(((/* implicit */int) (!((!(((/* implicit */_Bool) (signed char)(-127 - 1))))))))));
        var_13 = ((/* implicit */signed char) (+(((((/* implicit */_Bool) (signed char)(-127 - 1))) ? (((/* implicit */unsigned long long int) ((/* implicit */int) (!(((/* implicit */_Bool) arr_1 [i_0])))))) : (((((/* implicit */_Bool) arr_0 [i_0])) ? (((/* implicit */unsigned long long int) var_7)) : (arr_1 [i_0])))))));
    }
}
