...
unsigned long long int var_0 = 14897373729726174642ULL;
...
int zero = 0;
unsigned int var_13 = 227458654U;
unsigned short var_14 = (unsigned short)52076;
unsigned short var_15 = (unsigned short)61766;
unsigned long long int arr_1 [10] ;
_Bool arr_6 [10] [10] ;
void init() {
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        arr_1 [i_0] = 8173206523682564865ULL;
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
