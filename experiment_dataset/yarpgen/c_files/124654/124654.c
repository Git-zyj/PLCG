                        ...
                        {
                            {
                                ...
                                arr_14 [i_0] [i_3 - 2] [i_2] = (((min((arr_11 [i_1] [i_1] [i_2 - 2] [i_2 - 3] [i_3 + 2]), (arr_11 [i_0] [i_2 + 2] [i_2 - 2] [i_2 - 2] [i_3 + 2])))) ? ((~(arr_11 [i_0] [i_0] [i_2 - 2] [i_2 - 2] [i_3 + 2]))) : (((arr_9 [i_1] [i_2 + 3] [i_2 - 2] [i_3 - 2] [i_3 + 2] [i_3 + 3]) ? (arr_10 [i_0] [i_0] [i_2 - 2] [i_2 - 3] [i_3 + 2] [i_3 + 3]) : var_6)));
                                var_19 = 151271042;
                                arr_15 [0] [0] [i_2 + 3] [0] [i_3 - 1] [i_0] = (!-151271039);
                            }
                        }
                    }
                }
