        ...
        {
            {
                ...
                for (int i_2 = 0; i_2 < 17;i_2 += 1)
                {
                    ...
                    for (int i_3 = 0; i_3 < 17;i_3 += 1)
                    {
                        for (int i_4 = 1; i_4 < 16;i_4 += 1)
                        {
                            {
                                var_21 = arr_6 [i_0];
                                arr_12 [i_0] [i_1] [i_1] [2] = ((((1293663123 | (arr_8 [i_1] [i_4] [i_4] [i_4] [i_4 - 1]))) == ((min((arr_4 [i_1 - 1] [i_1] [i_4]), var_6)))));
                                var_22 = var_3;
                                arr_13 [i_4] [i_1] [i_2] [i_1] [8] = (1293663122 << (((-1161084988 + 1161085006) - 18)));
                            }
                        }
                    }
                    var_23 += ((var_7 * (790682343 == -1293663108)));
                ...
                for (int i_5 = 1; i_5 < 15;i_5 += 1)
                {
                    ...
                    arr_18 [14] [i_1] [i_0] [i_5] &= (min(1955865821, (min((arr_7 [i_0] [i_0] [i_0] [i_5 + 2]), var_17))));
                ...
                for (int i_6 = 0; i_6 < 17;i_6 += 1)
                {
                    ...
                    arr_22 [i_1] = min((((~986050647) ? ((((arr_4 [i_0] [i_1] [15]) < 1293663123))) : (((arr_15 [i_1] [i_1 + 1] [i_1]) - var_15)))), (min(-1293663123, ((var_16 << (((arr_17 [i_0] [12]) - 1085319859)))))));
                }
                for (int i_7 = 0; i_7 < 17;i_7 += 1)
                {
                    ...
                    for (int i_8 = 3; i_8 < 16;i_8 += 1)
                    {
                        ...
                        var_26 = var_12;
                        arr_30 [i_1] [i_1 - 1] [i_1 - 1] [i_0 - 2] [i_1] = (+(((((-762270971 ? (arr_10 [i_0] [i_1] [i_1] [i_7] [i_7] [i_8]) : (arr_16 [i_0])))) ? (arr_20 [i_0 + 1]) : -10)));
                    }
                    var_27 = min(((var_17 ? 1293663129 : (arr_24 [i_7] [i_0 - 1] [i_7]))), var_6);
                }
            }
        }
    }
