...
void test() {
    ...
    for (short i_0 = 0; i_0 < 12; i_0 += 4) 
    {
        ...
        {
            {
                var_11 = ((/* implicit */unsigned short) ((unsigned int) ((((/* implicit */unsigned int) ((/* implicit */int) (unsigned short)44242))) ^ ((-(var_0))))));
                var_12 = ((unsigned int) (+(((/* implicit */int) arr_2 [i_0] [i_0]))));
            }
        } 
    } 
}
