...
unsigned long long int var_3 = 9494212711474126105ULL;
int var_4 = -867655062;
unsigned int var_5 = 2913410700U;
int zero = 0;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        for (size_t i_1 = 0; i_1 < 13; ++i_1) 
            arr_5 [i_0] [i_1] = (i_0 % 2 == 0) ? (signed char)98 : (signed char)75;
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        arr_6 [i_0] = (i_0 % 2 == 0) ? -1805064864 : -1752861930;
}
