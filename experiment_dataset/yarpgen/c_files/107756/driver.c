...
unsigned short var_0 = (unsigned short)23866;
unsigned char var_1 = (unsigned char)90;
unsigned int var_5 = 3939263638U;
unsigned short var_6 = (unsigned short)15350;
signed char var_12 = (signed char)-124;
int zero = 0;
unsigned char var_15 = (unsigned char)184;
int var_16 = 1921306396;
unsigned short var_17 = (unsigned short)11223;
_Bool var_18 = (_Bool)1;
long long int var_19 = 3072982126020864288LL;
