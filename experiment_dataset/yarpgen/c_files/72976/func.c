...
void test() {
    ...
    {
        arr_3 [i_0] [i_0] = ((/* implicit */unsigned short) (-((~(208707446)))));
        var_13 ^= ((/* implicit */short) ((((/* implicit */_Bool) ((((/* implicit */_Bool) (unsigned char)142)) ? (((/* implicit */int) (unsigned short)34435)) : (2147483647)))) ? (((/* implicit */int) var_10)) : (arr_2 [i_0])));
    }
