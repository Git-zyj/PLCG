...
int zero = 0;
int var_10 = 1216522542;
unsigned long long int var_11 = 3781541220010070384ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        arr_2 [i_0] = (i_0 % 2 == 0) ? 1599200395U : 2964181290U;
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        arr_5 [i_0] = (i_0 % 2 == 0) ? (short)-2423 : (short)-13159;
}
