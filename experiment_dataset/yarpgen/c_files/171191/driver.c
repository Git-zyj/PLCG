...
unsigned short var_8 = (unsigned short)13304;
signed char var_13 = (signed char)-117;
int var_15 = 1589946657;
int zero = 0;
unsigned char var_16 = (unsigned char)240;
signed char var_17 = (signed char)20;
int var_18 = -1859248004;
long long int var_19 = -4985595769435953502LL;
short var_20 = (short)-21960;
    ...
    for (size_t i_0 = 0; i_0 < 21; ++i_0) 
        for (size_t i_1 = 0; i_1 < 21; ++i_1) 
            for (size_t i_2 = 0; i_2 < 21; ++i_2) 
                arr_5 [i_0] [i_1] [i_2] = (unsigned short)31873;
}
