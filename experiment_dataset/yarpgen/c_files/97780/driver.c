...
unsigned int var_1 = 893137629U;
unsigned short var_3 = (unsigned short)10747;
int var_5 = -111037068;
unsigned char var_11 = (unsigned char)213;
int zero = 0;
int var_13 = -1352312614;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        for (size_t i_1 = 0; i_1 < 22; ++i_1) 
            arr_3 [i_0] [i_1] = (unsigned short)18240;
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        arr_4 [i_0] = (unsigned short)44993;
}
