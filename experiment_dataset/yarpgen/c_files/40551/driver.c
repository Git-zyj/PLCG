...
unsigned int var_21 = 3531641984U;
signed char var_22 = (signed char)110;
signed char var_23 = (signed char)74;
_Bool var_24 = (_Bool)0;
unsigned int var_25 = 1041833914U;
int var_26 = 1616480391;
signed char arr_6 [16] [16] ;
long long int arr_7 [16] [16] [16] ;
void init() {
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        for (size_t i_1 = 0; i_1 < 16; ++i_1) 
            arr_6 [i_0] [i_1] = (i_0 % 2 == 0) ? (signed char)47 : (signed char)-24;
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        for (size_t i_1 = 0; i_1 < 16; ++i_1) 
            for (size_t i_2 = 0; i_2 < 16; ++i_2) 
                arr_7 [i_0] [i_1] [i_2] = (i_0 % 2 == 0) ? -605808587044430545LL : 5103583362051896873LL;
}
