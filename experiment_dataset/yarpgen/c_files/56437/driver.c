...
_Bool var_1 = (_Bool)1;
short var_3 = (short)-1550;
_Bool var_4 = (_Bool)0;
_Bool var_11 = (_Bool)0;
unsigned long long int var_12 = 7440103165791420803ULL;
_Bool var_13 = (_Bool)1;
int zero = 0;
signed char var_14 = (signed char)-122;
unsigned char var_15 = (unsigned char)104;
short var_16 = (short)17866;
unsigned long long int var_17 = 17312273083118910146ULL;
unsigned int var_18 = 3616140638U;
unsigned char var_19 = (unsigned char)18;
unsigned long long int var_20 = 8725087989318398730ULL;
_Bool arr_1 [14] ;
            ...
            for (size_t i_2 = 0; i_2 < 14; ++i_2) 
                for (size_t i_3 = 0; i_3 < 14; ++i_3) 
                    for (size_t i_4 = 0; i_4 < 14; ++i_4) 
                        arr_10 [i_0] [i_1] [i_2] [i_3] [i_4] = (unsigned char)114;
}
