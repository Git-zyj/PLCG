...
unsigned short var_0 = (unsigned short)6077;
unsigned int var_1 = 614801769U;
signed char var_4 = (signed char)61;
short var_8 = (short)-30901;
signed char var_9 = (signed char)45;
unsigned short var_10 = (unsigned short)46345;
int zero = 0;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        arr_1 [i_0] = (_Bool)1;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        arr_4 [i_0] = 3332526221U;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            arr_2 [i_0] [i_1] = (signed char)-34;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        arr_5 [i_0] = 2107058703;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            arr_6 [i_0] [i_1] = (unsigned short)16731;
}
