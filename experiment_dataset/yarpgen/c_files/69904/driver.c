...
_Bool var_3 = (_Bool)1;
unsigned long long int var_7 = 3298524292635613908ULL;
unsigned long long int var_8 = 12386027890202455919ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            arr_6 [i_0] [i_1] = (i_0 % 2 == 0) ? (signed char)43 : (signed char)76;
}
