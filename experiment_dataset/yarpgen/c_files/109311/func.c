                    ...
                    {
                        {
                            ...
                            arr_8 [i_1] = ((/* implicit */short) ((((/* implicit */_Bool) ((((/* implicit */_Bool) arr_4 [i_2 - 1] [i_3 + 1] [i_3 + 1] [i_1])) ? (((/* implicit */int) var_5)) : (((/* implicit */int) arr_6 [i_1] [i_3 + 1] [i_2]))))) ? (((/* implicit */int) ((short) 492223639))) : ((-(-492223640)))));
                        }
                    } 
                } 
                arr_9 [i_1] [i_1] = ((/* implicit */signed char) arr_0 [i_1]);
                arr_10 [i_0] [i_1] [i_1 + 2] = ((/* implicit */int) var_7);
            }
        } 
    } 
}
