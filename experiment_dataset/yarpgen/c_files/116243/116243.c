...
void test() {
    #pragma scop
    var_13 = (max(var_13, 17670468722178965164));

    for (int i_0 = 0; i_0 < 10;i_0 += 1)
    {
        var_14 = ((17670468722178965164 ? ((+(min((arr_1 [i_0]), (arr_0 [i_0]))))) : (arr_0 [i_0])));
        arr_4 [i_0] [i_0] = (776275351530586452 == 776275351530586452);
    }
    #pragma endscop
}
