...
unsigned long long int var_0 = 275123775970643486ULL;
unsigned long long int var_3 = 3162739533469519140ULL;
_Bool var_4 = (_Bool)1;
unsigned char var_6 = (unsigned char)18;
unsigned long long int var_7 = 1328998656160746980ULL;
unsigned long long int var_10 = 8877893007091327311ULL;
_Bool var_11 = (_Bool)1;
unsigned long long int var_12 = 16069999410291845599ULL;
unsigned char var_13 = (unsigned char)113;
unsigned char var_14 = (unsigned char)76;
unsigned char var_15 = (unsigned char)238;
int zero = 0;
unsigned long long int var_16 = 7348399210393760436ULL;
_Bool var_17 = (_Bool)0;
unsigned char var_18 = (unsigned char)249;
unsigned char var_19 = (unsigned char)127;
unsigned long long int var_20 = 1827116616070373942ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
            for (size_t i_2 = 0; i_2 < 25; ++i_2) 
                arr_6 [i_0] [i_1] [i_2] = 11711302121968997517ULL;
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
            arr_7 [i_0] [i_1] = 253785124474859865ULL;
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
            for (size_t i_2 = 0; i_2 < 25; ++i_2) 
                for (size_t i_3 = 0; i_3 < 25; ++i_3) 
                    for (size_t i_4 = 0; i_4 < 25; ++i_4) 
                        arr_8 [i_0] [i_1] [i_2] [i_3] [i_4] = 230353963752956846ULL;
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
            arr_9 [i_0] [i_1] = 7147732322260366541ULL;
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
            for (size_t i_2 = 0; i_2 < 25; ++i_2) 
                for (size_t i_3 = 0; i_3 < 25; ++i_3) 
                    for (size_t i_4 = 0; i_4 < 25; ++i_4) 
                        arr_10 [i_0] [i_1] [i_2] [i_3] [i_4] = 6871963489156805993ULL;
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
            for (size_t i_2 = 0; i_2 < 25; ++i_2) 
    ...
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
            arr_19 [i_0] [i_1] = 4297426885124271459ULL;
}
