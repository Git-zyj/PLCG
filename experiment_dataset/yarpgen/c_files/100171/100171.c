...
void test() {
    ...
    for (int i_0 = 0; i_0 < 19;i_0 += 1)
    {
        ...
        {
            {
                arr_5 [i_0] [i_0] [17] = (~((255 ? (arr_4 [i_1 - 2] [i_1 - 4] [i_0]) : (arr_4 [i_1 - 2] [i_1 - 4] [i_1]))));
                arr_6 [i_1] [i_1] [i_0] = (var_12 ? (17019294979142249799 / 6768930179021123938) : (~9025552454625092356));
            }
        }
    }
    #pragma endscop
