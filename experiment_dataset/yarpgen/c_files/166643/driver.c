...
int zero = 0;
unsigned long long int var_16 = 10139762613075050511ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
        arr_4 [i_0] = (i_0 % 2 == 0) ? (unsigned char)48 : (unsigned char)57;
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
        arr_5 [i_0] = (i_0 % 2 == 0) ? (unsigned short)45486 : (unsigned short)3515;
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        for (size_t i_1 = 0; i_1 < 23; ++i_1) 
    ...
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        arr_15 [i_0] = 16125165125548381051ULL;
}
