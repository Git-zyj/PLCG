...
int var_5 = -1026334398;
int var_13 = -1495572189;
_Bool var_15 = (_Bool)1;
unsigned long long int var_17 = 13564182581861203328ULL;
int zero = 0;
int var_18 = 501800991;
unsigned short var_19 = (unsigned short)15620;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        arr_5 [i_0] = 16285687182985775367ULL;
}
