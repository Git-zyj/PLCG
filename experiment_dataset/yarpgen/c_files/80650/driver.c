...
short var_1 = (short)-21422;
long long int var_2 = -8237609351340890822LL;
short var_3 = (short)24423;
unsigned char var_5 = (unsigned char)236;
long long int var_6 = 2122650232168313602LL;
int var_7 = -1671287961;
signed char var_8 = (signed char)10;
int var_9 = 1536676424;
unsigned char var_10 = (unsigned char)207;
int var_11 = -736689416;
int zero = 0;
short var_14 = (short)-30176;
int var_15 = -778153599;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        for (size_t i_1 = 0; i_1 < 16; ++i_1) 
            for (size_t i_2 = 0; i_2 < 16; ++i_2) 
                arr_5 [i_0] [i_1] [i_2] = 1317363907442808986ULL;
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        for (size_t i_1 = 0; i_1 < 16; ++i_1) 
            for (size_t i_2 = 0; i_2 < 16; ++i_2) 
