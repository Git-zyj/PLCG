...
unsigned short var_2 = (unsigned short)20505;
unsigned int var_5 = 2649518093U;
unsigned short var_7 = (unsigned short)31521;
int zero = 0;
int var_11 = 1275777287;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        for (size_t i_1 = 0; i_1 < 22; ++i_1) 
            arr_1 [i_0] [i_1] = (short)16961;
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        arr_2 [i_0] = 15255898070241778389ULL;
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
