        ...
        {
            {
                ...
                for (int i_2 = 0; i_2 < 22;i_2 += 1)
                {
                    ...
                    {
                        {
                            var_14 = ((((arr_5 [i_0] [i_3]) != 322494885)) ? ((((var_6 - var_0) < ((((arr_2 [i_0]) >= (arr_2 [i_0]))))))) : var_3);
                            var_15 = (((((~var_9) ? ((var_4 ? var_2 : 0)) : ((-1875310483 ? var_9 : -2107106956))))) ? (arr_9 [i_0] [i_1] [i_2] [i_3]) : (((arr_1 [i_3]) + ((14 ? 16383 : -909290206)))));
                        }
                    }
                }
            }
