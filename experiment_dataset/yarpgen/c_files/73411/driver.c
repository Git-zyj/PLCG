...
int zero = 0;
unsigned int var_11 = 2056892164U;
unsigned char var_12 = (unsigned char)190;
unsigned long long int var_13 = 14473412283500712188ULL;
unsigned char var_14 = (unsigned char)200;
unsigned long long int var_15 = 9815304713209767222ULL;
long long int arr_1 [16] ;
unsigned char arr_3 [16] [16] [16] ;
void init() {
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        arr_1 [i_0] = -8274238965861425808LL;
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
