...
unsigned long long int var_11 = 14934712472358901039ULL;
signed char var_12 = (signed char)125;
int zero = 0;
unsigned short var_13 = (unsigned short)24117;
signed char var_14 = (signed char)49;
short var_15 = (short)12951;
short arr_0 [17] ;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 17; ++i_0) 
        arr_4 [i_0] = 10139320013176355169ULL;
    for (size_t i_0 = 0; i_0 < 17; ++i_0) 
        for (size_t i_1 = 0; i_1 < 17; ++i_1) 
