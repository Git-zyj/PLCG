...
#define min(a,b) \
    ({ __typeof__ (a) _a = (a); \
       ...
       _a < _b ? _a : _b; })
void test() {
    var_13 = ((/* implicit */short) ((((/* implicit */_Bool) (~(((/* implicit */int) (unsigned char)255))))) ? (((/* implicit */int) var_8)) : ((~(((/* implicit */int) (!(((/* implicit */_Bool) (unsigned char)98)))))))));
    /* LoopNest 2 */
    for (long long int i_0 = 0; i_0 < 13; i_0 += 4) 
    {
        ...
        {
            {
                arr_7 [i_1] [i_1] = ((/* implicit */unsigned char) var_3);
                var_14 = (+(((/* implicit */int) (!(((/* implicit */_Bool) (+(((/* implicit */int) (unsigned char)151)))))))));
            }
        } 
    } 
