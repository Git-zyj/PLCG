...
long long int var_4 = 6069460211201794002LL;
long long int var_5 = -789160677965603100LL;
_Bool var_6 = (_Bool)0;
unsigned int var_7 = 1770101650U;
int zero = 0;
short var_11 = (short)2487;
unsigned short var_12 = (unsigned short)23569;
unsigned char var_13 = (unsigned char)169;
unsigned short var_14 = (unsigned short)19536;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
        for (size_t i_1 = 0; i_1 < 15; ++i_1) 
            arr_7 [i_0] [i_1] = -8540003941410647246LL;
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
        for (size_t i_1 = 0; i_1 < 15; ++i_1) 
            for (size_t i_2 = 0; i_2 < 15; ++i_2) 
