...
unsigned int var_3 = 1957553163U;
short var_4 = (short)15027;
signed char var_7 = (signed char)-127;
unsigned short var_8 = (unsigned short)39600;
int var_9 = -2188158;
short var_10 = (short)10568;
unsigned char var_11 = (unsigned char)217;
unsigned long long int var_12 = 14660265170164366560ULL;
int zero = 0;
unsigned int var_13 = 723693986U;
unsigned int var_14 = 424865098U;
signed char var_15 = (signed char)-90;
int var_16 = 783693963;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        for (size_t i_1 = 0; i_1 < 12; ++i_1) 
            arr_4 [i_0] [i_1] = (unsigned short)43696;
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        for (size_t i_1 = 0; i_1 < 12; ++i_1) 
            for (size_t i_2 = 0; i_2 < 12; ++i_2) 
    ...
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        for (size_t i_1 = 0; i_1 < 12; ++i_1) 
            for (size_t i_2 = 0; i_2 < 12; ++i_2) 
                for (size_t i_3 = 0; i_3 < 12; ++i_3) 
                    for (size_t i_4 = 0; i_4 < 12; ++i_4) 
                        arr_12 [i_0] [i_1] [i_2] [i_3] [i_4] = 3416159567U;
}
