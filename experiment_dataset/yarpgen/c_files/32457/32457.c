...
void test() {
    ...
    for (int i_0 = 0; i_0 < 23;i_0 += 1)
    {
        ...
        var_17 = (min(var_17, (min((min((arr_1 [i_0]), (min((arr_1 [i_0]), (arr_3 [i_0] [i_0]))))), (arr_1 [i_0])))));

        for (int i_1 = 0; i_1 < 23;i_1 += 1)
        {
            var_18 = (arr_2 [i_0]);
            var_19 = (arr_4 [i_0]);
            var_20 = (min((max((arr_6 [i_0] [i_0]), (arr_6 [i_0] [i_0]))), (arr_6 [i_1] [i_0])));
        }
        /* vectorizable */
        for (int i_2 = 0; i_2 < 23;i_2 += 1)
        {
            arr_10 [i_2] [i_2] [i_0] = (arr_4 [i_0]);
