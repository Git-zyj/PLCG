...
unsigned int var_1 = 2284794189U;
int var_3 = -840273469;
_Bool var_9 = (_Bool)0;
signed char var_11 = (signed char)-28;
unsigned char var_15 = (unsigned char)21;
int zero = 0;
int var_18 = 1152130317;
int var_19 = -1926253957;
...
void init() {
    for (size_t i_0 = 0; i_0 < 21; ++i_0) 
        for (size_t i_1 = 0; i_1 < 21; ++i_1) 
            arr_0 [i_0] [i_1] = (short)2089;
    for (size_t i_0 = 0; i_0 < 21; ++i_0) 
        for (size_t i_1 = 0; i_1 < 21; ++i_1) 
            arr_1 [i_0] [i_1] = 5844115844808832526LL;
    for (size_t i_0 = 0; i_0 < 21; ++i_0) 
        for (size_t i_1 = 0; i_1 < 21; ++i_1) 
            for (size_t i_2 = 0; i_2 < 21; ++i_2) 
                arr_3 [i_0] [i_1] [i_2] = (unsigned char)162;
    for (size_t i_0 = 0; i_0 < 21; ++i_0) 
        arr_9 [i_0] = 231504220454572814LL;
}
