...
short var_10 = (short)-10318;
unsigned char var_12 = (unsigned char)125;
unsigned char var_14 = (unsigned char)73;
_Bool var_15 = (_Bool)1;
int zero = 0;
int var_17 = -2015682988;
long long int var_18 = -7333763599016048601LL;
unsigned short var_19 = (unsigned short)45395;
int var_20 = 1227472985;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            for (size_t i_2 = 0; i_2 < 11; ++i_2) 
                arr_10 [i_0] [i_1] [i_2] = 1238263669858970692LL;
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            for (size_t i_2 = 0; i_2 < 11; ++i_2) 
                for (size_t i_3 = 0; i_3 < 11; ++i_3) 
                    arr_11 [i_0] [i_1] [i_2] [i_3] = 1513294220932764639ULL;
}
