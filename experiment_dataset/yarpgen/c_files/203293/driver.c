...
short var_1 = (short)-14644;
int var_2 = -1390199561;
unsigned char var_6 = (unsigned char)165;
_Bool var_9 = (_Bool)0;
int var_11 = 499246122;
int var_12 = 2062209225;
int var_13 = 470357920;
unsigned char var_16 = (unsigned char)110;
int zero = 0;
_Bool var_18 = (_Bool)1;
unsigned int var_19 = 1621731263U;
int var_20 = 58746174;
unsigned char var_21 = (unsigned char)220;
int var_22 = -441076948;
_Bool var_23 = (_Bool)0;
unsigned int var_24 = 3806505434U;
unsigned long long int var_25 = 5440391778339780458ULL;
...
void init() {
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
            arr_0 [i_0] [i_1] = (unsigned short)56635;
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        arr_1 [i_0] = 3433959911U;
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        arr_2 [i_0] = (_Bool)0;
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
