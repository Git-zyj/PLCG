...
void test() {
    #pragma scop
    var_11 = ((((min(((var_6 ? var_2 : var_2)), ((min(var_2, var_9)))))) ? var_6 : (((-((max(var_5, var_1))))))));
    ...
    for (int i_0 = 2; i_0 < 22;i_0 += 1)
    {
        ...
        {
            {
                arr_4 [i_0] [i_1] = ((((((arr_0 [i_0 + 1]) | (arr_0 [i_0 - 2])))) ? var_1 : (((arr_0 [i_0 - 1]) ^ (((arr_1 [i_0] [i_1]) & (arr_2 [i_0] [i_0] [i_1])))))));
