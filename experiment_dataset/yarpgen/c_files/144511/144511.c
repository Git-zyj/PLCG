        ...
        {
            {
                ...
                var_18 -= ((arr_3 [i_0 + 2] [i_0 + 1] [i_0 - 2]) ? ((+(((arr_4 [10]) ? (arr_1 [1] [1]) : (arr_4 [1]))))) : (arr_3 [i_0] [i_0] [i_0 - 1]));
                var_19 = (max(var_19, (arr_3 [i_1] [i_1] [i_0])));
                /* LoopNest 3 */
                for (int i_2 = 0; i_2 < 0;i_2 += 1)
                {
                    for (int i_3 = 0; i_3 < 1;i_3 += 1)
                    {
                        ...
                        {
                            {
                                var_20 ^= (((-(((arr_8 [i_0] [i_1]) + (arr_12 [i_0] [i_1] [i_4] [16] [i_4] [16] [i_0]))))));
