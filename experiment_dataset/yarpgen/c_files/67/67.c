        ...
        {
            {
                ...
                var_20 = (((((arr_1 [i_0 + 1]) <= ((var_19 ? var_16 : 3019765929)))) || (arr_4 [i_0] [i_0] [11])));
                arr_6 [i_0] [i_0 - 1] [i_0] = ((((((((var_16 >= (arr_1 [3]))))) / (arr_4 [16] [i_1] [i_1]))) % ((((((arr_3 [i_0] [i_0] [i_1]) ^ (arr_0 [i_0] [i_1])))) ? (var_5 <= var_11) : (arr_0 [i_0 + 2] [i_0 + 3])))));
            }
        }
    }
    var_21 -= var_4;
