...
void test() {
    ...
    for (int i_0 = 0; i_0 < 1;i_0 += 1)
    {
        ...
        {
            {
                var_11 = (min((((arr_4 [i_0] [i_0] [i_0]) ^ var_7)), ((~(arr_4 [i_0] [i_0] [i_1])))));
                arr_5 [i_0] [i_0] [i_0] |= (max(((1 ? (arr_3 [i_1 - 2] [i_1 - 1] [i_1 - 1]) : (arr_3 [i_1 - 2] [i_1 - 2] [i_1 - 2]))), ((min((arr_2 [i_1 - 1] [i_1 + 1] [i_1 - 1]), (arr_4 [i_1 - 2] [i_1 + 1] [i_1 - 2]))))));
            }
        }
    }
    #pragma endscop
