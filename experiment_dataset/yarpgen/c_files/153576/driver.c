...
short var_7 = (short)-26434;
short var_9 = (short)18114;
int zero = 0;
unsigned int var_14 = 2942861067U;
unsigned long long int var_15 = 2922603277273726162ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
            for (size_t i_2 = 0; i_2 < 25; ++i_2) 
                arr_7 [i_0] [i_1] [i_2] = (i_0 % 2 == 0) ? 7068337376088175951ULL : 5861255527333265123ULL;
}
