...
void test() {
    ...
    for (int i_0 = 0; i_0 < 15;i_0 += 1)
    {
        ...
        {
            {
                arr_6 [i_0] = (((((arr_3 [i_0] [i_0]) ? ((-(arr_3 [i_0] [i_1]))) : ((var_14 ? var_3 : var_5))))) ? (min((((arr_0 [i_0]) ? (arr_4 [i_0] [i_0]) : 14)), (((arr_0 [i_0]) ? var_1 : (arr_2 [i_0] [1]))))) : ((min(var_3, (min((arr_4 [i_0] [i_1]), (arr_2 [i_0] [i_0])))))));
                arr_7 [i_0] [i_0] = 71;
            }
        }
    }
