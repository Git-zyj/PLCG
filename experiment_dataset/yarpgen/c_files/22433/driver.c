...
short var_0 = (short)20706;
signed char var_1 = (signed char)-5;
unsigned char var_6 = (unsigned char)211;
long long int var_8 = -4824734840691033980LL;
unsigned long long int var_10 = 9020798282738353867ULL;
unsigned char var_16 = (unsigned char)67;
int zero = 0;
unsigned int var_17 = 3725321679U;
    ...
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
        for (size_t i_1 = 0; i_1 < 15; ++i_1) 
            for (size_t i_2 = 0; i_2 < 15; ++i_2) 
                arr_8 [i_0] [i_1] [i_2] = (i_0 % 2 == 0) ? 113855314U : 1979271047U;
}
