...
int var_9 = 374181505;
short var_10 = (short)4340;
unsigned char var_11 = (unsigned char)113;
int zero = 0;
unsigned int var_17 = 2426424807U;
int var_18 = -1800398130;
int var_19 = -1471591424;
int var_20 = 1605177130;
    ...
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        for (size_t i_1 = 0; i_1 < 13; ++i_1) 
            for (size_t i_2 = 0; i_2 < 13; ++i_2) 
                arr_4 [i_0] [i_1] [i_2] = -8290817928217974330LL;
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        arr_6 [i_0] = -1665620175391748083LL;
}
