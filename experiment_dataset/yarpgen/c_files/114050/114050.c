...
void test() {
    #pragma scop
    var_13 = (((((~1) / var_1)) - var_9));
    var_14 = (((var_8 ? ((var_8 ? var_3 : -5246636102287860045) : (((65525 ? 11 : -1)))))));

    for (int i_0 = 0; i_0 < 13;i_0 += 1)
    {
        arr_2 [i_0] = ((-(((arr_1 [i_0]) ? 9 : (arr_0 [i_0])))));
        var_15 = (min(1, 24));
        var_16 = ((4294962014 ? 88 : 127));
    }
    for (int i_1 = 0; i_1 < 1;i_1 += 1)
    {
        ...
        arr_10 [i_1] = ((!((min((arr_3 [i_1]), ((-78 ? (arr_8 [i_1] [i_1]) : -101)))))));
    }
    #pragma endscop
}
