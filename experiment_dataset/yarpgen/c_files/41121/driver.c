...
unsigned short var_0 = (unsigned short)18080;
signed char var_1 = (signed char)114;
signed char var_2 = (signed char)-57;
unsigned int var_3 = 1107333175U;
long long int var_9 = 5991848631883395000LL;
_Bool var_11 = (_Bool)0;
unsigned short var_14 = (unsigned short)25433;
int var_15 = 1000602974;
int zero = 0;
short var_18 = (short)-24466;
unsigned int var_19 = 2159921222U;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        arr_24 [i_0] = (short)-1024;
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        arr_25 [i_0] = -1749153035;
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
