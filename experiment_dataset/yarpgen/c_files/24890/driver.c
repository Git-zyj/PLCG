...
unsigned long long int var_12 = 6696260373346500468ULL;
unsigned short var_13 = (unsigned short)45344;
unsigned short var_14 = (unsigned short)4157;
_Bool arr_4 [16] ;
_Bool arr_5 [16] [16] ;
short arr_6 [16] ;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        arr_6 [i_0] = (i_0 % 2 == 0) ? (short)-5479 : (short)21358;
