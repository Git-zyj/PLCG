...
void test() {
    ...
    for (int i_0 = 1; i_0 < 17; i_0 += 1) 
    {
        ...
        {
            {
                var_11 = ((/* implicit */int) ((-1013841856) < ((-2147483647 - 1))));
                /* LoopSeq 3 */
                for (int i_2 = 0; i_2 < 18; i_2 += 2) 
                {
                    var_12 = (-(max((var_5), (var_0))));
                    arr_8 [i_0] [i_2] = ((((var_9) | (((int) 2013265920)))) / ((-(var_3))));
                }
                for (int i_3 = 0; i_3 < 18; i_3 += 3) 
                {
                    var_13 = ((/* implicit */int) min((var_13), (((/* implicit */int) (!(((/* implicit */_Bool) var_9)))))));
                    var_14 = ((/* implicit */int) max((var_14), (((max((((2013265904) - (691612477))), (min((2097747635), (2013265904))))) | (((853858636) / (-2781321)))))));
                    var_15 = (~(var_10));
                    arr_12 [i_0] [i_1] [i_3] = ((int) ((int) (~(var_4))));
                }
                for (int i_4 = 1; i_4 < 17; i_4 += 2) 
                {
                    ...
                    var_17 ^= var_8;
                    arr_16 [i_0] [i_1] [i_4] = (-(((((/* implicit */_Bool) var_1)) ? (var_4) : (-262415095))));
