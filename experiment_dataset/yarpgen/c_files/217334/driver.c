...
unsigned int var_17 = 26285675U;
int zero = 0;
unsigned char var_20 = (unsigned char)215;
unsigned long long int var_21 = 11144487217426500028ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
        arr_3 [i_0] = (i_0 % 2 == 0) ? 1360296353736366572LL : 1384759804659810408LL;
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
        for (size_t i_1 = 0; i_1 < 19; ++i_1) 
            arr_4 [i_0] [i_1] = (i_1 % 2 == 0) ? (signed char)47 : (signed char)49;
}
