...
void test() {
    ...
    for (signed char i_0 = 2; i_0 < 18; i_0 += 1) 
    {
        ...
        {
            {
                var_21 = ((/* implicit */long long int) (-(((((/* implicit */_Bool) arr_0 [i_0])) ? (arr_0 [i_0]) : (arr_0 [i_0])))));
                var_22 *= ((/* implicit */unsigned long long int) (-(((((/* implicit */int) (unsigned char)230)) << (((735092730) - (735092717)))))));
            }
        } 
    } 
}
