...
unsigned long long int var_3 = 3106071468096850589ULL;
short var_7 = (short)14906;
int zero = 0;
_Bool var_10 = (_Bool)1;
long long int var_11 = 6492781307652460054LL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        for (size_t i_1 = 0; i_1 < 14; ++i_1) 
            arr_7 [i_0] [i_1] = 3011447810U;
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        arr_8 [i_0] = (unsigned short)38743;
}
