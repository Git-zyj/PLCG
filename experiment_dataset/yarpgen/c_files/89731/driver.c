...
long long int var_1 = -5184029986782443066LL;
unsigned char var_3 = (unsigned char)209;
unsigned int var_6 = 3156116492U;
long long int var_11 = -6482781008430650205LL;
int zero = 0;
unsigned char var_13 = (unsigned char)71;
int var_14 = -812781265;
            ...
            for (size_t i_2 = 0; i_2 < 20; ++i_2) 
                for (size_t i_3 = 0; i_3 < 20; ++i_3) 
                    for (size_t i_4 = 0; i_4 < 20; ++i_4) 
                        arr_13 [i_0] [i_1] [i_2] [i_3] [i_4] = (short)32105;
}
