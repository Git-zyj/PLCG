...
int zero = 0;
unsigned short var_18 = (unsigned short)17763;
long long int var_19 = -8439584618752656548LL;
    ...
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
            for (size_t i_2 = 0; i_2 < 10; ++i_2) 
                arr_4 [i_0] [i_1] [i_2] = (i_2 % 2 == 0) ? -1428955075811611121LL : -8428030310537566321LL;
}
