...
long long int var_0 = 6313243582501755450LL;
int var_2 = 881412467;
...
short var_15 = (short)29410;
int zero = 0;
short var_16 = (short)-5627;
unsigned char var_17 = (unsigned char)195;
signed char var_18 = (signed char)-127;
short var_19 = (short)17767;
int var_20 = 1728029991;
unsigned int var_21 = 972521270U;
short var_22 = (short)16586;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
        arr_2 [i_0] = 7622130943815671170ULL;
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
        for (size_t i_1 = 0; i_1 < 15; ++i_1) 
    ...
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
        for (size_t i_1 = 0; i_1 < 15; ++i_1) 
            arr_4 [i_0] [i_1] = -5381424381235740253LL;
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
        for (size_t i_1 = 0; i_1 < 15; ++i_1) 
            arr_10 [i_0] [i_1] = -274310559;
}
