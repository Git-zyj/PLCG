...
int var_2 = -1135052992;
int var_4 = -1056615385;
unsigned char var_7 = (unsigned char)47;
unsigned long long int var_10 = 9782163917628157396ULL;
int var_13 = 1032672451;
int zero = 0;
unsigned char var_15 = (unsigned char)73;
short var_16 = (short)-17849;
    ...
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            for (size_t i_2 = 0; i_2 < 11; ++i_2) 
                arr_2 [i_0] [i_1] [i_2] = 17432259938758584563ULL;
}
