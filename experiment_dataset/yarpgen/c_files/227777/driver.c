...
unsigned long long int var_2 = 8272759423101009813ULL;
long long int var_4 = -454138910423265913LL;
unsigned char var_9 = (unsigned char)56;
short var_10 = (short)-2017;
unsigned int var_11 = 921306405U;
_Bool var_12 = (_Bool)0;
unsigned int var_13 = 3860010815U;
int zero = 0;
unsigned char var_14 = (unsigned char)60;
signed char var_15 = (signed char)-35;
unsigned char var_16 = (unsigned char)13;
_Bool var_17 = (_Bool)0;
unsigned int var_18 = 1304554510U;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            arr_5 [i_0] [i_1] = (unsigned short)13025;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            for (size_t i_2 = 0; i_2 < 20; ++i_2) 
                for (size_t i_3 = 0; i_3 < 20; ++i_3) 
                    arr_8 [i_0] [i_1] [i_2] [i_3] = 14427049587705019116ULL;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        arr_12 [i_0] = (i_0 % 2 == 0) ? 16228420217120466927ULL : 2625467669345044727ULL;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
