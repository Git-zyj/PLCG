...
long long int var_2 = 525016820603218252LL;
signed char var_6 = (signed char)-2;
_Bool var_7 = (_Bool)1;
signed char var_9 = (signed char)-106;
long long int var_10 = 4511402880422375735LL;
unsigned char var_15 = (unsigned char)31;
int zero = 0;
int var_19 = -1911948445;
long long int var_20 = 7677281236447800172LL;
_Bool var_21 = (_Bool)1;
long long int var_22 = -1771191062383232544LL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 17; ++i_0) 
        for (size_t i_1 = 0; i_1 < 17; ++i_1) 
            for (size_t i_2 = 0; i_2 < 17; ++i_2) 
                arr_12 [i_0] [i_1] [i_2] = 2572879282U;
    for (size_t i_0 = 0; i_0 < 17; ++i_0) 
        for (size_t i_1 = 0; i_1 < 17; ++i_1) 
