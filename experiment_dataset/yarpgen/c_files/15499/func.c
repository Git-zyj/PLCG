...
void test() {
    ...
    var_19 -= (-(max((7361496237504550894ULL), (((/* implicit */unsigned long long int) var_0)))));
    /* LoopNest 3 */
            ...
            {
                {
                    ...
                    arr_8 [i_1] [i_2] [i_1] [i_2] = ((/* implicit */unsigned short) min((((/* implicit */unsigned long long int) var_8)), (min((11085247836205000702ULL), (((/* implicit */unsigned long long int) (_Bool)1))))));
                }
            } 
        } 
    } 
