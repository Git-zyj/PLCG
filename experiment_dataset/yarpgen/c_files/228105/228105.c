...
void test() {
    ...
    {
        arr_2 [i_0] [i_0] = (((arr_0 [i_0] [i_0]) << (((((arr_1 [i_0]) + 43)) - 5))));
        /* LoopNest 3 */
        for (int i_1 = 1; i_1 < 19;i_1 += 1)
        {
            for (int i_2 = 2; i_2 < 19;i_2 += 1)
            {
                ...
                {
                    {
                        arr_9 [i_0] &= (((((arr_6 [i_1 - 1] [i_3]) + 2147483647)) >> (((arr_6 [i_1 - 1] [i_1 + 1]) + 1469727647))));
                        var_19 = (((arr_8 [i_0] [i_3]) ? (arr_8 [1] [i_3]) : (arr_8 [i_1] [i_3])));
                    }
                }
            }
        }
        arr_10 [i_0] [i_0] = (((arr_1 [0]) >= (arr_7 [i_0] [i_0] [i_0])));
    }
    var_20 = 65535;
    #pragma endscop
}
