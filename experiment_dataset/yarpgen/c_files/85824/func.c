...
void test() {
    ...
    {
        var_19 = min((((_Bool) arr_0 [i_0] [i_0])), (((min((arr_1 [i_0] [i_0]), (arr_0 [i_0] [i_0]))) && ((_Bool)1))));
        var_20 = ((/* implicit */signed char) ((((/* implicit */_Bool) (-(((/* implicit */int) var_12))))) ? ((~(var_13))) : ((~(((/* implicit */int) arr_0 [i_0] [i_0]))))));
        var_21 &= ((/* implicit */int) (signed char)-24);
    }
    var_22 = var_5;
}
