...
long long int var_3 = 8102153191429984100LL;
unsigned char var_4 = (unsigned char)186;
_Bool var_6 = (_Bool)0;
unsigned short var_9 = (unsigned short)47405;
unsigned char var_14 = (unsigned char)134;
int zero = 0;
int var_15 = -984135988;
long long int var_16 = -4134558774922224168LL;
unsigned int var_17 = 4173188834U;
unsigned short var_18 = (unsigned short)9147;
short var_19 = (short)-27848;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        for (size_t i_1 = 0; i_1 < 24; ++i_1) 
            for (size_t i_2 = 0; i_2 < 24; ++i_2) 
                for (size_t i_3 = 0; i_3 < 24; ++i_3) 
                    arr_7 [i_0] [i_1] [i_2] [i_3] = 308782584;
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        for (size_t i_1 = 0; i_1 < 24; ++i_1) 
