...
int var_2 = 1769427366;
signed char var_3 = (signed char)6;
unsigned char var_4 = (unsigned char)84;
int var_6 = 965068247;
unsigned long long int var_8 = 3201030935352446611ULL;
_Bool var_9 = (_Bool)1;
unsigned long long int var_10 = 6006551316192744306ULL;
int zero = 0;
unsigned long long int var_12 = 13615166635905308051ULL;
short var_13 = (short)-1726;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 21; ++i_0) 
        for (size_t i_1 = 0; i_1 < 21; ++i_1) 
            arr_6 [i_0] [i_1] = 5047828822108435597LL;
}
