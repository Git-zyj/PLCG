...
#define min(a,b) \
    ({ __typeof__ (a) _a = (a); \
       ...
       _a < _b ? _a : _b; })
void test() {
    var_17 = max((((((/* implicit */_Bool) ((var_15) & (var_10)))) ? ((~(var_1))) : ((~(var_0))))), ((~(4921552629206598641ULL))));
    var_18 *= (+(max((var_3), (max((16342242053360311999ULL), (16342242053360311996ULL))))));
    /* LoopNest 2 */
    for (unsigned long long int i_0 = 2; i_0 < 20; i_0 += 3) 
    {
        ...
        {
            {
                var_19 = 16342242053360311996ULL;
                arr_5 [i_0] [i_1] = min((((arr_3 [i_1] [i_1] [8ULL]) | ((-(arr_0 [i_0]))))), (((((/* implicit */_Bool) arr_3 [i_1 + 1] [i_0 + 1] [i_0])) ? (arr_3 [i_1 + 1] [i_0 + 1] [i_0 + 2]) : (arr_3 [i_1 - 3] [i_0 + 1] [i_0]))));
            }
        } 
    } 
    var_20 = var_11;
