...
unsigned long long int var_1 = 13109124860966914820ULL;
unsigned long long int var_4 = 10388477725321736328ULL;
...
int zero = 0;
unsigned long long int var_13 = 2543485699792185965ULL;
int var_14 = -2138734777;
int var_15 = 1440269785;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 17; ++i_0) 
        for (size_t i_1 = 0; i_1 < 17; ++i_1) 
            for (size_t i_2 = 0; i_2 < 17; ++i_2) 
                arr_11 [i_0] [i_1] [i_2] = (unsigned char)21;
}
