...
void test() {
    ...
    for (int i_0 = 0; i_0 < 1;i_0 += 1)
    {
        ...
        {
            {
                var_14 = (min(var_14, (max(((var_4 < (1 > 1))), (min((arr_1 [i_0]), (arr_0 [1])))))));
                var_15 += (min(((((arr_4 [i_0] [i_1]) < 1))), (((arr_4 [i_0] [i_1]) ? 0 : (arr_4 [i_1] [i_0])))));
                var_16 = (min(var_16, (((((min((arr_1 [i_1]), (arr_1 [i_0])))) * ((1 ? (arr_1 [i_0]) : (arr_1 [i_0]))))))));
            }
        }
    }
    var_17 |= min(1, var_4);
