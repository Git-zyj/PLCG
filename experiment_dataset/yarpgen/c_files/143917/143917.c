...
void test() {
    ...
    for (int i_0 = 0; i_0 < 13;i_0 += 1)
    {
        for (int i_1 = 0; i_1 < 13;i_1 += 1)
        {
            ...
            {
                {
                    var_12 += ((((!(((var_9 << (var_6 - 868196657218896993)))))) || var_3));
                    var_13 = (min(var_13, ((min(var_8, ((var_2 ? 1 : 0)))))));
                    var_14 = min((((((max(1, 32767)))) * (min(0, var_1)))), ((max(0, var_10))));
                }
            }
        }
    }
