...
void test() {
    ...
    for (unsigned char i_0 = 0; i_0 < 21; i_0 += 1) 
    {
        ...
        {
            {
                var_14 |= ((/* implicit */long long int) ((((/* implicit */int) (_Bool)1)) ^ (((/* implicit */int) (short)-1))));
                var_15 = ((/* implicit */_Bool) min((var_15), (((/* implicit */_Bool) (~(((/* implicit */int) ((unsigned char) 1018908888U))))))));
            }
        } 
    } 
