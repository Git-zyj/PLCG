...
unsigned short var_3 = (unsigned short)64979;
long long int var_5 = 774778813775529436LL;
unsigned short var_8 = (unsigned short)27781;
signed char var_11 = (signed char)-50;
long long int var_12 = -8596410250265300594LL;
            ...
            for (size_t i_2 = 0; i_2 < 23; ++i_2) 
                for (size_t i_3 = 0; i_3 < 23; ++i_3) 
                    for (size_t i_4 = 0; i_4 < 23; ++i_4) 
                        arr_11 [i_0] [i_1] [i_2] [i_3] [i_4] = (unsigned char)70;
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        arr_12 [i_0] = (unsigned char)78;
}
