...
void test() {
    ...
    for (int i_2 = 0; i_2 < 19;i_2 += 1)
    {
        ...
        {
            arr_15 [i_2] |= (min((arr_14 [i_2]), (arr_11 [i_2])));
            arr_16 [i_3] = (max((max((arr_14 [i_3]), (arr_7 [i_2]))), (max((arr_13 [i_3]), (max((arr_11 [i_2]), (arr_13 [i_3])))))));
            arr_17 [i_3] = (min((arr_11 [i_2]), (arr_10 [i_2])));
            arr_18 [i_2] [i_2] [i_3] &= max((arr_12 [i_2] [i_2] [i_2]), (max((arr_11 [i_2]), (max((arr_14 [i_2]), (arr_12 [i_2] [i_3] [i_2]))))));
        }
