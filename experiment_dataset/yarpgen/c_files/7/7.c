...
void test() {
    ...
    {
        arr_2 [i_0] [i_0] = 2078200668;
        var_21 = (max(var_21, (((max(var_12, (arr_0 [i_0 - 2] [i_0 + 2])))))));
    }
    for (int i_1 = 0; i_1 < 13;i_1 += 1)
    {
        arr_5 [i_1] = ((-(((((-(arr_4 [7] [i_1])))) ? 1 : (var_15 / 1)))));
        arr_6 [i_1] = (((((max((arr_3 [i_1] [i_1]), 2078200666)) * -68)) / (arr_1 [i_1])));
        arr_7 [i_1] = (arr_3 [i_1] [6]);

        for (int i_2 = 0; i_2 < 13;i_2 += 1)
        {
            var_22 = (min((max((arr_3 [i_1] [i_2]), 2216766631)), var_13));
