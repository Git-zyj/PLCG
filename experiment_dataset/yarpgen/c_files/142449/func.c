...
#define min(a,b) \
    ({ __typeof__ (a) _a = (a); \
       ...
       _a < _b ? _a : _b; })
void test() {
    var_11 |= ((/* implicit */long long int) min(((~(((/* implicit */int) var_10)))), ((+(((/* implicit */int) var_10))))));
    var_12 = ((/* implicit */short) max((((int) ((unsigned short) var_0))), (((/* implicit */int) var_0))));
    /* LoopNest 2 */
    for (int i_0 = 2; i_0 < 6; i_0 += 2) 
    {
        ...
        {
            {
                var_13 = ((/* implicit */long long int) (!(((/* implicit */_Bool) ((signed char) arr_6 [i_0] [i_0 - 1] [i_0 + 1])))));
                /* LoopNest 2 */
                for (_Bool i_2 = 0; i_2 < 1; i_2 += 1) 
                {
                    ...
                    {
                        {
                            arr_13 [i_0 + 3] [i_1] [i_1] [i_2] [i_1] [i_3 + 1] = ((/* implicit */long long int) var_1);
