...
_Bool var_5 = (_Bool)0;
int var_7 = -165668051;
int var_8 = 2087041126;
short var_9 = (short)30557;
unsigned long long int var_10 = 15807882056962594550ULL;
int zero = 0;
unsigned short var_14 = (unsigned short)17889;
signed char var_15 = (signed char)-21;
unsigned char var_16 = (unsigned char)92;
int var_17 = -149405743;
    ...
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        for (size_t i_1 = 0; i_1 < 14; ++i_1) 
            for (size_t i_2 = 0; i_2 < 14; ++i_2) 
                arr_4 [i_0] [i_1] [i_2] = 16518033400481233457ULL;
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        for (size_t i_1 = 0; i_1 < 14; ++i_1) 
