            ...
            {
                {
                    ...
                    var_15 = (max((min((-9223372036854775807 - 1), (1484132142 * 53))), (-90 - 90)));
                }
            }
        }
    }
    var_16 = ((((max(9536, ((min(-90, 82)))))) ? ((1 ? var_4 : var_3)) : (49954 <= -1672928847)));
    var_17 = (min(var_9, var_6));
    var_18 &= (((((((var_4 && (-127 - 1)))) % ((49958 ? -116 : var_6)))) / var_9));
    #pragma endscop
}
