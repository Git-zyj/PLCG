...
void test() {
    ...
    {
        var_14 = ((/* implicit */long long int) min((var_14), (((/* implicit */long long int) (short)-21583))));
        var_15 = ((/* implicit */long long int) ((((/* implicit */_Bool) (short)16590)) ? (((/* implicit */int) arr_0 [i_0])) : ((~(((/* implicit */int) arr_0 [i_0]))))));
    }
}
