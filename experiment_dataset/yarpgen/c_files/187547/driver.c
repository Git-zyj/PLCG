...
int var_3 = 1222685925;
unsigned char var_9 = (unsigned char)104;
long long int var_18 = -4639700892758470146LL;
unsigned int var_19 = 3689821256U;
int zero = 0;
unsigned short var_20 = (unsigned short)51679;
long long int var_21 = 2398482180623622119LL;
long long int var_22 = -5544746733779477141LL;
unsigned char var_23 = (unsigned char)21;
unsigned char var_24 = (unsigned char)29;
unsigned long long int var_25 = 1276849936074775566ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            arr_3 [i_0] [i_1] = 2590970106U;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            arr_4 [i_0] [i_1] = (_Bool)0;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            arr_6 [i_0] [i_1] = -680774015;
}
