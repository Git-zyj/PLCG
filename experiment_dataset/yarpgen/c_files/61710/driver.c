...
long long int var_0 = 4794873355474144237LL;
unsigned char var_2 = (unsigned char)111;
unsigned long long int var_4 = 2132492616463398858ULL;
...
long long int var_13 = -1989384624839270118LL;
int arr_1 [23] ;
int arr_4 [23] [23] [23] ;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        for (size_t i_1 = 0; i_1 < 23; ++i_1) 
            arr_9 [i_0] [i_1] = 7647403005351950973LL;
}
