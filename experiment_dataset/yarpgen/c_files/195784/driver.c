...
unsigned short var_16 = (unsigned short)29279;
unsigned char var_17 = (unsigned char)53;
unsigned int var_18 = 1929717753U;
unsigned int arr_0 [18] [18] ;
signed char arr_15 [18] [18] [18] ;
void init() {
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            arr_0 [i_0] [i_1] = 1093905737U;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            for (size_t i_2 = 0; i_2 < 18; ++i_2) 
                arr_15 [i_0] [i_1] [i_2] = (i_2 % 2 == 0) ? (signed char)32 : (signed char)16;
}
