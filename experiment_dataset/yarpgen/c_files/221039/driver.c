...
unsigned int var_10 = 3952069477U;
unsigned char var_13 = (unsigned char)246;
signed char var_16 = (signed char)57;
int zero = 0;
signed char var_20 = (signed char)-70;
short var_21 = (short)1910;
unsigned long long int var_22 = 145912608536801319ULL;
unsigned int var_23 = 4218411071U;
        ...
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
            for (size_t i_2 = 0; i_2 < 25; ++i_2) 
                for (size_t i_3 = 0; i_3 < 25; ++i_3) 
                    arr_7 [i_0] [i_1] [i_2] [i_3] = -252047232;
}
