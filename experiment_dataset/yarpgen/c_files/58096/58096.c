...
void test() {
    #pragma scop
    var_14 ^= (((((var_3 >> ((((var_7 ? var_5 : var_13)) - 1333))))) ? -557600021 : (((!(((var_5 ? var_4 : var_11))))))));
    /* LoopNest 2 */
    for (int i_0 = 0; i_0 < 11;i_0 += 1)
    {
        ...
        {
            {
                var_15 = (min(var_15, 4696622889463700367));
                arr_5 [i_0] [i_1] = (((arr_2 [i_1]) >= ((((var_12 ? 32755 : 1)) % (arr_1 [i_1])))));
            }
        }
    }
    #pragma endscop
