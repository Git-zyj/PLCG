...
unsigned long long int var_0 = 584626241624508494ULL;
signed char var_8 = (signed char)-11;
int zero = 0;
signed char var_14 = (signed char)2;
unsigned short var_15 = (unsigned short)19131;
int var_16 = 1145983999;
        ...
        for (size_t i_1 = 0; i_1 < 23; ++i_1) 
            for (size_t i_2 = 0; i_2 < 23; ++i_2) 
                for (size_t i_3 = 0; i_3 < 23; ++i_3) 
                    arr_4 [i_0] [i_1] [i_2] [i_3] = (unsigned char)136;
}
