...
void test() {
    #pragma scop
    var_16 = (max(var_1, ((var_13 + (var_13 && var_15)))));

    for (int i_0 = 0; i_0 < 15;i_0 += 1)
    {
        var_17 = (min(var_17, (((((((!50405) | (!var_8)))) + (max((~var_2), (1090013214 | 37822))))))));
        arr_2 [i_0] [i_0] = (((((((var_8 == var_12) == (arr_0 [i_0]))))) == ((204 / (9223372036854775803 - 512)))));
    }
    #pragma endscop
}
