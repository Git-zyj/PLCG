...
void test() {
    ...
    for (unsigned char i_0 = 0; i_0 < 14; i_0 += 3) 
    {
        for (unsigned long long int i_1 = 1; i_1 < 13; i_1 += 1) 
        {
            ...
            {
                {
                    var_14 = ((/* implicit */unsigned char) min((var_14), (((/* implicit */unsigned char) arr_4 [i_1 + 1]))));
                    var_15 = ((/* implicit */short) var_1);
                    var_16 = ((/* implicit */unsigned int) min((var_16), (((/* implicit */unsigned int) (unsigned char)26))));
                }
            } 
        } 
    } 
    var_17 = ((/* implicit */unsigned short) (~(((unsigned int) (~(((/* implicit */int) var_0)))))));
}
