...
unsigned long long int var_0 = 9439678614045358424ULL;
short var_3 = (short)-10468;
unsigned int var_5 = 1751292748U;
short var_7 = (short)-28185;
signed char var_9 = (signed char)-115;
unsigned short var_17 = (unsigned short)30576;
int zero = 0;
unsigned char var_18 = (unsigned char)229;
long long int var_19 = 7178073325268481037LL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        for (size_t i_1 = 0; i_1 < 14; ++i_1) 
            arr_2 [i_0] [i_1] = (unsigned short)17590;
}
