...
#define min(a,b) \
    ({ __typeof__ (a) _a = (a); \
       ...
       _a < _b ? _a : _b; })
void test() {
    var_11 = ((/* implicit */signed char) (+(((((/* implicit */_Bool) var_5)) ? (((/* implicit */int) var_4)) : (((/* implicit */int) var_2))))));
    /* LoopNest 2 */
    for (short i_0 = 3; i_0 < 22; i_0 += 1) 
    {
        ...
        {
            {
                var_12 = ((/* implicit */unsigned long long int) (short)32523);
                var_13 = ((/* implicit */unsigned char) 994256317U);
            }
        } 
    } 
}
