...
void test() {
            ...
            {
                {
                    ...
                    var_20 = ((((-631893842 ? 678704378 : var_9)) / (((arr_11 [i_4] [i_3]) ? -1033729553 : var_11))));
                    arr_21 [i_2] [i_2] [i_2] = min(var_9, 639523589);
                    var_21 = (min(var_21, (arr_11 [6] [i_4])));
                }
            }
        }
        var_22 = 631893842;
    ...
    {
        var_23 = -631893843;
        var_24 = max(var_1, (min(16744448, -1033729568)));
        var_25 = (((max((arr_23 [i_7]), (~2147483647)))) ? (arr_24 [i_7]) : -1379918386);
    }
    for (int i_8 = 0; i_8 < 22;i_8 += 1)
    {
            ...
            for (int i_10 = 2; i_10 < 19;i_10 += 1)
            {
                for (int i_11 = 0; i_11 < 22;i_11 += 1)
                {
                    for (int i_12 = 1; i_12 < 21;i_12 += 1)
                    {
                        {
                            var_26 &= var_1;
                            arr_42 [i_10] [i_9] [20] = ((var_12 ? -1895229923 : (~-1010712964)));
                        }
                    }
                }
            }
        ...
        {
            arr_45 [i_8] [i_8] = ((((~(arr_34 [i_8] [i_8] [i_13] [i_8])))) ? (min((arr_40 [i_8] [i_13] [i_13] [2] [i_8]), ((2147483643 + (arr_8 [i_8]))))) : (max((arr_18 [i_13] [i_13] [19]), (1033729575 | 935242696))));
