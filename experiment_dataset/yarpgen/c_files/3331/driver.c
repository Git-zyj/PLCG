...
_Bool var_9 = (_Bool)1;
unsigned short var_13 = (unsigned short)4030;
int zero = 0;
unsigned char var_19 = (unsigned char)91;
unsigned short var_20 = (unsigned short)4795;
int arr_5 [17] [17] ;
int arr_6 [17] [17] [17] ;
...
void init() {
    for (size_t i_0 = 0; i_0 < 17; ++i_0) 
        for (size_t i_1 = 0; i_1 < 17; ++i_1) 
            arr_5 [i_0] [i_1] = -411902983;
    for (size_t i_0 = 0; i_0 < 17; ++i_0) 
        for (size_t i_1 = 0; i_1 < 17; ++i_1) 
            for (size_t i_2 = 0; i_2 < 17; ++i_2) 
                arr_6 [i_0] [i_1] [i_2] = -943053687;
    for (size_t i_0 = 0; i_0 < 17; ++i_0) 
        for (size_t i_1 = 0; i_1 < 17; ++i_1) 
            for (size_t i_2 = 0; i_2 < 17; ++i_2) 
