...
unsigned long long int var_16 = 10713125477348153339ULL;
int zero = 0;
unsigned long long int var_20 = 6281094236426280167ULL;
...
void init() {
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        for (size_t i_1 = 0; i_1 < 14; ++i_1) 
            arr_0 [i_0] [i_1] = 17767267690766729515ULL;
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
