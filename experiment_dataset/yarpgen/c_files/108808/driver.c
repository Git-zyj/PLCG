...
long long int var_16 = -129243796044409162LL;
long long int var_17 = 8236387148530926564LL;
unsigned short arr_1 [11] ;
signed char arr_3 [11] [11] ;
short arr_7 [11] [11] [11] ;
void init() {
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        arr_1 [i_0] = (unsigned short)62243;
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
