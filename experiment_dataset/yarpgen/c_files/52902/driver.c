...
unsigned short var_12 = (unsigned short)44135;
int zero = 0;
signed char var_20 = (signed char)124;
int var_21 = -486708291;
unsigned short var_22 = (unsigned short)34803;
...
void init() {
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        arr_3 [i_0] = 953667913U;
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        arr_5 [i_0] = 781864574761504805ULL;
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
