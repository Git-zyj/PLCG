...
unsigned int var_3 = 4156382160U;
...
unsigned short var_19 = (unsigned short)25858;
signed char var_20 = (signed char)76;
unsigned short var_21 = (unsigned short)30652;
unsigned int var_22 = 3836861844U;
short var_23 = (short)-26026;
short arr_0 [17] ;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 17; ++i_0) 
        for (size_t i_1 = 0; i_1 < 17; ++i_1) 
            arr_4 [i_0] [i_1] = (unsigned short)32421;
    for (size_t i_0 = 0; i_0 < 17; ++i_0) 
        arr_8 [i_0] = (_Bool)0;
    for (size_t i_0 = 0; i_0 < 17; ++i_0) 
        for (size_t i_1 = 0; i_1 < 17; ++i_1) 
