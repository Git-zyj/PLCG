...
void test() {
    ...
    for (long long int i_0 = 0; i_0 < 13; i_0 += 4) 
    {
        ...
        var_11 = ((unsigned short) (~(((/* implicit */int) min(((unsigned short)61346), (((/* implicit */unsigned short) var_0)))))));
    }
    var_12 &= ((/* implicit */unsigned char) ((int) (-(((/* implicit */int) (unsigned char)98)))));
}
