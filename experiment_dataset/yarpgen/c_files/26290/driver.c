...
int var_0 = -459100275;
long long int var_1 = 2836577062660419038LL;
unsigned short var_2 = (unsigned short)43375;
signed char var_6 = (signed char)57;
unsigned short var_7 = (unsigned short)40633;
_Bool var_9 = (_Bool)1;
unsigned int var_10 = 427267519U;
long long int var_13 = 7654259117343522958LL;
short var_15 = (short)-13474;
int zero = 0;
    ...
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        for (size_t i_1 = 0; i_1 < 22; ++i_1) 
            for (size_t i_2 = 0; i_2 < 22; ++i_2) 
                arr_6 [i_0] [i_1] [i_2] = (unsigned short)51328;
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        for (size_t i_1 = 0; i_1 < 22; ++i_1) 
