...
long long int var_0 = 3042123421248560864LL;
unsigned char var_2 = (unsigned char)7;
unsigned char var_4 = (unsigned char)251;
unsigned int var_6 = 2210093262U;
unsigned long long int var_7 = 1320012212032703210ULL;
short var_8 = (short)-18124;
int zero = 0;
    ...
    for (size_t i_0 = 0; i_0 < 24; ++i_0) 
        for (size_t i_1 = 0; i_1 < 24; ++i_1) 
            for (size_t i_2 = 0; i_2 < 24; ++i_2) 
                arr_6 [i_0] [i_1] [i_2] = (i_0 % 2 == 0) ? (short)8836 : (short)23823;
}
