...
unsigned short var_3 = (unsigned short)62371;
_Bool var_4 = (_Bool)0;
unsigned char var_5 = (unsigned char)220;
unsigned short var_6 = (unsigned short)20746;
int var_9 = -978235961;
unsigned int var_10 = 2102335101U;
_Bool var_11 = (_Bool)0;
int zero = 0;
unsigned long long int var_12 = 8845343744341868385ULL;
int var_13 = 1991104158;
_Bool var_14 = (_Bool)1;
_Bool var_15 = (_Bool)0;
signed char var_16 = (signed char)-119;
unsigned long long int var_17 = 8608481576813024297ULL;
            ...
            for (size_t i_2 = 0; i_2 < 11; ++i_2) 
                for (size_t i_3 = 0; i_3 < 11; ++i_3) 
                    for (size_t i_4 = 0; i_4 < 11; ++i_4) 
                        arr_13 [i_0] [i_1] [i_2] [i_3] [i_4] = (i_4 % 2 == 0) ? (unsigned char)111 : (unsigned char)110;
}
