...
unsigned int var_0 = 2557671993U;
unsigned short var_4 = (unsigned short)18774;
int var_9 = 841648732;
int zero = 0;
signed char var_10 = (signed char)40;
int var_11 = 639245599;
unsigned long long int var_12 = 17385988518672709978ULL;
        ...
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            for (size_t i_2 = 0; i_2 < 20; ++i_2) 
                for (size_t i_3 = 0; i_3 < 20; ++i_3) 
                    arr_6 [i_0] [i_1] [i_2] [i_3] = (i_3 % 2 == 0) ? (unsigned char)24 : (unsigned char)203;
}
