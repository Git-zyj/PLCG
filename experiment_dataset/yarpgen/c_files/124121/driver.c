...
unsigned int var_3 = 3131305592U;
_Bool var_10 = (_Bool)1;
int zero = 0;
unsigned long long int var_18 = 8731316779023899360ULL;
unsigned long long int var_19 = 11768912148020972251ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        arr_6 [i_0] = (unsigned short)37712;
}
