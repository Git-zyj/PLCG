...
unsigned int var_9 = 650682112U;
unsigned char var_13 = (unsigned char)12;
int var_16 = 1152226865;
int zero = 0;
unsigned int var_20 = 31579686U;
unsigned char var_21 = (unsigned char)109;
signed char var_22 = (signed char)-36;
long long int var_23 = 3550579154631599501LL;
_Bool arr_0 [16] [16] ;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        arr_2 [i_0] = -7328671706685841427LL;
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        for (size_t i_1 = 0; i_1 < 16; ++i_1) 
