...
unsigned int var_5 = 2455419772U;
unsigned int var_6 = 1860120073U;
signed char var_11 = (signed char)-22;
_Bool var_12 = (_Bool)0;
unsigned int var_13 = 3416521943U;
short var_14 = (short)-25445;
signed char var_15 = (signed char)106;
int zero = 0;
unsigned short var_17 = (unsigned short)12383;
unsigned short var_18 = (unsigned short)10126;
int var_19 = 419286176;
unsigned int var_20 = 2114507603U;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        arr_3 [i_0] = (i_0 % 2 == 0) ? 922462760U : 446748485U;
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        for (size_t i_1 = 0; i_1 < 12; ++i_1) 
            arr_4 [i_0] [i_1] = (i_0 % 2 == 0) ? (_Bool)0 : (_Bool)1;
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        arr_5 [i_0] = (i_0 % 2 == 0) ? (signed char)102 : (signed char)-69;
}
