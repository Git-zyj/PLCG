...
unsigned int var_1 = 3848673881U;
signed char var_2 = (signed char)-107;
long long int var_5 = -4592976023824335415LL;
_Bool var_6 = (_Bool)0;
unsigned char var_8 = (unsigned char)34;
unsigned char var_9 = (unsigned char)44;
unsigned long long int var_10 = 14816953064491567663ULL;
unsigned long long int var_11 = 16069518344864304363ULL;
int zero = 0;
int var_15 = -599559287;
signed char var_16 = (signed char)-108;
long long int var_17 = 8974465549862914184LL;
unsigned char var_18 = (unsigned char)55;
short var_19 = (short)10918;
        ...
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            for (size_t i_2 = 0; i_2 < 11; ++i_2) 
                for (size_t i_3 = 0; i_3 < 11; ++i_3) 
                    arr_6 [i_0] [i_1] [i_2] [i_3] = 6425178781225947857LL;
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            for (size_t i_2 = 0; i_2 < 11; ++i_2) 
                for (size_t i_3 = 0; i_3 < 11; ++i_3) 
                    arr_7 [i_0] [i_1] [i_2] [i_3] = 14350168444995158521ULL;
}
