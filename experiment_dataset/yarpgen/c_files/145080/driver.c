...
long long int var_13 = -4931016229410314145LL;
unsigned char var_15 = (unsigned char)92;
long long int var_16 = -1396300969614508282LL;
int zero = 0;
unsigned int var_20 = 1911818436U;
unsigned long long int var_21 = 13875475615731734179ULL;
_Bool var_22 = (_Bool)0;
unsigned char var_23 = (unsigned char)85;
int var_24 = -838711132;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            for (size_t i_2 = 0; i_2 < 20; ++i_2) 
                for (size_t i_3 = 0; i_3 < 20; ++i_3) 
                    arr_9 [i_0] [i_1] [i_2] [i_3] = (i_1 % 2 == 0) ? (signed char)61 : (signed char)68;
}
