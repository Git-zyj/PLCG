...
void test() {
    ...
    {
        arr_4 [i_0 - 2] = (12288 <= (arr_2 [1] [i_0]));
        var_20 = ((var_16 ? (!12281) : (((arr_2 [i_0] [i_0]) ? (arr_3 [i_0 - 2]) : (arr_0 [i_0 - 2] [i_0 + 1])))));
    }
    var_21 = (min(var_21, ((((var_2 / -1420) ? ((12281 ? (var_2 | var_19) : -var_2)) : var_6)))));
    #pragma endscop
}
