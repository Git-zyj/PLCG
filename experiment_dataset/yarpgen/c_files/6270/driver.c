...
short var_11 = (short)-23111;
_Bool var_12 = (_Bool)1;
signed char var_13 = (signed char)-13;
signed char var_16 = (signed char)-113;
int zero = 0;
int var_19 = 2082974185;
unsigned long long int var_20 = 11345576231803140131ULL;
short var_21 = (short)-16421;
unsigned long long int arr_1 [23] [23] ;
_Bool arr_4 [23] ;
void init() {
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        for (size_t i_1 = 0; i_1 < 23; ++i_1) 
            arr_1 [i_0] [i_1] = 1272138244361617313ULL;
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
