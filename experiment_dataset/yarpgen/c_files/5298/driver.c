...
_Bool var_9 = (_Bool)1;
int zero = 0;
long long int var_10 = -5992024276555373861LL;
signed char var_11 = (signed char)114;
unsigned short var_12 = (unsigned short)53001;
long long int var_13 = 1166841538241713542LL;
long long int var_14 = 300412122959799711LL;
_Bool arr_2 [12] [12] ;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        for (size_t i_1 = 0; i_1 < 12; ++i_1) 
            arr_4 [i_0] [i_1] = (unsigned short)42218;
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        arr_6 [i_0] = (_Bool)0;
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        for (size_t i_1 = 0; i_1 < 12; ++i_1) 
    ...
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        for (size_t i_1 = 0; i_1 < 12; ++i_1) 
            arr_22 [i_0] [i_1] = 2508191724482307652LL;
}
