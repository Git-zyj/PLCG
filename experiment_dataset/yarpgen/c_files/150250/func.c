...
void test() {
    ...
    {
        arr_2 [i_0] [18ULL] = ((/* implicit */unsigned long long int) (!(((/* implicit */_Bool) var_0))));
        var_14 -= ((/* implicit */unsigned int) (((!((_Bool)1))) ? (((/* implicit */int) arr_0 [i_0])) : ((~(((/* implicit */int) arr_0 [i_0]))))));
