...
void test() {
    ...
    for (int i_0 = 0; i_0 < 1;i_0 += 1)
    {
        for (int i_1 = 0; i_1 < 1;i_1 += 1)
        {
            ...
            {
                {
                    arr_9 [i_2] [0] = (arr_1 [i_0]);
                    arr_10 [i_2] [i_1] [i_0] = (min(1, 0));
                }
            }
        }
    }
    var_13 *= (min((((!((min(var_0, 1832569230)))))), (min((!var_11), var_6))));
    var_14 = ((((min(-var_8, var_6))) ? (!1832569205) : (((var_1 >> (var_6 - 4086312657))))));
    #pragma endscop
}
