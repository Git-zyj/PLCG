...
int var_6 = 2031733553;
unsigned short var_12 = (unsigned short)14729;
int zero = 0;
signed char var_13 = (signed char)-64;
int var_14 = 1519547997;
int var_15 = 943455232;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        arr_5 [i_0] = (i_0 % 2 == 0) ? 9071865979508145915LL : 2056917278537617207LL;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            for (size_t i_2 = 0; i_2 < 20; ++i_2) 
                arr_6 [i_0] [i_1] [i_2] = 2788902131U;
}
