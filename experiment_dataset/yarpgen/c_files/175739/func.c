...
void test() {
    ...
    {
        arr_3 [i_0] = ((/* implicit */unsigned char) ((arr_0 [i_0] [i_0]) || (((/* implicit */_Bool) ((((/* implicit */_Bool) arr_1 [i_0] [i_0])) ? (var_2) : (var_11))))));
        var_19 = ((/* implicit */unsigned int) ((unsigned char) ((var_13) > (arr_1 [i_0] [i_0]))));
    }
}
