...
void test() {
    ...
    for (int i_0 = 0; i_0 < 16; i_0 += 3) 
    {
        for (unsigned int i_1 = 1; i_1 < 15; i_1 += 3) 
        {
            ...
            {
                {
                    var_11 -= ((/* implicit */int) (unsigned short)37517);
                    /* LoopNest 2 */
                    for (unsigned char i_3 = 3; i_3 < 14; i_3 += 4) 
                    {
                        ...
                        {
                            {
                                var_12 = ((/* implicit */int) ((((/* implicit */_Bool) min((((/* implicit */long long int) ((((/* implicit */int) var_5)) & (((/* implicit */int) var_6))))), ((~(var_0)))))) ? ((~(var_8))) : (((/* implicit */unsigned long long int) ((/* implicit */int) (short)2847)))));
