...
short var_1 = (short)-11498;
unsigned long long int var_9 = 14067838992582993085ULL;
int var_10 = -1667507741;
int zero = 0;
unsigned char var_13 = (unsigned char)248;
_Bool var_14 = (_Bool)1;
int var_15 = 1431919815;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        for (size_t i_1 = 0; i_1 < 16; ++i_1) 
            for (size_t i_2 = 0; i_2 < 16; ++i_2) 
                for (size_t i_3 = 0; i_3 < 16; ++i_3) 
                    arr_6 [i_0] [i_1] [i_2] [i_3] = 1604347011U;
}
