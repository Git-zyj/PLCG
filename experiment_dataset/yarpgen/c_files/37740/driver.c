...
int var_0 = 1556974611;
unsigned char var_3 = (unsigned char)101;
short var_7 = (short)11872;
unsigned char var_8 = (unsigned char)115;
long long int var_11 = -1979459258449358151LL;
int var_12 = -1798135658;
int zero = 0;
...
void init() {
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            arr_0 [i_0] [i_1] = 17647726128295805307ULL;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            arr_1 [i_0] [i_1] = (unsigned char)1;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        arr_2 [i_0] = 104293366U;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
