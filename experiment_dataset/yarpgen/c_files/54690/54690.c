...
void test() {
    #pragma scop
    var_19 = (max(((var_1 ? 14433 : ((96178385 / (-127 - 1))))), ((max(var_4, 30169)))));

    for (int i_0 = 1; i_0 < 13;i_0 += 1)
    {
        arr_2 [i_0] = ((~((~(arr_1 [i_0] [i_0])))));
        arr_3 [i_0 - 1] [i_0] = min((arr_0 [i_0]), ((-32752 - (((arr_1 [i_0] [i_0]) ? 4611686018427387904 : var_2)))));
        var_20 -= -4611686018427387892;
    }
    #pragma endscop
}
