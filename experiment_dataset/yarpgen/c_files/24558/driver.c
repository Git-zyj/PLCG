...
unsigned long long int var_0 = 2433704910979242340ULL;
...
unsigned int var_12 = 1885868926U;
short var_13 = (short)-27569;
unsigned long long int var_14 = 2517292351563550404ULL;
unsigned short var_15 = (unsigned short)546;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 21; ++i_0) 
        for (size_t i_1 = 0; i_1 < 21; ++i_1) 
            arr_3 [i_0] [i_1] = (i_0 % 2 == 0) ? 3539817838U : 1695873986U;
    for (size_t i_0 = 0; i_0 < 21; ++i_0) 
        for (size_t i_1 = 0; i_1 < 21; ++i_1) 
