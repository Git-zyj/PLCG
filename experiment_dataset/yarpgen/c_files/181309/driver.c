...
short var_12 = (short)-21030;
int zero = 0;
_Bool var_14 = (_Bool)0;
short var_15 = (short)7781;
short var_16 = (short)-19107;
signed char var_17 = (signed char)124;
unsigned long long int var_18 = 4278435904918572194ULL;
        ...
        for (size_t i_1 = 0; i_1 < 15; ++i_1) 
            for (size_t i_2 = 0; i_2 < 15; ++i_2) 
                for (size_t i_3 = 0; i_3 < 15; ++i_3) 
                    arr_6 [i_0] [i_1] [i_2] [i_3] = (i_3 % 2 == 0) ? (unsigned short)50473 : (unsigned short)45141;
    for (size_t i_0 = 0; i_0 < 15; ++i_0) 
