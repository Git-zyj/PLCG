...
void test() {
    ...
    for (int i_0 = 0; i_0 < 11;i_0 += 1)
    {
        for (int i_1 = 0; i_1 < 11;i_1 += 1)
        {
            ...
            {
                {
                    arr_9 [i_0] [i_0] [1] = ((((1 && (arr_3 [i_0] [i_1] [i_0]))) || ((((arr_3 [i_0] [i_1] [i_0]) ? (arr_7 [i_0] [i_1] [2] [i_2]) : -4716724519916246561)))));
                    arr_10 [i_0] = ((((var_10 + (arr_8 [i_0] [i_1] [i_2]))) + 4716724519916246560));
                }
            }
        }
    }
    var_18 = var_6;
    var_19 = ((var_15 ? var_9 : var_16));
    #pragma endscop
}
