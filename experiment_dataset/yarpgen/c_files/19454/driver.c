...
_Bool var_2 = (_Bool)0;
unsigned long long int var_6 = 18106067080744612694ULL;
unsigned char var_9 = (unsigned char)238;
signed char var_10 = (signed char)119;
long long int var_11 = 5774102141267618988LL;
unsigned char var_14 = (unsigned char)44;
_Bool var_17 = (_Bool)1;
int zero = 0;
long long int var_19 = -7638382552215533727LL;
signed char var_20 = (signed char)-88;
long long int var_21 = 3692594409367822824LL;
    ...
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            for (size_t i_2 = 0; i_2 < 20; ++i_2) 
                arr_5 [i_0] [i_1] [i_2] = (i_0 % 2 == 0) ? -2713613045308074969LL : 4080444864170225265LL;
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            for (size_t i_2 = 0; i_2 < 20; ++i_2) 
                for (size_t i_3 = 0; i_3 < 20; ++i_3) 
                    arr_6 [i_0] [i_1] [i_2] [i_3] = (i_3 % 2 == 0) ? (signed char)9 : (signed char)16;
}
