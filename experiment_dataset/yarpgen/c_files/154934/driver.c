...
_Bool var_3 = (_Bool)1;
unsigned short var_4 = (unsigned short)28002;
int var_8 = 1049201959;
signed char var_9 = (signed char)-4;
int zero = 0;
_Bool var_11 = (_Bool)0;
unsigned long long int var_12 = 11573689573798199892ULL;
int var_13 = -366077670;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
        arr_10 [i_0] = (unsigned short)15960;
}
