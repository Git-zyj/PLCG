...
short var_12 = (short)7096;
int zero = 0;
long long int var_18 = -6934338077992553828LL;
signed char var_19 = (signed char)55;
signed char var_20 = (signed char)-62;
int var_21 = -1389269960;
long long int var_22 = -8769437787945597643LL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        for (size_t i_1 = 0; i_1 < 16; ++i_1) 
            arr_6 [i_0] [i_1] = (i_0 % 2 == 0) ? (unsigned short)11666 : (unsigned short)45029;
}
