...
void test() {
    ...
    for (int i_0 = 0; i_0 < 15; i_0 += 4) 
    {
        ...
        arr_2 [i_0] &= ((((/* implicit */_Bool) (-(1789045455)))) ? (((((/* implicit */_Bool) ((((/* implicit */int) var_13)) | (1906202159)))) ? ((-(arr_1 [i_0]))) : (arr_1 [i_0]))) : (arr_1 [2]));
    }
    for (unsigned short i_1 = 0; i_1 < 17; i_1 += 4) 
    {
        var_17 -= ((/* implicit */unsigned short) (+(min((arr_3 [i_1] [i_1]), (arr_3 [i_1] [i_1])))));
        var_18 = var_15;
    }
