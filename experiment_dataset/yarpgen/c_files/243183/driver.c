...
long long int var_0 = 3910670560635280145LL;
unsigned long long int var_2 = 16696700432356339799ULL;
signed char var_5 = (signed char)-52;
int var_10 = -1803707442;
...
long long int var_20 = 8361590536359654812LL;
long long int var_21 = 6707534758050677446LL;
            ...
            for (size_t i_2 = 0; i_2 < 19; ++i_2) 
                for (size_t i_3 = 0; i_3 < 19; ++i_3) 
                    for (size_t i_4 = 0; i_4 < 19; ++i_4) 
                        for (size_t i_5 = 0; i_5 < 19; ++i_5) 
                            for (size_t i_6 = 0; i_6 < 19; ++i_6) 
                                arr_13 [i_0] [i_1] [i_2] [i_3] [i_4] [i_5] [i_6] = (unsigned char)31;
}
