...
void test() {
    ...
    for (unsigned short i_0 = 2; i_0 < 20; i_0 += 3) 
    {
        for (unsigned long long int i_1 = 0; i_1 < 21; i_1 += 1) 
        {
            ...
            {
                {
                    var_18 = ((/* implicit */unsigned short) min((var_18), (((/* implicit */unsigned short) ((unsigned long long int) arr_6 [(signed char)20] [(signed char)20] [(unsigned char)3] [(signed char)20])))));
                    arr_8 [i_0] [(signed char)20] [i_2] = arr_0 [i_0];
                }
            } 
        } 
    } 
