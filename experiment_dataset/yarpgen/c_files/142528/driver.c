...
unsigned long long int var_3 = 9403838346041712111ULL;
unsigned char var_5 = (unsigned char)218;
_Bool var_7 = (_Bool)0;
short var_9 = (short)15895;
unsigned int var_11 = 962500129U;
unsigned int var_12 = 977289661U;
signed char var_13 = (signed char)-65;
signed char var_15 = (signed char)-100;
int zero = 0;
unsigned int var_20 = 4107055556U;
_Bool var_21 = (_Bool)0;
int var_22 = -1025256084;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            arr_5 [i_0] [i_1] = 3739424020068984984ULL;
}
