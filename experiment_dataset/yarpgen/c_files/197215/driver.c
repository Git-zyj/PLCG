...
unsigned long long int var_0 = 18220666459514469797ULL;
...
unsigned long long int var_8 = 7600376842930265548ULL;
unsigned long long int var_9 = 2765667575344047220ULL;
int zero = 0;
unsigned char var_11 = (unsigned char)201;
unsigned char var_12 = (unsigned char)20;
unsigned char var_13 = (unsigned char)212;
unsigned long long int var_14 = 1111543190823730576ULL;
unsigned long long int var_15 = 3506194009705224746ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        arr_3 [i_0] = 14325036050304041564ULL;
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
            for (size_t i_2 = 0; i_2 < 10; ++i_2) 
                arr_5 [i_0] [i_1] [i_2] = (i_0 % 2 == 0) ? (unsigned char)1 : (unsigned char)150;
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
            for (size_t i_2 = 0; i_2 < 10; ++i_2) 
                arr_6 [i_0] [i_1] [i_2] = 8977534060211545915ULL;
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
            for (size_t i_2 = 0; i_2 < 10; ++i_2) 
                arr_8 [i_0] [i_1] [i_2] = 718945730013592758ULL;
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
            arr_11 [i_0] [i_1] = 15354732331724187840ULL;
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
            for (size_t i_2 = 0; i_2 < 10; ++i_2) 
                arr_7 [i_0] [i_1] [i_2] = (i_0 % 2 == 0) ? 7228479570566238787ULL : 6906011173158311429ULL;
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        arr_14 [i_0] = (i_0 % 2 == 0) ? (unsigned char)250 : (unsigned char)155;
}
