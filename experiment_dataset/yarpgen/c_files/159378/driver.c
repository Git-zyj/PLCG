...
short var_1 = (short)5367;
short var_3 = (short)22673;
unsigned short var_4 = (unsigned short)63397;
short var_5 = (short)3447;
int var_6 = -466684784;
unsigned long long int var_9 = 5613387976128054182ULL;
int zero = 0;
int var_11 = 592568053;
        ...
        for (size_t i_1 = 0; i_1 < 17; ++i_1) 
            for (size_t i_2 = 0; i_2 < 17; ++i_2) 
                for (size_t i_3 = 0; i_3 < 17; ++i_3) 
                    arr_8 [i_0] [i_1] [i_2] [i_3] = (unsigned short)9051;
    for (size_t i_0 = 0; i_0 < 17; ++i_0) 
        arr_9 [i_0] = 578117910;
    for (size_t i_0 = 0; i_0 < 17; ++i_0) 
        for (size_t i_1 = 0; i_1 < 17; ++i_1) 
