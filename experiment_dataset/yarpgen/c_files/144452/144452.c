...
void test() {
    #pragma scop
    var_17 = ((207 >= (((var_15 ? var_15 : -338270037)))));
    /* LoopNest 2 */
    for (int i_0 = 0; i_0 < 19;i_0 += 1)
    {
        ...
        {
            {
                arr_4 [i_0] [i_1] [i_0] &= ((+(((arr_1 [i_0]) ? (arr_2 [i_0] [i_0] [i_0]) : ((((arr_3 [11] [i_1] [i_1]) == -338270049)))))));
                arr_5 [i_0] [i_0] [i_0] &= ((((min((arr_0 [i_0] [i_1]), (arr_0 [1] [i_1])))) ? (arr_2 [i_0] [i_0] [i_1]) : (~24)));
            }
        }
    }
    #pragma endscop
