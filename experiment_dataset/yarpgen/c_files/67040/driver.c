...
short var_8 = (short)-73;
short var_9 = (short)22406;
int zero = 0;
unsigned int var_10 = 4061184801U;
long long int var_11 = 8000531109730623413LL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        arr_7 [i_0] = 4525399036182890899ULL;
    for (size_t i_0 = 0; i_0 < 25; ++i_0) 
        for (size_t i_1 = 0; i_1 < 25; ++i_1) 
            for (size_t i_2 = 0; i_2 < 25; ++i_2) 
                arr_4 [i_0] [i_1] [i_2] = -1967648403;
}
