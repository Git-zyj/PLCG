...
unsigned short var_2 = (unsigned short)31183;
unsigned short var_3 = (unsigned short)59303;
unsigned short var_5 = (unsigned short)41939;
unsigned char var_6 = (unsigned char)234;
unsigned short var_7 = (unsigned short)35708;
int zero = 0;
unsigned short var_11 = (unsigned short)42625;
unsigned short var_12 = (unsigned short)33026;
unsigned short var_13 = (unsigned short)32690;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        for (size_t i_1 = 0; i_1 < 23; ++i_1) 
            for (size_t i_2 = 0; i_2 < 23; ++i_2) 
                arr_4 [i_0] [i_1] [i_2] = (unsigned short)14599;
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        for (size_t i_1 = 0; i_1 < 23; ++i_1) 
