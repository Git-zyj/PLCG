...
int var_7 = -983727835;
int var_8 = 298430231;
unsigned short var_9 = (unsigned short)60754;
unsigned char var_10 = (unsigned char)25;
unsigned short var_13 = (unsigned short)11072;
unsigned long long int var_15 = 2504088200438942284ULL;
_Bool var_17 = (_Bool)0;
int var_19 = 1371097771;
int zero = 0;
unsigned char var_20 = (unsigned char)211;
signed char var_21 = (signed char)53;
unsigned int var_22 = 27644386U;
        ...
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            for (size_t i_2 = 0; i_2 < 11; ++i_2) 
                for (size_t i_3 = 0; i_3 < 11; ++i_3) 
                    arr_13 [i_0] [i_1] [i_2] [i_3] = -789750156;
}
