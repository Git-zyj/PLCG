...
long long int var_8 = 5735952716786034493LL;
short var_9 = (short)9944;
int zero = 0;
unsigned short var_10 = (unsigned short)8309;
unsigned short var_11 = (unsigned short)51464;
int var_12 = -2078969209;
signed char var_13 = (signed char)93;
short var_14 = (short)-6780;
        ...
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            for (size_t i_2 = 0; i_2 < 11; ++i_2) 
                for (size_t i_3 = 0; i_3 < 11; ++i_3) 
                    arr_10 [i_0] [i_1] [i_2] [i_3] = -5999308312933511178LL;
