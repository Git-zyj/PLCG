...
unsigned long long int var_2 = 12554514646596858476ULL;
unsigned long long int var_8 = 10554221814831336491ULL;
signed char var_10 = (signed char)-8;
unsigned short var_12 = (unsigned short)35718;
int zero = 0;
signed char var_13 = (signed char)-120;
signed char var_14 = (signed char)1;
short var_15 = (short)10823;
long long int var_16 = 7530170940547139503LL;
    ...
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            for (size_t i_2 = 0; i_2 < 11; ++i_2) 
                arr_4 [i_0] [i_1] [i_2] = 7135711758307328712ULL;
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        arr_5 [i_0] = (unsigned char)125;
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            for (size_t i_2 = 0; i_2 < 11; ++i_2) 
                arr_7 [i_0] [i_1] [i_2] = 2038706892450134710ULL;
}
