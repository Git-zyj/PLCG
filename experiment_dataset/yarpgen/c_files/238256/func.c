...
#define min(a,b) \
    ({ __typeof__ (a) _a = (a); \
       ...
       _a < _b ? _a : _b; })
void test() {
    var_11 = ((/* implicit */unsigned long long int) min((547115656U), (((/* implicit */unsigned int) (_Bool)1))));
    /* LoopSeq 1 */
    /* vectorizable */
    for (unsigned int i_0 = 1; i_0 < 22; i_0 += 1) 
    {
        arr_3 [i_0] [i_0] = ((/* implicit */short) (_Bool)1);
        var_12 += ((/* implicit */signed char) ((((/* implicit */_Bool) -5606117039778458218LL)) ? (((/* implicit */int) (_Bool)1)) : (((/* implicit */int) (_Bool)1))));
    }
    var_13 = ((/* implicit */int) (((_Bool)1) ? (((/* implicit */long long int) ((/* implicit */int) (_Bool)1))) : (4306052476235005930LL)));
}
