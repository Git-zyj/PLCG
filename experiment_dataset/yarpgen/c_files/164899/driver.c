...
unsigned long long int var_0 = 13319266060301254863ULL;
short var_3 = (short)10499;
unsigned char var_5 = (unsigned char)229;
unsigned short var_10 = (unsigned short)61472;
short var_12 = (short)-9554;
long long int var_13 = 6277277112593254395LL;
int zero = 0;
    ...
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        for (size_t i_1 = 0; i_1 < 16; ++i_1) 
            for (size_t i_2 = 0; i_2 < 16; ++i_2) 
                arr_10 [i_0] [i_1] [i_2] = (i_1 % 2 == 0) ? 15903434112577672821ULL : 4674105486339251740ULL;
}
