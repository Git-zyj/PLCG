...
_Bool var_2 = (_Bool)1;
int var_6 = 1988240013;
_Bool var_8 = (_Bool)1;
signed char var_9 = (signed char)-66;
unsigned char var_11 = (unsigned char)118;
int zero = 0;
signed char var_13 = (signed char)-69;
unsigned long long int var_14 = 12913203650385206651ULL;
long long int var_15 = 2810528377681692150LL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        arr_10 [i_0] = (i_0 % 2 == 0) ? 838502565 : -2055038230;
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        for (size_t i_1 = 0; i_1 < 14; ++i_1) 
            arr_11 [i_0] [i_1] = (i_0 % 2 == 0) ? (short)27353 : (short)10340;
}
