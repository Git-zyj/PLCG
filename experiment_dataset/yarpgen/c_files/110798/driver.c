...
unsigned int var_0 = 1461397127U;
signed char var_1 = (signed char)-64;
short var_2 = (short)-23951;
unsigned short var_9 = (unsigned short)61633;
unsigned short var_11 = (unsigned short)7319;
unsigned short var_12 = (unsigned short)61136;
int zero = 0;
signed char var_15 = (signed char)-15;
unsigned short var_16 = (unsigned short)6665;
unsigned long long int var_17 = 15678731690320561000ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        for (size_t i_1 = 0; i_1 < 16; ++i_1) 
            arr_1 [i_0] [i_1] = 1294668254U;
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        for (size_t i_1 = 0; i_1 < 16; ++i_1) 
            arr_2 [i_0] [i_1] = (short)-16395;
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        for (size_t i_1 = 0; i_1 < 16; ++i_1) 
