...
void test() {
    ...
    for (int i_0 = 0; i_0 < 15;i_0 += 1)
    {
        ...
        {
            {
                arr_4 [i_0] [i_0] = (arr_3 [5] [5] [5]);
                var_13 = ((+((((arr_3 [i_0] [i_0] [i_0]) >= (arr_1 [i_0] [i_1]))))));
            }
        }
    }
    ...
    {
        arr_7 [i_2] [i_2] = (-(((arr_1 [i_2] [i_2]) << var_6)));
        /* LoopNest 3 */
    ...
    var_14 ^= (~var_2);
    var_15 = ((var_6 ? (((~var_1) ^ 255)) : var_2));
    var_16 = ((var_11 / (((min(var_9, var_11))))));
    #pragma endscop
}
