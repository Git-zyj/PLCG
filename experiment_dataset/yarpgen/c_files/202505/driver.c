...
unsigned short var_1 = (unsigned short)6462;
...
int zero = 0;
unsigned long long int var_19 = 13747375512547125640ULL;
unsigned long long int var_20 = 12168428149243406461ULL;
unsigned short var_21 = (unsigned short)7833;
