...
void test() {
    ...
    for (unsigned short i_0 = 0; i_0 < 13; i_0 += 3) 
    {
        ...
        {
            {
                var_15 = ((/* implicit */signed char) 2073305340);
                arr_4 [i_0] [i_0] [i_1] = ((/* implicit */unsigned int) min((2278028706070472488ULL), (((/* implicit */unsigned long long int) min((((/* implicit */signed char) arr_3 [i_0])), (arr_0 [i_1]))))));
            }
        } 
    } 
}
