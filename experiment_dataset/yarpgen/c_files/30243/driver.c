...
long long int var_4 = -8019219482495044065LL;
long long int var_5 = 1456783709692245656LL;
long long int var_8 = -8740710046427286339LL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 20; ++i_0) 
        for (size_t i_1 = 0; i_1 < 20; ++i_1) 
            arr_5 [i_0] [i_1] = (i_1 % 2 == 0) ? (signed char)-112 : (signed char)-53;
}
