...
int zero = 0;
unsigned int var_10 = 2913985972U;
unsigned char var_11 = (unsigned char)96;
unsigned long long int var_12 = 18236869305706472ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            arr_2 [i_0] [i_1] = (i_1 % 2 == 0) ? (unsigned short)34768 : (unsigned short)22024;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        arr_3 [i_0] = (i_0 % 2 == 0) ? (unsigned short)10752 : (unsigned short)24217;
}
