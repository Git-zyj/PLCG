...
void test() {
    ...
    for (int i_0 = 1; i_0 < 17;i_0 += 1)
    {
        for (int i_1 = 2; i_1 < 18;i_1 += 1)
        {
            ...
            {
                {
                    arr_9 [i_0] [i_1] [i_0] [i_0] = (((((+(((arr_3 [i_0 + 2] [i_1]) ? (arr_8 [i_0] [i_0] [i_1] [i_2]) : 65530))))) >= -6504501094129149666));
                    var_17 = ((!830265331) ? (arr_6 [i_0 + 2] [i_0] [i_0]) : ((((!((max(-32747, 22362))))))));
