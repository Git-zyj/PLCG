...
unsigned long long int var_1 = 10663321202671172023ULL;
_Bool var_3 = (_Bool)0;
short var_5 = (short)25231;
unsigned char var_6 = (unsigned char)50;
long long int var_8 = 4257928664025668932LL;
long long int var_9 = 9189098161252002722LL;
unsigned char var_11 = (unsigned char)232;
short var_12 = (short)9083;
long long int var_14 = 12578932870188814LL;
int zero = 0;
unsigned long long int var_15 = 17359193528144631145ULL;
unsigned char var_16 = (unsigned char)3;
signed char var_17 = (signed char)43;
unsigned char var_18 = (unsigned char)2;
unsigned int var_19 = 1331580834U;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        for (size_t i_1 = 0; i_1 < 14; ++i_1) 
            arr_4 [i_0] [i_1] = -8875942378781933504LL;
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        for (size_t i_1 = 0; i_1 < 14; ++i_1) 
            for (size_t i_2 = 0; i_2 < 14; ++i_2) 
    ...
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        for (size_t i_1 = 0; i_1 < 14; ++i_1) 
            for (size_t i_2 = 0; i_2 < 14; ++i_2) 
                arr_8 [i_0] [i_1] [i_2] = 285285292U;
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        arr_9 [i_0] = (signed char)90;
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        for (size_t i_1 = 0; i_1 < 14; ++i_1) 
            for (size_t i_2 = 0; i_2 < 14; ++i_2) 
                arr_6 [i_0] [i_1] [i_2] = 2011718373U;
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        for (size_t i_1 = 0; i_1 < 14; ++i_1) 
            for (size_t i_2 = 0; i_2 < 14; ++i_2) 
                arr_12 [i_0] [i_1] [i_2] = (i_0 % 2 == 0) ? 7217236152670186292LL : -5144563493955829352LL;
}
