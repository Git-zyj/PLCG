...
long long int var_2 = -7618716690533730357LL;
long long int var_13 = 1902255549914292171LL;
int zero = 0;
signed char var_17 = (signed char)96;
unsigned short var_18 = (unsigned short)17984;
int arr_1 [21] ;
