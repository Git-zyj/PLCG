...
unsigned long long int var_0 = 8711502976727821178ULL;
_Bool var_1 = (_Bool)1;
unsigned char var_2 = (unsigned char)223;
short var_4 = (short)-22910;
signed char var_5 = (signed char)115;
_Bool var_7 = (_Bool)0;
short var_8 = (short)28252;
unsigned long long int var_9 = 12540150656126380823ULL;
long long int var_10 = -6206524345265505399LL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        arr_13 [i_0] = (i_0 % 2 == 0) ? (signed char)-93 : (signed char)-42;
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        for (size_t i_1 = 0; i_1 < 16; ++i_1) 
            for (size_t i_2 = 0; i_2 < 16; ++i_2) 
                arr_22 [i_0] [i_1] [i_2] = (i_0 % 2 == 0) ? 6535006290537464023ULL : 1323968350758822420ULL;
}
