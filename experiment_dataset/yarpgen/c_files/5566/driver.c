...
unsigned int var_0 = 2032715887U;
unsigned long long int var_2 = 5023873723084121700ULL;
unsigned short var_5 = (unsigned short)51509;
signed char var_7 = (signed char)76;
unsigned char var_11 = (unsigned char)78;
int var_13 = -1498956118;
int zero = 0;
int var_16 = -1420660047;
unsigned char var_17 = (unsigned char)98;
unsigned short var_18 = (unsigned short)43994;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        arr_12 [i_0] = (i_0 % 2 == 0) ? (unsigned short)61193 : (unsigned short)13998;
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        for (size_t i_1 = 0; i_1 < 22; ++i_1) 
