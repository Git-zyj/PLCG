...
long long int var_4 = -4159635941653953816LL;
int zero = 0;
int var_10 = -2065952187;
int var_11 = 1510277231;
unsigned char var_12 = (unsigned char)23;
int var_13 = 1914949303;
unsigned char var_14 = (unsigned char)107;
signed char var_15 = (signed char)60;
unsigned long long int var_16 = 17977022554795138084ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            arr_5 [i_0] [i_1] = (short)27612;
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        arr_7 [i_0] = (signed char)-26;
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            for (size_t i_2 = 0; i_2 < 11; ++i_2) 
                arr_12 [i_0] [i_1] [i_2] = -1170454509;
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            for (size_t i_2 = 0; i_2 < 11; ++i_2) 
