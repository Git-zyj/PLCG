...
void test() {
    var_17 = var_7;
    var_18 = min((var_9), (((((/* implicit */_Bool) var_10)) ? (var_15) : (((/* implicit */unsigned long long int) ((/* implicit */int) ((17484251608589431479ULL) > (var_6))))))));
    /* LoopNest 3 */
    for (unsigned long long int i_0 = 0; i_0 < 21; i_0 += 1) 
    {
        for (unsigned long long int i_1 = 0; i_1 < 21; i_1 += 3) 
        {
            ...
            {
                {
                    var_19 = 2203413982000680042ULL;
                    var_20 = max(((-((-(2203413982000680052ULL))))), (((var_8) - (((var_7) * (13ULL))))));
                }
            } 
        } 
    } 
