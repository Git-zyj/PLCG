...
unsigned long long int var_18 = 984257046087871839ULL;
int zero = 0;
signed char var_19 = (signed char)111;
unsigned long long int var_20 = 17819666989464102795ULL;
unsigned long long int var_21 = 1337334395827182545ULL;
_Bool arr_0 [13] ;
_Bool arr_1 [13] [13] ;
_Bool arr_2 [13] ;
_Bool arr_3 [13] ;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        arr_5 [i_0] = (i_0 % 2 == 0) ? (signed char)-76 : (signed char)58;
}
