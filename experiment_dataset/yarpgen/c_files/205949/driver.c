...
int var_4 = 507354963;
unsigned long long int var_5 = 3815373257018883735ULL;
unsigned long long int var_6 = 18011363831367584105ULL;
unsigned short var_9 = (unsigned short)19974;
signed char var_10 = (signed char)-75;
unsigned long long int var_11 = 9346311622708378772ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            for (size_t i_2 = 0; i_2 < 11; ++i_2) 
                arr_9 [i_0] [i_1] [i_2] = (i_1 % 2 == 0) ? (signed char)-48 : (signed char)-22;
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        for (size_t i_1 = 0; i_1 < 11; ++i_1) 
            for (size_t i_2 = 0; i_2 < 11; ++i_2) 
                for (size_t i_3 = 0; i_3 < 11; ++i_3) 
                    arr_10 [i_0] [i_1] [i_2] [i_3] = (i_2 % 2 == 0) ? 10068007316788864606ULL : 8812964032597300404ULL;
}
