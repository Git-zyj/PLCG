...
Seed: 187984
Invocation: /data/zyj/loop_generator/./baselines/mytest/../yarpgen/scripts/yarpgen --std=c --emit-align-attr=none --inp-as-args=none --emit-pragmas=none --expl-loop-param=true --seed=187984 -o /data2/zyj/Dataset_ISPASS/yarpgen/c_files/187984
*/
#include "init.h"
#define max(a,b) \
    ({ __typeof__ (a) _a = (a); \
