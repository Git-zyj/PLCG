...
unsigned int var_1 = 2056719223U;
signed char var_6 = (signed char)41;
long long int var_7 = 8870873135421661500LL;
signed char var_8 = (signed char)-6;
int zero = 0;
long long int var_14 = 3548439108383968015LL;
unsigned long long int var_15 = 2479870005405639387ULL;
...
void init() {
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        for (size_t i_1 = 0; i_1 < 22; ++i_1) 
            arr_4 [i_0] [i_1] = 12950746771887805865ULL;
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
