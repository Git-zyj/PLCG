        ...
        {
            {
                        ...
                        {
                            {
                                ...
                                arr_13 [i_0] [i_1] [14] [i_3] [i_1] = ((-((((arr_7 [i_1] [i_3 + 2] [i_4 - 2]) || (((arr_6 [i_3] [i_3] [i_3] [i_1]) && (arr_8 [i_0] [i_1] [i_2] [i_2] [i_3] [i_1]))))))));
                                var_17 = (min((arr_6 [i_3 - 1] [i_3 + 2] [i_3 - 1] [i_1]), 1720685));
                                var_18 = (max(var_18, ((1673046625 >= ((-(arr_5 [i_3] [i_4 - 3] [i_3] [i_1 + 1])))))));
                            }
                        }
                    }
                }
                ...
                for (int i_5 = 2; i_5 < 14;i_5 += 1)
                {
                    ...
                    {
                        {
                            var_19 = (-((~(((!(arr_15 [i_1] [i_1] [i_5 + 1])))))));
                            arr_20 [i_1] [i_1] [i_1] [i_1] [i_1] = ((!(arr_3 [i_1])));
                        }
                    }
                }
            }
