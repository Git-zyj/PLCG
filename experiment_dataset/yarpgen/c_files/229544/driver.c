...
long long int var_16 = -3968518546797519228LL;
unsigned long long int var_17 = 8198949233474726620ULL;
unsigned long long int var_18 = 15044699452986844727ULL;
int arr_2 [11] ;
_Bool arr_7 [11] [11] [11] [11] ;
signed char arr_8 [11] [11] [11] ;
void init() {
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
        arr_2 [i_0] = 1037601303;
    for (size_t i_0 = 0; i_0 < 11; ++i_0) 
