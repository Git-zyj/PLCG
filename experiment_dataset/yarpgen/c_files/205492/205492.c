...
void test() {
    #pragma scop
    var_15 = max(20842, (((((var_10 ? -1416558759 : var_7)) == (var_12 && -1)))));
    /* LoopNest 3 */
    for (int i_0 = 1; i_0 < 16;i_0 += 1)
    {
        for (int i_1 = 0; i_1 < 17;i_1 += 1)
        {
            ...
            {
                {
                    arr_9 [9] [i_2] [i_2] [i_2] = ((var_11 / -474129965) << ((((var_6 ? ((min(35780, 33939))) : ((255 ? var_0 : var_3)))) - 33921)));
                    var_16 = (524284 ? 31596 : 6);
                }
            }
        }
    }
