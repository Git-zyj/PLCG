...
unsigned long long int var_1 = 3599493926777333605ULL;
long long int var_3 = -6422461051034858525LL;
unsigned char var_5 = (unsigned char)88;
int var_8 = 22691509;
unsigned char var_15 = (unsigned char)43;
int zero = 0;
signed char var_19 = (signed char)-30;
short var_20 = (short)14122;
unsigned char var_21 = (unsigned char)111;
unsigned short var_22 = (unsigned short)10132;
    ...
    for (size_t i_0 = 0; i_0 < 19; ++i_0) 
        for (size_t i_1 = 0; i_1 < 19; ++i_1) 
            for (size_t i_2 = 0; i_2 < 19; ++i_2) 
                arr_8 [i_0] [i_1] [i_2] = (i_0 % 2 == 0) ? (unsigned short)57190 : (unsigned short)41458;
}
