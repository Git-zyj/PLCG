...
unsigned int var_1 = 3822254043U;
unsigned long long int var_6 = 14608722709431446872ULL;
unsigned char var_7 = (unsigned char)103;
signed char var_9 = (signed char)25;
short var_10 = (short)-5769;
unsigned short var_12 = (unsigned short)129;
int zero = 0;
_Bool var_17 = (_Bool)1;
unsigned long long int var_18 = 3813396802698204512ULL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            arr_5 [i_0] [i_1] = (unsigned short)18455;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        arr_6 [i_0] = (_Bool)0;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
