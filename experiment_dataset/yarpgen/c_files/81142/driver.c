...
_Bool var_9 = (_Bool)0;
unsigned long long int var_10 = 18366547060084462681ULL;
unsigned char var_15 = (unsigned char)140;
int zero = 0;
unsigned long long int var_16 = 15335213027697908926ULL;
int var_17 = 1286034433;
signed char var_18 = (signed char)73;
int var_19 = 124253922;
unsigned short var_20 = (unsigned short)20153;
int arr_0 [22] ;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 16; ++i_0) 
        arr_14 [i_0] = (unsigned short)8730;
}
