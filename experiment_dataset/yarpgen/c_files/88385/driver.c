...
_Bool var_1 = (_Bool)1;
_Bool var_3 = (_Bool)0;
unsigned long long int var_4 = 11962072078301934725ULL;
unsigned char var_5 = (unsigned char)81;
unsigned char var_6 = (unsigned char)168;
_Bool var_7 = (_Bool)0;
unsigned long long int var_8 = 16491046515392898995ULL;
unsigned long long int var_9 = 7814075891679805150ULL;
int zero = 0;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        for (size_t i_1 = 0; i_1 < 12; ++i_1) 
            for (size_t i_2 = 0; i_2 < 12; ++i_2) 
                for (size_t i_3 = 0; i_3 < 12; ++i_3) 
                    arr_21 [i_0] [i_1] [i_2] [i_3] = (i_1 % 2 == 0) ? (unsigned char)85 : (unsigned char)137;
    for (size_t i_0 = 0; i_0 < 12; ++i_0) 
        for (size_t i_1 = 0; i_1 < 12; ++i_1) 
            for (size_t i_2 = 0; i_2 < 12; ++i_2) 
