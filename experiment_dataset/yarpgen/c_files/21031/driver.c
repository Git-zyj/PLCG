...
short var_0 = (short)-1787;
_Bool var_1 = (_Bool)1;
signed char var_2 = (signed char)-10;
unsigned char var_3 = (unsigned char)237;
unsigned long long int var_5 = 14522960084613857582ULL;
signed char var_8 = (signed char)-5;
_Bool var_13 = (_Bool)0;
short var_14 = (short)-5329;
int zero = 0;
short var_17 = (short)-904;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 17; ++i_0) 
        arr_1 [i_0] = (unsigned short)31492;
    for (size_t i_0 = 0; i_0 < 17; ++i_0) 
        arr_2 [i_0] = (_Bool)0;
    for (size_t i_0 = 0; i_0 < 17; ++i_0) 
        for (size_t i_1 = 0; i_1 < 17; ++i_1) 
            arr_3 [i_0] [i_1] = -7820678831736886346LL;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            arr_10 [i_0] [i_1] = 12656387824554240699ULL;
}
