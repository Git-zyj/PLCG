...
short var_5 = (short)2324;
unsigned char var_11 = (unsigned char)196;
int zero = 0;
short var_15 = (short)-16054;
int var_16 = 562139675;
unsigned long long int arr_2 [18] [18] ;
unsigned long long int arr_9 [18] [18] [18] [18] ;
void init() {
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            arr_2 [i_0] [i_1] = 3293713190611879348ULL;
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            for (size_t i_2 = 0; i_2 < 18; ++i_2) 
                for (size_t i_3 = 0; i_3 < 18; ++i_3) 
                    arr_9 [i_0] [i_1] [i_2] [i_3] = (i_0 % 2 == 0) ? 4683401528664908102ULL : 8778677882772692867ULL;
}
