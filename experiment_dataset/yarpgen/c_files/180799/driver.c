...
int var_12 = -1134755267;
unsigned char var_13 = (unsigned char)205;
signed char var_14 = (signed char)-20;
short var_16 = (short)2380;
unsigned char var_18 = (unsigned char)254;
unsigned short var_19 = (unsigned short)64944;
int zero = 0;
long long int var_20 = -7924475588395084436LL;
int var_21 = 406560693;
signed char var_22 = (signed char)89;
int var_23 = -1521475223;
signed char var_24 = (signed char)74;
signed char var_25 = (signed char)-80;
int var_26 = -123669834;
int var_27 = -863055335;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        for (size_t i_1 = 0; i_1 < 14; ++i_1) 
            for (size_t i_2 = 0; i_2 < 14; ++i_2) 
                arr_24 [i_0] [i_1] [i_2] = (signed char)29;
    for (size_t i_0 = 0; i_0 < 14; ++i_0) 
        for (size_t i_1 = 0; i_1 < 14; ++i_1) 
            for (size_t i_2 = 0; i_2 < 14; ++i_2) 
                arr_25 [i_0] [i_1] [i_2] = (unsigned char)206;
}
