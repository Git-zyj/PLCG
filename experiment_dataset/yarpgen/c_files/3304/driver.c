...
_Bool var_4 = (_Bool)1;
unsigned long long int var_7 = 13890879237075568526ULL;
unsigned short var_8 = (unsigned short)6518;
int zero = 0;
long long int var_11 = -2018570813262153477LL;
long long int var_12 = 3188641369834100998LL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 10; ++i_0) 
        for (size_t i_1 = 0; i_1 < 10; ++i_1) 
            arr_6 [i_0] [i_1] = (i_1 % 2 == 0) ? (short)24179 : (short)-11481;
}
