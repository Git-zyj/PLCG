...
unsigned long long int var_2 = 11874266927692815817ULL;
_Bool var_3 = (_Bool)0;
unsigned int var_4 = 3100270606U;
short var_6 = (short)-3178;
signed char var_7 = (signed char)69;
_Bool var_8 = (_Bool)0;
_Bool var_9 = (_Bool)0;
unsigned long long int var_10 = 7619803820309693001ULL;
signed char var_11 = (signed char)62;
signed char var_12 = (signed char)100;
unsigned long long int var_13 = 6617529836660038583ULL;
int zero = 0;
unsigned int var_14 = 1737591688U;
unsigned long long int var_15 = 1689733521983398009ULL;
unsigned long long int var_16 = 9485438688646298799ULL;
short var_17 = (short)-7976;
...
long long int var_25 = 6394628803429470105LL;
unsigned short var_26 = (unsigned short)5583;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        arr_10 [i_0] = (_Bool)0;
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        arr_20 [i_0] = (unsigned char)171;
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        for (size_t i_1 = 0; i_1 < 23; ++i_1) 
            arr_6 [i_0] [i_1] = 16702716316516777621ULL;
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        for (size_t i_1 = 0; i_1 < 23; ++i_1) 
            arr_11 [i_0] [i_1] = 15487913531121910974ULL;
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        for (size_t i_1 = 0; i_1 < 23; ++i_1) 
            for (size_t i_2 = 0; i_2 < 23; ++i_2) 
    ...
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        for (size_t i_1 = 0; i_1 < 23; ++i_1) 
            for (size_t i_2 = 0; i_2 < 23; ++i_2) 
                arr_21 [i_0] [i_1] [i_2] = (signed char)-106;
    for (size_t i_0 = 0; i_0 < 23; ++i_0) 
        for (size_t i_1 = 0; i_1 < 23; ++i_1) 
