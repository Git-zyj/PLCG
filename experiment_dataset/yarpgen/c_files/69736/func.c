...
#define min(a,b) \
    ({ __typeof__ (a) _a = (a); \
       ...
       _a < _b ? _a : _b; })
void test() {
    var_18 = ((/* implicit */unsigned short) max((var_18), (((/* implicit */unsigned short) (unsigned char)67))));
    /* LoopNest 2 */
    ...
    var_21 = ((/* implicit */unsigned short) (~(((/* implicit */int) (!(((/* implicit */_Bool) min(((unsigned short)12800), (((/* implicit */unsigned short) (unsigned char)67))))))))));
}
