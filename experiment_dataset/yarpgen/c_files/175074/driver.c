...
unsigned short var_1 = (unsigned short)48327;
_Bool var_7 = (_Bool)0;
int var_15 = -1339169973;
unsigned short var_18 = (unsigned short)22361;
unsigned short var_19 = (unsigned short)22948;
int zero = 0;
signed char var_20 = (signed char)60;
signed char var_21 = (signed char)-61;
long long int var_22 = -6910900036078236029LL;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        for (size_t i_1 = 0; i_1 < 13; ++i_1) 
            arr_10 [i_0] [i_1] = 2840411980U;
    for (size_t i_0 = 0; i_0 < 13; ++i_0) 
        for (size_t i_1 = 0; i_1 < 13; ++i_1) 
            for (size_t i_2 = 0; i_2 < 13; ++i_2) 
                arr_14 [i_0] [i_1] [i_2] = (unsigned char)28;
}
