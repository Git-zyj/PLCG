...
unsigned int var_13 = 753177492U;
unsigned short var_14 = (unsigned short)16922;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 18; ++i_0) 
        for (size_t i_1 = 0; i_1 < 18; ++i_1) 
            arr_5 [i_0] [i_1] = (i_0 % 2 == 0) ? (unsigned short)25676 : (unsigned short)54043;
}
