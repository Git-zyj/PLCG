...
unsigned short var_12 = (unsigned short)18833;
int var_13 = -1320118207;
unsigned long long int var_14 = 9577195082106202127ULL;
_Bool arr_0 [14] ;
_Bool arr_2 [14] [14] ;
...
void init() {
    ...
    for (size_t i_0 = 0; i_0 < 22; ++i_0) 
        arr_13 [i_0] = (i_0 % 2 == 0) ? 15214096257471660070ULL : 4342422797398732893ULL;
