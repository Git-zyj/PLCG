...
void kernel_2312131313_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_P; i_1++) {
        for (int i_2 = 1; i_2 < -i_1+PB_M; i_2++) {
            A[i_2-1] = D[i_2][i_1+1] * D[i_1][i_2+i_1] * D[i_1][i_2] + D[i_2][i_1+1] * D[i_2+i_1][i_2] - D[i_2][i_2] * A[i_1-1] + 5;
        }
        for (int i_3 = i_1; i_3 < PB_P; i_3++) {
            C[i_3+1][i_1-1] = E[i_1] - D[i_3][i_1] + C[i_1+1][i_3] + C[i_3+2][i_1-1] + C[i_1+2][i_3-1] + C[i_3+2][i_1] * 4;
        }
    }
#pragma endscop
...
kernel_2312131313_09(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
