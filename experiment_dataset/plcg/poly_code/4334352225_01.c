...
void kernel_4334352225_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N; i_0++) {
        A[i_0] = D[i_0-1] - D[i_0] * D[1] + D[i_0-1] - E[i_0] + F[i_0] * F[i_0] * F[i_0] + D[i_0-1] - E[i_0-2] - A[i_0-1] - 5;
    }
    for (int i_1 = 2; i_1 < PB_M; i_1++) {
        A[i_1-1] = F[0] - D[i_1-2] + 5;
    }
    for (int i_2 = 0; i_2 < PB_Q; i_2++) {
        for (int i_3 = 2; i_3 < min(PB_Q, -i_2+PB_L); i_3++) {
            for (int i_4 = 1; i_4 < min(PB_Q+1, -i_2+PB_M); i_4++) {
                for (int i_5 = 1; i_5 < min(-i_4+PB_M, -i_2+PB_P); i_5++) {
                    C[i_3][i_4+i_2][i_5][i_5] = G[i_3][i_2][i_5][i_4-1] - H[i_4][i_5+i_2][i_2][i_3] * I[i_4-1][i_3+i_2][i_5-1][i_2] - C[i_3+1][i_4+i_2][i_5][i_5] + C[i_3-2][i_5+i_4][i_2][i_2] + 6;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4334352225_01(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I)));
