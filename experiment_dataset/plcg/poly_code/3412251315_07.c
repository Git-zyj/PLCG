...
void kernel_3412251315_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        A[i_0] = E[i_0] + F[i_0+1] * E[i_0-1] + A[i_0-1] + A[i_0+1] + A[i_0-1] + 5;
    }
    for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
        for (int i_2 = 1; i_2 < min(-i_1+PB_M+1, PB_L-1); i_2++) {
            for (int i_3 = 0; i_3 < min(-i_1+PB_L-1, -i_2+PB_L-1); i_3++) {
                B[i_1][i_3+i_2][i_1] = G[i_1][i_2] - H[i_2][i_3+i_1+1] * I[i_3][i_1][i_2+1] - J[i_2+i_1-1][i_3][i_1] - I[i_3][i_1][i_2] + J[i_1][i_2][i_3+i_2] * I[i_2][i_3+1][i_1] * J[i_3][i_1-1][i_2] + I[i_3][i_1+1][i_2+1] * H[i_2-1][i_1] * B[i_1][i_3+i_2+1][i_1] - B[i_1][i_3+i_2+1][i_1] + B[i_1+1][i_3+i_2+1][i_1+1] + 2;
            }
        }
        for (int i_4 = 1; i_4 < PB_L; i_4++) {
            for (int i_5 = 1; i_5 < i_4; i_5++) {
                C[i_1][i_4][i_5+1] = G[i_5-1][i_4-1] + I[i_4][i_5][i_1+1] + I[i_4-1][i_1][i_5] - C[i_1-1][i_5][i_4+2] + C[i_1-1][i_4][i_5+1] * 4;
            }
            for (int i_6 = 0; i_6 < -i_1+PB_L; i_6++) {
                C[i_1][i_4][i_6] = I[i_1][i_4][i_4] + I[i_4-1][i_6+i_1][i_4] + 3;
            }
        }
    }
#pragma endscop
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_3412251315_07(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J)));
