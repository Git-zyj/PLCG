...
void kernel_2432251213_04(int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 1; i_1 < min(-i_0+PB_M, PB_L); i_1++) {
            D[i_0-1][i_1] = E[i_1-1] + E[i_0-1] + F[i_1][i_0+1] - G[i_0][1] - G[i_1+i_0][0] - 5;
        }
    }
    for (int i_2 = 1; i_2 < PB_L-1; i_2++) {
        B[i_2] = E[i_2] - H[i_2-1] + 6;
        B[i_2-1] = H[i_2-1] - H[i_2] - H[i_2] + H[i_2-1] - 1;
        for (int i_3 = 1; i_3 < min(-i_2+PB_M+1, PB_L-1); i_3++) {
            D[i_2][i_3] = G[i_3+1][i_2] - I[i_3][i_2][i_2] + G[i_3][i_2] * F[i_2][i_3] - H[i_3+i_2-1] - F[i_3+1][i_2+1] * H[i_3] * D[i_2][i_3+1] + D[i_2][i_3-1] - D[i_2-1][i_3-1] - 5;
        }
    }
#pragma endscop
...
kernel_2432251213_04(xd,yd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
