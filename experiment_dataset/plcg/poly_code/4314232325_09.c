...
void kernel_4314232325_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_P-3; i_1++) {
            for (int i_2 = 2; i_2 < PB_L; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_0+PB_Q+2, -i_2+PB_L); i_3++) {
                    A[i_0-1][i_1+1][i_1][i_3] = D[i_3][i_2][i_0][i_1] - E[i_3+2][i_2-2][i_0][i_1] - D[i_1][i_1-1][i_3+i_0-2][i_1] + D[i_3+i_2][i_0+1][i_1][i_0] + A[i_0-1][i_1+3][i_1+2][i_3] - 4;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-2; i_4++) {
        B[i_4] = F[i_4] * F[i_4-1] * G[i_4-2] + G[i_4] * B[i_4-1] - B[i_4+1] - 3;
        B[i_4] = B[i_4] + B[i_4+2] * B[i_4+1] + 2;
    }
#pragma endscop
...
kernel_4314232325_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
