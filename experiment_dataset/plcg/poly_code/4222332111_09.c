    ...
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        ...
        for (int i_3 = 2; i_3 < PB_L-1; i_3++) {
            for (int i_4 = 1; i_4 < min(-i_3+PB_M+2, i_3); i_4++) {
                B[i_0][i_0][i_3] = C[i_0][i_3] * D[i_3-2][i_4-1][i_0] - C[i_4][i_3-2] + C[i_4+i_3-2][i_3] - E[i_3][i_4][i_0] * A[i_3][i_0][i_4+1] + B[i_0][i_0][i_3+1] - 4;
            }
        }
    }
#pragma endscop
...
kernel_4222332111_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
