...
void kernel_4432111211_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
        ...
        for (int i_4 = max(1, i_3); i_4 < PB_Q-1; i_4++) {
            for (int i_5 = 0; i_5 < -i_4+PB_Q-1; i_5++) {
                for (int i_6 = 1; i_6 < PB_Q; i_6++) {
                    C[i_3][i_4-1][0][i_5] = E[i_5][i_3][i_6][i_6][i_5+i_4+1] - C[i_3+1][i_4-1][0][i_5] * C[i_3+1][i_6-1][0][i_5] * 1;
                }
            }
        }
        for (int i_7 = 2; i_7 < i_3; i_7++) {
            for (int i_8 = 0; i_8 < PB_M; i_8++) {
                for (int i_9 = 2; i_9 < PB_M; i_9++) {
                    D[i_9-1][i_9][i_7-1][i_3] = F[i_9][i_7-1][i_8] - D[i_9-1][i_9][i_7-2][i_3] * D[i_9-1][i_9][i_7-1][i_3+1] * D[i_9][i_9+1][i_7-1][i_3] + D[i_9-2][i_9-1][i_7-1][i_3] + 3;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), INIT_SEED);
kernel_4432111211_03(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F)));
