...
void kernel_3224112123_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
    ...
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 1; i_1 < min(min(-i_0+PB_Q, i_0), PB_P-1); i_1++) {
            for (int i_2 = 0; i_2 < min(-i_0+PB_Q, PB_P-3); i_2++) {
                A[i_0][i_1+1][i_2][i_2+i_0] = C[i_1-1][i_0] * A[i_1][i_2+3][i_0][i_1+i_0] * 6;
            }
        }
        B[i_0] = 3;
    }
...
kernel_3224112123_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
