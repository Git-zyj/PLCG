...
void kernel_4212231225_02(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
        ...
        for (int i_1 = i_0; i_1 < -i_0+PB_P-2; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < PB_M; i_3++) {
                    B[i_2][i_1+i_0+2][i_3][i_2-1] = C[i_1][i_2-1][i_3][i_1] + C[0][i_0][i_3][i_2] + D[i_0][i_2][i_3][i_2] - C[i_2+i_1+1][i_3][i_0+1][i_0] + 4;
                }
            }
        }
        for (int i_4 = 1; i_4 < -i_0+PB_P; i_4++) {
            for (int i_5 = 1; i_5 < -i_0+PB_P-2; i_5++) {
                for (int i_6 = 0; i_6 < min(-i_5+PB_M, -i_0+PB_P); i_6++) {
                    B[i_5][i_4+i_0][i_6][i_5-1] = E[i_6+i_5][i_4+i_0-1][i_4] + B[i_4][i_5+i_0+2][i_6][i_4-1] * B[i_5][i_6+i_0][i_4][i_5-1] + 2;
                }
            }
        }
    }
...
kernel_4212231225_02(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
