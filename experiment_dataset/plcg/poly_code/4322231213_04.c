...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_M-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < min(PB_M, -i_0+PB_N); i_3++) {
                    A[i_0][i_1][i_2+1][i_3] = D[i_3][i_1+i_0+1][i_2][i_0] - D[i_3+i_0][i_2+1][i_1][i_1-1] + D[i_3][i_0-1][i_1+1][i_2] - E[i_3][i_1][i_0][i_2-1] - A[i_0][i_2-1][i_3][i_1] - 4;
                }
            }
        }
    }
    ...
    for (int i_5 = 1; i_5 < PB_M; i_5++) {
        B[i_5-1] = F[i_5] - F[i_5] - F[i_5] + F[i_5] - B[i_5] * 1;
    }
#pragma endscop
...
kernel_4322231213_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F));
