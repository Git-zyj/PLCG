...
void kernel_4236251315_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P-1; i_0++) {
        for (int i_1 = i_0; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_0+PB_N-1, -i_1+PB_P); i_2++) {
                A[i_2+i_0][i_1][i_2] = C[i_2][i_0][i_0] * D[i_0][i_1][i_2+1][0] * E[i_0][i_2+i_1][i_0-1] + E[i_1][i_0+1][i_2] + F[i_0][i_1] * A[i_2+i_0+1][i_1][i_2] + A[i_2+i_0-1][i_1][i_2] - A[i_2+i_0+1][i_1][i_0+1] - 5;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_L-1; i_3++) {
        for (int i_4 = 1; i_4 < PB_L; i_4++) {
            for (int i_5 = 0; i_5 < min(i_4, PB_L-1); i_5++) {
                B[i_3][i_4][i_5] = G[i_5][i_4] - C[i_3][i_4-1][i_5] * C[i_4][i_5+1][i_3-1] + C[i_4-1][i_3][i_5] + E[i_4][i_3+1][i_5] + B[i_3][i_4][i_5+1] * B[i_4][i_3+1][i_5+1] + 5;
            }
        }
    }
#pragma endscop
...
kernel_4236251315_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
