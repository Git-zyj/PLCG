...
void kernel_2232112225_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_M+1; i_0++) {
        ...
        for (int i_2 = 2; i_2 < PB_M-1; i_2++) {
            B[i_2-1] = C[i_2][i_0-1] * B[i_2-2] - B[i_2+1] * 3;
        }
    }
#pragma endscop
...
kernel_2232112225_00(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
