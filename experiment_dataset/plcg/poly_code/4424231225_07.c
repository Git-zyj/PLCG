...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < min(i_0, PB_P-1); i_1++) {
            for (int i_2 = 2; i_2 < -i_1+PB_L; i_2++) {
                for (int i_3 = 0; i_3 < PB_L; i_3++) {
                    A[i_2][i_3][i_2][0] = E[i_3][i_0][i_2+i_1][i_1+1] + A[i_2-2][i_3][i_2-2][0] + 1;
                }
            }
        }
    }
    for (int i_4 = 3; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 1; i_5 < PB_N-3; i_5++) {
            B[i_5+1] = F[i_5+1][i_4] - B[i_5+2] + B[i_5+3] - B[i_5] + B[i_5-1] + 3;
        }
        for (int i_6 = 1; i_6 < i_4; i_6++) {
            for (int i_7 = 1; i_7 < i_4; i_7++) {
                for (int i_8 = 2; i_8 < min(-i_7+PB_L, -i_4+PB_L); i_8++) {
                    A[i_8-2][i_4][i_8-2][0] = E[i_6][i_7-1][i_8+i_4][i_4] + G[i_8][i_7][0] * G[i_8-1][i_6][i_8+i_7] + E[i_4+1][i_7+1][i_8][0] * H[i_8][i_7][i_7+1][i_6-1] - 2;
                }
            }
        }
        D[i_4-1] = I[i_4][i_4+1] * J[i_4] + K[i_4] + D[i_4-3] + 6;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4424231225_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K)));
