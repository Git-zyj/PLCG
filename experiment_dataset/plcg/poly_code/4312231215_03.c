...
void kernel_4312231215_03(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
        ...
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_M; i_2++) {
                for (int i_3 = i_2; i_3 < PB_M; i_3++) {
                    B[i_3][i_0+1][i_1] = D[0][i_3][i_0][i_1] + E[i_2][i_0][i_1][i_0] - E[i_1][i_3][i_0][i_2] + 6;
                }
            }
            for (int i_4 = 1; i_4 < -i_1+PB_M+1; i_4++) {
                B[i_1][i_4][i_0] = F[i_1][i_0][i_4+i_1-1] + F[i_0][i_4][1] - F[i_4+1][i_1+1][i_0+1] - F[i_4-1][i_0][i_1] - B[i_0-1][i_4-1][i_1] + B[i_1-1][i_4][i_0] + 3;
            }
        }
        for (int i_5 = i_0; i_5 < PB_L-1; i_5++) {
            for (int i_6 = 1; i_6 < PB_L; i_6++) {
                B[i_0][i_5][i_6-1] = G[i_6][i_5+1][i_0] - 2;
            }
        }
    }
#pragma endscop
...
init_array(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4312231215_03(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G)));
