...
void kernel_3312112115_07(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N+1; i_0++) {
        for (int i_1 = 1; i_1 < PB_N+1; i_1++) {
            C[i_1-1] = D[i_0] * C[i_1-1] - 4;
...
kernel_3312112115_07(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
