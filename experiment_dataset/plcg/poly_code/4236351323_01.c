...
void kernel_4236351323_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_M-3; i_1++) {
            for (int i_2 = 0; i_2 < min(i_0, -i_1+PB_M-3); i_2++) {
                A[i_2+i_1+1][i_0][i_2] = C[i_1][i_0][i_2] + D[i_0][i_1-1][i_1] * D[i_0][i_0][i_1+1] * C[i_0][i_2][i_1+1] * A[i_2+i_1+3][i_0][i_2+2] - 5;
            }
        }
        for (int i_3 = max(2, i_0); i_3 < -i_0+PB_L-1; i_3++) {
            for (int i_4 = 0; i_4 < min(-i_0+PB_M, -i_3+PB_L); i_4++) {
                for (int i_5 = 1; i_5 < min(-i_0+PB_M, -i_3+PB_M); i_5++) {
                    B[i_4][i_5+i_3][i_0] = E[i_5+i_4][i_0][i_3][i_0] - E[i_5][i_4][i_0+1][i_5] - E[i_3-1][i_5-1][i_4+i_3][0] + F[i_0][i_4][i_3-1][i_5] * E[i_5][i_3+i_0+1][i_4+1][i_0] + D[i_4+1][i_5+i_3][1] - B[i_4][i_5+i_0][i_3-2] - B[i_5][i_4+i_0][i_3-1] - B[i_5][i_3+i_0][i_4+1] * B[i_5][i_4+i_0-1][i_3-1] - 1;
                }
            }
        }
    }
...
kernel_4236351323_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
