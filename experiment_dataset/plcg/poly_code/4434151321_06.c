...
void kernel_4434151321_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,int wg,DATA_TYPE POLYBENCH_5D(G,xG,yG,zG,vG,wG,xg,yg,zg,vg,wg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
            for (int i_2 = i_1; i_2 < min(-i_0+PB_L-2, -i_1+PB_Q-1); i_2++) {
                for (int i_3 = i_1; i_3 < -i_0+PB_L-1; i_3++) {
                    A[i_2-1][i_3+i_0+1][i_3][i_1-1] = E[i_1+1][i_3+1][i_1-1][i_2] + E[i_2][i_0][i_1][1] - E[i_3+1][i_3][i_1+1][i_2+i_1+1] - F[i_3+1][i_2-1][i_1-1] * G[i_3][i_1][i_2][i_3][0] - A[i_3-1][i_2+i_0+2][i_2][i_1-1] - 4;
                }
            }
        }
    }
    for (int i_4 = 3; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 2; i_5 < min(-i_4+PB_M, PB_L-2); i_5++) {
            B[i_4][i_5] = H[i_5][i_4-1] * H[i_4][i_5] * H[i_4][i_5] - H[i_5+i_4][1] + H[i_5][i_4-1] - B[i_4][i_5+2] + B[i_4+2][i_5] + B[i_5-2][i_4] - C[i_4+1][i_5+2] - 3;
            C[i_4-1][i_5+1] = H[i_5-1][i_4+1] + H[i_5][i_4] - I[i_5] - B[i_4][i_5-1] - B[i_5][i_4] + C[i_4-1][i_5+2] + 6;
        }
        for (int i_6 = 1; i_6 < min(i_4, -i_4+PB_M-1); i_6++) {
            D[i_4][i_6-1] = H[i_6][1] + H[i_6][i_4] * H[i_6+i_4+1][0] * H[i_6][i_4] + H[i_4][i_6] + H[i_6-1][i_4+1] * H[i_4][i_6] * D[i_4-1][i_6+1] + D[i_6-1][i_4-3] - D[i_6][i_4] * 2;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4434151321_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I)));
