    ...
    for (int i_4 = 1; i_4 < PB_Q; i_4++) {
        for (int i_5 = 2; i_5 < PB_P-2; i_5++) {
            for (int i_6 = 1; i_6 < -i_5+PB_P-2; i_6++) {
                for (int i_7 = 1; i_7 < min(min(i_4, -i_4+PB_P-1), PB_L-2); i_7++) {
                    B[i_4-1][i_6+i_5][i_7-1][i_6] = D[i_7][i_6][i_4][i_5-2] + C[i_6+1][i_6-1][i_7+2][i_4] * B[i_4-1][i_6+i_5+2][i_7-1][i_6] + B[i_5-1][i_7+i_4+1][i_6+1][i_7] * 3;
                }
            }
        }
    }
...
kernel_4226232225_09(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E));
