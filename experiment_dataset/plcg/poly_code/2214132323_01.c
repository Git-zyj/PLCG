...
void kernel_2214132323_01(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-3; i_0++) {
        B[i_0+1][i_0] = C[i_0+1][2] + D[i_0] + D[i_0] * D[i_0] * B[i_0+2][i_0+1] - B[i_0+1][i_0] * 3;
        B[i_0+1][i_0] = D[i_0] + D[i_0] + B[i_0+3][i_0+2] - 6;
    }
#pragma endscop
...
kernel_2214132323_01(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
