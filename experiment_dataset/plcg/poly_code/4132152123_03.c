...
void kernel_4132152123_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
...
kernel_4132152123_03(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
