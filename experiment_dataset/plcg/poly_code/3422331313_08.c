...
void kernel_3422331313_08(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P; i_0++) {
        for (int i_1 = 0; i_1 < -i_0+PB_Q; i_1++) {
            for (int i_2 = 1; i_2 < PB_P; i_2++) {
                B[i_0][i_2][i_1+i_0] = E[i_2][i_1][i_0] + F[i_2+i_1][i_0-1] - C[i_1+i_0-1][i_2-1][i_2-1] - 3;
            }
        }
        for (int i_3 = 1; i_3 < min(-i_0+PB_Q, PB_P); i_3++) {
            for (int i_4 = 0; i_4 < PB_P; i_4++) {
                B[i_0][i_4][i_3+i_0] = E[i_4][i_3+i_0-1][1] + B[i_0][i_4][i_3+i_0-1] * B[i_3][i_0][i_4+i_3-1] - 6;
            }
        }
    }
    for (int i_5 = 2; i_5 < PB_P; i_5++) {
        for (int i_6 = 1; i_6 < min(-i_5+PB_M-2, PB_P-1); i_6++) {
            for (int i_7 = 2; i_7 < PB_P+1; i_7++) {
                C[i_6+i_5][i_7-1][i_7-1] = G[i_7+1][i_6-1] + E[i_5][i_7-1][i_6+1] - E[i_5][i_7-1][i_6+1] * H[i_7-1][i_5][i_6] * I[i_7][i_5][i_6+1] * C[i_6+i_5+1][i_7-1][i_7-1] - C[i_6+i_5-2][i_7-1][i_7-1] + C[i_6+i_5+1][i_7-2][i_7-2] + C[i_6+i_5-1][i_7-1][i_7-1] + C[i_6+i_5+2][i_7-1][i_7-1] - 5;
            }
        }
    }
    for (int i_8 = 2; i_8 < PB_P; i_8++) {
        for (int i_9 = 0; i_9 < min(-i_8+PB_M, PB_P); i_9++) {
            D[i_8-1][i_9] = G[i_9][i_8] + J[i_8] - K[i_9+i_8][1] + F[i_9][i_8] - D[i_8-2][i_9+1] + 1;
        }
    }
#pragma endscop
...
init_array(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_3422331313_08(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K)));
