        ...
        for (int i_4 = 2; i_4 < -i_3+PB_M; i_4++) {
            for (int i_5 = 1; i_5 < min(-i_3+PB_L, PB_Q-2); i_5++) {
                for (int i_6 = max(1, i_3); i_6 < PB_M; i_6++) {
                    B[i_6][i_5][i_5+1] = D[i_4][i_3][i_5-1][i_4] * D[i_3][i_6][i_5-1][i_4] * D[i_4][i_6][i_4][i_5] * D[i_6+i_4-2][i_5+i_3][i_3][i_4+1] - E[i_5-1][i_4+i_3][i_4-1][i_4][i_5+2] - B[i_6-1][i_5][i_5+1] - B[i_6][i_5-1][i_5] - B[i_5+1][i_6][i_6+1] * B[i_6][i_5+1][i_5+2] + 4;
                }
            }
        }
    }
...
kernel_4224152311_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E));
