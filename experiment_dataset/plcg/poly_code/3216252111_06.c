    ...
    for (int i_3 = 2; i_3 < PB_M; i_3++) {
        for (int i_4 = 1; i_4 < min(-i_3+PB_L, PB_M); i_4++) {
            for (int i_5 = max(i_4, 2); i_5 < -i_4+PB_M; i_5++) {
                B[i_5][i_4][i_4+i_3] = C[i_5+i_4][i_3][i_4] + C[i_5][i_4+i_3][i_3-2] * C[i_5-2][i_3+2][i_4+1] - C[i_3][i_5][i_4] - A[i_4-1][i_5][i_3-1] * A[i_3][i_4][i_5] + 4;
            }
        }
    }
#pragma endscop
...
kernel_3216252111_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
