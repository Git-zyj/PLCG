...
void kernel_2232112115_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
kernel_2232112115_08(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
