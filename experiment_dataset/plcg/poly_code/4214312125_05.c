...
void kernel_4214312125_05(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            B[i_0][i_1] = B[i_0][i_1] * 5;
            for (int i_2 = 0; i_2 < PB_N; i_2++) {
                B[i_2][i_1] = C[i_2][i_0][i_1] - 4;
            }
        }
    }
#pragma endscop
...
kernel_4214312125_05(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
