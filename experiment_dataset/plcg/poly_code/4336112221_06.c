...
void kernel_4336112221_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
    ...
    for (int i_2 = 2; i_2 < PB_L+2; i_2++) {
        for (int i_3 = 2; i_3 < -i_2+PB_L+2; i_3++) {
            for (int i_4 = i_2; i_4 < PB_L; i_4++) {
                C[i_4][i_3][i_2] = D[i_4][i_3+i_2-2] * C[i_4][i_3-2][i_2] * C[i_4][i_3][i_2-2] - 2;
            }
        }
    }
#pragma endscop
...
kernel_4336112221_06(xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
