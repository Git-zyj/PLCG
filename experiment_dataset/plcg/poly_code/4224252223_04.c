        ...
        for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 1; i_2 < PB_M; i_2++) {
                for (int i_3 = 2; i_3 < min(-i_2+PB_M+1, PB_M-2); i_3++) {
                    A[i_3][i_0][i_2][i_1] = C[i_3][i_2][i_0] + D[i_1+2][i_3+2][i_0][i_2+1] * E[i_1+1][i_2][i_1+1][i_0] + E[i_3-2][i_0][i_1][i_0-2] + D[i_3+i_2-1][i_0-2][i_1][i_3] * D[i_3+2][i_2][i_1][i_0] - A[i_3-1][i_0][i_2][i_1-2] + 1;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
            for (int i_6 = 0; i_6 < -i_4+PB_L-2; i_6++) {
                for (int i_7 = 0; i_7 < PB_M-2; i_7++) {
                    A[i_6][i_4][i_5][i_7] = E[i_5][i_6+i_4+2][i_7][i_5] - C[i_4][i_7][i_6] + D[i_4][i_4][i_5][i_6] - F[i_5+1][i_7][i_6] - A[i_7+2][i_4-2][i_5][i_6+1] + 6;
                }
            }
        }
    }
...
kernel_4224252223_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
