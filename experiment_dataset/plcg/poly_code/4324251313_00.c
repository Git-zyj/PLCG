...
void kernel_4324251313_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < PB_P-1; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_0+PB_Q, -i_1+PB_P-1); i_2++) {
                for (int i_3 = i_0; i_3 < PB_L-1; i_3++) {
                    A[i_1-1][i_0+1][i_0][i_3] = D[i_1][i_3+1][i_0][i_3] - E[i_1][i_2][i_0][i_0][i_1+1] + F[i_1][i_3+1][0] + G[i_3-1][i_0][i_1+1][i_2+i_0] - D[i_3][i_0+1][i_2+i_1+1][i_1-1] - D[i_3][i_0+1][i_3][i_1] + A[i_1][i_0+2][i_0+1][i_3+1] - 2;
                }
            }
        }
        for (int i_4 = 0; i_4 < PB_L-1; i_4++) {
            for (int i_5 = 2; i_5 < PB_L; i_5++) {
                for (int i_6 = 0; i_6 < min(-i_4+PB_Q-1, -i_0+PB_Q-1); i_6++) {
                    B[i_0][i_6][i_5-1][i_6+i_4] = G[i_5-1][i_4][i_0+1][i_6] - H[i_6][i_4+1][i_5] + H[i_0-1][i_4][i_6+1] * D[i_4+1][i_0+1][i_6][i_5] * B[i_4][i_0+1][i_5-2][i_6+i_0+1] + B[i_0][i_6][i_5-2][i_6+i_4] + B[i_0-1][i_6][i_5-1][i_6+i_4] + B[i_0][i_4][i_5-2][i_6+i_4] * B[i_0][i_6+1][i_5-1][i_6+i_4+1] - 5;
                }
            }
        }
    }
    for (int i_7 = 1; i_7 < PB_L; i_7++) {
        for (int i_8 = 2; i_8 < PB_L-1; i_8++) {
            for (int i_9 = 0; i_9 < min(min(i_8, -i_7+PB_M), -i_8+PB_L-1); i_9++) {
                A[i_8-2][i_9+1][i_9][i_7] = H[i_9+i_7][i_9+i_8+1][i_7] * H[i_7][i_9+1][i_7] - F[i_9+i_8][i_7-1][i_9+1] - F[i_9][i_8][0] - 3;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4324251313_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H)));
