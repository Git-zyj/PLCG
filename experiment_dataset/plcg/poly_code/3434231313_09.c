...
void kernel_3434231313_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        A[i_0] = E[i_0] - E[i_0] * F[i_0][0] * A[i_0-1] + 3;
    }
    for (int i_1 = 2; i_1 < PB_M-1; i_1++) {
        for (int i_2 = 0; i_2 < -i_1+PB_M-1; i_2++) {
            B[i_2+i_1-1][i_2+i_1-1] = G[i_2][1] + G[i_1+1][1] + G[i_1-1][i_2] - A[i_2] + B[i_2+i_1-2][i_2+i_1-2] - B[i_2+i_1-2][i_2+i_1-2] * B[i_2+i_1+1][i_2+i_1+1] * B[i_2+i_1-1][i_2+i_1-1] + B[i_2+i_1-2][i_2+i_1-2] - 4;
        }
        D[i_1-1] = E[i_1+1] + H[i_1] - E[i_1] + 1;
        D[i_1-1] = H[i_1+1] * H[i_1] * D[i_1-2] + 1;
    }
#pragma endscop
...
kernel_3434231313_09(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
