...
void kernel_4222312225_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
        ...
        for (int i_1 = i_0; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < PB_P-3; i_2++) {
                for (int i_3 = 0; i_3 < PB_M-2; i_3++) {
                    A[i_3][i_1][i_2+2][i_0] = A[i_3+2][i_1][i_2+1][i_0] * A[i_3][i_1][i_2+3][i_0-1] + 4;
                }
            }
        }
        for (int i_4 = 0; i_4 < PB_M-3; i_4++) {
            B[i_4+1] = C[i_4][i_0] + B[i_4+3] - 6;
        }
    }
#pragma endscop
...
kernel_4222312225_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
