...
void kernel_4414352225_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,int zk,int vk,DATA_TYPE POLYBENCH_4D(K,xK,yK,zK,vK,xk,yk,zk,vk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < PB_M-1; i_1++) {
            A[i_1][i_0] = E[i_0][i_0] + F[i_1][i_0] + G[i_0][i_1+1] * G[i_1][i_0] + A[i_1+1][i_0] * 2;
        }
    }
        ...
        for (int i_3 = 2; i_3 < i_2; i_3++) {
            for (int i_4 = 0; i_4 < PB_M-2; i_4++) {
                for (int i_5 = 4; i_5 < PB_M-2; i_5++) {
                    B[i_5][i_3-2][i_4] = H[i_5][i_4][i_3][i_2] * H[i_5+1][i_3][i_2+1][i_4+2] - I[i_4+2][i_5+2][i_4][i_2] - B[i_4][i_3-2][i_5+2] + B[i_3][i_5-4][i_4] * B[i_5][i_3-1][i_4] - 3;
                }
            }
        }
        for (int i_6 = 2; i_6 < PB_L-2; i_6++) {
            for (int i_7 = max(2, i_2); i_7 < PB_M-1; i_7++) {
                for (int i_8 = 2; i_8 < -i_6+PB_M; i_8++) {
                    B[i_7+1][i_6-2][i_8-2] = J[i_8][i_6+2][0] * K[i_8+i_6][i_7][i_2][i_2+1] + I[i_2][i_2+2][i_8+i_6-2][i_7] * K[i_8][i_7+1][i_6][i_6] - K[i_7-1][i_8][i_2+2][i_7] + I[i_7][i_2][i_8][i_6] - J[i_7-2][i_8-2][i_6-2] + 5;
                }
            }
            for (int i_9 = 1; i_9 < -i_6+PB_M; i_9++) {
                B[i_2][i_6-2][i_9] = L[i_9-1][i_6][i_2] - L[i_6][i_9][i_2] - J[i_9+i_6][i_2][1] - 3;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4414352225_04(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L)));
