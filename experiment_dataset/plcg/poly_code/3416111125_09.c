...
void kernel_3416111125_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 0; i_1 < min(-i_0+PB_M-1, i_0); i_1++) {
            A[i_1] = E[i_1][i_0] + B[i_1+i_0+1][i_0] - B[i_1+i_0-1][i_0-2] + 5;
            B[i_1+i_0+1][i_0] = E[i_1][i_0] * 2;
        }
        for (int i_2 = i_0; i_2 < -i_0+PB_M-1; i_2++) {
            B[i_2+i_0+1][i_0] = E[i_2+1][i_0-1] + 1;
        }
    }
...
kernel_3416111125_09(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
