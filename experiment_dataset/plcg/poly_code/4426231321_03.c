...
void kernel_4426231321_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M-1; i_0++) {
        A[i_0-1] = E[i_0] * A[i_0+1] * A[i_0-2] * A[i_0-3] - 2;
    }
    for (int i_1 = 0; i_1 < PB_P-1; i_1++) {
        for (int i_2 = 1; i_2 < PB_Q-1; i_2++) {
            for (int i_3 = 0; i_3 < PB_M-1; i_3++) {
                for (int i_4 = 1; i_4 < i_1; i_4++) {
                    B[i_3][i_4][i_1+1][i_2+1] = F[i_4][i_4][i_1][i_2] * G[i_3][i_4][i_2] + H[i_4-1][i_1][i_3][i_2] * B[i_3+1][i_4][i_1+1][i_2+1] * B[i_2-1][i_1][i_3+1][i_4+1] + 6;
                }
            }
        }
    }
    for (int i_5 = 2; i_5 < PB_M-1; i_5++) {
        for (int i_6 = i_5; i_6 < PB_M; i_6++) {
            for (int i_7 = i_5; i_7 < PB_Q-2; i_7++) {
                C[i_5-1][i_6][i_7] = G[i_6][i_5][i_7] * G[i_7][i_6][i_7+1] + C[i_6-1][i_5][i_7+2] * 6;
            }
        }
        for (int i_8 = 1; i_8 < PB_M-1; i_8++) {
            for (int i_9 = 1; i_9 < min(PB_M-1, -i_8+PB_M+1); i_9++) {
                D[i_5][i_8-1][i_5] = I[i_9-1][i_5-1][i_8] + G[i_8][i_5][i_9] + G[i_9+i_8-1][i_5][i_5+1] + F[i_9+1][i_8+1][i_5+1][0] - J[i_5+1][i_8] - F[i_8-1][i_9][i_5][i_5] * D[i_5][i_8][i_5] * D[i_5][i_8+1][i_5] - D[i_5-2][i_8-1][i_5-2] + 4;
            }
        }
    }
#pragma endscop
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4426231321_03(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J)));
