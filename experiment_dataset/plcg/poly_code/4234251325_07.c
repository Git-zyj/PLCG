...
void kernel_4234251325_07(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf)){
        ...
        for (int i_1 = i_0; i_1 < PB_P; i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_P; i_2++) {
                for (int i_3 = 2; i_3 < PB_M-1; i_3++) {
                    B[i_3-2][i_1-1][i_2][i_2+i_0] = C[i_2][i_3][i_0-1][i_1] * D[i_1][i_0+1][i_2+1][i_2+1] * D[i_3+1][i_0-1][i_1][i_2] - D[i_3+1][i_2-1][0][i_0] + 3;
                }
            }
        }
    }
        ...
        for (int i_5 = i_4; i_5 < PB_P; i_5++) {
            for (int i_6 = 0; i_6 < -i_4+PB_P-2; i_6++) {
                for (int i_7 = 1; i_7 < PB_P-1; i_7++) {
                    B[i_5][i_7][i_6][i_6+i_4] = E[i_4+1][i_7-1][i_6] + E[i_6+1][i_7][0] * C[i_6][i_7][i_5][i_4-1] * D[i_4][i_6][i_7+1][i_5] + C[i_6][i_4][i_7][i_5-1] - F[i_4-1][i_5][i_7+i_6][i_4+1][i_6] + B[i_5-1][i_7][i_6][i_6+i_4] + B[i_5][i_7][i_6+2][i_6+i_4+2] - B[i_7][i_5][i_6+2][i_6+i_4] - 1;
                }
            }
        }
    }
...
kernel_4234251325_07(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F));
