...
void kernel_3312212321_03(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
...
#pragma scop
    for (int i_0 = 4; i_0 < PB_L+1; i_0++) {
        ...
        for (int i_2 = 3; i_2 < PB_L+1; i_2++) {
            B[i_0-2][i_2-1] = B[i_0-4][i_2-1] - B[i_0-1][i_2-1] * B[i_0-2][i_2-3] + 1;
        }
    }
    for (int i_3 = 1; i_3 < PB_L-2; i_3++) {
        for (int i_4 = 2; i_4 < i_3; i_4++) {
            for (int i_5 = 2; i_5 < PB_L+1; i_5++) {
                C[i_4][i_3][i_5-1] = D[i_5][i_4][i_3] + C[i_4+1][i_3+2][i_5-1] - C[i_4][i_3-1][i_5-1] - C[i_4-2][i_3+1][i_5-2] - 3;
            }
        }
    }
#pragma endscop
...
kernel_3312212321_03(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
