...
void kernel_4336111311_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < min(i_0, -i_0+PB_Q-1); i_2++) {
                for (int i_3 = 1; i_3 < PB_P; i_3++) {
                    A[i_0][i_1][i_2+i_0][i_3] = D[i_1][i_0+1][i_3-1][i_2+1] * A[i_0][i_1][i_2+i_0+1][i_3-1] - A[i_0-1][i_3][i_2+i_0][i_1-1] + 1;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        B[i_4] = E[i_4] - E[i_4] + B[i_4-1] * B[i_4+1] - 5;
    }
    for (int i_5 = 0; i_5 < PB_L-1; i_5++) {
        for (int i_6 = 1; i_6 < PB_M-2; i_6++) {
            for (int i_7 = 0; i_7 < min(i_5, PB_M-1); i_7++) {
                for (int i_8 = 0; i_8 < min(min(-i_6+PB_P-2, -i_7+PB_P-2), PB_M-1); i_8++) {
                    C[i_8+1][i_6][i_5][i_8+i_6+1] = C[i_8+1][i_7+1][i_5+1][i_8+i_7+2] * C[i_6+2][i_8][i_5][i_8+i_6+2] - C[i_8+1][i_6-1][i_5][i_8+i_6] + 2;
                }
            }
        }
    }
...
kernel_4336111311_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
