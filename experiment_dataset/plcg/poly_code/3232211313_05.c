...
void kernel_3232211313_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        for (int i_1 = 1; i_1 < PB_N-1; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_0+PB_M, i_0); i_2++) {
                A[i_1][i_2+i_0][i_2] = A[i_1+1][i_2+i_0-1][i_0] - A[i_1+1][i_2+i_0][i_2] - A[i_1-1][i_2+i_0][i_2] + A[i_1-1][i_2+i_0-1][i_0] - 4;
            }
        }
    }
    for (int i_3 = 2; i_3 < PB_M+1; i_3++) {
        for (int i_4 = 0; i_4 < PB_M-1; i_4++) {
            B[i_3-1][i_4][i_4] = C[i_4+1][i_3] - B[i_3-2][i_4][i_4] * B[i_3-1][i_4+1][i_4+1] + 4;
        }
    }
#pragma endscop
...
kernel_3232211313_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
