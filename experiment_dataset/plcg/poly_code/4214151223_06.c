...
void kernel_4214151223_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
    ...
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        for (int i_1 = 2; i_1 < min(-i_0+PB_M-1, PB_L); i_1++) {
            for (int i_2 = 1; i_2 < min(min(-i_0+PB_L, -i_1+PB_L), i_1); i_2++) {
                A[i_1+i_0+1][i_1-1][i_0] = C[i_2+i_1][i_0][i_1] - C[i_1][i_0][i_0] + C[i_2][i_1][i_0] * C[i_2-1][i_0][i_1] * C[i_1][i_0][i_2] - D[i_2+i_0][i_1] * D[i_0][i_1] + C[i_2][i_0][i_1] + A[i_1+i_0][i_1-2][i_0] - 5;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_L+1; i_3++) {
        for (int i_4 = i_3; i_4 < min(-i_3+PB_M-3, PB_L+1); i_4++) {
            for (int i_5 = 0; i_5 < PB_Q; i_5++) {
                A[i_4+i_3+3][i_3-1][i_4+2] = C[i_4-1][i_3][i_5] + A[i_4+i_3+1][i_3-1][i_4] * 6;
            }
        }
    }
#pragma endscop
...
kernel_4214151223_06(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
