...
void kernel_4434252215_08(int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 0; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 2; i_2 < min(-i_1+PB_L, PB_L-1); i_2++) {
                for (int i_3 = max(2, i_1); i_3 < min(min(PB_M, -i_2+PB_M+2), -i_1+PB_Q); i_3++) {
                    C[0][i_2][i_3] = E[i_1][i_0-2][i_3-2][i_2] + F[i_2][i_1][i_0][i_2][i_0] * G[i_2][i_0][i_2+i_1][i_1] + E[i_2][i_0][i_1][i_0] - E[i_0][i_2][i_3][i_2+i_1] * E[i_1][i_3+i_2-2][i_0][1] - G[i_2+1][i_3+2][i_3+i_1][i_0] + G[i_0][i_2+1][i_3][i_1+1] - G[i_1][i_3+i_2][i_0][1] + E[i_3][i_1][i_2-2][i_3] - E[i_3][i_1+1][i_3-1][i_0+2] + G[i_2+i_1][i_0][i_3][0] + 6;
                }
            }
        }
        B[i_0+1] = H[i_0+1] + H[i_0] * I[i_0-1] + B[i_0+2] - 6;
    }
    for (int i_4 = 1; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 0; i_5 < i_4; i_5++) {
            for (int i_6 = 1; i_6 < PB_M; i_6++) {
                C[0][i_5+1][i_6] = J[i_6][i_4+2][i_5] * J[i_5][i_4][i_6] + C[0][i_5][i_6-1] + C[0][i_5+2][i_6+1] - C[0][i_5][i_6] - 2;
            }
        }
        for (int i_7 = 0; i_7 < PB_M; i_7++) {
            D[i_4][i_7] = K[i_7][i_4] + K[i_7][i_4] * L[i_7][i_4] - D[i_4-1][i_7] + 5;
        }
    }
#pragma endscop
...
init_array(xc,yc,zc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4434252215_08(xc,yc,zc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L));
