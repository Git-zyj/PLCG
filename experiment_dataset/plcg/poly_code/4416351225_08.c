...
void kernel_4416351225_08(int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,int wg,DATA_TYPE POLYBENCH_5D(G,xG,yG,zG,vG,wG,xg,yg,zg,vg,wg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_1+PB_Q+1, i_0); i_2++) {
                for (int i_3 = 1; i_3 < min(min(PB_Q, -i_0+PB_P+1), -i_2+PB_M); i_3++) {
                    D[i_2][i_0+1][i_3-1][i_1] = E[i_3][i_3][i_0-1][i_2+i_1-1] * F[i_2][i_1][i_0] - G[i_1][i_2][i_0][i_1][0] + F[i_3][i_1+1][i_2] * H[i_1][i_3+i_0-1][i_2][0] * I[i_1][i_3+i_2][i_0-1][i_0] * E[i_1][i_3][i_2-1][i_1] + H[i_2][i_0+1][i_3][i_1] + 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L; i_4++) {
        for (int i_5 = 1; i_5 < min(i_4, PB_L-3); i_5++) {
            B[i_4-1][i_5] = J[i_4+1][i_5] - K[i_5-1][i_4] - B[i_4][i_5] * B[i_4+1][i_5] - 6;
            for (int i_6 = 2; i_6 < -i_5+PB_L; i_6++) {
                for (int i_7 = i_4; i_7 < PB_Q; i_7++) {
                    D[i_7][i_5+1][i_6-1][i_4] = E[i_6][i_4][i_5-1][i_7] + H[i_5-1][i_4+1][i_5+1][i_7] - 2;
                }
                for (int i_8 = 0; i_8 < -i_5+PB_L; i_8++) {
                    D[i_8][i_5+1][i_6-1][i_4] = E[i_6][i_5-1][i_8][i_4] + H[i_6+i_5][i_4][i_8][i_6] + G[i_4][i_8+i_5][i_6][i_5][i_4] + E[i_4+1][i_8][i_5][i_6+1] + H[i_8][i_6][i_6][i_5] + H[i_6+1][i_8][i_4][i_5] - D[i_8][i_5+3][i_6-2][i_4] - 5;
                }
            }
        }
    }
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4416351225_08(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K)));
