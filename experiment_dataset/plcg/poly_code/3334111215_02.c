...
void kernel_3334111215_02(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        for (int i_1 = 2; i_1 < PB_M+2; i_1++) {
            C[i_0-1] = C[i_0-1] - C[i_1-2] - 1;
        }
...
kernel_3334111215_02(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
