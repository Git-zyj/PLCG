...
void kernel_3334112223_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            B[i_1-1] = D[i_1-1] * B[i_0+1] - B[i_1] - 4;
        }
        B[i_0] = D[i_0-2] + 2;
    }
...
kernel_3334112223_05(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
