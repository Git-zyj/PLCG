...
void kernel_4416352311_01(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,DATA_TYPE POLYBENCH_1D(M,xM,xm),int xn,int yn,int zn,DATA_TYPE POLYBENCH_3D(N,xN,yN,zN,xn,yn,zn)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 2; i_1 < -i_0+PB_M-1; i_1++) {
            A[i_1+i_0][i_0] = E[i_0][i_1][0] + F[i_1+i_0][i_1] - F[i_0][2] - A[i_1+i_0+1][i_0] * 6;
            for (int i_2 = 2; i_2 < -i_0+PB_L-1; i_2++) {
                for (int i_3 = i_1; i_3 < -i_0+PB_L; i_3++) {
                    B[i_0][i_1-2][i_2][i_3] = G[i_2-1][i_0-1][i_3][i_1-2] - H[i_1-1][i_2][i_0+1][1] * I[0][i_1][i_3] - J[i_1][i_3+i_0][i_0][i_1+1] + J[i_1][i_2+i_0+1][i_0+1][i_0+2] - B[i_0-1][i_1-2][i_2][i_3] + B[i_0][i_1-2][i_2+1][i_3-1] + B[i_0][i_2-2][i_1][i_3+1] - 6;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-1; i_4++) {
        C[i_4] = K[i_4-2] * F[i_4+1][2] - L[i_4] * M[i_4+1] + C[i_4+1] * 5;
        for (int i_5 = 2; i_5 < PB_N-2; i_5++) {
            for (int i_6 = 2; i_6 < -i_5+PB_N-2; i_6++) {
                D[i_6+i_5][i_4][i_6] = E[i_6-2][i_4-2][i_5] - N[i_5-2][i_4][2] - I[i_5][i_4-2][i_6-1] - I[i_6-1][i_5][i_4] * N[i_6][i_6-1][0] + E[i_4][i_6][i_5-1] + D[i_6+i_5+2][i_4][i_5+1] + D[i_6+i_5-1][i_4-1][i_6-1] - D[i_6+i_5][i_4+1][i_6+1] + D[i_6+i_5-1][i_4-1][i_6] * D[i_6+i_5-1][i_4][i_6] - 2;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,POLYBENCH_ARRAY(M), xn,yn,zn,POLYBENCH_ARRAY(N), INIT_SEED);
kernel_4416352311_01(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,POLYBENCH_ARRAY(M), xn,yn,zn,POLYBENCH_ARRAY(N));
