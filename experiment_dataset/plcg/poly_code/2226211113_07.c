...
void kernel_2226211113_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N; i_0++) {
        A[i_0-1] = A[i_0] + 1;
        for (int i_1 = min(PB_M, i_0) - 1; i_1 >= 1; i_1--) {
            A[i_1-1] = C[i_1] + 4;
        }
    }
#pragma endscop
...
kernel_2226211113_07(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
