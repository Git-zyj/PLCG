...
void kernel_2216211323_05(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_N - 1; i_0 >= 2; i_0--) {
        for (int i_1 = 3; i_1 < i_0; i_1++) {
            B[i_0-2][i_1+1] = C[i_0][i_1] * B[i_0-1][i_1+1] + B[i_1-3][i_0+1] + B[i_0][i_1+1] - 5;
            B[i_0-1][i_1+1] = 1;
        }
    }
#pragma endscop
...
kernel_2216211323_05(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
