...
void kernel_2412331113_01(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        B[i_0-2] = E[i_0-1] * F[i_0-1] + F[i_0] + G[i_0] * F[i_0-1] + 2;
        B[i_0-1] = 6;
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            C[i_1][i_0] = H[i_1][i_0] - H[i_1][i_0] - B[i_1-1] - 3;
        }
    }
    for (int i_2 = 2; i_2 < PB_L; i_2++) {
        D[i_2-1] = E[i_2] + G[i_2-1] - B[i_2] + D[i_2-2] + 1;
    }
#pragma endscop
...
kernel_2412331113_01(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
