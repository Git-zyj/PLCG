...
void kernel_2232311125_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N; i_0++) {
        for (int i_1 = 0; i_1 < -i_0+PB_N; i_1++) {
            B[i_1] = C[i_1+i_0] * B[i_0] - 2;
        }
        B[i_0] = C[0] + 4;
    }
#pragma endscop
...
kernel_2232311125_09(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
