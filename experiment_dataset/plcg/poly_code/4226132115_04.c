...
void kernel_4226132115_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_M, i_1); i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_M; i_3++) {
                    A[i_2][i_0-2][i_1][i_0] = C[i_1-1][i_0-1][i_2][i_1+1] - C[i_3+i_0][i_2][i_0][i_1-1] + C[i_2+i_0][i_3][i_1][i_1] * A[i_2-1][i_0-2][i_1][i_0] * 6;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M; i_4++) {
        for (int i_5 = 1; i_5 < PB_M-2; i_5++) {
            for (int i_6 = 2; i_6 < min(-i_4+PB_N, PB_M-2); i_6++) {
                A[i_5-1][i_6-2][i_4][i_6] = D[i_5][i_6][i_4] - D[i_4][i_6][i_5] + D[i_6+i_4][i_5+2][i_6+2] + 3;
            }
        }
    }
#pragma endscop
...
kernel_4226132115_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
