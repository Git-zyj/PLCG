...
void kernel_4426252321_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
        ...
        for (int i_1 = 1; i_1 < min(-i_0+PB_L, PB_P-2); i_1++) {
            for (int i_2 = 0; i_2 < min(PB_M, -i_1+PB_Q); i_2++) {
                for (int i_3 = i_0; i_3 < -i_1+PB_M-1; i_3++) {
                    A[i_0+1][i_2][0][i_1+2] = E[i_3+i_1+1][i_0][i_2][i_1-1] - E[i_0-1][i_3-1][i_1][i_2+i_1] * F[i_2+2][i_3][i_0+1][0][i_1] + E[i_3+1][i_1+i_0][i_3+1][i_0] + A[i_0][i_2][0][i_1+2] + 1;
                }
            }
        }
        for (int i_4 = 1; i_4 < min(-i_0+PB_M, i_0); i_4++) {
            B[i_0][i_4] = G[i_0-2][i_4+i_0] + H[i_4][i_0] * I[i_0][i_4][0] + J[i_0] - J[i_0] * B[i_0-2][i_4] + B[i_0+2][i_4] + D[i_4-1][i_4+1] + 1;
        }
    }
    for (int i_5 = 1; i_5 < PB_M-2; i_5++) {
        for (int i_6 = 0; i_6 < min(-i_5+PB_P, i_5); i_6++) {
            C[i_5][i_6] = H[i_6+1][i_5] - G[i_6][i_5+2] * G[i_6][i_5-1] * G[i_5][i_6+2] - H[i_5][i_6+i_5] + C[i_5+1][i_6] * C[i_5][i_6+1] - 3;
        }
    }
    for (int i_7 = 0; i_7 < PB_M-2; i_7++) {
        for (int i_8 = 3; i_8 < i_7; i_8++) {
            D[i_8-1][i_8+1] = G[i_8][i_7+1] + H[i_8][i_7] - G[i_8][i_7+2] + G[i_7][i_8] + G[i_8][i_7] + J[i_8] - D[i_8-3][i_8-1] - D[i_8-2][i_8] - D[i_8+1][i_8+3] * 6;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4426252321_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J)));
