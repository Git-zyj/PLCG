    ...
    for (int i_3 = 0; i_3 < PB_P-1; i_3++) {
        for (int i_4 = 0; i_4 < min(PB_N, -i_3+PB_M); i_4++) {
            for (int i_5 = 2; i_5 < i_4; i_5++) {
                C[i_4][i_5] = H[i_4][i_5-1][i_3] * F[i_5][i_4+i_3] + G[i_5+1][i_3+1][i_4+i_3] * H[i_5+1][i_3][i_5] - C[i_4][i_5+1] * C[i_4][i_5-2] + C[i_4+2][i_5] * 2;
            }
        }
    }
    for (int i_6 = 2; i_6 < PB_M-1; i_6++) {
        D[i_6] = E[i_6-1] - E[i_6+1] - D[i_6-2] * 1;
    }
#pragma endscop
...
init_array(xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_3424231225_07(xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H)));
