...
void kernel_4216211221_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
        ...
        for (int i_1 = 0; i_1 < PB_P; i_1++) {
            for (int i_2 = 0; i_2 < PB_P-2; i_2++) {
                for (int i_3 = 0; i_3 < i_2; i_3++) {
                    A[i_2][0][i_1] = A[i_2+2][0][i_1] + A[i_3][0][i_2+2] - 3;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_L-3; i_4++) {
        for (int i_5 = 0; i_5 < PB_L; i_5++) {
            for (int i_6 = max(1, i_5); i_6 < PB_L; i_6++) {
                B[i_6-1][i_4+1][i_6] = C[i_6][i_5] * B[i_6-1][i_4+3][i_6] + 1;
            }
        }
    }
#pragma endscop
...
kernel_4216211221_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
