...
void kernel_3322212321_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_2 = 2; i_2 < PB_P-2; i_2++) {
        C[i_2][i_2] = C[i_2-1][i_2-1] + C[i_2-2][i_2-2] + C[i_2+2][i_2+2] * C[i_2+1][i_2+1] - 6;
    }
#pragma endscop
...
kernel_3322212321_03(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
