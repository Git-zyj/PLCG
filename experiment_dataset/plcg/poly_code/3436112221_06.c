...
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        ...
        for (int i_3 = 2; i_3 < PB_M-3; i_3++) {
            C[i_0][i_3] = F[i_3][i_0] * B[i_3+3][i_0][i_0] * C[i_0+1][i_3-2] * C[i_0][i_3-2] * C[i_0-1][i_3] + 6;
        }
    }
    for (int i_4 = 2; i_4 < PB_P-2; i_4++) {
        for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
            D[i_5][i_4] = F[i_5+1][i_4-1] + D[i_5][i_4-2] * D[i_5][i_4+1] - D[i_5][i_4+2] * 1;
        }
    }
#pragma endscop
...
kernel_3436112221_06(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
