...
void kernel_3132331123_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_L - 1; i_0 >= 0; i_0--) {
        A[1] = B[i_0] + B[i_0] + B[0] + A[1] * 6;
    }
#pragma endscop
...
kernel_3132331123_02(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
