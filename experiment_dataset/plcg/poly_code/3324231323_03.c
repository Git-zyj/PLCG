...
void kernel_3324231323_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
    ...
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        ...
        for (int i_1 = i_0; i_1 < PB_P; i_1++) {
            for (int i_2 = i_0; i_2 < PB_L-1; i_2++) {
                B[i_1+1][i_2] = F[i_2][i_0+1][i_1] - F[i_2][i_0-1][i_1] + G[i_2][i_0][i_1] * G[i_0-1][i_2+1][0] + H[i_1][i_2] * G[i_1][i_2+1][i_0-1] - B[i_1-1][i_2] + B[i_1+1][i_2-1] + B[i_1][i_2] + 2;
            }
        }
        A[i_0] = D[i_0-1] + A[i_0] - A[i_0+1] - 3;
    }
#pragma endscop
...
kernel_3324231323_03(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
