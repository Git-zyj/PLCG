        ...
        for (int i_1 = 1; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 2; i_2 < -i_1+PB_M-2; i_2++) {
                for (int i_3 = 2; i_3 < i_0; i_3++) {
                    A[i_0][i_3][i_2][i_1] = E[i_1+1][i_0][i_3][i_2-2] + F[i_0+2][i_3+2][i_1][i_0][i_2] + E[i_2+i_1+2][i_3-2][i_3-2][i_2] * A[i_0-1][i_3-1][i_2][i_1-1] + A[i_1][i_0-1][i_3][i_2-1] * A[i_0+1][i_3-1][i_2][i_1] + 5;
                }
            }
        }
        for (int i_4 = 2; i_4 < -i_0+PB_L; i_4++) {
            B[i_4-1] = G[i_4][i_4+i_0] - H[i_4+1][i_0+2] - B[i_4] * B[i_4-2] * B[i_4-2] * 3;
        }
    }
        ...
        for (int i_6 = i_5; i_6 < PB_M-2; i_6++) {
            for (int i_7 = 0; i_7 < PB_L; i_7++) {
                for (int i_8 = 0; i_8 < -i_5+PB_L; i_8++) {
                    C[i_6-2][i_8+i_5-1][i_7][i_6] = I[i_8][i_6+2][i_7] * J[i_7][i_5][i_6+2][i_8] * C[i_6-2][i_8+i_5-2][i_7][i_6] * C[i_6-2][i_8+i_5][i_7][i_6] * 6;
                }
            }
        }
        for (int i_9 = 2; i_9 < min(PB_M-3, -i_5+PB_M); i_9++) {
            for (int j_0 = 0; j_0 < min(min(PB_M-3, -i_9+PB_M-3), i_5); j_0++) {
                for (int j_1 = 0; j_1 < -j_0+PB_M-3; j_1++) {
                    D[i_5][j_0+i_9+2][i_5][i_9] = E[j_1][i_5][i_9][j_1+j_0] - E[i_9-2][j_1][i_5][j_0] * K[i_9+i_5][j_0+i_9][j_1][j_0] - D[i_5][j_0+i_9+3][i_5][j_0] * D[i_5-1][j_1+j_0+3][i_5-1][j_1+1] + D[i_5+1][j_0+i_9+1][i_5+1][i_9-1] * 3;
                }
            }
        }
    }
