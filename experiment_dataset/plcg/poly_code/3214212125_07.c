...
void kernel_3214212125_07(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        ...
        for (int i_3 = 0; i_3 < PB_L-1; i_3++) {
            for (int i_4 = 0; i_4 < -i_0+PB_M; i_4++) {
                B[i_0][i_3][0] = C[i_4+i_0][i_3][i_4] - B[i_0][i_3+1][0] + 5;
            }
        }
    }
#pragma endscop
...
kernel_3214212125_07(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
