...
void kernel_4234252115_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 0; i_1 < min(-i_0+PB_M, PB_M-1); i_1++) {
            for (int i_2 = 0; i_2 < PB_P-2; i_2++) {
                for (int i_3 = 0; i_3 < min(min(-i_2+PB_P-2, i_1), -i_0+PB_L-1); i_3++) {
                    A[i_1][i_3+i_0+1][i_2][i_3+1] = C[i_1][i_3][i_0+1][i_2] * C[i_0][i_1+1][0][i_2] + D[i_2+1][i_3+2][i_0][i_1] + C[i_0][i_3+i_1][i_2][1] + C[i_1][i_3][i_2+1][i_0+2] * D[i_3][i_0][i_2][i_1] - D[i_3+2][i_3+i_2+2][i_1][i_0] - C[i_3+1][i_0][i_1][i_2] - A[i_1][i_3+i_0+1][i_2][i_3] + 1;
                }
            }
            B[i_1] = E[i_1+i_0][0] - 2;
        }
...
kernel_4234252115_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
