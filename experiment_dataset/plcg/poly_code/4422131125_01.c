...
void kernel_4422131125_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
    ...
    for (int i_1 = 0; i_1 < PB_N; i_1++) {
        for (int i_2 = 0; i_2 < PB_N; i_2++) {
            for (int i_3 = 0; i_3 < -i_2+PB_N; i_3++) {
                C[i_2+1][i_3][i_1] = F[i_3+i_2][i_1][i_1+1] + G[i_3+i_2+1][i_1] - 5;
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_P-3; i_4++) {
        for (int i_5 = 0; i_5 < PB_M; i_5++) {
            for (int i_6 = 0; i_6 < PB_N; i_6++) {
                C[i_6+1][i_5][i_4+1] = F[i_6][i_4][i_5] + F[i_4][i_6][i_5] * C[i_6][i_5][i_4+1] - C[i_6+1][i_5][i_4+3] * 2;
            }
        }
        for (int i_7 = max(i_4, 1); i_7 < min(PB_N-1, -i_4+PB_M); i_7++) {
            A[i_7] = G[i_7][i_7+1] + G[i_7+i_4][0] - F[i_4][i_7+1][i_4+1] * G[i_7+i_4][i_7+i_4] * G[0][i_7+i_4] * G[i_7+1][i_4] * G[i_7-1][i_4] - 3;
        }
    }
#pragma endscop
...
kernel_4422131125_01(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
