...
void kernel_3222312323_04(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_N-1; i_0++) {
        ...
        for (int i_3 = 2; i_3 < -i_0+PB_N-1; i_3++) {
            B[i_3+i_0][i_3] = C[i_3-2][i_0] - B[i_3+i_0][i_3+2] * B[i_3+i_0+1][i_3] + B[i_3+i_0-2][i_3] - 5;
        }
    }
#pragma endscop
...
kernel_3222312323_04(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
