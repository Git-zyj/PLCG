...
void kernel_2314152125_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        B[i_0+1] = D[1] + D[i_0-2] * D[i_0] - D[i_0] + B[i_0+1] - 2;
        B[i_0+1] = D[i_0] - D[i_0] - D[i_0] + D[i_0+2] * D[i_0+2] + 3;
    }
    for (int i_1 = 0; i_1 < PB_M-3; i_1++) {
        B[i_1+3] = D[i_1] + D[i_1] * D[i_1] + D[i_1] - 4;
    }
#pragma endscop
...
kernel_2314152125_03(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
