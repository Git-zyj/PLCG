...
void kernel_4226111115_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            B[i_1] = C[i_1] - C[i_1] + B[i_1] + 5;
            B[i_1] = 6;
        }
    }
#pragma endscop
...
kernel_4226111115_09(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
