...
void kernel_2224212325_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = max(i_0, 4); i_1 < PB_M-1; i_1++) {
            A[i_1][i_1-2] = C[i_0] - A[i_1-1][i_1-3] - A[i_1-2][i_1-4] * A[i_1+1][i_1-1] * 6;
        }
    }
...
kernel_2224212325_04(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
