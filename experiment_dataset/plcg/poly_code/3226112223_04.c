...
void kernel_3226112223_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-4; i_0++) {
        A[i_0+2] = C[i_0] + A[i_0] + A[i_0+4] + 2;
    }
...
kernel_3226112223_04(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
