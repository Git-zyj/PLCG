...
void kernel_2322112223_03(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
        ...
        C[i_1-1] = D[0] - D[i_1+2] * C[i_1] + C[i_1-2] * 5;
    }
#pragma endscop
...
kernel_2322112223_03(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
