...
void kernel_2414212311_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        ...
        for (int i_2 = i_0; i_2 < -i_0+PB_P-1; i_2++) {
            B[i_0][i_2+i_0] = B[i_0][i_2+i_0+1] - 4;
        }
        C[i_0+1] = C[i_0] + C[i_0+2] * C[i_0+2] * C[i_0+2] * 1;
    }
    for (int i_3 = 1; i_3 < PB_P-1; i_3++) {
        for (int i_4 = 1; i_4 < min(-i_3+PB_P+1, PB_M-1); i_4++) {
            D[i_4][i_3] = E[i_4] - B[i_3][i_4+i_3-1] * C[i_4] - D[i_3][i_4-1] + D[i_4][i_3+1] - D[i_4+1][i_3+1] + 2;
        }
    }
#pragma endscop
...
kernel_2414212311_04(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
