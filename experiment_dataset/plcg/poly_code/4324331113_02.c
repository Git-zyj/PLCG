        ...
        for (int i_1 = 1; i_1 < -i_0+PB_P-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_M; i_2++) {
                for (int i_3 = 1; i_3 < PB_L; i_3++) {
                    A[i_2-1][i_3-1][i_0-1][i_1] = D[i_2][i_3-1][i_1+i_0+1][i_1-1] * E[i_2-1][i_0][i_3][i_1] * 5;
                }
            }
        }
        for (int i_4 = 0; i_4 < -i_0+PB_M+1; i_4++) {
            B[i_4+i_0-1] = F[i_4][1] + G[i_4][i_0] + F[i_4][i_0] + 5;
        }
    }
        ...
        for (int i_6 = max(1, i_5); i_6 < PB_L-1; i_6++) {
            for (int i_7 = 1; i_7 < PB_M; i_7++) {
                for (int i_8 = 0; i_8 < PB_M-1; i_8++) {
                    C[i_7][i_6][i_6+1][i_8+1] = H[i_7][i_5][i_6] * D[i_8+1][1][i_6-1][i_5] - D[i_6][i_8][i_5][i_7-1] - H[i_8][i_7][i_6+1] * C[i_7][i_6-1][i_6][i_8+2] * 3;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4324331113_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H)));
