...
void kernel_2136212313_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P; i_0++) {
        A[i_0][i_0] = B[i_0][0] - A[i_0+1][i_0+1] - A[i_0-1][i_0-1] * A[i_0-1][i_0-1] - 3;
    }
#pragma endscop
...
kernel_2136212313_04(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B));
