...
void kernel_4236112225_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            for (int i_2 = 2; i_2 < PB_L; i_2++) {
                for (int i_3 = 0; i_3 < PB_P-2; i_3++) {
                    A[i_1][i_2][i_3+1] = A[i_2+2][i_1-1][i_3+2] - A[i_1-2][i_2-2][i_0+2] - 5;
                }
            }
        }
        for (int i_4 = 0; i_4 < i_0; i_4++) {
            for (int i_5 = 0; i_5 < PB_L-1; i_5++) {
                A[i_4+1][i_5+1][i_0+2] = C[i_4+2][i_0+2][i_4] * C[i_4][i_5][i_0] - 1;
            }
        }
    }
#pragma endscop
...
kernel_4236112225_08(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C));
