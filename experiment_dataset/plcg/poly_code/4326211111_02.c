        ...
        for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
            for (int i_3 = i_2; i_3 < PB_P-1; i_3++) {
                for (int i_4 = 0; i_4 < PB_P; i_4++) {
                    C[i_2][i_3+1][i_2-1] = F[i_2+1][i_3+1][i_1][1] * 1;
                }
            }
        }
    }
...
kernel_4326211111_02(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
