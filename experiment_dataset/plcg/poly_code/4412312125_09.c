...
void kernel_4412312125_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
        ...
        for (int i_1 = 0; i_1 < -i_0+PB_L-3; i_1++) {
            for (int i_2 = 0; i_2 < i_0; i_2++) {
                for (int i_3 = 0; i_3 < PB_L; i_3++) {
                    A[i_3][i_1][i_0-1][1] = A[i_3][i_1][i_2][1] * D[i_2][i_1+i_0+3][0][i_1+1] - 2;
                }
            }
        }
        B[i_0-2] = E[i_0] + 5;
    ...
    for (int i_7 = 0; i_7 < PB_L-2; i_7++) {
        for (int i_8 = 2; i_8 < -i_7+PB_L-2; i_8++) {
            for (int i_9 = 0; i_9 < -i_7+PB_L-2; i_9++) {
                D[i_9][i_8+i_7+2][0][i_7] = F[i_9+i_8][i_7][i_8] * D[i_8-2][i_9+i_7+2][0][i_9] - 2;
            }
        }
    }
#pragma endscop
...
kernel_4412312125_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
