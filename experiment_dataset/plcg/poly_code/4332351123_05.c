...
void kernel_4332351123_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_N-2; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_M; i_2++) {
                for (int i_3 = i_1; i_3 < min(min(-i_0+PB_L, -i_1+PB_P), PB_M-1); i_3++) {
                    A[i_1][i_2][i_3][i_0+1] = D[i_3+1][i_2+1][i_1][i_0+1] * E[i_2+i_1-1][i_0][0][i_3+i_1] + E[i_3][i_1][i_2][i_0+1] - E[i_3-1][i_1][i_2][i_0] + F[i_3][i_2+i_1][i_0-1] - D[i_2+1][i_1+1][i_3+i_0][i_2] - D[i_2][i_3+i_0][i_3+i_1][0] + F[i_2][i_1][i_1] + A[i_1+2][i_2-1][i_3][i_0+1] - A[i_1-1][i_0][i_3+1][i_2+1] * 5;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 1; i_5 < PB_M; i_5++) {
            for (int i_6 = 1; i_6 < -i_5+PB_M; i_6++) {
                for (int i_7 = i_5; i_7 < min(-i_5+PB_P, PB_M); i_7++) {
                    B[i_6+i_5][i_7+1][1] = E[i_7][i_7][i_4-1][i_5] + G[i_7][i_4][i_5-1][i_6] - G[i_5][i_4+1][i_6+1][i_7-1] * D[i_6-1][i_4][i_7+i_5][i_5] - 1;
                }
            }
        }
    }
    for (int i_8 = 1; i_8 < PB_M; i_8++) {
        for (int i_9 = 0; i_9 < -i_8+PB_M; i_9++) {
            C[i_9+1] = H[i_9+i_8][i_8-1] * I[i_9][i_8] * 4;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4332351123_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I)));
