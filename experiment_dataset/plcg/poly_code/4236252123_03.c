...
void kernel_4236252123_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve)){
        ...
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_M; i_2++) {
                for (int i_3 = 2; i_3 < PB_P; i_3++) {
                    A[i_2+i_0][i_1+1][i_0][i_3] = C[i_3-1][i_1][i_2] * D[i_2+1][i_3][i_3-2][i_0-2] - 6;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_P-2; i_4++) {
        for (int i_5 = max(i_4, 2); i_5 < PB_P; i_5++) {
            for (int i_6 = 2; i_6 < min(PB_P-2, -i_5+PB_M); i_6++) {
                for (int i_7 = max(i_4, 2); i_7 < -i_5+PB_M; i_7++) {
                    A[i_6+i_5][i_7+1][i_5-2][i_4] = D[i_7+i_6][i_4][i_5][i_6-2] * C[i_7+i_6][i_4-1][i_5] - E[i_4][i_6][i_5][i_7] + E[i_5][i_7-2][i_4][i_6] - D[i_6][i_7][i_5][i_6+1] - E[i_7-2][i_6][i_7][i_4+2] + E[i_6][i_5][i_4][i_4] + A[i_7+i_5][i_4+2][i_5][i_6+2] * 5;
                }
            }
        }
    }
...
kernel_4236252123_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
