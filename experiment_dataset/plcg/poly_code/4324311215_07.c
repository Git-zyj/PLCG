...
void kernel_4324311215_07(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve)){
        ...
        for (int i_4 = 1; i_4 < PB_M; i_4++) {
            for (int i_5 = 1; i_5 < PB_P; i_5++) {
                for (int i_6 = 1; i_6 < PB_P; i_6++) {
                    B[i_0-1][i_4][i_0][i_5-1] = D[i_0][i_6][i_5][i_4] - B[i_0-2][i_4][i_0-1][i_5-1] - B[i_0-1][i_4][i_0][i_5] + B[i_4-1][i_5-1][i_4][i_6-1] * 1;
                }
            }
            for (int i_7 = 0; i_7 < min(-i_0+PB_L, i_0); i_7++) {
                for (int i_8 = 0; i_8 < -i_0+PB_Q-1; i_8++) {
                    C[i_4][i_7][i_7+1][i_0] = E[i_4][i_7+i_0][i_8][i_8+i_0+1] - 4;
                }
            }
        }
    }
...
kernel_4324311215_07(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
