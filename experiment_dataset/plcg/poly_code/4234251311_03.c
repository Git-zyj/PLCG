...
void kernel_4234251311_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        A[i_0] = C[i_0] - D[i_0] * C[i_0+1] + C[i_0-1] - C[i_0] - A[i_0-1] - A[i_0+1] * 1;
    }
        ...
        for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
            for (int i_3 = i_1; i_3 < -i_2+PB_N; i_3++) {
                for (int i_4 = 1; i_4 < min(-i_1+PB_L, i_3); i_4++) {
                    B[i_2][i_4-1][i_3] = E[i_3][i_4+1][i_4+1][i_1] * F[i_2][i_3][i_1][i_4] + E[i_2][i_4][i_3][i_4] * G[i_3+i_2][i_1][i_4-1] + E[i_4+i_1][i_3][i_2][0] * B[i_2][i_4-1][i_3+1] * B[i_2][i_4][i_3+1] * B[i_2-1][i_4-1][i_3-1] + B[i_2+1][i_1-1][i_4-1] - 3;
                }
            }
        }
    }
...
kernel_4234251311_03(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
