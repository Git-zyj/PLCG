...
void kernel_3212211323_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N-2; i_0++) {
        B[i_0+2] = B[i_0] + B[i_0-2] + 2;
        B[i_0] = C[1] + B[i_0-2] - 1;
    }
#pragma endscop
...
kernel_3212211323_05(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
