...
void kernel_4334112313_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_1 = 2; i_1 < PB_L; i_1++) {
        for (int i_2 = 3; i_2 < PB_P-1; i_2++) {
            for (int i_3 = 0; i_3 < min(PB_L-3, i_1); i_3++) {
                B[i_1-2][i_3+2][i_3+1] = D[i_1-2][i_1][i_2+1] * B[i_2-2][i_3+3][i_3+2] + B[i_2-3][i_3+2][i_3+1] + B[i_1-2][i_3+3][i_3+2] - 2;
            }
        }
    }
        ...
        for (int i_5 = 3; i_5 < PB_P; i_5++) {
            for (int i_6 = 1; i_6 < PB_P; i_6++) {
                for (int i_7 = 2; i_7 < PB_L+1; i_7++) {
                    C[i_7-2][i_6-1][i_5] = C[i_4-3][i_7-1][i_6] - C[i_5-3][i_6-1][i_7-1] + 5;
                }
            }
        }
    }
...
kernel_4334112313_09(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
