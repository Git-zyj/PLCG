...
void kernel_3414332215_08(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P-1; i_0++) {
        for (int i_1 = 1; i_1 < min(-i_0+PB_Q, PB_N); i_1++) {
            C[i_0] = E[i_1][i_0] * F[i_1][i_0-1] + C[i_1] + 6;
            for (int i_2 = 2; i_2 < -i_0+PB_P+2; i_2++) {
                C[i_2+1] = G[i_0-1][i_1-1][i_2-1] * G[i_2+2][i_0+1][i_1+i_0] - E[i_1][i_0+1] + G[i_1][i_2-2][i_0-2] - G[i_1][i_2+i_0-2][i_2] + 6;
            }
        }
        C[i_0] = H[i_0-2] - H[i_0-1] * I[i_0] * I[i_0+2] + C[i_0-1] * D[i_0-1] - 4;
        D[i_0-2] = 3;
    }
#pragma endscop
...
kernel_3414332215_08(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
