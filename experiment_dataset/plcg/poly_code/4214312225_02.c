...
void kernel_4214312225_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 4; i_1 < PB_P+2; i_1++) {
            for (int i_2 = 1; i_2 < min(PB_P-2, i_1); i_2++) {
                for (int i_3 = 0; i_3 < PB_Q-2; i_3++) {
                    A[i_0][i_1-2][i_2+2][i_3] = A[i_2-1][i_1-4][i_0+1][i_3] + A[i_0][i_1-2][i_2+2][i_3+2] * 2;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_M; i_4++) {
            for (int i_5 = 2; i_5 < -i_0+PB_L-1; i_5++) {
                for (int i_6 = 2; i_6 < PB_Q; i_6++) {
                    A[i_4][i_0-3][i_5+2][i_6] = C[i_6][i_5-2][i_4-1][i_0] + D[i_6-2][i_4][i_5+i_0+1] + 1;
                }
            }
        }
    }
...
kernel_4214312225_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
