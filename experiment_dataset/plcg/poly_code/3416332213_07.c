...
void kernel_3416332213_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        A[i_0+2] = E[i_0] - E[i_0-2] + A[i_0+1] - 2;
        A[i_0+3] = F[i_0] + F[i_0] * F[i_0] + A[i_0+3] - 3;
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            C[i_1+1][i_0] = G[i_1][i_0] * H[i_1][i_1] + C[i_1+1][i_0+1] - C[i_1+2][i_0] * 1;
        }
    }
    for (int i_2 = 1; i_2 < PB_N-2; i_2++) {
        A[i_2+2] = I[i_2+1] * E[i_2] + F[i_2-1] * 2;
    }
#pragma endscop
...
kernel_3416332213_07(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
