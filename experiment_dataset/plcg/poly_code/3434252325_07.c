...
void kernel_3434252325_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        A[i_0] = E[i_0] * F[i_0] + E[i_0-1] + G[i_0][0] + A[i_0-1] - A[i_0+2] - 4;
    }
    for (int i_1 = 2; i_1 < PB_P; i_1++) {
        for (int i_2 = i_1; i_2 < -i_1+PB_P; i_2++) {
            for (int i_3 = 2; i_3 < min(PB_P, -i_2+PB_M); i_3++) {
                B[i_2][i_3-1] = H[i_2][i_1][i_3] * H[i_3+i_2][i_1][i_2+i_1] * H[i_2+i_1+2][i_3+2][i_3] * H[i_2][i_3][i_1] + B[i_2+1][i_3-1] + B[i_3-2][i_2-1] + 5;
            }
        }
        for (int i_4 = i_1; i_4 < PB_N-2; i_4++) {
            D[i_1-2] = G[i_1][i_4] - G[i_1+1][i_4] + I[i_4+2][i_1-1] - E[i_4] - D[i_4] + D[i_4+1] + 1;
        }
        D[i_1] = F[i_1+2] + E[i_1] - E[i_1+2] + E[i_1] + F[i_1-1] - E[i_1] - E[i_1-2] - A[i_1] - D[i_1-2] - 6;
    }
#pragma endscop
...
kernel_3434252325_07(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
