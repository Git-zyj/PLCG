...
void kernel_4224131323_02(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M-2; i_0++) {
        A[i_0-1][i_0] = C[i_0] * C[i_0+1] + A[i_0-3][i_0-2] * A[i_0-2][i_0-1] - A[i_0+1][i_0+2] - 6;
    }
    for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
        A[i_1-1][i_1] = C[i_1] * C[i_1+1] - C[i_1-1] - 4;
    }
#pragma endscop
...
kernel_4224131323_02(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
