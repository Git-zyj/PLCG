...
void kernel_4434132125_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        A[i_0] = E[i_0] - E[i_0] - E[i_0-1] - E[i_0] - A[i_0+1] - A[i_0-2] - 5;
        for (int i_1 = 2; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_0+PB_M, i_1); i_2++) {
                B[i_1-2][i_2] = F[i_2+i_0][i_1+1] * G[i_2][i_1][i_0] * 5;
            }
        }
    }
    for (int i_3 = 2; i_3 < PB_P; i_3++) {
        for (int i_4 = 2; i_4 < min(PB_P, -i_3+PB_M-1); i_4++) {
            for (int i_5 = 2; i_5 < i_4; i_5++) {
                B[i_5-2][i_4-1] = G[i_4+i_3+1][i_5+1][0] - G[i_5][i_3+2][i_4] - G[i_4-2][i_3-2][i_5] + G[i_5+2][i_4][2] * 2;
            }
        }
        D[i_3] = E[i_3-2] - E[i_3] * D[i_3+2] + 2;
    }
#pragma endscop
...
kernel_4434132125_07(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
