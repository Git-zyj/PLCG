...
void kernel_4332151323_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
        ...
        for (int i_1 = 1; i_1 < PB_Q; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_0+PB_M-2, -i_1+PB_M-1); i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_M-1; i_3++) {
                    A[i_2][i_1][i_3+i_0+1][0] = D[i_1-1][i_3][i_0][1] * D[i_3+1][i_0][i_2][i_1] + D[i_2+1][i_3][i_1][0] + D[i_2+i_1+1][i_0][i_1][i_3] - A[i_2][i_1][i_3+i_0-1][0] + A[i_2][i_1+1][i_3+i_0+1][0] * A[i_3][i_1-1][i_2+i_0+2][0] + 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        B[i_4] = E[i_4] - E[i_4+1] + E[i_4] + E[i_4] + B[i_4+1] * B[i_4-1] * 4;
    }
    for (int i_5 = 1; i_5 < PB_P-1; i_5++) {
        for (int i_6 = i_5; i_6 < -i_5+PB_P-1; i_6++) {
            B[i_6] = F[i_5][i_6-1] - E[i_6] * F[i_6][i_5+1] * F[i_6-1][i_5-1] + E[i_5] - G[i_5-1][i_6+i_5+1][1] - B[i_5] * 6;
        }
    }
#pragma endscop
...
kernel_4332151323_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
