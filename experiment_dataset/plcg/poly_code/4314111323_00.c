...
void kernel_4314111323_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-3; i_0++) {
        for (int i_1 = 1; i_1 < PB_M-3; i_1++) {
            A[i_1+1] = A[i_1] * A[i_1-1] + A[i_1+3] + A[i_1+2] - A[i_1] * 5;
        }
        A[i_0+3] = D[i_0+1] - D[i_0] - D[i_0] - 5;
    }
...
kernel_4314111323_00(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
