...
void kernel_4332232123_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf)){
        ...
        for (int i_1 = 0; i_1 < PB_N; i_1++) {
            for (int i_2 = 2; i_2 < PB_M; i_2++) {
                for (int i_3 = 0; i_3 < -i_1+PB_N; i_3++) {
                    A[i_0+1][i_3+2][i_2][0] = D[i_0][i_2-2][i_1][i_3] - E[i_2][i_3+i_1][i_0+1][i_3] - D[i_2][i_3][i_0][i_0] - A[i_0+1][i_3+2][i_2+1][0] * 5;
                }
            }
        }
        B[i_0] = F[i_0-1] * F[i_0] - F[i_0-2] * F[i_0] + B[i_0-2] + 3;
    }
        ...
        for (int i_5 = 0; i_5 < min(PB_M-1, -i_4+PB_Q); i_5++) {
            for (int i_6 = 2; i_6 < PB_M+2; i_6++) {
                for (int i_7 = 0; i_7 < PB_L-4; i_7++) {
                    C[i_6-2][i_5][i_7][i_5+i_4] = D[i_5+1][i_6-1][i_7][i_6] - A[i_5+1][i_7+4][i_6-1][0] * 3;
                }
            }
        }
    }
...
kernel_4332232123_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F));
