...
void kernel_4412212123_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf)){
        ...
        for (int i_1 = 2; i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = 1; i_2 < PB_L; i_2++) {
                for (int i_3 = 4; i_3 < PB_P-2; i_3++) {
                    A[i_1+i_0][i_3][i_2][i_0-2] = E[i_2][i_3+2][i_3+i_1][i_0+2] * F[i_1][i_0][i_3][i_2+1] - A[i_3+i_1-2][i_0][i_2-1][i_3-4] - 4;
                }
            }
        }
        for (int i_4 = i_0; i_4 < PB_L; i_4++) {
            B[i_0][i_4] = B[i_0-1][i_4-1] - 6;
        }
    }
...
kernel_4412212123_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
