...
void kernel_4216112123_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < PB_M-2; i_2++) {
                for (int i_3 = 1; i_3 < PB_L+1; i_3++) {
                    A[i_1-1][i_2][i_3-1] = C[i_3][i_1][i_0+2][i_2] + A[i_1-1][i_2+2][i_3-1] - 2;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < i_4; i_5++) {
            for (int i_6 = max(i_4, 2); i_6 < PB_M+1; i_6++) {
                for (int i_7 = 0; i_7 < PB_P-2; i_7++) {
                    B[i_7][i_6-2][i_5-1][i_7+2] = B[i_7][i_6-1][i_5-1][i_7+2] * 6;
                }
            }
        }
    }
...
kernel_4216112123_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
