...
void kernel_4236252211_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg)){
        ...
        for (int i_1 = 2; i_1 < -i_0+PB_L; i_1++) {
            for (int i_2 = 3; i_2 < -i_1+PB_M+1; i_2++) {
                for (int i_3 = i_2; i_3 < PB_M; i_3++) {
                    A[i_0-2][i_3][i_2][i_2-2] = C[i_3][i_1-2][i_2][i_0] * D[i_1][i_2][i_0+2][1] + D[i_2+i_1-1][i_0][i_3-2][i_2] + E[i_3][i_1+i_0][i_2] + A[i_0-3][i_3-1][i_2][i_2-2] + A[i_2-2][i_3][i_0-1][i_0-3] - A[i_0-3][i_3][i_2-1][i_2-3] - 6;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L-2; i_4++) {
        B[i_4+1] = F[i_4-2] - F[i_4] + F[i_4-2] * G[i_4] * F[i_4+2] + B[i_4+2] - 6;
    }
#pragma endscop
...
kernel_4236252211_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
