...
void kernel_4336111311_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N-1; i_0++) {
        for (int i_1 = 0; i_1 < PB_N-1; i_1++) {
            A[i_1] = D[i_0] + A[i_1+1] + 6;
        }
        ...
        for (int i_3 = i_2; i_3 < PB_N; i_3++) {
            for (int i_4 = i_3; i_4 < PB_N-1; i_4++) {
                for (int i_5 = 2; i_5 < PB_L; i_5++) {
                    C[i_3][i_2][i_5-1][i_4-1] = C[i_3][i_2][i_5][i_4-1] - C[i_3][i_2][i_5-2][i_4-1] + C[i_4+1][i_2-1][i_5-1][i_3-1] * 5;
                }
            }
        }
    }
...
kernel_4336111311_07(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
