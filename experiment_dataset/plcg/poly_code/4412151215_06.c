...
void kernel_4412151215_06(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 1; i_2 < i_1; i_2++) {
                for (int i_3 = i_1; i_3 < PB_L-1; i_3++) {
                    B[i_2+2][i_3-1] = E[i_2+1][i_1+1][i_3][i_2] + E[i_0][i_1][i_3][i_2] * F[i_2][i_3+1][i_1] - E[i_2+1][i_3][i_1][1] - E[i_1][i_2][i_0][i_2] + B[i_2][i_3] - 2;
                }
                B[i_1+1][i_2] = F[i_0][i_2][i_1] * F[i_2][i_0][i_1-1] + F[i_2][i_0][i_0] * F[i_1][i_2][i_0] - B[i_0+1][i_2-1] - 2;
            }
        }
        for (int i_4 = 1; i_4 < min(-i_0+PB_M, PB_Q); i_4++) {
            for (int i_5 = 1; i_5 < -i_0+PB_L; i_5++) {
                for (int i_6 = 0; i_6 < PB_Q-1; i_6++) {
                    B[i_6+2][i_0-1] = E[i_6][i_5+i_0][i_4][i_4-1] - E[i_0][i_5+i_4-1][i_6+1][i_5] - E[i_4+i_0][i_5-1][i_6+1][i_5] * E[i_4][i_5+1][i_0][i_0-1] * 3;
                }
            }
        }
    }
    for (int i_7 = 0; i_7 < PB_P; i_7++) {
        for (int i_8 = 1; i_8 < PB_M-1; i_8++) {
            B[i_8+1][i_7] = G[i_8-1][i_7] + G[i_8+1][i_8-1] + G[i_8][i_7] - G[i_8-1][i_7] - H[i_7] * 3;
        }
    }
#pragma endscop
...
init_array(xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4412151215_06(xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H)));
