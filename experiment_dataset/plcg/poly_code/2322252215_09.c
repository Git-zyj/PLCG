...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_L; i_1++) {
        for (int i_2 = 2; i_2 < -i_1+PB_L; i_2++) {
            A[i_2+1] = F[i_1][i_2] - E[2] + G[i_2+1][i_1] - H[i_2-2][i_2+i_1][i_1+1] + F[i_2-2][i_1+1] - E[i_2] + G[i_1][i_2+i_1+2] - 5;
        }
    }
    for (int i_3 = 0; i_3 < PB_M-2; i_3++) {
        A[i_3] = D[i_3] - E[i_3+1] * E[i_3+2] * E[i_3+2] + D[i_3] - E[i_3] * 1;
    }
#pragma endscop
...
kernel_2322252215_09(xa,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
