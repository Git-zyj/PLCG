...
void kernel_4436352315_09(int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,int zk,int vk,DATA_TYPE POLYBENCH_4D(K,xK,yK,zK,vK,xk,yk,zk,vk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,DATA_TYPE POLYBENCH_1D(M,xM,xm)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_Q; i_0++) {
        for (int i_1 = i_0; i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = 2; i_2 < -i_1+PB_Q; i_2++) {
                C[i_1+i_0][i_0-1][i_2+i_1] = E[i_2][i_1-2] + F[i_2][i_0][i_1] * G[i_2+i_1][0] - C[i_2+i_1][i_2-1][i_1+i_0] - 3;
                for (int i_3 = 1; i_3 < min(-i_1+PB_P, -i_0+PB_P); i_3++) {
                    C[i_1+i_0][i_0-1][i_3+i_1] = H[i_2][i_3+i_0][i_1][i_2+2] - I[i_1-1][i_3+i_0-2][i_2] - F[0][i_3+1][i_2+i_1] - J[i_0][i_2-2][i_3][i_1-2] + K[i_2-2][i_0][i_0][i_1] - J[i_3+2][i_0][i_1][i_2-1] * F[i_1][i_3+i_1][i_3] - H[i_2][i_3][i_3][i_0] * J[i_0][i_3-1][i_0][i_2] - 4;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_P-2; i_4++) {
        for (int i_5 = 2; i_5 < min(min(i_4, PB_Q-2), -i_4+PB_N-1); i_5++) {
            for (int i_6 = 0; i_6 < PB_L-2; i_6++) {
                C[i_5+i_4][i_4-1][i_6+i_5] = F[i_6+1][i_4][i_4] * I[i_6+i_5][i_4+2][i_5-2] - J[i_4+2][i_6+2][i_4][i_5+2] - C[i_5+i_4+1][i_4][i_6+i_5] * C[i_5+i_4-1][i_4-2][i_6+i_5] + 6;
            }
        }
    }
    for (int i_7 = 3; i_7 < PB_M; i_7++) {
        D[i_7-2] = L[i_7-2] + L[i_7] + M[i_7] - D[i_7-1] + D[i_7-3] + D[i_7-1] - 3;
    }
#pragma endscop
...
init_array(xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,POLYBENCH_ARRAY(M), INIT_SEED);
kernel_4436352315_09(xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,POLYBENCH_ARRAY(M));
polybench_prevent_dce(print_array(xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,POLYBENCH_ARRAY(M)));
