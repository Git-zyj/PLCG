...
void kernel_2314131225_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_M-1; i_1++) {
        ...
        for (int i_2 = max(1, i_1); i_2 < PB_L; i_2++) {
            B[i_1] = D[0] * D[i_2-1] + B[i_1] * B[i_1+1] - 3;
        }
    }
#pragma endscop
...
kernel_2314131225_00(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
