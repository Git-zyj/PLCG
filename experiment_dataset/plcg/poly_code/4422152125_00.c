        ...
        for (int i_2 = 0; i_2 < min(PB_P-2, -i_1+PB_P); i_2++) {
            for (int i_3 = 1; i_3 < i_2; i_3++) {
                for (int i_4 = 0; i_4 < PB_P-2; i_4++) {
                    B[i_1+1][i_4+2][i_3][i_2] = F[i_3][i_2][i_1] + G[i_1-1][i_3+1][i_4+i_2+2][i_3] * H[i_2+i_1][i_3][i_4+i_2][i_4][i_3-1] + F[i_3+1][i_2+i_1][i_4] + 6;
                }
            }
        }
    }
    for (int i_5 = 2; i_5 < PB_L-2; i_5++) {
        C[i_5+1] = E[i_5] * E[i_5] - E[i_5] + E[i_5-1] - E[1] + E[i_5] + E[i_5] - D[i_5-2] + 3;
        D[i_5-2] = E[i_5] + E[i_5] * E[i_5] + E[i_5] * E[i_5] + E[i_5] - E[i_5+2] - 5;
    }
#pragma endscop
...
kernel_4422152125_00(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H));
