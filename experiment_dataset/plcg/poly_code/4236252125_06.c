...
void kernel_4236252125_06(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
        ...
        for (int i_1 = 1; i_1 < min(min(i_0, PB_N-2), -i_0+PB_N); i_1++) {
            for (int i_2 = 0; i_2 < min(-i_0+PB_L, PB_Q-3); i_2++) {
                for (int i_3 = 2; i_3 < PB_M-2; i_3++) {
                    B[i_3][i_0][i_2][i_2+3] = C[i_3-2][i_0][i_3][i_1] + D[i_1+i_0][i_2][i_3][i_2] - C[i_1+2][i_3][i_3][i_0] - D[i_1+2][i_3+2][0][i_2] - E[i_2+i_0][i_1-1][i_3] * D[i_2][i_1][i_0][i_3+1] - 4;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_Q-3; i_4++) {
        for (int i_5 = 0; i_5 < i_4; i_5++) {
            for (int i_6 = 0; i_6 < -i_5+PB_M; i_6++) {
                B[i_6][i_5+2][i_4-2][i_4+1] = F[i_6+i_5][i_4+1][i_4] + E[i_4+1][i_5][0] * F[i_5][i_6][i_5] * B[i_6][i_5+3][i_4][i_4+3] + 6;
            }
        }
    }
#pragma endscop
...
kernel_4236252125_06(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
