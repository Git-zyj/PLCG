...
void kernel_4334211325_08(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_Q-3; i_2++) {
                for (int i_3 = max(3, i_0); i_3 < PB_L; i_3++) {
                    B[i_2+1][i_3-3][i_0+1][i_1-1] = D[i_2][i_3][i_1] - 2;
                }
                for (int i_4 = 1; i_4 < PB_P; i_4++) {
                    B[i_0+1][i_4-1][i_2+1][i_1-1] = B[i_1+1][i_0+1][i_2+1][i_4-1] - B[i_0+3][i_4][i_2+3][i_1] + 4;
                }
            }
        }
    }
    for (int i_5 = 0; i_5 < PB_M-2; i_5++) {
        for (int i_6 = 0; i_6 < PB_P-2; i_6++) {
            for (int i_7 = 0; i_7 < PB_L-2; i_7++) {
                C[i_5+1][i_7][i_6] = C[i_5+1][i_7][i_6+1] - C[i_5+1][i_7+2][i_6+2] * C[i_5+2][i_6][i_7] - C[i_5][i_6][i_7] - 2;
            }
        }
    }
#pragma endscop
...
kernel_4334211325_08(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
