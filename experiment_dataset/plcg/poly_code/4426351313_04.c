...
void kernel_4426351313_04(int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-1; i_0++) {
        D[i_0] = E[i_0+1] - F[i_0] * F[i_0] + E[i_0] * D[i_0] - 4;
    }
        ...
        for (int i_2 = i_1; i_2 < PB_Q-1; i_2++) {
            for (int i_3 = 0; i_3 < PB_M; i_3++) {
                for (int i_4 = 0; i_4 < min(-i_3+PB_P, PB_Q); i_4++) {
                    B[i_2-1][i_1-1][i_4+i_3][i_2] = G[i_3][i_1-1][i_4][i_2+1] + H[i_3][0][i_2-1][i_4] * G[i_2][i_1-1][i_3][i_1] * B[i_2-1][i_1-1][i_4+i_3][i_2] - 6;
                }
            }
        }
        for (int i_5 = 1; i_5 < PB_M; i_5++) {
            C[i_1][i_5] = I[i_5-1][i_1] * J[i_5][i_1] - K[i_5][i_1] - L[i_5][i_1][0] + I[i_1][i_5] * C[i_1][i_5-1] * C[i_1+1][i_5] * 3;
        }
    }
    for (int i_6 = 1; i_6 < PB_N-1; i_6++) {
        D[i_6] = F[i_6] - E[0] * F[i_6-1] + E[i_6] + F[i_6] - D[i_6-1] - D[i_6+1] + D[i_6+1] * D[i_6+1] - 2;
    }
#pragma endscop
...
init_array(xd,POLYBENCH_ARRAY(D), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4426351313_04(xd,POLYBENCH_ARRAY(D), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L));
