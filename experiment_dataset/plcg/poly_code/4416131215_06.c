...
void kernel_4416131215_06(int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
        ...
        for (int i_1 = i_0; i_1 < -i_0+PB_L-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_P; i_2++) {
                for (int i_3 = 1; i_3 < PB_L-1; i_3++) {
                    D[i_0+1][i_1+i_0+1][i_2][i_1+1] = E[i_1][i_3+1][i_0][i_2] - F[i_3-1][i_1+1][i_0][i_1][i_2] - E[i_3-1][i_0-1][i_1][i_3+1] * 1;
                }
            }
            for (int i_4 = max(2, i_0); i_4 < min(-i_0+PB_L, -i_1+PB_P-1); i_4++) {
                B[i_1-1][i_0-1][i_4+i_1] = G[i_1-1][i_4][i_0+1] + G[i_1][i_4+i_0][i_1] * G[i_4-1][i_0-1][i_1-1] + B[i_1-1][i_0-1][i_4+i_1+1] - B[i_4-2][i_0-1][i_4+i_1-1] - B[i_1-1][i_0][i_4+i_1] + 3;
            }
        }
    }
    for (int i_5 = 1; i_5 < PB_M-2; i_5++) {
        C[i_5][i_5+1] = H[i_5] * H[i_5-1] - C[i_5+1][i_5+2] - 4;
        for (int i_6 = 0; i_6 < -i_5+PB_L; i_6++) {
            for (int i_7 = i_5; i_7 < PB_M; i_7++) {
                for (int i_8 = 0; i_8 < min(min(-i_7+PB_P, -i_6+PB_L), PB_M-1); i_8++) {
                    D[i_6][i_8+i_6][i_7][i_8+1] = G[i_8+1][i_6][i_7] + E[i_8][i_7][i_6+i_5-1][0] - E[i_7][i_8+1][i_5][i_6] * E[i_7][i_6+i_5][i_6][i_8+i_7] - 5;
                }
            }
        }
    }
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4416131215_06(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H)));
