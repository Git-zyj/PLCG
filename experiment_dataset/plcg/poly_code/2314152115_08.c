...
void kernel_2314152115_08(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N+2; i_0++) {
        A[i_0-2][i_0+2] = D[0] + D[i_0] + D[i_0+2] * D[0] - 2;
        C[i_0+2] = D[i_0] - D[i_0-2] + D[i_0] - D[i_0] + D[i_0-2] - C[i_0+2] - 1;
        C[i_0+2] = D[i_0] * D[i_0] * D[i_0] - D[i_0] * D[i_0] * D[i_0] * A[i_0-2][i_0+2] * 6;
    }
#pragma endscop
...
kernel_2314152115_08(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
