...
void kernel_4216151213_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = i_0; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_P; i_2++) {
                for (int i_3 = 1; i_3 < -i_2+PB_M-1; i_3++) {
                    A[i_0][i_1][i_2][i_2-1] = C[i_3+1][i_2][i_1][i_3] * C[i_2][i_3+i_2][i_0-1][i_1] - C[i_1][i_3+i_2+1][i_1][i_0] * C[i_2-1][i_0][i_3-1][i_2+i_1] - C[i_3-1][i_0][i_2+1][i_1] * C[i_3][i_2-1][i_1][i_0] - A[i_0-1][i_3][i_2+1][i_2] + A[i_0][i_1-1][i_2][i_2-1] - 6;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L; i_4++) {
        for (int i_5 = i_4; i_5 < -i_4+PB_M-1; i_5++) {
            for (int i_6 = 2; i_6 < -i_4+PB_M-1; i_6++) {
                A[i_5][i_4][i_6-1][i_6-2] = D[i_6+i_4+1][i_6][i_5] + C[i_6][i_5+i_4+1][i_4][i_5+1] - D[i_4][i_5][i_6] + D[i_5+1][i_6+i_4-1][i_5] + 1;
            }
        }
    }
#pragma endscop
...
kernel_4216151213_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
