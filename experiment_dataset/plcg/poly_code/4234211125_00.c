...
void kernel_4234211125_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 0; i_1 < PB_Q; i_1++) {
            for (int i_2 = 0; i_2 < i_1; i_2++) {
                for (int i_3 = 2; i_3 < PB_L+2; i_3++) {
                    A[i_0][i_2][i_1] = A[i_1][i_3-2][i_2] - 6;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L+1; i_4++) {
        for (int i_5 = 0; i_5 < PB_Q; i_5++) {
            for (int i_6 = 0; i_6 < PB_M; i_6++) {
                A[i_6][i_4-1][i_5] = C[i_6][i_5][i_4] - 3;
            }
        }
    }
#pragma endscop
...
kernel_4234211125_00(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C));
