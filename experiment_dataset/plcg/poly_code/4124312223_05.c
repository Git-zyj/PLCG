...
void kernel_4124312223_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
...
kernel_4124312223_05(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
