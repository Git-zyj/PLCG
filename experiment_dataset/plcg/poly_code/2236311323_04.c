...
void kernel_2236311323_04(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    ...
    for (int i_1 = 3; i_1 < PB_L-2; i_1++) {
        for (int i_2 = 0; i_2 < PB_L-1; i_2++) {
            B[i_1-1][i_1+1] = C[i_1][i_2+1] * B[i_1-2][i_1] * B[i_1][i_1+2] - B[i_1-3][i_1-1] + 1;
        }
    }
#pragma endscop
...
kernel_2236311323_04(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
