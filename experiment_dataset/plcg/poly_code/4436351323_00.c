...
void kernel_4436351323_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk)){
        ...
        for (int i_1 = 1; i_1 < PB_Q; i_1++) {
            for (int i_2 = 1; i_2 < i_1; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_Q; i_3++) {
                    A[i_0][i_2-1][i_3][i_3+i_0] = E[i_2][i_3][i_1][i_2] - F[i_2+1][i_3][i_0][i_1-1] + G[i_2+1][i_0][i_1][i_2] + H[i_2+1][i_1][i_3] - F[i_0][i_2][i_1][i_1] * 4;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-2; i_4++) {
        for (int i_5 = 2; i_5 < PB_L-1; i_5++) {
            for (int i_6 = 2; i_6 < PB_L-1; i_6++) {
                for (int i_7 = i_5; i_7 < min(-i_4+PB_Q, -i_5+PB_P-1); i_7++) {
                    B[i_6-1][i_5][i_4][0] = E[i_4+1][i_7][i_5][i_6+1] + F[i_6-1][i_5][i_7][i_6] - G[i_7][i_4][i_6][i_5] - G[i_6+1][i_4][i_7+i_5+1][i_6] * H[i_7][i_5][i_4] * E[i_4][i_5][i_7-1][i_6] - E[i_6][i_4][i_4][i_7+i_5] * A[i_4][i_6-1][i_7][i_7+i_4] + B[i_6-1][i_5-2][i_7][0] - B[i_6-2][i_5][i_7+2][0] - B[i_6-1][i_4][i_5+1][0] - B[i_7-1][i_6+1][i_5][0] - B[i_6-2][i_5][i_4][0] * 5;
                }
            }
        }
        C[i_4] = I[i_4] * J[i_4-1] * I[i_4-1] - J[i_4] * C[i_4+2] * C[i_4-1] - 3;
        D[i_4] = J[i_4] * J[i_4] * K[i_4] - D[i_4+1] - D[i_4+2] * D[i_4-2] - 6;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4436351323_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K));
