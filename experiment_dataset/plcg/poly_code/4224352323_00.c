...
void kernel_4224352323_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 4; i_0 < PB_Q; i_0++) {
        for (int i_1 = 3; i_1 < min(PB_Q, -i_0+PB_L); i_1++) {
            A[i_1-1][i_0] = C[i_0][i_1] * D[i_0][i_1] + E[i_0] * C[i_0][i_1] - C[i_1-1][i_1+2] * C[i_0][i_1] * A[i_1-1][i_0-2] + A[i_1-3][i_0] * 3;
            B[i_1+1][i_0-2] = C[i_0][i_1] + F[i_1+i_0][i_1][0] * D[i_1][i_0] + B[i_1+2][i_0-4] * B[i_1+1][i_0-4] + B[i_1+1][i_0-3] * 4;
        }
    }
#pragma endscop
...
kernel_4224352323_00(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
