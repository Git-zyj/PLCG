...
void kernel_4336352125_02(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-2; i_0++) {
        for (int i_1 = i_0; i_1 < PB_L-2; i_1++) {
            for (int i_2 = max(2, i_0); i_2 < PB_M-2; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_1+PB_P-2, -i_2+PB_M+2); i_3++) {
                    B[i_3+i_2-2][i_1+2][i_2-2] = D[i_0+1][i_2+2][i_2+1][i_1] - E[i_2+2][i_1][i_3][i_2] + F[i_2+2][i_2][i_3+i_1+2] - G[i_3][i_0+2][i_0][i_2] + 2;
                }
            }
        }
        for (int i_4 = 0; i_4 < -i_0+PB_M; i_4++) {
            for (int i_5 = max(i_4, 1); i_5 < -i_4+PB_M; i_5++) {
                B[i_5+i_4][i_0+2][i_5] = H[i_0-1][i_5][i_4] - H[i_5][i_0][i_4] - H[i_5-1][i_4][i_0] - F[i_5][i_4][i_0] * F[i_5][i_4][i_0] * F[i_4+i_0][i_5][i_0] + B[i_4+i_0][i_5][i_0] + 6;
            }
        }
    }
    for (int i_6 = 1; i_6 < PB_M-1; i_6++) {
        for (int i_7 = i_6; i_7 < -i_6+PB_M-1; i_7++) {
            for (int i_8 = 0; i_8 < i_6; i_8++) {
                B[i_7+i_6+1][i_8+1][i_6+1] = I[i_7][i_8] + J[i_7+2][i_8][i_6-1] - I[i_8][i_7] * F[i_7+i_6+1][i_8][i_8] + F[i_7+1][i_6][i_7] - 3;
            }
        }
    }
#pragma endscop
...
init_array(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4336352125_02(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J)));
