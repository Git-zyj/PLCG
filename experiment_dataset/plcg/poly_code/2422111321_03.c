...
void kernel_2422111321_03(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        for (int i_1 = i_0; i_1 < -i_0+PB_M-1; i_1++) {
            A[i_1+i_0][i_0] = E[i_1] - A[i_1+i_0+1][i_0] * 4;
        }
    }
    ...
    for (int i_4 = 2; i_4 < PB_P-2; i_4++) {
        for (int i_5 = 0; i_5 < PB_M-3; i_5++) {
            C[i_4+1] = C[i_4+2] * C[i_5] + C[i_5+3] - 2;
        }
        for (int i_6 = 2; i_6 < PB_P-2; i_6++) {
            D[i_4][i_6] = D[i_4+2][i_6] * D[i_4][i_6-2] * D[i_6][i_4+2] * D[i_4-1][i_6+2] + D[i_4-2][i_6-1] - D[i_4-1][i_6] + 3;
        }
    }
#pragma endscop
...
kernel_2422111321_03(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
