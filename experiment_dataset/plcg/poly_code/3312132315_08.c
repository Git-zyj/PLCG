...
void kernel_3312132315_08(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_2 = 1; i_2 < PB_M; i_2++) {
        B[i_2] = D[i_2] - D[i_2] - D[i_2] * D[i_2-1] + D[i_2] + 3;
    }
#pragma endscop
...
kernel_3312132315_08(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
