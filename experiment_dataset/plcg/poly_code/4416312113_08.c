        ...
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < PB_L; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_1+PB_M, -i_2+PB_P); i_3++) {
                    A[i_0-1][i_1][i_3+i_2][i_0] = E[i_3+i_1][i_2][i_0][i_2] - 3;
                }
            }
        }
        for (int i_4 = i_0; i_4 < PB_L-1; i_4++) {
            for (int i_5 = 0; i_5 < PB_L-1; i_5++) {
                for (int i_6 = 0; i_6 < i_4; i_6++) {
                    C[i_4-1][i_5+1][i_4+1] = 3;
                }
            }
            for (int i_7 = 0; i_7 < PB_P; i_7++) {
                C[i_0][i_4][i_0+2] = C[i_0][i_4-1][i_0+2] * 3;
            }
        }
    }
        ...
        for (int i_9 = 0; i_9 < PB_L; i_9++) {
            for (int j_0 = 2; j_0 < i_8; j_0++) {
                for (int j_1 = 2; j_1 < PB_L; j_1++) {
                    D[j_0-2][i_9][i_8][j_1] = F[j_1][i_9][j_0] - G[j_1][i_8][i_9][i_8-1] * H[i_8][2][j_1-2][i_9] * 1;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4416312113_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H)));
