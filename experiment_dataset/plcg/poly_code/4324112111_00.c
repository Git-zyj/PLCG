...
void kernel_4324112111_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
        ...
        for (int i_1 = 0; i_1 < PB_P; i_1++) {
            for (int i_2 = 0; i_2 < i_0; i_2++) {
                for (int i_3 = 0; i_3 < i_2; i_3++) {
                    A[i_2][i_1][i_0][i_3+1] = D[i_2][i_3+2][i_1][i_0+1] * 1;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_P-1; i_4++) {
            for (int i_5 = i_0; i_5 < min(-i_4+PB_M, PB_P-1); i_5++) {
                for (int i_6 = 0; i_6 < PB_M-1; i_6++) {
                    C[i_6+1][i_0-1][i_5+1] = E[i_5+i_4][i_6][i_0] * D[i_5+1][i_6][i_4+1][i_4] + 4;
                }
            }
            for (int i_7 = 1; i_7 < PB_M; i_7++) {
                C[i_7][i_4-1][i_0] = C[i_7][i_4-1][i_0+1] - C[i_4+1][i_7-1][i_0] + 4;
            }
        }
    }
#pragma endscop
...
kernel_4324112111_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
