...
void kernel_3434351311_06(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        for (int i_1 = i_0; i_1 < min(PB_N, -i_0+PB_M+1); i_1++) {
            A[i_0][i_1] = E[i_1+1] + F[i_1+i_0-1][1] + G[0][i_1] - F[i_0][i_1] - H[i_1+1][i_0+1] * I[i_1] * G[i_0][i_1] - A[i_0-1][i_1] - 6;
        }
        C[i_0-1] = J[i_0+1] * E[i_0] + C[i_0] - 6;
    }
    for (int i_2 = 1; i_2 < PB_N; i_2++) {
        C[i_2] = G[i_2][0] + J[i_2] + I[i_2] + G[i_2][i_2] - C[i_2+1] - C[i_2-1] * C[i_2+1] - 5;
    }
    for (int i_3 = 1; i_3 < PB_N-1; i_3++) {
        D[i_3] = E[i_3] - J[i_3] - E[i_3] - I[i_3+1] * C[i_3] + D[i_3-1] - D[i_3+1] - D[i_3+1] + 4;
    }
#pragma endscop
...
kernel_3434351311_06(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
