        ...
        for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_L-1; i_2++) {
                for (int i_3 = 0; i_3 < i_1; i_3++) {
                    A[i_0][i_3][i_2+i_1][i_2+1] = C[i_1][i_2+1][i_0][i_0] - D[i_1-1][i_2][i_0-1][i_1] - A[i_0][i_3][i_2+i_1+1][i_2+2] + 1;
                }
            }
        }
    }
...
kernel_4236231215_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F));
