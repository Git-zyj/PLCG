...
void kernel_3312212225_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_M-2; i_1++) {
        ...
        for (int i_4 = 1; i_4 < PB_L; i_4++) {
            C[i_1][i_4] = C[i_1+2][i_4] * C[i_4-1][i_1] + C[i_1-1][i_4] + 3;
        }
    }
#pragma endscop
...
kernel_3312212225_08(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
