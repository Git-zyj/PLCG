...
void kernel_4322231315_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        B[i_0-1] = D[i_0-1] - E[i_0] + B[i_0-1] + B[i_0] - 2;
        B[i_0-1] = E[i_0] - F[i_0][1] * D[i_0] + B[i_0-2] - 6;
    }
    for (int i_1 = 1; i_1 < PB_P-1; i_1++) {
        for (int i_2 = i_1; i_2 < PB_Q; i_2++) {
            C[i_2][i_1] = F[i_2][i_1-1] - F[i_2+1][i_1+1] * G[i_2][i_1][i_2] - B[i_2-1] + C[i_2-1][i_1] - C[i_2+1][i_1] + 1;
        }
    }
#pragma endscop
...
kernel_4322231315_05(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
