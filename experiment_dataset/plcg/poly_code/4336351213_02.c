...
void kernel_4336351213_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < PB_Q-1; i_2++) {
                for (int i_3 = i_0; i_3 < -i_1+PB_Q-1; i_3++) {
                    A[i_1][i_0][i_1][i_2+1] = D[i_3][i_0][i_2] * E[i_0+1][i_2][i_3+1][i_1] - E[i_2-1][i_3-1][i_0][i_1] * F[i_3][i_2-1][i_1+1][i_1] + G[0][i_2-1][i_0][i_3+i_1+1] * A[i_3][i_0-1][i_3][i_2+1] * A[i_1+1][i_0][i_1+1][i_3+1] * 1;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < -i_4+PB_M+1; i_5++) {
            for (int i_6 = 1; i_6 < i_4; i_6++) {
                for (int i_7 = 2; i_7 < PB_Q-1; i_7++) {
                    B[i_4][i_5][i_7-1][i_7] = E[i_6][i_5][i_4][i_7] + H[i_5+i_4-1][i_6][i_7] + G[i_4][i_6+i_5][i_7][1] + F[i_6][i_7][i_5+i_4+1][0] * A[i_6-1][i_5+1][i_6-1][i_7+1] + B[i_4][i_5][i_7-2][i_7-1] + B[i_7-1][i_5][i_6-1][i_6] + 4;
                }
            }
        }
        C[i_4-1] = I[i_4] - J[i_4+1] - K[i_4+1] - K[i_4] * J[i_4] * I[1] + 1;
    }
#pragma endscop
...
kernel_4336351213_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K));
