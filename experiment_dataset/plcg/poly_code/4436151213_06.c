        ...
        for (int i_5 = 1; i_5 < PB_P-1; i_5++) {
            for (int i_6 = 1; i_6 < min(-i_4+PB_M-1, i_5); i_6++) {
                for (int i_7 = 0; i_7 < -i_5+PB_M; i_7++) {
                    D[i_7][i_6][i_4][0] = G[i_6][i_4][i_6-1][i_7+i_5+1][0] + H[i_4][i_6][i_7][i_5] - G[i_5][i_4][0][i_7][i_7] + H[i_7][i_6+i_4+1][i_4][i_5-1] - H[i_7][i_6][i_5+1][0] * I[i_5][i_6][i_4-1] * H[i_6+1][i_7+i_5][i_4+1][i_4] * H[i_7][i_4][i_5][i_6-1] - D[i_7+1][i_4+1][i_6][0] * 2;
                }
            }
        }
    }
...
init_array(xc,yc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4436151213_06(xc,yc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xc,yc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
