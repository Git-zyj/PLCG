...
void kernel_4326112315_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf)){
...
#pragma scop
        ...
        for (int i_1 = 2; i_1 < PB_L; i_1++) {
            for (int i_2 = max(1, i_0); i_2 < PB_P-1; i_2++) {
                for (int i_3 = max(1, i_0); i_3 < PB_P-1; i_3++) {
                    A[i_0+1][i_1][i_2][i_3] = D[i_0][i_1-2][i_3][0] - A[i_0][i_1-1][i_2-1][i_3+1] * A[i_0+1][i_1-1][i_2][i_3] * A[i_0+1][i_1][i_2+1][i_3-1] - 6;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L; i_4++) {
        for (int i_5 = 3; i_5 < PB_L+1; i_5++) {
            B[i_5-2] = B[i_5-1] * B[i_5-3] - 4;
        }
        for (int i_6 = max(i_4, 3); i_6 < -i_4+PB_M+2; i_6++) {
            B[i_6-3] = E[i_6][i_4] - F[i_6+i_4-2] * 3;
        }
    }
#pragma endscop
...
kernel_4326112315_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F));
