...
void kernel_2222212325_03(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N; i_0++) {
        for (int i_1 = 2; i_1 < min(PB_L, i_0); i_1++) {
            A[i_0][i_1] = C[i_1-2][i_1] + A[i_0][i_1-2] + 5;
        }
        for (int i_2 = i_0; i_2 < PB_M-2; i_2++) {
            A[i_0][i_2] = A[i_0][i_2+2] + A[i_0][i_2] * 6;
        }
    }
#pragma endscop
...
kernel_2222212325_03(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C));
