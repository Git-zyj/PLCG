        ...
        for (int i_1 = i_0; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 2; i_2 < min(-i_1+PB_Q-2, -i_0+PB_L); i_2++) {
                for (int i_3 = 2; i_3 < PB_P-2; i_3++) {
                    A[i_0][i_1+2][i_2][i_3] = C[i_3][i_0][i_1+1][i_2] * D[i_2+i_1][i_2+2][i_0][i_3+1] * E[i_3-2][i_2][i_1+2] * C[i_1][i_3][i_2][i_2+i_1+2] + D[i_3][i_0][i_1+2][i_2-2] + D[i_3][i_2+i_0][i_3][0] + C[i_0][i_2+i_0][i_1][i_3] * A[i_0][i_3+2][i_2+2][i_1] - A[i_3][i_1+2][i_2][i_0-1] * 5;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-3; i_4++) {
        B[i_4+2] = F[i_4] + G[i_4-1] + G[i_4] + B[i_4+3] * 5;
    }
#pragma endscop
...
kernel_4224352223_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
