...
void kernel_4426251315_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl)){
        ...
        for (int i_1 = 1; i_1 < min(-i_0+PB_Q, PB_N-1); i_1++) {
            for (int i_2 = i_1; i_2 < PB_N-1; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_1+PB_M, -i_0+PB_L); i_3++) {
                    A[i_0+1][i_1][i_2][i_0] = E[i_3][i_3+i_0][i_1+1][i_2] + F[i_3-1][i_1][i_0][i_2-1][i_1+i_0] + G[i_2+1][i_1+1][i_0+1][i_3] + H[i_3+i_1][i_2+1][i_2] * A[i_0+1][i_1][i_2-1][i_0] + A[i_1][i_0][i_2+1][i_1-1] * 2;
                }
            }
            B[i_0][i_1] = I[i_1][i_1] + J[i_1] - I[i_0+1][i_1] - B[i_0][i_1-1] * B[i_0+1][i_1-1] + 5;
        }
    }
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        C[i_4] = K[i_4] - J[i_4] * K[i_4] + K[i_4] - K[i_4] + K[i_4+1] - C[i_4-1] - C[i_4+1] + 1;
        for (int i_5 = 1; i_5 < min(i_4, -i_4+PB_M); i_5++) {
            C[i_5] = I[i_4][i_4] * L[i_5][i_4] - L[i_4][i_5+1] + I[i_5][i_4] * L[i_5+i_4][i_4] + I[i_5][i_4] + C[i_5-1] + C[i_5] * C[i_5+1] * 4;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4426251315_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L));
