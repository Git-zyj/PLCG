...
void kernel_4222211215_07(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_4 = 0; i_4 < PB_M; i_4++) {
        for (int i_5 = 1; i_5 < PB_M; i_5++) {
            for (int i_6 = 1; i_6 < -i_5+PB_M; i_6++) {
                B[i_4][i_6][1] = C[i_6+i_5][i_5-1][i_4] - C[i_5][i_4][i_6-1] * B[i_4][i_6+1][1] - B[i_4][i_6-1][1] - 4;
            }
        }
    }
#pragma endscop
...
kernel_4222211215_07(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
