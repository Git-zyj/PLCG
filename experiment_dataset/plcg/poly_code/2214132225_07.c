...
void kernel_2214132225_07(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 4; i_0 < PB_M; i_0++) {
        A[i_0-2][i_0] = C[i_0] * C[i_0] + A[i_0-3][i_0-1] - A[i_0-4][i_0-2] - 3;
    }
    for (int i_1 = 2; i_1 < PB_M; i_1++) {
        A[i_1-2][i_1] = C[i_1] * C[i_1] - C[i_1] * 5;
    }
#pragma endscop
...
kernel_2214132225_07(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
