...
void kernel_4314251115_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_0+PB_M-1, -i_1+PB_P); i_2++) {
                for (int i_3 = 1; i_3 < min(-i_1+PB_M+1, -i_0+PB_P-1); i_3++) {
                    A[i_0][i_2][i_0][i_1] = D[i_1][i_1][i_3+i_0+1][0] + D[i_3+i_1-1][i_0+1][i_3-1][i_2] + D[i_2+i_0+1][i_1][i_3][i_3] * E[i_3][i_0-1][i_1][i_2] * E[i_0][i_3][i_1][i_2+i_1] + D[i_2][0][i_0][i_1+1] - D[i_3][i_2][i_0][i_3] - A[i_0+1][i_2][i_0+1][i_1] * 6;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M; i_4++) {
        B[i_4] = F[i_4] - G[i_4] - G[i_4] + F[i_4] + G[i_4-1] * F[i_4] - 2;
        for (int i_5 = 0; i_5 < PB_M; i_5++) {
            B[i_4] = H[i_4][i_5] + H[i_5][i_4] + 6;
        }
    }
#pragma endscop
...
kernel_4314251115_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
