...
void kernel_4224312315_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
        ...
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            for (int i_2 = i_0; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < i_1; i_3++) {
                    A[i_1][i_3][i_1] = A[i_1+1][i_3][i_1+1] + A[i_2+1][i_3][i_2+1] - A[i_1-1][i_3][i_1-1] + A[i_3+1][i_1][i_3+1] * 5;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M; i_4++) {
        B[i_4-1] = C[i_4] + D[i_4] * B[i_4-2] - 1;
    }
#pragma endscop
...
kernel_4224312315_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
