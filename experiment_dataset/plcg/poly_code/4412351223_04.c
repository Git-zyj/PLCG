        ...
        for (int i_1 = 2; i_1 < PB_P-2; i_1++) {
            for (int i_2 = 0; i_2 < PB_P; i_2++) {
                for (int i_3 = 2; i_3 < PB_Q-1; i_3++) {
                    A[i_0][i_1][i_3-1][i_1] = E[i_2][i_3][i_1-1][1] * F[i_3][i_2][i_0] + G[i_3][i_2][i_0-1][i_1] * H[i_0][i_2][i_1] - E[i_2][0][i_0][i_1+1] - G[i_2][i_0-1][i_2][i_3] + G[i_3][i_2][i_0][i_1+1] * A[i_0-2][i_1-2][i_3-2][i_1-2] + A[i_0][i_1+2][i_3-1][i_1+2] + A[i_0][i_1-2][i_3+1][i_1-2] - 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-2; i_4++) {
        for (int i_5 = i_4; i_5 < PB_P; i_5++) {
            for (int i_6 = i_4; i_6 < min(PB_P, -i_5+PB_L); i_6++) {
                D[i_4+1] = H[i_6][i_4][i_5] - I[i_4][i_6+i_5][i_6] * 1;
            }
            for (int i_7 = 1; i_7 < min(PB_Q-1, -i_5+PB_L); i_7++) {
                for (int i_8 = 2; i_8 < PB_P-1; i_8++) {
                    C[i_7+1][i_5][i_8][i_4-1] = E[i_4-1][i_8+1][i_5-1][i_7+1] * F[i_7][i_5-1][i_5] + J[i_7+i_5][i_4][i_8][i_7] + K[i_5][i_4][i_5][i_7][i_8] + J[i_8][i_4][i_5-1][i_7-1] + C[i_7][i_5][i_8-2][i_4-1] * 1;
                }
            }
        }
        for (int i_9 = 0; i_9 < PB_N; i_9++) {
            D[i_4] = L[i_4-1][i_9] + M[i_9][i_4] * M[i_9][i_4] * N[i_9+1][i_4] + D[i_4+2] + 5;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,wk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M), xn,yn,POLYBENCH_ARRAY(N), INIT_SEED);
kernel_4412351223_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,wk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M), xn,yn,POLYBENCH_ARRAY(N));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,wk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M), xn,yn,POLYBENCH_ARRAY(N)));
