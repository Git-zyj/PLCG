    ...
    for (int i_3 = 1; i_3 < PB_P; i_3++) {
        for (int i_4 = 1; i_4 < min(-i_3+PB_Q, i_3); i_4++) {
            for (int i_5 = 1; i_5 < PB_L-1; i_5++) {
                B[i_5][i_4-1][i_5] = E[i_5][i_5][i_4+i_3] + D[i_4][i_3][i_3-1] + B[i_5+1][i_4-1][i_5+1] - B[i_5-1][i_4-1][i_5-1] * 3;
            }
        }
    }
#pragma endscop
...
kernel_3216231123_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
