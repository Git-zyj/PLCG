...
void kernel_4336151315_03(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        C[i_0] = D[i_0] * D[i_0] - D[i_0+1] + C[i_0] + 6;
    }
    for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
        C[i_1+1] = D[i_1] - D[i_1-1] * D[i_1-1] * D[i_1] - D[i_1] - D[i_1] + D[i_1-1] - 2;
    }
    for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
        C[i_2] = D[i_2] + D[1] * D[i_2] * D[i_2] + C[i_2+1] + C[i_2-1] - 1;
    }
#pragma endscop
...
kernel_4336151315_03(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
