...
void kernel_4424111123_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
        ...
        for (int i_1 = 2; i_1 < PB_P-1; i_1++) {
            for (int i_2 = i_1; i_2 < PB_Q-1; i_2++) {
                for (int i_3 = 1; i_3 < i_2; i_3++) {
                    A[i_0-1][i_1][i_3-1][i_2] = E[i_3][i_2][i_1+1][i_0] - A[i_0-1][i_1][i_3-1][i_2+1] - A[i_0-3][i_1-2][i_3-1][i_2] * 1;
                }
            }
        }
        ...
        for (int i_8 = 1; i_8 < PB_P; i_8++) {
            for (int i_9 = 0; i_9 < i_8; i_9++) {
                for (int j_0 = 1; j_0 < PB_P+1; j_0++) {
                    A[i_7-2][i_8-1][j_0-1][i_9] = F[i_7][j_0][i_8] - 3;
                }
            }
        }
        for (int j_1 = 0; j_1 < i_7; j_1++) {
            for (int j_2 = 0; j_2 < PB_P-1; j_2++) {
                for (int j_3 = j_2; j_3 < PB_Q-1; j_3++) {
                    D[i_7][j_1][j_2+1][j_3+1] = 6;
                }
            }
        }
    }
...
kernel_4424111123_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
