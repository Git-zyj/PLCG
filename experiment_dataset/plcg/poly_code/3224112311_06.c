...
void kernel_3224112311_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        A[i_0-1] = C[i_0-2] - C[i_0] - A[i_0] - A[i_0-2] * 5;
    }
...
kernel_3224112311_06(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
