...
void kernel_2126311111_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            A[i_1] = B[i_1-1] - A[i_1+1] * 1;
        }
    }
#pragma endscop
...
kernel_2126311111_07(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
