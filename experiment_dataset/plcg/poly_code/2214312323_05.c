...
void kernel_2214312323_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-4; i_0++) {
        B[i_0+2] = B[i_0+4] - 3;
        B[i_0+2] = C[i_0] * B[i_0] - B[i_0+1] - 4;
    }
#pragma endscop
...
kernel_2214312323_05(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
