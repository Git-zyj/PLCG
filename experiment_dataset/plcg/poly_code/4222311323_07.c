...
void kernel_4222311323_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 4; i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = 0; i_2 < PB_Q-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_P; i_3++) {
                    A[i_1+i_0][i_1][i_2][i_3-1] = C[i_2][i_1][i_3] + A[i_3+i_1-4][i_1-2][i_2+1][i_0-1] - 3;
                }
            }
            B[i_0][i_1] = B[i_0-1][i_1] * B[i_1-2][i_0] - B[i_0-2][i_1-2] - B[i_0+2][i_1] * B[i_0][i_1+2] + 3;
        }
    }
#pragma endscop
...
kernel_4222311323_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
