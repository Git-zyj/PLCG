...
void kernel_2432252215_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M; i_0++) {
        A[i_0-2] = E[i_0] + F[0] - E[i_0] + F[i_0] - E[i_0] + A[i_0-3] - 1;
    }
    for (int i_1 = 3; i_1 < PB_M-1; i_1++) {
        for (int i_2 = 0; i_2 < -i_1+PB_M; i_2++) {
            C[i_2+i_1-1][2] = G[i_1][i_2] + G[i_2+i_1][i_2] * H[i_1][i_1] - G[i_2+2][i_1] - 4;
        }
        for (int i_3 = 2; i_3 < -i_1+PB_M; i_3++) {
            C[i_3+i_1][2] = I[i_3-2][i_1+1][i_3] - G[i_3-2][i_1] - H[i_3][i_1] * G[i_3][2] - H[i_1][i_3+2] - F[i_1+1] - A[i_1-3] - 6;
        }
    }
    for (int i_4 = 2; i_4 < PB_M-2; i_4++) {
        for (int i_5 = 0; i_5 < -i_4+PB_M-2; i_5++) {
            C[i_5+i_4+2][2] = H[i_5][i_4] - G[i_4-1][i_5] * E[i_5] * A[i_4-2] - 6;
        }
    }
#pragma endscop
...
kernel_2432252215_07(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
