...
void kernel_2322311311_00(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
    ...
    for (int i_4 = 2; i_4 < PB_M; i_4++) {
        C[i_4-1] = E[i_4+1] * C[i_4-2] * C[i_4] - C[i_4-2] + 2;
    }
#pragma endscop
...
kernel_2322311311_00(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
