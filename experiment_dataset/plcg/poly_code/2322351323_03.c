...
void kernel_2322351323_03(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N-1; i_0++) {
        for (int i_1 = 0; i_1 < -i_0+PB_N-1; i_1++) {
            A[i_1+i_0][1] = D[i_1][i_0] - E[i_1] - F[i_0][i_1] * A[i_1+i_0-2][1] + A[i_1+i_0+1][1] - 3;
        }
        for (int i_2 = 2; i_2 < min(-i_0+PB_M, PB_N); i_2++) {
            B[i_0][i_2] = D[i_0+1][i_2] - D[i_2+i_0][i_0] * G[i_2-1][i_0] - F[1][i_0] - D[i_2][i_0] + F[i_0][i_2] + G[i_2][i_2] - B[i_0-1][i_2-1] * B[i_0+2][i_2] + B[i_0-2][i_2-2] + B[i_2+2][i_0] * 4;
        }
    }
    for (int i_3 = 3; i_3 < PB_N-1; i_3++) {
        for (int i_4 = 1; i_4 < -i_3+PB_N-1; i_4++) {
            C[i_4+i_3-1][i_3] = H[i_4] * F[i_4-1][i_3] + G[0][i_3] - G[i_4][i_3] * E[i_4] - C[i_4+i_3-3][i_3] - C[i_4+i_3+1][i_3+2] + 6;
        }
    }
#pragma endscop
...
kernel_2322351323_03(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
