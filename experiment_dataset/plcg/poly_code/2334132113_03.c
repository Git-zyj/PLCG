...
void kernel_2334132113_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-2; i_0++) {
        B[0] = D[i_0] * D[i_0-1] - B[0] - 1;
        B[0] = D[i_0] - D[i_0+2] + 6;
    }
    for (int i_1 = 0; i_1 < PB_M-2; i_1++) {
        B[0] = D[i_1] - D[i_1] * D[i_1] + D[i_1+2] - 2;
    }
#pragma endscop
...
kernel_2334132113_03(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
