...
void kernel_4222211323_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 1; i_2 < PB_Q-2; i_2++) {
                for (int i_3 = i_0; i_3 < -i_0+PB_M-2; i_3++) {
                    A[i_3+i_0][i_1][i_2+1][i_3] = A[i_3+i_0+2][i_1][i_2-1][i_3+2] + A[i_3+i_0][i_1+2][i_2+1][i_3] * A[i_3+i_0][i_1][i_2+2][i_0] + 6;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_P-1; i_4++) {
        for (int i_5 = 0; i_5 < PB_L; i_5++) {
            B[i_4] = C[i_5][i_4+1] + B[i_4-1] + B[i_4+1] - 4;
        }
    }
#pragma endscop
...
kernel_4222211323_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
