...
void kernel_4216212125_05(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        ...
        for (int i_2 = 2; i_2 < PB_L; i_2++) {
            for (int i_3 = i_0; i_3 < PB_L-2; i_3++) {
                B[i_2][0] = C[i_0][i_2][1] - D[i_3+2][i_0][i_2+1] - B[i_2-2][0] * 6;
            }
        }
    }
#pragma endscop
...
kernel_4216212125_05(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
