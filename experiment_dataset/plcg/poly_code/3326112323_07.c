...
void kernel_3326112323_07(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        C[i_0] = 2;
        C[i_0+1] = D[i_0] * D[i_0-2] + 6;
    }
...
kernel_3326112323_07(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
