...
void kernel_4312132215_09(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P-1; i_0++) {
        for (int i_1 = 1; i_1 < -i_0+PB_P; i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_P; i_2++) {
                A[i_2][i_2+i_0][i_1] = D[i_1][i_0][i_2] * D[i_2+i_0][i_2+i_0-2][i_1-1] + A[i_2-1][i_2+i_0-2][i_1] - A[i_0-1][i_1+i_0][i_2] * 2;
                for (int i_3 = 2; i_3 < i_1; i_3++) {
                    B[i_3][i_1][i_2][i_0+1] = E[i_3+i_1][i_2][i_0][i_3-1] * E[i_3+i_2][i_1][i_0][0] - E[i_2][i_3+1][i_1][i_0] * E[i_3-2][i_3+i_2][i_0-2][i_1] - D[i_2-1][i_3][0] * E[i_0][i_3-2][i_1][i_2-1] * B[i_3][i_1+1][i_2][i_0+1] * 6;
                }
            }
            C[i_1][i_0] = C[i_1][i_0+1] - 4;
        }
    }
#pragma endscop
...
kernel_4312132215_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
