...
void kernel_2226131225_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_M; i_1++) {
        A[i_1] = C[1] + C[i_1-1] - C[i_1] + C[i_1] * A[i_1] + 1;
    }
#pragma endscop
...
kernel_2226131225_01(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
