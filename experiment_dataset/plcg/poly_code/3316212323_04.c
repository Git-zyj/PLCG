...
void kernel_3316212323_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < min(-i_0+PB_Q-2, i_0); i_1++) {
            for (int i_2 = 2; i_2 < PB_L; i_2++) {
                A[i_2][i_1+1][i_1+i_0+2] = D[i_2-2][i_0][i_1] - A[i_2-1][i_1+1][i_1+i_0+2] + 4;
            }
        }
        for (int i_3 = 1; i_3 < PB_L+1; i_3++) {
            for (int i_4 = i_0; i_4 < PB_M; i_4++) {
                B[i_4][i_3-1][i_0] = B[i_4][i_3-1][i_0+2] - 3;
            }
        }
    }
    for (int i_5 = 5; i_5 < PB_L-2; i_5++) {
        for (int i_6 = 2; i_6 < -i_5+PB_M; i_6++) {
            for (int i_7 = 0; i_7 < i_6; i_7++) {
                C[i_7][i_6+i_5-2][i_6][i_6] = C[i_7][i_6+i_5-4][i_6][i_6] + C[i_7+2][i_6+i_5-5][i_5-2][i_5-2] * C[i_7][i_6+i_5-1][i_5+2][i_5+2] * C[i_7][i_6+i_5-3][i_6-2][i_6-2] - C[i_7+1][i_6+i_5-2][i_6][i_6] - C[i_7][i_6+i_5][i_5][i_5] * 2;
            }
        }
    }
#pragma endscop
...
kernel_3316212323_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
