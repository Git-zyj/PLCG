...
void kernel_4422251313_02(int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 2; i_1 < min(-i_0+PB_P+1, PB_L-1); i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_M; i_2++) {
                for (int i_3 = 1; i_3 < min(PB_M-1, -i_2+PB_M); i_3++) {
                    D[i_0+1][i_2][i_1-2][i_3-1] = E[i_2][i_1+1][i_1+i_0-1] + F[i_3+i_2][i_0][i_1][i_3] - G[i_0][i_3][i_2+i_1][1] - F[i_3+1][i_2][i_0][i_1] * 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_P-1; i_4++) {
        for (int i_5 = 1; i_5 < PB_M-1; i_5++) {
            B[i_5] = H[i_5][i_4] - I[i_5] * J[i_4][i_5+1] - J[i_4][i_5-1] * J[i_5][i_4+1] - K[i_4-1] + L[i_5][i_4][i_4] * H[i_5-1][i_4] - J[i_5+1][i_4] - H[i_4][i_5-1] - B[i_5-1] - B[i_5+1] * B[i_5-1] + B[i_5+1] * 3;
        }
    }
    for (int i_6 = 1; i_6 < PB_Q; i_6++) {
        for (int i_7 = 1; i_7 < -i_6+PB_Q; i_7++) {
            C[i_7][i_7+1] = H[i_7][i_6] + H[i_6][i_7] - C[i_7-1][i_7] * C[i_7+1][i_7+2] + C[i_7-1][i_7] * 1;
            for (int i_8 = 1; i_8 < -i_7+PB_N; i_8++) {
                for (int i_9 = 0; i_9 < PB_L; i_9++) {
                    D[i_6][i_9][i_8-1][i_7] = G[i_8-1][i_6-1][i_9][i_7] - G[i_8+i_7][i_6-1][i_9][i_7] - L[i_8][i_7][i_7+i_6] + D[i_6-1][i_9][i_8][i_7-1] + 5;
                }
            }
        }
    }
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4422251313_02(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L)));
