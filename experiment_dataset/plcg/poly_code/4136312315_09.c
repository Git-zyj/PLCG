...
void kernel_4136312315_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 2; i_1 < min(PB_L, i_0); i_1++) {
            A[i_1-1] = B[i_0+2] - A[i_1-2] * A[i_1] + A[i_1] + 6;
        }
    }
#pragma endscop
...
kernel_4136312315_09(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
