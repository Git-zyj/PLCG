...
void kernel_3236112221_07(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_0 = 1; i_0 < PB_L-2; i_0++) {
        for (int i_1 = i_0; i_1 < -i_0+PB_M; i_1++) {
            ...
            for (int i_3 = 2; i_3 < min(PB_Q-2, i_0); i_3++) {
                B[i_0][i_3-2][i_3] = C[i_1][0][i_0+1] - B[i_0+1][i_3-2][i_3] - B[i_0-1][i_3-2][i_3] * B[i_0][i_3][i_3+2] - B[i_0+2][i_3-2][i_3] - 6;
            }
        }
    }
#pragma endscop
...
kernel_3236112221_07(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
