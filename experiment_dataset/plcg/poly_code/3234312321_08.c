...
void kernel_3234312321_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N-1; i_0++) {
        for (int i_1 = i_0; i_1 < PB_M; i_1++) {
            A[i_0-1][i_1][i_1] = A[i_0-1][i_1-1][i_1-1] * A[i_0+1][i_1][i_1] + A[i_0-2][i_1][i_1] + 4;
        }
    }
    for (int i_2 = 0; i_2 < PB_L; i_2++) {
        for (int i_3 = 1; i_3 < min(PB_P-1, i_2); i_3++) {
            for (int i_4 = 0; i_4 < PB_M-2; i_4++) {
                B[i_3-1][i_4] = C[i_3][i_4][i_2] * D[i_2][i_3+1][i_4] - B[i_3+1][i_4] - B[i_3+1][i_4+2] - 6;
            }
        }
    }
#pragma endscop
...
kernel_3234312321_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
