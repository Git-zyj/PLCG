...
void kernel_3214312323_02(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_L-4; i_1++) {
        B[i_1+2] = C[i_1] * B[i_1+3] + B[i_1+1] * B[i_1+4] - 1;
    }
#pragma endscop
...
kernel_3214312323_02(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
