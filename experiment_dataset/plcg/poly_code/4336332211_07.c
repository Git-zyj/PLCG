...
void kernel_4336332211_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf)){
        ...
        for (int i_1 = i_0; i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = 2; i_2 < PB_L; i_2++) {
                for (int i_3 = 1; i_3 < PB_M; i_3++) {
                    A[i_3][i_0][i_2-2][i_1] = D[i_1][i_3][i_0][i_2] + D[i_2][i_3][i_1+i_0][i_3-1] - A[i_3][i_1+1][i_2-2][i_0-1] + A[i_3-1][i_0][i_2-1][i_1+1] + 6;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-2; i_4++) {
        B[i_4-2] = E[i_4+2] * E[i_4] * B[i_4-1] - 2;
        for (int i_5 = 2; i_5 < -i_4+PB_L-2; i_5++) {
            for (int i_6 = 1; i_6 < PB_M; i_6++) {
                for (int i_7 = 0; i_7 < min(-i_6+PB_M, i_6); i_7++) {
                    C[i_7+1][i_5-1][i_4][i_6] = F[i_5][i_7+i_6][i_5][i_4] * F[i_7+2][i_4+1][i_5-1][i_6] * F[i_6][i_4][i_7][i_5+1] * F[i_7][i_6][i_5+2][i_5+i_4+2] + C[i_7+1][i_5-1][i_4+1][i_6-1] - C[i_7+1][i_5-2][i_4+1][i_6+1] * 3;
                }
            }
        }
    }
...
kernel_4336332211_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
