        ...
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < i_1; i_3++) {
                    B[i_1][i_2][i_0][1] = D[i_2+1][i_2][i_3] * 1;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        for (int i_5 = i_4; i_5 < PB_M-1; i_5++) {
            for (int i_6 = 1; i_6 < PB_M-1; i_6++) {
                for (int i_7 = 0; i_7 < min(-i_5+PB_N, -i_6+PB_L+1); i_7++) {
                    B[i_7][i_5][i_6][1] = E[i_7+i_5][i_6+1][i_4][i_7+i_6-1] + B[i_7][i_5][i_6-1][1] + B[i_5+1][i_7][i_6][1] - 1;
                }
            }
        }
        for (int i_8 = i_4; i_8 < -i_4+PB_L-1; i_8++) {
            for (int i_9 = 1; i_9 < PB_L; i_9++) {
                for (int j_0 = 1; j_0 < min(-i_8+PB_N, PB_L-1); j_0++) {
                    B[j_0][i_8+1][i_9-1][1] = F[i_8+1][j_0+1][i_4+1][i_9+1] * G[i_9][i_8+i_4+1][j_0][i_4] - G[i_9-1][i_4-1][i_8][i_4] + E[i_9][i_4-1][i_8][i_9] * E[j_0+i_8][i_4-1][i_8][j_0-1] + 3;
                }
            }
        }
    }
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4326331215_00(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G)));
