...
void kernel_4412111125_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve)){
...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_P; i_1++) {
            for (int i_2 = 1; i_2 < PB_M; i_2++) {
                for (int i_3 = max(1, i_0); i_3 < PB_P; i_3++) {
                    A[i_0][i_1-1][i_3-1][i_3] = E[i_2][i_0][i_1][i_1+i_0] - 6;
                }
                for (int i_4 = 0; i_4 < PB_L; i_4++) {
                    A[i_0][i_1-1][i_2-1][i_2] = 5;
                }
            }
        }
    }
    for (int i_5 = 1; i_5 < PB_N; i_5++) {
        for (int i_6 = 0; i_6 < PB_N-1; i_6++) {
            C[i_6][i_5+1] = C[i_6+1][i_5-1] * 6;
            for (int i_7 = 1; i_7 < PB_P; i_7++) {
                for (int i_8 = i_7; i_8 < PB_M-1; i_8++) {
                    A[i_5][i_8+1][i_7-1][i_7] = E[i_8-1][i_5][i_7][0] + 6;
                }
            }
        }
    }
...
kernel_4412111125_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
