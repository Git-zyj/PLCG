        ...
        for (int i_1 = 1; i_1 < PB_L-2; i_1++) {
            for (int i_2 = i_0; i_2 < PB_L-3; i_2++) {
                for (int i_3 = 1; i_3 < i_2; i_3++) {
                    A[i_0-1][i_2+2][i_2][i_3] = E[i_2][i_3][0][i_1] + F[i_2][i_0+1][i_1][2] * G[i_1][i_3][i_2][i_0+2] * A[i_0-1][i_2+3][i_2+1][i_3-1] * A[i_3][i_2+2][i_2][i_0+1] * A[i_0-2][i_1+2][i_1][i_3] - A[i_0-1][i_2+2][i_2][i_1-1] * 6;
                }
            }
            C[i_1-1] = H[i_1] + I[i_1][i_0] + J[i_1][i_0] * I[i_1+1][i_0] * C[i_0] - 4;
        }
        C[i_0] = H[i_0] + H[i_0-2] + C[i_0-1] + 4;
    }
    for (int i_4 = 0; i_4 < PB_L; i_4++) {
        for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
            for (int i_6 = 2; i_6 < min(PB_L, i_5); i_6++) {
                for (int i_7 = max(0, -i_6+2); i_7 < min(PB_L, -i_6+PB_P+2); i_7++) {
                    D[i_5][i_4][i_7+2][i_6] = E[i_5+1][i_6][i_4+1][i_7] - F[i_7][i_5][i_7+i_6-2][i_4] - D[i_5][i_7][i_4+2][i_6-1] + 5;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4414332315_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J)));
