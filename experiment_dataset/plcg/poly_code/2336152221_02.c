...
void kernel_2336152221_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N-1; i_0++) {
        A[i_0] = D[i_0] + D[i_0] * D[i_0] + D[i_0-1] + D[i_0] - D[i_0] * D[i_0] * A[i_0+1] - 1;
        for (int i_1 = max(3, i_0); i_1 < min(-i_0+PB_M, PB_L-1); i_1++) {
            B[i_0][i_1-1] = E[i_1][i_0-2] * E[i_1+i_0][i_1] * E[i_1+1][i_0] * E[i_1+i_0][2] + B[i_0+1][i_1+1] - B[i_0][i_1-3] - B[i_0-1][i_1-3] * 6;
        }
    }
    for (int i_2 = 2; i_2 < PB_L+2; i_2++) {
        for (int i_3 = 0; i_3 < i_2; i_3++) {
            C[i_3+1] = E[i_3][i_3] * E[i_3][i_2] * E[i_3][i_2] + E[i_3][i_2] - B[i_3][i_2-2] - C[i_3] + 1;
        }
    }
#pragma endscop
...
kernel_2336152221_02(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
