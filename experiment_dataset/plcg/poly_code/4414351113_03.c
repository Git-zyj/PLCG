...
void kernel_4414351113_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl)){
        ...
        for (int i_1 = 2; i_1 < min(-i_0+PB_N, PB_L-1); i_1++) {
            for (int i_2 = i_1; i_2 < PB_L; i_2++) {
                for (int i_3 = 1; i_3 < -i_2+PB_L; i_3++) {
                    A[i_1-1][i_2][i_3][i_0] = E[i_2][i_1][i_0][i_1] - F[i_2][i_1][i_1] - E[i_3+i_2][i_1][i_0-1][i_3] - G[i_3][i_2-1][i_0][i_1] * G[i_3][i_0][i_1][i_2] - H[i_2+i_1-1][i_3][i_0-1][i_2-1] - G[i_2-1][i_3][i_1][i_0] - A[i_1-2][i_2][i_0][i_3-1] - 4;
                }
            }
            for (int i_4 = 1; i_4 < PB_L; i_4++) {
                B[i_4-1][i_1][i_4] = F[i_1+i_0][i_4][0] * F[i_4][i_0][i_1] - I[i_1][i_0] + F[i_4][i_0][i_1+1] + 5;
            }
        }
        C[i_0] = J[i_0] + J[i_0] - J[i_0] - K[i_0] + L[i_0-1] * 6;
    }
    for (int i_5 = 0; i_5 < PB_L-1; i_5++) {
        C[i_5] = J[i_5] * J[i_5+1] + 2;
    }
#pragma endscop
