...
void kernel_4326211125_07(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
        ...
        for (int i_4 = 0; i_4 < min(min(-i_0+PB_Q, i_0), PB_M-1); i_4++) {
            for (int i_5 = 1; i_5 < PB_P-2; i_5++) {
                for (int i_6 = i_5; i_6 < PB_M-1; i_6++) {
                    B[i_6+1][i_4][i_5-1][i_0] = D[i_6][i_0][i_5+1][i_4+i_0] + B[i_4+1][i_5+2][i_6-1][i_0] + 2;
                }
            }
        }
    }
        ...
        for (int i_8 = 0; i_8 < PB_M-1; i_8++) {
            for (int i_9 = 1; i_9 < PB_P; i_9++) {
                for (int j_0 = 2; j_0 < PB_P; j_0++) {
                    B[i_7+1][i_9][j_0-2][i_8] = E[i_8+1][i_9-1][j_0] + 1;
                }
            }
        }
    }
...
kernel_4326211125_07(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
