        ...
        for (int i_1 = i_0; i_1 < -i_0+PB_P; i_1++) {
            for (int i_2 = i_0; i_2 < PB_P; i_2++) {
                for (int i_3 = 0; i_3 < -i_1+PB_M; i_3++) {
                    A[i_0][i_3+i_1][i_0][i_3+2] = D[i_1+i_0][i_2][i_3] + E[i_3][i_0][i_1][i_2] + F[i_2][i_0-2][i_1+i_0][1] + G[i_3][i_1][i_0][i_3+2][i_2+1] + E[i_1][i_2-1][i_0][i_1-1] * A[i_0][i_3+i_1-1][i_0][i_3+1] * A[i_0+1][i_3+i_1][i_0+1][i_1+2] + 4;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M; i_4++) {
        B[i_4] = H[i_4-2] * H[i_4] - H[i_4] * H[i_4] * H[i_4] + I[i_4] - B[i_4+1] + B[i_4-2] + 1;
        for (int i_5 = 2; i_5 < min(i_4, -i_4+PB_M); i_5++) {
            C[i_5+i_4][i_5] = J[i_5+i_4][i_5+2] * I[i_5+1] + H[i_5-2] + K[i_4] - B[i_4] - B[i_5] * C[i_5+i_4-1][i_5] + 6;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4326352321_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K));
