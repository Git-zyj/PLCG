...
void kernel_2224212225_02(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-2; i_0++) {
        ...
        for (int i_2 = max(2, i_0); i_2 < PB_L; i_2++) {
            B[i_2][i_0] = C[i_2][i_0] + B[i_0+2][i_2-2] + B[i_2][i_0-1] * 5;
        }
    }
#pragma endscop
...
kernel_2224212225_02(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
