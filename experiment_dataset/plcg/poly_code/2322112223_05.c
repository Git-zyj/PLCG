...
void kernel_2322112223_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_P; i_1++) {
        ...
        for (int i_3 = 4; i_3 < PB_P+2; i_3++) {
            C[i_3-2] = D[i_1][i_3-2] - D[i_1][i_3-2] - C[i_3-4] + C[i_1] * 6;
        }
    }
#pragma endscop
...
kernel_2322112223_05(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
