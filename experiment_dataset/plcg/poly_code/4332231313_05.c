        ...
        for (int i_1 = 0; i_1 < PB_P; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_1+PB_Q-1, i_1); i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_Q; i_3++) {
                    A[i_2][i_3+i_0][i_2+i_1+1][i_3] = D[i_3+1][i_2-1][i_1][i_0] - E[i_2-1][i_3][i_1+1] * A[i_2][i_3+i_0][i_2+i_1+1][i_3-1] * 2;
                }
            }
        }
        B[i_0-1] = F[i_0-1] - G[i_0] + B[i_0] + B[i_0-2] - B[i_0-2] - B[i_0-2] * 6;
    }
    for (int i_4 = 0; i_4 < PB_P; i_4++) {
        for (int i_5 = 1; i_5 < i_4; i_5++) {
            for (int i_6 = 1; i_6 < -i_4+PB_Q-1; i_6++) {
                for (int i_7 = 1; i_7 < min(PB_P-1, -i_5+PB_Q+1); i_7++) {
                    C[i_6-1][i_7][i_5][i_4] = H[i_5][i_4][i_7][i_4] * H[i_7-1][i_5-1][i_6+1][i_4] - D[i_7-1][i_6][i_4][i_5-1] - E[i_6][i_7+1][i_5+1] + H[i_5][i_4][i_6+1][i_5] + A[i_6][i_7+i_5-1][i_6+i_4+1][i_7] + C[i_6-1][i_7][i_5][i_4+1] + 2;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4332231313_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H)));
