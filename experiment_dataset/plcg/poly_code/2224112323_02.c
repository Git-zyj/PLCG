...
void kernel_2224112323_02(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        for (int i_1 = 0; i_1 < PB_L-2; i_1++) {
            B[i_0-2][i_0-1] = C[i_1+2][i_0] + 4;
        }
        B[i_0][i_0+1] = B[i_0+2][i_0+3] * B[i_0-2][i_0-1] - B[i_0+1][i_0+2] - 4;
    }
#pragma endscop
...
kernel_2224112323_02(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
