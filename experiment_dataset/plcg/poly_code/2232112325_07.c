...
void kernel_2232112325_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        A[i_0+1] = C[i_0] * A[i_0+3] + A[i_0] + 4;
...
kernel_2232112325_07(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
