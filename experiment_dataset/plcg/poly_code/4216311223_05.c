...
void kernel_4216311223_05(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 1; i_1 < PB_M+1; i_1++) {
            for (int i_2 = 1; i_2 < min(PB_L, i_1); i_2++) {
                for (int i_3 = 0; i_3 < -i_1+PB_M+1; i_3++) {
                    B[i_2][i_1][i_0][i_1] = C[i_3+i_1-1][i_2-1][i_0] + 6;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_L+1; i_4++) {
            for (int i_5 = 2; i_5 < PB_L; i_5++) {
                for (int i_6 = 0; i_6 < min(PB_Q-2, i_0); i_6++) {
                    B[i_5][i_6][i_0][i_6] = D[i_6][i_4-1][i_5-1] + B[i_5][i_6+2][i_0][i_6+2] + B[i_5-2][i_6+1][i_0-2][i_6+1] + 3;
                }
            }
        }
    }
...
kernel_4216311223_05(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
