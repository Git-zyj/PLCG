...
void kernel_4216231115_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
        ...
        for (int i_1 = 0; i_1 < -i_0+PB_Q; i_1++) {
            for (int i_2 = i_1; i_2 < PB_P; i_2++) {
                for (int i_3 = 1; i_3 < PB_M; i_3++) {
                    A[i_3][i_3][i_2][i_0] = C[i_2][i_3][i_3][i_1+i_0] * A[i_3-1][i_3-1][i_2][i_0] - 5;
                }
            }
        }
        for (int i_4 = max(1, i_0); i_4 < min(PB_M, -i_0+PB_L); i_4++) {
            for (int i_5 = 0; i_5 < PB_M; i_5++) {
                for (int i_6 = 1; i_6 < i_4; i_6++) {
                    A[i_6][i_6][i_5][i_0] = D[i_6-1][i_6][i_0][i_5] + D[i_0+1][i_6][i_4-1][i_5] - C[i_4][i_0][i_6][i_5] + E[i_5][i_4][i_0][i_6][i_0+1] - F[i_5][i_6+1][i_4+i_0] * 4;
                }
            }
        }
    }
...
kernel_4216231115_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
