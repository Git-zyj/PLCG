...
void kernel_4214251115_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf)){
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = i_0; i_2 < -i_0+PB_P; i_2++) {
                for (int i_3 = i_1; i_3 < -i_1+PB_P; i_3++) {
                    A[i_3][i_1+1][i_0][i_2] = C[i_1][i_3][i_2+i_0] - D[i_1+1][i_2-1][i_0][i_2] - D[i_2][i_1][i_0+1][i_2] - D[i_2][i_0+1][i_3+i_1-1][i_1+1] * E[i_1+1][i_0][i_2][i_3] * D[i_0][i_2+1][i_3][i_2] - F[i_2][i_3+i_1][i_0][i_2-1][i_0-1] + 3;
                }
            }
        }
        for (int i_4 = i_0; i_4 < PB_P-1; i_4++) {
            for (int i_5 = 1; i_5 < PB_P-1; i_5++) {
                for (int i_6 = 1; i_6 < PB_L; i_6++) {
                    A[i_6-1][i_5+1][i_0][i_4] = E[i_0][i_6][i_5][i_4-1] + D[i_5-1][i_6][i_5-1][i_4-1] - A[i_6][i_4+1][i_0][i_5-1] - 5;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), INIT_SEED);
kernel_4214251115_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F)));
