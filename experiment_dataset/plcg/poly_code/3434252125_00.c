...
void kernel_3434252125_00(int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-2; i_0++) {
        D[i_0] = E[i_0] * F[i_0] * F[i_0] - G[i_0][i_0+1] * E[i_0] + E[i_0] * 3;
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            D[i_1-2] = H[i_1][i_0] + G[i_0][i_1] + I[i_0][i_1-1][i_0] + F[i_1] - 2;
        }
        D[i_0+2] = E[i_0+2] + E[i_0] + F[i_0] * 2;
    }
    for (int i_2 = 1; i_2 < PB_M-2; i_2++) {
        D[i_2] = E[i_2+2] + E[i_2] * F[i_2] + E[i_2] + F[i_2] + D[i_2-1] - 2;
    }
#pragma endscop
...
kernel_3434252125_00(xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
