...
void kernel_4216211215_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
        ...
        for (int i_1 = i_0; i_1 < PB_P+1; i_1++) {
            for (int i_2 = i_1; i_2 < PB_L+1; i_2++) {
                for (int i_3 = 0; i_3 < PB_P; i_3++) {
                    A[i_1][i_0-1][i_2-1] = C[i_2][i_0][i_1-1] + 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L; i_4++) {
        for (int i_5 = 1; i_5 < i_4; i_5++) {
            for (int i_6 = 1; i_6 < PB_L; i_6++) {
                A[i_5+1][i_4-1][i_6] = D[1][i_6] - A[i_6][i_5-1][i_4-1] * A[i_5][i_4][i_6-1] + 5;
            }
        }
    }
#pragma endscop
...
kernel_4216211215_01(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
