...
void kernel_2214332223_07(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-3; i_0++) {
        A[i_0+1][i_0] = C[i_0+1] + C[i_0+2] * D[i_0] - C[i_0+1] * A[i_0-1][i_0-2] - A[i_0+3][i_0+2] + 6;
    }
    for (int i_1 = 0; i_1 < PB_M-1; i_1++) {
        A[i_1+1][i_1] = C[i_1] - C[i_1] + 3;
    }
#pragma endscop
...
kernel_2214332223_07(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
