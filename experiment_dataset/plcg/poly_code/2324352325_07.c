...
void kernel_2324352325_07(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        A[i_0][1] = D[i_0][i_0] * E[i_0] * F[i_0+1] - E[0] * A[i_0+1][1] - A[i_0-2][1] - 2;
        for (int i_1 = 0; i_1 < -i_0+PB_M; i_1++) {
            A[i_0][1] = E[i_1] + G[i_0][i_1] * G[i_1+i_0][i_1] - D[i_1][i_0+1] * H[i_1][i_0] + A[i_0][1] + C[1] + 2;
        }
        C[1] = I[i_0+1] - F[i_0+1] + D[i_0+2][i_0] * I[i_0-2] - E[i_0] - I[i_0] * C[1] + C[1] + 1;
    }
#pragma endscop
...
kernel_2324352325_07(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
