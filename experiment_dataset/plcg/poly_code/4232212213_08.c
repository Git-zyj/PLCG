...
void kernel_4232212213_08(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_P; i_0++) {
        for (int i_1 = min(-i_0+PB_L, PB_M-1) - 1; i_1 >= 0; i_1--) {
            for (int i_2 = 1; i_2 < PB_P+1; i_2++) {
                A[i_1][i_2] = C[i_1+i_0][i_2-1] + 3;
            }
            A[i_1][i_0] = C[i_1][i_0] - A[i_1][i_0] - A[i_1+1][i_0] + 3;
        }
    }
#pragma endscop
...
kernel_4232212213_08(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C));
