...
void kernel_3322152123_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N-2; i_0++) {
        A[i_0] = D[i_0] + D[i_0] - D[i_0] - D[i_0] + D[i_0+2] * A[i_0-2] - 5;
        B[i_0+2] = D[i_0+2] * D[i_0] * D[i_0] - D[i_0+2] * A[i_0+1] - 3;
    }
    for (int i_1 = 0; i_1 < PB_N-2; i_1++) {
        B[i_1+2] = D[i_1] * D[i_1+1] * D[i_1] - D[i_1] + D[i_1] - 6;
    }
#pragma endscop
...
kernel_3322152123_07(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
