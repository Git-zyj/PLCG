...
void kernel_4214312223_02(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = max(2, i_0); i_1 < min(PB_L-3, -i_0+PB_L-1); i_1++) {
            for (int i_2 = 0; i_2 < PB_Q-1; i_2++) {
                for (int i_3 = 0; i_3 < -i_1+PB_L-3; i_3++) {
                    B[i_3+i_1+3][i_2+1][i_2] = 4;
                }
            }
            for (int i_4 = 0; i_4 < min(-i_0+PB_L-3, -i_1+PB_L+2); i_4++) {
                B[i_1+i_0+1][i_4+1][i_4] = C[i_4][i_0][i_4+i_1-2] - B[i_1+i_0+1][i_4+2][i_4+1] * B[i_4+i_0+3][i_1+1][i_1] - 4;
            }
        }
    }
#pragma endscop
...
kernel_4214312223_02(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
