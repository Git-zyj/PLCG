...
void kernel_4224211323_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_P-1; i_2++) {
                for (int i_3 = 0; i_3 < min(PB_P-1, i_1); i_3++) {
                    A[i_1-1][i_2][i_0+1] = C[i_2+1][i_3][i_1+1] - A[i_2-1][i_3][i_1] * A[i_1-1][i_2-1][i_3+1] * A[i_1+1][i_2][i_3+1] + A[i_1-1][i_3+1][i_2+1] * A[i_1-1][i_2][i_0+3] - 1;
                }
            }
        }
    }
...
kernel_4224211323_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
