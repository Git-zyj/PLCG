...
void kernel_4216312311_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = PB_L-1 - 1; i_1 >= 0; i_1--) {
            for (int i_2 = 1; i_2 < -i_1+PB_M; i_2++) {
                for (int i_3 = 0; i_3 < PB_L-1; i_3++) {
                    A[i_2+i_1][i_3+1][i_3+1] = A[i_3+i_2-1][i_1+1][i_1+1] - 2;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L-1; i_4++) {
        for (int i_5 = i_4; i_5 < -i_4+PB_P-1; i_5++) {
            for (int i_6 = 1; i_6 < PB_M-1; i_6++) {
                B[i_6][i_4][i_5+i_4] = C[i_5+2][i_6][i_4-2] - B[i_6+1][i_4-1][i_5+i_4-1] - B[i_6-1][i_4-1][i_5+i_4-1] - B[i_6][i_4+1][i_5+i_4] + B[i_6][i_4][i_5+i_4+1] - 2;
            }
        }
    }
#pragma endscop
...
kernel_4216312311_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
