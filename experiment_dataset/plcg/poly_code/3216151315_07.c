...
void kernel_3216151315_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
        A[i_1+1] = C[i_1] + C[i_1] * C[i_1] + C[i_1] + C[i_1-1] - C[i_1] * C[0] + C[i_1] - 6;
    }
#pragma endscop
...
kernel_3216151315_07(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
