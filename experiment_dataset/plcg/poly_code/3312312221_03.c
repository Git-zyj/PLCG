...
void kernel_3312312221_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
    ...
    for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
        for (int i_3 = 0; i_3 < min(PB_M-2, -i_2+PB_M-1); i_3++) {
            for (int i_4 = 0; i_4 < PB_M-4; i_4++) {
                C[i_3+i_2][i_4] = B[i_4+4] + C[i_4+i_3+2][i_2] * C[i_3+i_2+1][i_4] - 1;
            }
        }
    }
#pragma endscop
...
kernel_3312312221_03(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
