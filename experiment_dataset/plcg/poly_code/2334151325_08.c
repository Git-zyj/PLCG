...
void kernel_2334151325_08(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = PB_L-1 - 1; i_1 >= 3; i_1--) {
        C[i_1-3] = D[i_1] + D[i_1] + D[i_1] * D[i_1+1] * D[i_1] - D[i_1] - D[i_1] - D[i_1-1] + C[i_1-1] + 5;
        C[i_1-1] = D[i_1] - D[i_1] - D[i_1+1] * D[i_1] * C[i_1+1] - C[i_1] * 3;
    }
#pragma endscop
...
kernel_2334151325_08(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
