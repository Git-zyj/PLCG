...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_P-1; i_1++) {
        for (int i_2 = 1; i_2 < PB_L-2; i_2++) {
            B[i_2+1][i_1] = G[i_2-1][i_1-1] - H[i_2+1][i_1+1] - B[i_2+2][i_1] + B[i_2+1][i_1+1] - 1;
        }
    }
    for (int i_3 = 1; i_3 < PB_L-1; i_3++) {
        C[i_3] = I[i_3-1] - I[i_3+1] + F[i_3] * 4;
        C[i_3] = F[i_3] + I[1] * I[i_3] + I[i_3] * 1;
    }
#pragma endscop
...
kernel_3436331111_04(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
