...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_Q-1; i_1++) {
            for (int i_2 = 0; i_2 < i_1; i_2++) {
                for (int i_3 = 2; i_3 < PB_Q-1; i_3++) {
                    A[i_2][i_1][i_0][i_3+1] = D[i_2][i_1+1][i_3+1][i_0] + A[i_2+2][i_1+1][i_0+1][i_3+1] - A[i_2+2][i_1][i_0][i_3+1] * A[i_2+2][i_1+1][i_0-1][i_3+1] * C[i_1-1][i_0+2][i_1+i_0+1][i_3-2] * 4;
                }
            }
        }
        B[i_0] = B[i_0-2] - 2;
    ...
    for (int i_4 = 0; i_4 < PB_L-3; i_4++) {
        for (int i_5 = 1; i_5 < i_4; i_5++) {
            for (int i_6 = 1; i_6 < min(-i_5+PB_Q, -i_4+PB_Q-2); i_6++) {
                for (int i_7 = 2; i_7 < PB_P-2; i_7++) {
                    C[i_6-1][i_5+1][i_6+i_5][i_7] = E[i_7-1][i_5][i_6] - A[i_6][i_5-1][i_7+2][i_4+3] - C[i_6-1][i_4+3][i_6+i_4+2][i_7-2] + 1;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), INIT_SEED);
kernel_4336211323_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E)));
