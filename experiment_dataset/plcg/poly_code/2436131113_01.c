...
void kernel_2436131113_01(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        B[i_0] = E[i_0] + E[i_0+1] * E[i_0-1] * E[i_0] + E[i_0+1] + 5;
        B[i_0] = E[0] + E[i_0] - B[i_0+1] - 4;
    }
    for (int i_1 = 0; i_1 < PB_Q-1; i_1++) {
        for (int i_2 = 1; i_2 < min(-i_1+PB_M, PB_Q); i_2++) {
            C[i_1][i_2] = F[i_1][i_2-1][i_1+1] * G[i_2][i_1] - F[i_2+i_1][i_2-1][1] * G[i_2-1][i_1] - 2;
        }
    }
...
kernel_2436131113_01(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
