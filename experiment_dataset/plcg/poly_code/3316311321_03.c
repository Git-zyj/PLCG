...
void kernel_3316311321_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
    ...
    for (int i_2 = 2; i_2 < PB_Q-3; i_2++) {
        ...
        for (int i_3 = 1; i_3 < i_2; i_3++) {
            for (int i_4 = 2; i_4 < -i_2+PB_Q-3; i_4++) {
                C[i_4-1][i_3+1][i_4+i_2] = D[i_3-1][i_4] + C[i_4+1][i_3-1][i_4+i_2+3] * C[i_2-1][i_3+3][i_4+i_2] * C[i_4-2][i_3+1][i_4+i_2-2] - 3;
            }
        }
    }
#pragma endscop
...
kernel_3316311321_03(xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
