...
void kernel_4426351323_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,int zk,int vk,DATA_TYPE POLYBENCH_4D(K,xK,yK,zK,vK,xk,yk,zk,vk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_L-1; i_0++) {
        A[i_0] = E[i_0] - F[i_0] + G[i_0][i_0] - E[i_0] - F[i_0+1] - F[i_0] - A[i_0-2] * A[i_0+1] - 3;
        for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
            for (int i_2 = i_0; i_2 < -i_1+PB_M; i_2++) {
                for (int i_3 = i_0; i_3 < -i_0+PB_M-1; i_3++) {
                    B[i_3][i_1][i_0-1][i_2+1] = H[i_2][i_0+1][i_1][i_2+1] * I[i_1][i_3+i_0+1][i_0][i_1-1] - J[i_2+i_1][i_3][i_2] + K[i_3][i_0][i_1][i_2+1] * K[i_2][1][i_0][i_0] + B[i_1+2][i_3-1][i_0-1][i_2+1] + B[i_3][i_1][i_0+1][i_2+2] - B[i_0+2][i_1-2][i_3-1][i_2+1] - 5;
                }
                for (int i_4 = i_0; i_4 < PB_L; i_4++) {
                    B[i_4][i_2][i_0-3][i_1+1] = L[i_4-1][i_2][i_1] + K[i_1][i_0][i_4][i_2] - H[i_4][i_0+1][i_1-1][i_2-1] - I[i_4-1][i_0-1][i_1][i_2-1] + 2;
                }
            }
        }
        for (int i_5 = i_0; i_5 < -i_0+PB_L; i_5++) {
            for (int i_6 = 1; i_6 < -i_5+PB_M; i_6++) {
                for (int i_7 = 1; i_7 < min(-i_5+PB_L, -i_0+PB_L); i_7++) {
                    B[i_0+2][i_6][i_7-1][i_5+1] = J[i_7+i_5][i_5][i_6+1] + H[i_6+i_5][i_7-1][i_7+i_0][i_5+i_0] - K[i_6-1][i_7+1][i_5+i_0][i_6-1] - H[i_7+i_6][i_5][i_0][i_6-1] + K[i_7+1][i_0+1][i_7+i_5][i_6+1] + 1;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4426351323_02(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L)));
