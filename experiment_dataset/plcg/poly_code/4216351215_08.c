        ...
        for (int i_1 = 1; i_1 < PB_Q; i_1++) {
            for (int i_2 = 1; i_2 < i_1; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_0+PB_Q-1, i_2); i_3++) {
                    A[i_3][i_1-1][i_3+1][i_0] = C[i_2-1][i_0-1][i_2][i_3-1] - C[i_2][i_1+1][i_3+i_0+1][i_1] * D[i_2][i_0-1][i_1][i_3] * D[i_2+1][i_0][i_3][i_1] * A[i_3+1][i_2-1][i_3+2][i_1] - 6;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        B[i_4] = E[i_4] + F[i_4-1] + F[i_4] * G[i_4] + G[i_4] * E[i_4] + B[i_4+1] * B[i_4-1] + B[i_4-1] + 2;
    }
#pragma endscop
...
kernel_4216351215_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
