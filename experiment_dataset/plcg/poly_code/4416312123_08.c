...
#pragma scop
        ...
        for (int i_1 = i_0; i_1 < PB_N; i_1++) {
            for (int i_2 = 2; i_2 < PB_L; i_2++) {
                for (int i_3 = max(2, i_0); i_3 < PB_P-1; i_3++) {
                    A[i_1][i_1][i_0][i_2] = E[i_3-2][i_2-2][i_1][i_0+2] + F[i_1][i_2][i_3+1][i_0+2] + 1;
                }
            }
    ...
    for (int i_6 = 2; i_6 < PB_P-1; i_6++) {
        for (int i_7 = 2; i_7 < i_6; i_7++) {
            for (int i_8 = i_7; i_8 < min(-i_7+PB_L-1, -i_6+PB_P-1); i_8++) {
                C[i_6-2][i_8+i_7+1][i_8] = 5;
                for (int i_9 = 2; i_9 < PB_L; i_9++) {
                    D[i_7-2][i_9-2][i_8+i_6][i_7] = G[i_8][i_9][i_7-2] + D[i_7-2][i_9][i_8+i_6+1][i_7] * 2;
                }
            }
        }
    }
...
kernel_4416312123_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
