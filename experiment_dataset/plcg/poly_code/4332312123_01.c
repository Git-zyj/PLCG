...
void kernel_4332312123_01(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N; i_0++) {
        for (int i_1 = 0; i_1 < PB_P-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-1; i_2++) {
                A[i_1][i_2+1] = D[i_2][i_1+1] + A[i_1+2][i_2+1] * 4;
            }
        }
    }
        ...
        for (int i_4 = 0; i_4 < PB_P-1; i_4++) {
            for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
                for (int i_6 = 0; i_6 < PB_N; i_6++) {
                    C[i_4][i_6][i_5+1] = E[i_5][i_4][i_4+1] - 3;
                }
            }
        }
    }
    for (int i_7 = 0; i_7 < PB_N; i_7++) {
        for (int i_8 = i_7; i_8 < PB_M-1; i_8++) {
            for (int i_9 = 0; i_9 < PB_N-1; i_9++) {
                C[i_7][i_9][i_8+1] = C[i_7][i_9+1][i_8+1] + 6;
            }
        }
    }
#pragma endscop
...
kernel_4332312123_01(xa,ya,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
