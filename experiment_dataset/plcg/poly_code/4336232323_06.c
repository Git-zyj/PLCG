        ...
        for (int i_1 = 1; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 4; i_2 < PB_L; i_2++) {
                for (int i_3 = i_2; i_3 < -i_0+PB_L-2; i_3++) {
                    A[i_2-2][i_1+2][i_0][i_3] = D[i_3+i_0+2][i_2][i_1][i_1-1] + A[i_2-4][i_1+2][i_0-2][i_3] + A[i_3-4][i_1+2][i_0+1][i_2-2] * A[i_2-2][i_3+1][i_0][i_1] * A[i_2-2][i_1+2][i_3+2][i_0] + 6;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L; i_4++) {
        B[i_4] = E[i_4] + E[i_4] - E[i_4] * E[0] - F[i_4] * 6;
        B[i_4] = E[i_4] + F[i_4] - G[i_4][0] - B[i_4-2] + B[i_4] - 6;
    }
#pragma endscop
...
kernel_4336232323_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
