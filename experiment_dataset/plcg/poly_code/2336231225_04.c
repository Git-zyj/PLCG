...
void kernel_2336231225_04(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-1; i_0++) {
        C[i_0] = D[i_0] * E[i_0+1] * E[i_0+1] + E[i_0] * 6;
    }
    ...
    for (int i_3 = 2; i_3 < PB_N-1; i_3++) {
        C[i_3] = E[i_3] - D[i_3+1] * D[i_3+1] + D[i_3] * C[i_3-2] * C[i_3+1] + 6;
    }
#pragma endscop
...
kernel_2336231225_04(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
