...
void kernel_4232211223_04(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    for (int i_0 = 3; i_0 < PB_Q-1; i_0++) {
        ...
        for (int i_2 = 0; i_2 < -i_0+PB_L-2; i_2++) {
            B[i_2+i_0][i_0-1] = C[i_2][i_0+1] - D[i_2] - B[i_2+i_0+2][i_0+1] + B[i_2+i_0-2][i_0-3] * 3;
        }
    }
#pragma endscop
...
kernel_4232211223_04(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
