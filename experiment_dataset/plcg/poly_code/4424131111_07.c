...
void kernel_4424131111_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        A[i_0] = E[i_0] - E[i_0] + E[i_0] + 5;
        B[i_0] = E[i_0] * E[i_0] * E[0] - E[i_0] * 4;
    }
    for (int i_1 = 1; i_1 < PB_L+1; i_1++) {
        for (int i_2 = i_1; i_2 < PB_M-1; i_2++) {
            for (int i_3 = 1; i_3 < PB_L; i_3++) {
                for (int i_4 = 1; i_4 < PB_L; i_4++) {
                    C[i_2+1][i_1-1][i_3][i_4] = F[i_2][i_4][i_3] * C[i_2][i_3-1][i_1-1][i_4] - C[i_2][i_1-1][i_3][i_4-1] * 5;
                }
            }
        }
    }
    for (int i_5 = 1; i_5 < PB_L-1; i_5++) {
        for (int i_6 = 0; i_6 < PB_L; i_6++) {
            for (int i_7 = i_6; i_7 < -i_6+PB_L; i_7++) {
                for (int i_8 = 0; i_8 < min(i_5, -i_6+PB_Q); i_8++) {
                    D[i_5][i_7][i_5][i_6] = G[i_7][i_5][i_8+i_6][i_7] + F[i_7+i_6][i_7][i_8] + F[i_8+1][i_6][i_5] - F[i_7][i_8][i_5+1] * D[i_5-1][i_6][i_5-1][i_7] * 1;
                }
            }
        }
    }
...
kernel_4424131111_07(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G));
