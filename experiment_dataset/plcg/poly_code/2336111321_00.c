...
void kernel_2336111321_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            A[i_1+1][i_0] = A[i_1+1][i_0-2] * A[i_1][i_0] - 4;
        }
        for (int i_2 = 2; i_2 < min(PB_L, i_0); i_2++) {
            B[i_0][i_2] = A[i_0+1][i_2-2] * 2;
        }
    }
    for (int i_3 = 2; i_3 < PB_L-2; i_3++) {
        for (int i_4 = 0; i_4 < min(-i_3+PB_L-2, i_3); i_4++) {
            C[i_4+i_3][i_3-1] = D[i_4+1] - C[i_4+i_3+1][i_3-1] + C[i_4+i_3-2][i_3-1] * C[i_4+i_3+1][i_3] + C[i_4+i_3-1][i_3-1] * C[i_4+i_3][i_3-2] * C[i_4+i_3+2][i_3] - 3;
        }
    }
#pragma endscop
...
kernel_2336111321_00(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
