...
void kernel_3414252221_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-2; i_0++) {
        A[i_0+2] = E[i_0] * E[i_0] - E[i_0+2] + E[i_0] - E[i_0+2] * F[i_0] - 5;
        for (int i_1 = 2; i_1 < PB_L; i_1++) {
            B[i_1][i_0][i_0+2] = G[i_1][i_1] + H[i_1-2][i_0] + I[i_0][i_0][i_1] * G[i_0][i_1] - A[i_0+2] - B[i_0][i_1-2][i_1] - 5;
        }
        C[i_0+2] = F[i_0] + C[i_0] * 4;
    }
    for (int i_2 = 1; i_2 < PB_L; i_2++) {
        D[i_2] = E[i_2+1] * E[i_2-1] * G[i_2][i_2] - E[i_2] - E[i_2+2] - F[i_2+2] - D[i_2+1] + D[i_2+2] * 5;
    }
#pragma endscop
...
kernel_3414252221_01(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
