...
void kernel_3326111321_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M; i_0++) {
        for (int i_1 = max(i_0, 5); i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = 1; i_2 < min(min(-i_0+PB_M+3, -i_1+PB_M+1), i_1); i_2++) {
                A[i_2+i_1-1][i_1+i_0-1][i_2] = D[i_0][i_1-1] * A[i_2+i_1-1][i_1+i_0][i_2] - A[i_2+i_0-3][i_2+i_1-5][i_0] - A[i_2+i_1-2][i_1+i_0-1][i_2-1] * 4;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_P-2; i_3++) {
        for (int i_4 = 1; i_4 < min(-i_3+PB_P+1, i_3); i_4++) {
            for (int i_5 = 0; i_5 < -i_3+PB_P-2; i_5++) {
                B[i_5+1][1][i_3-1] = C[i_5][i_4+i_3-1][i_5+1] * C[i_4-1][i_5+i_3+2][i_4] - 6;
            }
        }
    }
    for (int i_6 = 3; i_6 < PB_P; i_6++) {
        for (int i_7 = 1; i_7 < min(i_6, PB_P-2); i_7++) {
            for (int i_8 = i_7; i_8 < -i_7+PB_P-2; i_8++) {
                C[i_6-1][i_8+i_7][i_6] = C[i_6-3][i_8+i_7-1][i_6-2] * C[i_6-1][i_8+i_7+2][i_6] + C[i_6-1][i_8+i_7-1][i_6] + C[i_6-1][i_8+i_7+1][i_6] + 2;
            }
        }
    }
#pragma endscop
...
kernel_3326111321_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
