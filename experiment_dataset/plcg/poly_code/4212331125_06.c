...
void kernel_4212331125_06(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf)){
        ...
        for (int i_1 = 1; i_1 < PB_P-2; i_1++) {
            for (int i_2 = 1; i_2 < PB_P; i_2++) {
                for (int i_3 = 2; i_3 < PB_M-1; i_3++) {
                    B[i_0+3][i_1+2][i_2+1][i_3-2] = C[i_3+1][i_1][i_2-1] * D[i_3-1][i_0][i_2-1][i_1-1] * E[i_1][i_3][i_0][0] - B[i_0+1][i_1][i_2][i_3] * 6;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < PB_M; i_5++) {
            for (int i_6 = 0; i_6 < PB_M-1; i_6++) {
                for (int i_7 = 0; i_7 < min(-i_6+PB_P, PB_L); i_7++) {
                    B[i_4+1][i_5][i_6][i_7] = E[i_6+1][i_4+1][i_7][i_7+1] * F[i_5][i_7+i_6][i_4+1][i_4] - E[i_5-1][i_7][i_4][0] + 4;
                }
            }
        }
    }
...
kernel_4212331125_06(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
