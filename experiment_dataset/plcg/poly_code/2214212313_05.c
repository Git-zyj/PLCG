...
void kernel_2214212313_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_M-3; i_1++) {
        B[i_1+2] = C[i_1] + C[i_1] * B[i_1+1] * B[i_1+3] - B[i_1+1] * 2;
    }
#pragma endscop
...
kernel_2214212313_05(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
