...
void kernel_4222211323_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 2; i_1 < PB_M+2; i_1++) {
            for (int i_2 = 0; i_2 < PB_L; i_2++) {
                for (int i_3 = 2; i_3 < PB_P-2; i_3++) {
                    A[i_0][i_3-1][i_2] = A[i_0][i_2][i_3-2] + A[i_1-2][i_3-1][i_2+1] + A[i_2][i_0-1][i_3+2] * 2;
                }
            }
        }
    }
    for (int i_4 = 3; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 0; i_5 < i_4; i_5++) {
            for (int i_6 = 0; i_6 < -i_4+PB_L-1; i_6++) {
                A[i_5+2][i_4-3][i_6] = C[i_6][i_5][i_4] + D[i_5][i_6+i_4+1][i_5] - 1;
            }
        }
    }
#pragma endscop
...
kernel_4222211323_04(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
