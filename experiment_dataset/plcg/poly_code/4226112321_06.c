...
void kernel_4226112321_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
        ...
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < PB_M; i_2++) {
                for (int i_3 = 0; i_3 < PB_L; i_3++) {
                    A[i_1+1][i_2][i_3] = A[i_1+1][i_0-1][i_3] * 1;
                }
            }
        }
        B[i_0] = C[i_0] - C[i_0] - B[i_0-2] - B[i_0-1] * B[i_0+1] - B[i_0+2] - B[i_0+1] * 2;
    }
#pragma endscop
...
kernel_4226112321_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
