...
void kernel_3224251123_05(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < min(min(-i_0+PB_M, -i_1+PB_L), i_1); i_2++) {
                B[i_2][i_0+2] = C[i_2][i_0][i_1] - D[i_2-1][i_0-1][i_1] + C[i_2+i_0][i_1+1][i_0-1] - D[i_2][i_0][i_1] + D[i_0-1][i_2+i_1][i_2-1] - 1;
            }
        }
    }
    for (int i_3 = PB_L-1 - 1; i_3 >= 1; i_3--) {
        for (int i_4 = 1; i_4 < min(-i_3+PB_P, PB_L-2); i_4++) {
            for (int i_5 = i_3; i_5 < min(PB_L, -i_4+PB_P); i_5++) {
                B[i_5][i_3] = C[i_5][i_5+1][i_4+i_3] + D[i_5][i_3+1][i_4] + C[i_3][i_4-1][i_5+i_4] + D[i_4][i_5][i_3-1] - B[i_5+1][i_4+2] - 3;
            }
        }
    }
#pragma endscop
...
kernel_3224251123_05(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
