...
void kernel_2214111113_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        A[i_0] = 2;
        A[i_0] = C[i_0] * C[i_0] - A[i_0] + 5;
    }
#pragma endscop
...
kernel_2214111113_01(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
