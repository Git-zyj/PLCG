        ...
        for (int i_1 = 2; i_1 < min(-i_0+PB_M+1, PB_L-2); i_1++) {
            for (int i_2 = 0; i_2 < min(-i_0+PB_M, i_0); i_2++) {
                for (int i_3 = 2; i_3 < PB_L-3; i_3++) {
                    A[i_3+2][i_1][i_2][i_3] = D[i_3-2][i_0][i_2][i_1] + D[i_1][i_3][i_0+1][i_2+1] + D[i_3][i_3-2][i_1][i_0] * E[i_2+i_0][i_1][i_3-2][i_1-2] + D[i_2][i_3][i_1][i_0] + D[i_2+1][i_3+2][i_1+i_0-1][i_2] * F[i_0-1][i_1][i_0+2][i_2] * A[i_3+2][i_1][i_2+1][i_3] + A[i_3+3][i_1][i_2][i_3+1] - 6;
                }
            }
            B[i_0+1] = G[i_0][i_1] - H[i_1][i_0] - H[i_0][0] - H[i_1][i_0] - I[i_1+1] - J[i_1+2][i_0] + B[i_0] + B[i_1] * B[i_0+2] * 6;
        }
    }
    for (int i_4 = 0; i_4 < PB_M-1; i_4++) {
        B[i_4+1] = K[i_4] - K[i_4] + 6;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4316352313_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K)));
