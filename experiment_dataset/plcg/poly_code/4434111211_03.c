...
void kernel_4434111211_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf)){
        ...
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_L; i_2++) {
                for (int i_3 = 1; i_3 < i_1; i_3++) {
                    A[i_0][i_2][i_3][i_2-1] = E[i_3][i_2+i_0][i_0][i_1+1] * A[i_0-1][i_2][i_3][i_2-1] + A[i_1-1][i_2][i_3-1][i_2-1] + C[i_1][i_0][i_3][i_0] + 2;
                }
            }
        }
        B[i_0] = F[i_0] - 3;
        ...
        for (int i_5 = 1; i_5 < PB_P-1; i_5++) {
            for (int i_6 = 0; i_6 < PB_M-1; i_6++) {
                for (int i_7 = 0; i_7 < PB_L; i_7++) {
                    C[i_4][i_5][i_6][i_5] = D[i_4-1][i_6+1][i_7][i_5+1] * 4;
                }
            }
            for (int i_8 = 1; i_8 < PB_M-1; i_8++) {
                for (int i_9 = 0; i_9 < i_8; i_9++) {
                    D[i_4-1][i_8+1][i_9][i_5] = E[i_8][i_5-1][i_4+1][i_4] - D[i_8][i_9+1][i_4][i_5] + D[i_8-1][i_9][i_4+1][i_5] * 6;
                }
            }
        }
    }
...
kernel_4434111211_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F));
