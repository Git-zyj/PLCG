...
void kernel_2224112123_01(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        for (int i_1 = i_0; i_1 < min(PB_P, -i_0+PB_L); i_1++) {
            B[i_1] = C[i_1+i_0][i_0-2] - C[i_1-2][1] + 1;
        }
        B[i_0] = B[i_0-1] - 3;
    }
#pragma endscop
...
kernel_2224112123_01(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
