...
void kernel_4322252111_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 0; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_L; i_2++) {
                A[i_0+2][i_1+2][i_2] = D[i_1][i_2+i_0][i_0] + D[i_1][i_2+i_0][0] - D[i_0][i_1][i_2] * 3;
            }
        }
    }
        ...
        for (int i_4 = 2; i_4 < PB_L; i_4++) {
            for (int i_5 = 2; i_5 < PB_L-1; i_5++) {
                for (int i_6 = 2; i_6 < -i_3+PB_L; i_6++) {
                    B[i_6][i_3][i_4-2][i_5+1] = E[i_5-2][i_4-2][i_3][i_6-2] + D[i_6-1][i_6][i_4] + D[i_4-1][i_6+i_3][0] + F[i_3+1][i_4][i_5+1][i_6] - F[i_5][i_6+2][i_4][i_3+1] - E[i_4][i_6+2][i_3][0] * 4;
                }
            }
        }
        for (int i_7 = PB_P-3 - 1; i_7 >= 2; i_7--) {
            C[i_3+2][i_7+2] = G[i_7-2][i_3] - G[i_7][i_3-2] - H[i_7] + G[i_7][i_3] * G[i_7-2][i_3+2] + C[i_3+2][i_7+3] - C[i_3+3][i_7+2] + 1;
        }
    }
#pragma endscop
...
kernel_4322252111_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
