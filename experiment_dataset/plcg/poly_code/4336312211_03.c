...
void kernel_4336312211_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
...
#pragma scop
    ...
    for (int i_3 = 2; i_3 < PB_P; i_3++) {
        for (int i_4 = i_3; i_4 < PB_N-2; i_4++) {
            for (int i_5 = 1; i_5 < min(min(-i_3+PB_P, PB_M), i_4); i_5++) {
                B[i_4+1][i_5] = D[i_4][i_5+i_3][i_3-2] - B[i_5][i_4] * B[i_4+2][i_5-1] - 5;
            }
        }
    }
    for (int i_6 = 0; i_6 < PB_M; i_6++) {
        for (int i_7 = 2; i_7 < i_6; i_7++) {
            for (int i_8 = max(0, -i_7+2); i_8 < -i_7+PB_M+2; i_8++) {
                C[i_8+i_7-2][i_6][i_7+1] = C[i_8+i_7-2][i_6][i_7] - 5;
            }
        }
    }
#pragma endscop
...
kernel_4336312211_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
