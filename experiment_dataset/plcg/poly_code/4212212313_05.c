...
void kernel_4212212313_05(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
    ...
    for (int i_3 = 1; i_3 < PB_P; i_3++) {
        for (int i_4 = 1; i_4 < PB_P+1; i_4++) {
            for (int i_5 = 0; i_5 < PB_P; i_5++) {
                B[i_4][i_5] = C[i_5][i_4] - B[i_4+1][i_3-1] - B[i_5][i_4-1] - B[i_5+1][i_3] * 4;
            }
        }
    }
#pragma endscop
...
kernel_4212212313_05(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
