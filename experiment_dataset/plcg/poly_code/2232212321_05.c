...
void kernel_2232212321_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_2 = 3; i_2 < PB_N-1; i_2++) {
        B[i_2-1] = C[i_2] - B[i_2] * B[i_2+1] - B[i_2-3] - 5;
    }
#pragma endscop
...
kernel_2232212321_05(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
