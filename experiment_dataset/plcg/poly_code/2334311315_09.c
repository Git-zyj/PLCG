...
void kernel_2334311315_09(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        C[i_0] = C[i_0-1] + 6;
        C[i_0+1] = D[i_0] * C[i_0+1] - C[i_0] + 3;
...
kernel_2334311315_09(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
