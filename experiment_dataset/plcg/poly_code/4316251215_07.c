...
void kernel_4316251215_07(int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 0; i_1 < min(-i_0+PB_M-1, i_0); i_1++) {
            C[i_1][i_0+1] = D[i_1][i_0] * E[i_0+1] - D[i_1+1][i_0] + F[i_1+i_0+1][0] + 1;
        }
    }
    for (int i_2 = 1; i_2 < PB_P-1; i_2++) {
        for (int i_3 = 0; i_3 < PB_P-2; i_3++) {
            for (int i_4 = i_3; i_4 < -i_2+PB_M; i_4++) {
                C[i_3+1][i_4] = G[i_4][i_4+i_2][i_3] + G[i_3+1][i_4+1][i_2] * H[i_4+1][i_3][i_2] - 3;
            }
            C[i_3][i_2+1] = E[i_2-1] * D[i_2][i_3] * D[i_3][i_2-1] + F[i_3+1][i_2] - F[i_2-1][i_3+1] + D[i_3+1][i_2-1] - D[i_3][i_2] - C[i_3+1][i_2+1] - C[i_2][i_3+2] + 6;
        }
    }
#pragma endscop
...
kernel_4316251215_07(xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
