...
void kernel_2234312223_03(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            A[i_0][0] = A[i_0+2][0] * A[i_0-2][0] * 2;
        }
    }
    for (int i_2 = 0; i_2 < PB_P; i_2++) {
        A[i_2][0] = C[i_2] - D[i_2] * 6;
    }
#pragma endscop
...
kernel_2234312223_03(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
