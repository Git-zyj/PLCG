...
void kernel_2334311125_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 0; i_1 < PB_M-2; i_1++) {
            B[i_1+2] = D[i_0+1] + D[i_1] - 5;
        }
    }
...
kernel_2334311125_05(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
