...
void kernel_3432252223_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_Q-1; i_0++) {
        for (int i_1 = 1; i_1 < -i_0+PB_Q; i_1++) {
            for (int i_2 = 1; i_2 < PB_P-1; i_2++) {
                A[i_2+2][i_1][i_0+1] = E[i_1][i_2-1][i_1+i_0] * E[i_0][i_1][i_2+1] - F[i_2][i_0-1][i_2+i_1] - F[i_0][i_2+1][i_1-1] - A[i_2][i_1][i_0+1] * 5;
            }
        }
        for (int i_3 = 1; i_3 < PB_M-2; i_3++) {
            B[i_0][i_3] = G[i_3-1][i_0] + B[i_0][i_3-1] - B[i_0][i_3+2] * 4;
        }
    }
    for (int i_4 = 2; i_4 < PB_Q-2; i_4++) {
        for (int i_5 = 1; i_5 < PB_M-1; i_5++) {
            B[i_4+1][i_5] = H[i_5][i_4+1] - H[i_4][i_5] + H[i_5][1] + H[i_5-1][i_4] + I[i_4] - G[i_4-2][i_5] - G[i_4][i_4] - I[i_5+1] + 6;
        }
        for (int i_6 = 1; i_6 < PB_Q; i_6++) {
            for (int i_7 = 2; i_7 < PB_P; i_7++) {
                B[i_6][i_7] = F[i_7][i_4][i_6] + F[i_4-1][i_7][i_4+2] + E[i_6][i_4+2][i_7-2] * E[i_6-1][i_4][1] - B[i_4][i_6-1] * 1;
            }
        }
    }
#pragma endscop
...
kernel_3432252223_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
