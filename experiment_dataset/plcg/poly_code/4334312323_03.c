...
void kernel_4334312323_03(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
        C[i_1-2] = D[i_1] * D[0] * 1;
        C[i_1] = D[i_1] * C[i_1+1] - C[i_1-2] - C[i_1+2] - 2;
    }
#pragma endscop
...
kernel_4334312323_03(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
