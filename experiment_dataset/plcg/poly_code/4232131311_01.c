    ...
    for (int i_3 = 1; i_3 < PB_M; i_3++) {
        for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
            for (int i_5 = 0; i_5 < min(-i_3+PB_P, PB_L); i_5++) {
                B[i_3][i_4][i_5+i_3-1] = E[i_4][i_5] * C[i_4-1][i_3][i_4+1] + E[i_5][i_4] - B[i_3][i_4][i_5+i_3] + B[i_3][i_4-1][i_5+i_3-1] * B[i_3][i_4+1][i_5+i_3-1] - 4;
            }
        }
    }
#pragma endscop
...
kernel_4232131311_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
