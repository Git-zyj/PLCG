...
void kernel_4324331115_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg)){
        ...
        for (int i_1 = 0; i_1 < -i_0+PB_L; i_1++) {
            for (int i_2 = 1; i_2 < PB_P; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_Q+1; i_3++) {
                    A[i_1][i_1+i_0][i_2][i_3] = D[i_2+i_1][i_3][i_1+1] - E[i_0+1][i_2][i_1][i_3+i_0-1] - A[i_1][i_1+i_0][i_2-1][i_3] * 6;
                }
            }
        }
        for (int i_4 = 1; i_4 < min(i_0, -i_0+PB_N); i_4++) {
            B[i_0][i_4-1] = F[i_4+i_0-1][i_0] + F[i_4+i_0][i_4] * G[i_0+1] - F[i_4+i_0][1] + 4;
        }
    }
    for (int i_5 = 1; i_5 < PB_N; i_5++) {
        for (int i_6 = 0; i_6 < -i_5+PB_N; i_6++) {
            C[i_6][i_6] = F[i_6+i_5][i_5-1] + 3;
        }
    }
#pragma endscop
...
kernel_4324331115_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
