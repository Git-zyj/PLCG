...
void kernel_2236132225_08(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        for (int i_1 = 2; i_1 < min(-i_0+PB_M, i_0); i_1++) {
            B[i_1+i_0-2][0] = C[i_1+i_0][i_0] * C[i_1][i_0] * C[i_1-2][i_0] * B[i_1+i_0][0] - B[i_1+i_0-1][0] * 5;
            B[i_1+i_0-2][0] = C[i_1+2][i_0] + C[i_0][i_1] - 4;
        }
    }
#pragma endscop
...
kernel_2236132225_08(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
