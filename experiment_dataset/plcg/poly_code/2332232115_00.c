...
void kernel_2332232115_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
...
#pragma scop
    ...
    for (int i_2 = 1; i_2 < PB_L-2; i_2++) {
        B[i_2] = E[i_2] - E[i_2] - F[i_2][0] - G[i_2-1] + G[i_2] + 3;
        for (int i_3 = 0; i_3 < -i_2+PB_M; i_3++) {
            B[i_2] = H[i_3][i_2+2][i_2-1] - D[i_3][i_2] + D[i_3+i_2][i_2-1] - B[i_3] + 5;
        }
    }
#pragma endscop
...
kernel_2332232115_00(xb,POLYBENCH_ARRAY(B), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
