...
void kernel_3336132221_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_M+1; i_1++) {
        for (int i_2 = i_1; i_2 < PB_M; i_2++) {
            for (int i_3 = 2; i_3 < min(min(-i_1+PB_M+1, i_2), -i_2+PB_M); i_3++) {
                B[i_3+i_2][i_3] = E[i_3+i_1-1][i_3-2] + B[i_3+i_1-2][i_3-2] + B[i_3+i_1-2][i_1-1] + B[i_3+i_2][i_3-1] * 5;
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M; i_4++) {
        C[0] = D[i_4] * D[i_4] + D[i_4-1] * D[i_4] + D[i_4] * C[0] + C[0] - 5;
    }
#pragma endscop
...
kernel_3336132221_07(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
