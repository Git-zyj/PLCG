        ...
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < min(PB_M-2, -i_1+PB_Q); i_2++) {
                for (int i_3 = 1; i_3 < PB_Q-1; i_3++) {
                    A[i_1][i_3][i_2][i_0-1] = C[i_0][i_1][i_2+1] + D[i_1][i_0+1][i_3][i_2] + D[i_3-1][i_0][i_1][i_1] + D[i_2+2][i_0+2][i_1][i_0] + E[i_3][i_0][i_2+i_1][i_3+1][i_2] - A[i_1][i_3][i_2+1][i_0-1] + A[i_1+1][i_3][i_0][i_2-1] + 3;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_P-2; i_4++) {
            for (int i_5 = 2; i_5 < PB_P; i_5++) {
                for (int i_6 = i_4; i_6 < PB_P-2; i_6++) {
                    A[i_4+1][i_6-1][i_5][i_0-1] = D[i_0-2][i_6][i_4+2][i_5-2] + C[i_6][i_4][1] + D[i_4][i_6+2][i_0-2][i_6+1] * D[i_5][i_4][i_6+2][i_4+2] * C[i_4-1][i_6][i_5-1] + A[i_6][i_0][i_5][i_4-1] + 6;
                }
            }
        }
    }
...
kernel_4216152313_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E));
