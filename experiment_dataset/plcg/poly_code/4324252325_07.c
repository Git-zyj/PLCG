...
void kernel_4324252325_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        A[i_0] = D[i_0] + E[i_0] + E[i_0] + F[i_0][i_0-2] * A[i_0-1] - A[i_0+2] - 1;
    }
    for (int i_1 = 1; i_1 < PB_P; i_1++) {
        A[i_1+1] = D[i_1] + E[i_1+1] * D[i_1] + D[i_1] - E[i_1] - E[i_1-1] * A[i_1] + 4;
        for (int i_2 = 1; i_2 < min(PB_P-1, i_1); i_2++) {
            for (int i_3 = 2; i_3 < -i_2+PB_P-1; i_3++) {
                C[i_3][i_3+i_2+1] = G[i_3-2][i_1+1][i_2] - F[i_2][i_3] - G[i_2+2][i_1+2][i_1] - H[i_3][i_1][i_2+2] - C[i_3][i_3+i_2-1] + C[i_3+1][i_3+i_2] * 2;
            }
        }
    }
#pragma endscop
...
kernel_4324252325_07(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
