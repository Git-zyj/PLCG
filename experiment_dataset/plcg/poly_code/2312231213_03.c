...
void kernel_2312231213_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_M-2; i_1++) {
        A[i_1] = E[i_1-1] - E[i_1] - E[i_1] + D[i_1] - 5;
        for (int i_2 = 1; i_2 < -i_1+PB_M-2; i_2++) {
            C[i_2+i_1+1][i_2][0] = F[i_2][i_1] + G[i_2][i_1+1] * F[i_2][i_1] - G[i_2-1][i_2] + C[i_2+i_1+1][i_2-1][0] + C[i_2+i_1+2][i_2][0] - C[i_2+i_1][i_2-1][0] - 3;
        }
    }
#pragma endscop
...
kernel_2312231213_03(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
