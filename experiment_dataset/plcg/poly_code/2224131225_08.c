...
void kernel_2224131225_08(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_M-1; i_1++) {
        B[i_1] = C[i_1] - C[i_1] * C[i_1] - C[i_1] - B[i_1+1] + B[i_1-2] + 2;
    }
#pragma endscop
...
kernel_2224131225_08(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
