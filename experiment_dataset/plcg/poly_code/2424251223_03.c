...
void kernel_2424251223_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        for (int i_1 = i_0; i_1 < min(-i_0+PB_M, PB_P-1); i_1++) {
            A[i_1] = E[i_1+i_0] * F[i_0-1][i_1+1][i_0-1] * G[i_1][i_0] * H[i_1][i_0] + G[1][i_0] * H[i_1][i_0] + A[i_1-1] + 5;
        }
        A[i_0] = E[i_0] + I[i_0] + E[i_0] - I[i_0] * I[i_0] - I[i_0-1] * A[i_0] * 1;
    }
    for (int i_2 = 1; i_2 < PB_L; i_2++) {
        D[i_2][i_2] = H[i_2][i_2] - E[i_2-1] + I[i_2] - E[i_2] + I[1] + 3;
    }
    for (int i_3 = 0; i_3 < PB_L-2; i_3++) {
        D[i_3][i_3] = H[i_3][i_3] - H[i_3][i_3] - D[i_3+2][i_3+2] - 2;
    }
#pragma endscop
...
kernel_2424251223_03(xa,POLYBENCH_ARRAY(A), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
