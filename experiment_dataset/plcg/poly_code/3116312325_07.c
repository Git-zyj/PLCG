...
void kernel_3116312325_07(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-3; i_0++) {
        for (int i_1 = i_0; i_1 < PB_M-4; i_1++) {
            A[i_1+2][i_0][i_1+1] = B[i_1] - A[i_1+4][i_0][i_1+3] + A[i_1+1][i_0+2][i_1] - A[i_0+3][i_1][i_0+2] + 2;
        }
    }
#pragma endscop
...
kernel_3116312325_07(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
