...
void kernel_3424232315_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        A[i_0] = E[0] - E[i_0] * E[i_0] + F[i_0] - E[i_0+1] * A[i_0-1] + A[i_0+1] * B[i_0] - 2;
        B[i_0-1] = F[i_0] * A[i_0] + A[i_0-1] + A[i_0+1] - 3;
    }
    for (int i_1 = 1; i_1 < PB_L-2; i_1++) {
        for (int i_2 = 1; i_2 < min(PB_L-3, i_1); i_2++) {
            for (int i_3 = 2; i_3 < PB_M-1; i_3++) {
                C[i_2][i_1+2][i_3] = G[i_3+1][i_1+2] + H[i_3-2][i_3][i_1-1] * H[i_2+2][i_1][i_1] * G[i_3][i_2] * C[i_1][i_2+2][i_3+1] * C[i_1+1][i_2+3][i_3] - C[i_2-1][i_1+2][i_3+1] + 2;
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_P-2; i_4++) {
        for (int i_5 = 1; i_5 < min(i_4, PB_M); i_5++) {
            for (int i_6 = i_5; i_6 < PB_L-2; i_6++) {
                C[i_5-1][i_6+2][i_4] = I[i_5][i_6][i_4-2] * I[i_6][i_4+2][i_5] - 4;
            }
        }
    }
#pragma endscop
...
kernel_3424232315_09(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
