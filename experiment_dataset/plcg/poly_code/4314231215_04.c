...
void kernel_4314231215_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
        ...
        for (int i_1 = 1; i_1 < min(-i_0+PB_M+1, PB_M-1); i_1++) {
            for (int i_2 = 1; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 2; i_3 < -i_0+PB_Q; i_3++) {
                    A[i_0][i_3-1][i_2-1][i_2] = D[i_3+i_1-1][i_1+1][i_0][i_2-1] * E[i_1+i_0-1][i_3+1][i_2+1][i_1+1] * E[i_1][i_3+i_0][i_2][i_3+i_0] - F[i_2][i_3-1][i_0] - A[i_0-1][i_3-1][i_2-1][i_2] * A[i_0][i_3-2][i_2-1][i_2] - 5;
                }
            }
        }
        B[i_0] = G[i_0] * H[i_0] - B[i_0+1] - 4;
        B[i_0] = H[i_0-1] - H[i_0+1] + G[i_0] + 5;
    }
#pragma endscop
...
kernel_4314231215_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
