...
void kernel_4414311115_09(int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
        ...
        for (int i_1 = max(1, i_0); i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < i_1; i_2++) {
                for (int i_3 = 1; i_3 < PB_M+1; i_3++) {
                    D[i_2-1][i_1][i_1-1][i_3] = E[i_3-1][i_1][i_2][i_0] * 1;
                }
            }
        }
    }
        ...
        for (int i_6 = 0; i_6 < min(i_4, PB_M-2); i_6++) {
            ...
            for (int i_7 = 1; i_7 < PB_L; i_7++) {
                for (int i_8 = 1; i_8 < min(-i_6+PB_M, i_7); i_8++) {
                    D[i_4-1][i_6+1][i_6][i_8-1] = F[i_7][i_4][i_8+i_6][i_4] * F[i_7-1][i_4+1][i_6][i_7] * G[i_8][i_4+1][0] + D[i_4-1][i_6+1][i_6][i_8] * 3;
                }
            }
        }
    }
...
kernel_4414311115_09(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
