...
void kernel_3424212213_04(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
    for (int i_0 = 3; i_0 < PB_P-2; i_0++) {
        ...
        for (int i_2 = 1; i_2 < PB_L-1; i_2++) {
            B[i_2][i_0+2] = E[i_2] + B[i_2+1][i_0+2] * B[i_2-1][i_0+2] * 5;
        }
        C[i_0-2] = C[i_0-3] + 5;
    }
...
kernel_3424212213_04(xc,POLYBENCH_ARRAY(C), xb,yb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E));
