...
void kernel_4434251315_05(int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,int zk,int vk,DATA_TYPE POLYBENCH_4D(K,xK,yK,zK,vK,xk,yk,zk,vk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P-1; i_0++) {
        for (int i_1 = 1; i_1 < -i_0+PB_P-1; i_1++) {
            C[i_1][i_1+i_0-1] = E[i_1-1][i_0+1] + E[i_1][i_0] * E[i_1][i_0] * F[i_1+i_0][i_0] - B[i_1] + C[i_1][i_1+i_0+1] * 3;
        }
        B[i_0] = G[i_0] - B[i_0+1] - 4;
        for (int i_2 = 1; i_2 < -i_0+PB_P; i_2++) {
            C[i_2][i_2+i_0] = H[i_0] - F[i_2][i_0-1] * G[i_0] + E[i_2+1][i_0-1] + E[i_2][i_0] * B[i_0] + B[i_2-1] - 1;
        }
    }
    for (int i_3 = 2; i_3 < PB_P-1; i_3++) {
        for (int i_4 = 2; i_4 < PB_P-1; i_4++) {
            for (int i_5 = 1; i_5 < min(-i_3+PB_N-1, -i_4+PB_M-1); i_5++) {
                for (int i_6 = 1; i_6 < -i_3+PB_P-1; i_6++) {
                    D[i_6][i_5][i_4-1][i_3-1] = I[i_5][i_4][i_6+i_3+1][i_6+1] - I[i_4+1][i_6][i_3-1][i_5] + J[i_4][i_6-1][i_5+i_4] * I[i_5][i_3][i_4+1][i_6+1] - K[i_4][i_5+i_3+1][i_6+1][i_5+i_4+1] * I[i_5-1][i_3][i_5][i_4+1] + K[i_3][i_6][i_4][i_5] * D[i_6][i_5][i_4-1][i_3] - D[i_6][i_3][i_5-1][i_4-2] + D[i_6][i_5][i_3-2][i_4] * 4;
                }
            }
        }
    }
...
init_array(xc,yc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4434251315_05(xc,yc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xc,yc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K)));
