...
void kernel_3422112325_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
    ...
    for (int i_3 = 2; i_3 < PB_M-2; i_3++) {
        for (int i_4 = 0; i_4 < PB_M-4; i_4++) {
            B[i_4+2] = B[i_4+4] - C[i_4] * C[i_3] * 2;
        }
        C[i_3] = E[i_3] - E[i_3] + B[i_3+1] * B[i_3+2] + 2;
        C[i_3-2] = E[i_3] * B[i_3+2] + 6;
    }
#pragma endscop
...
kernel_3422112325_06(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E));
