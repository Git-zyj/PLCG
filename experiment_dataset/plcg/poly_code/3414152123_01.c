...
void kernel_3414152123_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        A[i_0-2] = E[i_0+2] - E[i_0] + E[i_0] * E[i_0] + E[0] * E[i_0] - A[i_0] * 1;
        B[i_0][i_0] = E[i_0] * E[1] - E[i_0+1] - 3;
        for (int i_1 = 2; i_1 < min(-i_0+PB_M-2, i_0); i_1++) {
            for (int i_2 = 2; i_2 < min(-i_0+PB_M, -i_1+PB_Q); i_2++) {
                D[i_1-1][i_2+i_1][i_0] = F[i_0-1][i_2] * G[i_0][i_1+2][i_1] - G[i_2+i_0][i_1][i_1+i_0+2] * G[i_2+i_0][i_2][i_1] * H[i_2+1][i_1-2][i_0+1][i_2-2] - 3;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_Q; i_3++) {
        for (int i_4 = 1; i_4 < -i_3+PB_Q; i_4++) {
            for (int i_5 = 2; i_5 < PB_Q; i_5++) {
                D[i_3-1][i_4+i_3][i_5] = G[i_5+i_4][i_3][0] - F[i_4-1][i_5-2] - G[i_5][i_3][i_4] + F[i_4+1][i_5] + G[i_3][i_5][i_4] - 2;
            }
        }
    }
#pragma endscop
...
kernel_3414152123_01(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
