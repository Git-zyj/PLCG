...
void kernel_3426251313_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        A[i_0-1] = E[i_0+1] * F[i_0] * F[i_0+1] - F[i_0+1] - E[0] * B[i_0-1] * 6;
        B[i_0] = F[i_0] + F[i_0] - F[i_0] - F[i_0-1] * E[1] + E[i_0] - A[i_0-1] - A[i_0-2] + B[i_0-1] * 5;
    }
    for (int i_1 = 1; i_1 < PB_Q; i_1++) {
        for (int i_2 = 1; i_2 < min(PB_Q, -i_1+PB_L+1); i_2++) {
            C[i_1][i_2] = G[i_2+i_1-1][i_2] - G[i_2+1][i_1] + H[i_2][i_1-1] - I[i_1][i_2][i_1] - H[i_2][i_1] + C[i_1][i_2+1] - C[i_1-1][i_2] - C[i_1+1][i_2] - C[i_1][i_2-1] - 3;
        }
        for (int i_3 = 1; i_3 < i_1; i_3++) {
            A[i_3-1] = G[i_3][i_1] * G[i_3][i_1-1] - H[i_1][i_3] - H[i_1][i_3-1] * 2;
        }
    }
#pragma endscop
...
kernel_3426251313_03(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
