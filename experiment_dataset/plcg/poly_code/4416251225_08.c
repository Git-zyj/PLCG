...
void kernel_4416251225_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-2; i_0++) {
        A[i_0] = E[i_0-1] + E[i_0] * F[i_0+1][0] - G[i_0] + A[i_0-1] + 5;
        for (int i_1 = i_0; i_1 < -i_0+PB_L-2; i_1++) {
            for (int i_2 = 3; i_2 < min(-i_0+PB_L, -i_1+PB_L); i_2++) {
                for (int i_3 = 1; i_3 < -i_2+PB_L; i_3++) {
                    B[i_0-1][i_2-1][i_2][i_3-1] = H[i_1][i_3+1][i_3][i_0] + H[i_1-1][i_2+1][i_3][i_0-1] * I[i_2+1][i_1+i_0+1][i_3-1][i_2] * H[i_3][i_2][i_0][i_1] - J[i_2+1][i_0][i_2] * K[i_2][i_3+i_2][i_1] + I[i_1][i_3-1][i_2+i_0][i_1] + H[i_3][i_0][i_1][i_2-1] * C[i_3][i_2+i_1] * 4;
                }
                C[i_1][i_2+i_0] = J[i_1][i_2-1][i_0] + J[i_1+1][i_0][i_1-1] * J[i_2+i_1][i_0][i_2] - F[i_2][i_1] + L[i_2-1][i_1] - F[i_2][i_1] - K[i_0][i_2+1][i_1] + B[i_0+1][i_1-1][i_1][i_2-3] - C[i_2][i_1+i_0+2] * 6;
            }
        }
    }
        ...
        for (int i_5 = 2; i_5 < PB_P-1; i_5++) {
            for (int i_6 = 0; i_6 < PB_M-2; i_6++) {
                for (int i_7 = 3; i_7 < i_4; i_7++) {
                    D[i_7-1][i_6+1][i_5][i_5+1] = D[i_7-3][i_6+1][i_5-2][i_5-1] + D[i_7-1][i_6+2][i_5][i_5+1] + 2;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4416251225_08(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L));
