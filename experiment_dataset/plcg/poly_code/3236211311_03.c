...
void kernel_3236211311_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
kernel_3236211311_03(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
