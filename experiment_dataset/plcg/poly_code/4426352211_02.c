...
void kernel_4426352211_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl)){
        ...
        for (int i_1 = 2; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < min(PB_N-1, i_0); i_2++) {
                for (int i_3 = 0; i_3 < -i_2+PB_N-1; i_3++) {
                    A[i_0][i_1][i_3][i_2] = E[i_1][i_3][i_1][i_0+2] * F[i_3+i_2+1][i_0][i_1][1] * E[i_2][i_0][i_1-2][i_3] + A[i_0][i_1][i_2][i_3+1] + A[i_0+1][i_1][i_3][i_2-1] * 4;
                }
            }
        }
    }
        ...
        for (int i_5 = i_4; i_5 < PB_M; i_5++) {
            for (int i_6 = 2; i_6 < PB_M; i_6++) {
                for (int i_7 = 1; i_7 < min(-i_6+PB_Q, -i_4+PB_Q); i_7++) {
                    B[0][i_6-1][i_7+i_4][i_6+1] = G[i_5][i_7][i_6] - E[i_5][i_4][i_5][i_7+i_6] - E[i_6-2][i_7-1][i_4+1][i_5] * E[i_7][i_4+2][i_5+2][i_5] * H[i_7][i_4][0][i_5+2] - D[i_7-1][i_5][i_6-2][i_7-1] - 3;
                }
            }
        }
        C[i_4] = I[i_4-1][0] * J[i_4] - K[i_4] - J[i_4] - J[i_4+2] - K[i_4-1] * C[i_4+1] * C[i_4-1] * C[i_4+1] + 3;
    }
    for (int i_8 = 0; i_8 < PB_N; i_8++) {
        for (int i_9 = 2; i_9 < PB_M; i_9++) {
            for (int j_0 = i_8; j_0 < PB_M-2; j_0++) {
                for (int j_1 = 2; j_1 < PB_M; j_1++) {
                    D[j_1][j_0][i_9-2][j_1] = L[j_1][i_9][j_0] - F[i_9][j_0][j_1][i_9-2] * E[j_0][j_1-2][i_9][i_8] * F[i_8][j_0+2][j_1][i_9] - H[i_9-1][j_0][i_8][j_1+2] - E[i_9][j_0+2][i_8+1][0] * 5;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4426352211_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L));
