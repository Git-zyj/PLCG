...
void kernel_3236112315_02(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        ...
        for (int i_2 = 0; i_2 < -i_0+PB_M-1; i_2++) {
            B[i_2+i_0] = C[i_2][i_2+i_0-1] - B[i_2+i_0+1] * B[i_2+i_0-1] + B[i_2+i_0-1] - 6;
        }
    }
#pragma endscop
...
kernel_3236112315_02(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
