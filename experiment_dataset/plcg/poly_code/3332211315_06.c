...
void kernel_3332211315_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        B[i_0-2] = B[i_0-1] * B[i_0-2] * B[i_0] + 2;
...
kernel_3332211315_06(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
