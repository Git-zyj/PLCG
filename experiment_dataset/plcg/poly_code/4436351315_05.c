...
void kernel_4436351315_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,int wb,DATA_TYPE POLYBENCH_5D(B,xB,yB,zB,vB,wB,xb,yb,zb,vb,wb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P-1; i_0++) {
        A[i_0] = E[i_0] * F[i_0] * F[i_0] - A[i_0-1] * 6;
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < min(min(-i_0+PB_M, i_0), PB_P-2); i_2++) {
                for (int i_3 = 1; i_3 < -i_1+PB_L-1; i_3++) {
                    B[i_1][i_3][i_1][i_2+1][i_0+1] = G[i_3-1][i_2+1][i_0][i_0] + H[i_3-1][i_0-1][i_2][i_1] + G[i_3+i_1][i_2+i_0][0][i_3+1] - I[i_0][i_2+1][i_1+1][i_1-1] * H[i_3][i_1-1][i_0][i_2] - I[i_3+i_1+1][i_0][i_1+1][i_2] * I[i_0][i_3][i_1-1][i_2+1] * G[i_1][i_0][i_1][i_2] - B[i_1+1][i_0][i_1+1][i_2+1][i_3+1] + B[i_1][i_3-1][i_1][i_0+1][i_2+1] - B[i_1][i_3][i_1][i_2+2][i_0+1] * B[i_1][i_3][i_1][i_2+1][i_0] - B[i_1-1][i_0][i_1-1][i_3+1][i_2] + 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 1; i_5 < -i_4+PB_L-2; i_5++) {
            C[i_5+i_4][i_5] = F[i_4] + J[i_4][0] * F[i_5+1] + K[i_4][i_5-1] + K[i_4-1][i_5] - K[i_5][i_4+1] * C[i_5+i_4+1][i_5+1] - C[i_5+i_4+2][i_5+1] + 1;
            for (int i_6 = 0; i_6 < -i_4+PB_M+1; i_6++) {
                for (int i_7 = 0; i_7 < PB_L-1; i_7++) {
                    B[i_7+1][i_4][i_7+1][i_5][i_6] = L[i_6][i_5][i_7] * H[i_6+i_4-1][i_7][i_5+i_4+1][0] - B[i_6][i_5][i_6][i_4+1][i_7+1] * 6;
                }
            }
        }
    }
