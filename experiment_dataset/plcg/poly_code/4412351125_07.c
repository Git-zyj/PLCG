...
void kernel_4412351125_07(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_Q-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_L+1, -i_1+PB_Q); i_2++) {
                for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
                    B[i_0][i_3+1] = E[i_1][i_1+1][i_2] + F[i_1-1][i_2][i_3][i_1][i_0] - G[i_2][i_3][i_1][i_2] * H[i_3+1][i_0-1][i_1][i_2] * I[i_2-1][i_1][i_3-1][i_0] - H[i_0][i_2+1][i_1][1] + 5;
                }
                B[i_2][i_1-1] = J[i_2][i_1][i_0] * G[i_0-1][i_2+i_1][i_0+1][i_0+1] * J[i_2+1][i_2+i_0-1][1] * 5;
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        for (int i_5 = i_4; i_5 < PB_P; i_5++) {
            for (int i_6 = 1; i_6 < PB_M-1; i_6++) {
                B[i_6][i_5] = E[i_6+1][i_4+1][i_5] - K[i_6-1][i_4-1][i_5] * E[i_6][i_4][i_5] * J[i_5-1][i_4+1][i_6] - L[i_6+1][i_4] * 1;
            }
        }
        for (int i_7 = 1; i_7 < i_4; i_7++) {
            for (int i_8 = 1; i_8 < -i_4+PB_M-1; i_8++) {
                for (int i_9 = 2; i_9 < min(PB_P-1, -i_4+PB_L); i_9++) {
                    D[i_9][i_4][i_8][i_7] = H[i_8-1][i_9][i_4+1][i_7] * I[i_7-1][i_8][i_9+i_4][i_8] - H[i_7-1][i_4][i_9+1][i_8] + G[i_8+i_4+1][i_9][i_9-1][i_7] - D[i_9-2][i_4+1][i_8+2][i_7] - D[i_9][i_4][i_8][i_7+1] - 4;
                }
            }
        }
    }
...
init_array(xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4412351125_07(xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L)));
