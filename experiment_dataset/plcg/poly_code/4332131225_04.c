...
void kernel_4332131225_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf)){
        ...
        for (int i_1 = 0; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_N; i_2++) {
                for (int i_3 = 2; i_3 < -i_2+PB_P; i_3++) {
                    A[i_0+1][i_1][i_2][i_3-1] = D[i_2+i_0][i_3+1][i_1][i_3+i_2] * E[i_1+1][i_2+i_0-1][i_1] * A[i_0+1][i_1+2][i_2][i_3-1] + A[i_0+1][i_1][i_2][i_3-2] * 3;
                }
            }
        }
    }
        ...
        for (int i_5 = i_4; i_5 < PB_L-3; i_5++) {
            for (int i_6 = 0; i_6 < PB_L; i_6++) {
                for (int i_7 = 0; i_7 < -i_5+PB_L-1; i_7++) {
                    B[i_4-1][i_5][i_7+i_5+1][i_4] = E[i_7][i_5][i_5+1] - B[i_4-1][i_5][i_7+i_5-1][i_4] * 3;
                }
            }
            for (int i_8 = 0; i_8 < -i_5+PB_L-3; i_8++) {
                B[i_4-1][i_8][i_8+i_5+3][i_4] = E[i_4-1][0][0] - E[i_5+1][i_8][i_4] * E[i_4][i_5][i_8] - F[i_5-1][i_8] + 4;
            }
        }
    }
#pragma endscop
...
kernel_4332131225_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
