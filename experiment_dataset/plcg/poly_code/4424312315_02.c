...
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        ...
        B[i_0] = E[i_0] - B[i_0-1] + B[i_0+1] + B[i_0-1] * B[i_0+1] + B[i_0+1] * 4;
    }
    for (int i_3 = 0; i_3 < PB_L-2; i_3++) {
        for (int i_4 = 1; i_4 < PB_N; i_4++) {
            for (int i_5 = 0; i_5 < i_4; i_5++) {
                C[i_4][i_3][i_5] = F[i_4-1][i_3+1][i_3+2] + 6;
            }
        }
    }
        ...
        for (int i_7 = 0; i_7 < i_6; i_7++) {
            for (int i_8 = 0; i_8 < PB_M-1; i_8++) {
                for (int i_9 = 1; i_9 < min(-i_8+PB_M, PB_P); i_9++) {
                    C[i_8][i_7+1][i_9] = G[i_6][i_7][i_9][i_6-2] - H[i_6][i_9+i_8][i_7][i_9][i_6+2] * C[i_9-1][i_8+1][i_7+1] + 3;
                }
            }
        }
    }
...
init_array(xc,yc,zc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4424312315_02(xc,yc,zc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xc,yc,zc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H)));
