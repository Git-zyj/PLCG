...
void kernel_4334251123_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P-1; i_0++) {
        for (int i_1 = 2; i_1 < -i_0+PB_M; i_1++) {
            A[i_0] = D[i_1][i_0] + E[i_1+1][i_0+1] - E[i_1+i_0][i_0] + E[i_1][i_0] - E[i_1+i_0][i_0] * E[i_1][i_0+1] * A[i_1-2] * 3;
        }
        for (int i_2 = 1; i_2 < min(PB_P, -i_0+PB_L); i_2++) {
            for (int i_3 = 0; i_3 < -i_0+PB_P; i_3++) {
                A[i_0] = F[i_2][i_3+i_0][0] * 1;
            }
            A[i_0+2] = E[i_2][i_0] + D[i_2][i_2] + D[i_2-1][i_2+i_0] * D[i_0][i_2+i_0] * D[i_2][i_0] * D[i_2][i_0-1] * D[i_2][i_0+1] - 6;
        }
    }
#pragma endscop
...
kernel_4334251123_00(xa,POLYBENCH_ARRAY(A), xd,yd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
