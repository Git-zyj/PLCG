...
void kernel_4214111321_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N-2; i_0++) {
        for (int i_1 = 1; i_1 < PB_Q-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_M+1; i_2++) {
                for (int i_3 = 1; i_3 < min(min(-i_0+PB_N-1, i_2), -i_1+PB_N+1); i_3++) {
                    A[i_3+i_0][i_2-1][i_0][i_3+1] = A[i_3+i_0-2][i_2-1][i_0-2][i_3+1] + A[i_3+i_1-1][i_2-1][i_3-1][i_1+1] - A[i_3+i_0+1][i_2-1][i_0+1][i_3+1] - 4;
                }
            }
        }
        B[i_0] = C[i_0][i_0] + B[i_0+2] * B[i_0+1] + B[i_0-2] - 2;
    }
#pragma endscop
...
kernel_4214111321_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
