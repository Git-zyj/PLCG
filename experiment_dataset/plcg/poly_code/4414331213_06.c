...
void kernel_4414331213_06(int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,int wg,DATA_TYPE POLYBENCH_5D(G,xG,yG,zG,vG,wG,xg,yg,zg,vg,wg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = 1; i_2 < PB_M; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_2+PB_L+1, -i_0+PB_L); i_3++) {
                    D[i_1+i_0][i_3+i_2-1][i_0][i_2] = E[i_3-1][i_0-1][i_2][i_1+1] * F[i_3+i_0][i_1][i_1-1][i_2-1] + G[i_1+1][i_2][i_3][0][i_0-1] * 6;
                }
            }
        }
        B[i_0] = H[0] - H[i_0] * I[i_0] + J[i_0] - B[i_0-1] + 1;
        for (int i_4 = 0; i_4 < PB_M-1; i_4++) {
            for (int i_5 = 0; i_5 < -i_0+PB_M; i_5++) {
                for (int i_6 = 0; i_6 < -i_4+PB_L; i_6++) {
                    D[i_5+i_0][i_6+i_4][i_0][i_4] = E[i_5][i_0][i_6][i_0] + E[i_4+1][i_0-1][i_6+1][i_5] - 4;
                }
            }
        }
    }
        ...
        for (int i_8 = i_7; i_8 < -i_7+PB_M-1; i_8++) {
            for (int i_9 = 1; i_9 < PB_L; i_9++) {
                for (int j_0 = i_9; j_0 < -i_9+PB_L; j_0++) {
                    D[i_8+i_7][j_0+i_9-1][i_7][i_9] = D[i_8+i_7][j_0+i_9][i_8+1][i_9] * D[i_8+i_7+1][j_0+i_9-1][i_7+1][i_9] - D[i_8+i_7][j_0+i_9][i_7][i_9+1] + 1;
                }
            }
        }
    }
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4414331213_06(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J)));
