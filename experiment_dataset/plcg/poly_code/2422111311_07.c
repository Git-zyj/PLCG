...
void kernel_2422111311_07(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N-2; i_0++) {
        B[i_0+1] = E[i_0+1] * B[i_0] * 1;
        B[i_0+1] = E[0] + B[i_0] + B[i_0+2] + 1;
    }
    for (int i_1 = 2; i_1 < PB_N-1; i_1++) {
        C[i_1-1] = E[i_1+1] + C[i_1-2] + C[i_1] + C[i_1-2] - 6;
    }
...
kernel_2422111311_07(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E));
