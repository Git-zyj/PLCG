...
static void print_array(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl),int xm,int ym,DATA_TYPE POLYBENCH_2D(M,xM,yM,xm,ym),int xn,DATA_TYPE POLYBENCH_1D(N,xN,xn),int xo,int yo,int zo,DATA_TYPE POLYBENCH_3D(O,xO,yO,zO,xo,yo,zo),int xp,int yp,int zp,DATA_TYPE POLYBENCH_3D(P,xP,yP,zP,xp,yp,zp))
{
int i_0, i_1, i_2, i_3, i_4;
...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < PB_L-2; i_1++) {
            for (int i_2 = i_0; i_2 < -i_0+PB_L; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_1+PB_M, PB_L); i_3++) {
                    A[i_1][i_2][i_3][0] = E[i_3+2][i_3][i_2-1][i_0] + F[i_3+i_1][i_2-1][i_3][i_0] + G[i_2+2][i_1][i_2+i_0] + H[i_2][i_3+1][i_0-1][i_1][i_3] * F[i_0-1][i_3][i_1+2][i_2] + A[i_2-1][i_0][i_3+1][0] - 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L; i_4++) {
        for (int i_5 = 1; i_5 < PB_L; i_5++) {
            B[i_4][i_5] = I[i_5] + J[i_5][i_4] * K[i_5] + L[i_5][0] - M[i_5][i_4] - L[i_5-1][i_4] * B[i_4-1][i_5] - 1;
        }
    }
    for (int i_6 = 2; i_6 < PB_N-2; i_6++) {
        C[i_6+2] = I[i_6] * I[i_6] + N[i_6] + N[i_6] + C[i_6] + 5;
        for (int i_7 = 0; i_7 < PB_L; i_7++) {
            for (int i_8 = 0; i_8 < -i_6+PB_L; i_8++) {
                D[i_7+1][i_8+i_6][i_6][0] = G[i_8][i_6][i_7] + O[i_7][i_7][i_6] * P[i_8][i_6+1][i_7] - D[i_7+1][i_8+i_6-2][i_6][0] * 2;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M), xn,POLYBENCH_ARRAY(N), xo,yo,zo,POLYBENCH_ARRAY(O), xp,yp,zp,POLYBENCH_ARRAY(P), INIT_SEED);
kernel_4432352121_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M), xn,POLYBENCH_ARRAY(N), xo,yo,zo,POLYBENCH_ARRAY(O), xp,yp,zp,POLYBENCH_ARRAY(P));
