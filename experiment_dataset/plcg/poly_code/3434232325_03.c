    ...
    for (int i_5 = 0; i_5 < PB_Q; i_5++) {
        for (int i_6 = i_5; i_6 < PB_Q; i_6++) {
            for (int i_7 = 0; i_7 < min(PB_Q, -i_6+PB_L); i_7++) {
                B[i_7+i_6][i_7] = F[i_7][i_5] * G[i_7+i_6][i_5][2] * 5;
            }
        }
    }
    for (int i_8 = 1; i_8 < PB_L; i_8++) {
        for (int i_9 = 0; i_9 < min(min(-i_8+PB_L, i_8), PB_M); i_9++) {
            B[i_9+i_8][i_8] = F[i_8-1][i_9] + H[i_9] + F[i_9][i_8+2] + I[i_9][i_8] * I[i_9][i_8] + 1;
        }
    }
#pragma endscop
...
init_array(xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_3434232325_03(xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I)));
