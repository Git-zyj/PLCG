...
void kernel_2234112313_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = 3; i_0 < PB_P; i_0++) {
        ...
        B[i_0-2] = B[i_0-1] + B[i_0-3] * B[i_0-1] + 5;
    }
#pragma endscop
...
kernel_2234112313_00(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
