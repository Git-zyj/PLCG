...
void kernel_4432251221_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,DATA_TYPE POLYBENCH_1D(M,xM,xm)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 0; i_1 < PB_Q-1; i_1++) {
            for (int i_2 = 3; i_2 < min(min(PB_Q-1, -i_0+PB_M-1), -i_1+PB_Q); i_2++) {
                for (int i_3 = 2; i_3 < min(min(-i_1+PB_M, PB_Q-3), -i_0+PB_L-1); i_3++) {
                    A[i_1][i_2-1][i_2+1] = E[i_3+1][i_2+i_0+1][i_0][i_1] - F[i_1][i_3+i_0+1][i_2+1][i_1][0] - E[i_2][i_1][i_0][i_3+1] - G[i_2-1][i_3-1][i_1+1][i_0+1] * G[i_3+i_1][i_2-1][i_0+1][i_2+i_1] * A[i_1+1][i_2-1][i_2+1] + A[i_2][i_3+1][i_3+3] - A[i_3-2][i_2-1][i_2+1] + A[i_1][i_2-3][i_2-1] + A[i_2-2][i_3-1][i_3+1] * 2;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_L; i_4++) {
            for (int i_5 = 1; i_5 < min(min(PB_Q-2, -i_0+PB_P), -i_4+PB_Q); i_5++) {
                B[i_4][i_0][i_5] = H[i_0-1][i_4][i_5+i_4] * I[i_0-1][i_5][i_4-1] * I[i_5-1][i_5][i_4] + J[i_4][i_0+1] * I[i_5][i_5][i_4] + H[i_5+i_4][i_5+i_0][i_4] - I[i_5-1][i_0-1][1] - I[i_5+i_4][i_0-1][i_4] + A[i_0+2][i_5][i_5+2] - 1;
            }
        }
        C[i_0-1] = K[i_0-1][i_0] * L[i_0] - C[i_0] - 5;
    }
    for (int i_6 = 1; i_6 < PB_L; i_6++) {
        D[i_6] = M[i_6] - K[i_6-1][1] + L[i_6] - D[i_6-1] * 1;
    }
#pragma endscop
...
kernel_4432251221_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,POLYBENCH_ARRAY(M));
