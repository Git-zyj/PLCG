        ...
        for (int i_1 = 1; i_1 < PB_P; i_1++) {
            for (int i_2 = i_1; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_Q-2; i_3++) {
                    A[i_2][i_0-1][i_1][i_3+i_0+2] = C[i_2][i_3+2][i_1][i_0] + D[i_0][i_2][i_1][i_3-1] + E[i_1+1][i_0][i_3][i_2] - C[i_2][i_1][i_0][i_3] + F[i_3][i_1][i_2] - A[i_2-1][i_0-2][i_1-1][i_3+i_0+1] + A[i_2+1][i_0-1][i_1][i_3+i_0+2] - 4;
                }
            }
        }
        for (int i_4 = 0; i_4 < -i_0+PB_P+1; i_4++) {
            B[i_0][i_4][i_4+i_0-1] = G[i_4+1][i_0-2] * H[i_4] - G[i_0][i_4] * G[i_4][i_0] - I[i_4+1][i_0] - 4;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4222352115_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I)));
