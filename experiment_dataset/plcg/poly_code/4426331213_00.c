        ...
        for (int i_1 = i_0; i_1 < min(-i_0+PB_M, PB_L); i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_M-1; i_2++) {
                for (int i_3 = i_2; i_3 < PB_M-1; i_3++) {
                    C[i_2+i_1+1][i_1][i_2] = G[i_0+1][i_0][1][i_1] * G[i_3+i_2][i_1+i_0][i_3+1][i_0] - 4;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_Q-1; i_4++) {
        for (int i_5 = 1; i_5 < min(i_4, -i_4+PB_M-1); i_5++) {
            for (int i_6 = 1; i_6 < -i_4+PB_Q-1; i_6++) {
                C[i_6+i_5][i_5-1][i_6] = H[i_6][i_5][i_6+i_4+1] - I[i_5-1][i_6][i_4] + I[i_6-1][i_4][i_5] + J[i_6][i_4][i_5] + H[i_5+1][i_4][i_6] + C[i_5+i_4+1][i_5][i_4] * 5;
            }
        }
        for (int i_7 = 1; i_7 < PB_P; i_7++) {
            for (int i_8 = 0; i_8 < min(i_4, -i_7+PB_M); i_8++) {
                C[i_8+i_7][i_7-1][i_8] = J[i_8+1][i_4][i_7] + 3;
            }
        }
    }
#pragma endscop
...
init_array(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4426331213_00(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J)));
