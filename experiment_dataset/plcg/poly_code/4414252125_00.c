        ...
        for (int i_1 = 2; i_1 < min(-i_0+PB_M, i_0); i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_P; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_0+PB_M, -i_2+PB_N); i_3++) {
                    B[i_1][i_3][i_2+i_0-1][i_3] = E[i_3][i_0-1][i_1+1][i_2] + F[i_2][i_3+2][i_1-1] + E[i_3][i_2+i_0][i_1][i_0] - F[i_2][i_3][i_1] - E[i_3+i_0][i_2][i_1-2][0] + 3;
                    B[i_1][i_3][i_2+i_0-1][i_3] = G[i_2+1][i_0+2][i_3][i_1] * E[i_2+i_1][i_0-2][i_0-2][i_3+2] - F[i_3+i_2][i_1+i_0][0] - G[i_2][i_2][i_3][i_0] - 3;
                }
            }
        }
        C[i_0] = H[i_0] + H[i_0] + I[i_0][i_0] * J[i_0+2] * C[i_0+2] + C[i_0-1] * 4;
    }
    for (int i_4 = 0; i_4 < PB_M-2; i_4++) {
        C[i_4] = H[0] + H[i_4] + H[i_4] + H[i_4+2] * J[i_4] + 5;
    }
#pragma endscop
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4414252125_00(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J)));
