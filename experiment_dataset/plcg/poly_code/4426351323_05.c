...
void kernel_4426351323_05(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,int zk,int vk,DATA_TYPE POLYBENCH_4D(K,xK,yK,zK,vK,xk,yk,zk,vk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 2; i_1 < -i_0+PB_L-2; i_1++) {
            A[i_1][i_1+i_0] = E[i_1-1] - F[i_1][i_0] * A[i_1-1][i_1+i_0-1] - A[i_1+2][i_1+i_0+2] * A[i_1-2][i_1+i_0] * A[i_1-1][i_1+i_0] - A[i_1-2][i_1+i_0-2] * 5;
        }
    }
    for (int i_2 = 1; i_2 < PB_P-1; i_2++) {
        for (int i_3 = 1; i_3 < min(min(PB_L-3, -i_2+PB_L), i_2); i_3++) {
            A[i_3][i_3+i_2] = G[i_3-1][i_2] * H[i_3][i_2] + 6;
            for (int i_4 = 2; i_4 < PB_L; i_4++) {
                for (int i_5 = 1; i_5 < -i_4+PB_P; i_5++) {
                    C[i_2][i_3+1][i_2][i_5+i_4] = I[i_5][i_2][i_3][i_4] - J[i_4][1][i_2+1][i_3-1] + J[i_3][i_5][i_3+i_2][i_5] - I[i_3][i_4][i_3][i_2+1] * I[i_4-1][i_3][i_2][i_5-1] - I[i_2][i_5][i_3][i_4] * I[i_5+1][i_4][i_3-1][i_2] - J[i_5][i_3][i_2-1][i_4-1] + C[i_2][i_3+3][i_2][i_5+i_4-2] + 3;
                }
            }
        }
    }
        ...
        for (int i_7 = i_6; i_7 < min(-i_6+PB_P, PB_L-2); i_7++) {
            for (int i_8 = 1; i_8 < PB_L; i_8++) {
                for (int i_9 = i_7; i_9 < -i_8+PB_P+1; i_9++) {
                    C[i_6][i_7+2][i_6][i_9+i_8-1] = I[i_7-1][i_6+1][i_8][i_6] * K[i_8+1][i_9][i_7][i_6] * L[i_8][i_9-1][i_7] - K[i_9][i_8-1][i_7+i_6][i_6-1] - J[i_9][i_6][i_7-1][i_8-1] + J[i_7+1][i_8][i_9][i_6] - 4;
                }
            }
        }
    }
...
init_array(xa,ya,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4426351323_05(xa,ya,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xa,ya,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L)));
