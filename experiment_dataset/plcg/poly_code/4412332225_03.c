...
void kernel_4412332225_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg)){
        ...
        for (int i_1 = 2; i_1 < -i_0+PB_M-1; i_1++) {
            for (int i_2 = 2; i_2 < -i_1+PB_M; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_P; i_3++) {
                    A[i_0][i_1-2][i_2][i_1-2] = E[i_0][i_3][i_3][i_1] + F[i_2][i_3][i_1][i_2] * G[i_1+i_0+1][i_2][i_3][2] - E[i_2+i_1][i_0-1][i_1-2][i_3] - E[i_1+1][i_2][i_3+i_0][2] - A[i_0+1][i_1-1][i_2+1][i_1-1] * 4;
                    A[i_0][i_1-2][i_2][i_1-2] = G[i_3][i_2-2][i_0][i_1+1] + F[i_1][i_0+1][i_3+1][i_2] * G[i_2-1][i_1+i_0-2][i_3+1][2] * 5;
                }
            }
        }
        for (int i_4 = 2; i_4 < PB_L; i_4++) {
            for (int i_5 = 0; i_5 < PB_L-2; i_5++) {
                for (int i_6 = 2; i_6 < PB_L; i_6++) {
                    A[i_0][i_4-1][i_5][i_4-1] = E[i_4][i_5][i_6-2][0] + F[i_0][i_4][i_6][i_5] - G[i_4][i_5+2][i_0][i_4] + G[i_4][i_6][i_5][i_0-1] * A[i_0][i_4-2][i_6][i_4-2] - 6;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4412332225_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G)));
