...
void kernel_3324132213_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        B[i_0+1] = D[i_0] * D[i_0+1] + D[i_0] + D[i_0] * D[i_0] + B[i_0-1] - 2;
        B[i_0] = D[i_0] - D[i_0+2] + 3;
...
kernel_3324132213_05(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
