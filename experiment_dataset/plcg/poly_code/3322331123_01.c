...
void kernel_3322331123_01(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
...
#pragma scop
    ...
    for (int i_2 = 3; i_2 < PB_L-1; i_2++) {
        B[i_2-1] = E[i_2-1] * D[i_2] * F[i_2+1] + B[i_2-3] - 5;
        for (int i_3 = 1; i_3 < -i_2+PB_M; i_3++) {
            C[i_3] = G[i_3][i_2+1] - G[i_3+i_2][i_2] + G[i_3-1][i_2] + H[i_3-1][i_2-1] - E[i_2] - 5;
        }
    }
#pragma endscop
...
kernel_3322331123_01(xc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
