...
void kernel_2132212223_05(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 1; i_1 < PB_L-2; i_1++) {
            A[i_0][i_1] = B[i_1] + A[i_0][i_1+2] + A[i_0][i_1-1] + 5;
        }
    }
#pragma endscop
...
kernel_2132212223_05(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
