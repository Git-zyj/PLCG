...
void kernel_3316211215_02(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N-1; i_0++) {
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            B[i_1+1] = B[i_1] - B[i_1+1] * 5;
        }
        B[i_0+1] = D[i_0+1] * 2;
...
kernel_3316211215_02(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
