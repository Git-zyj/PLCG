...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < min(PB_Q-2, i_0); i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_L, PB_L-2); i_2++) {
                for (int i_3 = 2; i_3 < PB_M-2; i_3++) {
                    A[i_2][i_0][i_3+1][i_1] = D[i_3+2][i_2+i_0][i_1][i_2] + D[i_2+i_0-1][i_3-2][i_1][i_1+2] * E[i_3][i_0][i_2][i_1] * F[i_1][i_2+2][i_0-1][i_1+1][i_3] + E[i_3][i_2+i_0][i_0+1][0] * G[i_2][i_1][i_3-2] - A[i_2-1][i_0][i_3][i_1] - A[i_2][i_0+1][i_3+1][i_1] * A[i_0][i_2][i_3+1][i_1+1] + 3;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_N-1; i_4++) {
        for (int i_5 = max(i_4, 2); i_5 < PB_M-1; i_5++) {
            B[i_5] = H[i_4+1][i_5-1][i_5+1] * I[i_5-2] + B[i_5+1] + 1;
        }
    }
    for (int i_6 = 0; i_6 < PB_Q; i_6++) {
        for (int i_7 = 1; i_7 < min(i_6, PB_Q-1); i_7++) {
            for (int i_8 = 1; i_8 < PB_Q; i_8++) {
                for (int i_9 = 1; i_9 < min(-i_8+PB_Q, -i_7+PB_Q-1); i_9++) {
                    C[i_8][i_7][0][i_9+i_7] = E[i_6][i_7+1][i_9+i_8][0] + A[i_8][i_9-1][i_6][i_7] - C[i_8][i_7][0][i_9+i_7-1] - C[i_8-1][i_7][0][i_9+i_7] + C[i_8][i_7][0][i_9+i_7+1] + C[i_8][i_7+1][0][i_9+i_7+1] * 4;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4336332311_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I)));
