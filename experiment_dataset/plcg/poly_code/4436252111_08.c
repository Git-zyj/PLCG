...
void kernel_4436252111_08(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            A[i_1-1][i_0] = E[i_0] * F[i_1][i_0] + A[i_1-1][i_0-1] * 2;
        }
        for (int i_2 = i_0; i_2 < PB_M; i_2++) {
            for (int i_3 = max(2, i_0); i_3 < PB_N-2; i_3++) {
                for (int i_4 = 0; i_4 < min(-i_3+PB_L, PB_L-3); i_4++) {
                    B[i_2][i_4+2][i_3][i_2] = G[i_3+2][i_0][i_2][i_4+2] * H[i_0][i_4+i_3][i_2][i_2+1] - G[i_0][i_4][i_3][i_2] - H[i_3-2][i_4][i_0][i_2] * B[i_3][i_4+3][i_0][i_3] - 3;
                }
            }
        }
    }
    for (int i_5 = 2; i_5 < PB_M-2; i_5++) {
        for (int i_6 = 2; i_6 < i_5; i_6++) {
            for (int i_7 = 2; i_7 < min(-i_5+PB_M-2, -i_6+PB_Q); i_7++) {
                C[i_6+1][i_5][i_7] = I[i_6][i_5-1][i_7] - J[i_7][i_5][i_6] + F[i_6-1][i_7+i_5+2] + J[i_7][i_6][i_5] * I[i_6][i_5-2][i_7+i_6] - J[i_7-2][i_6-1][i_5-2] - J[i_7+i_6-2][i_5-1][i_6] - I[i_7][i_5][i_6-2] + C[i_6][i_7+1][i_5] * C[i_7][i_5-1][i_6+1] * 6;
            }
        }
    }
    for (int i_8 = 1; i_8 < PB_M-1; i_8++) {
        for (int i_9 = i_8; i_9 < -i_8+PB_N; i_9++) {
            D[i_8-1][i_8] = K[i_9+i_8][1] + F[i_9][i_8] - L[i_8+1] - K[i_8][i_9] * 5;
        }
    }
#pragma endscop
...
init_array(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4436252111_08(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L)));
