...
void kernel_4332251321_01(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg)){
        ...
        for (int i_1 = 1; i_1 < PB_Q-1; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_P, -i_1+PB_Q-1); i_2++) {
                for (int i_3 = 0; i_3 < PB_M-1; i_3++) {
                    B[i_0][i_1-1][i_2+1][i_0+1] = D[i_2-1][i_3][i_0][i_1] - D[i_2-1][i_3][i_0][i_2+i_1+1] - D[i_3+1][i_2+i_0][i_1][i_2] + C[i_3][i_0+1][i_1-1][i_0+1] - 4;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_Q; i_4++) {
            for (int i_5 = 1; i_5 < min(-i_0+PB_Q, -i_4+PB_M); i_5++) {
                for (int i_6 = 1; i_6 < PB_P; i_6++) {
                    B[i_0][i_4-1][i_5][i_0+1] = D[i_6][i_0][i_5+i_0][i_4] + D[i_5+i_4][i_6][i_5+i_0][i_0+1] - E[i_4][i_0+1][i_5-1] - F[i_5][i_6][i_4] * B[i_0-2][i_6-1][i_4][i_0-1] + 2;
                }
            }
        }
    }
    for (int i_7 = 1; i_7 < PB_N-2; i_7++) {
        for (int i_8 = 2; i_8 < PB_P-1; i_8++) {
            for (int i_9 = 0; i_9 < -i_7+PB_L-1; i_9++) {
                for (int j_0 = 1; j_0 < min(min(PB_P-1, -i_7+PB_M), -i_9+PB_L-1); j_0++) {
                    C[i_7][j_0][i_8][j_0] = D[j_0+i_7][i_9][i_8][j_0] + G[j_0][i_9][i_8][i_7+1] + D[j_0][i_9][i_7][0] + D[i_7][i_8+1][j_0][i_9] * F[j_0-1][i_9+i_7+1][i_7] + E[j_0][i_8+1][j_0+i_9+1] - E[i_9][j_0+1][i_8] - C[i_7+2][j_0+1][i_8][j_0+1] + C[i_7+1][j_0][i_8+1][j_0] * C[i_7-1][j_0][i_8-2][j_0] - 5;
                }
            }
        }
    }
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4332251321_01(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G)));
