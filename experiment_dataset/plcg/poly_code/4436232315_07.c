...
void kernel_4436232315_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M; i_0++) {
        A[i_0-2] = E[i_0] - F[i_0-2] - A[i_0-3] * 1;
    }
    for (int i_1 = 2; i_1 < PB_M; i_1++) {
        for (int i_2 = 0; i_2 < PB_M; i_2++) {
            for (int i_3 = 0; i_3 < -i_2+PB_M; i_3++) {
                for (int i_4 = 2; i_4 < min(i_1, PB_M-2); i_4++) {
                    D[i_3+i_2][i_4+1][i_1+2][i_2] = G[i_4+2][i_2][i_4+1][i_1+1] * G[i_4+1][i_3][i_2][i_1] + H[i_4+2][i_1][i_4-2][i_2] + 5;
                }
            }
        }
        A[i_1-2] = E[i_1-1] * E[i_1] - F[i_1] + 1;
    }
    for (int i_5 = 2; i_5 < PB_M-1; i_5++) {
        for (int i_6 = 2; i_6 < PB_P-3; i_6++) {
            for (int i_7 = i_6; i_7 < min(-i_5+PB_M-1, -i_6+PB_Q+1); i_7++) {
                for (int i_8 = 2; i_8 < min(-i_7+PB_Q+1, -i_5+PB_Q); i_8++) {
                    D[i_7+i_5][i_8][i_6+2][i_5] = G[i_5][i_6-2][i_8+i_7-1][i_7+i_6-1] - G[i_5-2][i_8][i_6][i_7-2] + G[i_8-2][i_6-2][i_5][i_8] + G[i_6][i_7][i_8+i_5][1] - D[i_7+i_5][i_8-1][i_6+3][i_5] + D[i_7+i_5][i_8+1][i_6+3][i_5] * D[i_7+i_5+1][i_8][i_6+2][i_5+1] - D[i_7+i_5+1][i_6+1][i_8+2][i_5] - 1;
                }
            }
        }
    }
...
kernel_4436232315_07(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
