...
void kernel_2212112223_07(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M; i_0++) {
        B[i_0-1] = 2;
        B[i_0-1] = C[i_0] - C[i_0] * B[i_0-3] - B[i_0-2] * 3;
    }
#pragma endscop
...
kernel_2212112223_07(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
