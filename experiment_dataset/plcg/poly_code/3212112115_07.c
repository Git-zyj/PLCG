...
void kernel_3212112115_07(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_P; i_0++) {
        for (int i_1 = 0; i_1 < PB_P; i_1++) {
            A[i_0][i_0] = C[i_1][i_0+2] - 3;
            for (int i_2 = 0; i_2 < PB_P; i_2++) {
                A[i_1][i_1] = A[i_1][i_1] + 2;
            }
        }
    }
#pragma endscop
...
kernel_3212112115_07(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C));
