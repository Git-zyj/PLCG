...
void kernel_3414351315_04(int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        D[i_0+1] = E[i_0] * F[i_0-1] - G[i_0] - F[i_0-1] - 4;
    }
    for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
        for (int i_2 = 1; i_2 < PB_L-1; i_2++) {
            for (int i_3 = 1; i_3 < min(min(-i_2+PB_P, -i_1+PB_Q-1), PB_M-1); i_3++) {
                B[i_3][i_2][1] = H[i_1][i_3+i_2][0] + I[i_2][i_1][i_3] - H[i_1-1][i_3-1][i_1] - J[i_2][i_1][i_3] - I[i_2][i_1-1][i_1] - J[i_2+1][i_2][i_3+i_1+1] + I[i_1][i_3+1][i_2+1] + H[i_3][i_2-1][i_1] - H[i_2+1][i_3][i_1] - B[i_3][i_2-1][1] - B[i_3+1][i_2+1][1] * B[i_3+1][i_2][1] + B[i_3][i_1-1][1] - 5;
            }
        }
        D[i_1] = E[i_1-1] - D[i_1+1] + 1;
        D[i_1+1] = E[i_1] - F[i_1] * F[1] + F[i_1-1] + G[i_1] + E[i_1+1] * D[i_1] + 5;
    }
#pragma endscop
...
kernel_3414351315_04(xd,POLYBENCH_ARRAY(D), xb,yb,zb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
