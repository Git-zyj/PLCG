...
void kernel_4432352325_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 2; i_1 < PB_M; i_1++) {
            for (int i_2 = i_0; i_2 < -i_0+PB_Q-1; i_2++) {
                for (int i_3 = 2; i_3 < min(-i_0+PB_L, -i_1+PB_L); i_3++) {
                    A[i_1-2][i_2-2][i_3][i_2+i_0] = E[i_1][i_2-1][i_3][i_0-1] * F[i_0+2][i_2+2][i_3+i_1][i_1] + E[i_0][i_3-2][i_1][i_2] * F[i_0+2][i_3][i_1-2][2] + F[i_1][i_0][i_2][i_3] - G[i_2][i_1-2][i_3+i_0][i_1] * A[i_1-2][i_2-1][i_3][i_2+i_0+1] - A[i_1-2][i_2-2][i_3-1][i_2+i_0-2] + 1;
                }
            }
            for (int i_4 = 0; i_4 < PB_L; i_4++) {
                for (int i_5 = 2; i_5 < -i_0+PB_Q; i_5++) {
                    A[i_1-1][i_5-2][i_4+1][i_5+i_0] = H[i_5][i_1][0] * 4;
                }
            }
        }
    }
    for (int i_6 = 2; i_6 < PB_M-2; i_6++) {
        C[i_6] = I[i_6] + J[i_6] - K[i_6] - J[i_6] - I[i_6+2] * J[i_6] * C[i_6-1] - C[i_6+1] + C[i_6+2] - D[i_6-2] * 5;
    }
    for (int i_7 = 2; i_7 < PB_M-1; i_7++) {
        D[i_7-1] = K[i_7] + K[i_7+1] + J[i_7+1] * I[i_7-1] + C[i_7] + D[i_7-2] * 1;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4432352325_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K)));
