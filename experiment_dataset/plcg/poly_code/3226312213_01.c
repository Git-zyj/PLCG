...
void kernel_3226312213_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-4; i_0++) {
        for (int i_1 = i_0; i_1 < PB_M-3; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_0+PB_M-4, -i_1+PB_M-3); i_2++) {
                A[i_2+i_0+2][i_1][i_1] = A[i_2+i_0+4][i_1][i_1] + A[i_2+i_1+3][i_0][i_0] - A[i_2+i_0+3][i_1+1][i_1+1] * 4;
            }
        }
    }
    for (int i_3 = 0; i_3 < PB_L-2; i_3++) {
        for (int i_4 = 0; i_4 < min(-i_3+PB_N, i_3); i_4++) {
            for (int i_5 = i_3; i_5 < min(-i_3+PB_L, PB_M); i_5++) {
                B[i_4+i_3][i_5+1][i_5+i_3] = C[i_5][i_3+2] - 5;
            }
        }
    }
#pragma endscop
...
kernel_3226312213_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
