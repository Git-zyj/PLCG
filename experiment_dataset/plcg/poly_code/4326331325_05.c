...
void kernel_4326331325_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
        ...
        for (int i_1 = max(2, i_0); i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < PB_P-2; i_2++) {
                for (int i_3 = 1; i_3 < i_0; i_3++) {
                    A[i_3][i_1][i_2][i_0] = D[i_3][i_2+1][i_0][i_1] * E[i_2][i_3][i_1][i_0] - A[i_0+1][i_1][i_3-1][i_2] * A[i_3-1][i_1][i_2+1][i_0] - A[i_3][i_1-2][i_2+1][i_0+1] - A[i_3][i_1-2][i_2][i_0-1] * A[i_3][i_1-1][i_2+2][i_0+1] * 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L; i_4++) {
        for (int i_5 = 0; i_5 < PB_L; i_5++) {
            for (int i_6 = 2; i_6 < PB_L; i_6++) {
                for (int i_7 = 0; i_7 < min(min(-i_5+PB_P, i_5), -i_4+PB_Q); i_7++) {
                    A[i_5][i_4-1][i_6-2][i_7] = E[0][i_4][i_6][i_5] + F[i_6+1][i_4][i_7+i_5][0] - F[i_6-1][i_4][i_5][i_7+i_4] + D[i_7][i_4][i_5][i_4] * 6;
                }
            }
        }
    }
    for (int i_8 = 0; i_8 < PB_P-1; i_8++) {
        for (int i_9 = 1; i_9 < min(i_8, -i_8+PB_M); i_9++) {
            for (int j_0 = 2; j_0 < i_8; j_0++) {
                C[i_8][j_0][i_9-1] = G[j_0+1][i_8+1][i_9] + H[i_9+i_8][i_8][j_0+1] - C[i_8][j_0-2][i_9-1] - 3;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4326331325_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H)));
