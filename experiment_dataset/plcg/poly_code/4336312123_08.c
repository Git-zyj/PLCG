...
void kernel_4336312123_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
        ...
        for (int i_5 = 0; i_5 < PB_L-2; i_5++) {
            for (int i_6 = 0; i_6 < min(i_5, -i_5+PB_L-2); i_6++) {
                for (int i_7 = 2; i_7 < PB_M-2; i_7++) {
                    C[i_1+1][i_6+i_5][i_7-2][i_7] = C[i_1][i_6+i_5+2][i_7-2][i_7] - C[i_7+2][i_6+i_5][i_1-2][i_1] - 4;
                }
            }
        }
    }
...
kernel_4336312123_08(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
