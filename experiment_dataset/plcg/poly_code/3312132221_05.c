    ...
    for (int i_5 = 0; i_5 < PB_M; i_5++) {
        for (int i_6 = 1; i_6 < min(PB_P-1, i_5); i_6++) {
            for (int i_7 = 2; i_7 < PB_L-2; i_7++) {
                C[i_5][i_7][i_6] = C[i_5][i_7-2][i_6+1] - C[i_5][i_7+2][i_6-1] * C[i_5][i_7][i_6-1] * 3;
            }
        }
    }
#pragma endscop
...
kernel_3312132221_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
