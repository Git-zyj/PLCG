...
void kernel_4224252125_05(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
        ...
        for (int i_1 = max(2, i_0); i_1 < -i_0+PB_P; i_1++) {
            for (int i_2 = 0; i_2 < PB_L; i_2++) {
                for (int i_3 = 2; i_3 < PB_N; i_3++) {
                    B[i_3][i_1-1][i_2+1][i_1] = C[i_2][i_0][i_3][i_1-2] * D[i_2][i_0][i_3][i_1-1] - C[i_3-2][i_0-1][i_2][i_1] + C[i_2][i_1+i_0][i_3][i_3] + 3;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_P-2; i_4++) {
        for (int i_5 = 2; i_5 < PB_L; i_5++) {
            for (int i_6 = 0; i_6 < PB_L-2; i_6++) {
                for (int i_7 = 1; i_7 < min(min(PB_M-3, -i_6+PB_M-1), -i_4+PB_P); i_7++) {
                    B[i_4][i_5-1][i_7+1][i_5] = E[i_6+1][i_5-1][i_4] * D[i_7][i_6][i_7+i_4][i_6+1] * D[i_5-2][i_4][i_7-1][i_6] * D[i_7][i_6+2][i_4][i_5-1] - C[i_5][i_6][i_7][i_4] - F[i_7+i_6+1][i_5][i_4+2] * B[i_6][i_5-1][i_7+3][i_5] * 5;
                }
            }
        }
    }
...
kernel_4224252125_05(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
