...
void kernel_3222211321_01(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        B[i_0-1] = B[i_0-2] * 4;
        B[i_0-1] = C[1] - B[i_0-2] - B[i_0] - 2;
    }
#pragma endscop
...
kernel_3222211321_01(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
