...
void kernel_4416251313_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,int zk,int vk,DATA_TYPE POLYBENCH_4D(K,xK,yK,zK,vK,xk,yk,zk,vk),int xl,int yl,int zl,int vl,DATA_TYPE POLYBENCH_4D(L,xL,yL,zL,vL,xl,yl,zl,vl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 1; i_1 < PB_L-2; i_1++) {
            A[i_1][i_1+1] = E[i_0][i_1+1] * F[1] * G[i_0][i_1] + G[i_1][i_1] * A[i_1+1][i_1+2] * A[i_0+1][i_0+2] - A[i_1-1][i_1] * 5;
        }
    }
    for (int i_2 = 1; i_2 < PB_Q; i_2++) {
        A[i_2][i_2+1] = F[i_2] * F[i_2+1] + H[i_2] * F[i_2-1] * G[i_2-1][i_2] * 6;
        for (int i_3 = 1; i_3 < -i_2+PB_N-1; i_3++) {
            for (int i_4 = 1; i_4 < i_3; i_4++) {
                C[i_3+i_2][i_4][i_4] = I[i_4][i_2][i_3] - J[i_2][i_4][i_3] - G[i_4+1][0] * I[i_4][i_2][i_3+1] - C[i_3+i_2+1][i_4][i_4] - 3;
                for (int i_5 = i_3; i_5 < PB_Q; i_5++) {
                    C[i_4+i_3+1][i_2][i_2] = K[i_4+1][i_5][i_2+1][i_3-1] + J[i_4][i_3-1][0] - L[i_2][i_3+1][i_5+i_4-1][i_4] * L[i_2][i_5+i_4][i_2][0] * K[i_3][i_5][i_2][i_4] + K[i_5+i_4][i_2+1][i_3][i_2] + C[i_4+i_2][i_5][i_5] - 1;
                }
            }
        }
    }
...
init_array(xa,ya,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,vl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4416251313_00(xa,ya,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,vl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xa,ya,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,vl,POLYBENCH_ARRAY(L)));
