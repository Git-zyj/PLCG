...
void kernel_4424111315_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        for (int i_1 = i_0; i_1 < PB_P; i_1++) {
            for (int i_2 = i_1; i_2 < PB_M-1; i_2++) {
                A[i_2][i_1][i_2] = E[i_2-1][i_0][0] + A[i_0][i_2+1][i_0] - A[i_2+1][i_1][i_2+1] + A[i_2][i_0-1][i_2] + 2;
            }
        }
    }
    for (int i_3 = 2; i_3 < PB_M-1; i_3++) {
        B[i_3-1][i_3] = F[i_3] * B[i_3][i_3+1] + B[i_3-2][i_3-1] - 3;
        for (int i_4 = 1; i_4 < PB_P-2; i_4++) {
            for (int i_5 = 0; i_5 < min(-i_3+PB_L-1, -i_4+PB_P-2); i_5++) {
                C[i_3-1][i_5+i_3][i_5+i_4+1] = G[i_3][i_4] - E[i_5][i_5+i_3+1][i_4] + 4;
                A[i_5][i_4-1][i_5] = C[i_3][i_5+i_3+1][i_5+i_4+1] * C[i_3-1][i_5+i_3][i_5+i_4+1] - C[i_3-2][i_5+i_3-1][i_5+i_4+1] * C[i_3-1][i_5+i_3][i_5+i_4+2] + 6;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4424111315_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G)));
