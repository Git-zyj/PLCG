...
void kernel_4214352315_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 1; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 2; i_2 < min(i_0, -i_0+PB_P); i_2++) {
                for (int i_3 = 2; i_3 < min(-i_0+PB_Q-2, -i_1+PB_M); i_3++) {
                    A[i_2+1][i_3][i_0][i_1+1] = C[i_3+i_1][i_2][i_0] * D[i_3][i_0][i_2+1][i_0] * E[i_3][i_2][i_1][i_2+i_0] - F[i_2][i_1][i_3-2][i_3+i_0+2] * A[i_2+1][i_3][i_0+1][i_1+1] * A[i_2+1][i_3+1][i_0][i_1+1] + 2;
                    A[i_2+1][i_3-1][i_0][i_1] = D[i_0-1][i_3][i_1][i_2] + F[i_2][i_3][i_1][i_1+1] - F[i_3][i_2+i_0][i_1+1][2] + G[i_3][i_1][i_0+2] - D[i_1-1][i_0][i_2-2][i_3] + F[i_3][i_0-1][i_1][i_2] * A[i_2+1][i_3+1][i_0+1][i_1+2] - 3;
                }
            }
        }
    }
...
kernel_4214352315_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
