...
void kernel_3232152311_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        B[i_0-1] = C[i_0] * B[i_0] - B[i_0+1] - 1;
        B[i_0] = C[i_0-2] + C[i_0+1] * C[i_0-1] + C[0] - C[i_0] * C[i_0] * C[i_0] * C[i_0] + C[i_0] + B[i_0+1] * 2;
    }
#pragma endscop
...
kernel_3232152311_05(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
