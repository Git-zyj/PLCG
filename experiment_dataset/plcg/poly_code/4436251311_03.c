...
void kernel_4436251311_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl)){
        ...
        for (int i_1 = 1; i_1 < PB_L+1; i_1++) {
            for (int i_2 = 1; i_2 < min(i_1, PB_M-1); i_2++) {
                for (int i_3 = i_0; i_3 < PB_M; i_3++) {
                    A[i_1-1][i_2][i_0][i_3] = E[i_0][i_3][i_1][i_2] * E[i_0][i_3][i_1-1][i_2+1] + F[i_3][i_2][i_1] * A[i_1-1][i_2-1][i_3][i_0] - 1;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L; i_4++) {
        for (int i_5 = i_4; i_5 < -i_4+PB_P; i_5++) {
            for (int i_6 = 1; i_6 < -i_5+PB_P; i_6++) {
                B[i_6][i_5][i_4] = G[i_6-1][i_5][i_4][0] + H[i_4+1][i_5] * F[i_4][i_6+i_5][i_6] + I[i_6+1][i_4][i_5] - H[i_6][i_5] * J[i_6][i_5+1] + I[i_6][i_4][i_5] + J[i_6][i_5] - I[i_6][i_5+i_4][1] - B[i_6+1][i_5][i_4] + B[i_4-1][i_5][i_6] - B[i_6][i_5][i_4-1] + B[i_6-1][i_5][i_4] * B[i_6][i_5+1][i_4] * B[i_5+1][i_6][i_4] * B[i_6+1][i_4][i_5-1] * B[i_4-1][i_6][i_5] - 2;
            }
        }
        C[i_4] = K[i_4] * H[i_4][0] * L[i_4] * K[i_4] - C[i_4-1] + 5;
    }
    for (int i_7 = 1; i_7 < PB_N; i_7++) {
        for (int i_8 = 1; i_8 < PB_N; i_8++) {
            for (int i_9 = i_7; i_9 < PB_L; i_9++) {
                for (int j_0 = 1; j_0 < min(PB_N, -i_9+PB_M+1); j_0++) {
                    D[j_0-1][i_8-1][i_9][i_7] = G[i_7][i_9][i_8][j_0] + G[j_0][i_9][i_7][i_8] - E[i_8][i_9][j_0+i_9-1][i_7] * E[i_8][i_7-1][j_0][i_9] - D[j_0-1][i_8-1][i_7][i_9+1] - D[i_7-1][j_0-1][i_9-1][i_8] * 2;
                }
            }
        }
    }
