...
void kernel_4234211325_04(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_0 = 0; i_0 < PB_P; i_0++) {
        ...
        for (int i_3 = 2; i_3 < PB_M-1; i_3++) {
            for (int i_4 = 3; i_4 < min(PB_P, i_3); i_4++) {
                B[i_0+1][i_3][i_4-1] = C[i_4-1][i_0][i_3] + B[i_0+1][i_3-2][i_4-1] - B[i_0+1][i_3][i_4-3] * B[i_3+1][i_0][i_4] * 4;
            }
        }
    }
#pragma endscop
...
kernel_4234211325_04(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
