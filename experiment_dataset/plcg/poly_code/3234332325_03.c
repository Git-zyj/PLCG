...
void kernel_3234332325_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_L-1; i_0++) {
        B[i_0] = C[i_0] - D[i_0][i_0+1] * B[i_0-1] - B[i_0-3] * B[i_0] * 5;
        B[i_0-1] = D[i_0+2][i_0] * E[i_0+2][i_0] - C[i_0+1] * 5;
    }
#pragma endscop
...
kernel_3234332325_03(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
