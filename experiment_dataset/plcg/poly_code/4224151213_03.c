...
void kernel_4224151213_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 1; i_1 < min(PB_L-1, -i_0+PB_P); i_1++) {
            for (int i_2 = max(1, i_0); i_2 < PB_M-1; i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_M-1; i_3++) {
                    A[i_0+1][i_1+1][i_2][i_0] = C[i_3+i_0+1][i_1][i_2-1][i_2+1] - C[i_0][i_1-1][i_3-1][i_2-1] + C[i_1][i_2][i_3][i_0] * C[i_1][i_2][i_3][i_0] * C[i_2-1][i_2][i_1][i_3] + D[i_0][i_3][i_1] - C[i_2+1][i_0][i_1+i_0][i_3-1] * A[i_1+1][i_3+1][i_2-1][i_1] + A[i_0+2][i_1+1][i_2-1][i_0+1] + 5;
                }
                A[i_2][i_1+1][i_0][i_2-1] = D[i_1+1][i_2-1][0] - D[i_1][i_2-1][i_0] + D[i_1][i_0][i_2] * 1;
            }
        }
    }
#pragma endscop
...
kernel_4224151213_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
