        ...
        for (int i_1 = 0; i_1 < min(-i_0+PB_Q, i_0); i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_Q+2, PB_L-1); i_2++) {
                for (int i_3 = 0; i_3 < PB_P-2; i_3++) {
                    A[i_2][i_3+1][i_1+i_0][1] = E[i_0-1][i_3][i_1][i_2][i_0] - F[i_1][i_3][i_2-1][i_0+1] + G[i_3][i_1][i_2][i_0] * H[i_0-1][i_3+1][i_2][i_1] - A[i_2+1][i_3+1][i_1+i_0][1] - A[i_1][i_3+1][i_2+i_0-2][1] + A[i_2][i_3+2][i_1+i_0][1] * A[i_2][i_3+1][i_1+i_0-1][1] * 1;
                }
            }
        }
        B[i_0] = I[i_0-1] - J[i_0] * K[i_0] + I[i_0-1] * B[i_0+1] * B[i_0-1] - 3;
    }
    for (int i_4 = 1; i_4 < PB_L-2; i_4++) {
        for (int i_5 = i_4; i_5 < PB_M-1; i_5++) {
            C[i_4][i_5+1] = L[i_5-1][i_4-1] + B[i_5] + C[i_4+1][i_5+1] * C[i_4+1][i_5] + C[i_5+1][i_4+2] * C[i_4-1][i_5] - 4;
        }
    }
    for (int i_6 = 1; i_6 < PB_M; i_6++) {
        for (int i_7 = i_6; i_7 < PB_P; i_7++) {
            for (int i_8 = i_7; i_8 < PB_L-1; i_8++) {
                for (int i_9 = 0; i_9 < min(PB_P, -i_8+PB_M+1); i_9++) {
                    D[i_6][i_8][i_9][i_9] = E[i_8][i_9][i_6][i_7][i_8] + G[i_6][i_9+i_8-1][i_7][i_8] * F[i_8+1][i_7][i_8-1][i_6] + D[i_8-1][i_7-1][i_6-1][i_6-1] * 4;
                }
            }
        }
    }
