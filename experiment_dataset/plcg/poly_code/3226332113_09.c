    ...
    for (int i_2 = 1; i_2 < PB_L+1; i_2++) {
        for (int i_3 = 0; i_3 < min(i_2, PB_M-1); i_3++) {
            for (int i_4 = 1; i_4 < -i_3+PB_M; i_4++) {
                B[i_2-1][i_3][i_4-1] = E[i_3][i_2][i_4-1] * E[i_4][i_2][i_3] - F[i_3][i_4+i_3][i_2-1] * B[i_4-1][i_3+1][i_2-1] - 5;
            }
        }
    }
#pragma endscop
...
kernel_3226332113_09(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
