        ...
        for (int i_1 = 0; i_1 < PB_Q; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_M; i_2++) {
                for (int i_3 = 1; i_3 < i_1; i_3++) {
                    C[i_2][i_2][i_3-1] = E[i_3-1][i_1][i_0-1][i_2+1] - F[i_0][i_3][i_2] * G[i_3][i_2][i_1][i_0] * H[i_1][i_3-1][i_0+1][i_0] + H[i_2+i_0][i_3][i_1][i_0] - 5;
                }
            }
        }
        B[i_0-1] = I[i_0] + I[i_0] - J[i_0] - K[i_0] - B[i_0+1] - B[i_0-2] + 5;
        for (int i_4 = 2; i_4 < i_0; i_4++) {
            for (int i_5 = 0; i_5 < min(i_4, -i_0+PB_L-1); i_5++) {
                C[i_5][i_5][i_0] = L[i_4][i_0-1][i_4] + F[i_4-1][i_5+i_0+1][i_5] + M[i_5][i_4+1][i_0+1] * M[i_5][i_0+1][i_4+1] - N[i_5][i_4] - N[i_0][i_4] + M[i_4-1][i_4][i_5] * C[i_5+1][i_5+1][i_0] - C[i_5][i_5][i_0-1] * C[i_4-2][i_4-2][i_5] * 3;
            }
        }
    }
    for (int i_6 = 1; i_6 < PB_N+1; i_6++) {
        for (int i_7 = 1; i_7 < i_6; i_7++) {
            for (int i_8 = 0; i_8 < -i_7+PB_N+1; i_8++) {
                C[i_8][i_8][i_6] = G[i_7][i_8][i_6][0] * L[i_8][i_6][i_7] + M[i_8+i_7-1][i_6-1][i_6] + 2;
            }
        }
    }
#pragma endscop
