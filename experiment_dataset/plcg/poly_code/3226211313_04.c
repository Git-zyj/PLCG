...
void kernel_3226211313_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        A[i_0+1][i_0+1] = C[i_0] + C[i_0+1] * 4;
        for (int i_1 = 0; i_1 < PB_N; i_1++) {
            A[i_0+1][i_0+1] = A[i_0+1][i_0+1] * A[i_0+2][i_0+2] * A[i_0][i_0] - 3;
        }
    }
#pragma endscop
...
kernel_3226211313_04(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
