...
void kernel_3412151111_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N-1; i_0++) {
        A[i_0] = E[i_0] * E[i_0] + E[i_0] + E[i_0] - E[i_0+1] * 1;
        B[i_0][i_0-1] = E[i_0-1] + E[i_0] - E[i_0+1] - E[i_0] * E[i_0-1] * E[i_0] * E[i_0] * E[i_0+1] + B[i_0+1][i_0] - 5;
        for (int i_1 = 0; i_1 < PB_M; i_1++) {
            B[i_0-1][i_0-2] = E[i_0] * F[i_1][i_0-1] + F[i_1][i_0] - 2;
        }
    }
    for (int i_2 = 1; i_2 < PB_N; i_2++) {
        for (int i_3 = 0; i_3 < PB_L; i_3++) {
            for (int i_4 = 0; i_4 < -i_2+PB_N; i_4++) {
                D[i_3][i_4+i_2][i_4+i_2] = G[i_4][i_4+i_2-1][i_3] + G[i_3][i_2][i_4] - 1;
            }
        }
    }
#pragma endscop
...
kernel_3412151111_04(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
