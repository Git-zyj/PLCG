...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
        for (int i_2 = i_1; i_2 < -i_1+PB_M-1; i_2++) {
            B[i_2][i_1-1] = G[i_2] - A[i_2-1] - A[i_2] * B[i_2+1][i_1-2] - 6;
            for (int i_3 = 0; i_3 < min(i_1, -i_2+PB_P); i_3++) {
                for (int i_4 = 1; i_4 < min(min(-i_1+PB_M-1, -i_3+PB_Q-1), -i_2+PB_M-1); i_4++) {
                    C[i_4+i_1+1][i_3+1][i_1][i_4] = H[i_4][i_4-1][i_2][i_3] * I[i_2][i_3+1][i_4+1][i_1] + I[i_1][i_4][i_3+i_2][i_2] + H[i_4-1][i_4][i_2][i_1] * J[i_2][i_1][i_4+i_3+1][i_4] + I[i_2+1][i_1-1][i_4+i_3][i_1] - C[i_4+i_1][i_3+1][i_4][i_1-1] + C[i_2+i_1+1][i_4+2][i_1-1][i_2+1] + C[i_4+i_2+1][i_3][i_2][i_4] - C[i_4+i_1][i_2+1][i_1][i_4-1] - 4;
                }
            }
        }
        for (int i_5 = i_1; i_5 < -i_1+PB_M-2; i_5++) {
            for (int i_6 = 1; i_6 < PB_M-1; i_6++) {
                C[i_5+i_1+2][i_6][i_1+1][i_5] = K[i_5][i_6+1][i_1+1] - L[i_5][i_6+1][i_1+1] * L[i_5][i_6][i_1] + K[i_6-1][i_6][i_5+i_1] + K[i_6+1][i_1+1][i_5+i_1-1] + M[i_6][i_1][i_5] + K[i_6+1][i_1-1][i_5] + K[i_6-1][i_1-1][i_5-1] + N[i_6][i_5] - B[i_6][i_5-1] + 3;
            }
        }
    }
#pragma endscop
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,zm,POLYBENCH_ARRAY(M), xn,yn,POLYBENCH_ARRAY(N), INIT_SEED);
kernel_4426351311_04(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,zm,POLYBENCH_ARRAY(M), xn,yn,POLYBENCH_ARRAY(N));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,zm,POLYBENCH_ARRAY(M), xn,yn,POLYBENCH_ARRAY(N)));
