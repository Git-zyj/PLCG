        ...
        for (int i_1 = i_0; i_1 < PB_M; i_1++) {
            for (int i_2 = 2; i_2 < PB_M-2; i_2++) {
                for (int i_3 = 1; i_3 < PB_M; i_3++) {
                    A[i_0+2][i_1][i_2][i_0] = E[i_2+2][i_0][i_3][i_1] - E[i_2-2][i_3-1][i_1][i_0-1] * A[i_0][i_1][i_2][i_0-2] - A[i_0+1][i_1][i_2-2][i_0-1] * A[i_2+2][i_3][i_0+1][i_2] - 3;
                }
            }
        }
        for (int i_4 = 2; i_4 < PB_M-1; i_4++) {
            D[i_4-1] = F[i_4][i_0+2] * G[i_4-2][i_0] - H[i_4+1][i_0+1] + 2;
        }
        D[i_0-1] = I[i_0+1] - J[i_0+1] - 3;
    }
    for (int i_5 = 2; i_5 < PB_M-1; i_5++) {
        D[i_5-1] = K[i_5] + H[i_5-2][i_5] + J[i_5] + D[i_5+1] + D[i_5] + 1;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4424332325_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K)));
