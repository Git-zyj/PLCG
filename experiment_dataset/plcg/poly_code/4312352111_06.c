...
#pragma scop
    ...
    for (int i_1 = PB_L - 1; i_1 >= 1; i_1--) {
        for (int i_2 = 2; i_2 < PB_L; i_2++) {
            B[i_2][i_1] = F[i_2][i_1] * E[i_2-1] - F[i_2-2][i_1] - G[i_2][i_1] - G[i_2-2][i_1] - G[i_2+1][i_1] - H[i_1][i_2] + H[i_2][1] * B[i_2][i_1-1] * B[i_1-1][i_2] + 1;
        }
        C[i_1-1] = I[i_1] * D[i_1] - I[i_1] * 2;
    }
#pragma endscop
...
kernel_4312352111_06(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
