...
void kernel_2334212325_08(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        C[i_0+1] = 3;
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            C[i_1+1] = C[i_1+1] + C[i_0+1] * C[i_1-1] + 3;
        }
        C[i_0+1] = D[i_0] - 1;
    }
#pragma endscop
...
kernel_2334212325_08(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
