...
void kernel_4332211323_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we)){
...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_P-2; i_2++) {
                for (int i_3 = 0; i_3 < PB_Q-1; i_3++) {
                    A[i_1-1][i_2+i_0][i_2-1][i_3] = A[i_1][i_2+i_0+2][i_2-1][i_3+1] * A[i_1][i_2+i_0][i_2-1][i_3] * 1;
                }
            }
        }
        for (int i_4 = 1; i_4 < -i_0+PB_P; i_4++) {
            for (int i_5 = 1; i_5 < PB_L+1; i_5++) {
                for (int i_6 = 0; i_6 < PB_L; i_6++) {
                    A[i_5-1][i_4+i_0][i_0-1][i_6] = D[i_0][i_6][i_4][i_5-1] * E[i_4-1][i_6][i_5-1][i_6+1][i_0+1] + 4;
                }
            }
        }
    }
    for (int i_7 = 2; i_7 < PB_M; i_7++) {
        for (int i_8 = 1; i_8 < min(-i_7+PB_Q, i_7); i_8++) {
            C[1][i_7+1][i_8+i_7] = C[1][i_7-1][i_8+i_7] - C[1][i_8+1][i_8+i_7-1] + C[1][i_8-1][i_8+i_7-2] + 3;
        }
    }
#pragma endscop
...
kernel_4332211323_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E));
