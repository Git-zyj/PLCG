...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_L; i_1++) {
        for (int i_2 = 2; i_2 < i_1; i_2++) {
            A[i_2] = G[i_2+1][i_1-1] - G[i_2][i_1] - H[i_1][i_2-2] * F[i_2] - H[i_2][i_1] * 1;
        }
    }
    for (int i_3 = 0; i_3 < PB_M-3; i_3++) {
        C[i_3+2] = F[i_3] - E[0] * E[i_3] - E[i_3] - E[i_3] - C[i_3+3] + 3;
    }
#pragma endscop
...
kernel_4334352115_02(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
