...
void kernel_4316252313_05(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
        ...
        for (int i_1 = i_0; i_1 < PB_P; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_P; i_2++) {
                for (int i_3 = 2; i_3 < min(-i_0+PB_M, -i_1+PB_P); i_3++) {
                    B[i_3+1][i_0+1] = D[i_2][i_1][i_3+i_0][i_1] * D[i_1-1][i_0-1][i_3][i_0] + D[i_2][i_1-1][i_3][i_0-2] + E[i_3-2][i_1-1][i_2+i_0] * F[i_3+i_0][i_3+i_1][i_2] + 5;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M; i_4++) {
        for (int i_5 = 1; i_5 < min(i_4, -i_4+PB_P); i_5++) {
            for (int i_6 = i_4; i_6 < -i_4+PB_M; i_6++) {
                B[i_5][i_6+1] = G[i_6][i_4] + E[i_6+i_4][i_5][i_6] + E[i_4-2][i_5-1][i_6] + E[i_6+i_5-1][i_4][i_5] + B[i_5+1][i_6+1] - 6;
                B[i_5][i_6+2] = F[i_6][i_5][i_4+1] - F[i_6][i_5+i_4][i_5] * E[i_4][i_5][i_6] + H[i_6][i_5] + G[i_6-1][i_5] - B[i_5-1][i_6+1] - B[i_6][i_4+1] + 3;
            }
        }
    }
#pragma endscop
...
init_array(xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4316252313_05(xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H)));
