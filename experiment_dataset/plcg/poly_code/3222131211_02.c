...
void kernel_3222131211_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        A[i_0] = A[i_0-1] - 3;
        A[i_0] = C[i_0] * C[i_0-1] * C[i_0+1] + C[i_0] + C[i_0+1] * A[i_0] * 2;
    }
#pragma endscop
...
kernel_3222131211_02(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
