...
void kernel_4432231113_05(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
        ...
        for (int i_1 = 1; i_1 < PB_N-1; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_N+1, PB_L); i_2++) {
                for (int i_3 = 1; i_3 < PB_L; i_3++) {
                    B[i_2+i_0-1][i_1][i_2-1][i_0] = E[i_3-1][i_0-1][i_2][i_1] - F[i_1][i_3][i_2][i_0] * G[i_1-1][i_3][0] * 5;
                }
            }
            for (int i_4 = 1; i_4 < min(-i_0+PB_N+1, PB_L); i_4++) {
                for (int i_5 = 1; i_5 < -i_1+PB_P; i_5++) {
                    B[i_4+i_0-1][i_1][i_4-1][i_0] = G[i_5][i_5][i_1-1] * F[i_5-1][i_4][i_1][i_0+1] + H[i_0][i_4][i_5+i_1][0][i_4] * B[i_4+i_0-1][i_1+1][i_4-1][i_0] * 2;
                }
            }
        }
    }
    for (int i_6 = 1; i_6 < PB_L; i_6++) {
        C[i_6] = I[i_6] * I[i_6+1] + I[i_6] * 3;
        for (int i_7 = i_6; i_7 < PB_L; i_7++) {
            for (int i_8 = 0; i_8 < PB_L; i_8++) {
                for (int i_9 = 1; i_9 < PB_P; i_9++) {
                    D[i_6][i_8][i_6][i_9] = F[i_6-1][i_9][i_7][i_8] + G[i_9][i_7][i_8] - E[i_9-1][i_6-1][i_6][i_7] - 5;
                }
            }
        }
    }
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4432231113_05(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I)));
