...
void kernel_3136312221_03(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        for (int i_1 = i_0; i_1 < PB_M; i_1++) {
            A[0][i_1+1] = B[i_1] + A[0][i_1] * A[0][i_1+2] + 3;
        }
    }
#pragma endscop
...
kernel_3136312221_03(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
