...
void kernel_4416352311_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl),int xm,int ym,DATA_TYPE POLYBENCH_2D(M,xM,yM,xm,ym)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        for (int i_1 = i_0; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 1; i_2 < PB_M; i_2++) {
                for (int i_3 = i_0; i_3 < min(-i_2+PB_M+1, PB_M-2); i_3++) {
                    A[i_1-2][i_3][i_2][i_2] = E[i_1][i_3+i_2-1][i_0-2][i_3] - F[i_3+2][i_2][i_0+1][i_1-2] * E[i_3][i_2][i_0-1][i_3] - A[i_0-2][i_2][i_3-1][i_3-1] - A[i_2-1][i_3][i_1][i_1] - 4;
                }
            }
            for (int i_4 = 2; i_4 < PB_M; i_4++) {
                for (int i_5 = 2; i_5 < -i_4+PB_M; i_5++) {
                    B[i_5][i_1+2][i_4-1][i_0] = E[i_5][i_4][i_1][i_0] - G[i_5+i_4][i_4][i_1] * E[i_4][i_0][i_1+1][i_4] + H[i_4][i_4][i_5-2][i_0+1] * B[i_5][i_1+1][i_4-1][i_0] + B[i_5][i_1+2][i_4-2][i_0] * B[i_1][i_5+2][i_4-2][i_0+1] + B[i_5+1][i_1+2][i_4-1][i_0+1] + B[i_5][i_1+1][i_4][i_0] - B[i_5][i_1+2][i_4-2][i_0+1] * 6;
                }
            }
        }
        C[i_0] = I[i_0+2] * I[i_0-1] + I[i_0+2] * J[i_0] - D[i_0] - 3;
        for (int i_6 = 1; i_6 < -i_0+PB_M; i_6++) {
            D[i_6] = K[i_6][i_0] * L[i_0][i_6] + M[i_6+2][i_0] + J[i_6-1] - M[i_6][i_0] * M[i_6+i_0][i_6+2] - 5;
        }
    }
#pragma endscop
...
kernel_4416352311_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M));
