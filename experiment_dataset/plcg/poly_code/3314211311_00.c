...
void kernel_3314211311_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_0 = 0; i_0 < PB_P-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            ...
            for (int i_3 = 0; i_3 < PB_P-2; i_3++) {
                B[i_1][i_3][i_0+1] = B[i_1-1][i_3][i_0+1] + B[i_3][i_0][i_1+2] - B[i_1][i_0+1][i_3+2] + 4;
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 0; i_5 < PB_L-1; i_5++) {
            for (int i_6 = 0; i_6 < min(PB_M, -i_4+PB_L-1); i_6++) {
                C[i_6+i_4][i_5][i_4-1] = D[i_6][i_4+1][i_5] + C[i_6+i_4+1][i_5+1][i_4] - 4;
            }
        }
    }
#pragma endscop
...
kernel_3314211311_00(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
