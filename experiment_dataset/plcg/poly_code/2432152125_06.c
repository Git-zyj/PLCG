...
void kernel_2432152125_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_M-2; i_1++) {
        B[i_1] = E[i_1] - E[i_1-1] + E[i_1] * E[i_1] * E[i_1+2] + E[i_1+2] * E[i_1] + C[i_1+2] * 4;
    }
    for (int i_2 = 0; i_2 < PB_M-2; i_2++) {
        C[i_2+2] = E[i_2] + E[i_2] - E[i_2] + E[i_2] - E[i_2] - C[i_2] - 2;
    }
    for (int i_3 = 2; i_3 < PB_M; i_3++) {
        B[i_3-1] = E[i_3-2] - E[i_3] - E[i_3] + E[i_3] - E[i_3] * 4;
    }
#pragma endscop
...
kernel_2432152125_06(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E));
