...
void kernel_4436331325_01(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl)){
...
#pragma scop
        ...
        for (int i_1 = i_0; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_M; i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_Q-1; i_3++) {
                    B[i_1][i_3+i_0+1][i_2+2][i_3+1] = E[i_2+i_0][i_1][i_1][i_3] - F[i_3-1][i_2][i_0-1][i_1-1] - G[i_1][i_2-1][i_0][i_2] - 5;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L; i_4++) {
        for (int i_5 = 3; i_5 < PB_L; i_5++) {
            for (int i_6 = i_5; i_6 < min(-i_5+PB_P, -i_4+PB_Q+1); i_6++) {
                for (int i_7 = i_4; i_7 < min(min(-i_5+PB_L, -i_4+PB_P), -i_6+PB_Q); i_7++) {
                    B[i_5][i_7+i_6-1][i_4][i_6+1] = E[i_7+i_5][i_6][i_4][0] * H[i_4][i_6-1][i_7-1] + I[i_5][i_7+i_5][i_7+i_4] * E[i_7][i_4][i_6+i_5][0] - B[i_7][i_6+i_4-1][i_5-2][i_6+1] + B[i_6][i_7+i_5-3][i_4][i_5+1] + B[i_5+1][i_7+i_6][i_4][i_6+2] + B[i_5][i_7+i_6-2][i_4][i_6+1] - 6;
                }
            }
        }
    }
    for (int i_8 = 2; i_8 < PB_L-2; i_8++) {
        C[i_8] = J[i_8] - J[i_8+1] - K[i_8] * L[i_8+1] - C[i_8-2] * C[i_8-1] * 1;
        for (int i_9 = 0; i_9 < min(i_8, -i_8+PB_M); i_9++) {
            D[i_8][i_8][i_9] = J[i_9+i_8] - C[i_8-2] + D[i_8+2][i_8+2][i_9] * D[i_8+2][i_8+2][i_9+1] - 3;
        }
    }
#pragma endscop
