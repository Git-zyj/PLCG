...
void kernel_3234312323_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_M; i_1++) {
        for (int i_2 = 3; i_2 < min(i_1, PB_M-1); i_2++) {
            B[i_2-1] = C[i_1][i_2] * B[i_2-3] - B[i_2+1] + B[i_2] * 4;
        }
    }
#pragma endscop
...
kernel_3234312323_09(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
