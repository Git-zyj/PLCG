        ...
        for (int i_1 = max(2, i_0); i_1 < min(PB_Q-1, -i_0+PB_P); i_1++) {
            for (int i_2 = i_1; i_2 < min(-i_1+PB_L, PB_M-2); i_2++) {
                for (int i_3 = 2; i_3 < -i_2+PB_M+1; i_3++) {
                    A[i_3][i_3][i_1][i_2+2] = C[i_2][i_3-2][i_1+i_0][i_0] - D[i_2+2][i_1-2][i_3][i_0] + C[i_2+i_1][i_0+1][i_1][i_2] - E[i_3-2][i_1][i_1+i_0][i_2+2] - F[i_3+i_2-1][i_0][i_3] + A[i_3+1][i_3+1][i_1][i_2+3] - A[i_3][i_3][i_1+1][i_2+2] - A[i_3][i_3][i_1][i_2+3] + 3;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-1; i_4++) {
        B[i_4] = G[0] - H[i_4-2] + I[i_4] + I[i_4+1] - G[i_4] - 1;
    }
#pragma endscop
...
kernel_4216352221_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
