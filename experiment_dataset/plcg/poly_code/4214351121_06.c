...
void kernel_4214351121_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < -i_0+PB_L; i_1++) {
            for (int i_2 = i_0; i_2 < PB_N-1; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_L; i_3++) {
                    A[i_1+i_0][i_2][i_1][i_3] = C[i_2][i_1][i_2][i_0] - C[i_0][i_3][1][i_2+1] - D[i_1+1][i_3+i_0][i_2][i_0+1] - D[i_2+1][i_3+i_0][i_1][0] - C[i_2+1][i_1][i_3][i_0-1] * 4;
                }
            }
        }
    }
    for (int i_4 = 4; i_4 < PB_M-1; i_4++) {
        for (int i_5 = 1; i_5 < -i_4+PB_M-1; i_5++) {
            B[i_5+i_4] = E[i_4] - F[i_5][i_4] + G[i_5+i_4+1][i_5+i_4] * H[i_5-1] * B[i_5+i_4-4] + 3;
        }
    }
#pragma endscop
...
kernel_4214351121_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
