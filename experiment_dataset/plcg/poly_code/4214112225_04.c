...
void kernel_4214112225_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-4; i_0++) {
        A[i_0+2] = C[0] * 2;
        A[i_0+4] = A[i_0+2] * A[i_0] * 1;
    }
#pragma endscop
...
kernel_4214112225_04(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
