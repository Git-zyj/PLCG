...
void kernel_2322112225_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_2 = 1; i_2 < PB_N-2; i_2++) {
        C[i_2] = D[i_2+2] * C[i_2] * C[i_2+2] - 6;
        C[i_2] = D[i_2] * D[i_2-1] * 4;
    }
#pragma endscop
...
kernel_2322112225_01(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
