...
void kernel_4312211325_03(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
        C[i_1] = D[i_1+1] * C[i_1+2] - C[i_1] * C[i_1-2] + 5;
        C[i_1] = E[i_1+1] + 3;
    }
#pragma endscop
...
kernel_4312211325_03(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
