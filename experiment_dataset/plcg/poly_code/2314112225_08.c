...
void kernel_2314112225_08(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        B[i_0-2] = D[i_0-1] * B[i_0] + B[i_0+2] * 3;
        B[i_0] = D[i_0] - D[i_0] - 5;
        B[i_0] = 1;
    }
#pragma endscop
...
kernel_2314112225_08(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
