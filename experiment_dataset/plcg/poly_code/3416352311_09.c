...
void kernel_3416352311_09(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_N-1; i_1++) {
            A[i_1][i_0] = E[i_0] - F[i_1][i_0] - G[i_0][i_1] + E[i_1] - H[i_1+1][i_0] + A[i_1][i_0+1] + A[i_1+1][i_0] * A[i_1-1][i_0-1] - A[i_1+1][i_0-1] + A[i_1-1][i_0] - 3;
        }
        for (int i_2 = 1; i_2 < i_0; i_2++) {
            for (int i_3 = 0; i_3 < -i_0+PB_L-1; i_3++) {
                B[i_0][i_3+1][i_2] = I[i_2-1][i_3+i_0+1][i_0] - I[i_2][i_0+2][i_2+2] - B[i_0+1][i_3+1][i_2] + B[i_0][i_3+2][i_2] + 6;
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-1; i_4++) {
        for (int i_5 = i_4; i_5 < -i_4+PB_M; i_5++) {
            C[i_4][i_5] = J[i_4] - H[i_4][i_5+1] * K[i_5+i_4] * F[i_5][0] + G[i_5][i_5+i_4] - C[i_4][i_5+1] + C[i_4+1][i_5+1] * 5;
        }
        D[i_4] = E[i_4] - J[i_4-2] - H[i_4][i_4+2] * K[i_4] * K[i_4-1] + D[i_4-1] - 3;
    }
#pragma endscop
...
kernel_3416352311_09(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K));
