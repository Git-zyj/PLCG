...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_P-1; i_1++) {
            for (int i_2 = 1; i_2 < i_1; i_2++) {
                for (int i_3 = i_1; i_3 < PB_M-1; i_3++) {
                    A[i_2-1][i_0][1][i_3] = D[i_2][i_0-1][i_2+i_1][i_0] - D[i_2][i_1+1][i_3][i_1] * D[i_2-1][i_3+1][i_1+i_0][i_0] - E[i_2][i_3][i_2] * F[i_0+1][i_3][i_1][i_2] + F[i_1][i_2-1][i_3][i_0+1] + 1;
                }
            }
            for (int i_4 = i_0; i_4 < PB_P-1; i_4++) {
                for (int i_5 = i_0; i_5 < PB_M; i_5++) {
                    A[i_4][i_0-2][1][i_5-2] = D[i_5][i_0][i_1-1][i_1+i_0+1] - D[i_4][i_5][i_1][i_0] * E[i_5][i_4+1][i_0] - D[i_1-1][i_0-1][i_5][i_4+1] * 3;
                }
            }
        }
    }
    for (int i_6 = 1; i_6 < PB_M; i_6++) {
        for (int i_7 = 1; i_7 < PB_M; i_7++) {
            C[i_6][i_7] = G[i_6][i_7-1] + H[i_6][i_7-1] - I[i_7] * I[i_6-1] - J[i_7] + C[i_6][i_7-1] - 2;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4324251125_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J)));
