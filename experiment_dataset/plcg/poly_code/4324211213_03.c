...
void kernel_4324211213_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
...
#pragma scop
    ...
    for (int i_6 = 1; i_6 < PB_M-1; i_6++) {
        for (int i_7 = 0; i_7 < min(min(i_6, -i_6+PB_P+1), PB_N-1); i_7++) {
            for (int i_8 = 0; i_8 < PB_P-1; i_8++) {
                C[i_7][i_6][i_8+1] = D[i_6][i_8+1][i_7+i_6-1] + C[i_7][i_6][i_8] - C[i_7][i_6+1][i_8] * C[i_7+1][i_6][i_8+1] * 6;
            }
        }
    }
#pragma endscop
...
kernel_4324211213_03(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
