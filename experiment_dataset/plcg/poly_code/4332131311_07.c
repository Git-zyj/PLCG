...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < min(-i_0+PB_P, PB_M-1); i_1++) {
            for (int i_2 = 1; i_2 < PB_M; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_1+PB_L, -i_0+PB_L-1); i_3++) {
                    A[i_2-1][i_1][i_3+i_0][i_3] = D[i_3][i_0][i_1+i_0][i_2] * D[i_3+i_0][i_2][i_3][i_1] * D[i_2][i_1+1][i_0+1][i_3-1] - D[i_3+i_0][i_3+i_1][i_2][i_2] - D[i_1][i_3][i_0][0] + A[i_2-1][i_1+1][i_3+i_0+1][i_3] + 3;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_P; i_4++) {
        for (int i_5 = 0; i_5 < PB_M; i_5++) {
            for (int i_6 = 1; i_6 < min(PB_M, -i_4+PB_L+2); i_6++) {
                for (int i_7 = 1; i_7 < min(i_4, PB_L-1); i_7++) {
                    A[i_7-1][i_5][i_6+i_4-2][i_6-1] = D[i_6][i_7+1][i_4][i_6] + 1;
                }
            }
        }
    }
    for (int i_8 = 1; i_8 < PB_L-1; i_8++) {
        for (int i_9 = 1; i_9 < -i_8+PB_L; i_9++) {
            for (int j_0 = 0; j_0 < PB_M-1; j_0++) {
                for (int j_1 = 1; j_1 < min(PB_Q-1, -j_0+PB_Q); j_1++) {
                    C[i_9][j_0][i_8] = E[i_9][0][j_1+j_0][i_8][j_1+1] * F[j_1][i_8+1][i_9+i_8] + C[i_9-1][j_0][j_1-1] + C[j_0][j_1-1][i_9-1] - C[j_0][j_1][i_8+1] * C[j_0+1][j_1][i_9] + C[i_9][j_0+1][i_8-1] - 6;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), INIT_SEED);
kernel_4332131311_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F)));
