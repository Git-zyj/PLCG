...
void kernel_4226311225_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_Q-4; i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_Q; i_3++) {
                    B[i_2+1][i_1][i_3+i_0] = B[i_3-1][i_1][i_2+i_0+4] * B[i_3+1][i_1-1][i_2+i_0-2] * 2;
                }
            }
        }
    }
...
kernel_4226311225_09(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
