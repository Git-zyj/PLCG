...
void kernel_4416351115_09(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_L-1 - 1; i_0 >= 2; i_0--) {
        A[i_0][i_0-1] = E[i_0] - F[i_0+1] * F[i_0+1] + E[i_0+1] * A[i_0+1][i_0] - 4;
        for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
            B[i_0+1][i_1] = G[i_1+1][i_0+1] * H[i_1-1][i_0] + H[i_1][i_0+1] + I[i_1][i_0] + A[i_0-1][i_0-2] * 4;
        }
        A[i_0][i_0-1] = J[i_0] * E[i_0] * F[i_0-1] + J[i_0] * 5;
        for (int i_2 = 1; i_2 < PB_L; i_2++) {
            A[i_0+1][i_0] = G[i_2-1][i_0] + H[i_2+1][i_0-1] * H[i_2][i_0] - I[i_2][i_0] + G[i_2-1][i_0] * F[i_2] + 5;
        }
    }
#pragma endscop
...
kernel_4416351115_09(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
