...
void kernel_4436351321_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl)){
        ...
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_Q; i_2++) {
                for (int i_3 = 1; i_3 < PB_P-1; i_3++) {
                    A[i_2][i_1-1][i_3][i_0] = E[i_1][i_0][i_1][i_2-1] - F[i_2][i_1][i_3+1][i_2+i_0] + G[i_2][i_3][i_3+1][i_0-1] * F[i_2][i_0][i_1][i_3] * H[i_3][i_0+1][i_1+1] * F[i_2][i_2][i_3-1][i_1] + 4;
                }
            }
        }
        B[i_0+1] = I[i_0+1] - J[i_0-1] * K[i_0][i_0] + L[i_0+1][i_0] - J[i_0] + B[i_0-1] + 5;
    }
    for (int i_4 = 2; i_4 < PB_M-2; i_4++) {
        for (int i_5 = i_4; i_5 < -i_4+PB_M+1; i_5++) {
            C[i_4][i_5] = K[i_4][i_5] + L[i_4-1][i_5] - K[0][i_5] - K[i_5+i_4][1] - L[i_5+i_4-1][i_4+1] + L[i_4][i_5] + B[i_5+1] * C[i_4+2][i_5] + C[i_4][i_5-1] + C[i_4+1][i_5+2] - 3;
        }
        for (int i_6 = i_4; i_6 < PB_M-1; i_6++) {
            for (int i_7 = 0; i_7 < i_4; i_7++) {
                D[i_6+1][i_7][i_4] = H[i_6][i_4-1][i_7] * D[i_7+1][i_4][i_6-2] + D[i_6+1][i_7][i_4-2] + D[i_6-1][i_7][i_4-1] + D[i_4+1][i_6+1][i_7] + 6;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4436351321_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L));
