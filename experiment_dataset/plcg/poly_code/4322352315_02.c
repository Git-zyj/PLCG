...
void kernel_4322352315_02(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
        ...
        for (int i_1 = i_0; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_Q, -i_1+PB_P-2); i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_M; i_3++) {
                    B[i_1-2][i_2][i_3+2] = D[i_3+i_0][i_2-1][i_1+2][0] - E[i_1+2][i_3][i_2][i_0-1] - D[i_2][i_0][i_1][i_3+2] - F[i_2][i_3][i_0-2][i_1-2] + E[i_2][i_1][i_0-2][i_2+i_0] - F[i_1][i_3][i_2+i_0][0] + E[i_1-1][i_2+1][i_2+i_1+2][i_0] - D[i_0][i_2][i_3+2][i_1] * 2;
                }
            }
        }
    }
    for (int i_4 = 3; i_4 < PB_M; i_4++) {
        for (int i_5 = 1; i_5 < min(i_4, -i_4+PB_M); i_5++) {
            for (int i_6 = 1; i_6 < PB_P-3; i_6++) {
                B[i_4-2][i_5][i_6+2] = G[i_6-1][i_6+i_5] * H[i_5+i_4][i_6+2][i_6] * D[i_4][i_6+i_5-1][i_5-1][i_4] - B[i_4-1][i_5-1][i_6+3] - B[i_4-3][i_5][i_6+2] + B[i_4-1][i_5][i_6+3] - 5;
            }
        }
    }
    for (int i_7 = 3; i_7 < PB_Q; i_7++) {
        for (int i_8 = 2; i_8 < -i_7+PB_P+1; i_8++) {
            for (int i_9 = 2; i_9 < -i_8+PB_P; i_9++) {
                B[i_7-3][i_8][i_9+1] = H[i_7][i_9+i_8][i_8] + D[i_7][i_8-2][i_9-2][i_8+i_7-1] * H[i_8][i_9][i_7] + I[i_9][i_8][i_7] * 3;
            }
        }
    }
#pragma endscop
...
init_array(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4322352315_02(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
