...
void kernel_4332351311_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,int ym,DATA_TYPE POLYBENCH_2D(M,xM,yM,xm,ym)){
        ...
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_Q; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_0+PB_Q, -i_1+PB_M); i_3++) {
                    A[i_0][i_1][i_1-1][i_3+i_2] = D[i_3][i_0][i_1-1][i_2] + E[i_3][i_1][i_2] - F[i_3][i_2][i_1+1] * D[i_3+i_1][i_0][i_2-1][i_0] - G[i_2][i_0][i_1][i_3+i_0] * H[i_1][i_2][i_3+i_0][i_1] + A[i_0][i_1][i_1-1][i_3+i_2-1] - A[i_1-1][i_3][i_3-1][i_2+i_0-1] + A[i_3-1][i_1][i_1-1][i_2+i_0] * A[i_0-1][i_1][i_1-1][i_3+i_2] + 2;
                }
            }
        }
        for (int i_4 = 1; i_4 < min(PB_L, -i_0+PB_P); i_4++) {
            for (int i_5 = 2; i_5 < PB_L; i_5++) {
                B[i_4][i_4-1][i_5-1] = E[i_4][i_0][i_5] - E[i_5][i_0][i_4] - I[i_5+1][i_0][i_4+i_0] * J[i_5][i_0] * B[i_4][i_4-1][i_5-2] - B[i_4][i_4-1][i_5] + 4;
            }
        }
    }
    for (int i_6 = 1; i_6 < PB_M-2; i_6++) {
        for (int i_7 = 0; i_7 < PB_L-1; i_7++) {
            C[i_6+1][i_7+1] = K[i_6-1] - J[i_6][i_7] + L[i_6] + M[i_6][i_7] * M[i_7+1][i_7] - C[i_6+2][i_7+1] + C[i_6][i_7+1] - 2;
        }
    }
#pragma endscop
