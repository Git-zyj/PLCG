...
void kernel_2422131213_02(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_M-2 - 1; i_0 >= 1; i_0--) {
        B[i_0+1] = E[i_0-1] * E[i_0] - C[i_0-1] * 4;
        B[i_0+1] = E[0] + E[i_0] + B[i_0+2] - 5;
    }
    for (int i_1 = 0; i_1 < PB_M-1; i_1++) {
        C[i_1] = E[i_1] * B[i_1+1] * 4;
        C[i_1] = E[i_1+1] + E[i_1] * E[i_1] + E[i_1] * C[i_1+1] + 1;
    }
#pragma endscop
...
kernel_2422131213_02(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E));
