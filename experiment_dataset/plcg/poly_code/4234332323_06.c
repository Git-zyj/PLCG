...
#pragma scop
        ...
        for (int i_1 = 2; i_1 < PB_P-3; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_1+PB_L, -i_0+PB_L+1); i_2++) {
                for (int i_3 = 2; i_3 < -i_0+PB_L; i_3++) {
                    B[i_2+i_0-1][i_3][i_1+3][i_0-1] = C[i_0][i_1][i_3-1][i_1-2] - D[i_2+1][i_3+i_0][i_1+2][i_1-2] * C[i_1][i_0][i_3][i_2] * B[i_2+i_1][i_3][i_0+4][i_1] * B[i_2+i_0-1][i_3-2][i_1+2][i_0-1] * 2;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L; i_4++) {
        for (int i_5 = 1; i_5 < PB_L-1; i_5++) {
            for (int i_6 = 2; i_6 < min(-i_5+PB_M-2, -i_4+PB_L); i_6++) {
                for (int i_7 = 1; i_7 < PB_L-1; i_7++) {
                    B[i_6+i_4][i_7][i_5+2][i_4] = E[i_4][i_7+i_6][i_5+1][i_5-1] * D[i_6+i_5+2][i_7+1][i_7+i_6-2][i_4-2] - B[i_6+i_4-2][i_7-1][i_5][i_4-2] - 5;
                }
            }
        }
    }
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), INIT_SEED);
kernel_4234332323_06(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E)));
