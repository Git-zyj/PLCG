...
void kernel_2126111121_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N-3; i_0++) {
        A[i_0+1] = B[i_0+1][1] * A[i_0+3] + 2;
    }
#pragma endscop
...
kernel_2126111121_02(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B));
