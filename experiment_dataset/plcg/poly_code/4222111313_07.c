...
void kernel_4222111313_07(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
...
#pragma scop
    ...
    for (int i_3 = 1; i_3 < PB_M; i_3++) {
        for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
            B[i_3][i_4] = C[i_3][i_4-1][0] * B[i_3][i_4+1] + B[i_4][i_3-1] - B[i_3-1][i_4] + 4;
        }
    }
#pragma endscop
...
kernel_4222111313_07(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
