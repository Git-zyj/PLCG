...
void kernel_4236311123_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 2; i_2 < PB_M; i_2++) {
                for (int i_3 = 0; i_3 < PB_M; i_3++) {
                    A[i_3][i_2][i_1] = A[i_2-2][i_3][i_1] - 2;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_N; i_4++) {
        for (int i_5 = 1; i_5 < PB_L-1; i_5++) {
            for (int i_6 = 0; i_6 < min(-i_5+PB_L+1, i_5); i_6++) {
                for (int i_7 = 0; i_7 < min(i_5, PB_M-1); i_7++) {
                    A[i_6][i_7+1][i_5+1] = C[i_7][i_5][i_6+i_5-1] - 2;
                }
            }
        }
    }
...
kernel_4236311123_03(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C));
