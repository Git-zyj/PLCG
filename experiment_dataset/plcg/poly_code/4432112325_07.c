...
void kernel_4432112325_07(int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 2; i_1 < -i_0+PB_L; i_1++) {
            D[i_0][i_1-2][i_1+i_0] = 3;
        }
    }
    ...
    for (int i_6 = 3; i_6 < PB_M; i_6++) {
        for (int i_7 = 2; i_7 < PB_M-1; i_7++) {
            for (int i_8 = 1; i_8 < -i_7+PB_P+2; i_8++) {
                C[i_7][i_8] = E[i_6][i_8+i_7-2][i_7] - C[i_7+1][i_8] + C[i_8-1][i_7] - 3;
            }
        }
        for (int i_9 = i_6; i_9 < -i_6+PB_L-1; i_9++) {
            for (int j_0 = 0; j_0 < -i_9+PB_L-2; j_0++) {
                D[i_9][i_6-2][i_9+i_6] = D[i_9+1][i_6-2][i_9+i_6+1] - D[j_0+1][i_9-1][j_0+i_9+2] - D[i_9+1][i_6-3][i_9+i_6] * 1;
            }
        }
    }
#pragma endscop
...
kernel_4432112325_07(xd,yd,zd,POLYBENCH_ARRAY(D), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,POLYBENCH_ARRAY(E));
