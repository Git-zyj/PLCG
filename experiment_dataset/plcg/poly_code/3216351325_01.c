    ...
    for (int i_3 = 1; i_3 < PB_N-2; i_3++) {
        for (int i_4 = 2; i_4 < i_3; i_4++) {
            for (int i_5 = 1; i_5 < i_3; i_5++) {
                B[i_3][i_5][i_4-1] = C[i_5-1][i_3][i_4] + G[i_5+1][i_3] + E[i_3][i_5][i_4-1] + E[i_3+1][i_5][i_4] - B[i_3][i_5][i_4-2] + B[i_3+2][i_5][i_4] - B[i_3][i_5][i_4] + B[i_4+2][i_5+1][i_3-1] - 4;
            }
        }
    }
#pragma endscop
...
kernel_3216351325_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
