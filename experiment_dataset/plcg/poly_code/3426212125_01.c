    ...
    for (int i_3 = 0; i_3 < PB_P; i_3++) {
        for (int i_4 = 2; i_4 < i_3; i_4++) {
            for (int i_5 = max(1, i_3); i_5 < PB_L+1; i_5++) {
                B[i_4][i_4-2] = B[i_4+2][i_4] * B[i_5+1][i_5-1] * 6;
            }
        }
    ...
    for (int i_7 = 2; i_7 < PB_L+2; i_7++) {
        for (int i_8 = 0; i_8 < min(-i_7+PB_L+2, i_7); i_8++) {
            for (int i_9 = 2; i_9 < PB_L+2; i_9++) {
                B[i_9][i_9-2] = F[i_9][i_7][i_8+i_7-2] * G[i_9][1] - F[i_9][i_7][i_8] + 6;
            }
        }
    }
#pragma endscop
...
kernel_3426212125_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
