...
void kernel_4336152321_09(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        for (int i_1 = i_0; i_1 < min(-i_0+PB_M+1, PB_M-2); i_1++) {
            for (int i_2 = 0; i_2 < PB_M; i_2++) {
                A[i_1-2][i_2][i_0] = D[i_0][i_2][i_1+i_0-2] * E[i_1+2][i_2][i_2][0] * D[i_1+1][i_0][i_2+1] - D[i_2][i_1+i_0-1][i_0] * D[i_2][i_0][i_1+2] - F[i_2][i_1+i_0] + 5;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_M+1; i_3++) {
        for (int i_4 = 2; i_4 < PB_M; i_4++) {
            for (int i_5 = 0; i_5 < PB_M; i_5++) {
                B[i_4+2][i_5][i_3] = E[i_5][i_4][i_3+1][0] - D[i_4-2][i_3-1][i_3] + B[i_4+2][i_3-1][i_5+1] - B[i_5+4][i_4+1][i_3] * B[i_4][i_5+2][i_3] + 4;
            }
        }
    }
    for (int i_6 = 1; i_6 < PB_M-3; i_6++) {
        for (int i_7 = 2; i_7 < PB_M-1; i_7++) {
            for (int i_8 = i_7; i_8 < PB_M-1; i_8++) {
                C[i_8+1][i_7+2][i_6] = F[i_8][0] * D[i_7+1][i_8][i_6-1] - D[i_8][i_7-2][i_6+1] - D[i_8][i_7][i_6] * D[i_8][i_6][i_7-2] + F[i_7+1][i_8-2] + B[i_6+2][i_7][i_8] - C[i_7][i_8+2][i_6] * C[i_8+1][i_7+2][i_6+2] * C[i_6+3][i_7+2][i_8+2] - 6;
            }
        }
    }
#pragma endscop
...
kernel_4336152321_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
