...
void kernel_4412311113_09(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf)){
        ...
        for (int i_1 = i_0; i_1 < PB_Q; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_Q-1; i_2++) {
                for (int i_3 = 0; i_3 < PB_N; i_3++) {
                    A[i_3][i_2][i_1+1] = E[i_2][i_3][i_1][i_2+i_0+1] + 3;
                }
            }
        }
        for (int i_4 = 0; i_4 < i_0; i_4++) {
            for (int i_5 = 0; i_5 < PB_Q; i_5++) {
                for (int i_6 = 1; i_6 < PB_M+1; i_6++) {
                    B[i_6-1][i_4][i_5][i_0] = 3;
                }
            }
            C[i_4][i_0] = F[i_0][i_4+1] - 2;
            for (int i_7 = 1; i_7 < i_4; i_7++) {
                D[i_7][i_4][i_0-1] = D[i_7-1][i_4][i_0-1] - 6;
            }
        }
    }
#pragma endscop
...
kernel_4412311113_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
