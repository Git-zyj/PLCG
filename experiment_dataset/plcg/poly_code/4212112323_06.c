...
void kernel_4212112323_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < PB_Q-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_P+1; i_3++) {
                    A[i_2][i_3+i_0-1][i_1+1] = A[i_2+1][i_3+i_0-1][i_1+1] + 6;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_P-2; i_4++) {
        for (int i_5 = i_4; i_5 < min(-i_4+PB_M, PB_L-2); i_5++) {
            for (int i_6 = 2; i_6 < min(-i_4+PB_N+2, PB_M-2); i_6++) {
                for (int i_7 = 0; i_7 < min(-i_4+PB_N-1, -i_6+PB_N); i_7++) {
                    B[i_7+i_6][i_4+2][i_5][i_7+2] = C[i_5][i_7][i_5+2][i_6] - C[i_7+1][i_5+i_4][i_4+1][i_6] - B[i_7+i_6-2][i_4+2][i_5][i_7] - B[i_7+i_4+1][i_6+2][i_5-1][i_7+3] * B[i_7+i_6][i_4+2][i_5-1][i_7+2] + B[i_6+i_4-2][i_7+2][i_5-1][i_4+2] * 3;
                }
            }
        }
    }
...
kernel_4212112323_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
