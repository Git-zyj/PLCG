...
void kernel_4132111121_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb)){
        ...
        for (int i_1 = max(2, i_0); i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < PB_M; i_2++) {
                for (int i_3 = max(2, i_0); i_3 < PB_Q-1; i_3++) {
                    A[i_1][i_2][i_1] = B[i_0][i_1][i_3+1] + A[i_1-2][i_3-2][i_1-2] * 4;
                }
            }
        }
    }
...
kernel_4132111121_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B));
