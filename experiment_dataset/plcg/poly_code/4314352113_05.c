        ...
        for (int i_1 = 2; i_1 < -i_0+PB_M-2; i_1++) {
            for (int i_2 = i_1; i_2 < PB_L-2; i_2++) {
                for (int i_3 = 0; i_3 < min(i_0, -i_2+PB_M-1); i_3++) {
                    A[i_0][i_3][i_1-1][i_2] = D[i_3+2][i_2][i_2][i_1+i_0+2] + D[i_2][i_0][i_3][i_1] * D[i_3+i_2+1][i_2+1][i_0-2][i_1] * D[i_3+1][i_2+2][i_0][i_1-2] * 3;
                }
            }
            B[i_1] = E[0] - F[i_1+i_0][0] + G[i_0+1][i_1-1] - H[0] - G[i_0][i_1] - I[i_1+i_0][i_1+i_0+2] * B[i_1+1] - 5;
        }
    }
    for (int i_4 = 1; i_4 < PB_L; i_4++) {
        for (int i_5 = 0; i_5 < PB_L; i_5++) {
            C[i_4][i_5] = E[i_5] - I[i_5][i_4-1] * G[i_4-1][i_5] * I[i_5][i_4] * F[i_5][i_4] * 6;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4314352113_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I)));
