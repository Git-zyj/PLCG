...
void kernel_2236312323_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-4; i_0++) {
        A[i_0+2] = A[i_0+4] * A[i_0] * A[i_0+1] - 5;
    }
    for (int i_1 = 0; i_1 < PB_L-4; i_1++) {
        A[i_1+4] = C[i_1] - C[i_1+2] + 1;
    }
#pragma endscop
...
kernel_2236312323_07(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
