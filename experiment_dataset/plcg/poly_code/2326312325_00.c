...
void kernel_2326312325_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_2 = 0; i_2 < PB_M-3; i_2++) {
        B[i_2+1] = B[i_2+2] * B[i_2+3] + B[i_2] + 3;
    }
...
kernel_2326312325_00(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
