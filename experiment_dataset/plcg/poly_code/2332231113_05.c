...
void kernel_2332231113_05(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-2; i_0++) {
        C[i_0+2] = D[i_0+1] - D[i_0-1] * 1;
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            C[i_1+1] = D[i_1] - D[i_1+1] * D[i_1] * C[i_0] + 3;
        }
        C[i_0+1] = E[i_0] + D[i_0] - 2;
    }
#pragma endscop
...
kernel_2332231113_05(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
