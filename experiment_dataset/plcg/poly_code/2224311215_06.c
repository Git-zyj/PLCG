...
void kernel_2224311215_06(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
        A[i_2][i_2] = A[i_2][i_2] + A[i_2+1][i_2+1] - 2;
    }
#pragma endscop
...
kernel_2224311215_06(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
