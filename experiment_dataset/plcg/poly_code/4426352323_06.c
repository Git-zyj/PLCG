        ...
        for (int i_1 = i_0; i_1 < PB_N; i_1++) {
            for (int i_2 = 2; i_2 < i_0; i_2++) {
                for (int i_3 = 2; i_3 < PB_Q-2; i_3++) {
                    A[i_0-2][i_1][i_1][i_3] = E[i_0][i_3][i_1+2][i_2] + E[i_0+1][i_3-1][i_1+2][i_1] * F[i_1][i_2+2][i_3] * A[i_0-2][i_1][i_1][i_3+2] + A[i_0][i_1][i_1][i_3] + A[i_0-2][i_1-1][i_1-1][i_3] + A[i_0-2][i_2+1][i_2+1][i_1] * A[i_2-2][i_0][i_0][i_3-2] + 6;
                }
            }
            for (int i_4 = 1; i_4 < PB_P+1; i_4++) {
                for (int i_5 = 2; i_5 < PB_L; i_5++) {
                    A[i_0-2][i_1-2][i_1-2][i_5-2] = G[i_0][i_5-1][i_1+1][i_4] - H[i_0+1][i_5][i_1][i_1-2] - H[i_5][i_0][i_4-1][i_5] * 6;
                }
            }
        }
        C[i_0+2] = I[i_0] * J[i_0] - J[i_0+2] - C[i_0+3] + C[i_0] * C[i_0+1] * 5;
    }
    for (int i_6 = 2; i_6 < PB_M-2; i_6++) {
        D[i_6] = J[i_6] + K[i_6+2] - J[i_6-1] + K[i_6] * K[i_6] * L[i_6][i_6] * I[i_6] - I[i_6-1] - I[i_6] + K[i_6] * D[i_6-2] + 6;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4426352323_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L)));
