...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_N; i_1++) {
        ...
        D[i_1] = E[i_1-1] - E[i_1] * E[i_1-1] + H[i_1] * 6;
    }
#pragma endscop
...
kernel_2426331113_08(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
