...
void kernel_4212112223_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
        ...
        for (int i_1 = 0; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 0; i_2 < i_1; i_2++) {
                for (int i_3 = 2; i_3 < PB_P; i_3++) {
                    A[i_1][i_2][i_1] = A[i_1+1][i_3][i_1+1] + A[i_2][i_3-2][i_2] - 3;
                }
            }
        }
        for (int i_4 = 2; i_4 < PB_L-1; i_4++) {
            B[i_0+2][i_4] = C[i_4][i_0] - B[i_0+2][i_4+1] * B[i_0][i_4-2] * 6;
        }
    }
#pragma endscop
...
kernel_4212112223_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
