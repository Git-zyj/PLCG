        ...
        for (int i_1 = 1; i_1 < min(-i_0+PB_Q, PB_M-3); i_1++) {
            for (int i_2 = i_0; i_2 < PB_M; i_2++) {
                for (int i_3 = 1; i_3 < -i_2+PB_M; i_3++) {
                    A[i_0][i_1+1][i_1-1][i_3] = D[i_3+i_2][i_0][i_1+i_0][i_2] - A[i_0][i_1+1][i_1-1][i_3-1] + A[i_0][i_1+3][i_1+1][i_3-1] * 6;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L; i_4++) {
        B[i_4] = E[i_4] + E[i_4-1] - F[i_4] - F[i_4] * F[i_4] + 6;
        for (int i_5 = 1; i_5 < PB_M-2; i_5++) {
            B[i_5] = G[i_4-1][i_4] * H[i_4][i_5+1] + B[i_5+2] - B[i_5-1] + B[i_4-1] - B[i_4] - 4;
        }
    }
#pragma endscop
...
kernel_4334331325_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
