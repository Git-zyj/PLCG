...
void kernel_4416251113_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_N; i_2++) {
                for (int i_3 = 2; i_3 < -i_0+PB_M; i_3++) {
                    A[i_2+i_0][i_3+i_1+1][i_2-1][i_1] = E[i_1+1][i_2-1][i_3+i_0][i_1] - E[i_2+1][i_1-1][i_3][i_0-1] * F[i_3][i_0-1][i_1][i_0] * E[i_1][i_3+i_0][i_2][i_0-1] * E[i_3+i_0][i_3+i_2+1][i_1][0] - A[i_3+i_0-1][i_2+i_1][i_3-2][i_1-1] * 4;
                }
            }
            C[i_1] = G[i_1+1][i_0] + G[i_1][i_0-1] - H[i_0][i_1] * H[i_1+i_0][i_1] * 5;
        }
        for (int i_4 = i_0; i_4 < PB_M-1; i_4++) {
            C[i_4-1] = H[i_4][i_0+1] - H[i_4+1][i_0-1] - H[i_4-1][i_0-1] + H[i_0+1][i_4] + H[i_4][i_0-1] + C[i_0-2] * 3;
        }
        C[i_0-1] = G[i_0][1] + I[i_0] - I[i_0] * I[i_0+1] * I[i_0] + J[i_0] * 2;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4416251113_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J)));
