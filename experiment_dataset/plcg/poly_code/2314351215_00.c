...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
        for (int i_2 = 1; i_2 < min(PB_N, -i_1+PB_L-1); i_2++) {
            B[i_1][i_2] = D[i_2-1] - F[i_2][i_1] + G[i_2-1][i_1] * F[i_1-1][i_2+1] * D[i_2] * B[i_1-1][i_2-1] + 1;
            A[i_2] = F[i_2][i_1] * H[i_2+i_1+1][i_2][i_2] * F[i_1][i_2] * G[i_1-1][i_2] * G[i_2][i_1] - G[i_2-1][i_1] * F[i_2][i_1] + F[i_1-1][i_2] + B[i_1+1][i_2] - 2;
        }
    }
#pragma endscop
...
kernel_2314351215_00(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
