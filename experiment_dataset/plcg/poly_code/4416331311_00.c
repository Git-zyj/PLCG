...
void kernel_4416331311_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_P; i_1++) {
            for (int i_2 = 1; i_2 < min(PB_P-2, -i_0+PB_P); i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_N; i_3++) {
                    A[i_1][i_2+1][i_3] = E[i_2][i_3+i_1][i_0][1] * F[i_0][i_3+1][i_2+1][i_3][i_1-1] * A[i_1][i_2+2][i_3] * 3;
                    B[i_1+i_0][i_1][i_2][i_3] = E[i_1][i_1][i_0][i_2] * G[i_2][i_3][i_1+i_0][i_2+i_0] - E[i_1][i_2][i_0][i_3] - E[i_2][i_0][i_2][i_1] * H[i_0+1][i_3][i_1+1][i_2-1] + A[i_1-1][i_2+1][i_3] + B[i_2+i_0-1][i_2][i_3+1][i_1] - B[i_1+i_0][i_1-1][i_2][i_3-1] + B[i_1+i_0-1][i_1-1][i_3][i_2] - B[i_3+i_1][i_1][i_2+1][i_0] + B[i_3+i_0][i_3][i_2-1][i_1+1] - 4;
                }
            }
        }
        for (int i_4 = i_0; i_4 < -i_0+PB_L; i_4++) {
            C[i_0][i_4-1] = I[i_0][i_4+i_0] * J[i_4+i_0-1] - K[i_4][i_0] * L[0] + C[i_0+1][i_4] * C[i_4+1][i_0-1] + D[i_0] - 2;
        }
        D[i_0] = J[i_0-1] * D[i_0+1] * D[i_0-1] - 5;
    }
#pragma endscop
