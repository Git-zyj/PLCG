...
void kernel_4212252321_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf)){
...
#pragma scop
        ...
        for (int i_1 = 2; i_1 < PB_P; i_1++) {
            for (int i_2 = 2; i_2 < min(PB_P, -i_0+PB_M+2); i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_L; i_3++) {
                    A[i_0][i_1][i_3][i_2] = C[i_2+i_0-2][i_3][i_1-2][i_2] - D[i_3][i_3][i_0-2][0] * C[i_0+1][i_1][i_3][i_2] * C[i_1-2][i_3+i_0][i_1][i_2] + C[i_2][i_0][i_2-2][i_1] - D[i_3][i_1][i_0][i_2] - E[i_2][i_0][i_2] - C[i_3+2][i_1][i_2][i_0-2] + A[i_0][i_1][i_3][i_2-2] + A[i_3][i_2][i_0-1][i_1] - 1;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_N; i_4++) {
        for (int i_5 = 2; i_5 < PB_N-1; i_5++) {
            B[i_4] = F[i_4][i_5] * B[i_5+1] + B[i_5-2] + B[i_4-1] * 2;
        }
    }
#pragma endscop
...
kernel_4212252321_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
