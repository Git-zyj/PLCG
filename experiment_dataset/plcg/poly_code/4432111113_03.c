        ...
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_L; i_2++) {
                for (int i_3 = i_1; i_3 < PB_Q-2; i_3++) {
                    A[i_2][i_2+i_1-1][i_0-1][i_3+1] = A[i_2][i_2+i_1][i_0-1][i_3+2] + B[i_1][i_0+2][i_3+i_2-1][i_3] * 5;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < PB_L; i_5++) {
            for (int i_6 = 1; i_6 < min(-i_4+PB_P, PB_L-1); i_6++) {
                for (int i_7 = 0; i_7 < -i_5+PB_L; i_7++) {
                    B[i_5][i_4+1][i_7+i_6-1][i_6] = E[i_7][i_5][i_6+i_4][i_6][i_4] * F[i_5-1][i_6+1][i_4][i_6] + A[i_7][i_7+i_5][i_6-1][i_4+1] + 6;
                }
            }
        }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4432111113_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G)));
