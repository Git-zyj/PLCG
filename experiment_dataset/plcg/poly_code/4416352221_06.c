...
void kernel_4416352221_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        for (int i_1 = i_0; i_1 < PB_L; i_1++) {
            for (int i_2 = 2; i_2 < PB_M-2; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_0+PB_M-1, PB_Q-3); i_3++) {
                    A[i_0+2][i_2][i_3][i_3+1] = E[i_1][i_2][i_0][i_3] + F[i_3+i_0+1][i_2-2][i_1][i_2] - F[i_1][i_0+1][i_3+1][i_2-2] * F[i_2][i_0][i_1][i_3] + A[i_2+2][i_1][i_3-1][i_3] - A[i_0][i_2][i_3+2][i_3+3] * 2;
                }
            }
        }
        for (int i_4 = 2; i_4 < -i_0+PB_M-2; i_4++) {
            B[i_0][i_4] = G[i_4+i_0+2][i_4] - H[i_4][i_4+i_0][i_0] + I[i_4][i_0] - B[i_0][i_4+2] - 2;
            C[i_4+1][i_0] = J[i_4-2] + J[i_0-2] - G[i_4][i_4+2] - J[i_4+i_0] * K[i_4+i_0][i_4] * K[i_4+1][i_0-1] * B[i_0-1][i_4] * C[i_4+1][i_0-2] * C[i_4+1][i_0+1] * C[i_0][i_4] + 6;
        }
    }
    for (int i_5 = 2; i_5 < PB_L-2; i_5++) {
        for (int i_6 = i_5; i_6 < -i_5+PB_M; i_6++) {
            D[i_5][i_6] = K[i_6][0] * K[i_6][i_6+i_5-2] * G[i_5+2][i_6] + G[i_6+i_5][2] + G[i_6][i_5-1] * I[i_5+2][i_6-1] - 4;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4416352221_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K));
