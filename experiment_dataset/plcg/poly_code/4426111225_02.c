...
#endif
static void init_array(int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int seed)
{
srand(seed);
        ...
        for (int i_4 = i_3; i_4 < PB_M-1; i_4++) {
            ...
            for (int i_5 = 1; i_5 < PB_M; i_5++) {
                for (int i_6 = 0; i_6 < PB_L-1; i_6++) {
                    C[i_5][i_3-1][i_6+1][i_5] = F[i_4-1][i_5-1][i_6+1][i_3-1][i_3-1] + C[i_4][i_3-1][i_5][i_4] + C[i_5][i_6+1][i_3+1][i_5] + 5;
                }
            }
        }
        for (int i_7 = 0; i_7 < i_3; i_7++) {
            for (int i_8 = 1; i_8 < PB_M; i_8++) {
                for (int i_9 = 1; i_9 < PB_Q-1; i_9++) {
                    D[i_3-1][i_8-1][i_8][i_9+1] = G[i_8][i_3][i_9][i_7] + D[i_8-1][i_9-1][i_9][i_7+2] - 2;
                }
            }
        }
    }
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4426111225_02(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G)));
