        ...
        for (int i_1 = 1; i_1 < min(-i_0+PB_Q+1, PB_M-1); i_1++) {
            for (int i_2 = i_1; i_2 < -i_1+PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_M; i_3++) {
                    A[i_1+1][i_2-1][i_0][i_3] = E[i_2+i_1+1][i_0+1][i_3][i_1] + F[i_0][i_3][i_2][i_1][0] * G[i_1-1][i_3][i_2][i_1+i_0-1] + E[i_2+1][i_1][i_3][0] * E[i_2][i_3+i_0][i_1][i_1] - 5;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        B[i_4-1] = H[1] - I[i_4] * H[i_4-1] + 1;
        for (int i_5 = 0; i_5 < PB_M; i_5++) {
            C[i_5][i_4] = H[i_5] - J[i_4][i_5] * J[i_5][i_4] * K[i_5][i_4+1] - I[i_4] + C[i_5][i_4-1] - 5;
        }
        B[i_4-1] = I[i_4+1] * I[i_4] - L[i_4-1] * H[i_4] + 3;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4416351123_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L));
