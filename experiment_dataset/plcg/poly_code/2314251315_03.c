...
void kernel_2314251315_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-1; i_0++) {
        for (int i_1 = 0; i_1 < min(-i_0+PB_M, PB_N-1); i_1++) {
            B[i_1+1] = D[i_1+i_0][i_1] - E[i_0] - D[i_0][i_1] + F[i_0+1] * B[i_1] * B[i_0] - 6;
        }
        B[i_0] = F[i_0] * E[i_0] + E[i_0+1] - G[i_0+1][i_0] - B[i_0-1] - 1;
    }
    for (int i_2 = 0; i_2 < PB_N-1; i_2++) {
        for (int i_3 = 1; i_3 < -i_2+PB_N-1; i_3++) {
            B[i_3-1] = G[i_3+i_2+1][1] + D[i_2][0] - G[i_2+1][i_3] + H[i_3][i_3+1][i_2] + G[i_3][i_2] + D[i_3][i_2] - D[i_3+i_2][i_3] - 4;
        }
    }
#pragma endscop
...
kernel_2314251315_03(xb,POLYBENCH_ARRAY(B), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
