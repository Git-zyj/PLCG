...
void kernel_3236352325_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        for (int i_1 = i_0; i_1 < PB_M-3; i_1++) {
            A[i_1+2] = C[i_1] * A[i_1+1] - A[i_1+3] - A[i_1] - 2;
        }
        for (int i_2 = 1; i_2 < min(-i_0+PB_M, i_0); i_2++) {
            A[i_2+2] = D[i_2][i_0+2] - E[i_2][i_0] + C[i_2] - E[i_0-2][i_2] - D[i_0][i_2] + E[i_2+i_0][i_2] + D[i_0][i_2-1] + D[i_2][i_0] + 1;
        }
    }
#pragma endscop
...
kernel_3236352325_06(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
