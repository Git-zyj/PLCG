...
void kernel_2434251223_03(int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            D[i_0-2][i_0-1] = E[i_1] * F[i_1+1] - G[i_0+1][i_1-1] + G[i_1][i_0-1] + E[i_1] + 4;
        }
        D[i_0][i_0+1] = E[i_0] - F[i_0] + F[i_0+1] * E[i_0] + F[i_0] - 2;
        D[i_0+1][i_0+2] = F[i_0] + 5;
    }
    for (int i_2 = 1; i_2 < PB_P; i_2++) {
        for (int i_3 = 1; i_3 < min(PB_M-2, -i_2+PB_M); i_3++) {
            D[i_3][i_3+1] = E[i_3] + F[i_3+i_2] + E[i_3] + H[i_3][i_2-1] + I[i_3][i_3+i_2+1][i_2] * G[i_2][i_3-1] * D[i_3-1][i_3] - D[i_3+2][i_3+3] - 4;
        }
    }
#pragma endscop
...
kernel_2434251223_03(xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
