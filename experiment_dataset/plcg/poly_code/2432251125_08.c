...
void kernel_2432251125_08(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        C[i_0] = E[i_0] * F[0] + F[i_0] + E[i_0] - G[i_0+1][i_0] + C[i_0] - 1;
        C[i_0-2] = F[i_0] + E[i_0] + 2;
    }
    ...
    for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
        for (int i_3 = 1; i_3 < -i_2+PB_P+1; i_3++) {
            C[i_2-1] = G[i_3-1][i_2] + H[1][i_2] + G[i_3][i_3] * F[i_2-1] * G[i_2-1][i_3] - G[i_3][i_2] * I[i_2+1][i_3-1][i_2+1] + G[i_3+1][i_3+i_2-1] * G[i_3+1][i_2] + 1;
        }
    }
#pragma endscop
...
kernel_2432251125_08(xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
