...
void kernel_4336231315_09(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        for (int i_1 = i_0; i_1 < -i_0+PB_M; i_1++) {
            A[i_0-1][i_1-1] = D[i_1][i_0] - E[i_1+1][i_1+i_0] + D[i_1][i_0] * F[i_1+i_0] - A[i_0-1][i_1] + A[i_0-2][i_1-1] * 4;
        }
    }
        ...
        for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
            for (int i_4 = i_2; i_4 < PB_M; i_4++) {
                for (int i_5 = 1; i_5 < -i_4+PB_L; i_5++) {
                    B[i_4][i_3][i_2][i_5-1] = G[i_3+1][i_4][i_2][i_4+1] + G[i_3][i_2][i_5][i_4] - H[i_3][i_5+i_4][i_5-1][i_3] * B[i_4-1][i_2][i_5][i_3] - B[i_4][i_5][i_2][i_3] + B[i_2-1][i_5][i_4][i_3] - 3;
                }
            }
            for (int i_6 = 1; i_6 < PB_L; i_6++) {
                for (int i_7 = i_6; i_7 < -i_2+PB_N-1; i_7++) {
                    C[i_7+i_2][i_3][i_6-1][0] = C[i_7+i_2+1][i_3-1][i_6-1][0] - C[i_7+i_2-1][i_3][i_6-1][0] - C[i_7+i_2][i_3-1][i_6-1][0] - 6;
                }
            }
        }
    }
...
kernel_4336231315_09(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
