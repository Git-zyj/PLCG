...
void kernel_2134311213_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N; i_0++) {
        for (int i_1 = 0; i_1 < min(PB_N, -i_0+PB_L); i_1++) {
            A[0] = B[i_1+i_0] * A[0] - A[0] * 2;
        }
    }
#pragma endscop
...
kernel_2134311213_03(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
