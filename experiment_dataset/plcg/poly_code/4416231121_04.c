        ...
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < PB_L; i_2++) {
                for (int i_3 = i_0; i_3 < -i_1+PB_M; i_3++) {
                    B[i_3+i_1][i_0][i_3-1] = 6;
                }
            }
        }
        for (int i_4 = i_0; i_4 < PB_N-1; i_4++) {
            C[i_0+1][i_4] = F[i_4-1][i_0] * F[i_4+1][i_0] * A[i_0-2] - C[i_0-1][i_4-2] * C[i_0-1][i_4] - 3;
        }
    }
    for (int i_5 = 0; i_5 < PB_M; i_5++) {
        for (int i_6 = 1; i_6 < PB_M-1; i_6++) {
            for (int i_7 = 1; i_7 < min(min(-i_6+PB_M+1, -i_5+PB_M), PB_M-1); i_7++) {
                for (int i_8 = 2; i_8 < min(-i_6+PB_M, -i_5+PB_M); i_8++) {
                    D[i_6+1][i_7+1][i_5][i_8-1] = G[i_8][i_7+i_6-1][i_5+1][0] - H[i_8+i_5][i_7][i_6-1][i_6-1] + H[i_7+i_5][i_8][i_8-1][i_6] + H[i_8+i_6][i_7][i_5+1][i_7-1] + H[i_7-1][i_5][i_6][i_5] + G[i_6+1][i_7+1][i_8][i_7+1] + D[i_6+1][i_7+2][i_5][i_8-2] + 3;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4416231121_04(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H)));
