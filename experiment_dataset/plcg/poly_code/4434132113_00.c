...
#pragma scop
    ...
    for (int i_4 = 2; i_4 < PB_L; i_4++) {
        for (int i_5 = 1; i_5 < PB_M-1; i_5++) {
            B[i_4][i_5] = G[i_5][i_4] + B[i_4][i_5-1] * B[i_4+1][i_5+1] - 1;
        }
        C[i_4-1] = H[0] * G[i_4-2][i_4-1] - H[i_4] * C[i_4-2] + 4;
    }
    for (int i_6 = 1; i_6 < PB_P; i_6++) {
        for (int i_7 = i_6; i_7 < PB_M; i_7++) {
            for (int i_8 = 1; i_8 < PB_P; i_8++) {
                for (int i_9 = 0; i_9 < PB_P; i_9++) {
                    D[i_7][i_8-1][i_8][i_9] = E[i_9][i_6][i_6+2][i_8] - E[i_8][i_9][i_6-1][i_6] - 5;
                }
            }
        }
    }
...
kernel_4434132113_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
