...
void kernel_3232211325_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-3; i_0++) {
        for (int i_1 = 2; i_1 < min(-i_0+PB_N, PB_M-1); i_1++) {
            A[i_0+1][i_1] = C[i_0][i_1+1] + C[i_1+i_0][0] - A[i_0+1][i_1-1] - A[i_0+2][i_1-2] - A[i_0+3][i_1] * 4;
        }
    }
...
kernel_3232211325_04(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C));
