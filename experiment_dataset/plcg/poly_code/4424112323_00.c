...
void kernel_4424112323_00(int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
        ...
        for (int i_5 = 1; i_5 < PB_M-2; i_5++) {
            for (int i_6 = 2; i_6 < PB_M+2; i_6++) {
                for (int i_7 = 0; i_7 < -i_6+PB_M+2; i_7++) {
                    D[i_6-2][i_7+i_6-2][i_7] = 6;
                }
            }
            C[i_5+1][i_4] = C[i_5+2][i_4] + C[i_5+1][i_4+2] + C[i_4][i_5+2] + C[i_5-1][i_4] + 5;
        }
    }
    for (int i_8 = 2; i_8 < PB_L-2; i_8++) {
        for (int i_9 = 0; i_9 < -i_8+PB_M; i_9++) {
            for (int j_0 = i_8; j_0 < PB_M; j_0++) {
                D[i_9][i_9+i_8][i_8] = E[i_9+1][i_8+2][i_9+2] * E[j_0][i_8][i_8-1] * D[i_9][i_9+i_8-1][i_8-1] - D[i_9][i_9+i_8-2][i_8-2] * 1;
            }
        }
    }
#pragma endscop
...
kernel_4424112323_00(xd,yd,zd,POLYBENCH_ARRAY(D), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,POLYBENCH_ARRAY(E));
