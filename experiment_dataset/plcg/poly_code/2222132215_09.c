...
void kernel_2222132215_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N; i_0++) {
        for (int i_1 = 0; i_1 < PB_N-1; i_1++) {
            B[i_1+1] = B[i_1] * B[i_1+1] * 3;
        }
        B[i_0] = C[i_0] - C[i_0] - C[i_0] + C[i_0] - C[i_0] - C[i_0+1] - 2;
    }
#pragma endscop
...
kernel_2222132215_09(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
