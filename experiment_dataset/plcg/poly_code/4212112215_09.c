...
void kernel_4212112215_09(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        ...
        for (int i_3 = 0; i_3 < -i_0+PB_M+2; i_3++) {
            B[i_3][i_0][i_0+1] = C[i_3+i_0-2][i_0] * B[i_3][i_0-1][i_0] - B[i_3][i_0+1][i_0+2] - 4;
        }
    }
#pragma endscop
...
kernel_4212112215_09(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
