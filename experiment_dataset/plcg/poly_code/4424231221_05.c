        ...
        for (int i_2 = 0; i_2 < min(-i_1+PB_P, i_1); i_2++) {
            for (int i_3 = 1; i_3 < PB_M; i_3++) {
                for (int i_4 = 0; i_4 < -i_1+PB_Q-1; i_4++) {
                    D[i_1][i_4][i_3][i_4+1] = G[i_4][i_3-1][i_2][i_1] + H[i_3][i_2][i_2+i_1][i_4+i_1+1] - 2;
                }
            }
        }
    }
    for (int i_5 = 1; i_5 < PB_M-1; i_5++) {
        C[i_5] = F[i_5+1] * E[i_5] + F[i_5] + E[i_5+1] - C[i_5-1] + C[i_5+1] - 3;
        for (int i_6 = 2; i_6 < PB_Q-3; i_6++) {
            for (int i_7 = 0; i_7 < PB_N; i_7++) {
                for (int i_8 = 0; i_8 < PB_P-2; i_8++) {
                    D[i_5+1][i_6][i_8][i_6+1] = D[i_5+1][i_6-2][i_8+2][i_6-1] * D[i_5+1][i_6+2][i_8+1][i_6+3] * 2;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4424231221_05(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H)));
