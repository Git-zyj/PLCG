...
void kernel_2412151321_08(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        C[i_0] = E[i_0] - E[i_0] - D[i_0-1] - D[i_0+1] + 4;
        C[i_0+2] = E[i_0] + E[i_0-1] - E[i_0] * E[i_0-1] - E[0] + E[i_0] - C[i_0+2] + C[i_0] + 5;
        C[i_0+1] = E[i_0] * E[i_0] + E[i_0] + E[i_0] * 5;
    }
    for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
        D[i_1+1] = E[i_1-1] * E[i_1] + E[i_1-1] - E[i_1] * E[i_1] * D[i_1] * 6;
    }
#pragma endscop
...
kernel_2412151321_08(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
