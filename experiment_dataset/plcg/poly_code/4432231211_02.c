...
void kernel_4432231211_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,int wc,DATA_TYPE POLYBENCH_5D(C,xC,yC,zC,vC,wC,xc,yc,zc,vc,wc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        A[i_0] = E[i_0] - F[i_0] + F[i_0] + F[i_0] + A[i_0+1] * 1;
    }
    for (int i_1 = 2; i_1 < PB_L-1; i_1++) {
        for (int i_2 = 2; i_2 < min(i_1, -i_1+PB_Q-1); i_2++) {
            for (int i_3 = 1; i_3 < i_1; i_3++) {
                for (int i_4 = 1; i_4 < PB_L; i_4++) {
                    B[i_2+1][i_4][i_3][i_1] = G[i_2][i_4][i_1][1] * H[i_1+1][i_4-1][i_3+i_2] * B[i_2+1][i_4][i_3+1][i_1] - B[i_4+1][i_1+1][i_2-1][i_3] + B[i_2+1][i_4-1][i_3][i_1+1] - 1;
                }
                for (int i_5 = 0; i_5 < PB_L-1; i_5++) {
                    C[i_2+1][i_5+1][i_3+1][i_2+i_1+1][i_5] = I[i_2-1][i_3-1][i_1][i_5+1] - G[i_2][i_5][i_3][i_1] - 1;
                }
            }
            for (int i_6 = 1; i_6 < -i_1+PB_L+1; i_6++) {
                for (int i_7 = 0; i_7 < -i_1+PB_L+1; i_7++) {
                    D[i_1-1][i_6+i_1-1][i_6+1][i_2] = G[i_7+1][i_1][i_2][i_6] + I[i_2][i_6][i_1][i_6+1] * G[i_6][i_7+i_2-1][i_1][i_1] + G[i_1][i_7+i_6-1][i_2+1][i_7] * D[i_1-1][i_7+i_1-1][i_7+1][i_6+1] - D[i_1][i_6+i_1-1][i_6][i_2] * D[i_2-2][i_6+i_2-1][i_6+2][i_1] + D[i_1-2][i_6+i_1-2][i_6+1][i_2] + 6;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,wc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4432231211_02(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,wc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,wc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I)));
