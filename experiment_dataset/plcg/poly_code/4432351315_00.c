...
void kernel_4432351315_00(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,int zk,int vk,DATA_TYPE POLYBENCH_4D(K,xK,yK,zK,vK,xk,yk,zk,vk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 1; i_1 < -i_0+PB_M-1; i_1++) {
            B[i_1+i_0+1][i_0] = E[i_1][i_0-1] - F[i_1-1][i_0-1] - G[i_1][i_0+1] * F[i_0+1][i_1+1] * F[i_1+i_0][i_1+1] + F[i_0][i_1] * 6;
        }
        for (int i_2 = 0; i_2 < min(i_0, -i_0+PB_L-1); i_2++) {
            B[i_2+i_0][i_0] = F[i_2+i_0+1][i_0] + H[1] - F[i_2][i_0] + E[i_2+i_0-1][1] * G[i_0][i_2+i_0-1] + B[i_2+i_0][i_0+1] - B[i_2+i_0+1][i_0] * B[i_2+i_0-1][i_0-1] - B[i_2+i_0-1][i_0] + 2;
        }
    }
    for (int i_3 = 0; i_3 < PB_L-1; i_3++) {
        for (int i_4 = 0; i_4 < min(-i_3+PB_M, i_3); i_4++) {
            B[i_4+i_3][i_4] = F[i_3+1][i_4] + I[i_4+1] - 1;
        }
    }
    for (int i_5 = 1; i_5 < PB_L-1; i_5++) {
        for (int i_6 = 2; i_6 < min(PB_P-1, -i_5+PB_P+1); i_6++) {
            for (int i_7 = 1; i_7 < PB_Q-1; i_7++) {
                for (int i_8 = 1; i_8 < -i_5+PB_M; i_8++) {
                    D[i_6][i_5][i_8][i_7-1] = J[i_8-1][i_7][i_5+1][i_6+1] - J[i_8][i_8-1][i_7][i_6+i_5-1] + K[i_6-1][i_7][i_5][i_7+1] + J[i_8+i_5][i_7][i_6-1][i_5-1] + D[i_8+1][i_5][i_6-1][i_7-1] - D[i_7][i_5][i_8][i_6-2] + 5;
                }
            }
        }
    }
...
init_array(xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4432351315_00(xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K)));
