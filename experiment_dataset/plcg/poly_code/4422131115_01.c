...
void kernel_4422131115_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
        ...
        for (int i_1 = i_0; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_M; i_2++) {
                for (int i_3 = 0; i_3 < min(min(-i_2+PB_L, -i_0+PB_L), i_1); i_3++) {
                    A[i_0][i_0][i_1][i_3] = E[i_2][i_1+1][i_0][i_3+i_2] * F[i_3][i_2][i_1] - E[i_2][i_0-1][i_3][i_1] + E[i_0-1][i_1][i_3+i_2][i_1] * A[i_3][i_3][i_2+1][i_1+1] * 5;
                    B[i_1][i_2-1][i_3+i_0][i_2] = F[i_2-1][i_3+1][i_1] * F[i_3][i_1][i_2] - E[i_0][i_3][i_1][i_2+1] + E[i_0+1][i_0][i_3][i_2] * 3;
                }
            }
            for (int i_4 = 1; i_4 < PB_N-2; i_4++) {
                for (int i_5 = 0; i_5 < PB_N; i_5++) {
                    D[i_1][i_5][i_4+2][i_0+1] = E[i_4-1][i_0][i_5][i_1] + E[i_4][i_0+1][i_1][i_5] - 4;
                }
            }
        }
    }
        ...
        for (int i_7 = 0; i_7 < PB_M; i_7++) {
            for (int i_8 = 0; i_8 < PB_N-1; i_8++) {
                for (int i_9 = 1; i_9 < PB_N; i_9++) {
                    D[i_7][i_9][i_8+1][i_6+1] = E[i_8][i_7][i_6][i_9] * E[i_9-1][i_6][i_7][i_8] - 6;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), INIT_SEED);
kernel_4422131115_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F)));
