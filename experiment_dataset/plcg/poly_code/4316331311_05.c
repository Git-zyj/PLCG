...
void kernel_4316331311_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < min(PB_P, -i_1+PB_Q+1); i_2++) {
                for (int i_3 = 0; i_3 < PB_L; i_3++) {
                    A[i_0+1][i_2][i_2][i_1+1] = D[i_2][i_0-1][i_2][i_1] + D[i_1][i_2-1][i_0][i_3] - E[i_2][i_3][i_1][i_0-1] * F[i_3][i_2+i_1-1][0] * A[i_0+1][i_2][i_2][i_1] + A[i_0+2][i_2][i_2][i_1+1] * A[i_0+2][i_2-1][i_2-1][i_1+2] * 3;
                }
            }
        }
        for (int i_4 = i_0; i_4 < PB_L-1; i_4++) {
            B[i_4][i_0+1][i_0] = G[i_4][i_4] + H[i_4-1][i_0] - B[i_4][i_0+2][i_0+1] - 2;
            for (int i_5 = i_0; i_5 < PB_L; i_5++) {
                for (int i_6 = 0; i_6 < PB_P-2; i_6++) {
                    C[i_0+1][i_5-1][i_4+1][i_6+1] = E[i_6][i_5][i_0+1][i_5] * D[i_0][i_5-1][i_4+1][i_6] + D[i_6][i_4-1][i_5][i_0] - C[i_0][i_5-1][i_4+1][i_6+2] * C[i_5][i_0-2][i_4+1][i_6] - C[i_6+1][i_5-1][i_4][i_0+1] * C[i_0+1][i_5][i_4+1][i_6+1] - 5;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4316331311_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H)));
