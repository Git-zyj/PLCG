...
void kernel_4336331211_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg)){
        ...
        for (int i_1 = max(2, i_0); i_1 < PB_Q-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
                for (int i_3 = i_1; i_3 < PB_L-2; i_3++) {
                    A[i_2+1][i_3+1][i_0-1][i_1-1] = D[i_3+1][i_0+1][i_3][i_1] + E[i_2][i_3-1][i_0][i_1+1] - A[i_2+1][i_3+1][i_0-1][i_1-2] + A[i_2][i_3+2][i_0][i_1-1] - A[i_2][i_1+2][i_0][i_3-1] + 1;
                }
            }
        }
        B[i_0] = F[i_0] + G[i_0] + G[i_0] * B[i_0+1] + 2;
        for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
            for (int i_5 = 1; i_5 < i_0; i_5++) {
                for (int i_6 = i_5; i_6 < PB_Q-1; i_6++) {
                    A[i_4+1][i_6+1][i_0][i_5-1] = E[i_6][i_0][i_5][i_4] + E[i_4-1][i_5+1][i_6][i_0] - D[i_0-1][i_5+1][i_4+1][i_6+1] * D[i_6][i_5+1][i_0][i_0] + 1;
                }
            }
        }
    }
...
kernel_4336331211_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
