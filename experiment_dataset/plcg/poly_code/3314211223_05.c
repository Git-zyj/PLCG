...
void kernel_3314211223_05(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-3; i_0++) {
        for (int i_1 = 0; i_1 < min(-i_0+PB_L-2, i_0); i_1++) {
            A[i_0+1][i_1+i_0] = A[i_0][i_1+i_0-1] - 5;
            C[i_0][i_0+1] = D[i_1][i_0] * A[i_0+2][i_1+i_0+1] + A[i_0+3][i_1+i_0+2] * 3;
        }
        C[i_0][i_0+1] = 3;
    }
#pragma endscop
...
kernel_3314211223_05(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
