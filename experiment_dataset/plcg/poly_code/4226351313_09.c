...
void kernel_4226351313_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,int wg,DATA_TYPE POLYBENCH_5D(G,xG,yG,zG,vG,wG,xg,yg,zg,vg,wg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh)){
        ...
        for (int i_1 = i_0; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_Q; i_2++) {
                for (int i_3 = i_2; i_3 < -i_0+PB_P+1; i_3++) {
                    A[i_1][i_0][i_2][i_3] = C[i_0][i_3][i_1][i_2+1] + D[i_2][i_0+1][i_3][i_2+i_1] + E[i_1][i_0][i_2-1][i_3] - C[i_3-1][i_0-1][i_1+1][0] - C[i_2-1][i_3+i_0-1][i_1][i_0] - D[i_1+1][i_0][i_3][i_2-1] - A[i_1-1][i_0-1][i_3][i_2+1] + A[i_1][i_0][i_2][i_3+1] + A[i_1][i_0+1][i_2][i_3-1] * 1;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < PB_P-1; i_5++) {
            for (int i_6 = 0; i_6 < PB_M; i_6++) {
                for (int i_7 = 0; i_7 < i_6; i_7++) {
                    A[i_7][i_5+1][i_6][i_4-1] = D[i_6][i_7][i_5][i_4] + F[i_7][i_5][i_4+1] * G[i_4][i_5][i_7][i_6][i_5-1] + H[i_5-1][i_6][i_4-1][i_4][i_7] * 6;
                }
            }
        }
    }
...
kernel_4226351313_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H));
