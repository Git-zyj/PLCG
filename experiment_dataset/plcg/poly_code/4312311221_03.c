...
void kernel_4312311221_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 0; i_2 < i_0; i_2++) {
                A[i_1][i_0][i_2+1] = A[i_0][i_1][i_2+2] + A[i_1+2][i_0][i_2] - 2;
            }
        }
    }
    for (int i_3 = 2; i_3 < PB_M-1; i_3++) {
        for (int i_4 = 0; i_4 < PB_P; i_4++) {
            for (int i_5 = 0; i_5 < min(min(i_4, PB_M), -i_4+PB_P); i_5++) {
        ...
        for (int i_7 = 1; i_7 < i_3; i_7++) {
            for (int i_8 = 0; i_8 < -i_7+PB_M; i_8++) {
                C[i_3][i_8+i_7][i_7-1] = D[i_3][i_7+1][0] + C[i_3-2][i_8+i_7-1][i_7-1] - C[i_3+1][i_8+i_7][i_7-1] - 5;
            }
        }
    }
#pragma endscop
...
kernel_4312311221_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
