...
void kernel_2316252121_02(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        B[i_0-1] = D[i_0] - D[i_0] * E[i_0] - D[i_0+1] * D[i_0] - D[i_0] - 3;
        B[i_0] = E[i_0] - D[i_0] + D[i_0] + D[i_0-2] + D[i_0-1] - B[i_0-2] + 1;
        for (int i_1 = 1; i_1 < -i_0+PB_M; i_1++) {
            C[i_1][i_0+1] = F[i_1+i_0][i_1-1][i_0] + G[i_1+2][i_0-1] * E[i_1] - 2;
        }
    }
#pragma endscop
...
kernel_2316252121_02(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
