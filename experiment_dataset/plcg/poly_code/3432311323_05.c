    ...
    for (int i_3 = 0; i_3 < PB_M-1; i_3++) {
        for (int i_4 = 1; i_4 < PB_P-3; i_4++) {
            for (int i_5 = 0; i_5 < -i_4+PB_N-1; i_5++) {
                C[i_3][i_5][i_4+1] = F[i_5+i_4+1][i_3+1][0] * C[i_3][i_5][i_4] * C[i_3][i_5][i_4+3] + C[i_5][i_3+1][i_4+1] - C[i_3][i_5][i_4-1] * 4;
            }
        }
...
kernel_3432311323_05(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
