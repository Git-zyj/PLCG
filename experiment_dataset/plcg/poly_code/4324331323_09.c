...
void kernel_4324331323_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
        A[0] = E[i_1] + D[i_1] * D[i_1-1] + D[i_1] - F[i_1-1] * 5;
        for (int i_2 = 0; i_2 < PB_L; i_2++) {
            for (int i_3 = max(3, i_1); i_3 < PB_M-1; i_3++) {
                C[i_3+1][i_1-1][i_3] = G[i_2][i_3][i_1] * H[i_3+1][i_2][i_1-1] - C[i_3][i_1-1][i_3-1] * C[i_3-1][i_1-1][i_3-2] - C[i_1+2][i_3-3][i_1+1] - C[i_3][i_1-2][i_3-1] - 1;
            }
        }
    }
#pragma endscop
...
kernel_4324331323_09(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
