...
void kernel_2232111315_08(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        B[i_0][i_0-1] = B[i_0-1][i_0-2] * 5;
        for (int i_1 = 0; i_1 < min(PB_Q, -i_0+PB_L); i_1++) {
            B[i_0][i_0-1] = C[i_1+i_0][0] + B[i_0-1][i_0-2] - B[i_0+1][i_0] + 2;
        }
    }
#pragma endscop
...
kernel_2232111315_08(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
