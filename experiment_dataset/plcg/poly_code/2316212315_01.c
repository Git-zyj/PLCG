...
void kernel_2316212315_01(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            C[i_1] = D[i_1] + C[i_0] + C[i_1] * 1;
        }
...
kernel_2316212315_01(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
