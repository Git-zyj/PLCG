...
void kernel_2216152315_01(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L+2; i_0++) {
        B[i_0-2] = C[i_0-1] + C[i_0] - C[i_0] + C[i_0+2] - C[i_0] * C[i_0] * C[i_0] + C[i_0] * C[2] + 1;
    }
    for (int i_1 = 3; i_1 < PB_L+1; i_1++) {
        B[i_1-2] = C[i_1] + B[i_1-3] - B[i_1-1] + B[i_1-3] * 2;
    }
#pragma endscop
...
kernel_2216152315_01(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
