...
void kernel_3322352123_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        A[i_0] = D[i_0+2] - D[i_0+2] + E[i_0-2] * 5;
        for (int i_1 = 0; i_1 < -i_0+PB_M-2; i_1++) {
            B[i_0][i_1] = F[i_0][0] * G[i_1][0] * D[i_1+i_0] - G[i_1+i_0][i_1] + F[i_1+i_0+2][i_0] + F[i_1][i_0] - H[i_0+2][i_1+i_0][i_1] * G[i_0][0] - G[i_1][i_0] - 5;
            for (int i_2 = i_0; i_2 < PB_L; i_2++) {
                B[i_1][i_2-1] = F[i_1+1][1] - I[i_2-1][i_0][i_1] * J[i_2][i_0][i_1] * B[i_1][i_2] + 1;
            }
        }
    }
#pragma endscop
...
kernel_3322352123_02(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
