...
void kernel_4234311313_02(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
        ...
        for (int i_2 = 1; i_2 < PB_M; i_2++) {
            for (int i_3 = 1; i_3 < PB_L; i_3++) {
                for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
                    B[i_0][i_3][i_2][i_4] = C[i_4+1][i_3][i_2+1][0] + B[i_0][i_3][i_2-1][i_4] + B[i_3-1][i_0][i_2-1][i_4-1] + B[i_0][i_4][i_2-1][i_3] * B[i_0][i_3][i_2][i_4+1] - B[i_2][i_0][i_3][i_4-1] + 4;
                }
            }
        }
    }
...
kernel_4234311313_02(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
