...
void kernel_2226111111_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_N+1; i_0++) {
        ...
        for (int i_2 = i_0; i_2 < PB_M; i_2++) {
            A[i_0-1][i_2] = C[i_2-1] + A[i_0-1][i_2] - 6;
        }
    }
#pragma endscop
...
kernel_2226111111_00(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
