...
void kernel_4412252111_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,int vc,int wc,DATA_TYPE POLYBENCH_5D(C,xC,yC,zC,vC,wC,xc,yc,zc,vc,wc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,int wg,DATA_TYPE POLYBENCH_5D(G,xG,yG,zG,vG,wG,xg,yg,zg,vg,wg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk)){
        ...
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            for (int i_2 = i_1; i_2 < min(PB_P-1, -i_1+PB_L); i_2++) {
                for (int i_3 = 2; i_3 < -i_0+PB_Q+2; i_3++) {
                    A[i_1][i_3+i_0-2][i_2][i_3-2] = E[i_1][i_2][i_1-1][i_0] * F[i_0][i_2+1][i_3][1] * G[i_3-2][i_2+i_1][i_0][i_0-2][i_3] * 5;
                }
            }
        }
        for (int i_4 = 1; i_4 < -i_0+PB_L; i_4++) {
            B[i_0][i_0+2] = H[i_0][i_4] * H[i_4-1][i_0] + I[i_4+i_0][i_4+i_0] * H[i_0-1][i_4] * H[0][i_0+2] + H[i_0+2][i_4+i_0] * I[i_0][i_4-1] - I[i_4+1][i_0] + J[i_4+2][i_0][i_0] - B[i_0-1][i_0+1] - 2;
        }
    }
        ...
        for (int i_6 = i_5; i_6 < PB_Q-1; i_6++) {
            for (int i_7 = i_6; i_7 < -i_6+PB_Q-1; i_7++) {
                for (int i_8 = 2; i_8 < PB_P; i_8++) {
                    C[i_5+2][i_7][i_6][0][i_8] = F[i_5][i_8][i_7+i_6+1][i_6] * E[i_6][i_7][i_5][i_5] - F[i_6][i_8][i_8-2][i_7] * 5;
                }
            }
        }
        D[i_5-1] = K[i_5] - K[i_5] + B[i_5-1][i_5+1] + D[i_5-2] - D[i_5] * 3;
    }
#pragma endscop
