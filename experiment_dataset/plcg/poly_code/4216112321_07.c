...
void kernel_4216112321_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
        ...
        for (int i_1 = 3; i_1 < PB_Q; i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_L; i_2++) {
                for (int i_3 = 0; i_3 < PB_Q; i_3++) {
                    A[i_2+i_1-2][i_0][1][i_3] = A[i_2+i_1][i_0][1][i_3] + A[i_2+i_1-3][i_0][1][i_3] - A[i_2+i_1][i_0][1][i_3] - 6;
                }
            }
        }
    }
...
kernel_4216112321_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
