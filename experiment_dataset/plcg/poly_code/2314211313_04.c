...
void kernel_2314211313_04(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        B[i_0+1] = B[i_0] * B[i_0+1] + B[i_0-1] - 4;
        B[i_0] = 2;
        B[i_0] = D[i_0+1] - 4;
    }
#pragma endscop
...
kernel_2314211313_04(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
