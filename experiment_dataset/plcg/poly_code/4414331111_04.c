        ...
        for (int i_1 = max(1, i_0); i_1 < PB_M+1; i_1++) {
            for (int i_2 = 0; i_2 < min(i_0, PB_M-1); i_2++) {
                for (int i_3 = 1; i_3 < i_1; i_3++) {
                    A[i_2][i_1-1][i_3][i_1-1] = E[i_1-1][i_2][i_3-1][i_0] + A[i_2+1][i_1-1][i_3][i_1-1] * 2;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M; i_4++) {
        for (int i_5 = 1; i_5 < min(PB_M-1, -i_4+PB_L); i_5++) {
            for (int i_6 = 1; i_6 < min(i_4, -i_4+PB_L); i_6++) {
                B[i_5][i_6+i_4] = F[i_4][i_6][i_5] - G[i_6-1][i_4][i_5-1][i_6] * F[i_5+i_4][i_6+1][i_4] * H[i_5][i_4-1] * E[i_5][i_4+1][i_6][i_5] * 5;
            }
            C[i_4][i_5] = I[i_4][i_5][i_4] - J[i_5][i_4-1] + C[i_4+1][i_5+1] - 4;
            for (int i_7 = 0; i_7 < PB_M-1; i_7++) {
                for (int i_8 = 0; i_8 < i_5; i_8++) {
                    D[i_5][i_8][i_7+1][i_7] = E[i_5][i_7+1][i_5][i_8] * E[i_8][i_5][i_7][i_4+1] + K[i_7+1][i_8+1][i_5] * 2;
                }
            }
        }
    }
...
kernel_4414331111_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
