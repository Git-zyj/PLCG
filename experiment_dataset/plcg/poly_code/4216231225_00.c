...
void kernel_4216231225_00(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
        ...
        for (int i_1 = 1; i_1 < PB_Q-1; i_1++) {
            for (int i_2 = max(1, i_0); i_2 < PB_L; i_2++) {
                for (int i_3 = 1; i_3 < -i_2+PB_L; i_3++) {
                    B[i_1-1][i_0][i_3-1][i_3+1] = C[i_3][i_0+1][i_1][0] - D[i_3+i_2][i_0][i_0][i_1] - C[i_2][i_0+1][i_1][i_3] * E[i_3+1][i_2-1][i_0] * B[i_3+1][i_0+1][i_2-1][i_2+1] + 5;
                }
                for (int i_4 = 1; i_4 < PB_Q-1; i_4++) {
                    B[i_2-1][i_0][i_4-1][i_4+1] = C[i_1-1][i_4-1][i_4][i_2-1] * D[i_0][i_2+1][i_1+1][i_2] + B[i_2-1][i_0+2][i_4-1][i_4+1] + 2;
                }
            }
        }
    }
...
kernel_4216231225_00(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
