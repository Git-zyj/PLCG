...
void kernel_3412252215_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        A[i_0] = E[i_0+1] * F[i_0-1] + E[i_0] - E[i_0+1] - 2;
        A[i_0+1] = E[2] * E[i_0] + E[i_0] + E[i_0-2] * E[i_0] + 1;
        for (int i_1 = 3; i_1 < -i_0+PB_P+1; i_1++) {
            A[i_0] = G[i_1][i_1+i_0-1] + G[i_1+i_0][0] + G[i_0][i_1] - G[i_1][i_0] * A[i_1+1] * 1;
            for (int i_2 = 1; i_2 < min(-i_0+PB_Q, PB_P-1); i_2++) {
                D[i_0][i_1-2][i_2] = H[i_2][i_2+1][i_1] - H[i_2-1][i_2][i_1] * I[i_1][i_2][i_0-1] * H[i_1-2][i_0][i_2+i_0] + D[i_0][i_1-2][i_2-1] + D[i_0][i_1-3][i_2-1] - D[i_0][i_1-1][i_2] + 3;
            }
        }
    }
#pragma endscop
...
kernel_3412252215_08(xa,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
