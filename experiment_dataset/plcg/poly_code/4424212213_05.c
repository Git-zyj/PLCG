...
void kernel_4424212213_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve)){
        ...
        for (int i_1 = 0; i_1 < PB_M; i_1++) {
            for (int i_2 = 2; i_2 < PB_P-2; i_2++) {
                for (int i_3 = 0; i_3 < PB_Q-2; i_3++) {
                    A[i_0-2][i_1][i_2+1][i_3+1] = E[i_1][i_3][i_2+2][i_1] - A[i_0-2][i_1][i_2+2][i_3+1] + A[i_2-2][i_1+1][i_3+2][i_0+1] + A[i_0-1][i_1+1][i_2+1][i_3+1] * 3;
                }
            }
        }
    }
        ...
        for (int i_9 = max(i_8, 1); i_9 < PB_M; i_9++) {
            for (int j_0 = 0; j_0 < PB_M; j_0++) {
                for (int j_1 = 1; j_1 < PB_M; j_1++) {
                    C[j_1-1][j_0][i_9] = C[i_9-1][j_1][j_0+1] + 3;
                }
            }
            for (int j_2 = 1; j_2 < PB_Q; j_2++) {
                for (int j_3 = 0; j_3 < PB_L; j_3++) {
                    D[i_8][i_8][j_2][j_3] = E[i_9][j_3][i_9][j_2-1] + D[i_8+1][i_8+1][j_2-1][j_3] + 3;
                }
            }
        }
    }
...
kernel_4424212213_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
