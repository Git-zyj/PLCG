...
void kernel_2216112321_02(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N-1; i_0++) {
        for (int i_1 = max(3, i_0); i_1 < PB_M; i_1++) {
            B[i_0-2][i_1-2] = B[i_0][i_1-2] - B[i_0][i_1-3] * 3;
            B[i_0][i_1-2] = C[i_1][i_0] - B[i_0+1][i_1-2] - 6;
        }
    }
#pragma endscop
...
kernel_2216112321_02(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
