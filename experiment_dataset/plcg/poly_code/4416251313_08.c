...
#pragma scop
        ...
        for (int i_4 = i_0; i_4 < PB_Q-1; i_4++) {
            for (int i_5 = 1; i_5 < -i_4+PB_Q; i_5++) {
                for (int i_6 = 1; i_6 < -i_0+PB_L; i_6++) {
                    B[i_0][i_4][i_5][i_6] = H[i_5][i_0+1][i_6][i_4-1] + F[i_6][i_4][i_5] * H[i_5][i_6][i_5][i_5-1] - H[i_5][i_6][i_0][i_5+i_4] - E[i_5][i_0-1][i_6][i_4] - H[i_5][i_0][i_4+1][i_6] - E[i_4-1][i_5-1][i_6+i_0][0] - B[i_6-1][i_5][i_0][i_4] + B[i_6-1][i_4][i_5][i_0] * B[i_0][i_4-1][i_5][i_6+1] * 5;
                }
            }
        }
    }
    for (int i_7 = 1; i_7 < PB_M-1; i_7++) {
        for (int i_8 = 1; i_8 < -i_7+PB_M; i_8++) {
            C[i_7][i_8-1] = I[0] + J[i_8][i_7-1] * J[i_8+i_7][i_8] * 3;
            for (int i_9 = 0; i_9 < -i_8+PB_M; i_9++) {
                D[i_7][i_8][i_9] = F[i_7][i_9][i_8+1] * K[i_9+i_8][i_7][i_9+1] * F[i_9][i_7-1][i_7-1] - C[i_7+1][i_8-1] * D[i_7+1][i_8-1][i_9] + D[i_7-1][i_9][i_8] * 2;
            }
        }
    }
#pragma endscop
