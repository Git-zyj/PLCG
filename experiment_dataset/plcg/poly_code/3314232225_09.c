    ...
    for (int i_3 = 0; i_3 < PB_L; i_3++) {
        for (int i_4 = 0; i_4 < PB_P-1; i_4++) {
            for (int i_5 = 2; i_5 < i_3; i_5++) {
                B[i_4][i_3][i_5+4] = G[i_3][i_4+1][i_5] - G[i_4][i_3][i_4] - H[i_4][i_5][i_5-2] * 4;
            }
        }
    }
#pragma endscop
...
kernel_3314232225_09(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
