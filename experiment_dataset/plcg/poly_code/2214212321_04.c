...
void kernel_2214212321_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_L; i_0++) {
        A[i_0-2] = A[i_0] - A[i_0-1] - A[i_0-3] * 3;
    }
...
kernel_2214212321_04(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
