...
void kernel_4234111313_08(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_0 = 2; i_0 < PB_N; i_0++) {
        for (int i_1 = 1; i_1 < min(-i_0+PB_N+1, PB_M); i_1++) {
            for (int i_2 = 0; i_2 < min(min(-i_1+PB_M, -i_0+PB_N), PB_M-1); i_2++) {
                B[i_2][i_1+i_0-1][i_1] = C[i_2+i_1][i_2][i_0] - B[i_1-1][i_2+i_0][i_2+1] - 3;
            }
        }
        for (int i_3 = 1; i_3 < min(min(-i_0+PB_N+1, i_0), PB_M-1); i_3++) {
            for (int i_4 = 1; i_4 < PB_N; i_4++) {
                B[i_4][i_3+i_0-1][i_3] = B[i_4-1][i_3+i_0-2][i_3-1] + B[i_4-1][i_3+i_0-1][i_3+1] * 5;
            }
        }
    }
#pragma endscop
...
kernel_4234111313_08(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
