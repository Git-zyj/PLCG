    ...
    for (int i_4 = 0; i_4 < PB_L; i_4++) {
        for (int i_5 = 2; i_5 < PB_L-2; i_5++) {
            for (int i_6 = 1; i_6 < min(PB_L, -i_5+PB_M); i_6++) {
                A[i_6-1][i_5-2] = F[i_6][i_5-1] + G[i_6+i_5][i_4][0] - G[i_4+2][i_6-1][i_5+2] - 2;
            }
        }
    }
    for (int i_7 = 1; i_7 < PB_L-2; i_7++) {
        for (int i_8 = 0; i_8 < -i_7+PB_P+1; i_8++) {
            for (int i_9 = 2; i_9 < PB_L-1; i_9++) {
                D[i_7][i_8][i_9+1] = H[i_9][i_7+2][i_8] - F[i_8][i_9-2] - H[i_8][i_9][i_8+i_7-1] + 3;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4432232115_01(xa,ya,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H)));
