...
void kernel_3236112223_09(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    ...
    for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
        for (int i_3 = 2; i_3 < min(i_2, PB_L-2); i_3++) {
            B[i_2][i_3][i_3-1] = C[i_2][i_3-2] * C[i_2][i_3+2] - B[i_2][i_3+2][i_3+1] * B[i_2+1][i_3-1][i_3-2] * 1;
        }
    }
#pragma endscop
...
kernel_3236112223_09(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
