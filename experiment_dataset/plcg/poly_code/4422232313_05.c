...
void kernel_4422232313_05(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = max(2, i_0); i_2 < PB_P-1; i_2++) {
                B[i_1-1][i_0+1][i_2+1][i_1+1] = E[i_1][i_0][i_2][i_0] - F[i_1][i_2][i_0] - B[i_2-2][i_0][i_1][i_2] * 1;
            }
        }
        for (int i_3 = 1; i_3 < PB_P; i_3++) {
            for (int i_4 = i_0; i_4 < -i_0+PB_P; i_4++) {
                for (int i_5 = max(i_4, 2); i_5 < PB_Q-1; i_5++) {
                    B[i_5-2][i_0][i_3][i_5] = E[i_3][i_5-2][i_0+2][i_4] * G[i_3][i_5][i_4+i_0][1] - B[i_5-1][i_0][i_3][i_5+1] + B[i_5-1][i_0-1][i_3][i_5+1] + B[i_5-2][i_0][i_3-1][i_5] - 5;
                }
            }
        }
    }
        ...
        for (int i_7 = 3; i_7 < PB_P-1; i_7++) {
            for (int i_8 = 1; i_8 < PB_Q; i_8++) {
                for (int i_9 = 0; i_9 < PB_P; i_9++) {
                    B[i_6-1][i_8-1][i_7+1][i_6+1] = H[i_7-2][i_6-1][i_9][i_8][i_8-1] + G[i_8][i_6][i_9][i_7] + 2;
                }
            }
            D[i_6][i_7-2] = I[i_7][i_6] - I[i_7][i_6+2] - J[i_7][0] * K[i_6] - D[i_6][i_7-3] - D[i_6-1][i_7-3] * 5;
        }
    }
#pragma endscop
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4422232313_05(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K)));
