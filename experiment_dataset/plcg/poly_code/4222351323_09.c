        ...
        for (int i_1 = 3; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 3; i_2 < PB_N-2; i_2++) {
                for (int i_3 = 1; i_3 < PB_P-1; i_3++) {
                    A[i_2+1][i_1-1][i_3+1][i_0] = C[i_2-1][i_3][i_0-1][i_1-1] - D[i_2][i_0-1][i_1][i_2-1] * C[i_2+1][i_1][i_3+1][i_0] * E[i_3-1][i_1+1][i_2] * D[i_1+1][i_3-1][i_0][i_2] * A[i_2+1][i_1-1][i_3+1][i_0-2] + A[i_2+1][i_1-3][i_3+1][i_0] * A[i_2+2][i_1+1][i_3+1][i_0] * A[i_2+2][i_1-2][i_3+1][i_0-2] + A[i_0+1][i_2-3][i_3+1][i_1] - 1;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        B[i_4+1] = F[i_4] - F[i_4] + G[i_4] * H[i_4] + B[i_4-1] + 1;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4222351323_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H)));
