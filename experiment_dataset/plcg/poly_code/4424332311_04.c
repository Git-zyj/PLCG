...
void kernel_4424332311_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        for (int i_1 = i_0; i_1 < -i_0+PB_M; i_1++) {
            A[i_1][i_0] = E[i_1] - F[i_1-1][i_1+i_0] - F[i_1+i_0][i_0] * F[i_1][i_1] * 3;
        }
        for (int i_2 = 1; i_2 < -i_0+PB_M; i_2++) {
            B[i_0][i_2] = G[i_0-2][i_2+i_0] - G[i_2+i_0-1][i_2+i_0] + B[i_0][i_2+1] * B[i_0-1][i_2] * B[i_0+1][i_2] * B[i_0+1][i_2-1] * 3;
        }
    }
        ...
        for (int i_4 = i_3; i_4 < PB_L-1; i_4++) {
            for (int i_5 = i_3; i_5 < PB_M; i_5++) {
                for (int i_6 = 2; i_6 < PB_M; i_6++) {
                    C[i_5][i_4][i_3][i_6-2] = H[i_6][i_3][i_4-1][0] + C[i_3][i_4+1][i_5][i_6-2] + C[i_5][i_4][i_3-1][i_6-2] + 4;
                }
            }
        }
        for (int i_7 = 1; i_7 < PB_M; i_7++) {
            for (int i_8 = 3; i_8 < PB_M; i_8++) {
                for (int i_9 = 2; i_9 < -i_8+PB_M; i_9++) {
                    D[i_3][i_9-2][i_3+1][i_7] = H[i_9+i_8][i_7][i_3][i_8+2] + I[i_8-1][i_3][i_7+2][i_9-1] - D[i_3-1][i_9-2][i_3][i_7-1] * D[i_3-1][i_8-3][i_3][i_7] + D[i_3+1][i_9-2][i_3+2][i_7+1] - D[i_7][i_8-3][i_7+1][i_9-1] + 3;
                }
            }
        }
    }
...
init_array(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4424332311_04(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I)));
