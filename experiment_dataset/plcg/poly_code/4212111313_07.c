...
void kernel_4212111313_07(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
        ...
        for (int i_1 = 0; i_1 < min(-i_0+PB_Q, PB_L-1); i_1++) {
            for (int i_2 = 2; i_2 < PB_P; i_2++) {
                for (int i_3 = 1; i_3 < PB_P; i_3++) {
                    A[i_2-1][i_1][i_3] = C[i_1][i_2][i_1+i_0][i_3] + A[i_2][i_1][i_3] - A[i_3-1][i_1+1][i_0] * A[i_2-2][i_1][i_3] * 4;
                }
            }
        }
    }
        ...
        for (int i_5 = 2; i_5 < PB_L-2; i_5++) {
            for (int i_6 = 0; i_6 < PB_Q; i_6++) {
                for (int i_7 = 2; i_7 < PB_L-1; i_7++) {
                    B[i_7+1][i_5-1][i_4][i_5] = C[i_6][i_7+1][i_5-1][i_4] + B[i_4+1][i_7-2][i_6][i_7-1] - B[i_5+2][i_7][i_4][i_7+1] + B[i_7][i_5-2][i_6][i_5-1] * 3;
                }
            }
        }
    }
...
kernel_4212111313_07(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
