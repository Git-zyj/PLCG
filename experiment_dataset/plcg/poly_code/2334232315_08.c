...
void kernel_2334232315_08(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
    ...
    for (int i_2 = 2; i_2 < PB_M-2; i_2++) {
        C[i_2+1] = E[i_2] + C[i_2+1] + C[i_2+2] + 1;
        C[i_2+1] = E[i_2-2] * E[i_2] + D[i_2] + E[i_2+2] * E[i_2] + D[i_2+1] * D[i_2-2] - C[i_2] + 3;
    }
#pragma endscop
...
kernel_2334232315_08(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
