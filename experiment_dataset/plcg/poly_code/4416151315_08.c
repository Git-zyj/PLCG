...
void kernel_4416151315_08(int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
        ...
        for (int i_1 = i_0; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_M-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_L; i_3++) {
                    D[i_3-1][i_2-1] = E[i_2-1][i_0-1][i_3][i_1] * F[i_2+1][i_1][i_1] - F[i_3][i_0][i_2] + E[i_2+i_1+1][i_3][i_0-1][i_0] + F[i_2-1][i_1][i_3] - 1;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L; i_4++) {
        for (int i_5 = 1; i_5 < min(i_4, -i_4+PB_L); i_5++) {
            for (int i_6 = 1; i_6 < PB_L; i_6++) {
                D[i_5][i_6-1] = F[i_6][i_4][i_5-1] - F[i_6][i_4][i_5] - F[i_6-1][i_5+i_4][1] * G[i_6-1][i_5] * D[i_6][i_4-1] - 3;
            }
        }
        C[i_4] = H[1] + C[i_4+1] + C[i_4-1] - C[i_4-1] + 2;
        for (int i_7 = 1; i_7 < min(i_4, -i_4+PB_M); i_7++) {
            D[i_4][i_7-1] = G[i_7][i_4] * G[i_4+1][i_7+1] + G[i_4][i_7] - H[i_7] + G[i_4+1][i_7-1] - G[i_7][i_4] * G[i_7+i_4][1] - C[i_7] * D[i_4][i_7] - 3;
        }
    }
#pragma endscop
...
kernel_4416151315_08(xd,yd,POLYBENCH_ARRAY(D), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
