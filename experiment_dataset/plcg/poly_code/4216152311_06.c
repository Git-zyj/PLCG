...
void kernel_4216152311_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P; i_0++) {
        for (int i_1 = 1; i_1 < min(-i_0+PB_M, PB_P-2); i_1++) {
            for (int i_2 = 2; i_2 < min(min(-i_0+PB_Q, PB_P-3), -i_1+PB_P-2); i_2++) {
                A[i_0][i_1][i_2+2] = C[i_2-2][i_1] * D[i_1+i_0][i_2][i_2] * D[i_1][i_2][i_2+i_0] - D[i_0][i_2-1][i_1] * D[i_0][i_1][i_2] - E[i_1][i_0][i_2+i_1+2][i_0] * A[i_0][i_1][i_2+3] - A[i_0][i_1+1][i_2+2] - A[i_0+1][i_2-1][i_1+2] * A[i_0-1][i_1][i_2+2] * A[i_0+1][i_1+1][i_2+2] * 4;
            }
            for (int i_3 = i_0; i_3 < PB_P-1; i_3++) {
                for (int i_4 = 2; i_4 < PB_M; i_4++) {
                    B[i_4][i_3-1][i_0][i_1+1] = E[i_1-1][i_0][i_3+1][i_1+2] * E[i_4-2][i_3][i_0][i_1-1] - D[i_4][i_3][i_1+i_0] - B[i_3][i_4-1][i_0][i_1+2] + 2;
                }
            }
        }
    }
...
kernel_4216152311_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
