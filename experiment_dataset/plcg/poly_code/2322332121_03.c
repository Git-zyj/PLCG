...
void kernel_2322332121_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        ...
        B[i_0] = E[2] * F[i_0+2] * E[i_0] - E[i_0-2] - 6;
        for (int i_2 = 2; i_2 < min(-i_0+PB_M+2, PB_M-1); i_2++) {
            C[i_2] = G[i_2][i_0] - H[i_2+i_0-2][i_0] - C[i_2-2] - C[i_2+1] + 6;
        }
    }
#pragma endscop
...
kernel_2322332121_03(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
