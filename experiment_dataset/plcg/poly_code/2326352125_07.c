...
void kernel_2326352125_07(int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-2; i_0++) {
        C[i_0][0] = D[i_0+1] * D[i_0] * D[i_0+2] * E[i_0] - E[i_0] - E[i_0] - 2;
        C[i_0+1][0] = D[i_0+1] * E[i_0] - E[i_0] * E[i_0+2] + 1;
    }
    for (int i_1 = 2; i_1 < PB_M; i_1++) {
        for (int i_2 = i_1; i_2 < min(PB_M-1, -i_1+PB_M+2); i_2++) {
            C[i_2][0] = F[i_2][i_1] * G[i_2+1][i_1] + G[i_2+i_1-2][i_1] + H[i_2][i_1] + C[i_2+1][0] + 6;
        }
    }
#pragma endscop
...
kernel_2326352125_07(xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
