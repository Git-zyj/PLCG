...
void kernel_2214112321_01(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_L-2; i_1++) {
        B[i_1] = B[i_1-1] - B[i_1+2] + B[i_1-2] - 3;
    }
#pragma endscop
...
kernel_2214112321_01(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
