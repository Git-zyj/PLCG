...
void kernel_4232112213_05(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
        ...
        for (int i_3 = 0; i_3 < PB_Q-3; i_3++) {
            for (int i_4 = 2; i_4 < -i_3+PB_P-3; i_4++) {
                for (int i_5 = 2; i_5 < -i_2+PB_P; i_5++) {
                    B[i_5-2][i_4][i_4+i_3+2][i_3+2] = C[i_3][i_4-2][i_5+i_2][i_4] * B[i_5-2][i_4][i_4+i_3+3][i_3+3] - B[i_5-1][i_4][i_4+i_3+1][i_3+1] + B[i_5-2][i_4-1][i_4+i_3+2][i_3+3] + 1;
                }
            }
        }
    }
...
kernel_4232112213_05(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
