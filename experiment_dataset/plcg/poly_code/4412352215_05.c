...
static void print_array(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,int ym,int zm,DATA_TYPE POLYBENCH_3D(M,xM,yM,zM,xm,ym,zm),int xn,int yn,DATA_TYPE POLYBENCH_2D(N,xN,yN,xn,yn))
{
int i_0, i_1, i_2, i_3, i_4;
...
void kernel_4412352215_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,int ym,int zm,DATA_TYPE POLYBENCH_3D(M,xM,yM,zM,xm,ym,zm),int xn,int yn,DATA_TYPE POLYBENCH_2D(N,xN,yN,xn,yn)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_Q-2; i_0++) {
        for (int i_1 = 1; i_1 < min(-i_0+PB_Q, PB_L-2); i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_L+1, PB_L-2); i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_Q-2; i_3++) {
                    A[i_2][i_3][i_3+i_1][i_0+1] = E[i_2][i_0][i_1][i_3+i_0+2] * E[i_1][i_3][i_3+1][i_2+i_0] - F[i_1-1][i_3][i_2][i_0-2] * F[i_1+2][i_3][i_1+i_0][i_0] - G[i_1][i_2+i_0-1][i_3][i_0] + G[i_3-1][i_2+2][i_1][i_0] + H[i_3-1][i_1][i_2-1][i_0-2][i_2+2] * A[i_2][i_3-1][i_3+i_1][i_0+1] + 2;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 2; i_5 < PB_M+1; i_5++) {
            for (int i_6 = 0; i_6 < -i_4+PB_L+1; i_6++) {
                D[i_5-1][i_6+i_4-1][i_4-1] = I[i_5-2][i_6][i_4] - 4;
            }
        }
        C[i_4] = J[i_4] - K[i_4] - L[i_4-1] - C[i_4-1] * C[i_4+1] - C[i_4-1] + 5;
        for (int i_7 = 2; i_7 < PB_L; i_7++) {
            for (int i_8 = 2; i_8 < min(-i_4+PB_L-1, -i_7+PB_M); i_8++) {
                D[i_7][i_8+i_4][i_4] = M[i_8+1][i_8+1][i_4] - M[i_8][i_7][i_4-1] - I[i_7][i_8+i_4-1][2] * M[i_8+1][i_8][i_7+1] * N[i_8+i_7][i_4] * N[i_7-2][i_8-2] * D[i_7-1][i_8+i_4][i_4] - D[i_7][i_8+i_4+1][i_4] + 4;
            }
        }
    }
#pragma endscop
