...
void kernel_4336211223_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_Q-1; i_0++) {
        for (int i_1 = 1; i_1 < min(i_0, -i_0+PB_P); i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_P+2; i_2++) {
                A[i_2][i_0][i_1+i_0] = D[i_1][i_2][i_0+1] + A[i_1+2][i_0-2][i_2+i_0-2] - A[i_0][i_2][i_2+i_1-1] - 6;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_P+1; i_3++) {
        for (int i_4 = 0; i_4 < min(-i_3+PB_P+1, PB_Q-1); i_4++) {
            for (int i_5 = i_3; i_5 < PB_Q+1; i_5++) {
                A[i_5][i_3][i_4+i_3-1] = D[i_3][i_5-1][i_4+1] + 4;
            }
        }
    }
    for (int i_6 = 2; i_6 < PB_Q+1; i_6++) {
        for (int i_7 = i_6; i_7 < -i_6+PB_P+2; i_7++) {
            for (int i_8 = i_6; i_8 < PB_Q-1; i_8++) {
                A[i_8][i_6-1][i_7+i_6-2] = D[i_7-1][i_8+1][i_6-1] + 1;
            }
        }
    }
#pragma endscop
...
kernel_4336211223_00(xa,ya,za,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D));
