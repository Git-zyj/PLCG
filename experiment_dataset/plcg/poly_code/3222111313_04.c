...
void kernel_3222111313_04(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L+1; i_0++) {
        for (int i_1 = 1; i_1 < PB_Q+1; i_1++) {
            B[i_0-2][i_1-1] = B[i_0-1][i_1-1] - 3;
        }
        for (int i_2 = i_0; i_2 < PB_L; i_2++) {
            B[i_0-1][i_2-1] = C[i_2+1][i_0] + B[i_2][i_0-1] - B[i_0-2][i_2-1] - 2;
        }
    }
#pragma endscop
...
kernel_3222111313_04(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
