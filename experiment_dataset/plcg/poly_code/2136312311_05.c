...
void kernel_2136312311_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P+1; i_0++) {
        for (int i_1 = 2; i_1 < PB_L; i_1++) {
            A[i_1-1][i_0-1][0] = B[i_1-2] + A[i_1][i_0-1][0] + A[i_1-1][i_0-2][0] + A[i_1-2][i_0-1][0] * 6;
        }
    }
#pragma endscop
...
kernel_2136312311_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
