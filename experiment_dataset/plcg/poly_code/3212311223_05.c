...
void kernel_3212311223_05(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_0 = 0; i_0 < PB_P; i_0++) {
        ...
        for (int i_2 = 0; i_2 < PB_L; i_2++) {
            for (int i_3 = 2; i_3 < PB_M-1; i_3++) {
                B[i_3][i_0] = C[i_3+1][i_2][i_0+1] + D[i_3][i_2][i_0] + B[i_3-2][i_0+2] * B[i_3-1][i_2] * 6;
            }
        }
    }
#pragma endscop
...
kernel_3212311223_05(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
