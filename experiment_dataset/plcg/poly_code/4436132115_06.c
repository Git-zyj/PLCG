...
void kernel_4436132115_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < PB_M; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_Q-2; i_3++) {
                    A[i_3][i_2][i_1][i_3+i_0+1] = E[i_2][i_1][i_3][i_0] - A[i_3][i_2][i_1-1][i_3+i_0+2] - 5;
                }
            }
            for (int i_4 = 1; i_4 < min(-i_1+PB_M, i_1); i_4++) {
                C[i_1][i_4+1][i_4-1] = F[i_4+i_1][i_4][i_0] + G[i_4][i_1] * G[i_4][i_1] * F[i_4][i_0+2][i_1] * 1;
            }
        }
        for (int i_5 = i_0; i_5 < PB_L-2; i_5++) {
            for (int i_6 = 1; i_6 < PB_L-1; i_6++) {
                for (int i_7 = i_5; i_7 < -i_6+PB_M; i_7++) {
                    C[i_7][i_6+1][i_6-1] = E[i_7][i_0-1][i_5][i_0] - E[i_7][i_7+i_6][i_5][i_0+1] + E[i_7+i_6][i_0+2][i_5+2][i_5+2] * E[i_7-1][i_5][i_0][i_6] + 2;
                }
            }
        }
    }
        ...
        for (int i_9 = i_8; i_9 < PB_L; i_9++) {
            for (int j_0 = 2; j_0 < PB_P; j_0++) {
                for (int j_1 = i_8; j_1 < PB_Q-1; j_1++) {
                    D[j_1-1][i_8-1][j_0][i_9] = E[j_1][j_0-2][i_9][i_8] * D[j_1-2][i_8-2][j_0][i_9-1] * D[i_8-1][i_9-1][j_0][j_1+1] - 4;
                }
            }
        }
    }
...
kernel_4436132115_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
