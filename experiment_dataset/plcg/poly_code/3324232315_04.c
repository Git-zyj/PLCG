    ...
    for (int i_3 = 1; i_3 < PB_L; i_3++) {
        for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
            for (int i_5 = i_3; i_5 < PB_L-1; i_5++) {
                B[i_3+1][i_4][i_5] = E[i_5+1][i_4+2][i_4+1] * E[i_3][i_5][i_3] - E[i_5][i_4+2][i_3] * E[i_4][i_5][i_3] - B[i_3+1][i_4+1][i_5] * B[i_3+2][i_4][i_5] * B[i_5+2][i_4-1][i_3] - 5;
            }
        }
        for (int i_6 = i_3; i_6 < PB_N-1; i_6++) {
            C[i_6][i_3] = C[i_6+1][i_3] + C[i_6][i_3-1] - 1;
        }
    }
#pragma endscop
...
kernel_3324232315_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
