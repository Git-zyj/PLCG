...
void kernel_2212112221_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    for (int i_0 = 4; i_0 < PB_P; i_0++) {
        ...
        B[i_0-2] = C[i_0] * A[i_0-2][i_0] + A[i_0-4][i_0-2] + A[i_0-3][i_0-1] * 5;
    }
#pragma endscop
...
kernel_2212112221_00(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
