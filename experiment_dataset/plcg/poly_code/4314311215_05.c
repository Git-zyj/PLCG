...
void kernel_4314311215_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P+1; i_0++) {
        for (int i_1 = 2; i_1 < min(PB_L, i_0); i_1++) {
            for (int i_2 = 0; i_2 < PB_P; i_2++) {
                A[i_1][i_0-1][i_1-1] = A[i_1-1][i_0-1][i_1-2] + 5;
            }
        }
    }
    for (int i_3 = 2; i_3 < PB_Q; i_3++) {
        for (int i_4 = 2; i_4 < PB_L; i_4++) {
            for (int i_5 = 1; i_5 < -i_3+PB_Q; i_5++) {
                A[i_4-1][i_5-1][i_4-2] = D[i_5][i_3][i_4-1] + D[i_4-1][i_5+i_3][i_4] + A[i_4][i_3-2][i_4-1] - 6;
                A[i_5][i_4][i_5-1] = 4;
            }
        }
    }
...
kernel_4314311215_05(xa,ya,za,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D));
