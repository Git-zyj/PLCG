...
void kernel_2416331215_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        A[i_0] = E[i_0+1] - E[i_0] - F[i_0] - 4;
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            A[i_1-1] = G[i_1][i_1-1] + F[i_1] - F[i_1-1] + A[i_1-1] + 5;
        }
    }
    for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
        for (int i_3 = 0; i_3 < min(i_2, -i_2+PB_M); i_3++) {
            D[i_3][i_2+1][i_3] = H[i_3+i_2][0] * 4;
            D[i_3][i_2][i_3] = E[i_3] + G[i_2+1][i_3] - G[i_3+1][i_2] + D[i_3][i_2+1][i_3] * D[i_3][i_2-1][i_3] * D[i_3+1][i_2][i_3+1] - 5;
        }
    }
#pragma endscop
...
kernel_2416331215_09(xa,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
