...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_L; i_1++) {
        for (int i_2 = 2; i_2 < min(PB_L, -i_1+PB_M-1); i_2++) {
            B[i_1-1][i_2] = F[i_2+i_1+1][i_2] + G[i_2][i_1-2] - B[i_1-2][i_2] * B[i_1][i_2] + B[i_2-2][i_1] * B[i_1+1][i_2-2] - 2;
        }
    }
    for (int i_3 = 1; i_3 < PB_M-2; i_3++) {
        A[i_3] = H[i_3] * H[i_3-1] * I[i_3] - H[i_3+2] + 2;
    }
    for (int i_4 = 2; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 1; i_5 < min(PB_P-3, -i_4+PB_M); i_5++) {
            for (int i_6 = 2; i_6 < min(min(-i_5+PB_M-2, PB_L), -i_4+PB_M+2); i_6++) {
                D[i_5+i_4][i_6][i_4+1] = F[i_6][i_5] + J[i_5-1][i_6-2][i_6-2] - K[i_6][i_5-1] - L[i_6][i_5+2][i_4] + J[i_5+1][i_6][i_4-1] + D[i_6+i_5+2][i_4+2][i_5+3] + D[i_5+i_4][i_6][i_5-1] + D[i_6+i_4-2][i_5][i_4-1] - 2;
            }
        }
    }
#pragma endscop
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_3432332323_08(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L)));
