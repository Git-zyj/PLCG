...
void kernel_4226332125_02(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
...
#pragma scop
    ...
    for (int i_2 = 3; i_2 < PB_M-2; i_2++) {
        for (int i_3 = 3; i_3 < -i_2+PB_M-2; i_3++) {
            B[i_3-2][i_3+i_2] = C[i_2+2][i_3] * C[i_3+2][i_2] * D[i_3+i_2+2][i_2+2] + C[i_2][i_3-2] + C[i_3+i_2][0] - B[i_3-3][i_3+i_2-3] - 6;
        }
    }
#pragma endscop
...
kernel_4226332125_02(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
