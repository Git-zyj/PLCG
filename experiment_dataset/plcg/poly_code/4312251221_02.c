...
void kernel_4312251221_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,int wg,DATA_TYPE POLYBENCH_5D(G,xG,yG,zG,vG,wG,xg,yg,zg,vg,wg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk)){
        ...
        for (int i_1 = 3; i_1 < -i_0+PB_M-1; i_1++) {
            for (int i_2 = 1; i_2 < i_0; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_1+PB_M, -i_0+PB_M-1); i_3++) {
                    A[i_1+i_0][i_2][i_3-1][i_2] = D[i_2-1][i_3][i_1] + E[i_3+i_1][i_0][i_3-1][i_2] + F[i_3][i_2][i_0-1][i_2-1] + G[i_0+1][i_1][i_2][i_2][i_3+i_0+1] * A[i_1+i_0+1][i_2][i_3-1][i_2] * A[i_3+i_0+1][i_2+1][i_1-3][i_2+1] * A[i_3+i_1-2][i_2][i_0-1][i_2] - 6;
                }
            }
            B[i_1] = H[i_1] * I[i_1+1][i_1+i_0-1] - I[i_0][i_1] - J[i_1-1][i_0] + 3;
        }
    }
        ...
        for (int i_5 = 1; i_5 < min(i_4, PB_M); i_5++) {
            for (int i_6 = 1; i_6 < -i_5+PB_M; i_6++) {
                for (int i_7 = 1; i_7 < -i_5+PB_M; i_7++) {
                    A[i_7+i_5][i_6][i_4][i_6] = D[i_5][i_4][i_7] * F[i_7+1][i_4][i_6][i_5+1] + E[i_6+i_5][i_4][i_4-1][i_7] + F[i_5][i_6+1][i_7][i_7-1] * K[i_6][i_7][i_5] + F[i_6-1][i_4-1][i_4][i_5-1] - 1;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4312251221_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K)));
