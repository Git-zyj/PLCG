...
void kernel_4316332315_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
        ...
        for (int i_1 = i_0; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 2; i_2 < PB_Q-1; i_2++) {
                for (int i_3 = i_2; i_3 < -i_1+PB_P; i_3++) {
                    B[i_1][i_2-1][i_0][i_0] = E[i_2-2][i_3+i_1][i_0+2][0] + F[i_1-1][i_0][i_0][i_2+1] - G[i_3][i_1][i_0] + F[i_1][i_0][i_3][i_2] + B[i_1][i_2-2][i_0][i_0] - B[i_1][i_3-2][i_2][i_2] * B[i_1+1][i_2-1][i_0][i_0] + B[i_1-1][i_2-1][i_0-1][i_0-1] - B[i_1][i_2][i_3-1][i_3-1] - B[i_1][i_2-1][i_3-1][i_3-1] + 2;
                }
            }
        }
    }
        ...
        for (int i_5 = max(i_4, 2); i_5 < PB_Q-1; i_5++) {
            for (int i_6 = 1; i_6 < PB_M-2; i_6++) {
                for (int i_7 = 2; i_7 < i_4; i_7++) {
                    B[i_4+1][i_6-1][i_5][i_5] = E[i_7][i_6][i_7][i_5-2] - F[i_7-2][i_4][i_6][i_5+1] * E[i_6][i_7][i_4+2][i_5] * G[i_6+2][i_5][i_4] * 5;
                }
            }
        }
    }
...
kernel_4316332315_03(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
