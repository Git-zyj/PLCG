...
void kernel_4426331313_00(int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 2; i_1 < -i_0+PB_L-1; i_1++) {
            for (int i_2 = 0; i_2 < min(min(-i_0+PB_N, -i_1+PB_L), PB_M-1); i_2++) {
                for (int i_3 = 1; i_3 < i_1; i_3++) {
                    D[i_2+1][i_3][i_0][i_1] = E[i_3+i_1][i_2+i_0][i_1][i_0+1] + F[i_2][i_0][i_3][i_1+i_0] + G[i_1-1][i_2+i_1][i_3-1][i_0] - 4;
                }
            }
            for (int i_4 = i_1; i_4 < PB_L-1; i_4++) {
                B[i_1+i_0][i_1-1][i_0] = H[i_4][1] * I[i_1+1][i_4+1][i_0-1] + B[i_4+i_1-1][i_1-2][i_4] - B[i_1+i_0+1][i_1-1][i_0+1] * B[i_1+i_0+1][i_1][i_0] - B[i_1+i_0-1][i_1-2][i_0] + 4;
            }
        }
    }
    for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
        for (int i_6 = 0; i_6 < i_5; i_6++) {
            C[i_6][i_5] = H[i_5][0] * C[i_6+1][i_5+1] - C[i_6+1][i_5] - 2;
        }
        for (int i_7 = max(1, i_5); i_7 < PB_L-1; i_7++) {
            for (int i_8 = 0; i_8 < PB_M; i_8++) {
                for (int i_9 = 0; i_9 < -i_7+PB_L+1; i_9++) {
                    D[i_8][i_7+1][i_9][i_5] = G[i_8][i_9+i_7-1][i_5][i_8] - G[i_9][i_7-1][i_5][i_8] * J[i_9][i_7-1][i_8] * G[i_9][i_5][i_8+1][i_7] + D[i_8][i_7+1][i_9][i_5+1] + 5;
                }
            }
        }
    }
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4426331313_00(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J)));
