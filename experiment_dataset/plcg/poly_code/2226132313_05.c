...
void kernel_2226132313_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        B[i_0] = C[i_0] + C[i_0] + B[i_0] - B[i_0-1] - 1;
    }
    for (int i_1 = 1; i_1 < PB_L; i_1++) {
        B[i_1] = C[i_1] * C[1] + C[i_1-1] - B[i_1+1] + 6;
    }
#pragma endscop
...
kernel_2226132313_05(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
