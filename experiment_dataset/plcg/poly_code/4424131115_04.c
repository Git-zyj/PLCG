...
void kernel_4424131115_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < PB_N+1; i_2++) {
                A[i_2-1][i_1][i_0+1] = E[i_0][i_1][i_0-1] - 4;
            }
        }
    }
    ...
    for (int i_4 = 1; i_4 < PB_M-2; i_4++) {
        for (int i_5 = 1; i_5 < PB_M-1; i_5++) {
            for (int i_6 = max(2, i_5); i_6 < min(-i_5+PB_M, PB_M-2); i_6++) {
                A[i_4-1][i_5][i_6+2] = E[i_6+i_5][i_6-1][i_4-1] - E[i_4+1][i_6+1][i_5+1] - E[i_5+1][i_4+1][i_6] + E[i_5-1][i_6+1][i_4-1] * E[i_5][1][i_4+1] + 2;
                for (int i_7 = 1; i_7 < PB_Q; i_7++) {
                    D[i_4+1][i_5-1][i_7][i_6-1] = G[i_5][i_4][i_7-1][i_6] + H[i_6-1][i_7+1][i_4+1][i_5][i_4+1] + E[i_7-1][i_4][i_5] - G[i_5][i_6][i_7][i_4+1] * D[i_4+2][i_5-1][i_7][i_6-1] + D[i_4+1][i_5-1][i_7][i_6-2] * D[i_4+1][i_5][i_7+1][i_6-1] * 4;
                }
            }
        }
    }
...
kernel_4424131115_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H));
