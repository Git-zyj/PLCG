...
void kernel_3234312115_02(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M+2; i_0++) {
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            B[i_1+1] = C[i_1-1][i_0] - C[i_0-2][i_1] - 4;
        }
    }
...
kernel_3234312115_02(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
