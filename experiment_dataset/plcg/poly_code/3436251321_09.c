...
void kernel_3436251321_09(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_P+3; i_0++) {
        for (int i_1 = i_0; i_1 < PB_P; i_1++) {
            A[i_1][i_1-1] = E[i_1][i_1] * F[i_0][i_1+1] + F[i_1][i_0] + F[i_1][i_0] - F[i_0][0] - 1;
        }
        B[i_0] = G[i_0] - H[i_0+1] - B[i_0+2] - B[i_0+1] + B[i_0-2] + B[i_0-1] - 5;
        for (int i_2 = 1; i_2 < PB_N; i_2++) {
            for (int i_3 = 2; i_3 < PB_P; i_3++) {
                C[i_3][i_0][i_2-1] = I[i_2][i_0-1][i_3] * J[i_2+1][i_3][i_0-1] * F[i_3-1][i_2] * F[i_2][i_0] * A[i_2][i_2-1] + C[i_3][i_0-2][i_2-1] + C[i_3-2][i_2-1][i_0-3] - 6;
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_N+1; i_4++) {
        for (int i_5 = i_4; i_5 < PB_P-1; i_5++) {
            for (int i_6 = 1; i_6 < PB_N; i_6++) {
                D[i_6][i_5-1][0] = F[i_5][i_4+1] - F[i_6][0] - I[i_5][i_4][i_6] - I[i_4-1][i_5-1][i_5] * F[i_4+1][1] + I[i_6][i_5][i_5] + A[i_5][i_5-1] - D[i_4][i_5+1][0] - D[i_4+1][i_6-1][0] * D[i_6-1][i_5-1][0] + 4;
            }
        }
    }
#pragma endscop
...
kernel_3436251321_09(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
