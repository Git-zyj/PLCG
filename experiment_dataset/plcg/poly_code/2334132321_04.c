...
void kernel_2334132321_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        A[i_0] = D[i_0] * D[i_0] * D[i_0-2] * D[i_0] - D[i_0+2] + D[i_0] + A[i_0+2] * 2;
        B[i_0] = A[i_0] - 5;
        for (int i_1 = i_0; i_1 < PB_N+2; i_1++) {
            B[i_0] = D[i_0] - B[i_1-2] - B[i_0] - B[i_0+1] * B[i_0+2] * 5;
        }
    }
#pragma endscop
...
kernel_2334132321_04(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
