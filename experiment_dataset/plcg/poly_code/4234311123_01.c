...
void kernel_4234311123_01(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd)){
        ...
        for (int i_1 = 0; i_1 < PB_N; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-2; i_2++) {
                for (int i_3 = 1; i_3 < PB_M; i_3++) {
                    B[i_1][i_2][i_0][i_3-1] = B[i_0-2][i_3][i_1][i_2+2] - 6;
                }
            }
        }
    }
        ...
        for (int i_5 = max(i_4, 1); i_5 < PB_L-1; i_5++) {
            for (int i_6 = 0; i_6 < PB_Q-1; i_6++) {
                for (int i_7 = 0; i_7 < -i_4+PB_L; i_7++) {
                    B[i_4][i_7][i_6][i_5+1] = C[i_5][i_6][i_4] * D[i_6][i_7+i_4][i_5-1][i_6+1] + 6;
                }
            }
        }
    }
...
kernel_4234311123_01(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D));
