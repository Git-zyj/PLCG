...
void kernel_2322231315_07(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
...
#pragma scop
    ...
    for (int i_2 = 1; i_2 < PB_L-1; i_2++) {
        B[i_2+1] = E[i_2] + D[i_2] * D[i_2-1] + E[i_2] + E[i_2] + 3;
        for (int i_3 = PB_L - 1; i_3 >= 1; i_3--) {
            C[i_2][i_3] = F[i_2-1][i_3-1] + G[i_3+1][i_3][i_2+1] + B[i_3+1] - C[i_2-1][i_3] + C[i_3][i_2-1] - C[i_2][i_3-1] - C[i_2+1][i_3] * C[i_2-1][i_3-1] + 1;
        }
    }
#pragma endscop
...
kernel_2322231315_07(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
