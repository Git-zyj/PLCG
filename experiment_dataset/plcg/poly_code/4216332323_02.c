        ...
        for (int i_1 = i_0; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-2; i_2++) {
                for (int i_3 = 0; i_3 < i_2; i_3++) {
                    B[i_1][i_2+2][i_3+1][i_0+1] = C[i_1+1][i_0][i_3][i_2] * 4;
                }
            }
        }
        for (int i_4 = i_0; i_4 < PB_P-3; i_4++) {
            for (int i_5 = 2; i_5 < PB_L-1; i_5++) {
                for (int i_6 = 1; i_6 < min(min(i_4, -i_5+PB_L), PB_M-2); i_6++) {
                    B[i_5][i_4+2][i_6+1][i_0] = D[i_6][i_0][i_4][i_4] - E[i_0][i_5][i_4][i_6-1][i_6] + F[i_4][i_6+i_5][i_0+1] - G[i_6][i_0+1][i_4][i_5-2] * G[i_4+2][i_5][i_0][i_6] + B[i_5][i_6+2][i_4-1][i_0] + B[i_6+2][i_5+1][i_4+3][i_0+1] * B[i_5][i_4+2][i_6+1][i_0-1] * 6;
                }
            }
        }
    }
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4216332323_02(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G)));
