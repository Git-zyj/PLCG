...
void kernel_4314252223_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 2; i_1 < PB_L+2; i_1++) {
            for (int i_2 = i_1; i_2 < PB_L; i_2++) {
                for (int i_3 = 2; i_3 < min(-i_1+PB_L+2, -i_2+PB_Q-2); i_3++) {
                    A[i_0+1][i_1][i_3-2][i_3+i_2+2] = D[i_1][i_2][i_0][i_3-2] * E[i_0][i_3][i_1] * E[i_2][i_3+i_1-2][0] * D[i_1][i_3][i_0+1][i_3+i_2+1] - D[i_2][i_3][i_0][i_1-2] + 6;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L; i_4++) {
        for (int i_5 = 1; i_5 < PB_L; i_5++) {
            for (int i_6 = 2; i_6 < min(-i_5+PB_Q-2, -i_4+PB_L); i_6++) {
                for (int i_7 = 2; i_7 < min(-i_6+PB_Q-2, -i_4+PB_L); i_7++) {
                    C[i_6-1][i_6][i_7-2] = F[i_5][i_6+i_4][i_7][i_6+i_5+2] * D[i_7][i_6-2][i_4][i_5] - G[i_7][i_5-1][i_6-2] * F[i_7][i_5][i_7][i_6] - H[i_6][i_5+2][i_4-1][i_7][i_6+i_5] * F[i_5][i_7+i_4][i_6][0] - F[i_6+i_5][i_7][i_4][i_4] - A[i_4+1][i_5-1][i_6-2][i_7+i_6+2] + C[i_5-1][i_5][i_7-2] - 2;
                }
            }
        }
        for (int i_8 = 1; i_8 < PB_L; i_8++) {
            for (int i_9 = 4; i_9 < PB_L; i_9++) {
                C[i_8-1][i_8][i_9-2] = I[i_4][i_8] + E[i_9-2][i_4][i_8] * C[i_8-1][i_8][i_9] - C[i_4-1][i_4][i_9-4] * 3;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4314252223_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I)));
