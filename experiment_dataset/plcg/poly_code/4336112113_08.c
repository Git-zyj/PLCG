...
void kernel_4336112113_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_7 = 2; i_7 < PB_L+2; i_7++) {
        for (int i_8 = 1; i_8 < PB_M; i_8++) {
            for (int i_9 = 1; i_9 < PB_M; i_9++) {
                C[i_9][i_8-1][i_9+1] = D[i_8][i_7-2][i_9] + C[i_9-1][i_8-1][i_9] - 4;
            }
        }
    }
#pragma endscop
...
kernel_4336112113_08(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
