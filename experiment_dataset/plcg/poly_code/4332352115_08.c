        ...
        for (int i_1 = 1; i_1 < PB_N; i_1++) {
            for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < PB_N; i_3++) {
                    A[i_2][i_0-1][i_3][1] = D[i_3][i_0+2][i_1][i_2] + D[i_1][i_2+1][i_2-1][i_0] + A[i_2][i_1-1][i_3+1][1] - 3;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 2; i_5 < i_4; i_5++) {
            for (int i_6 = 0; i_6 < -i_4+PB_L; i_6++) {
                A[i_5][i_4][i_6+1][1] = E[i_6][i_5][i_4] - F[i_6][i_6+i_4][0] - G[i_5-1][i_6+1][i_4-2] * F[i_6][i_4][i_5-2] - E[i_5][i_6][i_4] - G[i_5][i_6][i_4] + 2;
            }
        }
        for (int i_7 = 1; i_7 < -i_4+PB_L-1; i_7++) {
            for (int i_8 = 1; i_8 < PB_N-1; i_8++) {
                for (int i_9 = 0; i_9 < PB_L; i_9++) {
                    A[i_9][i_7-1][i_4][1] = H[i_9][i_8][i_7+i_4+1][i_8] + F[i_4-2][i_9][i_8+i_7] + D[i_8+1][i_9][i_7-1][0] + I[i_7][i_8-1][i_4+1][i_9] + D[i_4+1][i_8][i_9][i_7] + 5;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4332352115_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I)));
