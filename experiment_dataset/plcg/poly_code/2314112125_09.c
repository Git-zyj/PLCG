...
void kernel_2314112125_09(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N; i_0++) {
        for (int i_1 = -i_0+PB_N - 1; i_1 >= 2; i_1--) {
            B[i_1][i_1+i_0] = D[i_0-2][i_1-1] - B[i_1][i_1+i_0] - 6;
            B[i_1][i_1+i_0] = D[i_1-1][i_0] - B[i_1-2][i_1+i_0-2] * 4;
        }
    }
...
kernel_2314112125_09(xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
