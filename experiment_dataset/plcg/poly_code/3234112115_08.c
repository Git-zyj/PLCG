...
void kernel_3234112115_08(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        for (int i_1 = 0; i_1 < -i_0+PB_L; i_1++) {
            for (int i_2 = 1; i_2 < PB_N; i_2++) {
                B[i_2-1][i_1+i_0-1][i_0] = C[i_1][i_2][i_1+i_0] + C[i_1][i_0][i_1] + B[i_2][i_1+i_0][i_1+1] + 6;
            }
        }
    }
...
kernel_3234112115_08(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
