...
void kernel_3412211313_07(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P; i_0++) {
        for (int i_1 = 2; i_1 < PB_P+2; i_1++) {
            for (int i_2 = 2; i_2 < PB_P+2; i_2++) {
                A[i_2+1][i_0-1][i_1] = A[i_2+1][i_1-2][i_0+1] + A[i_2+2][i_0][i_1] - A[i_1+1][i_0-1][i_2+1] * A[i_1+1][i_2-2][i_0] + 6;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
        ...
        C[i_3][i_3+1] = C[i_3-1][i_3] - C[i_3+1][i_3+2] - 2;
...
kernel_3412211313_07(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E));
