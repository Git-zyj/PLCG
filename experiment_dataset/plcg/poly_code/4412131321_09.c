...
void kernel_4412131321_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh)){
...
#pragma scop
        ...
        for (int i_1 = 2; i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = 1; i_2 < PB_L; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_0+PB_Q, PB_L); i_3++) {
                    B[i_1+i_0][i_2][i_3] = F[i_3][i_2+i_1-1][i_0-1][i_3] + F[i_2][i_3][i_0+1][i_1-1] * F[i_2-1][i_1+1][i_0][i_3+i_0] * B[i_2+i_1-2][i_0][i_3] - B[i_2+i_1-1][i_3][i_0] + 5;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L-2; i_4++) {
        for (int i_5 = i_4; i_5 < -i_4+PB_L-2; i_5++) {
            C[i_4][i_5] = G[i_5+1][i_4+1] - C[i_4][i_5-2] - C[i_4-1][i_5-1] - C[i_4+1][i_5] + 1;
            for (int i_6 = 1; i_6 < PB_L-1; i_6++) {
                for (int i_7 = 1; i_7 < -i_5+PB_L+1; i_7++) {
                    D[i_4-1][i_5+i_4][i_6][i_7-1] = F[i_7][i_5][i_6-1][i_4] - F[i_6+1][i_4-1][i_5][i_7] - H[i_5][i_7-1][i_6][i_4][0] * F[i_7+i_5-1][i_4+1][i_4][i_6] * F[i_5][i_6+1][i_4][i_5] + F[i_7+1][i_6][i_5-1][i_4] * D[i_4+1][i_5+i_4+2][i_6+2][i_7-1] * D[i_4][i_5+i_4+1][i_6+1][i_7-1] * D[i_4-1][i_5+i_4-2][i_6][i_7-1] + 6;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4412131321_09(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H)));
