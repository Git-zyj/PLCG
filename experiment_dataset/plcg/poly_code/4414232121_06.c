...
void kernel_4414232121_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-2; i_0++) {
        A[i_0-1] = A[i_0] + B[i_0+2] - 5;
        B[i_0+2] = E[i_0] + F[i_0+1] + E[i_0+2] - E[i_0] * F[2] * 2;
    }
    for (int i_1 = 2; i_1 < PB_L; i_1++) {
        for (int i_2 = 1; i_2 < -i_1+PB_L; i_2++) {
            for (int i_3 = 1; i_3 < -i_2+PB_Q-2; i_3++) {
                for (int i_4 = i_1; i_4 < -i_1+PB_L; i_4++) {
                    C[i_4][i_3][i_3+i_2][i_1] = G[i_3][0][i_4+i_2][i_1] + H[i_2+2][i_2+i_1][i_4][i_3] * H[i_1+2][i_3+i_2][i_2][i_4+2] * D[i_2][i_1-2][i_4][i_1-2] - 6;
                    D[i_2][i_1][i_4][i_1] = H[i_1][i_4][i_2+1][i_3+1] + H[i_2][i_4+i_1][i_3+1][i_2] - G[i_1+2][i_3][i_4][i_3+i_2+2] + C[i_4][i_3-1][i_3+i_2-1][i_1] + 3;
                }
            }
        }
    }
...
kernel_4414232121_06(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
