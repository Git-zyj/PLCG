...
void kernel_4416151225_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_M+1; i_1++) {
            for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_0+PB_M, i_1); i_3++) {
                    A[i_2-1][i_1+1][i_3+1][i_0] = E[i_2+1][i_3+i_0][i_3+i_1][i_1] - E[i_3+i_1][i_2][i_1][0] + E[i_3][i_2][i_1][i_0] - E[i_2+1][i_0][i_1-1][0] * E[i_0][i_2][i_1][i_3] * A[i_1-1][i_2+1][i_3+1][i_0+2] * A[i_3-1][i_1+1][i_2][i_0+1] - 6;
                }
            }
            B[i_0-1][i_0] = F[i_0][i_0] - F[i_1+1][i_0] * F[i_1+i_0-1][i_1-1] - B[i_0-2][i_0-1] + 1;
        }
    }
        ...
        for (int i_5 = 1; i_5 < min(i_4, PB_L-1); i_5++) {
            for (int i_6 = 0; i_6 < -i_5+PB_M-1; i_6++) {
                for (int i_7 = 1; i_7 < i_5; i_7++) {
                    A[i_4-3][i_5][i_7+1][i_6] = E[i_5-1][i_6][i_7][i_4] * G[i_6+1][i_7][i_5] - E[i_7+1][i_4][i_6][i_5-1] * E[i_5][i_4][i_7+1][i_6] + E[i_6+i_5+1][i_7-1][i_6][i_4] - G[i_7-1][i_5+1][i_6] * 5;
                }
            }
        }
        B[i_4-1][i_4] = H[i_4-1] + H[i_4] - H[1] - H[i_4] * H[i_4-1] + 1;
    }
#pragma endscop
...
kernel_4416151225_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
