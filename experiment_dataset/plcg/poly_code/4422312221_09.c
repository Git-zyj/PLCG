        ...
        for (int i_1 = 0; i_1 < -i_0+PB_M+2; i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_M; i_2++) {
                for (int i_3 = 0; i_3 < i_0; i_3++) {
                    A[i_1+i_0-2][i_2][0] = A[i_2+i_1][i_0][0] + 1;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-1; i_4++) {
        for (int i_5 = 2; i_5 < PB_P; i_5++) {
            for (int i_6 = 0; i_6 < min(-i_5+PB_L, -i_4+PB_L); i_6++) {
                B[i_4][i_5][i_5] = B[i_5-2][i_6][i_6] * 2;
                C[i_4][i_6+i_4][i_5] = E[i_6+i_5][i_4-1][i_6] - C[i_4][i_6+i_4][i_5-1] + C[i_4-2][i_6+i_4-2][i_5] + 5;
            }
        }
        for (int i_7 = 0; i_7 < -i_4+PB_L-1; i_7++) {
            for (int i_8 = 0; i_8 < -i_4+PB_M-1; i_8++) {
                D[i_8+i_7][i_7+i_4] = D[i_8+i_4+1][i_7+i_4+1] + D[i_8+i_4+1][i_7+i_4] - 3;
            }
        }
    }
#pragma endscop
...
kernel_4422312221_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
