...
void kernel_4334111121_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
        ...
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_L; i_2++) {
                for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
                    A[i_2][i_3][i_3][i_0] = D[i_3+1][i_2+i_1][i_0][i_3] * A[i_3-1][i_0][i_0][i_1] * 3;
                }
            }
        }
        B[i_0+1] = E[i_0] - B[i_0+3] + B[i_0] + 6;
    }
    for (int i_4 = 0; i_4 < PB_L; i_4++) {
        for (int i_5 = i_4; i_5 < -i_4+PB_N; i_5++) {
            for (int i_6 = i_5; i_6 < PB_M; i_6++) {
                for (int i_7 = 0; i_7 < -i_6+PB_M; i_7++) {
                    C[i_5+i_4][i_7+i_6][i_4][i_6] = 5;
                }
            }
        }
    }
...
kernel_4334111121_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
