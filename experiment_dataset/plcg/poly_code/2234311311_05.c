...
void kernel_2234311311_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_P; i_0++) {
        for (int i_1 = max(1, i_0); i_1 < -i_0+PB_P; i_1++) {
            B[i_1] = C[i_1][i_1+i_0] - B[i_1-1] - B[i_1] + 3;
        }
    }
...
kernel_2234311311_05(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
