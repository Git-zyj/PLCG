        ...
        for (int i_7 = 1; i_7 < PB_M+1; i_7++) {
            for (int i_8 = i_6; i_8 < PB_L-1; i_8++) {
                for (int i_9 = 2; i_9 < PB_L+2; i_9++) {
                    A[i_7-1][i_6][i_8+1][i_6] = E[i_7-1][i_9-2][i_8] * 5;
                }
            }
        }
    }
...
kernel_4436312111_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
