...
void kernel_2112131311_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_N - 1; i_0 >= 1; i_0--) {
        A[i_0] = B[i_0] + B[i_0] + B[i_0-1] * A[i_0+1] + A[i_0-1] + A[i_0-1] + 4;
    }
#pragma endscop
...
kernel_2112131311_04(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
