...
void kernel_3222111223_08(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    for (int i_0 = 0; i_0 < PB_N; i_0++) {
        ...
        for (int i_2 = 0; i_2 < PB_M-2; i_2++) {
            A[i_0][i_2+1] = C[1] - A[i_0][i_2] - A[i_0][i_2+2] + 6;
        }
    }
#pragma endscop
...
kernel_3222111223_08(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
