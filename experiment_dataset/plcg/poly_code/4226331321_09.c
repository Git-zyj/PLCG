        ...
        for (int i_1 = 0; i_1 < -i_0+PB_P; i_1++) {
            for (int i_2 = max(2, i_0); i_2 < PB_L-2; i_2++) {
                for (int i_3 = 0; i_3 < -i_2+PB_L; i_3++) {
                    A[i_2][i_1+i_0][i_1+1][i_3] = C[i_0][i_3+i_2][1][i_1+1] - D[i_2][i_3][i_1][i_0+1] * E[i_2+1][i_3][i_1+1] - F[i_0][i_2][i_3][i_1] - A[i_2-2][i_1+i_0-1][i_1][i_3] * A[i_2+2][i_3+i_1][i_1+1][i_0] - A[i_2][i_1+i_0-1][i_1][i_3] - 4;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L; i_4++) {
        B[i_4] = G[i_4] - H[i_4] + B[i_4-2] + B[i_4-1] + 2;
    }
#pragma endscop
...
kernel_4226331321_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
