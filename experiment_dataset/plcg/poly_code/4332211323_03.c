...
void kernel_4332211323_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
        ...
        for (int i_2 = 0; i_2 < PB_Q-1; i_2++) {
            for (int i_3 = 1; i_3 < PB_M; i_3++) {
                for (int i_4 = 0; i_4 < PB_L-1; i_4++) {
                    C[i_3][i_4][i_1][i_2+1] = C[i_3-1][i_4][i_1][i_2+1] + C[i_3][i_4+1][i_1][i_2+1] * C[i_3-1][i_4+1][i_1][i_2+1] * 3;
                }
            }
        }
    }
...
kernel_4332211323_03(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
