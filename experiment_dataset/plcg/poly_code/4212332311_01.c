        ...
        for (int i_1 = 2; i_1 < -i_0+PB_L+1; i_1++) {
            for (int i_2 = 1; i_2 < i_1; i_2++) {
                for (int i_3 = 1; i_3 < min(i_0, -i_2+PB_M); i_3++) {
                    A[i_2-1][i_1][i_3][i_1+i_0] = C[i_3+i_2][i_1+i_0-1][i_3-1][i_2+1] * D[i_1][i_2-1][i_0+2][i_3] + D[i_1-2][i_2+2][i_3][i_0] - 2;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
            B[i_4] = E[i_4] * F[i_4][i_0] - G[i_0-2] - B[i_4-1] * B[i_4+1] + B[i_4+1] * B[i_4+1] + B[i_4-1] + B[i_4+1] + 3;
        }
    }
#pragma endscop
...
kernel_4212332311_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
