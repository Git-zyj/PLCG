...
void kernel_3414151313_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        A[i_0] = E[i_0] - E[i_0+1] + E[i_0-1] + E[i_0+1] - A[i_0-1] - A[i_0+1] + 5;
        for (int i_1 = 0; i_1 < min(-i_0+PB_M, PB_L); i_1++) {
            B[i_1] = E[i_1] + E[i_1+i_0] * F[i_0-1][i_1] + F[i_1][0] + G[i_1+i_0][i_1][i_0] * A[i_1+1] * A[i_0-1] + B[i_1+1] + 2;
        }
    }
    for (int i_2 = 2; i_2 < PB_L; i_2++) {
        B[i_2-1] = E[1] + E[i_2] + E[i_2] * E[i_2] + A[i_2] + 5;
        for (int i_3 = 1; i_3 < PB_L-1; i_3++) {
            for (int i_4 = 2; i_4 < min(PB_L-1, -i_2+PB_P); i_4++) {
                D[i_3+1][i_2][i_4-1][i_3] = G[i_3+1][i_4][i_2] - G[i_3][i_4-1][i_2+1] - H[i_3][i_2-1][i_4][1] - G[i_3-1][i_2][i_4+i_2] + G[i_3][i_2-1][i_4] - D[i_3+1][i_2+1][i_4-2][i_3] + D[i_3+1][i_2][i_4][i_3] + D[i_4+1][i_3][i_2-2][i_4] - 4;
            }
        }
    }
#pragma endscop
...
kernel_3414151313_00(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
