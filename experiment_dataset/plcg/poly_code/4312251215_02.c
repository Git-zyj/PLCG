        ...
        for (int i_1 = max(1, i_0); i_1 < -i_0+PB_M-1; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_1+PB_M+1, PB_L-1); i_2++) {
                for (int i_3 = 2; i_3 < -i_2+PB_L-1; i_3++) {
                    A[i_1+i_0][i_2-1][i_0][i_3+1] = D[i_0][i_3-1][i_2+i_1-1][1] * E[i_1][i_3+i_2+1][i_0][i_3-1] + D[i_3][i_1][i_0+1][i_2-1] + D[i_2][i_1-1][i_3][i_0] + D[i_2-1][i_3][i_0][i_1] - A[i_2+i_1-1][i_3][i_1][i_0+1] * A[i_1+i_0+1][i_2-1][i_0][i_3+1] - A[i_1+i_0+1][i_3-2][i_0][i_2+1] + 5;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L; i_4++) {
        B[i_4+1] = F[i_4+1] * F[i_4] * G[i_4+1] - F[i_4] * 3;
        for (int i_5 = 1; i_5 < -i_4+PB_L; i_5++) {
            for (int i_6 = 1; i_6 < -i_4+PB_M; i_6++) {
                for (int i_7 = 0; i_7 < -i_4+PB_M-1; i_7++) {
                    A[i_7+i_4+1][i_5-1][i_4][i_6] = D[i_5-1][i_7+i_4-1][i_6][i_6] * D[i_6+i_4][i_7+1][i_5][0] * H[i_6-1][i_7][i_7+i_5+1] * E[i_5][i_4][i_7][i_5] + I[i_7+1][i_5+i_4][i_6-1] * 2;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4312251215_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
