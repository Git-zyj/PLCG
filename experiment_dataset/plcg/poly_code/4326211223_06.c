...
void kernel_4326211223_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
        ...
        for (int i_1 = 0; i_1 < -i_0+PB_P-1; i_1++) {
            for (int i_2 = 1; i_2 < i_1; i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_P-1; i_3++) {
                    A[i_1][i_2+i_1][i_3+i_0+1][i_3] = D[i_1+i_0][i_3][i_3+1][i_2-1] + A[i_2][i_3+i_2+1][i_1+i_0+1][i_1] - A[i_1][i_2+i_1][i_3+i_0-2][i_3-1] + A[i_2][i_3+i_2-1][i_1+i_0+1][i_1] - A[i_1][i_2+i_1+2][i_3+i_0+1][i_3] * 6;
                }
            }
        }
        B[i_0] = E[i_0] * B[i_0+2] * B[i_0-2] * 4;
    }
    for (int i_4 = 0; i_4 < PB_L; i_4++) {
        for (int i_5 = i_4; i_5 < PB_P; i_5++) {
            for (int i_6 = max(1, i_5); i_6 < PB_P+1; i_6++) {
                for (int i_7 = 0; i_7 < PB_Q; i_7++) {
                    C[i_4][i_5][i_6-1][i_7] = 2;
                }
            }
        }
    }
...
kernel_4326211223_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
