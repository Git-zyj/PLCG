...
void kernel_4224312223_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
        ...
        for (int i_1 = 0; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 1; i_2 < PB_P-1; i_2++) {
                for (int i_3 = i_1; i_3 < PB_P-2; i_3++) {
                    A[i_3][i_0][i_2+1] = A[i_1+2][i_2-1][i_3+2] - B[i_2-1][i_3][i_0+1] + 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_N-1; i_4++) {
        for (int i_5 = 0; i_5 < PB_L-1; i_5++) {
            for (int i_6 = 0; i_6 < PB_L; i_6++) {
                B[i_4-1][i_6][i_5+1] = C[i_5][i_6] - A[i_6][i_5][i_4+1] + B[i_4+1][i_6][i_5+1] - 4;
            }
        }
    }
#pragma endscop
...
kernel_4224312223_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
