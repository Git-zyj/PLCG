...
void kernel_3232211221_06(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-4; i_0++) {
        ...
        for (int i_2 = 0; i_2 < min(-i_0+PB_M-2, i_0); i_2++) {
            B[i_2+i_0+1][i_0-1] = C[i_0][i_0] + D[i_0] - B[i_2+i_0][i_0-1] + B[i_2+i_0+2][i_0-2] - 4;
        }
    }
#pragma endscop
...
kernel_3232211221_06(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
