...
void kernel_2234111325_08(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        for (int i_1 = 2; i_1 < PB_L; i_1++) {
            A[i_0-1][i_1] = C[i_1+1][i_0] * A[i_1-1][i_0-2] * A[i_0+1][i_1] * A[i_1-2][i_0-1] - 4;
        }
        for (int i_2 = i_0; i_2 < PB_L; i_2++) {
            A[i_0-1][i_2] = C[i_2+1][i_0] - 2;
        }
    }
#pragma endscop
...
kernel_2234111325_08(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C));
