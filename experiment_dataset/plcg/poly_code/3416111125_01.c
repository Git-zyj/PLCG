...
void kernel_3416111125_01(int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf)){
    ...
    for (int i_3 = 1; i_3 < PB_Q; i_3++) {
        for (int i_4 = 0; i_4 < i_3; i_4++) {
            for (int i_5 = 0; i_5 < i_3; i_5++) {
                C[i_3][i_5][i_4] = E[i_4][i_3][i_5] + 5;
            }
        }
        for (int i_6 = 0; i_6 < PB_L-1; i_6++) {
            for (int i_7 = 0; i_7 < PB_M-2; i_7++) {
                C[i_3][i_7][i_6] = C[i_3][i_7+2][i_6] - C[i_3][i_7][i_6+1] + 3;
            }
        }
        D[i_3-1] = F[i_3] + F[i_3+1] - F[i_3+1] + 4;
    }
#pragma endscop
...
kernel_3416111125_01(xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F));
