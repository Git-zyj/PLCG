...
void kernel_2416232325_07(int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 4; i_1 < min(-i_0+PB_L-2, i_0); i_1++) {
            D[i_1-2] = E[i_0] * F[i_0-2][i_1+i_0+2] + D[i_1-2] * 5;
            D[i_1-4] = G[i_1-1][i_0] + F[i_1][i_0+1] + D[i_1-2] * 6;
        }
        for (int i_2 = 2; i_2 < min(-i_0+PB_M-2, i_0); i_2++) {
            C[i_0][i_2+i_0] = F[i_2][0] - G[i_0][i_2] + H[i_2+i_0+2][i_2][i_0] * C[i_0][i_2+i_0+2] + D[i_2-2] + 2;
        }
    }
    for (int i_3 = 4; i_3 < PB_M; i_3++) {
        D[i_3-2] = I[i_3] - E[i_3] + I[i_3] * E[i_3] * D[i_3-4] - D[i_3-3] * 2;
    }
#pragma endscop
...
init_array(xd,POLYBENCH_ARRAY(D), xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_2416232325_07(xd,POLYBENCH_ARRAY(D), xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xd,POLYBENCH_ARRAY(D), xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I)));
