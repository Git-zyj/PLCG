...
void kernel_4136311125_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb)){
        ...
        for (int i_1 = max(1, i_0); i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < PB_M; i_2++) {
                for (int i_3 = max(1, i_2); i_3 < PB_M-2; i_3++) {
                    A[i_3][i_1][i_2] = B[i_2][i_3-1][i_1-1] + A[i_3+2][i_1][i_2] - 4;
                }
            }
        }
    }
...
kernel_4136311125_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B));
