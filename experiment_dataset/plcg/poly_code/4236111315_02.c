...
void kernel_4236111315_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
...
#pragma scop
        ...
        for (int i_1 = max(2, i_0); i_1 < PB_M; i_1++) {
            for (int i_2 = max(1, i_0); i_2 < PB_M-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_M; i_3++) {
                    A[i_1-1][i_2][i_3] = A[i_3-1][i_2-1][i_1] * A[i_1-2][i_2+1][i_3] - 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 0; i_5 < min(i_4, -i_4+PB_M-1); i_5++) {
            B[i_5+i_4][i_4] = C[i_5+1] + D[i_4][i_5] * B[i_5+i_4+1][i_4+1] * B[i_5+i_4][i_4-1] * B[i_5+i_4+1][i_4] + 1;
        }
    }
#pragma endscop
...
kernel_4236111315_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
