...
void kernel_4432131211_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        A[i_0] = E[i_0+1] * E[i_0] * E[i_0] - E[0] - A[i_0+1] + 1;
    }
        ...
        for (int i_2 = 1; i_2 < PB_N; i_2++) {
            for (int i_3 = max(2, i_2); i_3 < -i_2+PB_Q-1; i_3++) {
                for (int i_4 = 1; i_4 < -i_3+PB_Q; i_4++) {
                    B[i_1][i_3-1][i_4+i_3][i_2-1] = F[i_2][i_4][i_3] - B[i_4+1][i_3][i_3+i_2+1][i_1-2] + B[i_1][i_3-2][i_4+i_3-2][i_2-1] * B[i_1+1][i_3-1][i_3+i_2][i_4-1] + 6;
                }
            }
        }
    }
        ...
        for (int i_7 = 0; i_7 < -i_6+PB_P-1; i_7++) {
            for (int i_8 = 1; i_8 < PB_P; i_8++) {
                for (int i_9 = 0; i_9 < PB_M; i_9++) {
                    D[i_9][i_8][i_7+i_6+1][0] = G[i_7+1][i_6+1][i_8][i_7] + G[i_6+1][i_7][i_9][i_8] - H[i_6][i_9][i_8-1][i_7][i_6+1] - G[i_9][i_8-1][i_6][i_7] + 3;
                }
            }
        }
    }
...
kernel_4432131211_01(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H));
