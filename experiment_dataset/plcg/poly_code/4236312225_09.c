...
void kernel_4236312225_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = max(1, i_0); i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_0+PB_Q-2, i_0); i_3++) {
                    A[i_2][i_1][i_3+i_0][0] = C[i_2][i_1][0][i_1] + D[i_3][i_1-1][i_2-1] + A[i_2+1][i_1][i_3+i_0+2][0] - 6;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < min(PB_Q-2, -i_4+PB_Q+2); i_5++) {
            for (int i_6 = 0; i_6 < i_5; i_6++) {
                for (int i_7 = 0; i_7 < -i_4+PB_Q; i_7++) {
                    A[i_6+1][i_5+2][i_7+i_4][0] = A[i_7][i_6][i_5+i_4-2][0] * 1;
                }
            }
        }
    }
...
kernel_4236312225_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
