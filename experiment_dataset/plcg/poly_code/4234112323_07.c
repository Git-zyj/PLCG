...
void kernel_4234112323_07(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 4; i_1 < i_0; i_1++) {
            for (int i_2 = 2; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < PB_M-1; i_3++) {
                    A[i_2][i_1-2][i_3] = C[i_2][i_0+2][i_1] + A[i_3][i_1-4][i_2] + A[i_3+1][i_1-2][i_0-1] + A[i_2+1][i_1-2][i_3] + A[i_3][i_2-2][i_1+1] + 4;
                }
            }
        }
    }
...
kernel_4234112323_07(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
