...
void kernel_2216111113_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
kernel_2216111113_05(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
