...
void kernel_3326312313_08(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 3; i_1 < PB_M+1; i_1++) {
        C[i_1-2] = D[i_1+2] - C[i_1-2] * C[i_1-1] * C[i_1-3] + 3;
        C[i_1-2] = D[i_1+2] - 5;
    }
#pragma endscop
...
kernel_3326312313_08(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
