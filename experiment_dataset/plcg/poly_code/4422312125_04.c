        ...
        for (int i_1 = i_0; i_1 < PB_P-4; i_1++) {
            for (int i_2 = 1; i_2 < PB_M+1; i_2++) {
                for (int i_3 = 0; i_3 < PB_M; i_3++) {
                    D[i_0-2][i_3][i_1+4][i_1] = E[i_2-1][i_0][i_3][i_1+1] - 5;
                }
            }
        }
        B[i_0-2] = F[i_0] - G[i_0] * B[i_0-3] - 5;
    }
    for (int i_4 = 1; i_4 < PB_M; i_4++) {
        C[i_4] = C[i_4-1] * 4;
        for (int i_5 = 2; i_5 < PB_P-2; i_5++) {
            for (int i_6 = 2; i_6 < -i_5+PB_L+1; i_6++) {
                D[i_6-2][i_4][i_5+2][i_5-2] = H[i_6+i_5-1][i_4][i_6] * 2;
            }
        }
    }
#pragma endscop
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4422312125_04(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H)));
