    ...
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        ...
        for (int i_1 = max(2, i_0); i_1 < PB_M; i_1++) {
            for (int i_2 = i_0; i_2 < min(-i_0+PB_M, -i_1+PB_M); i_2++) {
                B[i_2+i_1-1][i_1+1] = F[i_0-1][i_2][i_1] * G[i_1][i_2+1] + F[i_2+i_1][i_0-1][i_1] - B[i_2+i_0][i_2+2] - B[i_2+i_1][i_1+2] - B[i_2+i_1-2][i_1+1] * B[i_2+i_1-2][i_1] * B[i_2+i_1][i_1+1] * 5;
            }
        }
    }
    for (int i_3 = 2; i_3 < PB_M-1; i_3++) {
        A[i_3+1] = H[i_3] - H[i_3] - E[i_3+1] * E[i_3] - H[i_3-1] - H[i_3] * 4;
        for (int i_4 = 0; i_4 < PB_P; i_4++) {
            for (int i_5 = i_3; i_5 < -i_3+PB_M+2; i_5++) {
                B[i_5+i_3-2][i_5] = I[i_5-1][i_3-1][i_4] * I[i_5][i_4][i_3+1] * 6;
            }
        }
    }
#pragma endscop
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_3416231315_02(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
