        ...
        for (int i_1 = 2; i_1 < PB_M; i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_M; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_0+PB_M, -i_1+PB_P); i_3++) {
                    B[i_1-1][i_3][i_2+3][i_1-1] = D[i_3+i_0][i_1][i_3][i_2] + E[i_2][i_1-2][i_3+i_1] - F[i_0][i_3+2][i_1-1][i_2] + F[i_3+1][i_0-2][i_3+i_1][i_2] * E[i_2+i_1][i_3+i_0-2][i_3-1] - F[i_1][i_3+i_2+1][i_0][i_1] - F[i_1][i_0][i_3][i_1] + B[i_3][i_1][i_2+2][i_3] * 1;
                }
            }
        }
    }
        ...
        for (int i_5 = 2; i_5 < PB_M; i_5++) {
            for (int i_6 = 0; i_6 < -i_4+PB_M+1; i_6++) {
                for (int i_7 = 0; i_7 < PB_L; i_7++) {
                    B[i_4][i_5][i_6+2][i_4] = G[i_6+i_4-1][i_5][i_7][i_4+1][0] * F[i_5][i_6][i_4][i_5] + F[i_6+1][i_4-2][i_5-2][i_7] * B[i_4+1][i_5][i_6+1][i_4+1] - 1;
                }
            }
        }
        for (int i_8 = 2; i_8 < min(i_4, -i_4+PB_L); i_8++) {
            C[i_8-1][i_8] = H[i_8+i_4][0] - H[i_8+1][i_4] - H[i_4][i_8+i_4-1] + C[i_8-2][i_8-1] * 1;
        }
    }
#pragma endscop
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4334252211_01(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H)));
