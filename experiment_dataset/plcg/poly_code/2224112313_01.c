...
void kernel_2224112313_01(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
        B[i_2] = C[i_2] - C[i_2] * B[i_2-1] * B[i_2+1] + B[i_2+1] * 2;
    }
#pragma endscop
...
kernel_2224112313_01(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
