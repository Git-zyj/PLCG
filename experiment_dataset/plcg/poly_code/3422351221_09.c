...
void kernel_3422351221_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        A[i_0-1] = E[i_0+1] + F[i_0+1] + G[i_0-1] - F[i_0-1] + G[i_0] - F[i_0] * E[i_0] + A[i_0-2] * 2;
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            B[i_0][i_1] = H[i_1][i_0+1] - I[i_0][i_1-1] * G[i_1-1] * B[i_0-1][i_1] + B[i_0][i_1+1] + 5;
        }
        for (int i_2 = 1; i_2 < -i_0+PB_M; i_2++) {
            D[i_2+i_0] = H[i_0][i_2+1] + J[i_2-1][0] - J[i_2][i_0] * 2;
            D[i_2+i_0] = J[i_0][i_2] * J[i_2][i_0] + J[i_2+i_0][i_2+1] - I[i_2][i_2+1] + D[i_2+i_0] + D[i_2+i_0-1] - 6;
        }
    }
#pragma endscop
...
kernel_3422351221_09(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
