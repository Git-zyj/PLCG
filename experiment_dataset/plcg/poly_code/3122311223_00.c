...
void kernel_3122311223_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
...
kernel_3122311223_00(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
