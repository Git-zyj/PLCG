...
void kernel_4424211221_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf)){
        ...
        for (int i_4 = 2; i_4 < PB_L; i_4++) {
            for (int i_5 = max(2, i_0); i_5 < PB_L; i_5++) {
                for (int i_6 = 0; i_6 < PB_M; i_6++) {
                    B[i_6][i_4][i_5][i_0] = E[i_5][i_5][i_4] * A[i_4][i_5-2][i_0-1][i_4] - 3;
                }
            }
            for (int i_7 = 1; i_7 < PB_M; i_7++) {
                A[i_0][i_4-2][i_7][i_0] = F[i_7-1][i_4] - 3;
            }
        }
    }
        ...
        for (int i_9 = max(i_8, 1); i_9 < PB_L; i_9++) {
            for (int j_0 = 0; j_0 < PB_P; j_0++) {
                for (int j_1 = 2; j_1 < PB_P-2; j_1++) {
                    D[j_0][j_1+1][i_8][i_9-1] = B[j_1-1][i_9][j_0][i_8] + B[j_1][i_8][i_9-1][j_0] * D[j_0][j_1+2][i_8][i_9-1] + D[j_0][i_8+1][j_1-2][i_9] - 5;
                }
            }
        }
    }
...
kernel_4424211221_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
