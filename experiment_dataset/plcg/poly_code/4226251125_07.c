...
void kernel_4226251125_07(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_P-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_P-2; i_3++) {
                    B[i_3][i_1+1][i_2][i_0] = C[i_1][i_2-1][i_0][i_2-1] * C[i_2][i_0][i_1-1][i_3] - C[i_0+1][i_3][i_2][i_2+i_1+1] - D[i_2-1][i_1][i_3-1][i_3] - E[i_2][i_1+1][i_0-1] - F[i_3][i_2+i_1][i_0] * D[i_1][i_3][i_2][i_0] * B[i_0-1][i_1+1][i_3+2][i_2] * 2;
                }
            }
        }
        for (int i_4 = 0; i_4 < -i_0+PB_Q; i_4++) {
            for (int i_5 = 1; i_5 < PB_L-1; i_5++) {
                for (int i_6 = 1; i_6 < i_0; i_6++) {
                    B[i_0][i_4+1][i_6][i_5] = D[i_5][i_0][i_6-1][i_4+i_0] - D[i_5-1][i_5+1][i_4][i_0-1] + 6;
                }
            }
        }
    }
...
kernel_4226251125_07(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
