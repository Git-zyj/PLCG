...
void kernel_3332212321_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_2 = 0; i_2 < PB_Q-2; i_2++) {
        for (int i_3 = 2; i_3 < PB_M; i_3++) {
            for (int i_4 = 2; i_4 < PB_P-1; i_4++) {
                B[i_2+2][i_3][i_4-2] = D[i_3][i_4+1][i_2+2] - A[i_3-2][i_4+1] * 6;
            }
        }
    }
    for (int i_5 = 0; i_5 < PB_L-2; i_5++) {
        for (int i_6 = 2; i_6 < PB_M-2; i_6++) {
            C[i_6][i_5] = C[i_6-2][i_5+2] * C[i_6-2][i_5] - C[i_6-1][i_5] + C[i_6+1][i_5] - C[i_6+2][i_5] * 3;
        }
    }
#pragma endscop
...
kernel_3332212321_00(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
