...
void kernel_4112311123_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
...
kernel_4112311123_06(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
