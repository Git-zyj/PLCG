...
void kernel_2332131325_04(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        B[i_0-1] = D[i_0-1] - D[i_0] + 4;
    }
    for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
        B[i_1-1] = D[i_1-1] * D[i_1-1] - D[i_1+1] - B[i_1+1] * 5;
        B[i_1] = D[i_1+1] * D[i_1-1] - D[i_1] + D[i_1+1] * B[i_1+1] + B[i_1-1] - 4;
    }
#pragma endscop
...
kernel_2332131325_04(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
