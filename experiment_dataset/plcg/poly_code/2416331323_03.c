...
void kernel_2416331323_03(int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        D[i_0] = E[i_0+1] * F[i_0] * 3;
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            D[i_1] = G[i_1-1][i_0] + H[i_1-1][i_0+1] - I[i_1] - C[i_1+2] * C[i_1] * 2;
        }
        C[i_0] = E[i_0+1] - F[i_0-1] + F[i_0-1] - I[i_0] * D[i_0] - 3;
    }
    for (int i_2 = 0; i_2 < PB_L-2; i_2++) {
        D[i_2] = E[i_2] - D[i_2+2] - D[i_2+1] + 5;
    }
#pragma endscop
...
kernel_2416331323_03(xd,POLYBENCH_ARRAY(D), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
