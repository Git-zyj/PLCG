...
void kernel_4214152223_09(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd)){
        ...
        for (int i_1 = 2; i_1 < -i_0+PB_P-1; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_M-1, i_0); i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_L-2; i_3++) {
                    B[i_0][i_2][i_3][i_0] = C[i_2][i_3][i_1] - D[i_2+i_0+1][i_3][i_1][1] - C[i_3+i_1-1][i_2-1][i_0] * D[i_2][i_3+i_0+2][i_1][i_1+i_0+1] + D[i_3+i_2][i_0][i_1-2][i_1] - 1;
                }
            }
            for (int i_4 = 0; i_4 < PB_L-1; i_4++) {
                for (int i_5 = 2; i_5 < -i_1+PB_L; i_5++) {
                    B[i_0][i_1][i_4][i_0] = D[i_4][i_5+i_1][i_1][i_0+2] - D[i_0+2][i_1][i_5][i_4+2] - D[i_1][i_5-2][i_0][i_4] + C[i_5][i_4][0] - B[i_4+1][i_0-1][i_1][i_4+1] + B[i_0][i_1][i_4+2][i_0] + 5;
                }
            }
        }
    }
...
kernel_4214152223_09(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D));
