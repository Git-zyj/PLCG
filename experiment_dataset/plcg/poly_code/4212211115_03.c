...
void kernel_4212211115_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
kernel_4212211115_03(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
