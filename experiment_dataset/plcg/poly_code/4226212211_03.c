...
void kernel_4226212211_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
        ...
        for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 2; i_2 < i_1; i_2++) {
                for (int i_3 = i_2; i_3 < PB_L; i_3++) {
                    A[i_3][i_3-1][i_1-2][i_2] = A[i_3+1][i_3][i_1-2][i_2+1] * A[i_2-1][i_2-2][i_3-2][i_0] * A[i_0][i_0-1][i_1-1][i_2] * 3;
                }
            }
            B[i_1] = C[i_1+2] - 3;
        }
...
kernel_4226212211_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
