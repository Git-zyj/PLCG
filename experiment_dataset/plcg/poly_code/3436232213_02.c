...
void kernel_3436232213_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_M-2; i_1++) {
        B[i_1+2] = F[i_1] - F[i_1] * F[i_1+1] * G[i_1+2][i_1] - B[i_1+1] * B[i_1+3] + 6;
    }
    for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
        C[i_2] = G[i_2][i_2] - F[i_2] - H[i_2][i_2] - C[i_2+1] * 6;
    }
    for (int i_3 = 0; i_3 < PB_M; i_3++) {
        C[i_3] = E[i_3] + B[i_3+2] - 2;
    }
#pragma endscop
...
kernel_3436232213_02(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
