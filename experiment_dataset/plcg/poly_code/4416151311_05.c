        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_1+PB_P, -i_0+PB_L+1); i_2++) {
                for (int i_3 = 0; i_3 < -i_1+PB_L; i_3++) {
                    D[i_3][i_2][i_0+1][i_1] = E[i_2][i_3][i_2+i_1][i_0] + F[i_2][i_1-1][i_3][i_0][i_1] - E[i_3][i_2][i_1][i_0+1] + E[i_1][i_2+i_0-1][i_3][i_3] * G[i_2-1][i_2-1][i_1] - G[i_2-1][i_0][i_3+i_1] - D[i_3][i_1-1][i_0+1][i_2] + 4;
                }
            }
        }
        B[i_0] = H[i_0-1] * H[i_0] * H[i_0] * H[1] * H[i_0] * H[0] + H[i_0-1] - B[i_0-1] - B[i_0+1] + B[i_0-1] + C[i_0-1][0] - 4;
        for (int i_4 = 1; i_4 < -i_0+PB_N; i_4++) {
            C[i_4][0] = I[i_4+i_0][i_4+1] + H[i_0] + B[i_4+1] * B[i_4] - C[i_4-1][0] * C[i_4+1][0] + 4;
            for (int i_5 = 1; i_5 < PB_M-1; i_5++) {
                for (int i_6 = 1; i_6 < min(PB_N-1, i_0); i_6++) {
                    D[i_5][i_6][i_0+1][i_4] = G[i_6+1][i_5+i_4][0] + E[i_6-1][i_5+1][i_4+1][i_0] - G[i_6][i_4-1][i_5-1] * E[i_5+1][i_0-1][i_6][i_0] + 1;
                }
            }
        }
    }
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4416151311_05(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I)));
