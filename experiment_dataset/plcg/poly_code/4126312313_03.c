...
void kernel_4126312313_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb)){
        ...
        for (int i_1 = 0; i_1 < PB_N; i_1++) {
            for (int i_2 = 2; i_2 < min(PB_L, -i_0+PB_P); i_2++) {
                for (int i_3 = 3; i_3 < min(-i_1+PB_M, i_0); i_3++) {
                    A[i_0][i_2][i_2][i_3-2] = B[i_3+i_1][i_0][i_2+i_0] * A[i_1][i_0+1][i_0+1][i_2-2] - A[i_0][i_2][i_2][i_3-3] + A[i_0][i_2][i_2][i_3-1] - 6;
                }
            }
        }
    }
...
kernel_4126312313_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B));
