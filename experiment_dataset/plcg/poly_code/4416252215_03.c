...
void kernel_4416252215_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        A[i_0] = E[i_0] * E[i_0] * F[i_0+1] - F[i_0] - A[i_0+1] + A[i_0-1] + B[i_0] - 3;
    }
    for (int i_1 = 2; i_1 < PB_M-1; i_1++) {
        B[i_1-1] = E[i_1] * F[i_1] * F[i_1] * 6;
        for (int i_2 = 2; i_2 < -i_1+PB_Q; i_2++) {
            for (int i_3 = 2; i_3 < min(-i_1+PB_M-1, i_1); i_3++) {
                for (int i_4 = 2; i_4 < -i_1+PB_Q; i_4++) {
                    C[i_3+i_1][i_2][i_2+i_1][i_4+1] = G[i_2-1][i_3+2][i_1][i_3+1] + H[i_3][i_2][i_4] - I[i_2][i_4-2][i_1][i_3+i_2] + I[i_2+1][i_4][i_1-2][i_3-2] - H[i_2-1][i_3-2][i_4] * H[i_3][0][i_4-2] - I[i_2-2][i_1][i_4][i_1] + C[i_3+i_1+1][i_4][i_4+i_1][i_2+1] - C[i_4+i_3][i_1][i_3+i_1][i_2+2] * 1;
                }
            }
        }
        for (int i_5 = i_1; i_5 < PB_Q-1; i_5++) {
            for (int i_6 = 2; i_6 < PB_L-2; i_6++) {
                for (int i_7 = 2; i_7 < PB_M-2; i_7++) {
                    D[i_1][i_6+2][i_1][i_7-2] = I[i_5][i_6-1][i_1][i_1] + I[i_1][i_7][i_5][0] - G[i_7+2][i_1][i_6+2][i_5+1] + I[i_1][i_7][i_5][i_6-2] * G[i_6][i_5-1][i_1][2] * H[i_6][i_5][i_7] * D[i_1][i_6+1][i_1][i_5-2] - D[i_7-1][i_6+1][i_7-1][i_5-2] * 5;
                }
            }
        }
    }
...
kernel_4416252215_03(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
