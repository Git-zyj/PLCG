...
void kernel_4232132111_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = 2; i_2 < PB_L-2; i_2++) {
                for (int i_3 = 0; i_3 < PB_P; i_3++) {
                    A[i_1][i_2+2][i_3] = C[i_2][i_3][i_1][i_0+1] + C[i_0][i_2-2][i_3][i_1] + 1;
                }
            }
            for (int i_4 = 1; i_4 < min(-i_0+PB_M+2, PB_L-2); i_4++) {
                B[i_1+i_0][i_4+i_0-2][i_4] = D[i_1+1][i_4-1][i_0+1] * E[i_1-1][i_0] * D[i_4+i_0-2][i_1][i_0] * A[i_1+1][i_4+2][i_0-1] + 3;
            }
        }
    }
#pragma endscop
...
kernel_4232132111_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
