...
void kernel_4426131125_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg)){
        ...
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_1+PB_M, i_0); i_2++) {
                for (int i_3 = i_1; i_3 < -i_1+PB_M-1; i_3++) {
                    A[i_1][i_0-1][i_2][i_3] = E[i_2+i_1][i_0][i_3][i_0-1] * E[i_3][i_1-1][i_1][i_0] + E[i_3][i_0][i_2][i_1-1] - E[i_3+i_1+1][i_1][i_0][i_2] * A[i_1][i_0-1][i_2][i_3-1] + A[i_1][i_0-1][i_3+2][i_2] + 1;
                }
            }
        }
        B[i_0+1] = 5;
        for (int i_4 = 1; i_4 < PB_L; i_4++) {
            B[i_0+1] = F[i_0+1][i_4-1] + F[i_4][i_0+1] - F[i_4][i_4] + G[i_4] + G[i_4] - F[i_4-1][i_0] + 2;
        }
        for (int i_5 = 0; i_5 < i_0; i_5++) {
            for (int i_6 = 0; i_6 < PB_L-1; i_6++) {
                for (int i_7 = 0; i_7 < min(-i_6+PB_M, -i_0+PB_P); i_7++) {
                    D[i_0][i_5][i_7+i_6][i_6+1] = E[i_6][i_5+1][i_7+i_0][0] * 6;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4426131125_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G)));
