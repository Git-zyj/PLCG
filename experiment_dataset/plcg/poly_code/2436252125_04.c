...
void kernel_2436252125_04(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N; i_0++) {
        B[i_0] = E[i_0] + F[i_0] - E[i_0] + F[i_0] * F[i_0] - 4;
    }
    for (int i_1 = 1; i_1 < PB_L; i_1++) {
        B[i_1] = E[i_1] * E[i_1+1] + F[i_1] + E[i_1] * E[i_1+2] - 3;
        for (int i_2 = 1; i_2 < min(PB_L-1, i_1); i_2++) {
            C[i_1][i_2-1] = G[i_2][i_2+1] - G[i_2][i_1] + H[i_2][i_1] - I[i_1-1][i_2+1][0] * F[0] - B[i_1] + C[i_1][i_2+1] - 4;
            C[i_1][i_2-1] = G[i_2][i_1] + G[i_2][i_1] + H[i_2][i_1] + H[i_1][i_2] - 4;
        }
    }
#pragma endscop
...
kernel_2436252125_04(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
