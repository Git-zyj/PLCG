...
void kernel_2226312311_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_2 = 0; i_2 < PB_M-2; i_2++) {
        B[i_2+1] = C[i_2] + C[i_2] - B[i_2] * B[i_2+2] + 1;
    }
#pragma endscop
...
kernel_2226312311_06(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
