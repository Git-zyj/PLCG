...
void kernel_4424251311_07(int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_L; i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_P; i_2++) {
                for (int i_3 = 1; i_3 < min(PB_N-1, i_0); i_3++) {
                    D[i_3][i_1+i_0][i_3][i_2+1] = E[i_2][i_0-1][i_1][i_2+1] - E[i_2][i_3-1][i_2][i_1] - E[i_3][i_0][i_2+i_1][i_0] + F[i_3+1][i_1][i_2][i_0+1][i_1] - G[i_1-1][i_2][i_0][1] + 4;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_N-2; i_4++) {
        B[i_4+1] = H[i_4] * I[i_4] - I[i_4] - H[i_4+1] - H[i_4] + I[i_4] + B[i_4+2] - B[i_4] - B[i_4] + 4;
    }
    for (int i_5 = 1; i_5 < PB_L-3; i_5++) {
        C[i_5] = H[i_5] + I[i_5-1] - H[i_5] * H[i_5-1] * B[i_5+1] * 5;
        for (int i_6 = 1; i_6 < min(-i_5+PB_L-3, i_5); i_6++) {
            for (int i_7 = 1; i_7 < -i_5+PB_L-2; i_7++) {
                for (int i_8 = i_5; i_8 < -i_5+PB_L-1; i_8++) {
                    D[i_7][i_8+i_5+1][i_7][i_6+1] = G[i_8-1][i_7+i_5-1][i_7][i_6] + J[i_8][i_6][i_6-1] * K[i_7-1][i_6][i_8] - J[i_6-1][i_8][i_7] - D[i_7][i_8+i_5+1][i_7][i_6+2] * D[i_8][i_7+i_5+2][i_8][i_6+2] + D[i_7][i_6+i_5+3][i_7][i_8+1] - 3;
                }
            }
        }
    }
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4424251311_07(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K)));
