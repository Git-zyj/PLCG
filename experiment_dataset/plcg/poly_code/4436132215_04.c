...
void kernel_4436132215_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        A[i_0] = E[i_0-2] - E[i_0] - E[i_0] * E[i_0+1] * A[i_0-1] + A[i_0+1] * 6;
    }
    for (int i_1 = 2; i_1 < PB_M-1; i_1++) {
        A[i_1] = E[i_1] * 5;
        A[i_1+1] = E[i_1-2] * E[i_1-1] - E[i_1] * E[i_1] + E[i_1] - 3;
        for (int i_2 = i_1; i_2 < -i_1+PB_M-1; i_2++) {
            for (int i_3 = 0; i_3 < PB_P; i_3++) {
                for (int i_4 = 1; i_4 < min(PB_P-1, -i_3+PB_Q-1); i_4++) {
                    D[i_1][i_2-1][i_3][i_4+i_3+1] = F[i_2+i_1+1][i_3][i_4-1] - G[i_3][i_2-2][i_4+1][i_1] * D[i_1][i_2-1][i_3][i_4+i_3] * 4;
                }
            }
        }
    }
...
kernel_4436132215_04(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G));
