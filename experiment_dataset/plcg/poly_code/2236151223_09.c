...
void kernel_2236151223_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        A[i_0] = C[i_0] * C[i_0-1] - C[i_0] + C[i_0] - C[i_0] - A[i_0-1] - 6;
    }
    for (int i_1 = 0; i_1 < PB_M; i_1++) {
        A[i_1] = C[i_1] + C[i_1] + C[i_1] - C[i_1] + A[i_1] - 2;
    }
#pragma endscop
...
kernel_2236151223_09(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
