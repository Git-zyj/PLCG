...
void kernel_4232111213_04(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 1; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < min(PB_L-2, -i_2+PB_M-1); i_3++) {
                    B[i_2][i_3+2][i_1-1] = C[i_3+i_2+1][i_1+1][i_1] * B[i_0][i_1+2][i_2] + 2;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M; i_4++) {
        for (int i_5 = 1; i_5 < PB_L+1; i_5++) {
            for (int i_6 = 0; i_6 < PB_L-1; i_6++) {
                B[i_5][i_6+1][i_4] = C[i_4][i_5-1][i_6+1] * B[i_5][i_6][i_4] + 3;
            }
        }
    }
#pragma endscop
...
kernel_4232111213_04(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
