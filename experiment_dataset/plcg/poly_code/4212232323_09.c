        ...
        for (int i_1 = 1; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_P; i_2++) {
                for (int i_3 = max(2, i_1); i_3 < PB_L-2; i_3++) {
                    A[i_1][i_3][i_0][i_2] = C[i_0][i_1][i_3-2][1] + D[i_1][i_3][i_0][i_2] + D[i_1+1][i_3-2][i_2+i_0][i_1-1] - C[i_3][i_0][i_1][i_2+i_0-2] * A[i_1][i_3][i_0-1][i_2] + A[i_3][i_1+2][i_0][i_2+2] - A[i_0-1][i_3][i_1][i_2] * A[i_1+2][i_3+2][i_2][i_0] + 3;
                }
            }
        }
    }
...
kernel_4212232323_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
