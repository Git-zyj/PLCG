...
void kernel_3234212221_07(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    for (int i_0 = 4; i_0 < PB_L; i_0++) {
        ...
        B[i_0-2] = C[i_0] * B[i_0] - B[i_0-1] - B[i_0-4] * 1;
    }
#pragma endscop
...
kernel_3234212221_07(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
