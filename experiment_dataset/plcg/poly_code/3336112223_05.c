...
void kernel_3336112223_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_0 = 1; i_0 < PB_Q+1; i_0++) {
        ...
        for (int i_1 = 2; i_1 < min(-i_0+PB_M, PB_P-1); i_1++) {
            for (int i_2 = i_1; i_2 < PB_Q-2; i_2++) {
                B[i_1+i_0][i_2][2] = D[i_2][i_1-2][i_0-1] * C[i_2+1][i_1+1][i_2+2] - 3;
            }
        }
    }
    for (int i_3 = 2; i_3 < PB_L; i_3++) {
        for (int i_4 = i_3; i_4 < min(PB_P-3, -i_3+PB_M+2); i_4++) {
            for (int i_5 = 0; i_5 < min(min(PB_Q-1, -i_4+PB_M), i_3); i_5++) {
                C[i_5][i_4+1][i_5+1] = B[i_5+i_4][i_3][2] - B[i_4+i_3-2][i_5][2] * C[i_5][i_4+3][i_5+1] - 5;
            }
        }
    }
#pragma endscop
...
kernel_3336112223_05(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
