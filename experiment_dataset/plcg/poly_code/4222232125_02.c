...
void kernel_4222232125_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        for (int i_1 = 0; i_1 < PB_Q-2; i_1++) {
            for (int i_2 = 2; i_2 < PB_P-2; i_2++) {
                A[i_0][i_1][i_2] = C[i_0+1][i_2-2][i_1+2] + D[i_1][i_2][i_0-2] - A[i_0-2][i_1][i_2+2] - 1;
            }
        }
        for (int i_3 = i_0; i_3 < PB_P; i_3++) {
            for (int i_4 = 0; i_4 < PB_Q-2; i_4++) {
                A[i_0][i_4][i_3] = C[i_3][i_0][i_4] + C[i_3][i_0][i_4+2] - C[i_4][i_0][1] - D[i_3+1][i_0-2][i_0] - 4;
            }
        }
    }
#pragma endscop
...
kernel_4222232125_02(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
