...
void kernel_4224112313_06(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_4 = 1; i_4 < PB_N-3; i_4++) {
        for (int i_5 = 1; i_5 < PB_P; i_5++) {
            for (int i_6 = 0; i_6 < PB_N-2; i_6++) {
                B[i_6+2][i_6][i_4] = C[i_4+1][i_5][i_5] * B[i_6+2][i_6][i_5-1] + B[i_4+3][i_4+1][i_6] + B[i_4+1][i_4-1][i_6] * 4;
            }
        }
    }
#pragma endscop
...
kernel_4224112313_06(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
