...
void kernel_4236252223_07(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf)){
        ...
        for (int i_1 = 0; i_1 < min(i_0, -i_0+PB_Q-1); i_1++) {
            for (int i_2 = 2; i_2 < -i_0+PB_M; i_2++) {
                for (int i_3 = 4; i_3 < i_0; i_3++) {
                    B[i_2][i_1+2][i_3-4][i_0] = C[i_1+2][i_0][i_1][i_2] - D[i_2][i_3][i_1+i_0+1][i_1] - E[i_2+i_0][i_1][i_3] + D[i_2][i_0][i_3][i_1] - C[i_3][i_2+i_1][i_0+2][i_0-2] - C[i_2][i_3][i_1][1] * D[i_1][i_3][i_0][i_2-2] * 6;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-2; i_4++) {
        for (int i_5 = 0; i_5 < min(PB_L-2, -i_4+PB_L); i_5++) {
            for (int i_6 = 0; i_6 < PB_M; i_6++) {
                for (int i_7 = 4; i_7 < min(-i_6+PB_M, PB_Q-1); i_7++) {
                    B[i_4][i_5+2][i_7-2][i_6] = D[i_7][i_6][i_5][i_4] * D[i_4][i_6][i_7+1][i_5] * F[i_7+i_6][i_5+i_4][i_6][0][i_4] + B[i_4+2][i_5+2][i_7-4][i_6] - B[i_4-1][i_5+2][i_7-2][i_6] * 1;
                }
            }
        }
    }
...
kernel_4236252223_07(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F));
