...
void kernel_4414311215_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
        ...
        for (int i_1 = max(1, i_0); i_1 < PB_P; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_M, PB_P); i_2++) {
                for (int i_3 = 0; i_3 < min(-i_1+PB_M, PB_P); i_3++) {
                    A[i_2-1][i_1][i_0+1][1] = E[i_2+i_0][i_3+i_1][i_2][0] - A[i_2-1][i_1][i_0][1] + A[i_2-1][i_1][i_0+2][1] + 1;
                }
            }
            B[i_0+1][i_1-1] = F[i_1] * G[i_1][i_0+1] - B[i_0][i_1-1] + B[i_0+2][i_1] - 4;
        }
        for (int i_4 = max(1, i_0); i_4 < PB_L+1; i_4++) {
            B[i_0][i_4-1] = H[i_4-1][i_0+1][i_0] * 6;
        }
    }
...
kernel_4414311215_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
