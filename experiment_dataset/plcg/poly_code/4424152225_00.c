...
void kernel_4424152225_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
    ...
    for (int i_0 = 1; i_0 < PB_N-4; i_0++) {
        ...
        for (int i_1 = i_0; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 2; i_2 < -i_0+PB_M-2; i_2++) {
                B[i_0+2][i_2][i_1] = F[i_2+i_0+2][i_1][i_2-1] + F[i_0][i_1][i_2] + G[0][i_0-1][i_2+1][i_1] + G[i_1][i_2][i_0-1][i_2+2] - F[i_1][i_2][i_0+1] - H[i_2-2][i_2] + B[i_0+4][i_2][i_1+2] * B[i_1+2][i_0][i_2+2] * B[i_0+3][i_2-2][i_1+2] - 1;
            }
        }
    }
    for (int i_3 = 2; i_3 < PB_L-1; i_3++) {
        for (int i_4 = 2; i_4 < -i_3+PB_M-1; i_4++) {
            for (int i_5 = 1; i_5 < i_4; i_5++) {
                C[i_4-2][i_5][i_3] = F[i_4][i_3][i_5+1] - F[i_3][i_4][i_5-1] * F[i_4-1][i_3+1][i_5+2] - F[i_4][i_5+2][i_3] + B[i_5][i_3-2][i_4] - 4;
            }
            A[i_4] = H[i_3][i_4] - H[i_3][i_4+i_3+1] + H[i_3-1][0] + F[i_3][i_4][i_3] * F[i_4+i_3][i_4][i_3] * 6;
        }
    }
#pragma endscop
...
kernel_4424152225_00(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
