...
void kernel_4316352215_03(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        C[i_0] = D[i_0-2] - D[i_0] + E[i_0-2] - D[i_0] + C[i_0] - C[i_0-1] - 4;
        for (int i_1 = 0; i_1 < PB_L-1; i_1++) {
            C[i_1+1] = F[i_1][i_0-2] * G[i_1][i_0] * F[i_0-2][i_1+1] * H[i_0-2][i_1] + 3;
        }
        C[i_0] = D[i_0+1] - E[i_0-1] - I[i_0] - I[i_0+2] + E[i_0] * 6;
    }
#pragma endscop
...
kernel_4316352215_03(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
