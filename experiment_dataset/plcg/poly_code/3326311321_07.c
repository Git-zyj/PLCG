...
void kernel_3326311321_07(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
        for (int i_4 = 2; i_4 < PB_L-1; i_4++) {
            for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
                B[i_3][i_4][i_4] = B[i_3][i_4-2][i_4-2] - B[i_3+1][i_4+1][i_4+1] * B[i_3-1][i_4][i_4] * B[i_5+1][i_4+1][i_4+1] * 6;
            }
        }
    }
    for (int i_6 = 0; i_6 < PB_L-1; i_6++) {
        for (int i_7 = 3; i_7 < PB_L-3; i_7++) {
            for (int i_8 = 1; i_8 < min(-i_7+PB_M-2, PB_L-1); i_8++) {
                C[i_8+i_7][i_8+1] = D[i_7][i_6+1][i_7+1] - C[i_8+i_7+1][i_7+1] * C[i_8+i_7-3][i_8-1] + C[i_8+i_7+2][i_7+3] * 3;
            }
        }
    }
#pragma endscop
...
kernel_3326311321_07(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
