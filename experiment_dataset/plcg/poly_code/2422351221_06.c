...
void kernel_2422351221_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        A[i_0] = E[i_0+1] + E[0] - E[i_0-1] - F[i_0-1] * A[i_0+2] + 2;
        for (int i_1 = 1; i_1 < -i_0+PB_M; i_1++) {
            B[i_1][i_0] = G[i_1][i_0] + H[i_1+i_0][i_0-1] + I[i_1][i_0] * H[i_1+1][i_0-1] - G[i_0-1][i_1-1] * G[i_1][i_0] * H[i_1][i_0] * H[i_0][i_1] - I[i_1+i_0][i_1] + H[i_1][i_0+1] + B[i_1][i_0-1] - 2;
        }
        A[i_0] = E[i_0] - E[i_0-1] - D[i_0-2] * 6;
        D[i_0] = F[i_0] + D[i_0-1] * 2;
    }
#pragma endscop
...
kernel_2422351221_06(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
