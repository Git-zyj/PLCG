        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 2; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 0; i_3 < -i_2+PB_L-1; i_3++) {
                    A[i_0][i_1+1][i_3][i_3] = C[i_3+1][i_2][i_1][0] + D[i_3][i_3+i_2+1][i_1][i_0+1] * C[i_1-1][i_3][i_0][i_2-2] + A[i_0][i_2+2][i_3][i_3] + A[i_0][i_2+2][i_3+1][i_3+1] - 6;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L-1; i_4++) {
        B[i_4] = E[i_4] * F[i_4+2] - E[i_4-2] + E[i_4] + F[i_4] - G[i_4] * B[i_4-1] + B[i_4+1] + B[i_4+1] - 3;
    }
#pragma endscop
...
kernel_4226352313_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
