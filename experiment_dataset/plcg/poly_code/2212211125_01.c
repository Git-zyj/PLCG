...
void kernel_2212211125_01(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        A[i_0][i_0-1] = C[i_0] * A[i_0+1][i_0] * 2;
    }
    for (int i_1 = 2; i_1 < PB_L+1; i_1++) {
        A[i_1-1][i_1-2] = D[i_1] - 3;
    }
#pragma endscop
...
kernel_2212211125_01(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
