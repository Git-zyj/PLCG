...
void kernel_4414312321_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
        ...
        for (int i_1 = 2; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 1; i_2 < PB_N-2; i_2++) {
                for (int i_3 = i_2; i_3 < -i_0+PB_L; i_3++) {
                    A[i_2][i_1+1][i_1][1] = E[i_2-1][i_3][i_1][i_0] - F[i_2+2][i_3+i_0][i_1][i_1] * A[i_3][i_0+2][i_0+1][1] - A[i_2][i_1+2][i_1+1][1] - A[i_2+2][i_0+1][i_0][1] - A[i_2][i_1-1][i_1-2][1] + 1;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-2; i_4++) {
        B[i_4] = B[i_4+2] * B[i_4-1] + B[i_4+1] + B[i_4-2] * 6;
        for (int i_5 = 1; i_5 < PB_L-1; i_5++) {
            for (int i_6 = 2; i_6 < min(PB_P-3, i_5); i_6++) {
                for (int i_7 = 1; i_7 < min(i_4, PB_N-2); i_7++) {
                    C[i_7][i_4][i_5-1][i_6+1] = C[i_7+2][i_4+2][i_5+1][i_6+3] + C[i_7-1][i_4+2][i_6-2][i_5+1] - 1;
                }
                for (int i_8 = 2; i_8 < PB_P; i_8++) {
                    D[i_8-2][i_5+1][i_4][i_8] = G[i_6-1][i_5+1][i_8-1] - D[i_8-2][i_5+1][i_4-1][i_8] * D[i_8-2][i_4+1][i_5-1][i_8] * 6;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4414312321_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G)));
