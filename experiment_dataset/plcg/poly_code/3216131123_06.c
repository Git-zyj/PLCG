...
void kernel_3216131123_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_L; i_0++) {
        for (int i_1 = i_0; i_1 < -i_0+PB_L; i_1++) {
            for (int i_2 = 2; i_2 < PB_L; i_2++) {
                A[i_2][i_1][i_2-1] = C[i_2][i_1+i_0][i_0+1] - C[i_0][i_2][i_1] - A[i_2-1][i_0][i_2-2] + 6;
            }
            A[i_0-2][i_1-1][i_0-3] = D[i_1+i_0][0] * D[i_0][i_1-1] * D[i_1][i_0] + D[i_1][i_1] * 2;
        }
    }
#pragma endscop
...
kernel_3216131123_06(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
