        ...
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_1+PB_N, PB_L-1); i_2++) {
                for (int i_3 = 1; i_3 < PB_L; i_3++) {
                    A[i_0-1][i_2][i_3][i_1] = E[i_2][i_3][i_1][i_0-1] + F[i_3-1][i_0][i_1+1][i_3+i_2+1] - E[i_1][i_2+1][i_3][i_0-1] + F[i_3+1][i_2][i_1][i_0+1] + G[i_2+i_1][i_0+1][i_1][i_0] * A[i_0-1][i_1+1][i_3+1][i_2] - A[i_0][i_2][i_3+1][i_1] + 2;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
            D[i_4+2] = H[i_0][i_4-1][i_4] + I[i_4+1][i_0] - J[i_4][1] - K[i_4+1][i_0-1] + K[i_4][i_0] - 5;
        }
    }
    for (int i_5 = 1; i_5 < PB_L; i_5++) {
        for (int i_6 = 1; i_6 < min(min(-i_5+PB_P, i_5), PB_L-1); i_6++) {
            D[i_6] = K[i_5-1][i_6+i_5] - I[i_5][i_6] + L[i_5] + I[i_6+1][i_5+1] - I[i_6-1][i_5-1] + M[i_6+1] - D[i_6+1] + 5;
        }
        D[i_5+1] = N[i_5] - M[i_5+1] + D[i_5] + 2;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,POLYBENCH_ARRAY(M), xn,POLYBENCH_ARRAY(N), INIT_SEED);
kernel_4426351213_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,POLYBENCH_ARRAY(M), xn,POLYBENCH_ARRAY(N));
