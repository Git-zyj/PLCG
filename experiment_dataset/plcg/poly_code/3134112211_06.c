...
void kernel_3134112211_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
            A[i_0] = B[i_1] * A[i_1+1] - A[i_1-1] * 5;
        }
    }
#pragma endscop
...
kernel_3134112211_06(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
