...
void kernel_4312311321_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_L; i_0++) {
        for (int i_1 = 0; i_1 < min(PB_L, -i_0+PB_N); i_1++) {
            for (int i_2 = 0; i_2 < PB_L; i_2++) {
                A[i_1+i_0-1][i_2+1][0] = A[i_1+i_0-3][i_2+1][0] * A[i_1+i_0-3][i_2+1][0] - A[i_1+i_0][i_2][0] + 3;
            }
        }
        for (int i_3 = 0; i_3 < min(PB_L, -i_0+PB_N+3); i_3++) {
            for (int i_4 = 0; i_4 < min(-i_0+PB_N+1, PB_L); i_4++) {
                A[i_4+i_0-1][i_3+1][0] = D[i_3][i_0][i_0] * 1;
                A[i_3+i_0-3][i_4+1][0] = 2;
            }
        }
    }
#pragma endscop
...
kernel_4312311321_08(xa,ya,za,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D));
