...
void kernel_4432211311_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
        ...
        for (int i_2 = 2; i_2 < PB_M; i_2++) {
            ...
            for (int i_3 = 2; i_3 < PB_L-1; i_3++) {
                for (int i_4 = i_1; i_4 < PB_L-1; i_4++) {
                    C[i_2-1][i_3+1][i_4] = C[i_2-1][i_3][i_4] * C[i_2-2][i_3+1][i_4] * C[i_2-1][i_3+1][i_4+1] * C[i_3-1][i_4+1][i_1+1] * C[i_3-2][i_1+1][i_4] + C[i_1-1][i_4][i_3] + 2;
                }
            }
        }
    }
    for (int i_5 = 2; i_5 < PB_L; i_5++) {
        D[i_5-1] = G[i_5][0] * D[i_5-2] - 6;
    }
#pragma endscop
...
kernel_4432211311_08(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
