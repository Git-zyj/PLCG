...
void kernel_4212211313_06(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P-1; i_0++) {
        for (int i_1 = 1; i_1 < min(-i_0+PB_M, PB_M-2); i_1++) {
            A[i_1+1][i_0] = C[i_1+i_0][i_1] - A[i_1+2][i_0+1] - A[i_1+1][i_0-1] * A[i_1+1][i_0+1] + 6;
            A[i_0][i_1-1] = 6;
        }
    }
#pragma endscop
...
kernel_4212211313_06(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C));
