...
void kernel_3226112225_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N-2; i_0++) {
        for (int i_1 = max(1, i_0); i_1 < PB_N-2; i_1++) {
            A[i_1+2] = C[i_0+1][i_1] * D[i_1-1] * 2;
        }
        A[i_0+2] = A[i_0+2] - A[i_0] * 1;
    }
#pragma endscop
...
kernel_3226112225_05(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
