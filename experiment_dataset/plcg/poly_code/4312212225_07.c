...
void kernel_4312212225_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf)){
        ...
        for (int i_1 = 0; i_1 < PB_P; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_Q-2; i_2++) {
                for (int i_3 = 0; i_3 < PB_Q; i_3++) {
                    A[i_3][i_0][i_1][i_2+i_0+2] = D[i_1][i_2][i_3][i_0] * 4;
                }
            }
        }
        B[i_0-1] = E[i_0] * B[i_0+1] - B[i_0] + B[i_0-2] - 2;
    }
    for (int i_4 = 2; i_4 < PB_M-1; i_4++) {
        for (int i_5 = 0; i_5 < PB_Q-4; i_5++) {
            for (int i_6 = -i_5+PB_Q-4 - 1; i_6 >= 0; i_6--) {
                for (int i_7 = 0; i_7 < -i_4+PB_M-1; i_7++) {
                    A[i_6][i_4-2][i_5+1][i_7+i_4] = F[i_6+i_5][i_7+i_4+1][i_6][i_4] - A[i_7][i_6][i_4][i_6+i_5+4] * 3;
                }
            }
        }
    }
...
kernel_4312212225_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
