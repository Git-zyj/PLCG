...
void kernel_2214211325_09(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_P-2; i_0++) {
        for (int i_1 = 0; i_1 < -i_0+PB_P-1; i_1++) {
            B[i_1+i_0+1][i_1+i_0+1] = C[i_1][i_0] + 6;
        }
        for (int i_2 = 0; i_2 < min(i_0, -i_0+PB_P-2); i_2++) {
            B[i_2+i_0][i_2+i_0] = B[i_2+i_0+2][i_2+i_0+2] * B[i_2+i_0-3][i_2+i_0-3] + B[i_2+i_0+1][i_2+i_0+1] - 6;
        }
    }
#pragma endscop
...
kernel_2214211325_09(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
