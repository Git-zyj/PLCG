...
void kernel_3336351211_01(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        for (int i_1 = i_0; i_1 < -i_0+PB_P; i_1++) {
            A[i_0][i_1+i_0-1] = D[i_1][i_0] + E[i_1+1] - A[i_0][i_1+i_0] * A[i_0][i_1+i_0-2] * A[i_0+1][i_1+i_0-1] * 5;
        }
        for (int i_2 = 1; i_2 < min(i_0, -i_0+PB_P); i_2++) {
            B[i_0-1][i_2] = D[i_2+i_0][0] - F[i_0][i_2-1] - D[i_0][0] + D[i_2][i_2+i_0] + F[i_0+1][i_2] + D[i_2+i_0+1][0] + D[i_0+1][i_2] - B[i_0-2][i_2] + B[i_0-1][i_2-1] - B[i_0][i_2-1] - 3;
        }
    }
    for (int i_3 = 1; i_3 < PB_P; i_3++) {
        for (int i_4 = 1; i_4 < -i_3+PB_P; i_4++) {
            C[i_3][i_4+i_3] = F[i_4][i_3] * G[i_3-1][i_4] * E[i_4-1] - F[i_4][i_3] + G[i_3+1][i_4] + G[i_3-1][i_4] + 1;
        }
    }
#pragma endscop
...
kernel_3336351211_01(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
