...
void kernel_3336212323_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
    ...
    for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
        for (int i_4 = 2; i_4 < min(-i_3+PB_M+1, i_3); i_4++) {
            for (int i_5 = 0; i_5 < -i_3+PB_M-1; i_5++) {
                C[i_3][i_5+i_4] = C[i_5][i_4+i_3-1] - C[i_4][i_5+i_3+1] * C[i_4-2][i_5+i_3] - 4;
            }
        }
    }
#pragma endscop
...
kernel_3336212323_08(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
