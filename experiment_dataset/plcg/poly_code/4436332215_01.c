        ...
        for (int i_1 = 3; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 2; i_2 < min(PB_P-3, i_0); i_2++) {
                for (int i_3 = 2; i_3 < -i_1+PB_Q; i_3++) {
                    A[i_0][i_2][i_3-2][i_1+2] = E[i_2][i_0][i_3+i_1][i_2] - E[i_0][i_0-1][i_3][2] + F[i_0][i_3][i_1-1][1][i_0] - G[i_1+1][i_2-2][i_3][i_2] * A[i_1][i_0][i_3-2][i_2+3] + A[i_0][i_2][i_3-1][i_1+2] - A[i_0+1][i_2-1][i_1-3][i_3+2] - 2;
                }
            }
        }
        D[i_0] = H[i_0-2] - I[i_0] - 6;
        for (int i_4 = 0; i_4 < -i_0+PB_M+1; i_4++) {
            D[i_4] = J[i_4] * K[i_4+i_0-1][i_0] * 5;
        }
    }
    for (int i_5 = 1; i_5 < PB_M-1; i_5++) {
        D[i_5] = H[i_5-1] + I[i_5+1] - D[i_5-1] - 1;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4436332215_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K)));
