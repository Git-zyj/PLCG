...
void kernel_2322312311_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-3; i_0++) {
        ...
        B[i_0+2] = B[i_0+1] * B[i_0+3] - C[i_0+2] + 5;
        for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
            C[i_2+1] = D[i_2+1][i_0-2] + A[i_0] + C[i_2+2] - C[i_0+2] + 5;
        }
    }
#pragma endscop
...
kernel_2322312311_07(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
