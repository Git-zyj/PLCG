...
void kernel_2322252215_04(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        B[i_0+1][i_0-1] = D[i_0+1] * E[i_0+1] - E[i_0] + B[i_0][i_0-2] - 5;
    }
    for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
        for (int i_2 = 3; i_2 < PB_L-2; i_2++) {
            B[i_2][i_2-2] = E[i_2] + F[i_2][i_2] + G[i_1][i_1] - E[i_2-2] * G[i_2-2][i_1+1] - D[i_2+2] * F[i_1-1][i_2] * B[i_2-1][i_2-3] + 1;
        }
    }
    for (int i_3 = 1; i_3 < PB_L; i_3++) {
        for (int i_4 = 2; i_4 < min(-i_3+PB_P-2, PB_L-2); i_4++) {
            B[i_4][i_4-2] = G[i_4+2][i_3] - G[i_3][i_4+2] * H[i_4][i_4+i_3+2][2] - F[i_4][i_3] - G[i_3-1][i_4-2] * 2;
        }
    }
#pragma endscop
...
kernel_2322252215_04(xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
