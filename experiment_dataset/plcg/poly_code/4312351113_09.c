...
void kernel_4312351113_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_L, -i_1+PB_Q-1); i_2++) {
                for (int i_3 = 1; i_3 < min(min(PB_N-1, -i_2+PB_Q), -i_1+PB_P); i_3++) {
                    A[i_2][i_1][i_0][i_3+i_2] = D[i_1][i_2][i_0][0] - E[i_2-1][i_3][i_1][i_0] + F[i_3+1][i_1+1][i_2+i_0] + 4;
                    B[i_0][i_2][i_0][i_3+1] = D[i_2][i_0-1][i_1][i_3] * G[i_3+i_2][i_3][i_1] - H[i_2-1][i_1][i_2+i_0][i_3+i_1][i_3] - I[i_0][i_3][i_1-1][i_2+i_1+1] * E[i_1-1][i_3][i_2+1][0] * I[i_3][i_0][i_1+1][i_2] * I[i_3-1][i_2+1][i_1-1][i_0-1] - A[i_2][i_0][i_1][i_3+i_2] * 5;
                }
            }
        }
    }
        ...
        for (int i_5 = max(i_4, 1); i_5 < PB_Q; i_5++) {
            for (int i_6 = i_5; i_6 < PB_L; i_6++) {
                for (int i_7 = 0; i_7 < min(-i_4+PB_Q-1, -i_5+PB_L+1); i_7++) {
                    A[i_4][i_6][i_5][i_7+i_4+1] = I[i_5][i_4][i_6][1] * E[i_6][i_7][i_5][i_4] + E[i_5][i_4][i_7][i_6] + I[i_5+1][i_7+i_5-1][i_6-1][i_4] * 1;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4312351113_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I)));
