...
void kernel_3326112315_09(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < PB_P; i_2++) {
                A[i_0-1][i_1+2][2] = A[i_0-2][i_1+2][2] - A[i_0-1][i_1+3][2] * A[i_0-1][i_1+1][2] + 4;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_P; i_3++) {
        for (int i_4 = 0; i_4 < i_3; i_4++) {
            for (int i_5 = 0; i_5 < PB_P; i_5++) {
                A[i_3-1][i_4+2][2] = D[i_4+1][i_5][i_4] - 3;
            }
        }
    }
    for (int i_6 = 2; i_6 < PB_P; i_6++) {
        for (int i_7 = i_6; i_7 < PB_P; i_7++) {
            for (int i_8 = i_6; i_8 < PB_P; i_8++) {
                A[i_6][i_7+2][2] = D[i_7][i_6-2][i_7] + 5;
            }
        }
    }
#pragma endscop
...
kernel_3326112315_09(xa,ya,za,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D));
