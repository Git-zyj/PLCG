...
void kernel_4224312221_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_2 = 2; i_2 < PB_L-2; i_2++) {
        for (int i_3 = 2; i_3 < i_2; i_3++) {
            for (int i_4 = 1; i_4 < PB_L; i_4++) {
                B[i_4-1][i_3][i_2] = C[i_3][i_4][i_2+2] - B[i_2-1][i_3-2][i_4+1] - B[i_4-1][i_2-2][i_3] - B[i_3][i_4][i_2+1] + 1;
            }
        }
    }
#pragma endscop
...
kernel_4224312221_05(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
