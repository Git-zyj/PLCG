...
void kernel_4216152215_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
        ...
        for (int i_1 = 0; i_1 < -i_0+PB_M-2; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_L; i_2++) {
                for (int i_3 = 2; i_3 < PB_Q; i_3++) {
                    A[i_1+i_0+2][i_2][i_3] = C[i_2+i_0][i_3-2][i_1][i_2] + C[i_1][i_0-2][i_2][i_3] + C[i_1+2][i_0][i_2][i_0] * C[i_1][i_0+2][i_3][i_2] - B[i_0][i_3-2][i_2][i_2] * 3;
                }
            }
        }
        for (int i_4 = 1; i_4 < min(-i_0+PB_Q, i_0); i_4++) {
            for (int i_5 = 3; i_5 < min(-i_0+PB_Q+2, i_0); i_5++) {
                for (int i_6 = 2; i_6 < -i_4+PB_M-1; i_6++) {
                    B[i_4][i_5-2][i_6][i_6] = C[i_5-2][i_0][i_0][i_6] * C[i_6][i_5+2][i_4+i_0][i_5+i_0-2] - C[i_0][i_5][i_4][i_6-1] - C[i_0][i_6-2][i_5][i_4-1] - C[i_6][i_0][i_0][i_4] * C[i_6-2][i_4][i_0][i_5] - A[i_6+i_4+1][i_5+1][i_0] - B[i_4][i_5-3][i_6][i_6] * 3;
                }
            }
        }
    }
...
kernel_4216152215_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
