    ...
    for (int i_3 = 1; i_3 < PB_L-1; i_3++) {
        for (int i_4 = 0; i_4 < -i_3+PB_L; i_4++) {
            for (int i_5 = 3; i_5 < -i_3+PB_L-1; i_5++) {
                B[i_3][i_5-1] = F[i_4][i_5+i_3] + G[i_5+1][i_3] - H[i_5][i_4+i_3][i_5+i_3+1] - B[i_4+1][i_5+1] * B[i_4+2][i_3-1] + B[i_4+2][i_5-3] + 1;
            }
        }
        for (int i_6 = 1; i_6 < PB_M; i_6++) {
            B[i_3][i_6-1] = F[i_6][i_3] + E[i_6][i_3][0] + 5;
        }
    }
        ...
        for (int i_8 = i_7; i_8 < -i_7+PB_P; i_8++) {
            for (int i_9 = i_7; i_9 < PB_M; i_9++) {
                for (int j_0 = 1; j_0 < PB_L; j_0++) {
                    B[i_9+1][i_8] = I[i_9][j_0][i_8+i_7][i_7-1] + H[i_9][j_0-1][i_8] + J[j_0][i_7][i_8] - 5;
                }
            }
        }
    }
...
init_array(xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4424331323_08(xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J)));
