...
void kernel_2216151325_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-2; i_0++) {
        B[i_0] = C[i_0-1] - C[i_0-1] + C[i_0] - C[i_0] - C[i_0+1] * C[i_0] + B[i_0] - B[i_0+1] * 3;
        B[i_0] = C[i_0-1] * C[i_0] * C[i_0] * B[i_0+2] - 6;
    }
#pragma endscop
...
kernel_2216151325_03(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
