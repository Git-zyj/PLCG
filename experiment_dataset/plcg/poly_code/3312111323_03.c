...
void kernel_3312111323_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-2; i_0++) {
        B[i_0+1] = D[i_0] - 4;
        B[i_0+1] = D[i_0+1] * D[i_0+1] - B[i_0+2] * B[i_0] + 6;
    }
...
kernel_3312111323_03(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
