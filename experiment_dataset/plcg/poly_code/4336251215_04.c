        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_Q+1, PB_Q-1); i_2++) {
                for (int i_3 = 1; i_3 < PB_P-1; i_3++) {
                    A[i_0][i_1][i_2][i_3] = D[i_1+1][i_2][i_3+1][i_0] * E[i_3+1][i_0+1][i_0][i_1] - D[i_3][i_0+1][i_0][i_1+1] + E[i_1+1][i_2][i_0][i_2+i_0-1] * E[i_2][i_3+1][i_0][i_2+1] * D[i_0][i_2][i_3][i_1] - D[i_0][i_3-1][i_1][i_2-1] + 4;
                }
            }
            B[i_1] = F[i_1-1][0] + G[i_0][i_1+1] + B[i_1+1] * B[i_1-1] - 6;
        }
        for (int i_4 = 1; i_4 < i_0; i_4++) {
            B[i_4-1] = F[i_4][i_0-1] - F[i_0-1][i_0] * F[i_4][i_0] + G[i_0][i_4] * H[0] - B[i_4] - B[i_4+1] + 3;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4336251215_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H)));
