...
static void print_array(int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xb,int yb,int zb,int vb,int wb,DATA_TYPE POLYBENCH_5D(B,xB,yB,zB,vB,wB,xb,yb,zb,vb,wb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh))
{
int i_0, i_1, i_2, i_3, i_4;
...
void kernel_4432131325_02(int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xb,int yb,int zb,int vb,int wb,DATA_TYPE POLYBENCH_5D(B,xB,yB,zB,vB,wB,xb,yb,zb,vb,wb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
...
#pragma scop
    ...
    for (int i_2 = 4; i_2 < PB_L-1; i_2++) {
        for (int i_3 = 1; i_3 < i_2; i_3++) {
            for (int i_4 = 1; i_4 < -i_3+PB_M; i_4++) {
                for (int i_5 = 2; i_5 < min(-i_3+PB_P, -i_2+PB_P+4); i_5++) {
                    B[i_5][i_2-1][i_2+1][i_4+i_3][i_4] = E[i_3-1][i_5][i_2+1][i_4] + E[i_3+1][i_2-1][i_5][i_4] * F[i_4+i_3][i_2][i_5] + E[i_2][i_3][i_5+1][0] - B[i_4-1][i_2-2][i_2][i_5+i_3][i_5] + B[i_5-2][i_2-1][i_2+1][i_4+i_3-1][i_4-1] - B[i_4+1][i_3-1][i_3+1][i_5+i_2-4][i_2-2] + 3;
                }
            }
        }
    }
    for (int i_6 = 2; i_6 < PB_L-2; i_6++) {
        for (int i_7 = 1; i_7 < PB_M-1; i_7++) {
            D[i_7-1] = G[i_6][i_7] + G[i_7+1][i_6] + H[i_6] + D[i_7-1] - 2;
        }
        D[i_6] = H[i_6+1] * H[i_6] * H[i_6] * D[i_6-2] + D[i_6+2] - 6;
    }
#pragma endscop
...
init_array(xd,POLYBENCH_ARRAY(D), xb,yb,zb,vb,wb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4432131325_02(xd,POLYBENCH_ARRAY(D), xb,yb,zb,vb,wb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xd,POLYBENCH_ARRAY(D), xb,yb,zb,vb,wb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H)));
