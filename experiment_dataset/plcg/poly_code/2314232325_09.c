...
void kernel_2314232325_09(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        ...
        C[0] = D[i_0] - D[i_0] - D[i_0] + 1;
    }
    for (int i_2 = 0; i_2 < PB_M-2; i_2++) {
        C[0] = E[i_2] - E[i_2] - D[i_2+2] + D[i_2] * C[0] + C[0] - C[0] - 2;
    }
#pragma endscop
...
kernel_2314232325_09(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
