...
void kernel_3436132323_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        A[i_0][i_0] = E[i_0] + E[i_0] * F[i_0-1][0] * A[i_0-2][i_0-2] * A[i_0-1][i_0-1] * 2;
    }
    for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
        A[i_1-1][i_1-1] = E[i_1] - E[i_1] - E[i_1] - E[i_1] - C[i_1+2] - C[i_1-2] - 2;
    }
    for (int i_2 = 2; i_2 < PB_M-2; i_2++) {
        C[i_2] = E[i_2] - E[i_2+1] - E[i_2] * E[i_2+2] * C[i_2+2] * C[i_2-2] - 5;
    }
    for (int i_3 = 2; i_3 < PB_M-1; i_3++) {
        for (int i_4 = 0; i_4 < min(PB_P, -i_3+PB_M-1); i_4++) {
            for (int i_5 = i_3; i_5 < PB_N-2; i_5++) {
                D[i_5][i_4+i_3][i_4] = G[i_5+i_4][i_3][i_4] - D[i_5-2][i_4+i_3+1][i_3+1] - D[i_5+2][i_4+i_3-2][i_4] + 5;
            }
        }
    }
#pragma endscop
...
kernel_3436132323_00(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
