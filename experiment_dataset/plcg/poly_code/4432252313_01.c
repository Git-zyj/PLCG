...
void kernel_4432252313_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-3; i_0++) {
        A[i_0+2] = E[i_0] + F[i_0-2] + F[i_0-1] * E[i_0-2] - A[i_0+3] * A[i_0+1] + A[i_0+1] - A[i_0+1] * 2;
        for (int i_1 = 2; i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = 0; i_2 < PB_L; i_2++) {
                for (int i_3 = 1; i_3 < PB_L-2; i_3++) {
                    B[i_3][i_2][i_1-1][i_1-1] = G[i_1][i_1+i_0][i_3+2][2] + G[i_3-1][i_2][i_1][i_0-2] - H[i_1+1][i_2+1][i_3][i_0-2] + B[i_3][i_2][i_1-2][i_1-2] + 3;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L-3; i_4++) {
        for (int i_5 = 2; i_5 < PB_L-1; i_5++) {
            for (int i_6 = 1; i_6 < -i_5+PB_P; i_6++) {
                C[i_4+2][i_5][i_6] = I[i_6][0] - J[i_4][i_6-1][i_5] + H[i_6+i_5][i_5+2][i_4+1][i_4-2] * K[i_6-1][i_5-1] * L[i_4][i_6][0] - L[i_5][i_4][i_4-2] + H[i_4][i_6+i_5][i_4+1][i_5-2] - I[i_5][i_5-1] - C[i_5+1][i_4][i_6+1] + C[i_4+1][i_5][i_6] * C[i_4+2][i_5+1][i_6] + C[i_4+3][i_5][i_6+1] - 2;
            }
        }
        for (int i_7 = 2; i_7 < PB_P-1; i_7++) {
            for (int i_8 = 1; i_8 < -i_7+PB_M; i_8++) {
                D[i_4][i_7-2][i_7] = L[i_7][i_8][i_4] + J[i_7][i_4][i_8] + I[i_4][i_8-1] * J[i_7][i_4-1][0] * L[i_8+i_7][i_4][0] * D[i_4][i_7-1][i_7+1] + 4;
            }
        }
    }
#pragma endscop
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4432252313_01(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L)));
