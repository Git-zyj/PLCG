...
void kernel_3414311325_07(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
    ...
    for (int i_1 = PB_L - 1; i_1 >= 2; i_1--) {
        C[i_1-1] = D[i_1] + D[i_1-2] + 1;
        C[i_1+1] = E[i_1-1] - D[i_1] - D[i_1+2] * 6;
        D[i_1] = E[i_1] * C[i_1+2] - C[i_1+1] + 2;
    }
#pragma endscop
...
kernel_3414311325_07(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
