...
void kernel_4412151125_03(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        B[i_0-1][i_0-1] = E[i_0] + E[i_0-1] + F[i_0+1][1] * E[i_0+1] * 6;
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            B[i_1][i_1] = F[i_1][i_0] - F[i_0][i_1-1] + 6;
        }
        B[i_0-2][i_0-2] = E[i_0-1] + E[i_0-1] + E[i_0] - E[i_0] - E[i_0+1] + 6;
    }
        ...
        for (int i_3 = 1; i_3 < i_2; i_3++) {
            for (int i_4 = 2; i_4 < min(-i_2+PB_Q, PB_M-2); i_4++) {
                for (int i_5 = 1; i_5 < PB_M-1; i_5++) {
                    D[i_2][1][i_4][i_5-1] = G[i_5][i_3][i_4+1][i_2] * G[i_4][i_5][i_3+1][i_2+1] + G[i_5+1][i_4-1][i_2-1][i_3-1] - H[i_5][i_3-1][i_4+1] * G[i_2][i_5+1][i_3-1][i_4] + G[i_5][i_2+1][i_3][i_4+i_2] * G[i_3][i_5][i_2][i_4+1] - G[i_4][i_2][i_3][i_5-1] - G[i_4][i_3][i_5+1][i_2] - D[i_2-2][1][i_4+2][i_5-1] - D[i_2][1][i_4-2][i_5+1] - 5;
                }
            }
        }
    }
...
init_array(xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4412151125_03(xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H)));
