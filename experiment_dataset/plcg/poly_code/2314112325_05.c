...
void kernel_2314112325_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-3; i_0++) {
        B[i_0+3] = D[i_0] * D[i_0] * B[i_0+1] - B[i_0] + 5;
...
kernel_2314112325_05(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
