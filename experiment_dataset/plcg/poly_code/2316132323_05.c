...
void kernel_2316132323_05(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-2; i_0++) {
        C[i_0] = D[i_0+2] * D[i_0-1] * 4;
        C[i_0-1] = D[i_0] - D[0] * D[i_0+1] * D[i_0] + 1;
    }
...
kernel_2316132323_05(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
