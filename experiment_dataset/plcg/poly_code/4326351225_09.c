...
void kernel_4326351225_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
        ...
        for (int i_1 = 2; i_1 < min(-i_0+PB_N+2, PB_M-1); i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_N-1; i_2++) {
                for (int i_3 = i_1; i_3 < -i_1+PB_N; i_3++) {
                    A[i_2+i_1][i_1][i_2][i_3+1] = D[i_1-1][i_0][i_3][i_2] * A[i_2+i_1][i_1+1][i_2-1][i_3+1] - A[i_3+i_1][i_1][i_3][i_0] - A[i_1+i_0-2][i_1-2][i_0][i_2+1] * A[i_2+i_1+1][i_1][i_2+1][i_3-1] * 3;
                }
            }
        }
    }
        ...
        for (int i_5 = i_4; i_5 < -i_4+PB_M; i_5++) {
            for (int i_6 = 1; i_6 < -i_5+PB_L; i_6++) {
                for (int i_7 = 1; i_7 < -i_4+PB_M; i_7++) {
                    B[i_7+i_4][i_5][i_6][i_5] = D[i_5+1][i_4-1][0][i_6] - E[i_5+i_4][i_7+1][i_6] * D[i_7+1][i_4][i_5][i_6] * D[i_7][i_6][i_5][i_4] + F[i_6-1][i_7+1][i_5+i_4+1][i_7] + G[i_5][i_7][i_6-1][i_4-1] - G[i_7][i_4][i_6+i_5][1] - G[i_7][i_4][i_5][i_6] * D[i_5+1][i_6-1][i_7+i_4][i_6] - E[i_7-1][i_5+1][i_6+1] - 2;
                }
            }
        }
        for (int i_8 = 0; i_8 < min(i_4, -i_4+PB_M+1); i_8++) {
            for (int i_9 = 0; i_9 < PB_L-1; i_9++) {
                A[i_8+i_4][i_4][i_8][i_9+1] = H[i_9][i_4][i_8+i_4] + I[i_8][i_9][i_4+1] * H[i_8+i_4-1][i_9][i_8] * 3;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4326351225_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
