...
void kernel_4332132125_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf)){
    ...
    for (int i_1 = 2; i_1 < PB_M; i_1++) {
        for (int i_2 = 2; i_2 < -i_1+PB_Q; i_2++) {
            for (int i_3 = 0; i_3 < -i_2+PB_P-2; i_3++) {
                C[i_3+1] = E[i_2][i_1][i_3+i_2] - E[i_3][i_2-2][i_2+i_1] - E[i_3+i_2-2][i_1][i_3+2] * F[i_1-2][i_3+i_2+2] + 6;
            }
        }
        for (int i_4 = i_1; i_4 < PB_M; i_4++) {
            C[i_4+1] = D[0] - D[i_4] * C[i_4-1] - 1;
        }
    }
#pragma endscop
...
kernel_4332132125_00(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
