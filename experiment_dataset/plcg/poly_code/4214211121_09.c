...
void kernel_4214211121_09(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = 0; i_2 < PB_P; i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_M-1; i_3++) {
                    A[i_1+i_0][i_2][i_3-1] = A[i_3+i_0+1][i_2][i_1-1] * 3;
                }
            }
            for (int i_4 = 1; i_4 < PB_M+1; i_4++) {
                B[i_1][i_0] = C[i_1][i_4-1][i_0-1] + D[i_4-1][i_1] * 3;
            }
        }
    }
#pragma endscop
...
kernel_4214211121_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
