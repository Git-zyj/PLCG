...
void kernel_4216212225_05(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = i_1; i_2 < PB_P; i_2++) {
                for (int i_3 = 0; i_3 < PB_M; i_3++) {
                    B[i_1+3][i_2][i_3] = C[i_3][i_2][0] - 1;
                }
            }
        }
        for (int i_4 = 0; i_4 < i_0; i_4++) {
            for (int i_5 = 0; i_5 < i_0; i_5++) {
                B[i_0+2][i_4][i_5] = B[i_0+4][i_5][i_4] - B[i_0+2][i_4+1][i_5] - 3;
            }
        }
    }
#pragma endscop
...
kernel_4216212225_05(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
