...
void kernel_4316352223_01(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
        ...
        for (int i_1 = 2; i_1 < min(-i_0+PB_L, i_0); i_1++) {
            for (int i_2 = 2; i_2 < PB_L; i_2++) {
                for (int i_3 = 0; i_3 < min(PB_L-2, -i_2+PB_M-1); i_3++) {
                    B[i_2-2][i_0][i_1][i_2] = D[i_0][i_1+1][i_2][0] * D[i_3][i_1-1][i_0][i_2-2] - E[i_3+i_2+1][i_1+i_0][0] * D[i_1-1][i_2][i_1-2][i_0] + F[i_3][i_0][i_2][i_0] - G[i_3][i_0-1][i_1] * D[i_1][i_0-2][i_0+1][i_1-2] + F[i_2-1][i_0-2][i_1][i_0-1] + C[i_0-1][i_0][i_3+2][i_1+1] * 3;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L; i_4++) {
        for (int i_5 = 1; i_5 < PB_L-2; i_5++) {
            for (int i_6 = 1; i_6 < PB_M; i_6++) {
                for (int i_7 = max(i_4, 4); i_7 < min(-i_6+PB_M, PB_L); i_7++) {
                    B[i_7-2][i_5][i_6][i_7] = E[i_6-1][i_7][i_5+2] + H[i_7+i_6][i_5][i_4][i_4] * B[i_7-4][i_5][i_6][i_7-2] - B[i_7-2][i_5-1][i_6][i_7] + 1;
                }
            }
        }
        for (int i_8 = 2; i_8 < PB_M-2; i_8++) {
            for (int i_9 = 1; i_9 < PB_L; i_9++) {
                for (int j_0 = 2; j_0 < min(min(-i_8+PB_M-2, -i_4+PB_P+1), -i_9+PB_N); j_0++) {
                    C[j_0-1][j_0][i_9][i_4+1] = H[i_9][j_0-2][i_4][i_8] - H[j_0][i_9+2][i_4][i_8] - E[i_8-1][j_0][i_4] + F[i_8][i_9-1][j_0+i_4-1][i_8-2] * I[j_0+i_9][j_0+i_8+2][i_9+1] * C[i_8][i_8+1][i_9][i_4+1] - 4;
                }
            }
        }
    }
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4316352223_01(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
