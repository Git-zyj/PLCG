...
void kernel_2234132223_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_N-1; i_1++) {
        A[i_1+1] = C[i_1] * C[i_1] - C[i_1] + C[i_1] - C[i_1] + 1;
    }
#pragma endscop
...
kernel_2234132223_09(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
