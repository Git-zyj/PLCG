...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < PB_Q-2; i_1++) {
            for (int i_2 = 2; i_2 < PB_L; i_2++) {
                for (int i_3 = 0; i_3 < PB_Q-2; i_3++) {
                    B[2][i_2][i_1+2] = B[2][i_2-2][i_3+2] * 1;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-1; i_4++) {
        for (int i_5 = 0; i_5 < -i_4+PB_M-1; i_5++) {
            C[i_5+i_4][i_4] = C[i_5+i_4+1][i_4+1] + C[i_5+i_4-1][i_4-2] + 3;
        }
    }
        ...
        for (int i_7 = 1; i_7 < -i_6+PB_Q; i_7++) {
            for (int i_8 = 0; i_8 < PB_Q; i_8++) {
                for (int i_9 = 0; i_9 < -i_8+PB_Q; i_9++) {
                    D[i_9][i_7+i_6][i_9+i_8][i_8] = F[i_6][i_9+i_8][i_7-1] + 4;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), INIT_SEED);
kernel_4422212125_07(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F)));
