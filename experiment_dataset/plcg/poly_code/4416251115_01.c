...
void kernel_4416251115_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk)){
        ...
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_M-1; i_2++) {
                for (int i_3 = i_0; i_3 < PB_L; i_3++) {
                    A[i_0][i_2][i_1][i_3-1] = E[i_1][i_2+i_0+1][i_3][i_1+1] + E[i_0-1][i_1][i_2][i_3-1] * F[i_1][i_3][i_2-1] + F[i_3+i_2][i_1][i_0-1] - G[i_3][i_2+i_0][i_2][i_1] + 3;
                }
            }
        }
        B[i_0+1] = H[i_0+1] * I[i_0-1] * J[i_0][0] - I[i_0] - B[i_0] - 3;
    }
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 0; i_5 < PB_L; i_5++) {
            for (int i_6 = i_4; i_6 < min(PB_N, -i_5+PB_M); i_6++) {
                for (int i_7 = 1; i_7 < min(-i_5+PB_L, i_5); i_7++) {
                    A[i_4][i_6][i_5][i_7-1] = G[i_6][i_4][i_7+i_5][i_5+1] + E[i_5][i_6-1][i_4+1][i_5] + E[i_6+i_5][i_6][i_4][i_4] * E[i_6][i_7][i_4-1][i_4-1] - G[i_6][i_7][i_4+1][i_5] + 6;
                }
            }
        }
        for (int i_8 = 1; i_8 < min(i_4, -i_4+PB_L); i_8++) {
            for (int i_9 = 1; i_9 < min(i_4, -i_4+PB_Q+1); i_9++) {
                D[i_8-1][i_4][i_9+i_4-1][i_8] = F[i_9][i_8+i_4][1] * F[i_9-1][i_4][i_8] - K[i_8][i_9][i_8+i_4] * 6;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4416251115_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K)));
