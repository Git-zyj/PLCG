...
void kernel_2412111225_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        B[i_0-1] = E[i_0] - 3;
        B[i_0-1] = E[i_0-1] - 1;
        C[i_0-1] = E[i_0] + B[i_0-2] - B[i_0-1] - 2;
...
kernel_2412111225_00(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E));
