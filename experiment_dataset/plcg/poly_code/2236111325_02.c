...
void kernel_2236111325_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        for (int i_1 = 3; i_1 < min(i_0, PB_L-1); i_1++) {
            A[i_1-1] = C[i_1-1] + A[i_1-2] + A[i_1-3] * A[i_1+1] * 4;
        }
    }
...
kernel_2236111325_02(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
