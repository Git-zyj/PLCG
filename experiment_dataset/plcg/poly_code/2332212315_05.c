...
void kernel_2332212315_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        ...
        B[i_0] = 6;
        B[i_0] = D[i_0] + B[i_0+1] - B[i_0] + B[i_0-1] - 2;
    }
#pragma endscop
...
kernel_2332212315_05(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
