...
void kernel_4324331321_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 4; i_0 < PB_M-1; i_0++) {
        A[i_0-1] = D[i_0] + E[i_0] * D[i_0+1] * A[i_0+1] - A[i_0-3] - 6;
        B[i_0] = D[i_0+1] + E[i_0] * F[i_0] * B[i_0-1] * 6;
        for (int i_1 = 2; i_1 < PB_M; i_1++) {
            for (int i_2 = 2; i_2 < -i_1+PB_M; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_0+PB_M, -i_1+PB_M+2); i_3++) {
                    C[i_0][i_2][i_3+i_0-1][i_2-1] = G[i_3][i_0+1][i_1][i_1-1] - H[i_1][i_3][i_2] * I[i_1][i_0][i_3][i_2] * C[i_2+1][i_3][i_2+i_1][i_3-1] + C[i_0+1][i_2-1][i_3+i_0][i_2-2] * C[i_0-2][i_2+2][i_3+i_0-4][i_2+1] - C[i_3-1][i_0][i_3+i_1-2][i_0-1] + 1;
                }
            }
        }
    }
...
kernel_4324331321_00(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
