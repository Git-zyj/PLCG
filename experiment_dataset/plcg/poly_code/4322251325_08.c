...
void kernel_4322251325_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        A[1] = D[i_0] + E[i_0+1] - E[i_0] - 1;
        A[1] = D[0] - F[i_0][0] - E[i_0] + E[i_0+1] * A[1] * A[1] * 4;
        for (int i_1 = 1; i_1 < min(min(i_0, -i_0+PB_P), PB_M-2); i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_P-1; i_2++) {
                for (int i_3 = 1; i_3 < min(min(-i_0+PB_P+1, -i_1+PB_M-2), -i_2+PB_M); i_3++) {
                    C[i_3+i_1][i_2+i_0][i_0-1][i_3] = G[i_2+1][i_3-1][i_1+i_0][0] * G[i_0][i_2][i_1][i_3+1] + H[i_3+i_2][i_3-1][i_1-1] - G[i_1-1][i_2][i_2][i_0-1] - I[i_3][i_3+1][i_0-1][i_2] * I[i_1+1][i_2][i_0][i_3] - C[i_3+i_1][i_2+i_0-1][i_0-2][i_3] * C[i_3+i_1-1][i_2+i_0][i_0-1][i_3-1] - C[i_2+i_1][i_3+i_0-1][i_0-1][i_1] - C[i_3+i_1+2][i_2+i_0+1][i_0-1][i_3+1] + 1;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4322251325_08(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I)));
