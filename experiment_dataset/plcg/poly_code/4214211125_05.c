...
void kernel_4214211125_05(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 0; i_1 < PB_L-3; i_1++) {
            for (int i_2 = 0; i_2 < min(i_0, PB_L-1); i_2++) {
                for (int i_3 = 0; i_3 < i_1; i_3++) {
                    B[i_2][i_1+3][i_3] = C[i_3][i_2+1][i_1+1] - 2;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        for (int i_5 = i_4; i_5 < PB_M; i_5++) {
            for (int i_6 = i_5; i_6 < PB_L-1; i_6++) {
                B[i_5][i_4+1][i_6] = B[i_5][i_6+1][i_4-1] * 3;
            }
        }
    }
#pragma endscop
...
kernel_4214211125_05(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
