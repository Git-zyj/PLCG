        ...
        for (int i_1 = 0; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_0+PB_Q, -i_1+PB_M); i_3++) {
                    C[i_2-1][i_3] = D[i_2+1][i_0-1][i_0][i_3-1] * D[i_2-1][i_2-1][i_3+i_0][i_1+1] - E[i_0][i_1+1][i_2] + F[i_2][i_3+i_1][i_3-1][i_0+1] - 3;
                }
                C[i_2][i_0] = G[i_2][i_1] - D[i_1][i_2-1][i_0][i_1+1] * H[i_1][i_0] * C[i_1][i_2] * 6;
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        for (int i_5 = 0; i_5 < min(-i_4+PB_L-1, PB_M-1); i_5++) {
            C[i_4][i_5] = I[i_5] - G[i_4+1][i_5] + H[i_4][i_4-1] - I[i_5] + G[i_5+i_4+1][i_4-1] * G[i_4-1][i_5+i_4] * E[i_5+1][i_4+1][0] * 3;
        }
    }
#pragma endscop
...
init_array(xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4312251115_05(xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I)));
