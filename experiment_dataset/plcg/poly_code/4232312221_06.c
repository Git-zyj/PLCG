...
void kernel_4232312221_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_M; i_2++) {
                for (int i_3 = 2; i_3 < PB_N; i_3++) {
                    A[i_2+i_0][i_1][i_3][i_1] = C[i_3][i_1+1][i_3-2] - 3;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L; i_4++) {
        for (int i_5 = 0; i_5 < PB_P-2; i_5++) {
            B[i_4][i_5] = B[i_4-2][i_5+1] + B[i_4][i_5+2] + B[i_4][i_5+1] + 2;
        }
    }
#pragma endscop
...
kernel_4232312221_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
