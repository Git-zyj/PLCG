    ...
    for (int i_3 = 0; i_3 < PB_L; i_3++) {
        for (int i_4 = 1; i_4 < PB_P+1; i_4++) {
            for (int i_5 = 1; i_5 < i_4; i_5++) {
                C[i_5][i_4][i_3] = E[i_4][i_5][i_4+1] - D[i_5-1][i_4-1] * 6;
            }
        }
    }
#pragma endscop
...
kernel_3332131121_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
