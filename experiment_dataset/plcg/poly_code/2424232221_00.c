...
void kernel_2424232221_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        A[i_0+1] = E[i_0] * F[i_0] - E[i_0] + F[i_0] * A[i_0] - A[i_0-1] * 1;
        B[i_0+2] = E[i_0] - F[i_0] + E[i_0] + A[i_0+1] * B[i_0+4] - 6;
    }
    ...
    for (int i_3 = 1; i_3 < PB_M; i_3++) {
        for (int i_4 = 2; i_4 < i_3; i_4++) {
            D[i_4] = G[i_3][i_4-1] - E[1] + H[i_4][i_3-1] + G[i_3-1][i_4+2] * D[i_4-2] - D[i_4-1] * 6;
        }
    }
#pragma endscop
...
kernel_2424232221_00(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
