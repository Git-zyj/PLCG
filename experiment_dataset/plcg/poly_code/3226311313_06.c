...
void kernel_3226311313_06(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_2 = 0; i_2 < PB_P; i_2++) {
        for (int i_3 = 1; i_3 < i_2; i_3++) {
            for (int i_4 = 0; i_4 < PB_N; i_4++) {
                B[i_3][i_4+1] = C[i_4][i_3][i_2] - B[i_3-1][i_4+1] * B[i_4][i_2] - B[i_3][i_4] - 2;
            }
        }
    }
#pragma endscop
...
kernel_3226311313_06(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
