...
void kernel_4422251323_03(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk)){
        ...
        for (int i_1 = 1; i_1 < min(PB_M, i_0); i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_Q, PB_M-1); i_2++) {
                for (int i_3 = 1; i_3 < PB_M; i_3++) {
                    B[i_2+1][i_0][i_3][0] = E[i_1][i_3+i_2+1][i_2+i_0][i_3] - E[i_2][i_2][i_0][i_1] - F[i_3-1][i_2+1][i_1] + G[i_2][i_3][i_1-1] + H[i_3][i_1][i_0][i_2-1] * E[i_3][i_2+1][i_1][0] + 3;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
            for (int i_6 = 0; i_6 < PB_P-1; i_6++) {
                for (int i_7 = 1; i_7 < PB_M+1; i_7++) {
                    B[i_4+1][i_7+1][i_5][0] = H[i_4+1][i_7-1][i_5][i_7] + E[i_7-1][i_6][i_5][i_4] * E[i_5+1][i_7][i_4-1][i_6] - B[i_4+1][i_7-1][i_5][0] * B[i_4+3][i_6+1][i_5][0] * B[i_4+1][i_7][i_5+1][0] - B[i_4+3][i_7+1][i_5][0] + 3;
                }
            }
        }
        C[i_4] = I[i_4+1] * J[i_4] * I[i_4-1] + C[i_4+1] * 2;
    }
    for (int i_8 = 2; i_8 < PB_M-1; i_8++) {
        C[i_8-2] = K[i_8][1] * I[i_8] + J[i_8] - I[i_8] * J[i_8] - J[i_8] + J[i_8] * J[i_8+1] - 5;
    }
#pragma endscop
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4422251323_03(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K)));
