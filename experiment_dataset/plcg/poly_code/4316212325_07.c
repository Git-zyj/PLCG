...
void kernel_4316212325_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_2 = 0; i_2 < PB_Q-4; i_2++) {
        for (int i_3 = 1; i_3 < -i_2+PB_Q-3; i_3++) {
            for (int i_4 = max(2, i_2); i_4 < -i_2+PB_M-3; i_4++) {
                for (int i_5 = 2; i_5 < -i_2+PB_Q-4; i_5++) {
                    C[i_3+i_2][i_5+1][i_4-2][i_5+i_2+2] = C[i_5+i_3-1][i_2+3][i_4-2][i_5+i_2+4] - C[i_3+i_2][i_4-1][i_5-2][i_4+i_2] + C[i_4+i_2+3][i_3][i_5-2][i_3+i_2+3] * C[i_5+i_3+1][i_2+1][i_4][i_5+i_2+2] - 5;
                }
            }
        }
    }
...
kernel_4316212325_07(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
