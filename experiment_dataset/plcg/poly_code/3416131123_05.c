...
void kernel_3416131123_05(int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        for (int i_1 = i_0; i_1 < -i_0+PB_P; i_1++) {
            for (int i_2 = 0; i_2 < PB_L; i_2++) {
                C[i_1][i_0+2][i_2] = E[i_2][i_0][i_1+i_0] + E[i_0][i_0][i_1] - E[i_1][i_2][i_0] + E[i_1][i_2][i_0-1] * 3;
            }
        }
        D[i_0-2] = F[i_0] - D[i_0] * 2;
        for (int i_3 = i_0; i_3 < PB_L-1; i_3++) {
            for (int i_4 = 0; i_4 < PB_Q; i_4++) {
                C[i_0-1][i_3+1][i_4] = 2;
            }
        }
        D[i_0] = F[i_0] + F[i_0] + F[0] - F[i_0] * 2;
    }
#pragma endscop
...
kernel_3416131123_05(xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F));
