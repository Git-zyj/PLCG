...
void kernel_4232312311_09(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
        ...
        for (int i_1 = 0; i_1 < min(PB_Q-1, i_0); i_1++) {
            for (int i_2 = 0; i_2 < PB_P; i_2++) {
                for (int i_3 = 1; i_3 < PB_M; i_3++) {
                    A[i_3][i_2][i_1+1] = A[i_0][i_3-1][i_1+1] + A[i_0][i_3][i_1] - 5;
                }
            }
        }
        for (int i_4 = 0; i_4 < PB_M-2; i_4++) {
            for (int i_5 = 0; i_5 < PB_P-1; i_5++) {
                for (int i_6 = 0; i_6 < PB_Q; i_6++) {
                    B[i_4+1][i_0][i_5][0] = C[i_0][i_4][i_5][i_6] - B[i_6+1][i_4][i_0-1][0] + B[i_4+2][i_0+1][i_5][0] - B[i_4+2][i_0][i_5][0] + B[i_4+1][i_0][i_5+1][0] - 2;
                }
            }
        }
    }
...
kernel_4232312311_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
