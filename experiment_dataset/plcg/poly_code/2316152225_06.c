...
void kernel_2316152225_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        A[i_0] = D[i_0][i_0+1] - A[i_0-2] - A[i_0-1] * 2;
        A[i_0] = E[i_0] - E[i_0] - E[i_0] * E[i_0-2] - E[i_0] - 3;
    }
    for (int i_1 = 2; i_1 < PB_L; i_1++) {
        for (int i_2 = 1; i_2 < PB_P-2; i_2++) {
            C[i_1][i_2] = D[i_2][i_1] * D[i_1+2][1] - D[i_2-1][i_1-2] + D[i_2][i_1] + D[i_2-1][i_1] * D[i_1][i_2] - D[i_1][i_2] * C[i_1-2][i_2+2] - C[i_1-2][i_2] + 2;
        }
    }
#pragma endscop
...
kernel_2316152225_06(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
