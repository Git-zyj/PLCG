...
void kernel_4226131221_01(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 1; i_1 < min(-i_0+PB_L, i_0); i_1++) {
            for (int i_2 = 0; i_2 < PB_Q; i_2++) {
                for (int i_3 = 0; i_3 < min(PB_Q, -i_2+PB_M); i_3++) {
                    B[i_0+2][i_3+i_2][i_3] = C[i_3][i_0+1][1] * C[i_1-1][i_0][i_2] * 6;
                }
            }
            for (int i_4 = 1; i_4 < min(-i_0+PB_L+1, PB_M-2); i_4++) {
                B[i_4][i_1+i_0][i_0] = C[i_1][i_4+i_0-1][1] + C[i_4-1][i_1+i_0][0] + C[i_4-1][i_1][i_0] - B[i_4][i_1+i_0-1][i_0] - B[i_4+2][i_1+i_0][i_0] + 2;
            }
        }
    }
#pragma endscop
...
kernel_4226131221_01(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
