...
void kernel_4234111325_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
...
#pragma scop
        ...
        for (int i_1 = 2; i_1 < -i_0+PB_P-1; i_1++) {
            for (int i_2 = 1; i_2 < min(PB_Q, -i_0+PB_P); i_2++) {
                for (int i_3 = i_1; i_3 < PB_L-1; i_3++) {
                    A[i_0+1][i_3+i_1][i_0][i_1] = C[i_1][i_0+1][i_3+1][i_2+i_0] - A[i_0+1][i_3+i_2-1][i_0][i_2] * A[i_3+1][i_1+i_0+1][i_3][i_1] + A[i_0+1][i_3+i_1-2][i_0][i_1-2] - 1;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_Q-2; i_4++) {
        for (int i_5 = 0; i_5 < PB_L-1; i_5++) {
            for (int i_6 = 0; i_6 < min(-i_5+PB_Q, -i_4+PB_P-2); i_6++) {
                A[i_5+1][i_6+i_4+2][i_5][i_4+2] = D[i_6][i_6+i_5][i_4] * 6;
            }
        }
    }
#pragma endscop
...
kernel_4234111325_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
