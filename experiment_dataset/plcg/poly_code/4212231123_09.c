...
void kernel_4212231123_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf)){
        ...
        for (int i_1 = 0; i_1 < PB_M; i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_M; i_2++) {
                for (int i_3 = PB_L+1 - 1; i_3 >= 1; i_3--) {
                    A[i_1][i_0][i_2][i_3-1] = C[i_2+i_1][i_0][i_3][1] - D[i_2][i_0][i_3-1][i_2+i_1] + 2;
                }
            }
        }
        for (int i_4 = 0; i_4 < min(-i_0+PB_L, PB_M-1); i_4++) {
            B[i_4] = E[i_4][i_0] * F[i_4+i_0] - E[i_0][i_4+i_0] - B[i_4+1] - 6;
        }
    }
#pragma endscop
...
kernel_4212231123_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F));
