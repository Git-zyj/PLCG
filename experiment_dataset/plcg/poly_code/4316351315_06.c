...
void kernel_4316351315_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj)){
        ...
        for (int i_1 = i_0; i_1 < min(-i_0+PB_P, PB_M-2); i_1++) {
            for (int i_2 = 1; i_2 < min(-i_1+PB_M, i_0); i_2++) {
                for (int i_3 = 0; i_3 < min(-i_1+PB_M, -i_0+PB_L); i_3++) {
                    A[i_1+1][i_2+1][i_3+i_0-1][i_2] = D[i_1][i_3+i_0][i_2][i_0] - E[i_2+i_1][i_0][i_3+1][i_1+i_0-1] * F[i_3+i_1][i_3+1][i_2][i_0] + E[i_2][i_3][i_0-1][1] - A[i_2][i_3+1][i_1+i_0][i_3] - A[i_1+2][i_2+2][i_3+i_0-2][i_2+1] + A[i_1+1][i_2][i_3+i_0-1][i_2-1] * A[i_0+2][i_1][i_3+i_2-1][i_1-1] + 3;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < min(i_4, -i_4+PB_Q); i_5++) {
            for (int i_6 = 1; i_6 < min(PB_M-1, -i_4+PB_L); i_6++) {
                for (int i_7 = 1; i_7 < PB_M-1; i_7++) {
                    A[i_7+1][i_6][i_5+i_4][i_6-1] = D[i_4-1][i_6][i_7+1][i_5] * G[i_6][i_7+i_5+1][0] + F[i_4][i_6][i_5][0] + F[0][i_6][i_7][i_5+i_4] * H[i_7-1][i_7][i_4][i_5+1][i_5] - I[i_7][i_5-1][i_6] - C[i_5+1][i_6][i_6] + 2;
                }
                C[i_4][i_5][i_5] = I[i_5-1][i_6+i_4][i_6] * G[i_6-1][i_4+1][i_5] - J[i_6][i_4] - C[i_6+1][i_5][i_5] - 4;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4316351315_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J)));
