...
void kernel_4236132121_01(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        B[2] = C[i_0-1] + C[i_0] + C[i_0] + 1;
    }
    for (int i_1 = 0; i_1 < PB_M; i_1++) {
        B[2] = C[i_1] * C[i_1] - B[2] - 1;
    }
#pragma endscop
...
kernel_4236132121_01(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
