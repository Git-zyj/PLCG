...
void kernel_2232112121_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
...
#pragma scop
    ...
    for (int i_2 = 4; i_2 < PB_M; i_2++) {
        B[i_2-2] = C[i_2] * D[i_2-2][i_2] * B[i_2-4] + 1;
    }
#pragma endscop
...
kernel_2232112121_00(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
