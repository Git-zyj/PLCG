...
void kernel_2412251315_05(int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-1; i_0++) {
        D[i_0] = E[i_0] * E[i_0+1] * F[i_0+1] + F[i_0] + 6;
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            D[i_1-1] = G[i_1+1][i_0] + H[i_1][i_0] - I[i_0+1][i_1][i_1] * H[i_0+1][i_1] + F[i_0] * G[i_1][i_0-1] - H[i_1][i_0] - F[i_1] - 2;
        }
    }
    for (int i_2 = 1; i_2 < PB_P-1; i_2++) {
        for (int i_3 = 1; i_3 < -i_2+PB_N; i_3++) {
            D[i_3+1] = G[i_2][i_3] + H[i_3][i_2] - H[i_3+i_2][i_3] - G[i_3+i_2+1][i_3] + F[i_2] + H[i_2][i_3] * G[i_3-1][i_2+1] + D[i_3] - 4;
        }
...
kernel_2412251315_05(xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
