...
void kernel_2334211123_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L+1; i_0++) {
        B[i_0] = D[i_0-1] - B[i_0] * 5;
        B[i_0] = 2;
    }
...
kernel_2334211123_09(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
