...
void kernel_4226111215_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-2; i_2++) {
                for (int i_3 = 0; i_3 < PB_L-1; i_3++) {
                    A[i_0][i_2+1][i_1] = C[i_3][i_0][i_1][i_2] * A[i_1][i_2+1][i_3+1] - A[i_1-1][i_3+1][i_2] + A[i_3][i_2+2][i_1] + 4;
                }
            }
        }
        for (int i_4 = 1; i_4 < min(-i_0+PB_M, i_0); i_4++) {
            B[i_4-1][i_0+1] = D[i_4+i_0][0] - B[i_4][i_0+1] * 2;
        }
    }
#pragma endscop
...
kernel_4226111215_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
