...
void kernel_2426232223_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        A[i_0] = E[i_0-1] + F[i_0+2] + F[i_0] + E[i_0] - A[i_0-1] * C[i_0+1] * 5;
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            C[i_1+1] = 6;
        }
        for (int i_2 = 0; i_2 < PB_L-1; i_2++) {
            C[i_2+1] = G[i_2][i_0] * H[i_0][i_2+1] * F[i_2] - H[i_0][i_2] + C[i_2+2] + C[i_2+3] * 6;
        }
    }
...
kernel_2426232223_04(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
