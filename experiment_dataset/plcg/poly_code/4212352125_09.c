...
void kernel_4212352125_09(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P-2; i_0++) {
        for (int i_1 = 0; i_1 < min(-i_0+PB_M, PB_P-3); i_1++) {
            for (int i_2 = 0; i_2 < i_1; i_2++) {
                A[i_0][i_1+1][i_2+1] = C[i_1][i_2+2][i_0+2] * C[i_0][i_1][i_2+1] * A[i_0-1][i_1+3][i_2+2] * B[i_1+i_0][i_1][i_2] + 2;
            }
        }
        for (int i_3 = 1; i_3 < PB_N-2; i_3++) {
            for (int i_4 = 0; i_4 < min(-i_0+PB_M, -i_3+PB_M); i_4++) {
                for (int i_5 = 0; i_5 < -i_3+PB_N-2; i_5++) {
                    B[i_4+i_3][i_3][i_5] = D[i_5+i_3][2][i_0][i_4] + D[i_5+i_3+2][i_4+i_0][i_0][i_4+i_3] - D[i_5+i_3][i_5][i_0+2][i_4] - D[i_4][i_0][i_5][i_3] - E[i_3-1][i_0][i_4][i_4+2] + D[i_4][i_5][i_3][i_3] + E[i_5][i_5][i_4+i_3][i_0-1] * 3;
                }
            }
        }
    }
...
kernel_4212352125_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
