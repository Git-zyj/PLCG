...
void kernel_3226211325_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        for (int i_1 = i_0; i_1 < PB_M-2; i_1++) {
            B[i_1] = B[i_1] + B[i_1+2] + 4;
        }
...
kernel_3226211325_03(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
