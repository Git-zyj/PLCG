        ...
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            for (int i_2 = 2; i_2 < min(-i_0+PB_M, -i_1+PB_M-2); i_2++) {
                for (int i_3 = 0; i_3 < min(PB_L-2, -i_1+PB_Q); i_3++) {
                    B[i_1-1][i_3+1][i_0][i_3+1] = C[i_1-1][i_2-2][i_3][i_2] + C[i_3+2][i_1-2][i_0][i_2-1] - D[i_1][i_1][i_0][i_2+1] + D[i_2][i_1][i_0][i_2] - C[i_1][i_3][i_0][i_2-1] + D[i_2+i_1+2][i_0][i_3+2][i_0-2] * E[i_2+i_0][i_1][i_3+i_1] - C[i_1][i_2][i_0][0] + 1;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_M; i_4++) {
            for (int i_5 = 1; i_5 < PB_P-1; i_5++) {
                for (int i_6 = i_4; i_6 < PB_L-1; i_6++) {
                    B[i_4-1][i_6][i_5][i_6] = C[i_5][i_6][i_4][i_0] * B[i_4][i_0][i_6][i_0] * B[i_4-1][i_6+1][i_5-1][i_6+1] * B[i_4][i_6][i_5+1][i_6] - 3;
                }
            }
        }
    }
...
kernel_4232252315_00(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
