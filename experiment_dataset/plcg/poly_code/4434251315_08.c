...
void kernel_4434251315_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,int wg,DATA_TYPE POLYBENCH_5D(G,xG,yG,zG,vG,wG,xg,yg,zg,vg,wg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        for (int i_1 = i_0; i_1 < min(PB_L-1, -i_0+PB_L+1); i_1++) {
            for (int i_2 = 0; i_2 < min(PB_P-2, -i_1+PB_Q-1); i_2++) {
                for (int i_3 = 0; i_3 < i_0; i_3++) {
                    A[i_3][i_1][i_2+1][i_0+1] = E[i_1][i_0][i_0][i_3] * F[i_2][i_3][i_0][i_1] + E[i_1+i_0-1][i_3+1][i_2+i_1+1][i_2] + A[i_0][i_1+1][i_2+2][i_3+1] - A[i_0-1][i_1][i_2][i_3] + 2;
                }
            }
            for (int i_4 = 1; i_4 < PB_L; i_4++) {
                for (int i_5 = 1; i_5 < -i_0+PB_L; i_5++) {
                    B[i_5][i_4-1][i_5][i_1+1] = E[i_5+i_0][i_1][i_5][i_4+1] - G[i_0-1][i_1][i_5+1][i_4][i_0] + H[i_1][i_0-1][i_4] - E[i_1][i_5][i_1-1][i_4] - E[i_4][i_5][i_1+i_0+1][i_4+1] * E[i_5-1][i_0-1][i_1+1][i_5] * B[i_5-1][i_4-1][i_5-1][i_1+1] + B[i_5][i_4-1][i_5][i_1+2] * B[i_1-1][i_5-1][i_1-1][i_4+1] + 2;
                }
            }
        }
    }
    for (int i_6 = 1; i_6 < PB_L; i_6++) {
        for (int i_7 = 1; i_7 < PB_L; i_7++) {
            for (int i_8 = 1; i_8 < min(i_6, -i_6+PB_Q); i_8++) {
                D[i_7][i_8-1][i_8+i_6] = F[i_7][i_8][i_8][i_6-1] - H[i_7-1][i_6-1][0] + I[i_8][i_6][i_7+1] + I[i_7][i_8][0] * I[i_8][i_8][i_7] - 4;
            }
        }
        for (int i_9 = 0; i_9 < PB_L-1; i_9++) {
            for (int j_0 = 0; j_0 < min(i_6, -i_6+PB_Q-2); j_0++) {
                D[i_9][j_0][j_0+i_6+1] = I[i_9+1][j_0][j_0] - J[j_0][i_9] * H[i_6][j_0][i_9] + I[i_6][i_9][j_0] + K[j_0][i_9] - D[i_9][i_6][j_0+i_6+2] * D[i_9][j_0][j_0+i_6] * D[i_9+1][j_0][j_0+i_6+1] * 4;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4434251315_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K)));
