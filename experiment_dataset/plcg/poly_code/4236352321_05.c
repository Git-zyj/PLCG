...
void kernel_4236352321_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 2; i_2 < PB_L; i_2++) {
                for (int i_3 = 3; i_3 < -i_1+PB_L; i_3++) {
                    A[i_0][i_1][i_2][i_3-1] = C[i_1+2][i_2][i_3+1][i_0] + C[i_2][i_1][i_2+1][i_3-2] + D[i_3][i_0][i_3+i_1][i_2] + E[i_3][i_0][i_1][i_0] * A[i_0-2][i_1][i_2][i_3-3] - A[i_0-1][i_1-1][i_2][i_3-3] - A[i_2][i_1][i_3-2][i_0] + A[i_2-2][i_3-2][i_1][i_0-1] + 5;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 2; i_5 < min(-i_4+PB_M, PB_L-2); i_5++) {
            for (int i_6 = i_5; i_6 < PB_Q-4; i_6++) {
                B[i_5-2][i_4+1][i_6+2] = F[i_6][i_4] - G[i_6][i_5][i_4] + H[i_6][i_4][i_6] * H[i_6-1][i_5+i_4][i_4+1] + G[i_6][i_4][i_5+2] * B[i_5-2][i_4+1][i_6+4] - B[i_5-2][i_4+2][i_6+1] + 3;
            }
        }
    }
#pragma endscop
...
kernel_4236352321_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
