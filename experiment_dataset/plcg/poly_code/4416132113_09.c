...
void kernel_4416132113_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg)){
        ...
        for (int i_1 = 2; i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = 0; i_2 < i_1; i_2++) {
                for (int i_3 = 0; i_3 < i_0; i_3++) {
                    A[i_1][i_3][i_2][i_0+1] = E[i_1][i_0][i_3][i_2] * E[i_0-1][i_2][i_3][i_1] * 2;
                }
            }
            B[i_0+1][i_1+1] = F[i_1+i_0][i_1-2] * F[i_1][i_0] + F[i_0][i_1-2] * B[i_0+1][i_1] * 6;
        }
        for (int i_4 = 2; i_4 < PB_L-2; i_4++) {
            B[i_0+1][i_4+1] = G[i_4+2] * F[i_4][i_0-2] * F[i_4-2][i_0] + G[i_4+1] + 6;
            B[i_0][i_4+1] = F[i_4][i_0] - 2;
        }
    }
#pragma endscop
...
kernel_4416132113_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
