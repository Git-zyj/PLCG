...
void kernel_2222112321_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 4; i_0 < PB_L; i_0++) {
        for (int i_1 = 3; i_1 < PB_P-1; i_1++) {
            B[i_1-3] = C[i_0][i_1+1] + B[i_0] * B[i_0-2] * 1;
        }
        B[i_0-2] = B[i_0-4] + 4;
    }
#pragma endscop
...
kernel_2222112321_00(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
