...
void kernel_4334211225_08(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 1; i_1 < min(-i_0+PB_M-2, i_0); i_1++) {
            A[i_1+i_0][i_1] = D[i_0-1][i_1-1] - D[i_1][i_1+i_0-1] + A[i_1+i_0+2][i_0+2] - A[i_1+i_0-2][i_1] * 1;
        }
        for (int i_2 = i_0; i_2 < PB_Q-2; i_2++) {
            for (int i_3 = 0; i_3 < -i_2+PB_Q-2; i_3++) {
                C[i_3][i_0-1][i_3+i_2+2] = 5;
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < min(i_4, PB_M); i_5++) {
            for (int i_6 = 1; i_6 < min(PB_M, -i_5+PB_Q); i_6++) {
                for (int i_7 = 2; i_7 < min(PB_M, -i_5+PB_Q); i_7++) {
                    C[i_7][i_6-1][i_7+i_5] = E[i_7][i_5-1][i_6] + C[i_5][i_7-2][i_6+i_5] * C[i_6][i_7-1][i_6+i_5-1] + 1;
                }
            }
        }
    }
...
kernel_4334211225_08(xa,ya,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
