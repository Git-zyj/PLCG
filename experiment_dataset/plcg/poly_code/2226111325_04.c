...
void kernel_2226111325_04(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_M-2 - 1; i_0 >= 2; i_0--) {
        B[i_0] = 6;
        B[i_0] = C[i_0+1][i_0] - B[i_0-2] - B[i_0+1] + B[i_0+2] - 5;
    }
#pragma endscop
...
kernel_2226111325_04(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
