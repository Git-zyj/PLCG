        ...
        for (int i_1 = 2; i_1 < min(-i_0+PB_P, PB_M-2); i_1++) {
            for (int i_2 = 0; i_2 < PB_M; i_2++) {
                for (int i_3 = 1; i_3 < PB_M; i_3++) {
                    B[i_0][i_0][i_2][i_3-1] = E[i_2][i_1-2][i_0-1][i_1+2] * F[i_1+1][i_3][i_2] + B[i_0-1][i_0-1][i_2][i_3] + 2;
                }
            }
            for (int i_4 = 2; i_4 < -i_0+PB_Q-2; i_4++) {
                for (int i_5 = 1; i_5 < -i_4+PB_M-1; i_5++) {
                    B[i_0][i_0][i_4][i_5] = F[i_4+i_1-1][i_5][i_0] - G[i_5+1][i_4+i_1][i_0+1][i_1] * E[i_1+2][i_0-1][i_5][i_4] - G[i_1][i_5][i_0-1][i_4] + G[i_1+1][i_0][i_5][i_4+i_0] - E[i_1][i_5-1][i_4+i_0+2][i_5] - G[i_0][i_5+i_4+1][i_1-2][i_4-2] + E[i_4][i_1+i_0][i_0+1][i_1] - G[i_5][i_4][i_5+i_1][i_0] * G[i_5][i_1-1][i_4][i_0] - 4;
                }
            }
        }
        C[i_0] = H[i_0] - H[i_0] + H[i_0-2] + I[i_0] - I[i_0] * H[i_0] - C[i_0+1] - 6;
        C[i_0+1] = H[i_0+1] + H[i_0] * C[i_0] - 4;
    }
#pragma endscop
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4412252211_01(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I)));
