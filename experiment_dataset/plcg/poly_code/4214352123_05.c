        ...
        for (int i_1 = 2; i_1 < PB_L-1; i_1++) {
            for (int i_2 = i_0; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 0; i_3 < min(i_0, PB_L-2); i_3++) {
                    A[i_3][i_0][i_2][i_2-1] = C[i_2][i_3+2][i_0+1][i_1] * C[i_0][i_1+1][i_3][i_2-1] * D[i_1+1][i_2+1][i_3][i_0] + A[i_3][i_1-2][i_2][i_2-1] - 5;
                }
            }
        }
        B[i_0] = E[i_0] + F[2] * F[i_0-2] + E[i_0] - G[i_0+2] + E[i_0] + B[i_0-1] * 4;
    }
#pragma endscop
...
kernel_4214352123_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
