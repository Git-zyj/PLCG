...
void kernel_4314151323_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
        ...
        for (int i_1 = 1; i_1 < PB_Q; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_Q-1; i_2++) {
                for (int i_3 = 0; i_3 < i_1; i_3++) {
                    A[i_2][i_1][i_3] = D[i_1-1][i_1][i_3][i_2+i_0+1] + D[i_2+1][i_3][i_1][i_0] + D[i_3][i_2][i_1][i_2+i_0] * D[i_1][i_2+i_0][i_3][i_0] + D[i_1][i_2][i_3][i_0] * A[i_0][i_2+1][i_3] + A[i_2+1][i_1][i_3] - A[i_2][i_3+1][i_1] + 4;
                }
            }
        }
    }
    for (int i_4 = 3; i_4 < PB_Q-1; i_4++) {
        for (int i_5 = 0; i_5 < -i_4+PB_Q-1; i_5++) {
            for (int i_6 = 1; i_6 < -i_4+PB_L; i_6++) {
                B[i_4+1][i_6+i_4][i_6+1] = E[i_6][i_5+1] * F[i_4-1][i_6-1][i_5] * E[i_6][i_5] + F[i_5][i_6][i_5+i_4+1] * F[i_4][i_6][i_5] + B[i_4+1][i_6+i_4-2][i_6-1] + B[i_4-1][i_6+i_4-1][i_6+2] - 1;
            }
            for (int i_7 = 1; i_7 < PB_L-2; i_7++) {
                C[i_7][i_4-1][0] = F[i_5][i_7][i_4] * F[i_5][i_7+1][i_4-1] * F[i_7-1][i_5+i_4][0] * C[i_7+2][i_4-3][0] + C[i_7+1][i_4-1][0] - C[i_7][i_4-2][0] * 1;
            }
        }
    }
#pragma endscop
...
kernel_4314151323_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
