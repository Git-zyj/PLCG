...
void kernel_2324212321_06(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        for (int i_1 = i_0; i_1 < PB_L; i_1++) {
            A[0][i_1+2] = A[0][i_1+3] + A[0][i_1+4] + A[0][i_1+1] - 5;
        }
    }
    for (int i_2 = 0; i_2 < PB_L; i_2++) {
        A[0][i_2+1] = D[i_2] + C[i_2+4] + 1;
    }
...
kernel_2324212321_06(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
