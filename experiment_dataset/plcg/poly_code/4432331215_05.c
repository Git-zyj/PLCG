        ...
        for (int i_1 = 0; i_1 < PB_M; i_1++) {
            for (int i_2 = 1; i_2 < PB_L; i_2++) {
                for (int i_3 = 1; i_3 < PB_L; i_3++) {
                    D[i_3-1][i_2-1][i_0+1][i_3-1] = E[i_2-1][i_0+1][i_3][i_2] + F[i_2-1][i_1][i_3][i_0] + G[i_2][i_3-1][i_1] - 3;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M; i_4++) {
        B[i_4-1] = H[i_4-1] * H[i_4] * 1;
    }
    for (int i_5 = 1; i_5 < PB_N; i_5++) {
        B[i_5-1] = H[0] + I[i_5] + I[i_5] + 5;
        for (int i_6 = 1; i_6 < PB_L; i_6++) {
            for (int i_7 = 1; i_7 < -i_5+PB_M; i_7++) {
                for (int i_8 = 1; i_8 < PB_L; i_8++) {
                    D[i_5][i_7-1][i_8][i_5] = E[i_6-1][i_8][i_7+i_5][1] + D[i_7][i_5][i_8][i_7] * D[i_5][i_7-1][i_8-1][i_5] - D[i_5][i_7][i_8][i_5] * 5;
                }
            }
        }
    }
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4432331215_05(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I)));
