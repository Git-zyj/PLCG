...
void kernel_4236152213_06(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
            for (int i_2 = max(2, i_0); i_2 < -i_1+PB_M; i_2++) {
                A[i_0][i_2] = C[i_1-2][i_0] + D[i_2+i_1][i_0][i_0] + D[i_1+2][i_0][i_2] + D[i_1][i_2-1][i_0] - D[i_1][i_2-2][i_0] * A[i_1-1][i_2] + A[i_1][i_2-1] + 6;
            }
        }
    }
        ...
        for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
            for (int i_5 = 1; i_5 < PB_M; i_5++) {
                for (int i_6 = 1; i_6 < PB_M-1; i_6++) {
                    A[i_6+1][i_5] = D[i_4][i_6+1][0] + E[i_5][i_4-1][i_3][i_3-1] + E[i_3][i_5-1][i_4-1][i_6] - E[i_4][i_3][i_5][i_4-1] + E[i_4+1][i_3+1][i_6-1][i_5] * 1;
                }
            }
        }
    }
...
kernel_4236152213_06(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
