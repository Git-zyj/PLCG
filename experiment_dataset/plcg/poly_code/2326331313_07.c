...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_P; i_1++) {
        for (int i_2 = 0; i_2 < min(-i_1+PB_M+1, i_1); i_2++) {
            B[i_1+1][i_2+1] = F[i_1-1][0] * G[i_2+i_1-1][0] - E[1] * B[i_1][i_2] + B[i_1][i_2+1] - B[i_1+1][i_2] + B[i_2+1][i_1+2] - 4;
        }
        A[i_1+1] = F[i_1][i_1-1] + E[i_1] - E[i_1-1] - H[i_1] + 3;
    }
#pragma endscop
...
kernel_2326331313_07(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
