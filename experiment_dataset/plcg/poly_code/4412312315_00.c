...
#endif
static void init_array(int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int seed)
{
srand(seed);
int i_0, i_1, i_2, i_3;
        ...
        for (int i_4 = 1; i_4 < i_0; i_4++) {
            for (int i_5 = 2; i_5 < PB_P+1; i_5++) {
                for (int i_6 = 1; i_6 < PB_M; i_6++) {
                    B[i_6][i_4][i_5-2][i_4-1] = D[i_5][i_4][i_0+1][i_6] + 1;
                    C[i_6][i_4][i_5-1][i_0-1] = C[i_6-1][i_4][i_5-1][i_0] - C[i_6][i_4-1][i_5-1][i_0] - 1;
                }
            }
            for (int i_7 = 3; i_7 < min(PB_P-1, -i_0+PB_L+1); i_7++) {
                for (int i_8 = 0; i_8 < PB_P; i_8++) {
                    D[i_0][i_4][i_7][i_8] = E[i_8][i_7+i_0-1][i_0][i_4] - B[i_0+1][i_4][i_7-2][i_4-1] * B[i_0-1][i_4+1][i_7-3][i_4] * D[i_4][i_7][i_8][i_0-1] + D[i_0+1][i_4+1][i_7+1][i_8] - 2;
                }
            }
        }
    }
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), INIT_SEED);
kernel_4412312315_00(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E)));
