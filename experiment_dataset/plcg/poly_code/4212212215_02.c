...
void kernel_4212212215_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_N; i_1++) {
            A[i_1][i_0][i_0] = A[i_1-1][i_0+1][i_0+1] - 6;
        }
    }
        ...
        for (int i_3 = 2; i_3 < i_2; i_3++) {
            for (int i_4 = 1; i_4 < PB_L; i_4++) {
                for (int i_5 = 2; i_5 < PB_Q; i_5++) {
                    B[i_2-1][i_4][i_3-1][i_5] = C[i_3+1][i_4-1][i_5-2][i_2] - C[i_2+1][i_5-2][i_4][i_3-1] * B[i_5-1][i_4][i_2-1][i_3-1] * B[i_2-2][i_5-1][i_3-2][i_4] + 3;
                }
            }
        }
    }
...
kernel_4212212215_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
