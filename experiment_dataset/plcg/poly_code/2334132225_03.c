...
void kernel_2334132225_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 3; i_1 < PB_M+2; i_1++) {
        B[i_1-2] = D[i_1] * D[i_1+2] + D[i_1] - B[i_1-3] * 5;
    }
    for (int i_2 = 2; i_2 < PB_M+1; i_2++) {
        B[i_2-2] = D[i_2] + D[i_2+2] + D[i_2] * D[i_2] * D[i_2-2] - B[i_2-1] * 3;
    }
#pragma endscop
...
kernel_2334132225_03(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
