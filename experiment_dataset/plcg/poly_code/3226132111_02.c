...
void kernel_3226132111_02(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P+2; i_0++) {
        for (int i_1 = 2; i_1 < min(-i_0+PB_M, PB_P); i_1++) {
            B[i_0][i_0-2] = C[i_1+1][i_1] * D[i_1] * D[i_1+i_0] - B[i_1][i_1-2] + 3;
        }
        B[i_0][i_0-2] = D[i_0] * D[i_0] * 1;
    }
#pragma endscop
...
kernel_3226132111_02(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
