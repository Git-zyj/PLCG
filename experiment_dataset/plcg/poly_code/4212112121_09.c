...
void kernel_4212112121_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 1; i_1 < min(i_0, -i_0+PB_M-3); i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_P; i_2++) {
                for (int i_3 = 0; i_3 < -i_1+PB_L; i_3++) {
                    A[i_1+i_0][i_3+i_1][i_2-1][i_0-1] = C[i_3][i_2+i_0][i_1] * A[i_1+i_0][i_3+i_1-1][i_2-1][i_0] * 4;
                }
            }
            B[2][i_1+i_0+1] = B[2][i_1+i_0+3] - 5;
        }
    }
#pragma endscop
...
kernel_4212112121_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
