...
void kernel_4424351211_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj)){
        ...
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_M, -i_1+PB_P); i_2++) {
                for (int i_3 = 0; i_3 < min(i_2, -i_1+PB_Q); i_3++) {
                    B[i_1][i_2][0][i_0] = F[i_3+i_1][i_0][i_2+1] - G[i_0][i_3][i_2+1][i_2+i_1] - G[i_1-1][i_3][i_0][i_2] - H[i_0][i_2][1][i_3+i_1] * H[i_2-1][i_0-1][i_1][i_2+i_1] * H[i_2+i_0][i_3][i_1][1] * B[i_1+1][i_2][0][i_0-1] + 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        A[i_4-1] = E[i_4+1] + I[i_4-1] * E[i_4] * E[i_4] + A[i_4-1] + 3;
    }
    for (int i_5 = 1; i_5 < PB_P; i_5++) {
        for (int i_6 = i_5; i_6 < PB_P; i_6++) {
            for (int i_7 = 1; i_7 < -i_6+PB_M; i_7++) {
                for (int i_8 = 2; i_8 < -i_5+PB_P; i_8++) {
                    D[i_5][i_5+1][i_7][i_8-1] = H[i_7][i_6+1][i_8+i_5][0] - G[i_8][i_7][i_6][i_8+1] + H[i_7][i_5][i_8-1][i_5] - J[i_7+i_6][i_8+i_5][i_5][0] - D[i_5][i_5+1][i_7-1][i_8-2] - D[i_8][i_8+1][i_7-1][i_5-1] + 1;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4424351211_06(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J)));
