...
void kernel_4226152121_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-4; i_0++) {
        A[i_0+2] = C[0] - C[i_0-1] * C[i_0+2] * C[i_0] - C[i_0] - C[i_0] + C[i_0] + A[i_0+4] * 2;
    }
    for (int i_1 = PB_M-2 - 1; i_1 >= 0; i_1--) {
        A[i_1+2] = C[i_1] - C[i_1] * C[i_1] - 6;
    }
#pragma endscop
...
kernel_4226152121_06(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
