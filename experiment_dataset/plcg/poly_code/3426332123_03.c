...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
        for (int i_2 = i_1; i_2 < -i_1+PB_L-1; i_2++) {
            B[i_2+i_1+1][i_1-2] = F[i_2][i_1] - G[i_2][i_1+2] * G[i_2+2][i_1] + 2;
            for (int i_3 = 2; i_3 < -i_2+PB_L-1; i_3++) {
                B[i_3+i_2+1][i_2-2] = H[i_1][i_3-2][i_2] - I[i_3][i_2+i_1][i_3] - B[i_3+i_2+1][i_3-1] - 6;
            }
        }
        D[i_1-1] = J[i_1+1] - E[i_1-2] * E[i_1] * 1;
    }
#pragma endscop
...
kernel_3426332123_03(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
