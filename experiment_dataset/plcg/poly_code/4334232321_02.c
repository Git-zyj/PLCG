...
void kernel_4334232321_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_Q; i_1++) {
            for (int i_2 = 2; i_2 < -i_0+PB_P+2; i_2++) {
                for (int i_3 = 2; i_3 < i_2; i_3++) {
                    A[i_3][i_0][i_2][i_1+1] = D[i_3][i_0][i_1][i_2+i_0-2] - E[i_3-1][i_2+2][i_0-2][i_1+i_0] - E[i_3+i_2][i_0][i_0][i_1] - A[i_3+2][i_0][i_2+1][i_1+1] + A[i_3-2][i_0][i_2+2][i_1] - A[i_1-1][i_0][i_2][i_3+1] + A[i_0][i_3][i_2-2][i_1+1] - 4;
                }
            }
        }
        B[i_0-2] = F[i_0] + F[i_0] - F[i_0+2] * G[i_0][2] * B[i_0-3] + B[i_0-1] - B[i_0-4] * 2;
    }
    for (int i_4 = 2; i_4 < PB_Q; i_4++) {
        for (int i_5 = 0; i_5 < min(i_4, PB_L-2); i_5++) {
            for (int i_6 = 0; i_6 < PB_P; i_6++) {
                for (int i_7 = 1; i_7 < PB_L-2; i_7++) {
                    C[i_6][i_5+2][i_7][i_6] = E[i_7-1][i_6][i_4][i_5] - C[i_4][i_5+1][i_7-1][i_4] - C[i_6][i_7+2][i_4-2][i_6] - 2;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4334232321_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G)));
