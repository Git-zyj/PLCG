...
void kernel_2324111321_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-2; i_0++) {
        A[i_0] = D[i_0] + B[i_0] * B[i_0+2] - 2;
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            B[i_1] = A[i_0+1] + B[i_1-1] - B[i_1-2] - B[i_1+2] * 2;
        }
    }
    for (int i_2 = 2; i_2 < PB_M-3; i_2++) {
        for (int i_3 = 0; i_3 < min(-i_2+PB_M-3, i_2); i_3++) {
            C[i_3+i_2+1][i_2] = D[i_3] - A[i_3] - C[i_3+i_2+3][i_2] + C[i_3+i_2-1][i_2-2] - 5;
        }
    }
#pragma endscop
...
kernel_2324111321_00(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
