...
void kernel_4414331321_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,int wb,DATA_TYPE POLYBENCH_5D(B,xB,yB,zB,vB,wB,xb,yb,zb,vb,wb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_Q; i_2++) {
                for (int i_3 = 3; i_3 < min(-i_2+PB_L, -i_0+PB_L); i_3++) {
                    A[i_0+1][i_2][i_3-1][i_1-1] = E[i_3+i_0][i_2-1][i_3][i_1-1] - F[i_1][i_3+i_2][i_0][i_0-1][i_1] * E[i_3][i_0][i_1][i_0] * G[i_1-1][i_0+1][i_2][1] + A[i_1+1][i_2][i_0-1][i_3-3] * A[i_1+1][i_3][i_2-1][i_0-3] * 2;
                }
            }
        }
    }
    for (int i_4 = 4; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 3; i_5 < PB_Q; i_5++) {
            for (int i_6 = 2; i_6 < -i_5+PB_Q; i_6++) {
                for (int i_7 = i_4; i_7 < min(-i_4+PB_L+1, -i_5+PB_Q+3); i_7++) {
                    B[i_5][i_4][i_7][i_6+i_5][i_6] = H[i_5][i_4][i_7][i_4] * G[i_7][i_5][i_4][0] + H[i_5][i_7+i_4-1][i_7-1][i_6+1] - B[i_5][i_4+2][i_7][i_6+i_5][i_6] - B[i_6-2][i_5][i_7][i_6+i_4-4][i_4-2] + B[i_5-2][i_4-1][i_6-1][i_7+i_5-3][i_7-1] + B[i_5-2][i_4][i_7][i_6+i_5-2][i_6] + B[i_5][i_4][i_7-1][i_6+i_5-2][i_6-2] - 4;
                }
            }
        }
        for (int i_8 = 0; i_8 < PB_L-1; i_8++) {
            for (int i_9 = 1; i_9 < i_4; i_9++) {
                C[i_8][i_9][i_4] = I[i_8][0] + J[i_9+1][i_8][i_4] * C[i_8+1][i_9-1][i_4] - C[i_4-1][i_9][i_8] - D[i_9+1][i_8][i_4-2] - 5;
            }
            for (int j_0 = 1; j_0 < PB_L; j_0++) {
                D[j_0][i_4][i_8] = K[i_8][i_4] * L[i_8+1][j_0-1][i_4] * I[j_0][i_4] - 6;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,wb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4414331321_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,wb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L));
