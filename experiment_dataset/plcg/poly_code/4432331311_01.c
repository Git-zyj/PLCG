...
void kernel_4432331311_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 1; i_1 < -i_0+PB_L-2; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_L-1; i_2++) {
                A[i_1][i_1+i_0+1][i_2+1] = E[i_1-1][i_0][i_2] - F[i_1][i_2+i_0+1] + G[i_1][i_2][i_0-1] - E[i_2+i_0][i_1][i_0] + A[i_1+1][i_1+i_0+2][i_2+1] + 3;
            }
        }
        for (int i_3 = 0; i_3 < i_0; i_3++) {
            for (int i_4 = max(1, i_3); i_4 < PB_Q; i_4++) {
                B[i_3][i_4-1][i_0] = F[i_3][i_0-1] * H[i_4][i_3] * B[i_3+1][i_4][i_0] - 1;
            }
        }
        for (int i_5 = i_0; i_5 < PB_L; i_5++) {
            for (int i_6 = 1; i_6 < PB_L; i_6++) {
                C[i_6][i_0][i_5] = I[i_0][i_5][i_6] * E[i_5][i_6+1][i_0] * I[i_6][i_5][i_6] + G[i_5][i_6+1][i_0] + G[i_5][i_5-1][i_0] - C[i_6-1][i_0][i_5+1] + C[i_6][i_0][i_5-1] + C[i_6+1][i_0-1][i_5] - C[i_6][i_0-1][i_5] + C[i_5][i_0][i_6+1] - C[i_6-1][i_0][i_5-1] - 3;
            }
        }
    }
        ...
        for (int i_8 = 0; i_8 < PB_Q-1; i_8++) {
            for (int i_9 = 1; i_9 < PB_L; i_9++) {
                for (int j_0 = 0; j_0 < PB_M-1; j_0++) {
                    D[j_0][i_9][i_8][i_7] = D[j_0][i_9][i_8+1][i_7] + D[i_8][i_9][j_0][i_7+1] - D[j_0+1][i_9-1][i_8][i_7-1] * 1;
                }
            }
        }
    }
...
kernel_4432331311_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
