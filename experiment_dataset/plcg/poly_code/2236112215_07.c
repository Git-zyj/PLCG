...
void kernel_2236112215_07(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        for (int i_1 = i_0; i_1 < PB_M+1; i_1++) {
            B[i_0-1] = B[i_0-1] - B[i_1-1] * 2;
        }
        B[i_0-1] = C[i_0] * 1;
    }
#pragma endscop
...
kernel_2236112215_07(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
