...
void kernel_4216112321_09(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_Q-4; i_0++) {
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < PB_M; i_2++) {
                for (int i_3 = 0; i_3 < min(min(i_2, PB_L-2), -i_0+PB_P-1); i_3++) {
                    A[i_2][i_3][i_1] = C[i_1][i_3+i_0+1][i_2][i_1] - A[i_2][i_1+1][i_3+1] + A[i_1][i_2][i_3+2] - 4;
                }
            }
        }
        for (int i_4 = 0; i_4 < i_0; i_4++) {
            for (int i_5 = 0; i_5 < PB_M; i_5++) {
                for (int i_6 = 2; i_6 < PB_P-2; i_6++) {
                    B[i_6][i_4][i_0+2][i_4] = B[i_6][i_4+1][i_0+2][i_4+1] - B[i_6-2][i_0][i_4+2][i_0] * B[i_5][i_6+2][i_4+3][i_6+2] - B[i_5][i_4+2][i_0+4][i_4+2] * 5;
                }
            }
        }
    }
...
kernel_4216112321_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
