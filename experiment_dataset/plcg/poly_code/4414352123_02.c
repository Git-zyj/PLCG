...
void kernel_4414352123_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl),int xm,int ym,DATA_TYPE POLYBENCH_2D(M,xM,yM,xm,ym)){
...
#pragma scop
        ...
        for (int i_1 = i_0; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 2; i_2 < PB_M-2; i_2++) {
                for (int i_3 = 2; i_3 < min(-i_1+PB_M, -i_0+PB_P); i_3++) {
                    A[i_0][i_2+2][i_3+i_1][i_3] = E[i_1+1][i_2-1][i_3+i_0][i_2] + F[i_2-2][0][i_3-1][i_0-2][i_2-1] * E[i_3][i_2][i_1][i_0] * E[i_3+i_1][i_0][i_2][i_3] + G[i_1-1][i_3+2][i_2][i_3-2] - 4;
                }
            }
            for (int i_4 = 2; i_4 < PB_L-2; i_4++) {
                for (int i_5 = 4; i_5 < min(-i_4+PB_P+1, -i_1+PB_Q); i_5++) {
                    B[i_1][i_4][i_5-2][i_0] = F[i_1][i_0][i_5][i_4-1][i_5+i_1] * H[i_1][i_4-2][i_0-1][i_5] + H[i_0][i_1+2][i_4][i_1] + H[i_4][i_0-2][i_5-2][i_1] + G[i_4][i_0][i_5+i_4-1][i_1] - H[i_5][i_0][i_1][i_1] - B[i_1][i_0-2][i_5-4][i_4+2] + 2;
                }
            }
        }
    }
    for (int i_6 = 2; i_6 < PB_M; i_6++) {
        for (int i_7 = i_6; i_7 < -i_6+PB_M; i_7++) {
            C[i_6-2][1] = I[i_7][i_6] - I[i_7+i_6][i_7-1] - I[i_6-2][i_6] - J[2] * J[i_7] - 2;
            for (int i_8 = 2; i_8 < i_7; i_8++) {
                D[i_8-2][i_7][i_8] = K[i_6][i_8][i_7] * L[i_7][i_6][i_8] + M[i_8][i_7] + D[i_8-1][i_7+2][i_8+1] - 3;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M), INIT_SEED);
kernel_4414352123_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M));
