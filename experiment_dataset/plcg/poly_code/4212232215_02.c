        ...
        for (int i_1 = 2; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 1; i_2 < i_1; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_2+PB_L, -i_1+PB_L); i_3++) {
                    A[i_3][i_1-1][i_0-2][i_3+1] = C[i_3+i_2][i_0-1][i_1][i_0] * D[i_0+2][i_2][i_3+i_1][i_1] - C[i_1+1][i_3+i_2][i_0+2][i_1] + A[i_1][i_3-1][i_0-3][i_1+1] + A[i_3-1][i_1-1][i_0-2][i_3] * A[i_2-1][i_0-1][i_1-2][i_2] * 6;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M; i_4++) {
        B[i_4] = E[i_4] + E[i_4] - E[i_4] * B[i_4-1] + 3;
    }
#pragma endscop
...
kernel_4212232215_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
