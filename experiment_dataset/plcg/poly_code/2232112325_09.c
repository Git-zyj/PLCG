...
void kernel_2232112325_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_L+1; i_1++) {
        for (int i_2 = 2; i_2 < PB_L; i_2++) {
            B[i_2-2] = C[i_2] * B[i_2] - B[i_2-1] * B[i_1-1] + 1;
        }
    }
#pragma endscop
...
kernel_2232112325_09(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
