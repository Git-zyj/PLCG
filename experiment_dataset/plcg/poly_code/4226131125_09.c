...
void kernel_4226131125_09(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
        ...
        for (int i_1 = 3; i_1 < min(i_0, PB_P-1); i_1++) {
            for (int i_2 = i_0; i_2 < -i_0+PB_P+1; i_2++) {
                for (int i_3 = 2; i_3 < PB_Q; i_3++) {
                    A[i_3][i_2-1][i_1] = C[i_2][i_1+1][i_0] * C[i_1-1][i_2+i_0-1][i_3] + A[i_3-2][i_1-3][i_2] - 6;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_P; i_4++) {
        for (int i_5 = 1; i_5 < PB_L; i_5++) {
            for (int i_6 = i_5; i_6 < PB_N-1; i_6++) {
                A[i_4][i_6-1][i_5] = D[i_6+1][i_5] - C[i_5-1][i_4][i_6] - C[i_5-1][i_6-1][i_4-1] + 5;
            }
        }
    }
#pragma endscop
...
kernel_4226131125_09(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
