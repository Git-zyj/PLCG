...
void kernel_4234112225_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_0+PB_M, -i_1+PB_L); i_2++) {
                for (int i_3 = 1; i_3 < i_2; i_3++) {
                    A[i_3-1][i_2+i_1][i_0+2] = C[2][i_3][i_1][i_2+i_0] * 1;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_Q-1; i_4++) {
        for (int i_5 = 0; i_5 < PB_P; i_5++) {
            for (int i_6 = 2; i_6 < PB_L-1; i_6++) {
                B[i_6+1][i_6][i_4] = D[i_6][i_4-1][i_5] - B[i_6+1][i_6][i_4-2] * B[i_6][i_6-1][i_4] - B[i_6+1][i_6][i_4+1] + B[i_6-1][i_6-2][i_4+1] * 4;
            }
        }
    }
#pragma endscop
...
kernel_4234112225_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
