...
void kernel_4334211313_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf)){
...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < min(PB_Q, -i_0+PB_L); i_1++) {
            for (int i_2 = 2; i_2 < min(-i_1+PB_L-1, PB_P-1); i_2++) {
                for (int i_3 = 1; i_3 < min(-i_2+PB_L, i_2); i_3++) {
                    A[i_1+i_0][i_2+1][i_3][i_2-1] = D[i_2][i_0][i_1][i_3] - A[i_2+i_1+1][i_3+1][i_0+1][i_3-1] + A[i_3+i_2][i_0+1][i_1][i_0-1] * A[i_1+i_0][i_2][i_3][i_2-2] + 5;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_P; i_4++) {
        for (int i_5 = 2; i_5 < PB_M-1; i_5++) {
            B[i_5-1] = E[i_5+1][i_4] - B[i_5] - B[i_5-2] * B[i_5-2] * 4;
        }
    }
        ...
        for (int i_7 = 0; i_7 < min(i_6, PB_Q-1); i_7++) {
            for (int i_8 = 0; i_8 < -i_6+PB_L+1; i_8++) {
                for (int i_9 = 1; i_9 < -i_7+PB_Q-1; i_9++) {
                    A[i_8+i_6-1][i_9+2][i_7][i_9] = F[i_7][i_9-1][i_6][i_6][i_9+i_7+1] + 2;
                }
            }
        }
    }
...
kernel_4334211313_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F));
