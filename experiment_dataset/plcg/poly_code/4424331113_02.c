...
void kernel_4424331113_02(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
        ...
        for (int i_1 = 0; i_1 < PB_P; i_1++) {
            for (int i_2 = i_0; i_2 < min(PB_P-1, -i_0+PB_L-1); i_2++) {
                for (int i_3 = 0; i_3 < PB_P; i_3++) {
                    B[i_0][i_1][i_2+1][i_1] = E[i_2][i_3][i_1] - F[i_3][i_1][i_0][i_2] - G[i_2+i_0+1][i_3][i_1][1] * 6;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_P-1; i_4++) {
        for (int i_5 = 1; i_5 < PB_N; i_5++) {
            for (int i_6 = 0; i_6 < -i_5+PB_N; i_6++) {
                for (int i_7 = 0; i_7 < min(PB_Q, -i_5+PB_L); i_7++) {
                    B[i_5][i_7][i_4][i_7] = H[i_4][i_6][i_7+1][i_6] * F[i_6][i_4][i_5][i_5-1] * H[i_6+i_5][i_7+1][i_6+1][i_4-1] + F[i_6+1][i_7+i_5][i_4+1][i_6] - B[i_5][i_7][i_4+1][i_7] - 5;
                }
            }
        }
        for (int i_8 = 1; i_8 < PB_P; i_8++) {
            for (int i_9 = 0; i_9 < PB_P; i_9++) {
                for (int j_0 = 0; j_0 < PB_M-1; j_0++) {
                    B[j_0+1][i_4][i_8-1][i_4] = 5;
                }
            }
            D[i_4-1][i_8][i_8] = I[i_8][i_4] - J[i_8] - D[i_4][i_8][i_8] * 1;
        }
    }
#pragma endscop
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4424331113_02(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J)));
