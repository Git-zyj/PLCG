...
void kernel_4322112311_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 2; i_1 < min(i_0, PB_M-1); i_1++) {
            for (int i_2 = 2; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 2; i_3 < PB_M-1; i_3++) {
                    A[i_1][i_2][i_3-2] = A[i_2][i_3+1][i_1-1] * A[i_3-1][i_2+1][i_1-2] - A[i_1][i_2-1][i_3-2] * A[i_3][i_1+1][i_2-2] - 3;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_N-2; i_4++) {
        for (int i_5 = i_4; i_5 < -i_4+PB_N-2; i_5++) {
            for (int i_6 = 0; i_6 < -i_5+PB_N-1; i_6++) {
                for (int i_7 = 0; i_7 < min(min(min(-i_4+PB_L, -i_6+PB_N-1), -i_5+PB_L-1), PB_M-1); i_7++) {
                    B[i_6+i_5+1][i_7+1][i_7+i_6] = D[i_4][i_7][i_5+2] - B[i_7+i_6+1][i_5+2][i_7+i_5+1] + B[i_5+i_4+2][i_7+1][i_7+i_4] + 4;
                }
            }
            for (int i_8 = 0; i_8 < i_5; i_8++) {
                for (int i_9 = 0; i_9 < PB_P; i_9++) {
                    C[i_4-1][i_5+1][i_8][i_4] = C[i_4-1][i_5+1][i_8+1][i_4] * 2;
                }
            }
        }
    }
...
kernel_4322112311_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
