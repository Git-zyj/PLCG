...
void kernel_2214232323_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_P-2; i_0++) {
        for (int i_1 = i_0; i_1 < -i_0+PB_P-2; i_1++) {
            A[i_1+i_0] = C[i_1][i_1] * D[i_0+2][i_1] - C[i_0][i_1-2] * C[i_1][i_0+1] - C[i_1+i_0][i_1+i_0+2] * A[i_1+i_0-2] * A[i_1+i_0-3] + A[i_1+i_0+2] + A[i_1+i_0+1] - 5;
        }
        for (int i_2 = 2; i_2 < PB_L; i_2++) {
            B[i_0][i_2] = B[i_0+1][i_2] + B[i_0][i_2-2] + 5;
        }
    }
#pragma endscop
...
kernel_2214232323_08(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
