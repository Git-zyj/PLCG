...
void kernel_4234152115_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 0; i_1 < PB_Q-2; i_1++) {
            for (int i_2 = 0; i_2 < i_1; i_2++) {
                for (int i_3 = 1; i_3 < -i_2+PB_L; i_3++) {
                    A[i_3+i_2][i_0][0][i_3-1] = C[i_0+2][i_2][i_3][i_1] + C[i_3][i_0-1][i_2][i_1+2] * C[i_2][i_3][i_3-1][i_2] - 3;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L-1; i_4++) {
        for (int i_5 = i_4; i_5 < min(-i_4+PB_Q+2, PB_L-1); i_5++) {
            for (int i_6 = i_5; i_6 < min(-i_5+PB_L+1, PB_L-2); i_6++) {
                for (int i_7 = 0; i_7 < min(-i_5+PB_L-1, -i_4+PB_Q); i_7++) {
                    A[i_6+i_5-1][i_4][0][i_5-1] = C[i_7+i_5][i_6][i_4-1][i_7+i_4] - C[i_7][i_4][i_5][i_6-1] * C[i_7][i_6][i_4+1][i_5+i_4-2] + C[i_6+2][i_4][i_7+i_5][i_4-2] + C[i_4+1][i_7+2][i_6][i_7+2] * D[i_7][i_5][i_7] - A[i_7+i_5+1][i_6][0][i_7] + 6;
                }
            }
        }
    }
...
kernel_4234152115_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
