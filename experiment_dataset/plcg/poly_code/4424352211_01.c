...
void kernel_4424352211_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl),int xm,int ym,DATA_TYPE POLYBENCH_2D(M,xM,yM,xm,ym)){
...
#pragma scop
        ...
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < PB_N-1; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_P; i_3++) {
                    A[i_0+1][i_2][i_0][i_3] = E[i_3][i_1][i_2] - F[i_1][i_2][i_3+i_0] + A[i_0+1][i_2][i_0][i_3+1] * A[i_0+1][i_1][i_0][i_3+1] - A[i_2+1][i_3+1][i_2][i_1] - 4;
                }
            }
            for (int i_4 = 1; i_4 < min(min(i_0, -i_1+PB_L), PB_M-2); i_4++) {
                for (int i_5 = 1; i_5 < min(PB_M-2, -i_1+PB_M+2); i_5++) {
                    B[i_4][i_0][i_1][i_5] = G[i_5][i_4][i_1][i_0-1] - E[i_5+i_1-2][i_4][0] - E[i_4][i_5][i_0] - E[i_4+2][i_0][i_5+i_1-2] - H[i_1-1][i_0][i_5+1][i_4] * G[i_4+i_1][i_0][i_5][0] - F[i_5][i_1][i_4] - G[i_1][i_5][i_4][i_0] - I[i_5+2][i_5-1][i_4][i_0] + B[i_5][i_0][i_1][i_4-1] + B[i_4][i_0][i_1-1][i_5-1] + 6;
                }
            }
        }
    }
    for (int i_6 = 2; i_6 < PB_M-2; i_6++) {
        for (int i_7 = i_6; i_7 < PB_M; i_7++) {
            C[i_6][i_7] = J[i_6+2] - K[i_6+2][i_7] - L[i_7][i_6] - M[i_6-2][0] * L[i_6-2][i_7] + K[i_7][i_6] + C[i_6+1][i_7-1] + 3;
        }
    }
    for (int i_8 = 1; i_8 < PB_Q-2; i_8++) {
        for (int i_9 = 2; i_9 < PB_P-1; i_9++) {
            for (int j_0 = 1; j_0 < min(min(i_9, -i_9+PB_Q-2), -i_8+PB_L-1); j_0++) {
                for (int j_1 = 1; j_1 < -i_9+PB_M; j_1++) {
                    D[j_0+i_8+1][i_9+1][j_1][i_9+1] = H[j_0][i_8-1][i_9-2][j_0] + I[j_1][i_8-1][j_0+i_9+2][i_9] + I[j_1+i_9][0][j_0][i_8+2] - B[i_8][j_0-1][i_9][j_1] * D[j_0+i_8+1][i_9+1][j_1-1][i_9+1] - 2;
                }
            }
        }
    }
