        ...
        for (int i_1 = 0; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_Q; i_2++) {
                for (int i_3 = 0; i_3 < min(PB_Q-1, -i_0+PB_L); i_3++) {
                    C[i_1+1][i_3+1][i_2][i_1+1] = E[i_3][i_3+i_0][i_2+i_0][i_1] + F[i_1][i_0][i_3+1][i_2][i_1] - E[i_1][i_3][i_0][0] * G[i_3][i_1][i_2] - 2;
                }
            }
        }
        B[i_0] = H[i_0] + I[i_0][1] - H[i_0] * H[i_0] - B[i_0+1] * B[i_0-1] - B[i_0-1] * 4;
    }
    for (int i_4 = 2; i_4 < PB_Q-2; i_4++) {
        for (int i_5 = 0; i_5 < PB_Q-2; i_5++) {
            for (int i_6 = 2; i_6 < min(-i_5+PB_Q, PB_M-1); i_6++) {
                for (int i_7 = 0; i_7 < PB_M-1; i_7++) {
                    C[i_7+1][i_5][i_6][i_7+1] = E[i_6-2][i_4-2][i_7][i_6+i_5] * 4;
                }
                for (int i_8 = i_6; i_8 < PB_M; i_8++) {
                    C[i_6+1][i_8][i_5+1][i_6+1] = E[i_6][i_8][i_4+2][i_5+2] - G[i_8][i_6][i_4] + 5;
                }
            }
        }
    }
...
init_array(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4432132215_04(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I)));
