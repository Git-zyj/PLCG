...
void kernel_4234112313_02(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_Q; i_0++) {
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < PB_M-3; i_2++) {
                A[i_2+2][i_1] = A[i_2+3][i_1] - 4;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_P; i_3++) {
        for (int i_4 = 1; i_4 < PB_P; i_4++) {
            for (int i_5 = 2; i_5 < PB_P; i_5++) {
                B[i_3][i_4][i_5-1] = C[i_3][i_4][i_5] + C[i_4][i_3][2] + A[i_5+2][i_4] + B[i_3-1][i_4-1][i_5-2] - B[i_3][i_4-1][i_5] * B[i_3+1][i_4+1][i_5-1] + 2;
            }
        }
    }
#pragma endscop
...
kernel_4234112313_02(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
