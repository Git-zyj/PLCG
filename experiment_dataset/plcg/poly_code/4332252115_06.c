...
void kernel_4332252115_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
        ...
        for (int i_1 = 2; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 2; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_2+PB_M, -i_1+PB_Q); i_3++) {
                    A[i_2+1][i_0-1][i_0][i_3+i_1-1] = D[i_2][i_0][i_3+i_1][i_2] + E[i_0+1][i_0][i_1][i_2+2] - E[i_2+1][i_3][i_1+1][i_0] * E[i_1-1][i_2-2][i_3+i_1-2][i_0+2] + F[i_3+i_2][i_1+2][i_0][i_2][0] + 6;
                }
            }
        }
    }
        ...
        for (int i_5 = 2; i_5 < -i_4+PB_L; i_5++) {
            for (int i_6 = 2; i_6 < min(i_4, -i_4+PB_Q+2); i_6++) {
                for (int i_7 = 0; i_7 < i_4; i_7++) {
                    A[i_7+2][i_5-1][i_5][i_6+i_4-2] = D[i_7+1][i_4+1][i_5-2][i_6+2] * D[i_6+1][i_7][i_5][0] - E[i_6][i_4][i_5][i_7] + E[i_7+i_6-2][i_4+2][i_5][1] + 2;
                }
            }
            C[i_5] = G[i_5+i_4-2][0] - G[i_4+1][i_5] * H[i_5][i_5+i_4] + H[i_4+2][i_5] * I[i_5+i_4][i_5][i_4-2] - C[i_5-1] + 2;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4332252115_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
