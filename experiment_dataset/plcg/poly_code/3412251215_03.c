...
void kernel_3412251215_03(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        for (int i_1 = 1; i_1 < -i_0+PB_M; i_1++) {
            A[i_0+1][i_1] = E[i_1] - F[i_1-1][i_0-1] * F[i_1][i_0] + E[i_1+i_0] + F[i_0-1][i_1] * G[i_1][i_0] - G[i_1+i_0][i_1] + F[i_1+i_0][0] * B[i_1] + 1;
        }
    }
    for (int i_2 = 1; i_2 < PB_M; i_2++) {
        B[i_2] = E[i_2] - E[i_2] * H[i_2] - H[0] * H[i_2] - E[i_2] - B[i_2-1] - 6;
        for (int i_3 = 1; i_3 < -i_2+PB_M; i_3++) {
            B[i_3-1] = I[i_3][i_2][1] + G[i_3-1][i_2-1] + G[i_2][i_3-1] * F[i_3+1][i_2-1] * 4;
            B[i_3] = G[i_3+i_2][i_3-1] - H[1] + B[i_2-1] - B[i_3+1] - 4;
        }
    }
#pragma endscop
...
kernel_3412251215_03(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
