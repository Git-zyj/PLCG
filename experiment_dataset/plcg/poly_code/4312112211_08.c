...
void kernel_4312112211_08(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_0 = 0; i_0 < PB_P-1; i_0++) {
        for (int i_1 = 0; i_1 < min(PB_L-3, -i_0+PB_L-2); i_1++) {
            ...
            for (int i_2 = 0; i_2 < -i_1+PB_L-3; i_2++) {
                B[i_1+i_0][i_2+i_1][i_0+1] = D[i_1+1][i_0][i_2] * A[i_2][i_2+i_1+3] * A[i_2][i_2+i_1+1] * 1;
            }
        }
    }
    for (int i_3 = 0; i_3 < PB_P-1; i_3++) {
        for (int i_4 = 0; i_4 < i_3; i_4++) {
            for (int i_5 = 0; i_5 < PB_L-1; i_5++) {
                C[i_3][i_4+2][i_3] = C[i_3][i_4+3][i_3] + C[i_3][i_5+1][i_3] * C[i_3+1][i_4+2][i_3+1] * 6;
            }
        }
    }
#pragma endscop
...
kernel_4312112211_08(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
