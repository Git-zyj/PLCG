...
void kernel_3414112323_00(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
    ...
    for (int i_3 = 2; i_3 < PB_L-2; i_3++) {
        C[i_3] = E[i_3+2] + D[i_3] - D[i_3-2] - D[i_3+1] - 1;
        D[i_3] = C[i_3] * C[i_3+1] * C[i_3+2] + 4;
    }
#pragma endscop
...
kernel_3414112323_00(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
