...
void kernel_3216112215_08(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_2 = 0; i_2 < PB_M-3; i_2++) {
        B[i_2+2] = C[i_2] * B[i_2+3] - B[i_2+1] - 1;
    }
#pragma endscop
...
kernel_3216112215_08(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
