...
void kernel_3236211325_03(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        for (int i_1 = i_0; i_1 < PB_L; i_1++) {
            B[i_1-2][i_0] = C[i_0][i_1] * 3;
        }
        for (int i_2 = i_0; i_2 < PB_P; i_2++) {
            B[i_0][i_2] = B[i_0][i_2-2] + B[i_0-2][i_2] - B[i_0][i_2-1] + 5;
        }
    }
#pragma endscop
...
kernel_3236211325_03(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
