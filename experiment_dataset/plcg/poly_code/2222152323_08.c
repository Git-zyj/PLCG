...
void kernel_2222152323_08(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P-2; i_0++) {
        for (int i_1 = 1; i_1 < -i_0+PB_P; i_1++) {
            B[i_0+2][i_1] = C[i_1][i_0-2] + C[i_1][i_0] * C[i_0-2][i_1] - C[i_0][i_1-1] - C[i_1][i_0] * B[i_0][i_1] * 5;
            B[i_0+2][i_1] = C[i_1+2][i_0-2] + D[i_1] - C[i_0][i_1+i_0] + C[i_1][i_0+2] - D[i_1+1] * B[i_0+1][i_1] - B[i_0+4][i_1] * 2;
        }
    }
#pragma endscop
...
kernel_2222152323_08(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
