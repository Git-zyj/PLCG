...
void kernel_4236152311_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N; i_0++) {
        for (int i_1 = 1; i_1 < -i_0+PB_N; i_1++) {
            for (int i_2 = 2; i_2 < PB_M-2; i_2++) {
                for (int i_3 = 2; i_3 < min(-i_0+PB_M, -i_2+PB_Q); i_3++) {
                    A[i_0][i_3][i_2+i_1][0] = C[i_2][i_3+i_0][i_3-2][i_1] - C[i_3+i_1][i_0][i_2][i_3+1] + C[i_1+i_0][i_2+2][0][i_3+i_2] * C[i_2-2][i_3-2][i_1][i_0] - C[i_0][i_3+i_2][i_1][2] * A[i_0][i_3][i_2+i_1-1][0] - A[i_0-1][i_2][i_3+i_1][0] - A[i_0+1][i_3][i_2+i_1][0] + 6;
                }
            }
        }
    }
        ...
        for (int i_5 = i_4; i_5 < PB_M-2; i_5++) {
            for (int i_6 = 2; i_6 < -i_5+PB_M; i_6++) {
                for (int i_7 = 1; i_7 < -i_4+PB_P; i_7++) {
                    A[i_5][i_6][i_7+i_4][0] = C[i_7][i_6-1][i_5+2][0] - C[i_5][i_7][i_4][i_6-2] * D[i_7][i_6+i_5][i_5] * C[i_5][i_4][i_7-1][0] + C[i_7-1][i_5+2][i_4-2][i_5] * 5;
                }
            }
        }
    }
...
kernel_4236152311_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
