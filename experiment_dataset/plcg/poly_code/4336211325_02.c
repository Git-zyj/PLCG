...
void kernel_4336211325_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve)){
        ...
        for (int i_1 = 1; i_1 < PB_P-1; i_1++) {
            for (int i_2 = i_0; i_2 < PB_P; i_2++) {
                for (int i_3 = 0; i_3 < PB_M-1; i_3++) {
                    A[i_0-1][i_1+1][i_2][i_2] = D[i_3+1][i_0][i_1-1][i_2] * E[i_3+1][i_0-1][i_2][i_1-1] * A[i_0-1][i_1+1][i_3+1][i_3+1] - 2;
                }
            }
        }
        B[i_0+1] = B[i_0+2] + B[i_0] * B[i_0-1] + 2;
    }
    for (int i_4 = 3; i_4 < PB_M-3; i_4++) {
        for (int i_5 = 1; i_5 < PB_M-3; i_5++) {
            for (int i_6 = i_4; i_6 < min(PB_L-1, -i_5+PB_M+1); i_6++) {
                for (int i_7 = i_4; i_7 < min(min(-i_5+PB_P, PB_Q-2), -i_4+PB_P+1); i_7++) {
                    C[i_5+1][i_6][i_7+i_4-1][i_7] = D[i_6+i_5-1][i_4][i_7][0] * C[i_5+2][i_6][i_7+i_4-1][i_7+2] + C[i_4+3][i_6][i_7+i_5][i_7] * C[i_5+3][i_6+1][i_7+i_4-3][i_7-2] - C[i_5+3][i_6][i_7+i_4-1][i_4] + 3;
                }
            }
        }
    }
...
kernel_4336211325_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
