...
void kernel_4124312323_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb)){
        ...
        for (int i_1 = 0; i_1 < min(i_0, PB_M-2); i_1++) {
            for (int i_2 = 1; i_2 < min(-i_1+PB_M, PB_P-2); i_2++) {
                for (int i_3 = 3; i_3 < -i_1+PB_M-2; i_3++) {
                    A[i_3+i_1][i_2-1][i_1] = B[i_2][i_3][i_1] + A[i_3+i_1+2][i_2-1][i_1+1] * A[i_2+i_1][i_3-3][i_2+2] + A[i_3+i_1+2][i_2+1][i_1+2] * 3;
                }
            }
        }
    }
...
kernel_4124312323_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B));
