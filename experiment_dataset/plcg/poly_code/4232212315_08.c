...
void kernel_4232212315_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        A[i_0] = C[2] * C[i_0] * A[i_0+1] * A[i_0-1] - A[i_0-1] + 2;
    }
...
kernel_4232212315_08(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
