...
void kernel_4426212223_02(int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xb,int yb,int zb,int vb,int wb,DATA_TYPE POLYBENCH_5D(B,xB,yB,zB,vB,wB,xb,yb,zb,vb,wb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg)){
        ...
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < PB_M; i_2++) {
                for (int i_3 = 0; i_3 < PB_L; i_3++) {
                    D[i_0-2][i_1][i_3][i_3] = E[i_3][i_2][i_1][i_0] + 4;
                }
            }
        }
    }
        ...
        for (int i_5 = i_4; i_5 < PB_L-2; i_5++) {
            for (int i_6 = 2; i_6 < PB_Q; i_6++) {
                for (int i_7 = 3; i_7 < -i_6+PB_Q; i_7++) {
                    B[i_5+2][i_4][i_6][i_7+i_6][i_7-1] = B[i_5+2][i_4][i_6-2][i_7+i_6-2][i_7-1] * B[i_5+2][i_4-1][i_6][i_7+i_6-2][i_7-3] + 6;
                }
            }
        }
        for (int i_8 = i_4; i_8 < -i_4+PB_L-2; i_8++) {
            C[i_4][i_8+i_4] = F[i_8][i_4] - C[i_4-1][i_8+i_4-1] + C[i_8-2][i_8+i_4-2] * C[i_4+2][i_8+i_4+2] + 1;
        }
    }
    for (int i_9 = 4; i_9 < PB_M; i_9++) {
        for (int j_0 = i_9; j_0 < PB_L; j_0++) {
            for (int j_1 = 2; j_1 < min(-i_9+PB_Q+2, j_0); j_1++) {
                for (int j_2 = 0; j_2 < PB_L; j_2++) {
                    D[i_9-2][j_0][j_1][j_1] = G[j_2][i_9][j_0][j_2] + E[i_9][j_0][j_2][j_1+i_9-2] + D[i_9-4][j_0][j_1-2][j_1-2] * 4;
                }
            }
        }
    }
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,zb,vb,wb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4426212223_02(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,zb,vb,wb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,zb,vb,wb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G)));
