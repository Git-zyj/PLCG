...
void kernel_2436112323_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_N-3; i_0++) {
        ...
        for (int i_2 = 0; i_2 < PB_M; i_2++) {
            B[i_0][i_2] = E[i_2][i_0+2] - B[i_0-2][i_2] + B[i_0+1][i_2] + 4;
        }
        C[i_0+1] = C[i_0-1] + C[i_0+3] - C[i_0+2] + C[i_0] + 2;
    }
    for (int i_3 = 1; i_3 < PB_N+1; i_3++) {
        for (int i_4 = 1; i_4 < PB_N-3; i_4++) {
            D[i_4+1][i_3] = D[i_4+2][i_3] + D[i_3-1][i_4-1] - D[i_4+3][i_3] - D[i_4+1][i_3+2] * 6;
        }
    }
#pragma endscop
...
kernel_2436112323_09(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
