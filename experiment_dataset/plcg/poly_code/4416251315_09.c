...
void kernel_4416251315_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_Q; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_Q; i_2++) {
                for (int i_3 = 1; i_3 < PB_Q-1; i_3++) {
                    A[i_1][i_3][i_2+i_0][i_3] = E[i_1][i_2][i_3][i_0][i_0] - F[i_2+i_1][i_0][i_0+1][i_3] + F[i_0][i_1][i_3][i_1] * G[i_0+1][i_1-1][i_2][i_3] - G[i_3][i_0][i_2][i_3+i_2] * A[i_1+1][i_3][i_2+i_0][i_3] + A[i_1][i_0-1][i_3+i_2][i_0-1] - A[i_2+1][i_3-1][i_1+i_0][i_3-1] * A[i_1+1][i_3+1][i_2+i_0-1][i_3+1] - 6;
                }
            }
        }
        B[i_0-1][i_0] = H[i_0] + H[i_0+1] + H[i_0] * H[i_0] + I[i_0] - H[i_0] - B[i_0][i_0+1] * 5;
    }
        ...
        for (int i_5 = i_4; i_5 < PB_M; i_5++) {
            for (int i_6 = 0; i_6 < min(-i_5+PB_P, -i_4+PB_P); i_6++) {
                for (int i_7 = 1; i_7 < -i_4+PB_Q; i_7++) {
                    A[i_5][i_6][i_7+i_4][i_6] = J[i_7-1][i_5-1][i_6+i_4] * G[0][i_7][i_5][i_6+1] + G[i_5-1][i_6][0][i_4] + G[i_4][i_5][i_4-1][i_7+i_6+1] * G[i_6][0][i_4-1][i_6+i_5] * F[i_5][i_6][i_7][i_6+i_4] - 5;
                }
            }
        }
        for (int i_8 = 0; i_8 < min(i_4, -i_4+PB_P); i_8++) {
            for (int i_9 = 1; i_9 < -i_4+PB_Q-1; i_9++) {
                for (int j_0 = 0; j_0 < PB_Q-1; j_0++) {
                    A[i_8+1][j_0+1][i_9+i_4+1][j_0+1] = G[i_9-1][i_4][i_8+i_4][i_8+1] * G[i_8+1][j_0][j_0][i_4] * G[i_4+1][j_0+1][i_9+i_8][i_4+1] + 5;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4416251315_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J)));
