...
void kernel_4432351211_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl),int xm,int ym,DATA_TYPE POLYBENCH_2D(M,xM,yM,xm,ym)){
        ...
        for (int i_1 = i_0; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_M; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_0+PB_Q, PB_M-1); i_3++) {
                    A[i_0][i_1][i_2][i_3+i_0] = E[i_3][i_0][i_1][i_2] * F[i_2+i_0][i_1+1][0] * G[i_2-1][i_3+i_0-1][i_1][1] - H[i_3+1][i_0][i_1][i_0] * A[i_0][i_1+1][i_2-1][i_3+i_0] - 4;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < PB_M-1; i_5++) {
            for (int i_6 = 1; i_6 < min(-i_5+PB_L+1, i_5); i_6++) {
                for (int i_7 = 1; i_7 < -i_5+PB_L; i_7++) {
                    B[i_4-1][i_7+i_5][i_7][i_6+1] = G[i_4-1][i_7][i_7][i_6-1] - E[i_5-1][i_4+1][i_5+1][i_6] * I[i_6][i_5][i_7-1] - B[i_4-1][i_6+i_5-1][i_6-1][i_7+1] - 2;
                }
            }
        }
        C[i_4-1] = J[i_4+1] - K[i_4] - K[i_4+1] - J[i_4-1] - C[i_4] - C[i_4-2] * 4;
        for (int i_8 = 0; i_8 < -i_4+PB_M+1; i_8++) {
            for (int i_9 = 1; i_9 < min(-i_8+PB_M, PB_M-1); i_9++) {
                D[i_8+i_4-1][i_9+1][i_4-1] = L[i_9-1][i_4-1][i_8] - I[i_9][i_8][i_4] - M[i_9][i_8] * L[i_9+i_8][i_4][i_4-1] + L[i_9][i_4-1][i_4+1] * F[i_9][i_8][i_4] - F[i_4][i_9][i_4] + D[i_8+i_4-1][i_9][i_4-1] - D[i_8+i_4-2][i_9+1][i_4-1] + 2;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M), INIT_SEED);
kernel_4432351211_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M));
