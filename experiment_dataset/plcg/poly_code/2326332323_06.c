...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_M-1; i_1++) {
        B[i_1-2] = E[i_1] + F[i_1-1] + F[i_1] - F[i_1+1] - B[i_1-1] - 5;
    }
    for (int i_2 = 2; i_2 < PB_M-2; i_2++) {
        for (int i_3 = 2; i_3 < PB_N-2; i_3++) {
            C[i_3][i_2] = G[i_2][i_3] + H[i_3][i_2] - C[i_3][i_2+2] + C[i_3+2][i_2] + C[i_3-2][i_2] + C[i_3][i_2-2] + 1;
        }
    }
#pragma endscop
...
kernel_2326332323_06(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
