...
void kernel_4434331215_08(int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,int zk,int vk,DATA_TYPE POLYBENCH_4D(K,xK,yK,zK,vK,xk,yk,zk,vk)){
...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < min(-i_0+PB_P+1, i_0); i_1++) {
            for (int i_2 = 1; i_2 < min(-i_1+PB_M, PB_P-1); i_2++) {
                for (int i_3 = 1; i_3 < min(-i_2+PB_M+1, PB_M-1); i_3++) {
                    D[i_0+1][i_3][i_2+1][i_3-1] = E[i_3][i_2+i_1][i_1+i_0][i_2] * F[i_3+i_2-1][i_1+1][i_0][0] - F[i_3+1][i_2][i_0+1][i_1+i_0-1] - 3;
                }
            }
        }
    ...
    for (int i_5 = 1; i_5 < PB_M-2; i_5++) {
        C[i_5-1] = H[i_5+1] - I[i_5-1] - I[i_5+1] * C[i_5] + 2;
        for (int i_6 = i_5; i_6 < PB_M-1; i_6++) {
            for (int i_7 = 1; i_7 < -i_5+PB_M; i_7++) {
                for (int i_8 = 0; i_8 < PB_L-2; i_8++) {
                    D[i_5+1][i_8+1][i_7][i_8] = J[i_7][i_8+1][i_6] + K[i_7][i_8][i_6][i_5] + E[i_8][i_7+i_5][i_6][i_6-1] - D[i_5+1][i_8+2][i_7+1][i_8+1] * D[i_5+2][i_8+1][i_7-1][i_8] + D[i_6+1][i_8+2][i_7-1][i_8+1] + 2;
                }
            }
        }
    }
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4434331215_08(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K)));
