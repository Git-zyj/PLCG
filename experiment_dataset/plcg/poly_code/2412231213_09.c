...
void kernel_2412231213_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        A[i_0] = E[i_0+1] + F[i_0+1] * A[i_0+1] + 5;
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            B[i_1][i_0][i_0] = G[i_0][i_1] - H[i_1][i_0] - H[i_1+1][i_0+1] - G[i_1][i_0] + H[i_1][i_0] - A[i_0+1] + B[i_1-1][i_0][i_0] * B[i_1+1][i_0][i_0] * 2;
        }
    }
    for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
        A[i_2] = F[i_2] + 5;
        A[i_2+1] = F[i_2-1] - F[i_2] - F[i_2] + 4;
    }
#pragma endscop
...
kernel_2412231213_09(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
