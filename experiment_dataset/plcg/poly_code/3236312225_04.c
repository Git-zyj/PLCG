...
void kernel_3236312225_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        for (int i_1 = 4; i_1 < i_0; i_1++) {
            for (int i_2 = max(-i_1+4, 0); i_2 < -i_1+PB_L; i_2++) {
                A[i_0][i_2+i_1][i_2+i_1-2] = C[i_2+1][i_0][i_1] * A[i_0-2][i_2+i_1][i_2+i_1-2] + A[i_0][i_2+i_1-2][i_2+i_1-4] - 6;
            }
        }
    }
    for (int i_3 = 2; i_3 < PB_L; i_3++) {
        for (int i_4 = 0; i_4 < min(-i_3+PB_L, i_3); i_4++) {
            for (int i_5 = 2; i_5 < PB_L; i_5++) {
                A[i_5-2][i_4+i_3][i_4+i_3-2] = C[i_5][0][i_4] - 4;
            }
        }
    }
#pragma endscop
...
kernel_3236312225_04(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C));
