        ...
        for (int i_1 = 1; i_1 < min(i_0, -i_0+PB_P-1); i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_Q-1; i_2++) {
                for (int i_3 = 1; i_3 < i_2; i_3++) {
                    A[i_1-1][i_3+i_2][i_0][i_1] = E[i_3+i_1-1][i_2][i_0+1][i_0] * F[i_1][i_2-1][i_0][0] + F[i_1][i_0][i_3][i_2+i_0+1] - G[i_3+i_1][i_2+i_0][i_2][i_1+i_0+1] - F[i_3-1][i_1+i_0][i_0][i_2] + G[i_2][i_2+i_0][i_3+1][i_1] + A[i_1-1][i_3+i_2-1][i_0][i_1] + 5;
                }
            }
            B[i_1] = H[i_0+1][i_1-1][i_0] - I[i_0][i_1] + J[i_1][i_1+i_0] + K[i_0] + 1;
        }
        for (int i_4 = 1; i_4 < PB_L; i_4++) {
            C[i_0][i_4] = L[i_4] + J[i_4][i_4-1] - J[i_0+1][i_4] + M[i_4] * C[i_0][i_4-1] * 3;
        }
    }
        ...
        for (int i_6 = 0; i_6 < PB_L; i_6++) {
            for (int i_7 = 0; i_7 < -i_6+PB_L; i_7++) {
                for (int i_8 = 1; i_8 < i_7; i_8++) {
                    A[i_8-1][i_7+i_6][i_5][i_8] = E[i_7][i_5-1][i_8][0] + H[i_8][i_7][i_6] + G[i_8][i_5+1][i_6+1][0] - G[i_6][i_7][i_5][1] * H[i_8-1][i_8+i_6][0] * 2;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,POLYBENCH_ARRAY(M), INIT_SEED);
kernel_4416351111_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,POLYBENCH_ARRAY(M));
