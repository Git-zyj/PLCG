...
void kernel_4336312221_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_2 = 0; i_2 < min(PB_M-3, i_1); i_2++) {
            for (int i_3 = 0; i_3 < -i_1+PB_L; i_3++) {
                for (int i_4 = 0; i_4 < -i_3+PB_L; i_4++) {
                    B[i_2+2][i_4+i_3][0] = B[i_2+3][i_3+i_1][0] + 1;
                }
            }
        }
        for (int i_5 = 4; i_5 < i_1; i_5++) {
            for (int i_6 = max(2, i_1); i_6 < PB_L; i_6++) {
                C[i_1+1][i_5-2][i_6] = D[i_1-1][i_1][i_6-1] + D[i_5][i_1][i_6] + C[i_1+1][i_5-4][i_6-2] + 2;
            }
        }
    }
#pragma endscop
...
kernel_4336312221_00(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
