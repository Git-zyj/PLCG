...
void kernel_2214151323_03(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-2; i_0++) {
        B[i_0-1][i_0] = C[i_0][i_0+1] + D[i_0+1] * C[i_0][0] + D[i_0+1] - D[i_0] + B[i_0][i_0+1] * 3;
        for (int i_1 = 1; i_1 < min(PB_L-3, i_0); i_1++) {
            B[i_0][i_0+1] = C[i_0][i_1] + C[i_1-1][i_0] - D[i_0] + E[i_0][i_1-1][i_0] + C[i_0+1][i_1] * B[i_0+1][i_0+2] * B[i_1+2][i_1+3] + 1;
        }
    }
#pragma endscop
...
kernel_2214151323_03(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
