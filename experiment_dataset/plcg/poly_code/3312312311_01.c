...
void kernel_3312312311_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        ...
        for (int i_3 = 1; i_3 < PB_M; i_3++) {
            B[i_0][0] = D[i_3][i_0] * B[i_0-1][0] - B[i_0+1][0] + B[i_3-1][0] * 3;
            C[i_3] = D[i_3-1][i_0] - B[i_0][0] - C[i_3+1] - C[i_3-1] + C[i_3-1] - 5;
        }
    }
#pragma endscop
...
kernel_3312312311_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
