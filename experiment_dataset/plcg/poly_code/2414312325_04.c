...
void kernel_2414312325_04(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        C[i_0] = C[i_0-2] * C[i_0] - 2;
        for (int i_1 = i_0; i_1 < PB_M; i_1++) {
            B[i_0][i_1+2] = E[i_0-1] * B[i_0][i_1+1] - B[i_0-2][i_1] + C[i_1] + 6;
        }
        C[i_0] = C[i_0-2] + 4;
    }
...
kernel_2414312325_04(xc,POLYBENCH_ARRAY(C), xb,yb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E));
