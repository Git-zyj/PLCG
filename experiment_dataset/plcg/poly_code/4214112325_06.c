...
void kernel_4214112325_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 0; i_1 < -i_0+PB_P; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-2; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_P; i_3++) {
                    A[i_1+2][i_2+2][i_3+i_0] = C[i_2][i_1+1][i_2] + A[i_1+2][i_2+1][i_3+i_0-2] * A[i_2][i_3+2][i_1+i_0] - A[i_0][i_2+2][i_3+i_1] - 1;
                }
            }
        }
        B[i_0][0] = B[i_0+1][0] + B[i_0-1][0] + 1;
    }
#pragma endscop
...
kernel_4214112325_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
