...
void kernel_4214131125_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
        ...
        for (int i_1 = i_0; i_1 < min(PB_Q, -i_0+PB_L); i_1++) {
            for (int i_2 = 0; i_2 < min(-i_0+PB_P, i_1); i_2++) {
                for (int i_3 = 0; i_3 < PB_Q; i_3++) {
                    A[i_3][i_2][i_1+i_0][i_1+i_0] = C[i_2+1][i_0][i_2] * C[i_1][i_2+i_0][i_3] * A[i_3][i_2+1][i_1+i_0][i_1+i_0] - 1;
                }
            }
            for (int i_4 = 2; i_4 < -i_1+PB_P-1; i_4++) {
                B[i_1][i_4] = C[i_0][i_4+i_1+1][0] * C[i_4][i_1+i_0-1][i_0] + D[i_0-1][i_1] - D[i_4][i_4-1] * B[i_4-2][i_1] + 6;
            }
        }
    }
#pragma endscop
...
kernel_4214131125_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
