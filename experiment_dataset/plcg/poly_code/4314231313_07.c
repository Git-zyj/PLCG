...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
        B[i_1] = D[i_1] + E[1] * B[i_1+1] + B[i_1-1] * B[i_1+1] - B[i_1+1] - B[i_1+1] - 6;
        for (int i_2 = 1; i_2 < min(-i_1+PB_P, i_1); i_2++) {
            for (int i_3 = 1; i_3 < min(-i_1+PB_P+1, PB_M-1); i_3++) {
                C[i_3][i_2][i_1] = F[i_1][0][i_2] * G[i_2][i_1-1][i_3-1] + H[i_3+1][i_3+i_1-1][i_2][i_1] + F[i_3][i_2+i_1][i_3] * C[i_3+1][i_2][i_1-1] - C[i_2-1][i_3][i_1] + 1;
            }
        }
    }
#pragma endscop
...
kernel_4314231313_07(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
