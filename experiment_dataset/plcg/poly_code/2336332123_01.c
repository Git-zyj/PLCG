...
void kernel_2336332123_01(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        C[i_0] = D[i_0] * D[0] + D[i_0] - 3;
    }
    for (int i_1 = 2; i_1 < PB_L; i_1++) {
        C[i_1-1] = D[i_1-2] * E[i_1] - 5;
    }
    for (int i_2 = 2; i_2 < PB_L; i_2++) {
        C[i_2] = D[i_2-1] * D[i_2] * C[i_2-2] + 1;
    }
#pragma endscop
...
kernel_2336332123_01(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
