...
void kernel_4424332313_06(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N-1; i_0++) {
        C[i_0-2] = E[i_0+1] + C[i_0-2] + 5;
    }
        ...
        for (int i_2 = 3; i_2 < min(-i_1+PB_Q+2, i_1); i_2++) {
            for (int i_3 = 3; i_3 < -i_1+PB_P+1; i_3++) {
                for (int i_4 = i_3; i_4 < -i_1+PB_Q+1; i_4++) {
                    B[i_1][i_3][i_2-2][i_4+i_1-2] = F[i_4+i_2-2][i_3][i_1-2][i_2] - G[i_4+1][i_4+2][0] * H[i_4][i_1-2][i_4+2][i_3-2] - I[i_4-1][i_2][i_3+i_1-1] - B[i_1][i_4][i_3-3][i_2+i_1-2] * B[i_1][i_3][i_2-2][i_4+i_1-3] * B[i_4][i_1][i_3-3][i_4+i_2-1] * B[i_1][i_3][i_2-3][i_4+i_1-1] * 2;
                }
            }
        }
        C[i_1-2] = J[i_1] + E[i_1] + J[i_1] + J[i_1] * C[i_1-1] - C[i_1-3] - 4;
    }
    for (int i_5 = 2; i_5 < PB_P-3; i_5++) {
        for (int i_6 = i_5; i_6 < -i_5+PB_P-3; i_6++) {
            for (int i_7 = 0; i_7 < PB_L-2; i_7++) {
                D[i_5-1][i_7+2][i_6+i_5+2] = K[i_6][i_7] - K[i_6+i_5][i_7] * G[i_5][i_5][0] * D[i_5-2][i_7+2][i_6+i_5+1] - D[i_5][i_7+2][i_6+i_5+3] + 4;
            }
        }
    }
#pragma endscop
...
init_array(xc,POLYBENCH_ARRAY(C), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4424332313_06(xc,POLYBENCH_ARRAY(C), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xc,POLYBENCH_ARRAY(C), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K)));
