...
void kernel_3416212111_05(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
    ...
    for (int i_0 = 0; i_0 < PB_Q-1; i_0++) {
        ...
        for (int i_2 = 0; i_2 < i_0; i_2++) {
            for (int i_3 = 0; i_3 < PB_L; i_3++) {
                B[i_0][i_3][i_0+1] = E[i_2][i_0+1][i_2] - 1;
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_P; i_4++) {
        C[i_4] = C[i_4-1] * D[i_4-2][i_4] + 2;
        for (int i_5 = i_4; i_5 < PB_P; i_5++) {
            D[i_5-2][i_5] = E[i_4][i_5-1][0] * 5;
        }
    }
#pragma endscop
...
kernel_3416212111_05(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
