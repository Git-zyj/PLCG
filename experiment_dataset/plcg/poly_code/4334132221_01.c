...
void kernel_4334132221_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 1; i_1 < -i_0+PB_L; i_1++) {
            for (int i_2 = 1; i_2 < i_0; i_2++) {
                A[i_0+2][i_1-1][i_2-1] = D[i_2][i_1+i_0][i_2] - D[1][i_2][i_0-2] + A[i_0+2][i_1][i_2-1] - A[i_0+1][i_1-1][i_2-1] + 2;
            }
        }
    }
        ...
        for (int i_4 = i_3; i_4 < PB_M; i_4++) {
            for (int i_5 = 2; i_5 < -i_3+PB_P+2; i_5++) {
                for (int i_6 = 2; i_6 < min(-i_4+PB_M, -i_3+PB_Q); i_6++) {
                    B[i_5][i_6-2][i_5][i_4-1] = D[i_6+i_4][i_6+i_3-2][0] - E[i_5-1][i_5-1][i_6+i_3][i_4] * E[i_6+i_4][i_5+i_3-2][i_4][0] + B[i_5-2][i_6-2][i_5-2][i_4-1] + 2;
                }
            }
        }
    }
    for (int i_7 = 0; i_7 < PB_M; i_7++) {
        for (int i_8 = max(4, i_7); i_8 < PB_M-2; i_8++) {
            C[i_7][i_8-2] = F[i_8-2][i_8] + G[i_8+2] - G[i_8] + F[i_8][i_7] - C[i_7][i_8-4] * C[i_7][i_8] * 6;
        }
    }
#pragma endscop
...
kernel_4334132221_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
