    ...
    for (int i_6 = 1; i_6 < PB_P; i_6++) {
        for (int i_7 = 1; i_7 < PB_M-1; i_7++) {
            for (int i_8 = 1; i_8 < min(-i_7+PB_M-1, -i_6+PB_L); i_8++) {
                C[i_8][i_7] = D[i_7+1][i_8][i_6] - D[i_8][i_6][i_7] * D[i_8-1][i_7-1][i_6] - D[i_8+i_7+1][i_8][i_6] * D[i_7-1][i_8+i_6][i_6-1] - C[i_7+1][i_8] - C[i_7-1][i_8+2] + 1;
            }
        }
    }
#pragma endscop
...
kernel_4314131221_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
