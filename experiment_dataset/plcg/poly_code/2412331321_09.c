...
void kernel_2412331321_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P; i_0++) {
        B[i_0] = E[i_0] - F[i_0-1] - G[i_0-1] + B[i_0] - 3;
        B[i_0] = H[i_0-1][i_0] - 3;
        for (int i_1 = 2; i_1 < PB_N; i_1++) {
            C[i_0+1][i_1-1] = I[i_1][i_0] - H[i_1-1][i_0-1] - F[i_1] * B[i_1+2] * B[i_1-2] - B[i_1] * C[i_0+1][i_1] * C[i_0][i_1-1] * 6;
        }
    }
    for (int i_2 = 1; i_2 < PB_N-1; i_2++) {
        D[i_2] = F[i_2+1] * F[i_2] * G[i_2] + E[i_2-1] * D[i_2+2] - D[i_2-1] - 5;
    }
#pragma endscop
...
kernel_2412331321_09(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
