...
void kernel_3414111211_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_P; i_0++) {
        ...
        for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
            B[i_0][i_0] = E[i_0][i_2-1] * B[i_0-1][i_0-1] - C[i_2] * C[i_2+1] - 2;
            C[i_2] = E[i_2][i_0] * B[i_0][i_0] * C[i_2+1] - C[i_2-1] + 5;
        }
    }
    for (int i_3 = 0; i_3 < PB_L; i_3++) {
        for (int i_4 = 0; i_4 < min(-i_3+PB_L, PB_M-1); i_4++) {
            D[i_4][i_4+i_3] = A[i_4+1] * D[i_4+1][i_4+i_3] * 2;
        }
    }
#pragma endscop
...
kernel_3414111211_02(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
