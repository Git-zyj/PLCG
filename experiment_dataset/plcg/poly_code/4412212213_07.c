        ...
        for (int i_2 = 3; i_2 < PB_P+3; i_2++) {
            for (int i_3 = 0; i_3 < PB_Q; i_3++) {
                for (int i_4 = 0; i_4 < PB_M; i_4++) {
                    D[i_4][i_1-3][i_2-3][i_3] = 1;
                }
            }
        }
        for (int i_5 = 2; i_5 < PB_L; i_5++) {
            for (int i_6 = 2; i_6 < min(-i_1+PB_M, -i_5+PB_Q); i_6++) {
                for (int i_7 = 1; i_7 < -i_5+PB_P; i_7++) {
                    C[i_6][i_7][i_5][i_1] = E[i_6][i_7+i_5][i_1][i_1] + E[i_6+2][i_7][i_1][i_6+i_5] + C[i_6][i_7+1][i_5][i_1] * C[i_6][i_5-1][i_7-1][i_1+1] - C[i_6][i_7-1][i_5-1][i_1] * 4;
                    D[i_1][i_5-2][i_6-2][i_7] = E[i_7][i_7+i_6][i_5+2][i_1+1] + F[i_7-1][i_6+i_1][i_5][i_1] - 4;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), INIT_SEED);
kernel_4412212213_07(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F)));
