...
void kernel_3236131313_08(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        B[i_0-1][0] = C[i_0] + C[i_0] * B[i_0-1][0] * B[i_0][0] + 2;
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            B[i_1-1][0] = D[i_0][i_1] * D[i_0][i_0] - D[i_1][i_0] * D[i_1][i_0] - B[i_0-2][0] + 5;
        }
    }
#pragma endscop
...
kernel_3236131313_08(xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
