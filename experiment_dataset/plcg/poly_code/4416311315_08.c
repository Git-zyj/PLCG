...
void kernel_4416311315_08(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
    ...
    for (int i_4 = 0; i_4 < PB_L; i_4++) {
        for (int i_5 = 0; i_5 < -i_4+PB_L; i_5++) {
            ...
            for (int i_6 = 0; i_6 < PB_L; i_6++) {
                B[i_6] = E[i_5][i_4+1] + F[i_4][i_6][0] - 1;
            }
        }
    }
#pragma endscop
...
kernel_4416311315_08(xb,POLYBENCH_ARRAY(B), xe,ye,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
