...
void kernel_3226151225_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-1; i_0++) {
        for (int i_1 = 1; i_1 < min(PB_N-2, -i_0+PB_N); i_1++) {
            B[i_1+1] = C[i_1+i_0] + C[i_1+1] * B[i_1-1] - B[i_1+2] - 4;
        }
        B[i_0+1] = C[i_0] * C[i_0+1] + C[i_0-1] * C[i_0] * C[i_0] + C[i_0] - C[i_0+1] * 6;
    }
#pragma endscop
...
kernel_3226151225_03(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
