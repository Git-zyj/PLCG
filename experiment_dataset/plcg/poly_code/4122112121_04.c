...
void kernel_4122112121_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 2; i_1 < PB_N+2; i_1++) {
            for (int i_2 = max(3, i_1); i_2 < PB_L; i_2++) {
                A[i_1-2][i_2] = B[i_1][i_2] * A[i_2-3][i_0] + 6;
            }
        }
    }
#pragma endscop
...
kernel_4122112121_04(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B));
