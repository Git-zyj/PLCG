...
void kernel_3332111221_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
    ...
    for (int i_1 = 1; i_1 < PB_M; i_1++) {
        for (int i_2 = i_1; i_2 < PB_L; i_2++) {
            for (int i_3 = 3; i_3 < PB_P; i_3++) {
                B[i_1-1][i_3][i_3-1] = E[i_1][i_2][i_3] - B[i_1-1][i_3-2][i_3-3] + 5;
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_N-2; i_4++) {
        C[i_4] = D[i_4] + C[i_4+2] * C[i_4-1] + C[i_4-2] - 2;
    }
#pragma endscop
...
kernel_3332111221_05(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
