...
void kernel_2222211223_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        A[i_0] = C[0] * 3;
        A[i_0] = A[i_0] * A[i_0-2] + 2;
    }
#pragma endscop
...
kernel_2222211223_08(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
