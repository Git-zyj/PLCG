...
void kernel_3322111315_00(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        C[i_0] = D[i_0+1] * D[i_0] * 5;
    }
    ...
    for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
        C[i_3] = D[i_3] - C[i_3+1] - C[i_3-1] * C[i_3+1] + 5;
    }
#pragma endscop
...
kernel_3322111315_00(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
