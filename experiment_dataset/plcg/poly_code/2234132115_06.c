...
void kernel_2234132115_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M; i_0++) {
        A[i_0-2] = C[i_0] + C[i_0] * C[i_0] * C[0] * C[i_0] - A[i_0-3] * 5;
        A[i_0-2] = C[i_0] - 6;
    }
#pragma endscop
...
kernel_2234132115_06(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
