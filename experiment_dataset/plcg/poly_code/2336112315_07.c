...
void kernel_2336112315_07(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_2 = 0; i_2 < PB_N-2; i_2++) {
        B[i_2+1] = D[i_2+2] - 6;
        B[i_2+1] = B[i_2+1] - B[i_2+2] - B[i_2] - 5;
    }
#pragma endscop
...
kernel_2336112315_07(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
