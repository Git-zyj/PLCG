...
void kernel_3212131221_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        for (int i_1 = 2; i_1 < min(-i_0+PB_M+1, PB_M-2); i_1++) {
            A[i_1] = C[i_1+i_0-1] * C[i_0] * A[i_1-2] * A[i_1+1] * A[i_1-1] - A[i_1+2] - 4;
        }
        B[i_0] = C[i_0] - C[i_0-1] - C[i_0] + 6;
    }
#pragma endscop
...
kernel_3212131221_08(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
