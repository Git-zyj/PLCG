...
void kernel_4214112321_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M; i_0++) {
        for (int i_1 = 1; i_1 < min(-i_0+PB_M, i_0); i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_P-2; i_2++) {
                A[i_1][i_1+i_0][i_2+2] = C[i_1+i_0][i_2+1][i_2] - A[i_1][i_1+i_0-2][i_2+2] - A[i_2+2][i_2+i_0+2][i_1+2] * A[i_1-1][i_1+i_0-3][i_2+1] * 4;
            }
        }
    }
    for (int i_3 = 0; i_3 < PB_M; i_3++) {
        for (int i_4 = 1; i_4 < min(PB_Q-4, i_3); i_4++) {
            for (int i_5 = 0; i_5 < PB_Q; i_5++) {
                for (int i_6 = 2; i_6 < PB_M; i_6++) {
                    B[i_6][i_4+1][i_4+2] = B[i_6][i_4+3][i_4+4] - B[i_6][i_4-1][i_4] - B[i_6-2][i_4+1][i_4+2] + 5;
                }
            }
        }
    }
...
kernel_4214112321_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
