...
void kernel_4322132323_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf)){
...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < min(-i_0+PB_M, PB_Q-2); i_1++) {
            for (int i_2 = 2; i_2 < PB_P; i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_M-1; i_3++) {
                    A[i_1+i_0][i_2-2][i_3][0] = D[i_3][i_0][i_2][i_1] - E[i_3][0][i_2-1] * D[i_2-1][i_0][i_1][i_3] + D[i_3][i_0-2][i_2][i_1+2] - A[i_1+i_0][i_2-2][i_3-1][0] - A[i_3+i_0+1][i_2-2][i_1][0] + 2;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_P-1; i_4++) {
        for (int i_5 = 1; i_5 < min(PB_N-2, -i_4+PB_M); i_5++) {
            B[i_5] = F[i_5][i_4] + F[i_5+i_4][i_4] - B[i_5+2] * B[i_5-1] - 1;
            for (int i_6 = max(i_4, 2); i_6 < PB_N-2; i_6++) {
                for (int i_7 = 1; i_7 < PB_Q-1; i_7++) {
                    C[i_6][i_5][i_7][i_4] = D[i_4+1][i_6][i_7+1][i_5+2] + C[i_6+2][i_5][i_7][i_4] - C[i_6][i_5][i_7-1][i_4] + C[i_7-1][i_5+2][i_4+1][i_6-2] - C[i_6-2][i_5][i_7][i_4+1] - 3;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), INIT_SEED);
kernel_4322132323_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F)));
