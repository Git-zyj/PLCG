...
void kernel_4414331321_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,int wg,DATA_TYPE POLYBENCH_5D(G,xG,yG,zG,vG,wG,xg,yg,zg,vg,wg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk)){
        ...
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            for (int i_2 = i_0; i_2 < PB_L; i_2++) {
                for (int i_3 = 2; i_3 < PB_L; i_3++) {
                    A[i_0][i_1+1][i_2][i_3-1] = E[i_1][i_0][i_3][i_2] + F[i_2+1][i_0][i_1][i_3+1] - G[i_2][i_3-1][i_1][i_3][i_0] * A[i_0][i_1-1][i_2][i_3-2] + A[i_2][i_1+2][i_3][i_0-1] + A[i_3][i_1+1][i_2][i_0] - A[i_0][i_1+1][i_2][i_3+1] - 1;
                }
            }
        }
    }
        ...
        for (int i_5 = 2; i_5 < min(i_4, -i_4+PB_L); i_5++) {
            for (int i_6 = 1; i_6 < PB_L; i_6++) {
                for (int i_7 = 1; i_7 < PB_L+1; i_7++) {
                    B[i_5-1][i_4+1][i_6+1][i_7] = F[i_5+i_4-1][i_6][i_7-1][i_6] * H[i_6-1][i_5+i_4][i_4][i_7][i_5-1] * E[i_6][i_5+i_4][0][i_7] + B[i_7-1][i_5+1][i_6+1][i_4-1] - B[i_5-1][i_4+1][i_6][i_7] - 1;
                }
            }
            for (int i_8 = 1; i_8 < -i_5+PB_N-1; i_8++) {
                D[i_5][i_8] = I[i_5-1][i_4+1][i_8-1] + D[i_5+1][i_8] * 1;
                D[i_5][i_8] = I[i_4][i_8+i_5+1][0] - J[i_8][i_5+1] * K[i_4-1][i_8][i_5-1] + D[i_5-2][i_8] + 3;
            }
        }
    }
#pragma endscop
...
kernel_4414331321_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
