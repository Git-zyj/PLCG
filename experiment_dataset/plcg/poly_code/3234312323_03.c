...
void kernel_3234312323_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        for (int i_1 = max(2, i_0); i_1 < PB_M; i_1++) {
            for (int i_2 = 2; i_2 < PB_L-1; i_2++) {
                A[i_0][i_1][i_0] = C[i_1][i_2+1] - A[i_0][i_1-2][i_0] * A[i_2-1][i_1][i_2-1] * A[i_2-2][i_1][i_2-2] * 3;
            }
        }
    }
    for (int i_3 = 3; i_3 < PB_M+1; i_3++) {
        for (int i_4 = 1; i_4 < min(PB_P-3, i_3); i_4++) {
            for (int i_5 = 0; i_5 < i_4; i_5++) {
                B[i_3-1][i_5][i_4+1] = B[i_3-2][i_5][i_4] + B[i_3-3][i_5][i_4-1] - B[i_3-2][i_5][i_4+3] * 2;
            }
        }
    }
#pragma endscop
...
kernel_3234312323_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
