...
void kernel_3322311113_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        ...
        for (int i_3 = 1; i_3 < PB_M; i_3++) {
            ...
            for (int i_5 = 2; i_5 < min(PB_P, -i_3+PB_Q-1); i_5++) {
                A[i_3][i_5-2][i_0] = D[i_0-1][i_5][i_5+i_3+1] * A[i_5+2][i_3-1][i_0] + 3;
            }
        }
    }
#pragma endscop
...
kernel_3322311113_05(xa,ya,za,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D));
