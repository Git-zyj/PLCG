...
void kernel_2214211123_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_L; i_0++) {
        for (int i_1 = 0; i_1 < min(-i_0+PB_P+1, i_0); i_1++) {
            A[i_0][i_1+i_0-1][0] = C[i_1] + A[i_0-2][i_1+i_0-3][0] - 5;
        }
        B[i_0-1] = 4;
    }
#pragma endscop
...
kernel_2214211123_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
