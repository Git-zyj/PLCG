...
void kernel_4312352323_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
...
#pragma scop
        ...
        for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 2; i_2 < PB_M; i_2++) {
                for (int i_3 = 0; i_3 < -i_2+PB_M; i_3++) {
                    A[i_1-1][i_2][i_2][i_3] = D[i_1+2][i_1-2][i_2][i_0+2] - E[i_3+i_2][i_3][i_2-2] * A[i_2-1][i_1][i_1][i_0-1] + A[i_1-1][i_2][i_2][i_3+1] * 2;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_Q-4; i_4++) {
        for (int i_5 = 2; i_5 < -i_4+PB_P; i_5++) {
            C[i_5+1][i_4][i_4+2] = F[i_5][i_4] + G[i_5][i_4] - G[i_5-2][i_4] + F[i_5][i_5+i_4] * F[i_4+1][i_5] * 4;
        }
        for (int i_6 = 2; i_6 < PB_M-2; i_6++) {
            for (int i_7 = 2; i_7 < PB_L-2; i_7++) {
                C[i_7][i_4][i_4+2] = E[i_7][i_4-1][i_6+2] * H[i_7][i_6-2][i_4] + E[i_7][i_7][i_6] + D[i_6+2][i_7-2][i_4][0] + I[i_7+1][i_4][0] * I[i_6][i_4-1][i_7] + C[i_7+2][i_4+2][i_4+4] - C[i_7][i_4+2][i_4+4] - C[i_7][i_4+1][i_4+3] + 4;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4312352323_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
