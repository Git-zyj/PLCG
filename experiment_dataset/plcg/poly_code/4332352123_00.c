...
void kernel_4332352123_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < min(min(PB_P-2, i_0), -i_1+PB_M-1); i_2++) {
                for (int i_3 = 2; i_3 < min(-i_0+PB_L, PB_L-2); i_3++) {
                    A[i_2+i_1][i_3+i_0][0][i_3+1] = D[i_2-1][i_3+2][i_1][i_0] - E[i_0-1][i_0][i_1][i_2+2] + E[i_2][i_1][i_0][i_3+i_0] - E[i_2][i_3-2][i_0][i_1] * E[i_3][i_2][i_0][i_1] * A[i_2+i_1+1][i_3+i_0][0][i_0+1] - 2;
                }
            }
        }
    }
        ...
        for (int i_5 = 2; i_5 < i_4; i_5++) {
            for (int i_6 = 2; i_6 < PB_L; i_6++) {
                for (int i_7 = 2; i_7 < -i_6+PB_M; i_7++) {
                    B[i_4+1][i_7][i_5][i_5-1] = E[i_5+2][i_6-2][i_4][i_7] - E[i_7-2][i_4-2][i_6][i_5] - D[i_7+i_6][0][i_5][i_4] + B[i_6][i_7][i_5][i_5-1] - 2;
                }
            }
            for (int i_8 = 1; i_8 < min(-i_5+PB_L, -i_4+PB_L); i_8++) {
                B[i_4+3][i_5-1][i_8][i_8-1] = F[i_8+1][i_8+i_4][i_5] - G[i_8+i_5][i_8][i_4-1] * G[i_8][i_4][i_5-2] + H[i_4][i_5] + I[i_5+2][i_4][i_5] * G[i_4][i_8+i_5][i_5+1] + 2;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4332352123_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
