...
void kernel_4234152221_07(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
        ...
        for (int i_1 = max(2, i_0); i_1 < min(-i_0+PB_P, PB_M-1); i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_L; i_2++) {
                for (int i_3 = 0; i_3 < PB_M-2; i_3++) {
                    A[i_0+1][i_2+i_1][i_3] = C[i_3+2][i_2][i_1+i_0][0] - C[i_1][i_0][i_3][i_2+1] * D[i_3][i_1][i_2] + C[i_1-2][i_2-1][i_0][i_2] * D[i_2][i_3][i_1] * A[i_1+1][i_3+i_2][i_0] - 2;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-2; i_4++) {
        for (int i_5 = 1; i_5 < min(i_4, -i_4+PB_P); i_5++) {
            for (int i_6 = 3; i_6 < PB_M-2; i_6++) {
                B[i_6-2][i_5][i_4+2] = D[i_6][i_4][i_5+i_4] + D[i_4][i_6][i_5-1] + D[i_6][i_4][i_5] * E[i_5][i_4-2] - D[i_5][i_6+i_5+2][i_4] + B[i_6-3][i_5-1][i_4+1] - B[i_4-2][i_6+2][i_5+2] - B[i_6-2][i_5][i_4] + 6;
            }
        }
    }
#pragma endscop
...
kernel_4234152221_07(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
