...
void kernel_4122311123_05(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 0; i_1 < min(-i_0+PB_L-2, PB_M-1); i_1++) {
            A[i_1+1][i_1+i_0] = B[i_0+1] - A[i_1+1][i_1+i_0+2] - 5;
        }
    }
#pragma endscop
...
kernel_4122311123_05(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
