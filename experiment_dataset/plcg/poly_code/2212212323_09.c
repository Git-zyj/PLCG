...
void kernel_2212212323_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N; i_0++) {
        B[i_0+2] = C[i_0] * B[i_0+3] * 3;
    }
    for (int i_1 = 0; i_1 < PB_N; i_1++) {
        for (int i_2 = i_1; i_2 < PB_M-2; i_2++) {
            B[i_2+2] = B[i_2] + B[i_2+1] * 4;
        }
    }
#pragma endscop
...
kernel_2212212323_09(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
