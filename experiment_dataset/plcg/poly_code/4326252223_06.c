...
void kernel_4326252223_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N-3; i_0++) {
        A[i_0+2] = D[i_0] + D[i_0] + D[i_0] - D[i_0+2] + E[i_0] - A[i_0+3] * 4;
    }
    for (int i_1 = 2; i_1 < PB_L; i_1++) {
        A[i_1+2] = D[i_1] + E[i_1] - D[i_1-1] * D[i_1-1] - E[i_1-2] - D[i_1] * A[i_1+2] + 5;
        for (int i_2 = i_1; i_2 < -i_1+PB_L; i_2++) {
            for (int i_3 = 1; i_3 < min(-i_2+PB_N-2, PB_L); i_3++) {
                C[i_1][i_2-1][i_3] = F[i_2][i_3][i_1] + F[i_3][i_2+i_1][i_1+2] * G[i_3+i_2+2][i_3] - F[i_2-2][i_1][i_3] - C[i_1][i_2-2][i_3] - C[i_1][i_2-1][i_3-1] + 4;
            }
        }
    }
#pragma endscop
...
kernel_4326252223_06(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
