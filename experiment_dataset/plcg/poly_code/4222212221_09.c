...
void kernel_4222212221_09(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < PB_L-2; i_1++) {
            A[i_0][i_1+2] = A[i_0][i_1] * 1;
        }
    }
        ...
        for (int i_3 = 0; i_3 < PB_N; i_3++) {
            for (int i_4 = 1; i_4 < PB_P-1; i_4++) {
                for (int i_5 = 2; i_5 < PB_M; i_5++) {
                    B[i_2][i_2][i_4][i_5-2] = C[i_5][i_4+1][i_3][i_4] - B[i_2][i_2][i_4-1][i_5-2] - B[i_3][i_3][i_4+1][i_5-2] - 6;
                }
            }
        }
    }
...
kernel_4222212221_09(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
