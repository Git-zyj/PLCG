...
void kernel_2216211113_05(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
kernel_2216211113_05(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
