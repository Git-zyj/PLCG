        ...
        for (int i_1 = 1; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_0+PB_L, PB_M-1); i_2++) {
                for (int i_3 = 1; i_3 < PB_L; i_3++) {
                    A[i_0+1][i_1+1][i_3][i_2] = E[i_1][i_2][i_3][i_0] + E[i_2][i_0][i_1+1][0] + E[i_3-1][i_0][i_2][i_1] - E[i_0][i_3][i_2+1][i_1+1] + E[i_2+1][i_3][i_1+1][i_0+1] - E[i_3-1][i_2+i_0][0][i_1-1] + A[i_0+1][i_1+2][i_3][i_2] + 1;
                }
            }
        }
        for (int i_4 = 1; i_4 < -i_0+PB_M-1; i_4++) {
            B[i_4+i_0+1][i_0] = F[i_4][i_0+1] - G[i_4+1][i_4-1][i_0] - F[i_4+i_0][i_0] + F[i_4+1][i_0] - 2;
        }
    }
    for (int i_5 = 1; i_5 < PB_M; i_5++) {
        for (int i_6 = 1; i_6 < -i_5+PB_M; i_6++) {
            C[i_6+i_5][i_6+i_5-1] = F[i_5][i_6] + G[i_6+i_5][0][i_6] * H[i_6] - F[i_6][0] - D[i_5][i_6] * D[i_6][i_5] * 2;
            for (int i_7 = 1; i_7 < i_6; i_7++) {
                D[i_7][i_6] = F[i_7-1][i_6-1] * G[i_6+1][i_7-1][i_5] - E[i_5][i_6][i_7-1][i_6] - G[i_7][i_6+1][i_5] - G[i_6][i_7+1][i_5] - 2;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4414151121_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H)));
