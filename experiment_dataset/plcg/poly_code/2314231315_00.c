...
void kernel_2314231315_00(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        C[i_0] = D[i_0-1] - E[i_0-1] - C[i_0] + 2;
        C[i_0-1] = E[i_0] + E[i_0] * D[i_0] - E[i_0+1] - D[i_0-1] - E[i_0] + C[i_0-1] * 3;
...
kernel_2314231315_00(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
