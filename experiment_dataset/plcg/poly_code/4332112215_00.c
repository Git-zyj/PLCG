...
void kernel_4332112215_00(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
kernel_4332112215_00(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
