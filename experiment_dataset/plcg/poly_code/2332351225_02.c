...
void kernel_2332351225_02(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        C[i_0] = D[i_0][i_0] + E[i_0] - E[i_0+1] * C[i_0] - 4;
        B[i_0] = F[i_0] - G[i_0][i_0] * H[i_0] * H[i_0+1] + E[i_0] + C[i_0] + 6;
        C[i_0] = E[i_0] + F[1] - H[i_0] + H[i_0] - E[i_0] - C[i_0+2] * 3;
    }
#pragma endscop
...
kernel_2332351225_02(xc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
