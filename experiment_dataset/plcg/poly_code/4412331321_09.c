...
void kernel_4412331321_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 2; i_2 < min(-i_0+PB_L, i_0); i_2++) {
                for (int i_3 = 2; i_3 < i_0; i_3++) {
                    A[i_3][i_0][i_1][i_2-1] = E[i_3][i_0][i_1][i_2] - F[i_3][i_1][i_2+i_0-1][i_1] + G[i_2+1][i_3+1][i_1][i_0] + E[i_1][i_2+i_0][i_0][i_1] - A[i_3-2][i_0][i_1][i_2-1] + A[i_3][i_0][i_1+1][i_2] + A[i_1][i_0+2][i_2-2][i_3-2] * B[i_2][i_1] + 5;
                }
    ...
    for (int i_4 = 2; i_4 < PB_N-2; i_4++) {
        for (int i_5 = 2; i_5 < PB_N; i_5++) {
            C[i_5-1][i_4] = B[i_5-2][i_4+2] - C[i_5-1][i_4+1] - C[i_5][i_4-2] + 3;
        }
        for (int i_6 = 1; i_6 < -i_4+PB_N-2; i_6++) {
            for (int i_7 = 1; i_7 < -i_4+PB_N; i_7++) {
                D[i_7+i_4][i_6-1][0] = H[i_6][i_7][i_7] * H[i_7+1][i_4][i_6] - I[i_6][i_7-1][i_4] * I[i_6][i_4][i_7+1] * H[i_7][i_4+1][i_6-1] + D[i_6+i_4-2][i_7][0] * D[i_6+i_4+1][i_7-1][0] * D[i_6+i_4+2][i_7-1][0] - 1;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4412331321_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
