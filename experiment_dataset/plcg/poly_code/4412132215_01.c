    ...
    for (int i_3 = 0; i_3 < PB_M-1; i_3++) {
        ...
        for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
            for (int i_6 = 0; i_6 < PB_M-1; i_6++) {
                D[i_5][0] = G[i_6][i_6][i_3] * H[i_3][i_6][i_5][i_5] - D[i_6+1][0] - D[i_5+1][0] * 4;
            }
        }
    }
#pragma endscop
...
kernel_4412132215_01(xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
