...
void kernel_2324311311_02(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
        C[i_1-1] = D[0] + C[i_1] - C[i_1+1] - C[i_1-1] - 5;
        C[i_1] = 5;
    }
#pragma endscop
...
kernel_2324311311_02(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
