...
void kernel_4414232225_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,int wg,DATA_TYPE POLYBENCH_5D(G,xG,yG,zG,vG,wG,xg,yg,zg,vg,wg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_P; i_2++) {
                for (int i_3 = 3; i_3 < PB_N; i_3++) {
                    A[i_0][i_3][i_2][i_3-1] = E[i_3-1][i_1][i_2+i_0][i_0] * F[i_2][i_0][i_1-1][i_3] + E[i_1+1][i_0-1][i_2][2] * A[i_0][i_3-2][i_2+1][i_3-3] - A[i_0][i_3][i_2-1][i_3-1] - 6;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_P; i_4++) {
            for (int i_5 = 2; i_5 < PB_N-2; i_5++) {
                for (int i_6 = i_0; i_6 < -i_5+PB_P; i_6++) {
                    A[i_5+2][i_0][i_6][i_0-1] = F[i_4][i_6+i_5][i_0][i_6] + E[i_5-2][i_5-1][i_4][i_6+1] - G[i_5+1][i_6][i_4-1][i_0][i_4] - H[i_6][i_5+2][i_4] - 4;
                }
            }
        }
    }
    for (int i_7 = 2; i_7 < PB_N-2; i_7++) {
        for (int i_8 = 2; i_8 < PB_N; i_8++) {
            for (int i_9 = 1; i_9 < PB_N-1; i_9++) {
                A[i_8][i_9+1][i_7][i_9] = I[i_8][i_9-1][i_7-1] - I[i_7+2][i_8-2][i_9-1] * 1;
            }
        }
        for (int j_0 = 1; j_0 < PB_N; j_0++) {
            for (int j_1 = 1; j_1 < min(j_0, PB_L-2); j_1++) {
                A[j_0][j_1][i_7][j_1-1] = H[i_7-2][j_1+2][j_0-1] * 3;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4414232225_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
