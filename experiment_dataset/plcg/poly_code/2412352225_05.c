...
void kernel_2412352225_05(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        C[i_0-2] = E[i_0+2] * E[i_0] * E[i_0+2] - F[i_0] + F[i_0] * E[1] + C[i_0] - 4;
        C[i_0+1] = F[i_0] - F[i_0-1] * E[i_0+1] - 4;
        C[i_0] = E[i_0] + G[i_0+1][i_0] + E[i_0] + E[i_0+2] + H[i_0] * F[i_0] * I[i_0][i_0] * C[i_0-1] * 6;
    }
    for (int i_1 = 0; i_1 < PB_P; i_1++) {
        for (int i_2 = 1; i_2 < PB_M; i_2++) {
            C[i_1+2] = I[i_1][i_2-1] - J[i_2][i_1] + F[1] - G[i_2][i_1] + 3;
        }
    }
#pragma endscop
...
kernel_2412352225_05(xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
