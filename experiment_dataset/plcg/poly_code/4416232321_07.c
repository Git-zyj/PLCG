    ...
    for (int i_3 = 2; i_3 < PB_L-2; i_3++) {
        for (int i_4 = 2; i_4 < i_3; i_4++) {
            for (int i_5 = 0; i_5 < -i_3+PB_M; i_5++) {
                B[i_3+1][i_4][i_5] = F[i_5+i_3][i_5][i_4] * G[i_5][i_4][i_3] - B[i_3+1][i_4-2][i_5] * B[i_3+1][i_4+1][i_5+1] * 6;
            }
        }
        for (int i_6 = 1; i_6 < min(i_3, -i_3+PB_Q-2); i_6++) {
            for (int i_7 = 0; i_7 < PB_P; i_7++) {
                for (int i_8 = i_6; i_8 < PB_L; i_8++) {
                    C[i_6][i_8][i_6] = H[i_8][i_3+2][i_7][i_6] + 6;
                }
            }
            for (int i_9 = 1; i_9 < min(-i_6+PB_Q-3, i_3); i_9++) {
                for (int j_0 = 2; j_0 < PB_L-2; j_0++) {
                    D[i_3][j_0][i_9+i_6+2][j_0] = H[i_6][i_3][j_0][i_9-1] + H[i_9][i_6-1][i_3][i_3+2] * I[i_6][i_9][i_3][i_3-1] - D[j_0-2][i_3-2][i_9+i_6+3][i_3-2] + D[i_9-1][j_0+2][i_6+i_3+2][j_0+2] + D[i_3][j_0][i_9+i_6][j_0] + D[i_3][j_0][i_9+i_6][j_0] + 1;
                }
            }
        }
    }
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4416232321_07(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I)));
