...
void kernel_2414331321_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        B[i_0] = D[i_0] * D[i_0-1] * 3;
        B[i_0] = E[i_0-1] * F[i_0] + B[i_0+1] * B[i_0+2] * 3;
        for (int i_1 = i_0; i_1 < -i_0+PB_L+1; i_1++) {
            B[i_1] = G[i_1-1][i_1+i_0-1] - H[i_0] + I[i_1][i_0] - B[i_0+1] * 2;
        }
        D[i_0] = E[i_0] - F[i_0-1] + H[i_0] * E[i_0] - B[i_0] * 1;
    }
#pragma endscop
...
kernel_2414331321_05(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
