...
void kernel_4234112221_02(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
        ...
        for (int i_3 = i_2; i_3 < PB_P; i_3++) {
            for (int i_4 = 0; i_4 < PB_P-3; i_4++) {
                for (int i_5 = 1; i_5 < PB_Q-1; i_5++) {
                    B[i_2][i_3][i_4+2][i_5] = C[i_2+2][i_4][i_5-1][i_3] + B[i_2-1][i_3][i_4+2][i_5] - B[i_2][i_3+1][i_4+3][i_5] * B[i_2][i_3][i_4+2][i_5+1] - 5;
                }
            }
        }
    }
...
kernel_4234112221_02(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
