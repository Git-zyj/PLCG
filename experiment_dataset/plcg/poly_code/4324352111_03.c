...
void kernel_4324352111_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,int vd,int wd,DATA_TYPE POLYBENCH_5D(D,xD,yD,zD,vD,wD,xd,yd,zd,vd,wd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,DATA_TYPE POLYBENCH_1D(M,xM,xm)){
        ...
        for (int i_1 = 2; i_1 < min(-i_0+PB_M, PB_M-3); i_1++) {
            for (int i_2 = i_1; i_2 < -i_0+PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < PB_L-2; i_3++) {
                    A[i_1][i_0+2][i_3+i_2][i_3+i_2] = D[i_2+i_0+1][i_1-1][i_0][i_3+1][i_1-2] * E[i_3][i_0][i_1][i_2] + F[i_2][i_0][i_3][i_1+1] + G[i_1][i_2][i_3+2][i_0] - H[i_2+i_1-2][i_0][i_3+1] - 5;
                }
            }
            B[i_0][i_1+2] = I[i_0][i_1-1] - I[i_0][i_1+1] * J[i_1][i_0+1] - K[i_1+i_0][2] + B[i_0-1][i_1+3] - B[i_0+1][i_1+2] + B[i_0][i_1+3] - 3;
        }
    }
    for (int i_4 = 0; i_4 < PB_M-2; i_4++) {
        for (int i_5 = 0; i_5 < PB_L; i_5++) {
            C[i_5] = I[i_5][i_4] - L[i_4+2] + M[i_4+1] - I[i_5][i_4] - I[i_4][i_5] * 5;
        }
    }
#pragma endscop
