...
#pragma scop
    ...
    for (int i_2 = 1; i_2 < PB_L-1; i_2++) {
        C[i_2] = G[i_2+1][i_2] - E[i_2+2] - F[i_2-1] + H[i_2+1][i_2] * C[i_2+1] + C[i_2-1] - C[i_2-1] + C[i_2+1] * 3;
        for (int i_3 = 0; i_3 < PB_M-1; i_3++) {
            for (int i_4 = 2; i_4 < PB_L; i_4++) {
                D[i_3][i_4][i_2+2] = H[i_4][i_3] - I[i_3][i_4-2][i_2+2] - D[i_3][i_4][i_2+1] - D[i_3+1][i_4][i_2+2] * 3;
            }
        }
    }
#pragma endscop
...
kernel_3436232313_02(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
