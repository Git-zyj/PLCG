...
void kernel_3214312315_05(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        ...
        for (int i_2 = 1; i_2 < -i_0+PB_L-1; i_2++) {
            B[i_0][i_2+i_0] = C[i_0+1][i_2-1] + B[i_0][i_2+i_0+1] - B[i_0][i_2+i_0-1] - B[i_0+1][i_2+i_0+1] * 3;
        }
    }
#pragma endscop
...
kernel_3214312315_05(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
