...
void kernel_4412151313_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi)){
...
#pragma scop
        ...
        for (int i_1 = i_0; i_1 < -i_0+PB_P; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_M-1; i_3++) {
                    A[i_3][i_1][i_1][i_0] = E[i_1][i_2+1][i_1][i_0][i_2+1] + F[i_3+i_0+1][i_2][i_1][i_1] - F[i_2+1][i_3][i_1][i_1] - G[i_0][i_3][i_1] - E[i_2][i_1+1][i_3][i_0-1][0] - A[i_3][i_0][i_0][i_1+1] * A[i_3-1][i_1+1][i_1+1][i_0-1] - 2;
                }
            }
            for (int i_4 = 1; i_4 < min(-i_0+PB_M-1, -i_1+PB_P); i_4++) {
                for (int i_5 = 1; i_5 < -i_1+PB_L; i_5++) {
                    B[i_0][i_5][i_1][i_0+1] = F[i_0-1][i_4+i_0+1][i_5][i_1] + G[i_4-1][i_5+i_1][i_1+i_0] + F[i_1][i_1][i_4][i_5] + F[i_1-1][i_4+1][i_0][i_4+i_1] * F[i_5-1][i_1][i_4][i_0+1] * A[i_5+1][i_1][i_1][i_0-1] * B[i_0+1][i_5][i_1+1][i_0+2] + B[i_0+1][i_1][i_5-1][i_0+2] + 4;
                }
            }
        }
    }
    for (int i_6 = 1; i_6 < PB_M-1; i_6++) {
        for (int i_7 = 0; i_7 < PB_M-2; i_7++) {
            D[i_7] = H[i_7] * I[i_7][i_6-1] - I[i_7][i_6+1] - I[i_6][i_7+1] - D[i_6+1] * 3;
            D[i_6+1] = I[i_7][i_6+1] * I[i_7][i_6] * I[i_7][i_6] - I[i_7][i_6] + D[i_7] + D[i_7+2] * D[i_7+2] * 3;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4412151313_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I)));
