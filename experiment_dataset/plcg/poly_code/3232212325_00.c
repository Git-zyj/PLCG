...
void kernel_3232212325_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 4; i_0 < PB_M; i_0++) {
        A[i_0-2] = C[i_0] * A[i_0] - A[i_0-1] + A[i_0-4] * 3;
    }
...
kernel_3232212325_00(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
