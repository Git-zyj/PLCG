...
void kernel_4226211321_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
        ...
        for (int i_1 = 4; i_1 < PB_M-1; i_1++) {
            for (int i_2 = i_1; i_2 < -i_1+PB_M+3; i_2++) {
                for (int i_3 = i_2; i_3 < -i_1+PB_M-1; i_3++) {
                    A[i_3+i_1-1][i_2][i_2] = A[i_2+i_1-3][i_3-2][i_3-2] - A[i_2+i_1-4][i_3][i_3] + A[i_3+i_1+1][i_2][i_2] + A[i_3+i_1-2][i_2-2][i_2-2] + 3;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_L; i_4++) {
            B[i_0][i_4] = C[i_4-1][i_0] * C[i_4][i_0] + B[i_0+1][i_4] * B[i_0-1][i_4] - 5;
        }
    }
#pragma endscop
...
kernel_4226211321_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
