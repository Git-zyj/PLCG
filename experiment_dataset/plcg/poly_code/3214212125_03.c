...
void kernel_3214212125_03(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_3 = 0; i_3 < PB_L; i_3++) {
        for (int i_4 = 2; i_4 < min(PB_L-2, i_3); i_4++) {
            for (int i_5 = 0; i_5 < PB_M-4; i_5++) {
                B[i_5+2][i_3][i_4+1] = C[i_5][i_4+2][i_3] + C[i_5][i_3][i_4-2] - B[i_5+4][i_3][i_4+1] * 6;
            }
        }
    }
#pragma endscop
...
kernel_3214212125_03(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
