...
void kernel_2224131315_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_N; i_1++) {
        A[i_1] = C[i_1] + C[0] + C[0] * C[i_1] * C[i_1] * 5;
    }
#pragma endscop
...
kernel_2224131315_03(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
