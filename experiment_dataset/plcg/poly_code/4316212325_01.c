...
void kernel_4316212325_01(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
        ...
        for (int i_2 = i_0; i_2 < PB_L; i_2++) {
            for (int i_3 = 2; i_3 < PB_L-1; i_3++) {
                for (int i_4 = 2; i_4 < PB_L; i_4++) {
                    C[i_2][0][i_4] = C[i_3+1][0][i_4] - C[i_2][0][i_3-2] - C[i_4-2][0][i_2] * C[i_4][0][i_3-1] + 4;
                }
            }
        }
    }
...
kernel_4316212325_01(xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
