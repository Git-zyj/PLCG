...
void kernel_4314332123_09(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
        ...
        for (int i_1 = i_0; i_1 < PB_M; i_1++) {
            for (int i_2 = 1; i_2 < PB_M+1; i_2++) {
                for (int i_3 = 2; i_3 < min(PB_P-2, -i_1+PB_P); i_3++) {
                    B[i_1][i_2-1][i_0] = D[i_2-1][i_3][i_0][i_3+i_1] * E[i_3-2][i_3+2][i_0-1][i_1] * 2;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
            for (int i_6 = 1; i_6 < PB_M-2; i_6++) {
                for (int i_7 = 1; i_7 < -i_6+PB_M-2; i_7++) {
                    B[i_5][i_6][i_7] = F[i_7+i_6+2][i_5][1] - D[i_6][i_7+i_6][i_5+1][i_4] * G[i_7+i_6][i_5][i_4][i_6] * B[i_7-1][i_6-1][i_5] - 3;
                }
            }
            for (int i_8 = max(1, i_5); i_8 < min(-i_4+PB_L-1, PB_P-2); i_8++) {
                for (int i_9 = 2; i_9 < min(PB_P, -i_5+PB_L); i_9++) {
                    B[i_5][i_9][i_4] = H[i_8-1][i_9+i_5][i_8] - D[i_5+1][i_8+i_4+1][i_9-2][i_8+2] + D[i_8][i_4][i_9-2][0] + 2;
                }
            }
        }
    }
...
init_array(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4314332123_09(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H)));
