...
void kernel_2316232215_06(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-2; i_0++) {
        C[i_0+2] = D[i_0] - E[i_0] + E[i_0] * E[i_0] * C[i_0+2] * 6;
        C[i_0+1] = D[i_0+2] - C[i_0+2] - 3;
...
kernel_2316232215_06(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
