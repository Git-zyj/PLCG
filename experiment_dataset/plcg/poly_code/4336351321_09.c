...
void kernel_4336351321_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk)){
...
#pragma scop
        ...
        for (int i_1 = 2; i_1 < min(i_0, -i_0+PB_L-1); i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_Q, -i_1+PB_M-1); i_2++) {
                for (int i_3 = 0; i_3 < PB_L-1; i_3++) {
                    A[i_2][i_0][i_3][i_1-1] = D[i_2][i_3+1][i_1] - E[i_2+i_1+1][i_0][i_3][i_3] - F[i_3][i_1][i_2+i_0][i_1] - D[i_2][i_1+i_0+1][i_2] + E[i_1][i_0+1][i_2][1] - G[i_1][i_3][i_2][i_1] + E[i_3][i_0][i_2+1][i_1] - A[i_2-1][i_1][i_0-1][i_3] + A[i_2][i_0+1][i_3][i_1-2] * A[i_3][i_0+1][i_1-1][i_2] + A[i_2-1][i_3][i_0][i_1-1] - A[i_2][i_0+2][i_3][i_1] - 6;
                }
            }
        }
    ...
    for (int i_5 = 1; i_5 < PB_L-1; i_5++) {
        for (int i_6 = 1; i_6 < -i_5+PB_L; i_6++) {
            for (int i_7 = max(2, i_5); i_7 < PB_P-2; i_7++) {
                C[i_6-1][i_5] = D[i_7+1][i_6+i_5][i_7-1] + I[i_7+1][i_5][i_6+1] - J[i_6-1][i_7-1] - K[i_5][i_6][i_7+1] - D[i_6][i_5+1][i_7] - D[i_6+i_5-1][i_5][i_7] * C[i_7-2][i_6] + C[i_6-1][i_7+2] - 1;
            }
        }
    }
#pragma endscop
