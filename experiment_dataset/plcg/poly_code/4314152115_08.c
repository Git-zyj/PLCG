        ...
        for (int i_1 = 2; i_1 < PB_L; i_1++) {
            for (int i_2 = i_0; i_2 < PB_P-2; i_2++) {
                for (int i_3 = 2; i_3 < -i_1+PB_L; i_3++) {
                    A[i_0+1][i_3][i_1-2][i_0] = D[i_2][i_3-1][i_2+1][i_0] + D[i_3-2][i_2][i_1-1][i_0] + E[i_2][i_3+i_1][i_0-1] + E[i_3+1][i_1][i_2+2] * D[i_2+1][i_3-2][i_1][i_0] * A[i_3][i_2+1][i_1-2][i_3-1] + 1;
                }
            }
        }
        B[i_0] = F[i_0-2] + G[i_0][1] - F[i_0] - F[0] - 5;
        B[i_0] = F[i_0] + F[i_0] + F[i_0] + F[i_0-1] + F[i_0] + 3;
    }
#pragma endscop
...
kernel_4314152115_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
