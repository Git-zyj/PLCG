...
void kernel_4212211325_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
        ...
        for (int i_1 = 0; i_1 < PB_P-2; i_1++) {
            for (int i_2 = 2; i_2 < PB_L; i_2++) {
                for (int i_3 = i_2; i_3 < PB_Q; i_3++) {
                    A[i_0+1][i_2][i_1][i_3] = A[i_0+3][i_2][i_1+2][i_3] + A[i_0+2][i_2][i_1][i_3-1] * A[i_0+1][i_2-2][i_1][i_3] + 2;
                }
            }
        }
        B[i_0+1] = C[i_0] + B[i_0+2] * B[i_0+3] * 6;
    }
#pragma endscop
...
kernel_4212211325_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
