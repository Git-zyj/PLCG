...
void kernel_3216112323_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 4; i_0 < PB_M+2; i_0++) {
        for (int i_1 = 2; i_1 < PB_M+2; i_1++) {
            B[i_1-2] = C[i_1] + B[i_1-2] - 6;
        }
        B[i_0-2] = C[i_0+2] - B[i_0-4] * B[i_0-3] * 2;
    }
#pragma endscop
...
kernel_3216112323_05(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
