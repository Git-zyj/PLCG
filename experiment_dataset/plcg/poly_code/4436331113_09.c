        ...
        for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
            for (int i_6 = 0; i_6 < PB_L; i_6++) {
                for (int i_7 = 0; i_7 < min(-i_5+PB_P, -i_4+PB_L); i_7++) {
                    A[i_7+1] = H[i_5+1][i_6][i_7+i_5][i_4] * I[i_6][i_7+i_4][i_5][i_7] - J[i_4][i_7][i_5][i_6] + 4;
                }
            }
        }
        for (int i_8 = 1; i_8 < PB_L; i_8++) {
            for (int i_9 = 0; i_9 < i_4; i_9++) {
                for (int j_0 = i_8; j_0 < min(-i_4+PB_L+1, PB_L-2); j_0++) {
                    A[j_0+2] = J[j_0][i_8-1][i_4+1][0] * I[i_9][j_0+i_4-1][i_4+1][i_8] * K[j_0-1][i_8][i_9+1] * I[i_9][i_4][j_0][i_8] + 1;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4436331113_09(xa,POLYBENCH_ARRAY(A), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K)));
