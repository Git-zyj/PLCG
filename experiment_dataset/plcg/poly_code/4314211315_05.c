...
void kernel_4314211315_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = i_0; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < PB_L+1; i_2++) {
                A[i_0][i_2-1][i_0] = D[i_1][i_0-1][i_1] - 5;
            }
        ...
        for (int i_5 = 0; i_5 < PB_M-2; i_5++) {
            for (int i_6 = 1; i_6 < PB_P-1; i_6++) {
                for (int i_7 = 2; i_7 < PB_M-2; i_7++) {
                    C[i_0+1][i_6-1][i_7] = C[i_7+2][i_6-1][i_5] + C[i_5+2][i_7-2][i_6] - C[i_5][i_7-1][i_6+1] + C[i_5+2][i_6][i_0] * C[i_5+1][i_7-1][i_6-1] + 6;
                }
            }
        }
    }
...
kernel_4314211315_05(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
