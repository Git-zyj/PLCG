...
void kernel_4236132123_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < PB_Q-1; i_1++) {
            for (int i_2 = i_1; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 1; i_3 < -i_1+PB_Q; i_3++) {
                    A[i_0][0][i_3-1] = C[i_2][i_0+2][i_3+i_1][i_1] * C[i_0-1][i_2-1][i_3+i_1-1][i_1] - C[i_2][i_3+1][i_0][i_1+1] * D[i_2+1][i_1][i_3+1] - 1;
                }
            }
        }
    }
    for (int i_4 = 3; i_4 < PB_L; i_4++) {
        for (int i_5 = i_4; i_5 < PB_L; i_5++) {
            B[i_5-2][i_5] = E[i_4] * B[i_4-3][i_4-1] - 4;
        }
    }
#pragma endscop
...
kernel_4236132123_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
