...
void kernel_4324312321_07(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
    ...
    for (int i_2 = 3; i_2 < PB_M; i_2++) {
        C[i_2-3] = D[i_2] + C[i_2-2] + 6;
    }
    for (int i_3 = 2; i_3 < PB_M; i_3++) {
        C[i_3-2] = E[0] + C[i_3] + C[i_3-1] * 1;
    }
#pragma endscop
...
kernel_4324312321_07(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
