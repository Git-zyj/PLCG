...
void kernel_4432331115_05(int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk)){
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_P-1; i_2++) {
                for (int i_3 = 0; i_3 < PB_M-1; i_3++) {
                    C[i_3][i_1+2][i_2+i_0+1][i_1+1] = E[i_1][i_2+1][i_3][i_0-1][i_1-1] + F[i_2][i_3][i_0+1][i_0] * G[i_3+1][i_0-1][i_1][i_2] + 2;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_L-2; i_4++) {
            D[i_0-1][i_4+2] = H[i_0][i_4] - I[i_4-1][i_0] + 5;
        }
    }
        ...
        for (int i_6 = 0; i_6 < PB_M; i_6++) {
            for (int i_7 = 1; i_7 < -i_5+PB_P-1; i_7++) {
                for (int i_8 = 0; i_8 < -i_6+PB_N; i_8++) {
                    C[i_8][i_6+1][i_7+i_5+1][i_6] = F[i_8+i_6][i_7][i_5+1][i_7] - F[i_7-1][i_8][i_6][i_5] - 4;
                }
            }
        }
    }
    for (int i_9 = 0; i_9 < PB_P; i_9++) {
        for (int j_0 = 0; j_0 < PB_M; j_0++) {
            for (int j_1 = 1; j_1 < -j_0+PB_M; j_1++) {
                D[j_0][j_1+1] = J[j_1][i_9][j_1-1] + J[j_1-1][i_9+1][j_0+1] - K[j_1+j_0][j_1][i_9] * D[j_0][j_1+2] + 3;
            }
        }
    }
#pragma endscop
...
init_array(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4432331115_05(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K)));
