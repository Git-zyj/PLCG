...
void kernel_3216212323_02(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        ...
        for (int i_3 = 2; i_3 < PB_M-2; i_3++) {
            B[i_0-1][i_3][i_0] = C[i_3][i_0] * B[i_3+1][i_0+1][i_3+2] - B[i_0-2][i_3][i_0-1] * B[i_0-1][i_3-2][i_0] * 5;
        }
    }
#pragma endscop
...
kernel_3216212323_02(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
