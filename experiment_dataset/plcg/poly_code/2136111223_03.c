...
void kernel_2136111223_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 5; i_0 < PB_M+1; i_0++) {
        for (int i_1 = min(min(i_0, -i_0+PB_M+1), PB_L-1) - 1; i_1 >= 0; i_1--) {
            A[i_1+i_0-1] = B[i_1+1] - A[i_1+i_0-2] - A[i_1+i_0-5] + 5;
        }
    }
#pragma endscop
...
kernel_2136111223_03(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
