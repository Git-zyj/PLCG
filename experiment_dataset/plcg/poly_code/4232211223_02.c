...
void kernel_4232211223_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        for (int i_1 = 0; i_1 < PB_P; i_1++) {
            for (int i_2 = 1; i_2 < min(i_0, PB_P-1); i_2++) {
                A[i_0][i_0][i_2+1] = C[i_2-1][i_0][i_1] + 1;
            }
        }
    }
        ...
        for (int i_4 = 0; i_4 < PB_P-1; i_4++) {
            for (int i_5 = 0; i_5 < PB_P-1; i_5++) {
                for (int i_6 = 0; i_6 < min(PB_L, i_3); i_6++) {
                    A[i_6][i_6][i_5+1] = A[i_5][i_5][i_4+1] * A[i_6][i_6][i_5+1] + 1;
                }
            }
        }
    }
...
kernel_4232211223_02(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C));
