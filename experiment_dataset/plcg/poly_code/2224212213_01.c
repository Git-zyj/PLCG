...
void kernel_2224212213_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 2; i_1 < PB_N; i_1++) {
            A[i_1-1] = C[i_0+2] * A[i_1-2] - A[i_1] * 3;
        }
    }
...
kernel_2224212213_01(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
