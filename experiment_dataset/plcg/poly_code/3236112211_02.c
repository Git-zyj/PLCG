...
void kernel_3236112211_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_3 = 1; i_3 < PB_M; i_3++) {
        for (int i_4 = 1; i_4 < PB_P; i_4++) {
            for (int i_5 = 0; i_5 < min(i_4, PB_Q-1); i_5++) {
                B[i_3][i_4][i_5] = C[i_4][0][i_3-1] * B[i_3][i_4-1][i_5+1] + B[i_3-1][i_4][i_5+1] + B[i_3-1][i_4][i_5] * 2;
            }
        }
    }
#pragma endscop
...
kernel_3236112211_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
