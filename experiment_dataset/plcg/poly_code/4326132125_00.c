        ...
        for (int i_1 = 2; i_1 < PB_N-1; i_1++) {
            for (int i_2 = i_1; i_2 < PB_L; i_2++) {
                for (int i_3 = i_1; i_3 < -i_0+PB_Q; i_3++) {
                    A[i_1-1][i_2][i_0-2][i_3-2] = D[i_1-2][i_2-2][i_3+i_0][i_0] - A[i_1+1][i_0+2][i_2-2][i_3-2] - A[i_1-1][i_2][i_0-3][i_3-2] - 1;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M; i_4++) {
        B[i_4-1] = E[i_4-1] - E[i_4-2] + E[i_4] * 3;
    }
    for (int i_5 = 2; i_5 < PB_P-2; i_5++) {
        for (int i_6 = i_5; i_6 < min(PB_P, -i_5+PB_M+2); i_6++) {
            B[i_6-1] = F[i_5][i_6] * F[i_6-2][i_5+2] * F[i_6+i_5-2][i_6] + F[i_6][i_5-2] * 6;
        }
    }
#pragma endscop
...
kernel_4326132125_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
