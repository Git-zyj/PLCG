...
void kernel_4234131315_08(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd)){
        ...
        for (int i_1 = 0; i_1 < PB_Q-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_N-1; i_2++) {
                for (int i_3 = 0; i_3 < min(PB_Q-1, -i_1+PB_P); i_3++) {
                    B[i_0][i_3][i_2-1][i_1+1] = C[i_2][i_2+1][i_3+i_1] - D[i_2+1][i_0][i_2][i_1+1] + D[i_0+1][i_2+1][i_1][i_3+1] + B[i_0][i_1][i_2+1][i_3+1] + B[i_3][i_0][i_1+1][i_2+1] - B[i_0][i_3+1][i_1][i_2+1] + 5;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_N-1; i_4++) {
            for (int i_5 = 0; i_5 < PB_Q-1; i_5++) {
                for (int i_6 = 0; i_6 < PB_M; i_6++) {
                    B[i_0][i_6][i_4][i_5+1] = C[i_6][i_4-1][i_5] * D[i_4+1][i_5][i_6][i_0+1] * 3;
                }
            }
        }
    }
...
kernel_4234131315_08(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D));
