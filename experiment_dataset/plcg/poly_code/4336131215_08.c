...
void kernel_4336131215_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
        ...
        for (int i_1 = 1; i_1 < PB_P-1; i_1++) {
            for (int i_2 = 1; i_2 < i_1; i_2++) {
                for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
                    A[i_2][i_3][i_0][i_1] = D[i_1][i_2-1][i_3+1][i_0-1] * D[i_2][i_0][i_1-1][i_3+1] - E[i_3-1][i_0][i_3] * A[i_2][i_3+1][i_0][i_1] * A[i_2][i_3][i_0][i_1-1] - A[i_2][i_3+1][i_0][i_1+1] + 2;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < i_4; i_5++) {
            for (int i_6 = 1; i_6 < -i_5+PB_M; i_6++) {
                for (int i_7 = 0; i_7 < PB_P-1; i_7++) {
                    A[i_5-1][i_7][i_6][i_4+1] = D[i_6+i_5][i_4+1][1][i_7] - D[i_7][i_5+1][i_4-1][i_6] * D[i_5][i_4][i_7+1][i_6] * D[0][i_7][i_7+1][i_6-1] - 1;
                }
            }
            for (int i_8 = 0; i_8 < PB_M; i_8++) {
                C[i_4][i_8][i_5] = E[i_5+1][i_8][i_4] + E[i_5][i_4][i_5] * C[i_4][i_8][i_5+1] - 5;
            }
        }
    }
#pragma endscop
...
kernel_4336131215_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
