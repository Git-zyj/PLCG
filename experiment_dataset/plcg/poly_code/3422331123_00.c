    ...
    for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
        for (int i_2 = 1; i_2 < PB_L; i_2++) {
            for (int i_3 = 0; i_3 < PB_L-1; i_3++) {
                B[i_1+1][i_2][i_3] = F[i_1][i_2-1] + G[i_3][i_3] - H[i_3][i_1+1][i_2+1] + G[i_3+1][i_2] * B[i_1-1][i_2][i_3+1] * 2;
            }
        }
        for (int i_4 = 0; i_4 < -i_1+PB_L; i_4++) {
            for (int i_5 = i_1; i_5 < PB_M-1; i_5++) {
                B[i_1+1][i_4][i_5] = H[i_5+1][i_4+i_1][i_4] * 1;
            }
        }
    }
    for (int i_6 = 0; i_6 < PB_M-1; i_6++) {
        D[i_6] = E[i_6] - E[i_6+1] + I[i_6] * F[i_6+1][0] - D[i_6+1] + 1;
    }
#pragma endscop
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_3422331123_00(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I)));
