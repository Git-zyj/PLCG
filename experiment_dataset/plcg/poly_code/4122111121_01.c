...
void kernel_4122111121_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L+1; i_0++) {
        for (int i_1 = i_0; i_1 < PB_N; i_1++) {
            A[i_1] = B[i_0-1] * A[i_1-1] - 1;
        }
    }
#pragma endscop
...
kernel_4122111121_01(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
