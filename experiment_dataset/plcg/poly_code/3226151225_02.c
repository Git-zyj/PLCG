...
void kernel_3226151225_02(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        A[i_0][i_0] = C[i_0] * C[i_0] - C[i_0] * C[i_0+1] - A[i_0-1][i_0-1] + 4;
        A[i_0][i_0] = C[i_0] * C[0] + C[i_0+1] + C[i_0+1] * C[i_0-1] - C[i_0] * A[i_0][i_0] - 5;
    }
#pragma endscop
...
kernel_3226151225_02(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
