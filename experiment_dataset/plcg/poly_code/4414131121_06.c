...
void kernel_4414131121_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        for (int i_1 = 1; i_1 < -i_0+PB_L; i_1++) {
            for (int i_2 = 1; i_2 < PB_Q+1; i_2++) {
                A[i_2][i_0][i_1+i_0] = E[i_0-1][i_1-1] + F[i_1][i_0][i_2-1] * 4;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_N; i_3++) {
        B[i_3] = G[i_3] - G[i_3-1] + 4;
        for (int i_4 = 2; i_4 < -i_3+PB_P-2; i_4++) {
            C[i_3][i_4+i_3] = E[i_4+1][i_3] - G[i_4] * C[i_4+2][i_4+i_3+2] - 4;
            for (int i_5 = 2; i_5 < min(-i_4+PB_Q+1, i_3); i_5++) {
                for (int i_6 = 2; i_6 < min(PB_L, -i_5+PB_L+2); i_6++) {
                    D[i_3-1][i_4][i_5-1][i_6] = H[i_6][i_5][i_5][i_3] - H[i_3][i_5][i_4][i_5] * H[i_6][i_3][i_5+i_4-1][i_5+i_4-1] - F[i_5][i_6+1][i_4] + A[i_4-2][i_6][i_6+i_5-2] + D[i_3][i_4][i_5-1][i_6-2] - 6;
                }
            }
        }
    }
...
kernel_4414131121_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
