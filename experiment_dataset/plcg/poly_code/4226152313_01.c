...
void kernel_4226152313_01(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd)){
        ...
        for (int i_1 = 1; i_1 < min(i_0, -i_0+PB_P); i_1++) {
            for (int i_2 = 2; i_2 < -i_0+PB_L; i_2++) {
                for (int i_3 = 0; i_3 < PB_L; i_3++) {
                    B[i_0-1][i_2][i_3][i_1] = C[i_3][i_1+1][i_2] + D[i_0][i_2-2][i_1][i_3] + D[i_1-1][i_3][i_3+1][i_0] + D[i_3][i_2+i_0][i_1+i_0][i_1+2] * D[i_1][i_2][i_3+1][i_0-1] * D[i_1][i_2+2][i_1-1][i_0-2] * D[i_1][i_0][0][i_3] + 5;
                }
            }
        }
        for (int i_4 = 2; i_4 < min(i_0, PB_L-2); i_4++) {
            for (int i_5 = 1; i_5 < PB_N; i_5++) {
                for (int i_6 = 1; i_6 < -i_0+PB_P; i_6++) {
                    B[i_5][i_6][i_0][i_4] = D[i_6][i_4-2][i_5][i_0] + D[i_5][i_4+2][i_6+i_0][0] - B[i_5][i_6-1][i_0+1][i_4] - B[i_6][i_4+1][i_0+1][i_5-1] * B[i_0][i_6][i_4][i_5-1] - 6;
                }
            }
        }
    }
...
kernel_4226152313_01(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D));
