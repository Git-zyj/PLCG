        ...
        for (int i_1 = 1; i_1 < min(-i_0+PB_Q+1, PB_M); i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_Q-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_Q-1; i_3++) {
                    A[i_1-1][i_2][i_0][i_3] = C[i_1][i_0][i_3][i_2+i_1+1] * D[i_1][i_0][i_2][i_2-1] + E[i_2][i_0][i_1+i_0-1][i_3+1] + D[i_2+i_1][i_3-1][i_2][i_0] - A[i_2][i_1][i_3][i_0] * A[i_1][i_2][i_3+1][i_0] * 1;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
            B[i_4][i_0] = F[i_0][i_4] * F[i_4][i_0] * G[i_4+1][0] - F[i_0][i_4+1] + H[i_4][i_0] + B[i_4-1][i_0] - B[i_4-1][i_0+1] + 2;
        }
    }
#pragma endscop
...
kernel_4212351215_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
