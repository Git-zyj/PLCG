        ...
        for (int i_1 = 1; i_1 < -i_0+PB_Q-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_L; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_0+PB_Q, PB_L); i_3++) {
                    A[i_2][i_3+i_0][i_1+1][i_3-1] = D[i_2+i_1-1][i_0-1][i_3+1][i_0] + D[i_2][i_3][i_1][i_0] - E[i_2-1][i_1][i_3-1][i_0-1] - D[i_2][i_3][i_1+i_0][i_1] - A[i_3][i_1+i_0+1][i_2+1][i_1-1] - 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-2; i_4++) {
        B[i_4+1] = F[i_4+1] - G[i_4] * G[i_4] + G[i_4] + F[i_4-1] - B[i_4] - B[i_4+2] - B[i_4] + 4;
        for (int i_5 = 0; i_5 < PB_L-1; i_5++) {
            B[i_5+1] = H[i_5][i_4+1] + I[i_4][i_5+1] + H[i_4][i_5+1] + I[i_5][i_4-1] * G[0] * B[i_5+2] + B[i_5+1] + 6;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4332351315_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I)));
