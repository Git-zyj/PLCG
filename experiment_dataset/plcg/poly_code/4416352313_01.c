...
void kernel_4416352313_01(int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,int zk,int vk,DATA_TYPE POLYBENCH_4D(K,xK,yK,zK,vK,xk,yk,zk,vk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl),int xm,int ym,int zm,int vm,int wm,DATA_TYPE POLYBENCH_5D(M,xM,yM,zM,vM,wM,xm,ym,zm,vm,wm),int xn,int yn,int zn,int vn,int wn,DATA_TYPE POLYBENCH_5D(N,xN,yN,zN,vN,wN,xn,yn,zn,vn,wn)){
...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_1+PB_L, PB_L-1); i_2++) {
                for (int i_3 = 0; i_3 < -i_1+PB_L-1; i_3++) {
                    D[i_2-1][i_3+i_1+1][i_0-2][i_2-1] = E[i_3][i_2+i_1][i_0][0] + F[i_0+2][1][i_2+i_1+1] * G[i_2-1][i_0][i_1+2][i_3] + F[i_3+2][i_2+1][i_1] + 5;
                }
            }
        }
        for (int i_4 = i_0; i_4 < -i_0+PB_L+1; i_4++) {
            for (int i_5 = 3; i_5 < PB_L; i_5++) {
                for (int i_6 = 0; i_6 < min(i_4, -i_4+PB_L-1); i_6++) {
                    D[i_0][i_6+i_4+1][i_5-3][i_0] = E[i_4][i_5][i_0][i_0] + G[i_6][i_0+2][i_4+2][i_5] - E[i_4][i_6][i_6+2][i_4+i_0] + E[i_6+2][i_0+1][i_4][i_5-2] - D[i_6][i_4+i_0-1][i_5-1][i_6] * 5;
                }
            }
        }
    }
    for (int i_7 = 1; i_7 < PB_L; i_7++) {
        for (int i_8 = 0; i_8 < min(PB_M-3, i_7); i_8++) {
            C[i_8+2] = H[i_7][i_8] - I[i_8+1] - C[i_8+1] + C[i_8+3] + C[i_8+1] * C[i_8+1] + 5;
        }
        for (int i_9 = 2; i_9 < min(PB_L-1, -i_7+PB_L+1); i_9++) {
            for (int j_0 = 3; j_0 < i_9; j_0++) {
                for (int j_1 = 1; j_1 < min(min(i_9, -i_7+PB_M-1), -i_9+PB_L-1); j_1++) {
                    D[i_7][j_1+i_9+1][j_0-2][i_7] = J[j_0+i_9+1][i_7][1] + K[i_9][j_1][i_7][j_0+i_9] - L[j_0][j_1-1][0] + L[j_1+i_7+1][j_0+i_9][j_0] - K[i_9-2][j_0][i_7][j_1] - M[j_1][i_7][j_0+1][i_9][i_9] + N[i_9-1][i_7][j_0][j_1][j_0] - E[i_9][i_7-1][j_1][j_0] + K[j_0-1][i_9+2][j_1][i_7] + D[j_1+1][i_9+i_7-1][j_0-3][j_1+1] * 6;
                }
            }
        }
    }
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,zm,vm,wm,POLYBENCH_ARRAY(M), xn,yn,zn,vn,wn,POLYBENCH_ARRAY(N), INIT_SEED);
kernel_4416352313_01(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,zm,vm,wm,POLYBENCH_ARRAY(M), xn,yn,zn,vn,wn,POLYBENCH_ARRAY(N));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,zm,vm,wm,POLYBENCH_ARRAY(M), xn,yn,zn,vn,wn,POLYBENCH_ARRAY(N)));
