...
void kernel_3434331311_01(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
...
#pragma scop
    ...
    for (int i_3 = 1; i_3 < PB_L; i_3++) {
        for (int i_4 = max(2, i_3); i_4 < min(-i_3+PB_M, PB_L); i_4++) {
            C[i_3-1][i_4-1] = F[i_4+1][i_3] * F[i_4-1][i_3] + F[i_4+1][i_3] + G[i_4+i_3-1][i_3] + F[i_4+i_3][i_3] * H[i_4-1][i_3] * G[i_4+i_3][i_3] * C[i_3][i_4-1] * C[i_3-1][i_4-2] * C[i_3][i_4] - 1;
        }
        D[i_3+1] = I[i_3] * D[i_3+2] + D[i_3] * 4;
    }
#pragma endscop
...
kernel_3434331311_01(xa,ya,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
