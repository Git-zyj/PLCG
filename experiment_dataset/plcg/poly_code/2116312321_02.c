...
void kernel_2116312321_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-4; i_0++) {
        A[i_0+2] = B[i_0+1] * A[i_0] + A[i_0+4] - A[i_0+1] + 6;
    }
#pragma endscop
...
kernel_2116312321_02(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
