...
void kernel_2336112223_07(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 4; i_0 < PB_M-2; i_0++) {
        C[i_0-2] = D[i_0] * D[i_0+2] + D[i_0] * 6;
        C[i_0-4] = 3;
    }
    for (int i_1 = 4; i_1 < PB_M; i_1++) {
        C[i_1-2] = C[i_1-4] - C[i_1] + 4;
    }
#pragma endscop
...
kernel_2336112223_07(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
