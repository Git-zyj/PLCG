...
void kernel_4436232323_01(int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
...
#pragma scop
    ...
    for (int i_2 = 4; i_2 < PB_M+1; i_2++) {
        B[i_2-2] = B[i_2-1] + B[i_2-4] - 5;
    }
    for (int i_3 = 4; i_3 < PB_M; i_3++) {
        B[i_3-2] = E[i_3] - E[i_3] - 1;
        for (int i_4 = i_3; i_4 < PB_L; i_4++) {
            for (int i_5 = i_4; i_5 < min(min(-i_3+PB_M+1, -i_4+PB_P), PB_L-2); i_5++) {
                D[i_4-2][i_5][i_5] = F[i_5][i_4] - G[i_5+i_3-1][i_4] + H[i_3][i_5][i_5+1] * I[0][i_3][i_4] - I[i_5-1][i_3][i_5+i_4] * I[i_4][i_5][i_3] + I[i_4+2][i_3][i_4] + D[i_4-2][i_5+1][i_5+1] * D[i_3-4][i_5+2][i_5+2] + D[i_4-3][i_5-1][i_5-1] + 2;
            }
        }
    }
#pragma endscop
...
init_array(xd,yd,zd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4436232323_01(xd,yd,zd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xd,yd,zd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
