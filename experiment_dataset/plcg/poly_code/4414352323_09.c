...
void kernel_4414352323_09(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
            A[i_0][i_1] = E[i_1+2] * F[i_0][i_1] * G[i_1-1][i_0] - F[i_0][i_1] - A[i_0-1][i_1+2] + A[i_0][i_1-2] * 3;
        }
    }
    for (int i_2 = 1; i_2 < PB_M-2; i_2++) {
        for (int i_3 = 2; i_3 < -i_2+PB_M-2; i_3++) {
            B[i_2+1][i_3] = F[i_3+i_2+2][i_2] - G[i_2][i_3+1] - F[i_3][i_2] * F[i_3+i_2+2][0] - G[i_3+i_2][i_3] - A[i_3-2][i_2-1] - B[i_2+1][i_3+2] + B[i_2+2][i_3] + B[i_2-1][i_3+1] + B[i_2][i_3+2] * 6;
            for (int i_4 = 2; i_4 < min(-i_2+PB_Q, PB_M-2); i_4++) {
                for (int i_5 = 0; i_5 < min(-i_2+PB_L, i_2); i_5++) {
                    D[i_3][i_3+1][i_5] = H[i_2][i_5][i_3-1][i_4+i_2] + H[i_3+1][i_5+i_2][i_3-1][i_4+2] * I[i_5][i_4][i_3+1][i_4] * H[i_4-1][i_5+i_2][i_3-1][i_4-1] - I[i_4-2][i_4][i_5][i_3] * J[i_4+2][i_2-1][i_5][i_3] * K[i_5][i_4][i_3+1] - 1;
                }
            }
        }
        for (int i_6 = max(2, i_2); i_6 < PB_M-1; i_6++) {
            for (int i_7 = i_2; i_7 < PB_L-2; i_7++) {
                for (int i_8 = 0; i_8 < PB_L; i_8++) {
                    D[i_6][i_6+1][i_7] = I[i_7+1][i_8][i_6][i_2] * L[i_8][i_7][i_6] * D[i_8][i_8+1][i_7+2] * D[i_6-2][i_6-1][i_7] * 6;
                }
            }
        }
    }
...
init_array(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4414352323_09(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L)));
