...
void kernel_3224211221_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_N-3; i_0++) {
        A[i_0+1] = A[i_0+3] - A[i_0] - 6;
        for (int i_1 = 1; i_1 < PB_L+1; i_1++) {
            B[i_0-1][i_0][i_1-1] = C[1] * B[i_0-3][i_0-2][i_1-1] - 4;
        }
    }
#pragma endscop
...
kernel_3224211221_02(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
