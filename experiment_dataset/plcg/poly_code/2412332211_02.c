...
void kernel_2412332211_02(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-1; i_0++) {
        A[i_0][i_0] = E[i_0] + E[i_0] + E[i_0] - E[i_0] * E[i_0] * 5;
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            B[i_1] = F[i_1-1] - G[i_1][i_0] + H[i_1][i_0] * A[i_1-1][i_1-1] + B[i_1-1] * 2;
        }
        C[i_0] = A[i_0][i_0] - A[i_0+1][i_0+1] * B[i_0] + 4;
        D[i_0] = E[i_0] - I[i_0] + F[2] - C[i_0] - 2;
    }
#pragma endscop
...
kernel_2412332211_02(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
