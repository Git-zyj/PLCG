...
void kernel_3216111323_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-3; i_0++) {
        for (int i_1 = i_0 - 1; i_1 >= 1; i_1--) {
            B[i_0+3] = C[i_1-1] - B[i_1+1] - 5;
        }
...
kernel_3216111323_00(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
