        ...
        for (int i_1 = 1; i_1 < PB_P-1; i_1++) {
            for (int i_2 = i_0; i_2 < -i_0+PB_M; i_2++) {
                for (int i_3 = 1; i_3 < min(PB_Q, -i_0+PB_L+1); i_3++) {
                    A[i_2+i_0][i_1][i_0][i_3] = D[i_2][i_0+1][i_1+1][i_3-1] - E[i_1-1][i_3][i_2+1][i_0] - D[i_1][i_3+i_0-1][i_0][i_2-1] - 6;
                }
            }
        }
        for (int i_4 = i_0; i_4 < PB_M-1; i_4++) {
            B[i_0+1][i_4] = F[i_4+1][i_0] + G[i_0][i_4] * B[i_0+2][i_4] + B[i_0][i_4] * 1;
        }
    }
...
kernel_4326231123_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
