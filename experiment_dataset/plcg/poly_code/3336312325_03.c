...
void kernel_3336312325_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M+1; i_0++) {
        for (int i_1 = 0; i_1 < min(PB_M, i_0); i_1++) {
            for (int i_2 = 0; i_2 < i_0; i_2++) {
                A[i_0-1][i_2][i_0] = A[i_0-2][i_2+1][i_0-1] + A[i_1][i_0][i_1+1] * 4;
            }
        }
        for (int i_3 = i_0; i_3 < PB_L; i_3++) {
            for (int i_4 = 0; i_4 < PB_L; i_4++) {
                A[i_0-2][i_3][i_0-1] = A[i_0-1][i_4][i_0] + 3;
            }
        }
    }
    for (int i_5 = 1; i_5 < PB_M+1; i_5++) {
        for (int i_6 = 2; i_6 < PB_L; i_6++) {
            for (int i_7 = 0; i_7 < -i_6+PB_L+2; i_7++) {
                A[i_5-1][i_6][i_5] = D[i_7+i_6-2][i_6-1][i_5] * 3;
            }
        }
    }
#pragma endscop
...
kernel_3336312325_03(xa,ya,za,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D));
