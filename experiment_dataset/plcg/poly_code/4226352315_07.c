...
void kernel_4226352315_07(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
        ...
        for (int i_1 = 0; i_1 < -i_0+PB_Q; i_1++) {
            for (int i_2 = 2; i_2 < min(-i_0+PB_L-2, i_0); i_2++) {
                for (int i_3 = 1; i_3 < PB_P; i_3++) {
                    B[i_1][i_2-1][i_3-1][i_0-2] = C[i_2-2][i_1][i_3][i_0+2] - D[i_2+i_0+2][i_2][i_3][2] + C[i_3][i_0+1][i_2][i_1+i_0] + D[i_1][i_0][i_3][i_2] + 4;
                }
            }
        }
    }
        ...
        for (int i_5 = 2; i_5 < i_4; i_5++) {
            for (int i_6 = 2; i_6 < min(PB_Q-1, -i_4+PB_P+1); i_6++) {
                for (int i_7 = 2; i_7 < PB_L-2; i_7++) {
                    B[i_7][i_6][i_4][i_5-1] = E[i_5][i_6+2][i_7-1][i_6+1] + C[i_5][i_4][i_6][i_7-1] * D[i_7+2][i_6-1][i_5][i_4] + D[i_5][i_7][i_6+i_4-1][i_4] * F[i_5][i_7][i_6-2] + D[i_7+i_6-2][i_4][i_5-2][i_7] - B[i_7+1][i_6][i_4][i_5-2] * B[i_7-1][i_4][i_5-1][i_6-1] - B[i_5][i_6][i_4+1][i_7-2] * 3;
                }
            }
        }
    }
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), INIT_SEED);
kernel_4226352315_07(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F)));
