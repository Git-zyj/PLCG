...
void kernel_3124312315_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_L+2; i_0++) {
        for (int i_1 = 3; i_1 < min(i_0, PB_L+1); i_1++) {
            A[i_0-2] = B[i_0] - A[i_1-1] * A[i_0-3] - A[i_1-3] * 3;
        }
    }
#pragma endscop
...
kernel_3124312315_06(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
