...
void kernel_4234211113_06(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_2 = 1; i_2 < PB_M; i_2++) {
        for (int i_3 = 0; i_3 < PB_Q; i_3++) {
            for (int i_4 = i_2; i_4 < PB_L; i_4++) {
                B[i_2][i_4] = C[i_2-1][i_4][i_3] + B[i_4-1][i_2] + 6;
            }
        }
    }
#pragma endscop
...
kernel_4234211113_06(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
