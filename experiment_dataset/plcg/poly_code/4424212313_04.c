...
void kernel_4424212313_04(int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
        ...
        for (int i_7 = 0; i_7 < PB_M-1; i_7++) {
            for (int i_8 = 0; i_8 < PB_M; i_8++) {
                for (int i_9 = 0; i_9 < PB_L; i_9++) {
                    D[i_7+1][i_6+1][i_6+1] = E[i_6][i_9][i_6] + 6;
                }
            }
        }
        for (int j_0 = max(i_6, 2); j_0 < PB_L; j_0++) {
            for (int j_1 = 1; j_1 < PB_M-2; j_1++) {
                D[j_1+1][j_0][j_0] = E[j_1+2][i_6][j_0-2] * D[i_6+2][j_1-1][j_1-1] - D[j_1+2][j_0-1][j_0-1] * D[j_1+2][j_0][j_0] + 4;
            }
        }
    }
#pragma endscop
...
kernel_4424212313_04(xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
