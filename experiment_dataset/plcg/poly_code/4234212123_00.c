...
void kernel_4234212123_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
        ...
        for (int i_2 = 3; i_2 < PB_M; i_2++) {
            for (int i_3 = 2; i_3 < PB_M; i_3++) {
                for (int i_4 = 1; i_4 < -i_2+PB_M+1; i_4++) {
                    B[i_1+2][i_4+i_2-1][i_3-2][i_3-1] = C[i_2][i_1][i_4-1][i_1] + C[i_3][i_4][i_1][i_1-1] - B[i_1+2][i_4+i_2-3][i_3-2][i_3-1] * 1;
                }
            }
        }
    }
...
kernel_4234212123_00(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
