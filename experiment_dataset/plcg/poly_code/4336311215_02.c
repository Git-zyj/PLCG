...
void kernel_4336311215_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 0; i_1 < PB_N; i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_N-1; i_2++) {
                for (int i_3 = 0; i_3 < -i_2+PB_N-1; i_3++) {
                    A[i_3+i_2][i_1][i_2] = D[i_3][i_0][i_0] - A[i_2+i_0+1][i_3][i_2] + A[i_3+i_2-1][i_1][i_2-1] * A[i_3+i_2+1][i_1][i_3] + A[i_2+i_0-1][i_3][i_2] * 1;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < PB_L; i_5++) {
            for (int i_6 = 0; i_6 < i_5; i_6++) {
                for (int i_7 = 0; i_7 < PB_L-1; i_7++) {
                    B[i_6][i_5][i_7+1] = B[i_7][i_6+1][i_5] - 1;
                }
            }
        }
        for (int i_8 = 0; i_8 < min(i_4, PB_P); i_8++) {
...
kernel_4336311215_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
