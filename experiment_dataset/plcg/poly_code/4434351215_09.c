...
void kernel_4434351215_09(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl),int xm,int ym,int zm,int vm,int wm,DATA_TYPE POLYBENCH_5D(M,xM,yM,zM,vM,wM,xm,ym,zm,vm,wm)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        A[i_0][i_0] = E[i_0] * F[0] - A[i_0-1][i_0-1] - A[i_0+1][i_0+1] * 2;
    }
    for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
        for (int i_2 = 1; i_2 < i_1; i_2++) {
            for (int i_3 = i_2; i_3 < PB_M; i_3++) {
                for (int i_4 = 1; i_4 < min(-i_1+PB_M-1, -i_2+PB_P); i_4++) {
                    B[i_2+1][i_3][i_1][i_4+1] = G[i_4][i_2][i_3] * H[i_3][i_4-1][i_1-1][i_2] - H[i_2-1][i_3][i_1][i_3] * I[i_3][i_4+i_1][i_2][i_4+i_2+1] - J[i_3-1][i_1][i_4+i_2][i_4] * K[i_3][i_4][i_3+1] - K[i_4+i_1+1][i_2+1][i_3-1] - H[i_3+1][i_2][i_1][i_4-1] - 1;
                }
            }
            for (int i_5 = 1; i_5 < min(-i_2+PB_L+1, PB_M); i_5++) {
                C[i_2][i_2+1] = G[i_2][i_1+1][i_1-1] - L[i_5][i_1][i_2] + G[i_1-1][i_5][i_2] * K[i_1][i_5][i_5+i_2-1] + C[i_2+1][i_2+2] - C[i_5-1][i_5] - 1;
            }
        }
    }
    for (int i_6 = 1; i_6 < PB_M-1; i_6++) {
        for (int i_7 = 0; i_7 < PB_P; i_7++) {
            for (int i_8 = 1; i_8 < i_7; i_8++) {
                for (int i_9 = 0; i_9 < min(-i_8+PB_L, PB_P-2); i_9++) {
                    B[i_6][i_8-1][i_7][i_9+2] = M[i_6+1][i_8][i_9+i_8][i_7+1][i_7] * J[i_9][i_8+1][i_9][i_7+1] * H[i_6][i_6-1][i_9][i_7] - J[i_9][i_6][i_6][i_8] * I[i_8][i_9][i_8][i_7] * 2;
                }
            }
        }
    }
...
init_array(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,zm,vm,wm,POLYBENCH_ARRAY(M), INIT_SEED);
kernel_4434351215_09(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,zm,vm,wm,POLYBENCH_ARRAY(M));
