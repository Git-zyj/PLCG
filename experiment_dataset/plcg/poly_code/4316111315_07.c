...
void kernel_4316111315_07(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            ...
            B[i_1] = D[i_0+1] - B[i_1+1] + B[i_1-1] + B[i_1-1] * 3;
        }
    }
...
kernel_4316111315_07(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
