...
void kernel_4226111313_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < PB_L; i_2++) {
                for (int i_3 = 1; i_3 < PB_P; i_3++) {
                    A[i_2][i_0+1][i_1] = C[i_0-1][i_1][i_3] * A[i_2][i_1+1][i_3-1] + A[i_0][i_2][i_1] + A[i_2-1][i_0][i_1] * 1;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M; i_4++) {
        for (int i_5 = 1; i_5 < -i_4+PB_M; i_5++) {
            B[i_5-1][i_5+i_4] = D[i_5+i_4] + B[i_5-1][i_5+i_4+1] + B[i_5][i_5+i_4+1] - 1;
        }
    }
#pragma endscop
...
kernel_4226111313_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
