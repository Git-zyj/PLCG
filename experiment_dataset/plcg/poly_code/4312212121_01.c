        ...
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < PB_M; i_3++) {
                    A[i_2+1][i_1-2][i_0][i_2] = 6;
                }
            }
        }
        for (int i_4 = 1; i_4 < min(PB_N, i_0); i_4++) {
            for (int i_5 = 2; i_5 < min(min(PB_N-2, -i_4+PB_N), -i_0+PB_P); i_5++) {
                for (int i_6 = 2; i_6 < -i_0+PB_N+2; i_6++) {
                    B[i_4-1][i_6+i_0-2][i_5][i_5-2] = D[i_6][i_5+i_0][i_4][0] * B[i_4-1][i_6+i_0-2][i_5+2][i_5] + B[i_0-1][i_5+i_4][i_6][i_6-2] * 1;
                }
            }
        }
    }
        ...
        for (int i_8 = 3; i_8 < PB_L; i_8++) {
            for (int i_9 = i_8; i_9 < PB_L; i_9++) {
                for (int j_0 = 2; j_0 < -i_8+PB_M; j_0++) {
                    A[j_0+1][i_8-3][i_9][j_0] = E[i_8-1][i_7+1][i_8][j_0-2] + E[j_0+i_8][j_0][i_9][2] + 2;
                }
            }
        }
    }
...
kernel_4312212121_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
