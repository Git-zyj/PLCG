...
void kernel_4322331323_09(int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_P; i_0++) {
        for (int i_1 = 0; i_1 < PB_M; i_1++) {
            for (int i_2 = 2; i_2 < PB_L-1; i_2++) {
                C[i_2][i_2-1] = D[i_1][i_2][i_0] - C[i_2+1][i_2] + C[i_2-1][i_2-2] * 1;
            }
        }
    }
        ...
        for (int i_4 = 1; i_4 < i_3; i_4++) {
            for (int i_5 = 1; i_5 < min(-i_4+PB_L+1, -i_3+PB_L-1); i_5++) {
                for (int i_6 = 0; i_6 < PB_M-1; i_6++) {
                    C[i_5+1][i_5] = E[i_6+1][i_5+i_3+1][i_4][i_5] + E[i_3][i_5+i_4-1][i_6][0] - F[i_5-1][i_6][i_4-1] - 5;
                }
            }
        }
        for (int i_7 = 2; i_7 < -i_3+PB_M-1; i_7++) {
            C[i_7+1][i_7] = G[i_7+1][i_3-1] - G[i_3][i_3] - G[i_7][i_3] - H[i_3][i_3] + H[i_3][i_7+i_3+1] * C[i_7-1][i_7-2] - 2;
        }
    }
#pragma endscop
...
kernel_4322331323_09(xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
