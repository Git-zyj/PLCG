...
void kernel_2212111223_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_L - 1; i_0 >= 0; i_0--) {
        B[i_0+1] = B[i_0+1] * 3;
        B[i_0+1] = C[i_0][1] * B[i_0] + 5;
    }
#pragma endscop
...
kernel_2212111223_09(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
