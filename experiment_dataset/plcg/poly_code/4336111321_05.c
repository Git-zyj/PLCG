    ...
    for (int i_5 = 1; i_5 < PB_L-1; i_5++) {
        for (int i_6 = 0; i_6 < i_5; i_6++) {
            for (int i_7 = i_6; i_7 < PB_M-2; i_7++) {
                C[i_7][i_6][i_5] = C[i_7+2][i_6][i_5+1] - C[i_7][i_6][i_5-1] + 4;
            }
        }
    }
#pragma endscop
...
kernel_4336111321_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
