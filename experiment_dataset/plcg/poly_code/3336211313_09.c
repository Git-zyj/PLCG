...
void kernel_3336211313_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_1 = 0; i_1 < PB_N; i_1++) {
        for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
            for (int i_3 = 0; i_3 < PB_M; i_3++) {
                B[i_3][i_2][0] = D[i_3][i_1][i_2+1] * B[i_3][i_2-1][0] * 6;
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M+1; i_4++) {
        for (int i_5 = i_4; i_5 < -i_4+PB_M+1; i_5++) {
            for (int i_6 = -i_5+PB_M - 1; i_6 >= 1; i_6--) {
                C[i_6+i_5][i_5][i_4] = C[i_6+i_5-1][i_5-1][i_4] + C[i_5+i_4-1][i_5][i_6-1] + C[i_6+i_5][i_5][i_4+1] - 5;
            }
        }
    }
#pragma endscop
...
kernel_3336211313_09(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
