...
void kernel_4226352215_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
        ...
        for (int i_1 = 2; i_1 < min(PB_Q, -i_0+PB_L-1); i_1++) {
            for (int i_2 = 1; i_2 < min(PB_Q, -i_0+PB_L-1); i_2++) {
                for (int i_3 = 2; i_3 < PB_Q; i_3++) {
                    A[i_2+1][i_1-2][i_3][1] = C[i_2][i_3][i_1-2] * D[i_2][i_0][i_3][i_1] - E[i_3][i_2+i_0+1][i_3][1] - E[i_3][i_0+2][i_2][i_1+i_0+1] - A[i_2+1][i_3-2][i_1-1][1] - A[i_3+1][i_2-1][i_0][1] - 3;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-2; i_4++) {
        for (int i_5 = i_4; i_5 < PB_Q; i_5++) {
            for (int i_6 = 0; i_6 < i_4; i_6++) {
                A[i_5+1][i_4-2][i_6][1] = F[i_4-1][i_6+1][i_5] + G[i_4+2][i_5][i_6] + H[i_5][i_6] - C[i_4][i_6][i_5-1] - C[i_6][i_5-1][i_4] + F[i_4][i_6][i_5] + 5;
            }
        }
    }
#pragma endscop
...
kernel_4226352215_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
