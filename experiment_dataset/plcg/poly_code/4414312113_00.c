...
void kernel_4414312113_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf)){
        ...
        for (int i_1 = i_0; i_1 < PB_P; i_1++) {
            for (int i_2 = 0; i_2 < PB_M; i_2++) {
                for (int i_3 = 0; i_3 < PB_Q; i_3++) {
                    A[i_0][i_3][i_0][i_2] = E[i_2][i_0][i_1][i_3] - 5;
                }
            }
        }
    }
        ...
        for (int i_5 = 2; i_5 < PB_M; i_5++) {
            for (int i_6 = 0; i_6 < PB_M; i_6++) {
                for (int i_7 = 2; i_7 < i_4; i_7++) {
                    A[i_4][i_5][i_4][i_6] = F[i_5][i_6][i_4][i_7-2] - 1;
                }
            }
            C[i_5-1] = C[i_5-2] - 1;
        }
        for (int i_8 = max(i_4, 2); i_8 < PB_Q+1; i_8++) {
            for (int i_9 = 1; i_9 < PB_L+1; i_9++) {
                for (int j_0 = 0; j_0 < PB_P-1; j_0++) {
                    D[i_4][i_9-1][j_0][i_8-2] = D[i_4][i_9-1][j_0+1][i_8-1] + 5;
                }
            }
        }
    }
...
kernel_4414312113_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
