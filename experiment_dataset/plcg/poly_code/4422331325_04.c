...
void kernel_4422331325_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj)){
        ...
        for (int i_1 = i_0; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 1; i_2 < i_0; i_2++) {
                for (int i_3 = 0; i_3 < -i_2+PB_Q; i_3++) {
                    A[i_2][i_3][i_1][i_0+1] = E[i_0+1][i_1+1][i_3+i_2][i_2] * A[i_2][i_0-1][i_1][i_3+1] * A[i_2-1][i_3][i_1][i_0+1] - A[i_2][i_3][i_1][i_0+3] + 3;
                }
            }
        }
    }
        ...
        for (int i_5 = 2; i_5 < min(i_4, -i_4+PB_M-1); i_5++) {
            for (int i_6 = 1; i_6 < -i_4+PB_L; i_6++) {
                for (int i_7 = 0; i_7 < -i_6+PB_L; i_7++) {
                    C[i_5+i_4+1][i_6][i_7][i_7] = F[i_4+1][i_5+1][i_7][i_6-1] - G[i_5-1][i_7+i_6][i_5][i_4] + E[i_7][i_6+i_4][i_7][i_5] - 1;
                }
            }
            for (int i_8 = 1; i_8 < min(PB_Q-1, -i_4+PB_M); i_8++) {
                for (int i_9 = 1; i_9 < PB_M-1; i_9++) {
                    C[i_5+i_4][i_8][i_9][i_9] = H[i_9][i_8][i_4][i_5][i_5-1] * F[i_9][i_5][i_4][i_8+1] * G[i_9+1][i_5-1][i_4][i_9+1] - G[i_5-1][i_8][i_5][i_4] + E[i_8][i_5][i_9+1][0] + G[i_5+1][i_8-1][i_4][i_9-1] - C[i_8+i_4][i_5][i_9-1][i_9-1] - 6;
                }
            }
            D[i_5-1] = I[i_5][i_4] + J[i_4][i_5] + D[i_5+1] * D[i_5] + D[i_5-2] * 6;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4422331325_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J)));
