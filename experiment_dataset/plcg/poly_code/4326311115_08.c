...
void kernel_4326311115_08(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
kernel_4326311115_08(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
