...
void kernel_3424332223_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 4; i_0 < PB_M-2; i_0++) {
        A[i_0] = E[i_0] + F[i_0] - E[i_0-1] + E[i_0-1] - 4;
        for (int i_1 = 2; i_1 < -i_0+PB_M-2; i_1++) {
            D[i_0-4][i_1+i_0+2] = G[i_1+i_0][0] + H[i_1] + D[i_1-2][i_1+i_0+2] - 1;
            for (int i_2 = 2; i_2 < -i_1+PB_M-1; i_2++) {
                D[i_2-2][i_2+i_1+1] = I[i_0][i_2][i_1] * G[i_2-2][i_1] - 4;
            }
        }
    }
    for (int i_3 = 0; i_3 < PB_M-4; i_3++) {
        for (int i_4 = max(4, i_3); i_4 < -i_3+PB_M-4; i_4++) {
            D[i_4-2][i_4+i_3+2] = G[i_3][i_3] * G[i_4+i_3][i_4-1] * J[i_4+i_3][0] - D[i_4-2][i_4+i_3+4] - D[i_4-4][i_4+i_3] - 4;
        }
    }
#pragma endscop
...
init_array(xa,POLYBENCH_ARRAY(A), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_3424332223_05(xa,POLYBENCH_ARRAY(A), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J)));
