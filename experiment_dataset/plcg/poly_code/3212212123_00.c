...
void kernel_3212212123_00(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 4; i_1 < PB_M; i_1++) {
            ...
            for (int i_3 = 1; i_3 < min(-i_1+PB_M, -i_0+PB_M-2); i_3++) {
                B[i_3+i_1][i_0-2] = C[i_1][i_3-1][i_1] - D[i_1-1][i_3][i_0+2] * B[i_3+i_0+2][i_1-2] * 5;
            }
        }
    }
#pragma endscop
...
kernel_3212212123_00(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
