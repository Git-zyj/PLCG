...
void kernel_4326232323_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
    ...
    for (int i_1 = 0; i_1 < PB_M-2; i_1++) {
        for (int i_2 = max(1, i_1); i_2 < PB_N; i_2++) {
            for (int i_3 = 2; i_3 < min(-i_2+PB_L+1, PB_M); i_3++) {
                C[i_1+2][i_2][i_3] = F[i_2][i_3-2] + G[i_1][i_3+i_2-1][0] + G[i_3][i_1][i_2+1] - 1;
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-2; i_4++) {
        for (int i_5 = 1; i_5 < PB_P-2; i_5++) {
            for (int i_6 = i_5; i_6 < -i_5+PB_P-2; i_6++) {
                C[i_4][i_5][i_6] = H[i_4-2][i_6-1][i_5] - H[i_4][i_6+i_5+2][i_4-1] * H[i_5][i_4][i_6+i_5] + G[i_6][i_5][i_4] + C[i_4][i_5][i_6+1] * C[i_4][i_5][i_6+2] * C[i_4][i_5-1][i_6] + C[i_4+2][i_5+1][i_6] + C[i_4+2][i_6][i_5] + 2;
            }
        }
    }
#pragma endscop
...
kernel_4326232323_06(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
