...
void kernel_4222311323_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 1; i_1 < min(PB_P-2, -i_0+PB_N); i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_N, i_1); i_2++) {
                for (int i_3 = 1; i_3 < -i_2+PB_N+1; i_3++) {
                    A[i_2+i_0][i_1][i_2][i_1] = C[i_3-1][i_0+1][i_1+1][i_2+i_1-1] * A[i_3+i_2-1][i_1][i_2+1][i_1] - A[i_1+i_0][i_2+1][i_1][i_2+1] + 5;
                }
                for (int i_4 = 1; i_4 < PB_L+1; i_4++) {
                    A[i_2+i_0-1][i_1+2][i_2][i_1+2] = D[i_1+1][i_2-1][i_4-1] + A[i_2+i_0-2][i_1+1][i_2][i_1+1] - 1;
                }
            }
        }
    }
...
kernel_4222311323_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
