...
void kernel_3312311315_08(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
kernel_3312311315_08(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
