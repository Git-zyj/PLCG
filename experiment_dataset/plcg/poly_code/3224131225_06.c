...
void kernel_3224131225_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        B[i_0] = C[i_0] - C[i_0] + C[i_0] - C[0] * 5;
    }
...
kernel_3224131225_06(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
