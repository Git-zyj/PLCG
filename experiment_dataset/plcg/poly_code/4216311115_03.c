...
void kernel_4216311115_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_4 = 1; i_4 < PB_Q-1; i_4++) {
        for (int i_5 = 1; i_5 < min(i_4, -i_4+PB_Q); i_5++) {
            for (int i_6 = 1; i_6 < PB_L; i_6++) {
                B[i_6][i_4][i_5] = C[i_6][i_5][i_4+1] - C[i_6][i_4][i_5+i_4] + B[i_6][i_4-1][i_5-1] + B[i_6-1][i_4-1][i_5] + 5;
            }
        }
    }
#pragma endscop
...
kernel_4216311115_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
