...
void kernel_4422351315_08(int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = max(2, i_0); i_2 < PB_M; i_2++) {
                for (int i_3 = 0; i_3 < PB_M; i_3++) {
                    D[i_1+1][0][i_3][i_0+1] = E[i_1+i_0][i_2-1][i_3][0] - F[i_3][i_0][i_1][i_2] - F[i_2][i_3+i_1-1][i_0][i_3+1] - G[i_0][i_2][i_3][0] * D[i_3][0][i_2-2][i_0+1] * 1;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_M; i_4++) {
            for (int i_5 = 1; i_5 < min(-i_0+PB_L, -i_4+PB_P); i_5++) {
                for (int i_6 = 1; i_6 < PB_M; i_6++) {
                    B[i_4][i_6][i_5][0] = G[i_6][i_0-1][i_0][i_5+i_4] * F[i_4][i_0][i_6][i_6] - H[i_6-1][i_4][i_5-1] * I[i_5+i_0][i_4][i_6] - B[i_5-1][i_4][i_6-1][0] - B[i_4-1][i_6][i_5][0] - 6;
                }
            }
        }
        C[i_0-1] = J[i_0] - K[i_0-1] + L[i_0] - L[i_0] * L[i_0] * J[i_0+1] * K[i_0] + C[i_0] - 2;
    }
    for (int i_7 = 1; i_7 < PB_M; i_7++) {
        for (int i_8 = 0; i_8 < PB_M; i_8++) {
            for (int i_9 = 1; i_9 < PB_M; i_9++) {
                for (int j_0 = 1; j_0 < min(min(-i_7+PB_P, -i_9+PB_Q), PB_N-1); j_0++) {
                    D[j_0][0][i_9-1][i_7] = F[i_8][j_0-1][j_0][i_7] * F[i_8][j_0][i_7][j_0+i_9] - F[i_8][i_7-1][j_0+i_7][i_9] * E[i_7][j_0][i_8+1][i_9] - D[j_0-1][0][i_9][i_7] - D[j_0-1][0][i_9-1][i_8] * D[j_0+1][0][i_9][i_7] + 5;
                }
            }
        }
    }
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4422351315_08(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L)));
