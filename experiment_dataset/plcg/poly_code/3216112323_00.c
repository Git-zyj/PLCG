...
void kernel_3216112323_00(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_2 = 0; i_2 < PB_P-1; i_2++) {
        for (int i_3 = 2; i_3 < PB_P; i_3++) {
            for (int i_4 = i_3; i_4 < PB_L-2; i_4++) {
                B[i_2][i_3][i_2] = C[i_4+2][i_2+2][i_3] - B[i_2][i_3+2][i_2] - B[i_2][i_3-2][i_2] * B[i_2+1][i_4][i_2+1] * 4;
            }
        }
    }
#pragma endscop
...
kernel_3216112323_00(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
