...
void kernel_2332352115_06(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        C[i_0-1] = D[i_0] + E[i_0-2] * 6;
        for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
            C[i_1-1] = F[i_1-2][i_0-1] * G[i_1+1][i_1] + G[i_0][i_1] * H[i_0][i_1+2] - 3;
        }
    }
    for (int i_2 = 2; i_2 < PB_M-2; i_2++) {
        C[i_2] = D[i_2+2] - D[i_2-2] + D[i_2] - D[i_2-2] * D[i_2] + E[0] * I[i_2] - D[i_2] * C[i_2-1] - 3;
    }
#pragma endscop
...
kernel_2332352115_06(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
