...
void kernel_2332311325_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-2; i_0++) {
        B[i_0+2] = B[i_0] - B[i_0-1] + 3;
...
kernel_2332311325_05(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
