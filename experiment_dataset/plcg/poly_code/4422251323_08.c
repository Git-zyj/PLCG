        ...
        for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 1; i_2 < min(PB_Q, -i_1+PB_M+1); i_2++) {
                for (int i_3 = 2; i_3 < PB_P-1; i_3++) {
                    A[i_0][i_3][i_1-1][i_0] = E[i_3][i_0][i_1-1][i_2] - F[i_1][i_3+1][i_2-1][i_1+1] * G[i_3][i_1-1][i_2] * F[i_0][i_2][i_1][i_3] * F[i_2+i_1-1][i_0][i_3][i_0+1] + A[i_0-2][i_1][i_3-2][i_0-2] + A[i_0][i_1+1][i_3+1][i_0] - 5;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L-2; i_4++) {
        B[i_4-1][i_4] = H[i_4] - I[i_4] + I[i_4] - H[i_4+1] + B[i_4+1][i_4+2] * 1;
        for (int i_5 = 1; i_5 < PB_P; i_5++) {
            C[i_5-1][i_4] = J[i_5][i_4] - K[i_4-1][i_5] + I[i_5] - J[i_5-1][0] - I[i_4] + K[i_5][i_4] * C[i_5-1][i_4+1] * C[i_5+1][i_4] - C[i_5-1][i_4-2] - C[i_5-1][i_4+2] - 5;
        }
    }
        ...
        for (int i_7 = 0; i_7 < i_6; i_7++) {
            for (int i_8 = 1; i_8 < PB_P; i_8++) {
                for (int i_9 = 1; i_9 < min(-i_7+PB_L, PB_L-1); i_9++) {
                    D[i_9][i_6+1][i_8][i_6] = L[i_9][i_9+1][i_7] + F[i_8][i_9+1][i_6][i_7] + F[i_9+1][i_8][i_6+1][i_9+i_7] + E[i_8-1][i_6][i_9][1] - D[i_9][i_6+3][i_8][i_6+2] * D[i_9-1][i_6+2][i_8][i_6+1] * 1;
                }
            }
        }
    }
