...
void kernel_2234112113_06(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 3; i_1 < PB_L; i_1++) {
            A[i_1-2][i_1] = C[i_0][i_1] + 6;
            A[i_1-2][i_1] = A[i_1-3][i_1-1] + 3;
        }
    }
#pragma endscop
...
kernel_2234112113_06(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C));
