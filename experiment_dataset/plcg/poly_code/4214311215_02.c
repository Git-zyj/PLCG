...
void kernel_4214311215_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_2 = max(1, i_1); i_2 < PB_M-2; i_2++) {
            for (int i_3 = 2; i_3 < PB_L-1; i_3++) {
                for (int i_4 = 2; i_4 < min(-i_3+PB_M+1, -i_2+PB_M-2); i_4++) {
                    B[i_4+i_2][i_1][i_2-1] = C[i_3][i_1+1][i_2+1] - B[i_4+i_3-1][i_2+1][i_4-2] * B[i_4+i_3-1][i_2][i_3-2] * B[i_4+i_2+2][i_3+1][i_2] - 4;
                }
            }
        }
    }
...
kernel_4214311215_02(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
