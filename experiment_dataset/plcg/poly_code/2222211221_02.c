...
void kernel_2222211221_02(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < -i_0+PB_M; i_1++) {
            A[i_0-1][i_1+i_0-1] = C[i_1+i_0] + A[i_0-1][i_1+i_0-2] - A[i_0-1][i_1+i_0-3] + A[i_0][i_1+i_0-1] + A[i_0-3][i_1+i_0-3] + 3;
        }
    }
...
kernel_2222211221_02(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
