...
void kernel_4216112121_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
        ...
        for (int i_1 = i_0; i_1 < PB_M; i_1++) {
            for (int i_2 = 1; i_2 < min(PB_P+1, i_0); i_2++) {
                for (int i_3 = i_2; i_3 < PB_P; i_3++) {
                    A[i_1][i_0-2][i_3] = A[i_0-2][i_1-2][i_3] + A[i_3][i_1-2][i_2-1] - 2;
                }
            }
        }
    }
...
kernel_4216112121_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
