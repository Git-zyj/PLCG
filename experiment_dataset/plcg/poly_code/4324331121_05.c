...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_N-1; i_1++) {
        B[i_1] = D[i_1-1] + E[i_1+1] + F[i_1] - D[i_1+1] * B[i_1-2] - B[i_1+1] - 1;
        for (int i_2 = 1; i_2 < i_1; i_2++) {
            for (int i_3 = 2; i_3 < -i_2+PB_M; i_3++) {
                C[i_1+1][i_3][i_3-1] = G[i_3+i_2][i_1-1][i_2] * H[i_3-1][i_1][i_2+1] * H[i_1-1][i_3][i_3+i_2-1] * C[i_1-1][i_3-1][i_3-2] - 4;
            }
        }
    }
#pragma endscop
...
kernel_4324331121_05(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
