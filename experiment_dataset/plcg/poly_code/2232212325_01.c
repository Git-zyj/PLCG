...
void kernel_2232212325_01(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    ...
    for (int i_2 = 0; i_2 < PB_M-2; i_2++) {
        for (int i_3 = 3; i_3 < -i_2+PB_M-2; i_3++) {
            B[i_3-1] = C[i_3+i_2+2][i_2] * C[i_3+i_2][0] - B[i_3+1] * B[i_3-3] * B[i_3-2] * 4;
        }
    }
#pragma endscop
...
kernel_2232212325_01(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
