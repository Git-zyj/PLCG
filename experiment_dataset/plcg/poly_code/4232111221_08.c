...
void kernel_4232111221_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 1; i_1 < PB_P; i_1++) {
            for (int i_2 = i_0; i_2 < PB_P; i_2++) {
                for (int i_3 = 0; i_3 < PB_L; i_3++) {
                    A[i_1-1][i_2][i_3] = A[i_3][i_0-1][i_1] + 5;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M; i_4++) {
        for (int i_5 = 0; i_5 < PB_L-1; i_5++) {
            for (int i_6 = 2; i_6 < PB_L-2; i_6++) {
                B[i_6][i_5][1] = C[i_4][i_6][i_5] + C[i_6-1][1][i_5] * B[i_6][i_5+1][1] - B[i_6-2][i_5][1] * B[i_6+2][i_4-1][1] * 3;
            }
        }
    }
#pragma endscop
...
kernel_4232111221_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
