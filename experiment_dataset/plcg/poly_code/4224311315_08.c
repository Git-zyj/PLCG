...
void kernel_4224311315_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_N-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_M; i_3++) {
                    A[i_2+i_1][i_3][i_2] = A[i_2+i_1-1][i_3][i_1] * A[i_2+i_1][i_3][i_2-1] - A[i_2+i_1][i_3-1][i_1+1] - A[i_2+i_1-1][i_0][i_2] + A[i_2+i_1+1][i_0][i_2] * 3;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_L-2; i_4++) {
        B[i_4][i_4+1] = C[i_4] + B[i_4+1][i_4+2] + 4;
    }
#pragma endscop
...
kernel_4224311315_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
