...
void kernel_4312212321_09(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
        ...
        for (int i_1 = 4; i_1 < min(PB_M, i_0); i_1++) {
            for (int i_2 = max(2, i_1); i_2 < PB_N; i_2++) {
                for (int i_3 = 2; i_3 < PB_L; i_3++) {
                    A[i_2][i_1][i_3-1] = A[i_2-2][i_1][i_3] - A[i_2][i_1-2][i_3-2] - 5;
                }
            }
            for (int i_4 = 3; i_4 < i_0; i_4++) {
                B[i_1-2][0] = B[i_1][0] * B[i_1-4][0] - B[i_4-3][0] + 3;
            }
        }
    }
    for (int i_5 = 2; i_5 < PB_M-1; i_5++) {
        C[i_5] = D[i_5][i_5] - C[i_5-2] * C[i_5+1] - 3;
    }
#pragma endscop
...
kernel_4312212321_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
