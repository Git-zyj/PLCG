...
void kernel_4222211225_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_L-3; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_1+PB_L-1, -i_0+PB_L-1); i_2++) {
                for (int i_3 = 1; i_3 < PB_P-1; i_3++) {
                    A[i_0][i_1-1][i_3-1][i_2] = C[i_1][i_3+1][i_2] - B[i_3-1][i_2+i_0+1] + B[i_3][i_1+i_0+3] + B[i_3-1][i_2+i_1+1] - 3;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 1; i_5 < -i_4+PB_L+2; i_5++) {
            for (int i_6 = 1; i_6 < -i_4+PB_L-1; i_6++) {
                B[i_5-1][i_6+i_4+1] = B[i_6-1][i_5+i_4-2] * 2;
            }
        }
    }
#pragma endscop
...
kernel_4222211225_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
