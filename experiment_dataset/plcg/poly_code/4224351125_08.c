...
void kernel_4224351125_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
        ...
        for (int i_1 = 4; i_1 < -i_0+PB_L; i_1++) {
            for (int i_2 = i_0; i_2 < -i_1+PB_L; i_2++) {
                for (int i_3 = 1; i_3 < -i_1+PB_Q; i_3++) {
                    A[i_3+1][i_2][i_0+1][i_1+1] = C[i_3+i_1][i_0][i_2][i_3+i_1] + D[i_3-1][i_0-1][i_1][i_1-1] + D[i_2+i_1][i_3+1][i_0][0] + E[i_3][i_2+1][i_1+i_0][0] * A[i_3][i_2][i_0-1][i_1+1] + 2;
                }
            }
            for (int i_4 = i_1; i_4 < -i_1+PB_L; i_4++) {
                B[i_4+i_1-1][i_0-1][i_4] = F[i_0-1][i_4+i_1] - G[i_1][i_0][i_4+i_1-1] + G[i_0][i_4+1][i_4+1] + G[i_4][i_1+i_0][i_1] + H[i_1][i_0][i_1] - B[i_4+i_1-4][i_0-1][i_1-1] * 1;
            }
        }
    }
#pragma endscop
...
kernel_4224351125_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
