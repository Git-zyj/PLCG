...
void kernel_4234212111_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        ...
        for (int i_3 = 0; i_3 < PB_P-1; i_3++) {
            for (int i_4 = i_3; i_4 < -i_3+PB_P-1; i_4++) {
                A[i_0][i_4+i_3+1][i_0] = C[i_0][i_4][i_3] + 4;
            }
        }
    }
#pragma endscop
...
kernel_4234212111_08(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C));
