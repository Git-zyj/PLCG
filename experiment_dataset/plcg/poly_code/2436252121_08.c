...
void kernel_2436252121_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        A[i_0] = E[i_0-1] * F[i_0-2] - E[i_0] * F[i_0] - G[i_0][i_0] + F[i_0] + A[i_0+2] * 4;
        A[i_0] = E[i_0] + F[i_0+2] * E[i_0] + E[i_0] + 6;
        for (int i_1 = i_0; i_1 < -i_0+PB_L; i_1++) {
            D[i_0][i_1-1][i_1-1] = H[i_1][i_1-2] * H[i_1][i_0] * H[i_1+i_0][i_0+1] * G[i_1-1][i_0] + E[i_0] * 6;
            D[i_1][i_0][i_0] = I[i_0-2][i_1-2][i_1+2] - F[i_1-2] + G[i_1-1][i_0-2] + 1;
        }
    }
#pragma endscop
...
kernel_2436252121_08(xa,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
