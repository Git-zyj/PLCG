        ...
        for (int i_6 = 0; i_6 < min(i_5, PB_L-1); i_6++) {
            for (int i_7 = 0; i_7 < PB_P; i_7++) {
                for (int i_8 = 0; i_8 < PB_P-1; i_8++) {
                    D[i_5][i_6+1][i_7][i_8+1] = 3;
                }
            }
        }
    }
    for (int i_9 = 0; i_9 < PB_Q-1; i_9++) {
        for (int j_0 = i_9; j_0 < PB_L-1; j_0++) {
            for (int j_1 = 0; j_1 < PB_P-1; j_1++) {
                for (int j_2 = 0; j_2 < PB_P; j_2++) {
                    D[i_9][j_0+1][j_1][j_2] = F[j_1][j_2][i_9+1][j_0] - D[i_9][j_0+1][j_1+1][j_2] + 5;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), INIT_SEED);
kernel_4426112125_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F)));
