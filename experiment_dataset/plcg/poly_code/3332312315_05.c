...
void kernel_3332312315_05(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_P; i_0++) {
        for (int i_1 = 0; i_1 < PB_M; i_1++) {
            for (int i_2 = 1; i_2 < PB_L+1; i_2++) {
                A[i_1][i_2-1] = D[i_2][0] + 1;
            }
        }
    }
    ...
    for (int i_5 = 1; i_5 < PB_L-1; i_5++) {
        for (int i_6 = 1; i_6 < min(-i_5+PB_M-1, PB_L-1); i_6++) {
            for (int i_7 = 0; i_7 < min(min(-i_6+PB_M, -i_5+PB_M-1), PB_L-1); i_7++) {
                C[i_7+i_6][i_5+1] = C[i_7+i_5][i_6] + C[i_6+i_5+1][i_7+1] * C[i_7+i_6-1][i_5+1] - C[i_7+i_5-1][i_6+1] - C[i_7+i_5+1][i_6+1] * 4;
            }
        }
    }
#pragma endscop
...
kernel_3332312315_05(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
