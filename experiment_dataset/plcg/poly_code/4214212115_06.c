...
void kernel_4214212115_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
        ...
        for (int i_1 = 2; i_1 < PB_M+1; i_1++) {
            for (int i_2 = 0; i_2 < min(PB_Q-1, i_0); i_2++) {
                for (int i_3 = i_1; i_3 < PB_M-1; i_3++) {
                    A[i_1-1][i_3][i_1-2] = C[i_1][i_3][i_0][i_2+1] + A[i_1-1][i_3+1][i_1-2] - 6;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < PB_L; i_5++) {
            for (int i_6 = i_4; i_6 < PB_L; i_6++) {
                for (int i_7 = 1; i_7 < PB_M; i_7++) {
                    B[i_7][i_4+1][i_6][i_4] = B[i_7-1][i_4+1][i_6][i_4] + 5;
                }
            }
        }
    }
...
kernel_4214212115_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
