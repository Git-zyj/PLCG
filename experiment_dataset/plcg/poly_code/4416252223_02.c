        ...
        for (int i_4 = 1; i_4 < i_0; i_4++) {
            for (int i_5 = 0; i_5 < PB_L; i_5++) {
                for (int i_6 = 0; i_6 < min(-i_0+PB_M, -i_4+PB_M); i_6++) {
                    B[i_5][i_6+i_4][i_4-1][i_0] = G[i_0+2][i_5][i_6][i_4] * E[i_4][i_6+i_0][i_5][i_0] * 6;
                }
            }
        }
    }
    for (int i_7 = 2; i_7 < PB_L-1; i_7++) {
        for (int i_8 = 2; i_8 < PB_L; i_8++) {
            for (int i_9 = i_7; i_9 < PB_L; i_9++) {
                for (int j_0 = 2; j_0 < min(-i_8+PB_L, i_9); j_0++) {
                    B[i_9][j_0+i_8][j_0-1][i_7] = H[i_9][i_8-2][j_0+2] * G[j_0+2][i_8][i_9][i_7] * F[i_8-1][j_0-1][0] * E[j_0-2][i_7][i_9][i_8] * E[i_9+1][i_8][i_7+1][2] - G[i_9][i_7][j_0+i_8][i_8] - 2;
                }
            }
        }
        D[i_7] = I[i_7] - J[i_7] - J[i_7-1] * I[i_7] * I[i_7+2] + I[i_7] + D[i_7-2] - D[i_7-1] - D[i_7+1] + D[i_7+2] + 3;
    }
#pragma endscop
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4416252223_02(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J)));
