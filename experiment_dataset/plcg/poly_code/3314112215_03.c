...
void kernel_3314112215_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        B[i_0] = D[i_0+1] * 4;
        B[i_0] = 3;
        B[i_0-1] = D[i_0-1] + B[i_0-1] * B[i_0] - 1;
    }
#pragma endscop
...
kernel_3314112215_03(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
