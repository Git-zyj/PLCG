...
void kernel_2334131123_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        B[i_0-1] = D[0] + D[i_0] - D[i_0] * D[i_0-1] * 4;
    }
    for (int i_1 = 3; i_1 < PB_L; i_1++) {
        B[i_1-1] = D[i_1] + D[i_1] * D[i_1] * B[i_1-3] * 3;
        B[i_1-3] = D[i_1] * D[i_1-1] * 3;
    }
#pragma endscop
...
kernel_2334131123_09(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
