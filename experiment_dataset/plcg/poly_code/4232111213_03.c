...
void kernel_4232111213_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 0; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 2; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 0; i_3 < PB_M-1; i_3++) {
                    A[i_1][i_2][i_0-1][i_3] = C[i_3+1][i_2+1][i_3] + A[i_1+1][i_2+1][i_0-1][i_3] - A[i_1+1][i_0][i_2-2][i_3] * 6;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_P; i_4++) {
        for (int i_5 = 2; i_5 < PB_P+1; i_5++) {
            for (int i_6 = 0; i_6 < PB_L-1; i_6++) {
                B[i_6][i_5-1] = B[i_6+1][i_5-2] - B[i_6+1][i_5-1] + 4;
            }
        }
    }
#pragma endscop
...
kernel_4232111213_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
