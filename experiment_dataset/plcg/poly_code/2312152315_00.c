...
void kernel_2312152315_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-3; i_0++) {
        B[i_0+2] = D[i_0-1] + D[i_0-2] - D[i_0] + D[i_0] + D[i_0] + B[i_0+2] * 6;
        B[i_0+2] = D[i_0] - D[i_0+2] * D[i_0] - B[i_0+3] + 4;
    }
    for (int i_1 = 0; i_1 < PB_M-2; i_1++) {
        B[i_1+1] = D[i_1] + D[i_1] * D[i_1] * D[i_1] - D[i_1+1] + B[i_1+2] - 4;
    }
#pragma endscop
...
kernel_2312152315_00(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
