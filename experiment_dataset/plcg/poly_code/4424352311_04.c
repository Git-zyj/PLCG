...
void kernel_4424352311_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,int zk,int vk,DATA_TYPE POLYBENCH_4D(K,xK,yK,zK,vK,xk,yk,zk,vk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl),int xm,int ym,int zm,int vm,int wm,DATA_TYPE POLYBENCH_5D(M,xM,yM,zM,vM,wM,xm,ym,zm,vm,wm),int xn,DATA_TYPE POLYBENCH_1D(N,xN,xn)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 2; i_1 < PB_L-1; i_1++) {
            A[i_0][i_1] = E[i_0-2] + F[i_1] - G[i_1-2][i_0] * A[i_0-1][i_1-1] - A[i_0-1][i_1] * A[i_0][i_1-1] + A[i_0+1][i_1+1] + 3;
            for (int i_2 = i_0; i_2 < -i_0+PB_N; i_2++) {
                for (int i_3 = 3; i_3 < PB_L; i_3++) {
                    B[i_3-2][i_0][i_2+1][i_0] = H[i_3][i_2+i_0-2][i_1][i_2] - I[i_2+i_0][i_1][i_3] + J[i_2+i_0][i_1][i_1-2][i_2+1] + J[i_2][i_1][i_0][i_3] * K[i_1][i_2+i_0-2][i_3][i_1] - B[i_1-2][i_3-1][i_2+1][i_3-1] * B[i_3-1][i_0][i_2+2][i_0] * B[i_3-1][i_0][i_2+1][i_0] + B[i_3-2][i_0-1][i_2+1][i_0-1] * B[i_3-3][i_0][i_2+1][i_0] + 1;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_L; i_4++) {
            for (int i_5 = 2; i_5 < min(PB_L, -i_4+PB_M); i_5++) {
                for (int i_6 = 1; i_6 < -i_0+PB_L; i_6++) {
                    C[i_6][i_6+i_5][i_0][i_4] = J[i_6+i_5][i_0][i_4][i_4] - K[i_5-2][i_4][i_0][i_6] * I[i_5+i_4][i_6+2][i_0+2] - L[i_0-2][i_5][0] * K[i_6+2][i_0][i_5][i_4] + M[i_0+1][i_5][i_4][i_4-1][0] - K[i_5][i_6][i_0+1][i_4-1] + K[i_6][i_6+i_0][i_6+i_5][i_4] * C[i_6][i_6+i_5-1][i_0][i_4] - C[i_6-1][i_6+i_5-1][i_4-1][i_0-1] + 1;
                }
            }
        }
    }
    for (int i_7 = 2; i_7 < PB_M-1; i_7++) {
        D[i_7] = N[i_7+1] * F[i_7-2] - D[i_7-1] - 2;
    }
#pragma endscop
...
init_array(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,zm,vm,wm,POLYBENCH_ARRAY(M), xn,POLYBENCH_ARRAY(N), INIT_SEED);
kernel_4424352311_04(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,zm,vm,wm,POLYBENCH_ARRAY(M), xn,POLYBENCH_ARRAY(N));
polybench_prevent_dce(print_array(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,zm,vm,wm,POLYBENCH_ARRAY(M), xn,POLYBENCH_ARRAY(N)));
