...
void kernel_2336131125_08(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_N-1; i_1++) {
        B[i_1] = D[i_1] * D[i_1] + D[i_1-1] * D[i_1-1] - D[1] + D[i_1] - B[i_1+1] + 2;
    }
    for (int i_2 = 0; i_2 < PB_N-1; i_2++) {
        B[i_2+1] = D[0] + D[i_2] + D[i_2] + 6;
    }
#pragma endscop
...
kernel_2336131125_08(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
