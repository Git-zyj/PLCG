...
void kernel_4212152115_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 1; i_1 < PB_P; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_Q; i_2++) {
                for (int i_3 = 1; i_3 < PB_P-2; i_3++) {
                    A[i_3][i_2][i_1][i_0] = C[i_2][i_3-1][i_0-2][i_1] - C[i_2-1][i_3][i_2][i_1] * C[i_3][i_3+2][i_0][i_2+i_1] * D[i_1][i_3][0] - A[i_0][i_2][i_1-1][i_3] + 6;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < PB_Q-2; i_5++) {
            for (int i_6 = i_4; i_6 < min(-i_5+PB_Q, -i_4+PB_P); i_6++) {
                for (int i_7 = 0; i_7 < PB_M-1; i_7++) {
                    A[i_7+1][i_5][i_6][i_4+1] = C[i_7][i_4][i_6+i_5][0] - C[i_6][i_7][i_4][i_5-1] * C[i_6][i_5][i_4-2][i_7] + C[i_6][i_4+1][i_7+1][i_5+2] + D[i_5][i_7][i_6+i_4] * 2;
                }
            }
        }
    }
...
kernel_4212152115_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
