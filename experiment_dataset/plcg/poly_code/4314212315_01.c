...
void kernel_4314212315_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N-3; i_0++) {
        for (int i_1 = max(1, i_0); i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-1; i_2++) {
                A[i_1+1][i_2+2][i_1] = D[i_0][i_2+1][i_1] + D[i_2][i_0][2] - A[i_1+1][i_2+1][i_1] + A[i_2+2][i_0+2][i_2+1] - A[i_1][i_2+2][i_1-1] + 4;
            }
        }
        for (int i_3 = 1; i_3 < PB_L-1; i_3++) {
            ...
            for (int i_4 = 0; i_4 < PB_M; i_4++) {
                for (int i_5 = 0; i_5 < i_0; i_5++) {
                    A[i_3+1][i_5+3][i_3] = D[i_4][i_3+1][i_0] - 1;
                }
            }
        }
    }
...
kernel_4314212315_01(xa,ya,za,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D));
