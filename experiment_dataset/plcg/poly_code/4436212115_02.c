    ...
    for (int i_2 = 0; i_2 < PB_M; i_2++) {
        for (int i_3 = 0; i_3 < PB_M; i_3++) {
            ...
            for (int i_4 = 0; i_4 < min(PB_M, -i_3+PB_L-1); i_4++) {
                D[i_2][i_4+i_3][1] = G[i_4][i_2][0] * G[i_4][i_3][i_2] + D[i_2][i_4+i_3+1][1] * 1;
            }
        }
    }
#pragma endscop
...
kernel_4436212115_02(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
