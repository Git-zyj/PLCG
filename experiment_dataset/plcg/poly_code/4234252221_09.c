    ...
    for (int i_3 = 3; i_3 < PB_P-2; i_3++) {
        for (int i_4 = 1; i_4 < i_3; i_4++) {
            for (int i_5 = 0; i_5 < min(-i_3+PB_P, -i_4+PB_M); i_5++) {
                B[i_5+i_3+2][i_4-1][i_3-1] = D[i_5][i_5+i_3][i_4] * E[i_5+i_4][i_4] - D[i_5][i_3+2][i_5+i_4] - C[i_4][i_5+1][i_3+2] - B[i_5+i_3][i_4-1][i_3-3] * B[i_5+i_3+4][i_4-1][i_5+1] * B[i_5+i_3+1][i_4-1][i_3-2] - 5;
            }
        }
    }
#pragma endscop
...
kernel_4234252221_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
