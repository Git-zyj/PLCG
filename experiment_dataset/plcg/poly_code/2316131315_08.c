...
void kernel_2316131315_08(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        B[i_0] = D[i_0] + D[i_0] + D[i_0+1] - D[i_0] + D[i_0-1] * D[i_0] - B[i_0] - B[i_0-1] - 6;
...
kernel_2316131315_08(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
