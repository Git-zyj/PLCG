        ...
        for (int i_2 = max(1, i_1); i_2 < PB_P; i_2++) {
            for (int i_3 = 2; i_3 < PB_P; i_3++) {
                for (int i_4 = max(2, i_2); i_4 < PB_P; i_4++) {
                    B[i_1+1][i_2+1][i_4+1][0] = E[i_2][i_3-2][i_1][i_2] * F[i_4-2][i_2-1][i_4-2][i_1] * B[i_1+1][i_2+1][i_3][0] * 4;
                }
                for (int i_5 = 2; i_5 < -i_3+PB_P+2; i_5++) {
                    B[i_1][i_3+1][i_5+2][0] = E[i_3-2][i_1][i_2][i_5] - G[i_3+1][i_2+1][i_5] - E[i_2][i_5-2][i_1][i_3] + E[i_2][i_1][i_5+i_3-2][1] + 4;
                }
            }
        }
    }
...
kernel_4316232215_07(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
