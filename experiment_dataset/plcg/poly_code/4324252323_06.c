        ...
        for (int i_1 = 2; i_1 < min(i_0, PB_L-1); i_1++) {
            for (int i_2 = 2; i_2 < -i_1+PB_L-1; i_2++) {
                for (int i_3 = 2; i_3 < i_2; i_3++) {
                    A[i_3][i_1][i_2+i_1][i_0] = D[i_3][i_2][i_1][i_0+1] - D[0][i_2][i_0][i_3-2] - E[i_3-2][i_1-2][i_2-2] * F[i_3-2][i_2][i_1] + E[i_3][i_1][i_2] * D[i_1][i_3][i_0-2][i_2-1] * G[i_1+1][i_2][i_1-1][i_3+2] - G[i_1][i_2][i_3+2][i_0] - A[i_0][i_1+1][i_2+i_1+1][i_3] - 2;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 0; i_5 < min(PB_M-4, -i_4+PB_P); i_5++) {
            B[i_5+2] = H[i_5+1][i_4] + I[i_5][i_5+i_4] * B[i_5+4] - 5;
        }
        for (int i_6 = 3; i_6 < PB_N-2; i_6++) {
            for (int i_7 = 2; i_7 < min(-i_4+PB_L+1, -i_6+PB_L+3); i_7++) {
                for (int i_8 = 0; i_8 < min(-i_6+PB_L, -i_4+PB_L-2); i_8++) {
                    C[i_4][i_6][i_8+i_7-2][i_4] = D[i_7-2][i_8+i_6][i_8+i_4][0] - G[i_8+i_7-1][i_4][i_8][i_6] - E[i_8+1][i_6][i_4] * E[i_4][i_8+i_6][i_7] * C[i_4-1][i_7][i_8+i_6-1][i_4-1] * C[i_6][i_8][i_7+i_4-1][i_6] - C[i_4+1][i_6+2][i_8+i_7][i_4+1] - C[i_8][i_4+2][i_7+i_6-3][i_8] * C[i_7][i_6+2][i_8+i_4+2][i_7] - 2;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4324252323_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I)));
