...
void kernel_2222132125_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P-2; i_0++) {
        A[i_0-2][i_0] = C[i_0] + C[i_0+1] + C[i_0] * C[i_0-2] * C[i_0] * A[i_0][i_0+2] - 5;
    }
    for (int i_1 = 2; i_1 < PB_P; i_1++) {
        B[i_1-2] = C[i_1+2] + A[i_1-2][i_1] - 1;
    }
#pragma endscop
...
kernel_2222132125_04(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
