...
void kernel_3316212125_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_5 = 3; i_5 < PB_M-1; i_5++) {
        C[i_5-1] = D[i_5] + C[i_5-3] + C[i_5+1] - 1;
    }
#pragma endscop
...
kernel_3316212125_04(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
