...
void kernel_4216111225_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
        ...
        for (int i_1 = 1; i_1 < min(i_0, -i_0+PB_L-1); i_1++) {
            for (int i_2 = 0; i_2 < PB_P-2; i_2++) {
                for (int i_3 = 0; i_3 < PB_L-2; i_3++) {
                    A[i_2][i_1][i_3] = A[i_3][i_2+2][i_1] * A[i_3+2][i_1][i_2+1] + 1;
                }
            }
            B[i_1+i_0][i_0][i_1-1] = C[i_0][i_0] - B[i_1+i_0+1][i_0+1][i_1-1] - 4;
        }
    }
#pragma endscop
...
kernel_4216111225_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
