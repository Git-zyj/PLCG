...
void kernel_4426352115_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,int wg,DATA_TYPE POLYBENCH_5D(G,xG,yG,zG,vG,wG,xg,yg,zg,vg,wg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl)){
        ...
        for (int i_1 = 0; i_1 < -i_0+PB_Q; i_1++) {
            for (int i_2 = max(2, i_0); i_2 < PB_M-2; i_2++) {
                for (int i_3 = 2; i_3 < -i_2+PB_P; i_3++) {
                    A[i_1][i_3+1][i_2][i_0] = E[i_2][i_0][i_3][i_1] * F[i_1][i_3+i_2-2][i_3-1][i_1] - F[i_2+2][i_0][i_0+2][i_1] + E[i_3-2][i_2+1][i_1+1][i_0+2] * G[i_1][i_0+1][i_2][i_3+i_2][i_1+i_0] + F[i_2][i_3-1][i_1][i_0+2] - 4;
                }
            }
        }
    }
        ...
        for (int i_5 = i_4; i_5 < min(-i_4+PB_M+2, PB_M-2); i_5++) {
            for (int i_6 = 0; i_6 < PB_M-2; i_6++) {
                for (int i_7 = 1; i_7 < -i_4+PB_L; i_7++) {
                    A[i_6+1][i_4+1][i_7-1][i_5-1] = H[i_6][i_5+1][i_7+i_4][i_4] - H[i_5][i_6+2][i_7][i_4] - 2;
                }
            }
            C[i_5+2][i_4+1] = I[i_5][0] - J[i_5+i_4-2][i_4] - J[i_4][i_5] - K[i_5][i_4] - C[i_5+2][i_4] + 5;
        }
        for (int i_8 = 2; i_8 < i_4; i_8++) {
            C[i_8+2][i_4+2] = K[i_4][i_8] + I[i_8+1][1] * L[i_8+1] * K[i_8+1][i_4] * I[i_8-2][i_4] * 2;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4426352115_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L));
