...
void kernel_4416151223_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P; i_0++) {
        B[i_0-1] = E[i_0] * E[i_0] * E[i_0] + E[i_0] + 2;
        B[i_0] = E[i_0] + E[i_0] * B[i_0+1] * 3;
        B[i_0] = E[i_0] * E[i_0] + E[i_0] - E[i_0] + F[i_0-1][0] * E[i_0] - 6;
    }
    for (int i_1 = 0; i_1 < PB_P; i_1++) {
        for (int i_2 = 1; i_2 < i_1; i_2++) {
            for (int i_3 = i_2; i_3 < min(-i_2+PB_L, PB_P-2); i_3++) {
                D[i_1][i_2+1][i_3] = G[i_3+i_2][i_3][i_2-1] * H[i_1+1][i_2-1][i_3+i_2][i_3] - G[i_2+1][i_1+1][0] * G[i_3+1][i_1][i_2] * G[i_3][i_1][0] + D[i_1+1][i_2+1][i_3] - D[i_1][i_2-1][i_3] * D[i_1][i_2+1][i_3+2] - 3;
            }
        }
    }
#pragma endscop
...
kernel_4416151223_06(xb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
