...
void kernel_4212312321_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        for (int i_1 = i_0; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 2; i_2 < PB_N-2; i_2++) {
                A[i_0][i_1+1][i_2-1] = C[i_0-2][i_1][i_2] * A[i_1][i_0+1][i_2-2] + B[i_2+2][i_2-2][i_0] * 5;
            }
        }
    }
    for (int i_3 = 0; i_3 < PB_L; i_3++) {
        for (int i_4 = 1; i_4 < PB_P; i_4++) {
            for (int i_5 = 3; i_5 < PB_N-4; i_5++) {
                for (int i_6 = max(4, i_3); i_6 < PB_P; i_6++) {
                    B[i_5+2][i_5-2][i_6] = B[i_6][i_6-4][i_4-1] * B[i_5+4][i_5][i_4] + B[i_5+1][i_5-3][i_6] * 5;
                }
            }
        }
    }
...
kernel_4212312321_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
