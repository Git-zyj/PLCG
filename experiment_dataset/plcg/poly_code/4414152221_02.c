...
void kernel_4414152221_02(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-2; i_0++) {
        for (int i_1 = max(2, i_0); i_1 < PB_M-2; i_1++) {
            A[i_1][i_0] = E[i_1] * F[i_0][i_1] - F[i_1][i_0] - E[0] + A[i_1-1][i_0] * A[i_0][i_1+1] * A[i_1-2][i_0+1] * 3;
            for (int i_2 = 2; i_2 < -i_1+PB_M; i_2++) {
                B[i_2][i_0][i_1] = G[i_2-2][i_1+2][i_0] * G[i_2+i_1][i_0][i_1+2] + G[i_2][i_0][i_1] + G[i_2+i_1][i_0][i_2] - G[i_2-1][i_1-2][i_0] - B[i_2-2][i_0][i_1+1] * 1;
            }
        }
        for (int i_3 = 2; i_3 < min(PB_L, -i_0+PB_N); i_3++) {
            C[i_0][i_3] = F[i_0+2][i_3] * F[i_3][i_0+2] + F[i_3+i_0][0] + E[i_0] * A[i_3][i_0] + C[i_0][i_3-2] * C[i_3-2][i_0] + 6;
        }
    }
    for (int i_4 = 1; i_4 < PB_L; i_4++) {
        for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
            D[i_4][i_4] = F[i_5][i_4] - F[i_5][i_4] * F[i_5][i_4] - E[i_4-1] - E[i_5] - F[i_5][i_4] + D[i_5+1][i_5+1] - 1;
        }
    }
#pragma endscop
...
kernel_4414152221_02(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
