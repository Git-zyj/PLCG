...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_N-1; i_1++) {
        ...
        for (int i_2 = i_1; i_2 < -i_1+PB_N; i_2++) {
            C[i_1][i_2-1] = F[i_2] - G[i_2+i_1][0] - G[i_2][0] + H[i_2+1][i_1] * B[i_1-2] + C[i_1-1][i_2-1] - C[i_1+1][i_2-1] * 1;
        }
        D[i_1] = F[i_1] * I[i_1-1] + I[i_1] + I[i_1] - B[i_1-2] + D[i_1-1] - 1;
    }
#pragma endscop
...
kernel_2416331311_07(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
