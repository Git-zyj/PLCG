        ...
        for (int i_1 = 1; i_1 < PB_P; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_P; i_2++) {
                for (int i_3 = 1; i_3 < i_1; i_3++) {
                    B[i_0-1][i_3-1][i_3][i_2+1] = D[i_3][i_2][i_1][i_2+i_0] + E[i_2][i_0][i_1-1][i_2] * 1;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_Q-2; i_4++) {
        for (int i_5 = 0; i_5 < PB_P; i_5++) {
            for (int i_6 = 1; i_6 < PB_Q-1; i_6++) {
                B[i_5][i_4-1][i_4][i_6+1] = F[i_6][i_4][i_5] * B[i_5][i_6-1][i_6][i_4] * B[i_5][i_6-1][i_6][i_4+2] - 4;
            }
        }
        for (int i_7 = i_4; i_7 < PB_M-1; i_7++) {
            for (int i_8 = 1; i_8 < PB_Q; i_8++) {
                for (int i_9 = 0; i_9 < min(-i_8+PB_L, PB_Q); i_9++) {
                    C[i_7+1][i_9+i_8][i_4-1][i_8] = C[i_4+2][i_9+i_8][i_7-1][i_8] - C[i_7+1][i_9+i_8-1][i_4-1][i_8] - C[i_7+1][i_9+i_8-1][i_4-1][i_9] + 5;
                }
            }
        }
    }
...
kernel_4334311315_04(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
