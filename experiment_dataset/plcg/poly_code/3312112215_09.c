...
void kernel_3312112215_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = max(1, i_0); i_1 < PB_L; i_1++) {
            B[i_1] = B[i_1-1] - B[i_0] - 6;
        }
        B[i_0] = D[i_0] * 2;
    }
...
kernel_3312112215_09(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
