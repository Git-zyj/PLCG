        ...
        for (int i_1 = 2; i_1 < min(PB_L-3, -i_0+PB_M-2); i_1++) {
            for (int i_2 = 0; i_2 < PB_P; i_2++) {
                for (int i_3 = 2; i_3 < i_1; i_3++) {
                    A[i_1+i_0][i_1+2][i_2][i_3-1] = C[i_2+i_1-2][i_3][i_0] + A[i_1+i_0+2][i_1+3][i_2][i_3-2] - 4;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_N-1; i_4++) {
        for (int i_5 = 1; i_5 < PB_L-2; i_5++) {
            for (int i_6 = 0; i_6 < min(-i_5+PB_N+1, PB_L-2); i_6++) {
                for (int i_7 = 2; i_7 < min(-i_6+PB_P, -i_5+PB_M-1); i_7++) {
                    A[i_7+i_5][i_5+2][i_6][i_4-2] = D[i_6][i_7-2][i_5+2][i_5] + E[i_6+2][i_7][i_4][i_5] + D[i_4+1][i_7-1][i_7+1][i_5+2] * D[i_6+i_5-1][i_4][i_7][i_4] + C[i_5][i_6+2][i_4+1] - E[i_5][i_7+i_6][i_4][i_5] * D[i_6][i_4-1][i_5][i_7-2] * E[i_5][i_7][i_4][i_6] - A[i_7+i_5+1][i_5+2][i_6+1][i_4] + 3;
                }
            }
        }
    }
...
kernel_4212252213_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
