...
void kernel_2326132213_04(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_M-1; i_1++) {
        B[i_1] = D[i_1] * D[i_1] - D[i_1] - B[i_1+1] * 2;
    }
    for (int i_2 = 0; i_2 < PB_M-2; i_2++) {
        B[i_2] = D[i_2] - D[i_2+2] * D[i_2] * 1;
    }
#pragma endscop
...
kernel_2326132213_04(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
