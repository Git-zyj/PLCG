...
void kernel_2212132113_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N; i_0++) {
        A[i_0+2] = C[1] * C[i_0] * C[i_0] * A[i_0+3] * 5;
...
kernel_2212132113_09(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
