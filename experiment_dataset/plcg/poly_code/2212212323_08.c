...
void kernel_2212212323_08(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = i_0; i_1 < -i_0+PB_M-1; i_1++) {
            B[i_1+i_0] = C[i_1][i_0] + 1;
            B[i_1+i_0] = B[i_1+i_0-1] - B[i_1+i_0+1] - B[i_1+i_0-1] - 5;
        }
    }
#pragma endscop
...
kernel_2212212323_08(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
