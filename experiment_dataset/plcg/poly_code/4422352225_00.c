...
void kernel_4422352225_00(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_L-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_Q-1; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_2+PB_Q-1, -i_0+PB_P); i_3++) {
                    B[i_0+1][i_1-1][i_3+i_2+1][i_3+1] = E[i_2][i_0][i_1][i_0] - F[i_3][i_2][i_1][i_3+i_0] * F[i_3+2][i_0][i_2][i_2] + E[i_1+2][i_0-1][2][i_2] + E[i_3+1][i_1+i_0+1][i_2][i_0] * 2;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_P; i_4++) {
            for (int i_5 = 2; i_5 < PB_Q-1; i_5++) {
                for (int i_6 = 0; i_6 < -i_5+PB_Q-1; i_6++) {
                    B[i_0][i_4-1][i_6+i_5][i_6] = G[i_4][i_0][i_6+1][i_5] + G[i_5+2][i_4][i_6][2] + G[i_6][i_0][i_0+1][i_5] + E[i_4][i_5][i_4][i_0] + E[i_4][i_5-2][i_0+1][i_6] * B[i_4][i_0-1][i_6+i_5+1][i_6+1] * 1;
                }
            }
        }
        C[i_0-1] = H[i_0] - I[i_0-2][0] * J[i_0] * C[i_0] * C[i_0-3] * 5;
    }
    for (int i_7 = 1; i_7 < PB_Q-2; i_7++) {
        for (int i_8 = 2; i_8 < PB_L; i_8++) {
            for (int i_9 = 2; i_9 < i_8; i_9++) {
                for (int j_0 = 0; j_0 < min(-i_7+PB_Q-2, -i_9+PB_Q); j_0++) {
                    B[i_9-2][i_8-1][j_0+i_7+2][i_7] = G[i_7+1][j_0+1][i_8-2][i_9] + E[i_9][i_7][j_0+i_9][i_7+2] * F[i_7-1][j_0][i_8][i_9] - E[i_9][i_9][i_8][i_7] * 2;
                }
            }
        }
    }
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4422352225_00(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J)));
