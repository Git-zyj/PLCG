...
void kernel_2232311225_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
kernel_2232311225_09(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
