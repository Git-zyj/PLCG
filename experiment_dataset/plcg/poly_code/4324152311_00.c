...
void kernel_4324152311_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
        ...
        for (int i_1 = i_0; i_1 < PB_M-2; i_1++) {
            for (int i_2 = i_1; i_2 < -i_1+PB_L; i_2++) {
                for (int i_3 = 2; i_3 < -i_1+PB_L; i_3++) {
                    A[i_1][i_2-1][i_0][i_3-1] = D[i_2][i_0][i_3][i_1+1] + D[i_0-1][i_2][i_3][i_1] + D[i_0][i_3+i_1][i_2][i_3] + D[i_2][i_0+1][i_3][i_1] - D[i_1+2][i_3][i_1][i_0] - E[i_2][i_2+i_1][i_3-2] - A[i_0][i_1-1][i_2+1][i_3-1] * A[i_1][i_2][i_0+1][i_3-2] - 1;
                }
            }
        }
        B[i_0-1] = F[i_0-1] - F[i_0] + G[i_0+2][1] + B[i_0-2] + 6;
    }
        ...
        for (int i_5 = 1; i_5 < min(i_4, -i_4+PB_Q-1); i_5++) {
            for (int i_6 = 2; i_6 < PB_P-1; i_6++) {
                for (int i_7 = 0; i_7 < PB_L; i_7++) {
                    C[i_5][i_4][i_6][i_4] = D[i_6][i_4][i_7][i_4] - D[i_5][i_7][i_4][i_6-2] * E[i_4-2][i_6][i_5] - D[i_5][i_4][i_7][0] * D[i_5-1][i_6-1][i_7][i_5+i_4+1] + C[i_5-1][i_6-1][i_7][i_6-1] - C[i_5][i_4][i_6+1][i_4] + C[i_5+1][i_4-1][i_6][i_4-1] - C[i_5+1][i_4][i_6+1][i_4] - C[i_5-1][i_4+1][i_7][i_4+1] - 4;
                }
            }
        }
    }
...
kernel_4324152311_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
