...
void kernel_4226132213_06(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        for (int i_1 = i_0; i_1 < PB_M; i_1++) {
            ...
            A[i_1][i_0+2] = C[i_0-2][i_1] - C[i_1][i_0-2] * C[i_0][2] + C[i_1-2][i_0+2] * C[i_1-1][i_0] * A[i_1][i_0+2] - A[i_1][i_0+3] + 2;
        }
    }
#pragma endscop
...
kernel_4226132213_06(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C));
