...
void kernel_2416232113_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-2; i_0++) {
        A[i_0] = E[i_0] + F[i_0+2] * F[i_0-1] * E[i_0] + 2;
        for (int i_1 = i_0; i_1 < PB_L; i_1++) {
            C[i_1-1][2][i_0] = G[i_0][i_1] + H[i_0][i_1] - H[i_0][i_1] + 3;
            C[i_1][2][i_0] = H[i_1][i_0] + G[i_1][i_0] - G[i_1][i_0+2] + G[i_1][i_0] - D[i_0] + 1;
        }
        D[i_0] = F[i_0] - D[i_0+1] - 4;
    }
#pragma endscop
...
kernel_2416232113_07(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
