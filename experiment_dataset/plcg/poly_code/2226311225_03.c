...
void kernel_2226311225_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    ...
    for (int i_2 = 0; i_2 < PB_N-1; i_2++) {
        B[i_2+1] = C[i_2][i_2+1] + B[i_2+2] + B[i_2] + 1;
    }
#pragma endscop
...
kernel_2226311225_03(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
