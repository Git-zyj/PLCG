...
void kernel_4412251311_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P; i_0++) {
        A[i_0] = E[i_0-1] * E[i_0] - E[i_0] - F[i_0-1] + E[i_0] * E[i_0] * A[i_0-1] * 5;
        for (int i_1 = 1; i_1 < PB_P; i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_P; i_2++) {
                for (int i_3 = 0; i_3 < PB_M-1; i_3++) {
                    B[i_2][i_2][i_1+1] = G[i_0-1][i_1][i_2-1][i_1] * G[i_3][i_0-1][i_1-1][0] - H[i_1][i_3+1][i_2+i_0][i_0] * B[i_2-1][i_2-1][i_1] * B[i_3+1][i_3+1][i_1+1] - 6;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_Q-1; i_4++) {
            C[i_0][i_4] = I[i_4+1][i_0] * E[i_0] * I[i_4+1][i_0] - I[i_4+1][i_0] * C[i_0-1][i_4-1] * C[i_0-1][i_4] + C[i_0-1][i_4+1] * 2;
        }
    }
    for (int i_5 = 1; i_5 < PB_P-1; i_5++) {
        for (int i_6 = 1; i_6 < PB_M; i_6++) {
            for (int i_7 = 1; i_7 < PB_L-2; i_7++) {
                for (int i_8 = 1; i_8 < min(min(-i_6+PB_M, -i_7+PB_M-1), PB_P-2); i_8++) {
                    D[i_5][i_7-1][i_5+1][i_6] = H[i_7][i_7-1][i_5][i_8-1] + G[i_5][i_7][i_6][i_8] - G[i_8+i_6][i_5][i_6-1][i_7] - H[i_6][i_5][i_8+1][i_6] * H[i_8+i_7+1][i_8+1][i_5-1][i_6] + B[i_8][i_8][i_7+2] * D[i_5-1][i_7-1][i_5][i_8+1] - D[i_8+1][i_7-1][i_8+2][i_6-1] * 4;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4412251311_04(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I)));
