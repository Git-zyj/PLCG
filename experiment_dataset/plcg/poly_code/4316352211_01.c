...
void kernel_4316352211_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N-2; i_0++) {
        for (int i_1 = 2; i_1 < min(PB_N-3, i_0); i_1++) {
            for (int i_2 = max(max(1, -i_0-2), -i_1+2); i_2 < -i_0+PB_P-2; i_2++) {
                for (int i_3 = 1; i_3 < PB_M; i_3++) {
                    A[i_0+2][i_3][i_2-1][i_3] = D[i_0+2][i_3][i_2][i_1] * E[i_3][i_2+i_1-2][i_0+1][i_2] - D[i_2][i_3][i_1-1][i_2+i_0+2] + D[i_0][i_3][i_3][i_2] + A[i_0+2][i_3-1][i_2-1][i_3-1] - A[i_1+3][i_3][i_2-1][i_3] * 2;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        for (int i_5 = 1; i_5 < min(i_4, PB_P-2); i_5++) {
            for (int i_6 = max(2, i_5); i_6 < min(-i_5+PB_L, -i_4+PB_L); i_6++) {
                C[i_5][i_6][i_5] = F[i_6][i_5] + G[i_5][i_4][i_4] * G[i_5+1][i_6+i_4][i_4] * H[i_4][i_6-2][i_5+2] + C[i_4][i_5][i_4] + 2;
                C[i_6][i_5][i_6] = G[i_4+1][i_6+i_5][i_4-1] * G[i_6-1][i_5][i_4] - I[i_5][i_6][i_4] + H[i_5][i_4][i_6-1] - H[i_5][i_4][i_4] + G[i_6][i_4][i_5] * J[i_6][i_5-1] + 1;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4316352211_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J)));
