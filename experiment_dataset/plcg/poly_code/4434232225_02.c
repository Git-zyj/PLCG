        ...
        for (int i_3 = 2; i_3 < min(PB_Q, -i_2+PB_L); i_3++) {
            for (int i_4 = 1; i_4 < PB_Q; i_4++) {
                for (int i_5 = 2; i_5 < -i_2+PB_P-1; i_5++) {
                    B[i_3+i_2][i_5][i_4][i_3] = H[i_4-1][i_3-1][i_5-1][0] * I[i_5-2][i_3][i_4] * J[i_3][i_4-1][i_5+i_2+1][i_3-1] * B[i_5+i_3-1][i_2][i_4][i_5] + B[i_5+i_3-2][i_4][i_2-1][i_3] * 4;
                }
            }
            for (int i_6 = 2; i_6 < PB_M; i_6++) {
                C[i_3][i_6-1] = I[i_3][i_6-2][i_2] * K[i_2][i_6][i_3+1] * 5;
            }
        }
        for (int i_7 = 1; i_7 < PB_Q; i_7++) {
            A[i_2][i_7] = F[i_2-1][i_7-1] * L[i_2] - 1;
        }
    }
#pragma endscop
