...
void kernel_4212152113_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_M-2 - 1; i_0 >= 0; i_0--) {
        B[i_0+1] = C[i_0] * C[i_0] - C[i_0] * C[i_0+2] * C[0] + B[i_0] - 3;
        B[i_0+1] = C[i_0] + C[i_0+2] + C[i_0] + C[i_0] + 2;
    }
#pragma endscop
...
kernel_4212152113_00(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
