...
void kernel_4434232213_05(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,int wi,DATA_TYPE POLYBENCH_5D(I,xI,yI,zI,vI,wI,xi,yi,zi,vi,wi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P-2; i_0++) {
        B[i_0-1][i_0-2] = E[i_0] - F[i_0] + 5;
        for (int i_1 = i_0; i_1 < -i_0+PB_N; i_1++) {
            B[i_1][i_1-1] = G[i_1][i_0-1] * E[0] * E[i_1+i_0] - G[i_1][i_0+2] - B[i_1+1][i_1] + 4;
        }
    }
        ...
        for (int i_3 = 0; i_3 < PB_P-2; i_3++) {
            for (int i_4 = 0; i_4 < PB_L-2; i_4++) {
                for (int i_5 = 0; i_5 < -i_2+PB_M-2; i_5++) {
                    C[i_5+i_2+2][i_4+2][i_4][i_3] = H[i_3][i_5+1][i_2][i_4+2] * I[i_3][i_4][i_5][i_2][i_3] * H[i_3][i_2-2][i_4][i_2-1] - D[i_5+1][i_3+2][i_4][i_4+2] + 1;
                }
            }
        }
    }
        ...
        for (int i_7 = 1; i_7 < i_6; i_7++) {
            for (int i_8 = 2; i_8 < -i_6+PB_M-1; i_8++) {
                for (int i_9 = 1; i_9 < i_8; i_9++) {
                    D[i_8][i_6+2][i_9][i_9+2] = H[i_9+i_6-1][i_8][i_7-1][i_8-2] * I[i_8-1][i_6][i_9+1][i_7][i_9-1] - J[i_9][i_6][i_7][i_8] * C[i_9+i_8+1][i_7+2][i_7][i_6] + C[i_8+i_6+1][i_9+2][i_9][i_7] + C[i_8+i_6+1][i_9+3][i_9+1][i_7] * 3;
                }
            }
        }
    }
...
init_array(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,wi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4434232213_05(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,wi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,wi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J)));
