...
void kernel_4434212125_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve)){
...
#pragma scop
        ...
        for (int i_4 = 2; i_4 < i_0; i_4++) {
            for (int i_5 = 2; i_5 < i_4; i_5++) {
                for (int i_6 = 2; i_6 < -i_0+PB_P-1; i_6++) {
                    A[i_0+1][i_5-2][i_6-2][i_4-2] = E[i_4][i_5][i_6+i_0+1][i_0+1] - 4;
                }
            }
        }
    }
    for (int i_7 = 0; i_7 < PB_L; i_7++) {
        for (int i_8 = max(2, i_7); i_8 < PB_M; i_8++) {
            C[i_8][i_7] = C[i_8-2][i_7] + C[i_8-1][i_7] + 2;
        }
    }
...
kernel_4434212125_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
