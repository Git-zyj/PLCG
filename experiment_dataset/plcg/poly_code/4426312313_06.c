        ...
        for (int i_5 = 1; i_5 < PB_L-2; i_5++) {
            for (int i_6 = 1; i_6 < min(i_4, -i_4+PB_P-2); i_6++) {
                for (int i_7 = 1; i_7 < PB_M+1; i_7++) {
                    D[i_4][i_5][i_6][i_7] = F[i_7-1][i_4-2][i_5+2][i_6+i_4+2] + F[i_5][i_4][i_5+1][i_7] + D[i_4-1][i_5][i_6-1][i_7-1] + D[i_4][i_5-1][i_6+1][i_7] - D[i_4-1][i_5][i_6][i_7] + 6;
                }
            }
        }
    }
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), INIT_SEED);
kernel_4426312313_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F)));
