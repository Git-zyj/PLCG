...
void kernel_4426332221_06(int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,int wg,DATA_TYPE POLYBENCH_5D(G,xG,yG,zG,vG,wG,xg,yg,zg,vg,wg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj)){
...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_L-1; i_2++) {
                for (int i_3 = 2; i_3 < i_1; i_3++) {
                    D[i_2+i_1][i_2][i_3-2] = D[i_2+i_1+1][i_1][i_3-2] - 4;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-2; i_4++) {
        for (int i_5 = 1; i_5 < PB_Q-2; i_5++) {
            for (int i_6 = 0; i_6 < min(i_4, -i_5+PB_L-2); i_6++) {
                for (int i_7 = 2; i_7 < -i_6+PB_M; i_7++) {
                    D[i_6+i_5+2][i_5+2][i_7-2] = E[i_7+i_6][i_5-1][i_4][i_5-1] + F[i_7][i_6][i_4][i_4-1] * G[i_6][i_4][i_7-2][i_5][i_5] - 6;
                }
            }
        }
        C[i_4] = H[i_4-1] * I[i_4+2] + H[i_4-1] * I[i_4] - H[i_4] * I[i_4] + C[i_4-2] - 2;
        for (int i_8 = i_4; i_8 < -i_4+PB_L; i_8++) {
            for (int i_9 = 4; i_9 < -i_4+PB_L; i_9++) {
                D[i_8+i_4][i_8][i_9-2] = J[i_9][i_8-2][0] * D[i_8+i_4][i_8][i_9-4] + D[i_9+i_4][i_9][i_8] + 6;
            }
        }
    }
#pragma endscop
...
init_array(xd,yd,zd,POLYBENCH_ARRAY(D), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4426332221_06(xd,yd,zd,POLYBENCH_ARRAY(D), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xd,yd,zd,POLYBENCH_ARRAY(D), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J)));
