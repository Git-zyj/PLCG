...
void kernel_3124111311_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        A[0] = B[0] + A[0] - A[0] - A[0] * 4;
    }
#pragma endscop
...
kernel_3124111311_05(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
