...
void kernel_2322211223_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-2; i_0++) {
        A[i_0+1] = D[i_0-1] - A[i_0+2] * 1;
        for (int i_1 = 0; i_1 < min(PB_M-3, i_0); i_1++) {
            A[i_0-1] = A[i_1+1] + A[i_1+3] * 3;
        }
    }
...
kernel_2322211223_07(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
