...
void kernel_2432352311_06(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 0; i_1 < min(PB_M-1, -i_0+PB_L-1); i_1++) {
            A[i_1][0] = E[i_1+2] - F[i_1][i_0] + G[i_1][i_0] - H[i_1][i_0] - B[i_1+1][i_1+i_0+1] - 6;
        }
        for (int i_2 = 2; i_2 < min(PB_M-1, -i_0+PB_L-1); i_2++) {
            B[i_2][i_2+i_0] = I[i_2-1][i_0-1][i_0] + G[i_0][i_2-2] * H[i_2][i_0-1] * F[i_0+1][i_0+1] - E[i_2+i_0] - J[i_2-1] * F[i_2+1][i_0] - B[i_2][i_2+i_0+1] * B[i_2-1][i_2+i_0-2] - B[i_2][i_2+i_0-1] - 6;
        }
    }
    for (int i_3 = 3; i_3 < PB_M; i_3++) {
        C[i_3-2][i_3] = K[1] + J[i_3] * E[i_3+2] + H[i_3-1][i_3] * C[i_3-3][i_3-1] - C[i_3-1][i_3+1] + C[i_3-1][i_3+1] * 2;
    }
    for (int i_4 = 1; i_4 < PB_M-2; i_4++) {
        for (int i_5 = 2; i_5 < min(PB_M, -i_4+PB_L); i_5++) {
            B[i_5][i_5+i_4] = G[i_5-2][i_4] + F[i_5][i_4] - H[i_4+2][i_5] * G[i_5+1][i_4] * F[i_5-1][i_4-1] - 5;
        }
    }
#pragma endscop
...
kernel_2432352311_06(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K));
