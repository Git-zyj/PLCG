...
void kernel_3224132225_09(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N; i_0++) {
        for (int i_1 = 1; i_1 < PB_N; i_1++) {
            for (int i_2 = max(2, i_0); i_2 < PB_N+2; i_2++) {
                B[i_1][i_2] = C[i_2+2][i_1] + C[i_1][i_0] + B[i_1-1][i_0] - B[i_2-2][i_1] - 5;
            }
            B[i_0][i_1] = C[i_1][i_0] * C[i_1][i_0] - C[i_1][i_0] - 3;
        }
    }
#pragma endscop
...
kernel_3224132225_09(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
