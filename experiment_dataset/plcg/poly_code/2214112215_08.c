...
void kernel_2214112215_08(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        ...
        for (int i_2 = 2; i_2 < -i_0+PB_M-1; i_2++) {
            B[i_2+i_0][i_2-2] = C[i_2] - D[i_0-2][i_2+1] * B[i_2+i_0+1][i_2-1] * B[i_2+i_0][i_2-1] - 4;
        }
    }
#pragma endscop
...
kernel_2214112215_08(xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
