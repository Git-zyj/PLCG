...
void kernel_4412252315_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
        ...
        for (int i_1 = 2; i_1 < -i_0+PB_Q-2; i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_M; i_2++) {
                for (int i_3 = 0; i_3 < PB_P-2; i_3++) {
                    A[i_2][i_3+2][i_2+i_0][2] = E[i_1+i_0][i_3][i_3][i_1][i_2] * F[i_3+1][i_0][i_1+1][i_2] * 1;
                }
                A[i_0][i_1+1][i_2+i_0][2] = G[i_2][i_1+1][i_0] + H[i_2+i_0][i_1-2][i_2+2][0] + G[i_2][i_0][i_2-1] * G[i_0][i_2+i_1][i_1+i_0+2] + C[i_2+i_0][i_1][i_2] * C[i_2+i_0-1][i_1][i_2-1] + 4;
                C[i_2+i_0][i_1][i_2] = H[i_1][i_0-2][i_2][0] + I[i_1][i_2+1][i_1-1] - G[i_1-2][i_2][i_0] * I[i_1][i_2+i_0][i_1] * G[i_1+2][i_2+1][i_0] - I[i_1][i_2][i_0] - A[i_2][i_1+1][i_2+i_0][2] * 1;
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L; i_4++) {
        for (int i_5 = 1; i_5 < PB_P-2; i_5++) {
            for (int i_6 = 2; i_6 < -i_4+PB_M; i_6++) {
                for (int i_7 = 0; i_7 < min(min(i_4, -i_5+PB_P-2), -i_4+PB_Q); i_7++) {
                    D[i_6][i_4][i_5][i_7] = F[i_5][i_6-2][i_7][i_4] * F[i_6+i_4][i_7][i_7+i_5][i_7+i_5+2] * I[i_5][i_7][i_5+2] * H[i_7][i_4][i_4][i_6-1] + F[i_6][i_4-2][i_4][i_5] + A[i_4][i_6+2][i_7+i_4][2] + D[i_6-1][i_4][i_5][i_7] * D[i_6][i_5][i_7][i_4-1] - D[i_6-1][i_4-1][i_5-1][i_7] + D[i_6-1][i_4][i_7][i_5] * D[i_6][i_4][i_5-1][i_7+1] - 2;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4412252315_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
