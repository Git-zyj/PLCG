...
void kernel_4316112213_06(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_Q-1; i_0++) {
        for (int i_1 = 1; i_1 < min(PB_Q, -i_0+PB_M-2); i_1++) {
            A[i_1+1][i_1+i_0+1] = D[i_1+i_0-2][i_0][i_1+1] * A[i_1+2][i_1+i_0+2] + 6;
            for (int i_2 = 0; i_2 < min(PB_Q-2, i_0); i_2++) {
                B[i_0+1][i_2+2][i_1] = B[i_0+1][i_2+1][i_1] + 4;
            }
            for (int i_3 = 3; i_3 < min(min(PB_Q-1, -i_0+PB_M-2), -i_1+PB_M-1); i_3++) {
                C[i_0-2][i_1][i_3+1] = D[i_1][i_0][i_3] - D[i_1+i_0][i_3+2][i_1-1] + A[i_3+2][i_3+i_1+1] + A[i_3+1][i_3+i_0+2] * A[i_0+1][i_1+i_0] * C[i_3-3][i_1][i_0+1] - 5;
            }
        }
    }
#pragma endscop
...
kernel_4316112213_06(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
