...
void kernel_3312212321_09(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_0 = 2; i_0 < PB_L+2; i_0++) {
        ...
        for (int i_2 = i_0; i_2 < PB_L; i_2++) {
            for (int i_3 = 3; i_3 < PB_P; i_3++) {
                B[i_3-2][i_2][i_3-2] = B[i_3-1][i_2][i_3-1] - B[i_3][i_2][i_3] + B[i_3-3][i_2][i_3-3] - 4;
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M-2; i_4++) {
        for (int i_5 = 1; i_5 < PB_M; i_5++) {
            for (int i_6 = max(2, i_5); i_6 < PB_L; i_6++) {
                C[i_5][i_6] = D[i_4+2][i_6][0] - C[i_5][i_6-2] * C[i_5-1][i_6-2] * 2;
            }
        }
    }
#pragma endscop
...
kernel_3312212321_09(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
