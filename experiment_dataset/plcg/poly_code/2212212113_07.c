...
void kernel_2212212113_07(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 1; i_1 < PB_L+1; i_1++) {
            B[i_0+1] = C[i_1-1][i_0-1] - 2;
        }
        B[i_0+2] = C[i_0][0] - B[i_0+1] + 4;
    }
#pragma endscop
...
kernel_2212212113_07(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
