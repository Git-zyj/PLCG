...
void kernel_4214211325_08(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        for (int i_1 = 0; i_1 < -i_0+PB_L-1; i_1++) {
            B[i_1+i_0+1] = B[i_1+i_0-1] + 2;
        }
        for (int i_2 = i_0; i_2 < -i_0+PB_L+1; i_2++) {
            B[i_2+i_0-1] = C[i_2+1][i_0] * B[i_2+i_0-2] * B[i_2+i_0-2] * 2;
        }
    }
#pragma endscop
...
kernel_4214211325_08(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
