...
void kernel_2114252215_08(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        A[i_0][i_0+2] = B[i_0] * C[i_0] * B[i_0] * B[i_0] - C[i_0] + A[i_0-1][i_0+1] - A[i_0+1][i_0+3] - 3;
    }
#pragma endscop
...
kernel_2114252215_08(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
