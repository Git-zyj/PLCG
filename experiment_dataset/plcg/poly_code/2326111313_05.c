...
void kernel_2326111313_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
        for (int i_4 = i_3; i_4 < -i_3+PB_M-1; i_4++) {
            C[i_4+i_3] = D[i_4] - C[i_4+i_3] - C[i_4+i_3-1] + C[i_4+i_3-1] + C[i_4+i_3+1] - 4;
        }
    }
#pragma endscop
...
kernel_2326111313_05(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
