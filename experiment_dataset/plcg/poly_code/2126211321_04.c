...
void kernel_2126211321_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        for (int i_1 = i_0; i_1 < PB_P; i_1++) {
            A[i_0][i_1][1] = B[0] - A[i_0+1][i_1-1][1] * A[i_0][i_1+1][1] * A[i_0-2][i_1+1][1] * 2;
        }
    }
#pragma endscop
...
kernel_2126211321_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
