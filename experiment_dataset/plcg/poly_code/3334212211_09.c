...
void kernel_3334212211_09(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-2; i_0++) {
        ...
        for (int i_3 = i_0; i_3 < -i_0+PB_M-2; i_3++) {
            B[i_3+i_0+2][i_0] = B[i_3+i_0][i_0-1] + 4;
        }
    }
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 0; i_5 < i_4; i_5++) {
            for (int i_6 = 2; i_6 < i_5; i_6++) {
                C[i_6][i_4][i_6] = D[i_6-2][i_4][i_5] - D[i_6][i_4+1][i_5+1] - D[i_5][i_6][i_4+1] * C[i_5][i_6-1][i_5] + C[i_6][i_4-1][i_6] - C[i_5][i_6+1][i_5] * C[i_6-1][i_4][i_6-1] + C[i_6+1][i_4][i_6+1] - 1;
            }
        }
    }
#pragma endscop
...
kernel_3334212211_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
