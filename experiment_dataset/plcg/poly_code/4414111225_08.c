...
void kernel_4414111225_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-2; i_0++) {
        A[i_0] = E[0] * A[i_0-1] * A[i_0+2] - 1;
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < PB_M; i_2++) {
                C[i_2][0][i_1][i_0] = F[i_2-1][i_0][i_1-1] - C[i_1][0][i_0+1][i_2] + 4;
            }
        }
    }
        ...
        for (int i_4 = 1; i_4 < PB_M; i_4++) {
            for (int i_5 = 0; i_5 < min(i_4, -i_4+PB_Q); i_5++) {
                for (int i_6 = 1; i_6 < min(-i_3+PB_P, PB_Q); i_6++) {
                    C[i_5][0][i_3][i_6] = G[i_4-1][i_6-1][i_3-1][i_5] + G[i_4-1][i_6+i_3][i_5+i_4][0] * 2;
                }
            }
            A[i_4] = 2;
        }
...
kernel_4414111225_08(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G));
