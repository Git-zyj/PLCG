...
void kernel_4322251213_01(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 1; i_1 < -i_0+PB_M-2; i_1++) {
            A[i_1][i_1+i_0+1] = D[i_1][i_0-1] - E[i_0+1] - F[i_1-1][i_0-1] - D[i_1][i_0] + A[i_1][i_1+i_0] * A[i_1+1][i_1+i_0+2] - A[i_1][i_1+i_0+2] - 1;
        }
        for (int i_2 = 1; i_2 < PB_L-2; i_2++) {
            for (int i_3 = 0; i_3 < min(-i_2+PB_L-2, -i_0+PB_P); i_3++) {
                for (int i_4 = 0; i_4 < -i_0+PB_L-2; i_4++) {
                    B[i_4+i_3+1][i_2][i_4] = G[i_4][i_0-1][i_2][0] + G[i_4][i_2][i_0][i_3] * G[i_2-1][i_0-1][i_3+i_0][i_4] - G[i_3][i_4][1][i_2+1] - G[i_0][i_3][i_2-1][i_4+i_3+1] * H[i_4][i_0][i_3][i_2] - G[i_4+i_0][i_0-1][i_2-1][i_3] * H[i_2-1][i_4+i_0][i_3][i_2+1] + B[i_4+i_0+2][i_2][i_4+1] + B[i_3+i_2+2][i_4][i_2] - B[i_4+i_3+1][i_2][i_4+1] + 1;
                }
            }
        }
    }
    for (int i_5 = 0; i_5 < PB_L-1; i_5++) {
        for (int i_6 = max(1, i_5); i_6 < -i_5+PB_L-1; i_6++) {
            C[i_5][i_6-1] = F[i_5+1][i_6+i_5+1] * 3;
        }
    }
#pragma endscop
...
kernel_4322251213_01(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
