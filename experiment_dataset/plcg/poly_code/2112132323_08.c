...
void kernel_2112132323_08(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        A[i_0+1][i_0] = B[i_0] * B[i_0] - C[i_0-1][i_0] + A[i_0+2][i_0+1] - A[i_0-1][i_0-2] + A[i_0+3][i_0+2] - 1;
    }
#pragma endscop
...
kernel_2112132323_08(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
