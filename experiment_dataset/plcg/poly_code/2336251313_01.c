...
void kernel_2336251313_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_L; i_1++) {
        A[i_1] = D[i_1] + D[i_1] * E[i_1] * E[i_1] - E[i_1] * 4;
        for (int i_2 = 0; i_2 < i_1; i_2++) {
            C[i_2+1][i_1] = F[i_2+1][i_1][0] + G[i_2][i_1] + E[i_2] - H[i_1][i_2] - A[i_2] + C[i_2+2][i_1] * C[i_2][i_1-1] + C[i_2][i_1] - 3;
        }
    }
#pragma endscop
...
kernel_2336251313_01(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
