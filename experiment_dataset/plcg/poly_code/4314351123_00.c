...
#pragma scop
        ...
        for (int i_1 = i_0; i_1 < min(-i_0+PB_M, PB_M-2); i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_L; i_2++) {
                for (int i_3 = i_1; i_3 < min(PB_L-2, -i_1+PB_Q); i_3++) {
                    A[i_1][i_3][1] = D[i_1+i_0][i_2+i_0][i_3+i_1][i_2] * D[i_2][i_2-1][i_0+1][i_3+i_1] * E[i_0][i_3][i_1+1][0] * E[i_1+1][i_2][i_3][i_0] * A[i_1][i_3+2][1] - 3;
                }
            }
            for (int i_4 = 0; i_4 < PB_Q-1; i_4++) {
                for (int i_5 = 0; i_5 < min(-i_1+PB_M+1, -i_0+PB_L-1); i_5++) {
                    A[i_1+2][i_5][1] = F[i_5+i_1-1][i_4][i_0-1] + D[i_1][i_5+i_0][i_1+i_0-1][i_4] + E[i_1+1][i_5+i_0+1][i_0][i_4+1] - 3;
                }
            }
        }
    }
    for (int i_6 = 0; i_6 < PB_M-1; i_6++) {
        for (int i_7 = max(i_6, 1); i_7 < PB_L+1; i_7++) {
            C[i_6][i_7-1] = G[i_7][i_6] * G[i_6][i_7] - H[i_7][i_6] * I[i_7-1][i_6+1] * H[i_7][i_6] + J[i_7] + G[i_7][i_6] + 3;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4314351123_00(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J)));
