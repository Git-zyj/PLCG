...
void kernel_4312331223_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
        ...
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_M; i_2++) {
                for (int i_3 = 1; i_3 < PB_M; i_3++) {
                    A[i_0+1][i_2-1][i_2][i_3-1] = D[i_2+i_1][i_0][i_2][i_1+1] + E[i_3][i_1-1][i_2-1] + F[i_3][i_0][i_1][i_2-1] + G[i_3][i_0-1][i_2][1] * A[i_1+1][i_3][i_3+1][i_2] + 1;
                }
            }
        }
        B[i_0+1] = H[i_0] * H[i_0] * B[i_0+3] + B[i_0-1] + 4;
        for (int i_4 = 0; i_4 < PB_L-1; i_4++) {
            for (int i_5 = i_4; i_5 < min(-i_4+PB_L-1, PB_M-1); i_5++) {
                for (int i_6 = 1; i_6 < -i_0+PB_N+1; i_6++) {
                    A[i_5+1][i_6+1][i_6+2][i_0-1] = G[i_6+i_0-1][i_5+1][i_4][i_5] * G[i_5][i_0-1][i_0-1][i_4] * F[i_6-1][i_5+i_4+1][i_0-1][i_4] * A[i_0+1][i_5+1][i_5+2][i_6-1] - 1;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4312331223_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H)));
