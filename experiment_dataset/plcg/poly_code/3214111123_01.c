...
void kernel_3214111123_01(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        B[i_0-1][i_0] = C[i_0][0] - 3;
        for (int i_1 = 1; i_1 < PB_P-2; i_1++) {
            B[i_1-1][i_1] = B[i_1+1][i_1+2] + 1;
        }
    }
#pragma endscop
...
kernel_3214111123_01(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
