...
void kernel_4312351223_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 1; i_3 < min(min(-i_2+PB_M, PB_L), -i_1+PB_Q); i_3++) {
                    A[i_1][i_2][i_0+1][i_2] = D[i_0][i_2+1][i_1][0] + E[i_3-1][i_0][i_2][i_3+i_1][i_0] + F[i_3][i_0+1][i_1][i_2] + A[i_3][i_2][i_0][i_2] - B[i_3+i_2][i_3-1][i_1][i_2] + 1;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L; i_4++) {
        for (int i_5 = 3; i_5 < -i_4+PB_P-1; i_5++) {
            for (int i_6 = i_4; i_6 < min(-i_5+PB_Q, -i_4+PB_M); i_6++) {
                for (int i_7 = 0; i_7 < -i_5+PB_M; i_7++) {
                    B[i_7+i_5][i_5-1][i_6][i_7] = G[i_6+1][i_6+i_4+1][i_7+i_5][i_7] - D[i_6+i_4][i_7+1][i_5+i_4+1][i_5+1] - D[i_6-1][i_4][i_5][i_5] * F[i_6][i_7+1][i_4][i_6+i_5] - A[i_6-2][i_7][i_4+1][i_7] + B[i_7+i_5-2][i_5-3][i_6-1][i_7] - B[i_7+i_5-1][i_5-2][i_6][i_7] * 6;
                }
            }
            C[i_5][i_4] = H[i_5] + I[i_5][i_4] * H[i_5] + J[i_4][i_5] + K[i_5][i_4] + I[i_4-1][i_5-1] * I[i_5+1][i_4] - J[i_5][i_4] + C[i_5][i_4-2] * 1;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4312351223_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K));
