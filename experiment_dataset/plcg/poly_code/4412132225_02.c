...
void kernel_4412132225_02(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N; i_0++) {
        C[i_0] = E[i_0-2] + E[i_0+1] + B[i_0][i_0] * B[i_0-1][i_0-1] - 1;
        B[i_0][i_0] = E[i_0] + E[i_0] * E[i_0] * 1;
    }
    for (int i_1 = 2; i_1 < PB_L; i_1++) {
        C[i_1] = E[i_1] - 1;
        C[i_1-2] = E[i_1] * E[i_1] * E[i_1] - E[i_1-2] * C[i_1] * C[i_1-1] + 6;
    }
#pragma endscop
...
kernel_4412132225_02(xc,POLYBENCH_ARRAY(C), xb,yb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E));
