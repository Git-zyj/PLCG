...
void kernel_2214212315_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
kernel_2214212315_05(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
