...
void kernel_3212152225_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        A[i_0-2] = C[i_0] - C[i_0-2] * C[i_0-1] + C[i_0] - C[i_0] + C[i_0] * C[i_0] * A[i_0] + 6;
        A[i_0-2] = C[i_0] + D[i_0][2] * A[i_0-2] + 6;
    }
#pragma endscop
...
kernel_3212152225_03(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
