...
void kernel_4216111121_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        for (int i_1 = 2; i_1 < PB_M-1; i_1++) {
            for (int i_2 = max(2, i_0); i_2 < PB_P; i_2++) {
                for (int i_3 = 0; i_3 < min(min(-i_1+PB_P+2, i_2), -i_2+PB_P); i_3++) {
                    A[i_2][i_0][i_3+i_2] = C[i_1+1][i_3][i_3] * A[i_3][i_2-2][i_3+i_1-2] * 2;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_L; i_4++) {
        for (int i_5 = 0; i_5 < PB_M; i_5++) {
            for (int i_6 = 0; i_6 < PB_L-3; i_6++) {
                B[i_4][i_6+1][i_4] = C[i_5][i_4][i_4] * B[i_4][i_6+3][i_4] - 2;
            }
        }
    }
#pragma endscop
...
kernel_4216111121_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
