...
void kernel_4316252311_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
        ...
        for (int i_1 = 0; i_1 < min(-i_0+PB_Q, i_0); i_1++) {
            for (int i_2 = 0; i_2 < i_0; i_2++) {
                for (int i_3 = 0; i_3 < PB_Q-3; i_3++) {
                    A[i_1+1][i_2][i_2][i_3+2] = D[i_1][i_0][i_3+1][i_0] + D[i_3+1][i_2][i_1+i_0][i_1+i_0] * A[i_1+2][i_0-1][i_0-1][i_3+3] - 6;
                }
            }
        }
        B[i_0+1] = E[i_0-1] - E[i_0] - F[i_0-2] - E[i_0] * B[i_0+2] * B[i_0] - B[i_0] + 4;
    }
        ...
        for (int i_5 = 3; i_5 < min(i_4, -i_4+PB_L); i_5++) {
            for (int i_6 = 0; i_6 < -i_4+PB_P-2; i_6++) {
                for (int i_7 = 1; i_7 < i_4; i_7++) {
                    C[i_4][i_5-2][i_7][i_5] = D[i_7-1][i_5][i_6+i_4+2][i_4+1] - G[i_4][i_6][i_7+2][i_5] * G[i_7-1][i_6][i_5-1][i_4+2] + H[i_7][i_5+i_4][0] * G[i_7][i_6][i_5][i_4] + H[i_6+1][i_5][i_6] + G[i_5][i_4][i_7][i_6] + I[i_7][i_5][i_6+1] + C[i_4][i_5-3][i_6][i_5-1] + C[i_4-1][i_5-1][i_7-1][i_5+1] - C[i_4+1][i_5-2][i_7][i_5] * C[i_4][i_5-1][i_7][i_5+1] + 5;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4316252311_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
