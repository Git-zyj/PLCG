...
void kernel_4214211223_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-3; i_0++) {
        A[i_0+1] = C[i_0+1] * C[i_0] * A[i_0+3] - A[i_0-1] + 1;
    }
...
kernel_4214211223_01(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
