...
void kernel_4422352123_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,int wg,DATA_TYPE POLYBENCH_5D(G,xG,yG,zG,vG,wG,xg,yg,zg,vg,wg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,int zk,int vk,int wk,DATA_TYPE POLYBENCH_5D(K,xK,yK,zK,vK,wK,xk,yk,zk,vk,wk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl),int xm,int ym,DATA_TYPE POLYBENCH_2D(M,xM,yM,xm,ym),int xn,int yn,int zn,DATA_TYPE POLYBENCH_3D(N,xN,yN,zN,xn,yn,zn)){
        ...
        for (int i_1 = 2; i_1 < PB_M; i_1++) {
            for (int i_2 = 2; i_2 < min(-i_1+PB_L-1, -i_0+PB_L+1); i_2++) {
                for (int i_3 = 0; i_3 < PB_M; i_3++) {
                    A[i_2][i_0][i_1+1][i_3] = E[i_1][i_2][i_0][i_1-2] * F[i_3][i_1][i_2+i_0-1][i_0] + G[i_1][i_2][i_3][i_2][i_3] - H[i_1][i_0+1][i_2-1] * A[i_3][i_1+1][i_0+1][i_2+1] - A[i_2+1][i_3][i_1+1][i_0+2] - 1;
                }
                for (int i_4 = 0; i_4 < -i_1+PB_M; i_4++) {
                    B[i_4+i_1][i_2+i_0-1][i_4] = E[i_4+i_2+2][i_0-1][2][i_1] * E[i_0][i_2][i_1+2][i_4] * F[i_1][i_0-2][i_4][0] + I[i_4+1][i_0][i_2+1] * J[i_4][i_0-2][i_2+i_1+1][i_1] - J[i_4][i_0][i_2-2][i_1] + K[i_2+1][i_0+1][i_4][i_1][i_2-2] * E[i_4][i_1][i_0-2][i_2] + I[i_2-1][i_4+2][i_1] - 5;
                }
            }
        }
        for (int i_5 = 0; i_5 < -i_0+PB_M; i_5++) {
            C[i_5+i_0][0] = H[i_5][i_0-2][0] - L[i_5][i_0+1] - M[i_5][1] * M[i_5][i_0] + C[i_5+i_0-3][0] * 3;
        }
    }
    for (int i_6 = 3; i_6 < PB_L-2; i_6++) {
        for (int i_7 = 0; i_7 < -i_6+PB_L-2; i_7++) {
            for (int i_8 = 0; i_8 < PB_M-1; i_8++) {
                D[i_6-2][i_8+i_7][i_6] = I[i_7][i_8+1][i_7+i_6+2] + N[i_7][i_8][i_6] * D[i_6-3][i_8+i_7][i_6-1] - 1;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,wk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M), xn,yn,zn,POLYBENCH_ARRAY(N), INIT_SEED);
kernel_4422352123_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,wk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M), xn,yn,zn,POLYBENCH_ARRAY(N));
