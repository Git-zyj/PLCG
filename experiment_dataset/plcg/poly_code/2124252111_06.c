...
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-2; i_0++) {
        A[i_0] = B[i_0-1] + C[i_0] + B[1] - C[i_0+2] + B[i_0] * A[i_0+1] + 6;
    }
#pragma endscop
...
kernel_2124252111_06(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
