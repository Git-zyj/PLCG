...
void kernel_2212211321_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        A[i_0] = C[i_0] + A[i_0+1] + B[0] * 6;
    }
    for (int i_1 = 1; i_1 < PB_M; i_1++) {
        B[0] = C[i_1-1] * B[0] - B[0] * B[0] - 2;
    }
#pragma endscop
...
kernel_2212211321_06(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
