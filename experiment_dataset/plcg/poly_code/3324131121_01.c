    ...
    for (int i_3 = 1; i_3 < PB_M; i_3++) {
        for (int i_4 = 1; i_4 < PB_M+1; i_4++) {
            for (int i_5 = 1; i_5 < PB_L; i_5++) {
                B[i_3][i_4-1][i_5] = D[i_5][i_5][i_3-1] + D[i_5-1][i_5-1][i_3] + E[i_3][i_4-1] - 2;
            }
        }
    }
    for (int i_6 = 1; i_6 < PB_L; i_6++) {
        for (int i_7 = 2; i_7 < PB_N-1; i_7++) {
            for (int i_8 = 0; i_8 < -i_7+PB_N-1; i_8++) {
                C[i_7][i_6][i_6+1] = E[i_8][i_7-1] * D[i_6][i_7][i_6-1] + E[i_8+i_7+1][i_6] * D[i_6][i_8][i_7] - C[i_7-2][i_6][i_6+1] - 5;
            }
        }
    }
#pragma endscop
...
kernel_3324131121_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
