...
void kernel_2416212313_01(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        ...
        C[i_0-1] = E[i_0] - C[i_0-2] - 6;
    }
    for (int i_3 = 0; i_3 < PB_N-2; i_3++) {
        D[i_3+1] = D[i_3] - D[i_3+2] - D[i_3] + 5;
    }
#pragma endscop
...
kernel_2416212313_01(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
