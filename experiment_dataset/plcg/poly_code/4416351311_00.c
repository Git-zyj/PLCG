...
void kernel_4416351311_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,DATA_TYPE POLYBENCH_1D(M,xM,xm),int xn,int yn,DATA_TYPE POLYBENCH_2D(N,xN,yN,xn,yn)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_M-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_M; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_2+PB_Q+1, PB_M-1); i_3++) {
                    A[i_0][i_2][i_3] = E[i_3-1][i_0-1][i_1+1][i_0] * F[i_1][i_0][i_3][i_2] * G[i_3+1][i_2-1][i_0] - H[i_0][i_1][i_3+i_2-1][i_1-1] + A[i_0-1][i_3][i_1] + A[i_2][i_1][i_3+1] + A[i_1+1][i_3][i_2] - A[i_1+1][i_2][i_3-1] + A[i_1][i_2+1][i_0] - 1;
                }
            }
            B[i_1+i_0][i_1+i_0] = I[i_1][i_0] - J[i_0][i_1] + J[i_0][i_1+1] - B[i_1+i_0+1][i_1+i_0+1] + B[i_1+i_0-1][i_1+i_0-1] + B[i_1+i_0-1][i_1+i_0-1] + 4;
        }
    }
    for (int i_4 = 1; i_4 < PB_M; i_4++) {
        C[i_4] = K[i_4] * L[i_4] - M[i_4] - K[0] + K[1] - M[i_4] * 1;
        for (int i_5 = 1; i_5 < min(-i_4+PB_N, PB_M-1); i_5++) {
            D[i_5][i_4] = J[i_4-1][i_5] - N[i_5+1][i_4] + N[i_5+i_4][i_4] - J[i_5][i_4] - I[i_5+1][i_4] - C[i_5] * D[i_5-1][i_4-1] * D[i_5+1][i_4-1] + D[i_4][i_5+1] - 4;
        }
    }
#pragma endscop
