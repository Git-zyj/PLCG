...
void kernel_4226152115_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-2; i_0++) {
        B[i_0+2] = C[i_0] + C[i_0-1] - C[i_0] - C[i_0] * C[i_0] * 5;
    }
    for (int i_1 = 0; i_1 < PB_M; i_1++) {
        for (int i_2 = 1; i_2 < PB_M-3; i_2++) {
            B[i_2+2] = C[i_2+2] + C[i_1] + C[i_2-1] - C[i_2] + C[i_2] * B[i_2+3] - 5;
        }
    }
#pragma endscop
...
kernel_4226152115_05(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
