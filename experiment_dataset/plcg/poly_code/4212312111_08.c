...
void kernel_4212312111_08(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            ...
            for (int i_3 = 1; i_3 < PB_M; i_3++) {
                B[i_3][i_1][i_0] = C[i_0][i_1][i_3] - B[i_0][i_1][i_3-1] * 6;
            }
        }
    }
#pragma endscop
...
kernel_4212312111_08(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
