...
void kernel_3234112123_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
...
#pragma scop
    for (int i_0 = 3; i_0 < PB_Q+1; i_0++) {
        ...
        for (int i_3 = 3; i_3 < PB_M-2; i_3++) {
            for (int i_4 = 2; i_4 < min(min(PB_Q+2, -i_3+PB_L+3), -i_0+PB_L+1); i_4++) {
                B[i_3+2][i_4+i_0-1][i_4-2] = C[i_3][i_4][i_0] - B[i_3+2][i_4+i_0-3][i_4-2] * B[i_0+2][i_4+i_3-3][i_4-2] * 5;
            }
        }
    }
#pragma endscop
...
kernel_3234112123_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
