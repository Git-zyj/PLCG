...
void kernel_3324211325_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        ...
        B[i_0] = B[i_0+2] - B[i_0-1] - C[i_0] * C[i_0-2] + 1;
        for (int i_2 = i_0; i_2 < -i_0+PB_M; i_2++) {
            C[i_2] = D[i_2+i_0][1] + B[i_2] - 3;
        }
    }
#pragma endscop
...
kernel_3324211325_05(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
