...
void kernel_2316152115_02(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        C[i_0-2] = D[i_0] + D[i_0] * D[i_0-1] - 4;
        C[i_0-1] = D[0] * D[i_0] * D[i_0] - 2;
    }
    for (int i_1 = 3; i_1 < PB_M-1; i_1++) {
        C[i_1-2] = D[i_1] - D[i_1-2] - D[i_1] - D[i_1] * D[i_1+1] * D[i_1] * D[i_1] * D[i_1+1] * C[i_1-3] + 6;
    }
#pragma endscop
...
kernel_2316152115_02(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
