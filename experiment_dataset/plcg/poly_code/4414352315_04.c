...
void kernel_4414352315_04(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk)){
        ...
        for (int i_1 = max(2, i_0); i_1 < PB_L; i_1++) {
            for (int i_2 = 2; i_2 < PB_L; i_2++) {
                for (int i_3 = 1; i_3 < -i_1+PB_M; i_3++) {
                    B[i_3][i_1][i_1][i_2-2] = E[i_3][i_0][i_2][i_1] - E[i_3+i_1][i_0-1][i_2][i_1] * E[i_3][i_2-2][i_0][i_1] - F[i_3][i_2][i_1-2][i_0] * G[i_2-1][i_0+2][i_1][i_3] + F[i_2][i_0][i_3][i_1] + G[i_1][i_0-1][i_0][i_2] - F[i_2][i_0+2][i_1][i_0] * G[i_2][i_3-1][i_3][i_1-2] - 2;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_N; i_4++) {
        for (int i_5 = 2; i_5 < PB_L; i_5++) {
            for (int i_6 = 2; i_6 < PB_L-1; i_6++) {
                for (int i_7 = 1; i_7 < min(-i_5+PB_Q+2, i_5); i_7++) {
                    B[i_5][i_6][i_6][i_4-2] = E[i_7+1][i_6-2][i_5][i_4] - G[i_5][i_6-1][i_4+1][i_7+i_5-2] + B[i_5+1][i_7][i_7][i_6-2] * B[i_7-1][i_6+1][i_6+1][i_5-2] + 2;
                }
            }
        }
        C[i_4] = H[i_4-2] * I[0] - J[i_4] - H[i_4] * C[i_4+1] + C[i_4-1] + C[i_4+1] - 3;
        for (int i_8 = i_4; i_8 < -i_4+PB_Q; i_8++) {
            for (int i_9 = 0; i_9 < -i_8+PB_M-1; i_9++) {
                for (int j_0 = 0; j_0 < PB_L; j_0++) {
                    B[i_8+1][i_9][i_9][i_4-2] = F[i_9+i_8+1][j_0][i_8+i_4][j_0] * K[i_9][j_0][i_8] - G[i_9][j_0][i_4][0] + 6;
                }
            }
        }
    }
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4414352315_04(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K)));
