...
void kernel_4232312323_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = i_0; i_1 < PB_M-3; i_1++) {
            for (int i_2 = 2; i_2 < PB_L; i_2++) {
                for (int i_3 = 2; i_3 < PB_M; i_3++) {
                    A[i_1+2][i_2-2][i_2] = C[i_1][i_3][i_2] + A[i_1+3][i_2-2][i_2] - A[i_0][i_3-2][i_3] + A[i_1+2][i_2-1][i_2+1] * 5;
                }
            }
        }
    }
    for (int i_4 = 3; i_4 < PB_M; i_4++) {
        B[i_4-2] = B[i_4-3] - B[i_4] * 4;
    }
#pragma endscop
...
kernel_4232312323_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
