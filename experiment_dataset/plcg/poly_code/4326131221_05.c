...
void kernel_4326131221_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 1; i_1 < min(-i_0+PB_L, i_0); i_1++) {
            for (int i_2 = 0; i_2 < min(-i_1+PB_M-1, i_0); i_2++) {
                A[i_0+1][i_2][i_2] = D[i_1][i_1+i_0][0] + E[i_0+1][i_2][i_0-1][i_1] * D[i_2+i_1+1][i_0-1][0] - A[i_2+2][i_0][i_0] + A[i_0+1][i_1-1][i_1-1] - 6;
            }
        }
    }
        ...
        for (int i_4 = 1; i_4 < i_3; i_4++) {
            for (int i_5 = 1; i_5 < PB_P-1; i_5++) {
                for (int i_6 = 1; i_6 < PB_M-3; i_6++) {
                    B[i_6+1][i_3+1][i_5] = E[i_5][i_4][i_6-1][i_3] - D[i_4-1][i_6-1][i_6] - B[i_3+3][i_5][i_6] + B[i_6-1][i_4+1][i_5+1] - B[i_5-1][i_3+1][i_6+1] - B[i_6+3][i_4+1][i_5] - 6;
                }
            }
        }
        for (int i_7 = 0; i_7 < min(-i_3+PB_N-1, i_3); i_7++) {
            for (int i_8 = max(1, i_7); i_8 < min(-i_3+PB_L, PB_M); i_8++) {
                C[i_3][i_7][i_8] = F[i_8-1][i_7+i_3+1] + D[i_8][i_8+i_3][i_3] * F[i_7][i_8] + 1;
            }
        }
    }
#pragma endscop
...
kernel_4326131221_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
