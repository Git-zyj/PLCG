...
void kernel_4222332115_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
        ...
        for (int i_1 = 2; i_1 < PB_Q; i_1++) {
            for (int i_2 = 2; i_2 < PB_M; i_2++) {
                for (int i_3 = 1; i_3 < -i_2+PB_M; i_3++) {
                    A[i_1-1][i_3][i_2-1][i_0] = C[i_3+i_2][i_0][i_1-2] * A[i_3-1][i_0][i_2-2][i_1] + 4;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < PB_M-2; i_5++) {
            for (int i_6 = 1; i_6 < min(PB_P-2, i_5); i_6++) {
                for (int i_7 = 0; i_7 < -i_5+PB_M-2; i_7++) {
                    A[i_5-1][i_7][i_6-1][i_4] = D[i_7][i_7][i_5+2][i_4+1] - E[i_7+1][i_5][i_6][i_4][1] * D[i_7+i_5+2][i_6-1][i_4][i_6] + F[i_6][i_4][i_6+2] - 1;
                }
            }
        }
    }
...
kernel_4222332115_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
