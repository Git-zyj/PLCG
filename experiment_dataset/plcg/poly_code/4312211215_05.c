...
void kernel_4312211215_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_L; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_2+PB_L-1, -i_1+PB_L+1); i_3++) {
                    A[i_3][i_2+i_1][0] = A[i_2][i_3+i_1-1][0] + A[i_1][i_3+i_2+1][0] + A[i_1][i_3+i_2+1][0] * A[i_1+1][i_3+i_2][0] + 2;
                }
            }
        }
        for (int i_4 = 1; i_4 < -i_0+PB_M+1; i_4++) {
            B[i_4-1][i_0] = D[i_4][i_0+1] + D[i_4+i_0-1][1] * B[i_4][i_0-1] * 2;
        }
        C[i_0+1] = C[i_0] + 6;
    }
#pragma endscop
...
kernel_4312211215_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
