...
void kernel_4212111115_09(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
        ...
        for (int i_4 = 0; i_4 < -i_3+PB_P; i_4++) {
            for (int i_5 = 0; i_5 < PB_P-2; i_5++) {
                for (int i_6 = 0; i_6 < PB_M; i_6++) {
                    B[i_4][i_3+1][i_6][i_5+1] = C[i_6][i_4+i_3][i_4][i_5] - A[i_6][i_5+1] - B[i_4][i_3][i_6][i_5+2] - 2;
                }
            }
        }
    }
...
kernel_4212111115_09(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
