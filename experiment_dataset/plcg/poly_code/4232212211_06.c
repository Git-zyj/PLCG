...
void kernel_4232212211_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
...
#pragma scop
        ...
        for (int i_1 = 2; i_1 < PB_M; i_1++) {
            for (int i_2 = 2; i_2 < PB_N+2; i_2++) {
                for (int i_3 = 2; i_3 < min(-i_1+PB_M, i_1); i_3++) {
                    A[i_3-2][i_2][i_2][i_0] = C[i_2-2][i_3+i_1][i_0+1] - A[i_3-2][i_1-1][i_1-1][i_0] - A[i_1-2][i_0+1][i_0+1][i_3] - 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        for (int i_5 = 0; i_5 < i_4; i_5++) {
            B[i_4][i_5] = B[i_5][i_4+1] + B[i_4-1][i_5] * 3;
        }
    }
#pragma endscop
...
kernel_4232212211_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
