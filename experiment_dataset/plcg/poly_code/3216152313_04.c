...
void kernel_3216152313_04(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-2; i_0++) {
        B[i_0] = C[i_0] + C[i_0] * C[i_0+2] + C[i_0] - C[i_0] + C[i_0] + 5;
    }
    for (int i_1 = PB_M-1 - 1; i_1 >= 1; i_1--) {
        B[i_1] = C[i_1] * C[i_1+1] - C[i_1] + C[i_1] * B[i_1+1] - B[i_1-1] - B[i_1+1] + 6;
    }
#pragma endscop
...
kernel_3216152313_04(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
