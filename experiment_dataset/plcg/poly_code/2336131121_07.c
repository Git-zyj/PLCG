...
void kernel_2336131121_07(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_N-2; i_1++) {
        C[i_1+2] = D[i_1] * D[i_1+1] - D[i_1+1] * D[i_1] * D[i_1+1] - C[i_1] - 3;
        C[i_1] = D[i_1+1] * 3;
    }
#pragma endscop
...
kernel_2336131121_07(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
