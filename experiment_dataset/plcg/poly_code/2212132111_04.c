...
void kernel_2212132111_04(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_Q-3; i_0++) {
        for (int i_1 = 3; i_1 < min(PB_Q-3, -i_0+PB_N); i_1++) {
            B[i_0-2][i_1+1][i_1+3] = C[i_1][i_0+1] - C[i_0-1][0] * C[i_1+1][i_0] * 3;
            B[i_0-2][i_1][i_1+2] = C[i_0-1][i_1] - C[i_1-2][i_0] - C[i_1+i_0][i_1] - B[i_1-3][i_0+1][i_0+3] + 3;
        }
    }
#pragma endscop
...
kernel_2212132111_04(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
