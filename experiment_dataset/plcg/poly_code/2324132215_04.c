...
void kernel_2324132215_04(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        B[i_0+1] = D[0] - B[i_0+1] + 2;
        B[i_0] = D[i_0-2] * D[i_0] * D[i_0] - D[i_0-2] + B[i_0-1] - 5;
        B[i_0] = D[i_0] - D[i_0] - 5;
    }
#pragma endscop
...
kernel_2324132215_04(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
