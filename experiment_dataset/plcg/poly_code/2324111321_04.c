...
void kernel_2324111321_04(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        C[i_0+1] = D[i_0] - C[i_0] - C[i_0-2] - 3;
        C[i_0-2] = 6;
    }
...
kernel_2324111321_04(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
