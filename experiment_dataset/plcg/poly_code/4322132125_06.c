        ...
        for (int i_1 = 0; i_1 < min(i_0, PB_M-2); i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_L; i_2++) {
                for (int i_3 = 0; i_3 < i_1; i_3++) {
                    A[i_2][i_1][i_3][i_0-1] = D[i_1+2][i_3][i_2+i_0][i_0] - 3;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        B[i_4-1] = E[i_4] + E[i_4] - B[i_4+1] * 2;
    }
    for (int i_5 = 2; i_5 < PB_Q; i_5++) {
        for (int i_6 = 2; i_6 < PB_L; i_6++) {
            for (int i_7 = 2; i_7 < -i_6+PB_P+1; i_7++) {
                for (int i_8 = 3; i_8 < min(-i_5+PB_M, -i_6+PB_L); i_8++) {
                    C[i_5][i_8-1][i_7+i_6-1][i_8+1] = D[i_8+2][i_5][i_6][i_7] * D[i_8][i_5][i_6][i_5] * F[i_7-2][i_8+i_6][i_5] - D[i_8][i_5-1][i_6][i_6] * D[i_8+i_5][i_6][i_7-2][0] - C[i_5-1][i_8-1][i_7+i_6-2][i_8+1] * C[i_5-2][i_8-3][i_7+i_6-1][i_8-1] + 6;
                }
            }
        }
    }
...
kernel_4322132125_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
