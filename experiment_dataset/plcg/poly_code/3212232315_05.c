...
void kernel_3212232315_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M-2; i_0++) {
        A[i_0-2] = C[i_0] * D[i_0-2] - C[i_0] - A[i_0-3] + 6;
        A[i_0-2] = D[2] * C[i_0+2] * A[i_0-2] + A[i_0-1] + 3;
    }
#pragma endscop
...
kernel_3212232315_05(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
