    ...
    for (int i_1 = 2; i_1 < PB_L; i_1++) {
        for (int i_2 = i_1; i_2 < PB_L; i_2++) {
            for (int i_3 = 2; i_3 < i_2; i_3++) {
                C[i_2-1][i_1-1][i_3+2] = F[i_2][i_3-2] * G[i_3][i_1-2][i_2] - 1;
            }
            for (int i_4 = 0; i_4 < PB_L; i_4++) {
                C[i_2-1][i_1][i_4+2] = H[i_1][i_2] * G[i_4][i_1][i_2] + C[i_2][i_1+1][i_4+2] - C[i_2-1][i_1][i_4+3] * 6;
            }
        }
    }
#pragma endscop
...
kernel_3314332311_04(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
