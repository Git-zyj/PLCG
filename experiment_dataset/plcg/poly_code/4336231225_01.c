...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_0+PB_L, i_0); i_2++) {
                for (int i_3 = 0; i_3 < -i_1+PB_L; i_3++) {
                    C[i_2][i_1][i_3] = D[i_3+i_2][i_3+i_1][i_0][i_2+1] * E[i_2][i_1-1][i_3][i_0] - D[i_1][i_2+i_0][i_0][i_3+1] - C[i_1-1][i_3][i_2] - 1;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 0; i_5 < PB_L-2; i_5++) {
            B[i_4][i_5] = F[i_5+1][i_4+1] - G[i_4][i_5+1] + B[i_4][i_5+2] - B[i_4+1][i_5] - 1;
        }
        for (int i_6 = 0; i_6 < PB_L-1; i_6++) {
            for (int i_7 = i_4; i_7 < PB_L; i_7++) {
                C[i_4-1][i_7][i_6] = H[i_7][i_4][i_6] * I[i_6+1][i_4-1][i_7] + 2;
            }
        }
    }
#pragma endscop
...
init_array(xc,yc,zc,POLYBENCH_ARRAY(C), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4336231225_01(xc,yc,zc,POLYBENCH_ARRAY(C), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xc,yc,zc,POLYBENCH_ARRAY(C), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
