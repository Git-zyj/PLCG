...
void kernel_2226312315_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M+1; i_0++) {
        for (int i_1 = 0; i_1 < min(min(PB_M, i_0), -i_0+PB_L-1); i_1++) {
            A[i_1+i_0] = C[i_1] - A[i_1+i_0-1] * A[i_1+i_0-1] - A[i_1+i_0+1] - A[i_1+i_0-2] - 1;
        }
...
kernel_2226312315_03(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
