...
#pragma scop
    ...
    for (int i_6 = 1; i_6 < PB_M+1; i_6++) {
        for (int i_7 = 0; i_7 < PB_M-1; i_7++) {
            A[i_7] = F[i_6][i_7+1] - G[i_7+2][i_6][i_6-1] - F[i_6+1][i_7] + F[i_6][i_7] * 5;
        }
    }
#pragma endscop
...
kernel_4436132323_04(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
