...
#pragma scop
        ...
        for (int i_2 = 0; i_2 < min(-i_1+PB_L, i_1); i_2++) {
            for (int i_3 = 2; i_3 < PB_L-1; i_3++) {
                for (int i_4 = 0; i_4 < min(-i_1+PB_M-1, -i_3+PB_M-2); i_4++) {
                    B[i_4+i_3][i_2+i_1][i_4][i_2+1] = G[i_1][i_2][i_4][i_3+1] * G[i_4+i_3][i_1-1][i_2][i_2] * G[i_4+i_2][i_3][i_2+i_1][1] + H[i_2][i_4+1][i_1][i_1+1][i_1] * I[i_3-1][i_4][i_1][i_2+1] - I[i_3][i_1][i_4][i_2+1] + B[i_4+i_3+1][i_2+i_1][i_3+1][i_2+1] - B[i_4+i_3-2][i_2+i_1][i_4][i_2+1] * B[i_4+i_1+1][i_3+i_2][i_1-1][i_2] - B[i_4+i_3+2][i_2+i_1][i_4+2][i_2+1] + 4;
                }
            }
        }
        for (int i_5 = 0; i_5 < min(-i_1+PB_L, i_1); i_5++) {
            for (int i_6 = 0; i_6 < PB_M-1; i_6++) {
                for (int i_7 = 0; i_7 < min(-i_6+PB_M, PB_L); i_7++) {
                    B[i_7+i_6][i_5+i_1][i_7][i_1+1] = G[i_5][i_7][i_1][i_5] - J[i_6+1][i_7][i_5+i_1] - 1;
                }
            }
        }
    }
    for (int i_8 = 2; i_8 < PB_P-1; i_8++) {
        for (int i_9 = 1; i_9 < PB_L-1; i_9++) {
            for (int j_0 = 0; j_0 < min(min(i_9, -i_8+PB_P-1), -i_9+PB_M); j_0++) {
                D[i_9][j_0][j_0+i_8] = K[j_0+i_9][j_0+i_8+1] - L[i_9-1][i_8][j_0+i_9] + L[i_9+1][i_8][0] * J[i_9][j_0+i_8-1][i_8] + J[i_9+1][0][i_8+1] - K[j_0][i_9] + D[i_9+1][j_0][j_0+i_8] * D[i_9][j_0][j_0+i_8-2] * 2;
            }
        }
    }
#pragma endscop
...
kernel_4424251323_01(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L));
