...
void kernel_3216212313_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_Q+2; i_0++) {
        for (int i_1 = 2; i_1 < PB_Q-1; i_1++) {
            for (int i_2 = 2; i_2 < i_1; i_2++) {
                A[i_0-1][i_2+2][i_1-2][i_2] = A[i_1-2][i_2+2][i_0-2][i_2] - A[i_0-2][i_1+3][i_2-2][i_1+1] + A[i_0-1][i_2+1][i_1-2][i_2-1] * A[i_0-1][i_2+3][i_1-2][i_2+1] - 3;
            }
        }
...
kernel_3216212313_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
