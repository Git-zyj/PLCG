...
void kernel_2322212113_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
            B[i_0] = 3;
            B[i_1+1] = D[i_1-2] - B[i_1+2] * 4;
        }
    }
...
kernel_2322212113_06(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
