        ...
        for (int i_1 = 2; i_1 < -i_0+PB_Q-1; i_1++) {
            for (int i_2 = 2; i_2 < PB_L; i_2++) {
                for (int i_3 = 1; i_3 < PB_Q-1; i_3++) {
                    A[i_1][i_2-1][i_3][i_1+i_0] = D[i_2][i_0][i_1][i_3] + A[i_1-1][i_2-2][i_3][i_1+i_0-3] - A[i_1][i_2-1][i_3+1][i_1+i_0+1] * A[i_1-2][i_2-1][i_3][i_1+i_0-2] - A[i_1+1][i_2-1][i_3-1][i_1+i_0+1] * 3;
                }
            }
        }
        B[i_0] = B[i_0+2] - 3;
    ...
    for (int i_4 = 2; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 1; i_5 < i_4; i_5++) {
            for (int i_6 = 2; i_6 < PB_Q-2; i_6++) {
                C[i_5][i_6][i_6+1][i_4] = E[i_4+1][i_6][0] - E[i_6-2][i_4+2][i_5] * C[i_5-1][i_6+1][i_6+2][i_4-2] - 6;
            }
        }
    }
#pragma endscop
...
kernel_4316112221_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
