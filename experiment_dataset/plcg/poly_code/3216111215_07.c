...
void kernel_3216111215_07(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_0 = 1; i_0 < PB_P; i_0++) {
        for (int i_1 = 1; i_1 < min(min(i_0, PB_P-2), -i_0+PB_P); i_1++) {
            for (int i_2 = 1; i_2 < min(-i_1+PB_P-2, -i_0+PB_P); i_2++) {
                A[i_2+i_0+1][i_1][i_1+i_0] = C[i_2-1][i_2+i_0][i_1-1] + A[i_2+i_0+3][i_1+1][i_2+i_1+2] - A[i_2+i_0+2][i_1-1][i_1+i_0-1] - 4;
            }
        }
        for (int i_3 = 0; i_3 < -i_0+PB_P; i_3++) {
            for (int i_4 = 0; i_4 < i_3; i_4++) {
                A[i_4+i_0+1][i_3][i_3+i_0] = C[i_3+i_0][i_4][i_3] * 5;
            }
        }
    }
#pragma endscop
...
kernel_3216111215_07(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C));
