...
void kernel_4334351125_01(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 1; i_3 < -i_2+PB_P; i_3++) {
                    B[i_2][i_3][i_1] = D[i_3-1][i_0-1][i_2-1][i_1] + D[i_0+1][i_2+1][i_1][1] - E[i_1+1][i_3+i_2][i_0-1][i_2] * F[i_2][i_1-1][i_0][i_2] * E[i_1-1][i_3-1][i_0-1][i_1] * 5;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < min(i_4, PB_Q-1); i_5++) {
            for (int i_6 = 1; i_6 < min(-i_5+PB_L+1, PB_P); i_6++) {
                for (int i_7 = 0; i_7 < PB_M-1; i_7++) {
                    B[i_4][i_7][i_6] = F[i_6][i_6][i_7][i_5] - F[i_7][i_5][i_5-1][i_6-1] - G[i_7+1][i_6][i_5] - E[i_4][i_6-1][i_7][i_5] * E[i_5][i_7][i_4][i_6] * F[i_6+i_5-1][i_4][i_7][i_5+1] * B[i_5][i_7][i_6-1] + 6;
                }
            }
        }
    }
    for (int i_8 = 0; i_8 < PB_Q; i_8++) {
        for (int i_9 = 1; i_9 < PB_L-1; i_9++) {
            for (int j_0 = 0; j_0 < min(i_8, PB_L-2); j_0++) {
                B[i_8][i_9-1][j_0+2] = H[i_9+1][j_0][i_8] * H[j_0+1][i_9][i_8] - G[i_9][i_8][j_0+1] + 6;
            }
        }
    }
#pragma endscop
...
init_array(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4334351125_01(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H)));
