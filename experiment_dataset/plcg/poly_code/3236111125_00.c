...
void kernel_3236111125_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    ...
    for (int i_2 = 0; i_2 < PB_L; i_2++) {
        for (int i_3 = 1; i_3 < i_2; i_3++) {
            for (int i_4 = max(0, -i_3+1); i_4 < min(PB_L, -i_3+PB_L+1); i_4++) {
                A[i_4][1] = C[i_4][i_4+i_3-1] * 5;
            }
        }
    }
#pragma endscop
...
kernel_3236111125_00(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C));
