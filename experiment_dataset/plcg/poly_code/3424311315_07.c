...
void kernel_3424311315_07(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        C[i_0] = E[i_0-1] * C[i_0] * C[i_0+1] - 5;
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            for (int i_2 = i_0; i_2 < PB_M; i_2++) {
                B[i_0-1][i_2-1] = B[i_1-2][i_2-1] * B[i_1][i_2-1] + B[i_1-1][i_2] + 6;
            }
        }
        C[i_0] = 2;
        C[i_0-1] = 6;
...
kernel_3424311315_07(xc,POLYBENCH_ARRAY(C), xb,yb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E));
