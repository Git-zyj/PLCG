        ...
        for (int i_1 = 2; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 2; i_2 < PB_L-2; i_2++) {
                for (int i_3 = 2; i_3 < PB_L-2; i_3++) {
                    A[i_0][i_3+2][i_2][i_3-2] = C[i_3+2][i_2][2][i_3-1] + D[i_0][i_3][i_1][i_2] * D[i_3][i_2-2][i_0+1][i_0] + D[i_3-1][i_0][i_3][i_2+2] * A[i_0+1][i_1+2][i_2][i_1-2] - A[i_0+1][i_3+2][i_1][i_3-2] * 2;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        B[i_4] = E[i_4] + E[i_4] * B[i_4+1] - B[i_4-1] - B[i_4-1] * B[i_4+1] * 4;
    }
#pragma endscop
...
kernel_4212232311_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
