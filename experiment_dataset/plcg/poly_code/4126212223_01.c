...
void kernel_4126212223_01(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = i_0; i_1 < PB_M; i_1++) {
            for (int i_2 = 4; i_2 < PB_L; i_2++) {
                A[0][i_2-2] = B[i_2][i_1] - A[0][i_2-4] - A[0][i_2] - 5;
            }
        }
    }
#pragma endscop
...
kernel_4126212223_01(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B));
