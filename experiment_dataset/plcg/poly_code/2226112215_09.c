...
void kernel_2226112215_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M; i_0++) {
        B[i_0-2] = 4;
        B[i_0-2] = C[2] - C[i_0] * B[i_0-1] + B[i_0-3] - 5;
    }
#pragma endscop
...
kernel_2226112215_09(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
