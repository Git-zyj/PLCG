...
void kernel_2326212315_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        A[i_0-2] = D[2] - D[2] - B[i_0-1] - 3;
    ...
    for (int i_2 = 0; i_2 < PB_M; i_2++) {
        for (int i_3 = 3; i_3 < min(i_2, PB_M-1); i_3++) {
            B[i_3+1] = A[i_3-2] + A[i_3-3] - A[i_3-1] + 4;
        }
    }
#pragma endscop
...
kernel_2326212315_03(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
