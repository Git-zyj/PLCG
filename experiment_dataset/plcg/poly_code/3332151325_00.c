    ...
    for (int i_3 = 1; i_3 < PB_L-1; i_3++) {
        for (int i_4 = 1; i_4 < min(-i_3+PB_Q-1, PB_M-1); i_4++) {
            for (int i_5 = 1; i_5 < PB_L; i_5++) {
                C[i_3-1][i_4] = D[i_5][i_3][0] - E[i_4][i_5-1][i_3][i_4+i_3+1] * D[i_5][i_3][i_4-1] + D[i_3][i_4-1][i_5+1] - C[i_4][i_5+2] * C[i_3][i_5] - C[i_3-1][i_4-1] - 6;
            }
            C[i_3][i_4] = F[i_3] - G[i_4+1][i_3+1] * G[i_4][i_3] + G[i_3-1][i_4] - 2;
        }
    }
#pragma endscop
...
kernel_3332151325_00(xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
