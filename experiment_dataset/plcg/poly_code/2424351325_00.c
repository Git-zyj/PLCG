...
void kernel_2424351325_00(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        B[i_0+1][i_0] = E[i_0-1] - F[i_0] * E[i_0] * 5;
    }
    for (int i_1 = 3; i_1 < PB_L-1; i_1++) {
        for (int i_2 = 0; i_2 < PB_N-1; i_2++) {
            B[i_1][i_1-1] = G[i_2+1][i_1+1] * H[i_1][0] - H[i_2][i_1] * H[i_1+1][i_2] - I[i_2][i_1+1] + G[i_2][i_1] - B[i_1+2][i_1+1] + B[i_1-2][i_1-3] * B[i_1+1][i_1] - 2;
        }
    }
    for (int i_3 = 1; i_3 < PB_L; i_3++) {
        for (int i_4 = 1; i_4 < PB_L; i_4++) {
            B[i_4][i_4-1] = I[i_4-1][i_3] - H[i_4][i_3] + G[i_4][i_3] - I[i_4][i_4] + I[i_4-1][i_3] * 6;
        }
        B[i_3][i_3-1] = J[i_3] + E[i_3] * J[i_3-1] * F[i_3] - J[i_3] + 2;
    }
#pragma endscop
...
kernel_2424351325_00(xb,yb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
