...
void kernel_2314152323_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_L; i_0++) {
        A[i_0] = D[i_0-1] + D[i_0] * D[i_0] * A[i_0-1] * A[i_0+2] * A[i_0+1] - 2;
        for (int i_1 = 4; i_1 < -i_0+PB_L; i_1++) {
            C[i_1-4] = E[i_1+i_0][0] * E[i_1][i_0] + D[i_1] * E[i_0][i_0] - E[i_1][i_0] - D[i_1-2] - C[i_0-3] * C[i_1-2] + 5;
        }
        C[i_0-2] = D[i_0] - D[i_0] - D[i_0+2] + D[i_0] * D[i_0+1] + A[i_0-1] - 5;
    }
#pragma endscop
...
kernel_2314152323_05(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
