...
void kernel_4232111221_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_P; i_0++) {
        for (int i_1 = 1; i_1 < PB_M-2; i_1++) {
            A[i_1] = C[i_1] * A[i_1-1] - A[i_1+2] + 5;
        }
    }
        ...
        for (int i_3 = 0; i_3 < PB_M-2; i_3++) {
            for (int i_4 = 0; i_4 < -i_3+PB_M-2; i_4++) {
                for (int i_5 = 0; i_5 < i_4; i_5++) {
                    B[i_4+i_3][i_5+i_3][i_3] = D[i_5+i_3][i_4+1][i_5][i_2] + B[i_4+i_3+2][i_5+i_3][i_3] - 5;
                }
            }
        }
    }
...
kernel_4232111221_07(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D));
