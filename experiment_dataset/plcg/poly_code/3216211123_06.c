...
void kernel_3216211123_06(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_0 = 2; i_0 < PB_Q-1; i_0++) {
        ...
        for (int i_3 = 0; i_3 < min(PB_N, i_0); i_3++) {
            for (int i_4 = 1; i_4 < PB_N; i_4++) {
                B[i_3][i_4] = C[i_3][i_0+1][i_4-1] + B[i_4][i_0-1] * 2;
            }
        }
    }
#pragma endscop
...
kernel_3216211123_06(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
