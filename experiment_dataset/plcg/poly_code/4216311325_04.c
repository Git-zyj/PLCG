...
void kernel_4216311325_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_4 = 4; i_4 < PB_M-1; i_4++) {
        for (int i_5 = 1; i_5 < min(i_4, -i_4+PB_L); i_5++) {
            for (int i_6 = 0; i_6 < -i_4+PB_M-1; i_6++) {
                B[i_4][i_6+i_4-1][0] = C[i_6+i_4+1][i_5][0] - D[i_6][i_4][i_5] - B[i_4-1][i_6+i_4-4][0] * B[i_4-2][i_6+i_4-1][0] * B[i_4][i_5+i_4][0] + B[i_4+1][i_6+i_4][0] + B[i_5-1][i_6+i_5-1][0] + 1;
            }
        }
    }
#pragma endscop
...
kernel_4216311325_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
