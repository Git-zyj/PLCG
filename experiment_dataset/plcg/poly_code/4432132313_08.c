...
void kernel_4432132313_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M-2; i_0++) {
        A[i_0-2] = E[i_0] * E[i_0] + E[i_0] * E[i_0] - E[0] - A[i_0-1] * A[i_0-3] - 6;
        A[i_0-2] = E[i_0+2] * F[i_0+1][i_0-2] * A[i_0-2] + A[i_0-3] + C[i_0-1] * 3;
    }
    for (int i_1 = 1; i_1 < PB_L; i_1++) {
        C[i_1] = E[i_1+2] - C[i_1-1] - C[i_1+1] - 6;
        for (int i_2 = 1; i_2 < -i_1+PB_L; i_2++) {
            for (int i_3 = 1; i_3 < -i_2+PB_L; i_3++) {
                for (int i_4 = 0; i_4 < i_1; i_4++) {
                    D[i_3][i_4][i_2-1] = G[i_4][i_2+i_1][i_3+i_2] - H[i_4][i_1][i_2+1][i_1] + D[i_2+1][i_4][i_3-1] * 6;
                }
            }
        }
    }
...
kernel_4432132313_08(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
