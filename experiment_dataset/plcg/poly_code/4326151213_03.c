...
void kernel_4326151213_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N; i_0++) {
        B[i_0+1] = D[i_0] - D[i_0] + D[i_0-1] + B[i_0+1] + 2;
    }
    for (int i_1 = 1; i_1 < PB_N-1; i_1++) {
        B[i_1+1] = D[i_1+1] - D[i_1-1] - B[i_1+2] - 4;
        B[i_1+2] = D[i_1] - D[i_1] + D[i_1] - D[i_1] + D[i_1-1] * D[i_1+1] - D[i_1+1] + D[i_1] - D[0] - 3;
    }
#pragma endscop
...
kernel_4326151213_03(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
