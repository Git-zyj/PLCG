...
void kernel_3214111121_09(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < min(-i_0+PB_M, PB_M-1); i_1++) {
            A[i_1+1][i_0+1] = C[i_1+i_0] + 5;
            for (int i_2 = 0; i_2 < i_1; i_2++) {
                A[i_1+1][i_0+3] = A[i_2+1][i_1] - 4;
            }
        }
    }
#pragma endscop
...
kernel_3214111121_09(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
