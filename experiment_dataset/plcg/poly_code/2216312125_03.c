...
void kernel_2216312125_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        for (int i_1 = 0; i_1 < min(i_0, PB_L-2); i_1++) {
            A[i_1] = C[i_1+2] + A[i_1+2] - 6;
        }
    }
...
kernel_2216312125_03(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
