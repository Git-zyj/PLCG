    ...
    for (int i_6 = 2; i_6 < PB_L; i_6++) {
        for (int i_7 = 0; i_7 < PB_L; i_7++) {
            for (int i_8 = 1; i_8 < -i_6+PB_M-1; i_8++) {
                C[i_7+2][i_6+1] = E[i_6][i_8][i_7] + I[i_6+1][i_8+2][i_7+1] - J[i_7][i_8] - G[i_7][i_8][i_6] + G[i_8][i_8+i_6+1][i_7] - E[i_7][i_8-1][i_6] * C[i_8+1][i_6+1] - C[i_8][i_6+2] - 4;
            }
        }
        for (int i_9 = 1; i_9 < min(i_6, -i_6+PB_Q+2); i_9++) {
            for (int j_0 = 2; j_0 < PB_L; j_0++) {
                for (int j_1 = 0; j_1 < -i_6+PB_N; j_1++) {
                    D[j_1+i_6][j_0][i_9][2] = K[j_1][i_9][j_1][j_0] - H[i_9-1][i_6-2][j_1][j_0] - H[j_1][j_0][j_0+1][i_9-1] + E[j_0][j_1][i_9-1] * L[i_9][i_9][j_0-1][i_6] - K[j_0][j_1][i_9][i_9+i_6-2] + D[j_1+i_6][j_0-2][i_9][2] - 6;
                }
            }
        }
    }
