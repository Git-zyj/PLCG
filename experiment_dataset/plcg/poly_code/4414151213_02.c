...
void kernel_4414151213_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        A[i_0] = E[i_0-1] + E[0] + E[i_0-1] * E[i_0] + E[i_0] - E[i_0] - E[i_0] * E[i_0] * A[i_0+1] + A[i_0-1] * 4;
        for (int i_1 = 1; i_1 < -i_0+PB_L; i_1++) {
            B[i_0][i_1-1] = F[i_1+i_0][i_1+i_0] - F[i_1-1][i_0] + F[i_0-1][i_1] * A[i_0-1] * 3;
        }
    }
        ...
        for (int i_3 = 1; i_3 < PB_L; i_3++) {
            for (int i_4 = 0; i_4 < PB_L; i_4++) {
                for (int i_5 = 0; i_5 < min(-i_3+PB_P, -i_4+PB_M); i_5++) {
                    D[i_5+i_4][i_2][i_4] = G[i_5+1][i_4][i_3][i_2] - G[i_2+1][i_3][i_5+i_3][i_4] + 6;
                }
            }
            for (int i_6 = 1; i_6 < min(i_2, -i_2+PB_M-1); i_6++) {
                D[i_6+i_2][i_3][i_6] = F[i_6-1][i_3] - H[i_3][i_6][i_2] + H[i_3-1][i_2+1][i_6+1] * H[i_3][i_6][i_3] + D[i_6+i_2+1][i_3][i_6] * 5;
            }
        }
    }
#pragma endscop
...
kernel_4414151213_02(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
