...
void kernel_4216211215_04(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        ...
        B[i_0] = C[i_0+1][i_0] + B[i_0+1] * B[i_0-1] + 2;
    }
#pragma endscop
...
kernel_4216211215_04(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
