        ...
        for (int i_1 = 1; i_1 < min(-i_0+PB_Q, i_0); i_1++) {
            for (int i_2 = 1; i_2 < i_1; i_2++) {
                for (int i_3 = 0; i_3 < PB_M-1; i_3++) {
                    A[i_2+1][i_0][i_1-1][i_3+i_2] = D[i_3][i_2][i_1][i_2] * D[i_3+1][i_2+1][i_1][1] - D[i_2+2][i_3][i_1][i_2+i_0] + D[i_2-1][i_3+1][i_1+i_0][i_0] + 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        B[i_4] = E[i_4] - E[i_4-1] * E[i_4] - E[i_4] * B[i_4-1] - 5;
        for (int i_5 = 2; i_5 < -i_4+PB_M; i_5++) {
            B[i_4+2] = F[1][i_4] + F[i_4][i_5] + F[i_5-1][i_4-1] - F[i_5][i_4] - F[i_5+i_4-1][i_4] * F[i_4+1][i_5-2] * F[i_5+i_4][0] * B[i_5] * 1;
        }
    }
#pragma endscop
...
kernel_4326152123_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
