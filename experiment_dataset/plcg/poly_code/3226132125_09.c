...
void kernel_3226132125_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_N; i_1++) {
        B[i_1] = C[i_1] * C[i_1-1] - C[i_1-1] * C[i_1] - B[i_1-1] * 2;
    }
#pragma endscop
...
kernel_3226132125_09(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
