...
void kernel_4416351323_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,int zk,int vk,int wk,DATA_TYPE POLYBENCH_5D(K,xK,yK,zK,vK,wK,xk,yk,zk,vk,wk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N-2; i_0++) {
        A[i_0] = E[i_0] + E[1] + E[i_0+1] * E[i_0] + E[i_0] * F[i_0] - A[i_0-2] - A[i_0-1] * A[i_0+2] + A[i_0+1] + A[i_0+1] - 4;
    }
    for (int i_1 = 3; i_1 < PB_L; i_1++) {
        for (int i_2 = 2; i_2 < min(i_1, -i_1+PB_L+1); i_2++) {
            for (int i_3 = 1; i_3 < PB_L; i_3++) {
                for (int i_4 = i_3; i_4 < -i_1+PB_P+1; i_4++) {
                    B[i_4][i_4-1][i_3-1][i_2] = G[i_3+1][i_2][i_1][i_4+i_2] * H[1][i_1][i_2+1][i_2+1] - G[i_4][i_3-1][i_2][i_4+i_1-1] * G[i_1-1][i_4][i_2][i_2] * G[i_3][i_4-1][i_2+i_1-1][i_3] - H[i_4][i_1-1][i_4][i_3] + B[i_1-2][i_1-3][i_3][i_2-2] + 3;
                }
            }
        }
        for (int i_5 = 1; i_5 < min(-i_1+PB_L, i_1); i_5++) {
            for (int i_6 = 1; i_6 < -i_1+PB_Q; i_6++) {
                B[i_6][i_6-1][i_5-1][i_1] = I[i_6+i_5][i_5+i_1][i_1-1] - J[i_5][i_6][i_1] + 5;
                for (int i_7 = 0; i_7 < PB_L; i_7++) {
                    B[i_5][i_5-1][i_6+1][i_7] = K[i_6+1][i_5][i_7][i_6+i_1][i_5] + H[i_6][i_1][i_7][i_5] + G[i_7][i_6][i_5+i_1][i_7] * L[i_7][i_5][i_1] * G[i_1-1][i_6][i_7][i_5] - 6;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,wk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4416351323_01(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,wk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,wk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L)));
