...
void kernel_4322312215_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
        ...
        for (int i_5 = 0; i_5 < PB_M; i_5++) {
            for (int i_6 = i_5; i_6 < PB_L; i_6++) {
                for (int i_7 = 1; i_7 < PB_L-1; i_7++) {
                    C[i_7][i_6][i_4][i_7+1] = C[i_4][i_7-1][i_6][i_4+1] * 3;
                }
            }
        }
    }
...
kernel_4322312215_03(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
