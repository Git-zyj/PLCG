...
void kernel_4316132323_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        for (int i_1 = i_0; i_1 < min(PB_P-2, -i_0+PB_P); i_1++) {
            for (int i_2 = 2; i_2 < min(min(-i_1+PB_M, i_0), PB_P-1); i_2++) {
                A[i_1][i_2][i_0] = D[i_2][i_1][0] * D[i_1][i_2+1][i_0] - D[i_2+i_1-1][i_0][i_0] - D[i_2+i_1][i_0][i_0] + A[i_2][i_0][i_1-1] - A[i_1-1][i_2][i_0] - 5;
                for (int i_3 = 2; i_3 < -i_1+PB_P; i_3++) {
                    B[i_3][i_1][i_0][i_2-1] = D[i_3][i_1+i_0][i_2-2] + E[i_3][i_3+i_1][i_0+1][i_2] * B[i_2-1][i_1][i_0][i_3-1] * B[i_3][i_1+2][i_0][i_2-1] + B[i_3-2][i_1][i_0][i_2-1] - B[i_0+1][i_1-1][i_3][i_2-1] * 6;
                }
            }
        }
        for (int i_4 = 0; i_4 < i_0; i_4++) {
            C[i_4][i_0-1] = F[i_4][i_0] + C[i_4][i_0] - C[i_4][i_0+1] * 3;
        }
    }
#pragma endscop
...
kernel_4316132323_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
