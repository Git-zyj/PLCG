...
void kernel_2212212221_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_M-3; i_1++) {
            A[i_0+1] = A[i_1+3] * A[i_1-1] + 5;
        }
...
kernel_2212212221_00(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
