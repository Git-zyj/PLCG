...
void kernel_3234211115_09(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        ...
        for (int i_2 = 1; i_2 < PB_N+1; i_2++) {
            for (int i_3 = 0; i_3 < -i_2+PB_P; i_3++) {
                B[i_0][i_0+1][i_3+1] = C[i_2-1][i_0-1][i_3+i_2] * B[i_0][i_0+1][i_3] + 5;
            }
        }
    }
#pragma endscop
...
kernel_3234211115_09(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
