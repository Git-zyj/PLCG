...
void kernel_3332311323_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_3 = 1; i_3 < PB_P; i_3++) {
        for (int i_4 = 0; i_4 < min(-i_3+PB_Q+1, i_3); i_4++) {
            for (int i_5 = 0; i_5 < -i_3+PB_P; i_5++) {
                B[i_5+1] = D[i_4][i_5+i_3][i_4+i_3-1] * 6;
            }
        }
    }
#pragma endscop
...
kernel_3332311323_09(xb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D));
