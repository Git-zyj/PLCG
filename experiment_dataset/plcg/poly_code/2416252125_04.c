...
void kernel_2416252125_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N-2; i_0++) {
        A[i_0] = E[i_0+1] + F[i_0-1] * E[i_0-2] + C[i_0+2] * 2;
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            B[i_0][i_1] = G[i_1][i_0+2] + G[i_1][i_0] - H[i_1][i_1-1] - G[i_0][i_0] - 4;
        }
        C[i_0] = F[i_0] + E[i_0] - F[i_0] * E[i_0+1] - E[i_0] - A[i_0] * 5;
    }
    for (int i_2 = 2; i_2 < PB_M-1; i_2++) {
        for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
            C[i_3] = E[i_3+1] + G[i_3][i_2] + G[i_2+1][i_3] - G[i_3-1][i_3] + G[i_2][i_3] * I[i_3+2][i_2+2][i_2] - G[i_3+1][i_2-2] - 5;
        }
    }
#pragma endscop
...
kernel_2416252125_04(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
