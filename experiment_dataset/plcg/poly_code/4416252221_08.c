...
void kernel_4416252221_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,int wg,DATA_TYPE POLYBENCH_5D(G,xG,yG,zG,vG,wG,xg,yg,zg,vg,wg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P-2; i_0++) {
        A[i_0] = E[i_0-1] + E[i_0] + F[i_0] - E[i_0+2] + F[i_0] + A[i_0-1] * 3;
        for (int i_1 = 4; i_1 < min(-i_0+PB_L, i_0); i_1++) {
            for (int i_2 = 2; i_2 < min(-i_0+PB_L, -i_1+PB_L+1); i_2++) {
                for (int i_3 = i_1; i_3 < min(-i_1+PB_L, -i_0+PB_L-1); i_3++) {
                    B[i_3][i_2-2][i_0][i_1] = G[i_1][i_3][i_0][i_2][i_0+2] + H[i_3+i_1][i_0-2][i_2][0] - H[i_2][i_3][i_1][1] + I[i_2][i_3][i_1] - J[i_0-1][i_2+1][i_1-2][i_3+i_2] + J[i_2][i_1][i_3][i_0+1] + C[i_2+2][i_3-1][i_1+i_0][i_0] * C[i_1+2][i_2-1][i_3+i_0+1][i_0+2] - C[i_1+2][i_2-1][i_3+i_0][i_3] + 5;
                    C[i_1+2][i_3-1][i_2+i_0][i_0] = H[i_2+i_1-1][i_3-1][i_0][2] + I[i_0][0][i_2-1] - H[i_3+i_0-2][i_2][i_1][i_1] * J[i_3][i_2][i_0][i_1] * H[i_2][i_2][i_0][i_1-2] - B[i_0][i_3-2][i_1][i_2] + B[i_0][i_1-4][i_2-2][i_3-1] * B[i_3][i_2-2][i_0-1][i_1] * 6;
                }
            }
            for (int i_4 = 0; i_4 < PB_L-1; i_4++) {
                D[i_0-1][i_1+2][i_0] = K[i_4+1][i_1] - D[i_0][i_1+2][i_0+1] + 1;
            }
        }
    }
#pragma endscop
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4416252221_08(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K)));
