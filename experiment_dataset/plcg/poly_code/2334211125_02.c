...
void kernel_2334211125_02(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
kernel_2334211125_02(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
