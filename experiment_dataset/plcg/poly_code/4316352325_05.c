...
void kernel_4316352325_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        A[i_0] = D[i_0] + E[i_0] * E[i_0] - D[i_0+1] + 4;
        for (int i_1 = 1; i_1 < min(-i_0+PB_L, i_0); i_1++) {
            B[i_0][i_1] = F[i_0][2] * G[i_0][i_1] * A[i_1] * A[i_1-1] * 1;
            for (int i_2 = i_0; i_2 < PB_L; i_2++) {
                B[i_1][i_2] = H[i_2][i_0][i_1] - I[i_1+1][i_1][i_2] - H[i_2][i_0-2][i_1] * H[i_2][i_0][i_2] - I[i_2-2][i_1+i_0][i_2] + I[i_2][i_1][i_0] * H[i_0][i_2][i_1] * B[i_1][i_2] - B[i_0+1][i_1] * B[i_0][i_1] + 2;
            }
        }
    }
#pragma endscop
...
kernel_4316352325_05(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
