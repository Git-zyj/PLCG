...
void kernel_4224251315_07(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < PB_L; i_2++) {
                for (int i_3 = 1; i_3 < min(i_0, -i_1+PB_L+1); i_3++) {
                    B[i_0-1][i_3-1][i_2][i_3] = C[i_1][i_0][i_3][i_0] - D[i_2][i_3][i_1][i_0] - E[i_3][i_2-1][i_1] * D[i_3+1][i_1][i_0+1][i_2] + D[i_2][i_0+1][i_3-1][i_1] * C[i_3+i_1-1][i_2][0][i_2] - 5;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < PB_M-1; i_5++) {
            for (int i_6 = i_5; i_6 < PB_Q-1; i_6++) {
                for (int i_7 = 1; i_7 < PB_Q-1; i_7++) {
                    B[i_4][i_7-1][i_5][i_7] = F[i_7-1][i_5-1][i_6] - E[i_7][i_6][i_5] + D[i_5+1][i_6][i_4+1][0] * D[i_7][i_6][i_4][i_6] - B[i_4][i_7-1][i_6+1][i_7] - B[i_4][i_7][i_5][i_7+1] - B[i_7][i_6][i_5+1][i_6+1] - 6;
                }
            }
        }
    }
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), INIT_SEED);
kernel_4224251315_07(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F)));
