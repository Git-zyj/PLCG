...
void kernel_3422232315_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
...
#pragma scop
    ...
    for (int i_2 = 2; i_2 < PB_L-2; i_2++) {
        for (int i_3 = 0; i_3 < min(PB_L, -i_2+PB_M); i_3++) {
            A[i_3] = G[i_3][i_3+i_2] + G[i_2][i_3] * H[i_2][i_3] - H[i_2][i_3] - H[i_3][i_2-2] + 2;
        }
        for (int i_4 = i_2; i_4 < PB_L+1; i_4++) {
            for (int i_5 = 1; i_5 < -i_4+PB_L+1; i_5++) {
                A[i_5] = I[i_5][i_5][i_4] + I[i_5-1][i_5+i_4-1][i_2] * I[i_5][i_2+2][i_4] * 4;
            }
        }
    }
#pragma endscop
...
kernel_3422232315_03(xa,POLYBENCH_ARRAY(A), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
