...
void kernel_2226311313_06(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_L-2 - 1; i_0 >= 0; i_0--) {
        for (int i_1 = 0; i_1 < min(-i_0+PB_L-2, i_0); i_1++) {
            A[i_1+i_0][i_1+i_0+1] = A[i_1+i_0+1][i_1+i_0+2] * 6;
            A[i_1+i_0+1][i_1+i_0+2] = C[i_1][i_0] * A[i_1+i_0][i_1+i_0+1] - A[i_1+i_0][i_1+i_0+1] - 2;
        }
    }
#pragma endscop
...
kernel_2226311313_06(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C));
