...
void kernel_4332311121_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
        ...
        for (int i_1 = 0; i_1 < PB_P; i_1++) {
            for (int i_2 = i_0; i_2 < PB_Q-2; i_2++) {
                for (int i_3 = 0; i_3 < PB_L; i_3++) {
                    A[i_3][i_2][i_1+1] = A[i_3][i_1][i_2+2] - B[i_0-2][i_3][i_2] + 6;
                }
            }
        }
    }
    ...
    for (int i_7 = 1; i_7 < PB_M; i_7++) {
        for (int i_8 = i_7; i_8 < PB_L-1; i_8++) {
            for (int i_9 = 0; i_9 < -i_8+PB_N-1; i_9++) {
                C[i_9+i_8+1][0] = E[i_8+1][i_7-1][i_9] + 2;
            }
        }
    }
#pragma endscop
...
kernel_4332311121_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
