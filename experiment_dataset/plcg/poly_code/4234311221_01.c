...
void kernel_4234311221_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_4 = 2; i_4 < PB_M; i_4++) {
        for (int i_5 = 1; i_5 < -i_4+PB_M+2; i_5++) {
            for (int i_6 = 1; i_6 < -i_4+PB_M; i_6++) {
                B[i_6+i_4][i_4][i_5] = C[i_4-1][i_6+1][i_5] + B[i_6+i_4-1][i_6-1][i_5-1] - B[i_6+i_4][i_4][i_5+2] - B[i_5+i_4-2][i_4][i_6-1] + 3;
            }
        }
    }
#pragma endscop
...
kernel_4234311221_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
