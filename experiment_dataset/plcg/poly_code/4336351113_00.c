...
void kernel_4336351113_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj)){
        ...
        for (int i_1 = i_0; i_1 < PB_P; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_L; i_3++) {
                    A[i_3+i_0][i_1][i_2][i_1-1] = D[i_3][0][i_1] - E[i_3][i_2+1][i_0][i_2] - F[i_0][i_3][i_2][i_3][i_1] - 1;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
            for (int i_5 = 1; i_5 < min(min(-i_0+PB_Q, i_0), -i_4+PB_L); i_5++) {
                for (int i_6 = 1; i_6 < min(-i_4+PB_M, -i_0+PB_L-1); i_6++) {
                    B[i_5][i_5+i_4][i_6-1] = G[i_5][i_0][i_6][i_4-1] - H[i_4+1][i_0][i_6][i_5+i_0] * I[i_6+1][i_4][i_5] * E[i_5+1][i_6+i_0+1][i_4][0] * G[i_4][i_5][i_0][i_5] * H[i_4][i_6][i_0][i_5] + H[i_6+i_4][i_4+1][i_0-1][i_5] * A[i_6+i_0][i_4][i_5][i_4-1] + B[i_5-1][i_5+i_4-1][i_6-1] * B[i_6][i_6+i_5-1][i_4-1] - 3;
                }
            }
        }
    }
        ...
        for (int i_8 = 1; i_8 < PB_M-1; i_8++) {
            for (int i_9 = 0; i_9 < min(i_8, -i_8+PB_L+1); i_9++) {
                for (int j_0 = i_8; j_0 < -i_8+PB_L; j_0++) {
                    C[j_0][i_8][i_9][0] = J[i_9][i_8+1][i_9+1] * F[i_7][i_9][j_0+i_8][j_0-1][1] * J[j_0][i_7][i_9+i_8-1] + G[i_7][i_7-1][i_9][i_7] + G[i_9][i_7][j_0][i_8-1] - 4;
                }
            }
        }
    }
...
kernel_4336351113_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
