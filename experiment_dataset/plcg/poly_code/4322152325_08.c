        ...
        for (int i_1 = 4; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_M; i_2++) {
                for (int i_3 = 2; i_3 < PB_L; i_3++) {
                    A[i_2+i_1][i_3-2][i_1-2][i_0-2] = D[i_1+2][i_2][i_3-1][i_0-1] + D[i_3][i_3][i_0][i_1+2] - D[i_3-1][i_1-1][i_0-1][i_2] * D[i_2][i_3][i_1][i_1] - A[i_2+i_1][i_3-2][i_1-2][i_0-4] * A[i_2+i_1-2][i_3][i_1-4][i_0] - 4;
                }
            }
        }
        B[i_0+1] = E[i_0][i_0] * F[i_0] - F[i_0] + F[i_0] + F[i_0] + B[i_0+2] - 2;
    }
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        B[i_4+1] = F[i_4] + F[i_4] - F[i_4] - F[i_4] - B[i_4-1] * B[i_4] + 5;
    }
#pragma endscop
...
kernel_4322152325_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F));
