...
void kernel_2232212125_07(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    ...
    for (int i_2 = 2; i_2 < PB_P; i_2++) {
        for (int i_3 = 0; i_3 < -i_2+PB_P; i_3++) {
            A[i_3+1][i_3+i_2] = C[i_2-2][i_3+2] - C[i_3][i_3] * 5;
        }
    }
#pragma endscop
...
kernel_2232212125_07(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C));
