...
void kernel_4416152225_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        A[i_0][i_0] = E[i_0] * E[i_0] + E[i_0] * E[i_0-2] - E[i_0] - E[i_0] - E[i_0+1] + E[i_0] * E[i_0] - A[i_0+2][i_0+2] - 2;
        for (int i_1 = 1; i_1 < -i_0+PB_M; i_1++) {
            A[i_0][i_0] = F[i_1][i_0] - F[i_1][0] * F[i_1+1][i_0] - F[i_1+i_0][i_1] + F[i_0][i_1-1] - A[i_0][i_0] + 3;
            for (int i_2 = 0; i_2 < PB_M-2; i_2++) {
                C[i_1][i_2][i_1][i_0] = F[i_2+2][i_1] * G[i_0][i_1][i_2] - F[i_2+1][i_1] - C[i_0][i_1+1][i_0][i_2] * 3;
            }
        }
    }
        ...
        for (int i_4 = i_3; i_4 < PB_P-2; i_4++) {
            for (int i_5 = 1; i_5 < -i_3+PB_L-1; i_5++) {
                for (int i_6 = i_4; i_6 < -i_5+PB_P; i_6++) {
                    C[i_6][i_3-2][i_6][i_5] = H[i_5][i_6][i_4+2][i_3] * H[i_5-1][i_6][i_3-1][0] + H[i_4][i_5+i_3+1][i_6+i_5][i_4] - 6;
                }
            }
        }
    }
...
kernel_4416152225_04(xa,ya,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
