...
void kernel_4236212115_01(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
    ...
    for (int i_3 = 0; i_3 < PB_M; i_3++) {
        for (int i_4 = 0; i_4 < PB_L; i_4++) {
            for (int i_5 = 2; i_5 < PB_L-1; i_5++) {
                B[i_3][i_4][i_5] = C[i_4][i_5-2] - B[i_3][i_4][i_5+1] + 4;
            }
        }
    }
#pragma endscop
...
kernel_4236212115_01(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
