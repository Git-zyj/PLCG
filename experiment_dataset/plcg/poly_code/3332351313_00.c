    ...
    for (int i_3 = 1; i_3 < PB_P; i_3++) {
        for (int i_4 = 1; i_4 < PB_N; i_4++) {
            for (int i_5 = i_4; i_5 < min(-i_3+PB_M, -i_4+PB_P); i_5++) {
                B[i_4][i_4][i_5+1] = H[i_3-1][i_5][i_4] * G[i_4][i_5+i_3][i_4] + D[i_4][i_5][i_3] - E[i_3][i_5+i_4][i_4-1][i_3] - B[i_4-1][i_4-1][i_5+1] * B[i_4][i_4][i_3] * B[i_4][i_4][i_5+2] + 6;
            }
        }
        for (int i_6 = 1; i_6 < -i_3+PB_L-1; i_6++) {
            for (int i_7 = i_6; i_7 < -i_3+PB_P; i_7++) {
                C[i_6][i_6+i_3][i_7] = D[i_6+i_3][i_7-1][0] + H[i_6+1][i_7][i_6+1] - H[i_3][i_7+i_3][i_6-1] - E[i_3][i_7][i_7+i_6-1][i_3+1] + D[i_6][i_3][i_7] * B[i_7][i_7][i_3+1] * C[i_6][i_6+i_3+1][i_7] - C[i_6+1][i_6+i_3+1][i_7+1] * C[i_6+1][i_6+i_3+1][i_7] * 4;
            }
        }
    }
#pragma endscop
...
kernel_3332351313_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
