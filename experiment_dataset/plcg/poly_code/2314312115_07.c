...
void kernel_2314312115_07(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
kernel_2314312115_07(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
