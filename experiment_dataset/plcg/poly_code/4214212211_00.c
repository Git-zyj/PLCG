...
void kernel_4214212211_00(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        ...
        for (int i_3 = 0; i_3 < i_0; i_3++) {
            for (int i_4 = 1; i_4 < min(-i_3+PB_L, PB_M-1); i_4++) {
                B[i_0][i_4][i_3] = C[i_4+i_3][i_0][i_0] + B[i_0][i_4-1][i_3] - B[i_4+1][i_0][i_3] * 3;
            }
        }
    }
#pragma endscop
...
kernel_4214212211_00(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
