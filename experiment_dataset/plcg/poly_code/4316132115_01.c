        ...
        for (int i_1 = 0; i_1 < PB_Q-2; i_1++) {
            for (int i_2 = 0; i_2 < PB_P; i_2++) {
                for (int i_3 = i_2; i_3 < PB_P; i_3++) {
                    A[i_2][i_3][i_0][0] = D[i_2][i_0][i_1][i_3] * D[i_3][i_0+2][i_2+1][i_1+2] + D[i_1+1][i_2][i_3][i_0] * 6;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        B[i_4] = E[i_4] - E[i_4] * E[i_4-1] - E[i_4] + E[i_4] - B[i_4-1] + B[i_4+1] - 6;
        for (int i_5 = 0; i_5 < PB_P; i_5++) {
            for (int i_6 = 0; i_6 < PB_Q; i_6++) {
                A[i_4][i_5][i_6][0] = F[i_5][i_4][2] + 4;
            }
        }
    }
#pragma endscop
...
kernel_4316132115_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
