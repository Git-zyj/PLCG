...
#pragma scop
    ...
    for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
        ...
        for (int i_4 = i_2; i_4 < PB_N-3; i_4++) {
            for (int i_5 = 1; i_5 < PB_N-3; i_5++) {
                C[i_4+2][i_5] = C[i_4+1][i_5] + C[i_4+3][i_5] - C[i_4+2][i_5+1] - C[i_5+3][i_4] + C[i_4+2][i_5-1] * 1;
            }
        }
    }
#pragma endscop
...
kernel_4334312311_08(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
