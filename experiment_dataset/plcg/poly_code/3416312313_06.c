...
void kernel_3416312313_06(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P+2; i_0++) {
        for (int i_1 = i_0; i_1 < PB_L; i_1++) {
            A[i_0-2][i_1] = E[i_0][i_1-1] + F[i_1] + B[i_1][i_0-2] - 5;
        }
        for (int i_2 = i_0; i_2 < PB_P+2; i_2++) {
            for (int i_3 = 2; i_3 < PB_P+2; i_3++) {
                B[i_2][i_3-2] = B[i_3+1][i_2-2] * 5;
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_P; i_4++) {
        for (int i_5 = i_4; i_5 < PB_N; i_5++) {
            for (int i_6 = 1; i_6 < PB_L-1; i_6++) {
                C[i_6][i_6] = E[i_6][i_5] - B[i_5][i_4-2] + D[i_5-1][i_6][i_4] - 1;
                D[i_5-1][i_6][i_4] = C[i_5][i_5] * C[i_6][i_6] * C[i_6-1][i_6-1] - C[i_6+1][i_6+1] * D[i_5][i_6-1][i_4-1] - 4;
            }
        }
    }
#pragma endscop
...
kernel_3416312313_06(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F));
