...
void kernel_3424231323_01(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = i_0; i_1 < PB_L; i_1++) {
            A[i_1][i_1+1] = E[i_1-1] + F[i_0+1][i_1] + F[i_1][i_0+1] + 2;
            for (int i_2 = 1; i_2 < PB_L+1; i_2++) {
                A[i_1][i_1+1] = G[i_2][i_0-1][i_1] - G[i_2][i_1][i_0] * G[i_1][i_2-1][i_1] - A[i_1+1][i_1+2] - 4;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_L; i_3++) {
        for (int i_4 = max(2, i_3); i_4 < PB_L-1; i_4++) {
            C[i_4] = H[i_4][i_4-1] * F[i_4][i_3] + G[i_3][i_4][i_3] - A[i_4][i_4+1] * A[i_3-1][i_3] + 2;
            C[i_4] = F[i_3][i_4] - H[i_4+1][i_3] - F[i_3][i_4-1] + C[i_4] + C[i_4+1] + C[i_4-2] - 3;
        }
    }
#pragma endscop
...
kernel_3424231323_01(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
