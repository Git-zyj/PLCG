...
void kernel_4314111321_09(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-2; i_0++) {
        for (int i_1 = -i_0+PB_M-1 - 1; i_1 >= 1; i_1--) {
            B[i_0][i_1+i_0+1] = 6;
            B[i_0][i_1+i_0+1] = B[i_0-1][i_1+i_0-1] + 2;
            for (int i_2 = max(2, i_0); i_2 < PB_M-1; i_2++) {
                C[i_0+1][i_1+1][i_2] = D[i_1][i_2+1][i_1] - D[i_1][i_2-1][i_0] + D[i_1][i_2][i_0-1] - C[i_0+1][i_1+1][i_2+1] * C[i_0+1][i_1+1][i_2-2] - C[i_2+1][i_0-1][i_1-1] * C[i_0+2][i_1+1][i_2] + C[i_0+1][i_1+1][i_2-1] + 3;
            }
        }
    }
#pragma endscop
...
kernel_4314111321_09(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
