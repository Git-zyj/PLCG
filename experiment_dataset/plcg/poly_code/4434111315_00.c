...
void kernel_4434111315_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
...
#pragma scop
        ...
        for (int i_1 = max(2, i_0); i_1 < PB_L+1; i_1++) {
            for (int i_2 = 1; i_2 < PB_Q-1; i_2++) {
                for (int i_3 = 0; i_3 < i_1; i_3++) {
                    A[i_0-1][i_1-1][i_1-1][i_2] = A[i_0-1][i_1-2][i_1-2][i_2] + A[i_0-1][i_1-1][i_1-1][i_2-1] * A[i_0-1][i_1-1][i_1-1][i_2+1] + A[i_0][i_1-1][i_1-1][i_2-1] + 3;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 1; i_5 < PB_L; i_5++) {
            C[i_5-1][i_5] = C[i_4+1][i_4+2] - 2;
        }
        for (int i_6 = 0; i_6 < PB_L-2; i_6++) {
            C[i_6][i_6+1] = E[i_4][i_6] * C[i_6+1][i_6+2] * 5;
        }
        C[i_4-1][i_4] = 6;
    }
#pragma endscop
...
kernel_4434111315_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xe,ye,POLYBENCH_ARRAY(E));
