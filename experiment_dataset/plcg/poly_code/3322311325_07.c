...
void kernel_3322311325_07(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N-2; i_0++) {
        for (int i_1 = max(3, i_0); i_1 < PB_N-1; i_1++) {
            A[i_0+1][i_1-1] = D[i_0+1][i_1+1] - A[i_0+2][i_1-1] - A[i_1+1][i_0] - A[i_0+1][i_1-3] * 5;
        }
        for (int i_2 = 0; i_2 < PB_L; i_2++) {
            for (int i_3 = 0; i_3 < -i_0+PB_N-2; i_3++) {
                C[i_3+i_0+2][i_2][i_0] = E[i_3+1][i_0][i_2] + 1;
            }
        }
        for (int i_4 = i_0; i_4 < -i_0+PB_N-1; i_4++) {
            for (int i_5 = 0; i_5 < PB_M-2; i_5++) {
                C[i_4+i_0][i_5][i_0] = F[i_5][i_4] - C[i_4+i_0+1][i_5][i_0+1] * C[i_4+i_0][i_5+2][i_0] + C[i_4+i_0-2][i_5][i_0] - 2;
            }
        }
    }
#pragma endscop
...
kernel_3322311325_07(xa,ya,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
