...
void kernel_4324252313_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh)){
...
#pragma scop
        ...
        for (int i_1 = 2; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 2; i_2 < -i_1+PB_M-1; i_2++) {
                for (int i_3 = 2; i_3 < PB_L; i_3++) {
                    A[i_3-1][i_2][i_0+2][i_1-2] = D[i_2][i_1][i_0][i_0] - D[i_2+i_1+1][i_0+2][i_3][i_3] - D[i_1][i_3][i_0-1][i_0+2] + D[i_3-1][i_0][i_3][i_1] * A[i_3-1][i_2-1][i_0+3][i_1-2] + A[i_3-2][i_1][i_0+2][i_2-2] + A[i_3-1][i_2][i_0+3][i_1-2] - 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 1; i_5 < PB_P-2; i_5++) {
            for (int i_6 = max(2, i_5); i_6 < -i_4+PB_P; i_6++) {
                for (int i_7 = i_5; i_7 < -i_6+PB_M+1; i_7++) {
                    B[i_7][i_5][i_6][i_4] = E[i_7][i_4][i_6-1] * F[i_5][i_6][i_7][i_4-1] + F[i_7+i_6-1][i_7][i_5+2][i_4] + F[i_6][i_4+1][i_7][i_6] * G[i_5][i_7][i_6+i_4] - F[i_4][i_7][i_6][i_6-2] - B[i_5-1][i_6][i_7+1][i_4] + B[i_7-1][i_5][i_6][i_4-1] * B[i_7+1][i_5+1][i_4][i_6-1] * 2;
                }
            }
        }
    }
        ...
        for (int i_9 = 2; i_9 < PB_P-2; i_9++) {
            for (int j_0 = 1; j_0 < PB_L-2; j_0++) {
                for (int j_1 = 0; j_1 < PB_M-2; j_1++) {
                    A[i_8][j_0][j_1+2][i_9-2] = F[j_0][j_1+2][i_8][i_9] + D[j_1][j_0+2][i_9][1] - D[i_9][0][i_8][i_8] * D[j_1+2][i_8][i_9][j_0] * H[j_0-1][i_9+2][i_8][j_1][2] - 4;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4324252313_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H)));
