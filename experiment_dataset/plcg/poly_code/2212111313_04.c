...
void kernel_2212111313_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_2 = 1; i_2 < PB_P; i_2++) {
        A[i_2-1][i_2] = C[i_2] * A[i_2-1][i_2] + 5;
    }
#pragma endscop
...
kernel_2212111313_04(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
