...
void kernel_3216151223_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_P-1; i_0++) {
        for (int i_1 = i_0; i_1 < PB_L-1; i_1++) {
            for (int i_2 = i_1; i_2 < -i_1+PB_L; i_2++) {
                A[i_0][i_2-1][i_1-1] = C[i_0][i_2][i_1] - C[i_2+i_1][i_0][i_2] + C[i_2][i_1][i_0] + C[i_1][i_0+1][1] * C[i_0][i_1][i_2+1] * C[i_1+1][i_2][i_0] * A[i_1][i_2-3][i_0-3] + A[i_0][i_2-1][i_1-2] * 5;
            }
        }
        for (int i_3 = i_0; i_3 < -i_0+PB_P; i_3++) {
            for (int i_4 = 2; i_4 < PB_L; i_4++) {
                A[i_0][i_3-1][i_4-2] = C[i_4][i_0][1] * C[i_4][i_3+i_0][i_3] * C[i_4-1][i_0-1][i_3+1] + C[i_4][i_0][i_3] - 4;
            }
        }
    }
#pragma endscop
...
kernel_3216151223_06(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C));
