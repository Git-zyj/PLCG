...
void kernel_4422252323_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        A[i_0] = E[i_0-1] + F[i_0] * F[i_0+1] - F[i_0-2] * A[i_0+2] + 4;
    }
    for (int i_1 = 3; i_1 < PB_M-2; i_1++) {
        C[i_1-2] = F[i_1] - E[i_1] * F[i_1+1] * F[i_1] - A[i_1] + 5;
        C[i_1-2] = E[i_1+2] + F[i_1-2] - F[i_1+1] * F[i_1] + E[i_1] + C[i_1-3] - 4;
    }
    for (int i_2 = 1; i_2 < PB_M; i_2++) {
        for (int i_3 = 2; i_3 < -i_2+PB_M; i_3++) {
            for (int i_4 = 2; i_4 < PB_M; i_4++) {
                for (int i_5 = 3; i_5 < -i_3+PB_M; i_5++) {
                    D[i_2][i_3][i_4-1][i_5] = G[i_2-1][i_3-2][i_5][i_4] * G[i_3][i_4][i_2-1][i_4-2] + H[i_4][i_3][i_5][i_2+1][0] - I[i_5+i_3][i_2+2][i_4][2] + G[i_5][i_3+i_2][i_5][i_4] - D[i_2][i_3][i_4+1][i_5] * D[i_2][i_3+2][i_5-3][i_4] - D[i_2][i_3][i_5-2][i_4-1] * D[i_3-2][i_2][i_4-1][i_5] - 6;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4422252323_02(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I)));
