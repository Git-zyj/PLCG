...
void kernel_4222212215_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
        ...
        for (int i_1 = 2; i_1 < PB_Q+1; i_1++) {
            for (int i_2 = 0; i_2 < PB_P-1; i_2++) {
                for (int i_3 = 3; i_3 < PB_M-1; i_3++) {
                    A[i_0-2][i_3+1][i_2+1][i_1-1] = A[i_3-3][i_0+1][i_2+1][i_1-2] - 1;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-1; i_4++) {
        for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
            B[i_4][i_5] = C[i_4-2] + B[i_4][i_5+1] * B[i_4+1][i_5] + 3;
        }
    }
#pragma endscop
...
kernel_4222212215_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
