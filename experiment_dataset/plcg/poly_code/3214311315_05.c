...
void kernel_3214311315_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P-2; i_0++) {
        for (int i_1 = 1; i_1 < min(-i_0+PB_M, i_0); i_1++) {
            for (int i_2 = 2; i_2 < i_1; i_2++) {
                A[i_1+i_0-1][i_2-1][i_0+1] = A[i_1+i_0-1][i_2][i_0+1] - A[i_1+i_0][i_2-1][i_0+2] * A[i_1+i_0-1][i_2-2][i_0+1] - 3;
            }
            for (int i_3 = 2; i_3 < PB_L+2; i_3++) {
                A[i_1+i_0][i_3-2][i_0+1] = C[i_1-1][i_0][i_3-1] * 2;
            }
        }
    }
#pragma endscop
...
kernel_3214311315_05(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C));
