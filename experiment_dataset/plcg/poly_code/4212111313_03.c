...
void kernel_4212111313_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
        ...
        for (int i_1 = 2; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 2; i_2 < PB_Q+1; i_2++) {
                for (int i_3 = 0; i_3 < PB_P; i_3++) {
                    A[i_0][i_3][i_2-1][i_1-1] = A[i_3][i_0][i_2-2][i_1-1] + A[i_0-1][i_3][i_2-1][i_1-2] + A[i_3][i_0][i_2-2][i_1-2] * 3;
                }
            }
            B[i_0][i_1+1] = C[i_1-1] * B[i_1+1][i_0+1] + B[i_0][i_1] * 5;
        }
    }
#pragma endscop
...
kernel_4212111313_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
