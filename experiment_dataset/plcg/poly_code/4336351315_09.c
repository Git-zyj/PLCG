...
void kernel_4336351315_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        A[i_0] = D[i_0-1] * E[i_0] + D[i_0] + D[i_0] + F[i_0] + F[i_0] - F[i_0-1] + E[i_0] * A[i_0+1] + A[i_0-1] + 3;
    }
    for (int i_1 = 1; i_1 < PB_M; i_1++) {
        for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
            for (int i_3 = 1; i_3 < PB_P; i_3++) {
                C[i_1][i_2][i_3-1] = G[i_2+1][i_1-1][i_3] - G[i_2-1][i_3-1][0] * 1;
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_P-1; i_4++) {
        for (int i_5 = i_4; i_5 < PB_M-1; i_5++) {
            for (int i_6 = 1; i_6 < min(PB_M-1, -i_4+PB_L); i_6++) {
                C[i_4-1][i_5][i_6] = H[i_6+1][i_5][i_4+1] + I[i_4-1][i_5+1] * G[i_5+1][i_6+i_4][i_5] - G[i_5+1][i_6][i_4] - C[i_4-1][i_5][i_6-1] * C[i_5-1][i_4][i_6-1] + C[i_4-1][i_5+1][i_6-1] + C[i_4-1][i_6-1][i_5-1] * 4;
            }
        }
    }
#pragma endscop
...
kernel_4336351315_09(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
