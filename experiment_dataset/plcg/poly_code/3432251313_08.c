...
void kernel_3432251313_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-1; i_0++) {
        A[i_0] = E[i_0+1] + F[i_0] - F[i_0] + A[i_0-1] - 1;
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            B[i_0+1][i_1] = G[i_1][i_0-1] - E[i_1] - G[i_0-1][i_1+1] * E[i_1] - H[i_1][i_0] - F[i_1] * H[i_0][i_1-1] - G[i_1][i_0] * G[i_0][i_1+1] + A[i_1] - A[i_1+1] - A[i_1-1] * 4;
        }
    }
    for (int i_2 = 0; i_2 < PB_M; i_2++) {
        for (int i_3 = 1; i_3 < PB_P; i_3++) {
            for (int i_4 = 1; i_4 < min(min(-i_3+PB_M, PB_P+1), -i_2+PB_L-1); i_4++) {
                B[i_4][i_2] = I[i_4][i_4+i_2+1][i_3-1] - I[i_3][i_2][i_3] + I[i_3][i_2+1][i_4-1] + I[i_4+i_3][i_2][i_3-1] - B[i_4+1][i_3] + 2;
            }
        }
    }
    for (int i_5 = 1; i_5 < PB_M-1; i_5++) {
        D[i_5] = E[i_5] - E[i_5] + D[i_5+1] * D[i_5-1] - 1;
    }
#pragma endscop
...
kernel_3432251313_08(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
