...
#pragma scop
    ...
    for (int i_2 = 2; i_2 < PB_L; i_2++) {
        B[i_2-2] = E[i_2] + F[i_2+1] * F[i_2] - E[i_2-1] + E[i_2] - G[i_2][i_2-1] - E[i_2] * 3;
    }
    for (int i_3 = 0; i_3 < PB_L; i_3++) {
        C[i_3] = E[i_3] * H[i_3][i_3] + D[i_3+1] - 5;
        D[i_3] = E[i_3] - 6;
    }
#pragma endscop
...
kernel_2426232111_07(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
