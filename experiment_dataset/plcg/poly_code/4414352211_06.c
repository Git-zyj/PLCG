...
void kernel_4414352211_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl),int xm,int ym,int zm,DATA_TYPE POLYBENCH_3D(M,xM,yM,zM,xm,ym,zm)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P-2; i_0++) {
        A[i_0-2] = E[i_0] * F[i_0] * E[i_0] * E[i_0] * A[i_0-1] + 1;
        for (int i_1 = i_0; i_1 < -i_0+PB_N; i_1++) {
            B[i_0+2][i_1] = G[i_0][i_1] * H[i_1][i_0] * I[i_0] - J[i_1][i_0+2] * K[i_0+2][i_1][0] - J[i_1][i_0] * I[i_1+i_0] * H[i_0][i_0] + B[i_0+1][i_1] + 3;
            for (int i_2 = 1; i_2 < -i_1+PB_L; i_2++) {
                C[i_1-1][i_2] = L[i_1][i_2-1][i_0+2] * M[i_0-1][i_2+i_1][0] + G[i_0][i_1] - J[i_2][i_0] * G[i_0][i_1] + L[i_1][i_0-1][0] + C[i_1-1][i_2+1] - C[i_1-1][i_2-1] * C[i_1][i_2] + 5;
            }
            for (int i_3 = 0; i_3 < -i_0+PB_M+1; i_3++) {
                for (int i_4 = 0; i_4 < PB_L; i_4++) {
                    D[i_4][i_1][i_0][i_3+i_0] = K[i_3+i_0-1][i_1][i_4] + M[i_4][i_1][i_0] + D[i_4][i_1][i_0-1][i_3+i_0] + D[i_4][i_1][i_0][i_3+i_0-1] + 4;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,zm,POLYBENCH_ARRAY(M), INIT_SEED);
kernel_4414352211_06(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,zm,POLYBENCH_ARRAY(M));
