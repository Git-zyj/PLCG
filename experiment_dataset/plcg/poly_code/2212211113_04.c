...
void kernel_2212211113_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N+1; i_0++) {
        for (int i_1 = 1; i_1 < PB_N+1; i_1++) {
            A[i_1-1][i_0] = A[i_0-1][i_1+1] - 5;
        }
    }
...
kernel_2212211113_04(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
