...
void kernel_4422212311_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf)){
...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            for (int i_2 = i_0; i_2 < -i_1+PB_L; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_Q; i_3++) {
                    A[i_0-1][i_3][i_1][i_0+1] = E[i_2+i_1][i_0][i_3+i_0][0] - E[i_3+1][i_2][i_1][i_0] - A[i_0-1][i_3][i_1-1][i_0+1] - A[i_0-1][i_3+1][i_1][i_0+1] + A[i_0-2][i_3][i_1-1][i_0] + A[i_0][i_3+1][i_1-1][i_0+2] + 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 1; i_5 < min(-i_4+PB_L+1, PB_L-1); i_5++) {
            B[i_4][i_5] = F[i_5+1][i_5+i_4-1] * F[i_5][i_4] - B[i_5][i_4-1] - B[i_4-1][i_5+1] * B[i_4-1][i_5-1] * C[i_5][i_4+2] + 3;
            for (int i_6 = 0; i_6 < PB_M; i_6++) {
                C[i_6][i_4+2] = B[i_5+1][i_6] - B[i_5][i_6] * 2;
            }
        }
        for (int i_7 = 0; i_7 < PB_N-1; i_7++) {
            D[i_7][i_4+2] = D[i_7+1][i_4+2] * 6;
        }
    }
#pragma endscop
...
kernel_4422212311_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
