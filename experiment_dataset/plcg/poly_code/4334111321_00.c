...
void kernel_4334111321_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        for (int i_1 = i_0; i_1 < min(PB_L, -i_0+PB_P-2); i_1++) {
            for (int i_2 = 0; i_2 < PB_Q; i_2++) {
                A[i_0-1][i_1+i_0+1][0] = A[i_0-2][i_1+i_0][0] * A[i_1][i_1+i_0+2][0] + A[i_0-2][i_1+i_0-2][0] * A[i_0-1][i_1+i_0][0] - A[i_0+1][i_1+i_0+1][0] - 5;
            }
        }
        for (int i_3 = max(3, i_0); i_3 < min(PB_M, -i_0+PB_N); i_3++) {
            B[i_0][i_3-1] = D[i_3+i_0][i_3] - D[i_3][i_0] * B[i_0+1][i_3-1] - B[i_0][i_3-3] * 5;
        }
    }
    for (int i_4 = 3; i_4 < PB_L+1; i_4++) {
        C[i_4-1] = C[i_4-2] * C[i_4-3] + 5;
    }
#pragma endscop
...
kernel_4334111321_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
