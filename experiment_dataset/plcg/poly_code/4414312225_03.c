        ...
        for (int i_1 = 0; i_1 < PB_P-2; i_1++) {
            for (int i_2 = 2; i_2 < PB_M; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_Q-2; i_3++) {
                    A[i_0][i_1][i_2][i_3+i_0] = E[i_2][i_0][i_1+1][i_3] * A[i_0][i_1+2][i_2-2][i_3+i_0+2] * 1;
                }
            }
        }
    ...
    for (int i_6 = 2; i_6 < PB_L-1; i_6++) {
        for (int i_7 = i_6; i_7 < PB_L-2; i_7++) {
            for (int i_8 = 0; i_8 < PB_P-3; i_8++) {
                C[i_7+2][i_6][i_8+2] = C[i_7][i_6+1][i_8+3] + C[i_8+2][i_6+1][i_7+2] + 6;
            }
            for (int i_9 = i_6; i_9 < PB_P-2; i_9++) {
                for (int j_0 = 1; j_0 < -i_7+PB_M; j_0++) {
                    D[j_0-1][i_7+1][i_9][i_6] = F[j_0+i_7][j_0+2][i_9][i_6-2] - D[j_0-1][i_7+2][i_9][i_6] + D[j_0-1][i_7-1][i_9+2][i_6] + 4;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), INIT_SEED);
kernel_4414312225_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F)));
