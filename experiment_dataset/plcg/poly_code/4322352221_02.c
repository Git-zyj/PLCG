        ...
        for (int i_1 = 0; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 2; i_2 < -i_0+PB_L-2; i_2++) {
                for (int i_3 = 2; i_3 < min(-i_2+PB_L, i_1); i_3++) {
                    A[i_0][i_3+i_2][0][i_3+2] = D[i_1][i_3][i_3-2][i_2] + E[i_3][i_2+i_0+2][i_1+1][i_0+2] - E[i_3+2][i_2][i_0][i_1] - D[i_3][i_2-1][i_0][i_2] + D[i_3-2][i_0-1][i_1][i_2] - A[i_1+2][i_3+i_2][0][i_3+2] + A[i_0+1][i_3+i_2-2][0][i_3] * 6;
                }
            }
        }
        for (int i_4 = 2; i_4 < -i_0+PB_M-1; i_4++) {
            B[i_0][i_4-1] = F[i_4+i_0][0] - G[i_4-2][i_0+1] * H[i_0][i_4] - H[i_0][i_4] + I[1] - C[i_0-1][i_4+i_0+1] + 3;
        }
    }
    for (int i_5 = 1; i_5 < PB_M-1; i_5++) {
        for (int i_6 = 1; i_6 < PB_M-1; i_6++) {
            for (int i_7 = 0; i_7 < -i_6+PB_M-1; i_7++) {
                C[i_6-1][i_7+i_6+1] = J[i_7][i_5+1][0] * J[i_7+i_6][i_5][i_5-1] - J[i_7][i_7+1][i_6] + B[i_7][i_6-1] * 3;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4322352221_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J)));
