...
void kernel_4434252325_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl)){
        ...
        for (int i_1 = 2; i_1 < PB_N-2; i_1++) {
            for (int i_2 = i_1; i_2 < PB_Q-2; i_2++) {
                for (int i_3 = i_0; i_3 < -i_2+PB_N; i_3++) {
                    A[i_3+i_2][i_1][i_0][i_1+2] = E[i_2][i_0][i_3][i_1] - F[i_1+2][i_0][i_3+2][i_2+1][i_1] * G[i_3+i_2][i_1][i_0][0] - H[i_3][i_1-2][i_2] * A[i_3+i_1-2][i_2][i_0][i_2+2] - A[i_3+i_2][i_1][i_0+2][i_1+2] - A[i_3+i_2+1][i_1][i_0][i_1+2] * 6;
                }
            }
        }
        B[i_0] = I[i_0] + J[i_0+2] - J[i_0] + I[i_0] + B[i_0+1] * B[i_0-1] + B[i_0-2] - 6;
        for (int i_4 = 0; i_4 < -i_0+PB_N; i_4++) {
            for (int i_5 = 1; i_5 < PB_L; i_5++) {
                C[i_0+2][i_4][i_5] = K[i_0][i_4] - L[i_4+i_0][i_5-1][i_4] * H[i_0][i_5+i_4][i_5-1] - C[i_0][i_4+2][i_5] - C[i_0][i_4][i_5] * C[i_0+1][i_4][i_5] + 2;
            }
        }
    }
    for (int i_6 = 2; i_6 < PB_L; i_6++) {
        for (int i_7 = 1; i_7 < i_6; i_7++) {
            for (int i_8 = 2; i_8 < -i_6+PB_N; i_8++) {
                C[i_6+2][i_7][i_8-2] = H[i_7+2][i_8][i_6-1] + L[i_6][i_8+i_6-2][i_7] + H[i_6][i_8][i_7-1] * L[i_7][i_8][i_6] + H[i_8][i_6][i_6] * L[i_8+i_6][i_7][i_7] * 3;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4434252325_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L));
