...
void kernel_2326352325_08(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        B[i_0-2] = D[i_0] - E[i_0] - E[i_0+2] * E[i_0] + B[i_0] - 2;
    }
    for (int i_1 = 2; i_1 < PB_M-1; i_1++) {
        B[i_1] = D[i_1+1] + D[i_1] - E[i_1] - D[i_1] * D[i_1-1] * E[i_1] + 1;
        for (int i_2 = i_1; i_2 < -i_1+PB_N-1; i_2++) {
            B[i_1] = F[i_2][i_1] * G[i_1][i_1+2] * H[i_2+1][i_1-1] - I[i_2+i_1+1] - B[i_1-2] - B[i_2] + 4;
        }
    }
#pragma endscop
...
kernel_2326352325_08(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
