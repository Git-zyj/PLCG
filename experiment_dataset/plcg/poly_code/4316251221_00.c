...
void kernel_4316251221_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        for (int i_1 = i_0; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < PB_P-2; i_2++) {
                for (int i_3 = 1; i_3 < min(PB_Q-2, -i_2+PB_P-2); i_3++) {
                    A[i_0+1][i_1][i_3+i_2][i_3] = D[i_2][i_1][i_0][0] * E[i_3-1][i_0-1][i_0][i_2] + E[i_3][i_0+1][i_2][i_1] - A[i_0+3][i_1][i_3+i_2+2][i_3+2] * 3;
                }
            }
        }
        B[i_0] = F[i_0] - F[i_0] + G[i_0] * G[i_0] * B[i_0+2] * B[i_0-2] + 2;
    }
    for (int i_4 = 1; i_4 < PB_Q-3; i_4++) {
        for (int i_5 = 1; i_5 < min(-i_4+PB_M, PB_L-1); i_5++) {
            for (int i_6 = 1; i_6 < min(PB_L-1, -i_5+PB_M+1); i_6++) {
                for (int i_7 = 0; i_7 < min(min(-i_5+PB_Q-1, -i_6+PB_L-1), -i_4+PB_Q-3); i_7++) {
                    C[i_6][i_4-1][i_7][i_7+i_5+1] = H[i_7+i_6+1][i_4-1][i_7+i_5+1] + I[i_7][i_5][1] + E[i_6][i_4][i_4][i_5+1] + E[i_5+i_4][i_6][i_7][i_6] + D[i_5-1][i_7][i_4][i_6] * D[i_6+i_5-1][i_7][1][i_6-1] + D[i_5][i_4+1][i_7+1][i_4] * E[i_4][i_7+i_6+1][i_5+1][i_4] - C[i_6][i_5+1][i_4][i_7+i_4+3] - 1;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4316251221_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
