        ...
        for (int i_1 = 0; i_1 < min(i_0, PB_M-2); i_1++) {
            for (int i_2 = 1; i_2 < PB_M-3; i_2++) {
                for (int i_3 = 2; i_3 < -i_1+PB_M-2; i_3++) {
                    A[i_2+2][i_2-1][i_1][i_3-2] = D[i_1][i_3][i_2][i_1] - E[i_3+i_1+2][i_0-1][i_2][0] + A[i_2+3][i_2][i_1][i_3-2] + A[i_2+3][i_2][i_0][i_3-2] + A[i_2+3][i_2][i_1+1][i_3-2] * 1;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_N-2; i_4++) {
        B[i_4] = F[i_4-2] - F[i_4] + F[i_4+2] - F[i_4+1] - B[i_4+1] - 6;
        for (int i_5 = 0; i_5 < i_4; i_5++) {
            for (int i_6 = 1; i_6 < PB_M-2; i_6++) {
                for (int i_7 = 2; i_7 < PB_L; i_7++) {
                    A[i_6+2][i_6-1][i_5][i_7-2] = G[i_6][i_7-2][i_5] * E[i_6+2][i_7][i_5][i_4] + H[i_4][i_7][i_6][i_4][i_5+1] * 6;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4322232213_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H)));
