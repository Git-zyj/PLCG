        ...
        for (int i_1 = i_0; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 0; i_2 < PB_Q-4; i_2++) {
                for (int i_3 = 2; i_3 < min(PB_M-2, -i_2+PB_P); i_3++) {
                    A[i_0+2][i_3][i_1][i_2+2] = D[i_1][i_0][i_3+i_2][i_1] * E[i_3][i_0][i_1-2][i_2] * E[i_2+2][i_1][i_3][i_0-2] + E[i_1+2][i_3][i_0][i_2] + A[i_3+2][i_1][i_0][i_2+4] * B[i_0-1][i_3][i_1-1] * B[i_1][i_3-1][i_2] * B[i_0][i_2+2][i_3] + 2;
                    B[i_0][i_2][i_3] = D[i_2][i_3][i_1+1][i_0+2] - D[i_0-1][i_3-1][i_1-1][i_3-2] - E[i_2][i_0][i_1][i_3] * E[i_0+2][i_3][i_1][i_2] + F[i_3][i_0][i_1] - D[i_1+1][i_0][i_0-2][i_2] - A[i_0+2][i_3][i_1][i_2+2] * A[i_3+2][i_1][i_2][i_0+2] + 6;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M; i_4++) {
        for (int i_5 = max(i_4, 2); i_5 < min(PB_M, -i_4+PB_L); i_5++) {
            for (int i_6 = 0; i_6 < -i_5+PB_M; i_6++) {
                B[i_6+1][i_4][i_5] = G[i_6][i_5] * F[i_5][i_6+1][i_5+i_4] + H[i_6+i_5][i_4][i_5-2] + F[i_6][i_4][i_5+1] * H[i_4][i_6][i_5] * 2;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4314252325_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H)));
