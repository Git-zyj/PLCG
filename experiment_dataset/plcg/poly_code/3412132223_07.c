...
void kernel_3412132223_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_L; i_0++) {
        A[i_0-2] = E[i_0] * E[i_0] - A[i_0-3] * 6;
        for (int i_1 = 0; i_1 < PB_P; i_1++) {
            for (int i_2 = 2; i_2 < min(PB_Q, -i_0+PB_L); i_2++) {
                B[i_2+i_0][i_0][i_2] = F[i_2-2][i_0][i_1] * F[i_1][i_2][i_0-2] + B[i_2+i_0-1][i_0-1][i_2] + B[i_2+i_0-2][i_0-2][i_2] - 1;
            }
        }
        for (int i_3 = 0; i_3 < PB_L-2; i_3++) {
            C[i_3][0][i_0-2] = G[i_3+2][i_0] - G[i_3][1] * G[i_3][i_0] + C[i_3+1][0][i_0-2] - 4;
        }
    }
    for (int i_4 = 2; i_4 < PB_L; i_4++) {
        A[i_4-2] = E[i_4] + G[i_4][0] - 6;
    }
#pragma endscop
...
kernel_3412132223_07(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
