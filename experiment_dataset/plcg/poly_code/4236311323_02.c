...
void kernel_4236311323_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 2; i_1 < PB_N; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 2; i_3 < min(PB_L-1, i_1); i_3++) {
                    A[i_1][i_2][i_3+1] = A[i_1-2][i_3][i_2+1] + A[i_1][i_3-2][i_2+1] * A[i_1-2][i_2][i_3+1] - 2;
                }
            }
        }
        for (int i_4 = i_0; i_4 < PB_N-1; i_4++) {
            for (int i_5 = i_4; i_5 < PB_M; i_5++) {
                A[i_4+1][i_5][i_0+2] = C[i_4][i_5][i_0] * 2;
            }
        }
    }
#pragma endscop
...
kernel_4236311323_02(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C));
