...
void kernel_3416152211_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_Q-3; i_1++) {
        for (int i_2 = 1; i_2 < min(-i_1+PB_P-1, PB_M-2); i_2++) {
            for (int i_3 = max(2, i_2); i_3 < min(-i_1+PB_M, -i_2+PB_M); i_3++) {
                B[i_1][i_2+1][i_1+2] = F[i_2][i_3] + G[i_3+i_2][i_1-2][i_1+2] - F[i_2][0] * B[i_1+1][i_2+2][i_1+3] + B[i_1-1][i_2+1][i_1+1] * C[i_2+1][i_3-2][i_2+i_1+1] + 5;
                C[i_1+1][i_3-2][i_2+i_1] = H[i_3][i_2][i_2][i_1-1] + F[i_3+i_1][i_2] - G[i_3][i_1][i_2+1] + G[i_2+2][i_1][i_3-1] - G[i_3][i_2][i_1+1] + G[i_2-1][i_1][i_1-2] + F[i_1-1][i_2] * G[i_2][i_3+i_1+2][i_2] - 1;
            }
        }
        A[i_1] = E[i_1] - E[i_1+1] - F[i_1][i_1] - E[i_1] * 3;
    }
#pragma endscop
...
kernel_3416152211_06(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
