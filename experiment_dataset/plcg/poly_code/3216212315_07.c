...
void kernel_3216212315_07(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N; i_0++) {
        for (int i_1 = max(3, i_0); i_1 < PB_N+1; i_1++) {
            A[i_0-2][i_1] = C[i_0] * A[i_1-3][i_0+1] + A[i_0-2][i_1-1] - 6;
            for (int i_2 = 1; i_2 < i_1; i_2++) {
                A[i_1-2][i_2-1] = A[i_1-1][i_2] - 4;
            }
        }
    }
#pragma endscop
...
kernel_3216212315_07(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
