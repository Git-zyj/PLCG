...
void kernel_3214212323_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        B[i_0] = C[0] * B[i_0] - B[i_0-2] + B[i_0+2] + 5;
        B[i_0] = 6;
    }
#pragma endscop
...
kernel_3214212323_06(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
