...
void kernel_3334352215_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_L; i_1++) {
        for (int i_2 = 1; i_2 < PB_L-2; i_2++) {
            B[i_1-1][i_2+2] = D[i_1] + F[i_2][i_1] * G[i_2+2] - F[i_2][i_1] + F[i_2][i_1] + H[i_1][i_2-1] - B[i_1][i_2+2] * 6;
            B[i_1-1][i_2+3] = F[i_2+1][i_1] - F[i_2][i_1] - D[i_2+2] * H[i_1][i_2] - B[i_1][i_2+2] + B[i_1-1][i_2+2] * 1;
        }
    }
#pragma endscop
...
kernel_3334352215_07(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
