...
void kernel_4214132125_06(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd)){
        ...
        for (int i_1 = 0; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 2; i_2 < min(PB_Q-2, -i_1+PB_M-2); i_2++) {
                for (int i_3 = i_0; i_3 < -i_2+PB_Q-2; i_3++) {
                    B[i_3+i_2-1][i_0][i_1][i_2-2] = C[i_2+i_1+2][i_3][i_3+i_2+2] - C[i_1][i_2][i_0] - D[i_3][i_0][i_2][i_1] * 6;
                }
            }
        }
        for (int i_4 = i_0; i_4 < PB_M; i_4++) {
            for (int i_5 = 1; i_5 < PB_Q-2; i_5++) {
                for (int i_6 = i_0; i_6 < min(-i_5+PB_L, -i_4+PB_M); i_6++) {
                    B[i_6+i_4][i_0][i_5][i_6] = D[i_4][i_6][i_0-2][i_5-1] - D[i_0-1][i_6][i_4][i_6+i_5] - B[i_6+i_4][i_0][i_5+2][i_6-1] + 3;
                }
            }
        }
    }
...
kernel_4214132125_06(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D));
