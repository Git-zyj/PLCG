...
void kernel_2314131125_02(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 3; i_1 < PB_M; i_1++) {
        B[i_1-1] = D[i_1] * D[i_1] - D[i_1] + B[i_1] - 1;
        B[i_1-3] = D[i_1] * D[i_1] + 3;
    }
#pragma endscop
...
kernel_2314131125_02(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
