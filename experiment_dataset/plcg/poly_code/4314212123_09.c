...
void kernel_4314212123_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf)){
        ...
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < PB_Q+1; i_2++) {
                for (int i_3 = 0; i_3 < PB_M; i_3++) {
                    A[i_1][i_2-1][i_3][i_0+2] = C[i_3][i_3][i_2] * 6;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < i_4; i_5++) {
            for (int i_6 = 2; i_6 < -i_5+PB_P-2; i_6++) {
                ...
                for (int i_7 = 1; i_7 < PB_P-2; i_7++) {
                    C[i_6][i_6][i_4] = D[i_4][i_7+i_6-2][i_5-1][i_5] + E[i_6][i_5+1][i_4] - F[i_7][i_6+i_5+2][i_7+2][i_4+1] * A[i_5+1][i_7-1][i_6][i_4+2] - 2;
                }
            }
        }
    }
...
kernel_4314212123_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
