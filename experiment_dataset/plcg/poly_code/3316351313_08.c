...
void kernel_3316351313_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        A[i_0] = D[i_0-1] + E[i_0+1] + D[i_0] - D[i_0+1] * A[i_0-1] * 2;
    }
    for (int i_1 = 2; i_1 < PB_N; i_1++) {
        for (int i_2 = i_1; i_2 < PB_N; i_2++) {
            C[i_2-1] = F[i_2+1][i_1] + D[i_1-1] - D[i_1] - F[i_2][i_1] + F[i_2][i_1] - F[i_1+1][i_2] - G[i_2][i_1] * C[i_2-1] - C[i_2-2] - C[i_2] + 3;
        }
        C[i_1-1] = E[i_1] * H[i_1-1] - D[i_1] * E[i_1] - C[i_1] - C[i_1-2] * 6;
    }
#pragma endscop
...
kernel_3316351313_08(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
