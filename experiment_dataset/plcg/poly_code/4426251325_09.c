...
void kernel_4426251325_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        A[i_0] = E[i_0] - E[i_0] + E[i_0-1] - E[i_0] * E[i_0] + A[i_0-2] - 6;
    }
    for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
        for (int i_2 = 2; i_2 < -i_1+PB_M; i_2++) {
            A[i_2-2] = F[i_2][i_2] * F[i_2][i_1] * G[i_2][i_2] * F[i_2+i_1][i_1] * A[i_2] + A[i_2-2] - 5;
        }
        for (int i_3 = 3; i_3 < i_1; i_3++) {
            for (int i_4 = 3; i_4 < -i_3+PB_L; i_4++) {
                for (int i_5 = 2; i_5 < min(i_4, -i_1+PB_Q); i_5++) {
                    C[i_5][i_3-1][i_4-1][i_5] = H[i_3][i_5-1][i_1][i_4+1] - H[i_5][i_3][i_5+i_1][i_4+1] * I[i_3][i_5][i_1-1][i_3-1] * H[i_3+1][i_1][i_4][i_1] + H[i_1+1][i_4+i_3][i_5][0] + C[i_5][i_3-1][i_4][i_5] + C[i_5-2][i_3-1][i_4-1][i_5-2] - C[i_5][i_3][i_4-1][i_5] + C[i_5][i_3-3][i_4-3][i_5] * 5;
                }
            }
        }
    }
    for (int i_6 = 1; i_6 < PB_M-1; i_6++) {
        for (int i_7 = i_6; i_7 < PB_P-1; i_7++) {
            for (int i_8 = 0; i_8 < PB_M-2; i_8++) {
                D[i_6+1][i_7][i_8] = J[i_7][i_6][i_8] + G[i_8][i_8] + K[i_8+1][i_6-1][i_7+1] + D[i_6+1][i_7-1][i_8] * D[i_8+2][i_7][i_6] + 1;
            }
        }
    }
#pragma endscop
...
init_array(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4426251325_09(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K)));
