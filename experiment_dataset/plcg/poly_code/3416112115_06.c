...
void kernel_3416112115_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_L+2; i_0++) {
        B[i_0-2] = 2;
        B[i_0-2] = B[i_0-3] * C[0] - 2;
        C[0] = E[i_0] - 3;
    }
    for (int i_1 = 2; i_1 < PB_M; i_1++) {
        C[0] = E[i_1-1] * E[i_1-2] - 6;
    }
#pragma endscop
...
kernel_3416112115_06(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E));
