...
void kernel_4234112311_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 1; i_1 < PB_Q+1; i_1++) {
            for (int i_2 = 3; i_2 < PB_M; i_2++) {
                for (int i_3 = 3; i_3 < PB_M-1; i_3++) {
                    A[i_2][i_3-2][i_0-1] = A[i_3-1][i_2-3][i_1-1] + A[i_3+1][i_0-3][i_1-1] - A[i_2][i_3-3][i_0-2] * 3;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_Q; i_4++) {
        for (int i_5 = 1; i_5 < i_4; i_5++) {
            for (int i_6 = 0; i_6 < PB_L; i_6++) {
                A[i_6][i_5-1][i_4] = C[i_5][i_6][i_6] + C[i_6][i_5][i_4] - 3;
            }
        }
    }
#pragma endscop
...
kernel_4234112311_06(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C));
