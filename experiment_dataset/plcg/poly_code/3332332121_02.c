    ...
    for (int i_2 = 2; i_2 < PB_M-2; i_2++) {
        for (int i_3 = 1; i_3 < PB_M-2; i_3++) {
            for (int i_4 = 2; i_4 < -i_3+PB_M; i_4++) {
                C[i_2+2][i_3][i_4-2] = H[i_2+1][i_4] * I[i_4+i_3][i_4-2][i_2] - C[i_2+2][i_3-1][i_4] * C[i_3+2][i_4-2][i_2-2] * 3;
            }
        }
    }
#pragma endscop
...
kernel_3332332121_02(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
