...
void kernel_4414331311_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl),int xm,DATA_TYPE POLYBENCH_1D(M,xM,xm)){
        ...
        for (int i_1 = i_0; i_1 < PB_P; i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_Q; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_1+PB_M, PB_P-1); i_3++) {
                    A[i_3][i_1][i_2][i_0] = E[i_3][i_2][i_1][i_0] - F[i_3+i_1][i_0][i_2][i_0][i_2+1] - G[i_2][i_3-1][i_1][0] * H[i_1][i_0][i_3-1][i_2+i_0] + I[i_3][i_2][i_1-1] * A[i_0][i_1][i_2-1][i_3] + A[i_3-1][i_1-1][i_2+1][i_0-1] - A[i_3+1][i_1-1][i_2][i_0+1] + A[i_3+1][i_1-1][i_2-1][i_0-1] + A[i_2][i_1][i_0+1][i_3+1] + A[i_3][i_1][i_2+1][i_0-1] - 2;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        B[i_4] = J[i_4+1] - K[i_4] * D[i_4-1] - D[i_4] + 6;
        for (int i_5 = 2; i_5 < PB_L+1; i_5++) {
            C[i_4][i_5-1] = J[i_4+1] * J[i_4] * B[i_4] + C[i_4][i_5-2] - 3;
        }
        D[i_4] = L[i_4+1][0] - M[i_4] - K[i_4-1] * B[i_4] - D[i_4+1] * 5;
    }
#pragma endscop
...
kernel_4414331311_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), xm,POLYBENCH_ARRAY(M));
