...
void kernel_4126252111_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        A[i_0-1] = B[i_0] - B[i_0] * B[i_0+2] + B[i_0+2] + B[i_0+1] + A[i_0-2] + 3;
    }
#pragma endscop
...
kernel_4126252111_03(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
