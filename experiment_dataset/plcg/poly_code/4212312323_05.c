...
void kernel_4212312323_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
        ...
        for (int i_1 = 0; i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 0; i_3 < PB_L-2; i_3++) {
                    A[i_0][i_1+i_0-2][i_2][i_3] = C[i_2+1][i_1][i_0-1] * A[i_0][i_1+i_0][i_2][i_3] * A[i_0][i_1+i_0-2][i_2+1][i_3+2] - 5;
                }
            }
        }
        for (int i_4 = 4; i_4 < i_0; i_4++) {
            B[i_4-2][i_0] = D[i_4][i_0+1] * B[i_4-1][i_0-2] - B[i_4-2][i_0+1] + B[i_4-4][i_0] * B[i_4][i_0] - 1;
        }
    }
#pragma endscop
...
kernel_4212312323_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
