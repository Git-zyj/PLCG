...
void kernel_3232311323_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        for (int i_1 = 0; i_1 < PB_M-3; i_1++) {
            for (int i_2 = 0; i_2 < PB_L; i_2++) {
                A[i_1+1][i_2][i_2][i_0] = A[i_1+3][i_0][i_0][i_2] - 3;
            }
        }
    }
    for (int i_3 = 0; i_3 < PB_N-2; i_3++) {
        for (int i_4 = 4; i_4 < PB_L; i_4++) {
            for (int i_5 = 2; i_5 < min(-i_4+PB_N, -i_3+PB_N-2); i_5++) {
                B[i_5][i_5+i_4] = C[i_4][i_5][i_3] * B[i_4-2][i_5+i_4-4] + B[i_5-2][i_5+i_4-2] + B[i_3+2][i_5+i_3+2] * B[i_3][i_5+i_3+1] * B[i_5][i_5+i_4-2] * 3;
            }
        }
    }
#pragma endscop
...
kernel_3232311323_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
