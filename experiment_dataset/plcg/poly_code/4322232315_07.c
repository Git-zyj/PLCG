...
void kernel_4322232315_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_Q-2; i_0++) {
        for (int i_1 = 2; i_1 < -i_0+PB_Q; i_1++) {
            for (int i_2 = 2; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_2+PB_M+1, -i_0+PB_L); i_3++) {
                    A[i_0][i_3][i_2-2][i_2+1] = D[i_2][i_3-1][i_3+i_0][i_2] - E[i_2][i_3][i_0+2][0] + D[i_2][i_0][i_3][i_1-2] - E[i_3+i_2-1][i_0-1][i_1+i_0][i_2] + E[i_2][i_2][i_1-1][i_0+2] + A[i_2][i_3+1][i_0-2][i_0+1] * A[i_3+1][i_2][i_1-2][i_1+1] - A[i_0][i_3+1][i_2-2][i_2+1] + 5;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-2; i_4++) {
        for (int i_5 = 2; i_5 < PB_L-1; i_5++) {
            for (int i_6 = 0; i_6 < PB_L; i_6++) {
                A[i_4-1][i_6][i_5-2][i_5+1] = F[i_4][i_5][i_6] - F[i_6][i_4-2][i_5-1] + 5;
            }
        }
        for (int i_7 = 0; i_7 < -i_4+PB_M-2; i_7++) {
            C[i_4][i_7+i_4] = G[i_4][i_4] - H[i_7] * C[i_4+1][i_7+i_4+2] - C[i_4+1][i_7+i_4+1] * 2;
        }
    }
#pragma endscop
...
kernel_4322232315_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
