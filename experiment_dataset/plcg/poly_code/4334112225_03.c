...
void kernel_4334112225_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf)){
...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < PB_Q; i_2++) {
                for (int i_3 = i_2; i_3 < PB_M; i_3++) {
                    A[i_0][i_1][i_2][2] = D[i_3][i_2-1][i_0-1][i_1] - A[i_0-1][i_1][i_2-1][2] * 1;
                }
            }
        }
    }
    for (int i_4 = 4; i_4 < PB_P; i_4++) {
        ...
        for (int i_5 = 3; i_5 < -i_4+PB_P; i_5++) {
            B[i_4-2] = E[i_4][i_5+i_4] * F[i_5] - B[i_5-3] * 1;
        }
    }
#pragma endscop
...
kernel_4334112225_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F));
