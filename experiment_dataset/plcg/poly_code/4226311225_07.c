...
void kernel_4226311225_07(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
        ...
        for (int i_4 = i_3; i_4 < PB_N-2; i_4++) {
            for (int i_5 = 0; i_5 < PB_P; i_5++) {
                for (int i_6 = max(i_4, 2); i_6 < PB_L-1; i_6++) {
                    B[i_6][i_5][i_3+1][0] = C[i_4-1][i_3-1][i_6+1][0] * B[i_4+2][i_5][i_6][0] + B[i_6-2][i_5][i_3+1][0] * B[i_6+1][i_5][i_3+1][0] - 1;
                }
            }
        }
    }
...
kernel_4226311225_07(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
