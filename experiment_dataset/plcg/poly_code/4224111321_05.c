...
void kernel_4224111321_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < PB_N; i_2++) {
                for (int i_3 = max(1, i_2); i_3 < PB_M-2; i_3++) {
                    A[i_2][i_1][i_3-1] = A[i_3][i_2+1][i_1] + B[i_2][1] + B[i_3+2][1] - 5;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_N; i_4++) {
        for (int i_5 = 3; i_5 < PB_L; i_5++) {
            for (int i_6 = 2; i_6 < min(i_5, PB_M-1); i_6++) {
                B[i_6][1] = C[i_5][i_4][i_4] * A[i_4][i_6][i_5-3] + A[i_4][i_5][i_6-2] - B[i_6+1][1] * 6;
            }
        }
    }
#pragma endscop
...
kernel_4224111321_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
