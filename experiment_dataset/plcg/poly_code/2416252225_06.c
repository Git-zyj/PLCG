...
void kernel_2416252225_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N-2; i_0++) {
        A[i_0] = E[i_0] + E[i_0] * A[i_0+1] + 2;
        for (int i_1 = 2; i_1 < PB_L; i_1++) {
            A[i_1] = F[i_1][0] - G[i_0][i_1] * H[i_1-2] - F[i_1-1][i_0] - G[i_0][i_1+2] * G[i_1][i_0] - A[i_0+2] + 6;
        }
    }
    for (int i_2 = 2; i_2 < PB_N-2; i_2++) {
        A[i_2] = G[i_2][i_2] * H[i_2] - H[i_2] * 1;
        for (int i_3 = i_2; i_3 < -i_2+PB_N+2; i_3++) {
            A[i_2+2] = G[i_3+i_2-2][i_2] * F[i_3][i_2+1] * F[i_3][i_2] - E[i_3] * G[i_2+2][i_3] + I[i_3+i_2-1][i_2-1][i_3] * 1;
        }
    }
#pragma endscop
...
kernel_2416252225_06(xa,POLYBENCH_ARRAY(A), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
