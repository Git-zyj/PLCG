...
void kernel_4226311215_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < min(i_0, PB_P-1); i_1++) {
            for (int i_2 = 0; i_2 < PB_N; i_2++) {
                for (int i_3 = 0; i_3 < PB_N-1; i_3++) {
                    A[i_3+1][i_0-1][i_2][i_1+1] = A[i_2][i_1-1][i_0][i_3+1] + 2;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M-1; i_4++) {
        for (int i_5 = 0; i_5 < min(-i_4+PB_M-1, PB_P-2); i_5++) {
            B[i_4][i_5+1] = C[i_5+i_4+1] + B[i_4][i_5+2] + B[i_5][i_4] + B[i_4+1][i_5+2] - 4;
        }
    }
#pragma endscop
...
kernel_4226311215_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
