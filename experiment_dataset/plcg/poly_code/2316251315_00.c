...
void kernel_2316251315_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            B[i_0-1] = D[i_0+1] - E[0] - E[i_1] - F[i_1][i_0] - G[i_1][i_0] * H[i_0][i_1-1][i_0] + B[i_0-1] - 5;
        }
    }
    for (int i_2 = 2; i_2 < PB_M-1; i_2++) {
        for (int i_3 = 2; i_3 < PB_L; i_3++) {
            B[i_3-1] = G[i_2][i_3] - F[i_3-1][i_2-1] - F[i_2+1][i_3] + F[i_2][i_3-1] + B[i_3-2] * 6;
        }
        B[i_2-2] = E[i_2] * E[i_2] + E[i_2] * E[i_2] * E[i_2+1] * B[i_2-2] - 1;
    }
#pragma endscop
...
kernel_2316251315_00(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
