...
void kernel_4334151315_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
        ...
        for (int i_1 = i_0; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 1; i_2 < PB_L-2; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_2+PB_L, i_1); i_3++) {
                    A[i_0][i_1][i_2-1][i_2+1] = D[i_3+i_2][i_0][i_1][i_1] + A[i_3-1][i_1][i_2][i_2+2] * A[i_0+1][i_2][i_3-1][i_3+1] * A[i_2][i_0][i_1][i_1+2] - 5;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        B[i_4] = E[i_4] * E[i_4] - E[i_4] - E[i_4-1] + E[i_4] * E[i_4] + F[i_4-1][i_4+1] - E[i_4-1] * B[i_4-1] - B[i_4+1] + 1;
        for (int i_5 = 0; i_5 < PB_P-1; i_5++) {
            for (int i_6 = i_4; i_6 < PB_M; i_6++) {
                for (int i_7 = 1; i_7 < PB_M+1; i_7++) {
                    A[i_6][i_5][i_4-1][i_4+1] = G[i_7-1][i_6][i_5] * D[i_5][i_6][i_5+1][1] * D[i_7][i_6][i_5+1][i_4] - D[i_6][i_7][i_4][0] + 1;
                }
            }
        }
    }
...
kernel_4334151315_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
