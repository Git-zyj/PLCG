        ...
        for (int i_1 = i_0; i_1 < PB_M; i_1++) {
            for (int i_2 = i_0; i_2 < -i_0+PB_M; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_M; i_3++) {
                    A[i_0-1][i_2][i_1][i_3+1] = E[i_1][i_2][i_3+1][i_2+i_0] * E[i_2][i_0][i_1][i_3+i_0] - A[i_0][i_2+2][i_3][i_1+2] - A[i_0-1][i_1][i_3+2][i_2-1] * 3;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
            for (int i_5 = i_0; i_5 < PB_M; i_5++) {
                for (int i_6 = 0; i_6 < min(-i_4+PB_M, -i_5+PB_N); i_6++) {
                    B[i_6][i_5+1][i_4][i_0+1] = F[i_5][i_6][i_4+1] * E[i_6+i_5][i_0][i_6+i_4][i_5] * B[i_5][i_0+1][i_4+2][i_6+1] - B[i_4-1][i_5+1][i_6][i_0+1] * B[i_0][i_6][i_4+1][i_5+2] * B[i_0-2][i_5+1][i_4][i_6+2] * 5;
                }
            }
        }
    }
    for (int i_7 = 0; i_7 < PB_M-1; i_7++) {
        D[i_7+1] = G[i_7] - G[i_7] - G[i_7] - D[i_7+1] + 5;
        D[i_7+1] = G[i_7] + H[i_7][i_7] * G[i_7] + G[i_7+1] - 6;
    }
#pragma endscop
...
kernel_4436131323_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
