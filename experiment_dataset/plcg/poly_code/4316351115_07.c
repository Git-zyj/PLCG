...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < min(-i_0+PB_Q, PB_M); i_1++) {
            for (int i_2 = 0; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_L-1; i_3++) {
                    B[i_0][i_2+1][i_3+1][i_0] = D[i_1][i_3-1][i_0+1] - E[0][i_2][i_3][i_1+i_0][i_2] * F[i_1][i_3+1][i_3] * 6;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_M; i_4++) {
            for (int i_5 = 1; i_5 < min(min(-i_0+PB_Q, i_4), PB_L-1); i_5++) {
                for (int i_6 = 1; i_6 < -i_4+PB_Q-1; i_6++) {
                    B[i_0][i_4][i_6+1][i_0] = G[i_0+1][i_5][i_4][i_6+1] - H[i_4-1][i_0][i_5-1][i_6] - E[i_0][i_5-1][i_6+i_4+1][i_6-1][i_5+i_0] - B[i_4][i_5+1][i_6][i_4] * 6;
                }
            }
        }
    }
    for (int i_7 = 1; i_7 < PB_M; i_7++) {
        for (int i_8 = 1; i_8 < -i_7+PB_M; i_8++) {
            for (int i_9 = 1; i_9 < min(min(min(i_8, -i_8+PB_M), -i_7+PB_L), PB_M-1); i_9++) {
                C[i_9+1][i_7][i_7] = D[i_8][i_9-1][i_7-1] - I[i_8-1][0] + J[i_9][i_8+i_7][i_9+i_7] + K[i_9][i_7] - L[i_9+i_8][i_7-1] * D[i_9][i_7][i_8] * D[i_8][i_7][i_9] * F[i_9-1][i_9+1][i_8] + D[i_9][i_7-1][i_8] + 5;
            }
        }
    }
#pragma endscop
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4316351115_07(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L)));
