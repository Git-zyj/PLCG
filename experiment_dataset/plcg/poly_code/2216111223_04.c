...
void kernel_2216111223_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_M-2 - 1; i_0 >= 0; i_0--) {
        A[i_0][0] = C[i_0] - A[i_0+2][0] - 6;
        A[i_0][0] = A[i_0][0] - 1;
    }
#pragma endscop
...
kernel_2216111223_04(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
