...
void kernel_2122112323_07(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N-2; i_0++) {
        for (int i_1 = 0; i_1 < min(PB_L-4, -i_0+PB_M-2); i_1++) {
            A[i_1+i_0][i_1+2] = B[i_0+2][i_1][i_1] - A[i_1+i_0+1][i_1+3] + A[i_1+i_0+1][i_1+2] + A[i_1+i_0+2][i_1+4] + 3;
        }
    }
#pragma endscop
...
kernel_2122112323_07(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B));
