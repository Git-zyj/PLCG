...
void kernel_4316131223_01(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_1+PB_N-1, -i_0+PB_P); i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_P-2; i_3++) {
                    B[i_2][i_1][i_3+i_0+2][i_1] = D[i_1][i_3+1][i_0][i_2] + 5;
                }
                for (int i_4 = i_1; i_4 < min(-i_1+PB_M, -i_0+PB_P); i_4++) {
                    B[i_2][i_1][i_4+i_0][i_1] = D[i_0][i_4][i_2][i_1] + D[i_2][i_0][i_1][i_4] - 1;
                    B[i_2][i_1][i_4+i_0-1][i_1] = D[i_2][i_0][i_4+i_1][i_2] + E[i_2][i_4][i_0][i_4+i_1][1] + D[i_2+i_1+1][i_0-1][i_4][i_4] * F[i_0][i_1][1] + B[i_4][i_1-1][i_2+i_0-2][i_1-1] + B[i_4][i_1][i_2+i_0][i_1] - 5;
                }
            }
        }
    }
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), INIT_SEED);
kernel_4316131223_01(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F)));
