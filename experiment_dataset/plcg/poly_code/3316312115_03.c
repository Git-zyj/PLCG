...
void kernel_3316312115_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_0 = 0; i_0 < PB_P; i_0++) {
        ...
        for (int i_3 = 1; i_3 < min(PB_P-2, i_0); i_3++) {
            for (int i_4 = 0; i_4 < PB_P; i_4++) {
                B[i_0+2][i_3][i_4] = D[i_4][i_3-1][i_0] * A[i_4][i_3+2][i_0+1] * 4;
            }
        }
    }
    for (int i_5 = 1; i_5 < PB_Q; i_5++) {
        for (int i_6 = 1; i_6 < min(PB_P+1, i_5); i_6++) {
            for (int i_7 = 0; i_7 < PB_M-1; i_7++) {
                C[i_7][i_6-1][i_5] = B[i_7+1][i_5-1][i_6-1] * 5;
            }
        }
    }
#pragma endscop
...
kernel_3316312115_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
