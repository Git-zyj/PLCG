        ...
        for (int i_1 = 1; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 2; i_2 < PB_L; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_1+PB_P, PB_L-2); i_3++) {
                    A[i_0][i_3+i_1][i_2][i_3+1] = D[i_3][i_0+1][i_1+2][i_2-1] + E[i_3][i_0][i_3+2][i_2] * F[i_0][i_2][i_3-1] - A[i_0+1][i_3+i_1-1][i_2-2][i_1+1] + 5;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < -i_4+PB_P-1; i_5++) {
            for (int i_6 = 0; i_6 < PB_Q-1; i_6++) {
                for (int i_7 = 0; i_7 < PB_M-2; i_7++) {
                    A[i_7+2][i_5+i_4+1][i_6+1][i_4+1] = G[i_7][i_6][0][i_4] * 5;
                }
            }
        }
        for (int i_8 = 0; i_8 < PB_L; i_8++) {
            for (int i_9 = 0; i_9 < PB_L; i_9++) {
                for (int j_0 = 0; j_0 < min(min(-i_9+PB_L, -i_8+PB_M-1), -i_4+PB_M); j_0++) {
                    C[j_0+i_4][i_8][i_9][2] = G[i_4][i_8][j_0][i_9] * F[i_8][j_0][i_9] - D[i_4+1][j_0+i_9][i_8][0] - H[j_0+i_8+1][j_0][i_4][i_9][i_4-1] + 1;
                }
            }
        }
    }
...
kernel_4332332125_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H));
