...
void kernel_2114132215_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        A[i_0] = B[1] - B[i_0] - B[i_0] - A[i_0+1] + A[i_0-1] * 4;
    }
#pragma endscop
...
kernel_2114132215_01(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
