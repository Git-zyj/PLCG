        ...
        for (int i_1 = 1; i_1 < PB_Q; i_1++) {
            for (int i_2 = i_0; i_2 < PB_Q-1; i_2++) {
                for (int i_3 = 1; i_3 < -i_2+PB_L; i_3++) {
                    A[i_0][i_1][i_2][i_0] = C[i_3-1][i_2][i_1][i_0-1] + D[i_3+i_2][i_1-1][i_0][i_0] - A[i_2+1][i_1][i_3][i_2+1] * A[i_0-1][i_1][i_2][i_0-1] + A[i_0][i_1-1][i_2][i_0] * A[i_1][i_3][i_0+1][i_1] - 3;
                }
            }
        }
        B[i_0] = E[i_0+1] - F[i_0] - G[i_0-1][i_0] - E[i_0] * E[i_0] + H[i_0-1] - F[i_0] * B[i_0-1] - 1;
    }
#pragma endscop
...
kernel_4234351311_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
