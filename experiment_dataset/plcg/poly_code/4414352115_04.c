...
void kernel_4414352115_04(int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj)){
        ...
        for (int i_1 = 0; i_1 < min(PB_P-3, -i_0+PB_L); i_1++) {
            for (int i_2 = 2; i_2 < min(-i_1+PB_M, PB_P); i_2++) {
                for (int i_3 = 2; i_3 < i_1; i_3++) {
                    D[i_0+2][i_1+3][i_3+i_2-1][i_3-2] = E[i_3][i_2-2][i_1+i_0][i_3] + F[i_1][i_0][i_3][0] * G[i_1][i_3+i_2][i_0][i_0] - F[i_2+i_1][i_3][i_3-1][i_1+i_0] - H[i_3-2][i_0][i_2] * G[i_1][i_3][i_3-2][i_0-2] * 6;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_P; i_4++) {
            for (int i_5 = 2; i_5 < min(-i_4+PB_M, -i_0+PB_M+2); i_5++) {
                B[i_4][i_5] = H[i_5-2][i_4-1][i_0] * I[i_5][i_0][i_4] - H[i_5+1][i_5][i_4] + I[i_4][i_5+i_0-2][i_5] * I[i_0][i_5+i_4][i_0] - B[i_4][i_5+1] + 5;
            }
        }
    }
    for (int i_6 = 3; i_6 < PB_P-2; i_6++) {
        for (int i_7 = 1; i_7 < min(-i_6+PB_Q+2, PB_L-2); i_7++) {
            for (int i_8 = 0; i_8 < -i_6+PB_L; i_8++) {
                for (int i_9 = 2; i_9 < i_7; i_9++) {
                    D[i_8+1][i_9+1][i_7+i_6-2][i_6-3] = G[i_8][i_7-1][i_9][i_6] - F[i_9-2][i_8][i_6][i_7] + F[i_9][i_8][i_7+1][i_9] - G[i_9][i_8+i_6][i_7][2] + F[i_9][i_6][i_9+1][i_7] + 6;
                }
            }
            for (int j_0 = 0; j_0 < min(-i_7+PB_P, -i_6+PB_Q+2); j_0++) {
                for (int j_1 = 2; j_1 < min(-i_6+PB_Q, i_7); j_1++) {
                    D[i_7+2][i_6+2][j_1+j_0][j_1-2] = G[i_7][j_1][j_0][i_6+2] - J[j_1][j_0+i_7][i_6] * G[j_1][j_0][i_7][j_1+i_6] - G[j_0][i_6][i_7-1][j_0+i_6-2] - 5;
                }
            }
        }
    }
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4414352115_04(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J)));
