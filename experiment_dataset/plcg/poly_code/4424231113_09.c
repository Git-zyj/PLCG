...
#pragma scop
        ...
        for (int i_1 = i_0; i_1 < PB_N; i_1++) {
            for (int i_2 = max(1, i_1); i_2 < -i_1+PB_N; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_1+PB_N, -i_2+PB_P); i_3++) {
                    A[i_3+i_1][i_0][i_1][i_3+i_2] = E[i_2][i_3-1][i_0][i_0+1] - F[i_2][i_3+1][i_3][i_0] * A[i_2+i_1][i_0+1][i_1][i_3+i_2-1] - 5;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_P-1; i_4++) {
        for (int i_5 = 1; i_5 < -i_4+PB_M-1; i_5++) {
            B[i_5+i_4-1][i_5-1] = G[i_5+i_4+1][i_5] + H[i_5][i_4] - G[i_4][i_5] - H[i_5][i_4] - 4;
            C[i_4][i_5] = H[i_5+1][i_4-1] + H[i_5][i_4+1] - B[i_5+i_4][i_5-1] * B[i_5+i_4][i_5] - 1;
        }
    }
    for (int i_6 = 0; i_6 < PB_P; i_6++) {
        for (int i_7 = 1; i_7 < i_6; i_7++) {
            D[i_6][i_7] = H[i_7-1][i_6] * I[i_6] - G[i_7+1][i_6] * 5;
        }
    }
#pragma endscop
...
kernel_4424231113_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
