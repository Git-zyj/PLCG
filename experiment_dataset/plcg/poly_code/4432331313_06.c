...
void kernel_4432331313_06(int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk)){
        ...
        for (int i_1 = 2; i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_Q, -i_1+PB_Q-1); i_2++) {
                for (int i_3 = i_1; i_3 < PB_Q; i_3++) {
                    D[i_1+i_0][i_3+i_2-1][i_2+i_1-2][0] = E[i_2][i_3][i_0][i_2+i_0][i_1] - F[i_0+1][i_3+i_1][i_2+i_1+1][i_3] - G[i_0][i_3][i_1][i_2] - 1;
                }
            }
        }
        B[i_0] = H[i_0-1] * I[i_0] - I[i_0+1] + I[i_0-1] + B[i_0+1] + B[i_0-1] - B[i_0-1] * 5;
        for (int i_4 = 1; i_4 < -i_0+PB_L-2; i_4++) {
            for (int i_5 = 0; i_5 < -i_0+PB_L-1; i_5++) {
                C[i_5+i_0+1][i_0-1][i_4] = J[i_5][i_0][i_5+i_4-1] + K[i_5][i_0+1][i_4] + C[i_4+i_0+2][i_0-1][i_5] * 6;
            }
        }
    }
    for (int i_6 = 1; i_6 < PB_M; i_6++) {
        for (int i_7 = 1; i_7 < -i_6+PB_M; i_7++) {
            for (int i_8 = 1; i_8 < min(min(-i_7+PB_L-2, PB_Q-1), -i_6+PB_L-1); i_8++) {
                for (int i_9 = 0; i_9 < -i_6+PB_M; i_9++) {
                    D[i_7+i_6][i_9+i_8][i_8+i_7][0] = G[i_7-1][i_6][i_9][i_8+1] - D[i_9+i_7-1][i_8+i_6+1][i_8+i_7][0] + D[i_9+i_6][i_8+i_7+2][i_9+i_8+1][0] + D[i_7+i_6-1][i_9+i_8-1][i_8+i_7-1][0] * 6;
                }
            }
        }
    }
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4432331313_06(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K)));
