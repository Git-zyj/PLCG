        ...
        for (int i_1 = 0; i_1 < min(PB_N, -i_0+PB_L); i_1++) {
            for (int i_2 = i_1; i_2 < min(-i_0+PB_M, PB_M-2); i_2++) {
                for (int i_3 = 2; i_3 < PB_M; i_3++) {
                    A[i_3][i_1+i_0][i_2][i_3] = C[i_1][i_3][i_0][0] - D[i_3-1][i_2][i_1][i_0] - D[i_2+i_0][i_1][i_3][i_0+1] - D[i_2][i_3][i_1][i_0] + A[i_2+2][i_1+i_0][i_3-2][i_2+2] + 2;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_N-2; i_4++) {
        B[i_4] = E[i_4] - F[i_4] - B[i_4+2] - 3;
    }
#pragma endscop
...
kernel_4236331121_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F));
