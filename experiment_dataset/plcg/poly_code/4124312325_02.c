...
void kernel_4124312325_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        A[1] = B[i_0] - A[1] + A[1] - A[1] + 4;
    }
#pragma endscop
...
kernel_4124312325_02(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
