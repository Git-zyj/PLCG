...
void kernel_4412252315_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        for (int i_1 = i_0; i_1 < PB_P; i_1++) {
            for (int i_2 = 1; i_2 < PB_M-2; i_2++) {
                A[i_0-2][i_2][i_1] = E[i_1][i_0][i_2] - E[i_0+1][i_1+1][2] - F[i_2-1][i_1] * G[i_0+1][i_2+2][i_1-1] - 5;
            }
            for (int i_3 = 0; i_3 < -i_0+PB_P; i_3++) {
                for (int i_4 = 2; i_4 < -i_1+PB_P; i_4++) {
                    A[i_0-2][i_3][i_4+1] = H[i_4-1][i_3][i_1-2][i_0] * E[i_3+2][i_1][i_4] * H[i_3][i_0+2][i_1][i_3] * I[i_4][i_0][i_3][i_4] - H[i_0][i_3+2][i_1][i_4+i_1] + 6;
                    A[i_4-2][i_1][i_3] = H[i_4][i_1][i_3+i_0][i_4+1] * I[i_1][i_0][i_3][i_4] + I[i_1+1][i_3+i_0][i_4+2][1] * I[i_1-1][i_3][i_0-1][0] * H[i_4+1][i_0+1][i_0+2][i_1] - 5;
                }
            }
        }
    }
    for (int i_5 = 1; i_5 < PB_L-1; i_5++) {
        D[i_5] = J[i_5+1] * J[i_5+1] * K[i_5-1][1] + J[i_5] - K[i_5][i_5] - D[i_5+1] * D[i_5-1] + D[i_5+1] * D[i_5-1] - D[i_5-1] - D[i_5-1] + 6;
    }
#pragma endscop
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4412252315_08(xa,ya,za,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K)));
