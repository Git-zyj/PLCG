...
void kernel_4226132315_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 1; i_1 < PB_N; i_1++) {
            for (int i_2 = 3; i_2 < i_1; i_2++) {
                for (int i_3 = 0; i_3 < PB_N; i_3++) {
                    A[i_0][i_1][i_2-2][i_3] = C[i_0][i_1][i_3][i_2] * C[i_3][i_2][i_0-2][i_1] - C[i_0][i_1-1][i_2-2][i_3] * A[i_1+1][i_0][i_2-2][i_3] + A[i_0][i_1][i_2-3][i_3] * A[i_0][i_1][i_2-3][i_3+1] * 6;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-2; i_4++) {
        for (int i_5 = 0; i_5 < min(i_4, PB_P-1); i_5++) {
            for (int i_6 = 2; i_6 < -i_5+PB_N; i_6++) {
                for (int i_7 = 0; i_7 < min(PB_N-2, i_5); i_7++) {
                    A[i_7][i_5+1][i_6-2][i_4] = D[i_5][i_4-1][i_5+1] * C[i_6+i_5][i_7+2][i_4+2][2] * 3;
                }
            }
        }
    }
...
kernel_4226132315_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
