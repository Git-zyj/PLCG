...
void kernel_2424231223_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        B[i_0-2] = E[i_0] + E[i_0+1] * B[i_0] * B[i_0+2] - B[i_0-2] - B[i_0-1] - 6;
        B[i_0] = E[i_0-1] * 3;
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            C[i_1-1] = F[i_1][i_0] * G[i_1+1][i_0] + C[i_1] - 4;
        }
    }
    for (int i_2 = 0; i_2 < PB_M-3; i_2++) {
        D[i_2+1] = E[1] - G[i_2][i_2] * H[i_2] - H[i_2] - H[i_2+1] * D[i_2+3] - 1;
    }
#pragma endscop
...
kernel_2424231223_06(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
