...
void kernel_3416151213_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_Q-2; i_0++) {
        A[i_0+1] = E[i_0] * E[0] - E[i_0-1] - 1;
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < min(min(-i_0+PB_M, PB_Q-2), -i_1+PB_L+1); i_2++) {
                B[i_0][i_1][i_2+1] = F[i_0][i_2+i_0][i_1-1] * F[i_0][i_2-1][i_1] * F[i_0][i_2+1][i_1+1] - F[i_2][i_2+i_0][i_1-1] - G[i_2+i_1-1][i_0] - F[i_1-1][i_0][0] + F[i_2-1][i_2][i_0] + B[i_2-1][i_1][i_0+2] - B[i_0][i_1][i_2+2] - B[i_0-1][i_1][i_2] - B[i_0+1][i_1-1][i_2+1] - 3;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_L; i_3++) {
        for (int i_4 = 2; i_4 < i_3; i_4++) {
            for (int i_5 = 1; i_5 < min(-i_4+PB_M, PB_L-1); i_5++) {
                C[i_5+1][i_3+1][i_5+i_4] = G[i_4-1][0] - G[i_5+1][i_4] * F[i_5-1][i_4][i_4] * F[i_4][i_5][i_3] * F[i_3][i_5+1][i_4] - C[i_5][i_3+1][i_5+i_4-2] - 3;
            }
        }
        A[i_3+1] = E[i_3] * E[i_3-1] * E[i_3+1] + 1;
    }
#pragma endscop
...
kernel_3416151213_07(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
