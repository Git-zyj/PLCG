        ...
        for (int i_1 = 0; i_1 < PB_L-1; i_1++) {
            for (int i_2 = max(1, i_1); i_2 < PB_P; i_2++) {
                for (int i_3 = 1; i_3 < -i_2+PB_P; i_3++) {
                    D[i_2-1][i_1+1][i_2][i_3-1] = E[i_0][i_3][i_0][i_1] - E[i_1][i_3+1][i_0-1][i_2] * E[i_1][i_3+i_2][i_0][i_2+1] - F[i_1][i_3][i_0] + 1;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L; i_4++) {
        B[i_4] = G[i_4] + G[i_4] + G[i_4] - G[i_4+1] - C[i_4] * 4;
        C[i_4] = G[i_4] + G[i_4] * G[i_4] + G[i_4+1] - G[i_4+1] * B[i_4+1] * B[i_4] * 6;
        for (int i_5 = 1; i_5 < PB_L; i_5++) {
            for (int i_6 = 1; i_6 < PB_P-1; i_6++) {
                for (int i_7 = 1; i_7 < -i_5+PB_M; i_7++) {
                    D[i_6-1][i_5][i_6][i_7] = E[i_4][i_6+1][i_7][i_5-1] * E[i_4][i_7-1][i_6][i_5] * H[i_4-1][i_7+i_5][i_6][i_5][i_7] * F[i_5][i_6][i_7+1] + D[i_6-1][i_4][i_6][i_7-1] - D[i_4-1][i_5-1][i_4][i_7] - 2;
                }
            }
        }
    }
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4434151213_02(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H)));
