...
void kernel_2314152313_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-1; i_0++) {
        A[i_0] = D[i_0] + D[i_0] * D[i_0] * D[i_0] + A[i_0+1] + 3;
        B[i_0] = D[i_0] * D[i_0-1] + D[i_0] - D[i_0] + D[0] - D[i_0] - D[i_0] * D[i_0] * A[i_0] + A[i_0+1] * B[i_0-1] * 6;
        A[i_0+1] = D[i_0] * D[i_0] + B[i_0] * B[i_0-1] - 2;
    }
#pragma endscop
...
kernel_2314152313_02(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
