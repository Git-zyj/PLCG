        ...
        for (int i_4 = 1; i_4 < min(-i_3+PB_M+2, i_3); i_4++) {
            for (int i_5 = 0; i_5 < -i_3+PB_M+1; i_5++) {
                for (int i_6 = 1; i_6 < i_5; i_6++) {
                    B[i_6+i_3-2][i_4-1][i_5][i_5] = E[i_4][i_3][i_6][i_5] * B[i_5+i_3-1][i_6-1][i_4][i_4] - B[i_4+i_3-3][i_6-1][i_5+1][i_5+1] - B[i_4+i_3-2][i_5][i_6-1][i_6-1] + 3;
                }
            }
        }
        C[i_3-2][i_3] = F[i_3] - C[i_3-1][i_3+1] - C[i_3-3][i_3-1] - C[i_3-1][i_3+1] - 3;
    }
#pragma endscop
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), INIT_SEED);
kernel_4336112311_07(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F)));
