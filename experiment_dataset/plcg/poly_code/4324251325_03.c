...
void kernel_4324251325_03(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 1; i_1 < -i_0+PB_P; i_1++) {
            for (int i_2 = 3; i_2 < min(min(-i_1+PB_L-2, PB_L-1), -i_0+PB_L+1); i_2++) {
                A[i_1-1][i_2+i_1+1] = D[i_2+1][i_1] * E[i_1][i_0][i_2] * E[i_1][i_2-1][i_0+1] - F[i_2][i_1] * G[i_2+1][i_2+1][i_1+i_0] + A[i_2-3][i_2+i_0-1] - A[i_1-1][i_2+i_1] + A[i_1-1][i_2+i_1+2] - 6;
            }
        }
    }
        ...
        for (int i_4 = 1; i_4 < -i_3+PB_M; i_4++) {
            for (int i_5 = 1; i_5 < min(PB_P-1, -i_3+PB_L+1); i_5++) {
                for (int i_6 = 2; i_6 < -i_3+PB_L-1; i_6++) {
                    A[i_6-2][i_6+i_3+1] = E[i_4][i_6-1][i_5+i_3-1] * H[i_5-1][i_5-1][i_4][i_3-1][i_6] * I[i_6-1][i_5+1][i_4][i_3] - J[i_5+i_4-1][i_3+1][i_6][i_3] * J[i_4+i_3][i_5][i_6+i_4-1][i_5] - 6;
                }
            }
        }
    }
    for (int i_7 = 1; i_7 < PB_P; i_7++) {
        for (int i_8 = 1; i_8 < PB_L-1; i_8++) {
            for (int i_9 = 3; i_9 < i_7; i_9++) {
                for (int j_0 = 1; j_0 < min(-i_7+PB_P, -i_9+PB_L+1); j_0++) {
                    A[i_9-3][j_0+i_9-1] = I[j_0][i_7-1][i_8+1][i_8-1] - I[i_9+1][j_0+i_7][i_7-1][i_8-1] + I[i_8+1][j_0-1][i_7][i_9] * 3;
                }
            }
        }
    }
...
init_array(xa,ya,POLYBENCH_ARRAY(A), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4324251325_03(xa,ya,POLYBENCH_ARRAY(A), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,POLYBENCH_ARRAY(A), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J)));
