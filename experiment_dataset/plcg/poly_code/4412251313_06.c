...
void kernel_4412251313_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-1; i_0++) {
        A[i_0] = E[i_0] - A[i_0-1] - A[i_0+1] - 2;
        for (int i_1 = 0; i_1 < -i_0+PB_N; i_1++) {
            A[i_0] = F[i_0][i_1+1] - G[i_1][i_1] + F[i_1+i_0][i_0+1] + A[i_0] - 5;
        }
    }
    for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
        for (int i_3 = 2; i_3 < PB_M-1; i_3++) {
            C[i_3] = G[i_3][i_3+1] * H[i_2] + E[i_2] + C[i_3+1] - D[i_3-1] + D[i_3-2] * 1;
        }
        D[i_2-1] = H[i_2] - H[i_2] + H[i_2] - E[0] + E[i_2+1] + E[i_2-1] + E[i_2-1] * G[i_2][i_2] - E[i_2] - H[0] - C[i_2] + C[i_2-1] * 2;
    }
#pragma endscop
...
kernel_4412251313_06(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
