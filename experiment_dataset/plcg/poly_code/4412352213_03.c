...
void kernel_4412352213_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M-1; i_0++) {
        A[i_0-2] = E[i_0] + F[i_0] + F[i_0+2] * A[i_0-3] - 1;
        for (int i_1 = 1; i_1 < -i_0+PB_M-1; i_1++) {
            B[i_1+i_0][1] = G[i_1+i_0][i_1] + H[i_1+2][i_0] + I[i_1+2][i_0-1] * B[i_1+i_0+1][1] - 4;
            for (int i_2 = 0; i_2 < -i_0+PB_Q-1; i_2++) {
                B[i_2+i_1][1] = J[i_2+i_1-1][i_0][i_1] - I[i_2][i_1] + K[i_1][i_0-1][i_2+2] * J[i_0-2][i_2+i_1-1][0] - K[i_1+2][i_2+i_0+1][i_2] - G[i_2][i_1] - B[i_2+i_1-1][1] - B[i_2+i_1-1][1] - 5;
            }
        }
    }
    for (int i_3 = 0; i_3 < PB_M; i_3++) {
        for (int i_4 = 1; i_4 < PB_M-2; i_4++) {
            D[i_4+2] = H[i_4][i_3] * I[i_3][i_4] - G[i_4-1][i_3] + H[i_4][i_3] + F[i_4-1] - 4;
        }
    }
#pragma endscop
...
kernel_4412352213_03(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
