...
void kernel_3336151111_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = i_0; i_1 < min(PB_Q-2, -i_0+PB_P); i_1++) {
            A[i_1][i_0][i_1+1] = D[i_0][i_1+i_0] - D[i_1][i_0] + D[i_1-1][i_0] + D[i_1][i_0-1] - D[i_0][i_1] + A[i_1][i_0-1][i_1+1] + A[i_1+1][i_0][i_1+2] + 5;
        }
        for (int i_2 = 1; i_2 < min(-i_0+PB_L, PB_M-1); i_2++) {
            for (int i_3 = 1; i_3 < i_0; i_3++) {
                B[i_2][i_2+i_0][i_3+1] = E[i_0-1][i_3+1][i_3+i_2-1] * E[i_3-1][i_0][i_2] + E[i_0+1][i_3][i_3] - E[i_0-1][i_3+1][i_2] - E[i_2+1][i_3+1][i_0-1] - E[i_2][i_0][i_3+i_2] + 3;
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_Q-1; i_4++) {
        for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
            for (int i_6 = 0; i_6 < PB_M; i_6++) {
                C[i_5][i_6][i_4] = E[i_5+1][i_6][i_4] * E[i_5][i_4][i_6] * E[i_6][i_5][i_4] + C[i_6][i_5+1][i_4+1] + 5;
            }
        }
    }
#pragma endscop
...
kernel_3336151111_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
