...
void kernel_4216312313_04(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_4 = 2; i_4 < PB_L; i_4++) {
        for (int i_5 = 1; i_5 < min(i_4, PB_Q-1); i_5++) {
            for (int i_6 = 2; i_6 < PB_M; i_6++) {
                B[i_4][i_6-1][i_5] = C[i_6][i_4][i_5-1] + B[i_6][i_4-2][i_5+1] - B[i_4][i_6-2][i_5] * B[i_4-1][i_6-1][i_5-1] + 6;
            }
        }
    }
#pragma endscop
...
kernel_4216312313_04(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
