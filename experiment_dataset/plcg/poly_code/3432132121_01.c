...
#pragma scop
    for (int i_0 = 1; i_0 < PB_N; i_0++) {
        ...
        B[i_0+2] = E[2] - E[i_0+2] * B[i_0+3] + 4;
        for (int i_2 = 2; i_2 < PB_P; i_2++) {
            for (int i_3 = 2; i_3 < PB_N; i_3++) {
                C[i_3][i_0+1][i_2] = F[i_3-2][i_2][i_0] * F[i_3][i_0][i_2-2] + F[i_2][i_3][i_0-1] * F[i_3][i_2][i_0] + F[i_3][i_0+1][i_2] - F[i_2][i_3][i_0+1] * 3;
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_N-2; i_4++) {
        D[i_4+2] = E[i_4] - G[i_4][i_4+1] - 3;
    }
#pragma endscop
...
kernel_3432132121_01(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
