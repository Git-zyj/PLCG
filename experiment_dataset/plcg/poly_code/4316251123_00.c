        ...
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_L, i_1); i_2++) {
                for (int i_3 = 0; i_3 < min(PB_L-1, i_1); i_3++) {
                    A[i_1][i_3+1][i_2] = D[i_2][i_3][i_0+1][i_3] - D[i_1][i_0][i_3][1] + D[i_0+1][i_3][i_1][i_2+1] - E[i_1-1][i_0][i_3+1][i_1] * F[i_2][i_1][i_3+1] + D[i_3][i_2][i_0+1][i_1] + E[i_1][i_3][i_1-1][i_2-1] + D[i_1][i_2+i_0][i_3][i_0] - E[i_0][i_2][i_3][i_1-1] + 5;
                }
            }
        }
        B[i_0] = G[i_0-1] - H[i_0] * G[i_0] + G[i_0] + 4;
    }
    for (int i_4 = 3; i_4 < PB_N-1; i_4++) {
        for (int i_5 = i_4; i_5 < PB_L; i_5++) {
            C[i_4-1][i_5] = I[i_4][i_5] + C[i_4-3][i_5] - C[i_4+1][i_5-1] * 6;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4316251123_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I)));
