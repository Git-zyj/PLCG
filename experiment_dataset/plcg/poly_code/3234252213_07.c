    ...
    for (int i_3 = 2; i_3 < PB_M-1; i_3++) {
        for (int i_4 = 1; i_4 < PB_P; i_4++) {
            for (int i_5 = 2; i_5 < PB_M-2; i_5++) {
                B[i_5+1][i_4][i_3-2] = E[i_5][i_3][i_3+1] + C[i_4+2][i_5+1][2] + D[i_5][i_4] * B[i_3+1][i_4-1][i_5-2] * B[i_5+2][i_4][i_3-2] + B[i_5][i_4-1][i_3-2] - 2;
            }
        }
    }
#pragma endscop
...
kernel_3234252213_07(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
