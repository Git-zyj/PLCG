...
void kernel_3234311323_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M-1; i_0++) {
        A[i_0-1] = C[i_0] - A[i_0] * A[i_0-3] * A[i_0+1] * 3;
    }
...
kernel_3234311323_09(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
