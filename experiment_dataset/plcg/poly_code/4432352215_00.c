...
static void print_array(int xb,int yb,int zb,int vb,int wb,DATA_TYPE POLYBENCH_5D(B,xB,yB,zB,vB,wB,xb,yb,zb,vb,wb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,int wg,DATA_TYPE POLYBENCH_5D(G,xG,yG,zG,vG,wG,xg,yg,zg,vg,wg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,DATA_TYPE POLYBENCH_1D(M,xM,xm))
{
int i_0, i_1, i_2, i_3, i_4;
...
void kernel_4432352215_00(int xb,int yb,int zb,int vb,int wb,DATA_TYPE POLYBENCH_5D(B,xB,yB,zB,vB,wB,xb,yb,zb,vb,wb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,int wg,DATA_TYPE POLYBENCH_5D(G,xG,yG,zG,vG,wG,xg,yg,zg,vg,wg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,DATA_TYPE POLYBENCH_1D(M,xM,xm)){
...
#pragma scop
        ...
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < PB_N-2; i_2++) {
                for (int i_3 = 2; i_3 < PB_M-1; i_3++) {
                    B[i_1][i_2][i_2+1][i_0+1][i_0+3] = E[i_2][i_0+1][i_3][i_0] + E[i_0][i_3+1][i_3][i_1-1] * E[i_1][i_0][i_2][i_3-2] - F[i_3-1][i_2-1][i_1][i_0-2] * G[i_2+2][i_1-2][i_2+2][i_3-2][i_0-1] + 4;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_Q-1; i_4++) {
        for (int i_5 = 0; i_5 < PB_Q-2; i_5++) {
            for (int i_6 = 0; i_6 < min(i_4, -i_5+PB_Q); i_6++) {
                for (int i_7 = 0; i_7 < PB_N-1; i_7++) {
                    B[i_7][i_4][i_4+1][i_5][i_5+2] = F[i_6][i_6][i_7][i_4-2] + H[i_6][i_7+1][i_4+1][i_5] * G[i_7+1][i_5][i_4+2][i_7][i_6+i_5] * F[i_5][i_7][i_4][i_6] * E[i_4][i_7][i_5][i_6] * H[i_7][i_4+2][i_6][i_5+2] - H[i_5][i_6+2][i_4][i_5] * F[i_5+1][i_4+2][i_6][i_5] * 6;
                }
            }
        }
    }
        ...
        for (int i_9 = 1; i_9 < -i_8+PB_M; i_9++) {
            for (int j_0 = 2; j_0 < PB_Q-1; j_0++) {
                for (int j_1 = 2; j_1 < PB_Q; j_1++) {
                    C[i_8-1][j_1][j_0][j_1-1] = I[i_9][j_0][j_1] * E[j_1-1][i_9+i_8][j_0][0] + H[j_0-2][j_1][i_8][i_9] * J[j_0][i_8+2][i_9-1] * C[i_8][j_1][j_0][j_1-1] * C[i_8-1][j_1-1][j_0][j_1-2] * C[i_8-2][j_1][j_0+1][j_1-1] + 2;
                }
            }
        }
        for (int j_2 = 2; j_2 < -i_8+PB_M; j_2++) {
            D[i_8][j_2] = K[j_2+i_8][j_2-1] + L[j_2-2] * M[i_8-2] + D[i_8][j_2-1] * D[j_2-1][i_8] * 4;
        }
    }
#pragma endscop
