...
void kernel_3414232325_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        A[i_0] = E[i_0] + F[i_0] - F[i_0] + E[i_0-2] + F[i_0-1] * 5;
        for (int i_1 = i_0; i_1 < PB_M; i_1++) {
            A[i_0+1] = G[i_0][0] - H[i_1][i_0] + A[i_1] * A[i_1-2] + A[i_0] * 1;
        }
        A[i_0] = F[i_0] + F[i_0] + 3;
    }
    for (int i_2 = 2; i_2 < PB_M+2; i_2++) {
        for (int i_3 = 0; i_3 < PB_Q; i_3++) {
            for (int i_4 = i_2; i_4 < min(-i_3+PB_P, PB_M-1); i_4++) {
                A[i_4+1] = I[i_2-2][i_4+i_3][i_3] - 2;
            }
        }
    }
#pragma endscop
...
kernel_3414232325_07(xa,POLYBENCH_ARRAY(A), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
