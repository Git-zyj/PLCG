...
void kernel_3422251315_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            A[i_1] = E[i_0+1][i_1-1] + E[i_1][i_0-1] * F[0][i_0+1] - A[i_1-1] * B[i_0] - B[i_1-1] - 6;
        }
        B[i_0-1] = G[i_0+1] - G[i_0] - H[i_0+1] - G[i_0] * G[i_0] * A[i_0] - A[i_0-1] - 6;
    }
    for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
        C[i_2] = H[i_2+1] + F[i_2+1][0] + H[i_2+1] - H[i_2] * F[i_2+1][i_2] - H[i_2+1] + A[i_2] * B[i_2-1] + 2;
    }
    for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
        A[i_3] = H[i_3] * G[i_3] - H[i_3] - H[i_3+1] * G[i_3-1] + C[i_3+1] * 1;
    }
#pragma endscop
...
kernel_3422251315_05(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
