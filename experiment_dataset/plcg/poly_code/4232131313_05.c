...
void kernel_4232131313_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_M; i_1++) {
        A[i_1] = C[i_1] * C[i_1] - C[i_1] - A[i_1] + 2;
    }
#pragma endscop
...
kernel_4232131313_05(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
