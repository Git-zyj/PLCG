...
void kernel_4212152213_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 2; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_Q; i_2++) {
                for (int i_3 = 2; i_3 < min(min(-i_2+PB_L, -i_0+PB_L), -i_1+PB_P); i_3++) {
                    A[i_1-1][i_0][i_3][i_3] = C[i_0][i_3+i_2][i_1][i_2+i_1] * C[i_3+i_2][i_1+1][i_0][0] - C[i_3][i_1-2][i_2][i_0+1] + C[i_2][i_0][i_3+i_1][i_1-2] - D[i_2][i_3-1][i_1-2] - C[i_1][i_3+i_0][i_3+1][0] + C[i_0][i_3][i_1][0] + A[i_3-2][i_0][i_1][i_1] - A[i_1-1][i_0][i_3+1][i_3+1] * 5;
                }
            }
            for (int i_4 = 0; i_4 < PB_M-1; i_4++) {
                A[i_0-1][i_4][i_1+1][i_1+1] = D[i_0][i_4+1][i_1+2] * D[i_4][i_1][i_0+2] - 3;
            }
        }
    }
#pragma endscop
...
kernel_4212152213_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
