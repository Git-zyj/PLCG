...
void kernel_2222112125_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        A[i_0-2] = C[i_0] - A[i_0-1] + 3;
    }
...
kernel_2222112125_01(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
