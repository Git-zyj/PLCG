...
void kernel_4434351323_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_L; i_0++) {
        A[i_0-1] = E[i_0] - E[i_0] * F[1] * G[i_0] * A[i_0] + A[i_0-2] * A[i_0-3] - 1;
        for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 3; i_2 < -i_1+PB_L-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_Q-1; i_3++) {
                    B[i_3][i_2-1][i_3-1] = H[i_0][i_2][i_3+1] - I[i_3][i_2+i_1+1][i_1] + B[i_1][i_2-3][i_1-1] - B[i_3+2][i_2-1][i_3+1] - 2;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 1; i_5 < i_4; i_5++) {
            for (int i_6 = 2; i_6 < min(-i_5+PB_M, PB_L-1); i_6++) {
                C[i_5-1][i_6] = J[i_5][i_6] - J[i_6+1][i_5-1] - H[i_6+i_5][i_4][i_5] - J[i_5-1][i_4] * H[i_5][i_4][i_6] - B[i_5][i_6-2][i_5-1] - C[i_5-1][i_6-1] - C[i_5+1][i_6] * 3;
            }
        }
        for (int i_7 = 1; i_7 < PB_Q-1; i_7++) {
            for (int i_8 = 1; i_8 < PB_L; i_8++) {
                D[i_4][i_7][i_4-1] = I[i_7][i_4][i_7] + K[i_7-1][i_8-1][i_4-1] * H[i_7][i_8][1] + I[i_8][i_4+1][i_7+1] * L[i_8][i_7] - I[i_8][i_4][i_7-1] - I[i_4][i_8][i_7+1] + B[i_7+2][i_8-1][i_7+1] * D[i_4-1][i_7-1][i_4-2] * 2;
            }
        }
    }
#pragma endscop
...
kernel_4434351323_05(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L));
