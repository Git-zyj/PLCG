...
void kernel_3414252225_06(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        for (int i_1 = i_0; i_1 < PB_P; i_1++) {
            A[i_0][i_1] = E[i_1-2][2] - F[i_1] - A[i_1-2][i_0] + 4;
            B[i_1][i_0] = F[i_1] + E[i_1][i_1] + G[i_0][i_1] - G[i_1][i_0] - A[i_0+2][i_1-1] - 1;
            for (int i_2 = 1; i_2 < PB_P-2; i_2++) {
                A[i_1-1][i_2-1] = H[i_1+1][i_0-1][i_2] * I[i_2][i_0-1][i_1] * H[i_1][i_2+2][i_0-2] - G[i_0][i_1-2] + H[i_1][i_0][1] * H[i_1][i_2][i_0] - I[i_1][i_2][i_1] + H[i_2][i_1][i_0] - B[i_2][i_1] - B[i_2][i_1+2] - 4;
            }
        }
    }
    for (int i_3 = 0; i_3 < PB_M-2; i_3++) {
        D[i_3] = F[i_3] - F[i_3+2] - J[i_3] * 6;
    }
#pragma endscop
...
kernel_3414252225_06(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
