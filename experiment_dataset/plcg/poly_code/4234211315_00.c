...
void kernel_4234211315_00(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    ...
    for (int i_3 = 2; i_3 < PB_L; i_3++) {
        for (int i_4 = 0; i_4 < min(PB_L-2, i_3); i_4++) {
            B[i_3-1][i_4+1] = C[i_4][i_3] * B[i_3-1][i_4+2] - B[i_3-2][i_4+1] + B[i_4][i_3] * 6;
        }
    }
#pragma endscop
...
kernel_4234211315_00(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
