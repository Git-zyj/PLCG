...
void kernel_4224312315_07(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 1; i_1 < PB_Q; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_1+PB_L-1, PB_P-1); i_2++) {
                A[i_0][i_2+i_1][i_2] = 2;
                A[i_0][i_2+i_1][i_2] = C[i_1][i_2][i_1] * A[i_0][i_2+i_1+1][i_2+1] * A[i_0][i_2+i_1][i_2] * A[i_0][i_2+i_1-1][i_2-1] - 6;
            }
        }
    }
#pragma endscop
...
kernel_4224312315_07(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C));
