...
void kernel_4316112325_07(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_2 = 0; i_2 < PB_M-2; i_2++) {
        B[i_2+2] = D[i_2] + B[i_2] - 5;
        B[i_2+2] = D[i_2] + B[i_2] + B[i_2+2] * 2;
    }
#pragma endscop
...
kernel_4316112325_07(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
