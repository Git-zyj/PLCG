...
void kernel_2216112323_05(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_P; i_0++) {
        for (int i_1 = 3; i_1 < PB_Q-2; i_1++) {
            A[i_1-1][i_1] = A[i_1-3][i_1-2] - A[i_1+1][i_1+2] - A[i_1-2][i_1-1] * 1;
        }
        for (int i_2 = 0; i_2 < PB_M-2; i_2++) {
            A[i_2+1][i_2+2] = C[i_2+2][i_0] * 2;
        }
    }
#pragma endscop
...
kernel_2216112323_05(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C));
