...
void kernel_2426351211_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
        B[i_1] = E[i_1] - F[i_1] + F[i_1] - F[i_1-1] * C[i_1-1] - 5;
        for (int i_2 = i_1; i_2 < -i_1+PB_M+1; i_2++) {
            C[i_2-1] = G[i_2][i_1+1] - H[i_2][i_1] + I[i_2+i_1-1] * B[i_2-1] + 5;
        }
        D[i_1] = I[i_1-1] - F[i_1] * I[i_1+1] + F[i_1] - F[i_1-1] + I[i_1] + F[i_1] + D[i_1+1] + D[i_1-1] - 4;
    }
#pragma endscop
...
kernel_2426351211_04(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
