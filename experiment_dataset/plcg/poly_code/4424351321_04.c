...
void kernel_4424351321_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl),int xm,int ym,DATA_TYPE POLYBENCH_2D(M,xM,yM,xm,ym)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 2; i_1 < min(-i_0+PB_Q, PB_L-2); i_1++) {
            for (int i_2 = 1; i_2 < PB_N-1; i_2++) {
                for (int i_3 = 2; i_3 < min(min(-i_0+PB_M, i_2), -i_2+PB_L-1); i_3++) {
                    A[i_0][i_1][i_3-1][i_1] = E[i_2-1][i_0][i_3][i_3] + F[i_1][i_2][i_3-1][i_0][i_3+1] - G[i_2+1][i_3+i_0][i_0] + E[i_3][i_3+i_2+1][i_1+i_0][i_2-1] + H[i_1][i_0][i_3][i_3] * H[i_3+1][i_0][i_1][i_0] - H[i_2+1][i_0][i_1][1] * A[i_0][i_3+2][i_2-1][i_3+2] + A[i_0+1][i_1-2][i_3][i_1-2] + A[i_0][i_1][i_3-2][i_1] + A[i_3+2][i_1][i_2-1][i_1] * A[i_0][i_1+1][i_2-1][i_1+1] + A[i_0+2][i_1][i_3-1][i_1] * A[i_0][i_1+2][i_3-2][i_1+2] - 3;
                }
            }
            for (int i_4 = 1; i_4 < min(i_1, -i_0+PB_L-1); i_4++) {
                for (int i_5 = 0; i_5 < min(-i_1+PB_M-1, -i_0+PB_Q-1); i_5++) {
                    B[i_4][i_1-1][i_5][i_4-1] = I[i_5+1][i_1-1][i_4] - H[i_1][i_5+i_0][i_4-1][0] * E[i_1][i_4+i_0+1][i_5+i_0+1][i_1] * J[i_5+i_1+1][i_4+i_0][i_5][i_0] + H[i_0-1][i_1][i_5+i_4][0] * J[i_4][i_0][i_1-1][i_5] + J[i_1][i_5][i_0][1] + G[i_4][i_1-1][i_0] + E[i_4][i_5][i_1][i_0-1] + B[i_4][i_1][i_5][i_4-1] * 1;
                }
            }
        }
    }
    for (int i_6 = 2; i_6 < PB_L-1; i_6++) {
        ...
        for (int i_9 = 1; i_9 < PB_P-2; i_9++) {
            D[i_6][i_9] = K[i_6] - L[i_6][0] - M[i_6][i_9+1] + D[i_6-2][i_9-1] - D[i_9-1][i_6] + D[i_6-1][i_9+2] * D[i_6][i_9+2] * 3;
        }
    }
#pragma endscop
...
kernel_4424351321_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M));
