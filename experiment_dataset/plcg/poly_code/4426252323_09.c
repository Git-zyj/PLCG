        ...
        for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_1+PB_M-2, i_1); i_2++) {
                for (int i_3 = 1; i_3 < PB_M-2; i_3++) {
                    B[i_0][i_3+2][i_1] = E[i_2][i_0-2][i_3][i_1] * E[i_3-1][i_0][i_2][i_1] + F[i_3][i_2+i_1+2][i_2] + G[i_1][i_2+1][i_3][i_0][i_1-2] - E[i_1+2][i_3][i_2][i_0-1] + H[i_3][i_0][i_2] * E[i_2][i_3][i_0][i_2+i_1] * 2;
                }
            }
        }
        for (int i_4 = 0; i_4 < i_0; i_4++) {
            for (int i_5 = 0; i_5 < min(-i_0+PB_M-2, -i_4+PB_M-2); i_5++) {
                for (int i_6 = 0; i_6 < PB_N-2; i_6++) {
                    B[i_6][i_5][i_0+2] = F[i_6][i_5+i_0+2][i_4] - I[i_6+1][i_5+i_4+2][i_0][2] * I[i_4][i_5+i_0][i_6][i_4+1] * I[i_5][i_4][i_0][i_5] - B[i_6+2][i_5][i_4+2] * B[i_6][i_5+2][i_4+2] - 5;
                }
            }
        }
    }
    for (int i_7 = 3; i_7 < PB_L-2; i_7++) {
        for (int i_8 = 2; i_8 < PB_L-2; i_8++) {
            for (int i_9 = 0; i_9 < -i_7+PB_M; i_9++) {
                B[i_7][i_9][i_8+2] = J[i_9][i_7] + H[i_9+i_7][i_8][i_7] + H[i_7-2][i_9][i_7] + H[i_8-1][i_7-1][i_8] + B[i_8-2][i_9][i_7+2] * 6;
            }
        }
        for (int j_0 = 2; j_0 < i_7; j_0++) {
            for (int j_1 = j_0; j_1 < min(-j_0+PB_M-2, -i_7+PB_M+1); j_1++) {
                for (int j_2 = 3; j_2 < min(-j_1+PB_M+2, -i_7+PB_M); j_2++) {
                    D[j_2-2][j_1+j_0][j_1+j_0][i_7] = E[j_2+i_7][j_0-2][j_1+1][2] * E[j_0][j_2+1][j_1][i_7] - F[j_1][j_0+2][i_7] * I[j_0][j_1][i_7][j_0] * E[j_1-2][j_2][i_7][1] - D[j_2-2][j_1+i_7-1][j_1+i_7-1][j_0] - D[i_7-3][j_2+j_1-2][j_2+j_1-2][j_0] * D[j_2-3][j_1+j_0+2][j_1+j_0+2][i_7] + 6;
                }
            }
        }
    }
...
init_array(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4426252323_09(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J)));
