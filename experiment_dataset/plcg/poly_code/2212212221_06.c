...
void kernel_2212212221_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_M-4 - 1; i_0 >= 1; i_0--) {
        B[i_0+2] = B[i_0+4] * 4;
        B[i_0+2] = C[i_0-1] + B[i_0+3] + 3;
    }
#pragma endscop
...
kernel_2212212221_06(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
