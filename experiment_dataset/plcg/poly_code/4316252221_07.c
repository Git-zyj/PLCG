...
void kernel_4316252221_07(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
...
#pragma scop
        ...
        for (int i_1 = i_0; i_1 < PB_N-1; i_1++) {
            for (int i_2 = 2; i_2 < -i_0+PB_P; i_2++) {
                for (int i_3 = 1; i_3 < PB_P-1; i_3++) {
                    A[i_1+1][i_2+2][i_3] = D[i_2][i_2+2][i_1][i_3] - D[i_1-2][i_3][i_2+i_0][0] + E[i_2][i_3-1][i_0-2][i_2] + E[i_3][i_2][i_0][i_1] - A[i_1-1][i_3+2][i_2-2] - A[i_2+1][i_1+1][i_3+1] - 5;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 2; i_5 < i_4; i_5++) {
            B[i_4][i_4-2][i_5] = F[i_5][i_4+1] - G[i_4][i_5] - G[i_5][i_4] - G[i_5+1][i_4+2] + G[i_4][i_5] - F[i_5][i_4] * G[i_5][0] * B[i_4][i_4-2][i_5-2] + 1;
        }
        for (int i_6 = i_4; i_6 < PB_P-2; i_6++) {
            for (int i_7 = 2; i_7 < PB_M-3; i_7++) {
                for (int i_8 = 0; i_8 < -i_6+PB_P-2; i_8++) {
                    C[i_7+1][i_6+1][i_8] = H[i_6][i_8][0] * D[i_7][i_4-1][i_8+i_6+2][i_6] - E[i_7][i_4+2][i_6][1] * D[i_7-2][i_4-1][i_6+2][0] - C[i_7+1][i_6+1][i_8+1] * C[i_7+3][i_8+1][i_6] - 6;
                }
            }
        }
    }
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4316252221_07(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H)));
