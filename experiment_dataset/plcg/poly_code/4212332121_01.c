        ...
        for (int i_1 = 2; i_1 < min(-i_0+PB_Q-2, i_0); i_1++) {
            for (int i_2 = 2; i_2 < i_0; i_2++) {
                for (int i_3 = 2; i_3 < PB_P-2; i_3++) {
                    A[i_0][i_1-1][i_2][i_3] = C[i_3][i_2-2][i_0][i_0] * C[i_3][i_0][i_1-2][i_2-2] - D[i_3][i_2+1][i_0][i_1+i_0+2] - A[i_0][i_1-1][i_2][i_3+2] * A[i_0][i_1-1][i_3-2][i_2] * 3;
                }
            }
        }
    }
...
kernel_4212332121_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F));
