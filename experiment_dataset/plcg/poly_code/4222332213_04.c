        ...
        for (int i_1 = 2; i_1 < min(PB_Q, -i_0+PB_L); i_1++) {
            for (int i_2 = 1; i_2 < PB_Q; i_2++) {
                for (int i_3 = i_0; i_3 < PB_Q-1; i_3++) {
                    A[i_2][i_0][i_1][i_3+1] = C[i_2][i_3][i_1+i_0][2] - D[i_1-2][i_0][i_3][1] + D[i_0][i_3][i_2][i_1] * A[i_2-1][i_0][i_1][i_3] * A[i_2][i_0][i_1-1][i_3+1] + 6;
                }
            }
        }
    }
...
kernel_4222332213_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
