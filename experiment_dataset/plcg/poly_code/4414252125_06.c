...
void kernel_4414252125_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj)){
        ...
        for (int i_1 = 2; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-2; i_2++) {
                for (int i_3 = 0; i_3 < -i_2+PB_M-2; i_3++) {
                    A[i_2+2][i_1][i_3][i_1-2] = E[i_3][i_2][i_0][2][i_1-1] + F[i_3+i_2+2][i_0][i_1][i_0] * G[i_2+2][i_1][i_0][i_3] + 1;
                }
            }
        }
    }
    for (int i_4 = 3; i_4 < PB_M-2; i_4++) {
        B[i_4+2] = H[i_4+2] + I[i_4] - H[i_4-2] - I[i_4] - J[i_4+2][0] - I[i_4] * H[i_4-1] - H[i_4-1] - 4;
        for (int i_5 = 1; i_5 < PB_Q-1; i_5++) {
            for (int i_6 = 0; i_6 < i_4; i_6++) {
                for (int i_7 = 0; i_7 < min(PB_Q-2, -i_5+PB_Q); i_7++) {
                    A[i_6+2][i_4-1][i_7][i_4-3] = G[i_6][i_4-2][i_7+i_5][i_5] + G[i_6][i_7][i_5+1][i_4] * G[i_5][i_4][i_7+2][i_6] - A[i_6+2][i_5+1][i_7][i_5-1] * 2;
                }
            }
            for (int i_8 = 0; i_8 < i_5; i_8++) {
                for (int i_9 = 2; i_9 < PB_Q; i_9++) {
                    A[i_8+2][i_9][i_5][i_9-2] = F[i_8][i_4][i_5+1][i_8] - F[i_9][i_9][i_5+1][i_8] * G[i_8][i_4][i_5][1] * 6;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4414252125_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J)));
