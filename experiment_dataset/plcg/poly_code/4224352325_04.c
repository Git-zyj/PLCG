        ...
        for (int i_2 = 2; i_2 < PB_L-1; i_2++) {
            for (int i_3 = 2; i_3 < PB_L-1; i_3++) {
                for (int i_4 = 0; i_4 < min(min(i_2, PB_L-2), -i_2+PB_P); i_4++) {
                    B[i_1][i_3+1][i_2][i_4+i_2] = E[i_1-2][i_1][i_4+2][0] - E[i_2-2][i_1][i_4][i_3] + F[i_1-1][i_4+i_2][i_3-2][0] + F[i_3][i_4][i_1+1][i_2] - G[i_3][i_4][i_2+1] * 2;
                }
            }
        }
    }
...
kernel_4224352325_04(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
