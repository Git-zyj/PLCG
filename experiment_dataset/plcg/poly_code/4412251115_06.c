    ...
    for (int i_0 = 0; i_0 < PB_P-1; i_0++) {
        ...
        for (int i_1 = 0; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-1; i_2++) {
                B[i_2][i_1][i_0] = G[i_2][i_1+1][i_0+1] * G[i_1][i_0][i_2] + H[i_1][i_2+1][i_0+1][i_0+1] * G[i_2][i_1][i_0] - 2;
            }
            C[i_1][i_0] = I[i_1+1][i_0] - J[i_0][i_1] * I[i_1][i_0] * F[i_0] - I[i_0][i_1] - A[i_0] * 1;
        }
    }
        ...
        for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
            for (int i_5 = 1; i_5 < -i_3+PB_Q; i_5++) {
                for (int i_6 = 1; i_6 < min(-i_3+PB_Q, i_3); i_6++) {
                    D[i_4][i_6][i_5+i_3][i_3-1] = K[i_6][i_4-1][i_5] * L[i_4-1][i_5][i_3][i_3-1] * H[i_5][i_4+1][i_6-1][i_3] * H[i_4+1][i_6-1][i_6+1][i_5+i_3] + H[i_6+i_5][i_3][i_4-1][i_4] - M[i_3][i_5-1][i_5][i_6+i_3][i_4] - 1;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,zl,vl,POLYBENCH_ARRAY(L), xm,ym,zm,vm,wm,POLYBENCH_ARRAY(M), INIT_SEED);
kernel_4412251115_06(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,zl,vl,POLYBENCH_ARRAY(L), xm,ym,zm,vm,wm,POLYBENCH_ARRAY(M));
