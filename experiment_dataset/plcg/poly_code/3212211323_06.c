...
void kernel_3212211323_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_L; i_0++) {
        for (int i_1 = 0; i_1 < min(-i_0+PB_P+1, PB_M); i_1++) {
            for (int i_2 = 1; i_2 < PB_P; i_2++) {
                A[i_0][i_1+i_0-1][i_2] = A[i_0-1][i_1+i_0-3][i_2-1] - 5;
            }
            for (int i_3 = 0; i_3 < -i_1+PB_M; i_3++) {
                A[i_0][i_1+i_0-1][i_3+2] = C[i_0-1][i_3+i_1][1] * A[i_0][i_1+i_0-1][i_3] - A[i_0-1][i_1+i_0-2][i_3] - 1;
            }
        }
    }
#pragma endscop
...
kernel_3212211323_06(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C));
