...
void kernel_4332312215_02(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
kernel_4332312215_02(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
