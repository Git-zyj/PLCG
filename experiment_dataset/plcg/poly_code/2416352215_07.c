...
void kernel_2416352215_07(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-1; i_0++) {
        for (int i_1 = 2; i_1 < PB_L-2; i_1++) {
            A[i_0][i_1-2] = E[i_1+2] - A[i_0+1][i_1-2] - B[i_1+1] + 1;
        }
        B[i_0] = F[2] + F[i_0] + G[i_0][0] * F[i_0] * F[i_0+1] + H[i_0] + 4;
        for (int i_2 = max(2, i_0); i_2 < -i_0+PB_N; i_2++) {
            B[i_0] = F[i_2] * G[i_2+i_0][i_0+1] - G[i_2-2][i_0] * E[i_2] + G[i_0][i_2] + I[i_2][i_0] - I[i_2+i_0][0] + I[i_2+i_0][i_0] + G[i_2][i_2+i_0] * B[i_2-1] * 6;
        }
        B[i_0-1] = E[i_0-1] + 2;
    }
#pragma endscop
...
kernel_2416352215_07(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
