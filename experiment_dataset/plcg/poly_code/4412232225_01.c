...
void kernel_4412232225_01(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        A[i_0][i_0] = E[0] + E[i_0] - A[i_0-1][i_0-1] * A[i_0+2][i_0+2] * 5;
        for (int i_1 = 2; i_1 < PB_M-1; i_1++) {
            B[i_1] = F[i_1][i_0-2] * G[i_1][i_0] + H[i_0] - B[i_1-2] + B[i_1+1] + 4;
        }
    }
    for (int i_2 = 2; i_2 < PB_M-2; i_2++) {
        C[i_2] = E[2] - H[i_2+2] - H[i_2] - E[i_2] + 4;
        C[i_2-2] = E[0] * H[i_2-1] * B[i_2] + C[i_2+2] - 5;
    }
#pragma endscop
...
kernel_4412232225_01(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
