...
void kernel_3414231121_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        A[i_0] = E[i_0] + E[i_0] - F[i_0] - 3;
        for (int i_1 = i_0; i_1 < PB_M-1; i_1++) {
            A[i_1] = G[i_1][0] * H[i_1][i_0] + 3;
            for (int i_2 = 1; i_2 < PB_L; i_2++) {
                C[i_2][i_1-1][i_0] = H[i_1][i_0] * I[i_1+1][i_2][i_0-1] * C[i_2-1][i_1-2][i_0] * C[i_2][i_1-1][i_0-2] - 5;
            }
        }
        A[i_0+2] = G[i_0][i_0] + F[i_0] - F[i_0] - 3;
    }
#pragma endscop
...
kernel_3414231121_04(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
