...
void kernel_3226112321_02(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
...
#pragma scop
    ...
    for (int i_3 = 1; i_3 < PB_Q-1; i_3++) {
        for (int i_4 = 3; i_4 < min(-i_3+PB_L+1, PB_L-2); i_4++) {
            for (int i_5 = i_3; i_5 < -i_4+PB_L-2; i_5++) {
                B[i_5+i_4][i_4-1] = C[i_4][i_5+1][i_3+1] + B[i_5+i_4-2][i_4-3] - B[i_5+i_4+2][i_5] + B[i_4+i_3-1][i_4-2] - 2;
            }
        }
    }
#pragma endscop
...
kernel_3226112321_02(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
