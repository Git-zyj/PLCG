...
void kernel_2314132325_07(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 4; i_0 < PB_N; i_0++) {
        C[i_0-2] = D[i_0-2] * D[i_0] + 6;
        C[i_0-4] = D[i_0] + D[i_0-2] - 2;
    }
    for (int i_1 = 4; i_1 < PB_N-2; i_1++) {
        C[i_1-2] = D[i_1-2] * D[i_1] * D[i_1+2] + C[i_1-4] - C[i_1-1] - C[i_1-3] * 3;
    }
#pragma endscop
...
kernel_2314132325_07(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
