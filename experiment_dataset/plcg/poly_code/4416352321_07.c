...
void kernel_4416352321_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P-2; i_0++) {
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = i_0; i_2 < min(-i_0+PB_Q-1, -i_1+PB_Q); i_2++) {
                for (int i_3 = 0; i_3 < PB_Q; i_3++) {
                    A[i_2-1][i_1][i_2+i_1][0] = E[i_1+2][i_0][i_2][2] - E[i_1][i_2-2][i_1][i_0-2] * A[i_0][i_2][i_2+i_0+1][0] * 2;
                }
            }
            for (int i_4 = max(2, i_1); i_4 < min(-i_0+PB_Q, -i_1+PB_L); i_4++) {
                B[i_0+2][i_1][i_4-2] = F[i_4+i_1][i_0+2][i_4] + G[i_4+i_0][i_1] - F[i_1][i_4][i_0+1] * F[i_4][i_0][i_1] + F[i_4+i_1][i_4+2][i_0-1] + A[i_4-1][i_0][i_4+i_0][0] + 3;
            }
        }
        for (int i_5 = 1; i_5 < min(-i_0+PB_Q, i_0); i_5++) {
            for (int i_6 = 2; i_6 < -i_0+PB_P; i_6++) {
                for (int i_7 = i_0; i_7 < PB_M-2; i_7++) {
                    C[i_7+2][i_5][i_6][i_0] = E[i_6][i_6+i_0-2][i_5][0] - H[i_0-1][i_6+2][i_5+1][i_7] * H[i_7][i_6+i_0][i_5+i_0][i_7] - E[i_6+1][i_0][i_6+i_5+1][i_6+1] + E[i_5][i_0][i_7][i_6] + H[i_5][i_0][i_7][i_6] * E[i_5+i_0][i_7][i_6][0] - I[i_6+2][i_0][i_5-1][i_5] - C[i_7][i_5][i_6][i_0+2] * C[i_7+1][i_5][i_6][i_0] - C[i_0+1][i_5][i_6][i_7] * C[i_7+2][i_5][i_6-2][i_0] + 2;
                }
            }
        }
    }
    for (int i_8 = 4; i_8 < PB_L; i_8++) {
        for (int i_9 = i_8; i_9 < PB_P-2; i_9++) {
            D[i_8-2][i_9] = J[i_9-2][i_8] + K[i_9] - J[i_8][i_9-2] - D[i_8-2][i_9-1] - D[i_8-2][i_9-2] + D[i_8-4][i_9-2] * D[i_8-2][i_9+2] + D[i_8][i_9-1] - 2;
        }
    }
#pragma endscop
