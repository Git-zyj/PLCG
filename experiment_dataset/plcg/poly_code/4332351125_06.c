...
void kernel_4332351125_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,int wi,DATA_TYPE POLYBENCH_5D(I,xI,yI,zI,vI,wI,xi,yi,zi,vi,wi)){
        ...
        for (int i_1 = i_0; i_1 < PB_M; i_1++) {
            for (int i_2 = i_0; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_1+PB_M, -i_0+PB_L); i_3++) {
                    A[i_2+1][i_3+i_1][i_0][1] = D[i_1][i_3+i_0][i_1+1][i_2] - E[i_1][i_2][i_0-1][i_3+1] + D[i_0][i_3][i_2][i_1-1] * D[i_3][i_1][1][i_2] * E[i_3+i_1][i_2-1][i_0][i_3+1] * 6;
                }
            }
        }
        B[i_0] = F[i_0] - G[0] + B[i_0-1] * 1;
    }
        ...
        for (int i_5 = 1; i_5 < min(-i_4+PB_L-2, PB_M-1); i_5++) {
            for (int i_6 = 1; i_6 < -i_5+PB_M-1; i_6++) {
                for (int i_7 = 0; i_7 < -i_6+PB_Q; i_7++) {
                    A[i_7+1][i_5+i_4+2][i_6][1] = H[i_5][i_6-1][i_4][i_7+i_6] + I[i_7+1][i_5+1][i_4][i_6+1][i_7] + D[i_6][i_4][i_5-1][i_4] + D[i_5+1][i_6-1][i_7][i_4+1] + D[i_6][i_4][i_5][i_6] - H[i_5][i_6+1][i_4][i_7] * H[i_6+i_5+1][i_7][i_4][i_6+1] + H[i_5][i_4][i_7][i_6] + 5;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,wi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4332351125_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,wi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,wi,POLYBENCH_ARRAY(I)));
