...
void kernel_4426331323_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi)){
    ...
    for (int i_1 = 1; i_1 < PB_Q-1; i_1++) {
        for (int i_2 = 0; i_2 < min(-i_1+PB_P+1, PB_Q-1); i_2++) {
            for (int i_3 = 1; i_3 < PB_P-1; i_3++) {
                for (int i_4 = 1; i_4 < min(-i_3+PB_L-1, -i_1+PB_Q-1); i_4++) {
                    B[i_1][i_1-1][i_4][i_3] = G[i_3][i_1-1][i_4+1][i_2] * H[i_4][i_2+1][i_3][i_1] + H[i_4+1][i_1][i_2][i_3] * G[i_3][i_4+i_1][i_2+i_1-1][i_2] + I[i_4][i_3][i_2][i_4+i_1+1] + H[i_4+i_3+1][i_1][i_1][i_3-1] - B[i_1][i_1-1][i_4][i_3-1] - B[i_1][i_1-1][i_3+1][i_4] - B[i_1][i_1-1][i_4+1][i_3] * B[i_1][i_1-1][i_4-1][i_3+1] + 1;
                }
            }
        }
        A[i_1] = E[i_1-1] + E[i_1] * E[i_1] - 2;
        for (int i_5 = 0; i_5 < i_1; i_5++) {
            for (int i_6 = i_5; i_6 < PB_P; i_6++) {
                for (int i_7 = 0; i_7 < PB_M-1; i_7++) {
                    B[i_1][i_1-1][i_5][i_7] = G[i_7+1][i_1-1][i_5][i_6] * 1;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4426331323_06(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I)));
