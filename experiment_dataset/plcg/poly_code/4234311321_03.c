...
void kernel_4234311321_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
        ...
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < PB_P; i_2++) {
                for (int i_3 = i_1; i_3 < PB_Q; i_3++) {
                    A[i_1][i_2][i_2] = A[i_0+1][i_2-1][i_2-1] - A[i_1-2][i_2-1][i_2-1] - A[i_1+1][i_2][i_2] + 6;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-1; i_4++) {
        B[i_4] = C[i_4+1] + D[i_4+1] + B[i_4+1] * B[i_4-2] - 3;
    }
#pragma endscop
...
kernel_4234311321_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
