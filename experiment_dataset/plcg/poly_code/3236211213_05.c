...
void kernel_3236211213_05(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_P-1; i_0++) {
        for (int i_1 = 2; i_1 < PB_M; i_1++) {
            ...
            B[i_1-1][i_0] = C[i_1][i_0+1] * B[i_1-2][i_0+1] * B[i_1][i_0] + 5;
        }
    }
#pragma endscop
...
kernel_3236211213_05(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
