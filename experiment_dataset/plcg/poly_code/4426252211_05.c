...
void kernel_4426252211_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-2; i_0++) {
        A[i_0] = E[i_0] - F[i_0] * F[i_0+2] + 5;
        B[i_0] = F[i_0] + F[i_0] - E[i_0] - E[i_0] - A[i_0-1] + 2;
    }
    for (int i_1 = 2; i_1 < PB_M-3; i_1++) {
        C[i_1+2] = E[i_1] * E[i_1] - E[i_1] * E[i_1] * F[i_1] - F[i_1] - G[i_1-2][0] * A[i_1+1] - C[i_1+3] + 3;
        for (int i_2 = 2; i_2 < PB_M; i_2++) {
            for (int i_3 = i_2; i_3 < min(min(-i_2+PB_N+2, PB_L-1), -i_1+PB_N+1); i_3++) {
                for (int i_4 = 1; i_4 < -i_1+PB_M; i_4++) {
                    D[i_4+i_1][i_2][i_4+2][2] = H[i_3][i_1-2][i_2][i_2] * H[i_3+i_2-2][i_1-1][i_1][i_4] - H[i_2][i_4+i_1][i_3][i_3] * H[i_4][i_3][i_1][i_2-2] * I[i_2-2][i_1][i_3][i_1] * I[i_1][i_3-1][i_2-1][i_4-1] * D[i_4+i_1+1][i_3][i_4+3][2] * D[i_3+i_1-1][i_2-1][i_3+1][2] * 3;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4426252211_05(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I)));
