...
void kernel_4426212221_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf)){
        ...
        for (int i_1 = 0; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 0; i_2 < PB_M-2; i_2++) {
                for (int i_3 = 0; i_3 < i_0; i_3++) {
                    A[i_0][i_1][i_2][i_2] = A[i_0][i_1][i_3+1][i_3+1] - A[i_2+2][i_1+2][i_0][i_0] * 5;
                }
            }
        }
        B[i_0+2] = E[i_0] + B[i_0+4] + B[i_0+3] - 2;
    }
    for (int i_4 = 2; i_4 < PB_M-2; i_4++) {
        for (int i_5 = i_4; i_5 < PB_Q-1; i_5++) {
            for (int i_6 = 0; i_6 < PB_P; i_6++) {
                for (int i_7 = 0; i_7 < PB_L-1; i_7++) {
                    C[i_4][i_7][i_5][i_4] = C[i_4+2][i_7][i_5+1][i_4+2] - C[i_4][i_7+1][i_5][i_4] + 4;
                }
            }
        }
        for (int i_8 = 0; i_8 < i_4; i_8++) {
            for (int i_9 = i_4; i_9 < PB_Q-1; i_9++) {
                for (int j_0 = 1; j_0 < -i_8+PB_M; j_0++) {
                    D[i_4-2][j_0-1][i_9+1][j_0] = F[j_0+i_8][i_4][i_9][j_0] - D[i_4][j_0-1][i_9+1][j_0] + 2;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), INIT_SEED);
kernel_4426212221_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F)));
