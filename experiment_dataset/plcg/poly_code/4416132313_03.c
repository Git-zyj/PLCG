...
void kernel_4416132313_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-2; i_0++) {
        ...
        B[i_0] = E[2] + E[i_0+2] * E[i_0] * E[i_0-1] - F[i_0][i_0] + E[i_0] - E[i_0] + B[i_0-1] - 5;
        B[i_0+1] = E[i_0-1] + E[i_0-1] + 6;
    }
    for (int i_2 = 1; i_2 < PB_M-3; i_2++) {
        for (int i_3 = i_2; i_3 < PB_L; i_3++) {
            for (int i_4 = 0; i_4 < -i_2+PB_P-1; i_4++) {
                for (int i_5 = 0; i_5 < PB_M-2; i_5++) {
                    D[i_2+2][i_3][i_4][i_5] = G[i_5][i_3-1][0] - H[i_3][i_4+i_2+1][i_5][1] * D[i_2+1][i_3][i_4][i_5] - D[i_5+2][i_3-1][i_2-1][i_4] + D[i_2+2][i_4][i_3-1][i_5] + D[i_2+3][i_3][i_4][i_5] - 1;
                }
            }
        }
    }
...
kernel_4416132313_03(xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
