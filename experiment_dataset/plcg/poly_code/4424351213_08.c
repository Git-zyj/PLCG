...
static void print_array(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl),int xm,int ym,int zm,DATA_TYPE POLYBENCH_3D(M,xM,yM,zM,xm,ym,zm))
{
int i_0, i_1, i_2, i_3;
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_Q-1; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_L; i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_Q; i_3++) {
                    A[i_2][i_1-1][i_3][i_0] = E[i_2][i_1][i_0][i_3] * F[i_2][i_1+1][i_3][i_0] - F[i_1+1][i_2+i_0][i_3-1][i_1-1] * G[i_1][i_2][i_3][i_0] + E[i_3][i_2][i_1+i_0+1][i_0] - E[i_1+1][i_2][i_3-1][i_3+i_0] * H[i_3][i_1][i_1+1] + A[i_3-1][i_0-1][i_2][i_1] - A[i_2][i_1-1][i_3][i_0+1] + 3;
                }
            }
        }
        B[i_0+1] = I[i_0] * J[i_0] + I[i_0-1] + K[i_0-1] * B[i_0] - 3;
        for (int i_4 = 2; i_4 < PB_Q-1; i_4++) {
            for (int i_5 = 0; i_5 < -i_4+PB_L; i_5++) {
                for (int i_6 = 0; i_6 < i_5; i_6++) {
                    C[i_5+i_4][i_6][1] = L[i_4][i_6+i_5+1][i_0] - F[i_0][i_4][i_5][i_0+1] - E[i_6][i_0-1][i_5+1][i_6] * E[i_4][i_0][i_5][i_6] - M[i_6][i_6][i_4+1] * C[i_5+i_4-1][i_6+1][1] - C[i_6+i_4-2][i_5+1][1] + 5;
                }
            }
        }
    }
    for (int i_7 = 0; i_7 < PB_M-2; i_7++) {
        B[i_7+2] = K[i_7+1] + K[i_7] - J[i_7] - J[i_7] + 6;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,zm,POLYBENCH_ARRAY(M), INIT_SEED);
kernel_4424351213_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,zm,POLYBENCH_ARRAY(M));
