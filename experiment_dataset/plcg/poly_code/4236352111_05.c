        ...
        for (int i_1 = 2; i_1 < -i_0+PB_N-2; i_1++) {
            for (int i_2 = 2; i_2 < min(min(-i_1+PB_Q-2, -i_0+PB_Q-1), i_1); i_2++) {
                for (int i_3 = 1; i_3 < -i_2+PB_Q-1; i_3++) {
                    A[i_3][i_1-1][i_0][i_2+i_1+2] = C[i_1][i_2][i_0][i_0-2] + C[i_1-1][i_0+2][i_3][i_2-2] + D[i_1+i_0+2][i_3][i_2+2][1] + E[i_2][i_3-1][i_1-2][i_2] + A[i_0][i_2-2][i_1][i_3+i_2+1] * A[i_3+1][i_2-2][i_1][i_2+i_0+1] * 6;
                }
            }
        }
    }
    for (int i_4 = PB_M - 1; i_4 >= 0; i_4--) {
        B[i_4] = F[i_4] - G[i_4] + H[i_4][i_4] * I[i_4] * G[i_4] - 3;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4236352111_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I)));
