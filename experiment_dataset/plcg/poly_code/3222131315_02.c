...
void kernel_3222131315_02(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < PB_P-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_N-1; i_2++) {
                B[i_2+1][i_0][i_1+1][i_1] = 2;
            }
        }
    }
    for (int i_3 = 0; i_3 < PB_L; i_3++) {
        for (int i_4 = 1; i_4 < min(PB_N-1, i_3); i_4++) {
            for (int i_5 = 2; i_5 < min(PB_N-1, -i_4+PB_L); i_5++) {
                B[i_5+1][i_3][i_4][i_4-1] = C[i_5][i_3+1][i_4] + D[i_3][i_5+i_4][i_4][i_3] - C[i_5][i_3][i_4] + C[i_4][i_3][i_5] + C[i_4+1][i_5][1] - B[i_5+1][i_3][i_4+1][i_4] * B[i_4+1][i_3][i_5-1][i_5-2] - B[i_5][i_3][i_4][i_4-1] - 1;
            }
        }
    }
#pragma endscop
...
kernel_3222131315_02(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D));
