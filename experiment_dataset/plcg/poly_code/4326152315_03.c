...
void kernel_4326152315_03(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 1; i_1 < min(i_0, -i_0+PB_P); i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_L; i_2++) {
                B[i_2][i_1-1] = D[i_0+2][i_2+i_1][i_2] - D[i_1+1][i_0+1][i_2] - D[i_1][i_0][i_0] - D[i_2][i_1+i_0][i_0-1] - D[i_2+i_1][i_0+1][i_1] + D[i_2][i_1+i_0][i_0] * 2;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_L; i_3++) {
        for (int i_4 = 1; i_4 < i_3; i_4++) {
            B[i_3][i_4] = D[i_3][i_4-1][i_3+2] * E[i_4][i_3] + E[i_4-1][i_3] * E[i_4][i_3] + B[i_3][i_4+1] - B[i_3-1][i_4] * B[i_3][i_4-1] - 3;
        }
    }
    for (int i_5 = 2; i_5 < PB_L; i_5++) {
        for (int i_6 = i_5; i_6 < PB_L; i_6++) {
            for (int i_7 = 1; i_7 < min(-i_5+PB_L, -i_6+PB_L); i_7++) {
                C[i_6][i_5][i_7+i_5+2] = D[i_5][i_7][i_6-2] - D[i_7+i_6][i_5-2][i_6-2] + D[i_7-1][i_5][i_6+1] + D[i_6][i_5+2][i_5] + E[i_7+i_5][i_6] * C[i_6][i_5+1][i_7+i_5+2] * C[i_6-1][i_5][i_7+i_5+1] * C[i_6-1][i_5][i_7+i_5+2] * 6;
            }
        }
    }
#pragma endscop
...
kernel_4326152315_03(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
