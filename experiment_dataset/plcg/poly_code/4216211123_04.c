...
void kernel_4216211123_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            ...
            for (int i_3 = 0; i_3 < i_1; i_3++) {
                A[i_0-2][i_1][0] = C[i_1][i_0][i_1+1] - 6;
            }
        }
    }
#pragma endscop
...
kernel_4216211123_04(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C));
