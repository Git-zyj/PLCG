...
void kernel_4436151213_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
...
#pragma scop
        ...
        for (int i_1 = max(1, i_0); i_1 < -i_0+PB_L-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_L; i_2++) {
                for (int i_3 = 1; i_3 < -i_2+PB_L; i_3++) {
                    A[i_0+1][i_1][i_2][i_3] = E[i_1+1][i_3+i_2][0][i_0+1] - E[i_2][i_1][i_3][i_0+1] - E[i_3-1][i_1+i_0+1][i_2][i_0] - A[i_0+1][i_1][i_3][i_2-1] + A[i_1+1][i_3][i_2-1][i_0] * A[i_0+1][i_1-1][i_2][i_3-1] - 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_N-2; i_4++) {
        for (int i_5 = 1; i_5 < i_4; i_5++) {
            B[i_4+1][i_4] = F[i_5][i_4] + F[i_5-1][i_4-1] + B[i_4+2][i_4+1] * 1;
        }
        for (int i_6 = 1; i_6 < PB_L-1; i_6++) {
            for (int i_7 = i_6; i_7 < PB_L-1; i_7++) {
                for (int i_8 = 1; i_8 < min(min(-i_7+PB_L, -i_4+PB_P+1), -i_6+PB_Q); i_8++) {
                    A[i_4+1][i_6+1][i_7-1][i_8-1] = G[i_8+i_6-1][i_6][i_7] - G[i_6][i_8+i_7][i_4-1] * E[i_6][i_7+1][i_8+i_4-1][i_6] * E[i_6][i_4][i_8-1][i_8] * E[i_4+1][i_7][i_8][i_6+1] + E[i_8][i_4][i_7][i_8+i_6] * G[i_4][i_8][i_7] * 6;
                }
            }
        }
    }
    for (int i_9 = 1; i_9 < PB_N-1; i_9++) {
        B[i_9+1][i_9] = H[i_9] + H[i_9] - H[i_9] * H[i_9+1] - H[i_9] - H[i_9] + H[i_9] * H[i_9-1] + 1;
    }
#pragma endscop
...
kernel_4436151213_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
