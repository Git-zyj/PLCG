...
void kernel_4322311115_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            B[i_0] = D[i_1][i_0-1][i_1] * B[i_1] - 6;
        }
        B[i_0] = 5;
    }
...
kernel_4322311115_06(xb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D));
