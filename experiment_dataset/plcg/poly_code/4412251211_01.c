...
void kernel_4412251211_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,int wb,DATA_TYPE POLYBENCH_5D(B,xB,yB,zB,vB,wB,xb,yb,zb,vb,wb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,int wg,DATA_TYPE POLYBENCH_5D(G,xG,yG,zG,vG,wG,xg,yg,zg,vg,wg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-2; i_0++) {
        A[i_0] = E[i_0] * E[i_0] - E[i_0-1] + F[i_0] + F[i_0] * F[i_0-1] - A[i_0-1] - 6;
        for (int i_1 = i_0; i_1 < -i_0+PB_P; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_P; i_2++) {
                for (int i_3 = 1; i_3 < min(PB_P-1, -i_0+PB_L+1); i_3++) {
                    B[i_0+1][i_3-1][i_1][i_2][i_1] = G[i_3+i_0-1][i_2+i_1][i_1+i_0][i_3][i_2] - H[i_2-1][i_3][i_1][0] + H[i_1][i_3+1][i_2][i_3+i_0] + H[i_3][i_0][i_0][i_2+1] + I[i_3][i_1+1][0] * B[i_0+2][i_1-1][i_3][i_2+1][i_3] - B[i_0][i_1-1][i_3][i_2-1][i_3] + B[i_3+1][i_2-1][i_0-1][i_1+1][i_0-1] * 5;
                }
            }
        }
        C[i_0] = E[i_0-1] - E[i_0-1] - A[i_0+1] * 3;
    }
        ...
        for (int i_5 = 0; i_5 < -i_4+PB_M; i_5++) {
            for (int i_6 = 1; i_6 < min(PB_L, -i_4+PB_Q+1); i_6++) {
                for (int i_7 = 1; i_7 < -i_4+PB_L; i_7++) {
                    D[i_4][i_6][i_6][1] = J[i_7][i_5][i_6][i_6+i_4-1] * H[i_5+i_4][i_6][i_7][1] * J[i_4][i_7][i_5][i_4] * K[i_6-1][i_5][i_7+i_4] * D[i_4][i_6+1][i_6+1][1] * D[i_4][i_6-1][i_6-1][1] - D[i_7-1][i_6][i_6][1] + 6;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,wb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4412251211_01(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,wb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
