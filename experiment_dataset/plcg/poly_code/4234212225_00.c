...
void kernel_4234212225_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
...
#pragma scop
    ...
    for (int i_3 = 0; i_3 < PB_L; i_3++) {
        for (int i_4 = 2; i_4 < min(-i_3+PB_N, PB_M-1); i_4++) {
            B[i_4-1] = C[i_4+i_3][i_4+1][i_3] - B[i_4-2] * 3;
        }
    }
#pragma endscop
...
kernel_4234212225_00(xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
