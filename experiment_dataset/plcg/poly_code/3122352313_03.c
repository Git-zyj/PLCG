    ...
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 2; i_1 < min(min(PB_L-3, -i_0+PB_L), i_0); i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_M-1, i_0); i_2++) {
                A[i_2+i_0][i_2][i_1+2] = B[i_2][i_1+i_0][i_0-2] - C[i_0][i_2+i_1][i_0] * D[i_1-1][i_2][i_0] + E[i_0+2][i_1-2][i_1][i_2] - B[i_0+2][i_2][i_1] - A[i_2+i_0-1][i_2-1][i_1+2] - A[i_2+i_0+1][i_2][i_1+2] * A[i_2+i_0][i_2][i_1+3] + 3;
            }
        }
    }
#pragma endscop
...
kernel_3122352313_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
