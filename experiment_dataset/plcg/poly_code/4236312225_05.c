...
void kernel_4236312225_05(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd)){
        ...
        for (int i_1 = i_0; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_P+2; i_2++) {
                for (int i_3 = i_2; i_3 < -i_0+PB_L; i_3++) {
                    B[i_1][i_2-1][i_3+i_0-2][i_0-2] = C[i_3-1][2][i_2+i_0-2] + D[i_2+1][i_3+i_0][i_1][i_2] - 3;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < i_4; i_5++) {
            for (int i_6 = 0; i_6 < -i_4+PB_P-2; i_6++) {
                for (int i_7 = 0; i_7 < -i_6+PB_P; i_7++) {
                    B[i_4][i_5][i_7+i_6][i_6] = B[i_4][i_5+2][i_7+i_6][i_6] - B[i_7][i_5][i_6+i_4+2][i_6+2] - 2;
                }
            }
        }
    }
...
kernel_4236312225_05(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D));
