...
void kernel_2214212325_07(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_N - 1; i_0 >= 2; i_0--) {
        B[i_0+2] = C[2] + C[i_0-2] * 5;
        B[i_0+2] = B[i_0+3] + B[i_0+1] - B[i_0+4] + 4;
    }
#pragma endscop
...
kernel_2214212325_07(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
