...
void kernel_2336131323_02(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        B[0] = D[0] * D[0] + D[i_0] * D[i_0] - B[0] - 2;
    }
    for (int i_1 = 1; i_1 < PB_L; i_1++) {
        B[0] = D[i_1] + B[0] + B[0] * 6;
        B[0] = D[1] - D[i_1-1] + D[i_1-1] * 1;
    }
#pragma endscop
...
kernel_2336131323_02(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
