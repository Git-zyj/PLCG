...
void kernel_2332311115_05(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
kernel_2332311115_05(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
