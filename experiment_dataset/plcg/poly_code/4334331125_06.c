    ...
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        ...
        for (int i_3 = 0; i_3 < min(PB_M, -i_0+PB_L); i_3++) {
            for (int i_4 = 1; i_4 < i_3; i_4++) {
                A[i_4][i_3][i_0] = D[i_3][i_4][i_0][i_4+1] * E[i_0][i_3][i_4-1] + E[i_4][i_3+i_0][i_0] + F[i_3+1][i_0] * G[i_4][i_4][i_3] + 4;
            }
        }
    }
        ...
        for (int i_6 = 2; i_6 < PB_M; i_6++) {
            for (int i_7 = 1; i_7 < -i_6+PB_Q; i_7++) {
                for (int i_8 = 0; i_8 < PB_M-1; i_8++) {
                    A[i_6][i_7][i_8] = D[i_8+1][i_5+1][i_6][i_7+i_6] + H[i_7-1][i_5+1][i_6][i_8] * A[i_7][i_5][i_6-2] + 3;
                }
            }
        }
    }
...
kernel_4334331125_06(xa,ya,za,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
