    ...
    for (int i_5 = 2; i_5 < PB_P; i_5++) {
        for (int i_6 = 2; i_6 < min(PB_N-2, i_5); i_6++) {
            for (int i_7 = 2; i_7 < PB_P+2; i_7++) {
                for (int i_8 = 0; i_8 < min(-i_7+PB_Q+2, PB_N-2); i_8++) {
                    D[i_6-2][i_7-2][i_8+i_7-2][i_5-2] = F[i_6+2][i_8+2][i_6][i_5] * 5;
                }
            }
        }
    }
...
kernel_4434212111_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
