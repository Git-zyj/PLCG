...
void kernel_4222311123_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 0; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_M; i_2++) {
                for (int i_3 = 0; i_3 < -i_2+PB_N; i_3++) {
                    A[i_3+i_2][i_0][i_1][0] = C[i_2][i_3][i_2][i_0+1] + D[i_1+1][i_2][0] * 2;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < PB_N; i_5++) {
            for (int i_6 = 0; i_6 < min(i_5, -i_5+PB_N); i_6++) {
                for (int i_7 = 0; i_7 < -i_5+PB_N; i_7++) {
                    A[i_7+i_5][i_4][i_6][0] = A[i_6+i_5][i_7][i_4][0] - 2;
                }
            }
        }
    }
...
kernel_4222311123_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
