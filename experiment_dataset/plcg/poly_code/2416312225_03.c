...
void kernel_2416312225_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_L-3; i_1++) {
        for (int i_2 = 0; i_2 < PB_L-2; i_2++) {
            B[i_2][i_1+2] = F[i_2+2] + G[i_2][i_1] + B[i_1-1][i_2+2] + 5;
            B[i_2][i_1+2] = H[i_2+1][i_1-1] - 5;
            B[i_2][i_1+3] = 3;
        }
    }
#pragma endscop
...
kernel_2416312225_03(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
