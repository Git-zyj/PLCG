...
void kernel_4436231321_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        A[i_0] = E[i_0] * F[i_0+1] * E[i_0+1] * C[i_0] + C[i_0-1] + C[i_0-2] + 5;
        for (int i_1 = i_0; i_1 < -i_0+PB_P-1; i_1++) {
            B[i_1][i_1+i_0-1] = G[i_1][i_0] - H[i_0][i_1] - A[i_0] * B[i_1+2][i_1+i_0+1] - 1;
        }
        for (int i_2 = 2; i_2 < min(-i_0+PB_M, i_0); i_2++) {
            C[i_2] = I[i_0][i_2+1][i_0] - H[i_2][i_0-1] - H[i_2][i_0] - G[i_2+i_0][i_2] - E[i_2+i_0] * F[i_2] * C[i_2+1] - C[i_2-2] + 3;
        }
    }
        ...
        for (int i_4 = 0; i_4 < min(PB_L-3, i_3); i_4++) {
            for (int i_5 = 0; i_5 < PB_Q-1; i_5++) {
                for (int i_6 = i_5; i_6 < PB_L-1; i_6++) {
                    D[i_6+1][i_3+1][i_5][i_5] = D[i_4+3][i_5+1][i_6][i_6] + D[i_6][i_3+2][i_5+1][i_5+1] * D[i_6+1][i_3+3][i_5][i_5] + D[i_6+1][i_3][i_5][i_5] * 2;
                }
            }
        }
    }
...
kernel_4436231321_08(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
