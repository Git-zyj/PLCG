...
void kernel_2126112113_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N; i_0++) {
        for (int i_1 = min(PB_M-3, -i_0+PB_N) - 1; i_1 >= i_0; i_1--) {
            A[i_1+2] = B[i_1+i_0] + A[i_1+3] + 6;
        }
    }
#pragma endscop
...
kernel_2126112113_05(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
