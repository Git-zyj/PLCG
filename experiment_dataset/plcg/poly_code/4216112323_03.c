...
void kernel_4216112323_03(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        for (int i_1 = i_0; i_1 < PB_L+1; i_1++) {
            A[i_1-1][i_0] = A[i_1-2][i_0] * 4;
        }
        for (int i_2 = 0; i_2 < i_0; i_2++) {
            for (int i_3 = 1; i_3 < i_2; i_3++) {
                for (int i_4 = 0; i_4 < min(-i_3+PB_P, PB_L-3); i_4++) {
                    B[i_0][i_4+1][i_2][i_3] = C[i_4][i_4+i_3][i_0][i_2] - B[i_0][i_4+1][i_2][i_3-1] + B[i_4+2][i_0+2][i_2][i_3] + B[i_0][i_4+3][i_2][i_3] * B[i_0-2][i_4+1][i_2][i_3-1] * B[i_0+1][i_4+3][i_2][i_3+2] * 2;
                }
            }
        }
    }
...
kernel_4216112323_03(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
