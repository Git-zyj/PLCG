...
void kernel_4332211311_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 0; i_1 < PB_Q-1; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_1+PB_P, PB_L-1); i_2++) {
                for (int i_3 = 0; i_3 < -i_1+PB_P-1; i_3++) {
                    A[i_2+1][i_3+i_1][i_3] = A[i_3][i_2+i_1][i_1] - A[i_2+1][i_3+i_1+1][i_1+1] * 2;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_L; i_4++) {
            B[i_0][i_4] = D[i_4][i_0][0] * B[i_0-1][i_4] * B[i_0+1][i_4] + B[i_0+1][i_4-1] + 3;
        }
    }
    for (int i_5 = 1; i_5 < PB_L; i_5++) {
        for (int i_6 = 1; i_6 < -i_5+PB_P; i_6++) {
            for (int i_7 = 0; i_7 < -i_6+PB_M; i_7++) {
                C[i_7+i_6][i_5][i_6+i_5] = D[i_7][i_6][i_5] + C[i_7+i_6-1][i_5][i_6+i_5-1] - C[i_7+i_6-1][i_5][i_6+i_5] * 6;
            }
        }
    }
#pragma endscop
...
kernel_4332211311_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
