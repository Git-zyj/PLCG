...
void kernel_4322252321_01(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 1; i_1 < -i_0+PB_L-2; i_1++) {
            A[i_0][i_1+i_0] = D[i_0] + E[i_1-1][i_0] * D[i_1] - E[i_1][i_0] + E[i_1][i_0] - E[i_0][i_0] - F[i_0+1][i_1] - A[i_0][i_1+i_0+2] * A[i_0+1][i_1+i_0+1] + 3;
        }
    }
        ...
        for (int i_3 = 2; i_3 < PB_M-2; i_3++) {
            for (int i_4 = 2; i_4 < PB_P+1; i_4++) {
                for (int i_5 = 2; i_5 < PB_Q-2; i_5++) {
                    B[i_5][i_2][i_4-2][i_3] = G[i_4][i_5][i_3][i_2+2] + H[i_3+2][i_2][i_2][i_3] + G[i_3-1][i_4-2][i_3][i_5] - I[i_4][i_5][i_3-2] + B[i_5+2][i_2][i_4-2][i_3] - B[i_3][i_2+2][i_5-2][i_4] * B[i_5][i_2][i_4-1][i_3] - B[i_2-1][i_3][i_4-2][i_5+2] * B[i_2+2][i_4][i_5-2][i_3] + 3;
                }
            }
        }
        for (int i_6 = 0; i_6 < PB_L-1; i_6++) {
            C[i_2][i_6] = J[i_2] * F[i_2-2][i_6+1] - E[i_2+1][i_6] * K[i_2][i_2][i_6] + C[i_2+1][i_6] + 3;
        }
    }
#pragma endscop
