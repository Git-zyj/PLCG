...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_M-1; i_1++) {
        A[i_1] = E[i_1] * E[i_1-2] + E[i_1] + E[i_1+1] + 6;
    }
    for (int i_2 = 2; i_2 < PB_P; i_2++) {
        for (int i_3 = 2; i_3 < -i_2+PB_L; i_3++) {
            C[i_2-1][i_3+1] = F[i_3+i_2][i_3-2][i_2] + G[i_3+i_2][i_3+i_2] - G[i_3][i_2] + G[i_3][i_2] + G[i_3-2][i_2] - C[i_2-2][i_3+1] * 6;
        }
        for (int i_4 = 0; i_4 < PB_P-2; i_4++) {
            for (int i_5 = 2; i_5 < PB_N-1; i_5++) {
                for (int i_6 = 0; i_6 < min(-i_5+PB_M-1, -i_4+PB_L); i_6++) {
                    D[i_2][i_5][i_6+1][0] = H[i_4+1][i_5][i_6][2] * H[i_5+1][i_5-2][i_6+i_4][1] - H[i_2][i_6+i_5+1][i_2-2][i_4+2] - H[i_4][i_6+i_5][i_2][i_4+2] - F[i_6][i_4][i_5] - H[i_6+2][i_4][i_2][0] - D[i_2+1][i_5][i_6+1][0] * 2;
                }
            }
        }
    }
...
kernel_4422152123_03(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
