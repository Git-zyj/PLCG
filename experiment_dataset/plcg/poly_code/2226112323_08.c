...
void kernel_2226112323_08(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_2 = 2; i_2 < PB_L-2; i_2++) {
        B[i_2] = C[i_2] - C[0] - B[i_2-2] * B[i_2-1] + B[i_2+2] - 4;
    }
#pragma endscop
...
kernel_2226112323_08(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
