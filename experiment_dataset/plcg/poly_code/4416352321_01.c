...
void kernel_4416352321_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,int ym,DATA_TYPE POLYBENCH_2D(M,xM,yM,xm,ym)){
...
#pragma scop
        ...
        for (int i_1 = 2; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_M; i_2++) {
                for (int i_3 = 2; i_3 < i_2; i_3++) {
                    A[i_0][i_1+2][i_1+2][i_2-1] = E[i_2-1][i_3+2][i_1][i_0-2] * F[i_0][i_3+i_2][i_1-2][0] - E[i_2][i_3+i_1-2][i_0+1][i_0] - G[i_2][i_3][i_3+1] + H[i_2][i_1][i_3-2][i_3+i_0] + H[i_3][i_1][i_0][i_1+1] + F[i_3-1][i_2+i_1][i_0][i_1] + A[i_0-2][i_1+2][i_1+2][i_3-1] * A[i_0+2][i_1+2][i_1+2][i_2+1] - 3;
                }
            }
        }
        B[i_0] = I[i_0][i_0] - J[i_0] - K[i_0] + J[i_0-1] - B[i_0+2] - B[i_0-2] + D[i_0+2] + 5;
        for (int i_4 = 0; i_4 < PB_L; i_4++) {
            for (int i_5 = 2; i_5 < min(-i_0+PB_Q, i_0); i_5++) {
                for (int i_6 = 2; i_6 < PB_L; i_6++) {
                    C[i_5][i_6][i_6][i_5+i_0] = E[i_5][i_6][i_0][i_4] + F[i_5][i_0][i_4][i_0-1] - C[i_5-2][i_6-1][i_6-1][i_5+i_0-2] + C[i_5-2][i_6-2][i_6-2][i_5+i_0] * 5;
                }
            }
        }
    }
    for (int i_7 = 1; i_7 < PB_M-2; i_7++) {
        for (int i_8 = 2; i_8 < i_7; i_8++) {
            D[i_8] = I[i_8+1][i_7-1] + L[i_8] - M[i_8-1][i_7] * L[i_7+2] + B[i_8+1] * B[i_8] + D[i_8-2] * D[i_8+1] - 4;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M), INIT_SEED);
kernel_4416352321_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M));
