...
void kernel_2232112325_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        for (int i_1 = 4; i_1 < PB_N+4; i_1++) {
            B[i_1-4] = C[i_0][0] - C[i_0-1][i_1] * 5;
        }
    }
    for (int i_2 = 4; i_2 < PB_N; i_2++) {
        B[i_2-2] = B[i_2-1] + B[i_2] - B[i_2-4] * 2;
    }
#pragma endscop
...
kernel_2232112325_06(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
