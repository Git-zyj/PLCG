...
void kernel_4432332313_05(int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,int wi,DATA_TYPE POLYBENCH_5D(I,xI,yI,zI,vI,wI,xi,yi,zi,vi,wi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N; i_0++) {
        for (int i_1 = 0; i_1 < -i_0+PB_M; i_1++) {
            D[i_0][i_1+i_0] = E[i_0] * F[i_1][i_0] * F[i_1][i_0] * 2;
        }
    }
        ...
        for (int i_3 = i_2; i_3 < PB_M-1; i_3++) {
            for (int i_4 = 1; i_4 < -i_3+PB_M-1; i_4++) {
                for (int i_5 = 1; i_5 < PB_M-2; i_5++) {
                    B[i_2][0][i_2-1][i_5] = G[i_5+2][i_5][i_2][i_4-1] - H[i_4+i_3+1][i_5][i_4][i_2+2] * B[i_5+1][0][i_5][i_4+1] - B[i_3][0][i_3-1][i_5-1] - B[i_4+1][0][i_4][i_5] - B[i_2-1][0][i_2-2][i_5-1] + 1;
                }
            }
        }
        for (int i_6 = 2; i_6 < PB_L-1; i_6++) {
            for (int i_7 = 1; i_7 < PB_L-1; i_7++) {
                for (int i_8 = 0; i_8 < -i_6+PB_Q; i_8++) {
                    B[i_7][0][i_7-1][i_6+1] = H[i_2+1][i_7+1][i_6][2] - I[i_6][i_8+1][i_7+1][i_2][i_6-2] * G[i_2][i_7][i_8+i_6][2] - 2;
                }
            }
        }
    }
    for (int i_9 = 0; i_9 < PB_M-1; i_9++) {
        for (int j_0 = 2; j_0 < -i_9+PB_M-1; j_0++) {
            D[j_0][j_0+i_9] = J[j_0-2][i_9][i_9] - K[j_0][i_9+1] - L[j_0][0] - F[i_9+1][j_0+i_9] * D[j_0][j_0+i_9+1] * 2;
        }
    }
#pragma endscop
...
init_array(xd,yd,POLYBENCH_ARRAY(D), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,wi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4432332313_05(xd,yd,POLYBENCH_ARRAY(D), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,wi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xd,yd,POLYBENCH_ARRAY(D), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,wi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L)));
