        ...
        for (int i_1 = 2; i_1 < PB_M; i_1++) {
            for (int i_2 = 2; i_2 < PB_M-2; i_2++) {
                for (int i_3 = 1; i_3 < PB_M-2; i_3++) {
                    A[i_2][i_1][i_0] = A[i_3][i_2][i_1-2] * A[i_3-1][i_2+2][i_1] * A[i_2-2][i_3][i_1] + A[i_2][i_1][i_3+2] + 5;
                }
            }
        }
        for (int i_4 = 0; i_4 < i_0; i_4++) {
            for (int i_5 = i_4; i_5 < PB_M-2; i_5++) {
                B[i_4][i_0][i_5+2] = B[i_4+2][i_5][i_0+2] * B[i_4][i_0][i_5+1] - 2;
            }
        }
    }
    for (int i_6 = 1; i_6 < PB_L-2; i_6++) {
        for (int i_7 = 0; i_7 < i_6; i_7++) {
            for (int i_8 = 1; i_8 < -i_6+PB_Q-1; i_8++) {
                for (int i_9 = 0; i_9 < i_6; i_9++) {
                    C[i_7][i_8-1][i_8+i_6] = E[i_9][i_6+2][i_7][0] * C[i_9][i_8-1][i_8+i_6+1] + C[i_7+1][i_8-1][i_9+i_8] + 6;
                }
            }
        }
        for (int j_0 = 0; j_0 < -i_6+PB_L-1; j_0++) {
            for (int j_1 = i_6; j_1 < PB_M; j_1++) {
                for (int j_2 = 0; j_2 < -j_0+PB_L-1; j_2++) {
                    D[j_1][j_0+i_6+1][j_2][j_2] = D[j_1][j_0+i_6-1][j_2][j_2] * D[j_1][j_2+j_0+1][i_6+1][i_6+1] + 4;
                }
            }
        }
    }
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), INIT_SEED);
kernel_4424312321_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E)));
