...
void kernel_2314112123_02(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N; i_0++) {
        for (int i_1 = 0; i_1 < PB_N-2; i_1++) {
            B[i_1+1] = D[i_1+2] * B[i_0] - 3;
        }
        B[i_0] = D[i_0] * 3;
    }
...
kernel_2314112123_02(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
