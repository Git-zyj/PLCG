...
void kernel_3432311211_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_M; i_2++) {
                A[i_1-1][i_2+i_0][i_0] = E[i_2+i_0][i_2+i_0][i_1] - A[i_1][i_2+i_0+1][i_0+1] - 1;
            }
        }
        for (int i_3 = 0; i_3 < PB_L-1; i_3++) {
            C[i_3+1][i_0+1] = C[i_3][i_0+1] - 5;
        }
    }
    for (int i_4 = 0; i_4 < PB_P-1; i_4++) {
        for (int i_5 = i_4; i_5 < PB_P-1; i_5++) {
            for (int i_6 = 0; i_6 < i_5; i_6++) {
                C[i_6][i_4+1] = C[i_6+1][i_5+1] + C[i_6+1][i_4+1] + 6;
            }
        }
    }
...
kernel_3432311211_02(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
