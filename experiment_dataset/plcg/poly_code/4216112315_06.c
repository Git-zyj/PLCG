...
void kernel_4216112315_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        for (int i_1 = 3; i_1 < min(i_0, PB_M+2); i_1++) {
            for (int i_2 = 2; i_2 < PB_M+2; i_2++) {
                B[i_1-2] = C[i_2-2][i_1][i_1+2] * B[i_1-2] * B[i_2-2] - 1;
            }
            B[i_1-2] = B[i_1-3] * 5;
        }
    }
...
kernel_4216112315_06(xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
