...
void kernel_3432131321_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        A[i_0] = E[i_0+1] + E[i_0] + E[i_0] + E[i_0+1] + A[i_0-2] * A[i_0+1] - 2;
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            A[i_0] = E[i_1] + F[i_0][i_1][i_0] + 1;
        }
    }
    for (int i_2 = 0; i_2 < PB_L; i_2++) {
        for (int i_3 = 2; i_3 < PB_Q; i_3++) {
            for (int i_4 = 2; i_4 < PB_Q; i_4++) {
                C[i_3][i_4+1][i_4] = G[i_3+1][i_4-1][i_4-1][i_2] + F[i_4][i_3][i_2] - H[i_4-1][i_3] * F[i_4+1][0][i_2] - C[i_3][i_4-1][i_4-2] - C[i_3+1][i_4+1][i_4] * C[i_3-2][i_4][i_4-1] + 1;
            }
        }
    }
    for (int i_5 = 2; i_5 < PB_L-2; i_5++) {
        D[i_5] = E[i_5+1] - E[i_5] * D[i_5-2] - D[i_5+1] + D[i_5+2] - 3;
    }
#pragma endscop
...
kernel_3432131321_04(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
