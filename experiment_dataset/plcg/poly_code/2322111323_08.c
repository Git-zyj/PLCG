...
void kernel_2322111323_08(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_2 = 1; i_2 < PB_M-2; i_2++) {
        B[i_2] = D[i_2-1] * B[i_2+2] * B[i_2-1] * B[i_2+1] - 6;
    }
...
kernel_2322111323_08(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
