...
#pragma scop
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        ...
        for (int i_3 = 2; i_3 < PB_P; i_3++) {
            ...
            for (int i_5 = 2; i_5 < min(PB_P, -i_0+PB_N); i_5++) {
                D[i_0][i_5][i_3+2][i_3] = E[i_3][i_5-2] + E[i_3+2][i_0] + G[i_5-1][i_0][i_3] - E[i_5+i_0][i_0+2] - H[i_5][i_5-1][i_0] * D[i_0+1][i_5-1][i_3+2][i_3] - D[i_0][i_3-1][i_5+2][i_5] - D[i_3][i_5+1][i_0+2][i_0] * D[i_0][i_5+1][i_3+2][i_3] + 6;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4414232315_09(xa,ya,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H)));
