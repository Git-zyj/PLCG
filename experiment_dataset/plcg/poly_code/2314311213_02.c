...
void kernel_2314311213_02(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-1; i_0++) {
        A[i_0+1][i_0] = C[i_0] + 1;
        A[i_0+1][i_0] = C[i_0+1] * 3;
        C[i_0] = D[i_0] - A[i_0+1][i_0] - C[i_0-1] * 2;
    }
#pragma endscop
...
kernel_2314311213_02(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
