...
void kernel_2222131115_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_N-1; i_1++) {
        A[i_1+1] = C[i_1-1] + C[i_1-1] - C[i_1+1] + A[i_1] + 5;
    }
#pragma endscop
...
kernel_2222131115_06(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
