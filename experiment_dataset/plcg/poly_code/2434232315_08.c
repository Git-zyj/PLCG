...
void kernel_2434232315_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_L; i_1++) {
        D[i_1+1] = F[i_1] + F[i_1] * C[i_1-2] * D[i_1-1] - 6;
        for (int i_2 = 3; i_2 < PB_M-1; i_2++) {
            C[i_2-2] = G[i_1][i_2+1] + G[i_2][0] - H[i_2][i_1] * C[i_2-3] + 6;
        }
        D[i_1] = F[i_1] + F[i_1] - F[i_1] * F[i_1] - E[0] * C[i_1-2] - D[i_1-1] + 3;
    }
#pragma endscop
...
kernel_2434232315_08(xa,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
