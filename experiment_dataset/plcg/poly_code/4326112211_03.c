...
void kernel_4326112211_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_P-1; i_0++) {
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = i_0; i_2 < PB_Q; i_2++) {
                A[i_0][i_0+1][i_1] = A[i_0][i_0+1][i_1-1] + 3;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_P-1; i_3++) {
        ...
        for (int i_5 = 0; i_5 < min(min(-i_3+PB_P, PB_N), i_3); i_5++) {
            for (int i_6 = PB_M - 1; i_6 >= 0; i_6--) {
                C[i_6][i_3][i_3] = D[i_5][i_6][i_5+i_3] * A[i_6][i_6+1][i_3] + A[i_5][i_5+1][i_3] - C[i_6][i_3-1][i_3-1] + C[i_6][i_3+1][i_3+1] + 2;
            }
        }
    }
#pragma endscop
...
kernel_4326112211_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
