        ...
        for (int i_1 = 1; i_1 < min(i_0, PB_L-2); i_1++) {
            for (int i_2 = 2; i_2 < min(-i_0+PB_L+1, PB_L-2); i_2++) {
                for (int i_3 = 2; i_3 < i_2; i_3++) {
                    A[i_3+1][i_0-2][i_2+2][i_3] = D[i_2-2][i_1][i_3][i_2] + E[i_1+2][i_0+1][i_2][i_3] * F[i_0][i_3+i_2][i_1-1][0] + E[i_3+i_1][i_3+i_2][i_2+i_0-1][i_3] + F[i_2-1][i_3-2][i_1+2][0] * G[i_3][i_3+2][i_2][i_1-1][i_0] - E[i_3+2][i_1][i_0+1][i_2] - A[i_2+1][i_0-2][i_3][i_2] + A[i_3+1][i_0][i_2+1][i_3] - A[i_3+3][i_0][i_1+2][i_3+2] - 5;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L-3; i_4++) {
        B[i_4+2] = H[i_4-2] * H[i_4] - H[i_4-1] + I[i_4] - H[i_4+2] * B[i_4+1] * B[i_4] - B[i_4+3] - 6;
    }
    for (int i_5 = 2; i_5 < PB_M; i_5++) {
        for (int i_6 = 4; i_6 < PB_L; i_6++) {
            for (int i_7 = 0; i_7 < i_5; i_7++) {
                for (int i_8 = 2; i_8 < PB_M-1; i_8++) {
                    C[i_5][i_6-2][i_8][i_6-1] = F[i_8+1][i_7][i_6-1][i_5-1] + E[i_8][i_5][i_6][i_7] * E[i_7][i_6-2][i_5-2][i_8-2] + C[i_5][i_6-4][i_8][i_6-3] - 6;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4322352321_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I)));
