...
void kernel_4412251123_02(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-2; i_0++) {
        C[i_0] = E[i_0-1] * E[i_0] + F[i_0] + E[i_0-1] * F[i_0] * E[i_0-1] * C[i_0+2] + 3;
        for (int i_1 = 0; i_1 < min(PB_M, -i_0+PB_N); i_1++) {
            for (int i_2 = 1; i_2 < min(i_0, -i_1+PB_Q); i_2++) {
                for (int i_3 = 1; i_3 < PB_L; i_3++) {
                    B[i_1+i_0][i_2-1][i_3-1][i_3] = G[i_2][i_0+1][i_3-1][i_2+i_1] + H[i_0-1][i_2][i_3][i_0] - I[i_1][i_3][1] + H[i_3-1][i_2][i_1][i_0] - G[i_2+1][i_2][i_1][i_0] + 3;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        C[i_4] = E[i_4] + F[i_4+1] - E[i_4+1] + E[i_4] - C[i_4-1] + 3;
        for (int i_5 = 1; i_5 < PB_M-1; i_5++) {
            for (int i_6 = 1; i_6 < min(-i_4+PB_M-1, -i_5+PB_Q+1); i_6++) {
                for (int i_7 = 1; i_7 < min(PB_L, -i_4+PB_P+1); i_7++) {
                    D[i_5+1][i_6][i_4][i_7] = J[i_6-1][i_4+1][i_5] * J[i_6][i_7-1][i_4+1] + H[1][i_7][i_7+i_4-1][i_6+i_5-1] - J[i_6+i_4+1][i_7][i_5] - G[i_7][i_6+1][i_4][i_5] + D[i_5-1][i_6][i_4][i_7] - 4;
                }
            }
        }
    }
...
init_array(xc,POLYBENCH_ARRAY(C), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4412251123_02(xc,POLYBENCH_ARRAY(C), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xc,POLYBENCH_ARRAY(C), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J)));
