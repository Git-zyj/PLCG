...
void kernel_3216111211_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_2 = 1; i_2 < PB_L+1; i_2++) {
        B[i_2] = C[i_2-1] + B[i_2-1] * B[i_2+1] + 5;
    }
#pragma endscop
...
kernel_3216111211_03(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
