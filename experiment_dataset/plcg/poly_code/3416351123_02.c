...
void kernel_3416351123_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        A[i_0+1] = E[i_0] - F[i_0+1] + F[i_0-1] * 2;
    }
    for (int i_1 = 2; i_1 < PB_M-1; i_1++) {
        for (int i_2 = 1; i_2 < -i_1+PB_M-1; i_2++) {
            B[i_2][i_2+i_1+1] = G[i_2+i_1+1][i_2-1] + H[i_2][i_1] + G[i_2][i_1+1] - B[i_2][i_2+i_1+2] - 3;
        }
        for (int i_3 = 2; i_3 < min(-i_1+PB_M, i_1); i_3++) {
            C[i_1-1][i_3] = I[i_3+1][i_1+1] - E[i_3+i_1] * H[i_3+i_1][0] - E[i_3] - I[i_1][i_3+i_1+1] - F[i_3] - D[i_3][i_1-2] - D[i_1-1][i_3] + 2;
            D[i_1][i_3] = J[1] - I[i_1][i_3] + J[i_3] + H[i_1+1][i_3+i_1] * E[i_3] * D[i_1][i_3-2] - 1;
        }
    }
#pragma endscop
...
kernel_3416351123_02(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
