...
void kernel_4212212125_01(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    ...
    for (int i_3 = 0; i_3 < PB_P-2; i_3++) {
        for (int i_4 = 0; i_4 < -i_3+PB_M-2; i_4++) {
            B[i_4][i_3+1] = C[i_4+i_3][i_3] - C[i_4][i_4+i_3+2] * B[i_4][i_3+2] - 1;
        }
    }
#pragma endscop
...
kernel_4212212125_01(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
