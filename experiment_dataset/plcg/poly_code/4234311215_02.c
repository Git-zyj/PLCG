...
void kernel_4234311215_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
        ...
        for (int i_1 = 1; i_1 < PB_N-2; i_1++) {
            for (int i_2 = 0; i_2 < PB_M-2; i_2++) {
                for (int i_3 = 0; i_3 < i_2; i_3++) {
                    A[i_1+1][i_2+1][i_1-1] = A[i_1+2][i_2+2][i_1] - 1;
                }
            }
            B[i_1] = C[i_1][i_0] - B[i_1-1] + B[i_1+1] * 1;
        }
    }
#pragma endscop
...
kernel_4234311215_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
