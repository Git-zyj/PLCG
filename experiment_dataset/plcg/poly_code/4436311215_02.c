...
void kernel_4436311215_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < min(PB_L-1, i_1); i_2++) {
                A[i_2][i_1][i_2] = A[i_2+1][i_1][i_2+1] * A[i_0][i_2+1][i_0] + 6;
            }
        }
    }
        ...
        for (int i_5 = i_4; i_5 < PB_Q-1; i_5++) {
            for (int i_6 = 0; i_6 < -i_4+PB_M-1; i_6++) {
                for (int i_7 = 1; i_7 < PB_Q-1; i_7++) {
                    C[i_6+i_4][i_7-1][i_5][i_7] = C[i_6+i_4][i_5][i_7-1][i_5+1] - C[i_6+i_4+1][i_7][i_5][i_7+1] - 5;
                }
            }
        }
        D[i_4+1] = D[i_4] + D[i_4+2] + 4;
    }
#pragma endscop
...
kernel_4436311215_02(xa,ya,za,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E));
