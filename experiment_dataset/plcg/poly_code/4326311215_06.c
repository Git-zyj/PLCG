...
void kernel_4326311215_06(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_4 = 0; i_4 < min(-i_0+PB_M-1, i_0); i_4++) {
            for (int i_5 = 1; i_5 < PB_P; i_5++) {
                for (int i_6 = 1; i_6 < -i_0+PB_M; i_6++) {
                    B[i_6+i_0][i_4][i_5][i_6] = B[i_6+i_0-1][i_4+1][i_5-1][i_6-1] - B[i_4+i_0+1][i_6][i_5][i_0] * 4;
                }
            }
        }
    }
    for (int i_7 = 0; i_7 < PB_L-2; i_7++) {
        for (int i_8 = i_7; i_8 < PB_L; i_8++) {
            for (int i_9 = 1; i_9 < PB_L-1; i_9++) {
                C[i_7][i_9+1][i_9+1] = D[i_9][i_9][i_7] * C[i_9-1][i_7+2][i_7+2] + 5;
            }
        }
    }
#pragma endscop
...
kernel_4326311215_06(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
