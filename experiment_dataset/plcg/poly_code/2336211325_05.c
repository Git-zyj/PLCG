...
void kernel_2336211325_05(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_M; i_1++) {
        for (int i_2 = 0; i_2 < PB_M; i_2++) {
            C[i_1] = D[i_2] + E[i_2] - C[i_1] + 1;
        }
        C[i_1] = D[i_1] + C[i_1-2] * C[i_1-1] - 6;
    }
#pragma endscop
...
kernel_2336211325_05(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
