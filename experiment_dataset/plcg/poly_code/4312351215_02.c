...
void kernel_4312351215_02(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_Q-1; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_Q; i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_M; i_3++) {
                    B[i_3+i_0][i_2][i_3][i_2] = D[i_3+i_1][i_2+i_0][i_1] * E[i_1][i_3][i_3][i_2+i_0] + F[i_3+i_0][i_1+1][i_2][i_1][i_1+i_0+1] - G[i_1+1][i_3-1][i_0-1][i_2] + G[i_1-1][i_3][i_0][i_2+1] + E[i_2][i_3][i_0][i_0] * H[i_2][i_3+i_1][i_0][i_0] - H[i_3][i_2+i_0][i_1][i_0] + 6;
                }
            }
            for (int i_4 = 0; i_4 < min(PB_M, -i_0+PB_N); i_4++) {
                for (int i_5 = 0; i_5 < i_1; i_5++) {
                    B[i_1+i_0][i_5][i_1][i_5] = G[i_4+1][i_4+i_0][i_1][i_5] + E[i_4][i_5][i_0-1][i_1] - G[i_1][i_5][i_4][1] - B[i_1+i_0-1][i_5][i_1-1][i_5] - B[i_1+i_0-1][i_5][i_1][i_5] - 2;
                }
            }
        }
    }
        ...
        for (int i_7 = 1; i_7 < PB_M; i_7++) {
            for (int i_8 = 0; i_8 < -i_7+PB_M; i_8++) {
                for (int i_9 = 0; i_9 < PB_Q; i_9++) {
                    B[i_8+i_7][i_9][i_7-1][i_9] = H[i_8][i_9][i_6][i_7] - G[i_8][i_6][i_9][i_7] * 4;
                }
            }
        }
    }
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4312351215_02(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H)));
