...
void kernel_2226112325_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-4; i_0++) {
        A[i_0+2] = C[i_0+2] - A[i_0+4] * A[i_0] * A[i_0+3] - 3;
        A[i_0+3] = 5;
    }
#pragma endscop
...
kernel_2226112325_06(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
