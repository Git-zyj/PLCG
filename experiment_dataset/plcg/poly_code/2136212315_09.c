...
void kernel_2136212315_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P; i_0++) {
        for (int i_1 = max(3, i_0); i_1 < min(-i_0+PB_M, PB_P); i_1++) {
            A[i_1-2] = B[i_1+i_0][1] - A[i_1-3] * A[i_1-1] - A[i_0-1] - 6;
        }
    }
#pragma endscop
...
kernel_2136212315_09(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B));
