        ...
        for (int i_1 = i_0; i_1 < PB_Q; i_1++) {
            for (int i_2 = 0; i_2 < PB_P; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_M-2; i_3++) {
                    A[i_3+i_0+1][i_2][i_1][i_3] = D[i_3][i_1][i_0+1][i_2] - A[i_3+i_0+2][i_2][i_1-1][i_3+1] + 4;
                }
            }
        }
        B[i_0-1] = E[i_0] - 4;
        ...
        for (int i_5 = i_4; i_5 < -i_4+PB_M-2; i_5++) {
            for (int i_6 = 1; i_6 < PB_P; i_6++) {
                for (int i_7 = i_6; i_7 < PB_P; i_7++) {
                    A[i_5+i_4+2][i_7][i_6-1][i_5] = F[i_6][i_7][i_4][0] * 3;
                }
            }
        }
    }
...
kernel_4336211115_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
