...
void kernel_4216312211_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
        ...
        for (int i_1 = 2; i_1 < PB_M+2; i_1++) {
            for (int i_2 = 0; i_2 < i_1; i_2++) {
                for (int i_3 = 0; i_3 < PB_M; i_3++) {
                    A[i_1-2][i_3][i_2][i_0+2] = A[i_1-2][i_3][i_2][i_0+3] + 5;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-2; i_4++) {
        for (int i_5 = 0; i_5 < i_4; i_5++) {
            B[i_4+1][i_5] = C[0] * B[i_5+1][i_4-1] + B[i_4+2][i_5] + 5;
        }
    }
#pragma endscop
...
kernel_4216312211_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
