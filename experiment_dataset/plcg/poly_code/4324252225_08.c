...
void kernel_4324252225_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
        ...
        for (int i_1 = i_0; i_1 < PB_N; i_1++) {
            for (int i_2 = 1; i_2 < PB_N; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_N+1; i_3++) {
                    A[i_1][i_3+i_0-1][i_2-1][i_1] = D[i_1][i_0-2][i_2][i_3] * A[i_1-2][i_3+i_0-1][i_2-1][i_1-2] - A[i_1][i_3+i_0-3][i_2][i_1] - A[i_1-2][i_3+i_0-3][i_2-1][i_1-2] - 6;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < -i_4+PB_Q-2; i_5++) {
            for (int i_6 = 1; i_6 < PB_P-2; i_6++) {
                for (int i_7 = 1; i_7 < PB_M-1; i_7++) {
                    B[i_5][i_6][i_6-1][i_7] = E[i_6+i_5][i_4+2][i_7-1][i_6+2] - D[i_5][i_4+2][i_7][i_5] + F[i_4+1][i_5-1][i_7][i_6][0] * D[i_7][i_6-1][i_5+i_4+2][0] - G[i_7+1][i_5][i_6] * 5;
                }
            }
        }
        for (int i_8 = 2; i_8 < -i_4+PB_M; i_8++) {
            for (int i_9 = 2; i_9 < -i_4+PB_Q; i_9++) {
                for (int j_0 = 2; j_0 < i_8; j_0++) {
                    B[j_0][i_4][i_4-1][i_9] = D[i_9][i_4-2][i_8][j_0] * D[i_9][i_9-1][j_0][i_8] - E[j_0+i_8][i_9][i_4-1][i_9-2] - D[i_4][i_8][j_0][i_9+i_4] - E[j_0+1][i_8][i_9][i_4-2] - D[i_8+i_4][j_0-2][i_9][i_8] + G[i_9][j_0+2][i_8-2] - 4;
                }
            }
        }
    }
...
kernel_4324252225_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
