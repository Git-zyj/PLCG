...
void kernel_4222132213_05(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 2; i_1 < PB_P-2; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_L; i_2++) {
                A[i_2][i_1+1] = C[i_0][i_2+i_1] + D[i_1-2][i_0+2][i_2+1] - A[i_2-1][i_0+1] * A[i_0][i_1+2] - 2;
            }
        }
    }
        ...
        for (int i_4 = max(2, i_3); i_4 < PB_L; i_4++) {
            for (int i_5 = 0; i_5 < PB_L-1; i_5++) {
                for (int i_6 = 0; i_6 < min(-i_5+PB_L, PB_L-2); i_6++) {
                    A[i_6][i_5+1] = E[i_3][i_5+1][i_4][0] + E[i_6][i_3-1][i_5][i_4-2] + E[i_3][i_6+i_5][i_4-2][i_6+2] * 4;
                }
            }
        }
    }
...
kernel_4222132213_05(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
