...
void kernel_3314311325_05(int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        ...
        for (int i_2 = 0; i_2 < PB_L; i_2++) {
            C[i_2+2][i_0] = D[i_0][i_2][i_0-1] + E[i_2][i_0+1] + 6;
            C[i_2][i_0] = F[i_0-1][0] + C[i_2][i_0-2] * C[i_2+1][i_0] + C[i_2][i_0-1] + 5;
        }
    }
#pragma endscop
...
kernel_3314311325_05(xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
