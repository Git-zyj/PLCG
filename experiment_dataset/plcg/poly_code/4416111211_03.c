...
void kernel_4416111211_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
        ...
        for (int i_1 = 0; i_1 < PB_P-1; i_1++) {
            for (int i_2 = 0; i_2 < i_1; i_2++) {
                for (int i_3 = 0; i_3 < i_2; i_3++) {
                    A[i_1][i_2+1][i_1+1] = A[i_1][i_3][i_1+1] * 2;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_M+1; i_4++) {
            B[i_4-1][i_0] = E[i_0][i_0] - 6;
        }
    }
    for (int i_5 = 1; i_5 < PB_L-1; i_5++) {
        for (int i_6 = 0; i_6 < i_5; i_6++) {
            C[i_6+1][i_5] = C[i_6+1][i_5+1] - C[i_6+2][i_5] - C[i_6+1][i_5-1] + 6;
        }
        for (int i_7 = 0; i_7 < PB_M-2; i_7++) {
            D[i_7+1] = D[i_7+2] + D[i_7] - 3;
        }
    }
#pragma endscop
...
kernel_4416111211_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
