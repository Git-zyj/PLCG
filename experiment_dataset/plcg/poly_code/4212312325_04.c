...
void kernel_4212312325_04(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 2; i_1 < min(-i_0+PB_L, i_0); i_1++) {
            for (int i_2 = 2; i_2 < PB_L+2; i_2++) {
                for (int i_3 = 0; i_3 < PB_M-1; i_3++) {
                    B[i_3+1][i_1-2][i_2-2] = C[i_3][i_2][i_1+i_0] - 5;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 2; i_5 < i_4; i_5++) {
            for (int i_6 = 2; i_6 < i_5; i_6++) {
                B[i_6][i_5-2][i_4] = B[i_6+2][i_5-2][i_4+2] * B[i_6-1][i_5-2][i_4] - B[i_6-2][i_5-2][i_4] * 1;
            }
        }
    }
#pragma endscop
...
kernel_4212312325_04(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
