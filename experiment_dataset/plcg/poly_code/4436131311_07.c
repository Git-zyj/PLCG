        ...
        for (int i_1 = i_0; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_L-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_M; i_3++) {
                    A[i_3][i_2][i_0-1][i_1] = E[i_3-1][i_2-1][i_0-1][i_1+1] - F[i_1][i_0][i_2-1] * E[i_2][i_1][i_3][0] + E[i_2+i_1+1][0][i_0+1][i_3-1] * 6;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M-1; i_4++) {
        for (int i_5 = 1; i_5 < PB_M-1; i_5++) {
            for (int i_6 = 0; i_6 < PB_M-1; i_6++) {
                B[i_6+1][i_4] = F[i_5-1][i_4][i_5] - G[i_6][i_5] * B[i_4+1][i_6+1] * B[i_6+2][i_5] + B[i_6][i_5+1] - B[i_6+1][i_5+1] - D[i_4+1][i_5] * 4;
            }
        }
    }
    for (int i_7 = 1; i_7 < PB_L-1; i_7++) {
        for (int i_8 = i_7; i_8 < PB_M-1; i_8++) {
            C[i_8][i_7] = G[i_8][i_7] - G[i_8-1][i_7] * C[i_7][i_8-1] * C[i_8][i_7+1] - D[i_8+1][i_7+1] + 3;
        }
        for (int i_9 = 1; i_9 < min(-i_7+PB_M, i_7); i_9++) {
            D[i_9+1][i_7] = G[i_9][i_7] + G[i_9+i_7][i_7] * H[i_9+i_7] * C[i_9-1][i_7] + C[i_9][i_7] - C[i_7][i_9] + D[i_9+1][i_7-1] - 4;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4436131311_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H)));
