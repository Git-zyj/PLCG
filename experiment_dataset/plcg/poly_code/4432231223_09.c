        ...
        for (int i_2 = 1; i_2 < -i_1+PB_L-1; i_2++) {
            for (int i_3 = 1; i_3 < -i_2+PB_L; i_3++) {
                for (int i_4 = 1; i_4 < PB_L; i_4++) {
                    C[i_2+i_1][i_4][i_3][i_1-1] = G[i_3][i_4][i_1][i_3+i_2-1][i_2] - H[i_1][i_4-1][i_3+i_2][i_1-1] + H[i_4][i_3-1][i_2+1][i_1] * H[i_4][i_2][i_2+i_1+1][i_3] * I[i_4][i_3-1][i_2+i_1+1] * I[i_4-1][i_3][i_3] + 4;
                }
            }
        }
    }
    for (int i_5 = 0; i_5 < PB_L-4; i_5++) {
        for (int i_6 = 1; i_6 < -i_5+PB_L-4; i_6++) {
            D[i_5][i_6+i_5] = J[i_6][i_5] * K[i_5][i_6-1] - D[i_5+2][i_6+i_5+4] * 6;
        }
    }
#pragma endscop
...
init_array(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4432231223_09(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K)));
