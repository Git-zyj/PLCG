...
void kernel_2112212215_03(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_N-2 - 1; i_0 >= 1; i_0--) {
        for (int i_1 = max(3, i_0); i_1 < -i_0+PB_N-2; i_1++) {
            A[i_0][i_1-2] = B[i_1+i_0+2][2][i_0] - A[i_1][i_0-1] - A[i_0][i_1-3] * 1;
        }
    }
#pragma endscop
...
kernel_2112212215_03(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B));
