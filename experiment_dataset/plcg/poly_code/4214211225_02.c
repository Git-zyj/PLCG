...
void kernel_4214211225_02(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        for (int i_1 = 1; i_1 < PB_Q; i_1++) {
            for (int i_2 = 0; i_2 < PB_L; i_2++) {
                B[i_2][i_0+1][i_1][i_2] = C[i_2][i_0-1][i_0] * D[i_0][i_2][i_1-1] + 4;
            }
        }
    }
        ...
        for (int i_4 = 0; i_4 < i_3; i_4++) {
            for (int i_5 = 0; i_5 < i_3; i_5++) {
                for (int i_6 = 0; i_6 < PB_L-2; i_6++) {
                    B[i_3][i_4][i_6][i_3] = B[i_6][i_3][i_5+1][i_6] + B[i_6+2][i_4][i_3+1][i_6+2] * 1;
                }
            }
        }
    }
...
kernel_4214211225_02(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
