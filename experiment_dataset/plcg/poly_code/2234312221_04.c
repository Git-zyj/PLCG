...
void kernel_2234312221_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        A[i_0] = 5;
        A[i_0] = C[i_0] - C[i_0+1] * A[i_0-2] + A[i_0] - 3;
    }
#pragma endscop
...
kernel_2234312221_04(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
