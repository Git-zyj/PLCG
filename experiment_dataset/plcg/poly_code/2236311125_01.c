...
void kernel_2236311125_01(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
kernel_2236311125_01(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
