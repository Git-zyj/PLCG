...
void kernel_2212252323_01(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-3; i_0++) {
        for (int i_1 = 0; i_1 < PB_M-1; i_1++) {
            B[i_0+1] = C[i_1][i_0-2] + C[i_1][i_0] + C[i_1][i_0] * C[i_1][i_0] - D[i_1+1][i_0] - C[i_1][i_0+1] + B[i_0+3] - 3;
        }
        for (int i_2 = 2; i_2 < PB_M-1; i_2++) {
            B[i_2+1] = E[i_0][i_2][i_0] - E[i_2+1][i_2][i_0] * C[i_2-1][i_0-1] + C[i_2-2][i_0+1] + B[i_2-1] + B[i_2] * 5;
        }
    }
#pragma endscop
...
kernel_2212252323_01(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
