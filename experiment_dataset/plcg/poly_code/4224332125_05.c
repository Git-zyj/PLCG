        ...
        for (int i_1 = 2; i_1 < PB_P; i_1++) {
            for (int i_2 = 1; i_2 < PB_P; i_2++) {
                for (int i_3 = 0; i_3 < PB_L; i_3++) {
                    A[i_0+1][i_3][i_1][i_2] = C[i_1-2][i_2][i_0][i_3] - D[i_2][i_3][i_1][i_0] + E[i_3+1][i_0-1][i_2][i_1][i_3] * A[i_0+2][i_3][i_1][i_2-1] + 4;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M-3; i_4++) {
        B[i_4+1] = F[i_4] - G[i_4] - B[i_4+3] - 2;
    }
#pragma endscop
...
kernel_4224332125_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
