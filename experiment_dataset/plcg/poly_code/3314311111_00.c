...
void kernel_3314311111_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_0 = 1; i_0 < PB_N-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_M+1; i_1++) {
            ...
            for (int i_3 = i_1; i_3 < PB_N-1; i_3++) {
                B[i_0][i_1-1][i_1-1] = D[i_0+1][i_3+1][i_3] * 6;
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_N; i_4++) {
        for (int i_5 = max(i_4, 1); i_5 < PB_M-1; i_5++) {
            C[i_5][i_5+1] = C[i_5+1][i_5+2] + C[i_5-1][i_5] + 5;
        }
    }
#pragma endscop
...
kernel_3314311111_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
