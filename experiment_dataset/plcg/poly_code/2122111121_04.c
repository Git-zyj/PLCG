...
void kernel_2122111121_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
...
kernel_2122111121_04(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
