...
void kernel_4216211111_00(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = i_0; i_1 < PB_L-1; i_1++) {
            for (int i_2 = i_1; i_2 < PB_N; i_2++) {
                for (int i_3 = 0; i_3 < PB_N; i_3++) {
                    B[i_3][i_1+1][i_0-2][i_3] = C[i_2][i_1-1][i_0] - 6;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < PB_L; i_5++) {
            for (int i_6 = 0; i_6 < PB_L-1; i_6++) {
                for (int i_7 = 0; i_7 < min(i_6, PB_M); i_7++) {
                    B[i_4][i_7+1][i_5-1][i_4] = D[i_7][i_6+1][i_5] + B[i_4][i_7][i_5][i_4] * 3;
                }
            }
        }
    }
...
kernel_4216211111_00(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
