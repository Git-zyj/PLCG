...
void kernel_4436232321_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            for (int i_2 = 2; i_2 < min(-i_0+PB_L, -i_1+PB_M-1); i_2++) {
                for (int i_3 = 2; i_3 < -i_2+PB_M-2; i_3++) {
                    A[i_0][i_2][i_0-2][i_3-2] = E[i_3+i_2+2][i_1][i_0][i_2] + F[i_2+i_1+1][i_0+1][i_2+i_0][i_3+2] - F[i_2-2][i_3][i_0][i_1] + A[i_0+1][i_1][i_0-1][i_3-2] + 3;
                }
            }
            B[i_1] = G[i_0] * H[i_0][i_1] * H[i_1][i_0] * B[i_1-2] + B[i_1+1] - 2;
        }
    }
    for (int i_4 = 1; i_4 < PB_L; i_4++) {
        for (int i_5 = 2; i_5 < min(min(i_4, PB_Q-2), -i_4+PB_L); i_5++) {
            for (int i_6 = 2; i_6 < PB_P-2; i_6++) {
                for (int i_7 = 0; i_7 < PB_Q-2; i_7++) {
                    C[i_4][i_5][i_6][i_7+2] = E[i_5+2][i_6+1][i_4][i_7+1] - I[i_6][i_7][i_5] * F[i_6][i_7+1][i_5+i_4][0] + C[i_4-1][i_5+1][i_7][i_6+2] + C[i_5-2][i_6][i_4][i_7+2] * C[i_4][i_5][i_6+2][i_7+2] * C[i_4][i_5+1][i_6-2][i_7+2] - C[i_4][i_7][i_6+1][i_5+2] * 2;
                }
            }
        }
    }
    for (int i_8 = 2; i_8 < PB_L; i_8++) {
        for (int i_9 = 2; i_9 < PB_P; i_9++) {
            for (int j_0 = max(i_8, 3); j_0 < PB_P; j_0++) {
                for (int j_1 = i_8; j_1 < PB_P-2; j_1++) {
                    D[i_8][j_0][j_1-2][i_9] = D[j_1-2][i_9][i_8-2][j_0] + D[i_8][j_1][j_0-3][i_9] * D[i_8][j_1+2][i_9-2][j_0] + 6;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4436232321_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
