...
void kernel_2224212211_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_L+3; i_0++) {
        for (int i_1 = 2; i_1 < min(PB_L+2, -i_0+PB_M-2); i_1++) {
            A[i_1-2] = C[i_1+i_0+2] + A[i_0-3] - 6;
        }
    }
...
kernel_2224212211_04(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
