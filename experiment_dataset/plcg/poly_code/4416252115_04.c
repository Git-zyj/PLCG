...
void kernel_4416252115_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,int wg,DATA_TYPE POLYBENCH_5D(G,xG,yG,zG,vG,wG,xg,yg,zg,vg,wg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_Q-2; i_0++) {
        A[i_0] = E[i_0] - E[i_0-1] + A[i_0-1] * 2;
        for (int i_1 = 0; i_1 < -i_0+PB_Q; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_Q; i_2++) {
                for (int i_3 = 2; i_3 < PB_M; i_3++) {
                    D[i_3][i_1][i_2+2][i_0] = F[i_0+2][i_3][i_1][i_2+1] + G[i_0][i_1][i_3][i_1+i_0][i_2] - H[i_2][i_3][i_0+2][i_1] * F[i_1][i_3][i_2+i_0][i_0] * I[i_1][i_3-2][i_2] - J[i_2][i_0-2][i_1] * I[i_3][i_3][i_1+i_0] * 1;
                }
            }
        }
    }
        ...
        for (int i_5 = i_4; i_5 < -i_4+PB_L; i_5++) {
            for (int i_6 = 0; i_6 < PB_Q-1; i_6++) {
                for (int i_7 = i_4; i_7 < PB_P-2; i_7++) {
                    D[i_4-1][i_5][i_7+2][i_6+1] = H[i_4][i_7][i_5][i_6] - F[i_5][i_4][i_7][i_6] + H[i_5+i_4][i_7][i_6][i_4+2] + H[i_6][i_7-2][i_4][i_5] + 3;
                }
            }
        }
        for (int i_8 = i_4; i_8 < PB_M-1; i_8++) {
            for (int i_9 = 1; i_9 < -i_8+PB_L-1; i_9++) {
                for (int j_0 = i_8; j_0 < min(PB_Q, -i_8+PB_L+2); j_0++) {
                    D[i_4][i_8][i_9+2][j_0] = H[i_9+i_8-2][i_4-2][i_4+1][j_0] * I[i_9][i_8][j_0] + J[i_4-2][j_0+i_8-2][j_0] + J[j_0][i_9+i_8+1][i_4] - H[i_8-2][j_0][i_9][i_4-1] - F[i_8+1][i_9-1][i_4-2][2] - D[i_4][i_8][i_9+1][j_0] + 3;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4416252115_04(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J)));
