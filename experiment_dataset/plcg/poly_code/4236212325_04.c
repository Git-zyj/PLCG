...
void kernel_4236212325_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 2; i_1 < min(i_0, PB_M-2); i_1++) {
            for (int i_2 = 2; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 0; i_3 < i_1; i_3++) {
                    A[i_2][i_1][i_3] = A[i_1+2][i_2+1][i_3+1] - A[i_2-2][i_1-2][i_3] - A[i_2][i_1-2][i_3] - 5;
                }
            }
        }
    }
        ...
        for (int i_5 = i_4; i_5 < PB_P; i_5++) {
            for (int i_6 = i_4; i_6 < PB_M-2; i_6++) {
                for (int i_7 = 0; i_7 < PB_P; i_7++) {
                    A[i_6+2][i_4][i_7] = C[i_6][i_7][i_4+1] * 2;
                }
            }
        }
    }
...
kernel_4236212325_04(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C));
