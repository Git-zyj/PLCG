...
void kernel_2334111325_03(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_2 = 3; i_2 < PB_M-1; i_2++) {
        C[i_2-1] = C[i_2-3] - C[i_2+1] + C[i_2] - 3;
    }
#pragma endscop
...
kernel_2334111325_03(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
