...
void kernel_4424331325_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
...
#pragma scop
        ...
        for (int i_1 = i_0; i_1 < -i_0+PB_Q; i_1++) {
            for (int i_2 = 2; i_2 < -i_0+PB_L; i_2++) {
                for (int i_3 = 0; i_3 < -i_2+PB_Q; i_3++) {
                    A[i_3][i_2][i_1-1][i_0-1] = E[i_3][i_3+1][i_1+i_0][i_2+1] * E[i_2][i_0+1][i_3][i_1-1] + E[i_2][i_1][i_3+i_2][i_1] * E[i_2][i_0][i_1][i_3] + F[i_2+i_0][i_1+1][i_3][i_2] + A[i_3][i_2-1][i_1-1][i_0-1] * A[i_1][i_3][i_2-2][i_0-2] * 1;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
            B[i_5] = G[i_4][i_5] - H[i_4+1][i_5+1] + B[i_5+1] + 1;
        }
        B[i_4] = I[i_4] + J[i_4] * B[i_4] - 4;
    }
    for (int i_6 = 2; i_6 < PB_N+1; i_6++) {
        for (int i_7 = 1; i_7 < PB_L-1; i_7++) {
            for (int i_8 = max(2, i_7); i_8 < PB_L; i_8++) {
                D[i_8][i_7][i_8-1] = D[i_6-1][i_8][i_6-2] + D[i_8+1][i_7+1][i_8] * D[i_8+1][i_7][i_8] * D[i_8][i_7-1][i_8-1] + D[i_8-1][i_7][i_8-2] + 6;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4424331325_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J)));
