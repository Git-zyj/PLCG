...
void kernel_3324112221_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
    ...
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        for (int i_1 = i_0; i_1 < PB_M+1; i_1++) {
            ...
            for (int i_3 = 2; i_3 < PB_L; i_3++) {
                B[i_0][i_3][i_0] = B[i_1-2][i_3-2][i_1-2] - B[i_0+1][i_3][i_0+1] + B[i_0][i_3-2][i_0] - B[i_0][i_1+2][i_0] - B[i_0-2][i_3][i_0-2] * 4;
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M; i_4++) {
        for (int i_5 = i_4; i_5 < PB_M; i_5++) {
            for (int i_6 = 1; i_6 < -i_4+PB_M; i_6++) {
                C[i_4][i_4][i_6] = D[i_6+i_4][i_4] + D[i_5][i_4+1] * C[i_4][i_4][i_6-1] + 3;
            }
        }
    }
#pragma endscop
...
kernel_3324112221_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
