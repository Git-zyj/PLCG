        ...
        for (int i_1 = 2; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_1+PB_M+1, -i_0+PB_L-1); i_2++) {
                for (int i_3 = 1; i_3 < min(-i_0+PB_Q-1, i_1); i_3++) {
                    A[i_1][i_3+i_2][i_0+1][i_3] = D[i_3-1][i_0+1][0][i_2] + D[i_2+i_1-1][i_3-1][i_2][i_0-1] + E[i_3][i_1-1][i_2+1] - D[i_3-1][i_1][i_3+i_0+1][i_2] * D[i_2+1][i_0][i_3][i_1+1] - A[i_2][i_3+i_0][i_1+2][i_0] * A[i_3][i_2+i_0+1][i_1+1][i_0-1] + 3;
                }
            }
            B[i_1] = F[i_1+1][i_0] + G[i_1] + F[i_1][i_0] - F[i_1][i_0] * F[1][i_0] * F[i_1-1][i_0] * B[i_1-2] - B[i_1+2] * B[i_1-1] + 6;
        }
    }
        ...
        for (int i_5 = 1; i_5 < PB_Q-2; i_5++) {
            for (int i_6 = 0; i_6 < PB_L-1; i_6++) {
                for (int i_7 = 1; i_7 < min(i_4, PB_L-1); i_7++) {
                    C[i_4][i_6+1][i_4][i_5+1] = E[i_6][i_7+1][i_4] * D[i_6][i_7][i_4-1][i_5+1] - D[i_5+1][i_7][i_5][i_6] + C[i_7][i_6][i_7][i_5+1] - C[i_4-2][i_6+1][i_4-2][i_5-1] + C[i_4-2][i_6+1][i_4-2][i_5+2] - C[i_4][i_6+1][i_4][i_7-1] * 1;
                }
            }
        }
    }
...
kernel_4324151321_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
