...
void kernel_3216312213_02(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_M-2 - 1; i_0 >= 1; i_0--) {
        B[i_0+2] = 2;
        B[i_0+1] = C[i_0-1] - B[i_0+2] + B[i_0] + 4;
    }
#pragma endscop
...
kernel_3216312213_02(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
