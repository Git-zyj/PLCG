...
void kernel_4334151325_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
...
#pragma scop
    ...
    for (int i_1 = 3; i_1 < PB_P; i_1++) {
        for (int i_2 = 3; i_2 < PB_P-2; i_2++) {
            B[i_1-1][i_1] = E[i_2][i_1] + E[i_2][i_1-1] - E[i_1+1][0] - E[i_1][i_2] * E[i_1][i_2+1] - D[i_2-1] + A[i_2] * B[i_2+1][i_2+2] * B[i_2-3][i_2-2] * B[i_1-3][i_1-2] * 1;
        }
    }
    for (int i_3 = 1; i_3 < PB_L; i_3++) {
        for (int i_4 = i_3; i_4 < -i_3+PB_L; i_4++) {
            A[i_4] = E[i_4][i_3] + E[i_4][i_3] * D[i_3+1] + E[i_3-1][i_4+1] - E[i_4][i_3-1] * E[i_4+1][i_4+i_3] + 5;
        }
    }
#pragma endscop
...
kernel_4334151325_06(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
