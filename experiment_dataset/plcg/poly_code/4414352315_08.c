...
void kernel_4414352315_08(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,DATA_TYPE POLYBENCH_1D(M,xM,xm)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_Q-2; i_0++) {
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_L; i_2++) {
                B[i_1][i_0][i_2-1] = E[i_0-1][i_1][i_2] * F[i_2][i_0][i_0+1] - E[i_0-2][i_2+i_1][0] - 2;
            }
        }
        for (int i_3 = i_0; i_3 < PB_M-2; i_3++) {
            for (int i_4 = 1; i_4 < -i_0+PB_Q-2; i_4++) {
                for (int i_5 = 0; i_5 < min(-i_0+PB_M, PB_Q-2); i_5++) {
                    B[i_3][i_4][i_5] = G[i_5+2][i_0][i_3-1][i_4+1] + H[i_4][i_5+1][i_0][i_3] - I[i_5][i_3][i_4+i_0+2][i_5+2] - I[i_5+i_0][i_4][i_3][i_5] + H[i_5][i_4][i_0][i_3-2] - F[i_5][i_3+2][0] + F[i_5][i_0][i_4] * B[i_5][i_4-1][i_3-1] - B[i_3-1][i_5][i_4] - B[i_3-1][i_4+1][i_5] - B[i_3-1][i_4][i_5] + B[i_3][i_4+1][i_5+1] + 6;
                }
            }
        }
    }
    for (int i_6 = 2; i_6 < PB_L; i_6++) {
        for (int i_7 = 1; i_7 < -i_6+PB_L; i_7++) {
            for (int i_8 = 0; i_8 < PB_L-1; i_8++) {
                B[i_7][i_6][i_8+1] = E[i_8][i_7+1][2] * J[i_8][i_6-2] * E[i_7][i_8][i_6] + F[i_7-1][i_6+1][i_7+i_6] + K[i_6][i_8][i_7] * 3;
            }
        }
        D[i_6] = L[i_6] * L[i_6] - M[i_6] + 5;
    }
#pragma endscop
...
init_array(xb,yb,zb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,POLYBENCH_ARRAY(M), INIT_SEED);
kernel_4414352315_08(xb,yb,zb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,POLYBENCH_ARRAY(M));
polybench_prevent_dce(print_array(xb,yb,zb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,POLYBENCH_ARRAY(M)));
