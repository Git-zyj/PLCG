...
void kernel_4134112323_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < PB_N; i_1++) {
            A[2] = B[i_0] * A[2] * A[2] + A[2] * 1;
        }
    }
#pragma endscop
...
kernel_4134112323_01(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
