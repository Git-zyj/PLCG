        ...
        for (int i_2 = i_1; i_2 < PB_P-2; i_2++) {
            for (int i_3 = 0; i_3 < min(-i_2+PB_P-1, PB_Q-2); i_3++) {
                for (int i_4 = 0; i_4 < -i_1+PB_L-1; i_4++) {
                    B[i_1-1][i_2+2][i_4][0] = G[i_3][i_4+i_1+1][i_2][0] - H[i_4][i_1][i_2+2][i_3+i_2+1] * G[i_4][i_1+2][i_2+1][i_3+2] - H[i_3][i_1-1][i_2][i_4] + I[i_4][i_2][i_3] + B[i_2-1][i_4+2][i_1-1][0] + 1;
                }
            }
        }
    }
    for (int i_5 = 1; i_5 < PB_N-1; i_5++) {
        for (int i_6 = 2; i_6 < min(PB_M-2, -i_5+PB_N-1); i_6++) {
            C[i_6] = J[i_6][i_5] * K[i_6+i_5+1][i_5-1] * J[i_5][0] + J[i_6-2][i_5] + L[i_5-1][0] - J[i_5][i_6] + A[i_6+2] * C[i_5-1] * 4;
        }
    }
#pragma endscop
...
kernel_4324352211_02(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L));
