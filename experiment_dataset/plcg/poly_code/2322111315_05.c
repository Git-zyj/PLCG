...
void kernel_2322111315_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        B[i_0+1] = B[i_0] * B[i_0+1] + B[i_0-1] + 6;
        B[i_0] = 3;
    }
...
kernel_2322111315_05(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
