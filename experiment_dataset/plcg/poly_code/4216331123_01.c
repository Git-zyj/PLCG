...
void kernel_4216331123_01(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_L; i_1++) {
            for (int i_2 = i_0; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
                    B[i_2][i_3][i_2+1][i_1+1] = C[i_2+1][i_3-1][i_1+i_0][0] - C[i_1-1][i_3+1][i_0][i_2] + D[i_2][i_1][i_0-1][i_0] - E[i_1][i_2][i_0][i_3] * B[i_2][i_3-1][i_2+1][i_1+1] - 4;
                    B[i_2][i_3][i_2+1][i_1+1] = F[i_3][i_2][i_1-1] + 4;
                }
            }
        }
    }
...
kernel_4216331123_01(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
