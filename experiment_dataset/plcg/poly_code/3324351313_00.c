...
void kernel_3324351313_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        A[i_0-1] = D[i_0-1] + D[i_0] + E[i_0-1] * A[i_0-2] + 5;
    }
    for (int i_1 = 1; i_1 < PB_Q-1; i_1++) {
        for (int i_2 = 0; i_2 < min(-i_1+PB_P, i_1); i_2++) {
            for (int i_3 = 1; i_3 < min(-i_1+PB_M, -i_2+PB_M); i_3++) {
                C[i_1-1][i_3][i_2][i_2] = F[i_2][i_3] - G[i_3+i_1][i_2][i_2+1] - G[i_3][i_1+1][i_2] + G[i_3+i_2][i_1+1][i_1] + H[i_2][i_3][i_1+1] + H[i_3-1][i_2+i_1][i_1] - F[i_3][i_3] + 4;
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_Q-1; i_4++) {
        for (int i_5 = 1; i_5 < PB_M-1; i_5++) {
            for (int i_6 = 1; i_6 < PB_M-1; i_6++) {
                C[i_5][i_4][i_6][i_6] = H[i_6][i_5+1][i_4+1] - H[i_5+1][i_6][i_4] * H[i_6-1][i_5+1][i_4-1] * C[i_4+1][i_6][i_5][i_5] - C[i_6+1][i_4+1][i_5-1][i_5-1] * C[i_6+1][i_4][i_5][i_5] - C[i_5][i_6+1][i_4][i_4] - C[i_5+1][i_4][i_6][i_6] - 6;
            }
        }
    }
#pragma endscop
...
kernel_3324351313_00(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
