...
void kernel_4434251325_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl)){
        ...
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 1; i_2 < min(PB_L-2, -i_1+PB_N+1); i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_M-1; i_3++) {
                    A[i_0+1][i_2][i_0+1][i_1] = E[i_1-1][i_0-1][i_3][0] + F[i_3+1][i_1][i_3][i_2] + E[i_0+1][i_2-1][i_1-1][i_3] - F[i_3][i_2][i_0][i_1] + E[i_2+i_1-1][i_1][i_3+i_0+1][i_0] * E[i_2][1][i_1][i_0] + A[i_0-1][i_2+2][i_0-1][i_1] + A[i_1+1][i_2][i_1+1][i_3+2] * 5;
                }
            }
        }
        for (int i_4 = 0; i_4 < PB_L-2; i_4++) {
            for (int i_5 = 0; i_5 < i_0; i_5++) {
                for (int i_6 = 0; i_6 < PB_M; i_6++) {
                    B[i_0][i_4][i_5][i_6] = E[i_4][i_5+1][i_0][0] + G[i_6][i_4][i_5] * B[i_0][i_4+2][i_5][i_6] * B[i_5][i_4][i_6][i_0+1] - 4;
                }
            }
        }
    }
    for (int i_7 = 1; i_7 < PB_L-2; i_7++) {
        for (int i_8 = 2; i_8 < PB_M-1; i_8++) {
            for (int i_9 = 1; i_9 < PB_M-1; i_9++) {
                for (int j_0 = 0; j_0 < min(-i_8+PB_M-1, -i_9+PB_M-1); j_0++) {
                    C[j_0+i_8+1][i_9-1][i_7][j_0] = G[i_7][j_0+i_9][i_8] - H[j_0][i_9][i_7][i_8][i_9] - E[i_8-1][i_9+1][j_0][i_7] * F[j_0+i_9+1][i_7][i_9-1][i_8] * I[j_0+1][i_9][i_8+1] * F[i_8][i_7-1][j_0][i_8] + C[j_0+i_9+1][i_8-2][i_7+2][i_9] - 6;
                }
            }
        }
    }
    for (int j_1 = 2; j_1 < PB_M-2; j_1++) {
        D[j_1] = J[j_1] * K[j_1+1] + L[j_1][j_1+1] + J[j_1] + K[j_1] + D[j_1-1] * D[j_1+2] + D[j_1-2] + D[j_1+1] - 5;
    }
#pragma endscop
...
kernel_4434251325_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L));
