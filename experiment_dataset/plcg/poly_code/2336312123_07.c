...
void kernel_2336312123_07(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-2; i_0++) {
        for (int i_1 = i_0; i_1 < PB_M-1; i_1++) {
            B[i_0+2] = D[i_1+1] + B[i_1+1] - 5;
        }
        B[i_0+2] = D[1] + D[i_0] - 5;
    }
...
kernel_2336312123_07(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
