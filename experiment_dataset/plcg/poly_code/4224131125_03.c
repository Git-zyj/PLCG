        ...
        for (int i_4 = 1; i_4 < min(PB_M-1, i_3); i_4++) {
            for (int i_5 = 1; i_5 < min(-i_3+PB_M, -i_4+PB_P); i_5++) {
                for (int i_6 = 1; i_6 < -i_3+PB_L-1; i_6++) {
                    B[i_6][i_4][i_5] = D[i_5-1][i_3][i_6+i_3+1][i_4-1] + D[i_3-1][i_5][i_6][i_5+i_4] + E[i_4][i_3][i_5][i_6][i_3] - D[i_6-1][i_5+i_3][i_4][i_4] - A[i_6-1][i_3][i_4-1] - B[i_6][i_4+1][i_5+1] * 5;
                }
            }
        }
    }
...
kernel_4224131125_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E));
