...
void kernel_2432132315_09(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_N-2; i_1++) {
        C[i_1-1] = E[i_1] + C[i_1+1] - C[i_1-1] - 5;
        C[i_1] = E[i_1+2] * E[i_1] + E[i_1] * C[i_1-1] * 1;
    }
    for (int i_2 = 1; i_2 < PB_N; i_2++) {
        D[i_2] = E[i_2] + E[i_2] * E[i_2] + E[i_2] + D[i_2+1] * D[i_2-1] - 1;
    }
#pragma endscop
...
kernel_2432132315_09(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
