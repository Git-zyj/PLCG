...
void kernel_4422351115_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,int vj,int wj,DATA_TYPE POLYBENCH_5D(J,xJ,yJ,zJ,vJ,wJ,xj,yj,zj,vj,wj),int xk,int yk,int zk,int vk,DATA_TYPE POLYBENCH_4D(K,xK,yK,zK,vK,xk,yk,zk,vk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl),int xm,int ym,int zm,int vm,DATA_TYPE POLYBENCH_4D(M,xM,yM,zM,vM,xm,ym,zm,vm)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        for (int i_1 = 0; i_1 < -i_0+PB_L; i_1++) {
            for (int i_2 = 0; i_2 < i_1; i_2++) {
                A[i_2+i_0][i_1+1][i_1+i_0-1] = E[i_1][i_2+1][i_1] + A[i_2+i_0][i_1+2][i_1+i_0] * 5;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_L-1; i_3++) {
        for (int i_4 = i_3; i_4 < PB_L-1; i_4++) {
            B[i_3][i_4+1] = F[i_3][i_4][i_3] + G[i_4+1][i_3] * H[i_4][i_3+1] - B[i_3-1][i_4+1] + 2;
            for (int i_5 = 1; i_5 < min(-i_3+PB_L, -i_4+PB_L+1); i_5++) {
                for (int i_6 = 1; i_6 < min(-i_3+PB_L, -i_4+PB_M-1); i_6++) {
                    A[i_6+i_4+1][i_5+1][i_5+i_4-1] = F[i_6][i_5][i_4+1] * I[i_6+i_5][i_3][i_4][i_3] + J[i_5-1][i_4][i_3][i_3][0] - K[i_5+i_4][i_6-1][i_3-1][0] + K[i_5-1][i_6+i_3][i_4-1][i_4] - K[i_6][i_5+i_3][i_4][i_4-1] + I[i_4][i_3][i_5-1][i_6] - L[i_3][i_5][i_4-1] + I[i_4][i_5-1][i_6+1][i_3+1] - K[i_6+i_5-1][i_4][i_6][i_3-1] - K[i_6][i_5+i_4-1][i_3][i_3] - 6;
                }
            }
        }
        for (int i_7 = 1; i_7 < -i_3+PB_M; i_7++) {
            for (int i_8 = 1; i_8 < -i_7+PB_L+1; i_8++) {
                for (int i_9 = 0; i_9 < PB_L-1; i_9++) {
                    A[i_7+i_3][i_8+1][i_8+i_7-1] = I[i_9][i_7-1][i_3][i_8-1] - M[i_7-1][i_9+1][i_3][i_8+1] + M[i_9][i_7][i_3][i_8] + 5;
                }
            }
        }
    }
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,wj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,zm,vm,POLYBENCH_ARRAY(M), INIT_SEED);
kernel_4422351115_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,wj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,zm,vm,POLYBENCH_ARRAY(M));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,wj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,zm,vm,POLYBENCH_ARRAY(M)));
