...
void kernel_3334311121_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_5 = 3; i_5 < PB_P-1; i_5++) {
        for (int i_6 = 3; i_6 < PB_N; i_6++) {
            for (int i_7 = 0; i_7 < -i_6+PB_L; i_7++) {
                C[i_6][i_7][0] = D[i_6-1][i_5-1][i_7+1] + D[i_7+i_6][i_5+1][i_7] - B[i_6-3][i_7] + B[i_5-3][i_7] - 5;
            }
        }
    }
#pragma endscop
...
kernel_3334311121_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
