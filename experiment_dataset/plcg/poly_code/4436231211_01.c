...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_M; i_1++) {
        for (int i_2 = i_1; i_2 < PB_M; i_2++) {
            C[i_1+1][i_2] = F[i_1+1] - E[i_2] + G[i_2][i_1] - G[i_1][i_2] - 2;
        }
    }
    for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
        for (int i_4 = 0; i_4 < i_3; i_4++) {
            C[i_3][i_4] = H[i_4][i_3+1] + F[i_4+1] * C[i_4+1][i_3-1] + 2;
        }
        for (int i_5 = 1; i_5 < PB_L-2; i_5++) {
            for (int i_6 = i_5; i_6 < -i_5+PB_L-1; i_6++) {
                for (int i_7 = 2; i_7 < -i_5+PB_L-2; i_7++) {
                    D[i_3][i_7+i_5+1][i_6-1][i_3] = I[i_5][i_7][i_3][i_5-1] + D[i_3][i_7+i_5+2][i_6][i_3] * D[i_3+1][i_6+i_5+1][i_7-2][i_3+1] * 1;
                }
            }
        }
    }
...
kernel_4436231211_01(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
