...
void kernel_2412251215_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_L - 1; i_0 >= 1; i_0--) {
        A[i_0] = E[i_0-1] * F[i_0] + 3;
        for (int i_1 = 1; i_1 < min(-i_0+PB_N, PB_M-1); i_1++) {
            A[i_1] = G[i_1][i_0] - G[i_1][i_0] + H[i_1][i_0] + H[i_0-1][i_1-1] - A[i_0-1] * 6;
            A[i_1-1] = H[i_1+1][i_0-1] * H[i_1+i_0][i_0-1] + H[i_0+1][i_1+1] + H[i_1][i_0] + I[i_1-1][0][i_0] + A[i_1] - 3;
        }
    }
    for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
        A[i_2] = F[i_2] + F[i_2] - E[i_2+1] + F[i_2] * E[i_2] - E[i_2] * E[i_2] - F[i_2] - E[i_2] - 3;
    }
#pragma endscop
...
kernel_2412251215_02(xa,POLYBENCH_ARRAY(A), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
