...
void kernel_4322112221_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_P-1; i_0++) {
        for (int i_1 = 2; i_1 < PB_L; i_1++) {
            for (int i_2 = 2; i_2 < PB_M+2; i_2++) {
                A[i_1-1][i_0+1][i_1-1] = D[i_2-2][i_0][i_1] - 3;
            }
            for (int i_3 = 0; i_3 < i_0; i_3++) {
                B[i_3][i_1-1][0] = B[i_3][i_1-2][0] - B[i_0][i_1][0] + 5;
            }
        }
        for (int i_4 = 1; i_4 < PB_N; i_4++) {
            for (int i_5 = i_4; i_5 < PB_P-1; i_5++) {
                for (int i_6 = 0; i_6 < min(min(-i_0+PB_M+3, -i_5+PB_M), -i_4+PB_M+1); i_6++) {
                    C[i_0][i_6+i_4-1][i_5][i_4] = C[i_4][i_6+i_0-3][i_5][i_0] - C[i_0][i_6+i_5][i_4-1][i_5+1] + 1;
                }
            }
        }
    }
...
kernel_4322112221_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
