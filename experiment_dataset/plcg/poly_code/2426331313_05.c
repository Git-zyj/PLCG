...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_M; i_1++) {
        for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
            D[i_1] = G[i_2+1][i_1] - C[i_2] - 6;
        }
    }
    for (int i_3 = 1; i_3 < PB_L; i_3++) {
        C[i_3-1] = F[i_3-1] + H[i_3] * H[1] + C[i_3] * D[i_3+1] + D[i_3] - D[i_3-1] - 4;
        D[i_3] = E[i_3] * H[i_3] - H[i_3] - F[i_3] - E[i_3] * C[i_3-1] + 5;
    }
#pragma endscop
...
kernel_2426331313_05(xa,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
