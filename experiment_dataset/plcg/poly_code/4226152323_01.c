...
void kernel_4226152323_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
        ...
        for (int i_1 = i_0; i_1 < PB_M; i_1++) {
            for (int i_2 = i_0; i_2 < PB_L-1; i_2++) {
                for (int i_3 = max(2, i_1); i_3 < -i_1+PB_M; i_3++) {
                    A[i_2][i_3][i_1-1] = C[i_2][i_3+1][i_1][i_2] + C[i_1][i_0][i_2][i_0] - C[i_3+i_1][i_2][i_0][i_0-1] * C[i_2][i_0][0][i_1] * C[i_2][i_0][i_1][0] - A[i_0][i_1][i_3-2] * A[i_3][i_2+1][i_1-1] * A[i_1][i_3+1][i_2-1] + A[i_3-1][i_2+1][i_1] * 5;
                }
            }
        }
        for (int i_4 = 2; i_4 < min(i_0, PB_M-2); i_4++) {
            for (int i_5 = 0; i_5 < PB_L-2; i_5++) {
                B[i_4][i_0][i_5] = D[i_0][i_5][i_4-2] + D[i_4+2][i_0][i_4] - E[i_5][i_0] + E[i_4][i_5] * D[i_0][i_5][i_4] + B[i_4][i_0][i_5+2] + 3;
            }
        }
    }
#pragma endscop
...
kernel_4226152323_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
