...
void kernel_4224112123_08(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_2 = 0; i_2 < PB_L; i_2++) {
        for (int i_3 = 2; i_3 < PB_L; i_3++) {
            for (int i_4 = i_3; i_4 < min(-i_3+PB_L, PB_P+1); i_4++) {
                B[i_4][i_4+i_3] = C[i_2][i_4-1][i_3] + B[i_4-2][i_4+i_3-2] + 6;
            }
        }
    }
#pragma endscop
...
kernel_4224112123_08(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
