...
void kernel_3422111315_03(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            C[i_1-1] = B[i_1-1][i_1] * 1;
            B[i_1-1][i_1] = C[i_1] - C[i_0-1] * C[i_1-1] * C[i_0] * 6;
        }
        C[i_0-1] = 4;
        C[i_0-1] = E[i_0] - 6;
    }
...
kernel_3422111315_03(xc,POLYBENCH_ARRAY(C), xb,yb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E));
