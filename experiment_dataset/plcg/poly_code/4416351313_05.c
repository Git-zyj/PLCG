...
void kernel_4416351313_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,int wb,DATA_TYPE POLYBENCH_5D(B,xB,yB,zB,vB,wB,xb,yb,zb,vb,wb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj)){
        ...
        for (int i_1 = 2; i_1 < min(-i_0+PB_Q, i_0); i_1++) {
            for (int i_2 = 0; i_2 < min(min(-i_0+PB_Q, -i_1+PB_M), PB_L); i_2++) {
                for (int i_3 = 1; i_3 < PB_L; i_3++) {
                    A[i_2][i_1+1][i_0][i_3] = E[i_1][i_0][i_3][0] * E[i_3][i_0-1][i_2+i_0][0] * F[i_0][i_2+i_1][i_3-1][i_0-1] * G[i_2][i_3][i_0][0] + A[i_2][i_0+1][i_1+1][i_3] + 6;
                }
            }
            for (int i_4 = 1; i_4 < min(-i_0+PB_M-1, -i_1+PB_L); i_4++) {
                for (int i_5 = 1; i_5 < min(min(-i_0+PB_P+1, -i_1+PB_M-1), i_0); i_5++) {
                    B[i_5+i_1+1][i_4][i_0-1][i_4-1][i_5] = H[i_4-1][i_0][i_5] + I[i_4][i_5][i_0+1] * E[i_4+i_1][i_5+i_0-1][i_0-1][0] - G[i_5-1][i_4][i_1+i_0][i_4] * E[i_4][i_0][i_1][i_5] * G[i_4][i_5][i_1][i_0] - E[i_5][i_0][0][i_1] - I[i_4][i_1][i_0] + G[i_1-1][i_4+i_0-1][i_5+1][i_1] * B[i_4+i_0+1][i_5][i_1-2][i_5-1][i_4] - 4;
                }
            }
            C[i_1] = H[i_0+1][i_1][i_0+1] - I[i_1][i_0][i_0] - I[i_1][i_0+1][i_0-1] * C[i_1+1] - C[i_1-1] - C[i_0+1] + C[i_0-1] * 2;
        }
    }
        ...
        for (int i_7 = 0; i_7 < -i_6+PB_L-1; i_7++) {
            for (int i_8 = 0; i_8 < PB_L; i_8++) {
                for (int i_9 = 1; i_9 < PB_N-1; i_9++) {
                    D[i_9+1][i_6][i_8][i_8+1] = E[i_7+i_6][i_8][i_9-1][i_7+1] + F[i_9+1][i_8][i_7+i_6+1][i_7] + E[i_9][i_8+i_7][i_6][i_8+1] - J[i_9][i_8][i_7] - D[i_9][i_6-1][i_7][i_7+1] + D[i_9][i_6][i_7][i_7+1] + D[i_9+1][i_6-1][i_8][i_8+1] - 1;
                }
            }
        }
    }
...
kernel_4416351313_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,wb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
