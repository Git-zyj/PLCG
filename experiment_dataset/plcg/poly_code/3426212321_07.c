...
void kernel_3426212321_07(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        for (int i_1 = i_0; i_1 < PB_P; i_1++) {
            A[i_0][i_1] = E[i_1+2][i_0-2] * A[i_0+2][i_1-2] - A[i_0][i_1-2] - 3;
        }
    }
    for (int i_2 = 0; i_2 < PB_M-2; i_2++) {
        ...
        for (int i_5 = 0; i_5 < min(PB_M-3, i_2); i_5++) {
            C[i_5][i_5+2] = C[i_5+1][i_5+3] - 1;
        }
    }
    for (int i_6 = 2; i_6 < PB_M-2; i_6++) {
        D[i_6] = D[i_6+2] - D[i_6-2] + D[i_6-1] + D[i_6+1] - 3;
    }
#pragma endscop
...
kernel_3426212321_07(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
