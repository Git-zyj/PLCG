        ...
        for (int i_1 = 0; i_1 < min(i_0, -i_0+PB_P-1); i_1++) {
            for (int i_2 = 2; i_2 < PB_Q; i_2++) {
                for (int i_3 = i_2; i_3 < PB_Q; i_3++) {
                    A[i_1+1][i_2-1][i_0][i_3] = C[i_1+1][i_2][i_0-1][i_3] + D[i_0-1][i_2][i_1][i_1+1] - E[i_3][i_1+i_0+1][i_2-1][i_0+1] + E[i_0][i_2+1][i_1][0] * D[i_1][i_3-1][i_0+1][1] + A[i_3][i_2-1][i_1+1][i_0] + A[i_1][i_2-2][i_3-1][i_0-1] + 4;
                }
            }
        }
        for (int i_4 = 1; i_4 < i_0; i_4++) {
            B[i_0][i_4] = F[i_0-1][i_4] * G[i_4][i_0+1] + H[i_4-1] - I[i_0+1][i_4][i_0+1] * B[i_0+1][i_4] + B[i_0][i_4-1] - B[i_0-1][i_4-1] * 5;
        }
    }
#pragma endscop
...
kernel_4216351311_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
