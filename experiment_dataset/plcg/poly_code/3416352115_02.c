...
void kernel_3416352115_02(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 1; i_1 < min(i_0, -i_0+PB_N); i_1++) {
            B[i_0+1][i_0] = E[i_1+i_0] * F[i_1+1][i_1+2] - F[i_1][i_0] + G[i_1+1][i_1-1] * H[i_1][i_0-2] + F[i_1+i_0][i_0] + 4;
        }
        for (int i_2 = 2; i_2 < PB_L; i_2++) {
            B[i_0+1][i_0] = F[i_2+1][i_0] * H[i_2][i_2] * G[i_0+2][i_2-2] - F[i_2][i_0] + B[i_2][i_2-1] + 3;
        }
        B[i_0+2][i_0+1] = I[1] * I[i_0] - I[i_0-2] * E[i_0-1] + F[i_0-2][i_0] - J[i_0-1] + 4;
    }
    for (int i_3 = 0; i_3 < PB_L; i_3++) {
        for (int i_4 = 2; i_4 < PB_L; i_4++) {
            B[i_4+1][i_4] = G[i_4-2][i_3] * F[i_4-2][i_3] * E[i_4-2] - 4;
        }
    }
#pragma endscop
...
kernel_3416352115_02(xb,yb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
