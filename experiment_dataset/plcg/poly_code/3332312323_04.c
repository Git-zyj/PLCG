...
void kernel_3332312323_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P-2; i_0++) {
        for (int i_1 = i_0; i_1 < -i_0+PB_Q; i_1++) {
            A[i_1][i_0+2][i_1+i_0] = A[i_1][i_0+1][i_1+i_0-1] - 5;
        }
    }
    for (int i_2 = 2; i_2 < PB_N-2; i_2++) {
        B[i_2] = D[i_2] + D[i_2] * B[i_2+2] + B[i_2-2] + B[i_2+1] * 4;
    }
    for (int i_3 = 0; i_3 < PB_M-3; i_3++) {
        for (int i_4 = 2; i_4 < PB_P-1; i_4++) {
            for (int i_5 = i_4; i_5 < PB_M-1; i_5++) {
                C[i_3+2][i_3][i_4] = C[i_5+1][i_5-1][i_4] * C[i_3+3][i_3+1][i_4-2] + C[i_3+2][i_3][i_4+1] - 1;
            }
        }
    }
#pragma endscop
...
kernel_3332312323_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
