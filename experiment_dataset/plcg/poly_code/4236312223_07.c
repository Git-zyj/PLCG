...
void kernel_4236312223_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 0; i_1 < -i_0+PB_M-2; i_1++) {
            for (int i_2 = 1; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_0+PB_M-2, i_0); i_3++) {
                    A[i_3+i_0+1][i_1+1][i_2][2] = C[i_3][i_1][i_2] + A[i_1+i_0+2][i_3+1][i_2][2] * A[i_1+i_0][i_3+1][i_2+1][2] * A[i_3+i_0+2][i_1+1][i_2-1][2] * 2;
                }
            }
        }
    }
...
kernel_4236312223_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
