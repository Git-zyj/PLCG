...
void kernel_2234112311_08(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-3; i_0++) {
        B[i_0+3][i_0+3] = C[i_0][0] - 1;
    }
    for (int i_1 = 0; i_1 < PB_M-3; i_1++) {
        B[i_1+2][i_1+2] = B[i_1+1][i_1+1] - B[i_1+3][i_1+3] - B[i_1+3][i_1+3] + 4;
    }
#pragma endscop
...
kernel_2234112311_08(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
