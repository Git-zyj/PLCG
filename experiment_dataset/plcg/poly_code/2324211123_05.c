...
void kernel_2324211123_05(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
        C[i_3+1] = D[i_3+1] - D[i_3-1] + C[i_3] * 6;
    }
#pragma endscop
...
kernel_2324211123_05(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
