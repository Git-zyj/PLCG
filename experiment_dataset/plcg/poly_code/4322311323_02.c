...
void kernel_4322311323_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
        ...
        for (int i_1 = 1; i_1 < min(i_0, -i_0+PB_P-2); i_1++) {
            for (int i_2 = 1; i_2 < PB_P-2; i_2++) {
                for (int i_3 = 0; i_3 < PB_Q-2; i_3++) {
                    A[i_0][i_2][i_3] = A[i_0][i_2+2][i_3+2] * A[i_2+2][i_3][i_1] * C[i_3+1][i_3][i_1+i_0+2][i_2-1] * 1;
                }
            }
            B[i_1][i_0] = D[i_1][i_1] + B[i_1][i_0-1] * B[i_0+2][i_1] - B[i_1-1][i_0] * B[i_1][i_0-2] + 6;
        }
        for (int i_4 = 1; i_4 < PB_Q+1; i_4++) {
            for (int i_5 = 0; i_5 < -i_0+PB_P; i_5++) {
                for (int i_6 = 0; i_6 < i_0; i_6++) {
                    C[i_6+1][i_6][i_5+i_0][i_4-1] = 2;
                }
            }
        }
    }
...
kernel_4322311323_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
