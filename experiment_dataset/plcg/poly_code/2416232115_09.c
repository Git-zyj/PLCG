...
void kernel_2416232115_09(int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P; i_0++) {
        D[i_0-1] = E[i_0-1] + E[i_0] * F[i_0] * F[i_0] + 5;
        for (int i_1 = 2; i_1 < PB_P; i_1++) {
            B[i_1][i_0] = G[i_0][0] - H[i_1][i_0] * I[i_0+2][i_1-1][0] - B[i_1][i_0+1] * 6;
            C[i_1-1][i_0+1] = G[i_1-2][i_0] * 5;
            D[i_1] = G[i_1][i_0-1] * 5;
        }
    }
#pragma endscop
...
kernel_2416232115_09(xd,POLYBENCH_ARRAY(D), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
