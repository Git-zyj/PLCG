...
void kernel_4414352313_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,int zk,int vk,DATA_TYPE POLYBENCH_4D(K,xK,yK,zK,vK,xk,yk,zk,vk)){
        ...
        for (int i_1 = 2; i_1 < -i_0+PB_L; i_1++) {
            for (int i_2 = i_0; i_2 < PB_L; i_2++) {
                for (int i_3 = 3; i_3 < PB_L; i_3++) {
                    A[i_1-1][i_0-2][i_3-2][i_2-2] = E[i_0][i_2][i_1][i_3+2] * E[i_2-1][i_3][i_1+1][i_0-2] + A[i_1][i_0-2][i_3-3][i_2-2] - A[i_1-2][i_0-1][i_3-3][i_2-2] - A[i_1-1][i_0-2][i_3-1][i_2-2] - A[i_1][i_0-3][i_3-2][i_2-2] + 6;
                }
            }
            B[i_1] = F[i_1-2][i_0] + F[i_1][i_0] + F[i_1][i_0] * G[i_0][i_1] - H[i_1+i_0+2][i_1+i_0] * F[i_1][i_0] + B[i_0+1] - B[i_1-1] - 1;
        }
    }
        ...
        for (int i_5 = 2; i_5 < -i_4+PB_Q; i_5++) {
            for (int i_6 = 1; i_6 < i_5; i_6++) {
                for (int i_7 = 1; i_7 < PB_P-2; i_7++) {
                    C[i_7-1][i_5-2][i_6][i_4] = I[i_7][i_6+1][i_5+i_4] - J[i_7][i_5][i_4+2][i_4] * K[i_5+1][i_6+i_4][i_7][i_4] * J[i_7][i_4-1][i_7+2][i_5] - J[i_6][i_7-1][i_4][i_4+2] - J[i_7][i_4+2][i_6+i_5][i_4] - C[i_7-1][i_5-1][i_6-1][i_4] * C[i_7-1][i_5-2][i_6-1][i_4-1] * C[i_7-1][i_5-2][i_4][i_6+1] - 3;
                }
            }
        }
        for (int i_8 = 1; i_8 < min(i_4, -i_4+PB_Q); i_8++) {
            for (int i_9 = 0; i_9 < PB_L; i_9++) {
                for (int j_0 = 1; j_0 < min(-i_9+PB_L, -i_4+PB_M); j_0++) {
                    D[i_8][i_4-2][i_9][j_0] = K[j_0][i_9][i_4+1][i_8+1] * E[i_4+2][j_0+i_9][i_8][i_8+i_4] + K[i_9][j_0+i_4][i_8+2][i_8] * D[i_8][i_4-3][i_9][j_0-1] + D[j_0][i_4-2][i_9][i_8-1] - D[i_8][i_4-2][i_9][j_0-1] - 6;
                }
            }
        }
    }
...
kernel_4414352313_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K));
