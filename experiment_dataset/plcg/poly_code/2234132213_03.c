...
void kernel_2234132213_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M; i_0++) {
        B[i_0-1] = C[i_0-2] * C[i_0] + C[i_0] + C[i_0] * C[0] - 3;
        for (int i_1 = 3; i_1 < PB_M; i_1++) {
            B[i_1-2] = D[i_1][i_0] + B[i_0-3] + B[i_1-3] - 4;
        }
    }
#pragma endscop
...
kernel_2234132213_03(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
