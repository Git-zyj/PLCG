...
void kernel_4316251313_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        A[i_0] = D[i_0-1] * E[i_0] - E[i_0] - A[i_0-1] + A[i_0+1] - A[i_0-1] + A[i_0+1] + A[i_0-1] + 5;
        for (int i_1 = 1; i_1 < min(i_0, PB_P-1); i_1++) {
            for (int i_2 = 0; i_2 < PB_L-1; i_2++) {
                C[i_0][i_2+1][i_1-1] = F[i_2][i_2+1][i_1+1] + G[i_1][i_2][i_1-1] + G[i_2][i_0-1][i_1] * 5;
            }
        }
        for (int i_3 = 0; i_3 < min(-i_0+PB_M, i_0); i_3++) {
            for (int i_4 = 0; i_4 < min(i_0, PB_P-1); i_4++) {
                C[i_3][i_4][i_0] = F[i_3][i_0][i_4+1] * G[i_3][i_4][i_3+i_0] - G[i_4][i_0-1][i_3] + F[i_0][i_4][i_0] * H[i_3][0] - F[i_3][i_0][i_4+1] - G[i_3][i_0-1][i_0] - 5;
            }
        }
    }
#pragma endscop
...
kernel_4316251313_01(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
