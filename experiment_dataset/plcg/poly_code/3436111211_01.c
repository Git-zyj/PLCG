...
void kernel_3436111211_01(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
    ...
    for (int i_3 = 0; i_3 < PB_L; i_3++) {
        for (int i_4 = 2; i_4 < PB_L+1; i_4++) {
            for (int i_5 = 0; i_5 < -i_4+PB_L+1; i_5++) {
                C[i_5+i_4-1][i_5+i_4+1] = C[i_5+i_4-2][i_5+i_4] + C[i_5+i_4-2][i_5+i_4] + 5;
            }
        }
    }
    for (int i_6 = 1; i_6 < PB_M-2; i_6++) {
        D[i_6+1] = E[i_6-1] - D[i_6+2] * D[i_6] * D[i_6] * 1;
    }
#pragma endscop
...
kernel_3436111211_01(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
