...
void kernel_4224112315_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = max(1, i_0); i_1 < PB_P; i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_M-3; i_2++) {
                for (int i_3 = max(2, i_1); i_3 < PB_P+1; i_3++) {
                    A[i_2+i_0+2][i_1][i_2][i_3-1] = A[i_2+i_0+2][i_1][i_2][i_3-2] * A[i_2+i_0+1][i_3-1][i_2-1][i_1-1] * A[i_2+i_0+3][i_1][i_2+1][i_3-1] - 3;
                }
            }
            for (int i_4 = 1; i_4 < PB_P; i_4++) {
                B[i_4][0] = C[i_0][i_1][i_4] + B[i_4+1][0] - B[i_4-1][0] * B[i_4+1][0] + 1;
            }
        }
    }
#pragma endscop
...
kernel_4224112315_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
