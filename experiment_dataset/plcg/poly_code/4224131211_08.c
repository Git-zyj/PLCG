        ...
        for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
            for (int i_5 = 0; i_5 < min(-i_3+PB_L-1, -i_4+PB_L); i_5++) {
                for (int i_6 = 1; i_6 < -i_3+PB_L-1; i_6++) {
                    B[i_5][i_4][i_6+i_3+1][i_6] = E[i_6+i_5][i_3][i_4-1][1] * B[i_6+1][i_4+1][i_5+i_3+1][i_5+1] - B[i_6+1][i_3-1][i_5+i_4][i_4] - B[i_5][i_4][i_6+i_3][i_6-1] + 1;
                }
            }
        }
    }
...
kernel_4224131211_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
