...
void kernel_2336251311_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        for (int i_1 = 1; i_1 < -i_0+PB_M; i_1++) {
            A[i_0-1][i_1-1] = D[i_0][i_1] - E[i_1+i_0] * D[i_1][i_0] - D[i_0][i_1+1] - F[i_1][i_0+1] - G[i_0-1][i_1][i_0] - A[i_0-2][i_1-1] + A[i_0-1][i_1] - B[i_1][i_1] + 5;
            B[i_1][i_1] = D[i_1][i_0] * D[i_0][i_0] * B[i_1+1][i_1+1] + B[i_1-1][i_1-1] + 4;
        }
        for (int i_2 = 0; i_2 < -i_0+PB_M; i_2++) {
            C[i_0+1][i_2+1] = H[i_0][i_2][i_0] - D[i_2+i_0][i_2+i_0] + F[i_2][i_0] * F[i_0][i_2+1] + D[i_2+1][i_0] + B[i_2+1][i_2+1] * C[i_0+2][i_2+1] - C[i_2][i_0+1] + C[i_0][i_2] * 5;
        }
    }
#pragma endscop
...
kernel_2336251311_00(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
