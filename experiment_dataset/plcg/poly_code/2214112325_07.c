...
void kernel_2214112325_07(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = max(i_0, 4); i_1 < PB_M+2; i_1++) {
            B[i_1-2] = B[i_1-2] + B[i_1-4] - 1;
            B[i_1-2] = C[i_1][i_0] * B[i_1-3] + 6;
        }
    }
#pragma endscop
...
kernel_2214112325_07(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
