...
void kernel_4432111225_09(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg)){
        ...
        for (int i_1 = 0; i_1 < PB_Q-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 0; i_3 < PB_Q; i_3++) {
                    B[i_2+1][i_0][i_3][i_3] = E[i_2+1][i_0][i_3][i_1+1] - 5;
                }
            }
        }
        for (int i_4 = 0; i_4 < PB_Q; i_4++) {
            for (int i_5 = 2; i_5 < PB_P; i_5++) {
                for (int i_6 = 1; i_6 < PB_Q; i_6++) {
                    B[i_5][i_0][i_6][i_6] = E[i_0][i_5][i_6][i_4] + F[i_0][i_6][i_4] - B[i_5-2][i_0][i_6-1][i_6-1] - B[i_5-2][i_0][i_6][i_6] * 3;
                }
            }
        }
        C[i_0+1] = G[i_0] - C[i_0+3] * 4;
    }
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4432111225_09(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G)));
