...
void kernel_3324212325_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
kernel_3324212325_06(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
