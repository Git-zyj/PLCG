...
void kernel_2426351313_00(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        C[i_0+1] = E[i_0] * E[i_0-1] * 3;
    }
    for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
        for (int i_2 = i_1; i_2 < -i_1+PB_N; i_2++) {
            B[i_2][i_1] = F[i_2+i_1][0] * G[i_2][i_1] - G[i_1][0] - G[i_2][i_1] + F[i_2+i_1-1][i_1] - H[i_1][0] - I[i_1] * F[i_1-1][i_2-1] - F[i_2][i_1] * B[i_2+1][i_1] - C[i_2] * C[i_2+1] * 4;
        }
        C[i_1] = E[i_1] + J[i_1] * I[i_1] + E[i_1] + I[i_1+1] - C[i_1+1] - 4;
    }
    for (int i_3 = 1; i_3 < PB_M; i_3++) {
        for (int i_4 = 1; i_4 < min(-i_3+PB_N, i_3); i_4++) {
            C[i_4] = I[i_4-1] * G[i_4][i_3-1] - F[i_4+i_3][i_3] + H[i_4][i_3] + B[i_3][i_4+1] - B[i_4+1][i_3] - 2;
        }
    }
#pragma endscop
...
kernel_2426351313_00(xc,POLYBENCH_ARRAY(C), xb,yb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
