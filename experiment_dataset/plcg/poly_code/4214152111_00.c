...
void kernel_4214152111_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P-2; i_0++) {
        for (int i_1 = 2; i_1 < min(-i_0+PB_L, i_0); i_1++) {
            for (int i_2 = 1; i_2 < i_1; i_2++) {
                A[i_2-1][i_1+2][i_1][i_0+2] = C[i_1][i_2-1][i_0] * C[i_2+i_0-1][i_1-2][i_2-1] * C[i_0][i_2][i_1] * 3;
            }
            for (int i_3 = 2; i_3 < min(min(PB_P, -i_0+PB_L), -i_1+PB_L); i_3++) {
                B[i_1][i_3] = D[i_1][i_3] - C[i_3][i_3+i_0][i_0-2] - C[i_3][i_1][i_0+2] * C[i_3-2][i_1+i_0][i_0-1] * C[i_1-2][i_0][i_0] * C[i_0][i_3+i_1][2] - B[i_3-1][i_1] + 5;
            }
        }
    }
#pragma endscop
...
kernel_4214152111_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
