...
void kernel_2222211123_02(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        ...
        for (int i_2 = 1; i_2 < min(-i_0+PB_P+2, i_0); i_2++) {
            A[i_2][i_2+i_0-2] = C[i_0+1][i_2] * C[i_2-1][i_0-1] - 1;
        }
    }
#pragma endscop
...
kernel_2222211123_02(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C));
