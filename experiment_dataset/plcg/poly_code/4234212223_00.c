...
void kernel_4234212223_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    ...
    for (int i_3 = 2; i_3 < PB_M; i_3++) {
        for (int i_4 = i_3; i_4 < PB_M-2; i_4++) {
            B[i_4] = C[i_4][i_3] * C[i_4+1][i_3-2] + B[i_4+2] * B[i_4-2] + 6;
        }
    }
#pragma endscop
...
kernel_4234212223_00(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
