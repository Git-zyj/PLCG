...
void kernel_3332112325_05(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        ...
        for (int i_2 = 0; i_2 < -i_0+PB_M; i_2++) {
            A[i_0][i_2] = D[i_2+2][i_0] * D[i_2+i_0][2] + 4;
        }
        for (int i_3 = 0; i_3 < i_0; i_3++) {
            C[i_0][i_0] = C[i_0-2][i_0-2] * C[i_0+2][i_0+2] + C[i_0-1][i_0-1] * C[i_0+1][i_0+1] + C[i_0+1][i_0+1] - 3;
        }
    }
#pragma endscop
...
kernel_3332112325_05(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
