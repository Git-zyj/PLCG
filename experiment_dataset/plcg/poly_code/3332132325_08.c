...
void kernel_3332132325_08(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_M-2; i_1++) {
        C[i_1] = D[i_1] * D[i_1+2] * D[i_1] + D[0] + D[i_1] + D[i_1] - 2;
    }
    for (int i_2 = 2; i_2 < PB_M-2; i_2++) {
        C[i_2] = D[i_2] - D[i_2+2] + C[i_2-2] - C[i_2-1] + C[i_2+2] - 6;
    }
#pragma endscop
...
kernel_3332132325_08(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
