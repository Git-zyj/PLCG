...
void kernel_4416232123_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = max(2, i_0); i_1 < min(PB_L-3, -i_0+PB_L-1); i_1++) {
            for (int i_2 = 2; i_2 < -i_1+PB_L-3; i_2++) {
                for (int i_3 = 2; i_3 < min(-i_1+PB_P+2, PB_M-2); i_3++) {
                    A[i_3][i_1+i_0+1][i_2+i_1-2][i_3-2] = E[i_0][i_2][i_3][i_1] - F[i_2+1][i_3][i_0][0] * E[i_0+1][0][i_3-1][i_1-2] + A[i_3+2][i_2+i_1+3][i_1+i_0][i_3] - A[i_2][i_1+i_0-1][i_3+i_1-2][i_2-2] - A[i_3][i_1+i_0-1][i_2+i_1-2][i_3-2] - 5;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
            B[i_4+1][i_0] = G[i_4-1][i_0] * G[i_0][i_4] * H[i_4] - 6;
        }
    }
    for (int i_5 = 0; i_5 < PB_M-2; i_5++) {
        C[i_5+1] = I[i_5+2] - H[i_5] - 6;
        for (int i_6 = i_5; i_6 < PB_M-3; i_6++) {
            C[i_6+3] = J[i_6][i_5] * H[i_6+1] - G[i_6+2][i_5] * 1;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4416232123_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J)));
