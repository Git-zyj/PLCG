...
void kernel_4232111313_02(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        ...
        B[i_0] = C[i_0-1] + B[i_0+1] + B[i_0-1] + B[i_0+1] - 3;
    }
#pragma endscop
...
kernel_4232111313_02(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
