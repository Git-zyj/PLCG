        ...
        for (int i_7 = 2; i_7 < PB_N-2; i_7++) {
            for (int i_8 = 2; i_8 < min(-i_7+PB_Q, -i_6+PB_L+1); i_8++) {
                for (int i_9 = i_8; i_9 < PB_M; i_9++) {
                    D[i_9][i_8][i_7-2] = L[i_6][i_8][i_9][i_8+i_7] * M[i_7][i_8][i_8][i_9][i_6] + N[i_8+i_7-1][i_9-1][i_6-1][i_6-2] + O[i_9][i_8+i_6-1][i_7+1][i_8] + N[i_8][i_7-2][i_6][i_9] * L[i_7][i_6-2][i_9][i_8-1] - N[i_7+2][i_9][i_6+2][i_7-2] * D[i_7+1][i_9][i_8-2] + 2;
                }
            }
        }
    }
...
init_array(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,zl,vl,POLYBENCH_ARRAY(L), xm,ym,zm,vm,wm,POLYBENCH_ARRAY(M), xn,yn,zn,vn,POLYBENCH_ARRAY(N), xo,yo,zo,vo,POLYBENCH_ARRAY(O), INIT_SEED);
kernel_4434352311_04(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,zl,vl,POLYBENCH_ARRAY(L), xm,ym,zm,vm,wm,POLYBENCH_ARRAY(M), xn,yn,zn,vn,POLYBENCH_ARRAY(N), xo,yo,zo,vo,POLYBENCH_ARRAY(O));
