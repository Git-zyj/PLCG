...
void kernel_2432112321_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            A[i_0][i_1][i_0] = A[i_1-1][i_0][i_1-1] - A[i_0][i_1+1][i_0] * D[i_1+1] - 6;
        }
        for (int i_2 = 0; i_2 < PB_L; i_2++) {
            B[i_2][i_0][i_0] = B[i_2][i_0+2][i_0+2] + B[i_2][i_0-1][i_0-1] * 2;
            C[i_2] = E[i_2][i_0] + 5;
        }
        D[i_0+1] = C[i_0] - C[i_0-1] + C[i_0-2] * C[i_0+2] + C[i_0+1] * 4;
    }
#pragma endscop
...
kernel_2432112321_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
