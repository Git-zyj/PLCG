...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
        B[i_1] = D[i_1+2] + E[i_1] - 6;
        for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
            for (int i_3 = 0; i_3 < -i_1+PB_P+2; i_3++) {
                C[i_1][i_2][i_1-2] = F[i_2][i_3][i_1-1] * F[i_2][i_3+i_1-2][1] + G[i_1-1][i_2][i_3] - C[i_2+1][i_1+2][i_2-1] - 6;
            }
        }
    }
#pragma endscop
...
kernel_3312332121_06(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
