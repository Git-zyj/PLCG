...
void kernel_4222131313_08(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf)){
    ...
    for (int i_2 = 1; i_2 < PB_L-1; i_2++) {
        for (int i_3 = 0; i_3 < PB_M-2; i_3++) {
            for (int i_4 = 0; i_4 < min(-i_2+PB_L+1, -i_3+PB_M-2); i_4++) {
                B[i_4+i_3+1][i_4+1] = D[i_3][i_4+i_2-1] * E[i_2+1][i_4][i_3] + F[i_4+i_3][i_2][i_2][0] + D[i_4+1][0] + A[i_2+1][i_4] + B[i_4+i_3+2][i_4+1] - B[i_4+i_3+2][i_4+2] - B[i_4+i_3][i_3] - B[i_4+i_3][i_4] - 2;
            }
        }
    }
#pragma endscop
...
kernel_4222131313_08(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
