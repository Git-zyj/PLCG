...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < -i_0+PB_Q+1; i_1++) {
            for (int i_2 = 0; i_2 < PB_L; i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_M; i_3++) {
                    B[i_3-1][i_2][i_0-2][i_1+i_0-1] = C[i_3+i_0][i_0][i_1][i_2] * D[i_0][i_3][i_1+1][i_1] + 3;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_Q-2; i_4++) {
        for (int i_5 = 2; i_5 < min(i_4, PB_M-2); i_5++) {
            for (int i_6 = 2; i_6 < min(-i_4+PB_Q+2, PB_M-2); i_6++) {
                for (int i_7 = 2; i_7 < -i_4+PB_Q-2; i_7++) {
                    B[i_5][i_6][i_7][i_7+i_4] = E[i_5][i_7][i_7][i_6] - D[i_4][i_6-2][i_7-2][i_5] * F[0][i_5][i_7] * E[i_6][i_4][i_7][i_5] + B[i_6+2][i_5][i_4-2][i_7+i_4-2] + B[i_5-2][i_7][i_6-2][i_6+i_4-2] - B[i_5+2][i_6][i_7][i_7+i_4+2] * 2;
                }
            }
        }
    }
...
kernel_4224332323_00(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
