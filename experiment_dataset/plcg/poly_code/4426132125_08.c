        ...
        for (int i_1 = 2; i_1 < min(i_0, PB_M-2); i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_M+1; i_2++) {
                for (int i_3 = 2; i_3 < PB_M-2; i_3++) {
                    A[i_2+i_0-1][i_3+1][i_1-2][i_3-2] = E[i_3+2][i_2][i_1][i_0] + F[i_3][i_1+2][i_2-1] * F[i_0][i_3][i_2] - E[i_3][i_1][0][i_0] + F[i_1+2][i_2+2][i_3-2] + E[i_3][i_2+1][i_1][i_0] - 3;
                }
            }
        }
        for (int i_4 = 0; i_4 < i_0; i_4++) {
            B[i_4] = G[i_4][i_0] - H[i_0+1] + 3;
        }
        for (int i_5 = 2; i_5 < PB_Q-1; i_5++) {
            for (int i_6 = 2; i_6 < PB_L-1; i_6++) {
                for (int i_7 = 0; i_7 < -i_0+PB_M+2; i_7++) {
                    A[i_7+i_0-2][i_6+1][i_5-2][i_6-2] = E[i_7][i_0][i_5+1][i_6] - 5;
                }
            }
        }
    }
    for (int i_8 = 0; i_8 < PB_M-1; i_8++) {
        B[i_8] = H[i_8+1] + B[i_8] * 6;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4426132125_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H)));
