...
void kernel_3326231123_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P; i_0++) {
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            A[i_0+1][i_0] = D[i_1][i_1] + E[i_1][i_0][i_0] * D[i_1][i_0] * A[i_0+3][i_0+2] * 6;
        }
        for (int i_2 = 0; i_2 < i_0; i_2++) {
            A[i_0+1][i_0] = F[i_2][i_0] - D[i_0+1][i_2] * F[i_0-1][i_2] * D[i_0][i_2+1] * 1;
        }
        A[i_0+2][i_0+1] = G[i_0] * H[i_0] + 6;
    }
#pragma endscop
...
kernel_3326231123_00(xa,ya,POLYBENCH_ARRAY(A), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
