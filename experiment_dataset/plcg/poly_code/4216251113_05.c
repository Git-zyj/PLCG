        ...
        for (int i_1 = i_0; i_1 < min(-i_0+PB_P+1, PB_Q-1); i_1++) {
            for (int i_2 = 1; i_2 < PB_Q-1; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_1+PB_N, PB_M-1); i_3++) {
                    A[i_0+1][i_2-1][i_3][i_1] = C[i_3][i_1][i_0][i_2] * D[i_3+i_1][i_2][i_0][i_0-1] + D[i_2+1][i_1][i_3][i_0-1] + D[i_1][i_0-1][i_3][i_1] - D[i_0][i_3+1][i_2][i_1-1] * C[i_1][i_3][i_1+i_0-1][i_2+1] * D[i_3][i_0-1][i_1-1][i_2] - A[i_0+1][i_2-1][i_3][i_1+1] + 1;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        B[i_4+1] = E[i_4-1] - E[i_4] * 3;
    }
#pragma endscop
...
kernel_4216251113_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
