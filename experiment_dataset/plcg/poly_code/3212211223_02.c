...
void kernel_3212211223_02(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
...
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            ...
            B[i_0][i_1] = C[i_0][i_1][i_0+1] - B[i_0][i_1+2] - B[i_0+2][i_1+2] - 1;
        }
    }
#pragma endscop
...
kernel_3212211223_02(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
