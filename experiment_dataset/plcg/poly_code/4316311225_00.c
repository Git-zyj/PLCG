...
void kernel_4316311225_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
        ...
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < PB_Q-3; i_2++) {
                for (int i_3 = 1; i_3 < PB_P-1; i_3++) {
                    A[i_1][i_0+1][i_3+1][i_2+1] = D[i_1+1][i_2][i_0][i_0] * E[i_2+1][i_1][i_3] - A[i_1][i_0][i_3-1][i_2+3] * A[i_1][i_0+1][i_3][i_2+1] * 4;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_P; i_4++) {
        for (int i_5 = 3; i_5 < PB_L+1; i_5++) {
            for (int i_6 = 0; i_6 < i_4; i_6++) {
                C[i_4][i_6][i_5-3] = F[i_5][i_6][i_4] * C[i_4][i_6][i_5-1] + 2;
                C[i_4][i_6][i_5-1] = 2;
            }
        }
    }
...
kernel_4316311225_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
