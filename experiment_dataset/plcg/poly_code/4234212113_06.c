...
void kernel_4234212113_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
        ...
        for (int i_1 = 0; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 1; i_2 < min(PB_Q-2, i_0); i_2++) {
                for (int i_3 = 0; i_3 < -i_1+PB_L-2; i_3++) {
                    A[i_3+i_1][i_2][i_3] = C[i_3+i_1+2][i_0][i_2+2] + A[i_3+i_1][i_2-1][i_3] - 5;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M-1; i_4++) {
        for (int i_5 = 0; i_5 < min(-i_4+PB_M-1, PB_P); i_5++) {
            for (int i_6 = 0; i_6 < PB_P; i_6++) {
                A[i_5+i_4+1][i_6][i_5] = D[i_6][i_5] + 6;
            }
        }
    }
#pragma endscop
...
kernel_4234212113_06(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
