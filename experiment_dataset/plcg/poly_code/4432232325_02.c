...
void kernel_4432232325_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
...
#pragma scop
    ...
    for (int i_4 = 0; i_4 < PB_M; i_4++) {
        for (int i_5 = 1; i_5 < PB_M; i_5++) {
            A[i_5-1] = F[i_5][i_4] * G[i_5][i_4] + F[i_4][i_5] + A[i_5] - 6;
        }
    }
    for (int i_6 = 1; i_6 < PB_M; i_6++) {
        for (int i_7 = 2; i_7 < i_6; i_7++) {
            for (int i_8 = 2; i_8 < min(-i_6+PB_M, -i_7+PB_M); i_8++) {
                A[i_8-1] = H[i_8-2][i_7][i_8+i_6-1] + I[i_8+i_6][i_8+i_7][2] - H[i_8+1][i_7-2][i_6] * I[i_8+i_7][i_6-1][i_7] * H[i_8][i_6][i_7] - 1;
            }
        }
    }
#pragma endscop
...
kernel_4432232325_02(xa,POLYBENCH_ARRAY(A), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
