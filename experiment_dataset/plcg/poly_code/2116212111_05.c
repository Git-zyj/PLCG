...
void kernel_2116212111_05(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-3; i_0++) {
        for (int i_1 = 3; i_1 < PB_L; i_1++) {
            A[i_0+2][i_1-2] = B[i_1] + A[i_0+3][i_1-3] - 5;
        }
    }
#pragma endscop
...
kernel_2116212111_05(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
