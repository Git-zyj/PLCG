...
void kernel_2236132225_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        B[i_0] = C[i_0] * C[i_0] + C[i_0] - C[i_0-2] - 4;
    }
...
kernel_2236132225_05(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
