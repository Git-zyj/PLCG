...
void kernel_4436352321_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        A[i_0] = E[i_0+1] - F[i_0] - F[i_0] - F[i_0] - F[i_0] + E[i_0] + A[i_0-1] * A[i_0+1] * C[i_0] * C[i_0+1] + 1;
    }
        ...
        for (int i_2 = 0; i_2 < min(-i_1+PB_Q+2, PB_L); i_2++) {
            for (int i_3 = 0; i_3 < PB_P; i_3++) {
                for (int i_4 = i_2; i_4 < PB_L; i_4++) {
                    D[i_1-1][i_3][i_4+1][i_2+1] = G[i_4][i_3][i_4+2][i_2+i_1-2] + H[i_2][i_1][i_4][i_3] - G[i_2][i_1][i_4+1][i_3] - 1;
                }
            }
        }
    }
    for (int i_5 = 2; i_5 < PB_L-2; i_5++) {
        C[i_5] = E[0] * E[i_5+2] - I[i_5][i_5-2] - E[i_5] + C[i_5-2] * C[i_5+2] - 2;
    }
    for (int i_6 = 1; i_6 < PB_P-1; i_6++) {
        for (int i_7 = i_6; i_7 < -i_6+PB_L; i_7++) {
            for (int i_8 = 0; i_8 < min(-i_7+PB_N, PB_P-2); i_8++) {
                for (int i_9 = 2; i_9 < PB_M-1; i_9++) {
                    D[i_9][i_7][i_6+2][i_8+1] = J[i_7][i_9+1][i_6][i_8+2] + J[i_9][i_8][i_7][i_6] - H[i_8][i_7][i_9][i_9-2] + G[i_9][i_6][i_8+i_7][1] - J[i_7+1][i_8][i_9][i_6-1] - J[i_8+i_7][i_9][i_7+i_6][i_9+1] - D[i_9][i_7][i_6+1][i_8+1] * D[i_9][i_7-1][i_8+2][i_6+1] + D[i_9-2][i_6+1][i_7+2][i_8+1] * 6;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4436352321_08(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J)));
