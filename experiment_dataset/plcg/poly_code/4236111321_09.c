...
void kernel_4236111321_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        A[i_0+1] = C[0] - A[i_0] + A[i_0+3] - A[i_0-1] * A[i_0+2] - A[i_0] * 5;
    }
    for (int i_1 = 3; i_1 < PB_M; i_1++) {
        B[i_1-1] = C[1] - B[i_1-3] * 2;
    }
#pragma endscop
...
kernel_4236111321_09(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
