...
void kernel_3414332321_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        A[i_0+1] = E[i_0] * F[i_0] - F[i_0-1] + A[i_0+2] - A[i_0-1] - A[i_0] + 6;
        for (int i_1 = max(2, i_0); i_1 < PB_M-2; i_1++) {
            B[i_1] = E[i_1-1] + G[i_1-1][i_0] - B[i_1-2] + B[i_1+2] - B[i_1+1] + 2;
        }
    }
    for (int i_2 = 2; i_2 < PB_Q-2; i_2++) {
        for (int i_3 = 2; i_3 < min(-i_2+PB_L-2, PB_P-1); i_3++) {
            for (int i_4 = 3; i_4 < PB_P-2; i_4++) {
                C[i_4-1][i_3][i_3] = H[i_3][i_2][i_4][i_2+2] * I[i_2-2][i_3+2][i_4+1] * I[i_2][i_3][i_4] * J[i_4][i_3+i_2+2] - C[i_4-1][i_3-2][i_3-2] * C[i_2-1][i_4+2][i_4+2] - C[i_4-1][i_3+1][i_3+1] + C[i_4][i_3][i_3] * C[i_4-3][i_3][i_3] - 3;
            }
        }
        D[i_2+2] = J[i_2][0] - E[i_2+2] - E[i_2-2] - A[i_2] - 4;
    }
#pragma endscop
...
init_array(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_3414332321_03(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J)));
