...
void kernel_3436251211_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-1; i_0++) {
        A[i_0] = E[i_0] * F[i_0] + F[i_0] * E[i_0] * E[i_0] * E[i_0] - G[i_0+1][i_0] - E[i_0+1] * F[i_0] + A[i_0+1] + A[i_0-1] * A[i_0+1] + 3;
    }
    ...
    for (int i_4 = 1; i_4 < PB_N-1; i_4++) {
        for (int i_5 = 1; i_5 < min(-i_4+PB_M+1, PB_L-1); i_5++) {
            for (int i_6 = 1; i_6 < min(-i_4+PB_M, i_5); i_6++) {
                C[i_6+i_4][i_5-1][i_6] = H[i_4][i_6+1][i_5] + H[i_4][i_6][i_5] * I[i_5][i_6][i_6-1] + I[i_6+1][i_5+1][i_4] + H[i_5][i_6][i_4] + C[i_5+i_4-1][i_6][i_5] - 5;
            }
        }
        A[i_4] = E[i_4] + F[i_4] - E[i_4+1] - J[i_4+1][i_4] * E[i_4] + A[i_4+1] + 1;
    }
#pragma endscop
...
kernel_3436251211_01(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
