...
void kernel_4316312225_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf)){
...
#pragma scop
        ...
        for (int i_1 = i_0 - 1; i_1 >= 1; i_1--) {
            for (int i_2 = 0; i_2 < -i_1+PB_M; i_2++) {
                for (int i_3 = 0; i_3 < PB_Q-3; i_3++) {
                    A[i_2+i_1][i_3][i_3][i_3+2] = D[i_3+1][i_1][i_0-2][i_3] * E[i_0][i_1][i_3] * A[i_2+i_1-1][i_3+1][i_3+1][i_3+3] * 6;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_N+1; i_4++) {
        B[i_4-2] = F[i_4-1] + 4;
        for (int i_5 = max(i_4, 3); i_5 < PB_L+3; i_5++) {
            B[i_4-2] = B[i_5-3] - B[i_4-2] - 1;
        }
    }
#pragma endscop
...
kernel_4316312225_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F));
