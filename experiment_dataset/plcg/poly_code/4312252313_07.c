...
void kernel_4312252313_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        A[i_0] = D[i_0] - D[i_0] + D[i_0] + D[i_0+1] * E[i_0] * A[i_0+1] - A[i_0-1] * 1;
    }
    for (int i_1 = 3; i_1 < PB_N; i_1++) {
        for (int i_2 = 3; i_2 < PB_L; i_2++) {
            for (int i_3 = 1; i_3 < -i_1+PB_N+2; i_3++) {
                B[i_2][i_3][i_1-2][i_3] = F[i_1][i_3][i_2] * G[i_2][i_3+i_1-2][i_3][i_1] - H[i_3][i_1][i_2] + F[i_1][i_2][i_3-1] - B[i_3][i_1][i_2-3][i_1] - B[i_3][i_1-1][i_2-2][i_1-1] - B[i_3-1][i_2-1][i_1-1][i_2-1] - B[i_3][i_2][i_1-3][i_2] + 2;
            }
        }
        for (int i_4 = 0; i_4 < PB_N-2; i_4++) {
            for (int i_5 = 2; i_5 < -i_1+PB_P; i_5++) {
                for (int i_6 = i_5; i_6 < min(-i_4+PB_P, -i_1+PB_P-1); i_6++) {
                    C[i_1][i_4+1][i_5+2][i_6] = I[i_5][i_6+i_4][i_1-2][0] - I[i_4][i_5+i_1][i_6][i_1] * F[i_6][i_1][i_5+1] - G[i_5-2][i_4+2][i_6][i_1] + I[i_6][i_6+i_1+1][i_4+2][i_5+2] - B[i_5][i_6][i_1-2][i_6] - C[i_1][i_6][i_5+2][i_4] - C[i_1][i_4+1][i_5+1][i_6] - 3;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4312252313_07(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I)));
