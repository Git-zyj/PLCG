...
void kernel_3424251115_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,int zk,int vk,DATA_TYPE POLYBENCH_4D(K,xK,yK,zK,vK,xk,yk,zk,vk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        A[i_0+1] = E[i_0-1] + F[i_0] * G[i_0][1] + F[i_0] * E[i_0] + A[i_0] + 6;
    }
    for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
        A[i_1+1] = H[i_1][0] - E[i_1+1] - F[i_1-1] - F[i_1] - E[i_1+1] * 6;
        for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
            A[i_1] = H[i_1][i_1] * E[i_1] - H[i_2][i_1-1] + G[i_2+1][i_1] - G[i_2+1][i_1-1] - 5;
            for (int i_3 = 1; i_3 < PB_M; i_3++) {
                A[i_3+1] = H[i_2][i_1] - I[i_3][i_1][i_2] - I[i_3-1][i_1][i_2] - J[i_1][i_2+1][i_3-1] - K[i_2-1][i_3-1][0][i_1+1] + 2;
            }
        }
    }
#pragma endscop
...
kernel_3424251115_07(xa,POLYBENCH_ARRAY(A), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K));
