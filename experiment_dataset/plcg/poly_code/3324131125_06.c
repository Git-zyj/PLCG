...
void kernel_3324131125_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_M-3; i_1++) {
        B[i_1+1] = D[i_1] * D[i_1] - D[i_1-1] * D[i_1] * D[i_1+1] + 5;
        B[i_1+2] = D[i_1] * D[i_1] * B[i_1+3] - 3;
    }
#pragma endscop
...
kernel_3324131125_06(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
