...
void kernel_4214352113_01(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve)){
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_1+PB_L, -i_0+PB_L-1); i_2++) {
                for (int i_3 = 1; i_3 < -i_1+PB_L; i_3++) {
                    B[i_3][i_2][i_1][i_0+1] = C[i_0][i_3][i_2+i_1][0] + C[i_3+1][i_0][i_3+i_1][i_2] - C[i_0-2][i_2][i_1][i_3] * C[i_3+i_2][i_0][i_3][i_1-1] + D[i_1][i_2][i_0-1][i_3+1] + E[i_3-1][i_1][i_2+i_0+1][0] + 5;
                }
            }
        }
    }
        ...
        for (int i_5 = i_4; i_5 < PB_L-1; i_5++) {
            for (int i_6 = 0; i_6 < -i_5+PB_L; i_6++) {
                for (int i_7 = i_6; i_7 < PB_P; i_7++) {
                    B[i_4][i_6][i_5][i_7] = C[i_7][i_6][i_5+1][i_6+2] + C[i_7][i_4-2][i_6+i_5][1] - E[i_6][i_7][i_4+1][i_5] * C[i_4+1][i_7][i_4][i_6] - B[i_4][i_6][i_5-1][i_7] - 4;
                }
            }
        }
    }
...
kernel_4214352113_01(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
