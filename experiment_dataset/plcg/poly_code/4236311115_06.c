...
void kernel_4236311115_06(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = max(1, i_0); i_1 < PB_P; i_1++) {
            for (int i_2 = 0; i_2 < PB_M; i_2++) {
                for (int i_3 = 0; i_3 < PB_Q; i_3++) {
                    B[i_2][i_1-1][i_3] = C[i_3][i_1][i_2] + 2;
                }
            }
        }
    }
        ...
        for (int i_5 = i_4; i_5 < PB_M; i_5++) {
            for (int i_6 = 1; i_6 < PB_L; i_6++) {
                for (int i_7 = 0; i_7 < PB_Q; i_7++) {
                    B[i_5][i_6-1][i_7] = B[i_5][i_6][i_7] * 2;
                }
            }
        }
    }
...
kernel_4236311115_06(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
