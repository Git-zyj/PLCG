        ...
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            for (int i_2 = 1; i_2 < min(i_1, PB_M-2); i_2++) {
                for (int i_3 = 0; i_3 < -i_2+PB_Q; i_3++) {
                    A[i_0+2][i_0][i_2][0] = C[i_3][i_1][i_0][i_3] * D[i_0+1][i_1-1][i_3][i_3+i_2] + E[i_2+2][i_2+1][i_1-1] * C[i_1][i_3][i_0][i_2-1] + C[i_2][i_0][i_1+1][i_1] * A[i_0+2][i_0][i_1-1][0] - A[i_0+2][i_0][i_2+1][0] + A[i_0+3][i_0+1][i_2+2][0] + 3;
                }
            }
        }
        B[i_0] = F[i_0] + F[i_0] * F[i_0-1] - G[i_0-2] - B[i_0+2] * B[i_0-2] - B[i_0-1] + 6;
    }
#pragma endscop
...
kernel_4212252323_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
