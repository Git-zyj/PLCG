...
static void print_array(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,int wb,DATA_TYPE POLYBENCH_5D(B,xB,yB,zB,vB,wB,xb,yb,zb,vb,wb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk))
{
int i_0, i_1, i_2, i_3, i_4;
...
void kernel_4416331311_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,int wb,DATA_TYPE POLYBENCH_5D(B,xB,yB,zB,vB,wB,xb,yb,zb,vb,wb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_Q-1; i_0++) {
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < min(min(-i_0+PB_L, PB_P-1), -i_1+PB_L+1); i_2++) {
                for (int i_3 = 1; i_3 < i_2; i_3++) {
                    A[i_3+i_2][i_1][i_0][i_0] = E[i_2+1][i_0-1][i_3+1][i_1-1] + F[i_2-1][i_3-1][i_1+1] + A[i_3+i_0][i_2+1][i_1][i_1] - A[i_2+i_0][i_3][i_1][i_1] - A[i_3+i_2+1][i_1+1][i_0][i_0] + A[i_2+i_1-1][i_3+1][i_0+1][i_0+1] - 5;
                }
            }
        }
        for (int i_4 = i_0; i_4 < PB_Q-1; i_4++) {
            for (int i_5 = 0; i_5 < PB_Q-2; i_5++) {
                for (int i_6 = 0; i_6 < PB_P; i_6++) {
                    B[i_0+1][i_4][i_5+1][i_0+1][i_6] = G[i_6][i_0][i_4][i_5] * E[i_0][i_6][i_4+1][i_5] + H[i_6+1][i_0][i_4][i_5] + B[i_0+1][i_4][i_5+2][i_0+1][i_6] + 2;
                }
            }
        }
    }
    for (int i_7 = 2; i_7 < PB_N; i_7++) {
        for (int i_8 = 1; i_8 < min(-i_7+PB_M-1, i_7); i_8++) {
            for (int i_9 = 1; i_9 < min(-i_7+PB_L-1, i_8); i_9++) {
                C[i_9+i_8][i_8-1] = F[i_9][i_7][i_9+i_8-1] - I[i_9][i_7][i_8] - J[i_9][i_8] * J[i_7][i_9] * F[i_8][i_9+i_7+1][i_7] * K[i_8][i_9] * C[i_9+i_7-1][i_9-1] * C[i_8+i_7+1][i_8] * 6;
            }
        }
        D[i_7-1] = D[i_7-2] * D[i_7] + 5;
    }
#pragma endscop
...
kernel_4416331311_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,wb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K));
