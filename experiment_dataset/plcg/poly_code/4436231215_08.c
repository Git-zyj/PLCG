...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_L; i_1++) {
        for (int i_2 = 0; i_2 < i_1; i_2++) {
            C[i_1][i_2][i_1] = G[i_2][i_1] * E[i_2] - G[i_1][i_2+1] - 4;
        }
    }
    for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
        for (int i_4 = i_3; i_4 < PB_L; i_4++) {
            for (int i_5 = 0; i_5 < -i_4+PB_M; i_5++) {
                C[i_3][i_4][i_3] = H[i_3][i_5+i_4][i_4] * I[i_4+1][i_5+i_4][i_3-1] * I[i_3][i_5][i_4] + H[i_4+1][i_3+1][i_5+i_4-1] * C[i_3][i_4+1][i_3] - C[i_5][i_4+1][i_5] - 6;
            }
        }
    }
        ...
        for (int i_7 = i_6; i_7 < PB_M; i_7++) {
            for (int i_8 = 0; i_8 < PB_M; i_8++) {
                for (int i_9 = 0; i_9 < PB_P-2; i_9++) {
                    D[i_6][i_7][i_8][i_9+1] = D[i_6+1][i_7][i_8][i_9+2] + D[i_6-1][i_8][i_7][i_9+1] * 2;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4436231215_08(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
