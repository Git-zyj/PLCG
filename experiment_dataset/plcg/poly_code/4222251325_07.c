...
void kernel_4222251325_07(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_L-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_Q; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_Q; i_3++) {
                    B[i_3][i_3+i_1][i_2][i_1] = C[i_1+i_0][i_2][i_1][i_3+i_1] + D[i_1+1][i_2+1][i_3+i_0][i_0] - D[i_1][i_2][i_0][i_1] * E[i_0][i_1][i_1][i_3][i_2] - C[i_0-1][i_3][i_2-1][i_1] - D[i_1][i_0][i_2][i_3] * 5;
                }
            }
            for (int i_4 = 1; i_4 < min(PB_L-3, -i_0+PB_P); i_4++) {
                for (int i_5 = 0; i_5 < min(-i_4+PB_L-3, -i_0+PB_L-1); i_5++) {
                    B[i_5][i_5+i_1][i_4-1][i_1] = C[i_5][i_1][i_4+i_0][i_5] * F[i_1+1][i_4][i_5+i_4+1] * C[i_4][i_0][i_5][i_1] + B[i_5+1][i_5+i_4+3][i_1-1][i_4+2] * B[i_5][i_5+i_0+1][i_4+1][i_0+1] * B[i_0+1][i_1+i_0+1][i_4-1][i_1] * 3;
                }
            }
        }
    }
...
kernel_4222251325_07(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
