...
void kernel_4312131125_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_L-3; i_1++) {
        B[i_1+1] = D[i_1] - D[i_1-1] + B[i_1] - B[i_1+3] * 5;
        A[i_1+1] = D[i_1+1] * D[i_1-1] + D[i_1] - D[0] - 3;
    }
#pragma endscop
...
kernel_4312131125_02(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
