...
void kernel_3336312325_05(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-2; i_0++) {
        C[i_0+2] = D[i_0+1] * C[i_0] + 2;
    }
...
kernel_3336312325_05(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
