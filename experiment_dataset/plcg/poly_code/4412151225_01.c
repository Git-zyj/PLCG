...
void kernel_4412151225_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_Q-1, -i_1+PB_Q); i_2++) {
                for (int i_3 = 1; i_3 < min(-i_1+PB_L, -i_0+PB_P); i_3++) {
                    A[i_0][i_1][i_2+1][i_3] = E[i_2][i_3-1][i_0][i_0-1] - E[i_1][i_3+i_2-1][i_0][1] - E[i_3][i_2][i_2+i_0+1][i_1] - E[i_3][i_0-1][i_1][i_2+i_1] + E[i_1][i_3+i_0][i_2-1][0] + E[i_1][i_0-1][i_2][i_2+1] - E[i_3+i_1][i_0][i_2][0] + E[i_2-1][i_3+1][i_0+1][0] + E[i_2][i_0][i_1][i_0] * A[i_3][i_0][i_2+1][i_1-1] + B[i_2][i_2] + 3;
                }
                B[i_1][i_1] = F[i_2+1][i_0-1][0] + F[i_2][i_0+1][i_1] + F[i_2][i_0+1][i_1] * F[i_2+1][i_0][i_1] * B[i_1+2][i_1+2] * 5;
            }
        }
        for (int i_4 = 1; i_4 < PB_L-2; i_4++) {
            B[i_0][i_0] = G[i_4+1][i_0+1] * G[i_4][i_0+1] - G[i_4+1][i_0-1] * 3;
            B[i_4+2][i_4+2] = G[i_4-1][i_0] * 6;
        }
    }
#pragma endscop
...
kernel_4412151225_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
