...
void kernel_2222111315_08(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < PB_M-1; i_1++) {
            B[i_1] = C[i_1+1] - B[i_0] * B[i_1] + 6;
        }
        B[i_0] = B[i_0-1] + 3;
    }
#pragma endscop
...
kernel_2222111315_08(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
