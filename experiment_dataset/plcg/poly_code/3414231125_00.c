    ...
    for (int i_2 = 1; i_2 < PB_L; i_2++) {
        ...
        for (int i_3 = 1; i_3 < PB_L; i_3++) {
            for (int i_4 = 1; i_4 < PB_P; i_4++) {
                D[i_2+1][i_3-1][i_4] = G[i_4][i_2-1][i_3] * H[i_3][i_2][i_2] - G[i_2][i_4-1][i_3] * 3;
            }
        }
    }
#pragma endscop
...
kernel_3414231125_00(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
