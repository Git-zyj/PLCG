...
void kernel_2434111325_08(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
    ...
    for (int i_4 = 1; i_4 < PB_M-3; i_4++) {
        D[i_4+1] = E[i_4] - D[i_4+2] - D[i_4+3] * D[i_4-1] * D[i_4] * D[i_4] - 2;
    }
#pragma endscop
...
kernel_2434111325_08(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
