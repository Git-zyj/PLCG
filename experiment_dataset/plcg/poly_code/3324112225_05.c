...
void kernel_3324112225_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            for (int i_2 = 2; i_2 < PB_M; i_2++) {
                A[i_1][i_0][i_2] = D[i_2][i_0][i_1] - A[i_1-1][i_0][i_2-2] - 3;
            }
        }
        for (int i_3 = 1; i_3 < PB_M-2; i_3++) {
            for (int i_4 = 0; i_4 < PB_M; i_4++) {
                A[i_4][i_3+2][i_0+2] = A[i_4][i_0+1][i_3-1] * 4;
            }
        }
    }
    for (int i_5 = 0; i_5 < PB_M-2; i_5++) {
        for (int i_6 = max(1, i_5); i_6 < -i_5+PB_Q; i_6++) {
            for (int i_7 = 0; i_7 < PB_M; i_7++) {
                A[i_5+2][i_7][i_6-1] = D[i_6][i_5][i_6+i_5] + 6;
            }
        }
    }
#pragma endscop
...
kernel_3324112225_05(xa,ya,za,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D));
