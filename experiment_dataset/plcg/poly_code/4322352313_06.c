...
void kernel_4322352313_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk)){
        ...
        for (int i_1 = 2; i_1 < PB_P-2; i_1++) {
            for (int i_2 = 2; i_2 < PB_Q-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_L; i_3++) {
                    A[i_0][i_1][i_3][i_2] = D[i_3][i_0][i_1-2][i_2] * D[i_1][i_3][i_0-1][i_2] + E[i_1][i_1+2][i_2] + F[i_2-2][i_0-1][i_1][i_3] + A[i_3-1][i_1][i_0][i_2-1] * A[i_0+1][i_1][i_3][i_2] + A[i_0-1][i_1][i_3][i_2+1] * 4;
                }
            }
        }
        for (int i_4 = 2; i_4 < PB_M-1; i_4++) {
            for (int i_5 = 2; i_5 < min(-i_0+PB_Q, PB_N-2); i_5++) {
                for (int i_6 = 2; i_6 < min(-i_0+PB_Q, PB_M); i_6++) {
                    B[i_0][i_6-2][i_4][i_6] = G[i_4][i_6][i_0-1][i_5+i_0] + H[i_5][i_4+1][i_5][i_0][i_6+1] - F[i_6][i_4][i_5+i_0][i_4] * F[i_5-1][i_0][i_6-2][i_4-2] * G[i_5+2][i_0][i_4][i_4] * D[i_5-2][i_4+1][i_6+i_0][i_5] - B[i_0-1][i_6-2][i_5][i_6] + B[i_4+1][i_6-2][i_0+1][i_6] - B[i_4][i_6-1][i_5][i_6+1] + 6;
                }
            }
        }
        for (int i_7 = 3; i_7 < PB_N; i_7++) {
            for (int i_8 = 0; i_8 < PB_M; i_8++) {
                B[i_0][i_7-3][i_8+1][i_7-1] = I[i_0][i_8][i_7] * I[i_8][i_0][i_7] * J[i_0][i_7] * K[i_7][i_0][i_0] * F[i_8][i_7][i_0-1][i_7] * 4;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4322352313_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K)));
