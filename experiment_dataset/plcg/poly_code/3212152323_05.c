...
void kernel_3212152323_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        ...
        for (int i_3 = 2; i_3 < PB_M-2; i_3++) {
            for (int i_4 = 2; i_4 < min(-i_3+PB_M, -i_0+PB_L); i_4++) {
                A[i_3-1][i_4][i_0+2] = C[i_3][i_0][i_0] + C[i_0][i_4][i_3-2] * C[i_3][i_0-2][i_4] * C[i_3][1][i_4+i_0] * C[i_4+i_3][i_4-1][i_0+1] - C[i_0][i_4][i_3] * C[i_4][i_0][i_3+2] + C[i_3+2][i_4][i_0] + C[i_3][i_0][i_4] - A[i_4-1][i_3+1][i_0] + A[i_3][i_4][i_0] * A[i_3+1][i_4-2][i_0+2] * 1;
            }
        }
    }
#pragma endscop
...
kernel_3212152323_05(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C));
