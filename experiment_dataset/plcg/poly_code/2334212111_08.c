...
void kernel_2334212111_08(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_N-3; i_1++) {
        ...
        C[i_1+2] = D[i_1] + D[2] * E[i_1+1] + C[i_1+3] * 4;
    }
#pragma endscop
...
kernel_2334212111_08(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
