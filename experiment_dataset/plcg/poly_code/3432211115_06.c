...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_M; i_1++) {
        ...
        for (int i_3 = 0; i_3 < PB_M; i_3++) {
            C[i_1][i_3] = F[i_1-1] - G[i_1][i_3] * A[i_3] * 5;
        }
    }
    for (int i_4 = 1; i_4 < PB_M; i_4++) {
        for (int i_5 = 1; i_5 < PB_M+1; i_5++) {
            B[i_4] = H[i_5-1][i_4-1] * 5;
        }
    }
#pragma endscop
...
kernel_3432211115_06(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
