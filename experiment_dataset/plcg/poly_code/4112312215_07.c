...
void kernel_4112312215_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-2; i_0++) {
        A[i_0+1] = B[i_0+2] - A[i_0+2] * A[i_0] + 6;
    }
#pragma endscop
...
kernel_4112312215_07(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
