...
void kernel_2224131325_01(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_N-2; i_1++) {
        B[i_1] = C[i_1+1] * C[i_1] * C[i_1+1] - B[i_1-2] - B[i_1+2] - B[i_1+1] + 4;
    }
#pragma endscop
...
kernel_2224131325_01(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
