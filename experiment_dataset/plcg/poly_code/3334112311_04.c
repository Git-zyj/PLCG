...
void kernel_3334112311_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 0; i_1 < PB_N; i_1++) {
            for (int i_2 = 1; i_2 < PB_N; i_2++) {
                A[i_2][i_0+2][i_0+1] = A[i_2][i_0+1][i_0] - A[i_2-1][i_0+2][i_0+1] * 6;
            }
        }
    }
    ...
    for (int i_5 = 1; i_5 < PB_N-1; i_5++) {
        for (int i_6 = max(2, i_5); i_6 < -i_5+PB_N-1; i_6++) {
            for (int i_7 = 0; i_7 < min(PB_M, -i_6+PB_Q-1); i_7++) {
                C[i_5][i_7+i_6][i_6+2] = D[i_6+i_5+1][i_7][0] - C[i_7+1][i_6+i_5][i_5+1] * C[i_5][i_7+i_6-2][i_6+1] * C[i_5-1][i_7+i_6+1][i_6+2] + 2;
            }
        }
    }
#pragma endscop
...
kernel_3334112311_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
