...
void kernel_4316311113_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve)){
        ...
        for (int i_5 = 0; i_5 < -i_4+PB_P; i_5++) {
            for (int i_6 = 0; i_6 < PB_P; i_6++) {
                for (int i_7 = 1; i_7 < PB_P; i_7++) {
                    B[i_7-1][i_7-1][i_7][i_6+i_5] = D[i_6+i_5][i_7-1][i_5+i_4][i_4+1] * A[i_5+1][i_6][i_7-1][i_7] - B[i_7-1][i_7-1][i_7][i_5+i_4-1] * 2;
                }
            }
        }
        for (int i_8 = i_4; i_8 < PB_Q-2; i_8++) {
            for (int i_9 = 0; i_9 < -i_4+PB_P+1; i_9++) {
                for (int j_0 = 0; j_0 < PB_Q; j_0++) {
                    A[i_4+1][i_9][i_8+1][i_8+2] = E[i_8][i_9+i_4-1][i_9][i_8+1] - 5;
                }
            }
        }
    }
...
kernel_4316311113_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
