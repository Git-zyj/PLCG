...
void kernel_4424111111_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
    ...
    for (int i_4 = 2; i_4 < PB_M-1; i_4++) {
        ...
        for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
            for (int i_6 = 0; i_6 < PB_M; i_6++) {
                C[i_4-1][i_5+1][i_6] = C[i_4][i_5+1][i_6] + C[i_4-2][i_5+1][i_6] + 2;
            }
        }
        D[i_4+1] = E[i_4] + 6;
    }
...
kernel_4424111111_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
