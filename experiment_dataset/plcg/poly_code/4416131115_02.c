...
void kernel_4416131115_02(int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
        ...
        for (int i_1 = 2; i_1 < min(-i_0+PB_M-1, i_0); i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_P; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_M; i_3++) {
                    D[i_2-1][i_3] = E[i_3+i_0][i_2+i_1][i_0][1] + 4;
                }
            }
            D[i_1-2][i_0] = F[i_0-1][i_1-1] + F[i_0+1][i_1] - F[i_1+1][i_0] + G[i_1+i_0+1][i_0][0] - F[i_0+1][i_1] - 5;
            for (int i_4 = 1; i_4 < i_0; i_4++) {
                D[i_4-1][i_1] = G[i_4-1][i_0][i_1-1] - 2;
            }
        }
        for (int i_5 = 0; i_5 < min(-i_0+PB_M-1, i_0); i_5++) {
            D[i_0-1][i_5] = H[1] - F[i_5+1][i_0] - F[i_5+i_0+1][i_0] - F[i_5][i_0] + H[i_5+1] - D[i_0][i_5] + 5;
        }
    }
#pragma endscop
...
init_array(xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4416131115_02(xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H)));
