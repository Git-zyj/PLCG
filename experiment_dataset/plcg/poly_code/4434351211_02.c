...
static void print_array(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,int wb,DATA_TYPE POLYBENCH_5D(B,xB,yB,zB,vB,wB,xb,yb,zb,vb,wb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,int zk,int vk,int wk,DATA_TYPE POLYBENCH_5D(K,xK,yK,zK,vK,wK,xk,yk,zk,vk,wk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl),int xm,int ym,int zm,DATA_TYPE POLYBENCH_3D(M,xM,yM,zM,xm,ym,zm),int xn,int yn,int zn,DATA_TYPE POLYBENCH_3D(N,xN,yN,zN,xn,yn,zn),int xo,DATA_TYPE POLYBENCH_1D(O,xO,xo),int xp,int yp,DATA_TYPE POLYBENCH_2D(P,xP,yP,xp,yp))
{
int i_0, i_1, i_2, i_3, i_4;
...
void kernel_4434351211_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,int wb,DATA_TYPE POLYBENCH_5D(B,xB,yB,zB,vB,wB,xb,yb,zb,vb,wb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,int zk,int vk,int wk,DATA_TYPE POLYBENCH_5D(K,xK,yK,zK,vK,wK,xk,yk,zk,vk,wk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl),int xm,int ym,int zm,DATA_TYPE POLYBENCH_3D(M,xM,yM,zM,xm,ym,zm),int xn,int yn,int zn,DATA_TYPE POLYBENCH_3D(N,xN,yN,zN,xn,yn,zn),int xo,DATA_TYPE POLYBENCH_1D(O,xO,xo),int xp,int yp,DATA_TYPE POLYBENCH_2D(P,xP,yP,xp,yp)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        A[i_0+1] = E[i_0+1] + F[i_0] + F[i_0] * G[i_0][1] + 1;
    }
        ...
        for (int i_2 = i_1; i_2 < -i_1+PB_N-1; i_2++) {
            for (int i_3 = 1; i_3 < min(-i_1+PB_L, -i_2+PB_M); i_3++) {
                for (int i_4 = 1; i_4 < i_3; i_4++) {
                    B[i_1+1][i_2][i_4][i_3][i_1] = H[i_3-1][i_1][i_4+i_2-1][i_4+i_3-1] * I[i_4][i_3][i_2+1][i_1] * J[i_1][i_3][i_4][i_2] - K[i_4-1][i_1][i_3+1][i_4][i_3+i_2] + J[i_2+i_1+1][i_3][i_1-1][i_3] + B[i_3][i_2-1][i_4-1][i_1][i_3-1] + B[i_1][i_2][i_4-1][i_3][i_1-1] + B[i_1][i_3][i_2][i_4+1][i_1-1] - 2;
                }
                D[i_3] = L[i_3][i_2][i_1] - L[i_1+1][i_2][i_2-1] - L[i_2+1][i_2+i_1][i_3+i_1] - M[i_3+i_2][i_1-1][i_1] - J[i_3-1][i_2+i_1-1][i_3+i_1][0] * N[i_3][i_1][i_2] * N[i_2+i_1][i_3-1][i_1] + D[i_2] * D[i_2-1] + 4;
            }
            D[i_2] = O[i_2+1] - P[i_2][i_2] * P[i_1][i_2] * O[i_2] + A[i_2+1] + 6;
        }
    }
#pragma endscop
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,wb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,wk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,zm,POLYBENCH_ARRAY(M), xn,yn,zn,POLYBENCH_ARRAY(N), xo,POLYBENCH_ARRAY(O), xp,yp,POLYBENCH_ARRAY(P), INIT_SEED);
kernel_4434351211_02(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,wb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,wk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,zm,POLYBENCH_ARRAY(M), xn,yn,zn,POLYBENCH_ARRAY(N), xo,POLYBENCH_ARRAY(O), xp,yp,POLYBENCH_ARRAY(P));
