...
void kernel_4414251121_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        B[i_0-1] = E[i_0] * F[i_0-1] + F[i_0-1] - E[i_0] - B[i_0-1] * 1;
        for (int i_1 = 1; i_1 < -i_0+PB_M-1; i_1++) {
            B[i_1-1] = G[i_1][i_0+1] * G[i_1+i_0+1][i_1-1] * H[i_1+1][i_0+1] + E[i_0] - 1;
        }
    }
    for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
        C[i_2] = F[i_2] - G[i_2][0] * F[i_2+1] * F[i_2] + F[i_2+1] - F[i_2] - F[i_2] + 5;
        D[i_2] = E[i_2+1] - F[i_2] * 4;
    }
#pragma endscop
...
kernel_4414251121_06(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
