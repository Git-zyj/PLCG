    ...
    for (int i_3 = 1; i_3 < PB_L-2; i_3++) {
        for (int i_4 = 0; i_4 < -i_3+PB_L-2; i_4++) {
            for (int i_5 = 2; i_5 < PB_L; i_5++) {
                B[i_3-1][i_5][i_4+i_3+2] = H[i_5][i_3][i_5] - F[i_4][i_3] * G[i_4][i_5][i_4] * H[i_4][i_5-2][i_3] * 2;
            }
        }
    }
#pragma endscop
...
kernel_4336232125_03(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
