...
void kernel_4322351323_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        for (int i_1 = 1; i_1 < PB_L-2; i_1++) {
            for (int i_2 = i_0; i_2 < min(-i_0+PB_M, -i_1+PB_L+1); i_2++) {
                for (int i_3 = 2; i_3 < min(min(-i_0+PB_M, PB_P-1), -i_2+PB_P); i_3++) {
                    A[i_0][i_3][i_1+1][i_2] = D[i_2][i_0][i_3+1][i_1] - E[i_0][i_3+i_2][i_1][i_3] - E[i_3+i_0][i_1-1][i_1-1][i_2] + F[i_2+i_0][i_2+i_1-1][i_3][i_3] - E[i_1][i_0][i_3][i_2] * A[i_3-2][i_0][i_1+2][i_2] - 5;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_L; i_4++) {
        for (int i_5 = 0; i_5 < PB_L; i_5++) {
            for (int i_6 = 2; i_6 < PB_P-1; i_6++) {
                C[i_4][i_4][i_6-2] = E[i_4][i_6+1][i_6][i_5] + G[i_6][i_5][i_4+1] + F[i_6][i_5][i_4][0] * 3;
            }
        }
    }
    for (int i_7 = 2; i_7 < PB_L-2; i_7++) {
        for (int i_8 = 0; i_8 < -i_7+PB_P; i_8++) {
            for (int i_9 = 1; i_9 < PB_P-2; i_9++) {
                C[i_7][i_7][i_9] = G[i_8+1][i_7][i_9] + H[i_8][i_8+i_7][i_7+1] * I[i_8][i_9][i_7+1] - I[i_9-1][i_9][i_8] * G[i_8][i_9][i_7] * C[i_7-2][i_7-2][i_9+1] - C[i_8][i_8][i_9+2] * C[i_7+2][i_7+2][i_9+2] + C[i_7][i_7][i_9+1] * 5;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4322351323_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
