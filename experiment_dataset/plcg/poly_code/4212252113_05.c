...
void kernel_4212252113_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
        ...
        for (int i_1 = 2; i_1 < PB_N-2; i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_N-2; i_2++) {
                for (int i_3 = 1; i_3 < i_2; i_3++) {
                    A[i_1][i_3][i_2+2] = C[i_2][i_1-2][i_0] * D[i_2+i_1+2][i_0][i_3][i_2+1] * D[i_1][i_3-1][i_3+i_2][i_0] * E[i_0][i_1][i_3+i_2][0] * A[i_3][i_1][i_2+3] - 1;
                }
            }
            for (int i_4 = 0; i_4 < -i_1+PB_L; i_4++) {
                B[i_1][i_0][i_4+i_1] = F[i_1][i_4][i_0] + C[i_1][i_4+2][i_0] - C[i_1][i_0][0] + G[i_4][i_4] - C[i_4+i_1][i_0][0] - 6;
            }
        }
    }
#pragma endscop
...
kernel_4212252113_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
