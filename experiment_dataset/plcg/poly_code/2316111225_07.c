...
void kernel_2316111225_07(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
kernel_2316111225_07(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
