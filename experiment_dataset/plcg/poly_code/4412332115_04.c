        ...
        for (int i_1 = i_0; i_1 < PB_L-1; i_1++) {
            for (int i_2 = i_1; i_2 < -i_1+PB_L-1; i_2++) {
                for (int i_3 = 0; i_3 < PB_L; i_3++) {
                    A[i_0][i_3][i_2+2][0] = D[i_0-1][i_2+i_1+1][i_3][i_3] * 3;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-2; i_4++) {
        for (int i_5 = 1; i_5 < -i_4+PB_M-1; i_5++) {
            for (int i_6 = 0; i_6 < -i_5+PB_M-2; i_6++) {
                B[i_4][i_6+i_5+2][i_5] = E[i_5+1][i_4][i_5] + E[i_5][i_4][i_5+2] - E[i_4-2][i_6][i_5] + F[i_5+i_4+1][i_6+i_5][1] - G[i_4+2][i_5-1][i_4][i_6] * 5;
            }
        }
        C[i_4] = C[i_4-1] - 6;
        for (int i_7 = 0; i_7 < PB_L-1; i_7++) {
            for (int i_8 = 0; i_8 < min(-i_7+PB_L, PB_L-1); i_8++) {
                for (int i_9 = 0; i_9 < PB_M; i_9++) {
                    D[i_4][i_8+i_7][i_9][i_9] = H[i_9][i_7+1][i_9+1][i_8+1] + H[i_7][i_8+1][i_4-1][i_8] - G[i_9][i_4][i_7][i_4] * I[i_8][i_9][i_7][2] + 5;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4412332115_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I)));
