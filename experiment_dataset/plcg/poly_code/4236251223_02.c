...
void kernel_4236251223_02(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_L+1; i_2++) {
                for (int i_3 = 0; i_3 < PB_P-2; i_3++) {
                    B[i_2][i_1][i_3+2] = C[i_3][i_2+i_0-1][i_1][0] + C[i_2+1][i_3][i_1][i_0] - D[i_3][i_0][i_1][i_2] * E[i_1+1][i_2][i_0][i_3][i_2] - 2;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_L; i_4++) {
        for (int i_5 = 0; i_5 < i_4; i_5++) {
            for (int i_6 = max(2, i_5); i_6 < -i_5+PB_N; i_6++) {
                for (int i_7 = 1; i_7 < PB_L-2; i_7++) {
                    B[i_5][i_7][i_6] = D[i_6][i_7][i_5][0] + F[i_6+i_5][i_4][i_7] + C[i_6][i_4][i_7][i_7] - C[i_7-1][i_4][i_6][i_5] - C[i_7][i_6][i_7+1][0] + B[i_5+1][i_7][i_6-2] - B[i_5][i_7+2][i_6] - 5;
                }
            }
        }
    }
...
kernel_4236251223_02(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
