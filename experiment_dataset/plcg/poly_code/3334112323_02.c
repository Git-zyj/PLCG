...
void kernel_3334112323_02(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        for (int i_1 = i_0; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 2; i_2 < PB_M; i_2++) {
                B[i_2-2][i_1+1] = D[i_2][i_1+2][i_0-2] + C[i_1+2][i_0+1][i_2-1] + 2;
            }
        }
    }
    for (int i_3 = 0; i_3 < PB_M-2; i_3++) {
        for (int i_4 = 0; i_4 < PB_M-1; i_4++) {
            for (int i_5 = 1; i_5 < min(PB_L-3, i_3); i_5++) {
                B[i_4][i_5+1] = B[i_3+2][i_5+1] - B[i_4+1][i_5+3] + B[i_4][i_5-1] - B[i_4+1][i_5+1] + 2;
            }
        }
    }
    for (int i_6 = 1; i_6 < PB_L-1; i_6++) {
        for (int i_7 = 0; i_7 < PB_M-1; i_7++) {
            for (int i_8 = 0; i_8 < PB_P; i_8++) {
                C[i_7+1][i_6+1][i_8] = C[i_7+1][i_6-1][i_8] + 2;
            }
        }
    }
#pragma endscop
...
kernel_3334112323_02(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
