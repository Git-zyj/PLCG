    ...
    for (int i_3 = 1; i_3 < PB_P-1; i_3++) {
        for (int i_4 = i_3; i_4 < PB_N-1; i_4++) {
            for (int i_5 = 1; i_5 < -i_4+PB_N-1; i_5++) {
                C[i_3][i_3] = F[i_5+i_4+1][i_3+1] - C[i_5-1][i_5-1] - C[i_5+2][i_5+2] - C[i_3-1][i_3-1] * 4;
            }
        }
        for (int i_6 = 1; i_6 < i_3; i_6++) {
            for (int i_7 = 0; i_7 < min(PB_P, -i_3+PB_Q-2); i_7++) {
                D[i_7][i_6][i_7+i_3+1][i_6] = G[i_6][i_3+1][i_7] - B[i_7][i_3-1][i_6-1] + B[i_6+2][i_3-1][i_7] + D[i_7+1][i_6][i_7+i_3+2][i_6] * D[i_7][i_6][i_7+i_3+2][i_6] + 2;
            }
        }
    }
#pragma endscop
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_3416211321_09(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G)));
