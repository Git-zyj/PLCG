...
void kernel_4314212111_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 0; i_1 < PB_P-2; i_1++) {
            ...
            for (int i_2 = 0; i_2 < min(-i_0+PB_P+1, -i_1+PB_P); i_2++) {
                B[i_0][i_0][i_2+i_1] = D[i_2][i_1][i_0-1] + B[i_1][i_1][i_2+i_0-1] - 4;
            }
        }
        for (int i_3 = 0; i_3 < i_0; i_3++) {
            for (int i_4 = 1; i_4 < PB_M+1; i_4++) {
                for (int i_5 = 0; i_5 < PB_P-1; i_5++) {
                    C[i_0][i_3][i_5][i_5] = C[i_4-1][i_3][i_5+1][i_5+1] + 3;
                }
            }
        }
    }
...
kernel_4314212111_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
