...
void kernel_3422111213_06(int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
    ...
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < min(i_0, PB_M-1); i_1++) {
            ...
            for (int i_3 = 0; i_3 < min(-i_1+PB_N-1, PB_M); i_3++) {
                D[i_3+i_1+1][i_0][i_1] = E[i_1+1][i_3][i_0] - 1;
            }
        }
        for (int i_4 = i_0; i_4 < PB_M-1; i_4++) {
            for (int i_5 = 0; i_5 < -i_0+PB_N+1; i_5++) {
                D[i_5+i_0-1][i_4+1][i_0] = 1;
            }
            for (int i_6 = 0; i_6 < -i_0+PB_N-1; i_6++) {
                D[i_6+i_0][i_4][i_0] = D[i_6+i_0+1][i_4-1][i_0+1] * D[i_6+i_0-1][i_4][i_0] + 4;
            }
        }
    }
#pragma endscop
...
kernel_3422111213_06(xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
