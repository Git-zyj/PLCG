...
void kernel_4322112323_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
    ...
    for (int i_2 = 1; i_2 < PB_Q; i_2++) {
        for (int i_3 = 0; i_3 < PB_L-1; i_3++) {
            for (int i_4 = 0; i_4 < -i_2+PB_P-2; i_4++) {
                B[i_2+1][i_3+1][i_4+i_2] = B[i_2+1][i_3+1][i_4+i_2+1] * B[i_2+1][i_3+1][i_4+i_2+2] * 6;
            }
        }
        for (int i_5 = 0; i_5 < PB_P-2; i_5++) {
            for (int i_6 = 0; i_6 < PB_M-2; i_6++) {
                C[i_6+2][i_5][i_2-1] = C[i_6][i_5][i_2-1] * C[i_6+2][i_5+2][i_2] - C[i_6][i_5][i_2] - C[i_6+2][i_5][i_2] * 4;
            }
        }
    }
#pragma endscop
...
kernel_4322112323_09(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
