...
void kernel_2416251315_04(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N; i_0++) {
        C[i_0+1] = E[i_0] - F[1] * F[i_0] - E[i_0+1] + C[i_0+1] + 1;
        for (int i_1 = i_0; i_1 < PB_P; i_1++) {
            C[i_1+2] = G[i_1+1][i_0] * H[i_1][i_0] * G[i_1][i_0] - G[i_1][i_0] + I[i_0][i_1+1][0] * I[i_0][i_1][i_0] + C[i_1+1] * 2;
        }
        C[i_0+1] = H[i_0][i_0] + F[i_0] - E[i_0] - F[1] + E[i_0] + C[i_0+2] * 5;
        for (int i_2 = 0; i_2 < i_0; i_2++) {
            C[i_2+1] = G[i_2][i_0-1] + H[i_2+1][i_0] - G[i_2][i_0] * E[i_2] - H[i_2][i_0-1] - 1;
        }
    }
#pragma endscop
...
kernel_2416251315_04(xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
