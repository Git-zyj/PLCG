...
void kernel_4436232213_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi)){
        ...
        for (int i_1 = i_0; i_1 < min(-i_0+PB_Q, PB_P); i_1++) {
            for (int i_2 = 2; i_2 < min(PB_M, -i_1+PB_Q-1); i_2++) {
                for (int i_3 = i_0; i_3 < -i_2+PB_Q-1; i_3++) {
                    A[i_0][i_3][i_2][0] = E[i_3][i_0][i_2+i_1+1][i_1] * F[i_3+1][i_1][i_2] * G[i_2-2][i_0][i_1+i_0][i_2] - G[i_0+2][i_1][i_3][i_3+i_2+1] - E[i_2][i_0][i_3][i_1] * G[i_0][i_3][i_3][0] - 4;
                }
            }
        }
        B[i_0] = H[i_0+2] - I[i_0][i_0+1] * H[i_0+1] * B[i_0+1] - 2;
    }
    for (int i_4 = 1; i_4 < PB_M; i_4++) {
        for (int i_5 = 1; i_5 < i_4; i_5++) {
            for (int i_6 = 0; i_6 < min(-i_5+PB_N, -i_4+PB_N-1); i_6++) {
                for (int i_7 = 1; i_7 < PB_P-2; i_7++) {
                    C[i_6+i_4][2][i_7][i_5] = G[i_6][i_7+2][i_4][i_5] - E[i_7][i_4-1][i_5-1][i_6] + G[i_6][i_7][i_4][i_5-1] * C[i_6+i_4][2][i_7+1][i_5+1] * C[i_6+i_5][2][i_7][i_4-1] + C[i_7+i_6+1][2][i_4][i_5+1] - C[i_6+i_4+1][2][i_7-1][i_5] + 1;
                }
            }
            for (int i_8 = 1; i_8 < min(PB_P+1, -i_4+PB_Q+1); i_8++) {
                for (int i_9 = 0; i_9 < min(i_8, -i_5+PB_Q); i_9++) {
                    D[i_4][i_5][i_8][i_9+i_5] = D[i_5][i_8-1][i_9+1][i_8+i_4-1] * 2;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4436232213_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I)));
