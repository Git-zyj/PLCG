...
void kernel_4424151215_04(int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 0; i_1 < PB_Q; i_1++) {
            for (int i_2 = i_1; i_2 < PB_L-1; i_2++) {
                D[i_0-1][i_0] = E[i_0][i_0][i_2+1][i_1] * F[i_0-1][i_2][i_1] + E[i_2][i_1+1][i_0+1][i_0-1] - 4;
            }
        }
        for (int i_3 = i_0; i_3 < -i_0+PB_L; i_3++) {
            D[i_0][i_0+1] = G[i_3-1][i_3+i_0] - H[i_0] * G[i_3-1][i_0] + G[i_3+i_0-1][i_3+i_0] - H[0] * 5;
        }
        D[i_0-2][i_0-1] = H[i_0] + H[i_0] * H[i_0] - H[i_0] - G[i_0][1] - 5;
    }
    for (int i_4 = 2; i_4 < PB_Q; i_4++) {
        for (int i_5 = 1; i_5 < -i_4+PB_Q; i_5++) {
            D[i_4-1][i_4] = F[i_4+1][i_5][i_5+i_4] - G[i_4-1][i_5+1] + G[i_4][i_5] - G[i_5][i_4] * G[i_5-1][i_4+1] * H[i_5] * D[i_4-2][i_4-1] - D[i_4][i_4+1] + 2;
        }
    }
#pragma endscop
...
kernel_4424151215_04(xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
