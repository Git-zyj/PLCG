...
void kernel_4312251311_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 0; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 0; i_2 < min(min(-i_0+PB_M, PB_L-1), -i_1+PB_Q); i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_M-1; i_3++) {
                    A[i_1][i_3+i_0][i_2+1] = D[i_0][i_1+1][i_2][i_3+1] * D[i_3][i_2][i_3+1][i_2+i_1] - A[i_1][i_3+i_0+1][i_2] - A[i_1][i_2+i_0][i_3] - A[i_1][i_3+i_0-1][i_2+1] + 2;
                }
            }
        }
        B[i_0-1] = E[i_0] * F[i_0-1] + F[i_0+1] * F[i_0] - F[i_0] * G[i_0][i_0] + B[i_0] + 4;
        for (int i_4 = 1; i_4 < -i_0+PB_L; i_4++) {
            C[i_4+1][i_0+1] = G[i_0-1][i_4] - G[i_0][i_4] + E[i_4] * E[i_0] * H[i_4][i_4+i_0] + F[i_4] + H[i_4-1][i_0-1] + B[i_4-1] * C[i_4+1][i_0] - C[i_0+2][i_4+1] * C[i_4][i_0+2] - C[i_4+1][i_0+2] * 6;
        }
    }
#pragma endscop
...
kernel_4312251311_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
