        ...
        for (int i_1 = 2; i_1 < min(i_0, -i_0+PB_M+1); i_1++) {
            for (int i_2 = 1; i_2 < PB_L-2; i_2++) {
                for (int i_3 = 0; i_3 < min(i_2, -i_2+PB_P); i_3++) {
                    A[i_0][i_1][i_1-1][i_3+1] = D[i_0-1][i_2][i_3+1][i_1] * E[i_1+i_0-1][i_2][i_3+i_2][i_1] * E[i_1][i_2-1][i_0][i_3] * E[i_3][i_2+1][i_1][0] * A[i_0][i_1][i_1-1][i_2+2] - A[i_2+1][i_1-1][i_1-2][i_3+1] * A[i_0][i_1][i_1-1][i_3] - A[i_0+1][i_1][i_1-1][i_3+1] * 1;
                }
            }
        }
        B[i_0] = F[i_0] - F[i_0] * G[i_0] + G[1] + F[i_0] * G[i_0] - B[i_0+1] + B[i_0-1] - 5;
        for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
            for (int i_5 = i_0; i_5 < min(PB_M-1, -i_4+PB_L); i_5++) {
                A[i_0][i_5][i_5-1][i_4+1] = H[i_5+i_4][i_0][0] - H[i_5][i_0][i_4-1] * E[i_0-1][i_4][i_0][i_5] + H[i_5][i_4][i_0] - I[i_5+1][i_0+1][i_4] - 6;
            }
        }
    }
#pragma endscop
...
kernel_4316351315_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
