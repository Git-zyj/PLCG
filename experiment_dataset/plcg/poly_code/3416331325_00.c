...
void kernel_3416331325_00(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P+1; i_0++) {
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            C[i_1] = E[i_1][i_0] + F[1] + G[i_1][i_0-1] * H[i_0-1][i_1-1] + 2;
        }
        C[i_0-1] = I[i_0+1] + I[i_0] * 6;
    }
    for (int i_2 = 3; i_2 < PB_P-1; i_2++) {
        C[i_2-1] = J[i_2] - J[i_2+1] * G[i_2+1][i_2+1] + C[i_2+1] - C[i_2-3] - C[i_2-2] * 1;
...
kernel_3416331325_00(xc,POLYBENCH_ARRAY(C), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
