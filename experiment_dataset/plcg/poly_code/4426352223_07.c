...
void kernel_4426352223_07(int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,int ym,DATA_TYPE POLYBENCH_2D(M,xM,yM,xm,ym)){
        ...
        for (int i_1 = 0; i_1 < PB_M-2; i_1++) {
            for (int i_2 = i_1; i_2 < PB_M; i_2++) {
                for (int i_3 = 0; i_3 < PB_Q-2; i_3++) {
                    D[i_1+2][i_3][i_2] = E[i_2][i_1][i_3+2][i_0-1] + F[i_2][i_3][i_1] + 3;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_P-2; i_4++) {
            for (int i_5 = 1; i_5 < PB_P; i_5++) {
                D[i_0][i_5][i_4+2] = F[i_4][i_0][i_5] + G[i_0][i_4] * G[i_4-1][i_4+2] - H[i_4][i_0][1] + I[i_0+1][i_5-1][i_4] + 2;
            }
        }
    }
    for (int i_6 = 2; i_6 < PB_M-2; i_6++) {
        C[i_6] = J[i_6] * K[i_6] * J[i_6+2] * J[i_6] + L[i_6] + 3;
        for (int i_7 = i_6; i_7 < -i_6+PB_M; i_7++) {
            for (int i_8 = 0; i_8 < PB_L-2; i_8++) {
                D[i_6][i_8][i_7] = E[i_7][i_6-2][i_8][1] + H[i_8][i_6+1][i_7] - I[i_7][i_8][i_6] * M[i_8][i_7] + I[i_6][i_8][i_7] + I[i_7+i_6][i_8][i_7] + H[i_8][i_7+2][i_6-1] - D[i_6+1][i_8][i_7] * D[i_6+2][i_8][i_7] + D[i_6+1][i_8][i_7-2] - D[i_6][i_8+2][i_7] * 3;
            }
        }
    }
#pragma endscop
...
init_array(xd,yd,zd,POLYBENCH_ARRAY(D), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M), INIT_SEED);
kernel_4426352223_07(xd,yd,zd,POLYBENCH_ARRAY(D), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M));
