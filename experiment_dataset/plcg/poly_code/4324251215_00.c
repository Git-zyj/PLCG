...
void kernel_4324251215_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        A[i_0+1] = D[i_0-1] * D[i_0] + D[i_0] - E[i_0+1] - F[i_0][i_0] * E[i_0+1] + E[i_0] * A[i_0] - 5;
    }
    for (int i_1 = 2; i_1 < PB_L-1; i_1++) {
        ...
        for (int i_4 = 1; i_4 < PB_M-2; i_4++) {
            for (int i_5 = i_4; i_5 < -i_1+PB_M; i_5++) {
                C[i_1-1][i_4+1][i_5+1] = G[i_4-1][i_5+1] + H[i_5+i_1][i_5-1][i_4] + I[i_5][i_1-1][i_4-1] + I[i_5][i_1][i_4] - G[i_4][i_5] + H[i_1][i_5][i_5+1] - G[i_5+i_1][i_4-1] * C[i_1-2][i_4+1][i_5] - C[i_1-1][i_4+2][i_5+1] * C[i_5][i_4+1][i_1+1] - 6;
            }
        }
    }
#pragma endscop
...
kernel_4324251215_00(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
