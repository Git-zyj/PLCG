...
void kernel_4234211123_09(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_4 = 2; i_4 < PB_L+1; i_4++) {
        B[i_4-1] = C[i_4-1] + C[i_4-1] * B[i_4-2] - 4;
    }
#pragma endscop
...
kernel_4234211123_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
