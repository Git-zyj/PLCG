...
void kernel_4214312223_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
kernel_4214312223_00(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
