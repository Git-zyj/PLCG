...
void kernel_4422351325_05(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,DATA_TYPE POLYBENCH_1D(M,xM,xm)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            A[i_0][i_1] = E[i_1][i_0] - E[i_1-1][i_0-1] - F[i_1][i_0] - G[i_1-1][i_0-1] * A[i_0][i_1-2] - C[i_1] + 3;
        }
        for (int i_2 = 0; i_2 < PB_L; i_2++) {
            for (int i_3 = max(1, i_2); i_3 < -i_0+PB_N; i_3++) {
                for (int i_4 = 0; i_4 < min(-i_3+PB_M, -i_0+PB_Q-1); i_4++) {
                    B[i_3-1][i_0-1][i_4][i_2] = H[i_3][i_0][i_3][i_2] - I[i_0][i_4][i_3][i_3] - I[i_3+i_0][i_4+i_3][i_2][1] - J[i_3][i_4+i_0+1][i_0+1][i_4+1] + H[i_3][i_3][i_0][i_4+1] + B[i_3-1][i_0+1][i_4][i_2] - B[i_3-1][i_0-2][i_4+2][i_2] - 3;
                }
            }
        }
    }
    for (int i_5 = 2; i_5 < PB_N-1; i_5++) {
        C[i_5] = K[i_5] * E[i_5][i_5] + C[i_5+1] * C[i_5-2] * 5;
        C[i_5] = L[i_5] + E[i_5][i_5] - K[i_5] - L[i_5] - E[i_5][1] - M[i_5-1] + C[i_5] + 1;
    }
#pragma endscop
...
kernel_4422351325_05(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,POLYBENCH_ARRAY(M));
