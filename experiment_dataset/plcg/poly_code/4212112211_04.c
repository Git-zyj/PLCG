...
void kernel_4212112211_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            for (int i_2 = 0; i_2 < PB_P-3; i_2++) {
                A[i_0+1][i_1][i_2+2] = A[i_0+1][i_1][i_2+3] + A[i_0+1][i_1-1][i_2+2] + 3;
            }
            for (int i_3 = 1; i_3 < PB_P; i_3++) {
                for (int i_4 = 1; i_4 < PB_Q; i_4++) {
                    B[i_0][i_4][i_3+1][i_3] = C[i_1][i_4][i_0][i_3] + B[i_3-1][i_1][i_4][i_4-1] * 4;
                }
            }
        }
    }
...
kernel_4212112211_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
