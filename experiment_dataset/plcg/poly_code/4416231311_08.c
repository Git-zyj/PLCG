...
void kernel_4416231311_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_Q-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_Q; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_1+PB_N-1, PB_Q-1); i_2++) {
                A[i_2+i_1][i_0][i_1][i_2] = E[i_1][i_2+1][i_0-1] - F[i_0+1][i_2][i_1] + E[i_1-1][i_0+1][i_1] + A[i_2+i_1+1][i_0][i_1+1][i_2] + 5;
                for (int i_3 = 0; i_3 < PB_Q; i_3++) {
                    B[i_1][i_2+i_1][i_0][i_0] = G[i_1-1][i_3][i_0][i_2] * F[i_2-1][i_1][i_1] - G[i_3][i_2+1][i_1][i_0+1] + H[i_1+1][i_0][i_0][i_2] + A[i_2+i_1][i_0+1][i_1][i_2] - B[i_3][i_3+i_2+1][i_1][i_1] - 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_P-1; i_4++) {
        for (int i_5 = 2; i_5 < PB_L; i_5++) {
            C[i_4][i_5-1] = I[i_5-1][i_4] + J[i_5-1][i_4] + K[i_5] - C[i_4-1][i_5-1] - C[i_4][i_5-2] - C[i_4+1][i_5-1] - C[i_4+1][i_5] - C[i_4-1][i_5-2] - 4;
            for (int i_6 = 0; i_6 < i_4; i_6++) {
                for (int i_7 = 1; i_7 < PB_Q-1; i_7++) {
                    D[i_6+1][i_5][i_4][i_7] = H[i_5][i_4][i_6][i_7-1] * D[i_6+1][i_5][i_4][i_7+1] - D[i_7+1][i_5-1][i_4+1][i_6] * 6;
                }
            }
        }
    }
...
kernel_4416231311_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K));
