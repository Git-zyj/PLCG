    ...
    for (int i_6 = 0; i_6 < PB_P-3; i_6++) {
        for (int i_7 = 3; i_7 < PB_L; i_7++) {
            for (int i_8 = 0; i_8 < PB_Q-3; i_8++) {
                D[i_7-1][i_6+2][i_8+1] = D[i_7-1][i_6+1][i_8+1] * D[i_7-3][i_6+2][i_8] * D[i_7][i_6+2][i_8+3] + D[i_7-1][i_6+3][i_8+1] + 6;
            }
        }
    }
#pragma endscop
...
kernel_3434112325_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
