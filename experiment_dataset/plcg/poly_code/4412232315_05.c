...
void kernel_4412232315_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
        ...
        for (int i_1 = 1; i_1 < PB_Q; i_1++) {
            for (int i_2 = 0; i_2 < PB_M; i_2++) {
                for (int i_3 = 0; i_3 < -i_1+PB_Q; i_3++) {
                    A[i_0][i_3][i_3][i_2] = E[i_2][i_3][i_0][i_1-1] * E[i_2][i_0][i_3+i_1][i_1-1] + 2;
                }
            }
        }
        for (int i_4 = max(1, i_0); i_4 < min(-i_0+PB_Q, PB_M); i_4++) {
            for (int i_5 = 1; i_5 < min(PB_M, -i_0+PB_P); i_5++) {
                for (int i_6 = 2; i_6 < min(-i_4+PB_M, -i_0+PB_P); i_6++) {
                    B[i_4][i_5+i_0][i_6][i_0] = F[i_6-2][i_4][i_0][i_5] + F[i_0+1][i_5][i_6][i_4] - E[i_6+1][i_0][1][i_5] + E[i_6+i_4][i_6+1][i_4+i_0][i_4] * B[i_4][i_6+i_5-1][i_0+1][i_6-1] - B[i_4-1][i_6+i_0][i_5-1][i_0] * 6;
                }
            }
        }
    }
        ...
        for (int i_8 = 0; i_8 < i_7; i_8++) {
            for (int i_9 = 1; i_9 < PB_M+1; i_9++) {
                for (int j_0 = 1; j_0 < PB_M+1; j_0++) {
                    A[j_0-1][i_7][i_7][i_8] = E[i_9-1][i_7][i_8][j_0-1] * 4;
                }
            }
        }
        D[i_7] = G[i_7] - G[i_7+2] + H[i_7] - D[i_7+1] * D[i_7-1] * D[i_7-1] + D[i_7+1] + D[i_7+1] * 2;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4412232315_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H)));
