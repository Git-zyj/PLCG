...
void kernel_4436331221_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M-1; i_0++) {
        A[i_0] = E[i_0-1] * F[i_0] * E[i_0-1] - A[i_0+1] * 2;
        for (int i_1 = 0; i_1 < PB_M; i_1++) {
            for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
                for (int i_3 = i_2; i_3 < -i_0+PB_M; i_3++) {
                    B[i_3][i_1][i_2-1][i_0-1] = G[i_3+i_0][i_3][i_1][i_2] * B[i_3+1][i_1][i_2-1][i_0-1] - B[i_3+2][i_1][i_2-1][i_0-3] * B[i_3][i_1][i_2+1][i_0-1] - 1;
                }
            }
        }
    }
    ...
    for (int i_5 = 1; i_5 < PB_P; i_5++) {
        for (int i_6 = 3; i_6 < min(-i_5+PB_L, PB_M-1); i_6++) {
            D[i_6-1][i_5] = H[i_6][i_6+i_5] + E[i_6] * H[i_6+1][i_5] - I[i_5-1][i_6] * A[i_6] + D[i_5][i_6] - D[i_6-3][i_5] - 1;
        }
    }
#pragma endscop
...
kernel_4436331221_09(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
