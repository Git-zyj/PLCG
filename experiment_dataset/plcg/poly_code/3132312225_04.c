...
void kernel_3132312225_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N; i_0++) {
        for (int i_1 = max(i_0, 4); i_1 < PB_M+2; i_1++) {
            A[i_1-2][i_0] = B[i_0] * A[i_1-4][i_0] + A[i_1-2][i_0+1] - 6;
        }
    }
#pragma endscop
...
kernel_3132312225_04(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
