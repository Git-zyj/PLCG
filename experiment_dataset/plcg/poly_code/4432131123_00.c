...
void kernel_4432131123_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        A[i_0] = E[i_0] + E[i_0-1] + E[i_0+1] + A[i_0-1] + 5;
    }
    for (int i_1 = 1; i_1 < PB_N; i_1++) {
        B[i_1] = E[i_1-1] * E[i_1+1] * E[i_1+1] + 3;
        for (int i_2 = 1; i_2 < PB_N; i_2++) {
            for (int i_3 = 0; i_3 < PB_L; i_3++) {
                D[i_1-1][i_2][i_3][i_1-1] = F[i_2][i_1][i_2-1] + 3;
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_N; i_4++) {
        for (int i_5 = 1; i_5 < PB_N-2; i_5++) {
            for (int i_6 = 1; i_6 < PB_N; i_6++) {
                D[i_5][i_4][i_6][i_5] = F[i_4-1][i_6][i_5] * F[i_5-1][i_6][i_4-1] + F[i_6][i_5][i_4-1] - G[i_5][i_6][i_4][i_4+1] * F[i_6-1][i_4][i_5] + D[i_5+2][i_6][i_4][i_5+2] * D[i_5-1][i_4][i_6][i_5-1] + 6;
            }
        }
    }
#pragma endscop
...
kernel_4432131123_00(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G));
