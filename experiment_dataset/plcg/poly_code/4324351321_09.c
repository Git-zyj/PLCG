        ...
        for (int i_1 = 2; i_1 < min(i_0, -i_0+PB_N); i_1++) {
            for (int i_2 = 1; i_2 < PB_L-2; i_2++) {
                for (int i_3 = 2; i_3 < PB_M-1; i_3++) {
                    A[i_0][i_3][i_2][i_1] = D[i_2+i_1][i_3][i_2-1] * E[i_2][i_3][i_1+i_0][0] - F[i_1+i_0][i_2+1][0][i_2][i_3] * G[i_1][i_1][i_2][i_0-1] + A[i_2][i_3][i_0+1][i_1] * A[i_0-2][i_3][i_2+2][i_1] + A[i_0][i_3+1][i_2-1][i_1+2] - A[i_3-2][i_0+1][i_2][i_1] - 3;
                }
            }
            for (int i_4 = 3; i_4 < PB_P-1; i_4++) {
                B[i_0][i_4-1][i_1] = H[i_1][i_4-1][0] * I[i_4][i_0][i_1] + H[i_4+i_1][i_0-1][i_0] + B[i_0][i_4-2][i_1] * B[i_0][i_4-3][i_1+1] + B[i_0+2][i_1-2][i_4+1] + B[i_1][i_0-1][i_4-1] - 2;
            }
        }
    }
    for (int i_5 = 3; i_5 < PB_N-1; i_5++) {
        C[i_5-1] = J[i_5] - J[i_5+1] * J[i_5-1] * K[i_5] + L[i_5-1] + J[i_5] - J[i_5-1] * C[i_5-3] + 6;
    }
#pragma endscop
...
kernel_4324351321_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L));
