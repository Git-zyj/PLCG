...
void kernel_2216131211_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-2; i_0++) {
        B[i_0+2] = C[i_0] + C[i_0] - B[i_0+1] - B[i_0] - 3;
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            B[i_1+1] = C[i_0-1] * C[i_0] - D[i_0+1][i_1] + 3;
        }
    }
#pragma endscop
...
kernel_2216131211_09(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
