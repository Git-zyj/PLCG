        ...
        for (int i_1 = 1; i_1 < -i_0+PB_Q; i_1++) {
            for (int i_2 = 2; i_2 < PB_P-2; i_2++) {
                for (int i_3 = 1; i_3 < -i_2+PB_P; i_3++) {
                    A[i_3+i_2][i_1][i_0][0] = D[i_2][i_1+1][i_1][i_0+2] - E[i_1][i_0+1][i_3+i_2][i_1] - F[i_0-1][i_1][i_3][i_2][i_3-1] + G[i_3][i_2-1][i_1+i_0][i_0] + D[i_1][i_2-2][i_3][i_0] * D[i_1-1][i_0][i_3][i_2] - E[i_1-1][i_2+2][i_1][i_0] - 4;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
            for (int i_6 = 0; i_6 < PB_L-2; i_6++) {
                for (int i_7 = 0; i_7 < PB_L; i_7++) {
                    B[i_5+1][i_7][i_6+2][0] = 1;
                }
            }
        }
        for (int i_8 = i_4; i_8 < PB_P; i_8++) {
            C[i_4-2][i_4+1] = H[i_4-1][i_8] * I[i_4][i_4] - C[i_4-3][i_4] - 1;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4324332111_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I)));
