...
void kernel_4234211115_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
kernel_4234211115_07(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
