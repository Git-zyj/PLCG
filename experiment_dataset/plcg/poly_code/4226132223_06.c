...
void kernel_4226132223_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N; i_0++) {
        B[i_0] = C[i_0] - C[i_0] + C[i_0-2] + C[i_0] + B[i_0] - 3;
    }
...
kernel_4226132223_06(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
