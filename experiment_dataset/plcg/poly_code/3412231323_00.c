...
void kernel_3412231323_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 2; i_1 < PB_M; i_1++) {
            B[i_0] = E[i_1-1][i_0] - F[i_1-1][i_0] - B[i_1] - B[i_1-2] * D[i_1-1] * 4;
            B[i_1] = F[i_1][i_0] + G[i_1] * H[i_1] - E[i_1][i_0] - F[i_1][0] - B[i_1-1] - B[i_1-2] - 3;
        }
        for (int i_2 = 0; i_2 < PB_M; i_2++) {
            for (int i_3 = 0; i_3 < PB_L-1; i_3++) {
                C[i_2][i_3][1] = I[i_2][i_3+1][i_0] - C[i_3][i_0+1][1] - 2;
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M-2; i_4++) {
        D[i_4] = G[i_4] + G[i_4] * G[i_4] - G[0] + B[i_4] + D[i_4+2] + 6;
    }
#pragma endscop
...
kernel_3412231323_00(xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
