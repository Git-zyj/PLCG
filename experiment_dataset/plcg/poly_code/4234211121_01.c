...
void kernel_4234211121_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
        ...
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            for (int i_2 = i_0; i_2 < -i_0+PB_L; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_L-2; i_3++) {
                    A[i_2+i_0][i_0-1][i_1] = A[i_2+i_0-2][i_0-3][i_1-2] - A[i_3+i_0+2][i_0+1][i_2+2] - 1;
                }
            }
        }
    }
...
kernel_4234211121_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
