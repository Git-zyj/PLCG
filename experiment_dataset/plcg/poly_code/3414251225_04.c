...
void kernel_3414251225_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        A[i_0] = E[i_0] - F[i_0-1] - F[i_0+1] - F[i_0] * A[i_0-2] - 2;
        for (int i_1 = 0; i_1 < PB_M-2; i_1++) {
            B[i_1][i_0-1] = G[i_1+1][0] * E[i_0] * E[i_1] * A[i_1] + A[i_1+2] + A[i_0-1] + 6;
        }
        for (int i_2 = 2; i_2 < -i_0+PB_L-1; i_2++) {
            for (int i_3 = 1; i_3 < PB_L-2; i_3++) {
                D[i_2-1][i_3+2][i_0-1] = H[i_2-1][i_3][i_0+1] * H[i_2][i_0+1][i_3] * H[i_3-1][i_2][i_0] - H[i_2][i_0][0] * I[i_2][i_0][i_3-1] * H[i_3][i_0][i_2] * I[i_2][i_2+i_0+1][i_3+1] - 6;
            }
            for (int i_4 = 2; i_4 < min(-i_0+PB_M, PB_L-1); i_4++) {
                D[i_2-1][i_4][i_0] = G[i_0+1][i_2] - J[i_0][i_2+i_0] - H[i_4+i_0][i_4+1][0] - I[i_4][i_0][i_2] - I[i_4][i_0][i_2+i_0+1] - B[i_2][i_0-1] + D[i_2-2][i_4-2][i_0] * 2;
            }
        }
    }
#pragma endscop
...
kernel_3414251225_04(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
