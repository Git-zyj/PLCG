...
void kernel_4316112111_06(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_0 = 1; i_0 < PB_Q; i_0++) {
        for (int i_1 = i_0; i_1 < -i_0+PB_Q; i_1++) {
            ...
            for (int i_2 = 0; i_2 < PB_Q-1; i_2++) {
                B[i_1-1][i_0][i_2] = B[i_1-1][i_0-1][i_2+1] * 1;
            }
        }
    }
    for (int i_3 = 2; i_3 < PB_L+2; i_3++) {
        for (int i_4 = 0; i_4 < min(PB_L, i_3); i_4++) {
            for (int i_5 = 0; i_5 < min(-i_3+PB_L+2, i_3); i_5++) {
                C[i_4][i_5] = D[i_4][i_5+i_3-2][i_3-2] - 6;
            }
        }
    }
#pragma endscop
...
kernel_4316112111_06(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
