        ...
        for (int i_1 = 1; i_1 < min(-i_0+PB_Q, PB_P-1); i_1++) {
            for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_M; i_3++) {
                    A[i_1-1][i_2][i_3-1] = D[i_0][i_1-1][i_2] + E[i_3][i_0][i_2+1][i_1] + F[i_1][i_2+1][i_1-1][i_2] - E[i_3][i_2][i_1+i_0][i_1+1] * G[i_3][i_1][0] * H[i_3][i_1][i_0+1] * 6;
                }
            }
            for (int i_4 = 0; i_4 < PB_P; i_4++) {
                B[i_4][i_0][i_0] = H[i_4][i_1+1][i_0] * F[i_0][i_4][i_1][1] - H[i_0][i_4][i_1] + 2;
            }
        }
    }
    for (int i_5 = 1; i_5 < PB_P; i_5++) {
        for (int i_6 = 1; i_6 < PB_N+1; i_6++) {
            for (int i_7 = 0; i_7 < min(PB_N-1, -i_6+PB_L); i_7++) {
                for (int i_8 = 0; i_8 < min(min(-i_5+PB_M, PB_P-1), -i_6+PB_L+1); i_8++) {
                    C[i_7][i_8+i_6-1][i_8+1] = E[i_8+1][i_5][i_7][i_6] - F[i_6-1][i_5][i_8][i_6] + I[i_8+1][i_7][i_6-1][i_8][i_5] - J[i_7+1][i_8][i_5][i_6-1] + F[i_8][i_8+i_5][i_6][i_6-1] + J[i_5-1][i_7][i_8][i_6] - C[i_8][i_7+i_6][i_7+1] + 2;
                }
            }
        }
    }
...
kernel_4332351111_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,wi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J));
