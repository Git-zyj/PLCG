...
void kernel_4436251123_04(int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk)){
        ...
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_L-2; i_2++) {
                for (int i_3 = 1; i_3 < PB_L; i_3++) {
                    D[i_1-2][i_2+i_0+2][i_3][i_3-1] = E[i_1][i_3][i_0][i_2] * F[i_2][i_3][i_1+1][i_0] + F[i_2][i_0+1][i_3][i_1] + F[i_2][i_1-1][i_3][i_0] - 3;
                }
            }
        }
        B[i_0] = G[i_0-1] - G[i_0+1] * H[i_0] + B[i_0-2] + B[i_0+2] + 3;
    }
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        for (int i_5 = max(i_4, 2); i_5 < -i_4+PB_M-1; i_5++) {
            B[i_5-2] = I[i_5+i_4+1][i_4] + I[i_5][0] + J[i_5][i_4] + J[i_4][i_4-1] * J[i_4][i_5] * J[i_5+i_4+1][i_4-1] * 5;
        }
        for (int i_6 = 1; i_6 < i_4; i_6++) {
            for (int i_7 = 1; i_7 < -i_4+PB_N; i_7++) {
                for (int i_8 = 1; i_8 < -i_6+PB_L-1; i_8++) {
                    D[i_4][i_8+i_6+1][i_7][i_7-1] = F[i_7-1][i_4][i_8][i_6-1] + E[i_4+1][i_8][i_7+1][i_6-1] - K[i_8+i_7][i_4][i_6+1] + F[i_8-1][i_7+i_4][i_8][i_6+1] * E[i_7+1][i_6][i_4][i_8] + 4;
                }
            }
        }
    }
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4436251123_04(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K)));
