...
void kernel_4232311121_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
        ...
        for (int i_4 = 1; i_4 < PB_L; i_4++) {
            for (int i_5 = max(i_4, 2); i_5 < PB_P; i_5++) {
                for (int i_6 = 0; i_6 < PB_L; i_6++) {
                    B[i_3][i_4][i_5][i_6] = C[i_5-1][i_6][i_3][i_4-1] + B[i_4][i_3][i_5-2][i_6] - 3;
                }
            }
        }
    }
...
kernel_4232311121_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
