...
void kernel_2326211325_08(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            B[i_0+2] = B[i_1] + B[i_0] - 4;
        }
        B[i_0] = D[i_0-1] + 4;
    }
...
kernel_2326211325_08(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
