...
void kernel_4226112123_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
...
#pragma scop
    ...
    for (int i_4 = 0; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 0; i_5 < i_4; i_5++) {
            for (int i_6 = 4; i_6 < PB_Q-2; i_6++) {
                for (int i_7 = 3; i_7 < i_4; i_7++) {
                    B[i_7][i_4][i_6-1][i_6] = C[i_4+2][i_5+2][i_7][i_6+2] * A[i_5][i_6-4][i_7] - A[i_5][i_7-3][i_6+2] - 4;
                }
            }
        }
    }
...
kernel_4226112123_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
