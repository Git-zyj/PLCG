...
void kernel_2336251115_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        A[i_0-1] = D[i_0+1][i_0+1] + E[i_0] - F[i_0] * 4;
        A[i_0-2] = F[i_0] - F[i_0] - F[i_0] * E[i_0+1] - G[i_0+1][i_0+1] * E[i_0] * A[i_0-2] - 4;
        for (int i_1 = 1; i_1 < min(min(-i_0+PB_M, PB_P), i_0); i_1++) {
            A[i_1-1] = D[i_0+1][i_1+i_0+1] * G[i_0][i_1-1] - G[i_0][i_1+1] - H[i_1+i_0][0][i_1] + 2;
        }
    }
#pragma endscop
...
kernel_2336251115_06(xa,POLYBENCH_ARRAY(A), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
