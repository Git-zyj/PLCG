...
void kernel_3236152211_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P; i_0++) {
        for (int i_1 = 0; i_1 < min(PB_P, -i_0+PB_L); i_1++) {
            for (int i_2 = max(1, i_1); i_2 < PB_M-3; i_2++) {
                A[i_2+2][i_0][i_2][i_2-1] = C[i_0][i_2][i_1] + C[i_1][i_0][2] * C[i_1+i_0][i_2+2][i_1] - C[i_1][i_0-1][i_2] + C[i_1][i_2][0] * A[i_2+3][i_0][i_2+1][i_2] + 3;
            }
        }
    }
    for (int i_3 = 0; i_3 < PB_P-2; i_3++) {
        for (int i_4 = max(2, i_3); i_4 < PB_M-2; i_4++) {
            for (int i_5 = 1; i_5 < min(-i_3+PB_P, PB_M-1); i_5++) {
                B[i_5][i_4] = C[i_5][i_3][i_3+2] + C[i_4][i_5+i_3][i_3] + C[i_5][i_4-2][i_3] * C[i_3][i_4-1][i_5] - A[i_4+2][i_3+1][i_4][i_4-1] - B[i_5+1][i_4] - B[i_5-1][i_4] + 4;
            }
        }
    }
#pragma endscop
...
kernel_3236152211_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
