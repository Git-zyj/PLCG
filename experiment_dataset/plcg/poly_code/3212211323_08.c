...
void kernel_3212211323_08(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_1 = 3; i_1 < PB_N; i_1++) {
        B[i_1-1] = B[i_1-3] + B[i_1-2] * B[i_1] + 2;
    }
#pragma endscop
...
kernel_3212211323_08(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
