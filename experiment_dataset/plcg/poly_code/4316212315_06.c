...
void kernel_4316212315_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 2; i_2 < PB_L-2; i_2++) {
                for (int i_3 = 0; i_3 < PB_P; i_3++) {
                    A[i_0+1][i_2+2][i_2-1][i_3] = D[i_0][i_1+2][i_3] - A[i_0+1][i_2+1][i_2-2][i_3] + 5;
                }
            }
        }
        for (int i_4 = 0; i_4 < PB_M-1; i_4++) {
            for (int i_5 = 1; i_5 < PB_L-2; i_5++) {
                C[i_0][i_5+1][i_4+1][i_0+2] = D[i_0][i_5][i_4] + A[i_4+1][i_5+2][i_5-1][i_0+1] - 1;
            }
        }
    }
    for (int i_6 = 0; i_6 < PB_M-1; i_6++) {
        for (int i_7 = max(i_6, 1); i_7 < PB_M; i_7++) {
            for (int i_8 = 0; i_8 < PB_L-3; i_8++) {
                C[i_8][i_6][i_7][i_8+2] = C[i_8+1][i_6+1][i_7][i_8+3] + C[i_8][i_6][i_7-1][i_8+2] - C[i_8+1][i_6+1][i_7-1][i_8+3] + 6;
            }
        }
    }
#pragma endscop
...
kernel_4316212315_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
