...
void kernel_2336111315_09(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
        C[i_3] = D[i_3+1] * D[i_3-1] + C[i_3+1] + C[i_3-1] + 5;
    }
#pragma endscop
...
kernel_2336111315_09(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
