...
static void print_array(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,int ym,int zm,int vm,DATA_TYPE POLYBENCH_4D(M,xM,yM,zM,vM,xm,ym,zm,vm),int xn,int yn,int zn,DATA_TYPE POLYBENCH_3D(N,xN,yN,zN,xn,yn,zn),int xo,int yo,int zo,int vo,int wo,DATA_TYPE POLYBENCH_5D(O,xO,yO,zO,vO,wO,xo,yo,zo,vo,wo))
{
int i_0, i_1, i_2, i_3, i_4;
...
void kernel_4424351111_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,int ym,int zm,int vm,DATA_TYPE POLYBENCH_4D(M,xM,yM,zM,vM,xm,ym,zm,vm),int xn,int yn,int zn,DATA_TYPE POLYBENCH_3D(N,xN,yN,zN,xn,yn,zn),int xo,int yo,int zo,int vo,int wo,DATA_TYPE POLYBENCH_5D(O,xO,yO,zO,vO,wO,xo,yo,zo,vo,wo)){
...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = 1; i_2 < PB_P-1; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_1+PB_M-1, i_0); i_3++) {
                    A[i_3][i_1][i_2][i_0] = E[i_0][i_3+1][i_1][i_2-1] - F[i_3-1][i_1-1][0] - G[i_3][i_1+i_0][i_2][1] - E[i_3+1][i_3-1][i_0-1][i_1] + H[i_3+i_1+1][i_2+1][i_0+1][i_3+i_1][i_2] - A[i_3][i_1][i_2][i_0-1] + 5;
                }
            }
        }
        B[i_0] = I[i_0] - I[i_0] + I[i_0] - J[i_0][1] + K[i_0-1] * I[i_0] * L[i_0] - I[i_0-1] + B[i_0+1] - 1;
    }
        ...
        for (int i_5 = 0; i_5 < PB_L-1; i_5++) {
            for (int i_6 = 1; i_6 < PB_N-1; i_6++) {
                for (int i_7 = 0; i_7 < min(-i_5+PB_M, PB_L-1); i_7++) {
                    C[i_6][i_7][i_6+1][i_4] = G[i_6-1][i_7][i_5+1][i_4] + M[i_5][i_7+1][i_6+1][i_4-1] - N[i_5][i_7+1][i_6+1] * G[i_6][i_7+i_5][i_7+1][i_4-1] + G[i_6+1][i_4][i_4+1][i_5] + G[i_7+1][i_6-1][i_4][i_5] + 2;
                }
            }
        }
    }
    for (int i_8 = 0; i_8 < PB_L-1; i_8++) {
        for (int i_9 = 1; i_9 < PB_L; i_9++) {
            for (int j_0 = 0; j_0 < min(i_9, -i_9+PB_L); j_0++) {
                for (int j_1 = 1; j_1 < PB_P; j_1++) {
                    D[j_1-1][j_0+i_9][i_8+1][i_9] = O[i_9][j_0][i_8][j_1][i_9-1] + 6;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,ym,zm,vm,POLYBENCH_ARRAY(M), xn,yn,zn,POLYBENCH_ARRAY(N), xo,yo,zo,vo,wo,POLYBENCH_ARRAY(O), INIT_SEED);
kernel_4424351111_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,ym,zm,vm,POLYBENCH_ARRAY(M), xn,yn,zn,POLYBENCH_ARRAY(N), xo,yo,zo,vo,wo,POLYBENCH_ARRAY(O));
