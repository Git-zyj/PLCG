...
void kernel_3114152323_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_M-2 - 1; i_0 >= 4; i_0--) {
        A[i_0-2] = B[i_0] * B[i_0+2] - B[i_0] + B[i_0] * B[i_0-2] - A[i_0] + A[i_0-4] - A[i_0-3] * 6;
    }
#pragma endscop
...
kernel_3114152323_05(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
