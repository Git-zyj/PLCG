...
void kernel_2234112221_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 4; i_0 < PB_L+1; i_0++) {
        B[i_0-1] = C[i_0][i_0-2] * 6;
        B[i_0-2] = B[i_0-4] - B[i_0-3] - 4;
    }
#pragma endscop
...
kernel_2234112221_03(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
