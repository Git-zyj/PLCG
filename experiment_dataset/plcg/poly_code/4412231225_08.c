...
void kernel_4412231225_08(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_L-4; i_0++) {
        for (int i_1 = 1; i_1 < -i_0+PB_L; i_1++) {
            C[i_0-3] = E[i_1][i_0-1] * F[i_1][i_0] - 4;
            for (int i_2 = 2; i_2 < -i_0+PB_L-4; i_2++) {
                for (int i_3 = 1; i_3 < -i_1+PB_L; i_3++) {
                    B[i_2-1][i_1+i_0][i_2-1][i_3] = G[i_3][i_2][i_1][i_0] + H[i_2-1][i_1][i_0][i_3][i_3] + I[i_0][i_1][i_3][i_2] + G[i_3][i_2+i_1-1][i_0-1][i_0+1] * I[i_3][i_1][i_0][i_2] - B[i_2-1][i_1+i_0-2][i_2-1][i_3] - B[i_2-1][i_3+i_1][i_2-1][i_0-2] - B[i_3-1][i_2+i_0+4][i_3-1][i_1] + B[i_2-2][i_1+i_0][i_2-2][i_3+1] * 1;
                }
            }
        }
        C[i_0-1] = J[i_0] * K[i_0] - 1;
    }
    for (int i_4 = 2; i_4 < PB_L-1; i_4++) {
        C[i_4-2] = K[i_4+1] - J[i_4+1] * J[i_4+1] + 2;
    }
#pragma endscop
...
init_array(xc,POLYBENCH_ARRAY(C), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4412231225_08(xc,POLYBENCH_ARRAY(C), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xc,POLYBENCH_ARRAY(C), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K)));
