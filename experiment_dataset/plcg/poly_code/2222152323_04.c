...
void kernel_2222152323_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        A[i_0][i_0] = C[0] - C[i_0] - A[i_0-2][i_0-2] + A[i_0+1][i_0+1] + A[i_0+2][i_0+2] - 4;
        A[i_0][i_0] = C[i_0] * C[i_0] + C[i_0] - C[i_0] - C[i_0] + C[i_0+2] * C[i_0] * 2;
    }
#pragma endscop
...
kernel_2222152323_04(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
