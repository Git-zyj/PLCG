...
void kernel_3334311111_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
    ...
    for (int i_3 = 0; i_3 < PB_P-2; i_3++) {
        for (int i_4 = 0; i_4 < min(-i_3+PB_P-2, PB_M-1); i_4++) {
            for (int i_5 = 0; i_5 < min(-i_3+PB_P-1, PB_M-1); i_5++) {
                C[i_4+1][i_5+i_3+1] = C[i_5+1][i_4+i_3+2] - 1;
            }
        }
    }
#pragma endscop
...
kernel_3334311111_07(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
