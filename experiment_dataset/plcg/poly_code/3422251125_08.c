...
void kernel_3422251125_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-2; i_0++) {
        A[i_0] = E[i_0] + F[i_0] + E[i_0] + F[i_0] + F[i_0-1] + 3;
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_M; i_2++) {
                B[i_0+1][i_1][i_2] = G[i_2][0] - H[i_0][i_2][0] + G[i_1+1][i_1-1] * H[i_2][i_0-1][i_1-1] * G[i_2][i_1+1] - I[i_2][i_2][i_1] - B[i_0+1][i_2+1][i_1] - B[i_0+2][i_1-1][i_2+1] - B[i_0-1][i_1+1][i_2+1] + 1;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
        for (int i_4 = 0; i_4 < min(-i_3+PB_L, PB_M-1); i_4++) {
            for (int i_5 = 0; i_5 < -i_3+PB_M; i_5++) {
                B[i_4+1][i_5][i_3] = H[i_5+i_3][i_4+i_3][0] * 6;
            }
        }
        D[i_3+1] = E[i_3+1] * F[i_3+1] - F[i_3-1] * E[i_3] - E[i_3-1] + E[i_3+1] + E[i_3] + 2;
    }
#pragma endscop
...
kernel_3422251125_08(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
