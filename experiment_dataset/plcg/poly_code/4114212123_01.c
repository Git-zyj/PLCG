...
void kernel_4114212123_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb)){
        ...
        for (int i_1 = 0; i_1 < min(PB_N, i_0); i_1++) {
            for (int i_2 = 2; i_2 < -i_1+PB_L; i_2++) {
                for (int i_3 = 2; i_3 < PB_N-1; i_3++) {
                    A[i_1][i_2][i_3-2] = B[i_3][i_2+i_1][i_0-2] - A[i_3+1][i_1][i_2-2] * 6;
                }
            }
        }
    }
...
kernel_4114212123_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B));
