...
void kernel_3322252211_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        A[i_0] = D[0] * D[i_0] * D[i_0] * E[i_0] - E[i_0] * E[i_0] + E[i_0] - 2;
        for (int i_1 = i_0; i_1 < PB_M; i_1++) {
            A[i_1] = E[i_1] - A[i_0] - A[i_0+1] + 5;
        }
    }
    for (int i_2 = 1; i_2 < PB_P; i_2++) {
        for (int i_3 = 1; i_3 < PB_P; i_3++) {
            for (int i_4 = 2; i_4 < min(-i_3+PB_P, -i_2+PB_L); i_4++) {
                C[i_2][i_3][i_4] = F[i_3-1][i_2-1][0] - G[i_4-2][i_4] - H[i_3+1][i_2][i_4+i_2] * F[i_4][i_2][i_4+i_3] * H[i_2-1][i_4+i_3][i_2+1] * C[i_2][i_3+1][i_4] - C[i_2+1][i_3][i_4] * 3;
            }
        }
    }
#pragma endscop
...
kernel_3322252211_02(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
