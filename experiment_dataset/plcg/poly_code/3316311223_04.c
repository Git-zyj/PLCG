...
void kernel_3316311223_04(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_2 = 3; i_2 < PB_N; i_2++) {
        ...
        C[i_2-1] = D[i_2] + C[i_2+1] * C[i_2-2] + 1;
    }
#pragma endscop
...
kernel_3316311223_04(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
