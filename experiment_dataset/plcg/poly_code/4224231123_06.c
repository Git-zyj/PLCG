        ...
        for (int i_1 = i_0; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_P; i_2++) {
                for (int i_3 = 1; i_3 < PB_P; i_3++) {
                    A[i_1+1][i_0-1][i_2][i_3-1] = C[i_2-1][i_1][i_0][i_1+1] - C[i_0+1][i_2-1][i_3-1][i_1+1] - D[i_3-1][i_2][i_0][i_1-1] + D[i_1+1][i_3-1][i_2+i_1][i_0] * A[i_1+1][i_0+1][i_3][i_2] + 2;
                }
            }
        }
    }
...
kernel_4224231123_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
