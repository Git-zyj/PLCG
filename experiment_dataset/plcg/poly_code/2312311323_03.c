...
void kernel_2312311323_03(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
...
#pragma scop
    for (int i_0 = PB_M - 1; i_0 >= 2; i_0--) {
        ...
        A[i_0][0] = A[i_0][0] - A[i_0-2][0] - A[i_0+1][0] - A[i_0-1][0] - 1;
    }
...
kernel_2312311323_03(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
