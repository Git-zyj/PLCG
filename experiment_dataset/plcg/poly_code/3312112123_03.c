...
void kernel_3312112123_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N-1; i_0++) {
        B[i_0] = D[i_0-2] - D[i_0+2] + 2;
...
kernel_3312112123_03(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
