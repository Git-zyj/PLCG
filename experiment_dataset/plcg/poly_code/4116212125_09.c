...
void kernel_4116212125_09(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_M+1 - 1; i_0 >= 2; i_0--) {
        A[i_0][2] = B[i_0-1] * A[i_0-2][2] + 6;
    }
#pragma endscop
...
kernel_4116212125_09(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
