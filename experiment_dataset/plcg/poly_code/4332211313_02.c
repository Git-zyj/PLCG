        ...
        for (int i_1 = 0; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_1+PB_P, i_1); i_2++) {
                for (int i_3 = 0; i_3 < PB_P; i_3++) {
                    A[i_1+1][i_3+i_2][i_3] = D[i_3+1][i_2+i_1][i_3][i_0] + A[i_1][i_3+i_2+1][i_3] * 1;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        B[i_4] = E[i_4] + B[i_4+1] - B[i_4-1] - B[i_4+1] + 1;
    }
    for (int i_5 = 0; i_5 < PB_M; i_5++) {
        for (int i_6 = 0; i_6 < min(i_5, PB_M-1); i_6++) {
            C[i_6][i_6] = F[i_6+1][i_5+1] + B[i_6+1] + B[i_5] + B[i_6] - 4;
        }
    }
#pragma endscop
...
kernel_4332211313_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
