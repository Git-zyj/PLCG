...
void kernel_2122152211_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P-2; i_0++) {
        for (int i_1 = 3; i_1 < min(-i_0+PB_M, PB_P-1); i_1++) {
            A[0][i_0][i_1-2] = B[i_1+2][i_0] - B[i_1+i_0][i_0] * B[i_1-2][i_0] * B[i_1][i_0+2] * B[i_1+i_0-2][i_1+1] * A[0][i_0-1][i_1-1] * A[0][i_0][i_1-3] - 5;
        }
    }
#pragma endscop
...
kernel_2122152211_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B));
