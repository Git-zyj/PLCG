        ...
        for (int i_1 = 1; i_1 < PB_P-2; i_1++) {
            for (int i_2 = 1; i_2 < PB_P; i_2++) {
                for (int i_3 = 1; i_3 < -i_2+PB_M; i_3++) {
                    B[i_3][i_1][i_3][i_0] = E[i_3+i_2][i_0][i_1][0] * F[i_0][i_3][i_2][i_1][i_1+2] + G[i_3][i_0][i_1+2][i_2] * H[i_1+1][i_3-1][i_0] - B[i_3][i_1-1][i_3][i_0] + B[i_3][i_2-1][i_3][i_0] - 3;
                }
            }
        }
    }
        ...
        for (int i_5 = i_4; i_5 < PB_P-1; i_5++) {
            for (int i_6 = 1; i_6 < min(-i_5+PB_M-1, -i_4+PB_L); i_6++) {
                for (int i_7 = 0; i_7 < PB_P-2; i_7++) {
                    C[i_5][i_6][i_7+1][i_4] = E[i_6][i_7][i_4][i_5+1] + G[i_6+i_5+1][i_6][i_7+2][i_4+1] * E[i_6-1][i_7][i_5+1][i_4+1] - I[i_5][i_6+i_4][i_4-2][0] + 1;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4334332115_00(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I)));
