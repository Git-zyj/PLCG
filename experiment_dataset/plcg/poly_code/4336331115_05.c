        ...
        for (int i_1 = max(1, i_0); i_1 < PB_Q-1; i_1++) {
            for (int i_2 = max(1, i_0); i_2 < PB_M+1; i_2++) {
                for (int i_3 = 0; i_3 < PB_M; i_3++) {
                    B[i_1-1][i_2-1][i_3] = D[i_2][i_1][i_3+1][i_1+1] * D[i_1][i_3][i_0][i_2] + E[i_3][i_1][i_0][i_2] * F[i_2-1][i_3][i_2] * 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M+1; i_4++) {
        for (int i_5 = i_4; i_5 < PB_M; i_5++) {
            for (int i_6 = i_4; i_6 < min(PB_M, -i_4+PB_L); i_6++) {
                B[i_4-1][i_5][i_6] = G[i_5][i_6+i_4][i_4] + H[i_6][i_4][i_5] - I[i_6][i_5-1] + B[i_4-1][i_5][i_6+1] - 1;
            }
        }
    }
        ...
        for (int i_8 = 0; i_8 < PB_M; i_8++) {
            for (int i_9 = 1; i_9 < PB_M+1; i_9++) {
                for (int j_0 = 1; j_0 < -i_8+PB_M; j_0++) {
                    B[i_9-1][i_7][j_0-1] = J[i_7][i_8][j_0][j_0][i_9] - K[j_0+i_8][j_0][i_7+1][i_9] + 3;
                }
            }
        }
    }
...
init_array(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,wj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4336331115_05(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,wj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,wj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K)));
