...
void kernel_3426151125_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N; i_0++) {
        A[i_0] = E[i_0-1] * E[i_0] * E[i_0] + E[i_0] + 5;
        for (int i_1 = 0; i_1 < min(-i_0+PB_Q, PB_N); i_1++) {
            for (int i_2 = 2; i_2 < min(-i_0+PB_L, PB_N+1); i_2++) {
                B[i_2][i_0][0] = F[i_2][i_1] - G[i_1][i_2-1][i_0] - G[i_2-1][i_0+1][i_1+i_0] - G[i_0][i_2][i_1] - H[i_2+i_0][i_1+1][i_2+1][i_1] + B[i_2-2][i_0-1][0] * 1;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_L; i_3++) {
        A[i_3+2] = E[i_3] + F[i_3+1][0] * E[0] + E[i_3-1] + E[i_3] * E[i_3] * E[i_3] * 2;
    }
    for (int i_4 = 2; i_4 < PB_M; i_4++) {
        A[i_4-2] = E[i_4] * E[i_4] - E[i_4] + E[i_4-1] - 5;
    }
#pragma endscop
...
kernel_3426151125_05(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
