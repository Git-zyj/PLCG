        ...
        for (int i_2 = max(2, i_1); i_2 < -i_1+PB_Q; i_2++) {
            for (int i_3 = 0; i_3 < -i_2+PB_Q; i_3++) {
                for (int i_4 = 2; i_4 < PB_Q; i_4++) {
                    B[i_4][i_4-1][i_2-2][i_3] = F[i_4][i_3][i_2+i_1][i_1-1] + G[i_2][i_3+2][i_1][i_4-2] + F[i_1][i_2-1][i_4][i_3+2] + G[i_4][i_1][i_3+i_2][i_3] * H[i_1][i_2][i_4][i_3+1][i_2-1] + 1;
                }
            }
        }
        for (int i_5 = 2; i_5 < min(-i_1+PB_L, PB_L-2); i_5++) {
            C[i_1+1][i_5+2] = I[i_1-1][i_5] * I[i_5][i_1+1] + J[i_5][i_1] * I[i_5-2][i_1] + K[i_1][i_5+i_1] - K[i_5][i_1] * I[i_5+i_1][0] + C[i_1-1][i_5+2] - C[i_1+3][i_5+2] - 5;
        }
    }
#pragma endscop
...
kernel_4334352121_00(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K));
