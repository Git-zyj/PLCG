        ...
        for (int i_1 = 1; i_1 < PB_P-1; i_1++) {
            for (int i_2 = i_0; i_2 < PB_M; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_0+PB_M, -i_2+PB_M); i_3++) {
                    A[i_3+i_0][i_3][i_1][i_1+1] = D[i_3+i_2][i_0-1][i_1][i_0] * D[i_1-1][i_3][i_2+1][i_0] * A[i_3+i_2][i_3][i_1-1][i_1] + A[i_3+i_0][i_3][i_1-1][i_1] + 5;
                }
            }
        }
        B[i_0] = E[i_0] + E[i_0] + E[i_0] + E[i_0] * E[i_0] + E[i_0] + B[i_0-1] + 6;
    }
    for (int i_4 = 3; i_4 < PB_P; i_4++) {
        for (int i_5 = 1; i_5 < -i_4+PB_P; i_5++) {
            for (int i_6 = 2; i_6 < -i_5+PB_P-1; i_6++) {
                for (int i_7 = 0; i_7 < min(min(-i_4+PB_M+3, i_4), -i_6+PB_M+1); i_7++) {
                    C[i_7+i_6-1][i_6+i_5-1][i_5+i_4][i_7] = D[i_7][i_6][i_4-1][i_5+1] * C[i_7+i_6-1][i_6+i_5-1][i_5+i_4-1][i_7] + C[i_7+i_4-3][i_7+i_6-2][i_6+i_5+1][i_4] * 5;
                }
            }
        }
    }
...
kernel_4316131221_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
