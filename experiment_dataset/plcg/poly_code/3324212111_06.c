...
void kernel_3324212111_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
    ...
    for (int i_0 = 1; i_0 < PB_N; i_0++) {
        ...
        for (int i_3 = i_0; i_3 < PB_L; i_3++) {
            for (int i_4 = 1; i_4 < PB_Q; i_4++) {
                B[i_4+1][i_3][i_0-1][i_4] = B[i_0+1][i_3+1][i_4-1][i_0] - 1;
            }
            for (int i_5 = 1; i_5 < min(-i_3+PB_M, PB_Q+1); i_5++) {
                C[i_0][i_3][i_5-1] = D[i_5+i_3][i_3] - 1;
            }
        }
    }
#pragma endscop
...
kernel_3324212111_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
