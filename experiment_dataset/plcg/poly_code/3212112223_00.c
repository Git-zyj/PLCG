...
void kernel_3212112223_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_2 = 0; i_2 < PB_M; i_2++) {
        for (int i_3 = 0; i_3 < PB_M; i_3++) {
            for (int i_4 = 2; i_4 < PB_M; i_4++) {
                B[i_3][i_4] = C[i_4+1][0][i_3] * C[i_4][i_3][i_2] - B[i_4+1][i_3] - B[i_4-2][i_3] + B[i_3][i_4-2] * B[i_2+1][i_4] * 5;
            }
        }
    }
#pragma endscop
...
kernel_3212112223_00(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
