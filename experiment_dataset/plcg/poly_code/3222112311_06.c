...
void kernel_3222112311_06(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-3; i_0++) {
        for (int i_1 = 0; i_1 < PB_N; i_1++) {
            A[i_0+2][1] = C[i_1] * A[i_0+3][1] + A[i_0+1][1] + 4;
        }
    }
    for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
        for (int i_3 = 0; i_3 < PB_M-2; i_3++) {
            A[i_3+2][1] = A[i_2+1][1] + 2;
        }
    }
#pragma endscop
...
kernel_3222112311_06(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
