...
void kernel_4314112125_08(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 0; i_1 < PB_P-2; i_1++) {
            for (int i_2 = 0; i_2 < i_0; i_2++) {
                for (int i_3 = 0; i_3 < PB_L-1; i_3++) {
                    B[i_2][i_0+2][i_3+1][i_1+2] = 5;
                }
                for (int i_4 = 0; i_4 < i_1; i_4++) {
                    B[i_2][i_0][i_4][i_1] = D[i_1][i_2][i_2] * 3;
                }
            }
        }
    }
    for (int i_5 = 0; i_5 < PB_L; i_5++) {
        for (int i_6 = 1; i_6 < PB_P; i_6++) {
            for (int i_7 = 0; i_7 < PB_L; i_7++) {
                C[i_7][i_6][i_5+1] = D[i_6-1][i_7][i_5] + C[i_7][i_6][i_5+2] + 3;
            }
        }
    }
#pragma endscop
...
kernel_4314112125_08(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
