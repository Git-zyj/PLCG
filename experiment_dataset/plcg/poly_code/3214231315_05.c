...
void kernel_3214231315_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M+1; i_0++) {
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            B[i_1] = C[i_1] - C[i_1] - C[i_0-1] - B[i_1-1] * 6;
        }
    }
    for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
        B[i_2] = C[i_2] - C[i_2+1] - C[i_2] + B[i_2-1] + B[i_2+1] - 1;
    }
#pragma endscop
...
kernel_3214231315_05(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
