...
void kernel_4434252213_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,int vi,int wi,DATA_TYPE POLYBENCH_5D(I,xI,yI,zI,vI,wI,xi,yi,zi,vi,wi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 0; i_1 < PB_P-3; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_Q-1, -i_1+PB_P-3); i_2++) {
                for (int i_3 = 1; i_3 < min(-i_0+PB_L, i_0); i_3++) {
                    A[0][i_3+1][i_2+i_1+2][i_0] = E[i_3][i_2][i_1][i_3+i_0][i_0] * F[i_2+i_1][i_0+1][i_2-1][i_3] + G[i_1][i_0][i_3+1][i_2] + H[i_2][i_1][i_3] + G[i_3][i_0][i_3][i_1+2] + I[i_3-1][i_0][i_2+i_1][i_2+i_0][1] - G[i_1][i_2][i_3][i_0] - F[i_3+2][i_0][i_0-2][0] + I[i_3][i_1][i_0+2][i_2+i_0+1][i_1] + A[0][i_3][i_2+i_1+3][i_0+1] - A[0][i_0+1][i_2+i_1+3][i_3+1] * 3;
                }
            }
        }
        for (int i_4 = 0; i_4 < PB_L-1; i_4++) {
            C[i_0][i_4+2][i_0+1] = J[i_4+1][i_0] - K[i_0] - 2;
        }
    }
    for (int i_5 = 0; i_5 < PB_L; i_5++) {
        for (int i_6 = 0; i_6 < min(PB_N, -i_5+PB_M); i_6++) {
            for (int i_7 = max(2, i_5); i_7 < PB_L; i_7++) {
                C[i_7][i_6+1][i_7+1] = L[i_7-2][i_6+i_5] * H[i_6][i_7][i_5] * J[i_7][i_6+1] + C[i_7][i_6][i_7+1] + 4;
            }
        }
        for (int i_8 = 0; i_8 < PB_N; i_8++) {
            for (int i_9 = 0; i_9 < min(i_5, PB_L-2); i_9++) {
                for (int j_0 = 0; j_0 < min(-i_8+PB_P, PB_L-1); j_0++) {
                    D[i_9][j_0][i_8][i_5] = G[i_8][i_9+2][i_5][j_0+i_8] - H[i_8][i_5][i_9+2] + H[j_0][i_8][i_9] + D[i_9][j_0+1][i_8][i_5] + 2;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,wi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4434252213_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,wi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,wi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L)));
