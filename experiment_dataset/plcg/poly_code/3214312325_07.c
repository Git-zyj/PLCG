...
void kernel_3214312325_07(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    ...
    for (int i_3 = 4; i_3 < PB_L; i_3++) {
        for (int i_4 = 4; i_4 < PB_L; i_4++) {
            B[i_4-2][i_3] = C[i_4-2][i_3] * B[i_4-4][i_3] + B[i_3-4][i_4] - B[i_4-2][i_3-2] * 6;
        }
    }
#pragma endscop
...
kernel_3214312325_07(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
