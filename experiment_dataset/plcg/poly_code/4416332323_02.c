...
void kernel_4416332323_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 2; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 2; i_2 < min(i_1, -i_0+PB_L-1); i_2++) {
                for (int i_3 = 1; i_3 < min(min(min(-i_2+PB_L, -i_1+PB_L), -i_0+PB_P), PB_M-2); i_3++) {
                    A[i_2+2][i_1][i_3] = E[i_1][i_2][i_3+i_0][i_1] * A[i_3+2][i_1][i_2-2] - C[i_3-1][i_2-2][i_1+2] - 6;
                    C[i_3][i_1+2][i_2+2] = F[i_1][i_0-1][i_2+2][i_0+2] - G[i_1+2][i_3+2][i_2][i_0] - H[i_1+2][i_3+i_2][i_0-1] + E[i_0][i_3+i_1][i_1][i_2] + D[i_1+2][i_2+i_0+1][i_0+1] * 2;
                }
                C[i_2][i_0][i_1+2] = I[i_1-2][i_0][i_2] - H[i_0][i_2][i_1+1] + H[i_2-2][i_1+1][i_0] + J[i_0][i_1][i_1+1] * 1;
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M-2; i_4++) {
        for (int i_5 = 1; i_5 < PB_L-2; i_5++) {
            for (int i_6 = i_5; i_6 < min(-i_5+PB_L, PB_L-2); i_6++) {
                for (int i_7 = i_4; i_7 < min(-i_5+PB_L-2, -i_6+PB_L); i_7++) {
                    D[i_7+2][i_6+i_5][i_6+1] = F[i_5][i_6][i_4][i_7] - C[i_4][i_7+1][i_6+2] * D[i_6+2][i_7+i_5+2][i_7+1] + D[i_7+2][i_6+i_5-1][i_6+1] + D[i_4+2][i_7+i_6][i_7] - 3;
                }
            }
        }
    }
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4416332323_02(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J)));
