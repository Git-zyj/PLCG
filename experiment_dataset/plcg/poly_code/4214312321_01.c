...
void kernel_4214312321_01(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        for (int i_1 = 2; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_L-1; i_2++) {
                A[i_1][i_2+1] = A[i_2-1][i_1+1] + A[i_2][i_1] + A[i_1-2][i_2+1] + 4;
            }
        }
    }
        ...
        for (int i_4 = i_3; i_4 < PB_L; i_4++) {
            for (int i_5 = 0; i_5 < min(-i_4+PB_P, PB_L-1); i_5++) {
                for (int i_6 = 2; i_6 < PB_L-1; i_6++) {
                    B[i_4][i_5][i_4] = C[i_6][i_4][i_6+1] + C[i_5][i_6-2][i_5+i_4] - B[i_5+1][i_6+1][i_5+1] + B[i_4][i_6+1][i_4] * 5;
                }
            }
        }
    }
...
kernel_4214312321_01(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
