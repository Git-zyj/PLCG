...
void kernel_4416112213_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve)){
        ...
        for (int i_1 = i_0; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_M; i_2++) {
                for (int i_3 = 0; i_3 < min(i_2, -i_1+PB_L); i_3++) {
                    A[i_3][i_1][i_2+i_0][i_3] = E[i_3][i_0+1][i_3+i_2-1][i_0] + E[i_3+i_1][i_0][i_2][i_3] * A[i_3][i_1][i_2+i_0-1][i_3] * 2;
                }
            }
        }
    }
        ...
        for (int i_5 = 2; i_5 < -i_4+PB_M+1; i_5++) {
            for (int i_6 = i_5; i_6 < PB_M-1; i_6++) {
                for (int i_7 = 1; i_7 < PB_M-1; i_7++) {
                    C[i_5+i_4-2][i_7][i_6][i_4] = C[i_5+i_4-1][i_7+1][i_6][i_4+1] * C[i_5+i_4-2][i_6+1][i_7-1][i_4] - 3;
                }
                for (int i_8 = 0; i_8 < PB_L; i_8++) {
                    D[i_5][i_8][i_5][i_4] = C[i_6+i_5-2][i_8][i_4][i_5] - 1;
                }
            }
        }
    }
...
kernel_4416112213_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
