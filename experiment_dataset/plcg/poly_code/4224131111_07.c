...
void kernel_4224131111_07(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = i_0; i_1 < PB_Q; i_1++) {
            for (int i_2 = 2; i_2 < PB_Q-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_P; i_3++) {
                    A[i_1][i_3-1][i_2+1] = C[i_0][i_3][i_2][i_1] * 6;
                }
                for (int i_4 = -i_2+PB_M - 1; i_4 >= 1; i_4--) {
                    B[i_4-1][i_1-1][i_0] = D[i_2][i_4-1][i_1] + D[i_4+i_2][i_0+1][i_1-1] - C[0][i_4+1][i_2][i_0+1] - C[i_0+1][i_4][i_1][i_2-1] * B[i_2-2][i_1-1][i_0-1] - 6;
                }
            }
        }
    }
...
kernel_4224131111_07(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
