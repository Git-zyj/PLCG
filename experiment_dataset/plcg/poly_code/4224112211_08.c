...
void kernel_4224112211_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N-3; i_0++) {
        for (int i_1 = 1; i_1 < PB_N-3; i_1++) {
            A[i_0+2][i_1][i_0] = A[i_1+3][i_0+1][i_1+1] * A[i_0+3][i_1][i_0+1] - A[i_0+2][i_1-1][i_0] - A[i_0+2][i_1+1][i_0] + 1;
        }
        B[i_0] = C[i_0+1] - 1;
    }
#pragma endscop
...
kernel_4224112211_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
