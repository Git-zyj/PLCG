...
void kernel_3436312321_09(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-4; i_0++) {
        for (int i_1 = max(1, i_0); i_1 < PB_P; i_1++) {
            for (int i_2 = i_0; i_2 < PB_L-1; i_2++) {
                A[i_1][i_0+2][0] = A[i_1][i_0+4][0] + A[i_1+2][i_2+1][0] - A[i_1-1][i_0+1][0] * 6;
            }
        }
    }
    ...
    for (int i_4 = 3; i_4 < PB_M-1; i_4++) {
        for (int i_5 = i_4; i_5 < PB_L+1; i_5++) {
            C[i_4-2][i_5-1] = C[i_4][i_5-1] * C[i_4-3][i_5-1] * 5;
        }
        D[i_4] = E[i_4-2] + D[i_4+1] + D[i_4-1] - D[i_4-2] * 1;
    }
#pragma endscop
...
kernel_3436312321_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
