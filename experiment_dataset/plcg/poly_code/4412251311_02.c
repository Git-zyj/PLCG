...
void kernel_4412251311_02(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        A[i_0-1][i_0] = E[i_0] - E[i_0] - F[i_0-1] - A[i_0][i_0+1] - A[i_0-2][i_0-1] - B[i_0][0] + 1;
        for (int i_1 = 0; i_1 < PB_M; i_1++) {
            B[i_0+1][0] = G[i_0][i_1] * G[i_1][i_0] * H[i_1][i_0] - A[i_0-1][i_0] + A[i_0][i_0+1] * 3;
        }
        for (int i_2 = 1; i_2 < min(-i_0+PB_N-1, i_0); i_2++) {
            for (int i_3 = 2; i_3 < -i_0+PB_P; i_3++) {
                for (int i_4 = 2; i_4 < -i_3+PB_Q; i_4++) {
                    D[i_2+1][i_3-2][i_4] = I[i_4-1][i_3+i_0][i_4+i_3][i_2] + J[i_2][i_0][i_4][i_3] * J[i_2][i_4][i_0-1][0] * I[i_2+1][i_0-1][i_4-1][i_3] - J[i_2][i_3-1][i_4+i_2][i_0] * J[i_3-1][i_4][i_0][0] + D[i_3+1][i_4-2][i_2] * 4;
                }
                D[i_0][i_3-1][i_2] = K[i_3][i_0][i_2] - K[i_0][i_3+i_2][i_0-1] - I[i_0][i_2][i_2][i_3] * L[i_2+i_0+1][i_3][0] - L[i_2-1][i_0][i_3] * K[i_3][i_2+1][i_0] + K[i_3+i_2+1][i_0][i_3] - K[i_3][i_2-1][i_0] + D[i_2-1][i_3-1][i_0] * D[i_2][i_0-2][i_3] * D[i_2+1][i_0-1][i_3] - 2;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4412251311_02(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L)));
