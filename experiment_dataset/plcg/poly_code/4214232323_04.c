...
void kernel_4214232323_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
        ...
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < PB_P-2; i_2++) {
                for (int i_3 = 0; i_3 < PB_M-1; i_3++) {
                    A[i_1-1][i_1-1][i_3][i_0+2] = C[i_2][i_3][0] + D[i_0][i_1-2][i_2+2][i_3] - E[i_3+1][i_2][i_1][i_0] - A[i_1-1][i_1-1][i_3][i_0+1] * A[i_1-1][i_1-1][i_3+2][i_0+2] * A[i_1-1][i_1-1][i_0-2][i_3+2] * 5;
                }
            }
            for (int i_4 = 0; i_4 < PB_L-2; i_4++) {
                A[i_0][i_0][i_1][i_4+2] = C[i_4+2][i_1][i_0] - F[i_1][i_4][i_0] + F[i_0][i_4][i_1] + 6;
            }
        }
    }
#pragma endscop
...
kernel_4214232323_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
