...
void kernel_3214111313_05(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_P-1; i_0++) {
        ...
        for (int i_3 = 1; i_3 < min(i_0, -i_0+PB_P); i_3++) {
            B[i_3][0][i_3+i_0] = C[i_3+1][i_0] * B[i_3-1][0][i_3+i_0-1] + B[i_0-1][0][i_3+i_0-1] + B[i_3][0][i_3+i_0-1] - 3;
        }
    }
#pragma endscop
...
kernel_3214111313_05(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
