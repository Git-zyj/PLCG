...
void kernel_2322152215_06(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        for (int i_1 = 1; i_1 < PB_L-2; i_1++) {
            A[i_1][i_1+1] = D[i_1] + A[i_1-1][i_1] + A[i_1+1][i_1+2] * 4;
        }
        for (int i_2 = 2; i_2 < PB_M; i_2++) {
            A[i_0][i_0+1] = E[i_2][i_0-2] + D[i_2] - D[i_0] + E[i_2-2][i_0] - E[i_2][i_0] * 3;
        }
    }
    for (int i_3 = 2; i_3 < PB_P-2; i_3++) {
        for (int i_4 = 1; i_4 < PB_P; i_4++) {
            C[i_3+1][i_3-1] = E[i_4][i_3] - E[i_4][i_3+2] + E[i_3][i_4-1] - E[i_4][i_3] + D[i_4] * E[i_3][0] - D[i_4] + E[i_3-2][0] + C[i_3+2][i_3] + 4;
        }
    }
#pragma endscop
...
kernel_2322152215_06(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
