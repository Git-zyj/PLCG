...
void kernel_3424312121_05(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
...
#pragma scop
    ...
    for (int i_2 = 2; i_2 < PB_Q; i_2++) {
        for (int i_3 = 0; i_3 < i_2; i_3++) {
            C[i_2][i_3+2][i_2] = C[i_2][i_3+2][i_2] + 4;
            for (int i_4 = 1; i_4 < PB_Q; i_4++) {
                C[i_4][i_3+2][i_4] = E[i_3][i_4-1][i_2] - A[i_3][i_4-1] + 3;
            }
        }
        for (int i_5 = 2; i_5 < -i_2+PB_L; i_5++) {
            D[i_5+i_2][i_5] = D[i_5+i_2-2][i_5-2] + 1;
        }
    }
#pragma endscop
...
kernel_3424312121_05(xa,ya,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
