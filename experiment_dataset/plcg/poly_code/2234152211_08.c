...
void kernel_2234152211_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-1; i_0++) {
        A[i_0] = C[i_0] - C[i_0] + C[i_0] * C[i_0] * C[i_0] + A[i_0+1] * 3;
    }
    for (int i_1 = 2; i_1 < PB_L; i_1++) {
        A[i_1] = C[i_1-2] - C[0] * C[i_1+1] + C[i_1] + A[i_1] * 5;
    }
#pragma endscop
...
kernel_2234152211_08(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
