...
void kernel_4214312321_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
        ...
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            for (int i_2 = 2; i_2 < PB_P+1; i_2++) {
                for (int i_3 = 2; i_3 < PB_P-1; i_3++) {
                    A[i_1][i_2-2][i_3] = A[i_0][i_1-2][i_3+1] - A[i_1][i_3-2][i_2-1] + 1;
                }
            }
        }
        B[i_0] = C[i_0-2][i_0] - B[i_0+2] - B[i_0-1] - B[i_0-2] * B[i_0+1] * 6;
    }
#pragma endscop
...
kernel_4214312321_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
