...
#pragma scop
        ...
        for (int i_1 = i_0; i_1 < PB_M; i_1++) {
            for (int i_2 = 2; i_2 < -i_0+PB_L-4; i_2++) {
                for (int i_3 = 0; i_3 < -i_1+PB_M; i_3++) {
                    C[i_3][i_2+i_0+4][i_3][0] = D[i_3+i_1][i_2][i_0][i_3] * E[i_1][i_3][i_0-1][i_2] - D[i_0][i_2+2][i_1+2][i_2-2] + 1;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 1; i_5 < PB_M; i_5++) {
            for (int i_6 = i_5; i_6 < min(PB_L, -i_4+PB_P); i_6++) {
                B[i_5][i_6][i_4] = E[i_5][i_6-1][i_6+i_4][0] + F[i_5][i_4][i_6+2] + G[i_6][i_5] - F[i_6][i_4+2][i_5] - F[i_4][i_6][i_5+1] + H[i_6][i_5-1] + F[i_6][i_4][i_5+2] + B[i_5][i_6][i_4-1] * 1;
            }
        }
        for (int i_7 = 0; i_7 < -i_4+PB_L-2; i_7++) {
            for (int i_8 = 0; i_8 < i_7; i_8++) {
                for (int i_9 = 0; i_9 < -i_4+PB_P-1; i_9++) {
                    C[i_9][i_7+i_4+2][i_9][0] = D[i_7][i_9+i_4+1][i_8+1][i_9+1] + E[i_8+1][i_9][i_9][i_7] * D[i_7][i_4][i_8][i_9+2] + 5;
                }
            }
        }
    }
...
init_array(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4324252111_06(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H)));
