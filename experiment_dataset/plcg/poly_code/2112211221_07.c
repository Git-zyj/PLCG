...
void kernel_2112211221_07(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N; i_0++) {
        for (int i_1 = max(3, i_0); i_1 < PB_N; i_1++) {
            A[i_0-1][0] = B[i_1] - A[i_0][0] + A[i_1-3][0] + 4;
        }
    }
#pragma endscop
...
kernel_2112211221_07(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
