...
void kernel_4222312115_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 2; i_1 < PB_L; i_1++) {
            for (int i_2 = 2; i_2 < PB_L-2; i_2++) {
                for (int i_3 = 0; i_3 < -i_2+PB_L-2; i_3++) {
                    A[i_3+1][i_1-2][i_2+1][i_2] = C[i_1][i_3+i_2+2][i_0-1][i_0] - D[i_1][i_3+i_2-2][i_1] * A[i_3][i_1-1][i_2+1][i_2] + 3;
                }
            }
        }
        for (int i_4 = 0; i_4 < PB_Q-1; i_4++) {
            for (int i_5 = 0; i_5 < PB_L; i_5++) {
                A[i_5][i_0-3][i_4+1][i_4] = 6;
            }
        }
    }
#pragma endscop
...
kernel_4222312115_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
