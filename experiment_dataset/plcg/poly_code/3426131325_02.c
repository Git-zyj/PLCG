    ...
    for (int i_4 = 0; i_4 < PB_P-1; i_4++) {
        for (int i_5 = 1; i_5 < PB_P; i_5++) {
            for (int i_6 = 2; i_6 < min(min(-i_5+PB_P, -i_4+PB_M-1), i_5); i_6++) {
                D[i_5][i_4][i_6] = H[i_4][i_6][i_5] - G[i_6+i_4+1][i_5-1][i_4+1][i_5-1] + F[i_5-1][i_6] - F[i_4][i_6+i_5] * H[i_6+1][i_6][i_5] * B[i_5+2][i_6-2] * 2;
            }
        }
    }
#pragma endscop
...
kernel_3426131325_02(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
