...
void kernel_2432351213_08(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        A[i_0][i_0-1] = E[i_0+1] - F[i_0][i_0] - A[i_0+1][i_0] + 5;
        for (int i_1 = 2; i_1 < min(min(-i_0+PB_L, i_0), PB_P-1); i_1++) {
            B[i_0][i_1] = G[i_1][i_0-1] + H[1] + I[i_1-1] - J[i_1][i_0+1] + J[i_1][i_0] + I[i_1] * F[i_1+i_0][i_0] - A[i_1-1][i_1-2] - B[i_0-1][i_1-1] * B[i_0][i_1-1] - B[i_0][i_1+1] * B[i_0-1][i_1] - 3;
        }
    }
    for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
        C[0] = J[i_2-1][i_2+1] - E[i_2-1] * I[i_2] * C[0] + 3;
        D[i_2] = H[i_2] - E[i_2] - H[i_2] - I[i_2] * E[i_2] - 1;
    }
#pragma endscop
...
kernel_2432351213_08(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
