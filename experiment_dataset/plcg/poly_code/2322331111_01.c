...
#pragma scop
    ...
    for (int i_2 = 1; i_2 < PB_M+1; i_2++) {
        for (int i_3 = 0; i_3 < min(-i_2+PB_L, PB_M-1); i_3++) {
            C[i_3] = G[i_2-1][i_3+i_2] * H[i_3+1] - I[i_2-1][i_3] - E[i_3] - 6;
        }
    }
#pragma endscop
...
kernel_2322331111_01(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
