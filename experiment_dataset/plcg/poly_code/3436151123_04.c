...
void kernel_3436151123_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        A[i_0] = E[i_0] * E[i_0+1] + E[i_0] + E[i_0-1] + E[i_0] + E[i_0] - 6;
        A[i_0] = E[i_0-1] + E[i_0] + E[i_0-1] + E[i_0] + E[i_0] - E[i_0] * D[i_0-2] + 5;
    }
    for (int i_1 = 1; i_1 < PB_M-2; i_1++) {
        for (int i_2 = 0; i_2 < min(-i_1+PB_L-3, PB_M-1); i_2++) {
            for (int i_3 = i_2; i_3 < min(min(-i_1+PB_L-3, -i_2+PB_L-3), PB_M-1); i_3++) {
                C[i_1+1][i_3+i_2+1][i_2+i_1] = F[i_3+1][i_2][i_1-1] + G[i_2][i_3] - F[i_2][i_2+i_1][1] * C[i_1+2][i_3+i_2+3][i_2+i_1+3] - C[i_2+1][i_3+i_1+3][i_3+i_2] * 5;
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M-1; i_4++) {
        D[i_4] = E[i_4+1] - E[i_4] * E[i_4] - E[i_4] * 2;
    }
#pragma endscop
...
kernel_3436151123_04(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
