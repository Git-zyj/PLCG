...
void kernel_4334351325_05(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj)){
        ...
        for (int i_1 = 0; i_1 < -i_0+PB_Q; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_L; i_2++) {
                for (int i_3 = 1; i_3 < i_0; i_3++) {
                    B[i_2+1][i_3][1][i_1+i_0] = D[i_3-1][i_2+i_0][i_1][1] - B[i_0+1][i_3][1][i_2+i_1] + 4;
                }
            }
        }
        for (int i_4 = 0; i_4 < PB_L; i_4++) {
            for (int i_5 = 1; i_5 < min(-i_4+PB_M, PB_L-1); i_5++) {
                for (int i_6 = 1; i_6 < PB_P-1; i_6++) {
                    B[i_0+1][i_6][1][i_5+i_4] = E[i_6-1][i_5+i_4][i_0+1] - F[i_5][i_4][i_0][i_6-1] - F[i_0-1][i_6][i_5][i_4] + G[i_5][i_0][1][i_4] - G[i_5-1][i_0][i_4][i_6+i_5] + D[i_6][i_5+1][i_0][0] - B[i_0+1][i_6+1][1][i_5+i_4] - 3;
                }
            }
        }
    }
    for (int i_7 = 2; i_7 < PB_L-1; i_7++) {
        for (int i_8 = i_7; i_8 < min(-i_7+PB_M, PB_L-2); i_8++) {
            C[i_7-1][i_8] = H[i_8+i_7][i_7] - I[i_7+1][i_8+1] * I[i_7+1][i_8+1] - I[i_8-1][i_7] + H[i_8+1][i_7] - J[i_8][i_8+i_7-1] - C[i_7+1][i_8] * C[i_7-2][i_8] - C[i_7+1][i_8+2] * 6;
        }
    }
#pragma endscop
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4334351325_05(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J)));
