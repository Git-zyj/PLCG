        ...
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_M; i_3++) {
                    B[i_1-1][i_3-1][i_2+1] = D[i_3][i_2+1][i_1][0] + D[i_3][i_2][i_0][i_1] - E[i_0][i_2][i_1][i_3] + E[i_1][i_0][i_3][i_2] - F[i_2][1][i_3+1] * 4;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < PB_M; i_5++) {
            for (int i_6 = 1; i_6 < PB_L; i_6++) {
                for (int i_7 = 1; i_7 < PB_M; i_7++) {
                    B[i_4][i_6-1][i_7] = E[i_7][i_6-1][i_4][i_5] + F[i_6][i_7-1][i_5] * E[i_5][i_4][i_6][i_7] + 4;
                }
            }
        }
        for (int i_8 = 0; i_8 < -i_4+PB_M-2; i_8++) {
            C[i_8+i_4][i_4+1] = G[i_8+1][i_4] + G[i_8][i_4] - H[i_4][i_8] * G[i_8][i_4] * G[i_4][i_8] + C[i_8+i_4+2][i_8+1] * 2;
        }
    }
#pragma endscop
...
kernel_4334251123_01(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
