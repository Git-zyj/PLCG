...
void kernel_2222112123_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        A[i_0+2][i_0-2] = C[i_0] + 1;
    }
    for (int i_1 = 3; i_1 < PB_L; i_1++) {
        A[i_1+2][i_1-2] = C[i_1] - A[i_1+1][i_1-3] - 2;
    }
#pragma endscop
...
kernel_2222112123_00(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
