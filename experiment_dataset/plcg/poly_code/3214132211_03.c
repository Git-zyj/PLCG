...
void kernel_3214132211_03(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-3; i_0++) {
        A[i_0+1][i_0+2] = C[1] + D[i_0][0] * C[i_0] - C[i_0] + A[i_0+2][i_0+3] * 3;
        B[i_0][2] = C[i_0] - A[i_0+1][i_0+2] * A[i_0][i_0+1] + B[i_0-1][2] * 6;
    }
#pragma endscop
...
kernel_3214132211_03(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
