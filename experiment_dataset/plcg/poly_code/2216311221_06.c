...
void kernel_2216311221_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_M-2; i_1++) {
        B[i_1] = C[i_1][i_1+1] - B[i_1-1] * B[i_1+2] + 6;
    }
#pragma endscop
...
kernel_2216311221_06(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
