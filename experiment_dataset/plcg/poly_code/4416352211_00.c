...
void kernel_4416352211_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,int zk,int vk,DATA_TYPE POLYBENCH_4D(K,xK,yK,zK,vK,xk,yk,zk,vk),int xl,int yl,int zl,int vl,DATA_TYPE POLYBENCH_4D(L,xL,yL,zL,vL,xl,yl,zl,vl),int xm,int ym,int zm,int vm,int wm,DATA_TYPE POLYBENCH_5D(M,xM,yM,zM,vM,wM,xm,ym,zm,vm,wm),int xn,int yn,int zn,int vn,DATA_TYPE POLYBENCH_4D(N,xN,yN,zN,vN,xn,yn,zn,vn)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        A[i_0][i_0] = E[i_0+1] * F[i_0+1] * 3;
        for (int i_1 = i_0; i_1 < -i_0+PB_M; i_1++) {
            B[i_1-1][i_0] = G[i_1][i_0+1] + H[i_1+i_0][1] * A[i_0+1][i_0+1] + A[i_0-1][i_0-1] - 4;
        }
    }
    for (int i_2 = 2; i_2 < PB_L-2; i_2++) {
        for (int i_3 = 2; i_3 < PB_L-1; i_3++) {
            C[i_2+1][i_3+1] = F[i_2-2] * I[i_2][i_3] + G[i_3-2][i_2] * J[i_3-2][i_2][i_3+1] + G[i_3][i_2+1] + G[i_2][i_3] - B[i_3-1][i_2] - B[i_2-1][i_3] * 5;
            for (int i_4 = 2; i_4 < min(min(-i_3+PB_L, -i_2+PB_L+1), i_2); i_4++) {
                for (int i_5 = 1; i_5 < min(-i_3+PB_M, -i_4+PB_L-1); i_5++) {
                    D[i_3][i_5+i_4][i_5-1] = K[i_3][i_2+1][i_5][i_4+1] * L[i_2][i_3][i_5][i_4-1] * L[i_5+i_3][i_4-1][i_2+2][i_2] + M[i_3][i_5][i_4][i_2][i_3] - L[i_5+i_3][i_4-2][i_2][i_4] - L[i_5+2][i_3][i_4][i_2] * N[i_3+2][i_4][i_2-1][i_2] - K[i_5][i_5][i_3+2][i_4] + D[i_3-1][i_5+i_4+1][i_4-1] - D[i_5+1][i_4+i_3][i_3-1] + D[i_3+1][i_4+i_2-1][i_2-1] * D[i_3][i_5+i_4-1][i_5-1] * 3;
                }
            }
        }
    }
...
init_array(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,vl,POLYBENCH_ARRAY(L), xm,ym,zm,vm,wm,POLYBENCH_ARRAY(M), xn,yn,zn,vn,POLYBENCH_ARRAY(N), INIT_SEED);
kernel_4416352211_00(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,vl,POLYBENCH_ARRAY(L), xm,ym,zm,vm,wm,POLYBENCH_ARRAY(M), xn,yn,zn,vn,POLYBENCH_ARRAY(N));
