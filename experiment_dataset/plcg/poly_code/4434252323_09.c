...
void kernel_4434252323_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk)){
        ...
        for (int i_1 = 1; i_1 < min(PB_M-4, i_0); i_1++) {
            for (int i_2 = 1; i_2 < min(-i_1+PB_L, PB_M-2); i_2++) {
                for (int i_3 = 1; i_3 < PB_L-2; i_3++) {
                    A[i_1+2][i_3][i_2][i_0] = E[i_3][i_2+i_1][i_3][i_2-1] * F[i_0][i_3][i_3][i_1] + E[i_3-1][i_2][i_1][i_0] - A[i_1][i_3][i_2+2][i_0] - A[i_2+2][i_3][i_1-1][i_0+1] - A[i_1+4][i_3+2][i_2][i_0] - 6;
                }
            }
        }
        for (int i_4 = max(2, i_0); i_4 < PB_M-2; i_4++) {
            B[i_0][i_4-1] = G[i_0][i_4] * H[i_0][i_4] * G[i_4][i_4-2] * I[i_0][i_4][i_0+1] - J[i_4] * G[i_0][i_4] + G[i_4+2][i_0] - B[i_0][i_4+1] - 3;
        }
    }
    for (int i_5 = 2; i_5 < PB_L; i_5++) {
        for (int i_6 = 1; i_6 < PB_L; i_6++) {
            for (int i_7 = 1; i_7 < PB_L; i_7++) {
                B[i_7][i_6-1] = F[i_5-2][i_7][i_7][i_6] + B[i_6][i_7-1] + 2;
            }
        }
        for (int i_8 = 2; i_8 < -i_5+PB_M; i_8++) {
            for (int i_9 = i_8; i_9 < -i_5+PB_L; i_9++) {
                for (int j_0 = 2; j_0 < -i_9+PB_N; j_0++) {
                    B[j_0][i_9-1] = E[j_0][i_9][i_5][i_8-2] * F[i_9+2][i_5-1][i_8][j_0-2] - K[j_0+i_9][i_8+i_5][i_8] * E[i_8][i_5][j_0][i_9] + E[i_9][j_0][i_5][i_8] - E[i_8][i_5][j_0+1][i_9+2] * F[j_0][i_9+i_5][i_8][i_8] + 1;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4434252323_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K)));
