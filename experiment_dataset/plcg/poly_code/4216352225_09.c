        ...
        for (int i_1 = max(2, i_0); i_1 < PB_L-3; i_1++) {
            for (int i_2 = 1; i_2 < PB_L; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_0+PB_M, -i_2+PB_L); i_3++) {
                    B[i_1+1][i_2-1][i_0][i_1+3] = C[i_1][i_0+2][i_3][i_2] - D[i_2][i_0][i_3][i_1] - C[i_3+i_0][i_2][i_1+2][1] + C[i_0-1][i_3+i_2][i_1-2][i_3] * 4;
                }
            }
        }
    }
        ...
        for (int i_5 = 2; i_5 < i_4; i_5++) {
            for (int i_6 = 1; i_6 < PB_M; i_6++) {
                for (int i_7 = 3; i_7 < PB_L-1; i_7++) {
                    B[i_7-1][i_6-1][i_4][i_7+1] = C[i_6][i_7][i_7+1][i_5] * D[i_7][i_5][i_6][2] * D[i_6][i_7][i_5][i_4] - E[i_7][i_7+1][i_5-2] * D[i_7][i_6][i_4][i_5] + D[i_7][i_4+1][i_4][i_5] + B[i_7-3][i_6-1][i_5][i_7-1] + B[i_7-1][i_6-1][i_4-2][i_7+1] - 2;
                }
            }
        }
    }
...
kernel_4216352225_09(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
