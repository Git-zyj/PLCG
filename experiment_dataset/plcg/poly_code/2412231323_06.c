...
void kernel_2412231323_06(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_N+1; i_0++) {
        for (int i_1 = 1; i_1 < PB_N-1; i_1++) {
            C[i_0-2] = E[i_1][i_1] * F[i_1][i_0] - G[i_0][i_1][i_0] * B[i_1+1] * B[i_1-1] - 2;
        }
        B[i_0-1] = H[i_0] * I[i_0] * B[i_0-3] + 2;
        C[i_0] = I[i_0] + H[0] * H[i_0-1] - H[i_0] - I[i_0] + C[i_0-1] * 2;
        C[i_0] = C[i_0+2] + C[i_0-2] + 1;
    }
#pragma endscop
...
kernel_2412231323_06(xc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
