...
void kernel_4434352321_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        A[i_0] = E[0] - F[i_0] + E[i_0] - F[0] - E[i_0] + A[i_0+2] + A[i_0-1] - A[i_0+1] - A[i_0-2] * A[i_0-1] + A[i_0+1] * A[i_0-1] + 6;
    }
    for (int i_1 = 4; i_1 < PB_L-2; i_1++) {
        for (int i_2 = 0; i_2 < i_1; i_2++) {
            for (int i_3 = 1; i_3 < PB_L; i_3++) {
                for (int i_4 = i_1; i_4 < PB_L; i_4++) {
                    B[i_4][i_1-2][i_3][i_4] = G[i_2][i_4][i_2+1][2] * H[i_4][i_3-1][i_1][i_2] - I[1][i_4][i_2+2][i_3] * I[i_2][i_1][i_4][0] * B[i_2][i_1-3][i_4-2][i_2] * B[i_4-2][i_1-4][i_3][i_4-2] - 3;
                }
            }
        }
        for (int i_5 = 2; i_5 < -i_1+PB_L+2; i_5++) {
            for (int i_6 = 2; i_6 < PB_L-2; i_6++) {
                C[i_5+2][i_1-1][i_6-1] = G[i_5+2][i_1][i_6][0] - J[i_1+2][i_6][i_5+2] + K[i_5+1][i_1+2][i_6] * L[i_6-2][i_5][i_1] - L[i_6][i_1+2][i_5] - K[i_6][i_1+1][i_1] - 6;
                for (int i_7 = 2; i_7 < -i_6+PB_L; i_7++) {
                    D[i_5][i_6-1][i_1+1][i_7+1] = H[i_7][i_5+i_1-2][i_7+i_6-1][1] * I[i_5][i_7][i_6+2][i_5+1] * G[i_1][i_6+2][i_5][i_6+i_5] * G[i_1][i_7+i_6][i_5-2][i_5] + G[i_1][i_5][i_6][i_7-2] * B[i_1][i_6][i_5][i_1] - D[i_5+2][i_7-1][i_1+2][i_6+1] + 1;
                }
            }
        }
    }
...
kernel_4434352321_02(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L));
