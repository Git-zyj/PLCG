...
void kernel_2234212225_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
            A[i_1] = A[i_1+2] - A[i_1-2] + 3;
        }
    }
...
kernel_2234212225_01(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
