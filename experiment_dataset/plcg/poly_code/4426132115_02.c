...
void kernel_4426132115_02(int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg)){
        ...
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_Q-1, -i_1+PB_L); i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_M; i_3++) {
                    C[i_0-1][i_1][i_1-1][i_2-1] = E[i_1][i_0+2][i_3][i_2+i_0+1] + F[i_2][i_1][i_2+i_1] + E[i_3+i_0][1][i_1-2][i_2+1] * 3;
                }
            }
        }
        ...
        for (int i_5 = 1; i_5 < PB_M-2; i_5++) {
            for (int i_6 = 0; i_6 < -i_5+PB_M-2; i_6++) {
                for (int i_7 = 2; i_7 < PB_L; i_7++) {
                    C[i_4][i_5][i_5-1][i_6] = E[i_5][i_7][i_6][i_4] * E[i_6][i_4][i_5][i_7] + E[i_6+i_5+2][i_4][i_7][i_6] - F[i_6][i_7-2][i_5+1] - 2;
                }
            }
        }
    }
    for (int i_8 = 2; i_8 < PB_M; i_8++) {
        B[i_8] = G[i_8] - G[i_8] + G[i_8-2] + 2;
    }
#pragma endscop
...
init_array(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4426132115_02(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G)));
