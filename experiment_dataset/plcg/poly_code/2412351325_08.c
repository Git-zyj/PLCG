...
void kernel_2412351325_08(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 2; i_1 < -i_0+PB_M-1; i_1++) {
            A[i_0][i_1] = E[i_0-1][0] - F[i_1+i_0+1][1] * E[i_0][i_1+1] * F[i_0-1][i_1+1] * A[i_0-1][i_1-1] + A[i_0][i_1-2] + A[i_0-2][i_1] + 2;
            A[i_0-1][i_1] = G[i_1][i_0+1] * F[i_1+i_0][i_0-1] + 5;
        }
        for (int i_2 = 0; i_2 < -i_0+PB_L; i_2++) {
            A[i_2+2][i_0] = F[i_2][i_0] + H[i_2+i_0-1] - H[i_2] * G[i_2][i_0-1] + E[i_2][i_0+1] - I[i_0][i_2][i_0] + F[i_2+i_0][i_2] - 1;
            A[i_0][i_2] = G[i_2+i_0][1] - E[i_2][i_2] - E[i_2+i_0][i_0] * E[i_0][i_2] - 4;
        }
    }
#pragma endscop
...
init_array(xa,ya,POLYBENCH_ARRAY(A), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_2412351325_08(xa,ya,POLYBENCH_ARRAY(A), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,POLYBENCH_ARRAY(A), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
