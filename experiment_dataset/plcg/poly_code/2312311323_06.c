...
void kernel_2312311323_06(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 3; i_1 < PB_N-1; i_1++) {
        C[i_1-1] = D[i_1] * C[i_1+1] + C[i_1] - C[i_1-3] + 5;
    }
#pragma endscop
...
kernel_2312311323_06(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
