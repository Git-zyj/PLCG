...
void kernel_2424331321_04(int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            C[i_0][i_1] = E[i_1-1] - F[i_0-1][i_1] + 5;
        }
        for (int i_2 = 0; i_2 < PB_L-1; i_2++) {
            B[i_0][i_2] = G[i_2][i_0] + F[i_0][i_0] - H[i_0][i_0+1] + E[i_2] + B[i_0-1][i_2] + B[i_0+1][i_2+1] + C[i_0-1][i_2] - C[i_0][i_2] - 2;
            C[i_0][i_2] = F[i_0+1][i_2] - B[i_0][i_2] + C[i_0+1][i_2] + 1;
        }
    }
    for (int i_3 = 0; i_3 < PB_L; i_3++) {
        D[i_3] = I[i_3] + I[i_3] + D[i_3+1] + 3;
    }
#pragma endscop
...
kernel_2424331321_04(xc,yc,POLYBENCH_ARRAY(C), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
