        ...
        for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 1; i_2 < PB_L; i_2++) {
                for (int i_3 = 1; i_3 < PB_P; i_3++) {
                    A[i_0][i_1-2][i_2-1][i_3] = C[i_1-2][i_3][1][i_0] * D[i_1+2][i_2][i_0][i_2] * A[i_0][i_1-1][i_3-1][i_2] - 6;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_N-1; i_4++) {
        B[i_4-1] = E[i_4] - F[i_4-1] + E[0] * F[i_4-2] + G[i_4+1] - G[i_4] - G[i_4-2] * 5;
    }
#pragma endscop
...
kernel_4226352113_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
