...
void kernel_2324132125_09(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-2; i_0++) {
        C[i_0] = D[i_0-1] * D[i_0] - D[i_0] + D[i_0] + 3;
        C[i_0+2] = D[i_0] + 6;
    }
    for (int i_1 = 2; i_1 < PB_N; i_1++) {
        C[i_1] = D[i_1] - D[i_1] * C[i_1-2] - 1;
    }
#pragma endscop
...
kernel_2324132125_09(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
