...
void kernel_3224212323_06(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < PB_M-4; i_1++) {
            ...
            for (int i_3 = i_0; i_3 < PB_M-1; i_3++) {
                B[i_3][i_1+2][i_0] = C[i_3][i_1+2][i_0+2] - B[i_3][i_1+1][i_0-2] - B[i_3+1][i_1+2][i_0] * B[i_0][i_1+4][i_3] + B[i_3+1][i_1+2][i_0-2] - B[i_3][i_1][i_0] - 5;
            }
        }
    }
#pragma endscop
...
kernel_3224212323_06(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
