...
void kernel_2212312315_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        B[i_0+2] = C[i_0] - 6;
        B[i_0+2] = B[i_0+3] * B[i_0+1] - B[i_0+1] - 6;
    }
#pragma endscop
...
kernel_2212312315_00(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
