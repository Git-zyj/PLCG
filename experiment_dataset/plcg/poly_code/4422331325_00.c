...
void kernel_4422331325_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_P; i_0++) {
        for (int i_1 = 1; i_1 < PB_P; i_1++) {
            for (int i_2 = i_1; i_2 < min(-i_0+PB_Q, PB_Q-1); i_2++) {
                for (int i_3 = 1; i_3 < min(-i_1+PB_P+1, -i_2+PB_Q); i_3++) {
                    A[i_1+1][i_0][i_3+i_2][i_2] = E[i_1+1][i_0+1][i_1][i_3] + E[i_2][i_0+1][i_3+i_1-1][i_1-1] - F[i_3][i_0][i_1][i_2+1] - A[i_1+1][i_3-1][i_2+i_0][i_2] - 6;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < -i_4+PB_Q; i_5++) {
            for (int i_6 = 2; i_6 < -i_4+PB_Q-1; i_6++) {
                for (int i_7 = 0; i_7 < -i_4+PB_Q; i_7++) {
                    A[i_5][i_6-2][i_7+i_4][i_7] = F[i_6][i_4][i_7][i_7+1] * G[i_4-1][i_6][i_5][i_7+1] * H[i_5][i_4-1][i_7+i_6][i_7+i_5][i_5+i_4] - 5;
                }
                for (int i_8 = 1; i_8 < i_5; i_8++) {
                    A[i_5+1][i_8-1][i_6+i_4+1][i_6-1] = E[i_6][i_4][i_8][i_5] * I[i_8][i_8][i_6+i_5] * 1;
                }
            }
        }
        D[i_4-1] = J[i_4-1] + K[i_4+1] - K[i_4+1] * D[i_4+1] * D[i_4-2] + D[i_4] - D[i_4-3] * 3;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4422331325_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K)));
