...
void kernel_4224112223_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
    ...
    for (int i_0 = 0; i_0 < PB_L-1; i_0++) {
        for (int i_1 = i_0; i_1 < min(-i_0+PB_M-2, PB_L); i_1++) {
            for (int i_2 = i_1; i_2 < min(-i_1+PB_M-2, PB_L-2); i_2++) {
                A[i_2+i_1+2][i_0][i_1] = C[i_2+1][i_1] - A[i_1+i_0+2][i_2+2][i_0] + A[i_2+i_1+2][i_0+1][i_1] * 2;
            }
        }
    }
    for (int i_3 = 0; i_3 < PB_L-2; i_3++) {
        for (int i_4 = 0; i_4 < PB_L; i_4++) {
            B[i_4+2][i_3] = C[i_3+2][0] * B[i_4][i_3] + B[i_3+1][i_4] * 3;
        }
    }
#pragma endscop
...
kernel_4224112223_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
