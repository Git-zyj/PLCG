...
void kernel_4424312115_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
        ...
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < i_1; i_2++) {
                for (int i_3 = 0; i_3 < PB_Q; i_3++) {
                    A[i_0][i_1][i_3][i_1] = A[i_0-1][i_1][i_3][i_1] + 3;
                }
            }
        }
        for (int i_4 = 3; i_4 < PB_L; i_4++) {
            for (int i_5 = 0; i_5 < i_0; i_5++) {
                C[i_5][i_4-3] = E[i_5][i_4] * 5;
            }
        }
    }
        ...
        for (int i_8 = i_6; i_8 < PB_P; i_8++) {
            for (int i_9 = 0; i_9 < PB_Q; i_9++) {
                for (int j_0 = 0; j_0 < min(i_9, PB_P-1); j_0++) {
                    D[i_6-1][i_8][j_0][i_9] = F[j_0][j_0+1][i_8] + 3;
                }
            }
        }
    }
...
kernel_4424312115_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
