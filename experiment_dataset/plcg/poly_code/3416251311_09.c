...
void kernel_3416251311_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        A[i_0-1] = E[i_0-1] * E[i_0] - E[i_0+1] + A[i_0] * B[i_0+1] - 6;
        B[i_0+1] = E[i_0] - F[i_0][i_0] * F[i_0][i_0-1] + E[i_0] + A[i_0-1] * B[i_0] - C[i_0+1] + 1;
    }
    for (int i_1 = 1; i_1 < PB_N; i_1++) {
        for (int i_2 = 2; i_2 < PB_N-1; i_2++) {
            C[i_2] = G[i_2-1][i_1] - G[i_2+1][i_1+1] + G[i_1-1][i_2] - G[i_2-1][i_1] * A[i_2-2] + C[i_2+1] - 2;
        }
        for (int i_3 = i_1; i_3 < min(PB_Q, -i_1+PB_L-1); i_3++) {
            for (int i_4 = 0; i_4 < min(PB_Q, -i_1+PB_L-1); i_4++) {
                D[i_4+1][i_4+i_1][i_3][i_1+1] = H[i_1-1][i_4][i_3] - H[i_3][i_1][i_3] + I[i_4+1][i_3][i_1] - G[i_1][i_3] - F[i_4][i_3-1] + I[i_1-1][i_4][i_3-1] + I[i_1][i_4][i_3] - H[i_3][i_4][i_1] * H[i_4+i_1][i_3-1][0] - C[i_4] * D[i_3+2][i_3+i_1+1][i_4+1][i_1+1] * D[i_3+1][i_3+i_1+1][i_4][i_1+2] - D[i_4+1][i_4+i_1+1][i_3][i_1+2] - 2;
            }
        }
    }
#pragma endscop
...
init_array(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_3416251311_09(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
