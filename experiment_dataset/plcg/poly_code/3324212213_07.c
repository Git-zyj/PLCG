...
void kernel_3324212213_07(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
    for (int i_0 = 0; i_0 < PB_P; i_0++) {
        ...
        for (int i_3 = max(1, i_0); i_3 < PB_P; i_3++) {
            B[i_0+1][i_3] = D[i_0+2][1] + E[i_3+2] * A[i_3][i_0+1] - A[i_3+1][i_0] * B[i_0+1][i_3-1] + 6;
        }
    }
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 2; i_5 < PB_P; i_5++) {
            C[i_5-1][i_4+1] = D[i_4+1][i_5] * C[i_5-2][i_4+1] * C[i_4-1][i_5] + C[i_5][i_4+1] + 3;
        }
    }
#pragma endscop
...
kernel_3324212213_07(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
