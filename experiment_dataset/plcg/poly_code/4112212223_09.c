...
void kernel_4112212223_09(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        for (int i_1 = PB_M - 1; i_1 >= 3; i_1--) {
            A[i_0-2][i_1-2] = B[i_1][i_0] - A[i_1-2][i_0] * A[i_0-2][i_1-3] - 4;
        }
    }
#pragma endscop
...
kernel_4112212223_09(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B));
