...
void kernel_4414251225_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk)){
        ...
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 0; i_2 < min(min(-i_1+PB_M, i_0), PB_L-2); i_2++) {
                for (int i_3 = 1; i_3 < min(-i_1+PB_P, PB_L-1); i_3++) {
                    A[i_1][i_0][i_2][i_0] = E[i_3-1][i_0][i_2+1][i_1-1][i_0] * F[i_0+1][i_3+1][i_1][i_2+1] + E[i_2+i_1][i_0][i_3][i_0-1][i_2] - G[i_3+1][i_2][i_3+i_1][i_0+1] - G[i_0][i_1][i_3+1][i_3] * A[i_1][i_0+2][i_2+2][i_0+2] * A[i_3][i_0-2][i_2][i_0-2] * A[i_0][i_1+1][i_2+2][i_1+1] - 3;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
            B[i_0-1] = H[i_0+1] * H[i_0] + I[i_4+1][i_0] + J[i_4-1][i_0] - 4;
        }
        B[i_0-1] = H[i_0] + H[i_0] * H[i_0] + H[i_0+1] - K[i_0+1] - K[i_0] + B[i_0-1] - 4;
    }
    for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
        B[i_5+1] = K[i_5] + K[i_5] * K[i_5+1] * 5;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4414251225_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K)));
