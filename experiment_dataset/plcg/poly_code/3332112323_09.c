...
void kernel_3332112323_09(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < PB_P-2; i_1++) {
            for (int i_2 = 0; i_2 < PB_P-2; i_2++) {
                A[i_0][i_2][i_1+2] = A[i_0-2][i_2][i_1] - A[i_0][i_1+2][i_2+2] + 5;
            }
        }
    }
    for (int i_3 = 0; i_3 < PB_M-2; i_3++) {
        for (int i_4 = 0; i_4 < -i_3+PB_M; i_4++) {
            for (int i_5 = 1; i_5 < PB_L+1; i_5++) {
                A[i_3][i_5-1][i_4+2] = C[i_4][i_4+i_3][i_3+2] * 2;
            }
        }
    }
    for (int i_6 = 0; i_6 < PB_M-1; i_6++) {
        for (int i_7 = 0; i_7 < min(-i_6+PB_M-1, PB_M-3); i_7++) {
            C[i_6][i_7+i_6][i_7+2] = D[i_7+1][i_6+2] + C[i_6][i_7+i_6+1][i_7+3] * C[i_6+1][i_7+i_6+1][i_7+2] * 4;
        }
    }
#pragma endscop
...
kernel_3332112323_09(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
