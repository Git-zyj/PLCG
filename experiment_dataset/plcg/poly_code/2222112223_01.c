...
void kernel_2222112223_01(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N; i_0++) {
        for (int i_1 = i_0; i_1 < -i_0+PB_N; i_1++) {
            B[i_1+2] = C[i_1+i_0] + B[i_1] - 1;
        }
    }
...
kernel_2222112223_01(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
