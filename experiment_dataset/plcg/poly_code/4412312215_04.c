...
void kernel_4412312215_04(int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = 0; i_2 < PB_Q; i_2++) {
                for (int i_3 = 0; i_3 < PB_L; i_3++) {
                    D[i_3][i_2][i_1][i_2] = E[i_1-1][i_0+2][i_3][i_2] * 6;
                }
            }
        ...
        for (int i_4 = 0; i_4 < PB_N-1; i_4++) {
            for (int i_5 = 0; i_5 < PB_N; i_5++) {
                for (int i_6 = 1; i_6 < min(-i_5+PB_P, PB_L); i_6++) {
                    D[i_4][i_6-1][i_5+1][i_6-1] = F[i_4+1][i_0][i_6+i_5][2] + F[i_5][i_6][i_0][i_4] - 5;
                }
            }
        }
    }
        ...
        for (int i_8 = 1; i_8 < i_7; i_8++) {
            for (int i_9 = 0; i_9 < PB_L; i_9++) {
                for (int j_0 = 1; j_0 < PB_Q; j_0++) {
                    D[i_7][j_0][i_8][j_0] = D[i_9][j_0][i_8-1][j_0] - D[i_7+1][j_0-1][i_8-1][j_0-1] - D[i_7-1][i_8+1][j_0][i_8+1] - 6;
                }
            }
        }
    }
...
kernel_4412312215_04(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
