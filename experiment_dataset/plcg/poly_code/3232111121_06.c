...
void kernel_3232111121_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        A[1] = A[1] - 2;
        for (int i_1 = 0; i_1 < PB_M-1; i_1++) {
            A[1] = C[i_1+1] + D[0][i_0] * 1;
        }
    }
#pragma endscop
...
kernel_3232111121_06(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
