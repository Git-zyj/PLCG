...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_M; i_1++) {
        for (int i_2 = 0; i_2 < PB_M; i_2++) {
            C[i_1-2] = F[i_2][i_1-1] + G[i_2][i_1] * D[i_2] + 3;
        }
        C[i_1-1] = H[i_1] - C[i_1-2] - C[i_1] * 3;
    }
#pragma endscop
...
kernel_3312331111_04(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
