...
void kernel_3214112325_05(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_L-2 - 1; i_0 >= 1; i_0--) {
        for (int i_1 = 2; i_1 < PB_P-1; i_1++) {
            A[i_0+1][i_1] = C[i_0-1][i_1] * A[i_0+2][i_1] - A[i_0-1][i_1-2] + 3;
...
kernel_3214112325_05(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C));
