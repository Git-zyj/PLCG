...
void kernel_4412332225_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,int wg,DATA_TYPE POLYBENCH_5D(G,xG,yG,zG,vG,wG,xg,yg,zg,vg,wg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_P-2; i_0++) {
        A[i_0-1] = E[i_0+1] - E[0] - A[i_0] + A[i_0-3] - A[i_0+1] * A[i_0-2] * 2;
        for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 0; i_2 < PB_P; i_2++) {
                B[i_0+1][i_1][i_2] = F[i_1-1][i_1-1][0] - F[i_2][i_1-2][i_0] * 5;
            }
            for (int i_3 = 0; i_3 < -i_0+PB_L+2; i_3++) {
                for (int i_4 = 2; i_4 < -i_0+PB_L-1; i_4++) {
                    B[i_1+1][i_3][i_4+2] = G[i_0][i_4][i_1][i_3][i_0-1] * H[i_1+2][i_4+i_0+1][i_0+2][0] + I[i_1][i_3+i_0-2][i_4][i_3] * J[i_1][i_4-2][i_0-1][i_3] * 5;
                }
            }
        }
    }
    for (int i_5 = 2; i_5 < PB_L+2; i_5++) {
        for (int i_6 = 0; i_6 < PB_M-1; i_6++) {
            for (int i_7 = 0; i_7 < PB_Q-1; i_7++) {
                for (int i_8 = 0; i_8 < min(i_6, PB_Q-2); i_8++) {
                    B[i_6+1][i_8][i_7] = I[i_8][i_5-2][i_8][i_6] - I[i_5-2][i_7][i_7+1][i_8+2] - 5;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4412332225_08(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J)));
