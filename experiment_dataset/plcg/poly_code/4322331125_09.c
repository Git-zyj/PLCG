...
void kernel_4322331125_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_L; i_1++) {
            for (int i_2 = 1; i_2 < PB_N-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_L-1; i_3++) {
                    C[i_1+i_0][i_2-1][i_2][i_1-1] = E[i_2-1][i_3-1][i_0][i_1] * F[i_3+1][i_2-1][i_0][i_1-1] * F[i_0-1][i_3+1][i_1-1][i_2] + E[i_2+1][i_3-1][i_0+1][i_1+i_0+1] * 4;
                }
            }
        }
        for (int i_4 = 1; i_4 < -i_0+PB_L; i_4++) {
            for (int i_5 = 3; i_5 < -i_0+PB_L; i_5++) {
                C[i_5+i_0][i_4-1][i_4][i_5-1] = G[i_4+1][i_0][i_0] + G[i_4+1][i_5][i_4+i_0] + C[i_5+i_4-1][i_0-1][i_0][i_5-3] - 6;
            }
        }
    }
#pragma endscop
...
kernel_4322331125_09(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
