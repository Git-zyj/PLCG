...
void kernel_4426231225_00(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj)){
        ...
        for (int i_1 = i_0; i_1 < PB_P-1; i_1++) {
            for (int i_2 = 2; i_2 < -i_0+PB_P; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_0+PB_L, -i_1+PB_L); i_3++) {
                    B[i_0+1][i_2-2][i_1][0] = E[i_2][i_0-1][i_3][i_3+1] - F[i_2][i_3+i_1][i_2+i_0][i_1][i_0] + G[i_3][i_3+i_0][i_0-1][i_1] + G[i_0][i_3][i_1+1][i_1-1] * 5;
                }
            }
        }
        for (int i_4 = i_0; i_4 < PB_L-1; i_4++) {
            for (int i_5 = 2; i_5 < i_4; i_5++) {
                for (int i_6 = 1; i_6 < min(PB_M, -i_4+PB_Q+1); i_6++) {
                    B[i_0][i_5][i_6][0] = E[i_6][i_4+1][i_6][i_4] - G[i_5-1][i_0-1][i_6][i_6+i_4-1] - G[i_4][i_0][i_6][i_5] - B[i_6-1][i_5][i_0-2][0] * B[i_0][i_5-2][i_6][0] - 1;
                }
            }
        }
    }
    for (int i_7 = 1; i_7 < PB_M-2; i_7++) {
        C[i_7+1] = H[i_7][1] * C[i_7] - C[i_7+2] * 2;
        for (int i_8 = 1; i_8 < i_7; i_8++) {
            for (int i_9 = 0; i_9 < PB_M; i_9++) {
                B[i_7-1][i_8][i_9][0] = I[i_8][i_9][i_7] + J[i_9][i_8] * I[i_8][i_9][0] - I[i_9][i_7+1][i_8-1] + 6;
            }
        }
    }
#pragma endscop
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4426231225_00(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J)));
