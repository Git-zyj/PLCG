...
void kernel_2436251113_07(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-2; i_0++) {
        for (int i_1 = i_0; i_1 < min(PB_M+1, -i_0+PB_L); i_1++) {
            B[i_0+1][i_0] = E[i_1+i_0] * F[i_1-1][i_0+1] + F[i_0][i_1] * G[i_0][i_1+1] * B[i_0+1][i_0] + 6;
        }
        B[i_0+1][i_0] = H[i_0] * H[0] * H[i_0] + H[i_0] + 2;
        for (int i_2 = 1; i_2 < i_0; i_2++) {
            B[i_0+2][i_0+1] = I[i_2-1][i_0][i_0] + G[i_2-1][i_0] + 3;
        }
        for (int i_3 = 1; i_3 < min(-i_0+PB_M-1, i_0); i_3++) {
            B[i_0][i_0-1] = F[i_3+i_0][i_3] - G[i_0][i_0] - F[i_3+i_0+1][i_0+1] - G[i_3][i_0+1] + H[i_0] * G[i_0][i_3] + G[i_3][i_0+1] + F[i_0][i_3+1] + G[i_3-1][i_0] * 4;
        }
    }
#pragma endscop
...
kernel_2436251113_07(xb,yb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
