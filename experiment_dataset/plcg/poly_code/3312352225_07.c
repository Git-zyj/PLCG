...
void kernel_3312352225_07(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        B[i_0-2] = D[i_0+1] + E[i_0+2] * B[i_0-1] + 4;
        B[i_0] = D[i_0] * D[i_0] + F[i_0] - F[i_0] - F[i_0+2] * F[i_0] - C[i_0] + 3;
        C[i_0] = E[i_0] - E[i_0+2] - G[i_0+1][i_0+1] + H[i_0+1][i_0] - E[i_0+1] * E[i_0] * F[2] - B[i_0] * C[i_0-1] * 1;
    }
#pragma endscop
...
kernel_3312352225_07(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
