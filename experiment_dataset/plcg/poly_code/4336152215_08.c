        ...
        for (int i_1 = i_0; i_1 < PB_M; i_1++) {
            for (int i_2 = 2; i_2 < min(-i_0+PB_M, -i_1+PB_M); i_2++) {
                for (int i_3 = 0; i_3 < min(-i_1+PB_M, -i_0+PB_L+2); i_3++) {
                    B[i_2+i_0][i_3+i_1][i_2-1][i_3+1] = D[i_1][i_2][0][i_3+i_0-2] * D[i_0][i_2+2][i_3+i_1][i_2-2] + D[i_3+i_1+1][i_0][i_2+i_1][i_2+i_0] * D[i_2][i_0][i_3+i_1][i_0] + B[i_2+i_0][i_3+i_1][i_0-1][i_1+1] * 3;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < -i_4+PB_M; i_5++) {
            for (int i_6 = 1; i_6 < i_5; i_6++) {
                for (int i_7 = 0; i_7 < -i_4+PB_M; i_7++) {
                    B[i_7+i_4][i_6+i_5][i_4-1][i_5+1] = D[i_7][i_6-1][i_5+i_4][1] * D[i_5+i_4][i_6+2][i_7][0] + D[i_5+2][i_6-1][i_7+1][i_4-2] + D[i_7][i_5+i_4-1][i_6][i_7] * D[i_5][i_7+1][i_4][i_6-1] - D[i_6+i_5+2][i_7][i_4][0] * 2;
                }
            }
        }
        for (int i_8 = 1; i_8 < -i_4+PB_L; i_8++) {
            C[i_8][i_8] = E[i_8] + F[i_4][i_8-1] + G[i_8+i_4][i_8+1][i_4] * C[i_8-1][i_8-1] - C[i_8+1][i_8+1] * C[i_8-1][i_8-1] * 2;
        }
    }
#pragma endscop
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4336152215_08(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G)));
