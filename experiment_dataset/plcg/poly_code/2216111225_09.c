...
void kernel_2216111225_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        B[i_0-1] = C[i_0] + B[i_0-1] * 4;
        B[i_0-1] = B[i_0-2] * 5;
    }
#pragma endscop
...
kernel_2216111225_09(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
