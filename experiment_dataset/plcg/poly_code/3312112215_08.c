...
void kernel_3312112215_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P-2; i_0++) {
        for (int i_1 = 0; i_1 < PB_P-2; i_1++) {
            for (int i_2 = 0; i_2 < PB_P-2; i_2++) {
                A[i_0-2][i_0+1][i_2+1] = D[i_1][i_2][i_0] - A[i_0-2][i_0+1][i_2+2] * 3;
            }
            A[i_0-1][i_0+2][i_1+2] = A[i_0-2][i_0+1][i_1+1] * 3;
            A[i_0-2][i_0+1][i_1] = 3;
        }
    }
#pragma endscop
...
kernel_3312112215_08(xa,ya,za,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D));
