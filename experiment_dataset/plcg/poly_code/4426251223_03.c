        ...
        for (int i_3 = 2; i_3 < min(i_2, PB_L-1); i_3++) {
            for (int i_4 = 0; i_4 < -i_2+PB_Q-1; i_4++) {
                for (int i_5 = 1; i_5 < -i_3+PB_M+2; i_5++) {
                    D[i_5+i_3-2][i_4][i_3] = I[i_2-1][i_3][i_5-1] - J[i_3+1][i_5][i_4+i_2+1][0] - 5;
                }
            }
        }
        for (int i_6 = 1; i_6 < -i_2+PB_M; i_6++) {
            for (int i_7 = 0; i_7 < i_6; i_7++) {
                D[i_6+i_2][i_7][i_2] = I[i_2][i_7][i_6] + I[i_7][i_2][i_6] * I[i_7][i_6-1][i_2-1] - K[i_6-1][i_7][i_2] - D[i_6+i_2-3][i_7][i_2-2] + D[i_7+i_6+1][i_2][i_6] * 2;
            }
        }
    }
#pragma endscop
...
kernel_4426251223_03(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
