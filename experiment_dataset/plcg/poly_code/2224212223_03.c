...
void kernel_2224212223_03(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        for (int i_1 = 0; i_1 < -i_0+PB_L; i_1++) {
            B[i_1+i_0-2][i_1+i_0] = 5;
        }
    }
    for (int i_2 = 3; i_2 < PB_Q; i_2++) {
        for (int i_3 = 0; i_3 < -i_2+PB_L-3; i_3++) {
            B[i_3+i_2-1][i_3+i_2+1] = C[i_3][i_2] + B[i_3+i_2-3][i_3+i_2-1] - B[i_3+i_2+1][i_3+i_2+3] - 1;
        }
    }
#pragma endscop
...
kernel_2224212223_03(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
