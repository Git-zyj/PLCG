...
void kernel_4322332225_07(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
        ...
        for (int i_1 = 1; i_1 < PB_Q-2; i_1++) {
            for (int i_2 = 2; i_2 < min(-i_0+PB_Q, i_0); i_2++) {
                for (int i_3 = 0; i_3 < PB_Q-2; i_3++) {
                    B[i_2][2][i_1+2][i_3] = D[i_1][i_3][i_0-1][i_2] + B[i_2][2][i_3+2][i_1+2] + 6;
                }
                for (int i_4 = 2; i_4 < i_2; i_4++) {
                    B[i_2][2][i_4+2][i_1] = E[i_1][i_0][i_4-1][i_0-1] + E[i_4+i_2-1][i_0][i_1][0] - E[i_0][i_4-2][i_1-1][i_2-2] - F[i_1-1][i_4][i_2+i_0][i_4] + B[i_2][2][i_4+2][i_1+1] + 1;
                }
            }
            C[i_0][i_1] = G[i_0][i_0-1] + H[i_1][1] * C[i_0-2][i_1-1] - C[i_0][i_1-1] - 5;
        }
    }
#pragma endscop
...
kernel_4322332225_07(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
