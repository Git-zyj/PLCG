...
void kernel_4332211325_08(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
...
#pragma scop
    ...
    for (int i_2 = 1; i_2 < PB_N; i_2++) {
        for (int i_3 = 0; i_3 < -i_2+PB_N; i_3++) {
            B[i_3+i_2-1] = B[i_3+i_2] - B[i_3+i_2-1] * 4;
        }
    }
    for (int i_4 = 0; i_4 < PB_M; i_4++) {
        for (int i_5 = 1; i_5 < PB_L-2; i_5++) {
            for (int i_6 = 2; i_6 < PB_L; i_6++) {
                C[i_5-1][i_6][i_5] = D[i_5][i_6-1] - D[i_6][i_5] * A[i_5+1][i_6] + C[i_5][i_6+1][i_5+1] + C[i_6-2][i_4][i_6-1] + C[i_5-1][i_6-1][i_5] * C[i_5+1][i_6][i_5+2] * 1;
            }
        }
    }
#pragma endscop
...
kernel_4332211325_08(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
