...
void kernel_4422251225_01(int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        D[i_0] = E[i_0] + E[i_0+1] + E[i_0] - E[i_0] * E[i_0-1] * E[i_0] * 4;
    }
        ...
        for (int i_2 = 1; i_2 < min(-i_1+PB_M+1, i_1); i_2++) {
            for (int i_3 = 1; i_3 < PB_Q; i_3++) {
                for (int i_4 = 2; i_4 < -i_2+PB_M; i_4++) {
                    B[i_1][i_2][i_3][i_4] = F[i_1][0][i_4][i_2][i_3-1] * G[i_4+i_2][i_2-1][i_1+1][i_3] * G[i_2][i_1][i_4][i_2] - B[i_3][i_1][i_4-2][i_2] + 5;
                }
            }
            for (int i_5 = 1; i_5 < -i_1+PB_M-1; i_5++) {
                for (int i_6 = 1; i_6 < PB_M-1; i_6++) {
                    C[i_5+i_2+1][i_6][i_5+i_1] = G[i_1+1][i_6][i_6][0] * H[i_2+i_1-1][i_6][i_5] - G[i_6-1][i_2][i_5][i_1] - H[i_5+1][i_6][i_2+1] * I[i_5+i_1+1][i_6-1][i_2+1][i_2] - G[i_6+1][i_1][i_2][i_5-1] - 5;
                }
            }
        }
        D[i_1] = E[i_1-1] * E[i_1] - D[i_1-2] + D[i_1+1] * D[i_1-1] + 2;
    }
#pragma endscop
...
init_array(xd,POLYBENCH_ARRAY(D), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4422251225_01(xd,POLYBENCH_ARRAY(D), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xd,POLYBENCH_ARRAY(D), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I)));
