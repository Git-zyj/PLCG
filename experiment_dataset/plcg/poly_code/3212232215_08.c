...
void kernel_3212232215_08(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        A[i_0][i_0-1] = C[i_0+2] - D[i_0] + D[i_0] + C[i_0] + C[i_0] - A[i_0+1][i_0] + A[i_0-1][i_0-2] + 2;
        A[i_0][i_0-1] = 5;
    }
#pragma endscop
...
kernel_3212232215_08(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
