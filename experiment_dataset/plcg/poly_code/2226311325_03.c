...
void kernel_2226311325_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        ...
        B[i_0] = B[i_0-1] - B[i_0-2] + B[i_0+2] * 3;
    }
#pragma endscop
...
kernel_2226311325_03(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
