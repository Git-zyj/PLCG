...
void kernel_4132111311_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb)){
        ...
        for (int i_1 = 0; i_1 < PB_N-2; i_1++) {
            for (int i_2 = 0; i_2 < min(PB_N-2, -i_1+PB_M-1); i_2++) {
                for (int i_3 = 0; i_3 < PB_N-1; i_3++) {
                    A[i_1+1][i_3][i_2+1] = B[i_2+i_1+1][i_3][i_1] + A[i_1+2][i_3][i_2+2] * A[i_1+2][i_2][i_3+1] + A[i_1+2][i_3][i_2+1] + 5;
                }
            }
        }
    }
...
kernel_4132111311_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B));
