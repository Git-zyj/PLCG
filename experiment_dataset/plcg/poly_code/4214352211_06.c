...
void kernel_4214352211_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 0; i_1 < -i_0+PB_Q-1; i_1++) {
            for (int i_2 = i_0; i_2 < min(-i_0+PB_P+2, PB_M-1); i_2++) {
                for (int i_3 = 1; i_3 < min(i_2, PB_M-2); i_3++) {
                    A[i_2+1][i_1][i_2+i_0-2][i_3] = C[i_1][i_0][i_3][i_1] + C[i_3+2][i_2][i_1][i_1+i_0+1] - D[i_0][i_2][i_1+1][i_3] + E[i_3+2][i_1][i_0][i_2+2] - A[i_0+1][i_1+1][i_2+i_0-2][i_3-1] * 4;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L; i_4++) {
        for (int i_5 = 2; i_5 < PB_P-2; i_5++) {
            for (int i_6 = 2; i_6 < min(-i_5+PB_P-2, -i_4+PB_L+2); i_6++) {
                B[i_6][i_4-1][i_6+i_5-1] = F[i_6][i_5] * G[i_5][i_6+i_4][0] - F[i_5][i_6-2] + G[i_5-1][i_4-1][i_6] - H[i_6+i_5][i_4][i_6+i_5+2] - B[i_4-1][i_5-2][i_6+i_4-2] * B[i_6-1][i_4-2][i_6+i_5-2] * 3;
            }
        }
    }
#pragma endscop
...
kernel_4214352211_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
