...
void kernel_4426351323_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,DATA_TYPE POLYBENCH_1D(M,xM,xm)){
        ...
        for (int i_1 = i_0; i_1 < PB_Q; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_Q; i_2++) {
                for (int i_3 = 1; i_3 < PB_P-2; i_3++) {
                    A[i_1][i_3][i_2+1][i_0-1] = E[i_3][i_3-1][i_0-1][i_2] - F[i_3][i_2-1][i_1][i_3] * G[i_3+1][i_3-1][i_2+i_1] - A[i_1][i_2][i_3+2][i_0-2] - 3;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_P-2; i_4++) {
        for (int i_5 = 0; i_5 < min(i_4, -i_4+PB_P-1); i_5++) {
            for (int i_6 = 1; i_6 < PB_Q-1; i_6++) {
                for (int i_7 = 1; i_7 < PB_Q; i_7++) {
                    A[i_5][i_7][i_4+2][i_6-1] = F[i_6][i_4-1][i_7+1][i_6] - E[i_5][i_4][i_6+1][i_7] * E[i_7][i_6][i_4][i_5] * G[i_7-1][i_5][i_6] - G[i_6-1][i_5+i_4+1][0] * H[i_6][i_5][i_7][i_6-1] + 4;
                }
            }
        }
    }
    for (int i_8 = 4; i_8 < PB_M-3; i_8++) {
        for (int i_9 = 2; i_9 < -i_8+PB_M-3; i_9++) {
            C[i_9+i_8][i_9] = I[i_9][i_8] + J[i_9][i_8] - J[i_9+1][i_8-1] + K[0] - C[i_9+i_8+3][i_9+2] - C[i_9+i_8-4][i_9-2] - C[i_9+i_8][i_9-1] - D[i_9] * 6;
        }
        D[i_8] = K[i_8-1] - L[i_8] + K[i_8-1] - M[i_8+1] - L[0] * K[i_8] - K[i_8+1] - D[i_8-2] * D[i_8+1] + 4;
    }
#pragma endscop
