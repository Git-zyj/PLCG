...
void kernel_3332311315_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_2 = 1; i_2 < PB_L-1; i_2++) {
        B[i_2-1] = 1;
        B[i_2-1] = D[i_2+1] * B[i_2-1] - B[i_2] + 5;
    }
#pragma endscop
...
kernel_3332311315_03(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
