...
#pragma scop
        ...
        for (int i_4 = max(2, i_3); i_4 < PB_P; i_4++) {
            for (int i_5 = 1; i_5 < PB_Q-2; i_5++) {
                for (int i_6 = 1; i_6 < PB_P-1; i_6++) {
                    B[i_4-1][i_3][i_5-1][i_5] = E[i_6-1][i_5][i_3][i_4] * B[i_4-2][i_3][i_5+1][i_5+2] - D[i_5][i_4][i_6+1] - 5;
                }
            }
        }
    }
    for (int i_7 = 1; i_7 < PB_L-2; i_7++) {
        for (int i_8 = 0; i_8 < min(PB_Q-1, -i_7+PB_L); i_8++) {
            C[i_7][i_7] = F[i_8+i_7][i_8+1] + C[i_7+2][i_7+2] * 1;
            for (int i_9 = 2; i_9 < PB_Q; i_9++) {
                D[i_9][i_8][i_7] = G[i_7-1][i_9-1][1] + C[i_8][i_8] - D[i_7+2][i_8][i_9-2] * 1;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4432211221_07(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G)));
