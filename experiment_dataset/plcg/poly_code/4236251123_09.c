    ...
    for (int i_3 = 0; i_3 < PB_P-1; i_3++) {
        for (int i_4 = 0; i_4 < PB_P; i_4++) {
            for (int i_5 = 1; i_5 < i_4; i_5++) {
                B[i_4][i_3][i_4] = E[i_5-1][i_3] * C[i_5][i_4][i_3] - C[i_4][i_5][0] + B[i_4][i_3+1][i_4] - 1;
            }
        }
    }
#pragma endscop
...
kernel_4236251123_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
