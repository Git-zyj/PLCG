...
void kernel_2314252125_01(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        B[i_0+2] = D[i_0] * E[i_0][i_0] * F[i_0] * B[i_0+2] - 4;
        B[i_0+2] = D[i_0] * F[i_0-2] + D[i_0] + D[i_0] + F[i_0] - D[i_0-2] * D[i_0-2] - 1;
        B[i_0] = D[i_0] - D[i_0+1] * F[i_0] * F[i_0] + 6;
    }
#pragma endscop
...
kernel_2314252125_01(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F));
