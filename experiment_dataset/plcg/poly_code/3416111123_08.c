...
void kernel_3416111123_08(int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
    ...
    for (int i_0 = 2; i_0 < PB_N-2; i_0++) {
        ...
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < i_0; i_2++) {
                B[i_0-1][i_2-1][i_0+1] = B[i_0-2][i_2-1][i_0] * 3;
            }
        }
        C[i_0] = E[i_0] * 6;
        D[i_0] = E[i_0] * D[i_0+2] - 2;
    }
#pragma endscop
...
kernel_3416111123_08(xd,POLYBENCH_ARRAY(D), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E));
