...
void kernel_4426231115_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            A[i_0][i_1-1] = E[i_1-1][i_0] - F[i_1][i_0] * A[i_0-1][i_1] * A[i_0+1][i_1-1] * 1;
        }
        for (int i_2 = 2; i_2 < -i_0+PB_L; i_2++) {
            for (int i_3 = 1; i_3 < PB_L; i_3++) {
                A[i_3][i_2-2] = G[i_3][i_0][i_2] - G[i_2][i_3+1][i_0] + G[i_2][i_0][i_0] + G[i_2+i_0][i_3-1][i_2] - 3;
            }
            A[i_0][i_2-1] = E[i_0-1][0] - H[i_2] * F[i_2+1][i_0] - H[i_2-1] - 3;
        }
    }
    for (int i_4 = 0; i_4 < PB_L; i_4++) {
        for (int i_5 = 0; i_5 < i_4; i_5++) {
            D[i_5] = I[i_4] + F[i_5][i_4] - 5;
        }
    }
#pragma endscop
...
kernel_4426231115_04(xa,ya,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
