        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = min(-i_1+PB_L, i_1) - 1; i_2 >= 1; i_2--) {
                for (int i_3 = 1; i_3 < PB_P; i_3++) {
                    A[i_0][i_0][i_3][i_2-1] = D[i_2+1][i_2+i_1][i_3-1] * E[i_1][i_3][i_2][i_0-1] - F[i_2][i_0][i_1-1][i_1] + G[i_1][i_2][i_3][0] + G[i_1][i_2][0][i_0] - 3;
                }
            }
        }
        for (int i_4 = 2; i_4 < PB_M-2; i_4++) {
            B[i_4][i_0][0] = H[0] * I[i_4][i_0] - J[i_4] - K[i_4][0][i_0+1] * I[i_4+1][i_0] - L[i_0-1][i_4-1] - B[i_0][i_4-2][0] * B[i_4-1][i_0][0] + B[i_4+2][i_0+1][0] - 1;
        }
    }
    for (int i_5 = 0; i_5 < PB_M; i_5++) {
        for (int i_6 = 0; i_6 < PB_Q; i_6++) {
            for (int i_7 = i_5; i_7 < min(-i_5+PB_M, PB_M-1); i_7++) {
                for (int i_8 = 0; i_8 < min(PB_M, -i_6+PB_L); i_8++) {
                    C[i_7+i_5][i_8+i_6][i_5][i_7+1] = F[i_7+1][1][i_8][i_6] - D[i_8][i_6][i_7] * 2;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4324351125_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L));
