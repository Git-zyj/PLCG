...
void kernel_3312131123_06(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_N; i_1++) {
        for (int i_2 = 1; i_2 < min(PB_N-1, i_1); i_2++) {
            B[i_1+1][i_2] = E[i_1][i_2+1] * E[i_2][i_1+1] * E[i_1][i_2-1] - D[i_2] - D[i_2+1] - E[i_2][i_1+1] * C[i_2][i_1+1][i_1+1] - 6;
            C[i_2][i_1][i_1] = E[i_2+1][i_1] - E[i_2][i_1] - B[i_2-1][i_1] * 1;
        }
    }
#pragma endscop
...
kernel_3312131123_06(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
