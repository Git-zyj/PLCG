...
void kernel_4414352311_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,int wb,DATA_TYPE POLYBENCH_5D(B,xB,yB,zB,vB,wB,xb,yb,zb,vb,wb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,int ym,int zm,int vm,int wm,DATA_TYPE POLYBENCH_5D(M,xM,yM,zM,vM,wM,xm,ym,zm,vm,wm)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 1; i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_N+1; i_2++) {
                A[i_0+1][i_1][i_2-1] = E[i_2-1][i_0-2][i_1] - F[i_2+i_1-1][i_0][2] * G[i_1][i_0][i_2] + F[i_0-2][i_2][i_1+1] * H[i_1][i_2][i_0][i_1] + A[i_0][i_1][i_2-1] * 4;
                for (int i_3 = 2; i_3 < PB_N-1; i_3++) {
                    B[i_1+i_0-2][i_0][i_3][i_2][i_2] = I[i_3+1][i_0-1][i_2-1][i_1] - I[i_3-2][i_2][i_3][i_1-1] - J[i_3+1][i_1+i_0][i_2][i_1] * I[i_1][i_0][i_2][i_3] + B[i_1+i_0-2][i_0+1][i_2][i_3-1][i_3-1] * 5;
                }
            }
        }
    }
    for (int i_4 = 3; i_4 < PB_M-2; i_4++) {
        C[i_4] = K[i_4-1] - K[i_4] - L[i_4] - L[i_4] + C[i_4-1] * C[i_4+1] + C[i_4+1] * C[i_4+1] - 2;
        for (int i_5 = 2; i_5 < PB_M-2; i_5++) {
            for (int i_6 = i_5; i_6 < min(-i_5+PB_M-2, -i_4+PB_M-2); i_6++) {
                for (int i_7 = 1; i_7 < min(-i_5+PB_L, -i_4+PB_P+2); i_7++) {
                    D[i_6+i_4+1][i_5-2][i_7+i_4-2][i_5] = I[i_7+i_5][i_4][i_6][i_7] + M[i_5][i_6-2][i_4][i_7+1][2] - J[i_7-1][i_6][i_5][i_4] - I[i_4-2][i_6+1][i_4][i_5] + D[i_6+i_5+2][i_4-3][i_7+i_5-2][i_4-1] + D[i_6+i_4+1][i_5-1][i_7+i_4-2][i_5+1] * D[i_6+i_4+2][i_5-2][i_7+i_4-2][i_5] + 6;
                }
            }
        }
    }
