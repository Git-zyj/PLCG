...
void kernel_4432332321_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        for (int i_1 = 2; i_1 < PB_L; i_1++) {
            for (int i_2 = 2; i_2 < PB_N-1; i_2++) {
                for (int i_3 = 2; i_3 < min(PB_P-2, -i_0+PB_P+2); i_3++) {
                    A[i_2][i_1][i_3][i_0] = E[i_1][i_3-2][i_0][i_3+2] + F[i_1][i_3+i_0-2][i_2-1][i_3][i_3] - A[i_2+1][i_1+1][i_3][i_0] + A[i_2][i_1-1][i_0][i_3] * A[i_2-2][i_1-2][i_3][i_0] * 3;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 2; i_5 < PB_L-1; i_5++) {
            for (int i_6 = 2; i_6 < min(-i_5+PB_M, PB_L-1); i_6++) {
                B[i_5][i_6][i_4-1] = G[i_6-2][i_5+1] - H[i_6][i_5][i_4][0] - I[i_5][i_4][i_5] + J[i_5-2][i_5-1][i_4-2] + G[i_6][i_4+2] + K[i_4][i_6] - L[i_6][0][i_5] - H[i_6+i_5][i_4+2][i_4][i_5-2] + B[i_5][i_6+1][i_4-1] - B[i_5][i_6][i_4] - B[i_5+1][i_6][i_4-1] - B[i_6+2][i_4][i_5-1] + 2;
            }
        }
        for (int i_7 = 2; i_7 < -i_4+PB_M-2; i_7++) {
            for (int i_8 = 1; i_8 < -i_4+PB_M; i_8++) {
                C[i_7+i_4][i_8-1][i_8] = K[i_8+2][i_7] - L[i_8][i_7-2][i_4] * C[i_8+i_4][i_7-2][i_7-1] * C[i_7+i_4+2][i_8-1][i_8] - 1;
            }
        }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4432332321_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L));
