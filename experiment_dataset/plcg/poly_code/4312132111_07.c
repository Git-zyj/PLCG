...
void kernel_4312132111_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf)){
        ...
        for (int i_1 = 0; i_1 < PB_P-2; i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_P-2; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_0+PB_Q, PB_L-2); i_3++) {
                    A[i_3][i_1][i_0][i_3] = D[i_1][i_3][i_2+i_1+2][i_3+i_0] - E[i_2][i_3+2][i_2+i_1] - 2;
                }
            }
        }
    }
        ...
        for (int i_5 = 2; i_5 < PB_Q-2; i_5++) {
            for (int i_6 = 0; i_6 < PB_M-2; i_6++) {
                for (int i_7 = 0; i_7 < -i_5+PB_Q-2; i_7++) {
                    B[i_4+2][i_5][i_7][i_5+2] = D[i_6+2][i_7+i_5+2][i_4][2] + D[i_4][i_6][i_5][i_7+2] * D[i_4][i_6][i_5-2][i_7+i_5+2] * D[i_7][i_4][i_6][i_5] * B[i_4+1][i_5][i_7+1][i_5+2] * 4;
                }
            }
        }
        for (int i_8 = i_4; i_8 < PB_Q; i_8++) {
            for (int i_9 = 1; i_9 < PB_L-1; i_9++) {
                for (int j_0 = 0; j_0 < PB_P-2; j_0++) {
                    B[i_4+2][j_0][i_9+1][j_0+2] = D[i_9][j_0][i_8][i_4+1] * F[i_9][i_9-1][j_0][i_4][i_8] + E[i_9][j_0][i_8] * 2;
                }
            }
        }
    }
...
kernel_4312132111_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F));
