...
void kernel_3224112121_08(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
kernel_3224112121_08(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
