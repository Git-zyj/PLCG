...
void kernel_3316212323_01(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_N-1; i_0++) {
        ...
        B[i_0] = D[i_0] + D[i_0] - B[i_0-2] - B[i_0-1] - 5;
        B[i_0+1] = B[i_0+1] - 6;
    }
#pragma endscop
...
kernel_3316212323_01(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
