...
void kernel_3212212315_08(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        ...
        B[i_0] = C[i_0] + B[i_0-1] - B[i_0+1] * B[i_0+1] * B[i_0-1] * B[i_0-1] - 5;
    }
#pragma endscop
...
kernel_3212212315_08(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
