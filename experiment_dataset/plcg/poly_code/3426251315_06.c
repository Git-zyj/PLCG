...
void kernel_3426251315_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N; i_0++) {
        A[i_0] = E[i_0] * E[i_0] * E[i_0] * F[i_0] * G[i_0][0] + A[i_0+1] + D[i_0-2] + 4;
    }
    for (int i_1 = 2; i_1 < PB_Q-1; i_1++) {
        for (int i_2 = i_1; i_2 < min(-i_1+PB_M, PB_Q-2); i_2++) {
            for (int i_3 = 0; i_3 < PB_P-1; i_3++) {
                B[i_1+1][i_3][i_2+1] = H[i_3][i_2-1][i_1+1][i_3] + G[i_2][i_3] - I[i_2+i_1][i_3][1] + B[i_1+1][i_3+1][i_2] * B[i_1+1][i_3][i_2+2] - B[i_1+2][i_3][i_2+1] * B[i_3+2][i_1][i_2+2] + 3;
            }
        }
        for (int i_4 = 0; i_4 < min(-i_1+PB_M, i_1); i_4++) {
            for (int i_5 = 1; i_5 < PB_P-1; i_5++) {
                B[i_1+2][i_4][i_5+1] = I[i_1][i_5+i_4][i_5] + I[i_4][i_4][i_5+1] + J[i_5-1][i_1][i_4+1] + K[i_5-1][i_4+i_1] + 3;
            }
        }
        D[i_1-1] = E[i_1] + G[i_1][i_1-1] + F[i_1] - E[i_1] * K[i_1][i_1] + D[i_1-2] - D[i_1] * 4;
    }
#pragma endscop
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_3426251315_06(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K)));
