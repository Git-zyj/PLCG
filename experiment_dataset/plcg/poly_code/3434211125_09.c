...
void kernel_3434211125_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
    ...
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        ...
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < PB_P-1; i_2++) {
                B[i_2+1][i_1][i_2-1] = B[i_2+3][i_1][i_2+1] * 4;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_P-1; i_3++) {
        for (int i_4 = 0; i_4 < PB_L; i_4++) {
            for (int i_5 = 0; i_5 < min(i_4, -i_4+PB_M); i_5++) {
                B[i_3+1][i_4][i_3-1] = F[i_5+i_4][i_3+1][i_4] - 3;
            }
        }
    }
    for (int i_6 = 0; i_6 < PB_P-1; i_6++) {
        for (int i_7 = 1; i_7 < PB_L; i_7++) {
            B[i_7+1][i_6][i_7-1] = G[i_7][i_6+1] + H[i_6][i_7][i_6+1] * 5;
        }
    }
#pragma endscop
...
kernel_3434211125_09(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
