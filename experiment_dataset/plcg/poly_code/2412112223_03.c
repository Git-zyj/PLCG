...
#pragma scop
    for (int i_0 = 0; i_0 < PB_N; i_0++) {
        ...
        for (int i_2 = 0; i_2 < PB_N-1; i_2++) {
            B[i_0][i_2] = E[i_2] - F[i_0][i_2+2] * B[i_0][i_2+1] - 6;
        }
    }
    for (int i_3 = 1; i_3 < PB_N-1; i_3++) {
        for (int i_4 = 0; i_4 < PB_N-2; i_4++) {
            C[i_3-1][i_4+1] = B[i_3][i_4+2] + D[i_3+3][i_4] - D[i_3+1][i_4] - 6;
            D[i_3+1][i_4] = C[i_3-1][i_4+1] * C[i_3+1][i_4+1] * 4;
        }
    }
#pragma endscop
...
kernel_2412112223_03(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
