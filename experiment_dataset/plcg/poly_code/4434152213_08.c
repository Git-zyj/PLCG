...
void kernel_4434152213_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
        ...
        for (int i_1 = i_0; i_1 < PB_P; i_1++) {
            for (int i_2 = 0; i_2 < PB_M; i_2++) {
                for (int i_3 = i_2; i_3 < PB_L; i_3++) {
                    A[i_0-1][i_3][i_1][i_0] = E[i_3+1][i_2][i_0] + 6;
                }
            }
        }
    }
        ...
        for (int i_5 = 2; i_5 < PB_L-1; i_5++) {
            for (int i_6 = 1; i_6 < PB_P-3; i_6++) {
                for (int i_7 = 0; i_7 < min(-i_6+PB_L, -i_5+PB_L-1); i_7++) {
                    B[i_6][i_7+i_5][i_6+2][i_4-1] = E[i_4][i_7][i_5-2] - F[i_7][i_6][i_5][i_4-2] - F[i_7+2][i_4][i_6][i_7] + F[i_5-2][i_7+2][i_7+i_6][i_6-1] + B[i_6+1][i_7+i_5][i_6+3][i_4-1] + B[i_6-1][i_7+i_5][i_6+1][i_4-2] * B[i_6][i_7+i_5+1][i_6+2][i_4-1] * B[i_6-1][i_7+i_5-1][i_6+1][i_4] - 4;
                }
            }
        }
        for (int i_8 = 2; i_8 < -i_4+PB_N; i_8++) {
            for (int i_9 = 2; i_9 < i_8; i_9++) {
                A[i_9-1][i_4][i_8][i_9] = E[i_9+1][i_4][0] * E[i_4][i_9][i_9] - E[i_8-2][i_4][i_9-2] * G[i_9-1][i_4] * E[i_8+i_4][i_9+2][i_8] * E[i_4-2][i_8-1][i_8-1] - E[i_8][i_4][i_8] + 3;
            }
        }
    }
    for (int j_0 = 0; j_0 < PB_L-1; j_0++) {
        for (int j_1 = 1; j_1 < j_0; j_1++) {
            for (int j_2 = 0; j_2 < min(-j_0+PB_L, -j_1+PB_M); j_2++) {
                for (int j_3 = 1; j_3 < -j_0+PB_L; j_3++) {
                    D[j_0][j_1][j_2+1][j_3] = F[j_2][j_0+1][j_1+1][j_3+j_0] + F[j_2+j_1][j_0][j_1][2] * F[j_1-1][j_0][j_2][j_3] - E[j_3][j_1-1][j_2] * F[j_2][j_0][j_3-1][j_1] - F[j_1][j_2][j_0][j_1] - F[j_1][j_3+j_0][j_2+j_0][j_1] + 6;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4434152213_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G)));
