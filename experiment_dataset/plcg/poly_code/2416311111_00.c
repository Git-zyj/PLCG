...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_P+1; i_1++) {
        ...
        for (int i_2 = 1; i_2 < min(PB_N, i_1); i_2++) {
            D[i_2][i_2] = G[i_2][i_1-1] + H[i_2+1][i_2-1] * 3;
        }
    }
#pragma endscop
...
kernel_2416311111_00(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
