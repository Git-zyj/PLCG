        ...
        for (int i_1 = max(1, i_0); i_1 < PB_M+1; i_1++) {
            for (int i_2 = 1; i_2 < PB_P+1; i_2++) {
                for (int i_3 = 1; i_3 < PB_L; i_3++) {
                    A[i_1-1][i_3][i_2-1] = A[i_1-1][i_3-1][i_2-1] - 2;
                }
            }
        }
    }
    for (int i_4 = 3; i_4 < PB_L; i_4++) {
        for (int i_5 = 3; i_5 < PB_L; i_5++) {
            for (int i_6 = 0; i_6 < PB_M-1; i_6++) {
                B[i_6][i_5-1][i_5] = D[i_6+1][i_4][i_5] + E[i_4][i_5] * B[i_6][i_5-3][i_5-2] + B[i_6][i_4-3][i_4-2] * B[i_6][i_5-2][i_5-1] + 6;
            }
        }
...
kernel_4332311223_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
