    ...
    for (int i_3 = 2; i_3 < PB_M; i_3++) {
        for (int i_4 = 0; i_4 < PB_M; i_4++) {
            for (int i_5 = 1; i_5 < PB_M-1; i_5++) {
                B[i_4][i_3][i_5] = B[i_4][i_3][i_5-1] - B[i_5+1][i_3][i_4] + 2;
            }
        }
        for (int i_6 = 2; i_6 < min(min(-i_3+PB_N, PB_M-1), i_3); i_6++) {
            for (int i_7 = 2; i_7 < -i_6+PB_M-1; i_7++) {
                C[i_3][i_6][i_7] = E[i_7][i_6+i_3][i_7][i_6] * F[i_7+i_6+1][i_3][0] + G[0][i_6][i_3-1] * C[i_3][i_6][i_7+2] * C[i_6-2][i_3][i_7] * C[i_3][i_6][i_7-2] + 3;
            }
        }
        for (int i_8 = 1; i_8 < min(PB_M-1, i_3); i_8++) {
            for (int i_9 = 0; i_9 < min(PB_L-3, -i_8+PB_N); i_9++) {
                for (int j_0 = 0; j_0 < PB_P-2; j_0++) {
                    D[i_8+1][i_9+1][i_3][j_0] = H[j_0][i_9+i_8][j_0][i_3-1][i_8] * D[i_8+1][i_9+3][i_3-2][j_0+2] * D[i_8-1][j_0+1][i_9][i_3] - 3;
                }
            }
        }
    }
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4422311325_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H)));
