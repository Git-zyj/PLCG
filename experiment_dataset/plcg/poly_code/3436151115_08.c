...
void kernel_3436151115_08(int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-1; i_0++) {
        for (int i_1 = i_0; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_L; i_2++) {
                C[i_0][i_0][i_1] = E[i_2][i_0][i_2] - E[i_2][i_1+1][i_0+1] * E[i_2][i_1+1][i_1] - E[i_1][i_2-1][i_0] + 1;
            }
        }
        for (int i_3 = 1; i_3 < PB_L; i_3++) {
            C[i_0+1][i_0+1][i_3+1] = F[i_3][i_0+1] + F[i_3][i_0] - F[i_3][i_0] + G[i_0] - F[i_3][i_0] * C[i_0+1][i_0+1][i_3+1] * 1;
            for (int i_4 = max(1, i_0); i_4 < min(-i_0+PB_M, -i_3+PB_L+1); i_4++) {
                C[i_0][i_0][i_4] = E[i_4+1][i_0][i_3] + H[i_4+i_0][i_3+1][i_4-1][0] - E[i_4+i_0][i_3-1][0] - E[i_4][i_0][i_4+i_3-1] * 6;
            }
        }
    }
    for (int i_5 = 0; i_5 < PB_L; i_5++) {
        for (int i_6 = 0; i_6 < i_5; i_6++) {
            for (int i_7 = 1; i_7 < PB_L-1; i_7++) {
                C[i_5+1][i_5+1][i_7] = E[i_7-1][i_7][i_5] * F[i_6][i_7+1] - E[i_6][i_5][0] + F[i_5+1][i_5] - 2;
            }
        }
    }
#pragma endscop
...
kernel_3436151115_08(xc,yc,zc,POLYBENCH_ARRAY(C), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
