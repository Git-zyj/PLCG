...
void kernel_4324252123_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            B[i_1+1] = D[i_0] * E[i_1][i_0] - E[i_1][i_0] * F[i_0+2][0] - 3;
        }
    }
    for (int i_2 = 0; i_2 < PB_L-2; i_2++) {
        for (int i_3 = max(2, i_2); i_3 < PB_L; i_3++) {
            B[i_3] = F[i_3+2][i_2] - E[i_2+2][i_3] + F[i_3-1][i_2] - E[i_3][i_2+2] - E[i_2][i_3] - E[i_3-2][i_2] + E[i_3+1][i_2] - E[i_3+2][i_2] - B[i_3-2] + 6;
        }
        for (int i_4 = 0; i_4 < PB_P; i_4++) {
            for (int i_5 = 0; i_5 < PB_L; i_5++) {
                B[i_5] = G[i_4][i_2][i_5] * G[i_5][i_2][i_4] - H[i_2+1][i_5][i_4] * 2;
            }
        }
    }
#pragma endscop
...
kernel_4324252123_05(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
