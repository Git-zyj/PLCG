...
void kernel_2434352323_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-4; i_0++) {
        A[i_0] = E[i_0-1] + F[2] - E[i_0+1] + A[i_0+2] + A[i_0-1] - B[i_0+2] + 5;
        B[i_0+2] = F[i_0] * F[i_0] - F[0] + B[i_0+4] + B[i_0+1] * B[i_0+3] * 6;
    }
    for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
        for (int i_2 = i_1; i_2 < -i_1+PB_M; i_2++) {
            C[i_1][i_2] = G[i_1+2][i_2-1] - H[i_2][i_2] + H[i_2][i_1] + H[i_2+i_1][i_1-1] - G[i_2+1][i_1] + I[i_1-1][i_2] - G[i_2+2][i_1-2] - G[i_2][i_1-2] + B[i_2+2] + C[i_1+1][i_2] * D[i_2] * 4;
        }
    }
    for (int i_3 = 2; i_3 < PB_M-3; i_3++) {
        D[i_3] = E[i_3-2] + F[i_3-2] - F[i_3] + J[i_3-1] - J[i_3-2] * H[i_3][i_3] + B[i_3+2] - B[i_3+3] - D[i_3-1] - 2;
    }
#pragma endscop
...
kernel_2434352323_09(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
