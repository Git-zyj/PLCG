...
void kernel_4334231315_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve)){
        ...
        for (int i_1 = 2; i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = 2; i_2 < i_0; i_2++) {
                for (int i_3 = 1; i_3 < -i_1+PB_M; i_3++) {
                    A[i_1-1][i_3+i_1][i_2-1][i_0] = D[i_1+1][i_0][i_3+i_1][i_2+1] + D[i_3+1][i_2-1][i_0][1] - A[i_3-1][i_3+i_1-1][i_2-1][i_0] * A[i_1-1][i_3+i_1][i_2-2][i_0] - 1;
                }
                for (int i_4 = 1; i_4 < -i_0+PB_M-1; i_4++) {
                    B[i_4+1][i_1][i_2][i_0-1] = E[i_4][i_2+1][i_1][0] - D[i_4][i_1+i_0][i_0][i_2-1] + A[i_1-2][i_4+i_1-1][i_2-1][i_0-1] - A[i_4-1][i_4+i_0+1][i_2-2][i_1] - B[i_4+1][i_1][i_0+1][i_2] - 3;
                }
            }
        }
        for (int i_5 = i_0; i_5 < PB_M-1; i_5++) {
            for (int i_6 = i_0; i_6 < -i_0+PB_Q; i_6++) {
                for (int i_7 = 1; i_7 < PB_L+1; i_7++) {
                    B[i_5+1][i_7-1][i_6][i_0-2] = E[i_5-1][i_7-1][i_6+i_0][i_7] - D[i_5-1][i_0-1][i_6][i_5-1] + E[i_5][i_0][i_6-1][0] + 5;
                }
            }
        }
    }
...
kernel_4334231315_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
