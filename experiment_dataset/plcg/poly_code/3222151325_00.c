...
void kernel_3222151325_00(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < min(min(-i_0+PB_L, PB_L-1), i_1); i_2++) {
                B[i_2+1][i_0-1][i_2+1] = C[i_0][i_1] * D[i_1][i_2+1][i_0+1] + D[i_1][i_2][i_1+1] - C[i_1][i_2+i_0] + 3;
            }
        }
        for (int i_3 = 3; i_3 < PB_L; i_3++) {
            for (int i_4 = 2; i_4 < PB_M-1; i_4++) {
                B[i_4][i_3-1][i_4] = C[i_4][i_3] + D[i_4+1][i_0][i_3] * D[i_3][i_0+1][i_3] + D[i_4-1][i_0][i_3] * D[i_3][i_0-1][i_4] - D[i_4][i_0][i_3-1] * B[i_4][i_3-2][i_4] - B[i_4-2][i_3-3][i_4-2] + B[i_4][i_3-3][i_4] - 3;
            }
        }
    }
#pragma endscop
...
kernel_3222151325_00(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
