...
void kernel_3114211315_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        A[1] = B[1] - A[1] * A[1] * A[1] - 4;
    }
#pragma endscop
...
kernel_3114211315_09(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
