...
void kernel_2432352315_09(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N-2; i_0++) {
        A[i_0+2][i_0] = E[i_0] - F[i_0] - E[i_0+2] - F[i_0] + A[i_0+3][i_0+1] - 6;
        for (int i_1 = 0; i_1 < min(-i_0+PB_M, PB_L); i_1++) {
            B[i_1+i_0-1] = G[i_0+1][i_1] * H[i_1][i_0-1] * E[i_1] + F[i_1] + G[i_0+1][i_1+i_0] * I[i_0][i_1] - G[i_0-2][i_1] + H[i_1][i_0] - B[i_1+i_0-2] - B[i_1+i_0] + 3;
        }
        for (int i_2 = 2; i_2 < min(-i_0+PB_M, i_0); i_2++) {
            A[i_0+1][i_0-1] = I[i_2+i_0][i_0] * G[i_2-2][i_0+1] * H[i_0][i_2-2] - G[i_2][i_0] - I[i_0][i_2] - B[i_2+i_0-2] * B[i_2+i_0-1] - 4;
        }
    }
    for (int i_3 = 0; i_3 < PB_L; i_3++) {
        A[i_3+2][i_3] = J[i_3+1] - J[i_3] - 1;
    }
#pragma endscop
...
kernel_2432352315_09(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
