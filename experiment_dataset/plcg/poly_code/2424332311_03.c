...
void kernel_2424332311_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        for (int i_1 = i_0; i_1 < -i_0+PB_N; i_1++) {
            B[i_1-1] = E[i_0] + F[i_1] * G[i_1+2][i_0+2] + H[i_1][i_0] + H[i_1+i_0][i_0] * G[i_0+1][i_1-2] - B[i_1-1] - 1;
        }
        B[i_0-2] = 6;
    }
    for (int i_2 = 3; i_2 < PB_L-1; i_2++) {
        for (int i_3 = 0; i_3 < i_2; i_3++) {
            C[i_2][i_3] = I[i_3+1][i_2+1][0] * C[i_2-1][i_3] + C[i_2][i_3+1] - C[i_2+1][i_3] + 5;
        }
        B[i_2-3] = E[i_2] - E[i_2] - B[i_2-2] + 2;
    }
#pragma endscop
...
kernel_2424332311_03(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
