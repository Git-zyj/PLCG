...
void kernel_4424252215_05(int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk)){
        ...
        for (int i_1 = 0; i_1 < PB_Q; i_1++) {
            for (int i_2 = 0; i_2 < PB_Q; i_2++) {
                for (int i_3 = i_0; i_3 < PB_Q; i_3++) {
                    C[i_0][i_2][i_3][i_3] = E[i_0+2][i_2][i_1][0] - 5;
                }
            }
        }
        for (int i_4 = 2; i_4 < min(min(-i_0+PB_Q, i_0), PB_L-1); i_4++) {
            B[i_0][2] = F[i_4][i_0] - D[i_4-1] - 6;
            for (int i_5 = 1; i_5 < min(-i_0+PB_P+1, PB_L); i_5++) {
                for (int i_6 = 2; i_6 < PB_Q-1; i_6++) {
                    C[i_0][i_4][i_6][i_6] = E[i_6][i_5][i_6][i_4+i_0] * E[i_6+1][i_0][i_6+i_4][i_5] + G[i_4][i_5][i_6] * H[i_5][i_0+1][i_4+2][i_4-2] - I[i_6-2][i_4+1][i_5] * E[i_6+i_4][i_5+i_0-1][i_6-2][0] + I[i_5][i_4][i_5] + H[i_5-1][i_6-1][i_0+2][0] + C[i_4-1][i_0][i_6][i_6] - C[i_0][i_5][i_6+1][i_6+1] + 3;
                }
            }
        }
    }
    for (int i_7 = 1; i_7 < PB_M; i_7++) {
        D[i_7] = J[i_7] + K[i_7] + K[i_7] + K[i_7-1] - K[i_7] - J[i_7] - J[i_7] + D[i_7-1] - 2;
    }
#pragma endscop
...
init_array(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4424252215_05(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K)));
