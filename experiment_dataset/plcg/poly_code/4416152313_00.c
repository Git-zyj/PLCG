...
void kernel_4416152313_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        A[i_0] = E[i_0] - E[i_0] * A[i_0+1] - A[i_0-1] * A[i_0+1] * 4;
    }
    for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
        for (int i_2 = 1; i_2 < min(min(-i_1+PB_M, i_1), PB_M-2); i_2++) {
            B[i_1][i_2] = F[i_1][i_2+2] * F[i_2+2][i_1-1] - G[i_1][i_2][i_1] + F[i_2+i_1][i_2+2] - F[i_2][i_1] * B[i_1+1][i_2] - B[i_1-1][i_2] + D[i_2+1] + 6;
            B[i_1][i_2] = F[i_1-1][i_1+2] * F[i_2][i_1] + B[i_1+1][i_2-1] - D[i_1] + 3;
        }
        D[i_1+1] = E[i_1] + F[i_1][1] - E[i_1] * E[i_1] + E[0] + E[i_1] + E[i_1] + E[i_1] + D[i_1] - 2;
    }
#pragma endscop
...
kernel_4416152313_00(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
