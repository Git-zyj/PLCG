...
void kernel_4236132125_00(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_L-2; i_1++) {
        for (int i_2 = i_1; i_2 < PB_L-2; i_2++) {
            B[i_2+1][i_2] = C[i_1][i_2-2] + C[i_1][i_2] * D[i_2] - C[i_2][i_1+2] * C[i_2][i_1-2] - B[i_2+3][i_2+2] - 2;
        }
    }
#pragma endscop
...
kernel_4236132125_00(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
