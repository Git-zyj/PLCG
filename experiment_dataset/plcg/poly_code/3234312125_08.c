...
void kernel_3234312125_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_L; i_0++) {
        A[i_0-2] = 4;
        A[i_0-3] = C[i_0] * A[i_0-2] + 3;
    }
#pragma endscop
...
kernel_3234312125_08(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
