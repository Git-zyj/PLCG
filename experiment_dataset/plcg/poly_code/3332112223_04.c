...
void kernel_3332112223_04(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_3 = 1; i_3 < PB_M-2; i_3++) {
        C[i_3] = D[i_3] + D[i_3-1] - D[2] + C[i_3+2] + C[i_3-1] - 3;
    }
#pragma endscop
...
kernel_3332112223_04(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
