...
#pragma scop
    ...
    for (int i_3 = 1; i_3 < PB_L-1; i_3++) {
        for (int i_4 = i_3; i_4 < -i_3+PB_L-1; i_4++) {
            B[i_3-1][i_4] = E[i_4] - F[i_4+1][i_3] * F[i_4][i_3] * G[i_4][i_3+1] * 1;
            for (int i_5 = 1; i_5 < PB_L; i_5++) {
                C[i_4][i_4+i_3][i_5+1] = H[i_5][i_3+1][i_3] + I[i_5][i_4][i_3+1] + I[i_4][i_5][i_3+1] + H[i_5-1][i_3-1][i_4-1] - C[i_4+1][i_4+i_3+1][i_5+1] - 2;
            }
        }
        D[i_3-1] = E[i_3] - E[i_3] + 1;
    }
#pragma endscop
...
kernel_4432231113_02(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
