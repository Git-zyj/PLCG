...
void kernel_4226211125_01(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < -i_0+PB_M; i_1++) {
            ...
            for (int i_4 = i_0; i_4 < PB_M; i_4++) {
                B[i_0][i_1][i_4] = C[i_4][i_4][i_1] - C[i_1+i_0][i_4][i_1] * B[i_0-1][i_4][i_1] - 5;
            }
        }
    }
#pragma endscop
...
kernel_4226211125_01(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
