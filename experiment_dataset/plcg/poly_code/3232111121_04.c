...
void kernel_3232111121_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_0 = 0; i_0 < PB_Q-1; i_0++) {
        ...
        for (int i_3 = 3; i_3 < PB_Q; i_3++) {
            for (int i_4 = 0; i_4 < i_3; i_4++) {
                B[i_3][i_0][i_3] = C[i_4][i_0+1][i_3] + A[i_3-3][i_0+1][i_4] + 3;
            }
        }
    }
#pragma endscop
...
kernel_3232111121_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
