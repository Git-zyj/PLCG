...
void kernel_4312332213_08(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 2; i_1 < PB_L; i_1++) {
            A[i_0][i_0+2] = D[i_0] + E[i_1][i_1][i_0-1] * F[i_1][i_0-2] - A[i_0+1][i_0+3] + 3;
            for (int i_2 = 0; i_2 < -i_1+PB_M+2; i_2++) {
                A[i_1+1][i_1+3] = E[i_2+i_1-2][i_0][i_1-1] + G[i_1][i_2][i_0] - G[i_1][i_2][i_0] + 2;
            }
        }
        A[i_0][i_0+2] = D[i_0] + H[i_0] - I[i_0+2] * A[i_0+1][i_0+3] + 1;
    }
#pragma endscop
...
kernel_4312332213_08(xa,ya,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
