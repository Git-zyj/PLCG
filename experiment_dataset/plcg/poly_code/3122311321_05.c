...
void kernel_3122311321_05(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 3; i_1 < PB_M+1; i_1++) {
            A[i_0+1][i_1-1] = B[i_1-1] + A[i_0-1][i_1+1] + A[i_0+2][i_1-1] - A[i_0+1][i_1-3] + 5;
        }
    }
#pragma endscop
...
kernel_3122311321_05(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
