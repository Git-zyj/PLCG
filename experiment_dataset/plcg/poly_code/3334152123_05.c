...
void kernel_3334152123_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        B[i_0-1] = D[i_0-2] * D[i_0] + B[i_0] * 5;
    }
    for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
        B[i_1] = D[i_1-1] + D[i_1-2] - D[i_1+2] * D[i_1] - D[i_1-1] * 3;
        B[i_1] = D[i_1] - D[i_1] * D[i_1] - D[i_1-2] * D[i_1] + D[i_1] * 5;
    }
#pragma endscop
...
kernel_3334152123_05(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
