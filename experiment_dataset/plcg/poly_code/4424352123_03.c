...
void kernel_4424352123_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl)){
...
#pragma scop
        ...
        for (int i_1 = 2; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_L; i_2++) {
                for (int i_3 = 2; i_3 < -i_0+PB_M; i_3++) {
                    A[i_3+i_0][i_2+i_1][i_1][i_3+i_0-2] = E[i_1][i_2][i_0][i_0] + F[i_0][i_1][i_1+2][i_2] * G[i_1-2][i_2+2][i_3][i_0-2] + H[i_0][i_3][i_2+i_1][i_3-2][i_2] - 2;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < -i_4+PB_L-2; i_5++) {
            for (int i_6 = 2; i_6 < min(PB_Q-2, -i_4+PB_L); i_6++) {
                for (int i_7 = 1; i_7 < PB_L-2; i_7++) {
                    B[i_6+i_4][i_4][i_5+1][i_7] = F[i_5-1][i_7-1][i_4+1][i_6] * E[i_7+2][i_5+1][i_6][i_4-1] * I[i_6+i_4][i_7][i_5-1] - E[i_6+i_4][i_7+2][i_5][1] * G[i_7][i_5+i_4+2][i_6+2][i_7] - F[i_7][i_6][i_5][i_4] + G[i_6-1][i_7+i_5][i_4][i_6-2] - B[i_6+i_4-2][i_4-1][i_5+1][i_7] - 4;
                }
            }
        }
    }
    for (int i_8 = 1; i_8 < PB_N; i_8++) {
        for (int i_9 = 1; i_9 < PB_M-2; i_9++) {
            D[i_9-1] = J[i_9+1][0] * J[i_8][i_9] * K[i_9+2] * J[i_9+1][i_8] - 5;
        }
        D[i_8] = K[i_8] * L[i_8] - L[i_8] - L[i_8-1] + 2;
    }
#pragma endscop
...
kernel_4424352123_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L));
