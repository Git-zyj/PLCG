...
void kernel_2334212323_08(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-1; i_0++) {
        ...
        C[i_0+1] = D[i_0] * C[i_0+1] - 2;
    }
    for (int i_2 = 1; i_2 < PB_L-1; i_2++) {
        C[i_2+1] = C[i_2] * C[i_2-1] + 4;
    }
#pragma endscop
...
kernel_2334212323_08(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
