...
void kernel_2336131125_00(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
        C[i_1-1] = D[i_1+1] - D[i_1] * D[i_1] - D[i_1] - 2;
    }
    for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
        C[i_2+1] = D[i_2+1] * D[i_2] * D[i_2-1] * D[0] - C[i_2-1] + 6;
    }
#pragma endscop
...
kernel_2336131125_00(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
