...
void kernel_2224212125_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N; i_0++) {
        for (int i_1 = 4; i_1 < PB_N; i_1++) {
            A[i_1-2] = C[i_1] - A[i_1-4] - 2;
        }
        A[i_0-2] = C[i_0] - 1;
    }
#pragma endscop
...
kernel_2224212125_09(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
