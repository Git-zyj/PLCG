...
void kernel_2212132121_07(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
...
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        ...
        for (int i_2 = 2; i_2 < min(PB_N, -i_0+PB_M-1); i_2++) {
            B[i_2] = C[i_2] - D[i_0][i_2-1] * D[i_0][i_2] * D[i_2+i_0+1][0] * D[i_0][i_0] + B[i_2-2] + 5;
        }
    }
#pragma endscop
...
kernel_2212132121_07(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
