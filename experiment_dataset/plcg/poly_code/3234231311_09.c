    ...
    for (int i_3 = 0; i_3 < PB_L; i_3++) {
        for (int i_4 = 0; i_4 < PB_Q; i_4++) {
            for (int i_5 = 1; i_5 < PB_L+1; i_5++) {
                B[i_3][i_5][i_4] = C[i_4][i_3][i_5] + B[i_5-1][i_3][i_4] + 2;
            }
        }
    }
#pragma endscop
...
kernel_3234231311_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
