...
void kernel_4224112325_02(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < PB_M-2; i_1++) {
            B[i_1][i_0][i_0] = C[i_1+1][i_1] - B[i_0][i_1][i_1] + B[i_0][i_1+2][i_1+2] - B[i_0-2][i_1][i_1] - 3;
...
kernel_4224112325_02(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
