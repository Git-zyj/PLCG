...
void kernel_4234131211_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
        ...
        for (int i_1 = 1; i_1 < PB_Q-1; i_1++) {
            for (int i_2 = i_1; i_2 < PB_M; i_2++) {
                for (int i_3 = 1; i_3 < PB_M-2; i_3++) {
                    A[i_3+1][i_2][i_1+1] = C[i_2][i_2+1][i_3-1][i_1+1] - C[i_3-1][i_0+1][i_1][i_2] + C[i_3][i_0+1][i_1+1][i_2-1] - C[i_3][i_3][i_2][i_0] - A[i_3+2][i_2+1][i_1+1] + A[i_0+2][i_1-1][i_2+1] + 3;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_Q-1; i_4++) {
        for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
            for (int i_6 = 0; i_6 < i_5; i_6++) {
                for (int i_7 = 1; i_7 < min(-i_6+PB_M-1, -i_4+PB_Q-1); i_7++) {
                    B[i_5][i_7+i_6][i_4+1][i_7-1] = C[i_5+1][i_6+1][i_7+i_4+1][i_5] - B[i_5][i_7+i_6+1][i_4+1][i_7-1] - 5;
                }
            }
        }
    }
...
kernel_4234131211_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
