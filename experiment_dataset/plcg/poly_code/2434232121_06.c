...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_L; i_1++) {
        for (int i_2 = 0; i_2 < -i_1+PB_M; i_2++) {
            B[i_2][i_1] = G[i_2][i_1] - H[i_2+i_1][i_1] + B[i_2][i_1-2] + 6;
        }
    }
    for (int i_3 = 2; i_3 < PB_Q; i_3++) {
        D[i_3][i_3] = F[i_3] - D[i_3][i_3] - D[i_3+2][i_3+2] * 3;
        for (int i_4 = 2; i_4 < min(PB_Q, -i_3+PB_M+1); i_4++) {
            D[i_3][i_3] = I[i_4][i_3-2][2] + G[i_3][i_4-2] + E[0] - H[i_4][i_3] + H[i_4][i_3+1] + H[i_4+i_3-1][i_4] + 5;
        }
    }
#pragma endscop
...
kernel_2434232121_06(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
