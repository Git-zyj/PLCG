...
void kernel_4236112111_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_4 = 2; i_4 < PB_M; i_4++) {
        for (int i_5 = 2; i_5 < min(i_4, PB_P); i_5++) {
            for (int i_6 = 1; i_6 < -i_4+PB_N; i_6++) {
                B[i_4-2][i_5][i_6] = C[i_6+i_4][i_5][i_5] * B[i_5-2][i_4][i_6-1] + B[i_4-2][i_5][i_6-1] * 3;
            }
        }
    }
#pragma endscop
...
kernel_4236112111_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
