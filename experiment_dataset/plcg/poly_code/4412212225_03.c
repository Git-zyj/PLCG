...
void kernel_4412212225_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg)){
        ...
        for (int i_2 = 0; i_2 < PB_M-2; i_2++) {
            for (int i_3 = 2; i_3 < PB_M-2; i_3++) {
                for (int i_4 = i_3; i_4 < PB_M; i_4++) {
                    C[i_1][i_2][i_3][i_2] = C[i_1][i_2][i_3-2][i_2] * C[i_1][i_2+2][i_3+2][i_2+2] - 4;
                }
            }
        }
        for (int i_5 = 0; i_5 < PB_M; i_5++) {
            for (int i_6 = 1; i_6 < -i_1+PB_P+2; i_6++) {
                for (int i_7 = 2; i_7 < PB_M-1; i_7++) {
                    C[i_1][i_5][i_7+1][i_5] = F[i_6-1][i_7-2][i_5] + G[i_5][i_5][i_6+i_1-2][i_1] - 1;
                }
            }
        }
    }
...
kernel_4412212225_03(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G));
