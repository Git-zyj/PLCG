        ...
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < PB_P; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_1+PB_Q+1, i_2); i_3++) {
                    A[i_1][i_3][i_1] = D[i_2][i_0+1][i_3+i_1-1][i_2] - E[i_1][i_3][i_1][i_2] + 6;
                }
            }
        }
        for (int i_4 = 0; i_4 < min(-i_0+PB_M, PB_N-2); i_4++) {
            B[i_0][i_4+i_0][i_4] = F[i_4][i_0] - 6;
            for (int i_5 = 0; i_5 < PB_L; i_5++) {
                for (int i_6 = 0; i_6 < i_4; i_6++) {
                    C[i_4][i_5][i_6] = C[i_4+2][i_6][i_5] + C[i_4+1][i_5][i_6+1] * 6;
                }
            }
        }
    }
...
kernel_4334311125_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
