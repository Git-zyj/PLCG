...
void kernel_3212112211_09(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_P-2; i_0++) {
        for (int i_1 = i_0; i_1 < PB_P-2; i_1++) {
            B[i_1][i_1+2] = B[i_0][i_0+2] * 1;
            for (int i_2 = 0; i_2 < PB_P-3; i_2++) {
                B[i_2][i_2+2] = C[i_2][i_1] - B[i_2+1][i_2+3] - 1;
            }
        }
    }
#pragma endscop
...
kernel_3212112211_09(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
