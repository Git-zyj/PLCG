        ...
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_1+PB_Q+1, PB_L); i_2++) {
                for (int i_3 = 1; i_3 < PB_L-1; i_3++) {
                    B[i_1][i_0-1][i_2+i_1-1][i_3] = D[i_3-1][i_2-1][i_0][i_1] + E[i_0][i_1][i_3+1][i_2-1][0] + F[i_3][i_0][i_1][i_2] - G[i_1][i_3][i_2-1][i_0-1] * G[i_3][i_0][i_1][1] + H[i_3-1][i_2][i_1-1] - H[i_2][i_3+1][i_1] * D[i_3][i_1-1][i_2][i_3] * 2;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L; i_4++) {
        for (int i_5 = 1; i_5 < min(PB_L-1, -i_4+PB_Q); i_5++) {
            for (int i_6 = 1; i_6 < PB_P-1; i_6++) {
                for (int i_7 = 2; i_7 < min(PB_L-1, -i_6+PB_Q); i_7++) {
                    B[i_7+1][i_5-1][i_7+i_6][i_4] = F[i_5][i_7-1][i_4-1][i_6-1] * G[i_6+i_5][i_4][i_7][i_5] + H[i_6][i_7+1][i_5+1] * F[i_7+1][i_4-1][i_6+1][i_5] + B[i_5+1][i_7-2][i_5+i_4][i_6] + 3;
                }
            }
        }
        for (int i_8 = 0; i_8 < PB_L; i_8++) {
            C[i_4+1][i_8] = I[i_8][i_4] - H[i_8][i_4-1][i_8] + 4;
        }
    }
#pragma endscop
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4316351113_00(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I)));
