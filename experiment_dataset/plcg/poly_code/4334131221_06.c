...
void kernel_4334131221_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
        ...
        for (int i_1 = 1; i_1 < PB_P-3; i_1++) {
            for (int i_2 = i_0; i_2 < -i_0+PB_M; i_2++) {
                for (int i_3 = 1; i_3 < PB_P; i_3++) {
                    A[i_2][i_1-1][i_0][i_1+1] = D[i_2][i_0][i_3-1][i_1] + D[i_3][i_2][i_0][i_1] + D[i_2+i_0][i_1-1][i_3][i_3+1] * D[i_2][i_3][i_1][i_0] + A[i_3+1][i_1+1][i_0-1][i_1+3] * A[i_2+2][i_1-1][i_0-2][i_1+1] * 6;
                }
            }
        }
        B[0] = E[i_0] * B[0] * B[0] - 3;
        for (int i_4 = 1; i_4 < PB_M-2; i_4++) {
            for (int i_5 = i_4; i_5 < PB_P; i_5++) {
                for (int i_6 = 1; i_6 < PB_L-1; i_6++) {
                    C[i_4][i_0][i_6-1][i_6-1] = D[i_6][i_4-1][i_5][i_0] - F[i_6][i_4][i_5+1] - C[i_4+2][i_0][i_6+1][i_6+1] - 1;
                }
            }
        }
    }
...
kernel_4334131221_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
