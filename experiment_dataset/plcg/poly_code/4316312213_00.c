...
void kernel_4316312213_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < PB_L; i_2++) {
                A[i_0][i_2][i_2+2] = D[i_1][0] + A[i_1][i_2-1][i_2+1] * 4;
            }
        }
        for (int i_3 = 1; i_3 < i_0; i_3++) {
            B[i_3] = E[i_0][i_3+1] - 5;
            for (int i_4 = 1; i_4 < min(PB_M-1, i_3); i_4++) {
                C[i_0][i_4-1][i_0+1] = B[i_4+1] * C[i_4-1][i_3-1][i_4] + C[i_4+1][i_0-1][i_4+2] + 6;
            }
        }
    }
#pragma endscop
...
kernel_4316312213_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
