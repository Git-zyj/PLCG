...
void kernel_4234152125_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we)){
        ...
        for (int i_1 = 2; i_1 < min(-i_0+PB_Q, PB_L-2); i_1++) {
            for (int i_2 = 2; i_2 < -i_0+PB_Q; i_2++) {
                for (int i_3 = 2; i_3 < PB_L-2; i_3++) {
                    A[i_2][i_0][i_3+i_2][i_3-1] = C[i_3+2][i_1][i_2-2] - D[i_3+2][i_1-2][i_0+2][i_2+1] + D[i_0][i_3-2][i_2][i_1] * C[i_2-2][i_1][1] + E[i_3][i_1+2][i_2][i_2+i_0][i_3] + A[i_1][i_3-2][i_1+i_0][i_0-1] - 6;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < min(i_4, -i_4+PB_Q-1); i_5++) {
            for (int i_6 = 0; i_6 < i_5; i_6++) {
                for (int i_7 = 2; i_7 < PB_L; i_7++) {
                    A[i_5+1][i_6][i_5+i_4+1][i_4-1] = E[i_7][i_6][i_4][i_5][i_4+2] * D[i_7-2][i_5+i_4][i_5+1][i_4] + D[i_6+1][i_7][i_5+i_4][i_6] + D[i_6][i_4-1][i_7][i_5] + 3;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), INIT_SEED);
kernel_4234152125_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E)));
