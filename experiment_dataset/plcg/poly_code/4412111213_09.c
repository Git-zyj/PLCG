        ...
        for (int i_1 = 0; i_1 < -i_0+PB_Q-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_L+1; i_2++) {
                for (int i_3 = 0; i_3 < i_0; i_3++) {
                    A[i_3][i_2-1][i_0+1][i_1+i_0] = A[i_3+1][i_2-1][i_0+1][i_1+i_0+1] + 6;
                }
            }
            for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
                for (int i_5 = 0; i_5 < -i_4+PB_L-1; i_5++) {
                    B[i_0-1][i_1][i_4][i_5+1] = E[i_5+i_4+1][i_1][i_0][i_0] + 2;
                    B[i_0-1][i_5][i_4-1][i_1+1] = A[i_5][i_4-1][i_0][i_1+i_0-1] - 2;
                }
            }
        }
    }
    for (int i_6 = 0; i_6 < PB_L-1; i_6++) {
        for (int i_7 = 0; i_7 < -i_6+PB_L-1; i_7++) {
            for (int i_8 = 0; i_8 < PB_Q; i_8++) {
                for (int i_9 = 0; i_9 < min(i_6, -i_8+PB_Q); i_9++) {
                    D[i_6][i_7+i_6][i_8][i_9+i_8] = D[i_6][i_7+i_6+1][i_8][i_9+i_8] - D[i_6+1][i_7+i_6][i_8][i_9+i_8] * 2;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), INIT_SEED);
kernel_4412111213_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E)));
