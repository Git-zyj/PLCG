...
void kernel_4422152323_07(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        for (int i_1 = 0; i_1 < min(i_0, -i_0+PB_P); i_1++) {
            A[i_0][i_0] = E[i_1] + F[i_0+2][i_1] * F[i_1][i_1+i_0] * F[i_1][i_0-2] + A[i_0+2][i_0+2] - A[i_0-1][i_0-1] - 1;
        }
    }
    for (int i_2 = 0; i_2 < PB_P; i_2++) {
        A[i_2][i_2] = E[i_2] - E[i_2+2] + E[i_2+1] * E[i_2] * E[i_2+1] * 2;
        for (int i_3 = 1; i_3 < PB_N; i_3++) {
            for (int i_4 = 0; i_4 < min(PB_N, -i_3+PB_M-2); i_4++) {
                C[i_2][i_3][i_4+i_3][2] = G[i_4+i_3][i_2+2][i_3] * G[i_4+i_3][i_2+2][i_4] - H[i_3][i_4][i_2][i_3] + F[i_3+1][i_2] + C[i_2+1][i_3][i_4+i_3-1][2] - C[i_2][i_4][i_4+i_3+2][2] - 6;
            }
        }
        for (int i_5 = 1; i_5 < PB_P; i_5++) {
            for (int i_6 = 2; i_6 < min(min(PB_N, -i_5+PB_M-1), -i_2+PB_M); i_6++) {
                C[i_2+1][i_6][i_6+i_5-1][2] = G[i_6+i_5][i_6+i_2][i_2] * G[i_2][i_6-2][i_5] + G[i_5+1][i_2][i_6] * G[i_2][i_6+i_5][i_5] + G[i_5][i_6+i_2][i_6] + G[i_2][i_6+i_5+1][1] * F[i_6-1][i_5] * A[i_5][i_5] - 2;
            }
        }
    }
#pragma endscop
...
kernel_4422152323_07(xa,ya,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
