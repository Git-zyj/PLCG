    ...
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        for (int i_1 = 0; i_1 < min(PB_Q, -i_0+PB_M+1); i_1++) {
            ...
            for (int i_3 = 0; i_3 < PB_Q; i_3++) {
                B[i_1+i_0-1][i_0][i_3] = D[i_1][i_0][i_3] - E[i_1][i_3][i_0-2][i_3] - 5;
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_P; i_4++) {
        for (int i_5 = 0; i_5 < i_4; i_5++) {
            for (int i_6 = 2; i_6 < PB_L-1; i_6++) {
                C[i_5][i_6+1][i_4] = F[i_5+2][i_6-1][i_4] + C[i_6-2][i_4+1][i_5] - 4;
            }
        }
    }
#pragma endscop
...
kernel_3312312123_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
