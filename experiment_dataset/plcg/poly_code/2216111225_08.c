...
void kernel_2216111225_08(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N; i_0++) {
        for (int i_1 = 0; i_1 < min(-i_0+PB_M, i_0); i_1++) {
            A[i_0][i_1] = C[i_1+i_0] - A[i_0-1][i_1] * 3;
        }
        for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
            A[i_0][i_2+1] = C[i_2] + A[i_0][i_2] + 3;
        }
    }
#pragma endscop
...
kernel_2216111225_08(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
