...
void kernel_4332231215_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
        ...
        for (int i_1 = 0; i_1 < min(PB_P, -i_0+PB_N); i_1++) {
            for (int i_2 = 1; i_2 < PB_P; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_1+PB_P, -i_0+PB_P); i_3++) {
                    A[i_1+i_0][i_3-1][i_2][i_3+i_1] = D[i_0][i_3][i_1][i_2+1] - A[i_3+i_1+1][i_0-1][i_2-1][i_3+i_0] - 2;
                }
            }
        }
        for (int i_4 = 1; i_4 < min(i_0, -i_0+PB_N); i_4++) {
            for (int i_5 = 1; i_5 < i_4; i_5++) {
                for (int i_6 = 1; i_6 < -i_4+PB_P; i_6++) {
                    A[i_4+i_0][i_6-1][i_5][i_6+i_4] = E[i_6+1][i_5][1] * D[i_4-1][i_6][i_0+1][i_5-1] - E[i_6-1][i_4+1][i_5-1] - 6;
                }
            }
        }
    }
    for (int i_7 = 0; i_7 < PB_M-1; i_7++) {
        for (int i_8 = 1; i_8 < PB_L-1; i_8++) {
            for (int i_9 = 1; i_9 < PB_P-2; i_9++) {
                C[i_8][i_8+1][i_9+1] = F[i_7+1][i_9+1][i_9+1] - F[i_9-1][i_7][i_7] - G[i_9-1][1] + C[i_8][i_8+1][i_9] + C[i_8-1][i_8][i_9+2] * 2;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4332231215_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G)));
