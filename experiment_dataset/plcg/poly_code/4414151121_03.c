...
void kernel_4414151121_03(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            A[i_0][i_1] = E[0] * E[i_0] - F[i_1][i_1] + F[i_0+1][0] + E[i_0] + 4;
            B[i_0-1][i_1+1] = F[i_1-1][i_0-1] - F[i_0+1][i_1] - B[i_0-1][i_1-1] - 6;
            C[i_0-1][i_1] = F[i_1][i_0] * F[i_1+1][i_0-1] * F[i_0+1][i_1] + F[i_1][i_0-1] * F[i_0][i_1] + 2;
            D[i_1][i_1+1] = E[i_0] * G[i_0][i_1][i_1+1] + F[i_1+1][i_0+1] * G[i_1][i_0][i_1] + F[i_1][i_0] * F[i_0+1][i_1] * D[i_1+1][i_1+2] * 6;
        }
    }
#pragma endscop
...
kernel_4414151121_03(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
