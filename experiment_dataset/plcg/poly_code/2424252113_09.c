...
void kernel_2424252113_09(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-1; i_0++) {
        B[i_0][i_0+2] = E[0] + E[i_0] - F[i_0] - G[i_0+1][i_0] - E[i_0+2] * 3;
        B[i_0][i_0+2] = E[0] * E[i_0] * E[i_0+1] - F[0] - F[i_0+1] + G[i_0][1] + E[i_0] * 5;
        for (int i_1 = 1; i_1 < PB_L+1; i_1++) {
            B[i_0+1][i_0+3] = E[i_1+2] * H[i_0][i_1-1] - B[i_0][i_0+2] + 5;
        }
    }
    for (int i_2 = 2; i_2 < PB_L; i_2++) {
        for (int i_3 = 2; i_3 < -i_2+PB_L; i_3++) {
            D[i_3+i_2][i_3-1] = G[i_3][i_2] * H[i_3-2][i_2] + H[i_3][i_2-2] - G[i_3+1][i_2] - G[i_3+1][i_2] + I[i_3][i_2][0] + 1;
        }
    }
#pragma endscop
...
kernel_2424252113_09(xb,yb,POLYBENCH_ARRAY(B), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
