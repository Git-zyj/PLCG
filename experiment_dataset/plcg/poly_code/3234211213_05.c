...
void kernel_3234211213_05(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        ...
        for (int i_3 = 1; i_3 < PB_L; i_3++) {
            B[i_0][i_3-1] = C[i_0][i_3] - B[i_0-1][i_3-1] + B[i_0][i_3] - 4;
        }
    }
#pragma endscop
...
kernel_3234211213_05(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
