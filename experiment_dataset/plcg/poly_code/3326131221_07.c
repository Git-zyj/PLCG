    ...
    for (int i_3 = 1; i_3 < PB_Q; i_3++) {
        for (int i_4 = 0; i_4 < min(PB_M, -i_3+PB_L+1); i_4++) {
            for (int i_5 = 0; i_5 < -i_3+PB_Q; i_5++) {
                B[i_4+1][i_5][i_5+i_3] = E[i_5][i_4+i_3-1] * D[i_4][i_5+1][i_3-1] - B[i_4][i_5][i_5+i_3] + 5;
            }
        }
    }
    for (int i_6 = 1; i_6 < PB_Q; i_6++) {
        for (int i_7 = i_6; i_7 < PB_Q; i_7++) {
            for (int i_8 = 1; i_8 < PB_M-1; i_8++) {
                C[i_8-1][i_8][i_6] = D[i_8][i_7][i_6] - E[i_6-1][i_8] * D[i_8+1][i_7][0] + C[i_8][i_8+1][i_6-1] + C[i_8][i_8+1][i_6] + 3;
            }
        }
    }
#pragma endscop
...
kernel_3326131221_07(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
