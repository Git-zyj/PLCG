...
void kernel_4332332321_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 2; i_2 < min(-i_0+PB_M, -i_1+PB_P); i_2++) {
                for (int i_3 = 0; i_3 < PB_Q; i_3++) {
                    A[i_1][i_0-1][i_1][i_3] = D[i_2+i_0][i_3][i_3][i_1+1] + E[i_3+i_2][i_1][i_0][i_0+1] + F[i_3+i_2-2][i_0-2][i_2+i_1] - A[i_1-1][i_0-1][i_1-1][i_3] - 2;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_P-2; i_4++) {
        for (int i_5 = 1; i_5 < PB_M-3; i_5++) {
            B[i_5+1] = G[i_4][i_5] * B[i_5+3] * B[i_5] + B[i_5+2] - B[i_5-1] + B[i_5] * 3;
        }
        for (int i_6 = 1; i_6 < -i_4+PB_P-2; i_6++) {
            for (int i_7 = 2; i_7 < PB_M-3; i_7++) {
                for (int i_8 = 1; i_8 < min(-i_4+PB_P+1, -i_7+PB_M-3); i_8++) {
                    C[i_8+i_7][i_6][i_8+i_4-1][i_6-1] = H[i_8+i_4-1][i_7-1][i_6][i_8][i_7] * E[i_8][i_6+i_4+2][i_7-2][i_4] - I[i_6][i_8-1][i_4-2] + E[i_6][i_7][i_8][i_4] - C[i_7+i_6][i_8][i_6+i_4-2][i_8-1] * C[i_8+i_7+1][i_6][i_8+i_4-1][i_6-1] - C[i_8+i_7+3][i_6+2][i_8+i_4-1][i_6+1] * 4;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4332332321_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
