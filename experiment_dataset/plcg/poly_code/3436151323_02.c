...
void kernel_3436151323_02(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_N-1; i_1++) {
        B[i_1] = E[i_1-1] * E[i_1] - E[i_1] + E[i_1] - E[1] - E[i_1+1] - E[i_1] + B[i_1+1] * B[i_1-2] * 5;
    }
    for (int i_2 = 1; i_2 < PB_N; i_2++) {
        C[i_2+1] = E[i_2] - E[i_2-1] + E[i_2] + E[i_2] + E[i_2-1] * B[i_2] * C[i_2] * C[i_2-1] + 1;
    }
    for (int i_3 = 1; i_3 < PB_N; i_3++) {
        B[i_3] = E[0] - E[i_3] * E[i_3-1] - E[i_3] - C[i_3+1] - 1;
    }
#pragma endscop
...
kernel_3436151323_02(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E));
