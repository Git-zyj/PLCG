        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_L; i_2++) {
                for (int i_3 = 1; i_3 < PB_Q; i_3++) {
                    B[i_1][i_3][i_2] = D[i_3-1][i_0][i_1][i_1-1] - E[i_3-1][i_3][i_1+1][0] + F[i_1][i_2+i_0][i_3][0] + F[i_2][i_1+1][i_0-1][i_2] + 3;
                }
            }
        }
        for (int i_4 = 1; i_4 < i_0; i_4++) {
            for (int i_5 = 0; i_5 < min(i_0, -i_4+PB_L); i_5++) {
                B[i_0][i_4][i_5] = G[i_5][i_4] + H[i_0+1][i_5+i_4][1] + I[1][i_0][i_4] - H[i_5][i_0-1][i_4] * B[i_0+1][i_4-1][i_5] + 6;
            }
        }
    }
    for (int i_6 = 0; i_6 < PB_Q; i_6++) {
        for (int i_7 = 1; i_7 < i_6; i_7++) {
            for (int i_8 = max(i_6, 1); i_8 < min(-i_6+PB_P, PB_M-1); i_8++) {
                B[i_6][i_7][i_8+1] = E[i_7-1][i_8+i_6][i_8+1][i_6] - J[i_6][i_8-1] + I[i_7][i_6][i_7-1] + H[i_8+1][i_6][i_7] + H[i_7][i_8][i_6] * H[i_7][i_8][i_8] - I[i_8][i_7][0] - 2;
            }
        }
    }
#pragma endscop
...
init_array(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4316351115_09(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J)));
