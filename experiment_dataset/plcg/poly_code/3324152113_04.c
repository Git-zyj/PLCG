...
void kernel_3324152113_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        A[1] = D[i_0+2] + D[i_0-1] * D[i_0+2] * D[i_0] + D[i_0] + A[1] + 2;
        C[i_0] = D[i_0-2] * D[i_0-1] - D[i_0+2] - 4;
        C[i_0] = D[2] * D[i_0-1] - D[i_0] - D[i_0] * D[i_0-1] + D[i_0] - D[i_0] - C[i_0+1] + 4;
    }
#pragma endscop
...
kernel_3324152113_04(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
