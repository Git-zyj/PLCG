...
void kernel_4126212313_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        A[i_0-1] = B[0] - A[i_0] - A[i_0-2] - A[i_0-2] + 5;
    }
#pragma endscop
...
kernel_4126212313_08(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
