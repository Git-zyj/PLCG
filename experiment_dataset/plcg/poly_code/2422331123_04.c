...
#pragma scop
    ...
    for (int i_3 = 1; i_3 < PB_M; i_3++) {
        D[i_3] = F[i_3] * F[i_3] + F[i_3-1] - D[i_3+2] - 4;
    }
#pragma endscop
...
kernel_2422331123_04(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
