...
void kernel_4424351221_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj)){
...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < PB_N-1; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_1+PB_M+1, PB_L-1); i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_P-1; i_3++) {
                    A[i_1+1][i_2][i_0][i_3] = E[i_3+i_2][i_3+i_0+1][i_1-1][0] - E[i_3+i_2][i_2][i_0][i_1] + F[i_1+1][i_3][i_2][i_0-1] * F[i_3][i_2+i_1-1][i_2][i_0] - G[1][i_3-1][i_1][i_0] + G[i_1][i_2][i_0][i_3] * F[i_0][i_3][i_1-1][i_2] + F[i_3][i_2+1][i_1][i_1-1] - A[i_3+3][i_1][i_0][i_2] * A[i_1+1][i_2+1][i_0][i_3] - A[i_2+1][i_3][i_0][i_1+2] * D[i_2][i_0-2][i_0-3][i_1+1] + 2;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_L-1; i_4++) {
        for (int i_5 = max(i_4, 1); i_5 < PB_L-1; i_5++) {
            for (int i_6 = 1; i_6 < PB_M-1; i_6++) {
                for (int i_7 = 0; i_7 < min(-i_5+PB_L-1, -i_4+PB_Q); i_7++) {
                    B[i_4][i_6][i_7+1][i_7+i_4] = H[i_6][i_7][i_5-1] - H[i_6+1][i_5][i_6] - G[i_6][i_4+1][i_7+i_5+1][0] * G[i_5][i_7+1][i_6-1][i_7] * 4;
                }
            }
        }
    }
    for (int i_8 = 1; i_8 < PB_L; i_8++) {
        for (int i_9 = i_8; i_9 < PB_N-1; i_9++) {
            for (int j_0 = i_8; j_0 < PB_L; j_0++) {
                C[i_8][j_0][i_9] = H[i_9-1][j_0][i_8-1] + I[i_9+1][i_8][j_0] - H[i_9][j_0-1][i_8] + J[j_0][j_0][i_9] * C[i_8][j_0][i_9+1] * 4;
            }
        }
        for (int j_1 = 1; j_1 < min(i_8, PB_P-2); j_1++) {
            for (int j_2 = 0; j_2 < min(min(i_8, PB_L-2), -j_1+PB_M); j_2++) {
                for (int j_3 = 1; j_3 < min(-i_8+PB_L, -j_2+PB_L); j_3++) {
                    D[i_8][j_1][j_1-1][j_3+1] = G[j_2+j_1][i_8-1][j_3-1][j_2+1] - E[j_3+j_2][j_1][i_8+1][j_2+1] - G[j_2][j_1-1][j_3+i_8][j_3] + C[j_1][j_2+2][j_3] - D[j_2][j_1+2][j_1+1][i_8+1] * 4;
                }
            }
        }
    }
...
kernel_4424351221_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
