...
void kernel_3412252225_07(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        for (int i_1 = 1; i_1 < min(-i_0+PB_L, i_0); i_1++) {
            A[i_1-1][i_0] = E[i_1] * F[i_1][i_0] + F[i_0][i_1+i_0] + G[i_1][i_0] + A[i_0+1][i_1+2] - A[i_1-1][i_0-2] - 6;
            for (int i_2 = 2; i_2 < PB_L-2; i_2++) {
                A[i_2-1][i_1] = H[i_2-1][i_1+i_0][i_2] - F[i_1][i_2] * H[i_1+i_0][i_1-1][i_2] + H[i_1][i_0-2][i_2] + H[i_2+2][i_1+i_0+1][i_2] * F[i_2][i_2+2] - I[i_2-2][i_0][i_0] + A[i_2-1][i_1] - 2;
            }
        }
        C[i_0] = J[i_0] * E[i_0-2] * E[i_0] - C[i_0-2] - 6;
        for (int i_3 = 2; i_3 < PB_L-2; i_3++) {
            for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
                A[i_4-1][i_3+2] = I[i_4+1][i_0][i_3-2] + H[i_0+1][i_4-1][i_3+1] - I[i_0][i_4][i_3] + G[1][i_3-1] * 5;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_3412252225_07(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J)));
