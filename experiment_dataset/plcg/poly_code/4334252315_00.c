...
void kernel_4334252315_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
        ...
        for (int i_1 = 2; i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = 2; i_2 < PB_Q-1; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_0+PB_M, -i_2+PB_M); i_3++) {
                    A[i_3+i_0][i_1-1][i_2][i_1+1] = D[i_3+1][i_0-1][i_0][i_1] * E[i_3][i_1][i_0][i_2] + E[i_1][i_0][i_2][i_3] - E[i_2][i_0+2][i_1][0] - D[i_3+i_2][i_0][i_3+2][i_1-2] + E[i_1+i_0][i_2-2][i_3][i_0] * A[i_3+i_0-1][i_1-1][i_2-1][i_1+1] + A[i_1+i_0][i_2-1][i_3][i_2+1] * 6;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 2; i_5 < -i_4+PB_L-2; i_5++) {
            for (int i_6 = i_4; i_6 < -i_4+PB_L-1; i_6++) {
                B[i_5][i_6+i_4][i_6+i_5] = F[i_5-2][i_4-1][i_6] * F[i_6][i_5+i_4+2][0] - G[i_5][i_4] * F[i_4][i_6+1][2] - H[i_5][i_4-1][i_6] - H[i_6][i_4][i_5] - B[i_5-1][i_6+i_4][i_6+i_5-1] * B[i_5][i_6+i_4+1][i_6+i_5] * 3;
            }
        }
        C[i_4] = I[i_4] - I[i_4] + I[i_4-1] - C[i_4+1] + C[i_4-1] - C[i_4-1] - C[i_4-1] - C[i_4-1] - 2;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4334252315_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I)));
