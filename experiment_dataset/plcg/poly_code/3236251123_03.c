...
void kernel_3236251123_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = max(2, i_0); i_1 < min(PB_L-3, -i_0+PB_P-1); i_1++) {
            for (int i_2 = i_1; i_2 < min(-i_1+PB_L, -i_0+PB_L-1); i_2++) {
                A[i_2-1][i_1+1][i_2] = C[i_2+i_0+1][i_2+i_1][i_1][0] - D[i_2][i_0][i_1] - E[i_2][i_1+1] + A[i_2+1][i_1+3][i_2+2] - 1;
            }
            for (int i_3 = 1; i_3 < -i_1+PB_L; i_3++) {
                B[i_3-1][i_1-1][i_1+1] = D[i_0][i_1][0] - D[i_0][i_3+i_1][i_1+i_0+1] + D[i_0][i_3-1][i_1-1] - D[i_3][i_0][i_1] - E[i_3][i_1-1] + D[i_3][i_1-1][i_0+1] * B[i_0-1][i_1-2][i_1] + 1;
            }
        }
    }
#pragma endscop
...
kernel_3236251123_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
