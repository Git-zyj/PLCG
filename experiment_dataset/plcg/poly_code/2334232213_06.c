...
void kernel_2334232213_06(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        ...
        C[i_0+2] = D[i_0] - E[i_0] * D[i_0-2] - E[i_0] + 2;
    }
    for (int i_2 = 0; i_2 < PB_L-1; i_2++) {
        C[i_2+1] = D[i_2] - D[i_2] * E[i_2+1] + C[i_2+2] * 6;
    }
#pragma endscop
...
kernel_2334232213_06(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
