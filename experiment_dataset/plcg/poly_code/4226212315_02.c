...
void kernel_4226212315_02(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        for (int i_1 = 1; i_1 < min(PB_L, -i_0+PB_P-1); i_1++) {
            B[i_0][i_1][i_1+i_0] = C[i_0][i_1-1] + B[i_0+1][i_1][i_1+i_0+1] + 4;
            B[i_1][i_0][i_1+i_0] = C[i_1][i_0] * B[i_1-1][i_0][i_1+i_0-1] + B[i_1][i_0-1][i_1+i_0-1] - 6;
        }
    }
#pragma endscop
...
kernel_4226212315_02(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
