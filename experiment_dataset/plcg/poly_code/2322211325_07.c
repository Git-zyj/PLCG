...
void kernel_2322211325_07(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_N-1; i_1++) {
        C[i_1-1] = D[i_1-1] - C[i_1+1] - C[i_1] + C[i_1-1] + 3;
        C[i_1] = D[i_1-1] - 5;
    }
#pragma endscop
...
kernel_2322211325_07(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
