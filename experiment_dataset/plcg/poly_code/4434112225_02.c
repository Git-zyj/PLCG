        ...
        for (int i_1 = 1; i_1 < PB_P+1; i_1++) {
            for (int i_2 = i_0; i_2 < PB_L; i_2++) {
                for (int i_3 = 1; i_3 < PB_P; i_3++) {
                    A[i_0][i_2][i_2][i_3] = E[i_0][i_2][i_3][i_1-1] * A[i_0][i_2][i_2][i_3-1] - 2;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_N-2; i_4++) {
        for (int i_5 = 0; i_5 < i_4; i_5++) {
            for (int i_6 = max(i_4, 2); i_6 < PB_N+2; i_6++) {
                C[i_6-2][i_6-2] = F[i_6-1][i_4][i_5+1] * 2;
            }
        }
        for (int i_7 = 0; i_7 < i_4; i_7++) {
            C[i_4][i_4] = G[i_7][i_4] * C[i_4+1][i_4+1] + C[i_4+2][i_4+2] - 5;
        }
        for (int i_8 = 0; i_8 < i_4; i_8++) {
            C[i_4][i_4] = G[i_8][i_4+1] * 1;
        }
    }
#pragma endscop
...
kernel_4434112225_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
