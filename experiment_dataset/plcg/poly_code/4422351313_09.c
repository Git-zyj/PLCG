        ...
        for (int i_1 = i_0; i_1 < -i_0+PB_P; i_1++) {
            for (int i_2 = 1; i_2 < PB_Q-2; i_2++) {
                for (int i_3 = 1; i_3 < PB_P-1; i_3++) {
                    A[i_0][i_1][i_3][i_2+1] = E[i_0][i_3+1][i_2-1][i_1-1] + F[i_1][i_2][i_0][i_3] - E[i_1-1][i_0-1][i_2][i_3] - F[i_1][i_0+1][i_2][0] * F[i_2-1][i_1+i_0][i_1+1][1] + F[i_3][i_1+1][i_3][i_1] * G[i_2][i_0][i_1+1][i_3-1] * A[i_0+1][i_1+1][i_3+1][i_2+2] - A[i_0][i_1][i_3-1][i_2+1] + A[i_0][i_1-1][i_3][i_2+2] - 5;
                }
            }
        }
        for (int i_4 = i_0; i_4 < PB_M-2; i_4++) {
            for (int i_5 = 1; i_5 < PB_L-1; i_5++) {
                B[i_4+1][i_5] = H[i_4][i_5] + I[0][i_5] + B[i_4+1][i_5-1] * B[i_4][i_5] + B[i_4+1][i_5+1] + B[i_4+2][i_5] - 5;
            }
        }
    }
    for (int i_6 = 1; i_6 < PB_L-1; i_6++) {
        for (int i_7 = 1; i_7 < -i_6+PB_L; i_7++) {
            for (int i_8 = 1; i_8 < -i_7+PB_L; i_8++) {
                C[i_8][i_8+i_7] = H[i_8][i_7] + J[i_6][i_8-1][i_7+1] * I[i_6-1][i_8] * J[i_7+1][i_6][i_6] + K[i_7-1][i_8][i_6+1] * K[i_6][i_7][i_6] * K[i_6+1][i_8+1][i_7] + C[i_7-1][i_8+i_7] - C[i_7-1][i_8+i_7-1] - C[i_6-1][i_7+i_6] - 1;
            }
            D[i_6] = I[i_6+1][i_6] * H[i_6][i_6] * H[i_7][i_6] + D[i_6+1] - 3;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4422351313_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
