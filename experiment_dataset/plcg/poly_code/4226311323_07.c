...
void kernel_4226311323_07(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_N-1; i_0++) {
        ...
        for (int i_2 = i_0; i_2 < -i_0+PB_N-1; i_2++) {
            B[i_2+i_0][i_2+i_0-1] = C[i_2-1][i_0] + B[i_2+i_0+1][i_2+i_0] + B[i_2+i_0-1][i_2+i_0-2] * B[i_2+i_0+1][i_2+i_0] - B[i_2+i_0-1][i_2+i_0-2] + 2;
        }
    }
#pragma endscop
...
kernel_4226311323_07(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
