...
void kernel_4224132115_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-2; i_0++) {
        A[0] = C[0] * C[0] * C[i_0] + 6;
        A[0] = C[i_0] + C[i_0] * C[i_0+2] * A[0] - 5;
    }
#pragma endscop
...
kernel_4224132115_02(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
