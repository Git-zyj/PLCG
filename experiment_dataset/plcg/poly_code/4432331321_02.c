...
void kernel_4432331321_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk)){
        ...
        for (int i_1 = 1; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_L, i_1); i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_P; i_3++) {
                    A[i_3+1][i_1][i_0][i_2] = E[i_3][i_1][i_0][i_1+1] - E[i_3][i_1][i_3+i_0][i_2] + F[i_2-1][i_2+i_0][i_1-1][i_3] * E[i_2][i_3-1][i_1][i_0] * G[i_1+1][i_2][i_2+i_0][1] * H[i_2+1][i_1][i_3-1][i_0][i_2+1] * F[i_1][i_0][i_3-1][i_2] - A[i_0+3][i_3][i_1+2][i_2] * 3;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L; i_4++) {
        for (int i_5 = 1; i_5 < PB_P-2; i_5++) {
            for (int i_6 = 1; i_6 < PB_L; i_6++) {
                B[i_4][i_6][i_5+1] = I[i_6-1][i_4][i_5-1] * J[i_4+1][i_6][i_5] + K[i_5][i_6][i_4-1] + B[i_4+2][i_6][i_5+1] - B[i_4+1][i_6][i_5+2] - B[i_4][i_5][i_6-1] * B[i_4-2][i_5][i_6+1] - 6;
            }
        }
        for (int i_7 = 0; i_7 < -i_4+PB_M; i_7++) {
            for (int i_8 = 2; i_8 < -i_4+PB_L; i_8++) {
                for (int i_9 = 0; i_9 < PB_N-1; i_9++) {
                    C[i_8][i_4+1][i_9+1] = E[i_7][i_8+i_4][i_4][i_8+1] + E[i_7+i_4][i_4][i_7][i_8] - C[i_8-2][i_9+1][i_7+1] * C[i_8-2][i_7+1][i_9+1] + C[i_8-1][i_7+1][i_9+1] + C[i_7][i_8][i_9+1] * 1;
                }
            }
        }
    }
...
kernel_4432331321_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
