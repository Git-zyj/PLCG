...
void kernel_4336111315_05(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_N; i_1++) {
        C[i_1+2] = D[i_1] + C[i_1+2] - C[i_1] * C[i_1+1] + 3;
        C[i_1+1] = D[i_1] + 5;
    }
#pragma endscop
...
kernel_4336111315_05(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
