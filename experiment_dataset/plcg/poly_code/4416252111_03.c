...
void kernel_4416252111_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        A[i_0+1] = E[i_0] - E[i_0] + F[i_0] + E[i_0] - F[i_0] * 1;
        for (int i_1 = 2; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_M, -i_1+PB_P); i_2++) {
                for (int i_3 = 2; i_3 < min(min(-i_0+PB_Q, -i_2+PB_P-1), PB_N); i_3++) {
                    B[i_3][i_1][i_2-1][i_0+1] = G[i_1+1][i_2][i_3+2][i_0] * H[i_0-1][i_2][i_1-2][i_0] + H[i_0+1][i_2+i_1][0][i_2] + I[i_3][i_1-2][i_2] - J[i_2+i_0][i_1][i_0] * G[i_0][i_2+2][i_1][i_3] - G[i_3-2][i_1][i_2-1][i_3+i_0] + H[i_0][i_3+i_2+1][i_1][i_3] * 2;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_N; i_4++) {
        for (int i_5 = i_4; i_5 < PB_N-2; i_5++) {
            for (int i_6 = 1; i_6 < PB_P-1; i_6++) {
                C[i_6-1][i_5][i_4] = J[i_5][i_4][i_6+1] - I[i_5][i_4-2][i_6] * K[i_4][i_5] + J[i_5][0][i_6] * 1;
            }
            for (int i_7 = 2; i_7 < PB_N-2; i_7++) {
                D[i_7+2][i_5+2][i_5-1] = J[i_5][i_7][i_5] + I[i_4][i_5+1][i_7] + I[i_5+2][i_7][i_4] - C[i_7-2][i_5][i_4] * D[i_7+2][i_5+3][i_5] * D[i_7+1][i_5+2][i_5-1] - 5;
            }
        }
    }
#pragma endscop
...
kernel_4416252111_03(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K));
