...
void kernel_2336312325_04(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_M-2; i_1++) {
        B[i_1] = D[i_1] * B[i_1-1] - B[i_1+2] * B[i_1+1] + 4;
        B[i_1+1] = 5;
    }
#pragma endscop
...
kernel_2336312325_04(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
