...
void kernel_4236112211_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
    ...
    for (int i_2 = 1; i_2 < PB_P+1; i_2++) {
        for (int i_3 = 0; i_3 < min(PB_L, i_2); i_3++) {
            for (int i_4 = i_2; i_4 < -i_2+PB_P+1; i_4++) {
                B[i_4+1][i_3][i_4+i_2-1] = C[i_4][i_3] - B[i_4][i_3][i_4+i_2-1] * 1;
            }
        }
    }
#pragma endscop
...
kernel_4236112211_01(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
