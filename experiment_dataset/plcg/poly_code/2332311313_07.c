...
void kernel_2332311313_07(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
        B[i_1] = 3;
        B[i_1+1] = D[i_1] + B[i_1] + B[i_1+1] * B[i_1-1] + 5;
    }
#pragma endscop
...
kernel_2332311313_07(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
