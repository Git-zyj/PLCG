...
void kernel_3414111225_08(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M+1; i_0++) {
        B[i_0-1] = B[i_0-3] - B[i_0-1] - 6;
        B[i_0-1] = 2;
    }
    for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
        C[i_1] = E[i_1] * E[i_1+1] * C[i_1-1] * 3;
        C[i_1-1] = E[i_1] + 4;
    }
#pragma endscop
...
kernel_3414111225_08(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E));
