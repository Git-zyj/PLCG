...
void kernel_4432152125_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
        ...
        for (int i_1 = 2; i_1 < PB_M; i_1++) {
            for (int i_2 = 2; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 2; i_3 < PB_M; i_3++) {
                    A[i_0][i_1-2][i_1][i_3] = E[i_1][i_2-2][i_3][i_0] + E[i_2+1][i_1][i_0-1][i_0-1] - F[i_2][i_3][i_3][i_1][i_0+1] * A[i_0-2][i_3-2][i_3][i_1] + A[i_0+1][i_1-2][i_1][i_3] * 2;
                }
            }
        }
        for (int i_4 = 0; i_4 < PB_M-2; i_4++) {
            B[i_0][i_4+2] = G[i_4][i_0] + G[i_0][i_0+2] * B[i_4][i_0+4] + 4;
        }
        C[i_0] = H[i_0] + H[i_0+2] + H[i_0] - H[i_0] - H[i_0] - H[i_0] + H[i_0+1] + H[i_0] - 2;
    }
    for (int i_5 = 1; i_5 < PB_M-2; i_5++) {
        C[i_5] = H[0] - H[i_5] * H[i_5] - H[i_5-1] - H[i_5] + G[i_5][i_5] * H[i_5+2] * 3;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4432152125_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H)));
