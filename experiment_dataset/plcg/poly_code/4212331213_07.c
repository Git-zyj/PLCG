        ...
        for (int i_1 = 0; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_Q; i_2++) {
                for (int i_3 = 1; i_3 < PB_M; i_3++) {
                    A[i_2+1][i_1+1][i_3][i_3] = C[i_1+1][i_3-1][i_2+i_0][i_3] * D[i_2][i_0][i_0-1][i_1+1] + E[i_2][i_3][i_0] + 5;
                }
            }
        }
        B[i_0] = F[i_0] - G[i_0] * B[i_0+1] - B[i_0-1] + B[i_0-1] + 4;
    }
#pragma endscop
...
kernel_4212331213_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
