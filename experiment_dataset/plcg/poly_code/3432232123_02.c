...
void kernel_3432232123_02(int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        D[i_0] = E[i_0] * 1;
        for (int i_1 = i_0; i_1 < PB_P; i_1++) {
            B[i_0][i_1] = F[i_1-2][i_0+1] - E[i_1] - G[i_1][i_0-2][0] + B[i_0-2][i_1-1] + 4;
        }
    }
    for (int i_2 = 2; i_2 < PB_L-1; i_2++) {
        D[i_2+1] = H[i_2-2] - E[i_2] + H[i_2] - E[i_2-2] + 5;
    }
    for (int i_3 = 2; i_3 < PB_L-1; i_3++) {
        D[i_3+1] = H[i_3] - E[i_3-2] * H[i_3] + 6;
    }
#pragma endscop
...
kernel_3432232123_02(xd,POLYBENCH_ARRAY(D), xb,yb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
