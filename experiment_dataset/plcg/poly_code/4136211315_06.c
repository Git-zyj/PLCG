...
void kernel_4136211315_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb)){
        ...
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < PB_L; i_2++) {
                for (int i_3 = 0; i_3 < PB_L; i_3++) {
                    A[0][i_3+1][i_1] = B[i_3][i_2-1][i_1] + A[0][i_2+1][i_1+1] + A[0][i_3+2][i_1] - A[0][i_0+1][i_1+1] * 1;
                }
            }
        }
    }
...
kernel_4136211315_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B));
