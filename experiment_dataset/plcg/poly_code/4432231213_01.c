...
#pragma scop
    ...
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        ...
        for (int i_6 = 2; i_6 < -i_4+PB_L-1; i_6++) {
            C[i_6+i_4][i_6] = I[i_6][i_6+i_4+1] * J[i_6-1] + I[i_6][i_4] - K[i_6][i_4][i_4] + L[0] - C[i_6+i_4-1][i_6-1] - C[i_6+i_4+1][i_6] + C[i_6+i_4+1][i_6+1] - C[i_6+i_4-1][i_6] - 3;
            for (int i_7 = i_4; i_7 < min(PB_Q, -i_4+PB_M+1); i_7++) {
                for (int i_8 = 0; i_8 < -i_6+PB_Q; i_8++) {
                    D[i_6][i_7+i_4-1][i_8+1] = H[i_8+1][i_4+1][i_7] - G[i_4-1][i_7][i_6][i_8+i_6][i_7-1] + D[i_7+1][i_8+i_6-2][i_4+1] + 1;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4432231213_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L));
