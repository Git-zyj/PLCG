...
void kernel_4236312123_09(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N; i_0++) {
        for (int i_1 = 4; i_1 < PB_P; i_1++) {
            for (int i_2 = 1; i_2 < PB_P; i_2++) {
                A[i_2-1][i_1-2][i_0] = C[i_2][i_0][i_1] * B[i_1-4][i_0-2][i_2] - 1;
            }
        }
    }
        ...
        for (int i_4 = 2; i_4 < PB_P; i_4++) {
            for (int i_5 = 0; i_5 < i_3; i_5++) {
                for (int i_6 = 2; i_6 < -i_4+PB_L; i_6++) {
                    B[i_6-2][i_4-2][i_5] = C[i_5][i_6+i_4][0] + 3;
                }
            }
        }
    }
...
kernel_4236312123_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
