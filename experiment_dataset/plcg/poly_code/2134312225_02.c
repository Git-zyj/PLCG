...
void kernel_2134312225_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_L; i_0++) {
        for (int i_1 = i_0; i_1 < min(-i_0+PB_P, PB_L+1); i_1++) {
            A[i_0][i_1+i_0][i_1] = B[i_0] + A[i_1-1][i_1+i_0-3][i_0-2] - A[i_0-2][i_1+i_0-2][i_1] - 3;
        }
    }
#pragma endscop
...
kernel_2134312225_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
