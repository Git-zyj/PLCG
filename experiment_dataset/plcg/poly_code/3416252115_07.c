...
void kernel_3416252115_07(int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            C[i_0-2][i_1-2] = E[i_1-1] * F[i_1] - F[i_1] - F[i_1] - G[i_1][i_0] + E[i_1-1] - 2;
        }
        for (int i_2 = i_0; i_2 < -i_0+PB_M-1; i_2++) {
            for (int i_3 = 1; i_3 < min(-i_0+PB_M-2, i_0); i_3++) {
                B[i_3+i_0+2][i_2][i_2+i_0] = H[i_2+1][i_3][i_0-1] - I[i_2+2][i_3][i_3] - I[i_3][i_2+i_0][2] + J[i_2][i_0] * G[i_3][i_2-2] + H[i_2][i_0][i_3] - G[i_3][i_0] - I[i_2][i_0][i_0+2] - H[i_3][i_0][i_2+i_0] - B[i_2+i_0+1][i_3-1][i_3+i_0-2] + 5;
            }
            C[i_0-1][i_2-2] = J[i_2+i_0][i_2+1] + J[i_2][0] * G[i_2-2][0] - C[i_0][i_2-1] - 3;
        }
    }
    for (int i_4 = 1; i_4 < PB_L; i_4++) {
        for (int i_5 = 1; i_5 < PB_P; i_5++) {
            C[i_5-1][i_4-1] = J[i_4][i_5] + 1;
        }
    }
#pragma endscop
...
kernel_3416252115_07(xc,yc,POLYBENCH_ARRAY(C), xb,yb,zb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
