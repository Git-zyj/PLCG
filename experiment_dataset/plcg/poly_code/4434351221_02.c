...
void kernel_4434351221_02(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl),int xm,int ym,DATA_TYPE POLYBENCH_2D(M,xM,yM,xm,ym)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        A[i_0][i_0] = E[i_0+1] + F[i_0] - F[i_0-1] * A[i_0+2][i_0+2] * A[i_0-1][i_0-1] - A[i_0-2][i_0-2] - 2;
    }
    for (int i_1 = 1; i_1 < PB_P; i_1++) {
        for (int i_2 = 1; i_2 < PB_M; i_2++) {
            for (int i_3 = 0; i_3 < -i_2+PB_M; i_3++) {
                for (int i_4 = 1; i_4 < -i_2+PB_M; i_4++) {
                    B[i_4+i_2][i_3][i_4] = G[i_1][i_4][i_2] + H[i_4-1][i_3][i_2][i_1] * I[i_4][i_2][i_3][i_1+1] * J[i_4][i_1][i_3+i_2-1][0] * H[i_4][i_3+1][i_4+1][i_1-1] - B[i_3+i_2][i_4-1][i_3] - 2;
                }
            }
        }
    }
    for (int i_5 = 1; i_5 < PB_M; i_5++) {
        for (int i_6 = 1; i_6 < PB_M-2; i_6++) {
            C[i_6][i_6] = K[i_6-1][i_5] + L[i_6][i_5-1] - M[i_6-1][i_5] * L[i_6-1][i_5-1] - M[i_6][i_5] - K[i_5][i_5] - C[i_6+2][i_6+2] - 2;
        }
    }
    for (int i_7 = 1; i_7 < PB_M-1; i_7++) {
        D[i_7-1] = E[i_7+1] * E[i_7] - E[i_7] + F[i_7] * A[i_7+1][i_7+1] + D[i_7] + 4;
    }
#pragma endscop
...
kernel_4434351221_02(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M));
