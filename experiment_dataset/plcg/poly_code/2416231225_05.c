...
void kernel_2416231225_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_P-1; i_1++) {
        A[i_1-1] = E[i_1] - F[i_1] - E[i_1] - E[i_1] - 2;
        for (int i_2 = 1; i_2 < i_1; i_2++) {
            C[i_2][i_1] = G[i_2][i_1] - 2;
            C[i_1][i_2] = E[i_1-1] - H[i_2][0][i_1+1] - F[i_2-1] - 3;
        }
    }
#pragma endscop
...
kernel_2416231225_05(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
