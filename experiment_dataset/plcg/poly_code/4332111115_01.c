...
void kernel_4332111115_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
        ...
        for (int i_2 = 0; i_2 < PB_L; i_2++) {
            for (int i_3 = 1; i_3 < PB_L+1; i_3++) {
                for (int i_4 = i_2; i_4 < PB_L; i_4++) {
                    C[i_1][i_4][i_2][i_1+1] = C[i_1][i_3-1][i_2][i_1+1] * 1;
                }
            }
        }
    }
...
kernel_4332111115_01(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
