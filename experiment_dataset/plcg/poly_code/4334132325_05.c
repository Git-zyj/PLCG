...
void kernel_4334132325_05(int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg)){
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < PB_L; i_2++) {
                for (int i_3 = 2; i_3 < min(-i_0+PB_M+1, i_1); i_3++) {
                    C[i_0][i_3] = D[i_3-2][i_2][i_0] - E[i_3+i_0-1][i_2][i_0+2][i_1-1] + 3;
                }
            }
        }
        for (int i_4 = 2; i_4 < i_0; i_4++) {
            C[i_4][i_0] = F[i_4][2] - F[i_4-2][i_4] - G[i_4-1] * F[i_4+1][i_0-2] * 3;
        }
    }
    for (int i_5 = 0; i_5 < PB_L-1; i_5++) {
        for (int i_6 = 2; i_6 < min(PB_Q-2, -i_5+PB_Q); i_6++) {
            for (int i_7 = 2; i_7 < PB_L-1; i_7++) {
                C[i_6][i_7] = D[i_7][i_6][i_6+i_5] - D[i_7][i_5+1][i_6+2] * C[i_6-2][i_7] - C[i_6+1][i_7-2] + C[i_6][i_7+1] + 4;
            }
        }
    }
#pragma endscop
...
kernel_4334132325_05(xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
