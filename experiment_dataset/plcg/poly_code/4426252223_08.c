...
static void print_array(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,int ym,DATA_TYPE POLYBENCH_2D(M,xM,yM,xm,ym))
{
int i_0, i_1, i_2, i_3, i_4;
...
void kernel_4426252223_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,int ym,DATA_TYPE POLYBENCH_2D(M,xM,yM,xm,ym)){
        ...
        for (int i_1 = 2; i_1 < min(i_0, -i_0+PB_N); i_1++) {
            for (int i_2 = 2; i_2 < PB_Q-1; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_0+PB_M, -i_2+PB_L); i_3++) {
                    A[i_3+i_0-2][i_1][i_2][0] = E[i_1+i_0][i_2+2][i_3+i_2][1] * E[i_0][i_2][i_3][i_1] * F[i_0+2][i_1][i_3][i_2-1][i_0+2] + E[i_2-1][i_0][i_1][i_0] * G[i_2+i_1][i_0-2][i_3][i_2+1] - H[i_3][i_2+i_1+1][i_1] * E[i_0][i_1][i_2][i_3] + A[i_1+i_0][i_3+2][i_2][0] * A[i_3+i_0-2][i_1][i_2-2][0] * A[i_3+i_0][i_1][i_2][0] + A[i_3+i_0-1][i_1-2][i_2][0] + 6;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_Q-2; i_4++) {
        for (int i_5 = i_4; i_5 < PB_Q; i_5++) {
            for (int i_6 = 0; i_6 < i_4; i_6++) {
                B[i_6+1][i_4][i_4] = I[i_5-1][i_6+1][i_4] + H[i_6][i_5][i_5] - H[i_5][i_4][i_4] + B[i_6][i_4+1][i_4+1] - B[i_6+1][i_4+2][i_4+2] - B[i_6+3][i_4][i_4] * 5;
            }
        }
        for (int i_7 = 2; i_7 < i_4; i_7++) {
            C[i_4][i_7] = J[i_4-1][i_7] + K[i_7] * L[i_4-1] - K[i_7] - M[i_7][i_4+1] * C[i_4][i_7-2] * 4;
            for (int i_8 = 0; i_8 < PB_Q-2; i_8++) {
                D[i_7][i_4+2][i_8] = I[i_7][i_4+1][i_4] - I[i_7][i_8+2][i_4] * 3;
            }
        }
    }
#pragma endscop
