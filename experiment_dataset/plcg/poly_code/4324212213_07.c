...
void kernel_4324212213_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_M-2; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-2; i_2++) {
                for (int i_3 = 0; i_3 < PB_P; i_3++) {
                    A[i_1][i_0][0][i_3] = D[i_3][i_2+2][i_1][i_1-1] - A[i_3][i_0+1][0][i_1-1] - A[i_1+1][i_2][0][i_3] + 3;
                }
            }
            B[i_1+i_0] = B[i_1+i_0+2] - B[i_1+i_0+1] * B[i_1+i_0-1] + 5;
        }
    }
    for (int i_4 = 0; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 3; i_5 < PB_P; i_5++) {
            for (int i_6 = i_5; i_6 < min(PB_P-2, -i_5+PB_L+2); i_6++) {
                C[i_6+i_5-2][i_4][i_5][0] = E[i_5][i_4][i_6+2] + F[i_4+1][i_6+1][i_6] + C[i_6+i_5-3][i_4][i_5][0] - 2;
            }
        }
    }
#pragma endscop
...
kernel_4324212213_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
