...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_M-3; i_1++) {
        B[i_1+1] = E[i_1] + E[i_1] - F[i_1][i_1] + E[i_1-1] - E[i_1] * B[i_1+3] * D[i_1-1] * D[i_1+1] * 3;
        for (int i_2 = i_1; i_2 < -i_1+PB_M-1; i_2++) {
            for (int i_3 = 1; i_3 < PB_L-1; i_3++) {
                C[i_2+i_1][i_3+1][i_3+1] = G[i_3+1][i_1][i_2-1] - G[i_2][i_3][i_3+1] * C[i_2+i_1+1][i_3-1][i_3-1] + C[i_2+i_1][i_3][i_3] + 4;
            }
        }
        D[i_1+1] = E[i_1] + E[i_1+1] * E[i_1] - E[i_1+1] - E[i_1] + A[i_1] * B[i_1] * B[i_1+1] + D[i_1] - 5;
    }
#pragma endscop
...
kernel_4416131323_02(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
