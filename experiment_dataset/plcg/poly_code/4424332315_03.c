...
void kernel_4424332315_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl),int xm,int ym,DATA_TYPE POLYBENCH_2D(M,xM,yM,xm,ym)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        A[i_0] = E[i_0] * F[i_0] - G[i_0-2] - F[i_0] + F[i_0-2] + 5;
        for (int i_1 = i_0; i_1 < PB_N-2; i_1++) {
            for (int i_2 = 1; i_2 < PB_M-2; i_2++) {
                B[i_1+1][i_2][i_0-1] = H[i_2][i_0][i_1+2] - I[i_0][i_2-1][i_1] - J[i_2][i_1][i_0] - K[i_2][i_1] * B[i_2+2][i_0-1][i_1-1] - B[i_2+2][i_0][i_1-2] + B[i_1+1][i_2-1][i_0-1] * 3;
            }
        }
        for (int i_3 = i_0; i_3 < min(-i_0+PB_N+1, PB_N-2); i_3++) {
            D[i_0][i_3-1] = L[i_3+i_0-1][i_3+2] - M[i_0][i_3-1] - G[i_3+1] * 6;
            D[i_0][i_3] = D[i_0][i_3-1] - D[i_0-1][i_3] - D[i_0][i_3+1] * D[i_3][i_0+1] - D[i_0+1][i_3+1] - 2;
        }
    }
#pragma endscop
...
kernel_4424332315_03(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M));
