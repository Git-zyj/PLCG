        ...
        for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 2; i_2 < i_0; i_2++) {
                for (int i_3 = 2; i_3 < i_2; i_3++) {
                    A[i_3][i_1][i_2+1][i_3] = E[i_1-1][i_0-2][i_3+2][i_1] * E[i_2-2][i_0][i_3-2][i_1] + A[i_2-1][i_1][i_3+1][i_2-1] * A[i_3][i_1+1][i_2][i_3] * A[i_2+1][i_3+1][i_0+2][i_2+1] * 5;
                }
            }
        }
        for (int i_4 = 0; i_4 < i_0; i_4++) {
            for (int i_5 = 0; i_5 < PB_M; i_5++) {
                for (int i_6 = 0; i_6 < -i_0+PB_M; i_6++) {
                    A[i_0][i_5][i_6][i_0] = F[i_6+1][i_6+i_0][i_4][i_4] + 2;
                }
                for (int i_7 = 0; i_7 < min(PB_M, -i_4+PB_Q); i_7++) {
                    A[i_7][i_5+1][i_4+2][i_7] = F[i_5][i_0+1][i_4][i_7+i_4] - G[i_4][i_4][i_7+1][i_0][i_5] - H[i_7][i_4+2][2] + F[i_7][i_5][i_4][i_0] - A[i_0+1][i_5][i_7+1][i_0+1] + 1;
                }
            }
        }
        for (int i_8 = 0; i_8 < PB_M-2; i_8++) {
            D[i_8+1] = I[i_8+2][i_0+1] + J[i_0+2][i_8] + D[i_8+2] * D[i_8] - 1;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4424332315_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J)));
