...
void kernel_2334111315_02(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_N-2; i_1++) {
        C[i_1+1] = D[i_1] * D[i_1] * C[i_1] * C[i_1+2] - C[i_1] + 4;
    }
#pragma endscop
...
kernel_2334111315_02(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
