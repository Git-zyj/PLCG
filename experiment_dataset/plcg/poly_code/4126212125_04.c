...
void kernel_4126212125_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
...
kernel_4126212125_04(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
