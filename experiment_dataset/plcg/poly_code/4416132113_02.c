...
void kernel_4416132113_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        A[i_0] = E[i_0] - E[i_0-2] - E[i_0] + E[i_0+2] + E[i_0] - 3;
    }
    for (int i_1 = 1; i_1 < PB_L; i_1++) {
        for (int i_2 = 1; i_2 < PB_L; i_2++) {
            for (int i_3 = i_1; i_3 < PB_L-1; i_3++) {
                B[i_1][i_3+1][i_2-1] = F[i_2][i_3][i_1] * 5;
            }
            C[i_2][i_1] = G[i_2][i_1] * G[i_1][i_2] * 3;
            for (int i_4 = 3; i_4 < i_2; i_4++) {
                for (int i_5 = 1; i_5 < PB_L-1; i_5++) {
                    D[i_1-1][i_5][i_2][i_4-2] = F[i_5][i_5+1][i_4-1] - F[i_4][i_5-1][0] * F[i_1][i_2][i_5] - H[i_4][i_5-1][i_2][i_1] - D[i_1-1][i_2][i_5][i_4-3] + 1;
                }
            }
        }
    }
...
kernel_4416132113_02(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
