...
void kernel_2234151115_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        A[i_0+1] = C[i_0+1] + C[i_0-1] + C[i_0] * C[i_0] * C[i_0+1] * C[i_0] + C[i_0] * C[i_0] - 2;
        A[i_0+1] = C[i_0+1] - C[i_0] * A[i_0] - 4;
    }
#pragma endscop
...
kernel_2234151115_00(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
