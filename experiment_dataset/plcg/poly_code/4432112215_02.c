        ...
        for (int i_1 = 0; i_1 < PB_M; i_1++) {
            for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 2; i_3 < min(-i_1+PB_M, -i_2+PB_M+1); i_3++) {
                    D[i_2+1][i_3-2] = E[i_3+i_2-1][i_2+2][i_0][i_1] * F[i_2][i_3+i_1][i_0] + 4;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_L-2; i_4++) {
            B[i_4] = G[i_0][i_4+2] * H[i_4-1] - B[i_4-1] * B[i_4+1] - 2;
        }
    }
    for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
        ...
        for (int i_7 = 0; i_7 < PB_M-1; i_7++) {
            for (int i_8 = 2; i_8 < PB_L; i_8++) {
                D[i_5+1][i_8-1] = D[i_7][i_8] - D[i_7+1][i_8-2] * 2;
            }
        }
    }
#pragma endscop
...
init_array(xd,yd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4432112215_02(xd,yd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xd,yd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H)));
