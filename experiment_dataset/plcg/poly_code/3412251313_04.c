...
void kernel_3412251313_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 2; i_1 < PB_M; i_1++) {
            A[i_1-1][i_0+1] = E[i_1] - F[i_1][i_0-1] * E[i_1] - F[i_1][i_0+1] - A[i_1][i_0+1] * A[i_1-2][i_0] - A[i_1-2][i_0+1] - 1;
        }
        for (int i_2 = 1; i_2 < min(PB_M-1, -i_0+PB_L-1); i_2++) {
            for (int i_3 = 1; i_3 < min(-i_0+PB_N, -i_2+PB_M); i_3++) {
                B[i_2][i_2-1][i_3+i_0-1] = G[i_2][i_0+1][i_3] + G[i_3+i_2][i_3][i_0+1] - H[i_0-1][i_2+1][i_3] + H[i_0+1][i_3-1][i_2] - G[i_2+1][i_0][i_3] - I[i_3+1][i_0+1] - H[i_0][i_2][i_3] - 2;
                D[i_3][i_2-1][i_0-1] = H[i_3][i_0-1][i_2] - J[i_0+1][i_2][i_3][i_0] * H[i_3+i_0][i_2][i_3] + B[i_2][i_2-1][i_3+i_0-2] + B[i_2+1][i_2][i_3+i_0-1] * 2;
                D[i_2][i_0-1][i_3-1] = H[i_0][i_2][i_2] - G[i_3][i_2][i_0+1] + G[i_3][i_2][i_0] * F[i_3-1][i_2+i_0+1] * D[i_2+1][i_0-1][i_3-1] + D[i_2][i_0-2][i_3-1] + 4;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_3412251313_04(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J)));
