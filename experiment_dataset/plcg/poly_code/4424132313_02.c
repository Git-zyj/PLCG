        ...
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < PB_L; i_2++) {
                for (int i_3 = i_2; i_3 < PB_P-1; i_3++) {
                    A[i_0][i_2][i_3] = E[i_2][i_1][i_3+1] + A[i_0+1][i_2][i_1] * 2;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_N-2; i_4++) {
        B[i_4-1] = F[0] - F[i_4+2] * F[i_4] - F[i_4-1] - B[i_4] * B[i_4-2] * 1;
        for (int i_5 = 2; i_5 < i_4; i_5++) {
            B[i_5-2] = B[i_5-1] * B[i_5-2] + B[i_5] * 5;
        }
    }
        ...
        for (int i_7 = 2; i_7 < PB_M-1; i_7++) {
            for (int i_8 = 2; i_8 < i_7; i_8++) {
                for (int i_9 = 1; i_9 < PB_M-2; i_9++) {
                    D[i_7+1][i_9+1][i_8-1][i_7+1] = E[i_6+1][i_7-2][i_8] + E[i_6][i_9][i_9+1] - E[i_8-2][i_7][i_9-1] + G[i_7-1][i_9][i_8][i_6-2] - H[i_8][i_9+2][i_6][i_7][i_9] - H[i_6][i_7][i_9-1][i_8][0] + D[i_6+1][i_9+1][i_8][i_6+1] + 2;
                }
            }
        }
    }
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4424132313_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H)));
