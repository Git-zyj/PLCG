...
void kernel_4216112111_04(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P-2; i_0++) {
        for (int i_1 = PB_M - 1; i_1 >= 0; i_1--) {
            B[i_1][i_0+1][i_0-1] = C[i_0][0] + B[i_1][i_0+1][i_0-1] + 4;
            B[i_1][i_0+2][i_0] = 3;
        }
    }
#pragma endscop
...
kernel_4216112111_04(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
