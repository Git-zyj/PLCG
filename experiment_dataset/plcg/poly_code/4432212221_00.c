...
void kernel_4432212221_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve)){
        ...
        for (int i_5 = 2; i_5 < PB_P-1; i_5++) {
            for (int i_6 = 2; i_6 < PB_L; i_6++) {
                for (int i_7 = 3; i_7 < PB_P; i_7++) {
                    C[i_6-1][i_6-2][i_7][i_4-1] = E[i_7-2][i_6][i_5][i_4] - C[i_5-1][i_5-2][i_7-1][i_4-1] - C[i_7-2][i_7-3][i_5+1][i_4-1] * C[i_6-1][i_6-2][i_5][i_4-2] - 4;
                }
            }
        }
        for (int i_8 = 0; i_8 < min(i_4, PB_L-3); i_8++) {
            for (int i_9 = 0; i_9 < -i_8+PB_L-3; i_9++) {
                for (int j_0 = 0; j_0 < PB_Q; j_0++) {
                    D[i_4][i_9+i_8][i_4][j_0] = D[i_4][i_9+i_8+3][i_4][j_0] - 3;
                }
            }
        }
    }
...
kernel_4432212221_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
