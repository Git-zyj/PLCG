...
void kernel_4224311313_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_L-2; i_1++) {
            for (int i_2 = i_1; i_2 < -i_0+PB_L-1; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_L-1; i_3++) {
                    A[i_2+i_1][i_3+i_0+1][i_1] = C[i_3][i_2][i_1] - A[i_2+i_0+1][i_3+i_1+1][i_0] - A[i_3+i_2][i_1+i_0+2][i_2] * A[i_3+i_2][i_1+i_0-1][i_3] - A[i_3+i_2+1][i_1+i_0+2][i_3] - A[i_3+i_1-1][i_2+i_0+1][i_1-1] - 5;
                }
            }
        }
    }
...
kernel_4224311313_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
