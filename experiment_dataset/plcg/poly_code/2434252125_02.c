...
void kernel_2434252125_02(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 2; i_1 < -i_0+PB_M-2; i_1++) {
            A[i_0][i_1+1] = E[i_1] * F[i_1][i_0+1] * E[1] - G[i_1+i_0+2][i_0] * F[i_1][i_0+2] - H[i_0+2][i_1][i_1-2] - G[i_0+1][i_1-2] * A[i_0][i_1+2] - 4;
        }
        C[i_0-2] = I[i_0-1] + I[i_0] - C[i_0-1] + 6;
    }
    for (int i_2 = 0; i_2 < PB_M-2; i_2++) {
        C[i_2] = I[i_2+1] - I[i_2] * I[i_2] + I[i_2+2] - I[i_2] + E[i_2] - E[i_2] + 2;
        for (int i_3 = 2; i_3 < PB_M; i_3++) {
            D[i_2][i_3] = F[i_2][i_3-1] * I[i_3] + F[i_3-2][i_2] - C[i_3] + 3;
        }
    }
#pragma endscop
...
kernel_2434252125_02(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
