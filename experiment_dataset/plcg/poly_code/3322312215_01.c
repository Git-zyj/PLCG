...
void kernel_3322312215_01(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M; i_0++) {
        B[i_0-2] = D[i_0] - B[i_0-3] - 1;
        B[i_0-2] = B[i_0-3] - 6;
    }
...
kernel_3322312215_01(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
