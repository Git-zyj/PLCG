...
void kernel_4324351323_08(int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_Q; i_1++) {
            for (int i_2 = 0; i_2 < min(min(-i_0+PB_M, PB_Q), -i_1+PB_M+1); i_2++) {
                C[i_2+i_1-1][i_0+1] = D[i_2+i_0][i_1][i_2][i_1] - E[i_0][i_2][i_1] * 3;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_Q-1; i_3++) {
        for (int i_4 = 1; i_4 < PB_Q-1; i_4++) {
            B[i_4][i_3+1] = F[i_4-1][i_3+1] - G[i_3+1][i_4] * H[i_3][i_4] - I[i_4] - E[i_3][i_4][i_4+1] + B[i_4+1][i_3+1] * 2;
        }
        for (int i_5 = 0; i_5 < min(PB_Q, -i_3+PB_M); i_5++) {
            for (int i_6 = i_3; i_6 < min(min(-i_5+PB_M-2, PB_Q+1), -i_3+PB_M-1); i_6++) {
                C[i_5+i_3][i_6+1] = J[i_3][i_6+i_5][i_5] * J[i_3+1][i_3+1][i_5] - G[i_5][i_3] * E[i_6][i_5][i_3] * E[i_6][i_3][i_5] * J[i_5+i_3-1][i_6][i_6] + J[i_6][i_3+1][i_3] * E[i_5][i_3][i_6-1] + C[i_6+i_5+1][i_3+3] + C[i_6+i_5+2][i_3+2] * C[i_6+i_3+1][i_5+1] + C[i_6+i_5+1][i_3+1] - 1;
            }
        }
    }
#pragma endscop
...
init_array(xc,yc,POLYBENCH_ARRAY(C), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4324351323_08(xc,yc,POLYBENCH_ARRAY(C), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xc,yc,POLYBENCH_ARRAY(C), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J)));
