...
void kernel_4312232225_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        A[i_0+2] = D[i_0] * E[i_0] - E[i_0+2] - A[i_0+3] - A[i_0+4] - 6;
    }
    for (int i_1 = 2; i_1 < PB_L; i_1++) {
        for (int i_2 = i_1; i_2 < PB_P-3; i_2++) {
            for (int i_3 = 0; i_3 < PB_L-2; i_3++) {
                C[i_3+2][i_3+2][i_2+2] = F[i_3][i_2][i_1-2] - G[i_3+2][i_2] - 4;
            }
            for (int i_4 = 1; i_4 < PB_L-2; i_4++) {
                C[i_4+2][i_4+2][i_2+2] = H[i_1][i_4-1][i_2] * F[i_4+1][i_1][i_2] * F[i_4][i_2][i_1-1] - C[i_1][i_1][i_2+3] - 6;
            }
        }
    }
#pragma endscop
...
kernel_4312232225_06(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
