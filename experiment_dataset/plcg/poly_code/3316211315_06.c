...
void kernel_3316211315_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
kernel_3316211315_06(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
