...
#pragma scop
    ...
    for (int i_4 = 2; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 1; i_5 < i_4; i_5++) {
            B[i_4][i_5] = F[i_5][i_4] * F[i_5][i_4] - F[i_4][i_4] - G[i_5-1] + F[i_5][i_4-2] * B[i_5-1][i_4+2] + 6;
            C[i_4+1][i_5] = F[i_5][i_4-1] - F[i_5][i_4] + B[i_4+1][i_5] - 4;
        }
    }
#pragma endscop
...
kernel_4316152121_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
