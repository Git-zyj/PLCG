    ...
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 1; i_1 < min(-i_0+PB_P+1, i_0); i_1++) {
            for (int i_2 = 1; i_2 < min(min(-i_0+PB_M, -i_1+PB_M-1), PB_L-1); i_2++) {
                A[i_2+i_1][i_0][i_1] = B[i_1-1][i_0+1][i_2] * C[i_2+i_0][i_1][i_2+1] - D[i_2-1][i_1][1] - E[i_0][i_2][i_1+i_0-1][0] + C[i_2+i_1+1][i_0][i_0] * A[i_2+i_1-1][i_0-1][i_1] - A[i_2+i_1+1][i_0-1][i_1] - 1;
            }
        }
    }
#pragma endscop
...
kernel_3126351213_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
