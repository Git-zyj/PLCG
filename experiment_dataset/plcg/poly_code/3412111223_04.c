...
void kernel_3412111223_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 3; i_2 < PB_L+1; i_2++) {
                A[i_1][i_2-1] = A[i_1][i_2-3] + 5;
            }
        }
        for (int i_3 = 3; i_3 < PB_M-1; i_3++) {
            for (int i_4 = 2; i_4 < PB_M-1; i_4++) {
                B[i_4][i_3-1] = B[i_4+1][i_3-1] * B[i_4][i_3-3] * B[i_4-2][i_3+1] - 3;
            }
        }
        C[i_0][i_0] = E[i_0-1] - C[i_0-1][i_0-1] - C[i_0-2][i_0-2] * C[i_0+2][i_0+2] + 1;
    }
...
kernel_3412111223_04(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
