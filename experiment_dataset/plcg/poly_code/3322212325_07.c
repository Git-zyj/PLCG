...
void kernel_3322212325_07(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_3 = 2; i_3 < PB_M-2; i_3++) {
        C[i_3] = D[i_3] * C[i_3-1] - C[i_3-2] - C[i_3+2] - 4;
    }
#pragma endscop
...
kernel_3322212325_07(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
