...
void kernel_3232312323_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        ...
        for (int i_2 = 1; i_2 < PB_L; i_2++) {
            B[i_2+2] = C[i_2-1][i_2] - B[i_2+1] + B[i_2+4] - B[i_2+3] - 3;
        }
    }
#pragma endscop
...
kernel_3232312323_09(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
