    ...
    for (int i_3 = 0; i_3 < PB_M; i_3++) {
        for (int i_4 = 1; i_4 < i_3; i_4++) {
            for (int i_5 = 3; i_5 < PB_L+2; i_5++) {
                B[i_5-2][i_5][i_3] = B[i_5-3][i_5-1][i_3] * 4;
            }
            for (int i_6 = 0; i_6 < min(PB_N, -i_4+PB_P); i_6++) {
                C[i_3][i_6+2][i_4] = E[i_6][i_3][i_4+1][i_6+i_4] - C[i_3][i_6+4][i_4] * C[i_3][i_6+2][i_4-1] - 6;
            }
        }
    }
#pragma endscop
...
kernel_3316212221_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
