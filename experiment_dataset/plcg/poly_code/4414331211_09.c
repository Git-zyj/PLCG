        ...
        for (int i_1 = 1; i_1 < min(-i_0+PB_L, PB_P-1); i_1++) {
            for (int i_2 = 0; i_2 < min(PB_P-1, -i_0+PB_P); i_2++) {
                for (int i_3 = 1; i_3 < min(-i_2+PB_P-1, -i_0+PB_P); i_3++) {
                    A[i_3][i_2][i_1] = E[i_3+1][i_0][i_1][i_2+i_0] - E[i_2][i_1+i_0][i_3+i_0][i_2+1] * F[i_2][i_3+i_1][i_0+1] * G[i_1][i_0][i_2][1] - B[i_2][0][i_2+1] - B[i_1][0][i_1+1] - 5;
                    B[i_1][0][i_1+1] = E[i_1][i_0+1][i_3+i_2+1][i_1+1] + G[i_2][i_0+1][i_0][i_2+1] + A[i_3-1][i_1-1][i_2] - 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 2; i_5 < min(i_4, -i_4+PB_L-2); i_5++) {
            for (int i_6 = 1; i_6 < PB_P; i_6++) {
                C[i_4-1][i_5][i_6] = H[i_5+i_4-1][i_5] - I[i_5][i_4-1] * J[i_6][i_4][i_5] + K[i_6][i_5][i_4+1][i_4] * C[i_4-1][i_5-1][i_6-1] + 1;
            }
            for (int i_7 = 0; i_7 < -i_5+PB_L-1; i_7++) {
                for (int i_8 = 1; i_8 < PB_P; i_8++) {
                    D[i_4][i_7+i_5+1][i_8][i_4] = F[i_8][i_7+i_5][i_5] * C[i_5-2][i_7][i_8-1] + D[i_7][i_5+i_4+2][i_8][i_7] * D[i_4][i_7+i_5+1][i_8][i_4] * 6;
                }
            }
        }
    }
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4414331211_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K)));
