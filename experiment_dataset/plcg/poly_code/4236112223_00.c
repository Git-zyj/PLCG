...
void kernel_4236112223_00(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
    ...
    for (int i_2 = 0; i_2 < PB_L; i_2++) {
        for (int i_3 = 0; i_3 < min(i_2, PB_L-2); i_3++) {
            for (int i_4 = max(1, i_3); i_4 < PB_P; i_4++) {
                B[i_3+1][i_3][i_4] = C[i_4-1][i_3] * B[i_3+3][i_3+2][i_4] - B[i_3+2][i_3+1][i_4] * 6;
            }
        }
    }
#pragma endscop
...
kernel_4236112223_00(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
