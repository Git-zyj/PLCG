...
void kernel_4226231115_01(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
        ...
        for (int i_1 = i_0; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < PB_N; i_2++) {
                for (int i_3 = i_1; i_3 < PB_L; i_3++) {
                    B[i_1][i_0-1][i_2+1][i_3+1] = C[i_2][i_0][i_3][i_1-1] * 3;
                }
            }
        }
        for (int i_4 = 1; i_4 < i_0; i_4++) {
            for (int i_5 = 1; i_5 < PB_M-1; i_5++) {
                for (int i_6 = 1; i_6 < PB_P-1; i_6++) {
                    B[i_0][i_4][i_6][i_5+1] = C[i_4-1][i_5-1][i_6-1][i_4] - D[i_4-1][i_6][i_0][i_4+1] * C[i_6-1][i_5+1][i_6][i_0] * E[i_4][i_5-1][i_6+1] * B[i_0-1][i_4-1][i_6][i_5+1] * 1;
                }
            }
        }
    }
...
kernel_4226231115_01(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
