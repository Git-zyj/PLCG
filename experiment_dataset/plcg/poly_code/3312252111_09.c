...
void kernel_3312252111_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P-2; i_0++) {
        A[i_0+1] = D[i_0-2] - D[i_0] + E[i_0] - 5;
        for (int i_1 = 1; i_1 < PB_P; i_1++) {
            for (int i_2 = 2; i_2 < min(PB_P-2, -i_1+PB_L); i_2++) {
                B[i_0-2][i_2][i_1] = F[i_2-2][i_2][i_0+2] + F[i_0][i_1-1][i_2] - G[i_2][i_0+1][2] * G[i_0+1][i_2+i_1][i_2+2] + B[i_2-2][i_0-1][i_1] + 3;
            }
        }
        for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
            for (int i_4 = 2; i_4 < PB_M-2; i_4++) {
                B[i_0-2][i_3+1][i_4] = F[i_4][i_3][i_0+1] - F[i_0][i_4+1][i_0] + H[i_3-1][1] - F[i_0+1][i_4-2][i_3] + G[i_4+2][i_0-1][0] + F[i_4][i_3][i_4-1] * F[i_3-1][i_0+1][i_4-1] + 2;
            }
        }
    }
#pragma endscop
...
kernel_3312252111_09(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
