...
void kernel_4424251125_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk)){
        ...
        for (int i_1 = 0; i_1 < PB_N-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_N-1; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_0+PB_P, i_1); i_3++) {
                    A[i_2-1][i_1+1][i_0-1][i_3] = E[i_2+1][i_0][i_1][i_3] + F[i_2+1][i_1][i_0] - E[i_3+1][i_1][i_0+1][i_2+1] + E[i_1+1][i_0][i_3+i_0-1][i_2+1] * E[i_1+1][i_3-1][i_3+i_0][i_2] - G[i_2+1][i_0][i_3][i_1+1] - E[i_1][i_2][i_3][i_0] - A[i_3+1][i_1+1][i_0-1][i_2] - 3;
                }
            }
        }
        for (int i_4 = 0; i_4 < min(-i_0+PB_N+1, i_0); i_4++) {
            B[i_4][i_4] = H[i_4] * I[i_4][1] * J[i_4] - K[i_4+i_0-1][i_4] + K[i_0][i_4] + 6;
        }
    }
    for (int i_5 = 0; i_5 < PB_N; i_5++) {
        for (int i_6 = 0; i_6 < PB_N; i_6++) {
            B[i_6][i_6] = K[i_5][i_6] - K[i_6][0] + 4;
        }
    }
    for (int i_7 = 1; i_7 < PB_P; i_7++) {
        B[i_7][i_7] = J[i_7-1] * J[i_7] * J[i_7] * H[i_7] * H[i_7-1] * 6;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4424251125_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K)));
