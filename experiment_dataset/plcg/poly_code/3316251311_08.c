    ...
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        ...
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            for (int i_2 = i_0; i_2 < PB_M-1; i_2++) {
                B[i_1][i_2][i_0] = F[i_2][i_1+1][1] + G[i_1][i_0][i_2] * G[i_1+1][i_0][i_2] + F[i_1][i_0-1][i_1+1] - B[i_2+1][i_0][i_1] + B[i_2+1][i_1+1][i_0-1] - B[i_1+1][i_2][i_0] * B[i_2][i_1-1][i_0+1] * B[i_1][i_2-1][i_0] - B[i_1][i_2][i_0+1] - 4;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_M; i_3++) {
        for (int i_4 = 0; i_4 < PB_M; i_4++) {
            for (int i_5 = 0; i_5 < PB_M; i_5++) {
                B[i_4][i_5][i_3+1] = F[i_5][i_3-1][i_4] * F[i_5][i_3][i_4] + H[i_4][i_3] - G[i_5][i_3-1][i_4] * G[i_5][i_4][i_3] - 1;
            }
        }
    }
#pragma endscop
...
kernel_3316251311_08(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
