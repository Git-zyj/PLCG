...
void kernel_2212312311_02(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            B[i_0+1] = B[i_1] + B[i_1-1] * B[i_1+1] + 6;
            B[i_1] = C[i_1][i_0] - 2;
        }
    }
#pragma endscop
...
kernel_2212312311_02(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
