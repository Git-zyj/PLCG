...
void kernel_2222312315_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 2; i_1 < PB_L+1; i_1++) {
            A[i_0][i_1-2] = A[i_0+1][i_1-2] - A[i_0-1][i_1-2] * A[i_0][i_1-1] * 6;
        }
        for (int i_2 = 2; i_2 < min(PB_L+2, -i_0+PB_M+1); i_2++) {
            A[i_0][i_2-2] = C[i_2+i_0-1] * 1;
        }
    }
#pragma endscop
...
kernel_2222312315_04(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
