...
void kernel_3224111321_07(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        ...
        for (int i_3 = max(1, i_0); i_3 < PB_N-2; i_3++) {
            B[i_3] = B[i_3+2] * B[i_3-1] + B[i_3+1] - 5;
        }
    }
#pragma endscop
...
kernel_3224111321_07(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
