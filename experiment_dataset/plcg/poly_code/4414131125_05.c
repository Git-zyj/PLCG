...
void kernel_4414131125_05(int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
        ...
        for (int i_1 = 3; i_1 < -i_0+PB_L-1; i_1++) {
            for (int i_2 = 2; i_2 < PB_M; i_2++) {
                for (int i_3 = 0; i_3 < -i_1+PB_Q; i_3++) {
                    D[i_2-1][i_1] = E[i_3][i_2][i_1+i_0][i_3+i_1] + E[i_1-1][i_2][1][i_3] + 5;
                }
                D[i_1][i_2-2] = F[i_0][i_2+1][i_1+1] + G[i_2][i_1+1] - F[i_2][i_0-1][i_1+1] * D[i_1-3][i_2] + 4;
            }
            for (int i_4 = 3; i_4 < i_1; i_4++) {
                for (int i_5 = 0; i_5 < PB_P; i_5++) {
                    D[i_4-3][i_1] = E[i_1-1][i_5][i_0][i_4] - 1;
                }
            }
            D[i_0-1][i_1] = H[i_1+i_0+1] + G[i_1][i_0+1] + G[0][i_1] + G[i_1-1][i_1-1] + G[i_0+1][i_1] - 2;
        }
    }
#pragma endscop
...
kernel_4414131125_05(xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
