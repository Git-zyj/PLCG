    ...
    for (int i_3 = 1; i_3 < PB_M; i_3++) {
        for (int i_4 = 1; i_4 < min(-i_3+PB_M, i_3); i_4++) {
            for (int i_5 = 0; i_5 < PB_N-1; i_5++) {
                B[i_3][i_3][i_4-1] = E[i_5+1][i_4+i_3][i_4+i_3] * B[i_3-1][i_3-1][i_4+1] - 4;
            }
        }
    }
    for (int i_6 = 1; i_6 < PB_P-2; i_6++) {
        for (int i_7 = 0; i_7 < PB_M-2; i_7++) {
            for (int i_8 = 2; i_8 < i_6; i_8++) {
                C[i_8][i_7][i_6] = C[i_8][i_7][i_6-1] + C[i_8-2][i_7+2][i_6] - C[i_8+2][i_7][i_6+2] * 2;
            }
        }
    }
#pragma endscop
...
kernel_4324211221_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
