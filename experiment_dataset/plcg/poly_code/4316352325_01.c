...
void kernel_4316352325_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P-1; i_0++) {
        for (int i_1 = 2; i_1 < min(i_0, PB_M-2); i_1++) {
            for (int i_2 = i_0; i_2 < min(-i_1+PB_N+2, -i_0+PB_P); i_2++) {
                for (int i_3 = 0; i_3 < -i_1+PB_M; i_3++) {
                    A[i_0-2][i_2][i_3][i_2] = D[i_3+i_1][i_0-1][i_3][i_0] - E[i_1+1][i_3][i_0][i_2-1] * F[i_0][i_2][i_3][i_1] + F[i_1+2][i_3+2][i_2+i_0][i_3+1] - E[i_2+i_1-2][i_1][i_0-2][i_3] + A[i_0-2][i_2+2][i_3][i_2+2] * A[i_0-2][i_2][i_3+1][i_2] - A[i_0-2][i_2-2][i_1-2][i_2-2] + A[i_3][i_1][i_0+1][i_1] + 4;
                }
            }
        }
        for (int i_4 = 2; i_4 < PB_M; i_4++) {
            for (int i_5 = 2; i_5 < -i_0+PB_M; i_5++) {
                for (int i_6 = 2; i_6 < PB_M-2; i_6++) {
                    B[i_0][i_4][i_5+1][i_6] = G[i_4][i_5+1][i_4] * D[i_5-2][i_6][i_0][i_4-2] * H[i_5+i_0][i_6][i_0][i_4][i_6-2] + I[i_5-1][i_6][i_4] * I[i_5][i_6][i_4] - B[i_6+2][i_4][i_5+1][i_0] + B[i_0][i_4-2][i_6+1][i_5+2] - 5;
                }
            }
        }
    }
        ...
        for (int i_8 = 1; i_8 < min(-i_7+PB_M, i_7); i_8++) {
            for (int i_9 = 1; i_9 < PB_M; i_9++) {
                for (int j_0 = 0; j_0 < i_9; j_0++) {
                    B[i_8][i_9][i_7+1][j_0] = F[j_0][i_9-1][i_7-1][i_9] - I[i_8-1][i_9][j_0] + E[i_9][i_8+i_7][j_0][i_7] * G[i_9][j_0][0] + 5;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4316352325_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
