...
void kernel_4222152123_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-2; i_0++) {
        A[0] = C[i_0+2] + C[i_0] * C[i_0] - C[i_0] + C[i_0] + A[0] - A[0] - 5;
    }
    for (int i_1 = 0; i_1 < PB_L-2; i_1++) {
        B[i_1] = C[i_1] + C[i_1] - C[i_1+2] * C[i_1+2] - 1;
    }
#pragma endscop
...
kernel_4222152123_09(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
