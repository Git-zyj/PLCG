...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_M; i_1++) {
        B[i_1] = E[i_1] * F[i_1] * B[i_1+1] - B[i_1-1] + B[i_1+1] * 1;
    }
    for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
        for (int i_3 = 2; i_3 < PB_M+1; i_3++) {
            C[i_3-1] = G[i_3-2][i_2] * H[i_3][i_2+1] * B[i_3-1] * C[i_3-2] + 1;
        }
    }
    for (int i_4 = 2; i_4 < PB_M; i_4++) {
        for (int i_5 = 1; i_5 < PB_M+1; i_5++) {
            D[i_4-1][i_5] = C[i_5-1] + D[i_4][i_5] + D[i_4-2][i_5+1] + 3;
        }
    }
#pragma endscop
...
kernel_2434212311_08(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
