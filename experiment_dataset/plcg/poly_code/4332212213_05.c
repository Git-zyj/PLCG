...
void kernel_4332212213_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
        ...
        for (int i_2 = 0; i_2 < PB_Q-1; i_2++) {
            for (int i_3 = 0; i_3 < PB_Q; i_3++) {
                for (int i_4 = 0; i_4 < -i_2+PB_Q-1; i_4++) {
                    C[i_2][i_2][i_3][i_4+i_2+1] = C[i_2+1][i_2+1][i_3][i_4+i_2+1] + 4;
                }
            }
        }
    }
...
kernel_4332212213_05(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
