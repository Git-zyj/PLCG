...
void kernel_2426152221_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        A[i_0] = E[i_0+2] - E[i_0] + E[i_0-2] * E[i_0] * E[i_0] + E[i_0] - A[i_0+2] - A[i_0-1] - 6;
        A[i_0] = E[i_0] + E[i_0-1] * E[i_0] + E[i_0] * E[i_0] + E[i_0-1] + E[i_0] + E[i_0] + 5;
    }
    for (int i_1 = 0; i_1 < PB_L-1; i_1++) {
        for (int i_2 = 2; i_2 < -i_1+PB_L; i_2++) {
            C[i_2][i_1][i_2] = F[i_2][i_1][i_2] + G[i_2+i_1][i_2+i_1] * G[i_2][i_1] * G[i_2-2][i_1+1] * C[i_1+1][i_2][i_1+1] - D[i_2] + 3;
        }
        D[i_1] = E[1] - E[i_1+2] * 2;
    }
#pragma endscop
...
kernel_2426152221_04(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
