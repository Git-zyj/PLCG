...
void kernel_4422352115_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        A[i_0-2] = E[i_0-2] - E[i_0] * A[i_0-1] - 3;
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            B[i_0-2][i_1] = F[i_1] - G[i_1][i_0+2] - G[i_1][i_0] + 3;
        }
        for (int i_2 = 2; i_2 < PB_M; i_2++) {
            for (int i_3 = 0; i_3 < min(-i_2+PB_M+1, -i_0+PB_L); i_3++) {
                for (int i_4 = 1; i_4 < PB_M-2; i_4++) {
                    D[i_3+i_2-1][i_0][i_4-1][2] = H[i_4+2][i_0][i_2][i_4] - H[i_2][i_3+i_0][i_4][i_0] * H[i_3][i_2-2][i_4][i_0] * I[i_2][i_0][i_0-2][i_3+1] * 2;
                }
            }
        }
    }
    for (int i_5 = 2; i_5 < PB_Q-2; i_5++) {
        for (int i_6 = 1; i_6 < PB_L; i_6++) {
            for (int i_7 = i_5; i_7 < PB_L-2; i_7++) {
                for (int i_8 = 1; i_8 < min(-i_6+PB_M, -i_5+PB_Q+2); i_8++) {
                    D[i_8+i_6-1][i_5][i_7][2] = I[i_8][i_6][i_7][i_5] * J[i_6][i_7][i_8+i_5-2][i_5+2] * I[i_5-1][i_8-1][i_7-1][i_6] + K[i_8][i_6-1][i_7] - J[i_8][i_7-1][i_5+1][i_5] - L[i_8][i_6][i_7+1] + J[i_6][i_7+2][i_8][i_5] * H[i_7][i_8][i_8+2][i_5+1] * H[i_8+i_6][i_8][i_7-1][i_5+2] - D[i_8+i_6-1][i_5-1][i_7][2] * D[i_8+i_6][i_5+1][i_7][2] + 5;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4422352115_01(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L)));
