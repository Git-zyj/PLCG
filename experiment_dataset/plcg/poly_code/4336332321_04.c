...
void kernel_4336332321_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
        ...
        for (int i_1 = 2; i_1 < -i_0+PB_L-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_M-2; i_2++) {
                for (int i_3 = 0; i_3 < -i_1+PB_L-1; i_3++) {
                    A[i_3][i_0][i_2+i_1][1] = D[i_2][i_0-2][i_3+1][i_0] - D[i_1-2][i_3][i_0][i_1-2] + E[i_2][i_3+i_1][0] - A[i_3][i_2+2][i_1+i_0+1][1] + A[i_0+1][i_3+1][i_2+i_1][1] * A[i_3][i_2][i_1+i_0-1][1] - A[i_0][i_2-1][i_3+i_1+1][1] - 2;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-2; i_4++) {
        B[i_4] = F[i_4] * G[i_4] - F[i_4+1] * F[0] + B[i_4+1] + B[i_4-2] + B[i_4-1] - B[i_4+2] + 1;
    }
    for (int i_5 = 1; i_5 < PB_L; i_5++) {
        for (int i_6 = 0; i_6 < PB_M; i_6++) {
            for (int i_7 = 2; i_7 < min(i_6, -i_5+PB_L); i_7++) {
                for (int i_8 = 3; i_8 < -i_7+PB_L; i_8++) {
                    C[i_6][i_7+i_5][i_8+1][i_7-2] = H[i_5][i_8][i_6][i_6] - H[i_6][i_8+i_7][i_5-1][i_7-1] - C[i_6][i_8+i_7-1][i_5-1][i_8-3] + 6;
                }
            }
        }
    }
...
kernel_4336332321_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
