...
void kernel_4226232115_05(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
        ...
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_1+PB_L, i_1); i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_Q; i_3++) {
                    B[i_2][i_1][i_3+i_0][i_0+2] = C[i_3+1][i_0][i_2][i_0] - D[i_2][i_1][i_0-2][1] - E[i_2+i_1][i_3][i_2] + B[i_1][i_0][i_3+i_2][i_3+2] - 2;
                }
            }
        }
    }
        ...
        for (int i_5 = max(i_4, 2); i_5 < PB_L; i_5++) {
            for (int i_6 = 2; i_6 < -i_5+PB_Q; i_6++) {
                for (int i_7 = 0; i_7 < PB_L; i_7++) {
                    B[i_4][i_7][i_6+i_5][i_6+2] = C[i_4-1][i_4][i_5-2][i_6-2] * C[i_6][i_5][i_7][i_5] - 3;
                }
            }
        }
    }
...
kernel_4226232115_05(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
