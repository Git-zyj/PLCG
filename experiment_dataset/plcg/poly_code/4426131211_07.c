...
void kernel_4426131211_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg)){
        ...
        for (int i_4 = 1; i_4 < PB_M; i_4++) {
            for (int i_5 = 1; i_5 < min(-i_4+PB_M, -i_3+PB_Q+1); i_5++) {
                for (int i_6 = 1; i_6 < PB_Q-1; i_6++) {
                    C[i_6][i_5+i_4][i_5+i_4] = G[i_6][i_5][i_4-1][i_3-1] - G[i_5-1][i_6][i_4][i_3] + G[i_5][i_4][i_6+1][i_3] + G[i_6][i_5+i_4-1][i_5+i_3-1][1] + G[i_4][i_3][i_3][i_6+i_5] * C[i_6-1][i_5+i_4][i_5+i_4] - 1;
                }
            }
        }
        D[i_3-1] = E[i_3] * D[i_3-2] + D[i_3] * D[i_3] - 1;
    }
#pragma endscop
...
kernel_4426131211_07(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G));
