...
void kernel_4322351111_00(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg)){
        ...
        for (int i_1 = 0; i_1 < PB_M; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_0+PB_Q, PB_M-1); i_2++) {
                for (int i_3 = 0; i_3 < PB_M; i_3++) {
                    B[i_3][i_1][i_2][i_1] = D[i_3][i_2+i_0-1][i_3][i_1] * E[i_1][i_3][i_2+i_0][i_1+1] - E[i_2+1][i_3][i_1][i_2] + 3;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < PB_M; i_5++) {
            for (int i_6 = 1; i_6 < PB_M; i_6++) {
                for (int i_7 = 0; i_7 < min(PB_M, -i_4+PB_L); i_7++) {
                    B[i_5][i_4][i_6+1][i_4] = E[i_5][i_6][i_6][i_4] * F[i_6][i_4][i_5] + D[i_7][i_6-1][i_4][i_5] * E[i_5-1][i_4][i_7][1] * E[i_6][i_7+i_4][i_5][1] * G[i_5][i_6-1][i_4-1][0] * 2;
                }
            }
        }
    }
        ...
        for (int i_9 = 0; i_9 < PB_M; i_9++) {
            for (int j_0 = 0; j_0 < PB_N-1; j_0++) {
                for (int j_1 = 0; j_1 < -i_8+PB_Q-1; j_1++) {
                    C[i_8][i_9][j_0+1][j_1] = G[j_1][j_0][i_8+1][i_8] * G[j_0][j_1][i_8+1][i_9+1] + G[i_9][i_8][j_1+1][j_0+1] * E[i_9][j_0+1][j_1+i_8+1][i_8] + B[i_9][j_0][i_8+1][j_0] + C[j_0+1][i_9][i_8+2][j_1] * 1;
                }
            }
        }
    }
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4322351111_00(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G)));
