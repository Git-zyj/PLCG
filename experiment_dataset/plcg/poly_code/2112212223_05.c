...
void kernel_2112212223_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M+2; i_0++) {
        for (int i_1 = 0; i_1 < min(PB_M-3, i_0); i_1++) {
            A[i_1+1] = B[i_0-2] - A[i_1+3] * A[i_1+2] + 5;
        }
    }
#pragma endscop
...
kernel_2112212223_05(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
