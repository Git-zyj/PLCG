...
void kernel_4332251313_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
        ...
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_M-1; i_2++) {
                for (int i_3 = 1; i_3 < -i_2+PB_M; i_3++) {
                    A[i_3+i_2][i_1][i_3][i_0] = D[i_0][i_2-1][i_3][i_1-1] - D[i_1+1][i_0][i_3+i_2][i_1] * E[i_1][i_3][i_2][i_0] - F[i_3][i_1-1][i_2] + D[i_3][i_0][i_3+1][0] * E[i_3-1][i_2-1][i_1][i_2] * A[i_3+i_2-1][i_1][i_3-1][i_0+1] + A[i_2+i_1+1][i_3-1][i_1][i_0] * 3;
                }
            }
        }
        for (int i_4 = 2; i_4 < i_0; i_4++) {
            B[i_4][i_0-1][i_4+1] = G[i_4-1][i_4] - H[i_4+1][0] - G[i_0][i_4+1] - I[i_4+1] + H[i_0][i_4] * B[i_4-1][i_0-1][i_4] + B[i_0][i_4-2][i_0+1] * B[i_4+1][i_0-1][i_4+2] + B[i_4][i_0][i_4+1] + B[i_0][i_4][i_0+1] * 1;
            C[i_0][i_4] = G[i_0-1][i_4-1] * G[i_4][i_0-1] + G[i_0+1][i_4] * C[i_0-1][i_4] - C[i_4-1][i_0] * 5;
        }
    }
#pragma endscop
...
kernel_4332251313_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
