...
void kernel_4414352213_09(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_L; i_1++) {
            for (int i_2 = i_0; i_2 < -i_0+PB_P-1; i_2++) {
                for (int i_3 = 3; i_3 < PB_L-2; i_3++) {
                    A[i_2+i_1-1][i_3][i_3-2] = E[i_3+1][i_0][i_0+1][i_3-2] + F[i_3][i_1][i_2+i_0+1][i_0][i_2] * G[i_1][i_3+2][i_0][i_2-1] - H[i_3+1][i_1][i_2-2][i_0] + H[i_2-2][i_3-1][i_1+i_0][i_2+i_0] - G[i_2+i_0][i_3][i_1][i_2] * G[i_2+1][i_3][i_1][i_0] * A[i_2+i_1][i_3][i_3-2] + A[i_2+i_1][i_3-1][i_3-3] - 5;
                }
            }
        }
        B[i_0-1] = I[i_0] + J[i_0] * I[i_0] * J[i_0] * B[i_0-2] + B[i_0] * 2;
    }
    for (int i_4 = 2; i_4 < PB_L; i_4++) {
        for (int i_5 = 1; i_5 < min(PB_L-2, -i_4+PB_Q); i_5++) {
            B[i_5] = I[i_5] - K[i_4-2][i_4] - L[i_4-2][i_5] + 5;
            for (int i_6 = 1; i_6 < min(PB_M-2, -i_4+PB_L+2); i_6++) {
                for (int i_7 = 1; i_7 < -i_6+PB_L; i_7++) {
                    D[i_7][i_5][i_4][i_6+1] = H[i_4-2][i_5][i_7+i_6][i_6] * H[i_6-1][i_5-1][i_4][i_7] + F[i_6][i_7+1][i_4-1][i_7][i_5+i_4] * G[i_5][i_4][i_7-1][i_6+i_4-1] + E[i_7][i_6][i_6+i_4-2][i_7] + H[i_4][i_6+2][i_5+2][i_6+i_4-2] - 2;
                }
            }
        }
    }
