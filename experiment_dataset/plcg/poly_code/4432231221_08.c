    ...
    for (int i_1 = 1; i_1 < PB_L; i_1++) {
        for (int i_2 = 1; i_2 < -i_1+PB_M; i_2++) {
            for (int i_3 = 1; i_3 < -i_1+PB_M; i_3++) {
                B[i_2][i_1-1][i_3-1] = F[i_3+i_1][i_2-1] - G[i_2-1][i_1][0] * G[i_2+1][i_1-1][i_3] - G[i_3][i_2+i_1][i_2-1] * B[i_3][i_1-1][i_2+1] - 5;
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-1; i_4++) {
        C[i_4] = E[i_4] - E[i_4-1] + C[i_4+1] - 1;
        for (int i_5 = 0; i_5 < PB_Q; i_5++) {
            for (int i_6 = 2; i_6 < min(PB_Q-3, i_5); i_6++) {
                for (int i_7 = 1; i_7 < PB_Q-1; i_7++) {
                    D[i_7-1][i_5][i_4-1][i_6+1] = H[i_6+1][i_5][i_4][i_7] - I[i_5][i_6][i_7] - J[i_6][i_4-1][i_5][i_5] * D[i_6][i_5][i_7-1][i_4-1] - D[i_4-2][i_5][i_6-2][i_7+1] * D[i_5][i_6-2][i_4-1][i_7+1] * D[i_7-1][i_5][i_4-1][i_6+3] - 6;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4432231221_08(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J)));
