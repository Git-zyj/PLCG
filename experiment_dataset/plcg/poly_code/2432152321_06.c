...
void kernel_2432152321_06(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 0; i_1 < PB_L-2; i_1++) {
            A[i_0+2][i_1] = E[i_0-2] - F[i_0+2][i_1][0] * G[i_0][i_1+2] * A[i_0+2][i_1+2] - A[i_1+4][i_0+2] * A[i_0+1][i_1] + 4;
        }
    }
    for (int i_2 = 2; i_2 < PB_L; i_2++) {
        for (int i_3 = 0; i_3 < min(PB_Q, -i_2+PB_M-1); i_3++) {
            B[i_3+i_2][i_2] = G[i_2][i_3] - F[i_2][i_3+i_2][i_3] - G[i_2+2][i_3] - B[i_3+i_2-2][i_2-2] - B[i_3+i_2-1][i_2] * B[i_3+i_2+1][i_2] + 3;
        }
    }
    for (int i_4 = 2; i_4 < PB_L; i_4++) {
        for (int i_5 = 2; i_5 < min(i_4, -i_4+PB_M); i_5++) {
            C[i_4][i_4] = G[i_5][i_4] - E[0] * E[1] + G[i_5+i_4][i_5] - G[i_5][i_4] - G[i_5-2][i_4-1] - G[i_5][i_5-2] - E[i_4] + E[i_5+i_4] - C[i_4-2][i_4-2] - 2;
        }
        for (int i_6 = 2; i_6 < min(PB_Q, -i_4+PB_M+1); i_6++) {
            D[i_6][i_4] = F[i_6+i_4-1][i_6+i_4-2][1] * G[i_6][i_4-1] - G[i_6-2][i_4] * C[i_4-2][i_4-2] - D[i_6+2][i_4-2] - 6;
        }
    }
#pragma endscop
...
kernel_2432152321_06(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
