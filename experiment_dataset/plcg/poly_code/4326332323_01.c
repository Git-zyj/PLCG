...
void kernel_4326332323_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_P-1; i_1++) {
        for (int i_2 = 2; i_2 < i_1; i_2++) {
            B[i_2] = F[i_2][i_1] * G[i_2][i_1-1] - A[i_2] * B[i_2-2] + B[i_2-1] + 1;
            for (int i_3 = 2; i_3 < PB_P-1; i_3++) {
                for (int i_4 = 3; i_4 < -i_3+PB_P-1; i_4++) {
                    C[i_2-2][i_3][i_4+1] = H[i_3][i_1][i_2][i_3] + H[i_3-2][i_4][i_1][0] * I[i_1][i_4][i_4+i_3+1] - H[i_2][i_3][i_4][i_1+1] * C[i_2][i_1][i_4+2] - C[i_3-2][i_4-1][i_1+1] * C[i_3-2][i_4+1][i_2+1] + C[i_4-3][i_3][i_2+1] + 3;
                }
            }
        }
    }
...
kernel_4326332323_01(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
