...
void kernel_2234112223_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        ...
        for (int i_2 = 1; i_2 < min(-i_0+PB_M, PB_L-2); i_2++) {
            A[i_2][i_0-1] = C[i_2+i_0][i_2-1] - A[i_0][i_2+2] + 6;
        }
    }
#pragma endscop
...
kernel_2234112223_00(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C));
