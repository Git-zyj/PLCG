        ...
        for (int i_4 = 0; i_4 < PB_P-2; i_4++) {
            for (int i_5 = 0; i_5 < min(i_4, -i_4+PB_N); i_5++) {
                for (int i_6 = 0; i_6 < -i_4+PB_P-2; i_6++) {
                    B[i_4][i_6][i_6] = D[i_6+2][i_3][i_6+i_4+2][i_5] + E[i_5][i_4][i_3][i_6] * C[i_5+i_4][i_6][i_3] * 5;
                }
            }
        }
    }
...
kernel_4214232223_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
