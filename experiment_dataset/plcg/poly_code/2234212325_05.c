...
void kernel_2234212325_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_L; i_1++) {
        for (int i_2 = 4; i_2 < PB_M; i_2++) {
            B[i_2-2] = C[i_2][i_1] * B[i_2-3] - B[i_2-4] - B[i_2-1] + 2;
        }
    }
#pragma endscop
...
kernel_2234212325_05(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
