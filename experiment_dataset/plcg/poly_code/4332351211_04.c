...
void kernel_4332351211_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
        ...
        for (int i_1 = 0; i_1 < -i_0+PB_Q-1; i_1++) {
            for (int i_2 = 2; i_2 < -i_0+PB_L; i_2++) {
                for (int i_3 = 1; i_3 < PB_L-1; i_3++) {
                    A[i_2-1][i_0][i_1][i_0] = D[i_2+i_0][i_3][i_0][i_1] - D[i_3][i_2][i_1+i_0+1][i_1] * D[i_3+1][i_2][i_1+i_0][1] + A[i_3-1][i_0][i_1+1][i_0] * A[i_2-2][i_0][i_1][i_0] + 3;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < -i_4+PB_M-1; i_5++) {
            for (int i_6 = 1; i_6 < -i_5+PB_M-1; i_6++) {
                for (int i_7 = 1; i_7 < -i_6+PB_L+1; i_7++) {
                    B[i_7][i_5+i_4+1][i_4-1][i_6-1] = D[i_7+i_6-1][i_4+1][i_4-1][i_5+1] * E[i_6][i_7-1][i_5-1] * F[i_7][i_6][i_6][0] + B[i_7][i_6+i_5+1][i_6][i_4-1] * B[i_7-1][i_6+i_5+1][i_5-1][i_4-2] - 5;
                }
            }
        }
    }
    for (int i_8 = 1; i_8 < PB_L; i_8++) {
        for (int i_9 = 1; i_9 < PB_L-1; i_9++) {
            for (int j_0 = 1; j_0 < PB_L; j_0++) {
                for (int j_1 = 0; j_1 < -j_0+PB_P; j_1++) {
                    A[j_0-1][i_8][j_1][i_8] = D[i_9][j_0-1][i_8][i_8] * F[j_0+1][i_8+1][i_9+1][j_0] * F[j_0+1][i_9][i_8][j_1+j_0] - G[i_8-1][j_1][i_9-1][i_9-1] - D[j_1][j_0-1][i_8-1][i_9-1] + G[i_9+1][j_0][i_9][i_8] + H[j_0][i_8][i_8-1] - 2;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4332351211_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H)));
