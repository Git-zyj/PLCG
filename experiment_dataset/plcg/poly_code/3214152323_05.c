...
void kernel_3214152323_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-2; i_0++) {
        for (int i_1 = 2; i_1 < -i_0+PB_N-2; i_1++) {
            B[i_1-2] = C[i_0][i_1] + C[i_1][i_0] + C[i_1][i_0] - C[i_1][i_0] * C[i_1+2][0] * C[i_0-1][i_0] * C[i_1+i_0+2][1] * B[i_1+1] - B[i_1] - B[i_1+2] * 2;
            B[i_1] = C[i_1][i_0] - C[i_1][i_0] * C[i_1][i_1+1] * 1;
        }
    }
#pragma endscop
...
kernel_3214152323_05(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
