...
void kernel_4424211311_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
        ...
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            for (int i_2 = 2; i_2 < PB_L; i_2++) {
                for (int i_3 = 2; i_3 < PB_M; i_3++) {
                    A[i_3][i_0-1][i_3-1] = E[i_1][i_2][i_3][1] + A[i_1][i_2-2][i_1-1] - A[i_3][i_1-2][i_3-1] + A[i_3-1][i_1-1][i_3-2] + A[i_2][i_1][i_2-1] + 4;
                }
            }
            for (int i_4 = 0; i_4 < i_1; i_4++) {
                for (int i_5 = 1; i_5 < min(-i_1+PB_L+1, -i_4+PB_L); i_5++) {
                    B[i_5][i_4][i_5+i_4] = F[i_4][i_0][i_5][i_1] * A[i_1][i_5-1][i_1-1] - B[i_5][i_1-1][i_5+i_1-1] * 1;
                }
            }
        }
    }
    for (int i_6 = 2; i_6 < PB_L-1; i_6++) {
        for (int i_7 = 0; i_7 < i_6; i_7++) {
            for (int i_8 = 0; i_8 < min(-i_7+PB_P, PB_P-1); i_8++) {
                C[i_7][i_8+1][i_6] = G[i_7][i_6+1][i_8+i_7] * 3;
            }
        }
        for (int i_9 = 0; i_9 < PB_L-1; i_9++) {
            for (int j_0 = 0; j_0 < min(i_9, -i_9+PB_L-1); j_0++) {
                D[i_6][i_6-1][j_0] = B[i_9][j_0+1][j_0+i_9+1] + D[i_6][i_6-1][j_0+1] - D[i_6-1][i_6-2][j_0] - D[i_6-1][i_6-2][j_0+1] - 3;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4424211311_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G)));
