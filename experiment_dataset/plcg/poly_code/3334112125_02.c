...
void kernel_3334112125_02(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M+1; i_0++) {
        C[i_0-1] = 6;
        C[i_0-2] = D[i_0] + D[i_0+2] * 4;
    }
    for (int i_1 = 0; i_1 < PB_M; i_1++) {
        for (int i_2 = 3; i_2 < i_1; i_2++) {
            C[i_2-1] = D[i_2] * C[i_2-3] * 2;
        }
    }
#pragma endscop
...
kernel_3334112125_02(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
