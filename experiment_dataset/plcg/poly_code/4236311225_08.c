...
void kernel_4236311225_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        A[i_0] = C[i_0] * 5;
        for (int i_1 = max(2, i_0); i_1 < PB_M+1; i_1++) {
            A[i_1-2] = C[i_1-1] * A[i_0+1] - A[i_1] - 3;
        }
    }
#pragma endscop
...
kernel_4236311225_08(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
