        ...
        for (int i_1 = 1; i_1 < PB_P-1; i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_P; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_L-1; i_3++) {
                    A[i_3+1][i_2][i_0][i_1+1] = D[i_1-1][i_3][i_3+i_0+1][i_2+i_1] + 3;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-1; i_4++) {
        for (int i_5 = 1; i_5 < PB_L; i_5++) {
            for (int i_6 = 0; i_6 < min(-i_5+PB_P, PB_M-1); i_6++) {
                C[i_4+1][i_5][i_6] = E[i_4][i_5-1][i_6+i_5] * F[i_6+1][1] * E[i_6+1][i_4+1][i_5] + 1;
            }
        }
        for (int i_7 = 1; i_7 < PB_M-3; i_7++) {
            for (int i_8 = 1; i_8 < min(PB_M, -i_7+PB_L+1); i_8++) {
                C[i_7+1][i_4][i_8] = F[i_8+i_7-1][i_7] * D[i_8-1][i_4][0][i_7] * F[i_8-1][i_7] + E[i_8][i_7-1][i_4] * C[i_7+3][i_4-2][i_8] * C[i_7-1][i_4][i_8-1] - C[i_7+1][i_8-1][i_4] + 6;
            }
        }
    }
#pragma endscop
...
kernel_4332131221_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
