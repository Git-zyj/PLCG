...
void kernel_4424131115_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_P; i_0++) {
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            A[i_0][i_1+1] = E[i_0] * F[i_1][0] * 1;
            for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
                A[i_1][i_2+1] = F[i_1-1][i_2] + G[i_2-1][i_0][i_1] * G[i_1][i_0][1] - G[i_2-1][i_0][i_1] - 4;
            }
        }
    }
        ...
        for (int i_4 = 1; i_4 < -i_3+PB_P; i_4++) {
            for (int i_5 = 1; i_5 < min(-i_3+PB_P-1, i_3); i_5++) {
                for (int i_6 = 1; i_6 < PB_P-1; i_6++) {
                    C[i_5-1][i_4][i_5][i_4+i_3] = H[i_4-1][i_3+1][i_4][i_3] * H[i_4][i_3+1][i_6][i_5] + H[i_4][i_6+i_5][i_3-1][i_6+i_5] - C[i_6-1][i_5][i_6][i_5+i_3+1] + C[i_6][i_5][i_6+1][i_5+i_3+1] - 1;
                }
            }
        }
        D[i_3] = 1;
...
init_array(xa,ya,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4424131115_00(xa,ya,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H)));
