...
void kernel_2212312215_03(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < PB_P; i_1++) {
            B[i_0-1][i_1] = C[i_0][i_1+1] * 1;
        }
        for (int i_2 = 1; i_2 < i_0; i_2++) {
            B[i_0-1][i_2] = B[i_0-2][i_2] + B[i_0][i_2-1] * 4;
        }
    }
#pragma endscop
...
kernel_2212312215_03(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
