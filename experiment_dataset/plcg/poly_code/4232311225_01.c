...
void kernel_4232311225_01(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd)){
        ...
        for (int i_1 = 0; i_1 < min(PB_M, i_0); i_1++) {
            for (int i_2 = 0; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 0; i_3 < PB_M; i_3++) {
                    B[i_3][i_2+1][i_0-1][i_0-2] = C[i_1][i_3][i_2+1] + 2;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < PB_M; i_5++) {
            for (int i_6 = 2; i_6 < i_4; i_6++) {
                for (int i_7 = 0; i_7 < PB_Q; i_7++) {
                    B[i_5][i_6][i_4][i_4-1] = D[i_4][i_6][i_5-1][0] - B[i_5][i_6-2][i_4][i_4-1] * B[i_5-1][i_6][i_4][i_4-1] + 4;
                }
            }
        }
    }
...
kernel_4232311225_01(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D));
