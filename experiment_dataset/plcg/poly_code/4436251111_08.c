...
#pragma scop
    ...
    for (int i_4 = 1; i_4 < PB_L; i_4++) {
        for (int i_5 = i_4; i_5 < PB_M-1; i_5++) {
            C[i_5][i_4-1] = K[i_5+1][i_4] - L[i_5][i_4] - 1;
        }
    }
    for (int i_6 = 1; i_6 < PB_N+1; i_6++) {
        for (int i_7 = 0; i_7 < -i_6+PB_P; i_7++) {
            for (int i_8 = 0; i_8 < -i_6+PB_L+1; i_8++) {
                D[i_6-1][i_8][i_7] = J[i_7][i_8+i_6-1][i_7] * J[i_6-1][i_8][i_7] * J[i_7][i_8][i_6] + M[i_8][i_6][i_7] + M[i_7+1][i_7+i_6][1] - 1;
            }
        }
    }
#pragma endscop
