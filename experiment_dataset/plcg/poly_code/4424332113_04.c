...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < min(PB_Q-2, i_1); i_2++) {
                for (int i_3 = 0; i_3 < PB_L; i_3++) {
                    B[i_3][i_2+1][i_0+1] = E[i_0][0][i_3][i_2+2] * 2;
                }
            }
            for (int i_4 = 0; i_4 < PB_L-2; i_4++) {
                for (int i_5 = 0; i_5 < PB_L-3; i_5++) {
                    B[i_1][i_4+2][i_5+1] = B[i_1-1][i_5+3][i_4+1] - 1;
                }
            }
        }
    }
    for (int i_6 = 2; i_6 < PB_L; i_6++) {
        for (int i_7 = 2; i_7 < -i_6+PB_L; i_7++) {
            C[i_6][i_7] = F[i_7-2][i_6] + G[i_6-1][i_6-1] - 5;
            for (int i_8 = 0; i_8 < -i_6+PB_L; i_8++) {
                for (int i_9 = 1; i_9 < PB_L-1; i_9++) {
                    D[i_6][i_6-2][i_7+1][i_9] = H[i_9+1][i_9][i_8+i_6][i_7-2] * I[i_9][i_8][i_7+i_6] * H[i_7][i_9][i_9][i_8] * E[i_8+i_6][i_9-1][i_7][i_8] * H[i_8][i_9][i_7+i_6][i_9+i_7-2] * I[i_9][i_8+2][i_7+i_6] - 1;
                }
            }
        }
    }
...
init_array(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4424332113_04(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
