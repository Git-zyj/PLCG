...
void kernel_3224112121_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
...
#pragma scop
    ...
    for (int i_3 = 2; i_3 < PB_L-2; i_3++) {
        for (int i_4 = 0; i_4 < -i_3+PB_L-2; i_4++) {
            B[i_4+i_3-2][i_4+i_3] = C[i_4][i_3-2][1] * B[i_4+i_3-1][i_4+i_3+1] + B[i_4+i_3][i_4+i_3+2] * 4;
        }
    }
#pragma endscop
...
kernel_3224112121_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
