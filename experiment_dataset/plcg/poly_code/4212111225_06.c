...
void kernel_4212111225_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        B[i_0-2] = C[i_0] + C[i_0-1] - B[i_0+2] * 1;
        B[i_0] = B[i_0-1] + 6;
    }
#pragma endscop
...
kernel_4212111225_06(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
