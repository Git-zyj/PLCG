...
void kernel_4436151313_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-1; i_0++) {
        A[i_0] = E[i_0] - E[i_0-1] + E[i_0] - E[0] - E[i_0] - E[i_0+1] * A[i_0+1] - B[i_0] - 6;
    }
    for (int i_1 = 1; i_1 < PB_L; i_1++) {
        B[i_1] = E[i_1] + E[i_1] * E[i_1] + A[i_1] * B[i_1+1] + 3;
        for (int i_2 = 1; i_2 < -i_1+PB_M-1; i_2++) {
            B[i_2] = F[i_2+i_1-1][i_2][i_1] * G[i_2-1][i_1] + G[i_2][i_2] * E[i_1] + G[i_2+i_1+1][0] * B[i_2+1] * B[i_2-1] - 6;
        }
    }
        ...
        for (int i_4 = 0; i_4 < PB_L; i_4++) {
            for (int i_5 = 1; i_5 < PB_L; i_5++) {
                for (int i_6 = 1; i_6 < PB_L-1; i_6++) {
                    D[i_5][i_3][i_5+1][i_6] = F[i_5][i_4][i_5] - H[i_5][i_4][i_3][i_6] - H[i_4][i_6][i_6+1][i_5] + H[i_6][i_5][i_4][i_3] * D[i_5-1][i_3-1][i_5][i_6-1] - D[i_5][i_3][i_5+1][i_6-1] - 6;
                }
            }
        }
    }
...
kernel_4436151313_06(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
