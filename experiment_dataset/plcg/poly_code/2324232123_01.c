...
void kernel_2324232123_01(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
    ...
    for (int i_3 = 2; i_3 < PB_N-2; i_3++) {
        C[i_3+1] = D[i_3] + E[i_3] + D[i_3] - E[i_3+2] + E[i_3-2] - C[i_3-1] - 4;
    }
#pragma endscop
...
kernel_2324232123_01(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
