...
void kernel_3424252311_06(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_P; i_0++) {
        for (int i_1 = 2; i_1 < min(PB_P, -i_0+PB_N-1); i_1++) {
            A[i_1+i_0][i_1] = E[i_0+2][i_1-1] - E[i_1+2][i_0] - F[i_1][i_0] - A[i_1+i_0+1][i_1+1] + B[i_0+1][i_1-1][1] - B[i_1][i_0][1] * B[i_0][i_1][1] * B[i_1-1][i_0][1] + 4;
            for (int i_2 = 2; i_2 < PB_P; i_2++) {
                B[i_0][i_2][1] = G[i_1+1][i_0][i_2] - G[i_2][i_1-2][i_0] * H[i_2][i_1-1][i_2] + F[i_1+2][i_0] - G[i_0][i_1][i_2-2] * A[i_2+i_1][i_2+1] - 5;
            }
        }
    }
    for (int i_3 = 2; i_3 < PB_M-2; i_3++) {
        for (int i_4 = 2; i_4 < -i_3+PB_N-2; i_4++) {
            A[i_4+i_3+2][i_3+1] = F[i_3+2][i_4-2] - F[i_4][i_3] + F[i_4-2][i_3] - E[i_4][i_3+1] + F[i_3-2][i_4] + 1;
        }
    }
    for (int i_5 = 2; i_5 < PB_P; i_5++) {
        for (int i_6 = 2; i_6 < i_5; i_6++) {
            B[i_5][i_6-1][1] = I[i_5] * I[i_5] - E[i_6-2][i_5-2] * J[i_6-2] * F[i_6-1][i_5-2] + F[i_5][i_6-1] * 5;
        }
    }
#pragma endscop
...
kernel_3424252311_06(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
