...
void kernel_4216212321_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < PB_N-1; i_1++) {
            for (int i_2 = 0; i_2 < i_0; i_2++) {
                for (int i_3 = 2; i_3 < i_0; i_3++) {
                    A[i_1][i_0][i_3+2] = A[i_2][i_3-2][i_1+2] + A[i_1][i_0][i_2] - A[i_1+1][i_0-1][i_3+1] * A[i_1][i_3-1][i_0+2] + 3;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-2; i_4++) {
        for (int i_5 = max(i_4, 3); i_5 < PB_N; i_5++) {
            B[i_4+2][i_5-2] = C[i_4][i_5][i_4-2] + B[i_4+2][i_5-3] * B[i_4][i_5-2] - 2;
        }
    }
#pragma endscop
...
kernel_4216212321_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
