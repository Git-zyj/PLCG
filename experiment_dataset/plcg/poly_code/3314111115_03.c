...
void kernel_3314111115_03(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve)){
    ...
    for (int i_3 = 1; i_3 < PB_M; i_3++) {
        for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
            for (int i_5 = 1; i_5 < PB_M+1; i_5++) {
                C[i_5][i_4] = D[i_4+1][i_3][i_5] + E[i_5-1][i_3][i_4-1][i_4] + 1;
            }
        }
        for (int i_6 = 1; i_6 < -i_3+PB_L; i_6++) {
            C[i_6][i_3] = D[i_3][i_6+i_3][i_6-1] - C[i_6][i_3-1] + 5;
        }
    }
#pragma endscop
...
kernel_3314111115_03(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
