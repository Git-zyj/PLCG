...
void kernel_4322212113_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
    ...
    for (int i_4 = 2; i_4 < PB_L; i_4++) {
        ...
        for (int i_5 = 1; i_5 < PB_L; i_5++) {
            for (int i_6 = 1; i_6 < -i_5+PB_L; i_6++) {
                C[i_5][i_6+i_5][i_6-1] = C[i_5-1][i_6+i_5-1][i_6-1] + 1;
            }
        }
    }
#pragma endscop
...
kernel_4322212113_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
