        ...
        for (int i_1 = 2; i_1 < PB_L-2; i_1++) {
            for (int i_2 = i_0; i_2 < PB_M; i_2++) {
                for (int i_3 = 2; i_3 < PB_M-2; i_3++) {
                    A[i_2][i_3-2][i_1][i_0-2] = C[i_2][i_0-1][i_3][i_1+1] * D[i_2][i_2][i_3-1][i_0][i_1-2] * E[i_2][i_3][i_1][i_0] + E[i_3+2][i_2][i_1][i_3] * F[i_3][i_1+2][i_2] - E[i_3+1][i_0+2][i_2][i_1] - A[i_2][i_3-1][i_0][i_1-2] - A[i_3+1][i_2][i_1][i_0-2] - 2;
                }
            }
        }
        for (int i_4 = 2; i_4 < -i_0+PB_P; i_4++) {
            B[i_0][i_4+i_0] = G[i_4][i_0+2] + H[i_4][i_0] + I[i_4] + I[i_4-2] * B[i_0+1][i_4+i_0-1] + 2;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,wd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4224252225_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,wd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,wd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I)));
