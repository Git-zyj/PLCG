...
void kernel_4332331225_09(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
        ...
        for (int i_1 = 0; i_1 < min(-i_0+PB_P, PB_L-2); i_1++) {
            for (int i_2 = 1; i_2 < PB_L; i_2++) {
                for (int i_3 = 0; i_3 < PB_L; i_3++) {
                    B[i_2+1][i_3][i_1+2][i_1+2] = D[i_3][i_2][i_1+i_0][i_2-1] * E[i_2+i_1][i_3+1][i_0][i_0-1] - B[i_2+1][i_3][i_0][i_0] * 6;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < min(-i_4+PB_P+1, PB_M-2); i_5++) {
            for (int i_6 = 0; i_6 < min(PB_L, -i_5+PB_M); i_6++) {
                for (int i_7 = 1; i_7 < -i_6+PB_L; i_7++) {
                    B[i_5+1][i_7][i_6][i_6] = F[i_7][i_5][i_4][i_6] * F[i_5][i_7+i_6][i_5+i_4-1][i_4] + E[i_7-1][i_6][i_5][0] - F[i_6+i_5][i_4+1][i_7][i_5] + B[i_5+2][i_7][i_4+2][i_4+2] * B[i_5][i_7][i_4+2][i_4+2] - 3;
                }
            }
        }
        for (int i_8 = 0; i_8 < PB_L; i_8++) {
            C[i_4-1][i_8] = G[i_4][i_8] + H[i_8][i_4] + G[i_8][i_4] * 1;
        }
    }
#pragma endscop
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4332331225_09(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H)));
