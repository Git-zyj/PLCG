...
void kernel_4226251323_04(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
        ...
        for (int i_1 = 3; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_P, -i_1+PB_Q); i_2++) {
                for (int i_3 = 0; i_3 < PB_M; i_3++) {
                    B[i_2][i_1-3][i_3+1][i_1-2] = C[i_3][i_1][i_2+i_0][i_0] - C[i_2-1][i_3][0][i_1+1] * D[i_2][i_3][i_0][i_2+i_1] - D[i_1-1][i_3][i_2][1] - 5;
                }
            }
        }
        for (int i_4 = 1; i_4 < -i_0+PB_P; i_4++) {
            for (int i_5 = 0; i_5 < PB_M; i_5++) {
                for (int i_6 = 0; i_6 < min(i_0, PB_M-1); i_6++) {
                    B[i_6][i_0-1][i_5+1][i_0] = D[i_6+1][i_5][i_4][i_5+1] * C[i_5][i_0][i_4+1][i_6] + D[i_4][i_0][i_5][i_6] - D[i_0][i_5][i_6+1][i_4-1] + E[i_6+1][i_4][i_5] - C[i_5][i_6][i_4+i_0][0] - B[i_6][i_0-1][i_5][i_0] * B[i_6][i_0][i_5+1][i_0+1] - B[i_6+1][i_0-1][i_5][i_0] + 6;
                }
            }
        }
    }
...
kernel_4226251323_04(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
