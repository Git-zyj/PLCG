...
void kernel_4322352325_07(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 2; i_1 < PB_M; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_1+PB_P, -i_0+PB_M+2); i_2++) {
                for (int i_3 = 2; i_3 < PB_L-2; i_3++) {
                    B[i_2+i_0-2][i_3+2][i_1-2][i_3-2] = D[i_1][i_3+2][i_0-2][i_2] * D[i_0+1][i_3][i_2+i_1][0] - 4;
                }
            }
        }
    }
        ...
        for (int i_5 = 2; i_5 < PB_P-2; i_5++) {
            for (int i_6 = 2; i_6 < min(-i_5+PB_M-1, -i_4+PB_L); i_6++) {
                for (int i_7 = 2; i_7 < -i_5+PB_L; i_7++) {
                    B[i_6+i_5-1][i_7+2][i_4-2][i_7-2] = E[i_7][i_6+i_5][i_7] * F[i_7][i_6+2][i_4][i_5-2] * D[i_6][i_7+i_5][i_4][i_6-2] - D[i_4][i_6][i_5][i_4] - F[i_6][i_4][i_5][i_4] * D[i_7][i_5][i_6][i_4+1] - D[i_7][i_6+i_4][i_5+2][i_4-1] + B[i_6+i_4-2][i_7+2][i_5-2][i_7-2] * B[i_6+i_5+1][i_7+2][i_4-2][i_7-2] - 6;
                }
            }
        }
        for (int i_8 = 2; i_8 < PB_M; i_8++) {
            C[i_4][i_4] = G[i_8][0] + H[i_8] - I[i_8-1][i_4] - J[i_4] + I[i_8-2][i_4] + C[i_4-1][i_4-1] * C[i_4+1][i_4+1] - C[i_8-2][i_8-2] + C[i_4+2][i_4+2] - 4;
        }
    }
#pragma endscop
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4322352325_07(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J)));
