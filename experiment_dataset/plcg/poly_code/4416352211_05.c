...
void kernel_4416352211_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,int wg,DATA_TYPE POLYBENCH_5D(G,xG,yG,zG,vG,wG,xg,yg,zg,vg,wg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,int ym,int zm,int vm,int wm,DATA_TYPE POLYBENCH_5D(M,xM,yM,zM,vM,wM,xm,ym,zm,vm,wm)){
        ...
        for (int i_1 = 2; i_1 < PB_L-1; i_1++) {
            for (int i_2 = i_0; i_2 < -i_1+PB_L; i_2++) {
                for (int i_3 = 2; i_3 < PB_L-2; i_3++) {
                    A[i_0+1][i_3+1][i_0+2][0] = E[i_3][i_2][i_0][i_2+i_1] * E[i_1][i_3-2][i_0][i_1] * F[i_1][i_2+1][i_3][i_0] + G[i_0-2][i_1][i_3][i_2][0] - E[i_3+1][i_0+1][i_1-2][i_3] - F[i_2][i_1+1][i_0-1][i_3] + E[i_2][i_1][i_0][i_3+2] * 4;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_L-2; i_4++) {
            for (int i_5 = 1; i_5 < PB_L; i_5++) {
                B[i_0-1][i_5][i_4] = H[i_5][i_0][i_4] * H[i_0][i_4+2][i_5-1] - I[i_4+2][i_5][i_4] + J[i_4+2][i_5][i_0] * J[i_4+2][i_5-1][i_0] + B[i_0][i_5][i_4] + B[i_4-1][i_0+1][i_5] + 4;
            }
        }
    }
    for (int i_6 = 1; i_6 < PB_P; i_6++) {
        C[i_6] = K[i_6][i_6] - L[i_6] * C[i_6+1] * C[i_6-1] + C[i_6-1] * C[i_6+1] + 5;
        for (int i_7 = 2; i_7 < PB_P; i_7++) {
            for (int i_8 = 2; i_8 < min(min(-i_6+PB_M, PB_Q-2), i_7); i_8++) {
                for (int i_9 = 1; i_9 < -i_7+PB_P; i_9++) {
                    A[i_8+1][i_6][i_8+2][0] = I[i_8+i_6][i_7][i_9] - I[i_8-1][i_9-1][i_7-2] * M[i_8-2][i_9+i_7][i_6][i_9][0] + F[i_7-2][i_6][i_8][i_6] - 2;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,ym,zm,vm,wm,POLYBENCH_ARRAY(M), INIT_SEED);
kernel_4416352211_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,ym,zm,vm,wm,POLYBENCH_ARRAY(M));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,ym,zm,vm,wm,POLYBENCH_ARRAY(M)));
