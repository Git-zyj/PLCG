...
void kernel_4314311221_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < min(-i_0+PB_L, i_0); i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_L; i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_L; i_3++) {
                    A[i_2-1][i_1][i_3+i_0] = D[i_0][i_3-1][i_2+i_1][i_3] - A[i_2-1][i_3+1][i_1+i_0] + A[i_0-3][i_2-1][i_3+i_1] * 3;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M-3; i_4++) {
        for (int i_5 = i_4; i_5 < PB_M-1; i_5++) {
            B[i_5+1][i_4][i_5] = E[i_5][i_4] * B[i_4+3][i_5][i_4+2] - 4;
        }
        for (int i_6 = 1; i_6 < i_4; i_6++) {
            for (int i_7 = 1; i_7 < PB_L-1; i_7++) {
                for (int i_8 = max(0, -i_6+1); i_8 < -i_6+PB_M; i_8++) {
                    C[i_8+i_6][i_7-1][i_7-1] = C[i_8+i_6][i_7+1][i_7+1] * C[i_8+i_6-1][i_7-1][i_7-1] - 5;
                }
            }
        }
    }
...
kernel_4314311221_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
