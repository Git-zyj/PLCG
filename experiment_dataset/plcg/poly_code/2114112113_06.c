...
void kernel_2114112113_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_N+2; i_0++) {
        for (int i_1 = 0; i_1 < min(i_0, -i_0+PB_N+2); i_1++) {
            A[i_1+i_0-2] = B[i_1] + A[i_1+i_0-3] * 5;
        }
    }
#pragma endscop
...
kernel_2114112113_06(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
