        ...
        for (int i_5 = 2; i_5 < i_1; i_5++) {
            for (int i_6 = 2; i_6 < PB_M; i_6++) {
                for (int i_7 = 2; i_7 < -i_5+PB_M; i_7++) {
                    C[i_7][i_5-2][i_6-1][i_1] = I[i_5][i_1-2][i_7][i_6] * I[i_6][i_6][i_7-2][i_5] + G[i_1][i_6][i_5][i_7-1] * J[i_6][i_5+1][i_5] + K[i_7+i_5][i_1][i_6-1] * C[i_7][i_5-2][i_6-1][i_1-2] - C[i_5][i_6-2][i_7][i_1] - 2;
                }
            }
        }
    }
...
kernel_4334352321_07(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
