        ...
        for (int i_1 = 0; i_1 < PB_N-1; i_1++) {
            for (int i_2 = max(3, i_0); i_2 < PB_M+1; i_2++) {
                for (int i_3 = 1; i_3 < PB_P-2; i_3++) {
                    A[i_1+1][i_0][i_3][i_2-1] = E[i_2-1][i_0][i_3-1][i_1] - A[i_1+1][i_0][i_3][i_2-3] + A[i_1+1][i_0][i_3+2][i_2-1] + 1;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M; i_4++) {
        ...
        for (int i_7 = i_4; i_7 < PB_P; i_7++) {
            for (int i_8 = 1; i_8 < PB_Q; i_8++) {
                C[i_4][i_7][i_8] = C[i_4-2][i_7][i_8-1] + 4;
            }
        }
    }
    for (int i_9 = 0; i_9 < PB_L-1; i_9++) {
        for (int j_0 = max(i_9, 2); j_0 < -i_9+PB_P-1; j_0++) {
            for (int j_1 = 1; j_1 < PB_L-1; j_1++) {
                for (int j_2 = 0; j_2 < min(-j_0+PB_P+2, -i_9+PB_P-2); j_2++) {
                    D[j_1][j_1+1][j_2+i_9][j_0] = E[j_1-1][i_9+1][j_0][0] - D[j_1-1][j_1][j_2+i_9][j_0] * D[j_1][j_1+1][j_2+i_9+2][j_0] - D[j_2][j_2+1][j_0+i_9+1][j_1-1] * D[i_9][i_9+1][j_2+j_0-2][j_1+1] - 5;
                }
            }
        }
    }
...
kernel_4432111321_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
