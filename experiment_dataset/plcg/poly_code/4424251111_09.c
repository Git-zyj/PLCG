...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < PB_N; i_1++) {
            for (int i_2 = 1; i_2 < min(i_0, -i_0+PB_Q-1); i_2++) {
                for (int i_3 = 1; i_3 < PB_M; i_3++) {
                    A[i_2][i_1][i_0-1][i_3] = E[i_2][i_3][i_1-1][i_2+i_0+1] + E[i_2][i_3][i_0][i_2] + E[i_2][i_1][i_3-1][i_0+1] * E[i_2-1][i_3-1][i_0+1][i_1] - F[i_3][i_1-1][i_2+i_0+1][i_3] * 4;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M; i_4++) {
        for (int i_5 = 2; i_5 < PB_M; i_5++) {
            B[i_5-1] = G[i_5-1][i_4] - G[i_5][i_4] * H[i_5][i_4] + B[i_5-2] + 3;
        }
    }
    for (int i_6 = 1; i_6 < PB_M-1; i_6++) {
        C[i_6-1] = G[i_6+1][i_6] * I[i_6+1] + I[i_6+1] * I[i_6] - J[i_6-1] - J[i_6-1] + I[i_6] - 2;
        for (int i_7 = 1; i_7 < PB_M-1; i_7++) {
            D[i_6][i_7+1] = H[i_7][i_6] + H[i_6][i_7] * H[i_7-1][i_6] * D[i_7-1][i_6+1] * 4;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4424251111_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J)));
