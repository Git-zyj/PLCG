...
void kernel_4416252221_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_P-2; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_M-1; i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_M; i_3++) {
                    A[i_3][i_3+i_0][i_3+i_2][i_0] = E[i_3-1][i_0][i_1+2][i_1] - F[i_0][i_2][i_0][i_3-1] + A[i_0-1][i_2+i_0+1][i_3+i_0-1][i_2+2] * A[i_3][i_3+i_2][i_3+i_0-1][i_2] + 6;
                }
            }
            for (int i_4 = 1; i_4 < PB_L; i_4++) {
                B[i_1+2][i_1+1] = G[i_4-1][i_0][i_1-1] - G[i_1+2][i_0][i_1+2] - G[i_0][i_4][i_1+1] - G[i_1-1][i_4][i_1+i_0+2] + B[i_1][i_1-1] * 2;
            }
        }
    }
    for (int i_5 = 3; i_5 < PB_L-4; i_5++) {
        for (int i_6 = 2; i_6 < -i_5+PB_L-4; i_6++) {
            C[i_5+1][i_6+i_5+1] = H[i_5][i_6-2][i_6] - I[i_5][i_5-2] + G[i_6][i_5-2][i_5-2] - I[i_5][i_6] * I[i_6-1][i_6] - I[i_6-1][i_5] - J[i_5][i_6] + C[i_5+1][i_6+i_5-1] * C[i_5+1][i_6+i_5+2] + C[i_5+3][i_6+i_5+4] * 3;
        }
        D[i_5-1][i_5] = K[i_5+2] - K[i_5] + L[i_5-2] * K[i_5] - L[i_5] - L[i_5] * D[i_5][i_5+1] + D[i_5-3][i_5-2] + 2;
    }
#pragma endscop
