...
void kernel_4222112211_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
        ...
        for (int i_1 = i_0; i_1 < PB_Q; i_1++) {
            for (int i_2 = 0; i_2 < PB_P; i_2++) {
                for (int i_3 = 1; i_3 < PB_Q+1; i_3++) {
                    A[i_1][i_2][i_1] = A[i_3-1][i_1-1][i_3-1] - 2;
                }
            }
        }
        for (int i_4 = i_0; i_4 < PB_P; i_4++) {
            for (int i_5 = 1; i_5 < PB_Q-1; i_5++) {
                B[i_4][i_0-1][i_5] = C[i_5-1][0] * A[i_5+1][i_4][i_5+1] - B[i_4-1][i_0-1][i_5] + B[i_4-1][i_0-1][i_5+1] * 2;
            }
        }
    }
#pragma endscop
...
kernel_4222112211_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
