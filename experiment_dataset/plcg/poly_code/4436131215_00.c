...
#pragma scop
    ...
    for (int i_3 = 0; i_3 < PB_L; i_3++) {
        for (int i_4 = 1; i_4 < i_3; i_4++) {
            A[i_4-1] = F[i_4][i_3] * F[i_3][i_4-1] - E[i_4] + 2;
        }
    }
    for (int i_5 = 1; i_5 < PB_N-1; i_5++) {
        for (int i_6 = 1; i_6 < PB_L; i_6++) {
            for (int i_7 = 1; i_7 < min(min(i_6, -i_6+PB_N+1), PB_M-2); i_7++) {
                for (int i_8 = 0; i_8 < PB_L-1; i_8++) {
                    D[i_7+1][i_8][i_7][i_7] = G[i_6][i_8+1][1] + H[i_7+i_6-1][i_5+1][i_8][i_6-1] - H[i_8+1][i_7][i_5-1][i_6] - D[i_7+2][i_8][i_7+1][i_7+1] + D[i_7][i_8][i_7-1][i_7-1] + 5;
                }
            }
        }
    }
...
kernel_4436131215_00(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
