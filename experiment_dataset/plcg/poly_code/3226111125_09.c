...
void kernel_3226111125_09(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
    ...
    for (int i_3 = 1; i_3 < PB_M+1; i_3++) {
        for (int i_4 = i_3; i_4 < -i_3+PB_M+1; i_4++) {
            for (int i_5 = 0; i_5 < min(PB_M, -i_4+PB_L); i_5++) {
                B[i_4+i_3-1][i_5+i_4][i_3] = C[i_5][i_4] - A[i_5][i_4+1][i_3] - 5;
            }
        }
    }
#pragma endscop
...
kernel_3226111125_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
