    ...
    for (int i_3 = 0; i_3 < PB_N-1; i_3++) {
        for (int i_4 = 2; i_4 < i_3; i_4++) {
            for (int i_5 = 0; i_5 < PB_N-1; i_5++) {
                B[i_3+1][i_4][i_5] = E[i_5][i_3][1] - D[i_5+1][i_3+1][i_4] * B[i_3+1][i_4-2][i_5] * 6;
            }
        }
    }
#pragma endscop
...
kernel_3222231221_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
