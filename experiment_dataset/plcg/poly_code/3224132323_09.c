...
void kernel_3224132323_09(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L+1; i_0++) {
        for (int i_1 = i_0; i_1 < PB_P-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_P; i_2++) {
                A[i_0][i_1][i_2] = C[i_2-1][i_0-1][i_1+1] + A[i_1-1][i_0][i_2] - 1;
            }
        }
    }
    for (int i_3 = 0; i_3 < PB_L; i_3++) {
        for (int i_4 = max(2, i_3); i_4 < min(-i_3+PB_M-3, PB_L); i_4++) {
            for (int i_5 = 0; i_5 < min(min(-i_4+PB_M, PB_L-2), -i_3+PB_Q-2); i_5++) {
                B[i_5+i_3][i_4][i_5+i_4] = C[i_3][i_4][i_5] + C[i_3][i_5+2][i_4] - C[i_5+i_4][i_3][i_5+2] - C[i_5][i_4-2][0] - B[i_5+i_3][i_4+2][i_5+i_4] - B[i_4+i_3+3][i_5][i_5+i_3+1] + B[i_4+i_3+2][i_5][i_5+i_3+2] * B[i_5+i_3+1][i_4-2][i_5+i_4-2] + 1;
            }
        }
    }
#pragma endscop
...
kernel_3224132323_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
