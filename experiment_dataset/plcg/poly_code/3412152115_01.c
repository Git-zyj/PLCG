    ...
    for (int i_0 = 1; i_0 < PB_L-2; i_0++) {
        ...
        for (int i_1 = 2; i_1 < PB_L-2; i_1++) {
            for (int i_2 = i_1; i_2 < PB_M-1; i_2++) {
                B[i_2-1][i_2+1][i_0] = F[i_2+1][i_0][i_1] * F[i_1][i_2][i_0] + G[i_1][i_0+2][i_2][i_1-2] + H[i_2][i_1] * H[i_2][i_1+2] + F[i_2][i_0-1][i_1] - F[i_0][i_1][i_2] + 4;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_M-2; i_3++) {
        for (int i_4 = 1; i_4 < min(-i_3+PB_M, i_3); i_4++) {
            for (int i_5 = 0; i_5 < min(-i_3+PB_M, -i_4+PB_M); i_5++) {
                C[i_5+i_3][i_4][i_5] = H[i_4][i_5] * F[i_4][i_3][i_3] - H[i_4-1][i_5] + H[i_4][i_5] + F[i_5+i_4][i_3][i_5] - B[i_3][i_3+2][i_5] - 3;
            }
            B[i_4][i_4+2][i_3] = H[i_4+i_3][1] - H[i_4][i_3-1] - 6;
        }
    }
#pragma endscop
...
kernel_3412152115_01(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
