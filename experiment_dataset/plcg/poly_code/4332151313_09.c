...
void kernel_4332151313_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
        ...
        for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_0+PB_P+1, -i_1+PB_Q); i_2++) {
                for (int i_3 = 1; i_3 < min(-i_1+PB_M, -i_0+PB_P-1); i_3++) {
                    A[i_1][i_3-1][i_2][i_0] = D[i_1-1][i_3][i_2+i_0-1][i_3-1] - D[i_1][i_1][i_0][i_3] - D[i_0-1][i_2][i_1][1] - D[i_3+i_1][i_2][i_0][i_1-1] + D[i_3][i_1][i_2][i_0] + D[i_1+1][i_1+1][i_3+i_0+1][i_2+1] + D[i_3+i_1][i_2][i_0][i_2+i_1] - A[i_1][i_0-2][i_2][i_3+1] * A[i_1+1][i_3][i_2][i_0-1] + A[i_1+1][i_3-1][i_2+1][i_0] + A[i_2][i_1-1][i_3+1][i_0] - 6;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M-1; i_4++) {
        B[i_4+1] = E[i_4] - E[i_4] + E[i_4] * B[i_4] - 4;
    }
    for (int i_5 = 1; i_5 < PB_P-1; i_5++) {
        for (int i_6 = 0; i_6 < -i_5+PB_P-1; i_6++) {
            for (int i_7 = 1; i_7 < PB_L-1; i_7++) {
                for (int i_8 = 1; i_8 < min(-i_6+PB_P-1, -i_7+PB_M); i_8++) {
                    C[i_8-1][i_7-1][i_6+i_5][i_8] = D[i_8+i_7][i_7][i_5][i_6] * D[i_6][i_7+1][i_5][i_5+1] * D[i_8+1][i_8][i_7][i_6+i_5-1] * C[i_8-1][i_7][i_6+i_5+1][i_8] * C[i_8-1][i_7-1][i_6+i_5-1][i_8] - C[i_5-1][i_7-1][i_8+i_6+1][i_5] * C[i_8-1][i_7-1][i_6+i_5+1][i_8] + 2;
                }
            }
        }
    }
...
kernel_4332151313_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
