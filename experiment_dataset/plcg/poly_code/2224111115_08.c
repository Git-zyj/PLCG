...
void kernel_2224111115_08(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_L+1; i_0++) {
        ...
        A[i_0][i_0-1] = C[i_0] - A[i_0-1][i_0-2] + 1;
    }
#pragma endscop
...
kernel_2224111115_08(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
