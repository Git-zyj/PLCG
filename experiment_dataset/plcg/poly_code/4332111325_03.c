...
void kernel_4332111325_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < PB_M; i_1++) {
            for (int i_2 = 1; i_2 < PB_L; i_2++) {
                for (int i_3 = 0; i_3 < PB_L; i_3++) {
                    A[i_1][i_2-1][i_3] = A[i_1][i_2][i_3] * 2;
                }
            }
        }
    }
    ...
    for (int i_5 = 2; i_5 < PB_N-2; i_5++) {
        for (int i_6 = 0; i_6 < min(-i_5+PB_P, PB_N-2); i_6++) {
            for (int i_7 = 0; i_7 < -i_5+PB_N-2; i_7++) {
                C[i_6][i_7+i_5][i_7] = D[i_6+1][i_7+i_5][i_6+i_5] + D[i_6+1][i_7][i_6+i_5] - D[i_5][i_7+1][i_6] * C[i_6+2][i_7+i_5][i_7] - C[i_6][i_7+i_5][i_5-2] - C[i_6][i_7+i_5-2][i_7] - C[i_6][i_7+i_5+2][i_7] - 5;
            }
        }
    }
#pragma endscop
...
kernel_4332111325_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
