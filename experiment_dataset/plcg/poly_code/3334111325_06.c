...
void kernel_3334111325_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        A[i_0-1] = D[i_0] - D[i_0-1] * A[i_0-2] * C[i_0-1] - 4;
        for (int i_1 = 3; i_1 < i_0; i_1++) {
            A[i_0-1] = C[i_1-1] + C[i_1-3] + 2;
        }
...
kernel_3334111325_06(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
