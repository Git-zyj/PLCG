...
void kernel_3224211313_07(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 1; i_1 < min(PB_L, i_0); i_1++) {
            B[i_1][i_0] = C[i_0-1][i_1] * 2;
            B[i_1][i_0] = B[i_1+1][i_0] - B[i_1-1][i_0+1] * B[i_1][i_0-1] - 6;
        }
    }
#pragma endscop
...
kernel_3224211313_07(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
