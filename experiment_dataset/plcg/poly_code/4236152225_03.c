...
void kernel_4236152225_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L+1; i_0++) {
        A[i_0-2] = C[i_0] + C[i_0+2] - C[i_0] + A[i_0-1] - 6;
    }
    for (int i_1 = 2; i_1 < PB_L+2; i_1++) {
        A[i_1-2] = C[i_1] * C[i_1+2] - C[i_1] + C[i_1-1] - C[i_1] - C[i_1+1] - C[i_1] + A[i_1-2] - 3;
    }
#pragma endscop
...
kernel_4236152225_03(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
