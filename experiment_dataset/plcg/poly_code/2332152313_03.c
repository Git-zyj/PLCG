...
void kernel_2332152313_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-1; i_0++) {
        A[1] = D[i_0] - D[i_0] - D[i_0] * D[i_0+1] + D[i_0] - A[1] + A[1] - 2;
    }
    for (int i_1 = 0; i_1 < PB_M; i_1++) {
        for (int i_2 = 2; i_2 < PB_M; i_2++) {
            C[i_2] = E[i_1][i_2+1] - E[i_2-2][i_1+2] * C[i_2-1] + 2;
        }
    }
    for (int i_3 = 0; i_3 < PB_M-2; i_3++) {
        for (int i_4 = 2; i_4 < min(-i_3+PB_M, PB_M-2); i_4++) {
            C[i_4] = E[i_3][i_4] + E[i_4][i_3] - E[i_3+2][i_4] * E[i_4-2][i_3] - E[i_4][i_4+i_3] - E[i_4+2][i_3+2] * E[i_4+i_3][i_4+2] * E[i_4-2][i_3] * A[1] * C[i_4-1] + 3;
        }
    }
#pragma endscop
...
kernel_2332152313_03(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
