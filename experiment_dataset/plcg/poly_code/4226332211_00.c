        ...
        for (int i_1 = 2; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_L-2; i_2++) {
                for (int i_3 = 2; i_3 < min(-i_1+PB_M, i_1); i_3++) {
                    A[i_2-1][i_3+2][i_0][i_1] = C[i_0+2][i_3-2][i_1+1][i_2] - D[i_0-2][i_3][i_1-2][i_3+2] - E[i_0][i_3+i_1][i_3][i_1-1][i_0-1] + A[i_3][i_2+2][i_0+1][i_1] * 5;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M-2; i_4++) {
        for (int i_5 = 1; i_5 < PB_M; i_5++) {
            for (int i_6 = 1; i_6 < PB_M-1; i_6++) {
                B[i_4][i_5-1][i_6+1] = F[i_5][i_6][i_4] - F[i_6][i_6][0] - F[i_5][i_6][i_4+1] * B[i_5][i_6-1][i_4] - B[i_6-1][i_5-1][i_4+1] + B[i_6-1][i_5-1][i_4+2] + 3;
            }
        }
    }
#pragma endscop
...
kernel_4226332211_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
