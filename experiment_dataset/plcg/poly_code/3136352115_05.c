    ...
    for (int i_0 = 0; i_0 < PB_L-1; i_0++) {
        for (int i_1 = i_0; i_1 < min(PB_N, -i_0+PB_L); i_1++) {
            for (int i_2 = 1; i_2 < min(min(-i_0+PB_L, -i_1+PB_N), PB_P-1); i_2++) {
                A[i_1][i_0+1][i_2] = B[i_1+1][i_2][i_2+i_0] + C[i_2+i_1][i_0][2] - D[i_2][i_1][i_0+1] - E[i_1+2][i_2-1] + D[i_2][i_1+i_0][2] + A[i_1][i_0+1][i_2+1] - 6;
            }
        }
    }
#pragma endscop
...
kernel_3136352115_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
