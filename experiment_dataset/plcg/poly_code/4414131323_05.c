...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < PB_Q; i_1++) {
            for (int i_2 = 1; i_2 < i_0; i_2++) {
                for (int i_3 = 1; i_3 < i_0; i_3++) {
                    A[i_0][i_2][i_3][i_1] = E[i_0-1][i_1-1][i_3-1][i_2] - E[i_1+1][i_0][i_3-1][i_1] + A[i_0-2][i_2-1][i_3-1][i_1] + A[i_0][i_2-1][i_3][i_1] + A[i_0+2][i_2-1][i_3][i_1-1] * 1;
                }
            }
        }
    ...
    for (int i_4 = 2; i_4 < PB_Q; i_4++) {
        B[i_4] = G[i_4][1] * B[i_4-1] * 5;
        for (int i_5 = i_4; i_5 < PB_P-2; i_5++) {
            for (int i_6 = 1; i_6 < PB_Q; i_6++) {
                for (int i_7 = 1; i_7 < PB_P-1; i_7++) {
                    D[i_7][i_5][i_4][i_6] = E[i_6-1][i_6][i_7-1][i_5] - E[i_4][i_6][i_7+1][i_5-1] - D[i_4-2][i_5+2][i_7][i_6-1] + D[i_7][i_5-1][i_4][i_6-1] * 5;
                }
            }
        }
    }
...
kernel_4414131323_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
