...
void kernel_3134311321_02(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            A[i_0][i_0] = B[i_0] + A[i_0+2][i_0+2] * A[i_0-1][i_0-1] + A[i_0+1][i_0+1] * 3;
        }
    }
#pragma endscop
...
kernel_3134311321_02(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
