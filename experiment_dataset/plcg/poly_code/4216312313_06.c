...
void kernel_4216312313_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
        ...
        for (int i_1 = 1; i_1 < PB_L+1; i_1++) {
            for (int i_2 = 0; i_2 < i_1; i_2++) {
                for (int i_3 = 0; i_3 < min(PB_P, i_0); i_3++) {
                    A[i_1][i_1-1][i_3] = A[i_1][i_1-1][i_0-1] - 3;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-2; i_4++) {
        for (int i_5 = 0; i_5 < i_4; i_5++) {
            for (int i_6 = 2; i_6 < PB_L-1; i_6++) {
                B[i_4+1][i_6][i_6] = C[i_6-2][i_4+1] - B[i_4+1][i_6+1][i_6+1] - B[i_4+2][i_6][i_6] + B[i_6+2][i_4-1][i_4-1] + B[i_4+2][i_6-1][i_6-1] * 5;
            }
        }
    }
#pragma endscop
...
kernel_4216312313_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
