...
void kernel_3216111225_08(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-3; i_0++) {
        for (int i_1 = i_0; i_1 < -i_0+PB_L-3; i_1++) {
            A[i_0][i_1+i_0] = C[i_1] * A[i_1-2][i_1+i_0-2] + A[i_1+2][i_1+i_0+3] * 4;
            A[i_0-2][i_1+i_0-2] = 5;
        }
    }
#pragma endscop
...
kernel_3216111225_08(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
