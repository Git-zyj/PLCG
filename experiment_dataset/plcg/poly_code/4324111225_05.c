...
void kernel_4324111225_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-3; i_0++) {
        A[0] = A[0] + 5;
        C[i_0+3] = D[i_0] - D[i_0] + A[0] - 2;
    }
    for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
        C[i_1+1] = E[i_1-1][0] * A[0] - 4;
    }
#pragma endscop
...
kernel_4324111225_05(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
