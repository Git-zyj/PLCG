...
void kernel_4232211225_03(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    ...
    for (int i_2 = 2; i_2 < PB_M; i_2++) {
        for (int i_3 = 1; i_3 < PB_N; i_3++) {
            B[i_2-1][i_3+1] = C[i_3][i_2] + B[i_2-2][i_3-1] * B[i_2+1][i_3+1] * 6;
        }
    }
#pragma endscop
...
kernel_4232211225_03(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
