    ...
    for (int i_3 = 2; i_3 < PB_M; i_3++) {
        for (int i_4 = 1; i_4 < -i_3+PB_Q+1; i_4++) {
            for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
                B[i_5][i_4+i_3-1][i_5] = C[i_3][i_4][0] + D[i_5][i_5][i_4] + E[i_4][i_5+1][i_4+i_3][i_5] * F[i_3][i_5+i_4] - G[i_5][i_4-1][i_3] + B[i_5][i_4+i_3-2][i_5] * 4;
            }
        }
    }
#pragma endscop
...
kernel_3224331213_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
