...
void kernel_3222212225_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N-2; i_0++) {
        for (int i_1 = 0; i_1 < PB_N-3; i_1++) {
            A[1] = C[1] * B[i_1+3] - B[i_1+2] - 5;
        }
        B[i_0+2] = C[i_0] - A[1] - 1;
    }
#pragma endscop
...
kernel_3222212225_09(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
