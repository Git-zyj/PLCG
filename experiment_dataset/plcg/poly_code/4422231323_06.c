...
void kernel_4422231323_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
        ...
        for (int i_1 = i_0; i_1 < -i_0+PB_L; i_1++) {
            for (int i_2 = 0; i_2 < PB_M; i_2++) {
                for (int i_3 = 1; i_3 < PB_L-1; i_3++) {
                    A[i_3][i_1][i_0-1][i_2] = E[i_2][i_3+1][i_0][i_1+1] - E[i_1-1][i_0][i_2][i_3] + E[i_2][i_1][i_3+1][i_0] + F[i_2][i_1+i_0][i_3-1][i_1][i_0+1] + A[i_3+1][i_1][i_0+1][i_2] - 4;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < PB_P; i_5++) {
            for (int i_6 = 1; i_6 < PB_M+1; i_6++) {
                for (int i_7 = 0; i_7 < PB_L; i_7++) {
                    D[i_6-1][i_7][i_5-1] = E[i_7][i_4][i_5][i_6-1] + 2;
                }
            }
        }
    }
    for (int i_8 = 2; i_8 < PB_L-1; i_8++) {
        for (int i_9 = 1; i_9 < -i_8+PB_P; i_9++) {
            for (int j_0 = 2; j_0 < PB_L; j_0++) {
                C[i_8][j_0-1][i_9] = G[j_0][i_9-1] + H[j_0+1][j_0][i_8+1] * C[i_8][j_0-1][i_9-1] - C[i_8-1][j_0-1][i_9] - C[i_8+1][j_0-1][i_9] * C[i_8+2][j_0-2][i_9] + C[i_8-2][j_0+1][i_9-1] * C[i_8][j_0-2][i_9] - 6;
            }
            for (int j_1 = 1; j_1 < PB_L-1; j_1++) {
                D[i_8+1][j_1][i_9-1] = I[j_1+1][i_8][i_9-1] - I[j_1+1][i_8][i_9-1] + H[j_1-1][i_9][i_8] * G[j_1-1][i_9+i_8] - I[j_1-1][i_8][i_9+1] - D[i_8+2][j_1+1][i_9-1] - D[i_8-1][j_1][i_9-1] - 6;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D), xc,yc,zc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4422231323_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D), xc,yc,zc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D), xc,yc,zc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
