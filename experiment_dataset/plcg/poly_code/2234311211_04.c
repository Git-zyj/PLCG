...
void kernel_2234311211_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        A[0] = C[i_0+1] + A[0] + A[0] * 3;
    }
...
kernel_2234311211_04(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
