...
void kernel_2234151115_01(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-2; i_0++) {
        B[i_0+2] = C[i_0] * C[i_0] * C[i_0] - C[i_0-1] * C[i_0-1] - 5;
    }
    for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
        B[i_1+1] = C[i_1] - C[i_1] + C[i_1-1] - C[i_1] - C[i_1+1] * B[i_1] * 4;
    }
#pragma endscop
...
kernel_2234151115_01(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
