...
void kernel_4232112125_03(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    ...
    for (int i_3 = 1; i_3 < PB_M; i_3++) {
        for (int i_4 = 1; i_4 < PB_M-2; i_4++) {
            A[i_4-1][i_3] = C[i_4][i_3-1] + C[i_4+2][i_3] * 2;
        }
    }
#pragma endscop
...
kernel_4232112125_03(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C));
