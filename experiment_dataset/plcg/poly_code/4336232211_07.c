        ...
        for (int i_1 = 0; i_1 < min(-i_0+PB_L, PB_L-1); i_1++) {
            for (int i_2 = max(2, i_1); i_2 < PB_L-1; i_2++) {
                for (int i_3 = 2; i_3 < PB_N-2; i_3++) {
                    B[i_3+1][i_2][i_1] = D[i_0][i_2+1][i_3][i_1] + D[i_3-2][i_2+2][i_1+1][i_0] - D[i_2][i_3][i_0][i_1] + D[i_1][i_3][i_0][i_2-1] + D[i_3+2][i_2][i_1+i_0][i_2+1] * E[i_2][i_3][i_0+2] + F[i_3][i_1][i_0][i_2-2] + 5;
                }
            }
        }
        for (int i_4 = max(1, i_0); i_4 < PB_L-2; i_4++) {
            C[i_4][i_0+2] = G[i_4+2][i_0] - G[i_0+2][i_4] - A[i_4] * A[i_4+1] * C[i_4-1][i_0+2] * 1;
        }
    }
#pragma endscop
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4336232211_07(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G)));
