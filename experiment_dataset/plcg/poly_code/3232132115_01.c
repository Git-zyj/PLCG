...
void kernel_3232132115_01(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P-2; i_0++) {
        for (int i_1 = 2; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 2; i_2 < PB_M; i_2++) {
                B[i_1+1][i_1+1] = C[i_2][i_0][i_1] - C[i_2][i_1-2][i_0] + C[i_0-2][i_1][i_2+1] + C[i_1][i_0+2][i_0] - C[i_1-1][i_2-2][i_0] + 5;
            }
        }
    }
...
kernel_3232132115_01(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
