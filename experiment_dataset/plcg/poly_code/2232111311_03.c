...
void kernel_2232111311_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N; i_0++) {
        for (int i_1 = 0; i_1 < min(i_0, -i_0+PB_N); i_1++) {
            A[i_1+i_0] = A[i_1+i_0-1] * A[i_1+i_0-2] + A[i_1+i_0] - 6;
        }
    }
...
kernel_2232111311_03(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
