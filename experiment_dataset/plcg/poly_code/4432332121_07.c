        ...
        for (int i_8 = 0; i_8 < PB_Q-2; i_8++) {
            for (int i_9 = 0; i_9 < PB_M-2; i_9++) {
                for (int j_0 = 1; j_0 < PB_L-2; j_0++) {
                    D[j_0-1][i_8][i_9][i_7] = G[i_9+2][j_0][i_8][i_7] * H[i_9][j_0+2][i_7][i_8+2] - I[i_9+2][i_8][j_0] * 3;
                }
            }
        }
    }
...
kernel_4432332121_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K));
