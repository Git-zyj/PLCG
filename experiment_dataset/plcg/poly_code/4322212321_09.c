        ...
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = max(2, i_1); i_2 < PB_M-2; i_2++) {
                for (int i_3 = 0; i_3 < PB_M-2; i_3++) {
                    A[i_3][i_2-2][i_1] = A[i_3][i_1][i_2] - C[i_2+2][i_0+2] + C[i_3+2][i_2+2] * 6;
                }
            }
        }
    }
        ...
        for (int i_5 = 2; i_5 < min(i_4, PB_L-4); i_5++) {
            for (int i_6 = 1; i_6 < -i_4+PB_Q-1; i_6++) {
                for (int i_7 = 0; i_7 < -i_5+PB_Q-2; i_7++) {
                    B[i_5+2][i_6+i_4+1][i_7+i_5][i_6] = D[i_6][i_7][i_5-2] + B[i_5+4][i_6+i_4+1][i_7+i_5+2][i_6] - B[i_5+2][i_6+i_4][i_7+i_5][i_6-1] * B[i_5+2][i_6+i_4-1][i_7+i_5][i_6] * B[i_5+3][i_6+i_4][i_7+i_5+1][i_6] * 3;
                }
            }
        }
        for (int i_8 = 1; i_8 < -i_4+PB_L; i_8++) {
            for (int i_9 = 0; i_9 < PB_M-2; i_9++) {
                C[i_8+2][i_9+2] = E[i_8+i_4][i_9][i_8-1][i_9] - D[i_8][i_4][i_9] + A[i_8][i_4-2][i_9] * 3;
            }
        }
    }
#pragma endscop
...
kernel_4322212321_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
