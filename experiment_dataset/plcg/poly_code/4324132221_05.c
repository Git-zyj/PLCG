        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < PB_L; i_2++) {
                for (int i_3 = max(2, i_2); i_3 < PB_L+1; i_3++) {
                    A[i_2][i_3][i_3] = D[i_2][i_0][i_3][i_1-1] * D[i_0][i_3][i_1][i_2+1] * A[i_2][i_0+2][i_0+2] * A[i_3-1][i_2][i_2] * A[i_1][i_3-2][i_3-2] - 1;
                }
            }
        }
        for (int i_4 = max(1, i_0); i_4 < PB_Q; i_4++) {
            for (int i_5 = 0; i_5 < -i_4+PB_Q; i_5++) {
                for (int i_6 = 0; i_6 < PB_L-1; i_6++) {
                    B[i_5][i_5+1][i_6] = D[i_0+1][i_6][i_6][i_5+i_4] - B[i_6+1][i_6+2][i_4-1] * 1;
                }
            }
        }
    }
    for (int i_7 = 1; i_7 < PB_L; i_7++) {
        for (int i_8 = max(2, i_7); i_8 < -i_7+PB_Q; i_8++) {
            for (int i_9 = 1; i_9 < min(min(PB_M-2, -i_8+PB_M+2), -i_7+PB_L+1); i_9++) {
                C[i_7][i_8][i_9+1] = E[i_9-1][i_8+i_7] + F[i_9][i_9+i_7-1][i_8-1] + F[i_9+i_8-2][i_7-1][0] - F[0][i_7][i_8] - E[i_7][i_9-1] - F[i_8][i_9][i_7-1] - A[i_9+1][i_8][i_8] + C[i_9+2][i_8][i_7+1] + 6;
            }
        }
    }
#pragma endscop
...
kernel_4324132221_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
