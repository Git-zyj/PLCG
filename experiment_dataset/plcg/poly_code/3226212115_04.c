...
void kernel_3226212115_04(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
    ...
    for (int i_3 = 0; i_3 < PB_L-1; i_3++) {
        for (int i_4 = i_3; i_4 < PB_L-1; i_4++) {
            for (int i_5 = 0; i_5 < PB_M; i_5++) {
                B[i_5][i_3][i_4] = C[i_5][i_4] + B[i_5][i_3+1][i_4+1] + 5;
            }
        }
    }
#pragma endscop
...
kernel_3226212115_04(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
