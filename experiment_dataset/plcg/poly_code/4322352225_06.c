...
void kernel_4322352225_06(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P-1; i_0++) {
        for (int i_1 = 0; i_1 < -i_0+PB_Q+2; i_1++) {
            for (int i_2 = 2; i_2 < i_1; i_2++) {
                B[i_0][i_1][i_2][i_1+i_0-2] = D[i_0][i_1][i_2] - D[i_1][i_2-2][i_0+1] + 1;
            }
        }
    }
        ...
        for (int i_4 = i_3; i_4 < -i_3+PB_Q+1; i_4++) {
            for (int i_5 = 1; i_5 < -i_3+PB_M-2; i_5++) {
                for (int i_6 = 0; i_6 < PB_M-2; i_6++) {
                    B[i_4][i_3][i_5+2][i_4+i_3-2] = D[i_5][i_6][i_4-1] * E[i_5+2][i_3][i_4][i_6] * F[i_5+2][i_5+i_3+2][i_4][i_3] * E[i_6][i_5-1][i_3-1][i_4] - G[i_6+2][i_3][i_4][i_4] * E[i_4+1][i_6][i_5][i_4-2] + B[i_4+1][i_3][i_5+4][i_4+i_3-1] + 5;
                }
            }
        }
    }
    for (int i_7 = 2; i_7 < PB_M; i_7++) {
        for (int i_8 = 2; i_8 < PB_M-2; i_8++) {
            C[i_7][i_8] = H[i_8+2][i_7] - H[i_8][i_7] * H[i_8][i_7] - I[i_8][i_7] - H[i_8][i_7] - C[i_7][i_8-2] - C[i_7-2][i_8] - 5;
        }
    }
#pragma endscop
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4322352225_06(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I)));
