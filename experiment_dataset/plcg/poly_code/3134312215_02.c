...
void kernel_3134312215_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
...
kernel_3134312215_02(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
