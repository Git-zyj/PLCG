...
void kernel_4426232315_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
...
#pragma scop
        ...
        for (int i_1 = i_0; i_1 < PB_Q-2; i_1++) {
            for (int i_2 = 1; i_2 < PB_N; i_2++) {
                for (int i_3 = 1; i_3 < PB_Q; i_3++) {
                    A[i_2][i_0-1][i_1+2][i_3] = E[i_2][i_3][i_0+1][i_1] + A[i_2][i_1][i_0+2][i_3-1] + A[i_2][i_0][i_1+1][i_3] * A[i_3][i_2-1][i_1+2][i_0-1] - 3;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 1; i_5 < -i_4+PB_L-2; i_5++) {
            C[i_5-1] = F[i_5-1] - G[i_5+i_4+2][i_4-2] - G[i_5][i_4] * G[i_4-1][i_5] * H[i_4-1][i_5] - 3;
        }
        C[i_4] = C[i_4-1] + C[i_4+1] - 6;
    }
    for (int i_6 = 1; i_6 < PB_N+1; i_6++) {
        for (int i_7 = 1; i_7 < PB_Q; i_7++) {
            for (int i_8 = 2; i_8 < min(i_6, -i_6+PB_N+1); i_8++) {
                for (int i_9 = 0; i_9 < PB_Q-2; i_9++) {
                    A[i_8][i_6-1][i_9+2][i_7] = I[i_8][i_7][i_9] - E[i_8+i_6-1][i_7+1][i_9+1][i_7-1] + E[i_9][i_8-1][i_7][i_8-2] + 2;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4426232315_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
