...
void kernel_4234331311_00(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 2; i_1 < PB_P; i_1++) {
            for (int i_2 = 1; i_2 < PB_L; i_2++) {
                for (int i_3 = 0; i_3 < PB_L-1; i_3++) {
                    B[i_1-2][i_2][i_3] = C[i_0][i_3+1][i_2] - C[i_0][i_2-1][i_1] * 2;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_Q; i_4++) {
        for (int i_5 = 1; i_5 < PB_L-1; i_5++) {
            for (int i_6 = 2; i_6 < PB_M-1; i_6++) {
                B[i_6-1][i_5][i_4] = C[i_5][i_4][i_5] * C[i_6+1][i_4][i_5-1] + C[i_5][i_6][i_5] + B[i_6-2][i_4-1][i_5] + B[i_4-1][i_5-1][i_6+1] * B[i_4-1][i_5+1][i_6] + 3;
            }
        }
    }
#pragma endscop
...
kernel_4234331311_00(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
