        ...
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < PB_L; i_2++) {
                for (int i_3 = 0; i_3 < PB_N; i_3++) {
                    A[i_3][i_0][i_2][1] = D[i_0][i_1][i_0-1][1] * A[i_0][i_3][i_2-1][1] + A[i_3][i_2][i_1-1][1] + A[i_3][i_1+1][i_2][1] - 4;
                }
            }
        }
    ...
    for (int i_4 = 0; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 0; i_5 < PB_N; i_5++) {
            for (int i_6 = 0; i_6 < PB_L; i_6++) {
                A[i_6][i_5][i_4+1][1] = F[i_6][i_5][i_4] * A[i_5][i_6][i_4][1] - 6;
            }
        }
    }
#pragma endscop
...
kernel_4332311315_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
