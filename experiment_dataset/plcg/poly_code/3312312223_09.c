...
void kernel_3312312223_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        ...
        for (int i_1 = 0; i_1 < PB_Q-2; i_1++) {
            for (int i_2 = 0; i_2 < PB_P-2; i_2++) {
                B[i_0][i_2][i_1+1] = B[i_0][i_2][i_1+2] * B[i_0+2][i_2+2][i_1+2] * 2;
            }
        }
    }
    for (int i_3 = 2; i_3 < PB_M-1; i_3++) {
        for (int i_4 = i_3; i_4 < -i_3+PB_M-1; i_4++) {
            for (int i_5 = 0; i_5 < PB_M; i_5++) {
                C[i_3][i_3][i_4+2] = D[i_5][i_5][i_4+i_3-2] + D[i_5][i_4+i_3+1][i_3] + C[i_3][i_3][i_4+1] + C[i_3][i_3][i_4] - 2;
            }
        }
    }
#pragma endscop
...
kernel_3312312223_09(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
