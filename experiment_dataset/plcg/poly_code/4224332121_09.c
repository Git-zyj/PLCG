        ...
        for (int i_1 = i_0; i_1 < PB_P; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_Q; i_2++) {
                for (int i_3 = 0; i_3 < PB_P-2; i_3++) {
                    A[i_3][i_0+2][i_2+i_1][i_0+1] = C[i_2][i_0][i_0][i_2+i_1] - D[i_0-2][i_2][0][i_1] * E[i_0][i_2][i_1][i_3] * C[i_3+i_2-1][i_0][i_3][i_1] * D[i_3][i_2][i_3+2][i_1] + A[i_1][i_0+2][i_3+i_2][i_0+1] + 3;
                }
            }
        }
    }
...
kernel_4224332121_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
