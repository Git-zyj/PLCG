...
void kernel_4232312215_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_3 = 2; i_3 < PB_M; i_3++) {
            for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
                for (int i_5 = 1; i_5 < PB_M+1; i_5++) {
                    B[i_3-2][i_4+1][i_5+1] = C[i_4][i_3][i_5] * C[i_5][i_3][0] * B[i_4-1][i_3+1][i_5+1] * B[i_5-1][i_4+1][i_3+2] + 2;
                }
            }
        }
    }
...
kernel_4232312215_06(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
