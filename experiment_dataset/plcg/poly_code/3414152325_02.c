...
void kernel_3414152325_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-1; i_0++) {
        A[i_0] = E[i_0] - E[i_0+2] + E[i_0] - E[i_0] * E[i_0] * E[i_0] - E[i_0] * E[i_0] + A[i_0-1] * A[i_0+1] + 6;
    }
    for (int i_1 = 3; i_1 < PB_M-1; i_1++) {
        for (int i_2 = 2; i_2 < min(-i_1+PB_M, PB_N); i_2++) {
            B[i_2+i_1][i_1-1] = F[i_2][i_1+1] * G[i_2+i_1-2][i_1][i_2+2] + E[i_2] * E[i_2+i_1] - A[i_2] * A[i_2-2] - B[i_2+i_1-2][i_1-3] + B[i_2+i_1-1][i_1-2] + 1;
        }
        for (int i_3 = 2; i_3 < min(min(PB_N, -i_1+PB_M-1), i_1); i_3++) {
            for (int i_4 = 2; i_4 < -i_1+PB_M; i_4++) {
                D[i_3+i_1-1][i_1+1][i_4-2] = G[i_1][i_3][i_4+1] * F[i_3][i_4+i_1] + D[i_3+i_1-1][i_3+1][i_4] * D[i_3+i_1-1][i_1+1][i_4] * 4;
                D[i_3+i_1-1][i_1+1][i_4] = H[i_3+2][i_1][i_4][i_1] + G[i_3][i_1][i_4-2] + G[i_4][i_1+1][i_3+1] - G[i_3+i_1][i_4][i_3-2] + G[i_4-2][i_1][i_3] - D[i_3+i_1+1][i_1+1][i_4] - 4;
            }
        }
    }
#pragma endscop
...
kernel_3414152325_02(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
