...
void kernel_2322352225_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N-2; i_0++) {
        B[i_0+1] = D[i_0] - D[i_0] - D[i_0+2] + D[i_0+1] - E[i_0+2] - E[0] - 6;
    }
    for (int i_1 = 1; i_1 < PB_N; i_1++) {
        B[i_1+2] = E[i_1+2] - F[i_1] + E[i_1] * G[i_1-1][0] * B[i_1] + B[i_1+3] - 4;
        for (int i_2 = 2; i_2 < -i_1+PB_N; i_2++) {
            B[i_1+3] = H[i_2][i_1+1][i_2-2] - G[i_2][i_1-1] - D[i_2+i_1] * I[i_2][i_1][i_2] + 5;
        }
    }
#pragma endscop
...
kernel_2322352225_00(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
