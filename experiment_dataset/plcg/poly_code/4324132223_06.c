...
void kernel_4324132223_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
...
#pragma scop
        ...
        for (int i_1 = 2; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 2; i_2 < PB_P-2; i_2++) {
                for (int i_3 = 0; i_3 < -i_2+PB_P; i_3++) {
                    A[i_0-2][i_3+1][i_2][i_1] = D[i_1][i_0][i_3+i_2][i_0] * D[i_1][i_2-1][i_3][i_0-2] + A[i_1-1][i_0+1][i_3][i_2-2] * A[i_3][i_1+1][i_2+2][i_0] - A[i_1-2][i_2-1][i_3][i_0] * 5;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < PB_P; i_5++) {
            for (int i_6 = 1; i_6 < PB_L; i_6++) {
                for (int i_7 = 0; i_7 < PB_L-1; i_7++) {
                    A[i_4-3][i_7+1][i_6-1][i_5] = D[i_7][i_6][i_5][0] + 1;
                }
            }
        }
    }
    for (int i_8 = 1; i_8 < PB_L; i_8++) {
        for (int i_9 = 2; i_9 < -i_8+PB_L; i_9++) {
            C[i_9+1][i_8][i_8-1] = E[i_9-2][i_8] * F[i_9][i_8+1][i_9] + E[i_9+i_8][i_9] * E[i_8][i_9] + 3;
        }
    }
#pragma endscop
...
kernel_4324132223_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
