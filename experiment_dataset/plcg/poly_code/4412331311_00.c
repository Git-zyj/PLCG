...
void kernel_4412331311_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,int zk,int vk,DATA_TYPE POLYBENCH_4D(K,xK,yK,zK,vK,xk,yk,zk,vk)){
        ...
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            for (int i_2 = max(2, i_0); i_2 < PB_Q; i_2++) {
                for (int i_3 = 1; i_3 < PB_M; i_3++) {
                    A[i_3-1][i_1-1][i_2][i_0] = E[i_1][i_3-1][i_1][i_2] + A[i_1-1][i_2-2][i_0-1][i_3] * B[i_3][i_0][i_0][i_1] * 6;
                }
            }
        }
        for (int i_4 = 1; i_4 < -i_0+PB_M-1; i_4++) {
            for (int i_5 = 1; i_5 < PB_Q-1; i_5++) {
                B[i_4][i_0][i_0][i_5] = F[i_5][i_0][i_4] - F[i_5][i_0][0] - B[i_0][i_5-1][i_5-1][i_4] - B[i_4-1][i_0][i_0][i_5] * B[i_4][i_0][i_0][i_5-1] + B[i_4][i_0][i_0][i_5+1] * 5;
            }
            C[i_4+i_0][i_4] = G[i_0+1][i_4+1] - H[i_4+i_0][i_4] * I[1] + J[i_4-1][i_0] * G[i_0][i_4] - G[i_4][i_0] - C[i_4+i_0+1][i_4+1] - C[i_4+i_0-1][i_4-1] + 5;
        }
    }
        ...
        for (int i_7 = 1; i_7 < -i_6+PB_P; i_7++) {
            for (int i_8 = 1; i_8 < -i_6+PB_L; i_8++) {
                for (int i_9 = 1; i_9 < min(-i_6+PB_L, PB_M-1); i_9++) {
                    D[i_8][i_9+i_6][i_7][i_9-1] = E[i_9+1][i_8+i_6][i_7+i_6][0] - K[i_7][i_9+i_6][i_8][i_8+i_6] + A[i_7-1][i_9][i_6][i_8-1] + D[i_9][i_8+i_6][i_7][i_6-2] * 4;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4412331311_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K));
