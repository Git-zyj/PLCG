...
void kernel_2214211315_02(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        ...
        A[i_0][i_0] = C[i_0+1] - A[i_0][i_0] * A[i_0+1][i_0+1] + 4;
    }
#pragma endscop
...
kernel_2214211315_02(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
