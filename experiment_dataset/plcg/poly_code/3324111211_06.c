...
void kernel_3324111211_06(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        ...
        for (int i_2 = 0; i_2 < -i_0+PB_M-1; i_2++) {
            for (int i_3 = 0; i_3 < i_2; i_3++) {
                B[i_2+i_0+1][i_2][i_3] = 5;
            }
            for (int i_4 = 1; i_4 < i_2; i_4++) {
                C[i_0][i_4][i_4] = D[i_2][i_4][i_0-1] * D[i_4-1][i_2+i_0][i_0] * C[i_4-1][i_0][i_0] + C[i_0+1][i_4][i_4] * C[i_0+1][i_2][i_2] - 6;
            }
        }
    }
#pragma endscop
...
kernel_3324111211_06(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
