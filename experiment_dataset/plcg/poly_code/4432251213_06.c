...
void kernel_4432251213_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P-1; i_0++) {
        for (int i_1 = 1; i_1 < min(-i_0+PB_Q-1, PB_M-1); i_1++) {
            for (int i_2 = 2; i_2 < PB_M-1; i_2++) {
                for (int i_3 = i_2; i_3 < min(min(min(-i_0+PB_Q, PB_M), -i_1+PB_M), -i_2+PB_P); i_3++) {
                    A[i_1][i_3-1][i_0][i_0-1] = E[i_2][i_3][i_1+i_0+1][i_1+1] * F[i_1][i_3][i_2+1] - G[i_2][i_0][i_3+i_1][0] * H[i_1+1][i_0][i_3-1][i_2][1] * E[i_3][i_0][i_2+1][i_1] - G[i_3+i_1][i_0][i_3+i_2][i_2] + G[i_2-1][i_3][i_1][i_3+i_0] + A[i_1][i_3-2][i_0+1][i_0] * A[i_1+1][i_3-1][i_0][i_0-1] + A[i_3][i_1-1][i_2-1][i_2-2] * 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-2; i_4++) {
        for (int i_5 = 1; i_5 < -i_4+PB_M; i_5++) {
            B[i_5][i_4] = I[i_4][0] * J[i_5+i_4] * I[i_5+1][i_4+1] * F[i_5-1][i_5][i_4] + K[i_4-1][i_5] - 4;
        }
        C[i_4] = L[i_4] - J[i_4] - L[i_4] - L[i_4] - L[i_4] * K[i_4][i_4] * D[i_4] - 6;
        D[i_4+1] = J[i_4] - L[i_4] - C[i_4] * D[i_4+2] + 5;
    }
#pragma endscop
