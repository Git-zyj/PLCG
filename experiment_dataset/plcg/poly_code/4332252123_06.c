...
void kernel_4332252123_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            for (int i_2 = 2; i_2 < PB_L-2; i_2++) {
                for (int i_3 = 0; i_3 < min(min(-i_0+PB_M, -i_2+PB_Q), -i_1+PB_N); i_3++) {
                    A[i_0][i_2][i_1][i_3] = D[i_3+i_1][i_0][i_0+2][0] * D[i_2+1][i_3+i_1][i_0+2][i_0+2] + D[i_3][i_2+2][i_0][i_1] + D[i_1][i_0+2][i_3+i_0][i_2-2] + E[i_2+2][i_3][i_1-1][i_0] * E[i_0+2][i_1][i_3+i_2][i_2] * E[i_3+1][i_2][i_1][i_3] + 3;
                }
            }
        }
        B[i_0-1] = F[i_0] - B[i_0-2] * B[i_0] * 3;
    }
    for (int i_4 = 2; i_4 < PB_M; i_4++) {
        B[i_4-1] = G[i_4-2] - F[i_4] - F[i_4] + G[i_4] - F[i_4] * G[i_4-1] * G[i_4] - 2;
    }
#pragma endscop
...
kernel_4332252123_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
