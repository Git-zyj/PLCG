...
void kernel_3122312111_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_Q-1; i_0++) {
        for (int i_1 = 2; i_1 < PB_P+2; i_1++) {
            A[0][i_1-2][i_0] = B[i_1-1] * A[0][i_1-2][i_0+1] * 5;
        }
    }
#pragma endscop
...
kernel_3122312111_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
