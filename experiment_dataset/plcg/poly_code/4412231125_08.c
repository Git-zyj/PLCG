...
void kernel_4412231125_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,int wg,DATA_TYPE POLYBENCH_5D(G,xG,yG,zG,vG,wG,xg,yg,zg,vg,wg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk)){
...
#pragma scop
        ...
        for (int i_3 = 0; i_3 < PB_P-2; i_3++) {
            for (int i_4 = 1; i_4 < -i_3+PB_P; i_4++) {
                for (int i_5 = 0; i_5 < -i_3+PB_P-2; i_5++) {
                    B[i_5][i_4+i_3][i_0+1][i_0] = E[i_4][i_3][i_5][i_4+i_3] - F[i_5+1][i_4][i_3+1] * E[i_0][i_5+i_4][i_3][0] - G[i_0+1][1][i_4][i_5][i_3] - H[i_5][i_4-1][i_3][i_4] - B[i_4][i_5+i_3+2][i_0+3][i_0+2] + 4;
                }
            }
        }
    }
    for (int i_6 = 0; i_6 < PB_M; i_6++) {
        C[i_6] = I[i_6] - 6;
        D[i_6] = J[i_6][i_6] + K[i_6] * K[0] + K[i_6] * 4;
    }
#pragma endscop
...
kernel_4412231125_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K));
