...
void kernel_4224311325_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            for (int i_2 = 0; i_2 < i_1; i_2++) {
                for (int i_3 = 2; i_3 < PB_Q-2; i_3++) {
                    A[i_0-1][i_2+1][i_1][i_3] = A[i_1][i_2+1][i_0+1][i_3+2] + A[i_1-1][i_3][i_2][i_0+2] - A[i_0-2][i_2+1][i_1][i_3-2] + 3;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M; i_4++) {
        for (int i_5 = 1; i_5 < PB_M-2; i_5++) {
            B[i_5] = C[i_5-1] * B[i_5+2] + B[i_5-1] * 3;
        }
    }
#pragma endscop
...
kernel_4224311325_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
