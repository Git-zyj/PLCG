...
void kernel_3314112225_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_P; i_0++) {
        for (int i_1 = max(1, i_0); i_1 < PB_M; i_1++) {
            for (int i_2 = 0; i_2 < PB_L; i_2++) {
                A[i_1][i_2][i_2] = D[i_2][i_1-1][i_0] * 3;
            }
        }
    }
    for (int i_3 = 0; i_3 < PB_P-1; i_3++) {
        for (int i_4 = 1; i_4 < i_3; i_4++) {
            for (int i_5 = i_3; i_5 < PB_L; i_5++) {
                A[i_4][i_3][i_3] = 4;
                A[i_4][i_5][i_5] = D[i_4-1][i_5][i_3+1] * D[i_4][i_3+2][i_5] + A[i_4][i_3][i_3] - A[i_4][i_5][i_5] + 1;
            }
        }
    }
#pragma endscop
...
kernel_3314112225_06(xa,ya,za,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D));
