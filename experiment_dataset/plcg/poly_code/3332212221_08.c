...
void kernel_3332212221_08(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_2 = 3; i_2 < PB_M-2; i_2++) {
        for (int i_3 = 2; i_3 < -i_2+PB_M-2; i_3++) {
            for (int i_4 = 0; i_4 < -i_3+PB_M; i_4++) {
                B[i_4+i_3][i_3+i_2][i_2] = B[i_4+i_3-2][i_3+i_2-3][i_2-1] - B[i_4+i_3][i_3+i_2+2][i_2+2] + 3;
            }
        }
    }
    for (int i_5 = 0; i_5 < PB_M; i_5++) {
        for (int i_6 = 0; i_6 < PB_P-2; i_6++) {
            for (int i_7 = 0; i_7 < PB_M; i_7++) {
                C[i_5][i_6+2][i_6+2] = D[i_5][i_7][i_6+2] - C[i_5][i_6+1][i_6+1] + 2;
            }
        }
    }
#pragma endscop
...
kernel_3332212221_08(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
