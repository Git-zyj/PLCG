...
void kernel_3334212321_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_2 = 2; i_2 < PB_P; i_2++) {
        for (int i_3 = 1; i_3 < i_2; i_3++) {
            for (int i_4 = 2; i_4 < PB_P; i_4++) {
                B[i_2][i_4][i_3] = D[i_3][i_4][i_2] + B[i_2-1][i_3][i_4] * B[i_2+2][i_4][i_3] + B[i_2-2][i_4-2][i_3-1] - B[i_2][i_4+2][i_3] + 4;
            }
        }
        for (int i_5 = 2; i_5 < PB_L-2; i_5++) {
            C[i_5][i_2] = C[i_5+1][i_2-1] - C[i_5+2][i_2-2] * C[i_2][i_5-2] + C[i_5][i_2+1] + C[i_5+1][i_2] + 6;
        }
    }
#pragma endscop
...
kernel_3334212321_04(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
