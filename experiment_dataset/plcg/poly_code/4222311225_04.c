...
void kernel_4222311225_04(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        B[i_0][i_0] = B[i_0-2][i_0-2] + B[i_0+2][i_0+2] * 6;
        for (int i_1 = 0; i_1 < PB_M; i_1++) {
            B[i_1][i_1] = C[i_1][i_0] * 5;
        }
    }
#pragma endscop
...
kernel_4222311225_04(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
