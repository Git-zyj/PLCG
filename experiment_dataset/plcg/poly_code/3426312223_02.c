...
void kernel_3426312223_02(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
...
#pragma scop
    ...
    for (int i_2 = 2; i_2 < PB_M; i_2++) {
        for (int i_3 = 2; i_3 < min(i_2, -i_2+PB_M); i_3++) {
            B[i_3+i_2][i_2] = 1;
            for (int i_4 = 1; i_4 < min(min(-i_3+PB_M-1, PB_P+1), i_2); i_4++) {
                C[i_2][i_3][i_4-1] = B[i_4+i_3][i_3] + B[i_4+i_3+1][i_3] * C[i_2][i_3-2][i_4-1] - C[i_2-2][i_3][i_4-1] - 3;
            }
        }
        D[i_2] = E[i_2-2][0] * 3;
    }
...
kernel_3426312223_02(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
