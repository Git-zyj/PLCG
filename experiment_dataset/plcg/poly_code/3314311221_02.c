...
void kernel_3314311221_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 0; i_1 < -i_0+PB_L-1; i_1++) {
            A[i_0][i_1+i_0][i_1] = A[i_0+1][i_1+i_0+1][i_1] + A[i_1][i_1+i_0-2][i_0-2] - 2;
        }
    }
    for (int i_2 = 1; i_2 < PB_N; i_2++) {
        ...
        for (int i_3 = 0; i_3 < -i_2+PB_M-2; i_3++) {
            for (int i_4 = 0; i_4 < i_2; i_4++) {
                C[i_3+i_2+1][i_3][i_4] = D[i_2][i_3+1][i_4] - C[i_4+i_3+1][i_3][i_2-1] * C[i_3+i_2+2][i_2+1][i_4] + 6;
            }
        }
    }
#pragma endscop
...
kernel_3314311221_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
