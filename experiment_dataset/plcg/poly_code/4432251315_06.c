...
void kernel_4432251315_06(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        A[i_0][i_0] = E[i_0] + F[i_0+1] * E[i_0] + F[i_0+1] * A[i_0+1][i_0+1] + A[i_0-1][i_0-1] * 2;
        A[i_0][i_0] = E[i_0] * F[i_0] * G[i_0][i_0] - E[i_0] - E[i_0+1] + E[i_0-1] * A[i_0][i_0] - 3;
    }
        ...
        for (int i_2 = 1; i_2 < min(-i_1+PB_M, PB_L-1); i_2++) {
            for (int i_3 = 0; i_3 < min(-i_1+PB_L-1, -i_2+PB_Q-1); i_3++) {
                for (int i_4 = 0; i_4 < -i_1+PB_L-1; i_4++) {
                    C[i_4][i_2+1][i_3+i_1+1][i_1-1] = H[i_4][i_1-1][i_2][i_1-1] - I[i_3+1][i_4+1][i_2+1] - J[i_4][i_1][i_2][i_3+i_2+1] - I[i_4+1][i_2+i_1][i_3+1] - H[i_4][i_3][i_2][i_1] * C[i_2-1][i_3][i_4+i_1+1][i_1-1] - C[i_4][i_2+1][i_3+i_1+1][i_1] - 5;
                }
            }
        }
    }
    for (int i_5 = 1; i_5 < PB_L-1; i_5++) {
        for (int i_6 = 1; i_6 < min(PB_L, -i_5+PB_M); i_6++) {
            A[i_5+1][i_5+1] = K[i_6][i_5] * G[i_6+i_5][0] - K[i_6][i_5+1] - F[i_6-1] * K[i_6][i_5-1] + 4;
        }
    }
#pragma endscop
...
init_array(xa,ya,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4432251315_06(xa,ya,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,ya,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K)));
