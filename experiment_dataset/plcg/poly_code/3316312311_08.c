...
void kernel_3316312311_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_N-2; i_0++) {
        ...
        for (int i_2 = 1; i_2 < -i_0+PB_N-2; i_2++) {
            C[i_2+i_0+1][i_2] = B[i_2] * B[i_0] * B[i_2-1] - B[i_0+1] - C[i_2+i_0+2][i_2] * C[i_2+i_0+1][i_2-1] * C[i_2+i_0][i_0] - C[i_2+i_0+2][i_2+1] + 6;
        }
    }
#pragma endscop
...
kernel_3316312311_08(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
