...
void kernel_4326311121_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
    ...
    for (int i_3 = 3; i_3 < PB_M-3; i_3++) {
        for (int i_4 = i_3; i_4 < PB_M-1; i_4++) {
            for (int i_5 = 1; i_5 < PB_M+1; i_5++) {
                B[i_3-1][i_4+1][i_5-1] = D[i_5-1][i_4+1][i_3] - B[i_3-3][i_4][i_5-1] - C[i_3+3][i_4-1][i_5] - 5;
            }
        }
        for (int i_6 = 1; i_6 < i_3; i_6++) {
            for (int i_7 = 1; i_7 < PB_M-1; i_7++) {
                C[i_3+1][i_7-1][i_6-1] = E[i_7+1][i_3] - 2;
            }
        }
    }
#pragma endscop
...
kernel_4326311121_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
