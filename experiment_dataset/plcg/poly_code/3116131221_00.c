...
void kernel_3116131221_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_L; i_0++) {
        A[i_0-1] = B[i_0] - B[i_0] + B[i_0] + A[i_0] - A[i_0-3] * 2;
    }
#pragma endscop
...
kernel_3116131221_00(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
