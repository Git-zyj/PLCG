        ...
        for (int i_1 = 0; i_1 < min(PB_M-3, -i_0+PB_M-1); i_1++) {
            for (int i_2 = 2; i_2 < -i_1+PB_M-3; i_2++) {
                for (int i_3 = max(2, i_0); i_3 < PB_L-4; i_3++) {
                    B[i_2+i_1+3][i_3+4][i_3+2] = E[i_2][i_2-2][i_3][i_0+1] - F[i_3][i_3-2][i_1][i_0] - F[i_1][i_3][i_2+i_0-1][i_1+i_0] * F[1][i_1+i_0+1][i_0+1][i_2+2] * 4;
                }
            }
            for (int i_4 = i_1; i_4 < -i_1+PB_M-3; i_4++) {
                for (int i_5 = 1; i_5 < -i_1+PB_M-2; i_5++) {
                    B[i_5+i_1+2][i_4+2][i_4] = G[i_1][i_4][i_0][i_5] + F[i_5-1][i_0+2][i_1][1] + E[i_4][i_4][i_5][i_0] * B[i_4+i_1+3][i_5+2][i_5] * 3;
                }
            }
        }
        for (int i_6 = 1; i_6 < i_0; i_6++) {
            for (int i_7 = i_0; i_7 < -i_6+PB_M; i_7++) {
                for (int i_8 = 2; i_8 < PB_Q-2; i_8++) {
                    B[i_7+i_6][i_8+2][i_8] = H[i_7-1][i_6][i_8-2][i_8+2][i_0] - G[i_8][i_0-1][i_6-1][i_7] * 5;
                }
            }
        }
    }
    for (int i_9 = 0; i_9 < PB_M-2; i_9++) {
        D[0] = I[i_9+1] + I[i_9+2] * I[i_9] * D[0] + 5;
    }
#pragma endscop
...
init_array(xb,yb,zb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4416332123_01(xb,yb,zb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xb,yb,zb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I)));
