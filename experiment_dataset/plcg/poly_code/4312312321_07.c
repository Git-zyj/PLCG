...
void kernel_4312312321_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
        ...
        for (int i_1 = 0; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 2; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 3; i_3 < PB_L-2; i_3++) {
                    A[i_1][i_3+1][i_2-1][i_0] = D[i_2][i_3+2][i_2][i_0] - A[i_1][i_3-1][i_2-2][i_0] + A[i_1][i_3+1][i_2-1][i_0-2] - A[i_0+1][i_2+1][i_3-3][i_1] + A[i_1+1][i_0+1][i_3-1][i_2+2] * 4;
                }
            }
        }
        B[i_0] = E[0] * B[i_0-2] * B[i_0+1] + B[i_0+2] * 5;
        for (int i_4 = 0; i_4 < PB_L-2; i_4++) {
            for (int i_5 = 1; i_5 < PB_L-1; i_5++) {
                for (int i_6 = 0; i_6 < PB_L-1; i_6++) {
                    C[i_0][i_0+1][i_6][i_5-1] = C[i_5][i_5+1][i_6+1][i_0-3] - C[i_0][i_0+1][i_4+2][i_6+1] * 5;
                }
            }
        }
    }
...
kernel_4312312321_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
