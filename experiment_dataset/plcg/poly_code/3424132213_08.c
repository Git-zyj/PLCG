...
void kernel_3424132213_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
    ...
    for (int i_2 = 1; i_2 < PB_L-2; i_2++) {
        for (int i_3 = 1; i_3 < min(-i_2+PB_L-2, i_2); i_3++) {
            for (int i_4 = 2; i_4 < -i_2+PB_L-1; i_4++) {
                C[i_2][i_3][i_4] = F[i_4][i_4][i_2] * F[i_3][i_4+i_2+1][i_3-1] + G[i_4][i_3] - F[i_4][i_3+i_2+2][i_4-2] - F[i_3-1][i_4][i_2] * F[i_3][i_2][i_4] + G[i_2][i_3] + C[i_2-1][i_3][i_4] * C[i_2-1][i_3+1][i_4-1] - 2;
            }
        }
        A[i_2+1] = E[i_2+2] * E[i_2] - 6;
    }
#pragma endscop
...
kernel_3424132213_08(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
