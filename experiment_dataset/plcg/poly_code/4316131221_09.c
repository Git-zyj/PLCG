...
void kernel_4316131221_09(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf)){
        ...
        for (int i_1 = i_0; i_1 < -i_0+PB_Q+1; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_Q; i_2++) {
                for (int i_3 = 1; i_3 < -i_1+PB_M; i_3++) {
                    A[i_1][i_3-1][i_2] = D[i_1][i_2][i_2] - E[i_1][i_2+1][i_2][i_0] * E[i_3+i_1][i_3][i_2+i_0][i_0] + A[i_2][i_1-1][i_3+2] + 3;
                }
            }
            for (int i_4 = 1; i_4 < -i_1+PB_L; i_4++) {
                for (int i_5 = 1; i_5 < -i_0+PB_M; i_5++) {
                    B[i_5-1][i_0][i_4][i_1+i_0-1] = E[i_5+i_0][i_4+i_1][i_1+1][1] + E[i_4-1][i_1+1][i_0+1][i_5] - E[i_5][i_4][i_0][i_0-1] - B[i_5][i_4][i_0][i_4+i_1-1] + B[i_5-1][i_0-2][i_4][i_1+i_0-3] + 2;
                }
            }
        }
        for (int i_6 = 0; i_6 < min(-i_0+PB_M, i_0); i_6++) {
            C[i_0][i_6] = F[i_6+i_0][i_6+1] * F[i_6][i_0] + C[i_6][i_0-2] - 6;
        }
    }
#pragma endscop
...
kernel_4316131221_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
