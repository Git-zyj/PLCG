...
void kernel_4424332225_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj)){
        ...
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < PB_M; i_2++) {
                for (int i_3 = 0; i_3 < PB_M; i_3++) {
                    A[i_0][i_1][i_2-1][i_2] = E[2][i_0-2][i_1][i_0-1] - A[i_0+2][i_1][i_2+1][i_2+2] - 6;
                }
            }
        }
        for (int i_4 = 0; i_4 < PB_P; i_4++) {
            for (int i_5 = 1; i_5 < min(-i_0+PB_L, i_0); i_5++) {
                for (int i_6 = 0; i_6 < min(-i_0+PB_Q, -i_5+PB_M); i_6++) {
                    C[i_0-1][i_0-3][i_5-1][i_6] = F[i_0][i_6][i_4][i_6+i_5] * E[i_6+i_5][i_5+i_0][i_4][i_6+i_0] - 3;
                }
            }
        }
    }
        ...
        for (int i_8 = 0; i_8 < PB_P; i_8++) {
            for (int i_9 = 4; i_9 < PB_M-2; i_9++) {
                for (int j_0 = 0; j_0 < min(i_8, PB_P-1); j_0++) {
                    C[i_9][i_9-2][i_8][i_7] = E[i_9+2][i_7][j_0+1][i_8] + E[i_7][j_0][i_8][i_9] - G[0][i_9][j_0][i_7-2] * C[i_9-2][i_9-4][j_0][i_7] * 2;
                }
            }
        }
    }
    for (int j_1 = 2; j_1 < PB_L-2; j_1++) {
        for (int j_2 = 2; j_2 < -j_1+PB_L; j_2++) {
            for (int j_3 = 1; j_3 < PB_M; j_3++) {
                D[j_1][j_2][j_3] = H[j_3-1][j_2][0] * I[j_1][j_3+j_2-2][0] * J[j_3][j_1][1] - H[j_2][j_1][0] - G[j_3][j_2][j_2+j_1][j_3+2] - H[j_3][j_2+j_1][j_3] + D[j_1+2][j_2][j_3] * D[j_1-2][j_2][j_3] * 3;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4424332225_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J)));
