...
void kernel_4326151325_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        for (int i_1 = i_0; i_1 < PB_L; i_1++) {
            A[i_0][i_1] = D[i_1][i_0-1] + E[i_1+1] + D[i_0][i_1] * A[i_0][i_1-1] + A[i_1+1][i_0] * 1;
        }
    }
        ...
        for (int i_3 = 0; i_3 < -i_2+PB_L; i_3++) {
            for (int i_4 = 1; i_4 < i_3; i_4++) {
                for (int i_5 = 0; i_5 < PB_L; i_5++) {
                    B[i_3][i_4][i_2][i_5] = F[i_4][i_5][i_3+i_2] - F[i_5+i_3][i_5][i_4+1] - G[i_5+1][i_4][i_2][i_5] - G[i_4+1][i_5][i_3][i_2] + H[i_4][i_5][i_2][i_3][i_4+1] * G[i_5+1][i_4-1][i_2][i_3] + G[i_2+1][i_4][i_5][i_3] - B[i_2+1][i_4][i_3][i_5] * B[i_3][i_4][i_2-2][i_5] - B[i_5+2][i_4][i_3][i_2] * 6;
                }
            }
        }
    }
    for (int i_6 = 0; i_6 < PB_L-2; i_6++) {
        for (int i_7 = 1; i_7 < min(i_6, -i_6+PB_M-1); i_7++) {
            A[i_7][i_6+2] = E[i_7] + D[i_7][i_6] - D[i_6][i_7+i_6+1] * D[i_7][i_6] * A[i_7-1][i_6+1] + 3;
        }
    }
#pragma endscop
...
kernel_4326151325_00(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H));
