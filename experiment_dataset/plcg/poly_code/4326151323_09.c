...
void kernel_4326151323_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg)){
        ...
        for (int i_1 = 2; i_1 < PB_L-1; i_1++) {
            for (int i_2 = i_0; i_2 < PB_P-1; i_2++) {
                for (int i_3 = 0; i_3 < -i_1+PB_P; i_3++) {
                    A[i_0][i_1+1][i_2+1][i_0] = D[i_0-1][i_2][i_3+1][i_1-1] - D[i_2-1][i_1-1][i_0][i_3+1] + D[i_2][i_0+1][i_1-1][i_3] - E[i_2][i_3+i_1][i_0] - D[i_1][i_0][i_2+1][i_3] - A[i_0-2][i_1+1][i_2+1][i_0-2] + 1;
                }
            }
            B[i_1] = F[i_1-1][i_0] + G[i_1] - G[0] * B[i_1+1] + B[i_1-1] + B[i_1-2] + 4;
        }
    }
    for (int i_4 = 0; i_4 < PB_P-1; i_4++) {
        for (int i_5 = 0; i_5 < min(i_4, -i_4+PB_L); i_5++) {
            for (int i_6 = 1; i_6 < PB_P-1; i_6++) {
                A[i_6][i_5+1][i_4+1][i_6] = E[i_6-1][i_5][i_4] * F[i_5+i_4][i_4] * E[i_5][i_4][i_6] * E[i_5][i_6-1][i_4] - F[i_6-1][i_5+1] * A[i_4][i_5+1][i_6+1][i_4] * B[i_6+1] * 1;
            }
        }
    }
#pragma endscop
...
kernel_4326151323_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
