...
void kernel_4414251221_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        A[i_0] = E[0] + E[i_0] - D[0] * 2;
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < PB_Q; i_2++) {
                for (int i_3 = 1; i_3 < min(min(-i_2+PB_L+1, -i_0+PB_M-1), -i_1+PB_P); i_3++) {
                    C[i_1][i_3][i_2] = F[i_1][i_3][i_2-1][i_0-1][i_0] - G[i_3-1][i_0-1][0] - H[i_0][i_3][i_3+i_1][i_2] * H[i_0][i_2+1][i_3-1][i_1] + I[i_2][i_1][i_0][i_3] * J[i_3][i_1][i_3+i_2-1] - I[i_0][i_3][i_2][1] * I[i_3+i_0+1][i_1][i_2][0] + G[i_2][i_0][i_1] * 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_Q-1; i_4++) {
        for (int i_5 = i_4; i_5 < -i_4+PB_Q-1; i_5++) {
            for (int i_6 = i_5; i_6 < -i_5+PB_Q-1; i_6++) {
                for (int i_7 = 2; i_7 < min(PB_Q-1, -i_4+PB_L); i_7++) {
                    C[i_4][i_7][i_5] = H[i_6][i_4][i_5][i_6] * F[i_7][i_6+1][i_7-1][i_5+i_4+1][i_6] * I[i_6+i_5][i_7+i_4][i_6+i_5+1][i_7+1] * I[i_5][i_5+i_4][i_7-1][i_6] * F[i_4][i_6][i_7][i_5][i_5-1] * H[i_5][i_4-1][i_7][i_6] - C[i_7-2][i_6][i_5] - 5;
                }
            }
            D[0] = K[i_5+1][i_4] + K[i_5-1][i_4] - D[0] + D[0] - 3;
        }
    }
#pragma endscop
...
init_array(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4414251221_00(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K)));
