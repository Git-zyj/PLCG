...
void kernel_4416352213_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl),int xm,int ym,DATA_TYPE POLYBENCH_2D(M,xM,yM,xm,ym)){
        ...
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            for (int i_2 = 2; i_2 < min(-i_0+PB_P+1, PB_L); i_2++) {
                for (int i_3 = 0; i_3 < min(-i_0+PB_Q, -i_1+PB_L); i_3++) {
                    A[i_2][i_0][i_3][i_1] = E[i_1-1][i_0+2][i_3+2][i_2] + F[i_3+i_1][i_3][i_0+2][i_2][i_0+2] * G[i_3+i_1][i_2-2][i_0][i_0-2] * H[i_3][i_1-1][i_2+i_0-1][i_3+i_0] - G[i_0][i_2][i_1-2][i_3] * H[i_2][i_0][i_1][i_3] - I[i_3+2][i_0][i_2+1] + H[i_0+2][i_1][i_3][2] - B[i_0][i_3+1][i_1] + 3;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        for (int i_5 = i_4; i_5 < -i_4+PB_M; i_5++) {
            for (int i_6 = 0; i_6 < min(-i_5+PB_L, -i_4+PB_M); i_6++) {
                B[i_4][i_5][i_6] = J[i_5+i_4-1][i_6][0] - I[i_5][i_6][i_5-1] - I[i_4][i_6+i_5][i_5] + I[i_5+i_4][i_6][0] * 2;
                for (int i_7 = 0; i_7 < i_6; i_7++) {
                    A[i_5][i_6][i_4-1][i_7] = E[i_7][i_6][i_7][i_6] - G[i_6][i_7+i_4][i_5][2] + E[i_5][i_7][i_6+i_4][2] * 4;
                }
            }
            D[i_5][i_4][i_4] = K[i_5][i_4] - L[i_5][i_4] - M[i_5][i_4] + D[i_4+1][i_5-1][i_5-1] * D[i_5-1][i_4][i_4] * D[i_4][i_5+1][i_5+1] * 3;
        }
    }
#pragma endscop
