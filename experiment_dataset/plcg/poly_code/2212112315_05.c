...
void kernel_2212112315_05(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    ...
    for (int i_2 = 2; i_2 < PB_Q; i_2++) {
        for (int i_3 = 1; i_3 < PB_Q; i_3++) {
            B[i_3][i_2-1][1] = C[i_3][i_2] + C[i_3][i_2] + B[i_3][i_2-2][1] * B[i_3+1][i_2-1][1] + B[i_3-1][i_2-1][1] - 4;
        }
    }
#pragma endscop
...
kernel_2212112315_05(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
