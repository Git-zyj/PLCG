        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_Q, -i_1+PB_Q+1); i_2++) {
                for (int i_3 = 1; i_3 < -i_2+PB_Q-1; i_3++) {
                    A[i_0][i_1-1][i_0-1][i_3+i_2+1] = D[i_0][i_3+i_2][i_1][1] * D[i_3-1][i_1][i_0][i_2+i_0] * E[i_2+1][i_0-1][i_3][i_2] + A[i_0][i_1-1][i_0-1][i_3+i_2-1] + A[i_0+2][i_3-1][i_0+1][i_2+i_1-1] - 2;
                }
            }
        }
        for (int i_4 = i_0; i_4 < PB_M-1; i_4++) {
            B[i_0-1][i_4] = F[i_4][i_0-1] - G[i_4][i_0] + H[i_0][i_4] * H[i_0+1][i_4-1] * F[i_4+1][i_0] - F[i_0+1][1] * F[i_4+1][i_0+1] + B[i_0-1][i_4-1] - B[i_0+1][i_4] - B[i_0][i_4] * 6;
            B[i_4-1][i_0+2] = F[i_4][i_0] - F[i_4][i_0+1] * F[i_0][i_4+1] + H[i_4][i_0+1] - 3;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4316351325_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H)));
