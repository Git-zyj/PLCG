...
void kernel_2334352315_06(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        C[i_0-2] = D[i_0-1] * D[i_0-1] - E[i_0] * D[i_0] - E[i_0+1] * E[i_0] + E[i_0+2] + B[i_0] - 3;
    }
    for (int i_1 = 2; i_1 < PB_L; i_1++) {
        B[i_1] = F[i_1][i_1] + E[i_1-1] + G[i_1][0] - E[i_1] - H[i_1] * E[i_1] + B[i_1-1] * B[i_1+1] * 3;
        C[i_1-2] = H[i_1] * B[i_1] * B[i_1+1] * 2;
    }
#pragma endscop
...
kernel_2334352315_06(xc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
