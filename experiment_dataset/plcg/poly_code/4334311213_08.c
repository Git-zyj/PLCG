        ...
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < min(PB_Q-1, i_1); i_2++) {
                for (int i_3 = 1; i_3 < PB_Q; i_3++) {
                    A[i_1][i_0][i_2][i_3] = A[i_1][i_0][i_2+1][i_3-1] - 6;
                }
            }
        }
        for (int i_4 = 0; i_4 < PB_P-1; i_4++) {
            for (int i_5 = max(1, i_0); i_5 < -i_0+PB_M; i_5++) {
                C[i_5][i_0][i_4+1] = D[i_0][i_4][i_4][i_5-1] * E[i_5+i_0][i_0][i_4][0] * 2;
            }
        }
    }
    for (int i_6 = 1; i_6 < PB_N; i_6++) {
        for (int i_7 = 1; i_7 < i_6; i_7++) {
            for (int i_8 = 0; i_8 < min(i_6, PB_M); i_8++) {
                C[i_6][i_7][i_8] = F[i_6][i_8][i_7] * C[i_6-1][i_7][i_8] * C[i_6][i_7-1][i_8] * 5;
            }
        }
    }
#pragma endscop
...
kernel_4334311213_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
