...
#pragma scop
    for (int i_0 = 0; i_0 < PB_P-1; i_0++) {
        ...
        for (int i_2 = min(-i_0+PB_L, i_0) - 1; i_2 >= 1; i_2--) {
            A[i_0][i_2] = G[i_2+i_0][1] - H[i_2+1][0] - G[i_2-1][i_0+1] * F[i_0] + E[i_2][i_0] * G[i_0][i_2] - 6;
        }
    }
    for (int i_3 = 1; i_3 < PB_P; i_3++) {
        C[i_3] = G[i_3][0] - F[i_3] - I[i_3+1] + J[i_3] - I[i_3] - I[i_3] - I[i_3] + I[i_3] * D[i_3+1] - 2;
        D[i_3] = J[i_3] + J[i_3] * J[i_3] - F[i_3-1] - 3;
    }
#pragma endscop
...
init_array(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_2424351113_06(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J)));
