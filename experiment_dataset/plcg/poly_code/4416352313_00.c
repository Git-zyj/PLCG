...
static void print_array(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl),int xm,DATA_TYPE POLYBENCH_1D(M,xM,xm),int xn,DATA_TYPE POLYBENCH_1D(N,xN,xn))
{
int i_0, i_1, i_2, i_3;
...
void kernel_4416352313_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl),int xm,DATA_TYPE POLYBENCH_1D(M,xM,xm),int xn,DATA_TYPE POLYBENCH_1D(N,xN,xn)){
        ...
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            for (int i_2 = i_1; i_2 < PB_Q-2; i_2++) {
                for (int i_3 = i_0; i_3 < PB_M-1; i_3++) {
                    A[i_3][i_0-1][i_2+2][i_1] = E[i_2-1][i_0][i_1][i_1] * F[i_2-1][i_3][i_2] - G[i_3][i_0][i_2][i_1+1] - H[i_1][i_3][i_0][i_2] - A[i_0-1][i_3-1][i_2+1][i_1] * A[i_3+1][i_0-1][i_2+2][i_1] + A[i_3][i_0][i_2+2][i_1-1] + A[i_0][i_3-1][i_2+2][i_1+1] + 6;
                }
            }
        }
        for (int i_4 = 3; i_4 < i_0; i_4++) {
            for (int i_5 = i_0; i_5 < min(-i_0+PB_M, -i_4+PB_M-1); i_5++) {
                B[i_5][i_4][1] = I[i_5+i_4+1][i_0][i_4] - I[i_0-1][0][i_4] * F[i_4][i_5][i_5+i_0] - I[i_4][i_0-1][i_5-1] - F[i_4][i_5+2][i_0] + C[i_5+1][i_4+1] - 4;
            }
            C[i_0][i_4] = J[i_4][i_0-1] + K[i_4-2][i_0] * L[i_0][i_4] + L[i_4][i_0-1] + J[i_4+1][i_0] + L[i_0][i_4] + B[i_4][i_0][1] * B[i_0][i_4+1][1] - D[i_4-2] + D[i_4-3] * 4;
        }
        D[i_0-2] = M[i_0+2] + M[i_0+2] - M[i_0+2] + N[i_0] + N[i_0] - D[i_0-1] - D[i_0-3] - D[i_0-3] + 4;
    }
#pragma endscop
