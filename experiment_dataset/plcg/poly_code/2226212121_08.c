...
void kernel_2226212121_08(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_2 = 2; i_2 < PB_L; i_2++) {
        B[i_2] = C[i_2-2] + C[i_2+2] * B[i_2-2] + 5;
    }
#pragma endscop
...
kernel_2226212121_08(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
