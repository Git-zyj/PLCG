...
void kernel_4216211125_09(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = PB_L-2 - 1; i_0 >= 0; i_0--) {
        for (int i_1 = 1; i_1 < PB_Q+1; i_1++) {
            ...
            B[i_0][i_1-1] = C[i_1+1][1] - B[i_0+2][i_1-1] + 1;
        }
    }
#pragma endscop
...
kernel_4216211125_09(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
