...
void kernel_4414351223_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl),int xm,int ym,DATA_TYPE POLYBENCH_2D(M,xM,yM,xm,ym)){
        ...
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 2; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 1; i_3 < min(min(-i_0+PB_L, i_2), -i_2+PB_L-1); i_3++) {
                    A[i_1+1][i_3+i_2][i_0][i_0] = E[i_0+1][i_3+1][i_2+1][i_2] + F[i_3][i_1][i_2-1] + G[i_2-1][i_3-1][i_1][i_0-1] * H[i_3-1][i_2][i_1-1][i_2] + E[i_0][i_2+1][i_2-1][i_3] - A[i_1+1][i_3+i_2-1][i_0][i_0] * A[i_2+1][i_3+i_0][i_1][i_1] + A[i_1+1][i_3+i_2-2][i_0][i_0] * A[i_1+1][i_3+i_2+1][i_0][i_0] * 3;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < -i_4+PB_M; i_5++) {
            for (int i_6 = 1; i_6 < -i_5+PB_Q-1; i_6++) {
                for (int i_7 = 1; i_7 < i_4; i_7++) {
                    B[i_4+1][i_5][i_7][i_6] = F[i_6][i_7][i_5] - I[i_7-1][i_6-1][i_6+i_5+1] - E[i_5][i_4][i_7][i_6+1] + H[i_7][i_5][i_4-1][i_6] + J[i_4][i_5+1][i_6+1] - H[i_7-1][i_4][i_5][i_4] + B[i_4+2][i_7][i_5][i_6-1] * 1;
                }
            }
            C[i_5] = K[i_5] - L[i_5+i_4][i_5] - L[i_4][0] * K[i_4] - C[i_5+1] * 5;
        }
        for (int i_8 = 1; i_8 < PB_M-2; i_8++) {
            for (int i_9 = 0; i_9 < -i_4+PB_L; i_9++) {
                D[i_4][i_9][i_8] = F[i_9][i_4+1][i_8] * M[i_9+1][i_4] + I[i_9+i_4][i_8-1][i_9] - M[i_8][i_9] - F[i_8][i_9][i_4] - D[i_8+2][i_9+1][i_4] * D[i_4][i_9+1][i_8] + 4;
            }
        }
    }
#pragma endscop
...
kernel_4414351223_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M));
