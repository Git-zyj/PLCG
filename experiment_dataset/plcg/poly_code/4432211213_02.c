...
void kernel_4432211213_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg)){
        ...
        for (int i_2 = i_1; i_2 < PB_L; i_2++) {
            for (int i_3 = 1; i_3 < -i_1+PB_P; i_3++) {
                for (int i_4 = 0; i_4 < PB_M; i_4++) {
                    D[i_1-1][i_4][i_3][i_2] = F[i_3-1][i_4][i_2+1][i_1] - G[i_2][i_4][i_1][i_3+i_1] - 2;
                }
            }
            for (int i_5 = 2; i_5 < PB_L+1; i_5++) {
                for (int i_6 = 1; i_6 < PB_L; i_6++) {
                    D[i_1-1][i_6][i_5-1][i_2] = G[i_6][i_5+1][i_1+1][i_1] * D[i_1-2][i_2][i_5-1][i_6] - D[i_5-2][i_1-1][i_6-1][i_2] * D[i_1-1][i_6][i_5-1][i_2+1] - 2;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4432211213_02(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G)));
