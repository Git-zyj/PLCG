        ...
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_Q; i_2++) {
                for (int i_3 = 1; i_3 < PB_L; i_3++) {
                    A[i_3-1][i_2][i_2+i_0] = D[i_2][i_3][i_0][i_1] * D[i_3][i_2][i_1-1][i_2+i_0] * E[i_2+1][i_3-1][i_3] * F[i_2][i_3][i_1][i_0+1] + G[i_3][i_2+1][i_1+1][i_0] * D[i_1][i_0+1][i_3][i_2] - 5;
                }
            }
        }
        for (int i_4 = 1; i_4 < min(-i_0+PB_M-1, i_0); i_4++) {
            for (int i_5 = 1; i_5 < -i_0+PB_L; i_5++) {
                B[i_4][i_0][i_0+1] = H[i_5][i_4+i_0][0] * H[i_5][i_0][i_4-1] - E[i_4][i_5][i_0] + C[i_4][i_0] - C[i_5-1][i_4] * C[i_4][i_5+1] - 5;
                C[i_4][i_5] = E[i_4+i_0+1][i_5-1][i_4+1] * I[i_4][i_5+i_0][0] + J[i_5][i_4+1] * E[i_4][i_5][i_0+1] + B[i_4][i_0][i_0+1] + C[i_4][i_5-1] + C[i_0-1][i_5] + 3;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4312351211_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J)));
