...
void kernel_2426351123_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N; i_0++) {
        for (int i_1 = 0; i_1 < min(i_0, -i_0+PB_N); i_1++) {
            A[i_1+1] = E[i_0-1][i_1] + E[i_1+1][i_0-1] - F[i_1][i_0] - E[i_1][i_0] + F[i_1+i_0][i_0] - G[i_1][i_1] - F[i_1][i_1] + H[i_0] * F[i_1][i_1+i_0] * 1;
        }
        B[i_0] = I[i_0-1] + H[i_0+1] + A[i_0+2] - 5;
    }
    for (int i_2 = 1; i_2 < PB_N-1; i_2++) {
        C[i_2+1] = J[i_2+1] + I[i_2-1] - B[i_2] - 6;
        for (int i_3 = 1; i_3 < -i_2+PB_N; i_3++) {
            C[i_3+1] = G[i_3+1][i_2-1] + G[i_3][i_2] * G[i_3+i_2+1][i_3+1] - F[i_3+i_2-1][0] - F[i_2+1][i_3+i_2] - E[i_3-1][i_2] * 1;
        }
    }
#pragma endscop
...
kernel_2426351123_08(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
