...
void kernel_2222232113_08(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        A[i_0][i_0] = C[i_0] * D[i_0-2] * C[i_0] * A[i_0-1][i_0-1] * 2;
    }
    for (int i_1 = 0; i_1 < PB_P; i_1++) {
        A[i_1][i_1] = C[i_1+2] - C[i_1+2] - 4;
    }
#pragma endscop
...
kernel_2222232113_08(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
