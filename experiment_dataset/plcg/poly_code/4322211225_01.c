...
void kernel_4322211225_01(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd)){
        ...
        for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
            for (int i_5 = 0; i_5 < PB_Q; i_5++) {
                for (int i_6 = 0; i_6 < PB_Q; i_6++) {
                    B[i_4+1][i_0][i_5][i_6] = B[i_4-1][i_0][i_5][i_6] + 4;
                }
            }
        }
    }
    for (int i_7 = 0; i_7 < PB_L-1; i_7++) {
        for (int i_8 = 1; i_8 < min(-i_7+PB_P, i_7); i_8++) {
            for (int i_9 = 0; i_9 < PB_P-1; i_9++) {
                C[i_7][i_8][i_9] = D[i_9][i_7+1][i_8+i_7][i_8-1] * C[i_7][i_8][i_9+1] * C[i_7+1][i_8][i_9] * 4;
            }
        }
    }
#pragma endscop
...
kernel_4322211225_01(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D));
