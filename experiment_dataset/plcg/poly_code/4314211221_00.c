...
void kernel_4314211221_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_2 = 1; i_2 < -i_1+PB_P; i_2++) {
            for (int i_3 = 1; i_3 < i_2; i_3++) {
                for (int i_4 = 0; i_4 < PB_Q-1; i_4++) {
                    B[i_2][i_3][i_4+1] = B[i_2][i_3-1][i_4+1] + 1;
                }
            }
            for (int i_5 = 2; i_5 < PB_M-1; i_5++) {
                C[i_5][i_2-1][i_2+i_1] = D[i_2-1][i_5+1][i_2] * B[i_5][i_1][i_2+1] + C[i_5-2][i_2-1][i_2+i_1] + 3;
            }
        }
    }
#pragma endscop
...
kernel_4314211221_00(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
