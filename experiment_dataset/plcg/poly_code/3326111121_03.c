...
void kernel_3326111121_03(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_2 = 0; i_2 < PB_P-1; i_2++) {
        for (int i_3 = 2; i_3 < i_2; i_3++) {
            for (int i_4 = 0; i_4 < PB_P; i_4++) {
                B[i_3][i_4] = B[i_3-2][i_4] * 4;
            }
        }
        for (int i_5 = 1; i_5 < PB_P+1; i_5++) {
            for (int i_6 = 0; i_6 < PB_L; i_6++) {
                C[i_2][i_6][i_2+1] = D[i_6][i_5-1][i_2] - 5;
            }
        }
    }
#pragma endscop
...
kernel_3326111121_03(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
