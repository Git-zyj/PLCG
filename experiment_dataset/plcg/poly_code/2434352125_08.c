...
void kernel_2434352125_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        A[i_0] = E[i_0] - F[i_0] - G[i_0][i_0] + H[2] - A[i_0-1] * 6;
        for (int i_1 = 2; i_1 < min(-i_0+PB_M, i_0); i_1++) {
            B[i_0][i_0] = I[i_0][i_1] * J[i_0-1][i_1] * J[i_1-2][i_0] - J[i_1][i_0] * I[i_1][i_0] - I[i_1][i_0] - G[i_1+i_0][i_1] + 6;
        }
        B[i_0][i_0] = H[i_0+2] * E[i_0] + H[i_0-2] + F[i_0] * B[i_0][i_0] + 3;
    }
    for (int i_2 = 0; i_2 < PB_M-2; i_2++) {
        D[i_2+2] = F[i_2] * H[i_2] + H[i_2+2] - E[i_2] + 2;
    }
#pragma endscop
...
kernel_2434352125_08(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
