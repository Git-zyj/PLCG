...
void kernel_4214112113_07(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        ...
        for (int i_3 = 3; i_3 < -i_0+PB_P; i_3++) {
            for (int i_4 = 0; i_4 < PB_L-1; i_4++) {
                B[i_4][i_3-2] = C[i_0][i_4+1][i_3] - C[i_3][i_4][i_3+i_0] - B[i_0+1][i_3-3] * 1;
            }
        }
    }
#pragma endscop
...
kernel_4214112113_07(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
