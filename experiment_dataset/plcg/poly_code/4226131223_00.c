...
void kernel_4226131223_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-2; i_0++) {
        A[i_0][i_0] = C[i_0] - C[i_0] * A[i_0+2][i_0+2] + 6;
    }
    for (int i_1 = 1; i_1 < PB_M-2; i_1++) {
        A[i_1][i_1] = C[i_1-1] * C[i_1-1] * C[0] + C[i_1-1] + A[i_1+2][i_1+2] + 1;
    }
#pragma endscop
...
kernel_4226131223_00(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
