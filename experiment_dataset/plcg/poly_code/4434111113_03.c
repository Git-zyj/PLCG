    ...
    for (int i_1 = 0; i_1 < PB_M-1; i_1++) {
        for (int i_2 = 1; i_2 < PB_M; i_2++) {
            ...
            for (int i_5 = i_2; i_5 < PB_P-2; i_5++) {
                C[i_5+1][i_5+1] = B[i_2-1][i_1+1][i_5+1] - C[i_5+2][i_5+2] * 3;
            }
        }
    }
        ...
        for (int i_7 = 1; i_7 < PB_P; i_7++) {
            for (int i_8 = i_7; i_8 < PB_P-1; i_8++) {
                for (int i_9 = 0; i_9 < PB_L; i_9++) {
                    D[i_6+1][i_8+1][i_7-1][i_7-1] = E[i_6-1][i_9][i_7][i_8] + C[i_8+1][i_8+1] - 5;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), INIT_SEED);
kernel_4434111113_03(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E)));
