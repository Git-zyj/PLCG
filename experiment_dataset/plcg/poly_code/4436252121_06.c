...
void kernel_4436252121_06(int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj)){
...
#pragma scop
        ...
        for (int i_1 = 2; i_1 < -i_0+PB_L; i_1++) {
            for (int i_2 = 1; i_2 < min(i_0, -i_0+PB_P); i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_P; i_3++) {
                    D[i_1][i_1+i_0][i_2][i_3+1] = E[i_1-1][i_3+i_2+1][i_2+i_0][i_0][1] * F[i_2-1][i_1-2][i_2][i_3+i_0-2] - F[i_1][i_2+2][i_3+i_0][i_1-1] + G[i_3][i_2-1][i_1][i_2] - H[i_1+1][i_3][i_2] * E[i_2][i_3][i_0][i_1][i_0] - G[i_2][i_0][i_3+1][i_1] - 2;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M; i_4++) {
        for (int i_5 = 2; i_5 < min(min(i_4, -i_4+PB_M), PB_M-2); i_5++) {
            B[i_4][i_4] = I[i_5+2] - J[i_5+i_4][i_4] + J[i_5][i_4-1] - J[i_5][i_4] * J[i_5-2][i_4] + 4;
        }
    }
    for (int i_6 = 1; i_6 < PB_L-1; i_6++) {
        for (int i_7 = 0; i_7 < min(i_6, PB_P-2); i_7++) {
            for (int i_8 = 1; i_8 < -i_6+PB_L-1; i_8++) {
                for (int i_9 = max(i_6, 2); i_9 < PB_P; i_9++) {
                    D[i_8+1][i_8+i_6+1][i_7][i_9] = G[i_8][i_7][i_6-1][i_9] + F[i_8+i_6][i_9-2][i_7+2][0] - F[i_7][i_6][i_8][i_9] + 4;
                }
                for (int j_0 = 2; j_0 < PB_P-1; j_0++) {
                    D[i_8][i_8+i_6][i_7][j_0+1] = G[j_0-2][i_8+1][i_7][i_6] + F[i_8][i_7+1][i_6][i_6-1] * D[i_8-1][i_8+i_6-1][i_7][j_0+1] + 4;
                }
            }
        }
    }
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4436252121_06(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J)));
