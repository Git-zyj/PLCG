...
void kernel_4324231211_01(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,int wg,DATA_TYPE POLYBENCH_5D(G,xG,yG,zG,vG,wG,xg,yg,zg,vg,wg)){
        ...
        for (int i_1 = 0; i_1 < PB_M; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_L; i_3++) {
                    B[i_1][i_0][i_2+1][i_3] = D[i_0-1][i_3-1][i_1][i_1] * 3;
                }
            }
        }
    }
        ...
        for (int i_5 = i_4; i_5 < PB_M-1; i_5++) {
            for (int i_6 = 0; i_6 < i_5; i_6++) {
                for (int i_7 = 1; i_7 < PB_M-1; i_7++) {
                    B[i_5][i_4][i_6][i_7+1] = E[i_4][i_7+1][i_5][i_6+1] - E[i_6][i_4][i_7-1][i_5+1] * E[i_4][i_7-1][i_5][1] - D[i_7+1][i_6][i_4-1][i_5] - B[i_5+1][i_4+1][i_7][i_6] - B[i_5][i_7][i_6][i_4] + 5;
                }
            }
        }
        for (int i_8 = 1; i_8 < min(i_4, -i_4+PB_P); i_8++) {
            for (int i_9 = i_4; i_9 < min(-i_8+PB_L, -i_4+PB_L); i_9++) {
                for (int j_0 = 1; j_0 < min(min(-i_9+PB_P-1, -i_4+PB_P), -i_8+PB_L+1); j_0++) {
                    C[i_8][i_9+i_4][j_0] = F[i_4][i_9][i_8-1][i_9+1][i_4] * D[j_0-1][i_9+i_8][j_0+i_4][0] + G[i_8+1][i_4][j_0+i_9+1][i_9][i_4+1] - D[i_8-1][i_9+i_4][j_0+1][i_8+i_4] * C[i_9-1][j_0+i_8-1][i_4] + 1;
                }
            }
        }
    }
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4324231211_01(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G)));
