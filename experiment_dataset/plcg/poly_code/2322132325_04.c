...
void kernel_2322132325_04(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_M-2 - 1; i_0 >= 2; i_0--) {
        C[i_0] = D[i_0] * D[i_0] - D[i_0] - D[i_0] + C[i_0+1] - C[i_0] - 4;
        C[i_0-2] = D[i_0+2] + D[i_0] + D[i_0] * D[i_0-2] - C[i_0+1] + 1;
        C[i_0] = D[i_0] + 5;
    }
#pragma endscop
...
kernel_2322132325_04(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
