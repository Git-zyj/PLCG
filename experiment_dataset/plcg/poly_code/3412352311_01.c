...
void kernel_3412352311_01(int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            D[i_1-1] = E[i_1][i_0] + F[i_0] - G[i_0][i_1-1] - H[i_0][i_1+1] + E[i_0+1][0] + 1;
        }
        D[i_0-1] = F[i_0-1] - F[i_0] - I[i_0+2] - F[i_0] + 3;
        for (int i_2 = 1; i_2 < -i_0+PB_M+1; i_2++) {
            C[i_2][i_0] = G[i_2+i_0-1][i_2+1] + H[i_0][i_2] + F[i_2] + E[i_2+i_0-2][i_0] * C[i_2-1][i_0+1] - C[i_2+1][i_0] + C[i_2-1][i_0] * 3;
        }
    }
    for (int i_3 = 2; i_3 < PB_M-1; i_3++) {
        D[i_3] = E[i_3-2][i_3] - J[i_3-1] + I[i_3-1] - F[i_3] * I[i_3] + F[i_3] * I[i_3] + D[i_3-1] + D[i_3+1] * 2;
    }
#pragma endscop
...
init_array(xd,POLYBENCH_ARRAY(D), xc,yc,POLYBENCH_ARRAY(C), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_3412352311_01(xd,POLYBENCH_ARRAY(D), xc,yc,POLYBENCH_ARRAY(C), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xd,POLYBENCH_ARRAY(D), xc,yc,POLYBENCH_ARRAY(C), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J)));
