...
void kernel_4312231213_04(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P; i_0++) {
        B[i_0] = D[i_0] - D[i_0-1] + B[i_0-1] - B[i_0] + 1;
        B[i_0] = D[i_0] + E[i_0-1][i_0] - 3;
        B[i_0-1] = D[1] - D[i_0] * F[i_0+1] * F[i_0] * 3;
    }
#pragma endscop
...
kernel_4312231213_04(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F));
