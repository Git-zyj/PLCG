...
void kernel_2426331211_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
        D[i_1+1] = E[i_1] + F[i_1-1] - A[i_1-1] + 4;
        C[i_1] = F[i_1+1] + G[i_1][0] + F[i_1] - F[i_1] * F[i_1] + C[i_1+1] - C[i_1-1] * 3;
        D[i_1] = H[i_1] - F[i_1-1] - F[i_1] - A[i_1-1] * C[i_1] - C[i_1+1] * 5;
    }
#pragma endscop
...
kernel_2426331211_01(xa,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
