...
void kernel_4414111121_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve)){
        ...
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = i_1; i_2 < PB_P-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_N; i_3++) {
                    A[0][i_1][i_3+1][i_1] = A[0][i_2+1][i_3-1][i_2+1] - A[0][i_1][i_3-1][i_1] - 4;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < PB_P-2; i_5++) {
            for (int i_6 = 0; i_6 < i_5; i_6++) {
                for (int i_7 = 0; i_7 < min(PB_L-3, -i_6+PB_N); i_7++) {
                    A[0][i_5+2][i_7+3][i_5+2] = E[i_7+i_6][i_4][i_5][i_7] + 6;
                }
            }
            C[i_4-1][i_5-1][0] = 3;
            for (int i_8 = PB_L-2 - 1; i_8 >= 0; i_8--) {
                for (int i_9 = 2; i_9 < PB_Q; i_9++) {
                    D[i_9-1][i_8][i_5][1] = D[i_9-2][i_8+2][i_4-1][1] + 5;
                }
            }
        }
    }
...
kernel_4414111121_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
