...
void kernel_4226331213_06(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        A[i_0-1][1] = C[i_0] * C[i_0] * A[i_0-2][1] + A[i_0][1] * 1;
        A[i_0-2][1] = D[i_0] * C[i_0-1] * C[i_0] * 6;
    }
#pragma endscop
...
kernel_4226331213_06(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
