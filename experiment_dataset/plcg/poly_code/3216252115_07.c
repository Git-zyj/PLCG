    ...
    for (int i_3 = 2; i_3 < PB_P; i_3++) {
        for (int i_4 = 1; i_4 < min(-i_3+PB_L, PB_P); i_4++) {
            for (int i_5 = 1; i_5 < PB_P-2; i_5++) {
                B[i_5][i_4][i_4] = D[i_3][i_4-1][i_5+2] + C[i_5][i_3][i_4] + C[i_3-2][i_5+i_4][i_5] + C[i_5][i_4+i_3][2] - E[i_4-1][i_5-1][i_3][i_4] + D[i_4][i_3][i_5] * C[i_3][i_4][i_5] - 1;
            }
        }
    }
#pragma endscop
...
kernel_3216252115_07(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
