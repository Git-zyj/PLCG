        ...
        for (int i_1 = 0; i_1 < min(-i_0+PB_Q+1, PB_L-1); i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_M, -i_1+PB_M); i_2++) {
                for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
                    A[i_0][i_0][i_2][i_3+1] = D[i_1][i_2+i_0][i_1][i_0] * D[i_2][i_2][i_1+1][i_3-1] - E[i_2+i_1][i_3][i_1+i_0-1][i_0] - F[i_1][i_3][i_2] + E[i_3][i_1+1][i_0][i_2] + A[i_3+1][i_3+1][i_2][i_0+1] + A[i_0+1][i_0+1][i_2-1][i_3+1] + 3;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M; i_4++) {
        B[i_4] = G[i_4] - G[i_4] + H[i_4] + G[0] * H[0] * 4;
    }
    for (int i_5 = 1; i_5 < PB_M; i_5++) {
        for (int i_6 = 0; i_6 < PB_M; i_6++) {
            B[i_6] = I[i_6][0] - I[i_6][i_5] + J[i_5-1][i_6] - G[i_6] - J[i_5][i_6] * 6;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4332251115_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J)));
