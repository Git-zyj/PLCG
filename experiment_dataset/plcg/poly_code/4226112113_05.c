...
void kernel_4226112113_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
        ...
        for (int i_1 = 2; i_1 < PB_Q+2; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_P; i_2++) {
                for (int i_3 = max(2, i_0); i_3 < PB_Q+2; i_3++) {
                    A[i_0][i_3+i_2][i_1-2] = A[i_1-1][i_2+i_0][i_3-2] * 2;
                }
            }
        }
    }
...
kernel_4226112113_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
