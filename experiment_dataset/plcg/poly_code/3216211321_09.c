...
void kernel_3216211321_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_1 = 3; i_1 < PB_N-2; i_1++) {
        B[i_1-1][0] = C[i_1] - A[i_1] + A[i_1+2] - B[i_1-3][0] + 5;
    }
#pragma endscop
...
kernel_3216211321_09(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
