...
#pragma scop
    ...
    for (int i_6 = 1; i_6 < PB_Q; i_6++) {
        for (int i_7 = 0; i_7 < PB_N; i_7++) {
            C[i_7][1] = F[i_7] + D[i_6-1][i_7][2] + G[i_7][i_6] - G[i_7][i_6] + 2;
        }
    }
#pragma endscop
...
kernel_4332152213_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
