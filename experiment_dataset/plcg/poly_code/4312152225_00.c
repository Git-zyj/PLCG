...
void kernel_4312152225_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf)){
        ...
        for (int i_1 = 3; i_1 < PB_Q-1; i_1++) {
            for (int i_2 = 0; i_2 < min(i_0, -i_1+PB_N); i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_P-2; i_3++) {
                    A[i_3+1][i_2+i_1-2][i_0][i_3+2] = D[i_2][i_3+i_0+2][i_1][i_0] - D[i_3+i_2][i_2+1][i_1+1][i_0] * D[i_3+i_2][i_3][i_0+1][i_0] + D[i_3][i_2][i_0-2][i_1] * A[i_3+1][i_2+i_1][i_0-1][i_3+2] * A[i_3+1][i_2+i_1-3][i_0-2][i_3+2] + 5;
                }
            }
        }
        B[i_0] = E[i_0+1] - E[i_0] * E[i_0] * E[i_0] + E[i_0] - E[i_0] - B[i_0-2] * B[i_0+2] - 5;
        for (int i_4 = i_0; i_4 < PB_N-2; i_4++) {
            B[i_4] = F[i_4+2][i_0] + F[i_4][i_4] - F[i_4][i_0] * 2;
        }
    }
#pragma endscop
...
kernel_4312152225_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
