        ...
        for (int i_1 = 1; i_1 < min(PB_Q-2, -i_0+PB_L); i_1++) {
            for (int i_2 = 1; i_2 < PB_Q-2; i_2++) {
                for (int i_3 = 2; i_3 < PB_M-1; i_3++) {
                    B[i_3][i_2][i_1+i_0][i_1] = D[i_3][i_3-2][i_0-2][i_2-1] + E[i_3-2][i_0][i_1-1][i_2] - E[i_3+1][i_0][i_2+2][i_1] - F[i_3][i_1][i_2] - E[i_2][i_0][i_1+2][i_3+1] + D[i_0][i_3][i_1][i_2] - 5;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < -i_4+PB_L-1; i_5++) {
            for (int i_6 = 0; i_6 < PB_L-1; i_6++) {
                for (int i_7 = 2; i_7 < PB_M; i_7++) {
                    B[i_7][i_6][i_5+i_4][i_5] = G[i_7][i_5][i_6] * E[i_5][i_7-2][i_6][i_4] * B[i_7-1][i_6+1][i_5+i_4][i_5] + B[i_7][i_6][i_5+i_4+1][i_5+1] + 2;
                }
            }
        }
    }
    for (int i_8 = 0; i_8 < PB_N; i_8++) {
        for (int i_9 = 1; i_9 < PB_M; i_9++) {
            for (int j_0 = 1; j_0 < PB_M-1; j_0++) {
                C[i_9][j_0] = H[j_0+1][i_9] + C[i_9][j_0-1] * C[j_0-1][i_9] - C[i_9-1][j_0] + 1;
            }
        }
    }
#pragma endscop
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4332232315_09(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H)));
