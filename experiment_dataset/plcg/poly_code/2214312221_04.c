...
void kernel_2214312221_04(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-4; i_0++) {
        B[i_0+4] = C[i_0] - C[i_0] * 6;
    }
    for (int i_1 = 0; i_1 < PB_M-3; i_1++) {
        B[i_1+2] = B[i_1+3] * B[i_1] + 6;
    }
#pragma endscop
...
kernel_2214312221_04(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
