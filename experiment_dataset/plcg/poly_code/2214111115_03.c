...
void kernel_2214111115_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            B[i_0] = C[i_0][i_1] * C[i_0][i_1] + B[i_0] * 2;
        }
        B[i_0] = 5;
    }
#pragma endscop
...
kernel_2214111115_03(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
