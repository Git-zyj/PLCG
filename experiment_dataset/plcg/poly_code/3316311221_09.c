...
void kernel_3316311221_09(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_Q; i_0++) {
        for (int i_1 = 0; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 3; i_2 < PB_P+1; i_2++) {
                A[i_1+1][i_2-1] = A[i_1+1][i_2-3] - 5;
            }
        }
    }
    for (int i_3 = 2; i_3 < PB_Q; i_3++) {
        for (int i_4 = 2; i_4 < min(-i_3+PB_P-4, i_3); i_4++) {
            for (int i_5 = 3; i_5 < min(PB_Q+1, -i_4+PB_L); i_5++) {
                B[i_3][i_5-1][i_4+i_3] = D[i_5+1][i_4] * E[i_4][i_3+1][i_5-1] + E[i_4-1][i_5+i_4][i_3] * B[i_3][i_5-1][i_4+i_3+1] * B[i_4][i_3-1][i_5+i_4-2] - B[i_3][i_5+1][i_4+i_3-2] + B[i_3+2][i_5-3][i_4+i_3+4] * B[i_3][i_5+1][i_4+i_3+2] * 3;
            }
        }
        C[i_3+1] = 3;
    }
...
kernel_3316311221_09(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
