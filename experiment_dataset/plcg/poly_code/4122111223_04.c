...
void kernel_4122111223_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < PB_P-3; i_1++) {
            A[i_0-1][i_0][i_1+1] = B[i_0] + A[i_0-1][i_0][i_1+3] + A[i_0-1][i_0][i_1+2] - 5;
        }
    }
#pragma endscop
...
kernel_4122111223_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
