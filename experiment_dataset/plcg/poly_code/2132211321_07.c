...
void kernel_2132211321_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_M-1 - 1; i_0 >= 3; i_0--) {
        A[i_0-1] = B[i_0] + A[i_0-3] + A[i_0+1] - A[i_0-2] * 6;
    }
#pragma endscop
...
kernel_2132211321_07(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
