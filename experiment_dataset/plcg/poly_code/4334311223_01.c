...
void kernel_4334311223_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-1; i_0++) {
        for (int i_1 = 0; i_1 < PB_M; i_1++) {
            for (int i_2 = 0; i_2 < PB_M; i_2++) {
                A[i_0+1][i_1][i_1] = A[i_0-1][i_1][i_1] + 5;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
        for (int i_4 = 0; i_4 < -i_3+PB_L; i_4++) {
            for (int i_5 = 1; i_5 < PB_L; i_5++) {
                B[i_3-1][i_5][i_4+1] = D[i_4][i_5-1][i_4+i_3] * B[i_3+1][i_5][i_4+1] + 3;
            }
        }
    }
    for (int i_6 = 0; i_6 < PB_M; i_6++) {
        for (int i_7 = i_6; i_7 < PB_M-4; i_7++) {
            for (int i_8 = 0; i_8 < -i_7+PB_M-4; i_8++) {
                for (int i_9 = 1; i_9 < -i_7+PB_M-1; i_9++) {
                    C[i_9+i_7+1][i_8][i_9] = C[i_8+i_7+4][i_9][i_8+1] - C[i_9+i_7][i_8][i_9-1] + 3;
                }
            }
        }
    }
...
kernel_4334311223_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
