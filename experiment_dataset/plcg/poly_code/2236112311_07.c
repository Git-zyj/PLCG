...
void kernel_2236112311_07(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    ...
    for (int i_2 = 1; i_2 < PB_M; i_2++) {
        for (int i_3 = i_2; i_3 < PB_M-2; i_3++) {
            B[i_3+1][i_2][i_3+1] = C[i_3][i_2] * C[i_2][i_3-1] - B[i_3+1][i_2-1][i_3+1] - B[i_3+1][i_2+1][i_3+1] + B[i_3+2][i_2][i_3+2] + 6;
        }
    }
#pragma endscop
...
kernel_2236112311_07(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
