...
void kernel_4414211215_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < PB_P; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_Q; i_3++) {
                    A[i_2][i_0+1][i_1][i_3] = A[i_2+1][i_0+1][i_1][i_3] * A[i_2][i_0][i_1][i_3-1] * 4;
                }
            }
            C[i_0][i_1] = 4;
        }
    ...
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 1; i_5 < PB_M; i_5++) {
            C[i_4][i_5] = E[i_5][i_4-1] * C[i_4+1][i_5+1] - C[i_5-1][i_4] - 4;
        }
...
kernel_4414211215_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xe,ye,POLYBENCH_ARRAY(E));
