...
void kernel_2314231213_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        B[i_0-1] = D[i_0-1] * D[i_0] + D[i_0] - D[i_0] - E[i_0+1][i_0] + B[i_0] - 6;
        B[i_0] = D[i_0-1] + F[i_0] + D[i_0] - B[i_0+1] + 3;
    }
...
kernel_2314231213_09(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F));
