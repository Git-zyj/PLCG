...
void kernel_2434332221_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi)){
...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_M-2; i_1++) {
        B[i_1+1] = E[i_1] + C[i_1+2] * C[i_1+4] * 1;
        C[i_1+2] = F[i_1] + E[i_1+1] * E[i_1] * C[i_1+1] - C[i_1+4] - 6;
        for (int i_2 = 2; i_2 < PB_M; i_2++) {
            D[i_1][i_2] = G[i_2][i_1] + H[i_2-2] - I[i_1+1][i_2-1] + I[i_2-1][i_1+1] + G[i_2][i_1+2] + B[i_1+2] + D[i_2-2][i_1] * 1;
        }
    }
#pragma endscop
...
kernel_2434332221_08(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
