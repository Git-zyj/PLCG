...
void kernel_2412332323_06(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_P-1 - 1; i_0 >= 2; i_0--) {
        C[i_0] = E[i_0] - F[i_0-2] * 5;
        for (int i_1 = 2; i_1 < min(-i_0+PB_M, PB_P-3); i_1++) {
            B[i_0][i_1+1] = G[i_1-2][i_0] - H[i_0][i_1] + B[i_0][i_1+3] * B[i_0+1][i_1+3] + B[i_0][i_1-1] + B[i_0][i_1] - 5;
            C[i_1] = E[i_1+i_0] * 6;
        }
        C[i_0+2] = E[i_0] - F[i_0-1] * G[i_0+1][i_0+1] - I[i_0] - C[i_0] + 4;
    }
#pragma endscop
...
kernel_2412332323_06(xc,POLYBENCH_ARRAY(C), xb,yb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
