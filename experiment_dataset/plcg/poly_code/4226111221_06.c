...
void kernel_4226111221_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 1; i_1 < min(i_0, PB_P-1); i_1++) {
            for (int i_2 = 0; i_2 < PB_Q-3; i_2++) {
                for (int i_3 = 0; i_3 < -i_2+PB_Q-3; i_3++) {
                    A[i_2][i_1][0] = A[i_2][i_1+1][0] + B[i_3][i_1-1][i_3+i_2+3] - 1;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_P-1; i_4++) {
        for (int i_5 = max(i_4, 1); i_5 < PB_Q-3; i_5++) {
            for (int i_6 = 0; i_6 < min(-i_4+PB_P, -i_5+PB_Q-3); i_6++) {
                B[i_4][i_5+1][i_6+i_4+1] = C[i_6][i_6+i_4] + D[i_6][i_6][i_5-1] + B[i_5][i_4+1][i_6+i_5+3] - 1;
            }
        }
    }
#pragma endscop
...
kernel_4226111221_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
