...
void kernel_4422211325_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-3; i_0++) {
        A[i_0+1] = 2;
        A[i_0+1] = E[i_0-1] - E[i_0+1] + A[i_0+1] - A[i_0-1] - A[i_0+3] + 6;
        for (int i_1 = i_0; i_1 < PB_L-1; i_1++) {
            C[i_0][i_1] = F[i_0][i_1] * C[i_0-2][i_1] + C[i_0][i_1+1] * C[i_0+2][i_1+1] * 2;
        }
    }
        ...
        for (int i_3 = 3; i_3 < PB_M; i_3++) {
            for (int i_4 = 0; i_4 < -i_3+PB_M; i_4++) {
                for (int i_5 = 0; i_5 < i_2; i_5++) {
                    D[i_2][i_4][i_3-1][i_2] = G[i_4+i_3][i_5][i_4+1] - D[i_2+2][i_4][i_3-1][i_2+2] - D[i_2][i_4][i_3-3][i_2] - 3;
                }
            }
        }
    }
...
kernel_4422211325_02(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
