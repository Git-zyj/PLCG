...
void kernel_4226211121_09(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
    ...
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        for (int i_5 = 0; i_5 < i_4; i_5++) {
            for (int i_6 = i_5; i_6 < PB_P-1; i_6++) {
                B[i_4-1][i_5][i_6+1] = C[i_5+1][i_6] - B[i_4+1][i_5][i_6+1] + 2;
            }
        }
    }
#pragma endscop
...
kernel_4226211121_09(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
