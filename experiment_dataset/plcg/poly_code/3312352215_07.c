...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
        B[i_1] = E[i_1] + D[i_1] + D[i_1] * F[i_1] - D[i_1-2] + F[i_1] * D[i_1] - 3;
        for (int i_2 = 2; i_2 < -i_1+PB_M; i_2++) {
            C[i_1+1][i_2-2] = G[i_1][i_2] * H[i_1][i_2+2] - D[1] * H[i_2+i_1][i_2+i_1] - B[i_2] - C[i_1+1][i_2-1] * C[i_1+2][i_2-1] - 2;
        }
    }
#pragma endscop
...
kernel_3312352215_07(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
