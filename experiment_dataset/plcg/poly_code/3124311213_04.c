...
void kernel_3124311213_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_N-1 - 1; i_0 >= 1; i_0--) {
        for (int i_1 = 0; i_1 < min(-i_0+PB_N-1, PB_L); i_1++) {
            A[i_1+i_0+1][i_0] = B[i_1] + A[i_1+i_0-1][i_0-1] * A[i_1+i_0][i_0-1] - 2;
        }
    }
#pragma endscop
...
kernel_3124311213_04(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
