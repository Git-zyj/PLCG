...
void kernel_4316251113_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
        ...
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_1+PB_M+1, PB_M-1); i_2++) {
                for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
                    A[i_0][i_2][i_3][i_1-1] = D[i_3][0][i_1-1] - E[i_0][i_3][i_1+1][i_2-1] - F[i_1+1][i_3+1][i_2][i_3+1] - G[i_3+1][i_1][i_2-1] + E[i_0][i_3][i_2][i_1] + F[i_0][i_2+1][i_3+1][i_1] + G[i_2+i_1-1][i_3-1][i_0] - E[i_1][i_0-1][i_3][i_2-1] - 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_P-2; i_4++) {
        for (int i_5 = 2; i_5 < PB_M; i_5++) {
            for (int i_6 = 0; i_6 < min(i_4, -i_5+PB_M+1); i_6++) {
                B[i_6+i_5-1][i_6] = G[i_5][i_4][i_5] * H[i_6][i_5] - G[i_6][i_4][i_5+1] - I[i_5][i_6] - G[i_6+1][i_4][i_5+1] - B[i_6+i_5-2][i_5-1] - 6;
            }
        }
        C[i_4][i_4+1] = J[i_4-1] - J[i_4+1] - C[i_4+1][i_4+2] * 6;
    }
#pragma endscop
...
kernel_4316251113_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
