        ...
        for (int i_4 = 0; i_4 < PB_Q; i_4++) {
            for (int i_5 = i_3; i_5 < PB_Q; i_5++) {
                for (int i_6 = 0; i_6 < -i_3+PB_M; i_6++) {
                    B[i_6+i_3][i_5][i_5][i_4] = E[i_6][i_3+1][i_5][i_4] + 6;
                }
            }
        }
        C[i_3] = F[i_3] * C[i_3+1] + C[i_3-1] - C[i_3-2] - C[i_3+2] + 3;
    }
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), INIT_SEED);
kernel_4432111221_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F)));
