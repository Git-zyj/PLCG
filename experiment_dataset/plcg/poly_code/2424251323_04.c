...
void kernel_2424251323_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        A[i_0+1][i_0] = E[i_0] * F[i_0+1] + F[i_0] - F[i_0-1] - F[i_0] * E[i_0] + A[i_0][i_0-1] + 3;
        A[i_0+1][i_0] = F[i_0] - F[i_0] - E[i_0+1] - G[i_0][0] * 4;
    }
    for (int i_1 = 2; i_1 < PB_P-1; i_1++) {
        for (int i_2 = 2; i_2 < PB_L-2; i_2++) {
            C[i_1][i_2] = E[i_2-1] + H[i_2][i_1] * I[i_2][i_1][i_2-1] - F[i_2-1] - G[i_2+1][i_1+1] - C[i_2][i_1-2] + C[i_1-2][i_2-2] + C[i_1][i_2-1] * C[i_1+1][i_2+2] + 4;
        }
        for (int i_3 = 0; i_3 < PB_L; i_3++) {
            A[i_1][i_1-1] = F[i_1-1] - H[i_1][i_1-1] + H[i_1][i_3] + H[i_3][i_1] * 1;
        }
    }
#pragma endscop
...
kernel_2424251323_04(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
