...
void kernel_3216212225_00(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_0 = 0; i_0 < PB_P; i_0++) {
        ...
        for (int i_3 = 2; i_3 < min(i_0, PB_P-1); i_3++) {
            for (int i_4 = 0; i_4 < min(PB_N, -i_0+PB_M-1); i_4++) {
                B[i_3][i_0] = C[i_4+i_0+1][i_3+1][i_3] - D[i_4][i_0+2][i_3] + B[i_3-2][i_4] - B[i_4+2][i_3] - 4;
            }
        }
    }
#pragma endscop
...
kernel_3216212225_00(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
