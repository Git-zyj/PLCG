...
void kernel_4426131325_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_L; i_0++) {
        A[i_0-1] = E[i_0] - E[i_0+1] + E[i_0] * E[i_0] + A[i_0-3] + A[i_0] - 1;
        A[i_0-1] = F[i_0][0] + E[i_0] - A[i_0-1] + 5;
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 2; i_2 < PB_L; i_2++) {
                for (int i_3 = 1; i_3 < -i_1+PB_L; i_3++) {
                    C[i_0][i_3+i_1-1][i_2][i_1] = G[i_3+i_1][i_3][i_2] * H[i_0][i_3-1][i_2-1][i_1] - C[i_0][i_3+i_1][i_2][i_1] - C[i_0][i_3+i_1-1][i_2-2][i_1] + C[i_0-1][i_3+i_1-1][i_2][i_1] - 5;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < PB_P-1; i_5++) {
            for (int i_6 = i_4; i_6 < -i_5+PB_P; i_6++) {
                for (int i_7 = 0; i_7 < min(PB_L, -i_4+PB_M+1); i_7++) {
                    C[i_7][i_6+i_5][i_4][i_5+1] = H[i_5][i_4][i_7+i_4-1][i_5-1] + G[i_7][i_6+i_5][i_4] + 1;
                }
            }
        }
    }
...
kernel_4426131325_09(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
