...
void kernel_2212251225_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_L-1; i_0++) {
        A[i_0-1] = C[i_0] * D[i_0] + A[i_0-3] - 2;
        A[i_0+1] = C[i_0+1] - C[0] * C[i_0] - D[i_0] * D[i_0-1] - C[i_0+1] - D[i_0] - D[i_0] + A[i_0-1] - 3;
    }
#pragma endscop
...
kernel_2212251225_07(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
