...
void kernel_4314351325_06(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
        ...
        for (int i_1 = i_0; i_1 < PB_P-1; i_1++) {
            for (int i_2 = 0; i_2 < min(i_1, -i_1+PB_P-1); i_2++) {
                for (int i_3 = 0; i_3 < min(-i_1+PB_P, PB_L-1); i_3++) {
                    B[i_2+1][i_0+1][i_3+i_1][i_3+i_1-1] = D[i_2][i_0][i_3+1][i_1+1] * E[i_2][i_0-1][i_3+i_1][i_2+i_1] * F[i_3][i_1][i_0] * G[i_0][i_3+i_2][i_0][i_1] * B[i_0+1][i_3+1][i_2+i_1+1][i_2+i_1] * 4;
                }
            }
        }
    }
        ...
        for (int i_5 = i_4; i_5 < PB_N-2; i_5++) {
            for (int i_6 = 1; i_6 < PB_M-1; i_6++) {
                for (int i_7 = 1; i_7 < -i_6+PB_P-1; i_7++) {
                    B[i_5+1][i_4+1][i_7+i_6][i_7+i_6-1] = E[i_6+1][i_7][i_4+1][0] * D[i_7+1][i_4][i_5][i_6] + G[i_6+1][i_4][i_5][i_7+1] - E[i_5][i_4][i_6][i_7-1] + G[i_4][i_6][i_5+1][i_7] - B[i_5+2][i_4-1][i_7+i_6][i_7+i_6-1] * B[i_5+1][i_4+2][i_7+i_6+1][i_7+i_6] - B[i_5+1][i_4-1][i_7+i_6][i_7+i_6-1] * 4;
                }
            }
        }
        for (int i_8 = i_4; i_8 < PB_M-2; i_8++) {
            C[i_8][i_8] = H[i_8][i_4] * I[i_8][i_4-1] + H[i_4+1][1] + J[i_4] + H[i_8+1][i_4] - C[i_8+2][i_8+2] - C[i_4+1][i_4+1] * 5;
        }
    }
#pragma endscop
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4314351325_06(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J)));
