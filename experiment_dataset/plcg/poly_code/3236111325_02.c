...
void kernel_3236111325_02(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_L; i_1++) {
        B[i_1+1] = C[i_1] + B[i_1+2] * B[i_1+3] * B[i_1] + 4;
    }
#pragma endscop
...
kernel_3236111325_02(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
