        ...
        for (int i_1 = 1; i_1 < PB_Q; i_1++) {
            for (int i_2 = 0; i_2 < PB_Q-2; i_2++) {
                for (int i_3 = 1; i_3 < PB_L-2; i_3++) {
                    A[i_2+2][i_1][i_0+2] = E[i_1][i_0][i_1][i_3-1] + F[i_3][i_3+2][i_2+2][i_0][i_1] - G[i_3+2][i_1][i_0] * E[i_1][i_2][i_1-1][i_0] * H[i_1][i_2][i_0][i_3] - 4;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_Q; i_4++) {
        for (int i_5 = 2; i_5 < PB_Q-1; i_5++) {
            for (int i_6 = 1; i_6 < PB_Q; i_6++) {
                for (int i_7 = 0; i_7 < min(min(i_5, -i_6+PB_L), PB_L-2); i_7++) {
                    A[i_7+2][i_6][i_5+1] = H[i_7+1][i_6-1][i_5-1][i_4-2] + H[i_7][i_4][i_5][i_6] * I[i_6][i_5+2][i_7][0] + I[i_7+i_6][i_4-2][i_5][i_6] + E[i_6][i_4+1][i_5][i_5-2] + 2;
                }
            }
        }
    }
    for (int i_8 = 2; i_8 < PB_L-1; i_8++) {
        for (int i_9 = 0; i_9 < PB_Q-4; i_9++) {
            for (int j_0 = 0; j_0 < PB_Q; j_0++) {
                A[i_8][j_0][i_9+4] = G[i_9][i_8][j_0] * G[j_0][i_8][i_9+1] * G[i_8][j_0][i_9] - I[j_0][i_9+2][i_8-2][i_9] * J[j_0][i_8+1][j_0] - 6;
            }
        }
        for (int j_1 = 2; j_1 < PB_M; j_1++) {
            D[i_8][j_1] = K[i_8][i_8] - L[j_1][i_8] - M[j_1-1][i_8-2] * K[i_8][j_1-2] - D[i_8+1][j_1] * 2;
        }
    }
#pragma endscop
