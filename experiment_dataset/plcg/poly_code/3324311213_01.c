...
void kernel_3324311213_01(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
kernel_3324311213_01(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
