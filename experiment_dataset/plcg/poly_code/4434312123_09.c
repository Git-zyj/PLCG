...
void kernel_4434312123_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve)){
        ...
        for (int i_1 = 0; i_1 < PB_Q-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_P-2; i_2++) {
                for (int i_3 = 2; i_3 < PB_Q+2; i_3++) {
                    A[i_0-1][i_2][i_0-2][i_1] = 1;
                    A[i_0-3][i_2][i_0-4][i_1] = E[i_1][i_2][i_0][i_3-2] - A[i_0+1][i_2+2][i_0][i_1+1] - 5;
                }
            }
        }
    }
...
kernel_4434312123_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
