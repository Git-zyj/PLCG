...
void kernel_3226111125_02(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-3; i_0++) {
        for (int i_1 = 0; i_1 < -i_0+PB_L-2; i_1++) {
            for (int i_2 = i_1; i_2 < -i_0+PB_L-3; i_2++) {
                B[i_2+i_0+3][i_1] = C[i_2+1][i_1] - B[i_1+i_0+2][i_2+1] + 6;
            }
        }
    }
...
kernel_3226111125_02(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
