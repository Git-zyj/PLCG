...
void kernel_4316211221_09(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_3 = 0; i_3 < PB_L; i_3++) {
            for (int i_4 = max(2, i_3); i_4 < PB_M-1; i_4++) {
                for (int i_5 = 1; i_5 < PB_M-1; i_5++) {
                    B[i_4+1][i_3][i_2] = B[i_2+1][i_3][i_4-2] + B[i_5+1][i_4-1][i_3] + B[i_3+1][i_4-2][i_5-1] - 2;
                }
            }
        }
        for (int i_6 = i_2; i_6 < PB_Q-1; i_6++) {
            for (int i_7 = 1; i_7 < -i_2+PB_L+1; i_7++) {
                C[i_2-1][i_6][i_7] = D[i_7][i_2][i_6+1] + D[i_7+i_2-1][i_6][i_7-1] - C[i_2-1][i_6-1][i_7] * 5;
            }
        }
    }
#pragma endscop
...
kernel_4316211221_09(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
