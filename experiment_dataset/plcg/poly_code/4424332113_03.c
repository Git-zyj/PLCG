...
#pragma scop
    ...
    for (int i_3 = 2; i_3 < PB_Q; i_3++) {
        for (int i_4 = 1; i_4 < PB_L; i_4++) {
            D[i_4-1] = E[i_3][i_4] - F[i_4][i_3] + 3;
        }
        for (int i_5 = 0; i_5 < i_3; i_5++) {
            for (int i_6 = 0; i_6 < min(-i_3+PB_L, -i_5+PB_Q); i_6++) {
                for (int i_7 = 0; i_7 < min(min(-i_3+PB_M+1, -i_5+PB_M), i_5); i_7++) {
                    C[i_3][i_7+i_6][i_3+1][i_7+i_5] = G[i_7][i_6+i_3][i_5][i_3] + G[i_6][i_5][i_7][i_3] - G[i_3-2][i_7][i_5][i_6+i_5] * H[i_5][i_6][i_3][0] - C[i_5][i_6+i_3+1][i_5+1][i_7+i_3-1] - C[i_3][i_7+i_6+1][i_3+1][i_7+i_5] * 1;
                }
            }
        }
    }
    for (int i_8 = 1; i_8 < PB_M; i_8++) {
        D[i_8] = I[i_8] * J[i_8] - K[i_8-1] * 5;
    }
#pragma endscop
...
init_array(xd,POLYBENCH_ARRAY(D), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4424332113_03(xd,POLYBENCH_ARRAY(D), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xd,POLYBENCH_ARRAY(D), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K)));
