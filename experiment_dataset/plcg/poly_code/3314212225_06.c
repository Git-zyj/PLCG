...
void kernel_3314212225_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
    ...
    for (int i_0 = 3; i_0 < PB_M; i_0++) {
        ...
        for (int i_3 = 0; i_3 < min(PB_M-2, -i_0+PB_N-4); i_3++) {
            for (int i_4 = 0; i_4 < i_3; i_4++) {
                C[i_4][i_3+i_0][i_3] = D[i_0][i_3] + C[i_4][i_3+i_0+1][i_3+1] * C[i_3+2][i_4+i_0][i_4] - C[i_4][i_3+i_0+4][i_3+2] - 2;
            }
        }
    }
#pragma endscop
...
kernel_3314212225_06(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
