...
void kernel_4324211325_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
        ...
        for (int i_5 = 2; i_5 < PB_L-1; i_5++) {
            for (int i_6 = 2; i_6 < min(PB_Q-1, i_5); i_6++) {
                for (int i_7 = 2; i_7 < PB_Q-2; i_7++) {
                    C[i_5][i_6][i_4][i_7] = C[i_5][i_6-1][i_4-1][i_7+2] + C[i_5-2][i_7-2][i_4][i_6+1] - C[i_5+1][i_6-2][i_4][i_7] * 3;
                }
            }
        }
    }
...
kernel_4324211325_00(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
