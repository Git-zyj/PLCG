...
void kernel_3432152113_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_L-2; i_1++) {
        for (int i_2 = 0; i_2 < min(i_1, -i_1+PB_N-2); i_2++) {
            C[i_2+i_1][i_2+1] = F[i_1+2][i_1+1] - E[i_2+i_1+2] * F[i_2+i_1][i_2] * E[i_1] - C[i_2+i_1+1][i_2+1] + 1;
        }
        for (int i_3 = 3; i_3 < PB_L; i_3++) {
            for (int i_4 = 2; i_4 < -i_1+PB_L-2; i_4++) {
                D[i_4][i_4-2][i_3][i_3] = G[i_3][i_4+i_1+2][i_3] + F[i_4][i_1] + F[i_3-2][0] * F[i_4][i_3-2] + G[i_4][i_1-1][i_3-2] - G[i_1][i_4+1][i_3] - H[i_3][i_4][i_1-2][i_3] * D[i_3-1][i_3-3][i_1+1][i_1+1] - 6;
            }
        }
    }
#pragma endscop
...
kernel_3432152113_00(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
