...
void kernel_4424331125_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi)){
        ...
        for (int i_1 = 0; i_1 < PB_M; i_1++) {
            for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_1+PB_M, i_2); i_3++) {
                    A[i_0][i_3+1][i_2][i_1] = E[i_2+1][i_0][i_1][i_0+1] * F[i_3+i_1][i_2][i_0+1] - 1;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M; i_4++) {
        for (int i_5 = 2; i_5 < -i_4+PB_M; i_5++) {
            for (int i_6 = 1; i_6 < PB_M; i_6++) {
                for (int i_7 = max(i_4, 1); i_7 < min(PB_M, -i_6+PB_L+1); i_7++) {
                    B[0][i_4][i_7] = G[i_5][i_4+1][i_7+i_6-1][i_5] * G[i_5][i_6][i_7+1][i_5] - E[i_5][i_4][i_6][i_7-1] * G[i_5][i_7][i_4+1][i_4] + E[i_5+i_4][i_6][i_7+1][i_5] * B[0][i_5-2][i_7] * 3;
                }
            }
        }
        for (int i_8 = 0; i_8 < PB_M-1; i_8++) {
            for (int i_9 = 0; i_9 < min(i_8, -i_8+PB_Q); i_9++) {
                B[0][i_4][i_8] = F[i_9][i_4][i_4] * F[i_8+1][i_4][i_9] + H[i_4][0][i_9+i_8] + 3;
                for (int j_0 = 0; j_0 < PB_M; j_0++) {
                    B[0][i_8][j_0] = G[i_9][i_8][j_0+1][i_4] * I[i_9][i_4][i_9][i_8] - 1;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4424331125_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I)));
