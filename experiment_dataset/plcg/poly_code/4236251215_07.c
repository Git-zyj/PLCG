...
void kernel_4236251215_07(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < i_0; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_1+PB_Q-1, -i_2+PB_M); i_3++) {
                    B[i_0+1][i_1][i_2+1][i_3] = C[i_2][i_1-1][i_0][i_3+i_1+1] + C[i_3+i_2][i_3][i_1-1][i_1-1] + C[i_3+i_2][i_1-1][i_0-1][i_1] + 5;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < i_4; i_5++) {
            for (int i_6 = 1; i_6 < min(-i_5+PB_P, i_5); i_6++) {
                for (int i_7 = 0; i_7 < -i_6+PB_M; i_7++) {
                    B[i_4+1][i_5][i_6+1][i_7] = D[i_6][i_4-1][i_7][i_5] + C[i_7+i_6][i_4][i_4][1] + E[i_7+1][i_6+i_5][i_4][0][i_6] + F[i_6-1][i_5][i_4+1] - D[i_7+i_6][i_5][i_4][0] + C[i_6][i_7][i_4+1][i_5] + D[i_5][i_6][i_4][i_5+1] * B[i_4+1][i_7+1][i_6][i_5] - B[i_4+1][i_5-1][i_7+1][i_6-1] + 3;
                }
            }
        }
    }
...
kernel_4236251215_07(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
