...
void kernel_2422351325_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_L-2; i_1++) {
        for (int i_2 = 3; i_2 < min(-i_1+PB_P+1, i_1); i_2++) {
            B[i_1][i_2-1] = G[i_2-1][i_1] + G[i_2-1][i_1] * H[i_2][i_1] - H[i_2+1][i_1] - H[i_2][i_2+i_1-1] - I[i_2+1][i_1+1] - B[i_1+1][i_2-1] - B[i_1+2][i_2-3] * B[i_1-2][i_2-1] + B[i_1][i_2-3] - B[i_1+2][i_2-1] - 6;
        }
        for (int i_3 = 1; i_3 < -i_1+PB_L; i_3++) {
            C[i_3] = G[i_3-1][i_1] * H[i_3][i_1] * H[i_3+i_1][i_3] - I[i_3][i_1] - I[i_3][i_1] * C[i_1+1] - 6;
        }
    }
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        C[i_4+1] = J[i_4] + E[i_4+1] - E[i_4+1] * E[i_4-1] - J[i_4] * 1;
    }
#pragma endscop
...
kernel_2422351325_08(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
