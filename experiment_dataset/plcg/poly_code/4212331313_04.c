        ...
        for (int i_4 = 0; i_4 < PB_L-2; i_4++) {
            for (int i_5 = 2; i_5 < PB_L-1; i_5++) {
                for (int i_6 = 1; i_6 < PB_L-1; i_6++) {
                    B[i_6][i_5][i_4+1][i_3-1] = E[i_5][i_3][i_4][i_5+1] * F[i_4+1][i_6-1][i_5][i_3] - B[i_6][i_5-1][i_4+2][i_3-1] + B[i_3][i_6+1][i_4][i_5-2] - B[i_6-1][i_4][i_5+1][i_3-1] - 6;
                }
            }
        }
    }
...
kernel_4212331313_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
