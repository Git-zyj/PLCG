...
void kernel_3212211125_07(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    for (int i_0 = 0; i_0 < PB_Q-3; i_0++) {
        ...
        A[i_0+3][i_0+3] = C[i_0][i_0] + D[i_0] + A[i_0+1][i_0+1] * 4;
    }
#pragma endscop
...
kernel_3212211125_07(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
