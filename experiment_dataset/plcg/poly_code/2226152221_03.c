...
void kernel_2226152221_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_L - 1; i_0 >= 2; i_0--) {
        A[1] = C[0] * D[0][i_0] - C[i_0] + C[i_0] - C[i_0-2] - C[i_0+2] + A[1] - 6;
        A[1] = C[i_0] * C[i_0] * C[i_0] * A[1] - 3;
    }
#pragma endscop
...
kernel_2226152221_03(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
