...
void kernel_2434232323_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        ...
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            C[i_0][i_1] = G[i_1+2][i_0] - G[i_0][0] * H[i_1][i_0] * G[i_0][i_1] - E[i_1] + H[i_0+2][i_1] * I[i_1][i_1][i_0+1] * C[i_0+1][i_1-1] - C[i_0][i_1-1] + C[i_0-2][i_1] * 3;
        }
    }
    for (int i_2 = 2; i_2 < PB_M-3; i_2++) {
        D[i_2+1] = F[i_2] * E[i_2-2] * D[i_2] - D[i_2+3] + D[i_2-1] * 6;
    }
#pragma endscop
...
kernel_2434232323_07(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
