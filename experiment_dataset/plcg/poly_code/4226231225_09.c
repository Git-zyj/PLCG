...
void kernel_4226231225_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
...
#pragma scop
        ...
        for (int i_1 = i_0; i_1 < -i_0+PB_L; i_1++) {
            for (int i_2 = i_1; i_2 < -i_0+PB_M; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_0+PB_M, -i_2+PB_L); i_3++) {
                    A[i_3+i_0][i_2][i_1+i_0][0] = C[i_1][i_0+1][i_3+1][i_2] - C[i_1][i_3+i_2][i_3+i_0][i_0-1] - C[i_2][i_1+1][i_3+1][i_2] + D[i_2-1][i_1][1] - A[i_1+i_0-2][i_2][i_3+i_0][0] - A[i_2+i_0][i_3][i_1+i_0-2][0] + 4;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_P; i_4++) {
        for (int i_5 = 0; i_5 < PB_M; i_5++) {
            for (int i_6 = 0; i_6 < min(min(-i_5+PB_L, i_5), PB_M-2); i_6++) {
                for (int i_7 = i_4; i_7 < -i_6+PB_M-2; i_7++) {
                    A[i_7+i_6+2][i_4][i_6+i_5][0] = D[i_6][i_7+1][i_5] + C[i_5][i_4][i_6][i_4] * 5;
                }
            }
        }
    }
...
kernel_4226231225_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
