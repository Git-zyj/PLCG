...
static void print_array(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,int ym,int zm,DATA_TYPE POLYBENCH_3D(M,xM,yM,zM,xm,ym,zm))
{
int i_0, i_1, i_2, i_3;
...
void kernel_4424352215_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,int ym,int zm,DATA_TYPE POLYBENCH_3D(M,xM,yM,zM,xm,ym,zm)){
        ...
        for (int i_1 = 3; i_1 < min(i_0, -i_0+PB_P); i_1++) {
            for (int i_2 = 0; i_2 < PB_L-2; i_2++) {
                for (int i_3 = 0; i_3 < PB_M-2; i_3++) {
                    A[i_3+2][i_1][i_0][i_2+2] = E[i_1][i_0+2][i_2][i_3] * E[i_3+1][i_0+1][i_2+i_1-1][1] * A[i_1+3][i_3+1][i_0][i_2+2] * 1;
                }
            }
            for (int i_4 = 1; i_4 < -i_0+PB_P; i_4++) {
                B[i_1-2][i_0][i_4+i_0] = F[i_4-1][i_1][i_0][i_1+i_0] - G[i_0+1][i_1] * H[i_4+1][i_1] * H[i_4][0] - I[i_0-2][i_4+1][i_1-1] * B[i_1-1][i_0][i_4+i_0] + B[i_1-3][i_0-1][i_4+i_0] * 5;
            }
        }
    }
    for (int i_5 = 2; i_5 < PB_L-2; i_5++) {
        C[i_5][i_5+1] = J[i_5-2] + J[i_5] + J[i_5] - J[0] + K[i_5] - L[i_5+2] - J[i_5] * C[i_5+1][i_5+2] * 2;
    }
    for (int i_6 = 0; i_6 < PB_M; i_6++) {
        for (int i_7 = 0; i_7 < min(-i_6+PB_M, PB_L-3); i_7++) {
            for (int i_8 = 2; i_8 < min(i_6, PB_L); i_8++) {
                for (int i_9 = 2; i_9 < PB_L-2; i_9++) {
                    A[i_9+2][i_8][i_6][i_7+3] = F[i_6][i_7][i_9-2][i_8] * F[i_7+i_6][i_9][i_8-2][i_6] - E[i_7][i_9+2][i_8][0] * M[i_8][i_7+1][i_9+1] - 6;
                }
            }
        }
    }
...
kernel_4424352215_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,ym,zm,POLYBENCH_ARRAY(M));
