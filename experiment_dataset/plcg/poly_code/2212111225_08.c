...
void kernel_2212111225_08(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        for (int i_1 = 1; i_1 < PB_M-2; i_1++) {
            B[i_0][i_1+2] = B[i_0][i_1] * 5;
            B[i_0][i_1] = C[i_1-1][i_0] - B[i_0-2][i_1] * 6;
        }
    }
#pragma endscop
...
kernel_2212111225_08(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
