...
void kernel_4326331315_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N; i_0++) {
        for (int i_1 = 1; i_1 < min(i_0, PB_L-1); i_1++) {
            for (int i_2 = 1; i_2 < min(i_0, PB_L-1); i_2++) {
                for (int i_3 = i_2; i_3 < min(-i_0+PB_M-1, PB_P-1); i_3++) {
                    A[i_3+i_0][i_1][i_2][i_1] = D[i_0-1][i_3+1][i_1][i_2-1] + D[i_1][i_2+1][i_0][i_1] * E[i_2+1][i_3-1][i_1][i_0] + F[i_0][i_3][i_1] + A[i_3+i_0-1][i_1][i_2+1][i_1] * A[i_3+i_0+1][i_1-1][i_2-1][i_1-1] + A[i_3+i_0+1][i_1][i_2][i_1] * A[i_3+i_0][i_1+1][i_2][i_1+1] * A[i_3+i_0+1][i_1][i_2][i_1] + 4;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < PB_P; i_5++) {
            for (int i_6 = 1; i_6 < min(PB_P, -i_5+PB_M-1); i_6++) {
                for (int i_7 = 0; i_7 < i_6; i_7++) {
                    A[i_6+i_5+1][i_7+1][i_4+1][i_7+1] = E[i_6-1][i_4-1][i_5+1][i_7] + E[i_6+1][i_6][i_4][i_5] + E[i_6+1][i_5][i_7+i_5][i_7+i_4+1] + 5;
                }
            }
        }
        C[i_4] = G[i_4][i_4] - H[i_4] * C[i_4+1] + 3;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4326331315_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H)));
