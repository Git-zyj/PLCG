...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_M-1; i_1++) {
        A[i_1] = E[i_1-1] * F[i_1] * F[i_1] + F[i_1] - E[i_1-1] - 6;
        A[i_1+1] = E[0] + E[i_1] - E[i_1+1] * F[i_1] + G[i_1][i_1] + A[i_1+1] + 1;
        for (int i_2 = i_1; i_2 < PB_L; i_2++) {
            for (int i_3 = i_2; i_3 < PB_L; i_3++) {
                D[i_1-1][0][i_1-1] = H[i_2-1][i_1-1] + D[i_1-2][0][i_1-2] * D[i_1][0][i_1] * D[i_1][0][i_1] - 4;
            }
        }
    }
#pragma endscop
...
kernel_3434231315_07(xa,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
