...
void kernel_2332112325_00(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_2 = 4; i_2 < PB_M; i_2++) {
        C[i_2-2] = C[i_2-4] + C[i_2] + C[i_2-1] + 2;
    }
#pragma endscop
...
kernel_2332112325_00(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
