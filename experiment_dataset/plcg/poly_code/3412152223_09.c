...
void kernel_3412152223_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        A[i_0] = E[i_0] + E[i_0-2] - E[i_0] + E[i_0+1] * A[i_0+1] - A[i_0-2] * 6;
    }
    for (int i_1 = 2; i_1 < PB_P-1; i_1++) {
        for (int i_2 = 1; i_2 < min(PB_Q, -i_1+PB_P); i_2++) {
            for (int i_3 = 2; i_3 < min(min(-i_1+PB_L, i_1), PB_N+1); i_3++) {
                B[i_3][i_2][i_2] = F[i_1][i_3][i_2+2] * F[i_3+2][i_1][i_2] * F[i_3][i_2][1] + F[i_3][i_3+i_2][i_1] - F[i_3][i_1][i_2+2] - C[i_2-1][i_3][i_1-2] - 6;
                C[i_3-1][i_2][i_1] = F[i_2][i_1][i_3+1] + F[i_1][i_3][i_2] - F[i_3][i_3][i_2+i_1] - F[i_2+2][i_3][i_1] + F[i_2-1][i_3+i_1][i_3+1] * B[i_3][i_2][i_2] - B[i_1][i_3-1][i_3-1] - 1;
                C[i_3-2][i_2][i_1+1] = G[i_1][i_3][i_2][i_2] - F[i_3][i_1-1][i_2] + F[i_2][i_3][i_1] * F[i_1][i_1][i_2+1] - F[i_3][i_1][i_2+2] * B[i_3][i_2][i_2] - 6;
            }
        }
    }
#pragma endscop
...
kernel_3412152223_09(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G));
