...
void kernel_2234132213_02(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_N; i_1++) {
        B[i_1-2] = C[i_1] + C[0] - C[0] + B[i_1-1] * 1;
    }
#pragma endscop
...
kernel_2234132213_02(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
