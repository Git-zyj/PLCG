...
void kernel_2224251315_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-1; i_0++) {
        A[0] = C[i_0+1] + C[i_0] - C[i_0] - A[0] * 6;
        A[0] = C[i_0+1] + C[i_0] - D[i_0-1] * D[0] - D[i_0-1] - D[i_0] - C[i_0] - A[0] * A[0] + 5;
    }
#pragma endscop
...
kernel_2224251315_09(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
