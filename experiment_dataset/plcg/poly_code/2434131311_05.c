...
void kernel_2434131311_05(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_Q+1; i_0++) {
        A[i_0][i_0] = E[i_0] * A[i_0+1][i_0+1] - 6;
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            B[i_1][i_0-1] = F[i_1][i_0] - F[i_1-1][i_0] - A[i_0+1][i_0+1] + A[i_0][i_0] + 6;
        }
    }
    for (int i_2 = 1; i_2 < PB_Q; i_2++) {
        for (int i_3 = i_2; i_3 < PB_L-1; i_3++) {
            C[i_2][i_3] = F[i_3][i_3] * F[i_2][1] - F[i_3][i_2-1] + E[i_3] * B[i_3][i_2] - C[i_2][i_3+1] + D[i_3][i_2] - 5;
        }
        for (int i_4 = 1; i_4 < PB_L; i_4++) {
            D[i_2][i_4] = F[i_4][i_2+1] - F[i_4-1][0] * E[i_2-1] + B[i_4][i_2-1] + D[i_2+1][i_4] + D[i_2][i_4-1] * D[i_2-1][i_4-1] - 4;
        }
    }
#pragma endscop
...
kernel_2434131311_05(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
