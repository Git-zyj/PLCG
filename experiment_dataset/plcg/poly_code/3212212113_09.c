...
void kernel_3212212113_09(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        ...
        for (int i_3 = 0; i_3 < PB_M-2; i_3++) {
            B[i_3][i_0] = C[i_3+2][i_0] - B[i_3+1][i_0] + 5;
        }
    }
#pragma endscop
...
kernel_3212212113_09(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
