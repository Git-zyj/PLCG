...
void kernel_4316131213_07(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf)){
        ...
        for (int i_1 = 1; i_1 < min(-i_0+PB_M-1, i_0); i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_P; i_2++) {
                for (int i_3 = 0; i_3 < PB_Q; i_3++) {
                    B[i_0-1][i_2+i_1][i_1][i_3] = D[i_0][i_2][i_1][i_3] * D[i_2][i_0-1][i_3][i_1] * C[i_1+i_0+1][i_0][i_2][i_3] + 3;
                }
            }
            for (int i_4 = 0; i_4 < PB_Q-1; i_4++) {
                for (int i_5 = 1; i_5 < -i_1+PB_P; i_5++) {
                    B[i_0][i_5+i_1][i_1][i_4+1] = D[i_4][i_1][i_0-1][i_5-1] * B[i_0][i_5+i_1-1][i_1][i_4] - 3;
                }
            }
        }
    }
        ...
        for (int i_7 = 1; i_7 < min(i_6, -i_6+PB_M-1); i_7++) {
            for (int i_8 = 1; i_8 < -i_7+PB_M-1; i_8++) {
                for (int i_9 = 1; i_9 < PB_P-1; i_9++) {
                    C[i_7+i_6+1][i_7][i_8][i_9] = D[i_7][i_7+1][i_6][i_8-1] + E[i_6][i_8][i_7+1] - F[i_6][i_9-1][i_8][i_8][i_7+1] + D[i_7][i_8+1][i_9-1][i_7-1] * C[i_8+i_7+1][i_7][i_9+1][i_6-1] + 4;
                }
            }
        }
    }
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), INIT_SEED);
kernel_4316131213_07(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F)));
