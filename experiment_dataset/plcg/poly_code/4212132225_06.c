...
void kernel_4212132225_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 2; i_1 < PB_P; i_1++) {
            for (int i_2 = 0; i_2 < min(PB_P-1, i_1); i_2++) {
                for (int i_3 = max(3, i_2); i_3 < PB_M; i_3++) {
                    A[i_1][i_0][i_2][i_3-1] = C[i_3-2][i_2][i_0][i_1-2] * C[i_3][i_1][i_0][i_2+1] * A[i_1][i_0-1][i_2+1][i_3-1] * A[i_1][i_0][i_2][i_3-3] + 5;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < PB_M-2; i_5++) {
            for (int i_6 = 0; i_6 < PB_P; i_6++) {
                for (int i_7 = 0; i_7 < PB_P-1; i_7++) {
                    A[i_5+2][i_7][i_6][i_4-2] = D[i_7][i_5][0] - C[i_5][i_6][i_4][i_7] * C[i_6][i_7+1][i_4][0] + C[i_4][i_7][i_5][i_6] * 3;
                }
            }
        }
    }
...
kernel_4212132225_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
