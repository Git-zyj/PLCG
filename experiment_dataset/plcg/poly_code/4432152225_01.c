...
void kernel_4432152225_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P-2; i_0++) {
        for (int i_1 = 2; i_1 < min(PB_Q-1, -i_0+PB_M+1); i_1++) {
            for (int i_2 = 2; i_2 < -i_1+PB_L; i_2++) {
                for (int i_3 = 1; i_3 < min(min(-i_0+PB_M, -i_1+PB_M), -i_2+PB_L-1); i_3++) {
                    A[i_2+2][i_3+i_1][i_0][i_2-1] = E[i_3][i_1-2][i_0][i_2-2] - E[i_1-2][i_3+i_2+1][i_0][0] + E[i_2][i_0][i_3][i_1] + E[i_3+i_0][i_2+i_1][i_3+1][i_2] * A[i_2+2][i_3+i_1][i_0+1][i_2-1] + A[i_3+2][i_1+i_0-1][i_2][i_3-1] * 3;
                }
            }
            for (int i_4 = 0; i_4 < min(-i_0+PB_M, -i_1+PB_M-1); i_4++) {
                B[2][i_1] = F[i_1][i_4+i_0-2][i_1] - F[i_4][i_1-1][0] - E[i_4+i_1+1][i_0][i_4][i_1] - F[i_4+i_0][i_1-2][i_0] * G[i_0][i_4+i_1-2] - F[i_4+1][i_0+2][i_1-2] + F[i_4][i_0-2][i_1+1] * F[i_1][i_0-1][1] - B[2][i_1+1] + 4;
            }
        }
        B[2][i_0] = H[i_0] + H[i_0] * H[i_0+2] + H[i_0] + H[i_0-2] + H[i_0] + 3;
    }
...
kernel_4432152225_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
