...
void kernel_4334232211_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = i_1; i_2 < min(PB_M, -i_0+PB_P); i_2++) {
                for (int i_3 = 1; i_3 < min(-i_1+PB_M, -i_0+PB_P); i_3++) {
                    A[i_2][i_3][i_1][i_3+i_0] = D[i_3+i_1][i_0][i_1-1][i_2] - A[i_3-1][i_2][i_1+1][i_2+i_0] + 5;
                }
            }
        }
        B[i_0] = E[i_0][0] - F[i_0] + F[i_0] + G[i_0+1] - G[i_0] * B[i_0+1] - 1;
    }
    for (int i_4 = 2; i_4 < PB_Q-1; i_4++) {
        for (int i_5 = i_4; i_5 < PB_M-2; i_5++) {
            for (int i_6 = 1; i_6 < min(PB_P-2, -i_4+PB_Q+1); i_6++) {
                for (int i_7 = 0; i_7 < PB_N-2; i_7++) {
                    C[i_7+1][i_5][i_6-1][i_4] = H[i_5+2][i_7][i_6+2][i_4-2][i_6+i_4-1] * C[i_5][i_7][i_6-1][i_4] * C[i_5+1][i_6-1][i_4-1][i_7] - C[i_7+2][i_5][i_6-1][i_4] - C[i_7+1][i_5+1][i_6][i_4+1] - 4;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4334232211_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H)));
