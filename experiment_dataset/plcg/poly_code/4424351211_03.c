...
void kernel_4424351211_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl)){
...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_P+1; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_N, PB_M-2); i_2++) {
                for (int i_3 = i_1; i_3 < -i_2+PB_P-1; i_3++) {
                    A[i_2][i_1][i_3+1] = E[i_0][i_2][i_1][i_1] * E[i_3+i_2-1][i_0][i_1+1][i_3] - F[i_2][i_1][i_3+i_2+1][i_0][i_3+1] + G[i_2+i_0][i_3+i_1][i_2+1][i_1-1] + G[i_0][i_1][i_2][i_0+1] - G[i_2][i_3+1][i_1+i_0-1][i_3+i_1+1] - H[i_0][i_3][i_1+1][i_2][i_2] * C[i_3][i_0-1][i_1+1][i_3-1] - C[i_2+2][i_1][i_0+1][i_2+1] + 5;
                }
            }
        }
        for (int i_4 = 1; i_4 < -i_0+PB_L; i_4++) {
            for (int i_5 = 1; i_5 < i_4; i_5++) {
                B[i_0-1][i_0][i_4] = I[i_5][i_4+i_0][i_4] * J[i_5][i_0-1][i_4-1] - I[i_5][i_0-1][i_4] - J[i_5][i_5-1][i_4-1] - K[i_4][i_0][i_0] - A[i_5][i_4-1][i_0+1] - B[i_0][i_0+1][i_4] + B[i_0-2][i_0-1][i_4] - 1;
            }
        }
    }
    for (int i_6 = 0; i_6 < PB_L-1; i_6++) {
        for (int i_7 = 0; i_7 < PB_P-1; i_7++) {
            for (int i_8 = 0; i_8 < PB_M-1; i_8++) {
                for (int i_9 = 0; i_9 < min(-i_7+PB_P-1, i_8); i_9++) {
                    C[i_8+1][i_7][i_9][i_8] = E[i_9+i_7+1][i_8][i_7][i_6] - K[i_6][i_7][i_9+i_7+1] + E[i_8][i_6+1][i_6][i_9] + 1;
                }
            }
        }
    }
    for (int j_0 = 0; j_0 < PB_P-1; j_0++) {
        for (int j_1 = j_0; j_1 < -j_0+PB_M-1; j_1++) {
            D[j_1][j_0][j_0] = L[j_1+j_0+1][j_1+1] + L[j_1][j_0] * I[j_1][j_0][j_0] + D[j_1+1][j_0][j_0] * D[j_1+1][j_0+1][j_0+1] - 1;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4424351211_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L)));
