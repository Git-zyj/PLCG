    ...
    for (int i_2 = 1; i_2 < PB_L-1; i_2++) {
        for (int i_3 = 1; i_3 < PB_L; i_3++) {
            for (int i_4 = 0; i_4 < min(-i_3+PB_L, -i_2+PB_L); i_4++) {
                C[i_3+1][i_4+i_2][i_3] = F[i_4][i_2][i_3] * F[i_3][i_2][i_3] + F[i_4][i_2][i_3] + F[i_2-1][i_3][i_4+i_3] - F[i_4+i_3][i_2+1][i_4] * F[i_4+i_2-1][i_3][1] - F[i_3][i_4][i_2-1] + C[i_3][i_4+i_2-1][i_3-1] - C[i_2+2][i_4+i_3][i_2+1] * 4;
            }
        }
        D[i_2+1] = E[i_2] * D[i_2] + D[i_2+2] - D[i_2+2] + D[i_2] + 4;
    }
#pragma endscop
...
kernel_4426131213_00(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
