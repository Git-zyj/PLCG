...
void kernel_4214112125_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 1; i_1 < PB_N; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_M; i_2++) {
                ...
                for (int i_3 = 0; i_3 < min(-i_0+PB_M-1, i_0); i_3++) {
                    A[i_2+1][i_3+i_0+1][i_3+1] = C[i_1][i_2][i_3] * A[i_1-1][i_3+i_2][i_2] - 1;
                }
            }
        }
    }
...
kernel_4214112125_04(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C));
