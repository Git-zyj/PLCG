...
void kernel_4416232313_08(int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
...
#pragma scop
        ...
        for (int i_1 = i_0; i_1 < PB_P-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_Q; i_2++) {
                for (int i_3 = 1; i_3 < PB_Q-1; i_3++) {
                    C[i_0][i_1+1][i_3+1][i_2] = E[i_2][i_3-1][i_1][i_0] - 2;
                }
            }
        }
        B[i_0] = F[i_0+1] + F[i_0] + B[i_0-1] - B[i_0+1] + B[i_0+1] * 3;
        for (int i_4 = 2; i_4 < PB_P; i_4++) {
            for (int i_5 = i_4; i_5 < PB_Q-2; i_5++) {
                for (int i_6 = 0; i_6 < -i_0+PB_N-2; i_6++) {
                    C[i_0][i_6][i_4][i_5-1] = E[i_0][i_6][i_5][i_4-2] - G[i_6][i_0-1][i_4][i_5+2] - H[i_6+i_0+2][i_4][i_0][i_5][0] + G[i_0+1][i_6][i_5+2][i_4] - E[i_5][i_4][i_0][i_5+1] - C[i_6][i_0][i_4-1][i_5-1] + 1;
                }
            }
        }
    }
    for (int i_7 = 0; i_7 < PB_P; i_7++) {
        for (int i_8 = 1; i_8 < PB_L-1; i_8++) {
            for (int i_9 = 2; i_9 < PB_Q-3; i_9++) {
                for (int j_0 = max(2, i_7); j_0 < PB_Q-2; j_0++) {
                    D[i_9-1][i_8+1][j_0][j_0+2] = E[i_9][i_7][j_0-1][i_7+1] * G[j_0][1][i_9-1][i_8-1] - I[i_7][i_8][0] * D[i_9-2][i_8+1][j_0-1][j_0+1] * D[j_0-2][i_8+1][i_9+1][i_9+3] + D[i_9-2][i_8+1][j_0][j_0+2] - 4;
                }
            }
        }
    }
...
init_array(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4416232313_08(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
