...
void kernel_4226112321_02(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_4 = 0; i_4 < PB_L-3; i_4++) {
        for (int i_5 = i_4; i_5 < PB_P-1; i_5++) {
            for (int i_6 = 2; i_6 < min(PB_Q, -i_5+PB_L); i_6++) {
                B[i_4+1][i_5][i_6] = C[i_5][i_4][i_6] * C[i_5][i_6+i_5][i_4] - B[i_4+3][i_5+1][i_6-2] - B[i_4][i_5][i_6] * B[i_4+2][i_5][i_6] - 2;
            }
        }
    }
#pragma endscop
...
kernel_4226112321_02(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
