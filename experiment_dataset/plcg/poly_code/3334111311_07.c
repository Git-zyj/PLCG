...
void kernel_3334111311_07(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 2; i_1 < PB_Q; i_1++) {
            A[i_0][i_0][i_1-1] = A[i_0][i_0][i_1] - A[i_0][i_0][i_1-2] - A[i_0-1][i_0-1][i_1-1] * A[i_0+1][i_0+1][i_1-1] - 2;
        }
    }
    for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
        for (int i_3 = max(1, i_2); i_3 < PB_Q; i_3++) {
            for (int i_4 = 1; i_4 < PB_Q+1; i_4++) {
                A[i_3-1][i_3-1][i_4-1] = D[i_2+1][i_4+1][i_3] - 1;
            }
        }
    }
    for (int i_5 = 0; i_5 < PB_Q; i_5++) {
        for (int i_6 = i_5; i_6 < PB_L-1; i_6++) {
            for (int i_7 = 0; i_7 < min(-i_6+PB_M, PB_L); i_7++) {
                C[i_7+1][i_6][i_7+1] = D[i_7+i_6][i_7][i_5] * C[i_7+1][i_6+1][i_7+1] + 4;
            }
        }
    }
#pragma endscop
...
kernel_3334111311_07(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
