...
void kernel_4412251323_07(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-3; i_0++) {
        A[i_0][i_0+1] = E[i_0-1] * F[i_0] * F[1] * F[i_0] + E[i_0] - E[i_0] + A[i_0-1][i_0] - A[i_0-2][i_0-1] + A[i_0+1][i_0+2] * A[i_0+2][i_0+3] * 5;
        for (int i_1 = 0; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 3; i_2 < PB_Q; i_2++) {
                for (int i_3 = 1; i_3 < -i_2+PB_Q; i_3++) {
                    B[i_1][i_2-1][i_2] = G[i_0+1][i_3][i_1+1][i_2] * H[i_1][i_3][i_0][i_2][0] + G[i_1][i_0-1][i_2][i_3+i_2] * I[i_1][i_3-1][i_0][0] + I[i_1][i_0+1][i_3][i_2] + B[i_3+1][i_2-1][i_2] - B[i_1+2][i_0-1][i_0] + B[i_1+2][i_2-3][i_2-2] - 4;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 0; i_5 < -i_4+PB_M; i_5++) {
            for (int i_6 = 1; i_6 < PB_M-1; i_6++) {
                C[i_6+1][i_5+1] = J[i_5+i_4][i_6][i_6-1] - K[i_5][i_4-1][i_6+1] + K[i_6][i_4+1][i_5] + I[i_6][i_5][i_4][i_4] * 4;
            }
        }
        D[i_4] = F[i_4] + E[i_4+1] - F[i_4] * E[i_4] + A[i_4][i_4+1] * A[i_4+1][i_4+2] * D[i_4+2] + D[i_4-2] - 3;
    }
#pragma endscop
...
init_array(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4412251323_07(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
