...
void kernel_2236132225_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 4; i_0 < PB_M-2; i_0++) {
        A[i_0-2] = C[i_0+2] * C[i_0] * A[i_0-4] + A[i_0-3] - 2;
        A[i_0-3] = D[i_0+1][0] + C[i_0] - C[i_0] - 5;
    }
#pragma endscop
...
kernel_2236132225_04(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
