...
void kernel_4222212313_02(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 0; i_1 < PB_P; i_1++) {
            for (int i_2 = 0; i_2 < PB_L; i_2++) {
                B[i_0-2][i_2][i_1] = C[i_0+2][i_2][i_1] - 2;
            }
        }
    }
        ...
        for (int i_4 = 1; i_4 < PB_L; i_4++) {
            for (int i_5 = 3; i_5 < PB_L; i_5++) {
                for (int i_6 = 2; i_6 < PB_P; i_6++) {
                    B[i_5-2][i_4][i_6] = B[i_6-2][i_5][i_3-1] * B[i_5-3][i_4-1][i_6] - B[i_5-3][i_4][i_6-1] - 2;
                }
            }
        }
    }
...
kernel_4222212313_02(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
