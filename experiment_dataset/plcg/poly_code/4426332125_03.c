...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 0; i_2 < i_0; i_2++) {
                for (int i_3 = 2; i_3 < -i_1+PB_M; i_3++) {
                    A[i_0][i_1][i_3][i_3-2] = E[i_1-1][i_1][i_0][i_2][i_0] + F[i_0][i_1][i_3][i_2] + G[i_1+2][i_3+2][i_0][i_0-1] - G[i_3+i_1][i_2][i_0][i_0] + 2;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M; i_4++) {
        ...
        for (int i_5 = max(i_4, 2); i_5 < -i_4+PB_L; i_5++) {
            B[i_5-2] = I[i_5-1][i_5+i_4] - J[i_5][i_4] - I[i_5][i_4] + 3;
            for (int i_6 = 4; i_6 < PB_P-2; i_6++) {
                for (int i_7 = 2; i_7 < min(-i_6+PB_M, -i_4+PB_P); i_7++) {
                    A[i_4][i_6][i_7][i_7-2] = G[i_5][i_6+1][i_7+i_4][i_6] * G[i_7+i_6][i_4-1][i_5][1] * G[i_7][i_4][i_6+2][i_5] * A[i_5-2][i_4][i_6-2][i_6-4] + 5;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4426332125_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J)));
