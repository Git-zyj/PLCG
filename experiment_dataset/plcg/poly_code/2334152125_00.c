...
void kernel_2334152125_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        B[i_0] = D[i_0] + D[i_0-2] - 2;
    }
    for (int i_1 = 0; i_1 < PB_M-2; i_1++) {
        B[i_1] = D[i_1] + D[i_1] - D[i_1+2] - B[i_1+2] - 2;
    }
    for (int i_2 = 2; i_2 < PB_M-2; i_2++) {
        B[i_2+2] = D[i_2+2] - D[i_2-2] + D[0] + D[i_2] + D[i_2] * D[i_2-2] * D[i_2] + D[i_2] - 3;
    }
#pragma endscop
...
kernel_2334152125_00(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
