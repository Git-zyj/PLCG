...
void kernel_4436251313_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        A[i_0] = E[i_0+1] - F[i_0] + E[i_0] + E[i_0-1] * G[i_0+1][i_0] + F[i_0] * A[i_0+1] - B[i_0] * B[i_0-1] - B[i_0+1] * B[i_0] * 2;
        B[i_0] = E[i_0+1] * A[i_0] + A[i_0-1] - B[i_0+1] + 6;
    }
        ...
        for (int i_2 = 0; i_2 < -i_1+PB_M-1; i_2++) {
            for (int i_3 = 1; i_3 < min(-i_1+PB_M-1, i_2); i_3++) {
                for (int i_4 = 1; i_4 < PB_M; i_4++) {
                    C[i_3+i_1+1][i_2][i_3-1][i_2] = H[i_2+i_1+1][i_4][i_3+i_2][i_2] + I[i_3+1][i_4][i_1][i_2] * H[i_4-1][i_1+1][i_2][i_3] * H[i_4][i_1][i_2][i_1+1] * I[i_2][i_3+1][i_1][0] * I[i_4][i_3-1][i_2][i_1] - 6;
                }
            }
        }
    }
        ...
        for (int i_6 = 1; i_6 < PB_M-2; i_6++) {
            for (int i_7 = 1; i_7 < min(i_5, -i_6+PB_M-2); i_7++) {
                for (int i_8 = 1; i_8 < PB_M-1; i_8++) {
                    C[i_7+i_6+2][i_8+1][i_7-1][i_8+1] = H[i_8][i_5][i_6-1][i_5-1] + H[i_7+1][i_5][i_8][i_6] - H[i_7][i_5-1][i_6][i_8] * H[i_6+1][i_7][i_8][i_5] - H[i_8-1][i_5][i_6][i_7] - 4;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4436251313_02(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I)));
