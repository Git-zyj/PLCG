...
void kernel_4422312125_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
        ...
        for (int i_1 = 0; i_1 < -i_0+PB_N-1; i_1++) {
            for (int i_2 = 2; i_2 < PB_M; i_2++) {
                for (int i_3 = 0; i_3 < i_2; i_3++) {
                    A[i_1+i_0+1][i_2-2][i_3+1][0] = E[i_1][i_3+1][i_0+2][i_2-2] - A[i_1+i_0+1][i_2][i_3+1][0] - 4;
                }
            }
        }
    }
        ...
        for (int i_7 = 0; i_7 < PB_P; i_7++) {
            for (int i_8 = 0; i_8 < -i_7+PB_P; i_8++) {
                for (int i_9 = 0; i_9 < i_6; i_9++) {
                    C[i_6][i_7][i_8][i_7] = F[i_8][i_8+i_7][i_9][i_6-1] * C[i_9][i_6][i_8+1][i_6] - 4;
                }
            }
        }
        for (int j_0 = 0; j_0 < PB_N-1; j_0++) {
            for (int j_1 = 0; j_1 < -j_0+PB_N-1; j_1++) {
                for (int j_2 = 2; j_2 < -i_6+PB_M; j_2++) {
                    A[j_1+j_0+1][i_6-1][j_2-1][0] = E[j_0][j_1][j_2+i_6][i_6] + G[j_2-2][j_0][j_1] * 2;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4422312125_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G)));
