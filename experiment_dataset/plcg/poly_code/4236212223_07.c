...
void kernel_4236212223_07(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    for (int i_0 = 4; i_0 < PB_M-2; i_0++) {
        ...
        B[i_0-2][i_0] = C[i_0] * B[i_0][i_0+2] - B[i_0-1][i_0+1] + B[i_0-4][i_0-2] - 4;
    }
#pragma endscop
...
kernel_4236212223_07(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
