...
void kernel_4416251215_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk)){
        ...
        for (int i_1 = i_0; i_1 < min(-i_0+PB_P, PB_M-1); i_1++) {
            for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_2+PB_Q, PB_M-1); i_3++) {
                    A[i_1][i_3][i_2-1] = E[i_2+1][i_0][i_3][0] - F[i_1-1][i_0][i_3] - F[i_3][i_2+1][i_0-1] + G[i_2+1][i_3][i_1-1] + A[i_2+1][i_3][i_0-1] - B[i_3+1][i_0][i_1-1][i_3+i_2] - 5;
                }
            }
            for (int i_4 = 0; i_4 < min(PB_M, -i_1+PB_Q); i_4++) {
                for (int i_5 = 1; i_5 < min(-i_1+PB_Q+1, PB_M-1); i_5++) {
                    B[i_1+1][i_0][i_5-1][i_4+i_1] = G[i_5+1][i_1][i_4] + F[i_1][i_4][i_5] - H[i_1][i_5][i_4][i_0-1] * E[i_0][i_5][i_4][i_1] * H[i_4][i_0][i_1+i_0][i_5+i_1-1] * H[i_1][i_5][i_0][i_4+1] * 5;
                }
            }
        }
        C[i_0] = I[i_0] + J[i_0] + K[i_0][i_0] - J[i_0] * J[i_0] + C[i_0+1] + 5;
    }
    for (int i_6 = 0; i_6 < PB_M-1; i_6++) {
        C[i_6] = I[i_6+1] * J[i_6] * J[i_6] - J[i_6+1] - C[i_6+1] * 2;
    }
#pragma endscop
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4416251215_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K)));
