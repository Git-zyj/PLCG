...
void kernel_4214332115_01(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we)){
        ...
        for (int i_1 = 2; i_1 < min(PB_L, -i_0+PB_Q-1); i_1++) {
            for (int i_2 = 0; i_2 < PB_N-1; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_2+PB_N-1, i_1); i_3++) {
                    B[i_2][i_1][i_3-1][i_3+1] = C[i_3+i_2+1][i_0][i_1][i_1] * D[i_2+1][i_0][i_1-2][0] * 1;
                }
            }
            for (int i_4 = 0; i_4 < PB_P-2; i_4++) {
                for (int i_5 = 2; i_5 < PB_L-2; i_5++) {
                    B[i_4][i_1][i_5][i_5+2] = D[i_1+1][i_5+2][i_4+2][i_1+1] - E[i_5-2][i_1][i_4][i_0][i_1+i_0+1] + E[i_1][i_0][i_4][i_5+2][1] - D[i_0+1][i_5][i_1-1][i_4] + B[i_0+1][i_5-1][i_4+1][i_4+3] + 1;
                }
            }
        }
    }
...
kernel_4214332115_01(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E));
