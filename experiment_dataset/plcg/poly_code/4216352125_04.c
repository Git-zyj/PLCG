        ...
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 2; i_2 < PB_L-2; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_2+PB_N+2, i_1); i_3++) {
                    B[i_1][i_2+2][i_0] = E[i_3][i_0][i_2][i_1+1] - F[i_3][i_3][i_0][i_1+1] + E[i_1][i_2][i_0+1][0] * G[i_3][i_0][i_2-2] - E[i_2][i_2-1][i_1][i_3] + G[i_1][i_3][i_2] * F[i_3+i_2-2][i_1][i_0][0] + B[i_3][i_2][i_1] - 6;
                }
            }
        }
    }
...
kernel_4216352125_04(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
