        ...
        for (int i_1 = i_0; i_1 < -i_0+PB_M-2; i_1++) {
            for (int i_2 = 0; i_2 < PB_Q-2; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_0+PB_Q, i_0); i_3++) {
                    A[i_0][i_0][i_2][i_3] = C[i_3+1][i_1+i_0-2][i_3][i_2] * C[i_3-1][i_2+2][i_1][0] - C[i_1-1][i_2][i_3+i_0][i_0] * D[i_1+i_0+2][i_2][i_1][i_2] * A[i_2][i_2][i_0][i_3-1] - A[i_0+1][i_0+1][i_2][i_3] - 3;
                }
            }
        }
        B[i_0-1] = E[i_0] * E[i_0] + E[i_0] - E[i_0+2] * E[i_0-2] - 6;
    }
#pragma endscop
...
kernel_4236352111_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
