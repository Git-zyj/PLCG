...
void kernel_4232351215_05(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
        ...
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < PB_Q-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_L; i_3++) {
                    B[i_0+1][i_1][i_2+1][0] = C[i_3-1][i_0][i_1+1][i_2] * D[i_3-1][i_0-1][i_1] + E[i_1][i_3][i_0-1][i_2-1] * E[i_1][i_0][i_3+1][i_2+1] + F[i_0][i_1][i_1][i_3] * 3;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < -i_4+PB_P-1; i_5++) {
            for (int i_6 = 1; i_6 < PB_Q; i_6++) {
                for (int i_7 = 0; i_7 < PB_L-1; i_7++) {
                    B[i_7+1][i_5][i_6+1][0] = E[i_6][i_5][i_7+1][i_4] + E[i_5-1][i_7][i_5+i_4+1][i_4] + C[i_7][i_6][i_5][i_4+1] * G[i_6-1][i_5+i_4+1][i_7] + E[i_5][i_4-1][i_7+1][i_6] * B[i_5][i_7][i_6+1][0] * B[i_6][i_7+1][i_5+1][0] * 5;
                }
            }
        }
    }
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4232351215_05(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G)));
