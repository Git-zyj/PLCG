...
void kernel_4322351325_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            for (int i_2 = 0; i_2 < min(PB_Q-3, -i_1+PB_P); i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_M-1; i_3++) {
                    A[i_1][i_1][i_2+1][i_3] = D[i_3+i_0+1][i_3][i_2][i_2+i_1] * D[i_1-1][i_3][i_0+1][i_2+1] - A[i_3][i_3][i_2+3][i_1] * A[i_1][i_1][i_2+2][i_3] + 3;
                }
            }
        }
        for (int i_4 = 2; i_4 < i_0; i_4++) {
            for (int i_5 = 1; i_5 < -i_0+PB_P; i_5++) {
                for (int i_6 = 1; i_6 < -i_0+PB_P-1; i_6++) {
                    B[i_4][i_6][i_5+i_0][i_0] = E[i_5-1][i_6-1][i_0] - F[i_5+1][i_6+1][i_0] * G[i_5-1][i_0][i_4][i_6] + G[i_0][i_6+1][i_4][i_5] - B[i_4][i_0-2][i_6+i_5+1][i_5+1] - B[i_4-2][i_0-1][i_6+i_5][i_6] - B[i_5][i_4][i_6+i_0+1][i_6] - 1;
                }
            }
        }
    }
    for (int i_7 = 2; i_7 < PB_M; i_7++) {
        for (int i_8 = 1; i_8 < PB_L-1; i_8++) {
            for (int i_9 = i_8; i_9 < -i_8+PB_P; i_9++) {
                for (int j_0 = max(i_9, 2); j_0 < min(-i_7+PB_P, -i_9+PB_L+1); j_0++) {
                    B[j_0-2][i_7-2][i_9+i_8][i_8] = D[i_7-1][j_0+1][i_8+1][i_9] * G[i_8][i_9][i_7][j_0+1] + H[i_8-1][j_0+i_9-1][j_0+i_7][1] * D[i_8-1][i_9][0][j_0] - H[i_8][j_0][i_7][i_9-1] + G[i_7][i_7][j_0][i_8] * F[i_8][i_9][j_0] - H[i_8][j_0][i_7][i_9] * 2;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4322351325_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H)));
