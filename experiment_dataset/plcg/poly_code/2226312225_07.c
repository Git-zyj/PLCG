...
void kernel_2226312225_07(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-4; i_0++) {
        ...
        B[i_0+2] = C[i_0][0] + B[i_0+4] + B[i_0+1] * 6;
    }
#pragma endscop
...
kernel_2226312225_07(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
