...
void kernel_2214131223_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-2; i_0++) {
        A[i_0] = C[i_0][0] - A[i_0+2] + A[i_0+1] + 6;
    }
    for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
        A[i_1] = D[i_1] + D[i_1] * D[i_1+1] * D[i_1-1] * 2;
    }
#pragma endscop
...
kernel_2214131223_00(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
