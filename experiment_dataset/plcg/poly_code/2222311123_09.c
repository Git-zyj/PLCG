...
void kernel_2222311123_09(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_N; i_0++) {
        ...
        for (int i_2 = 1; i_2 < PB_L; i_2++) {
            B[i_2][i_0+1] = C[i_0][0] * B[i_2-1][i_0-1] + 4;
        }
    }
#pragma endscop
...
kernel_2222311123_09(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
