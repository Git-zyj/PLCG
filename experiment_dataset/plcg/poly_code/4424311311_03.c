...
void kernel_4424311311_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf)){
        ...
        for (int i_2 = 2; i_2 < min(PB_M, -i_1+PB_L+1); i_2++) {
            for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
                for (int i_4 = 0; i_4 < i_1; i_4++) {
                    C[i_3][i_4+1][i_1][i_2-1] = E[i_2][i_3][i_4][i_1] + E[i_1][i_4+1][i_4][i_3+1] * F[i_2+i_1-1][i_3][i_2][i_4+1] - C[i_3][i_4+2][i_1-1][i_2-1] - C[i_3-1][i_4+1][i_1-1][i_2-2] + C[i_2][i_4+1][i_1-1][i_3-1] * C[i_3+1][i_4+2][i_1][i_2-2] + C[i_3-1][i_4+1][i_1][i_2] + C[i_3][i_4+1][i_1+1][i_2-1] * C[i_4+1][i_3+1][i_1][i_2-1] * 4;
                }
            }
        }
        for (int i_5 = 0; i_5 < PB_L; i_5++) {
            for (int i_6 = i_1; i_6 < PB_P; i_6++) {
                for (int i_7 = 0; i_7 < PB_L; i_7++) {
                    D[i_1][i_5][i_6][i_6] = D[i_1-1][i_7][i_6-1][i_6-1] + 5;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), INIT_SEED);
kernel_4424311311_03(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F)));
