...
void kernel_3412231215_00(int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N; i_0++) {
        C[i_0-2][i_0-1] = E[i_0] * F[1] * E[i_0] + E[i_0] - 6;
        for (int i_1 = 1; i_1 < -i_0+PB_L-1; i_1++) {
            B[i_1][i_0] = G[i_0][i_1] * H[i_0-1][i_1-1] * G[i_1+i_0][1] + G[i_1][i_0-1] - G[i_1+i_0+1][0] + 6;
            C[i_0-1][i_0] = F[i_1+i_0+1] * B[i_1+1][i_0-1] - B[i_0-1][i_1] - B[i_1][i_0] * 4;
        }
    }
    for (int i_2 = 0; i_2 < PB_P; i_2++) {
        for (int i_3 = 1; i_3 < PB_N; i_3++) {
            for (int i_4 = 1; i_4 < PB_L; i_4++) {
                C[i_3-1][i_3] = I[i_4][i_2][i_4-1] + I[i_3][i_2][i_4] + 1;
            }
        }
    }
#pragma endscop
...
kernel_3412231215_00(xc,yc,POLYBENCH_ARRAY(C), xb,yb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
