...
void kernel_4226212325_09(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N; i_0++) {
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
                B[i_1-2][i_2] = B[i_1][i_2] - B[i_1][i_2+1] * 5;
            }
            B[i_0][i_1] = C[i_1][i_0-2] + B[i_0-2][i_1] - 4;
        }
    }
#pragma endscop
...
kernel_4226212325_09(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
