...
void kernel_4234111313_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        for (int i_1 = 2; i_1 < PB_M; i_1++) {
            for (int i_2 = 0; i_2 < i_1; i_2++) {
                B[i_1-1] = B[i_1-1] - B[i_2] + 3;
            }
            B[i_1-1] = C[i_1][i_0-1] + C[i_1][i_0] + B[i_1-2] - 5;
        }
    }
#pragma endscop
...
kernel_4234111313_09(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
