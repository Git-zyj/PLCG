...
void kernel_4232212213_07(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < min(PB_P-1, -i_0+PB_P); i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_P-1; i_2++) {
                for (int i_3 = 0; i_3 < PB_M-2; i_3++) {
                    A[i_2+1][i_3][i_1+i_0] = A[i_3+2][i_0+1][i_2+i_1+1] + 2;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M-3; i_4++) {
        for (int i_5 = 0; i_5 < PB_M-3; i_5++) {
            B[i_5][i_5+2] = C[i_4][i_5+2] * B[i_4+1][i_4+3] - B[i_5+1][i_5+3] - 4;
        }
    }
#pragma endscop
...
kernel_4232212213_07(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
