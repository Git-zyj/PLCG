...
void kernel_4432131325_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_L+1; i_1++) {
            for (int i_2 = 1; i_2 < PB_L-2; i_2++) {
                for (int i_3 = 2; i_3 < i_2; i_3++) {
                    A[i_0][i_2][i_1+1][i_3] = E[i_1][i_2][i_0][i_3-1] - A[i_0][i_3-2][i_2+1][i_1] + A[i_0][i_2+2][i_3+3][i_1-1] - A[i_1][i_3+2][i_2+1][i_0] * A[i_3][i_2-1][i_1+1][i_0] - 2;
                }
            }
            for (int i_4 = 1; i_4 < -i_1+PB_L-1; i_4++) {
                for (int i_5 = 1; i_5 < PB_L; i_5++) {
                    B[i_5][i_0-1][i_4+i_1+1][i_4-1] = E[i_4][i_4][i_5][1] * E[i_5][i_1+i_0][i_4+1][i_1-1] * F[i_5+1][i_4][1] - E[i_0+1][i_4][i_1][i_5] * E[i_5][i_4][i_1-1][i_0] - E[i_0][i_4+1][i_1][0] + E[i_5-1][i_0][i_1][i_1] + B[i_5][i_4+1][i_1+i_0-1][i_0-3] - B[i_5+1][i_0-1][i_4+i_1+1][i_4-1] * 3;
                }
            }
        }
    }
    for (int i_6 = 1; i_6 < PB_M-3; i_6++) {
        D[i_6+3] = G[i_6] * D[i_6+1] + D[i_6-1] - D[i_6+3] * 2;
        D[i_6+1] = H[i_6][i_6+1] + G[i_6] * G[i_6] - 3;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4432131325_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H)));
