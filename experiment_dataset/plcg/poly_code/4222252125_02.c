...
void kernel_4222252125_02(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
        ...
        for (int i_1 = i_0; i_1 < min(-i_0+PB_Q+1, PB_M); i_1++) {
            for (int i_2 = 2; i_2 < PB_L; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_1+PB_M, -i_0+PB_L); i_3++) {
                    B[i_1-1][i_3+i_0][i_3][i_2-2] = C[i_2][i_3+2][i_1+i_0-1][i_1] - D[i_2][i_3][i_1-2][i_2] + C[i_3+i_1][i_2][i_3][i_0] * E[i_3][i_2][i_0] * 1;
                }
            }
        }
        for (int i_4 = 0; i_4 < PB_L-1; i_4++) {
            for (int i_5 = 1; i_5 < min(-i_0+PB_L-2, -i_4+PB_L-1); i_5++) {
                for (int i_6 = 2; i_6 < PB_L-2; i_6++) {
                    B[i_6][i_5+i_0][i_5][i_4] = D[i_5][i_4][i_0][i_5-1] * D[i_5+i_4+1][i_4][i_0][i_6-2] + C[i_0][i_5][i_4][i_0] + C[i_5][i_6+i_5][i_0-2][i_4+2] - C[i_0][i_6][i_5][i_4+2] + B[i_6+2][i_5+i_0+2][i_5+2][i_4+1] * 5;
                }
            }
        }
    }
...
kernel_4222252125_02(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
