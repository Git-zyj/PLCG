...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < -i_0+PB_L; i_1++) {
            for (int i_2 = 0; i_2 < min(i_0, PB_L-1); i_2++) {
                for (int i_3 = 0; i_3 < PB_P; i_3++) {
                    A[i_1][i_2+1][i_0][i_3] = E[i_2][i_1+i_0][i_1][i_2] - 2;
                }
            }
        }
    }
    for (int i_4 = 3; i_4 < PB_M-2; i_4++) {
        for (int i_5 = i_4; i_5 < -i_4+PB_L; i_5++) {
            B[i_5+1][i_4-1][i_4] = F[i_5][i_5+i_4] * G[i_5][i_4] - B[i_5][i_4-3][i_4-2] + 2;
        }
        C[i_4] = H[i_4] - 6;
        for (int i_6 = i_4; i_6 < PB_L+2; i_6++) {
            for (int i_7 = 2; i_7 < min(i_6, PB_L); i_7++) {
                for (int i_8 = 0; i_8 < PB_L-1; i_8++) {
                    D[i_4+2][i_8][i_7][i_8] = A[i_7-2][i_8+1][i_6-2][i_4-1] * 2;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4426312121_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H)));
