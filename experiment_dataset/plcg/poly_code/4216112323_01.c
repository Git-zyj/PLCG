...
void kernel_4216112323_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 4; i_1 < PB_M; i_1++) {
            for (int i_2 = 2; i_2 < i_1; i_2++) {
                for (int i_3 = 0; i_3 < PB_M-2; i_3++) {
                    A[i_2-1][i_3+2][i_1-2] = C[i_3][i_1][i_2] - A[i_2-1][i_3+2][i_1-4] - A[i_3][i_1][i_2-2] * A[i_3+1][i_2][i_0] * 2;
                }
            }
        }
...
kernel_4216112323_01(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C));
