...
void kernel_2234111223_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_2 = 0; i_2 < PB_M; i_2++) {
        for (int i_3 = 0; i_3 < PB_M-3; i_3++) {
            B[i_3+1] = C[i_3] - B[i_3+3] + B[i_3+2] * 2;
        }
    }
#pragma endscop
...
kernel_2234111223_09(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
