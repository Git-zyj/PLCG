...
void kernel_4324252311_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        A[i_0] = D[i_0] + E[i_0-2] * D[i_0-1] * E[i_0] * B[i_0] * 2;
        B[i_0] = E[i_0] - E[0] + B[i_0+1] * B[i_0-1] * 5;
    }
    for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
        for (int i_2 = 2; i_2 < PB_L-1; i_2++) {
            for (int i_3 = 2; i_3 < PB_L; i_3++) {
                C[i_2-1][i_3][i_1] = F[i_2+1][0] - G[i_3-2][i_1+1][i_2] + H[i_3-1][i_1+1][i_2] * I[i_2][i_3][i_1-1][0] + F[i_2][i_3] - G[i_1+1][i_3-1][i_2] - H[i_2][i_1][0] - C[i_2-1][i_3-1][i_1] + C[i_2-1][i_3-1][i_1+1] + C[i_2-2][i_3][i_1-1] + C[i_2-1][i_3][i_1-1] + C[i_2][i_3][i_1] - 4;
            }
        }
    }
#pragma endscop
...
kernel_4324252311_00(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
