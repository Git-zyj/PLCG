...
void kernel_4436131311_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
        ...
        for (int i_1 = i_0; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 1; i_2 < i_0; i_2++) {
                for (int i_3 = 0; i_3 < PB_P-1; i_3++) {
                    A[i_0-1][i_2-1][i_0][i_3] = E[i_3+1][i_2][i_3][i_0-1] * F[i_3][i_0-1][i_1] - A[i_0-1][i_2-1][i_0][i_3+1] * 3;
                }
            }
            B[i_0][i_1+1] = G[i_0][i_1+1] + G[i_0][i_1+1] + G[i_1+1][i_0-1] * C[i_0] * 3;
        }
    }
    for (int i_4 = 1; i_4 < PB_M-2; i_4++) {
        C[i_4+1] = H[i_4-1] + H[i_4] - H[i_4+1] - H[i_4] + H[i_4] + C[i_4] - C[i_4+2] + C[i_4] - 3;
    }
    for (int i_5 = 1; i_5 < PB_L-2; i_5++) {
        for (int i_6 = 1; i_6 < min(i_5, -i_5+PB_L-2); i_6++) {
            for (int i_7 = 1; i_7 < PB_L; i_7++) {
                for (int i_8 = 1; i_8 < min(-i_6+PB_L-2, -i_5+PB_L); i_8++) {
                    D[i_7][i_8+i_6+1][0][i_5-1] = E[i_7+i_6][i_7-1][i_8+i_5][i_6] - A[i_5-1][i_7][i_5][i_8] + D[i_7][i_8+i_5][0][i_6-1] * D[i_7+1][i_6+i_5+1][0][i_8] * D[i_7][i_8+i_6+1][0][i_5] * D[i_7+1][i_8+i_6+2][0][i_5-1] + D[i_7][i_8+i_6][0][i_5-1] * D[i_7-1][i_6+i_5+2][0][i_8-1] + 2;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4436131311_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H)));
