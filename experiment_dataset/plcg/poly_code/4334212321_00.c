...
void kernel_4334212321_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M+1; i_0++) {
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 4; i_2 < PB_M; i_2++) {
                A[i_2][i_1][i_2-2] = A[i_2-2][i_1][i_2-4] - A[i_0-1][i_1][i_0-3] * A[i_2][i_0-2][i_2-2] * 2;
            }
        }
    }
        ...
        for (int i_4 = 0; i_4 < i_3; i_4++) {
            for (int i_5 = 1; i_5 < min(-i_4+PB_L, i_3); i_5++) {
                for (int i_6 = 2; i_6 < PB_P; i_6++) {
                    B[i_5-1][i_4][i_6][i_3] = D[i_3-1][i_5+i_4][i_6-2] - E[i_3][i_5+1][i_5][i_6-1] + B[i_5-1][i_4+2][i_6][i_3-2] + 1;
                }
            }
        }
        for (int i_7 = i_3; i_7 < -i_3+PB_M-2; i_7++) {
            C[i_7+i_3][i_7+2] = C[i_7+i_3][i_7+4] - C[i_7+i_3+2][i_7+4] - C[i_7+i_3][i_3+3] + 1;
        }
    }
#pragma endscop
...
kernel_4334212321_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
