...
void kernel_3214152223_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        B[i_0] = C[i_0] * C[i_0] - C[i_0] * C[i_0] * C[i_0] + C[i_0] - C[i_0] - 6;
    }
    for (int i_1 = 1; i_1 < PB_M-2; i_1++) {
        B[i_1] = C[i_1] * C[i_1] * C[i_1] - B[i_1+2] + B[i_1-1] + 1;
    }
#pragma endscop
...
kernel_3214152223_09(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
