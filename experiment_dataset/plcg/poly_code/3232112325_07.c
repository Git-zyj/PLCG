...
void kernel_3232112325_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        A[i_0+2] = A[i_0+4] - A[i_0+3] * 3;
        A[i_0+3] = C[i_0] - A[i_0+2] + 2;
    }
#pragma endscop
...
kernel_3232112325_07(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
