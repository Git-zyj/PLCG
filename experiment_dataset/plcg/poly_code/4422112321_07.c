...
void kernel_4422112321_07(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 0; i_1 < min(-i_0+PB_M-2, i_0); i_1++) {
            A[i_1+i_0][i_1] = A[i_1+i_0+2][i_1+2] - A[i_1+i_0-1][i_1] - 3;
        }
    ...
    for (int i_3 = 0; i_3 < PB_N; i_3++) {
        for (int i_4 = 1; i_4 < PB_M-2; i_4++) {
            C[i_3][i_4] = C[i_3][i_4+2] * C[i_3][i_4-1] + 4;
        }
    }
    for (int i_5 = 0; i_5 < PB_P; i_5++) {
        for (int i_6 = 2; i_6 < PB_M; i_6++) {
            for (int i_7 = 1; i_7 < PB_Q-2; i_7++) {
                for (int i_8 = 2; i_8 < min(-i_6+PB_P+2, PB_M-1); i_8++) {
                    D[i_7][i_7][i_8] = E[i_7][i_5][i_8+i_6-2][i_7+2] - D[i_7][i_7][i_8-2] * D[i_8+1][i_8+1][i_7-1] + D[i_6][i_6][i_8+1] - 4;
                }
            }
        }
    }
...
kernel_4422112321_07(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
