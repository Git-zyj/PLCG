...
void kernel_2316352323_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        B[i_0] = D[i_0] * E[i_0] * D[i_0] + E[i_0] + D[i_0+1] * B[i_0-2] * 2;
        B[i_0] = F[i_0] + F[i_0] - D[i_0] - D[i_0+2] * F[i_0] * G[i_0-2][i_0] - B[i_0-2] - C[i_0] - 1;
    }
    for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
        C[i_1] = E[i_1+2] - D[i_1] - F[i_1+2] + H[i_1][0] + C[i_1+1] - C[i_1-1] * 3;
    }
#pragma endscop
...
kernel_2316352323_00(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
