...
void kernel_4336211323_06(int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N-1; i_0++) {
        for (int i_1 = 0; i_1 < -i_0+PB_N-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_M; i_2++) {
                C[i_1+i_0+1][i_1+i_0] = D[i_2][i_2][i_1] - 1;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_N-3; i_3++) {
        for (int i_4 = 2; i_4 < PB_N+1; i_4++) {
            for (int i_5 = 0; i_5 < -i_4+PB_N+1; i_5++) {
                C[i_5+i_4-1][i_5+i_4-2] = 6;
            }
        }
        for (int i_6 = 1; i_6 < -i_3+PB_N-3; i_6++) {
            C[i_6+i_3+1][i_6+i_3] = E[i_6-1][i_3] * F[i_6][i_3-1] + C[i_6+i_3+3][i_6+i_3+2] - C[i_6+i_3][i_6+i_3-1] * C[i_6+i_3+1][i_6+i_3] - 6;
        }
    }
#pragma endscop
...
kernel_4336211323_06(xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
