...
void kernel_4422251121_01(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        B[i_0] = E[i_0] * E[i_0] - F[i_0] - G[i_0][1] + F[i_0] - G[i_0+1][0] * H[i_0][1] - B[i_0] * 1;
        for (int i_1 = i_0; i_1 < PB_M-1; i_1++) {
            B[i_1] = E[i_1] + F[i_1] - G[i_1+1][i_0] - G[i_1-1][i_0+1] * I[i_0+1][i_1][1] * 4;
            C[i_0-1][i_1+1] = G[i_1][i_0] - H[i_1][i_0] - 3;
        }
    }
    for (int i_2 = 0; i_2 < PB_M; i_2++) {
        D[i_2] = F[1] - E[i_2] * E[i_2] * E[i_2] * 2;
    }
#pragma endscop
...
kernel_4422251121_01(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
