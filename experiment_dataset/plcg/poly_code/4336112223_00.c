        ...
        for (int i_1 = 0; i_1 < PB_P; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-3; i_2++) {
                for (int i_3 = 0; i_3 < min(i_0, -i_2+PB_L-3); i_3++) {
                    A[i_0][i_2+1][i_3+i_2+1][i_0] = D[i_3][i_2+2][i_1][i_0-2] * A[i_0][i_2][i_3+i_2][i_0] - A[i_0][i_2+1][i_3+i_2+3][i_0] - A[i_0][i_3+2][i_3+i_2+2][i_0] + 3;
                }
            }
        }
    }
        ...
        for (int i_6 = i_4; i_6 < PB_L-1; i_6++) {
            for (int i_7 = 2; i_7 < i_4; i_7++) {
                for (int i_8 = 2; i_8 < PB_Q-1; i_8++) {
                    C[i_4-2][i_6][i_7-1][i_8] = E[i_4][i_7-1][i_8][i_6][i_4+1] - C[i_8-2][i_6-2][i_7-1][i_4] + C[i_4-3][i_6][i_7-2][i_8+1] + C[i_4-3][i_6+1][i_7-2][i_8] * 2;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), INIT_SEED);
kernel_4336112223_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E)));
