...
void kernel_4222312315_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
        ...
        for (int i_1 = 1; i_1 < PB_L+1; i_1++) {
            for (int i_2 = 1; i_2 < min(PB_L, i_1); i_2++) {
                for (int i_3 = i_2; i_3 < PB_L; i_3++) {
                    A[i_2][i_3][0] = A[i_1-1][i_3][0] * A[i_3][i_2+1][0] - A[i_2-1][i_3-1][0] + 4;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_L-2; i_4++) {
            B[i_0][i_4-1] = C[i_4][i_4+2] * B[i_0][i_4] * B[i_0+1][i_4-1] * B[i_0-1][i_4] * 6;
        }
    }
#pragma endscop
...
kernel_4222312315_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
