...
void kernel_2412352125_01(int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        D[i_0] = E[i_0] + E[i_0] + F[i_0][i_0-1] + E[i_0] - 3;
        for (int i_1 = 2; i_1 < -i_0+PB_M; i_1++) {
            B[i_0][i_1] = E[i_1+1] - G[i_1][i_0] - F[i_1+i_0][i_0] * 4;
            C[i_0][i_1+2] = H[i_1][i_0] - G[0][i_1] - H[i_0-2][i_1-2] * H[i_0][i_1+1] + H[i_1][i_0] * F[i_1][i_0] - C[i_0][i_1+4] * 3;
        }
    }
    for (int i_2 = 0; i_2 < PB_N; i_2++) {
        D[i_2] = E[i_2] * I[i_2] - J[i_2] - I[i_2] * I[i_2] - I[i_2] * J[i_2] * 2;
    }
#pragma endscop
...
kernel_2412352125_01(xd,POLYBENCH_ARRAY(D), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
