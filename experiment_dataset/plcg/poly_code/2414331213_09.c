...
void kernel_2414331213_09(int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        for (int i_1 = 0; i_1 < min(PB_P, -i_0+PB_M-1); i_1++) {
            C[i_0][i_0] = E[i_1+i_0+1] + F[i_0-1][i_1] - G[i_1][i_0] * 2;
        }
    }
    for (int i_2 = 1; i_2 < PB_L-1; i_2++) {
        for (int i_3 = 0; i_3 < PB_L; i_3++) {
            C[i_2-1][i_2-1] = G[i_3][i_2+1] + F[i_3+1][i_2-1] - H[i_2] * G[i_2][0] + C[i_2+1][i_2+1] - 3;
        }
        C[i_2][i_2] = H[i_2] - I[i_2][0] * 6;
        for (int i_4 = 0; i_4 < i_2; i_4++) {
            C[i_2+1][i_2+1] = F[i_2][i_2] - G[i_4+1][i_2] - G[i_4+1][i_2+1] + C[i_2][i_2] + 2;
        }
    }
#pragma endscop
...
kernel_2414331213_09(xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
