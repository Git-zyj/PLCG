...
void kernel_4422251315_06(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        C[i_0] = E[i_0] - F[i_0+1] - E[i_0] - F[i_0] - E[i_0-1] + F[0] + E[i_0] - C[i_0] - 3;
        for (int i_1 = i_0; i_1 < PB_M-1; i_1++) {
            C[i_0+1] = F[i_0] + G[i_1-1][i_0-1] - H[i_1-1][0] + G[i_1+1][i_0] * C[i_0] - 5;
        }
        C[i_0] = H[i_0-1][0] * F[i_0-1] + F[i_0+1] + F[i_0] * E[i_0-1] * E[i_0] - C[i_0+1] - 4;
    }
    for (int i_2 = 1; i_2 < PB_Q+1; i_2++) {
        for (int i_3 = 0; i_3 < PB_M; i_3++) {
            for (int i_4 = 0; i_4 < PB_M-1; i_4++) {
                C[i_4] = I[i_4+1][0][i_2] + I[i_3][i_4][i_2] - J[i_4][i_3][i_2-1] - 6;
            }
        }
    }
#pragma endscop
...
kernel_4422251315_06(xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
