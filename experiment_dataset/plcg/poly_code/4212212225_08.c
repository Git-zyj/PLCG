...
void kernel_4212212225_08(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        for (int i_1 = 0; i_1 < PB_M; i_1++) {
            for (int i_2 = 3; i_2 < PB_M-2; i_2++) {
                A[i_2][i_2-1] = C[i_2][i_0] + A[i_2+2][i_2+1] + A[i_2-2][i_2-3] + 4;
            }
        }
    }
...
kernel_4212212225_08(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C));
