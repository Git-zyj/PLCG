...
void kernel_3322111215_08(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < min(-i_0+PB_M, PB_M-1); i_1++) {
            C[i_1] = D[i_1+i_0] * D[i_1+1] + 4;
        }
...
kernel_3322111215_08(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
