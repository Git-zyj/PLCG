...
void kernel_4236311221_01(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd)){
        ...
        for (int i_5 = 1; i_5 < PB_L-1; i_5++) {
            for (int i_6 = max(2, i_5); i_6 < min(PB_L, -i_5+PB_M); i_6++) {
                for (int i_7 = 0; i_7 < -i_4+PB_L; i_7++) {
                    B[i_6][i_5][i_4+1][i_4] = C[i_7][i_6+1][i_6] + D[i_6+i_5][i_7+i_4][i_5-1][i_4+1] + B[i_6-2][i_5][i_4+3][i_4+2] * B[i_6][i_5+1][i_4+1][i_4] * 5;
                }
            }
        }
    }
...
kernel_4236311221_01(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D));
