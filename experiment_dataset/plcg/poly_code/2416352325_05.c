...
void kernel_2416352325_05(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        C[i_0] = E[i_0] + E[i_0] * F[i_0+1] - C[i_0] - 3;
    }
    for (int i_1 = 2; i_1 < PB_M-1; i_1++) {
        for (int i_2 = i_1; i_2 < PB_M; i_2++) {
            B[i_2-2] = G[i_2-2][i_1+1] - H[i_2-2][i_1] * I[i_2-1][i_1-2] - I[i_1][i_2] * G[i_2][i_1] - C[i_1] + 4;
        }
        C[i_1] = J[i_1+1] - F[i_1] - J[i_1] - J[i_1] * J[i_1] - E[i_1] - B[i_1-2] * C[i_1-1] * 5;
        C[i_1+1] = J[i_1] - F[i_1-1] * E[i_1] * F[i_1] - C[i_1] - C[i_1-1] - 4;
    }
#pragma endscop
...
kernel_2416352325_05(xc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
