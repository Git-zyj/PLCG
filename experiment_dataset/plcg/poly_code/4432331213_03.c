        ...
        for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
            for (int i_3 = 1; i_3 < -i_2+PB_M-1; i_3++) {
                for (int i_4 = 1; i_4 < min(-i_2+PB_N, i_2); i_4++) {
                    D[i_4+1][i_2-1][i_2-1] = F[i_3+i_2+1][i_1][i_4-1][i_2] - G[i_3-1][i_4+i_2][i_1+1][i_2] + H[i_2][i_3+1][0][i_1+1] * 5;
                }
            }
            A[i_2] = I[i_2+1][i_1+1] - J[i_1] - 2;
        }
    }
        ...
        for (int i_6 = 0; i_6 < PB_M; i_6++) {
            for (int i_7 = 1; i_7 < i_5; i_7++) {
                for (int i_8 = 0; i_8 < min(PB_M, -i_7+PB_L); i_8++) {
                    D[i_7][i_8][i_8] = K[i_8][i_6][i_5] * F[i_6][i_8+i_7][i_5][i_7-1] - G[i_7][i_5+1][i_8][i_6] + 6;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4432331213_03(xa,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K)));
