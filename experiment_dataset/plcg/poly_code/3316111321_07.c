...
void kernel_3316111321_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
    ...
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        ...
        for (int i_1 = 0; i_1 < PB_M-1; i_1++) {
            for (int i_2 = max(1, i_1); i_2 < PB_M; i_2++) {
                B[i_1+1][i_2] = D[i_0][i_0] - B[i_2][i_1] * B[i_1+1][i_2-1] - B[i_2-1][i_0] - 1;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_L+1; i_3++) {
        for (int i_4 = 0; i_4 < min(PB_L-3, i_3); i_4++) {
            for (int i_5 = i_4; i_5 < PB_L-3; i_5++) {
                C[i_4][i_5+1] = B[i_3+1][i_4] * C[i_5][i_4+3] * C[i_4+1][i_5+3] * C[i_4][i_3-1] * 3;
            }
        }
    }
#pragma endscop
...
kernel_3316111321_07(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
