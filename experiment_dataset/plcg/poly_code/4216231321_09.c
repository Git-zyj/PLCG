    ...
    for (int i_3 = 0; i_3 < PB_M; i_3++) {
        for (int i_4 = max(2, i_3); i_4 < min(-i_3+PB_M, PB_L-1); i_4++) {
            for (int i_5 = 0; i_5 < -i_4+PB_M+1; i_5++) {
                B[i_3][i_4][i_5+i_4] = C[i_4+i_3][i_5][0] * E[i_5][i_3][i_5+i_4-1] - D[i_3][i_4] + B[i_3][i_4-2][i_5+i_4] - B[i_3][i_4+1][i_5+i_4-1] * 2;
            }
        }
    }
#pragma endscop
...
kernel_4216231321_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
