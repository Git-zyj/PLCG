...
void kernel_4212212325_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 0; i_1 < min(-i_0+PB_P+1, PB_P-1); i_1++) {
            for (int i_2 = 2; i_2 < -i_1+PB_P-1; i_2++) {
                for (int i_3 = 3; i_3 < PB_L+1; i_3++) {
                    A[i_0-1][i_2+i_1+1][i_3-1][i_3-1] = A[i_0-1][i_2+i_1+1][i_3-3][i_3-3] - A[i_3-1][i_1+i_0-1][i_2-2][i_2-2] + 3;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_P; i_4++) {
        for (int i_5 = 1; i_5 < PB_M-1; i_5++) {
            for (int i_6 = i_5; i_6 < min(-i_5+PB_M-1, -i_4+PB_L); i_6++) {
                B[i_6+i_5][1] = C[i_5][i_6+i_4][i_4] * B[i_6+i_5-1][1] - B[i_6+i_5+1][1] * B[i_6+i_5][1] + 6;
            }
        }
    }
#pragma endscop
...
kernel_4212212325_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
