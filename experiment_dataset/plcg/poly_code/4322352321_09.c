...
#endif
static void init_array(int xa,int ya,int za,int va,int wa,DATA_TYPE POLYBENCH_5D(A,xA,yA,zA,vA,wA,xa,ya,za,va,wa),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl),int seed)
{
srand(seed);
...
static void print_array(int xa,int ya,int za,int va,int wa,DATA_TYPE POLYBENCH_5D(A,xA,yA,zA,vA,wA,xa,ya,za,va,wa),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl))
{
int i_0, i_1, i_2, i_3, i_4;
...
void kernel_4322352321_09(int xa,int ya,int za,int va,int wa,DATA_TYPE POLYBENCH_5D(A,xA,yA,zA,vA,wA,xa,ya,za,va,wa),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 1; i_1 < PB_Q; i_1++) {
            for (int i_2 = 2; i_2 < min(-i_1+PB_M, PB_Q); i_2++) {
                for (int i_3 = 1; i_3 < min(PB_P-2, -i_0+PB_P); i_3++) {
                    A[i_1][i_3][i_1][i_0][i_2] = D[i_0-1][i_3+1][i_2] + E[i_1][i_0][i_3][i_2] - E[i_2][i_3+i_0][i_1][i_1] * F[i_2][i_1-1][i_0] + G[i_1][i_2][i_3][i_0] + H[i_3-1][i_2+1][i_2][i_1][i_0] * G[i_3-1][i_2+i_1][i_0+2][i_1] - G[i_2][i_0+1][i_1][i_2-1] + A[i_0][i_1][i_0][i_2][i_3+2] + A[i_1][i_3][i_1][i_0][i_2-2] * A[i_1][i_3][i_1][i_0][i_2+1] - A[i_1-1][i_3][i_1-1][i_2-2][i_0] + 3;
                }
            }
        }
    }
        ...
        for (int i_5 = 2; i_5 < -i_4+PB_M; i_5++) {
            for (int i_6 = 0; i_6 < PB_Q; i_6++) {
                for (int i_7 = 0; i_7 < -i_6+PB_Q; i_7++) {
                    A[i_4][i_5][i_4][i_6][i_7] = I[i_6][i_5][i_4] - J[i_4+1][i_7+i_6][i_5][0] - I[i_7][i_5][i_4] + 4;
                }
            }
            C[i_4][i_5] = K[i_4][i_5] - L[i_5-2][i_4] * L[i_5+i_4][i_4] * C[i_4+2][i_5] - C[i_4-2][i_5-2] - 1;
        }
    }
#pragma endscop
