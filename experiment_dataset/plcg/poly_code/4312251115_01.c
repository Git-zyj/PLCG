        ...
        for (int i_1 = 1; i_1 < -i_0+PB_Q-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_P-1; i_3++) {
                    A[i_0][i_1-1][i_2+1][i_3] = D[i_1][i_0][i_2][0] - D[i_3-1][i_2][i_1+i_0+1][i_2] * A[i_0][i_2][i_1+1][i_3+1] - 6;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        B[i_4+1] = E[i_4+1] - F[i_4] + F[i_4] * 3;
        for (int i_5 = i_4; i_5 < PB_L-1; i_5++) {
            B[i_4+1] = G[i_5][i_4+1] * H[i_5+1][i_4] + F[i_5] + H[i_5][i_4] * G[i_5][i_4] * G[i_4][i_5+1] - G[i_5+1][i_4-1] + H[i_5][i_4] * G[i_5][i_4] - F[i_4-1] * B[i_5+1] + 2;
        }
    }
#pragma endscop
...
kernel_4312251115_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
