        ...
        for (int i_1 = 0; i_1 < -i_0+PB_P; i_1++) {
            for (int i_2 = 1; i_2 < PB_P-2; i_2++) {
                for (int i_3 = 0; i_3 < i_1; i_3++) {
                    A[i_1][i_2+2][i_0] = D[i_3][i_0-2][i_1+i_0][i_2+2] + E[i_3][i_2][i_1+i_0-2][i_2] * E[i_3][i_1][i_3][i_2-1] - A[i_2][i_3+3][i_0+2] - 2;
                }
            }
        }
        B[i_0] = F[i_0] + F[i_0] - B[i_0+1] * B[i_0-1] + B[i_0-2] - B[i_0+2] - 1;
    }
    for (int i_4 = 0; i_4 < PB_L-2; i_4++) {
        for (int i_5 = max(i_4, 4); i_5 < PB_M-1; i_5++) {
            C[i_5][i_5-2] = G[i_5+1][i_4+2] * H[i_5-1] - H[i_5-2] + I[i_5][i_4] - C[i_5-2][i_5-4] - C[i_5-1][i_5-3] - 4;
        }
    }
#pragma endscop
...
kernel_4316332323_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
