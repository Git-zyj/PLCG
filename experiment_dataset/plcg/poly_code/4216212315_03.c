...
void kernel_4216212315_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 2; i_1 < PB_M; i_1++) {
            B[i_1] = C[i_1-2] - B[i_1] * 2;
        }
    }
...
kernel_4216212315_03(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
