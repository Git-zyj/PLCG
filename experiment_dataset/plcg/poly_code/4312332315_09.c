        ...
        for (int i_1 = i_0; i_1 < PB_P-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_Q-3; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_0+PB_M, i_2); i_3++) {
                    A[i_3][i_3][i_0][i_2+2] = D[i_3-1][i_1+1][i_2][i_0] * E[i_3+i_0][i_2][0] * A[i_3-1][i_3-1][i_0+1][i_2+2] * A[i_3][i_3][i_0][i_2+3] * 5;
                }
            }
        }
        B[i_0+2] = F[i_0][i_0-2] + G[i_0] - B[i_0+1] + B[i_0+3] * 1;
        B[i_0+2] = H[i_0] - I[i_0] + I[i_0+1] + G[i_0-1] - B[i_0+2] + 5;
    }
#pragma endscop
...
kernel_4312332315_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
