...
void kernel_4212351121_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_Q; i_1++) {
            for (int i_2 = 1; i_2 < PB_Q-2; i_2++) {
                for (int i_3 = max(2, i_2); i_3 < PB_Q-1; i_3++) {
                    A[i_0][i_2][i_3][i_1] = C[i_2][0][i_3][i_0-1] - D[i_2][i_3][i_1-1][i_0+1] * E[i_2][i_2][i_1][i_3+1] - E[i_3][i_0-1][i_1][1] * B[i_3-2][i_2+2][i_2+1] + 2;
                }
                B[i_2-1][i_1+1][i_1] = F[i_2][i_2+1][i_1+i_0] + G[i_2+i_1][i_1] - H[i_1+i_0-1][i_0][i_2] + H[i_0-1][i_2][i_1] - D[i_1][i_2][i_0+1][i_2-1] * H[i_1][i_1+i_0][i_2] + B[i_2][i_1+1][i_1] + 2;
            }
        }
    }
#pragma endscop
...
kernel_4212351121_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
