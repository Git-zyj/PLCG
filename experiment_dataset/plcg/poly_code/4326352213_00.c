...
void kernel_4326352213_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
        ...
        for (int i_1 = 0; i_1 < min(-i_0+PB_M-1, i_0); i_1++) {
            for (int i_2 = 1; i_2 < PB_L+1; i_2++) {
                for (int i_3 = 0; i_3 < PB_L-2; i_3++) {
                    A[i_3][i_0][i_2][i_1] = D[i_1][i_3+2][i_3][i_2] + E[i_2][i_0-1][i_1][i_3+1] - E[i_2][i_0-2][i_3][i_1+1] - F[i_3][i_2-1][i_1] - E[i_1][i_2-1][i_0][i_3] - 3;
                }
            }
            B[i_0+1][i_1+i_0] = G[i_0][i_1] * H[i_1+1][i_0-1] + B[i_1+1][i_1+i_0+1] - B[i_0+1][i_1+i_0-1] - B[i_0+1][i_1+i_0+1] * 1;
        }
        for (int i_4 = 2; i_4 < -i_0+PB_M; i_4++) {
            B[i_0+1][i_4+i_0] = H[i_0][i_4] * I[0] + F[i_4][0][i_0] * H[i_0+1][i_4-2] - I[i_0+1] * J[i_4] * 6;
        }
    }
#pragma endscop
...
kernel_4326352213_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
