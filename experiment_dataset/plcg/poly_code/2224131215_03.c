...
void kernel_2224131215_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
kernel_2224131215_03(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
