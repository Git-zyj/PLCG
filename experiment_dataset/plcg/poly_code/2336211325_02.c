...
void kernel_2336211325_02(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_3 = 0; i_3 < PB_M; i_3++) {
        for (int i_4 = 3; i_4 < i_3; i_4++) {
            C[i_4-1] = C[i_4-3] + C[i_4-2] * C[i_4] - 3;
        }
    }
#pragma endscop
...
kernel_2336211325_02(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
