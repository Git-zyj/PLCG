...
void kernel_3216212113_06(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
...
#pragma scop
    for (int i_0 = PB_L - 1; i_0 >= 0; i_0--) {
        ...
        for (int i_3 = 0; i_3 < min(PB_L, -i_0+PB_P-1); i_3++) {
            B[i_3][i_3+i_0] = C[i_0][i_3][1] + B[i_3+1][i_3+i_0+1] - 2;
        }
    }
#pragma endscop
...
kernel_3216212113_06(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
