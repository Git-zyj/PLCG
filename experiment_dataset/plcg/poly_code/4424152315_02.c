...
void kernel_4424152315_02(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
        ...
        for (int i_1 = 0; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 1; i_2 < i_0; i_2++) {
                for (int i_3 = 1; i_3 < -i_1+PB_M-2; i_3++) {
                    B[i_1+1][i_1][i_3+1] = E[i_3+i_1+2][i_2][i_0][i_2] + F[i_1][i_2-1][i_3-1][i_0][i_3+2] + 5;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-2; i_4++) {
        for (int i_5 = 0; i_5 < -i_4+PB_M-1; i_5++) {
            for (int i_6 = 2; i_6 < PB_Q; i_6++) {
                B[i_4+1][i_4][i_6] = G[i_6-2][i_5+i_4+1] * G[i_5+i_4+1][i_6] * B[i_5+1][i_5][i_4-1] - 2;
            }
        }
        for (int i_7 = 1; i_7 < PB_M-2; i_7++) {
            C[i_4][i_7] = G[i_7][i_4] + G[i_4+2][i_7] * G[i_4][i_7] + H[i_7+2][i_4][1] - G[i_7][i_4] - I[i_7] - B[i_4+1][i_4][i_7+1] + C[i_4][i_7-1] - C[i_4-1][i_7] - C[i_4+1][i_7] * 3;
        }
        D[i_4] = I[i_4-1] - I[i_4-1] - I[i_4+2] + I[i_4+2] + I[i_4] + I[i_4-2] * I[i_4] * I[i_4+2] - I[i_4+1] - I[i_4] * D[i_4+1] - D[i_4-1] + 5;
    }
#pragma endscop
...
init_array(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4424152315_02(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I)));
