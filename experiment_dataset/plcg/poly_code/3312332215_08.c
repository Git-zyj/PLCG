...
void kernel_3312332215_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        A[i_0-2] = D[i_0+2] * 4;
        for (int i_1 = 3; i_1 < -i_0+PB_M; i_1++) {
            A[i_1-2] = E[i_1+i_0] + F[i_1+i_0][i_0] - A[i_1-2] + A[i_1-3] + 4;
            for (int i_2 = 3; i_2 < i_0; i_2++) {
                A[i_2-3] = G[i_1+1][i_2][i_0] + H[i_2][i_1+2] + I[i_1][i_2+2][i_0-2] + G[i_1][i_0][i_2] - I[i_2+1][i_0-1][i_1+2] * 3;
            }
        }
    }
#pragma endscop
...
kernel_3312332215_08(xa,POLYBENCH_ARRAY(A), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
