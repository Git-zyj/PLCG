...
void kernel_4322311223_01(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        for (int i_1 = 2; i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = 2; i_2 < PB_L; i_2++) {
                A[i_1+i_0][i_2] = A[i_2+i_1-2][i_0-1] * A[i_1+i_0-2][i_2-2] * 5;
            }
        }
        for (int i_3 = 0; i_3 < -i_0+PB_M; i_3++) {
            for (int i_4 = 0; i_4 < -i_0+PB_M; i_4++) {
                A[i_3+i_0][i_4] = A[i_4+i_0][i_3] * 3;
            }
        }
    }
    for (int i_5 = 0; i_5 < PB_M-2; i_5++) {
        for (int i_6 = 0; i_6 < PB_M; i_6++) {
            C[i_5][i_6] = D[i_5][0] * C[i_5+2][i_6] - 4;
        }
    }
#pragma endscop
...
kernel_4322311223_01(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
