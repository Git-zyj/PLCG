...
void kernel_2316112325_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_L-4; i_1++) {
        B[i_1+2] = D[i_1] + B[i_1+1] * B[i_1+3] - B[i_1+4] + 6;
...
kernel_2316112325_05(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
