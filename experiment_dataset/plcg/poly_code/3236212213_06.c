...
void kernel_3236212213_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
kernel_3236212213_06(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
