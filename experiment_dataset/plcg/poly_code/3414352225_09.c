...
void kernel_3414352225_09(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M-1; i_0++) {
        C[i_0-3] = E[i_0] * F[i_0+1] * G[i_0][i_0] * E[i_0+1] + 4;
        C[i_0-1] = F[i_0] - H[i_0+1] - F[i_0] * E[i_0] * 2;
    }
    for (int i_1 = 3; i_1 < PB_M-1; i_1++) {
        C[i_1-1] = E[i_1] - E[i_1] - F[i_1-2] * C[i_1-3] + 1;
        for (int i_2 = 1; i_2 < -i_1+PB_M; i_2++) {
            D[i_2+1][i_1] = G[i_2][i_1] + G[i_1][i_2] + I[i_2+i_1][i_1+2] + I[i_1][i_2] * G[i_2-1][i_1] + G[i_1+1][i_2] - H[i_2+2] * C[i_2-1] - D[i_2+3][i_1] + D[i_1+1][i_2+2] * 3;
        }
    }
#pragma endscop
...
kernel_3414352225_09(xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
