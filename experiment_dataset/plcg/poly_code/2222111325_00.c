...
void kernel_2222111325_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_N; i_0++) {
        ...
        B[i_0+1] = C[i_0] * C[i_0] - B[i_0+3] - B[i_0-1] * 2;
    }
#pragma endscop
...
kernel_2222111325_00(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
