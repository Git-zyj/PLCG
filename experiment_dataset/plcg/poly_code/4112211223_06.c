...
void kernel_4112211223_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb)){
        ...
        for (int i_1 = 0; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_P; i_2++) {
                for (int i_3 = 0; i_3 < PB_M-2; i_3++) {
                    A[i_1][i_3][i_3] = B[i_1][i_2-1][0] - A[i_3+2][i_1][i_1] * A[i_1+1][i_3][i_3] + 6;
                }
            }
        }
    }
...
kernel_4112211223_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B));
