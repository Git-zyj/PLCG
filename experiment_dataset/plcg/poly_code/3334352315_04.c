...
void kernel_3334352315_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        A[i_0-1] = D[i_0] + E[i_0] + F[i_0-1] + E[i_0] * F[i_0] * F[i_0] + A[i_0] * A[i_0-2] - A[i_0-2] + A[i_0-2] - 3;
    }
    for (int i_1 = 1; i_1 < PB_L-2; i_1++) {
        A[i_1-1] = E[i_1] - D[i_1+1] - E[i_1+1] + E[i_1] * 6;
        for (int i_2 = 2; i_2 < i_1; i_2++) {
            C[i_1][i_2-1] = G[i_2][i_1+2] + H[i_1][i_2-2] + I[i_1][i_2][i_2+1] + G[i_2][i_1] + A[i_2] + C[i_1+1][i_2] + 4;
        }
    }
#pragma endscop
...
kernel_3334352315_04(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
