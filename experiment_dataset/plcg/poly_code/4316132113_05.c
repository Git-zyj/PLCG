...
void kernel_4316132113_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_P; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_P-1; i_3++) {
                    A[i_1+1][i_3][i_2][i_2+i_0] = D[i_2][i_0][i_0][i_3+1] + E[i_2][i_1][i_3] - A[i_2+1][i_1-1][i_3][i_3+i_0+1] - A[i_0+1][i_1][i_2+1][i_3+i_2+1] - 6;
                }
            }
        }
        for (int i_4 = 2; i_4 < PB_L; i_4++) {
            for (int i_5 = 1; i_5 < PB_L-2; i_5++) {
                for (int i_6 = i_0; i_6 < -i_5+PB_L+1; i_6++) {
                    B[i_0-1][i_6][i_4-2][i_5] = D[i_0+2][i_5+2][i_6][i_4-2] * D[i_4][i_0][i_5+2][0] * D[i_0+2][i_6+i_5-1][i_6][i_4] + 3;
                }
                for (int i_7 = i_4; i_7 < min(-i_5+PB_P, -i_4+PB_L); i_7++) {
                    A[i_4][i_0][i_5][i_7+i_5] = E[i_5-1][i_7+i_4][i_7] - D[i_5][i_7-1][i_0][0] + E[i_5][i_4-2][i_7+1] * 1;
                }
            }
        }
    }
...
kernel_4316132113_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
