...
void kernel_2422252311_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M-1; i_0++) {
        A[i_0-2][i_0-1] = E[1] - F[i_0] * E[i_0-2] * E[0] - E[i_0-2] + E[i_0+1] - E[i_0+1] - 6;
        for (int i_1 = 2; i_1 < min(-i_0+PB_M, i_0); i_1++) {
            A[i_0-1][i_0] = G[i_1+i_0][i_1] * G[i_1][i_0] * H[i_0][i_1-2] * F[i_1-2] + A[i_0-1][i_0] - 2;
        }
        A[i_0-2][i_0-1] = F[i_0] * E[i_0+1] * A[i_0-3][i_0-2] - 2;
    }
    for (int i_2 = 2; i_2 < PB_N-1; i_2++) {
        for (int i_3 = 2; i_3 < PB_M-1; i_3++) {
            D[i_2][i_3] = G[i_3+1][i_2] + G[i_3][i_2] - H[i_2-1][i_2] * I[i_2][i_3][0] * H[i_3-2][i_2+2] + F[i_2-2] + D[i_2][i_3+1] - D[i_2+1][i_3+1] - D[i_2-1][i_3] * 5;
        }
    }
#pragma endscop
...
kernel_2422252311_04(xa,ya,POLYBENCH_ARRAY(A), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
