...
void kernel_2436251325_00(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_Q; i_0++) {
        for (int i_1 = 1; i_1 < PB_Q; i_1++) {
            C[i_0+3] = E[i_1][i_0] + E[i_1][i_0] + E[i_1][i_0] * F[i_1][i_0] - E[i_1][i_0+1] * 3;
            C[i_1+3] = E[i_0][i_1+1] - E[i_1][i_0] + E[i_0][i_1-1] * G[i_1-1][i_0][0] - D[i_1] + 5;
        }
    }
    for (int i_2 = 0; i_2 < PB_M-3; i_2++) {
        C[i_2+1] = H[i_2] + I[i_2] + C[i_2+3] - C[i_2] - 5;
    }
    for (int i_3 = 0; i_3 < PB_N-2; i_3++) {
        D[i_3] = I[i_3] + I[i_3] - I[i_3] - I[i_3] + I[i_3] - I[i_3] - D[i_3+2] - D[i_3+1] - 6;
    }
#pragma endscop
...
kernel_2436251325_00(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
