...
void kernel_4334252121_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 0; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_1+PB_M, -i_0+PB_M); i_2++) {
                for (int i_3 = 1; i_3 < min(min(-i_1+PB_M, -i_0+PB_L), PB_N-1); i_3++) {
                    A[i_3+i_0][i_3][i_2][i_2] = D[i_2][i_2+i_0][i_1+1][i_3-1] * D[i_3+1][i_2+i_1][i_0-2][i_2] - E[i_3+i_1][i_2][i_0][i_2+i_1] - E[i_3][i_0][i_1][i_0] + 4;
                }
            }
        }
        for (int i_4 = 0; i_4 < PB_M-2; i_4++) {
            B[i_4][i_0] = F[i_0][i_4][i_0] * G[i_0+1][i_4] * H[i_4][i_0] + G[i_4+2][i_0] + B[i_4+2][i_0] + 2;
        }
    }
    for (int i_5 = 1; i_5 < PB_P-2; i_5++) {
        for (int i_6 = 0; i_6 < -i_5+PB_L; i_6++) {
            C[i_5][i_6+1] = F[i_5+1][i_5][i_6] - I[i_6] + I[i_6+i_5] - G[i_5-1][i_6] - H[i_6][i_5+2] + G[i_6][i_6] * G[i_5][i_6+i_5] - 2;
        }
    }
#pragma endscop
...
kernel_4334252121_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
