...
void kernel_2226112323_01(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N+2; i_0++) {
        B[i_0-2] = C[i_0-1] * C[i_0-2] + 3;
    }
    for (int i_1 = 4; i_1 < PB_N; i_1++) {
        B[i_1-2] = B[i_1-4] + B[i_1-3] * B[i_1] + 2;
    }
#pragma endscop
...
kernel_2226112323_01(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
