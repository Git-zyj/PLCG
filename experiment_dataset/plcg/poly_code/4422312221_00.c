...
void kernel_4422312221_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
        ...
        for (int i_2 = 0; i_2 < PB_Q; i_2++) {
            for (int i_3 = 1; i_3 < PB_Q-2; i_3++) {
                for (int i_4 = i_3; i_4 < PB_Q+1; i_4++) {
                    B[i_3-1][i_2][i_4-1][i_2] = B[i_1-1][i_3+2][i_4-1][i_3+2] * 5;
                }
            }
        }
    }
    for (int i_5 = 1; i_5 < PB_M-1; i_5++) {
        ...
        for (int i_6 = 3; i_6 < PB_Q-2; i_6++) {
            for (int i_7 = 2; i_7 < PB_P-2; i_7++) {
                D[i_6-1][i_7] = E[i_6-1][i_5][i_6+2] * D[i_6-3][i_7-2] - D[i_6-1][i_7+2] + D[i_7-1][i_5+1] + 3;
            }
        }
    }
#pragma endscop
...
kernel_4422312221_00(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
