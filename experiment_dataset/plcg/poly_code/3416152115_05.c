...
void kernel_3416152115_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
    ...
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        ...
        for (int i_1 = 2; i_1 < PB_P; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_0+PB_M, PB_P); i_2++) {
                C[i_2][i_0][i_1] = F[i_1-2][i_2+i_0][i_1] + F[i_0][i_1-2][i_2] * G[i_1][i_2] - F[i_1-1][i_2+2][i_0-2] * F[i_1][i_0][i_2] - F[i_1][i_2+i_0][i_0] - 5;
            }
        }
        for (int i_3 = i_0; i_3 < PB_P; i_3++) {
            for (int i_4 = 2; i_4 < min(-i_3+PB_P, i_3); i_4++) {
                C[i_0][i_3][i_4] = F[i_3][i_0][i_4+i_3] + F[i_3][i_0][i_4-2] - F[i_3][i_0+2][i_4] * F[i_3][i_4][i_0-2] + C[i_0+1][i_3-1][i_4] - C[i_3][i_0-1][i_4] * 4;
            }
        }
    }
    for (int i_5 = 0; i_5 < PB_N; i_5++) {
        D[i_5] = E[i_5] + E[i_5+1] + E[i_5] - E[i_5] + E[i_5] - E[i_5] - 1;
    }
#pragma endscop
...
kernel_3416152115_05(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
