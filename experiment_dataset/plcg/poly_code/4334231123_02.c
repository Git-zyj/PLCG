...
void kernel_4334231123_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg)){
...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 2; i_2 < PB_M; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_0+PB_M, -i_2+PB_M); i_3++) {
                    A[i_3+i_2][i_1+1][i_3+i_2][i_1-1] = D[i_1][i_2][i_0-1][i_3+1] - E[i_3+1][i_0][i_1+1] * A[i_3+i_0][i_2][i_3+i_0][i_2-2] * 5;
                }
            }
        }
    }
    ...
    for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
        for (int i_6 = 1; i_6 < i_5; i_6++) {
            B[i_6] = F[i_6+1][i_5] * G[i_6] + F[i_6-1][i_5] * F[i_6][i_5+1] - G[i_6] + 5;
        }
    }
#pragma endscop
...
kernel_4334231123_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
