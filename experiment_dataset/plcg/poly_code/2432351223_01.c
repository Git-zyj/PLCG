...
void kernel_2432351223_01(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        A[i_0][i_0] = E[i_0] - F[i_0] - E[i_0+1] + 2;
        for (int i_1 = 2; i_1 < -i_0+PB_M; i_1++) {
            B[i_1][i_0] = G[i_0-1][i_1+1] - E[0] + G[i_0][i_1] + H[i_1+i_0][i_0] - H[i_0][i_1] + F[i_1+1] * H[i_0+1][i_1] + B[i_1+2][i_0] * B[i_1-2][i_0] + B[i_0-2][i_1-2] - 1;
        }
    }
    for (int i_2 = 2; i_2 < PB_M-1; i_2++) {
        A[i_2][i_2] = I[i_2] + F[i_2+1] - E[i_2] + E[i_2] * 4;
        A[i_2-2][i_2-2] = F[i_2] - E[i_2] + F[i_2] - 2;
    }
#pragma endscop
...
kernel_2432351223_01(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
