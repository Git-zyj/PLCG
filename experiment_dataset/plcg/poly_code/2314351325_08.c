...
void kernel_2314351325_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P-3; i_0++) {
        A[i_0] = D[i_0] - E[1] * D[i_0+1] + F[i_0] * A[i_0-2] + B[i_0][i_0+1] * 6;
        for (int i_1 = i_0; i_1 < -i_0+PB_L; i_1++) {
            B[i_0][i_0+1] = F[i_1+1] - G[i_0][i_1+1] * E[i_1] + B[i_0-2][i_0-1] * B[i_0-1][i_0] * B[i_0+2][i_0+3] - 2;
            A[i_0+1] = G[i_1][i_1] + F[i_0] + F[0] + H[i_1][i_0] + I[i_1][i_1+i_0] * D[i_1-1] * A[i_1] * 4;
        }
    }
#pragma endscop
...
kernel_2314351325_08(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
