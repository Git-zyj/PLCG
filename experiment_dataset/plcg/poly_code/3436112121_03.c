    ...
    for (int i_2 = 0; i_2 < PB_M; i_2++) {
        for (int i_3 = PB_M-1 - 1; i_3 >= 0; i_3--) {
            for (int i_4 = 0; i_4 < -i_3+PB_L; i_4++) {
                C[i_2][i_3][i_4] = F[i_3+1][i_4+i_3][i_2][i_4+1] + G[i_3][i_4][i_2+1] * 5;
            }
        }
    }
...
kernel_3436112121_03(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
