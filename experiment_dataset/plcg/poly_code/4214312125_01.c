...
void kernel_4214312125_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        A[i_0-2] = 5;
        for (int i_1 = i_0; i_1 < PB_M+2; i_1++) {
            A[i_1-2] = C[i_0+2] * A[i_1-2] * 4;
        }
    }
#pragma endscop
...
kernel_4214312125_01(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
