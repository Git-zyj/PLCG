...
void kernel_4314111323_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
kernel_4314111323_09(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
