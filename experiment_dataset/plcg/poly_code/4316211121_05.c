...
void kernel_4316211121_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = i_0; i_2 < PB_P-2; i_2++) {
                for (int i_3 = 1; i_3 < PB_Q; i_3++) {
                    A[i_3-1][i_2][i_0] = D[i_2][i_1][i_0+1] - A[i_1][i_2+2][i_3] - 5;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M; i_4++) {
        ...
        for (int i_5 = 0; i_5 < min(i_4, PB_P-2); i_5++) {
            for (int i_6 = 0; i_6 < PB_M-1; i_6++) {
                C[i_4][i_5][i_5] = C[i_4-2][i_5][i_5] * C[i_6+1][i_5+2][i_5+2] + 3;
            }
        }
    }
#pragma endscop
...
kernel_4316211121_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
