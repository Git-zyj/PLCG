...
void kernel_4336132125_07(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        B[i_0] = D[i_0-1] + 5;
        B[i_0] = D[i_0-1] + D[i_0] - D[i_0] - D[i_0] - B[i_0+1] * 6;
    }
    for (int i_1 = 1; i_1 < PB_M; i_1++) {
        B[i_1-1] = D[i_1] * D[i_1] - 5;
    }
#pragma endscop
...
kernel_4336132125_07(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
