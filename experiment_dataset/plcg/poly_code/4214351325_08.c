        ...
        for (int i_1 = 0; i_1 < -i_0+PB_P-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_P-2; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_2+PB_P-2, -i_0+PB_P-1); i_3++) {
                    A[i_0+1][i_1+1][i_3+i_2-1][i_3+i_2] = C[i_2+1][i_1][i_3+i_0+1][i_2] * D[i_3][i_1][i_2-1][i_0+1] - E[i_3][i_0+1][i_1][i_2] - A[i_0-1][i_1+1][i_3+i_2-1][i_3+i_2] * A[i_0+1][i_1+1][i_3+i_2+1][i_3+i_2+2] + A[i_0][i_1+1][i_3+i_2-1][i_3+i_2] - A[i_3+1][i_2+1][i_1+i_0][i_1+i_0+1] * 3;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        for (int i_5 = 1; i_5 < PB_P-1; i_5++) {
            for (int i_6 = i_5; i_6 < -i_4+PB_M-1; i_6++) {
                B[i_6+i_4+1][i_5][i_4][i_6] = F[i_5][i_6+1] + G[i_6][i_5] - H[i_5-1][i_6][i_4] + H[i_6+1][i_5][i_5] + I[i_5][i_6+i_4][i_4] - H[i_5][i_6+i_4-1][i_4] * B[i_6+i_4+1][i_5+1][i_4][i_6] + 3;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4214351325_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
