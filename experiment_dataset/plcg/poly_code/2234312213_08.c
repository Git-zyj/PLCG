...
void kernel_2234312213_08(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N; i_0++) {
        for (int i_1 = max(1, i_0); i_1 < PB_L+1; i_1++) {
            B[i_1+1] = C[i_1-1] * B[i_0] + 4;
        }
    }
...
kernel_2234312213_08(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
