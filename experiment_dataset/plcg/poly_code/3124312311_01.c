...
void kernel_3124312311_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M+1; i_0++) {
        for (int i_1 = 3; i_1 < PB_N; i_1++) {
            A[i_0-2] = B[i_1] + A[i_0-1] + A[i_1-3] * A[i_1-1] + 6;
        }
    }
#pragma endscop
...
kernel_3124312311_01(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
