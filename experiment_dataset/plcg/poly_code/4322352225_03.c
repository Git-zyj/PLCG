...
void kernel_4322352225_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P-3; i_0++) {
        for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_0+PB_Q, -i_1+PB_Q+2); i_2++) {
                for (int i_3 = 1; i_3 < i_1; i_3++) {
                    A[i_3][i_2][i_0+2][i_1] = D[i_1-1][i_3][i_0][i_2+i_0] * E[i_3][i_0][i_1-2] + F[i_2][i_3+1][i_0-2][i_0][i_2] * D[i_0][i_3][i_2+i_1-2][2] - D[i_3+2][i_0][i_1][i_2] - G[i_3][0][i_2+i_0][i_1-2] - G[i_0][i_1][i_3][i_2] * H[i_1-1][i_2][i_3][i_0] * I[i_3][i_1][i_1] - A[i_3][i_1][i_0+3][i_2+2] + A[i_3-1][i_2][i_0+2][i_1] - A[i_3+1][i_1+2][i_0+2][i_2] + 1;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L; i_4++) {
        for (int i_5 = 0; i_5 < min(PB_L, -i_4+PB_M+2); i_5++) {
            B[i_4][i_5] = J[i_5][i_4-2] - K[i_4][i_5] * K[i_5][i_4] - K[i_5+i_4-2][i_4] + K[i_5][i_4] * B[i_4+1][i_5] * 4;
        }
        for (int i_6 = i_4; i_6 < PB_P; i_6++) {
            for (int i_7 = 2; i_7 < PB_M+2; i_7++) {
                for (int i_8 = 0; i_8 < PB_N; i_8++) {
                    A[i_8][i_7-2][i_4][i_6] = 1;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4322352225_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K));
