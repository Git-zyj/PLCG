...
void kernel_4434131315_04(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        B[i_0] = E[i_0+1] - F[i_0][i_0-1] - 4;
    }
    for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
        B[i_1] = E[i_1+1] * E[i_1-1] + E[i_1] * B[i_1+1] + 2;
        for (int i_2 = 0; i_2 < -i_1+PB_P; i_2++) {
            B[i_2+1] = F[i_1][i_2+i_1] + F[i_2][i_1-1] + B[i_2] + 3;
        }
        for (int i_3 = 1; i_3 < PB_Q-1; i_3++) {
            for (int i_4 = 1; i_4 < -i_3+PB_Q-1; i_4++) {
                for (int i_5 = 1; i_5 < PB_Q; i_5++) {
                    D[i_1][i_4][i_5-1][i_1] = G[i_5-1][i_4][i_1-1] - G[0][i_5][i_4+i_3+1] - H[i_3][i_5][i_1-1][i_4] + D[i_1][i_4-1][i_5-1][i_1] - D[i_5-1][i_4][i_3-1][i_5-1] * D[i_1][i_3+1][i_5][i_1] * D[i_5][i_4][i_1][i_5] + 1;
                }
            }
        }
    }
...
kernel_4434131315_04(xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
