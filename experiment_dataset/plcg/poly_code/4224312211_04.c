...
void kernel_4224312211_04(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = max(2, i_0); i_1 < PB_M; i_1++) {
            for (int i_2 = 1; i_2 < PB_Q; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_2+PB_P+1, PB_M); i_3++) {
                    B[i_1][i_1-2][i_3+i_2-1][i_0] = C[i_3][i_1-2][i_2] + 4;
                }
            }
        }
    }
        ...
        for (int i_5 = max(i_4, 2); i_5 < min(-i_4+PB_P+1, PB_M-1); i_5++) {
            for (int i_6 = 3; i_6 < -i_4+PB_P; i_6++) {
                for (int i_7 = 2; i_7 < PB_Q+1; i_7++) {
                    B[i_5][i_5-2][i_6+i_4][i_7-1] = D[i_5+1][i_6][i_6] * B[i_5+1][i_5-1][i_6+i_4-1][i_7-2] + B[i_6-1][i_6-3][i_5+i_4-1][i_7-1] - 5;
                }
            }
        }
    }
...
kernel_4224312211_04(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
