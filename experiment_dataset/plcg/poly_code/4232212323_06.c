...
void kernel_4232212323_06(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_0 = 3; i_0 < PB_P; i_0++) {
        ...
        for (int i_2 = i_0; i_2 < -i_0+PB_Q; i_2++) {
            for (int i_3 = 1; i_3 < PB_Q; i_3++) {
                B[i_0][i_2][i_0-1] = C[i_3][i_0][i_2+i_0] + C[i_2+1][i_0][i_3] - B[i_0-2][i_2][i_0-3] * B[i_0][i_2+2][i_0-1] + B[i_3][i_2+1][i_3-1] - 2;
            }
        }
    }
#pragma endscop
...
kernel_4232212323_06(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
