...
void kernel_2224131315_07(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N; i_0++) {
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            B[i_1] = C[i_1] - B[i_1-1] - B[i_0] + 4;
        }
    }
    for (int i_2 = 1; i_2 < PB_L-1; i_2++) {
        B[i_2] = C[i_2+1] * C[0] - C[i_2] * C[i_2] * C[i_2] - B[i_2-1] * 1;
    }
#pragma endscop
...
kernel_2224131315_07(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
