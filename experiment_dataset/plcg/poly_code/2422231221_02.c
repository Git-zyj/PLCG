...
void kernel_2422231221_02(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_M-3; i_1++) {
        B[i_1+1] = E[i_1] * B[i_1+3] * B[i_1-1] * 2;
    }
    for (int i_2 = 1; i_2 < PB_M-2; i_2++) {
        C[i_2] = G[i_2-1][1] * F[i_2] + H[i_2][i_2+1] - C[i_2+1] * C[i_2+2] - 2;
        D[i_2] = E[i_2-1] - E[i_2-1] * F[i_2] + 4;
    }
#pragma endscop
...
kernel_2422231221_02(xc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
