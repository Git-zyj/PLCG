...
void kernel_4312151223_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        for (int i_1 = 1; i_1 < min(-i_0+PB_L, i_0); i_1++) {
            for (int i_2 = 2; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 1; i_3 < min(min(PB_Q-2, -i_1+PB_L), -i_2+PB_P); i_3++) {
                    A[i_0][i_3+1][i_2][i_0] = D[i_2][i_0][i_3+i_1][i_2+1] + D[i_3][i_1+1][i_3+i_2-1][i_0] * E[i_1-1][i_3+i_2][i_0][i_3-1][0] - F[i_3][i_2][i_0] + D[i_2+1][i_3+i_1][i_0][i_2] + A[i_0-2][i_3+1][i_2][i_0-2] * A[i_0][i_3+2][i_2][i_0] + 3;
                    B[i_0][i_2-1][i_3][i_1] = E[i_2][i_3+i_1][i_1][i_0-1][i_0] + D[i_2-1][i_3][i_1-1][i_0] + D[i_0][i_2][i_3][i_2+1] - D[i_3][i_1+i_0][i_2][i_3] - D[i_1][i_2+1][i_3+1][i_0] * F[i_0][i_2+i_1-1][i_3] + E[i_0][i_3-1][i_1][i_2][i_0+1] * B[i_0][i_2-2][i_1][i_3+1] * 3;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L; i_4++) {
        for (int i_5 = 2; i_5 < PB_Q+2; i_5++) {
            for (int i_6 = 1; i_6 < PB_Q-1; i_6++) {
                A[i_4][i_6+1][i_5-2][i_4] = F[i_4-1][i_4+1][i_6-1] + 2;
            }
        }
    }
#pragma endscop
...
kernel_4312151223_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
