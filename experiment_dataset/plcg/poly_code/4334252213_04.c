        ...
        for (int i_1 = i_0; i_1 < PB_P-1; i_1++) {
            for (int i_2 = 2; i_2 < -i_1+PB_M; i_2++) {
                for (int i_3 = 1; i_3 < PB_L-2; i_3++) {
                    C[i_3+i_2][i_1+1][i_3] = D[i_3-1][i_2-2][i_0+2][i_0-2] - E[i_3][i_0][i_3][i_2+i_1-2] * F[i_2+i_1][i_3+2][0] - D[i_3][i_2+2][i_1][i_0] - E[i_0][i_2][i_3][i_1+1] + 2;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_P; i_4++) {
        for (int i_5 = 2; i_5 < -i_4+PB_M+1; i_5++) {
            for (int i_6 = 2; i_6 < PB_M; i_6++) {
                C[i_6+i_5][i_4][i_5] = G[i_5][i_6] + H[i_5-2][i_6-2] - I[i_5+i_4-1][i_6][0] - I[i_5][i_4][i_4] + I[i_6][i_4][i_5] - 1;
            }
        }
        for (int i_7 = 1; i_7 < PB_P-1; i_7++) {
            for (int i_8 = 1; i_8 < min(-i_7+PB_L, i_7); i_8++) {
                for (int i_9 = 2; i_9 < min(-i_7+PB_L-1, PB_M-1); i_9++) {
                    C[i_8+i_7][i_9][i_7] = E[i_7][i_9][i_8][i_4-1] * I[i_9-2][i_7+1][i_8] - E[i_7][i_9+1][i_4-1][i_9] - E[i_4][i_8][i_7][i_7] * C[i_9+i_8-1][i_7-1][i_9] * C[i_9+i_7+1][i_8][i_7] * 4;
                }
            }
        }
    }
...
init_array(xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4334252213_04(xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
