...
void kernel_3326312125_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf)){
...
#pragma scop
    for (int i_0 = 3; i_0 < PB_L; i_0++) {
        ...
        B[i_0-1] = E[i_0-1] - B[i_0-2] + B[i_0-3] * 3;
        for (int i_2 = 1; i_2 < PB_Q-2; i_2++) {
            for (int i_3 = 2; i_3 < -i_2+PB_Q-2; i_3++) {
                C[i_3][i_2-1][i_0] = F[i_3-2][i_0][i_2][i_3+i_2+2] + C[i_3][i_2+1][i_0] - 4;
            }
        }
    }
#pragma endscop
...
kernel_3326312125_04(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
