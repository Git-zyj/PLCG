...
void kernel_4232352113_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg)){
        ...
        for (int i_1 = 1; i_1 < min(i_0, -i_0+PB_M+1); i_1++) {
            for (int i_2 = 2; i_2 < -i_0+PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < PB_L; i_3++) {
                    A[i_0][i_0][i_2][i_1] = C[i_1][i_3][i_3][i_0-2] - D[i_1][i_3][i_1-1][1] + E[i_1+i_0-1][i_2][i_3+1][i_1] + F[i_2][i_1][i_3+1] + F[i_3+1][i_1][i_2-2] - D[i_3][i_2+i_0+1][i_1][i_2] - E[i_0][i_1][i_3][i_2+1] * A[i_0][i_0][i_2-1][i_1] - 2;
                }
            }
        }
    }
...
kernel_4232352113_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
