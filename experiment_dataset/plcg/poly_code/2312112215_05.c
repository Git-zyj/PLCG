...
void kernel_2312112215_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_2 = 0; i_2 < PB_M-3; i_2++) {
        B[i_2+2] = D[i_2+1] - B[i_2+1] - B[i_2+3] - 2;
        B[i_2+2] = D[i_2] - 4;
    }
#pragma endscop
...
kernel_2312112215_05(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
