...
#pragma scop
    ...
    for (int i_4 = 2; i_4 < PB_M-4; i_4++) {
        for (int i_5 = 0; i_5 < PB_Q-4; i_5++) {
            B[i_4][i_4-2][i_5+2] = G[i_5][i_5] - G[i_4][i_5] - B[i_4][i_4-2][i_5+4] + D[i_4+2][i_5] + 2;
        }
        for (int i_6 = 2; i_6 < min(-i_4+PB_N, PB_L-2); i_6++) {
            for (int i_7 = 0; i_7 < i_4; i_7++) {
                for (int i_8 = 2; i_8 < -i_7+PB_P-1; i_8++) {
                    A[i_6][i_4+1][i_8+i_7+1][0] = H[i_8-2][i_4][i_7][i_6-2] - 3;
                }
            }
            D[i_4+2][i_6] = G[i_4][i_6] - I[i_4-1][i_6+2] + J[i_6] - I[i_6+i_4][i_4] * G[i_6][i_4-1] * F[i_4][i_6][i_4] - G[i_6][i_4] * D[i_4+1][i_6] - D[i_4+2][i_6-1] + D[i_4+4][i_6+2] - D[i_4+4][i_6+1] - D[i_4+2][i_6+1] * 1;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4422252321_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J)));
