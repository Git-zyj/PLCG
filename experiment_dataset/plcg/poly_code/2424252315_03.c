...
void kernel_2424252315_03(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 1; i_1 < min(PB_N-1, -i_0+PB_M-2); i_1++) {
            C[i_1] = E[i_1] - F[i_1+1][i_0][i_1] + G[i_1][i_0] + H[i_0][i_1-1] - G[i_1+i_0+2][1] + G[i_1+2][i_0+2] * C[i_1] * 2;
        }
        C[i_0] = I[i_0] - I[i_0-2] + I[i_0] * E[i_0+1] - I[i_0+2] - 4;
    }
    for (int i_2 = 2; i_2 < PB_L; i_2++) {
        C[i_2] = I[i_2] + I[i_2] * 3;
        for (int i_3 = 1; i_3 < min(PB_L, -i_2+PB_M); i_3++) {
            C[i_3-1] = G[i_3+i_2-2][i_3] * H[i_3+i_2][i_3] * G[i_3][i_2] * E[i_3] - G[i_3][i_2] - E[i_2] - I[i_3-1] + C[i_3] - C[i_2+1] - 4;
        }
    }
#pragma endscop
...
init_array(xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_2424252315_03(xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I)));
