...
void kernel_2114312125_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
...
kernel_2114312125_08(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
