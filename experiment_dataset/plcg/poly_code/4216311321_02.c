...
void kernel_4216311321_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < PB_L; i_2++) {
                for (int i_3 = 1; i_3 < i_0; i_3++) {
                    A[i_1][1][i_0] = C[i_2][i_1][1] * A[i_3-1][1][i_1+1] - A[i_2-1][1][i_1] * 1;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_L; i_4++) {
            B[i_0][i_4] = B[i_0-1][i_4] * B[i_0+1][i_4] + B[i_0][i_4-1] - 2;
        }
    }
#pragma endscop
...
kernel_4216311321_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
