...
void kernel_4426151213_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            B[i_1+2] = E[i_1] * F[i_1][i_1+1] - F[i_1][i_0] * G[i_0][i_1][i_0+1] + B[i_0+1] * B[i_1] - 6;
        }
        B[i_0+1] = E[i_0-1] + E[i_0] - E[i_0-1] - B[i_0] - 3;
    }
    for (int i_2 = 1; i_2 < PB_M+1; i_2++) {
        for (int i_3 = 1; i_3 < min(i_2, PB_M-1); i_3++) {
            C[i_3][i_2] = F[i_3][0] * F[i_3-1][i_2] + E[i_3+1] * F[i_2-1][i_3-1] * F[i_2-1][i_3+1] * F[i_3-1][i_2] - F[i_3-1][i_2] - C[i_3][i_2+1] * 3;
        }
    }
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        D[i_4+1] = E[i_4] * E[i_4+1] - E[i_4] + E[i_4-1] - 2;
    }
#pragma endscop
...
kernel_4426151213_05(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
