...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
        B[i_1+1] = D[i_1] + E[i_1-1] - C[i_1+1] - 5;
    }
    for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
        for (int i_3 = 1; i_3 < min(PB_M-1, -i_2+PB_P); i_3++) {
            C[i_3+1] = F[i_3][i_3+i_2][i_3-1] + G[i_3+1][i_2] - D[i_3] - H[i_2+1][i_3] - H[i_3][i_2] - C[i_2-1] + 6;
        }
    }
#pragma endscop
...
kernel_3324231123_00(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
