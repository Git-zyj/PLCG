...
void kernel_3112151323_02(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M; i_0++) {
        A[i_0-1][1] = B[i_0] - B[i_0-1] * B[i_0] + B[i_0-1] * B[i_0] + A[i_0-3][1] * A[i_0+1][1] - A[i_0-2][1] - 6;
    }
#pragma endscop
...
kernel_3112151323_02(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
