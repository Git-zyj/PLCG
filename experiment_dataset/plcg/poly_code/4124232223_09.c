...
void kernel_4124232223_09(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb)){
        ...
        for (int i_1 = 2; i_1 < PB_P; i_1++) {
            for (int i_2 = 2; i_2 < min(PB_P-2, i_0); i_2++) {
                for (int i_3 = 0; i_3 < min(-i_2+PB_L, PB_L-2); i_3++) {
                    A[i_3][i_1][0] = B[i_3][i_3+i_2][i_1] + B[i_3][i_3][i_2+2] - B[i_1-2][i_0][i_2-2] * A[i_3+2][i_2-2][0] + A[i_2-2][i_1][0] - 3;
                }
            }
        }
    }
...
kernel_4124232223_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B));
