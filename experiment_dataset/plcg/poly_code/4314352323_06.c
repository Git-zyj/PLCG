        ...
        for (int i_1 = 2; i_1 < PB_Q-2; i_1++) {
            for (int i_2 = 1; i_2 < PB_M+1; i_2++) {
                for (int i_3 = i_1; i_3 < PB_P; i_3++) {
                    A[i_2-1][i_1][i_3][i_1] = D[i_2-1][i_1-2][i_3][i_0+2] - A[i_2-1][i_0][i_1-1][i_0] * A[i_2-1][i_1+2][i_3][i_1+2] * 3;
                }
            }
        }
        B[i_0] = E[i_0] + F[i_0] + E[i_0] + E[i_0+2] + E[0] - B[i_0-1] * B[i_0+1] * B[i_0+2] + B[i_0-2] * 6;
        for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
            for (int i_5 = 0; i_5 < -i_0+PB_M; i_5++) {
                A[i_4-1][i_5][i_0][i_5] = G[i_5+1][i_4][i_0] + H[i_4][i_0][i_0-2] * I[i_5][i_4] * J[i_5+i_0][i_4][i_4-1] - J[i_5][i_0-1][i_4-1] - H[i_4+1][i_5][i_0] * G[i_0+2][i_5][i_4] - 4;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4314352323_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J)));
