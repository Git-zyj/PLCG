...
void kernel_3122112321_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N; i_0++) {
        for (int i_1 = 4; i_1 < i_0; i_1++) {
            A[i_1-2] = B[i_1] - A[i_1-4] - A[i_1-3] + A[i_1-1] * 6;
        }
    }
#pragma endscop
...
kernel_3122112321_07(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
