...
void kernel_4324312315_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
    ...
    for (int i_2 = 1; i_2 < PB_P-1; i_2++) {
        for (int i_3 = i_2; i_3 < PB_P; i_3++) {
            for (int i_4 = 1; i_4 < PB_P-1; i_4++) {
                C[i_2][i_3][i_4][i_4] = C[i_4][i_2+1][i_3][i_3] + C[i_2][i_3-1][i_4][i_4] - C[i_4-1][i_3][i_2-1][i_2-1] - C[i_2-1][i_3][i_4][i_4] + C[i_3][i_4+1][i_2+1][i_2+1] + 4;
            }
        }
    }
#pragma endscop
...
kernel_4324312315_09(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
