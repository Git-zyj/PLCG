...
void kernel_3326312311_05(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
...
#pragma scop
    for (int i_0 = 0; i_0 < PB_P-2; i_0++) {
        ...
        for (int i_2 = 1; i_2 < min(-i_0+PB_L-2, i_0); i_2++) {
            B[i_2][i_0+2] = D[i_2][i_0+2] - B[i_2-1][i_0+1] - C[i_2+2][i_2+i_0+2] + 4;
        }
    }
    for (int i_3 = 0; i_3 < PB_L-3; i_3++) {
        for (int i_4 = 0; i_4 < -i_3+PB_L-3; i_4++) {
            C[i_4+2][i_4+i_3+2] = D[i_4+1][i_3] * C[i_4+1][i_4+i_3+1] - C[i_4+3][i_4+i_3+3] - C[i_4+2][i_4+i_3+3] - C[i_4+1][i_4+i_3] * 5;
        }
    }
#pragma endscop
...
kernel_3326312311_05(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
