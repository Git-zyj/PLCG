...
void kernel_2432131323_03(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
    ...
    for (int i_2 = 2; i_2 < PB_M-2; i_2++) {
        ...
        C[i_2] = E[i_2] + E[i_2] - E[1] - E[0] + E[i_2] + 6;
    }
    for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
        D[i_3] = E[0] + E[i_3] * E[i_3] * E[i_3+1] * E[i_3-1] + D[i_3-1] * 6;
    }
#pragma endscop
...
kernel_2432131323_03(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
