        ...
        for (int i_1 = i_0; i_1 < -i_0+PB_M-1; i_1++) {
            for (int i_2 = 2; i_2 < PB_Q-1; i_2++) {
                for (int i_3 = 1; i_3 < min(PB_Q-1, -i_1+PB_M+1); i_3++) {
                    A[i_2][i_1-1][i_0-1][i_3-1] = E[i_3+i_1-1][i_2][i_0][0] * F[i_3][i_2][i_0][0] + G[i_2][i_1-1][i_0-1][i_3+1] - H[i_3-1][i_1-1][i_2] - F[i_1][i_3+1][i_0-1][i_2+1] * G[i_3-1][i_1+i_0][i_2+1][i_3-1] - A[i_0][i_1-1][i_3-1][i_2-2] + 5;
                }
            }
            B[i_1+1] = I[i_1-1][i_0-1] + J[i_0-1][i_0] + J[i_1+i_0+1][i_0] + I[i_1][i_0+1] - K[i_0][i_1] - 6;
            B[i_1] = K[i_0+1][i_1] - L[i_1] * K[i_1][i_0] + I[i_1+i_0][i_0] + J[i_0-1][i_1] - I[i_1+1][i_0] + 4;
        }
    }
    for (int i_4 = 0; i_4 < PB_L-1; i_4++) {
        for (int i_5 = i_4; i_5 < PB_M; i_5++) {
            for (int i_6 = 1; i_6 < min(-i_5+PB_Q, -i_4+PB_P); i_6++) {
                B[i_4] = H[i_5][i_6+i_4][i_6+i_5] * K[i_6-1][i_4] * M[i_5][i_4+1][i_6-1] * 3;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,ym,zm,POLYBENCH_ARRAY(M), INIT_SEED);
kernel_4412351115_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,ym,zm,POLYBENCH_ARRAY(M));
