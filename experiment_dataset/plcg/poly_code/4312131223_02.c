...
void kernel_4312131223_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf)){
        ...
        for (int i_1 = 0; i_1 < -i_0+PB_Q; i_1++) {
            for (int i_2 = 2; i_2 < -i_0+PB_Q; i_2++) {
                for (int i_3 = 0; i_3 < PB_P; i_3++) {
                    A[i_1][i_3][i_0] = D[i_1][i_3][i_2+i_0][0] - D[i_3][i_2][i_1+i_0][i_0-1] + A[i_1][i_3][i_2-2] - 5;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_N-1; i_4++) {
        B[i_4] = E[i_4] + E[i_4] + E[i_4+1] * E[i_4] + 4;
        for (int i_5 = 0; i_5 < PB_L-1; i_5++) {
            C[i_4][i_5+1] = F[i_4+1][i_5+1] + B[i_5] + B[i_4] - B[i_4-2] * C[i_4+2][i_5+1] - 6;
        }
    }
#pragma endscop
...
kernel_4312131223_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
