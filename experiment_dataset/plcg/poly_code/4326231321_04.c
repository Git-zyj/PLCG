        ...
        for (int i_1 = 1; i_1 < PB_Q-1; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_Q-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_L; i_3++) {
                    B[i_0][i_1][i_2-1][i_1] = D[i_1][i_0][i_3+1][i_2] + E[i_3][1][i_1][i_0] + F[i_3-1][i_2-1][i_0+1][i_3-1][i_2+i_1+1] - 1;
                }
            }
            for (int i_4 = i_0; i_4 < PB_L-1; i_4++) {
                for (int i_5 = 1; i_5 < i_1; i_5++) {
                    B[i_5][i_1][i_4-1][i_1] = G[i_0][i_5-1][i_4] - B[i_0-2][i_1-1][i_4-2][i_1-1] - B[i_5+1][i_1][i_4+1][i_1] - 6;
                }
            }
            for (int i_6 = 1; i_6 < PB_P-2; i_6++) {
                for (int i_7 = i_0; i_7 < PB_P; i_7++) {
                    C[i_0][i_6][i_1][i_0] = G[i_6][i_7][i_1-1] * H[i_1][i_6][i_7] - E[i_7-1][i_1+1][i_0][i_6] * H[i_7][i_1][i_6-1] * C[i_0][i_7-1][i_6][i_0] - C[i_6][i_0][i_1-1][i_6] * C[i_6+2][i_7][i_1][i_6+2] + 1;
                }
            }
        }
    }
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4326231321_04(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H)));
