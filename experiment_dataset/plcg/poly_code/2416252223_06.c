...
void kernel_2416252223_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        A[i_0] = E[i_0+2] - F[i_0] * F[i_0] * E[i_0-1] + A[i_0-2] * 1;
        for (int i_1 = i_0; i_1 < -i_0+PB_M-2; i_1++) {
            A[i_1-2] = G[i_1+2][i_0] - H[i_1-1][i_0] - E[1] * I[i_1][i_1+i_0+2][i_0] * H[i_0][i_1] + F[i_0] + H[i_1][i_0] * A[i_0+2] + 4;
        }
    }
    for (int i_2 = 2; i_2 < PB_L; i_2++) {
        C[i_2][1] = F[i_2-2] - E[1] * E[i_2] - E[i_2] + C[i_2+1][1] * 2;
        C[i_2][1] = E[i_2] * F[0] * F[i_2] - G[i_2][0] - E[i_2] + C[i_2-2][1] + 5;
    }
#pragma endscop
...
kernel_2416252223_06(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
