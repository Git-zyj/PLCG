...
void kernel_4322111321_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        ...
        for (int i_1 = 3; i_1 < PB_P-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-1; i_2++) {
                B[i_1-1][i_2+1][i_0] = D[i_1][i_2][i_0-1] * D[i_2][i_0][i_1+1] + B[i_1-3][i_2+1][i_0] * B[i_2][i_1-1][i_0+1] - B[i_1-1][i_2][i_0] - 3;
            }
        }
    }
        ...
        for (int i_4 = 3; i_4 < PB_M; i_4++) {
            for (int i_5 = 1; i_5 < PB_M; i_5++) {
                for (int i_6 = 1; i_6 < PB_M-1; i_6++) {
                    C[i_5-1][i_4][i_6+1] = C[i_5-1][i_4-2][i_6+1] * C[i_6-1][i_5][i_4-1] * C[i_4-3][i_5][i_6+1] - 6;
                }
            }
        }
    }
...
kernel_4322111321_07(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
