...
void kernel_4324311221_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf)){
        ...
        for (int i_5 = 1; i_5 < PB_L-2; i_5++) {
            for (int i_6 = 2; i_6 < PB_L-1; i_6++) {
                for (int i_7 = 1; i_7 < -i_6+PB_P; i_7++) {
                    C[i_1][i_1][i_6][i_5] = E[i_5+1][i_1][i_7+i_6][i_1] - F[i_7-1][i_1][i_5][i_6] * C[i_7][i_7][i_6-2][i_5-1] * C[i_1][i_1][i_6+1][i_5+2] - 5;
                }
            }
        }
    }
...
kernel_4324311221_05(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
