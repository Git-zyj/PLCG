...
void kernel_2326112315_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N; i_0++) {
        for (int i_1 = i_0; i_1 < PB_N; i_1++) {
            B[i_0] = B[i_1] * B[i_0-1] + 2;
        }
        B[i_0] = B[i_0-1] * 3;
    }
...
kernel_2326112315_05(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
