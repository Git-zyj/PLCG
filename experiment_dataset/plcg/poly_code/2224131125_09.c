...
void kernel_2224131125_09(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        ...
        for (int i_2 = 1; i_2 < min(i_0, -i_0+PB_L-1); i_2++) {
            A[i_0+1][i_2-1] = C[i_2][i_0-1] * C[i_0][i_2] - C[i_2][i_0] + C[i_2][i_0] - C[i_2+i_0+1][i_0+1] * 2;
        }
    }
#pragma endscop
...
kernel_2224131125_09(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C));
