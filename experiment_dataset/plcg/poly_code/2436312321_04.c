...
void kernel_2436312321_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 1; i_1 < PB_P; i_1++) {
            A[i_0][i_1] = A[i_0+2][i_1] - A[i_0-1][i_1] - A[i_1-1][i_0-2] - A[i_0+1][i_1] - 5;
        }
    }
    for (int i_2 = 3; i_2 < PB_M; i_2++) {
        for (int i_3 = i_2; i_3 < min(-i_2+PB_Q+2, PB_P-2); i_3++) {
            B[i_2][i_3+i_2-2] = A[i_2][i_3+2] - B[i_2][i_3+i_2-3] + B[i_2-1][i_3+i_2-3] * 6;
        }
    }
    ...
    for (int i_5 = 3; i_5 < PB_P+2; i_5++) {
        for (int i_6 = i_5; i_6 < PB_P-2; i_6++) {
            D[i_6-1][i_6] = D[i_5-3][i_5-2] + D[i_6+1][i_6+2] * D[i_6][i_6+1] - D[i_6-3][i_6-2] - 5;
        }
    }
#pragma endscop
...
kernel_2436312321_04(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
