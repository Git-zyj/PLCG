...
void kernel_3226112125_02(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        ...
        for (int i_2 = 0; i_2 < i_0; i_2++) {
            for (int i_3 = 2; i_3 < PB_M; i_3++) {
                B[i_0][i_3][i_3] = C[i_2][i_0][i_0] - B[i_0][i_3-2][i_3-2] - 6;
            }
        }
    }
#pragma endscop
...
kernel_3226112125_02(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
