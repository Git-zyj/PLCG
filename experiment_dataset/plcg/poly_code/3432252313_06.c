...
void kernel_3432252313_06(int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 2; i_1 < PB_L+2; i_1++) {
            D[i_1+2] = E[0] + F[i_1][i_1-2] - G[i_1][i_0] - E[i_1] - 1;
        }
    }
    for (int i_2 = 2; i_2 < PB_L-1; i_2++) {
        for (int i_3 = 2; i_3 < -i_2+PB_L-1; i_3++) {
            for (int i_4 = 1; i_4 < -i_2+PB_L; i_4++) {
                B[i_3][i_4+i_2][i_4+i_2] = H[i_3][i_2][0] - G[i_4+i_3+2][i_2+2] * I[i_4][i_3-2][i_2] + I[i_3][i_2][i_4] * F[i_4][i_3] + H[i_4+1][i_2-2][i_3+1] + G[i_4][i_3-2] + B[i_4-1][i_3+i_2+1][i_3+i_2+1] - B[i_2+1][i_4+i_3-1][i_4+i_3-1] * B[i_3+1][i_4+i_2-1][i_4+i_2-1] - B[i_3+1][i_4+i_2][i_4+i_2] + 3;
            }
        }
        D[i_2+2] = J[i_2] + F[i_2][i_2] + E[i_2] - E[i_2] + E[i_2-1] * D[i_2+1] + 2;
        D[i_2+2] = J[i_2+2] * J[i_2+2] + D[i_2+1] * 5;
    }
#pragma endscop
...
kernel_3432252313_06(xd,POLYBENCH_ARRAY(D), xb,yb,zb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
