...
void kernel_4332311321_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
...
#pragma scop
    ...
    for (int i_4 = 2; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 2; i_5 < PB_P-2; i_5++) {
            B[i_4][i_5] = D[i_4-1][i_5] - B[i_4][i_5-2] - B[i_4+1][i_5] - B[i_4+2][i_5+2] + B[i_4-2][i_5] - B[i_4-1][i_5] * 5;
        }
    }
    for (int i_6 = 0; i_6 < PB_L; i_6++) {
        for (int i_7 = 1; i_7 < PB_Q-3; i_7++) {
            for (int i_8 = 0; i_8 < i_7; i_8++) {
                C[i_7][i_6+1][i_8] = C[i_8][i_6+1][i_7-1] + C[i_6][i_7+3][i_8+1] - 5;
            }
        }
    }
#pragma endscop
...
kernel_4332311321_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
