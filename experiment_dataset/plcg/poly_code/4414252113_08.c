...
static void print_array(int xb,int yb,int zb,int vb,int wb,DATA_TYPE POLYBENCH_5D(B,xB,yB,zB,vB,wB,xb,yb,zb,vb,wb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl))
{
int i_0, i_1, i_2, i_3, i_4;
...
void kernel_4414252113_08(int xb,int yb,int zb,int vb,int wb,DATA_TYPE POLYBENCH_5D(B,xB,yB,zB,vB,wB,xb,yb,zb,vb,wb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl)){
        ...
        for (int i_1 = 2; i_1 < -i_0+PB_M+1; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_L-2, i_0); i_2++) {
                for (int i_3 = 2; i_3 < PB_L; i_3++) {
                    B[i_1+1][i_3][i_0-1][i_2][i_1+1] = E[i_1-2][i_2+i_0+2][i_3][0] - F[i_2-1][i_3-2][i_3] + 5;
                }
            }
            for (int i_4 = 2; i_4 < -i_0+PB_P; i_4++) {
                for (int i_5 = 0; i_5 < -i_0+PB_P; i_5++) {
                    B[i_1][i_4][i_0-1][i_5][i_1] = G[i_1+i_0-1][i_5][i_5+2][0] * G[i_1][i_5+i_0][i_4-1][i_0] + H[i_5+i_1][i_0][i_4][i_1][i_5+i_4-2] + G[i_4][i_0][i_5][i_1] * G[i_5][i_4+i_0][i_1][i_4+1] - F[i_0][i_5+2][i_4] * B[i_1][i_4][i_5][i_0+1][i_1] * B[i_1][i_4+1][i_0-2][i_5][i_1] - 1;
                }
            }
        }
        C[i_0] = I[i_0] * I[i_0] * J[i_0] - I[i_0+1] * 4;
    }
    for (int i_6 = 0; i_6 < PB_M; i_6++) {
        for (int i_7 = 1; i_7 < min(-i_6+PB_M, PB_M-2); i_7++) {
            D[i_6][i_7] = K[i_7+2][i_6] + L[i_7+i_6][i_7] + L[i_7-1][i_7+i_6] + L[i_6][i_7-1] - K[i_7][i_6] - K[i_7+1][0] + L[i_6][i_7] * 6;
        }
    }
#pragma endscop
