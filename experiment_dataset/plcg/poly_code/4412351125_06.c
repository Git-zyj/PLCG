...
void kernel_4412351125_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,DATA_TYPE POLYBENCH_1D(M,xM,xm)){
...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_N+1; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_1+PB_M, PB_L-1); i_2++) {
                for (int i_3 = 1; i_3 < min(-i_1+PB_M, PB_N-1); i_3++) {
                    A[i_0][i_1][i_3+1][i_1-1] = E[i_3][i_1-1][i_0+1][i_0-1] - F[i_3+1][i_1+i_0-1][i_2][0] * G[i_3-1][i_1+1][i_2+1][i_0] - G[i_2+1][i_0][i_1+1][i_2+1] * G[i_2][i_3+i_1][i_0][i_1+1] * E[i_2+i_1][i_0-1][i_3-1][1] * F[i_3+1][i_2+1][i_1][i_0+1] + G[i_3+1][i_0][i_2][i_1] * E[i_1+i_0-1][i_2][i_3+1][0] * A[i_0-1][i_1][i_3-1][i_1-1] + A[i_0-2][i_3][i_1+1][i_3-1] + 5;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_L; i_4++) {
            for (int i_5 = 3; i_5 < PB_M; i_5++) {
                for (int i_6 = 0; i_6 < i_4; i_6++) {
                    A[i_0+2][i_5-2][i_6+1][i_5-3] = H[i_5][i_6][i_4] * H[i_6][i_4-1][0] + G[i_6][i_0-1][i_4][1] - 6;
                }
            }
        }
    }
    for (int i_7 = 2; i_7 < PB_L; i_7++) {
        for (int i_8 = 1; i_8 < min(-i_7+PB_L, i_7); i_8++) {
            C[i_8-1][0] = I[i_7+1][i_8] * J[i_8][i_7] * J[1][i_8+i_7] * K[i_8][i_7] * K[i_8][i_8] + L[i_8+1] * 1;
        }
        C[i_7-2][0] = M[i_7] * M[i_7] * 5;
    }
#pragma endscop
