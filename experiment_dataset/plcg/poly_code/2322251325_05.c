...
void kernel_2322251325_05(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_N-1; i_0++) {
        C[i_0-3] = D[i_0] * E[i_0] - E[i_0] - D[i_0] + D[i_0-1] + D[i_0] * 4;
        C[i_0-1] = E[i_0+1] * E[i_0] + C[i_0-1] + C[i_0] + C[i_0-2] - 4;
        C[i_0-1] = D[i_0] * D[i_0] * D[i_0] + E[i_0] * E[i_0] * 4;
    }
#pragma endscop
...
kernel_2322251325_05(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
