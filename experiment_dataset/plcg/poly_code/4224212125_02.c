...
void kernel_4224212125_02(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_3 = 1; i_3 < PB_P+1; i_3++) {
        for (int i_4 = 0; i_4 < PB_P-2; i_4++) {
            for (int i_5 = 2; i_5 < -i_3+PB_P+1; i_5++) {
                B[i_5][i_4] = C[i_3][0][i_5+i_3-1] + B[i_5-2][i_4+2] + 6;
            }
        }
    }
#pragma endscop
...
kernel_4224212125_02(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
