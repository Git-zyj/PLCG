...
void kernel_3126311213_01(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        for (int i_1 = i_0; i_1 < min(PB_M, -i_0+PB_N-1); i_1++) {
            A[i_1+i_0-1][i_1-1] = B[i_0] * A[i_1+i_0+1][i_1] * A[i_1+i_0-2][i_1-1] + 6;
        }
    }
#pragma endscop
...
kernel_3126311213_01(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
