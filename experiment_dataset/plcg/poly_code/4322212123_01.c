...
void kernel_4322212123_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
...
#pragma scop
    ...
    for (int i_6 = 3; i_6 < PB_M-1; i_6++) {
        for (int i_7 = 0; i_7 < PB_L-4; i_7++) {
            for (int i_8 = 2; i_8 < -i_7+PB_L-4; i_8++) {
                for (int i_9 = 0; i_9 < PB_L-1; i_9++) {
                    C[i_6-1][i_8+i_7+2][i_8-2][i_7] = D[i_8+i_7][i_9+1][i_9] * C[i_6+1][i_8+i_7+4][i_8-2][i_7+2] * C[i_6-3][i_8+i_7+2][i_8-2][i_7] * 3;
                }
            }
        }
    }
...
kernel_4322212123_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
