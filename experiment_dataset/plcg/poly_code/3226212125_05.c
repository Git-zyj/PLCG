...
void kernel_3226212125_05(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_0 = 0; i_0 < PB_P-2; i_0++) {
        ...
        for (int i_3 = i_0 - 1; i_3 >= 0; i_3--) {
            for (int i_4 = 0; i_4 < i_0; i_4++) {
                B[i_4][i_0+2][1] = C[i_4+2][i_4][i_3] + B[i_4+2][i_0+2][1] + 1;
            }
        }
    }
#pragma endscop
...
kernel_3226212125_05(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
