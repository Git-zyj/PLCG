...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < PB_L-3; i_1++) {
            for (int i_2 = 1; i_2 < i_1; i_2++) {
                for (int i_3 = 0; i_3 < PB_L; i_3++) {
                    A[i_0][i_3][i_1+2][i_0+2] = D[i_1][i_3][i_0][i_0-1] * E[i_1][i_0+2][i_2-1][i_0] + A[i_0-1][i_1][i_2+2][i_0+1] + A[i_3][i_0][i_1+1][i_3+2] - A[i_0][i_3][i_1+3][i_0+2] - 3;
                }
            }
        }
    ...
    for (int i_4 = 2; i_4 < PB_L; i_4++) {
        B[i_4] = F[i_4-2] * G[i_4] * H[i_4] + I[i_4][2] - 5;
    }
#pragma endscop
...
kernel_4326332323_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
