...
void kernel_3416231325_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        B[i_0] = E[i_0] * E[i_0] + E[i_0] * F[i_0+1][i_0-1] + 3;
        B[i_0] = G[i_0] * G[i_0] * B[i_0-1] * B[i_0+2] * 1;
        for (int i_1 = i_0; i_1 < -i_0+PB_M-1; i_1++) {
            C[i_0][i_1+i_0] = E[i_0] - H[i_1+i_0-1][i_1][i_0-1] * F[0][i_1] + G[i_0] + C[i_1-1][i_1+i_0-2] - C[i_0-1][i_1+i_0-1] + C[i_1+1][i_1+i_0+1] + 5;
        }
    }
    for (int i_2 = 2; i_2 < PB_M-2; i_2++) {
        D[i_2] = D[i_2+2] * D[i_2-1] + D[i_2-2] - D[i_2+1] - 6;
    }
#pragma endscop
...
kernel_3416231325_05(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
