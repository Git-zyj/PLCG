...
void kernel_4332251123_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg)){
        ...
        for (int i_1 = 0; i_1 < min(-i_0+PB_M, i_0); i_1++) {
            for (int i_2 = 1; i_2 < PB_M; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_0+PB_M+1, PB_M-1); i_3++) {
                    A[i_3+i_0-1][i_1+1][i_2][i_2-1] = D[i_3+1][i_2][i_1+i_0][1] + D[i_1][i_0][i_3][i_0] + 4;
                }
            }
        }
        B[i_0] = E[i_0] * F[i_0] * F[i_0+1] - F[i_0] + F[i_0+1] + F[i_0] * B[i_0-1] * 6;
        for (int i_4 = 2; i_4 < -i_0+PB_M; i_4++) {
            for (int i_5 = 1; i_5 < -i_4+PB_M; i_5++) {
                for (int i_6 = 3; i_6 < -i_5+PB_M-1; i_6++) {
                    C[i_0][i_5-1][i_6][i_4-1] = D[i_5+1][i_0][i_4][i_6] + G[i_6][i_5][i_0][i_4] - D[i_5+1][i_0][i_6-1][i_4+i_0] - G[i_6+i_5+1][i_0][i_4+1][i_0+1] + D[i_5+i_4][i_6][i_6+1][i_0] + D[i_6][i_5+1][i_0][i_4] * G[i_5][i_6+i_4][i_0-1][i_5] - C[i_0+2][i_5-1][i_4-2][i_6-3] - 5;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4332251123_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G)));
