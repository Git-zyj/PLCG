...
void kernel_3434151223_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-1; i_0++) {
        A[i_0][i_0+1] = E[i_0-1] - E[i_0] - E[i_0] * 1;
        for (int i_1 = 1; i_1 < min(PB_N-1, -i_0+PB_L+1); i_1++) {
            B[i_0+1][i_1][i_1] = F[i_1][i_0][0] + A[i_1-1][i_1] - C[i_1-1][i_0-1] * 5;
            C[i_1][i_0] = G[i_1][i_1] - G[i_0][i_1+1] * G[i_1-1][1] * G[i_1][i_0] + G[i_1][i_1+i_0-1] * B[i_1+1][i_0][i_0] + B[i_0+1][i_1][i_1] - C[i_1][i_0+1] + C[i_1-1][i_0+2] * 5;
        }
    }
    for (int i_2 = 1; i_2 < PB_N-1; i_2++) {
        for (int i_3 = i_2; i_3 < PB_N-1; i_3++) {
            D[i_3+1][i_2-1] = E[i_3] + E[i_2] * E[i_3+1] * G[i_3-1][i_2+1] - G[i_3][i_2-1] * G[i_3][i_2] + E[i_3] - G[i_3][i_2] + D[i_2+1][i_3+1] + 2;
        }
    }
#pragma endscop
...
kernel_3434151223_04(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
