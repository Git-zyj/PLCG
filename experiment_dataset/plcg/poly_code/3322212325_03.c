...
void kernel_3322212325_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 0; i_1 < min(i_0, -i_0+PB_M+2); i_1++) {
            for (int i_2 = 0; i_2 < min(min(-i_1+PB_M, PB_L), -i_0+PB_M+1); i_2++) {
                A[i_1+i_0-2][i_2][i_2] = D[i_2+i_1][i_0][i_0] - A[i_2+i_0-1][i_1][i_1] + 3;
            }
        }
        for (int i_3 = i_0; i_3 < PB_L; i_3++) {
            for (int i_4 = 1; i_4 < PB_L; i_4++) {
                B[i_3][i_4] = B[i_3][i_0+2] - B[i_4-1][i_0+2] - B[i_4+1][i_3] - 2;
            }
        }
    }
    for (int i_5 = 0; i_5 < PB_L; i_5++) {
        for (int i_6 = 0; i_6 < min(PB_L, -i_5+PB_M); i_6++) {
            for (int i_7 = 2; i_7 < -i_6+PB_L; i_7++) {
                C[i_7][i_6+1][i_5] = D[i_5+2][i_7+i_6][0] + D[i_6+i_5][i_5][1] + C[i_7-2][i_6+1][i_5+1] * C[i_7-2][i_6+1][i_5] * C[i_7+1][i_6+2][i_5+1] * 3;
            }
        }
    }
#pragma endscop
...
kernel_3322212325_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
