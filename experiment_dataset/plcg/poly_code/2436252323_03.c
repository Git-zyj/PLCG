...
void kernel_2436252323_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        A[i_0] = E[i_0] - E[i_0] * E[i_0-2] + F[i_0-1] + F[i_0] + E[i_0+1] + E[i_0] + A[i_0-1] * A[i_0-2] - 1;
        for (int i_1 = 2; i_1 < min(-i_0+PB_M, i_0); i_1++) {
            A[i_1-1] = E[i_1+i_0-2] * E[i_1-2] * G[i_1+i_0][i_0] - H[i_0][i_1-2] - E[i_0] * G[i_1][i_0] - G[i_1][1] - G[i_1][i_1] * A[i_0] - 6;
        }
    }
    for (int i_2 = 1; i_2 < PB_M-3; i_2++) {
        C[i_2+2] = E[i_2-1] - A[i_2+2] + C[i_2+3] * 6;
    }
    for (int i_3 = 2; i_3 < PB_M-1; i_3++) {
        D[i_3] = F[i_3-2] + E[i_3] - E[i_3] - D[i_3+1] + D[i_3-2] * D[i_3-1] - 2;
    }
#pragma endscop
...
kernel_2436252323_03(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
