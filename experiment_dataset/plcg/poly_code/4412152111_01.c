...
void kernel_4412152111_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
...
#pragma scop
        ...
        for (int i_1 = 2; i_1 < -i_0+PB_L+1; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_0+PB_L, i_1); i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_P-2; i_3++) {
                    A[i_1+i_0][i_3][i_2][i_3] = E[i_3+i_2+2][i_1+i_0-1][i_3+i_0+2][0] - E[i_2][i_3][i_0][i_1] + E[i_3][i_2+i_0][i_1-2][0] + E[i_3+i_2][i_1-1][i_0][0] * E[i_3+1][i_0][i_2+1][i_1] * A[i_1+i_0][i_3-1][i_2][i_3-1] * 6;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 0; i_5 < -i_4+PB_M-2; i_5++) {
            B[i_4][i_4] = F[i_5+i_4+2][i_5+1] - F[i_4][i_5+1] - F[i_5][0] * F[i_4+2][i_5] + F[0][i_4+1] - G[i_4] + F[i_4][i_5] * F[i_4+1][i_5+1] - B[i_4+1][i_4+1] + 4;
        }
        for (int i_6 = max(i_4, 1); i_6 < min(PB_L-1, -i_4+PB_L); i_6++) {
            C[i_4][i_6+1] = H[i_6][i_4][i_6+i_4] * F[i_4][i_6-1] + G[i_4] - D[i_4][i_6+i_4] - 4;
            D[i_4][i_6+i_4] = F[i_6+2][i_4] - G[i_6] + F[i_6-1][i_6] + F[i_6][0] * 5;
        }
    }
#pragma endscop
...
kernel_4412152111_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
