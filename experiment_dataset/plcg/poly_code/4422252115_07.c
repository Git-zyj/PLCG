        ...
        for (int i_1 = 0; i_1 < PB_P-2; i_1++) {
            for (int i_2 = 0; i_2 < i_0; i_2++) {
                for (int i_3 = 2; i_3 < i_1; i_3++) {
                    D[i_3][i_0+1][i_2][i_3+2] = E[0][i_1][i_0][i_2] - E[i_3-2][i_0][i_1][i_2+2] + F[i_0+2][i_3][i_1+2][0] * 2;
                }
            }
        }
        B[i_0] = G[i_0][i_0] * H[i_0-1] + G[i_0+1][i_0] * I[i_0+1] + I[i_0] * I[i_0] * I[i_0] + I[i_0] - H[i_0+1] + 5;
    }
    for (int i_4 = 1; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 0; i_5 < PB_P-2; i_5++) {
            for (int i_6 = 2; i_6 < min(-i_5+PB_Q, PB_M-2); i_6++) {
                D[i_5][i_4][i_6][i_5+2] = J[i_4][i_6+i_5][i_4-1] + K[i_5][i_4][i_6-2] * J[i_4+2][i_6][2] - K[i_5][i_4-1][i_6+1] * 5;
                for (int i_7 = i_6; i_7 < PB_P-2; i_7++) {
                    D[i_7][i_6][i_4][i_7+2] = E[i_5][i_6][i_6][i_7] * E[i_7+1][i_4][i_5+1][i_5] + K[i_6+2][i_5][i_5] - D[i_7-1][i_6][i_4][i_7+1] * D[i_7][i_6][i_4+1][i_7+2] + 1;
                }
            }
        }
    }
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4422252115_07(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K)));
