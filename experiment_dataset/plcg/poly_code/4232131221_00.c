...
void kernel_4232131221_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        A[i_0-1] = C[0] + C[i_0-1] * C[i_0-1] - C[0] - C[i_0] * A[i_0-2] - 6;
    }
    for (int i_1 = 2; i_1 < PB_Q-2; i_1++) {
        B[0][i_1] = C[i_1] - A[i_1-1] + B[0][i_1+2] + B[0][i_1-2] * 2;
    }
#pragma endscop
...
kernel_4232131221_00(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
