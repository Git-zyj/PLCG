...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_L; i_1++) {
        for (int i_2 = 1; i_2 < PB_L; i_2++) {
            B[i_2-1] = G[i_2][i_1] - H[i_1][i_2] - D[i_2-1] * 1;
        }
    }
    for (int i_3 = 1; i_3 < PB_L; i_3++) {
        C[i_3] = F[i_3] - E[i_3-1] - A[i_3] + 3;
        D[i_3] = E[i_3] - I[i_3] + E[i_3+1] * I[i_3] + A[i_3] * 2;
    }
#pragma endscop
...
kernel_2436331211_01(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
