...
void kernel_2212311123_00(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    ...
    for (int i_2 = 0; i_2 < PB_L; i_2++) {
        for (int i_3 = 1; i_3 < min(PB_Q, i_2); i_3++) {
            B[i_3][i_2][i_3] = C[i_3-1][i_2] + B[i_3][i_2+1][i_3] - 4;
        }
    }
#pragma endscop
...
kernel_2212311123_00(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
