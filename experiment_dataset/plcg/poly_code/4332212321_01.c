...
void kernel_4332212321_01(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 2; i_1 < PB_L; i_1++) {
            A[i_0][i_1] = A[i_0+2][i_1] + A[i_0][i_1-2] - A[i_0-2][i_1-1] - A[i_0-2][i_1] * 3;
        }
        for (int i_2 = 0; i_2 < PB_M-2; i_2++) {
            for (int i_3 = max(i_0, 4); i_3 < PB_L+2; i_3++) {
                B[i_2][i_0][i_3-2] = B[i_2+2][i_3-2][i_0-1] * B[i_2][i_0][i_3-4] - 3;
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-2; i_4++) {
        for (int i_5 = 2; i_5 < -i_4+PB_M; i_5++) {
            for (int i_6 = 2; i_6 < -i_4+PB_M-2; i_6++) {
                C[i_4][i_5+i_4][i_6] = D[i_4][i_5][i_6] + C[i_4][i_6+i_4-2][i_5+1] * C[i_5][i_5+i_4][i_6-2] * C[i_4+1][i_6+i_4+2][i_5-2] - 4;
            }
        }
    }
#pragma endscop
...
kernel_4332212321_01(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
