...
void kernel_4236332213_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg)){
        ...
        for (int i_1 = 1; i_1 < PB_P-2; i_1++) {
            for (int i_2 = 1; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 1; i_3 < min(i_2, -i_2+PB_M); i_3++) {
                    A[i_2][i_1][i_0][i_3-1] = C[i_1][i_3+i_2][i_2+1] - D[i_1][i_2][i_3][i_1] + A[i_2][i_1-1][i_0-1][i_3-1] * A[i_0+1][i_1+1][i_2-1][i_3] - 3;
                }
            }
            for (int i_4 = 1; i_4 < PB_P-2; i_4++) {
                for (int i_5 = max(i_4, 2); i_5 < PB_L-1; i_5++) {
                    A[i_0][i_1+1][i_5+1][i_4-1] = E[i_1][i_4+2][0] + F[i_5-2][i_4+2][i_0][i_1] * G[i_0+1][i_4][i_5][i_1+2] - 6;
                }
            }
        }
    }
...
kernel_4236332213_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G));
