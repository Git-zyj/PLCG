    ...
    for (int i_3 = 2; i_3 < PB_L-1; i_3++) {
        for (int i_4 = i_3; i_4 < PB_L-2; i_4++) {
            for (int i_5 = 1; i_5 < min(PB_L, -i_4+PB_M); i_5++) {
                B[i_4-1][i_3-1][i_5] = C[i_4-2][i_5][i_3] - D[i_4-2][i_5][0] + E[i_3][i_4] * D[i_5+i_4][i_3-2][i_3] + C[i_4+1][i_3-2][i_5-1] * D[i_3][i_5][i_4] + A[i_5][i_4+2][i_3+1] * B[i_4-1][i_3-2][i_5+1] + 4;
            }
        }
    }
#pragma endscop
...
kernel_4226332311_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
