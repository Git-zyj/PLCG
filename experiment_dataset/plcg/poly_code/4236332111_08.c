        ...
        for (int i_1 = i_0; i_1 < PB_M; i_1++) {
            for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < PB_Q-2; i_3++) {
                    A[i_0][i_3][i_2][i_0-2] = C[i_2+1][i_0][i_1][i_3] + D[i_1][i_3][i_0][2] - C[i_3][i_0-2][i_1+1][i_2] - C[i_2][i_3][i_0][i_3+2] * A[i_0+1][i_3][i_2][i_0-1] + 1;
                }
            }
        }
    }
...
kernel_4236332111_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
