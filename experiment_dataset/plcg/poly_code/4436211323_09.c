...
void kernel_4436211323_09(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-2; i_0++) {
        for (int i_1 = max(2, i_0); i_1 < PB_L-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_P-1; i_2++) {
                A[i_0][i_1-1][i_2] = A[i_0][i_1+1][i_2+1] + A[i_0+2][i_1-2][i_2+1] - A[i_0+1][i_1+1][i_2] - 6;
            }
        }
    }
    for (int i_3 = 3; i_3 < PB_M-2; i_3++) {
        for (int i_4 = 3; i_4 < PB_M; i_4++) {
            for (int i_5 = 0; i_5 < PB_P; i_5++) {
                A[i_3+2][i_4-3][i_5] = E[i_4][i_3][i_3] + 5;
            }
        }
        C[i_3][i_3-1] = C[i_3+2][i_3+1] - C[i_3+1][i_3] + C[i_3-1][i_3-2] * C[i_3-2][i_3-3] + 6;
    }
...
kernel_4436211323_09(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
