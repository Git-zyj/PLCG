...
void kernel_4222332113_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf)){
        ...
        for (int i_2 = 1; i_2 < PB_M-2; i_2++) {
            for (int i_3 = 0; i_3 < -i_2+PB_M-1; i_3++) {
                for (int i_4 = 1; i_4 < min(-i_1+PB_M, PB_M-1); i_4++) {
                    B[i_2][i_1+2][i_3+1][i_4] = D[i_1+1][i_3][i_2+1][i_4] + E[i_2][i_3][i_1][i_4-1] * F[i_3+i_2+1][i_4+1][i_4+i_1][0] * F[i_1][i_3+2][i_2+2][i_2] - B[i_2-1][i_1+2][i_3+1][i_4] + 3;
                }
            }
        }
    }
...
kernel_4222332113_09(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
