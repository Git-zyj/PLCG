...
void kernel_3236151325_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N; i_0++) {
        for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
            A[i_1-1][i_0+1][i_1] = C[i_1][i_0] * C[i_0][i_1+1] - C[i_1][i_0+1] + C[i_1][i_0+1] * C[i_0][i_1] * A[i_1][i_0+1][i_1+1] + A[i_1-1][i_0+3][i_1] - A[i_1-1][i_0-1][i_1] + 6;
        }
        for (int i_2 = min(-i_0+PB_L, i_0) - 1; i_2 >= 1; i_2--) {
            A[i_2-1][i_0+1][i_2] = D[i_2] - C[i_2][i_0] * C[i_2][i_0] - E[i_0][i_2][0] * C[i_0][i_2+i_0] + 2;
        }
    }
#pragma endscop
...
kernel_3236151325_01(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
