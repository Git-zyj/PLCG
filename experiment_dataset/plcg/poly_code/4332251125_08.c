        ...
        for (int i_1 = 1; i_1 < min(PB_N, -i_0+PB_P+2); i_1++) {
            for (int i_2 = 1; i_2 < min(min(i_1, -i_1+PB_L-1), -i_0+PB_P); i_2++) {
                for (int i_3 = 1; i_3 < PB_N; i_3++) {
                    A[i_1][i_3][i_2+i_0][i_3+i_2-1] = D[i_2][i_3+i_1][i_1][i_0] - E[i_3][i_2+i_1+1][i_0][i_3-1][0] * D[i_3][i_2+i_1+1][i_1][i_0] - D[i_1][i_3-1][i_0-1][i_2] - A[i_3][i_2][i_1+i_0-2][i_2+i_1-1] * 2;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        B[i_4-1] = F[i_4+1] * G[i_4][0] - F[i_4] * F[i_4] + F[i_4] - 4;
        for (int i_5 = 1; i_5 < -i_4+PB_L; i_5++) {
            for (int i_6 = 1; i_6 < min(i_4, -i_5+PB_M); i_6++) {
                for (int i_7 = 1; i_7 < -i_5+PB_M; i_7++) {
                    C[i_4][i_6][i_4][i_5] = D[i_7+1][i_5+i_4][i_7+1][i_6+i_5] * D[i_6+i_5][i_7-1][i_5][i_4] - H[i_7+i_5][i_6+1][i_4][i_6] * H[i_6-1][i_5+i_4][i_7-1][i_5-1] + C[i_4][i_6-1][i_4][i_5-1] - 6;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4332251125_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H)));
