...
void kernel_3336312311_03(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        ...
        for (int i_2 = 0; i_2 < PB_M-3; i_2++) {
            for (int i_3 = 1; i_3 < PB_M-3; i_3++) {
                B[i_2+2][i_0-1][i_3+2] = B[i_2+3][i_3-1][i_0+2] - B[i_3+3][i_0][i_2+3] - B[i_2+1][i_0][i_3+3] * 4;
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_P; i_4++) {
        for (int i_5 = i_4; i_5 < PB_M; i_5++) {
            for (int i_6 = 0; i_6 < min(-i_4+PB_L+1, -i_5+PB_L-1); i_6++) {
                C[i_6+i_5][i_4][i_6+1] = D[i_5][i_6][i_4] * C[i_6+i_4-1][i_5][i_4+1] + C[i_6+i_5][i_4][i_6+2] - C[i_6+i_5+1][i_4][i_6+1] - 5;
            }
        }
    }
#pragma endscop
...
kernel_3336312311_03(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
