        ...
        for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 1; i_2 < PB_L; i_2++) {
                for (int i_3 = 1; i_3 < -i_1+PB_M-1; i_3++) {
                    A[i_1][i_0+1][i_3][i_2] = D[i_0][i_2-1][i_0+1][i_3] * D[i_0][i_3+1][i_1][i_2] + D[i_2][i_1][i_0][i_3] + D[i_0+1][i_1+1][i_2][0] - D[i_2][i_3+i_1+1][i_0+1][i_0-1] + E[i_1][i_3-1][i_3-1] * 4;
                }
            }
            B[i_1] = F[i_1][i_0] - G[i_1+1][i_0-1] * G[i_1][i_0-1] - B[i_1-2] - B[i_1+2] + 1;
        }
        B[i_0] = H[i_0] + I[i_0+1] + H[i_0+1] * I[i_0] * H[i_0] + B[i_0] * 4;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4324251225_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I)));
