...
void kernel_4416151123_08(int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_M-1; i_1++) {
            for (int i_2 = 0; i_2 < i_1; i_2++) {
                for (int i_3 = 0; i_3 < -i_1+PB_M; i_3++) {
                    D[i_3][i_2+i_1][i_3][i_0] = E[i_1-1][i_1][i_3][i_0] + E[i_2][i_3][i_1+i_0-1][1] + E[i_3][i_1+1][i_0+1][i_2] - F[i_3+i_1][i_1][i_2+1][i_0][i_2] + E[i_3+i_2][i_1-1][i_0][i_0] + 5;
                }
            }
            for (int i_4 = 1; i_4 < PB_L; i_4++) {
                C[i_4][i_1][i_0] = G[i_1][i_4-1][i_0] + H[i_1-1][0] - H[i_4][1] - C[i_0+1][i_1][i_4] + 6;
                C[i_0][i_1][i_4] = G[i_4][i_0][i_1] + G[i_1+i_0+1][i_4][1] + G[i_1][i_0][i_4] * 4;
            }
        }
    }
    for (int i_5 = 1; i_5 < PB_M; i_5++) {
        for (int i_6 = i_5; i_6 < min(PB_L-1, -i_5+PB_P-1); i_6++) {
            for (int i_7 = 1; i_7 < min(i_5, PB_L-1); i_7++) {
                for (int i_8 = 1; i_8 < -i_7+PB_M; i_8++) {
                    D[i_5][i_8+i_7][i_5][i_6+1] = E[i_6][i_7][i_5][i_8] - E[i_8][i_6][i_5][i_7] + E[i_7][i_6][i_7+1][i_8] + G[i_6][i_7+1][i_8+1] - E[i_6][i_6][i_5-1][i_7] - E[i_7-1][i_8+1][i_6+i_5+1][i_8-1] * 6;
                }
            }
        }
    }
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xc,yc,zc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4416151123_08(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xc,yc,zc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xc,yc,zc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H)));
