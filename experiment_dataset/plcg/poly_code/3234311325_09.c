...
void kernel_3234311325_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_2 = 0; i_2 < PB_M; i_2++) {
        for (int i_3 = 2; i_3 < PB_M-2; i_3++) {
            B[i_3] = B[i_3-2] * B[i_3+1] * B[i_3+2] + 3;
        }
    }
#pragma endscop
...
kernel_3234311325_09(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
