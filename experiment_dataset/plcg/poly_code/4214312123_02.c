...
void kernel_4214312123_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 0; i_1 < PB_P; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-2; i_2++) {
                for (int i_3 = max(1, i_0); i_3 < PB_M-2; i_3++) {
                    A[i_1][i_3][i_0] = C[i_2+2][i_0][i_3-1] * A[i_3+2][i_2][i_1] + 2;
                }
            }
        }
    }
...
kernel_4214312123_02(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C));
