...
void kernel_4316211325_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_Q-2; i_0++) {
        for (int i_1 = 0; i_1 < min(-i_0+PB_Q-2, i_0); i_1++) {
            A[i_0][i_1+i_0] = D[i_1][i_0+1] + A[i_0][i_1+i_0-1] - A[i_0+1][i_1+i_0+1] - A[i_0][i_1+i_0+1] + A[i_0+2][i_1+i_0+2] * 2;
        }
        for (int i_2 = 0; i_2 < min(-i_0+PB_Q, i_0); i_2++) {
            for (int i_3 = 0; i_3 < i_0; i_3++) {
                C[i_0-1][i_2][i_3] = A[i_0][i_2+i_0] * 3;
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M-1; i_4++) {
        for (int i_5 = 1; i_5 < PB_Q; i_5++) {
            for (int i_6 = 0; i_6 < min(PB_Q-2, -i_5+PB_Q); i_6++) {
                C[i_4+1][i_5][i_6] = E[i_4+1][i_6][i_5-1] + E[i_4+1][i_4][i_6+i_5] * C[i_4+1][i_5+1][i_6+2] * 4;
            }
        }
    }
#pragma endscop
...
kernel_4316211325_00(xa,ya,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
