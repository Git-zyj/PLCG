...
void kernel_3322312313_07(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-1; i_0++) {
        C[i_0-1] = D[i_0] - 1;
        for (int i_1 = 1; i_1 < PB_N-1; i_1++) {
            C[i_0+1] = C[i_1] * C[i_1-1] * C[i_1+1] * 3;
        }
    }
...
kernel_3322312313_07(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
