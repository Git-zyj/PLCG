...
void kernel_4412251313_04(int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-1; i_0++) {
        for (int i_1 = i_0; i_1 < PB_Q+1; i_1++) {
            for (int i_2 = 0; i_2 < min(PB_N-1, -i_1+PB_Q+1); i_2++) {
                for (int i_3 = 0; i_3 < min(min(-i_1+PB_M, -i_0+PB_L), -i_2+PB_N-1); i_3++) {
                    D[i_1][i_0+1][i_2+1][i_2] = E[i_3+i_2+1][i_1][i_0-1] + F[i_2][i_3+i_0][i_3][i_2+i_1-1] - F[i_3+i_1][i_2][i_0][i_2] * G[i_2][i_3][i_1-1][i_0] + 6;
                }
            }
        }
        B[i_0] = H[1] - I[i_0-1] * H[0] - I[i_0] - H[i_0-1] + I[i_0] * H[i_0] * H[i_0] * I[i_0] + B[i_0-1] - B[i_0+1] - B[i_0+1] + 6;
        for (int i_4 = 0; i_4 < PB_L-1; i_4++) {
            for (int i_5 = 1; i_5 < PB_Q+1; i_5++) {
                D[i_4+1][i_0+1][i_5][i_5-1] = J[i_0][i_4+1] + E[i_0][0][i_4] + K[i_5][i_0][i_4] + E[i_0][i_5][i_4] + 3;
            }
        }
    }
    for (int i_6 = 1; i_6 < PB_Q; i_6++) {
        for (int i_7 = i_6; i_7 < PB_Q; i_7++) {
            for (int i_8 = 1; i_8 < min(PB_Q, -i_6+PB_P); i_8++) {
                D[i_7][i_6][i_8][i_8-1] = K[i_7+1][i_8][i_6] + K[i_8][i_8+i_6][i_7] - D[i_7+1][i_6][i_8][i_8-1] + D[i_7][i_6-1][i_8+1][i_8] * 3;
            }
        }
    }
#pragma endscop
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4412251313_04(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K)));
