...
void kernel_4326231215_02(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
        ...
        for (int i_1 = 1; i_1 < PB_N; i_1++) {
            for (int i_2 = 0; i_2 < min(i_1, -i_1+PB_N+1); i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_M; i_3++) {
                    B[i_1][i_3-1][i_2+i_1-1] = D[i_0][i_3][i_2][i_1] - E[i_3+i_0][i_2+1][i_0-1][i_1] - F[i_0+1][i_3+1][i_2] + 1;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-1; i_4++) {
        for (int i_5 = 0; i_5 < PB_L-1; i_5++) {
            for (int i_6 = 1; i_6 < -i_4+PB_N; i_6++) {
                B[i_4+1][i_5][i_6+i_4] = G[i_4+1][i_5+1][i_6-1] - F[i_6][i_5+1][i_4] - G[i_6][i_5][i_6+i_4] * B[i_4][i_5][i_6+i_4-2] * B[i_4+1][i_5][i_6+i_4-1] - 1;
            }
        }
    }
    for (int i_7 = 1; i_7 < PB_L; i_7++) {
        for (int i_8 = 1; i_8 < -i_7+PB_L; i_8++) {
            for (int i_9 = 1; i_9 < i_8; i_9++) {
                B[i_8][i_9-1][i_8+i_7-1] = F[i_8+i_7][i_9-1][i_8] + H[i_9][i_8-1] + F[i_8][i_7][i_7] + 1;
            }
        }
    }
#pragma endscop
...
init_array(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4326231215_02(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H)));
