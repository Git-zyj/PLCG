...
void kernel_4426351211_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,int ym,DATA_TYPE POLYBENCH_2D(M,xM,yM,xm,ym)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 1; i_1 < min(-i_0+PB_L+2, i_0); i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_L+1; i_2++) {
                A[i_1-1][i_2+i_0-1][i_0+1] = E[i_0+1][i_2][i_1+1][i_0] - F[i_2+1][i_1][i_0] - F[i_2][i_0][i_1] * G[i_2][i_1-1][i_0][i_0] - A[i_2-1][i_1+i_0-2][i_0+1] - A[i_1-1][i_2+i_0-2][i_2] + 3;
            }
        }
    }
        ...
        for (int i_4 = 1; i_4 < -i_3+PB_M; i_4++) {
            for (int i_5 = 2; i_5 < PB_L-1; i_5++) {
                for (int i_6 = 1; i_6 < PB_L; i_6++) {
                    B[i_6-1][0][i_3] = H[i_6][i_3-1][i_5+i_4][i_6] * G[i_5][i_6][i_6][i_4-1] * H[i_5][i_6][i_4+i_3][i_4+1] - E[i_4-1][i_5+1][i_3][i_6-1] - I[i_6-1][i_5][i_4] - J[i_4+1][0][i_6] + B[i_5-2][0][i_4-1] + 4;
                }
            }
        }
        for (int i_7 = 0; i_7 < min(-i_3+PB_M, i_3); i_7++) {
            for (int i_8 = 1; i_8 < PB_M-1; i_8++) {
                for (int i_9 = 1; i_9 < PB_P-1; i_9++) {
                    C[i_7][i_9][i_3][i_8+1] = H[i_7][i_7][i_8+1][i_9-1] - G[i_8][i_3-1][i_7+1][0] + H[i_9][i_8][i_7+i_3][0] + C[i_7][i_8-1][i_3-1][i_9+1] + 3;
                }
            }
        }
    }
    for (int j_0 = 1; j_0 < PB_L; j_0++) {
        for (int j_1 = j_0; j_1 < -j_0+PB_M; j_1++) {
            D[j_1] = K[j_1+1][j_0] * K[j_1-1][j_0-1] + L[j_1+1] + M[j_1+j_0][1] - D[j_1+1] + D[j_1-1] - 3;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M), INIT_SEED);
kernel_4426351211_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M)));
