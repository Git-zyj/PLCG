...
void kernel_4316311225_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-3; i_0++) {
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_1+PB_N-1, i_0); i_2++) {
                A[i_2+i_1][i_0+1][i_2] = D[i_1][i_2-1][i_1] - A[i_2+i_1+1][i_0+1][i_2+2] - A[i_2+i_1][i_0+3][i_2] + 4;
            }
        }
    }
    for (int i_3 = 0; i_3 < PB_L; i_3++) {
        for (int i_4 = 0; i_4 < PB_M; i_4++) {
            for (int i_5 = 3; i_5 < PB_N+3; i_5++) {
                for (int i_6 = max(2, i_3); i_6 < -i_5+PB_N+3; i_6++) {
                    A[i_6+i_5-3][i_4][i_6-2] = 1;
                }
            }
        }
...
kernel_4316311225_01(xa,ya,za,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D));
