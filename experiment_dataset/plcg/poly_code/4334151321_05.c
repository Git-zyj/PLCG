...
void kernel_4334151321_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < min(PB_Q-2, i_0); i_1++) {
            for (int i_2 = i_0; i_2 < -i_1+PB_M; i_2++) {
                for (int i_3 = 1; i_3 < -i_2+PB_M; i_3++) {
                    A[i_1-1][i_0-1][i_3][i_1] = D[i_1][i_3][i_0][i_2] - D[i_2][i_0-1][i_3+1][i_1] * D[i_2+i_1][i_0+1][i_3][i_2] * E[i_0][i_2][i_1][i_3][i_3+1] * D[i_3+i_2][i_0][i_1][i_0] - D[i_3][i_0][i_2][i_1] + D[i_2][i_0][i_3][i_1] * A[i_1-1][i_0-3][i_3-1][i_1] + A[i_1+1][i_3-1][i_0-1][i_1+2] - A[i_1][i_0-1][i_3][i_1+1] * 2;
                }
            }
        }
    ...
    for (int i_4 = 0; i_4 < PB_M-1; i_4++) {
        for (int i_5 = 3; i_5 < min(PB_Q-2, -i_4+PB_L); i_5++) {
            for (int i_6 = 3; i_6 < min(min(min(PB_Q-1, i_5), -i_5+PB_P+1), -i_4+PB_L); i_6++) {
                C[i_5-1][i_6+i_4][i_4][i_5] = G[i_6][i_5-1][i_4] + G[i_4][i_5-1][i_6+1] + G[0][i_6][i_5] - H[i_4+1][i_5-1] * D[i_4+1][i_6-1][i_6+i_5-1][i_5+1] + H[i_6+1][i_5] * C[i_5+1][i_6+i_4][i_4][i_5+2] * C[i_5-3][i_6+i_4][i_4][i_5-2] * C[i_5][i_6+i_4][i_4][i_5+1] * C[i_6-3][i_5+i_4][i_4][i_6-2] - 4;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4334151321_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H)));
