...
void kernel_3216211321_08(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        ...
        for (int i_3 = i_0; i_3 < min(-i_0+PB_M-1, PB_L); i_3++) {
            B[i_3+i_0][0] = C[i_0][i_3] * B[i_3+i_0-1][0] - B[i_3+i_0+1][0] - B[i_3+i_0+1][0] * 2;
        }
    }
#pragma endscop
...
kernel_3216211321_08(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
