        ...
        for (int i_3 = 1; i_3 < PB_L; i_3++) {
            for (int i_4 = 2; i_4 < PB_L; i_4++) {
                for (int i_5 = 0; i_5 < min(-i_3+PB_M, -i_4+PB_L); i_5++) {
                    D[i_2-1][i_5+i_3][i_5+i_4][0] = F[i_4-2][i_3][0] - G[i_4-1][i_3][i_2][0] * D[i_2-1][i_5+i_3-1][i_5+i_4][0] - 4;
                }
            }
        }
    }
...
kernel_4434132113_07(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G));
