        ...
        for (int i_1 = 0; i_1 < min(-i_0+PB_L, i_0); i_1++) {
            for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_0+PB_Q, -i_2+PB_P); i_3++) {
                    A[i_2][i_1][i_3+i_0] = E[i_2][i_3+i_0-1][i_1][i_0] - E[i_2+1][i_1+i_0][i_3][i_0] * F[i_1][i_3+i_2][i_3-1] * E[i_0+2][i_3][i_1][i_2] + 1;
                }
            }
        }
        for (int i_4 = 1; i_4 < -i_0+PB_M; i_4++) {
            B[i_4] = G[i_0][i_4] - H[i_0][i_4+1] - G[i_4+i_0][2] - H[i_4][i_0] * G[i_0+2][i_4-1] * H[i_4][0] - B[i_4+1] + 6;
        }
    }
    for (int i_5 = 1; i_5 < PB_L-2; i_5++) {
        for (int i_6 = 2; i_6 < PB_M-1; i_6++) {
            B[i_6] = H[i_5][0] + I[i_6+1][i_5+2][i_6-1] - G[i_6-2][i_5-1] + G[i_6][i_5] - J[i_6] * K[i_6] + 1;
        }
        for (int i_7 = 1; i_7 < PB_M; i_7++) {
            for (int i_8 = 0; i_8 < PB_M; i_8++) {
                B[i_8] = I[i_7][i_7][i_5] + F[i_8][i_8][i_7-1] * F[i_5][i_7][i_7] - I[i_8][i_7][i_5] + B[i_8] * 6;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4422252111_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K)));
