...
void kernel_3212251225_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 1; i_1 < min(PB_N, -i_0+PB_L-1); i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_M; i_2++) {
                A[i_0][i_2][1] = C[i_2+i_1][i_2][i_0] - D[i_1-1][i_0][i_2] - D[i_1][i_0][i_2-1] * D[i_1][i_2][i_0-1] - C[i_2][i_1+i_0+1][i_0] * A[i_0+2][i_2][1] + A[i_0-2][i_1-1][1] * 5;
            }
            for (int i_3 = 1; i_3 < PB_N-1; i_3++) {
                A[i_0][i_1][1] = C[i_0+1][i_0-1][i_3-1] + D[i_3+1][i_0+1][i_1] - C[i_3][i_0+1][i_0] - C[i_1][i_0][i_3] * D[i_3-1][i_0+1][i_1+1] * 5;
            }
        }
    }
#pragma endscop
...
kernel_3212251225_01(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
