...
void kernel_4322112211_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_2 = 0; i_2 < PB_Q; i_2++) {
            for (int i_3 = 2; i_3 < PB_Q-1; i_3++) {
                for (int i_4 = 0; i_4 < -i_3+PB_L+2; i_4++) {
                    B[i_4][i_3][i_2] = D[i_2+1][i_4+i_3-2][i_0] + B[i_2][i_4][i_3+1] - B[i_0][i_3+1][i_2] + 4;
                }
            }
        }
    }
    for (int i_5 = 1; i_5 < PB_Q; i_5++) {
        for (int i_6 = 1; i_6 < PB_L-2; i_6++) {
            for (int i_7 = 1; i_7 < PB_Q; i_7++) {
                C[i_7][i_5][i_6] = D[i_7][i_6][0] - D[i_6+2][i_7][i_5] - C[i_6-1][i_5-1][i_7-1] + C[i_7+1][i_5][i_6] + 2;
            }
        }
    }
#pragma endscop
...
kernel_4322112211_02(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
