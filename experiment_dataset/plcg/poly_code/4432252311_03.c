...
void kernel_4432252311_03(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,int zk,int vk,int wk,DATA_TYPE POLYBENCH_5D(K,xK,yK,zK,vK,wK,xk,yk,zk,vk,wk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl),int xm,int ym,int zm,DATA_TYPE POLYBENCH_3D(M,xM,yM,zM,xm,ym,zm)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-3; i_0++) {
        for (int i_1 = 2; i_1 < -i_0+PB_M-2; i_1++) {
            A[i_0+2][i_1] = E[i_0-1] * F[i_0][i_1-2][i_1] - G[i_0][i_1] + H[i_1+i_0+2] - A[i_0+1][i_1+1] * A[i_0+3][i_1] + A[i_0+1][i_1] + A[i_0+2][i_1-1] + A[i_0+2][i_1+1] * 2;
        }
    }
        ...
        for (int i_3 = 2; i_3 < PB_L; i_3++) {
            for (int i_4 = 2; i_4 < PB_L-1; i_4++) {
                for (int i_5 = 1; i_5 < PB_M-1; i_5++) {
                    B[i_3][i_2][i_4][i_5-1] = I[i_5][i_4][i_2+2][i_4-2] - J[i_4][i_3][i_5][i_4] * K[i_5+1][i_2][i_4][i_5][i_4] - I[i_4][i_2][i_3+1][i_5] - I[i_2-1][i_4][i_5][i_3-2] + J[i_5][i_4+1][i_4][i_2] * I[i_5][i_2+2][i_3][i_4] - I[i_3][i_2][i_5][i_4-1] + B[i_5][i_3-1][i_2-1][i_4-1] + 4;
                }
            }
        }
    }
    for (int i_6 = 2; i_6 < PB_Q-1; i_6++) {
        for (int i_7 = 0; i_7 < PB_L; i_7++) {
            C[i_6][i_7] = L[i_7][0] - G[i_7][i_6] - M[i_6][i_7][0] * G[i_7][i_6] * C[i_6-1][i_7] + C[i_6+1][i_7] * C[i_7][i_6+1] * 1;
        }
        for (int i_8 = 0; i_8 < PB_Q-2; i_8++) {
            for (int i_9 = max(i_8, 1); i_9 < -i_8+PB_M-1; i_9++) {
                for (int j_0 = 1; j_0 < min(min(-i_8+PB_M, -i_6+PB_Q-1), -i_9+PB_Q); j_0++) {
                    D[j_0][i_6-2][j_0+i_9][i_9] = I[i_9][i_6-1][j_0][i_6] + J[i_9][i_6][i_8+2][j_0+i_6+1] + J[i_9+i_8][j_0+i_6][i_6+1][j_0+i_9] - D[i_8+1][j_0-1][i_9+i_8+1][i_9] + D[i_8][i_9-1][j_0+i_8][j_0] - 2;
                }
            }
        }
    }
