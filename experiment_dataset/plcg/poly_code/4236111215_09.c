...
void kernel_4236111215_09(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd)){
    ...
    for (int i_4 = 0; i_4 < PB_P; i_4++) {
        for (int i_5 = max(i_4, 1); i_5 < PB_M-2; i_5++) {
            for (int i_6 = 2; i_6 < PB_L-1; i_6++) {
                for (int i_7 = 1; i_7 < min(min(-i_5+PB_M-2, i_5), -i_6+PB_M+2); i_7++) {
                    B[i_5-1][i_7+i_5][i_6+1][i_7] = C[i_5][i_7][i_6] + D[i_5][i_6][i_4][i_7] + B[i_5][i_7+i_5+2][i_6][i_7+1] - B[i_6-2][i_7+i_6-2][i_5+1][i_7-1] - 1;
                }
            }
        }
    }
...
kernel_4236111215_09(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D));
