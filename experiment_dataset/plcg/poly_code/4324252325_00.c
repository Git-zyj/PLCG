...
void kernel_4324252325_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 1; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 0; i_2 < min(min(-i_0+PB_L, i_0), -i_1+PB_L); i_2++) {
                for (int i_3 = 2; i_3 < min(min(PB_M-3, -i_1+PB_P), -i_2+PB_M); i_3++) {
                    A[i_1+2][i_2+i_0][i_3-1][i_3] = D[i_1][i_3-1][i_2][i_0] - D[i_1][i_3-2][i_2+i_1][i_0] * E[i_2][i_0][i_3+i_1][i_2] + D[i_3][i_2][i_1+1][i_2] + F[i_3][i_1][i_2] - F[i_3+i_2][i_3+2][i_2] * A[i_3+3][i_2+i_0][i_1-1][i_1] * A[i_1+2][i_2+i_0-1][i_3+1][i_3+2] - 5;
                }
            }
            B[i_0][i_0] = G[i_1][i_0+2] + H[i_1][i_0] * I[i_1] + H[i_1+2][i_0] + G[i_1][i_0+1] + B[i_0-2][i_0-2] * 2;
        }
        B[i_0][i_0] = I[i_0] + I[i_0+2] * J[i_0] - B[i_0-1][i_0-1] - B[i_0][i_0] + B[i_0+2][i_0+2] - 1;
    }
#pragma endscop
...
kernel_4324252325_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
