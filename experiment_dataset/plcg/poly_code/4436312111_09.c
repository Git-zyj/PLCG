...
void kernel_4436312111_09(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_Q-1; i_0++) {
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_L; i_2++) {
                A[i_1][i_2+i_1][i_0] = E[i_2][i_1-1][i_0][i_0+1] + 1;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_P-1; i_3++) {
        for (int i_4 = i_3; i_4 < PB_L; i_4++) {
            for (int i_5 = 1; i_5 < -i_4+PB_L+1; i_5++) {
                A[i_5-1][i_5+i_4-1][i_3+1] = 2;
            }
            for (int i_6 = i_3; i_6 < PB_L; i_6++) {
                for (int i_7 = 1; i_7 < PB_P; i_7++) {
                    C[i_3][i_4][i_6][i_7] = C[i_3-1][i_4][i_6][i_7-1] * 3;
                }
            }
        }
    }
...
kernel_4436312111_09(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
