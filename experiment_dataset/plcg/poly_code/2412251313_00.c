...
void kernel_2412251313_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        A[i_0-1] = E[1] + E[i_0] * E[i_0-1] - E[i_0] + E[i_0] + F[i_0] * A[i_0] * A[i_0-2] - 6;
    }
    for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
        for (int i_2 = 1; i_2 < PB_M; i_2++) {
            B[i_1][i_2] = G[i_2][i_1-1] - H[i_1-1][i_2] + F[i_1] * H[i_2][i_1] - E[i_1] - B[i_2-1][i_1] * C[i_1+1][i_2] * C[i_2][i_1-1] * 2;
            C[i_1][i_2-1] = I[i_1][i_2][i_1] - G[i_2][i_1] + E[i_1] * H[i_1][i_1] * B[i_1-1][i_2+1] - B[i_1][i_2-1] - 5;
        }
        for (int i_3 = 1; i_3 < PB_L; i_3++) {
            B[i_1][i_3] = F[i_1] - E[i_1] + C[i_1-1][i_3-1] + 4;
        }
    }
#pragma endscop
...
kernel_2412251313_00(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
