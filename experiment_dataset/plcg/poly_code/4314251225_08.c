        ...
        for (int i_1 = 0; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_M-1; i_2++) {
                for (int i_3 = 2; i_3 < PB_M+1; i_3++) {
                    A[i_3][i_2+i_1][i_1] = D[i_1][i_2][i_0-1][i_0] - D[i_1][i_3-1][i_0+1][i_2-1] * E[i_1][i_3-1][i_2][i_1] + A[i_3-2][i_2+i_1+1][i_2+1] - A[i_3][i_2+i_1+1][i_2+1] * 6;
                }
            }
        }
        B[i_0-1] = F[i_0-1] + G[i_0+1] - F[i_0] + F[i_0] + G[i_0-1] * B[i_0-2] - 2;
    }
    for (int i_4 = 1; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 1; i_5 < PB_L-2; i_5++) {
            C[i_4][i_5] = H[i_4][i_5] - I[i_5][i_4] * F[i_4] * H[i_5][i_4] * F[i_5-1] - I[i_5][i_4] * H[i_4+1][i_4-1] * C[i_4][i_5+2] * C[i_5][i_4+2] - C[i_4+1][i_5] - 2;
        }
    }
#pragma endscop
...
kernel_4314251225_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
