...
void kernel_3416152113_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        B[i_0] = E[i_0-1] + E[i_0] + E[i_0] - E[i_0+2] - E[i_0] + E[i_0-1] - E[i_0] + 5;
        for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
            B[i_1] = F[i_1][i_0+1] * G[i_0][i_1][i_1] * F[i_1][i_0] * F[i_0][i_1] + F[i_1][i_1-2] + D[i_0] + 2;
            C[i_0][i_1+2] = F[i_0][i_1] + F[i_1+2][i_0-2] + F[i_1][i_0] + F[i_0][i_0] * D[i_1] - 6;
        }
...
kernel_3416152113_06(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
