...
void kernel_2224132315_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_N-1 - 1; i_0 >= 1; i_0--) {
        A[0] = C[i_0+1] + C[i_0] * C[i_0-1] * A[0] - A[0] * 4;
        A[0] = C[i_0] + C[0] * A[0] * 2;
    }
#pragma endscop
...
kernel_2224132315_09(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
