...
void kernel_4332151211_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf)){
        ...
        for (int i_1 = i_0; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < PB_L; i_3++) {
                    A[i_1][i_3][i_0][i_2] = D[i_1][i_1][i_2+1][0] - 6;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        B[i_4] = E[i_4] * E[i_4+1] * E[i_4] - E[i_4] - E[i_4-1] - E[i_4] - E[0] * E[i_4] - E[i_4] + B[i_4+1] + B[i_4-1] - 4;
    }
    for (int i_5 = 0; i_5 < PB_N-3; i_5++) {
        for (int i_6 = 0; i_6 < -i_5+PB_N-1; i_6++) {
            for (int i_7 = 0; i_7 < -i_5+PB_N-3; i_7++) {
                for (int i_8 = 1; i_8 < min(-i_5+PB_Q, PB_L-1); i_8++) {
                    C[i_7+i_5+1][i_8-1][0][i_8] = D[i_7][i_5][i_8][i_6+1] - F[i_7+i_6+1][i_6][i_8+i_5][i_5][i_7] - D[i_6+i_5+1][i_7][i_8][i_6] + D[i_7][i_5][i_8][i_6] * C[i_7+i_5+3][i_8-1][0][i_8] * C[i_7+i_5+1][i_8][0][i_8+1] * 6;
                }
            }
        }
    }
...
kernel_4332151211_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F));
