...
void kernel_4424251323_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj)){
        ...
        for (int i_1 = 2; i_1 < min(-i_0+PB_N-1, i_0); i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < i_2; i_3++) {
                    A[i_3][i_2+i_0][i_1-1][0] = E[i_2][i_1+i_0+1][i_3][0] * E[i_2][i_0][i_1-1][i_3] * E[i_3][i_0+1][i_2][i_1] - E[i_0+1][i_2][i_3][i_1-1] - A[i_3][i_2+i_0+1][i_1-2][0] + A[i_3][i_2+i_0-2][i_1-1][0] - A[i_3+2][i_1+i_0][i_2-1][0] + 5;
                }
            }
        }
        B[i_0] = F[i_0+1] * G[i_0][i_0] - F[i_0] * H[i_0] - B[i_0-1] * B[i_0-2] * 1;
    }
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        B[i_4] = H[i_4-1] * F[i_4] - F[i_4] - F[i_4] * B[i_4] + 4;
        for (int i_5 = i_4; i_5 < min(PB_Q-2, -i_4+PB_Q); i_5++) {
            for (int i_6 = 1; i_6 < -i_5+PB_N; i_6++) {
                for (int i_7 = max(i_4, 2); i_7 < PB_N-1; i_7++) {
                    D[i_6-1][i_4+1][i_6+1][i_5] = E[i_6+1][i_7][i_4][i_5] + I[i_6][i_6][i_5+i_4][0] * E[i_7+1][i_4][i_5][i_6] - E[1][i_7][i_6+i_5][i_4] * I[i_4-1][i_5][i_6][i_4] + J[i_5-1][i_4-1][i_6] + J[i_5][i_4-1][i_7+i_6] - D[i_6-1][i_4][i_6+1][i_5+2] - D[i_7-2][i_4+1][i_7][i_5+2] - 1;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4424251323_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J)));
