    ...
    for (int i_3 = 1; i_3 < PB_M-2; i_3++) {
        for (int i_4 = 2; i_4 < min(PB_M, -i_3+PB_L-2); i_4++) {
            for (int i_5 = 2; i_5 < PB_M-2; i_5++) {
                B[i_3][i_4][i_5] = E[i_4][i_5-2] - C[i_5+2][i_4+i_3][0] * E[i_4][i_3] + E[i_3+2][2] + C[i_5][i_3][i_4] * C[i_5][i_4+i_3+2][i_3-1] * B[i_3-1][i_4][i_5-2] * B[i_5-2][i_3][i_4] - B[i_3+2][i_4][i_5] - B[i_3][i_4-2][i_5+1] * 2;
            }
        }
    }
#pragma endscop
...
kernel_3232152321_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
