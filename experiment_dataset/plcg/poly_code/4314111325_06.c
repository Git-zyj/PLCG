...
void kernel_4314111325_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_P; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_1+PB_P-1, PB_L-2); i_3++) {
                    A[i_1-1][i_2][i_3+i_1] = D[i_2][i_1][i_0-1] * A[i_1][i_2][i_3+i_1+1] - A[i_2-1][i_3+2][i_2+i_1] * 4;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L-1; i_4++) {
        B[i_4] = B[i_4-1] * B[i_4+1] + B[i_4-2] + 1;
        for (int i_5 = 1; i_5 < PB_L; i_5++) {
            for (int i_6 = 2; i_6 < PB_M-2; i_6++) {
                for (int i_7 = 2; i_7 < min(i_4, -i_5+PB_L); i_7++) {
                    C[i_5][i_6][i_5+1] = D[i_6][i_4+1][i_7+i_5] + D[i_4+1][i_5][i_6] - C[i_5][i_7-2][i_5+1] * C[i_5-1][i_6-2][i_5] + C[i_5-1][i_6+2][i_5] + 1;
                }
            }
        }
    }
...
kernel_4314111325_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
