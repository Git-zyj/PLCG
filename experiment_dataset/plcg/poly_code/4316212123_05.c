...
void kernel_4316212123_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_3 = 0; i_3 < PB_P; i_3++) {
        for (int i_4 = max(1, i_3); i_4 < PB_P; i_4++) {
            for (int i_5 = 0; i_5 < min(PB_P, -i_4+PB_M); i_5++) {
                C[i_4][i_3][i_5] = D[i_5+i_4][i_3][0] * C[i_4-1][i_3][i_5] + 6;
            }
        }
    }
#pragma endscop
...
kernel_4316212123_05(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
