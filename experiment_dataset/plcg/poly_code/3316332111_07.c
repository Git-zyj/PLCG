...
void kernel_3316332111_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj)){
    ...
    for (int i_1 = 2; i_1 < PB_M; i_1++) {
        ...
        for (int i_2 = i_1; i_2 < PB_P-2; i_2++) {
            for (int i_3 = 2; i_3 < min(-i_1+PB_L-2, PB_M-2); i_3++) {
                C[i_3][i_1][i_2+1] = F[i_3][i_2-2] + G[i_3-2][i_3+i_1+2] + H[i_3][i_2-1][0][i_2] + I[i_3+2][0][i_2-1] * J[i_1][i_3-2][i_2] * I[i_1-2][i_3][i_2] + C[i_3+1][i_1][i_2+1] - C[i_1][i_3+1][i_2+2] + 6;
            }
        }
    }
#pragma endscop
...
kernel_3316332111_07(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
