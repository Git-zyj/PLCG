...
void kernel_2312352325_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        A[i_0] = D[0] - E[i_0+1] - E[i_0] + E[i_0] - A[i_0-2] * 6;
        for (int i_1 = 2; i_1 < min(-i_0+PB_L, PB_M-2); i_1++) {
            B[i_1][i_0+2] = F[i_1][i_0] * G[i_1-1][i_0] * F[i_1][i_1] + G[i_1][i_1+i_0] * F[i_1][i_0-2] + A[i_1+2] - B[i_0-2][i_1+2] * 5;
            B[i_1-1][i_0+2] = H[i_0-2][i_1] * I[i_0][i_1][i_0] + H[i_1-2][i_0] + G[i_1+2][i_0] * H[i_0][i_0] - A[i_0+2] - B[i_1-1][i_0+2] - 1;
        }
    }
#pragma endscop
...
kernel_2312352325_09(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
