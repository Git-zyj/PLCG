...
void kernel_3414251225_05(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P; i_0++) {
        for (int i_1 = 2; i_1 < PB_L-1; i_1++) {
            B[i_0][i_1-2] = E[i_1][i_1] + E[i_1][i_0] * F[i_1][i_0] - 6;
            for (int i_2 = 1; i_2 < PB_P+1; i_2++) {
                B[i_2][i_1-1] = G[i_0][i_2-1][i_1+1] + F[i_2][i_0] * H[i_1][i_0-1][i_2-1] + E[i_2-1][i_1] + E[i_1-1][i_0-1] - G[i_2][0][i_1+1] - B[i_2][i_1] - 4;
            }
        }
    }
    for (int i_3 = 0; i_3 < PB_P; i_3++) {
        for (int i_4 = 0; i_4 < min(PB_P, -i_3+PB_L-1); i_4++) {
            for (int i_5 = 0; i_5 < min(min(-i_3+PB_M, -i_4+PB_P), i_3); i_5++) {
                C[i_5][i_3+1][i_4] = E[i_5+i_4][i_5+i_3] - G[i_5][i_3][i_4] * H[i_5+1][i_3][i_4] - H[i_5+1][i_4][i_5+i_4] + C[i_5][i_3+2][i_4] + 4;
            }
            for (int i_6 = 1; i_6 < i_3; i_6++) {
                B[i_6][i_4] = H[i_6+i_4][i_4+i_3+1][i_3] - H[i_6+i_4+1][i_3][i_4] - E[i_6-1][i_4+i_3] * F[i_3][0] + B[i_4][i_6] + 1;
            }
        }
    }
#pragma endscop
...
kernel_3414251225_05(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
