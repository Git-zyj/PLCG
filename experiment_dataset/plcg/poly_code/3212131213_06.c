...
void kernel_3212131213_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-1; i_0++) {
        B[i_0+1] = C[i_0+1] - C[i_0+1] + C[i_0] * C[i_0-1] + 6;
    }
    for (int i_1 = PB_N-2 - 1; i_1 >= 0; i_1--) {
        B[i_1+1] = C[i_1] * B[i_1] * B[i_1+2] * 3;
    }
#pragma endscop
...
kernel_3212131213_06(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
