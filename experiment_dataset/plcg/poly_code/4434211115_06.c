...
void kernel_4434211115_06(int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-1; i_2++) {
                D[i_2+1][i_0+1][i_2+1] = E[i_0][i_0+1][i_1] - 1;
            }
            D[i_1][i_0+1][i_1] = 2;
        }
    }
    ...
    for (int i_4 = 0; i_4 < PB_L; i_4++) {
        for (int i_5 = 0; i_5 < PB_L-1; i_5++) {
            for (int i_6 = max(i_4, 1); i_6 < PB_L; i_6++) {
                D[i_6][i_5+1][i_6] = D[i_6-1][i_5+1][i_6-1] * 5;
            }
        }
    }
#pragma endscop
...
kernel_4434211115_06(xd,yd,zd,POLYBENCH_ARRAY(D), xc,POLYBENCH_ARRAY(C), xe,ye,ze,POLYBENCH_ARRAY(E));
