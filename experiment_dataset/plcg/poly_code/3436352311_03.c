...
void kernel_3436352311_03(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl),int xm,int ym,int zm,DATA_TYPE POLYBENCH_3D(M,xM,yM,zM,xm,ym,zm)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        for (int i_1 = i_0; i_1 < PB_M+1; i_1++) {
            for (int i_2 = 2; i_2 < PB_M+1; i_2++) {
                A[i_1-1][i_2] = E[i_1][i_0][i_2] - A[i_2-2][i_1] - A[i_2-1][i_0-1] + A[i_1-1][i_0+1] - 4;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_M-2; i_3++) {
        for (int i_4 = 0; i_4 < i_3; i_4++) {
            A[i_3-1][i_4] = F[i_3][i_4] + F[i_3][i_4] * G[i_4][i_3+2] * H[i_4][i_3] - I[0] * H[i_4][i_3] + 6;
        }
    }
    for (int i_5 = 2; i_5 < PB_M-2; i_5++) {
        C[i_5-1][i_5+1] = I[i_5+2] + I[i_5] * J[i_5+1] - K[i_5-2] - K[i_5] + I[i_5-2] - C[i_5][i_5+2] - C[i_5-2][i_5] + 3;
        for (int i_6 = 1; i_6 < i_5; i_6++) {
            for (int i_7 = 1; i_7 < min(PB_M-2, -i_6+PB_N); i_7++) {
                D[i_5][i_7][i_6] = L[i_5][i_7+2][i_6+2] * M[i_6+1][i_5][i_7] + E[i_7+i_6][i_5][i_7] * E[i_7+i_6][i_5-2][i_5] - M[i_5+1][i_7+1][i_6] - D[i_5+1][i_7][i_6] * D[i_5][i_7-1][i_6-1] - D[i_5+1][i_7+1][i_6] + D[i_5][i_7+1][i_6] - 3;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,zm,POLYBENCH_ARRAY(M), INIT_SEED);
kernel_3436352311_03(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), xm,ym,zm,POLYBENCH_ARRAY(M));
