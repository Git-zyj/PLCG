...
void kernel_4232251113_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
        ...
        for (int i_1 = 1; i_1 < PB_N; i_1++) {
            for (int i_2 = i_0; i_2 < -i_1+PB_N; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_0+PB_N, -i_2+PB_M); i_3++) {
                    A[i_3+1][i_0-1][i_2-1][i_1] = C[i_3-1][i_2+i_1-1][i_2-1] - D[i_1-1][i_0-1][i_3][i_2+1] - D[i_2+1][i_3][i_0][i_1] + D[i_3-1][i_0+1][i_0][i_1] * E[i_1][i_0][i_3+i_0][0] * E[i_2+i_1][i_3][i_0+1][i_3+i_2] + E[i_3][i_1][i_0+1][i_2-1] - A[i_1][i_0][i_3][i_2] - 5;
                }
            }
        }
        for (int i_4 = 1; i_4 < i_0; i_4++) {
            for (int i_5 = 0; i_5 < PB_N-1; i_5++) {
                for (int i_6 = 1; i_6 < PB_N-2; i_6++) {
                    A[i_6+2][i_0-2][i_4-1][i_5] = D[i_5][i_4][i_6][i_0] * E[i_5+1][i_4-1][i_6][i_0-1] - F[i_4][i_6-1][i_5] * 4;
                }
            }
        }
    }
...
kernel_4232251113_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
