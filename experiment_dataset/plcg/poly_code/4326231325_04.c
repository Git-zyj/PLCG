        ...
        for (int i_1 = 2; i_1 < min(i_0, -i_0+PB_P); i_1++) {
            for (int i_2 = 1; i_2 < i_1; i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_P; i_3++) {
                    A[i_2][i_1][i_1+i_0][i_3-1] = D[i_3-1][i_0][i_2][i_1] + E[i_2][i_3-1][i_1+1][i_0] * A[i_2-1][i_1-2][i_1+i_0-2][i_3+1] * A[i_2+1][i_1][i_1+i_0][i_3-1] * A[i_2-1][i_3][i_3+i_0][i_1-1] * 1;
                }
            }
        }
    }
        ...
        for (int i_5 = i_4; i_5 < PB_P-3; i_5++) {
            for (int i_6 = 1; i_6 < -i_4+PB_L; i_6++) {
                for (int i_7 = 0; i_7 < min(-i_4+PB_P, PB_M-1); i_7++) {
                    B[i_7][i_4-1][i_6+1][i_6] = E[i_6][i_5-1][i_7+i_4][1] * E[i_7][i_5][i_4][i_6] + B[i_7][i_4-1][i_6+3][i_6+2] + B[i_7+1][i_4-1][i_6+1][i_6] * 1;
                }
                B[i_4][i_6-1][i_5+3][i_5+2] = F[i_6][i_4+1][i_5] - F[i_6][i_5][i_4+1] * F[i_5][i_6][i_4] - G[i_6][i_5][i_4] + G[i_5][i_6+i_4][i_4+1] * 3;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4326231325_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G)));
