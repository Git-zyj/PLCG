...
void kernel_2214212325_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N-2; i_0++) {
        for (int i_1 = 0; i_1 < PB_N-4; i_1++) {
            A[i_1+2] = A[i_1+1] - A[i_1+4] * A[i_1+3] - 6;
        }
        A[i_0+2] = C[0] - C[i_0] - 6;
    }
#pragma endscop
...
kernel_2214212325_00(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
