...
void kernel_2222212323_07(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-4; i_0++) {
        B[i_0+4] = B[i_0+2] + B[i_0+1] - B[i_0+3] + 1;
        B[i_0+2] = C[i_0-2] - 5;
    }
#pragma endscop
...
kernel_2222212323_07(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
