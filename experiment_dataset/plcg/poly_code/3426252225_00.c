...
void kernel_3426252225_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 3; i_1 < min(-i_0+PB_M-1, i_0); i_1++) {
            A[i_0-1][i_1] = E[i_1] * F[i_1][i_0+2] - F[i_1][i_0-1] - G[i_0][i_1] - H[i_1] - G[i_1][i_0] - H[i_0] - G[i_1][0] * A[i_0+1][i_1] + 6;
            for (int i_2 = 2; i_2 < PB_L; i_2++) {
                A[i_2-1][i_1] = G[i_2+1][i_1+2] - G[i_1-1][i_2-2] - G[i_1-1][i_2] - I[i_1+i_0+1][i_2][0] * A[i_1-3][i_2] + 5;
            }
        }
    }
    for (int i_3 = 2; i_3 < PB_L-2; i_3++) {
        C[i_3] = E[i_3-2] + H[i_3-2] - E[i_3] * G[i_3-2][2] - H[i_3] + C[i_3+2] - 3;
    }
    for (int i_4 = 2; i_4 < PB_M; i_4++) {
        for (int i_5 = 2; i_5 < min(i_4, -i_4+PB_N+2); i_5++) {
            A[i_4-2][i_5-2] = G[i_5+i_4-2][i_5-1] - G[i_5][i_4] - F[i_5][i_4-1] + 5;
        }
    }
#pragma endscop
...
kernel_3426252225_00(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
