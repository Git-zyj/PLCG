        ...
        for (int i_4 = 1; i_4 < PB_L+1; i_4++) {
            for (int i_5 = 0; i_5 < PB_L; i_5++) {
                for (int i_6 = 0; i_6 < i_3; i_6++) {
                    B[i_6][i_5] = H[i_5][i_4-1][i_3-1][i_6] + 3;
                }
            }
        }
        for (int i_7 = 0; i_7 < PB_L-1; i_7++) {
            for (int i_8 = 1; i_8 < PB_L-1; i_8++) {
                for (int i_9 = 0; i_9 < min(i_8, -i_8+PB_P-1); i_9++) {
                    D[i_3][i_7+1][i_9][i_8+1] = I[i_3][i_7][i_9+i_8+1][0] * I[i_8-1][i_9+1][i_3+1][0] * 1;
                }
            }
        }
    }
...
kernel_4422231115_06(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
