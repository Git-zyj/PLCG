...
void kernel_3316352123_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        A[i_0] = D[i_0] + E[i_0] * F[i_0] - G[i_0+1][i_0] * F[0] - 3;
        for (int i_1 = i_0; i_1 < PB_L-1; i_1++) {
            B[i_0-2][i_1] = H[i_1][i_0] * G[i_0-2][i_1-1] + H[i_0][i_1-1] * H[i_1-2][i_0] + I[i_1][i_1+1][i_0] * B[i_0-2][i_1-1] + 2;
        }
        for (int i_2 = 2; i_2 < min(i_0, PB_L-2); i_2++) {
            A[i_2-2] = G[i_2][i_0] + J[i_2+1][i_0] * H[i_2][i_0] * J[i_2][i_0] + G[i_0][i_2+2] * 6;
        }
    }
#pragma endscop
...
kernel_3316352123_03(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
