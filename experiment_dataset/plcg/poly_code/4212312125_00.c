...
void kernel_4212312125_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 0; i_1 < min(min(-i_0+PB_Q, i_0), PB_P-2); i_1++) {
            for (int i_2 = 0; i_2 < min(-i_0+PB_Q, PB_P-2); i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_Q; i_3++) {
                    A[i_3][i_1][i_2+2][i_2+i_0] = C[i_1][i_0][i_3+i_2][i_0] + D[i_2][i_1+2][i_3+i_0] - A[i_3-1][i_2+1][i_1+2][i_1+i_0] - 3;
                }
            }
        }
    }
...
kernel_4212312125_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
