...
void kernel_3426251125_06(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 0; i_1 < min(-i_0+PB_L, i_0); i_1++) {
            for (int i_2 = 1; i_2 < i_1; i_2++) {
                B[i_1][i_2-1][i_0+1] = E[i_1+1][i_0][i_2+i_0] * E[i_2][i_0][i_1+1] * F[i_2][i_1+i_0][i_0] - 3;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
        for (int i_4 = 1; i_4 < i_3; i_4++) {
            for (int i_5 = 0; i_5 < min(-i_4+PB_M-1, i_3); i_5++) {
                B[i_3][i_4][i_5+1] = E[i_5+1][i_4-1][i_3] + E[i_4-1][i_3][i_3] - F[i_3][i_5][1] + E[i_5+i_4+1][i_3][i_3-1] + 5;
            }
        }
        C[i_3+1] = G[i_3][0] + H[i_3] - H[i_3+1] + I[i_3] + H[i_3-1] + H[0] - C[i_3-1] - C[i_3] * 5;
    }
    for (int i_6 = 1; i_6 < PB_L; i_6++) {
        for (int i_7 = 1; i_7 < PB_M-1; i_7++) {
            C[i_7+1] = G[i_6-1][i_7-1] - J[i_7][i_6] + G[i_7+1][i_6] + J[i_7+1][i_6] - G[i_7][i_6-1] - 2;
        }
    }
#pragma endscop
...
kernel_3426251125_06(xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
