...
void kernel_3436112121_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
    ...
    for (int i_3 = 2; i_3 < PB_L+2; i_3++) {
        for (int i_4 = i_3; i_4 < PB_P-2; i_4++) {
            for (int i_5 = 2; i_5 < PB_L+2; i_5++) {
                B[i_5-2][i_4+2] = A[i_4][i_5-1] * B[i_3-2][i_5+4] * 4;
            }
        }
        C[i_3-2] = E[i_3-2] + 3;
        for (int i_6 = 0; i_6 < min(-i_3+PB_M-1, i_3); i_6++) {
            D[i_6+i_3+1][i_3+2] = D[i_6+i_3][i_6+2] - 4;
        }
    }
#pragma endscop
...
kernel_3436112121_00(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
