        ...
        for (int i_1 = 1; i_1 < min(PB_N-1, i_0); i_1++) {
            for (int i_2 = i_0; i_2 < min(-i_1+PB_M, -i_0+PB_L+1); i_2++) {
                for (int i_3 = i_1; i_3 < -i_1+PB_M; i_3++) {
                    A[i_0][i_3][i_2][i_1-1] = E[i_2-1][i_3-1][i_0][i_2-1] * F[i_3+i_1][i_2+i_0-1][i_1] + E[i_0][i_1][i_3][i_2] + G[i_3][i_2-1][i_1][i_0] * H[i_0][i_2+i_1][i_3] * A[i_0][i_3-1][i_2][i_1] * 4;
                }
            }
            for (int i_4 = i_1; i_4 < PB_L; i_4++) {
                D[1] = I[i_1-1][i_4][i_0] - J[i_1+1][i_4] - 5;
            }
        }
        for (int i_5 = 0; i_5 < i_0; i_5++) {
            D[1] = K[i_5][0] + L[i_0] - M[i_5] - 3;
        }
    }
    for (int i_6 = 0; i_6 < PB_L; i_6++) {
        D[1] = N[i_6] * N[i_6] * D[1] - 3;
    }
#pragma endscop
