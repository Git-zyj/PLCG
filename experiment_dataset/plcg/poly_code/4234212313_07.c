...
void kernel_4234212313_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
        ...
        for (int i_1 = 0; i_1 < PB_Q-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_Q; i_2++) {
                for (int i_3 = 1; i_3 < i_2; i_3++) {
                    A[i_0+1][i_0][i_2][i_1] = A[i_0+1][i_0][i_2-1][i_1] + A[i_1+1][i_1][i_3-1][i_2] + A[i_0+1][i_0][i_2][i_1+1] * A[i_0][i_0-1][i_2][i_3] + 6;
                }
            }
        }
    }
...
kernel_4234212313_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
