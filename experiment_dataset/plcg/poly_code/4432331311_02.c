...
void kernel_4432331311_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,int zk,int vk,int wk,DATA_TYPE POLYBENCH_5D(K,xK,yK,zK,vK,wK,xk,yk,zk,vk,wk)){
...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < PB_Q; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_P; i_2++) {
                for (int i_3 = 0; i_3 < PB_L; i_3++) {
                    A[i_3][i_1][i_2+i_0][i_0] = E[i_1][i_3][i_0][i_2] * F[i_0+1][i_1][i_3] - 5;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L-1; i_4++) {
        for (int i_5 = i_4; i_5 < PB_L; i_5++) {
            B[i_4][i_5] = G[i_4][i_5] + B[i_5][i_4+1] + B[i_5+1][i_4] - B[i_4-1][i_5] * B[i_4][i_5-1] - 6;
        }
        for (int i_6 = 1; i_6 < -i_4+PB_Q-1; i_6++) {
            for (int i_7 = i_6; i_7 < -i_6+PB_L-1; i_7++) {
                for (int i_8 = i_6; i_8 < min(-i_7+PB_M, -i_6+PB_L); i_8++) {
                    C[i_4][i_6][i_7][i_6+i_4] = H[i_4+1][i_8][i_6][i_4][i_7] + I[i_7][i_8][i_6-1][i_4] - J[i_8+i_6][i_7][i_4][i_6+1] - K[i_8][i_7+1][i_6+1][i_4][i_4-1] - I[i_7+i_6][i_8+i_7][i_8][i_4] + J[i_7+i_6+1][i_4][i_8][i_7] + C[i_4][i_6+1][i_7][i_6+i_4+1] + 4;
                }
            }
        }
        for (int i_9 = 1; i_9 < -i_4+PB_Q; i_9++) {
            for (int j_0 = 1; j_0 < PB_L; j_0++) {
                for (int j_1 = 1; j_1 < -i_4+PB_Q; j_1++) {
                    D[j_1+1][i_9][j_0][i_9+i_4] = D[j_1][i_9-1][j_0][i_9+i_4-1] - D[i_4+2][i_9][j_0][j_1+i_9] - D[j_1+1][i_9-1][j_0-1][i_9+i_4-2] + D[i_9+1][j_1-1][j_0][j_1+i_4] - 5;
                }
            }
        }
    }
...
kernel_4432331311_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,wk,POLYBENCH_ARRAY(K));
