...
void kernel_2322152125_02(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_L-2; i_0++) {
        C[i_0-3] = D[i_0+1] - D[i_0+2] - D[i_0] + 2;
    }
    for (int i_1 = 2; i_1 < PB_L-2; i_1++) {
        C[i_1-2] = D[i_1+2] - D[i_1] - 6;
    }
    for (int i_2 = 2; i_2 < PB_L-2; i_2++) {
        C[i_2-2] = D[i_2] * D[i_2] * D[i_2-2] - D[i_2-2] + D[i_2+2] * D[i_2] * D[1] * D[i_2] - D[i_2] - C[i_2-1] * 1;
    }
#pragma endscop
...
kernel_2322152125_02(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
