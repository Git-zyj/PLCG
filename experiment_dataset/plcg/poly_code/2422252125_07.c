...
void kernel_2422252125_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        A[i_0] = 6;
        A[i_0] = E[i_0+2] - F[i_0] - E[0] * F[i_0] * G[i_0][i_0] - 1;
        A[i_0-2] = F[i_0+1] + H[i_0][i_0] + G[i_0][i_0+2] - E[i_0] + F[i_0] * E[i_0] * E[i_0] + E[i_0] + 6;
        for (int i_1 = 1; i_1 < min(-i_0+PB_M+2, PB_L-2); i_1++) {
            A[i_1] = H[i_1][i_0-1] - G[i_1+i_0-2][0] - I[i_0][i_1][i_0] * F[i_0-1] - H[i_1][i_0] + G[i_0][i_1+2] + H[i_1-1][i_0] * A[i_0] + 6;
        }
    }
#pragma endscop
...
kernel_2422252125_07(xa,POLYBENCH_ARRAY(A), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
