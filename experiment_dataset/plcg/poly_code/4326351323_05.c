...
void kernel_4326351323_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl)){
        ...
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            for (int i_2 = i_0; i_2 < PB_L-2; i_2++) {
                for (int i_3 = 1; i_3 < PB_M-3; i_3++) {
                    A[i_3+1][i_1+1][i_1-1] = D[i_2][i_3][i_0-1] - E[i_2-1][i_3+1][i_0] - F[i_2][i_0-1][i_3][i_1][0] * G[i_3-1][i_0][i_3][i_1] + A[i_3+1][i_2+2][i_2] * A[i_3+3][i_1][i_1-2] - 2;
                }
            }
        }
        for (int i_4 = 2; i_4 < -i_0+PB_Q; i_4++) {
            for (int i_5 = 0; i_5 < -i_0+PB_M; i_5++) {
                for (int i_6 = 1; i_6 < i_4; i_6++) {
                    B[i_6][i_4][i_4+1][i_6] = H[i_4][i_6][i_0][i_5] + I[i_4-1][i_6][i_5] - G[i_4-1][i_5][i_6][i_4+i_0] + H[i_5+i_0][i_6][i_4][i_0+1] + J[i_5][i_0][i_6+i_4][i_5+1] + E[i_6][i_4][1] - A[i_4][i_0+1][i_0-1] - B[i_6+1][i_4][i_4+1][i_6+1] - B[i_6-1][i_4][i_4+1][i_6-1] - B[i_6][i_4-2][i_4-1][i_6] - 1;
                }
            }
        }
    }
    for (int i_7 = 2; i_7 < PB_N-1; i_7++) {
        C[i_7-1] = K[i_7] - K[i_7] - L[i_7] - L[i_7] * L[i_7] * C[i_7-2] * C[i_7] + C[i_7+1] - 2;
    }
#pragma endscop
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4326351323_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L));
