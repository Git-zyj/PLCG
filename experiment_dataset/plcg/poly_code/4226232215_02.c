    ...
    for (int i_3 = 1; i_3 < PB_Q; i_3++) {
        for (int i_4 = 1; i_4 < i_3; i_4++) {
            for (int i_5 = 0; i_5 < -i_4+PB_M; i_5++) {
                B[i_5+i_4+1][i_5][i_3] = C[i_5][i_3][i_4] + C[i_5+i_4][i_3][i_4] - E[i_5][i_4-1] + C[i_4][i_5][i_3] + B[i_5+i_4][i_5][i_3] - B[i_5+i_4][i_4][i_3-1] + 3;
            }
        }
    }
#pragma endscop
...
kernel_4226232215_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
