...
void kernel_4314351113_06(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < min(PB_L-1, -i_0+PB_P); i_2++) {
                for (int i_3 = 1; i_3 < PB_L; i_3++) {
                    B[i_1][i_0+1][i_2][1] = D[i_3][i_2][i_1][i_0-1] - E[i_1][i_3][i_2+1] + F[i_3][i_0+1][i_1][i_2] + G[i_2+1][i_1-1][i_0+1][i_0] - G[i_0+1][i_1][i_1][i_2-1] - B[i_1][i_3][i_2][1] * 5;
                    B[i_1][i_0][i_2][1] = G[i_2][i_3-1][i_1+1][i_0-1] - G[i_0][i_1-1][i_3][i_2+i_0] * D[i_2-1][i_3][i_1+1][i_2] * G[i_0][i_3][i_2][1] + F[i_3][i_1+1][i_2+1][i_0+1] + D[i_1][i_2][i_3][i_0-1] * B[i_1+1][i_0+1][i_2][1] + 5;
                }
            }
        }
        for (int i_4 = 0; i_4 < -i_0+PB_M; i_4++) {
            C[i_0][i_0] = H[i_0][1] * H[i_4+i_0][i_0] - I[i_0-1] + 4;
        }
    }
#pragma endscop
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4314351113_06(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I)));
