...
void kernel_2314312323_08(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 4; i_0 < PB_L; i_0++) {
        B[i_0-2] = D[i_0] + B[i_0-2] - B[i_0-4] - B[i_0] - 4;
        B[i_0-2] = 4;
    }
...
kernel_2314312323_08(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
