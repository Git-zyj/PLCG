...
void kernel_2226212321_02(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_2 = 1; i_2 < PB_L-4; i_2++) {
        B[i_2+2] = C[i_2-1] * C[i_2] * B[i_2+3] - B[i_2+1] - B[i_2+4] + 4;
    }
#pragma endscop
...
kernel_2226212321_02(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
