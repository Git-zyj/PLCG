...
void kernel_4422252221_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        A[i_0] = E[i_0] + E[i_0-2] * E[i_0-1] * F[i_0] + A[i_0+1] - A[i_0-1] + B[i_0-2] * 3;
    }
    for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
        B[i_1-2] = F[i_1] * E[i_1] * F[i_1] - E[i_1+2] - A[i_1] + 1;
    }
    for (int i_2 = 3; i_2 < PB_P-2; i_2++) {
        for (int i_3 = 1; i_3 < -i_2+PB_P; i_3++) {
            for (int i_4 = 2; i_4 < -i_2+PB_L-1; i_4++) {
                for (int i_5 = 0; i_5 < -i_2+PB_L-3; i_5++) {
                    C[i_2-2][i_3][i_5+i_2+2][i_4] = G[i_4][i_5][i_3+i_2][i_2] * H[i_4+2][i_5][2] + I[i_5][i_4][i_2][i_4+i_3] - G[i_5][i_4-2][i_2][i_3] - I[i_4-2][i_2-2][i_3-1][i_5] * I[i_4][i_3][i_5+1][i_2-2] - C[i_2-2][i_4-1][i_5+i_2+2][i_3] + C[i_2-3][i_3-1][i_4+i_2+1][i_5] * C[i_2-1][i_3][i_5+i_2+3][i_4] + 1;
                }
            }
        }
        for (int i_6 = 0; i_6 < -i_2+PB_Q+1; i_6++) {
            for (int i_7 = 2; i_7 < -i_2+PB_P-1; i_7++) {
                for (int i_8 = 0; i_8 < min(-i_6+PB_L-2, -i_2+PB_M); i_8++) {
                    D[i_8][i_8+i_6][i_7+i_2+1][i_7-2] = H[i_2][i_7+2][i_6] - I[i_8+i_2][i_7][i_6][2] * I[i_8][i_7-2][i_2+2][i_6+i_2-1] * H[i_8][i_8+i_7-1][i_6] * G[i_7-1][i_7+i_6][i_8][i_2] - G[i_8][i_2][i_7+i_6][i_2+2] - D[i_8+1][i_8+i_6+2][i_7+i_2+1][i_7-2] * 2;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4422252221_02(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I)));
