...
void kernel_4316352225_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,int zk,int vk,int wk,DATA_TYPE POLYBENCH_5D(K,xK,yK,zK,vK,wK,xk,yk,zk,vk,wk)){
        ...
        for (int i_1 = 2; i_1 < PB_Q; i_1++) {
            for (int i_2 = i_0; i_2 < -i_0+PB_M-2; i_2++) {
                for (int i_3 = 1; i_3 < PB_Q-2; i_3++) {
                    A[i_2+i_0][i_1][i_3-1][i_3] = D[i_3][i_1-2][i_0+2][i_2-1] - E[i_2-1][i_0-2][i_0][0] - F[i_2][i_0][i_3] - A[i_2+i_0][i_1-1][i_3+1][i_3+2] * A[i_2+i_0+2][i_1][i_3-1][i_3] - 6;
                }
            }
        }
        B[i_0] = G[i_0] * H[i_0][i_0] * G[0] + G[i_0] - I[i_0] * B[i_0+1] + B[i_0-2] - 4;
        for (int i_4 = 1; i_4 < -i_0+PB_M-2; i_4++) {
            for (int i_5 = 2; i_5 < i_0; i_5++) {
                for (int i_6 = 2; i_6 < -i_5+PB_Q; i_6++) {
                    A[i_4+i_0+1][i_5-2][i_6-1][i_6] = D[i_6][i_0][i_4+1][i_0+1] - E[i_4+i_0+2][i_6-1][i_6+i_5][i_4] * J[i_5][i_6-2][i_0][i_4+2] - J[i_6][i_5][i_4-1][i_0+1] + K[i_6+2][i_5][i_0][i_4][i_6] * J[i_5+i_4][i_6][i_4+2][i_0] - J[i_5][i_6][i_0][i_4] - 6;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,wk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4316352225_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,wk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,wk,POLYBENCH_ARRAY(K)));
