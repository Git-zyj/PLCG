        ...
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < PB_M-2; i_2++) {
                for (int i_3 = 0; i_3 < min(PB_P-1, -i_2+PB_M); i_3++) {
                    A[i_1][i_3][i_0][i_3] = D[i_0][i_3][i_2][i_3+1] - D[i_0-1][i_3+i_2][i_1][0] * D[i_0][i_3][i_1][0] + D[i_2+2][i_2][i_0-2][i_3] * D[i_0-2][i_2][i_1][0] * D[i_2][i_3][i_0][i_1] - A[i_1][i_3][i_0+1][i_3] + 6;
                }
            }
        }
        B[i_0] = E[i_0] * E[i_0] * F[i_0][i_0] * B[i_0-1] + B[i_0+1] - B[i_0+1] + 2;
    }
    for (int i_4 = 0; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 2; i_5 < min(-i_4+PB_P, PB_L-2); i_5++) {
            for (int i_6 = 0; i_6 < i_4; i_6++) {
                for (int i_7 = 0; i_7 < PB_Q; i_7++) {
                    A[i_6][i_7][i_5+1][i_7] = D[i_6+2][i_7][i_5+2][0] + D[i_5][i_4+2][i_4][i_6+2] + D[i_6][i_7][i_4+1][i_5+i_4] + D[i_6][i_7][i_5-2][i_4] * 6;
                }
            }
        }
    }
...
kernel_4332152215_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
