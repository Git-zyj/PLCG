...
void kernel_4412231313_06(int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < PB_N; i_2++) {
                for (int i_3 = i_2; i_3 < -i_1+PB_L+1; i_3++) {
                    D[i_2][i_0-1][i_3+i_1-1][i_3+i_1] = E[i_0][i_1][i_3][i_2] * 2;
                }
            }
        }
        B[i_0-1] = F[0] - F[i_0] + G[i_0][i_0] - B[i_0-2] + B[i_0] * C[i_0] + 3;
        C[i_0] = F[i_0] - G[i_0+1][i_0] - B[i_0-1] * B[i_0-2] * B[i_0] + B[i_0-2] + 6;
        for (int i_4 = 2; i_4 < -i_0+PB_P; i_4++) {
            for (int i_5 = 1; i_5 < min(-i_0+PB_Q, -i_4+PB_L-1); i_5++) {
                for (int i_6 = i_4; i_6 < -i_5+PB_M; i_6++) {
                    D[i_6][i_0-1][i_5+i_4][i_5+i_4+1] = E[i_5][i_4+i_0][i_6+1][i_0] + E[i_0][i_4][i_6][i_5+i_0] * H[i_6+i_5][i_4][i_4-1] * D[i_5-1][i_0-1][i_6+i_4-2][i_6+i_4-1] * D[i_6][i_0-1][i_5+i_4+1][i_5+i_4+2] - 6;
                }
            }
        }
    }
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4412231313_06(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H)));
