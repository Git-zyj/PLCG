...
void kernel_4222351321_07(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_P-2; i_0++) {
        for (int i_1 = 3; i_1 < i_0; i_1++) {
            A[i_1-1][i_0] = C[i_1-1][i_0] + D[i_1][i_1] - E[i_1] + F[i_1+1][i_0-1] * C[i_1][i_0+1] * D[i_0][i_1] + G[i_0+1][i_1][i_0-1] - A[i_0+1][i_1] - A[i_1-3][i_0] + 5;
            for (int i_2 = 2; i_2 < PB_M; i_2++) {
                B[i_0-1][i_1][i_0] = H[i_2][i_0][i_1+1] + F[i_2][i_1] + B[i_0+1][i_1+2][i_0+2] - B[i_0-3][i_1][i_0-2] * B[i_1-1][i_2-2][i_1] - B[i_0-2][i_1][i_0-1] + 4;
            }
        }
    }
#pragma endscop
...
kernel_4222351321_07(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
