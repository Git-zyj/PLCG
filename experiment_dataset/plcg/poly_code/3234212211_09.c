...
void kernel_3234212211_09(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_3 = 0; i_3 < PB_P; i_3++) {
        for (int i_4 = 1; i_4 < i_3; i_4++) {
            for (int i_5 = 0; i_5 < min(i_4, PB_L-1); i_5++) {
                B[i_4][i_5] = C[i_5+1][i_3][i_4] - B[i_4-1][i_5] + B[i_4][i_5+1] * 2;
            }
        }
    }
#pragma endscop
...
kernel_3234212211_09(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
