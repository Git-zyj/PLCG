        ...
        for (int i_1 = 0; i_1 < PB_P-2; i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_M; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_1+PB_M, PB_M-2); i_3++) {
                    A[i_2+1][i_0+2][i_3][i_1+1] = D[i_2+i_0][i_1][i_3][i_1] + E[i_3+i_1][i_2-1][i_0] * A[i_2+1][i_1+2][i_0-1][i_3+1] - A[i_3+2][i_0+2][i_2+1][i_1+1] - A[i_2+1][i_0+3][i_3][i_1+1] - A[i_2+1][i_0+2][i_3][i_1+2] + 3;
                }
            }
        }
    }
...
kernel_4322312213_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F));
