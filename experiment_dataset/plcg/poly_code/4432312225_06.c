...
void kernel_4432312225_06(int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
    ...
    for (int i_5 = 2; i_5 < PB_M-2; i_5++) {
        C[i_5] = E[i_5+1] - C[i_5+2] - C[i_5-2] + 6;
        for (int i_6 = 0; i_6 < i_5; i_6++) {
            for (int i_7 = 3; i_7 < PB_P+2; i_7++) {
                D[i_6][i_7-2][i_5] = D[i_6][i_7-3][i_5] - 1;
            }
        }
    }
#pragma endscop
...
kernel_4432312225_06(xd,yd,zd,POLYBENCH_ARRAY(D), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E));
