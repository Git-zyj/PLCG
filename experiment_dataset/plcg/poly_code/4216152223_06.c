...
void kernel_4216152223_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 1; i_1 < min(-i_0+PB_Q-1, i_0); i_1++) {
            for (int i_2 = 0; i_2 < i_0; i_2++) {
                for (int i_3 = 2; i_3 < PB_L-2; i_3++) {
                    A[i_0+1][i_0-1][i_3][i_1] = C[i_3][i_2+1][i_1][i_0] - C[i_3-2][i_0-1][i_1][i_2] * D[i_0+2][i_3+i_1][i_2] - A[i_0+1][i_0-1][i_3+2][i_1-1] - A[i_2+3][i_2+1][i_3][i_1] * 2;
                }
            }
            for (int i_4 = 0; i_4 < min(-i_0+PB_Q, i_0); i_4++) {
                for (int i_5 = i_0; i_5 < -i_1+PB_P-1; i_5++) {
                    A[i_0+1][i_0-1][i_4][i_1] = C[i_5][i_0][i_1+i_0+1][i_4] + C[i_5-1][i_5][i_4+i_0][0] * C[i_4][i_5+2][i_1][i_5] * D[i_0][i_5+i_1+1][i_4] + C[i_4][i_1][i_5+2][i_0] + C[i_4][i_0][i_5][i_1] + 5;
                }
            }
        }
    }
...
kernel_4216152223_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
