...
void kernel_4324332223_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
        ...
        for (int i_1 = 0; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 2; i_2 < -i_0+PB_L-2; i_2++) {
                for (int i_3 = 2; i_3 < -i_1+PB_M-2; i_3++) {
                    A[i_0][i_2-2][i_3][i_1+2] = D[i_3+2][i_1][i_2+i_0+2][i_0] * D[i_1][i_2][i_0][0] - D[i_3][i_2+i_0][i_1][i_2] + E[i_3+i_1+2][i_0+2][i_3+i_2+1][i_1] + A[i_0][i_3-2][i_1+2][i_2] * 5;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-3; i_4++) {
        B[i_4+1] = F[i_4] + G[i_4+2] + B[i_4+2] * B[i_4+3] - 1;
        for (int i_5 = 0; i_5 < min(PB_Q-3, -i_4+PB_M); i_5++) {
            for (int i_6 = 0; i_6 < PB_P-2; i_6++) {
                for (int i_7 = i_4; i_7 < -i_6+PB_N; i_7++) {
                    A[i_7][i_4-2][i_6][i_5+3] = H[i_6][i_7][i_5+2] - E[i_6][i_7][i_4][i_6] - D[i_7+i_6][i_5+i_4][i_4][i_6+2] * 1;
                }
            }
        }
    }
...
kernel_4324332223_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
