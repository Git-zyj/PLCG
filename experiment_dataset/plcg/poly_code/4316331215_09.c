...
#pragma scop
        ...
        for (int i_1 = i_0; i_1 < PB_M-1; i_1++) {
            for (int i_2 = i_0; i_2 < min(-i_0+PB_Q-1, PB_L-1); i_2++) {
                for (int i_3 = 1; i_3 < PB_L; i_3++) {
                    A[i_1][i_3][i_2+1][i_0+1] = D[i_2][i_0-1][i_3][i_1] - D[i_1][i_0][i_0][i_3-1] - E[i_3+1][i_0-1][i_3+1][i_1+1] + E[i_1][i_3][i_0-1][i_2+i_0+1] - D[i_1+1][i_3][i_2][i_2-1] * A[i_1+1][i_2+1][i_3+1][i_0+1] * 5;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M; i_4++) {
        for (int i_5 = 1; i_5 < i_4; i_5++) {
            for (int i_6 = 0; i_6 < min(i_4, PB_L); i_6++) {
                for (int i_7 = 0; i_7 < min(PB_L-1, -i_4+PB_Q); i_7++) {
                    A[i_4][i_7+1][i_5+1][i_6+1] = F[i_4][i_6][i_5-1][0] * G[i_7][i_6][i_5][i_7+i_4][1] + 5;
                }
            }
        }
        for (int i_8 = 1; i_8 < min(i_4, PB_L-1); i_8++) {
            for (int i_9 = 1; i_9 < PB_L-1; i_9++) {
                C[i_9][i_8-1][i_4-1] = H[i_8][i_9+1] * C[i_9-1][i_8-1][i_4-1] * C[i_8+1][i_9-1][i_4-1] - 5;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4316331215_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H)));
