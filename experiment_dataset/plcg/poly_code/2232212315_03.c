...
void kernel_2232212315_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_2 = 2; i_2 < PB_M; i_2++) {
        B[i_2-1] = C[i_2] - B[i_2-2] + B[i_2] * B[i_2-2] + 3;
    }
#pragma endscop
...
kernel_2232212315_03(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
