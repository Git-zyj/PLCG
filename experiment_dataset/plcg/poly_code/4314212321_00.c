...
void kernel_4314212321_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
        ...
        for (int i_5 = max(i_4, 2); i_5 < PB_P-2; i_5++) {
            for (int i_6 = 0; i_6 < -i_4+PB_Q-1; i_6++) {
                for (int i_7 = 0; i_7 < -i_5+PB_M+2; i_7++) {
                    C[i_7+i_5-2][i_4][i_5][i_6+i_4-1] = C[i_7+i_5-2][i_4][i_5+2][i_6+i_4+1] + 3;
                }
            }
        }
    }
...
kernel_4314212321_00(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
