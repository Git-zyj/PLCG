...
void kernel_3334312215_02(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_3 = 2; i_3 < PB_M-1; i_3++) {
        B[i_3] = D[i_3-2] + B[i_3-1] - B[i_3+1] - 2;
    }
...
kernel_3334312215_02(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
