...
void kernel_2216211223_00(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
...
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-1; i_0++) {
        ...
        for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
            B[i_2][i_0] = C[i_2+1][i_0][0] - B[i_2+1][i_0] - B[i_2+1][i_0+1] + 6;
        }
    }
#pragma endscop
...
kernel_2216211223_00(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
