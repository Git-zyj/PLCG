...
void kernel_4216112223_07(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
        ...
        for (int i_2 = i_1; i_2 < PB_Q; i_2++) {
            for (int i_3 = 2; i_3 < -i_1+PB_P; i_3++) {
                for (int i_4 = 2; i_4 < PB_M; i_4++) {
                    B[i_4][i_1][i_3][i_2] = C[i_3][i_4][i_2+1][i_3+i_1] * C[i_4][i_1-2][i_3][i_1+2] * B[i_3][i_1][i_4][i_2-2] + B[i_4][i_1][i_3-2][i_2] * B[i_2-2][i_1][i_3-2][i_4-2] - 2;
                }
            }
        }
    }
...
kernel_4216112223_07(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
