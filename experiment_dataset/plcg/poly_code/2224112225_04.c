...
void kernel_2224112225_04(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M; i_0++) {
        for (int i_1 = 3; i_1 < i_0; i_1++) {
            B[i_1-1] = B[i_1-3] * B[i_0-3] * 3;
        }
        B[i_0-1] = C[i_0] * 3;
    }
#pragma endscop
...
kernel_2224112225_04(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
