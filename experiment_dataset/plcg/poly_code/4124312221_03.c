...
void kernel_4124312221_03(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 4; i_0 < PB_L-3; i_0++) {
        for (int i_1 = 0; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 2; i_2 < -i_0+PB_L-3; i_2++) {
                A[i_1][i_2+i_0-1] = B[0][i_2-2] - A[i_1+2][i_2+i_0-4] - A[i_1][i_2+i_0+3] - 4;
            }
        }
    }
#pragma endscop
...
kernel_4124312221_03(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B));
