...
void kernel_3116212323_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-3; i_0++) {
        for (int i_1 = 0; i_1 < min(i_0, -i_0+PB_M-3); i_1++) {
            A[i_1+i_0] = B[i_0] - A[i_1+i_0+3] + A[i_1+i_0-1] * A[i_1+i_0+1] + 2;
        }
    }
#pragma endscop
...
kernel_3116212323_05(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
