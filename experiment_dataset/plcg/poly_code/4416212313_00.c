...
void kernel_4416212313_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg)){
    ...
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        ...
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < i_1; i_2++) {
                B[i_2][i_1][i_0] = B[i_2-1][i_1][i_0] + B[i_2][i_1][i_0-1] - 6;
            }
        }
    }
        ...
        for (int i_4 = 1; i_4 < PB_P; i_4++) {
            for (int i_5 = i_3; i_5 < PB_L-1; i_5++) {
                for (int i_6 = 0; i_6 < i_4; i_6++) {
                    B[i_6][i_5+1][i_4] = F[i_6][i_5][i_5][i_3][i_4-1] * 6;
                }
            }
        }
        for (int i_7 = i_3; i_7 < min(-i_3+PB_L, PB_M); i_7++) {
            for (int i_8 = 1; i_8 < PB_M-1; i_8++) {
                for (int i_9 = i_3; i_9 < PB_M-1; i_9++) {
                    D[i_9+1][i_7+i_3][2][i_8-1] = G[i_8][i_9][i_7][i_3+2] + B[i_9][i_8][i_7+1] + D[i_9][i_7+i_3][2][i_8-1] * D[i_9][i_7+i_3-1][2][i_8] - D[i_8+1][i_7+i_3][2][i_9] - D[i_9+1][i_7+i_3][2][i_8-1] + 4;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4416212313_00(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G)));
