...
void kernel_4422251211_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,int zk,int vk,DATA_TYPE POLYBENCH_4D(K,xK,yK,zK,vK,xk,yk,zk,vk)){
...
#pragma scop
    ...
    for (int i_2 = 1; i_2 < PB_L; i_2++) {
        B[i_2] = E[i_2] * E[i_2] - F[i_2] * G[i_2][i_2+1] + E[i_2] + F[i_2] * B[i_2-1] - 3;
    }
        ...
        for (int i_4 = i_3; i_4 < -i_3+PB_M-1; i_4++) {
            for (int i_5 = 1; i_5 < min(-i_3+PB_P, -i_4+PB_L); i_5++) {
                for (int i_6 = 0; i_6 < min(i_4, -i_4+PB_M); i_6++) {
                    C[i_5][i_3][i_6+i_4][i_6] = H[i_4-1][i_6][i_5+i_3][1] - H[i_5][i_3-1][i_6+1][i_4+1] - I[i_6][i_5+i_4][i_5-1] - H[i_6][i_3][i_4][i_5] - C[i_5-1][i_3][i_6+i_4][i_6] + C[i_5+1][i_3-1][i_6+i_4][i_4] + C[i_5][i_3][i_6+i_4-1][i_6] - C[i_5][i_6][i_4+i_3+1][i_3] + 5;
                }
                for (int i_7 = 1; i_7 < -i_3+PB_M; i_7++) {
                    D[i_3+1][i_4-1][i_4][i_7+1] = H[i_3][i_5][i_4+1][i_7-1] - I[i_3][i_4][i_5-1] + H[i_7+i_3][i_5][i_5+i_4][1] * J[i_4-1][i_7-1][0] + K[i_3+1][i_7+i_5][i_4][i_5] * D[i_3+2][i_4-1][i_4][i_5+1] * D[i_3+2][i_4-1][i_4][i_7+1] - 6;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4422251211_05(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K)));
