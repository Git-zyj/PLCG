...
void kernel_3214211225_07(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P-1; i_0++) {
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            A[i_1][i_0] = C[i_1] - A[i_1][i_0-1] + A[i_1][i_0-2] - 1;
        }
        for (int i_2 = i_0; i_2 < PB_L; i_2++) {
            A[i_2][i_0+1] = C[i_0-1] * 2;
        }
    }
#pragma endscop
...
kernel_3214211225_07(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
