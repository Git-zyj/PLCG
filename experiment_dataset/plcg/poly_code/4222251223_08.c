    ...
    for (int i_3 = 1; i_3 < PB_P; i_3++) {
        for (int i_4 = 1; i_4 < PB_P; i_4++) {
            for (int i_5 = 2; i_5 < min(-i_3+PB_M, PB_P); i_5++) {
                B[i_3][i_4+1][i_5-1] = C[i_5][i_5][i_3] - D[i_3][i_3][i_4-1] + C[i_5+i_3][i_4-1][0] * C[i_5+i_3][i_4][0] - D[i_5-1][i_3][i_4-1] - C[i_4-1][i_5][i_3] - E[i_5][i_4] + B[i_3-1][i_4+1][i_5-2] * 5;
            }
        }
    }
#pragma endscop
...
kernel_4222251223_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
