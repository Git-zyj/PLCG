...
void kernel_4212312121_06(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd)){
        ...
        for (int i_1 = 2; i_1 < min(-i_0+PB_M, PB_M-2); i_1++) {
            for (int i_2 = 2; i_2 < -i_1+PB_M-2; i_2++) {
                for (int i_3 = i_2; i_3 < PB_L-3; i_3++) {
                    B[i_2+i_1+2][i_0+2][i_3][i_0] = C[i_3+1][i_1][i_2] + 3;
                    B[i_2+i_1][i_0+2][i_3][i_0] = D[i_3][i_0+2][i_2][i_1-2] - B[i_1+i_0][i_3+3][i_2-2][i_3+1] * 1;
                }
            }
        }
    }
...
kernel_4212312121_06(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D));
