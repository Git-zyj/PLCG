    ...
    for (int i_4 = 0; i_4 < PB_N-2; i_4++) {
        for (int i_5 = 2; i_5 < min(PB_M-2, -i_4+PB_L); i_5++) {
            for (int i_6 = 0; i_6 < PB_Q-2; i_6++) {
                C[i_6][i_5+i_4][i_6] = E[i_6][i_6+i_5][i_4] + F[i_5+2][i_6][i_4] + G[i_6][i_4][i_5+2] * H[i_4][i_5][i_6+2][0] + G[i_5-2][i_4+1][i_5] - G[i_6][i_4][0] * 1;
            }
            for (int i_7 = 0; i_7 < i_4; i_7++) {
                for (int i_8 = 0; i_8 < min(-i_5+PB_L+1, -i_4+PB_L); i_8++) {
                    C[i_7][i_8+i_4][i_7] = I[i_5-2][i_4][i_7][i_5+1] + H[i_4+2][i_7][i_5+2][i_7] * C[i_7+1][i_8+i_5-1][i_7+1] + 5;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4312332215_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I)));
