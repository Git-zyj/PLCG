...
void kernel_3212212121_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_3 = 1; i_3 < PB_P-2; i_3++) {
        B[i_3][i_3] = C[i_3] - C[i_3] * B[i_3-1][i_3-1] - B[i_3+2][i_3+2] + 1;
    }
#pragma endscop
...
kernel_3212212121_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
