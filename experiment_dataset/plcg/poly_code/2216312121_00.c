...
void kernel_2216312121_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        ...
        B[i_0+2] = C[i_0] - C[i_0-2] - B[i_0+1] + 4;
    }
#pragma endscop
...
kernel_2216312121_00(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
