    ...
    for (int i_3 = 1; i_3 < PB_L; i_3++) {
        for (int i_4 = 1; i_4 < -i_3+PB_M; i_4++) {
            for (int i_5 = 0; i_5 < i_4; i_5++) {
                C[i_3] = G[i_5][i_3][i_4] - F[i_3][i_4] + G[i_5][i_3][i_3] + F[i_5+i_4][i_3-1] + G[i_4][i_3][i_5] + 4;
            }
            C[i_4] = F[i_4-1][i_3] + F[i_4][i_3-1] + I[i_4] + J[i_4][i_3] * J[i_4-1][i_3-1] * F[i_4][i_3] - C[i_4+1] - 4;
            C[i_4] = J[i_3][i_4-1] * J[i_4+1][i_3] - F[i_4][i_3] - I[i_4+i_3] - C[i_4] + C[i_4-1] + 3;
        }
    }
#pragma endscop
...
init_array(xc,POLYBENCH_ARRAY(C), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4414251325_06(xc,POLYBENCH_ARRAY(C), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xc,POLYBENCH_ARRAY(C), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J)));
