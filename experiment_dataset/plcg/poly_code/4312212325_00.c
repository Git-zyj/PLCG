...
void kernel_4312212325_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
        ...
        for (int i_1 = i_0; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 2; i_2 < PB_L-2; i_2++) {
                for (int i_3 = 0; i_3 < PB_N; i_3++) {
                    A[i_1][i_2+2][i_2] = A[i_2][i_0+3][i_0+1] * A[i_2-2][i_1+1][i_1-1] + 5;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_M-2; i_4++) {
            for (int i_5 = 1; i_5 < PB_L; i_5++) {
                B[i_0][i_5] = D[i_5][i_4-1] - B[i_4][i_5-1] * 4;
            }
            for (int i_6 = 2; i_6 < -i_0+PB_P-2; i_6++) {
                C[i_4][i_6+i_0][i_4] = B[i_0+2][i_6-2] - C[i_4][i_6+i_0+2][i_4] * C[i_4][i_6+i_0-1][i_4] - C[i_4+2][i_6+i_0][i_4+2] * 5;
            }
        }
    }
#pragma endscop
...
kernel_4312212325_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
