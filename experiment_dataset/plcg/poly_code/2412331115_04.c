...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_N; i_1++) {
        for (int i_2 = 1; i_2 < PB_N-1; i_2++) {
            D[i_2] = F[i_2-1][i_1+1] * G[i_1-1][i_2-1] - F[i_2][i_1+1] * D[i_2-1] - 4;
            D[i_2+1] = H[i_2+1][i_1-1] + G[i_1][i_1] - 3;
        }
        D[i_1] = E[i_1+1] - E[i_1-1] * I[i_1] * E[i_1] * J[i_1+1] * 2;
    }
#pragma endscop
...
kernel_2412331115_04(xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
