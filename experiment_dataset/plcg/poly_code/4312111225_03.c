...
void kernel_4312111225_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
        ...
        for (int i_1 = 2; i_1 < PB_Q; i_1++) {
            for (int i_2 = 1; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_L-1; i_3++) {
                    A[i_2+1][i_0-1][i_1][i_3-1] = A[i_2+1][i_0-3][i_1-1][i_3] * A[i_3+1][i_0-1][i_2][i_1] + A[i_3][i_0-1][i_1-2][i_2-1] + 5;
                }
            }
        }
        for (int i_4 = i_0; i_4 < PB_L-3; i_4++) {
            for (int i_5 = 0; i_5 < -i_4+PB_M+1; i_5++) {
                for (int i_6 = 1; i_6 < PB_Q+1; i_6++) {
                    A[i_4+3][i_0-1][i_5][i_6-1] = D[i_5+i_4-1][i_5][i_4+1][i_0] * 3;
                }
            }
            for (int i_7 = 1; i_7 < i_0; i_7++) {
                C[i_7][i_7][i_0] = E[i_4][i_7] + F[i_7-1][i_4-1][i_0+1] - C[i_7][i_7][i_0-2] - 1;
            }
        }
    }
#pragma endscop
...
kernel_4312111225_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
