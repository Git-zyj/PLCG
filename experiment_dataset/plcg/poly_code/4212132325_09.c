...
void kernel_4212132325_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        ...
        A[i_0] = C[i_0] - C[i_0] * C[i_0] + C[i_0] - C[i_0] - A[i_0] - 3;
    }
#pragma endscop
...
kernel_4212132325_09(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
