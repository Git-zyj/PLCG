...
void kernel_4214351125_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf)){
...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < -i_0+PB_P; i_1++) {
            for (int i_2 = 0; i_2 < PB_L; i_2++) {
                for (int i_3 = 1; i_3 < PB_L+1; i_3++) {
                    A[i_2][i_1+i_0-1][i_3][i_0] = C[i_2][i_3-1][i_1] + D[i_2+1][i_3-1][i_1][1] * E[i_0-1][i_2][i_1][i_1] * A[i_2][i_1+i_0][i_3][i_0] - 5;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 0; i_5 < PB_P-1; i_5++) {
            for (int i_6 = 1; i_6 < min(i_4, -i_5+PB_P-1); i_6++) {
                for (int i_7 = 2; i_7 < min(-i_5+PB_M, -i_4+PB_L); i_7++) {
                    A[i_4][i_6+i_5+1][i_7-2][i_6+2] = D[i_5][i_7][i_4][i_6-1] - F[i_5+1][i_6][i_4][i_7] * D[i_5][i_4][i_7][i_6+1] * F[i_5][i_4][i_7+i_6+1][0] - D[i_5+1][i_4+1][i_6-1][i_6] * F[i_6+1][i_4-1][i_7+i_5][1] + D[i_6][i_7+i_4][i_5][i_6-1] - 5;
                }
            }
        }
    }
...
kernel_4214351125_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
