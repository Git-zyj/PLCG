...
void kernel_3226152215_00(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        B[i_0][i_0] = C[i_0+1][i_0] - D[i_0] - D[2] * D[i_0] + D[i_0-1] - D[i_0+1] - D[i_0+2] * B[i_0][i_0] + 6;
        B[i_0][i_0] = D[i_0-1] * D[i_0] - D[i_0] - B[i_0-1][i_0-1] * 4;
    }
#pragma endscop
...
kernel_3226152215_00(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
