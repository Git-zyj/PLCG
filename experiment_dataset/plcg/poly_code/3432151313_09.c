    ...
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        ...
        for (int i_1 = i_0; i_1 < PB_M; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_N+1, -i_1+PB_M+1); i_2++) {
                B[i_0][i_2][i_1] = F[i_2+i_0-1][i_1][i_0+1] + F[i_0-1][i_2+i_1-1][0] + F[i_2+i_1][i_0-1][i_0] * F[i_2][i_0][1] + G[i_0-1][i_1-1] * B[i_1][i_2-1][i_0] * B[i_1][i_0][i_2-1] * 5;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_M; i_3++) {
        for (int i_4 = 1; i_4 < -i_3+PB_M; i_4++) {
            for (int i_5 = 2; i_5 < PB_M-1; i_5++) {
                C[i_5+i_4][i_3-1][i_5-1] = F[i_4-1][i_5][i_3] - F[i_5][i_3][i_4] * F[i_4][i_5+1][i_4+i_3] * G[i_5+1][i_5] - F[i_5-1][i_5][i_4-1] + C[i_5+i_4-1][i_3-1][i_5-2] * C[i_5+i_4+1][i_3-1][i_5] + C[i_5+i_4][i_3][i_5-1] + 3;
            }
        }
        for (int i_6 = i_3; i_6 < PB_M; i_6++) {
            A[i_6-1] = E[i_6] + G[i_3][i_6] * G[i_6][i_3-1] + G[i_3][i_3] * G[i_6][i_3] * E[i_3] + 6;
        }
    }
#pragma endscop
...
kernel_3432151313_09(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
