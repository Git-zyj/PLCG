...
void kernel_4326211313_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
        ...
        for (int i_1 = max(1, i_0); i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < PB_L; i_2++) {
                for (int i_3 = 0; i_3 < PB_L; i_3++) {
                    A[i_1][i_2][i_3] = A[i_3+1][i_2-1][i_1] * A[i_3+1][i_2][i_1] * A[i_1][i_2-1][i_3] * A[i_1-1][i_2][i_3] * 4;
                }
            }
        }
    }
    ...
    for (int i_5 = 0; i_5 < PB_L; i_5++) {
        for (int i_6 = 1; i_6 < i_5; i_6++) {
            for (int i_7 = 2; i_7 < min(min(-i_5+PB_L, i_5), PB_L-1); i_7++) {
                for (int i_8 = 1; i_8 < min(-i_7+PB_L-1, -i_5+PB_L); i_8++) {
                    C[i_6][i_8+i_7][i_7-1] = C[i_6-1][i_7+i_5][i_7-1] * C[i_6][i_8+i_7+1][i_7-1] - C[i_6+1][i_8+i_7][i_7-2] * C[i_7+1][i_8+i_5][i_8-1] * 2;
                }
            }
        }
    }
...
kernel_4326211313_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
