...
void kernel_4226211113_09(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    ...
    for (int i_3 = 2; i_3 < PB_M+1; i_3++) {
        for (int i_4 = 0; i_4 < -i_3+PB_P+1; i_4++) {
            B[i_3][i_4+i_3-1] = C[i_3-1][i_4] - B[i_3-1][i_4+i_3-2] * 6;
        }
    }
#pragma endscop
...
kernel_4226211113_09(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
