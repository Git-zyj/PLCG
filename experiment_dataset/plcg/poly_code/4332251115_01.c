...
void kernel_4332251115_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 1; i_1 < -i_0+PB_M-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_P; i_2++) {
                for (int i_3 = 0; i_3 < min(min(-i_2+PB_P+1, i_0), -i_1+PB_P); i_3++) {
                    A[i_0-1][i_1+i_0][i_1][i_3+i_2-1] = D[i_1][i_0+1][i_1][i_2] * D[i_1-1][i_0+1][i_2][i_3+i_1] * E[i_1][i_0][i_2][i_1] * A[i_0-1][i_1+i_0+1][i_1+1][i_3+i_2-1] - 1;
                }
            }
        }
    }
        ...
        for (int i_5 = i_4; i_5 < PB_P-1; i_5++) {
            for (int i_6 = 1; i_6 < -i_4+PB_M; i_6++) {
                for (int i_7 = 0; i_7 < -i_5+PB_P+1; i_7++) {
                    A[i_4-1][i_6+i_4][i_6][i_7+i_5-1] = D[i_5][i_4+1][i_6][i_7] * D[i_5-1][i_4][i_7+1][i_6-1] - E[i_6][i_7][i_5-1][i_4] - D[i_6][i_4][i_7][i_5+1] * 3;
                }
            }
        }
    }
    for (int i_8 = 0; i_8 < PB_M-1; i_8++) {
        for (int i_9 = 1; i_9 < PB_M-1; i_9++) {
            for (int j_0 = 1; j_0 < -i_9+PB_L; j_0++) {
                C[0][i_8][j_0] = F[i_8][i_9+1][j_0] - E[i_9-1][j_0][i_8][j_0] - G[i_8][j_0][i_9] - H[j_0+i_9-1][i_8] + F[i_8][j_0+i_9][j_0] * G[j_0][i_9+1][j_0-1] * F[i_8+1][j_0][j_0] + 2;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4332251115_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H)));
