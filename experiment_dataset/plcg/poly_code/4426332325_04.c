...
void kernel_4426332325_04(int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl)){
        ...
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 2; i_2 < -i_0+PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < -i_2+PB_P-1; i_3++) {
                    C[i_1][i_2-1][i_0][0] = E[i_3][i_2-2][i_1][i_0] * F[i_1][i_3+i_2+1][i_2+i_0] + E[i_2+i_0+1][i_3][i_1][i_1] * G[i_1][i_3][i_2+1] - 4;
                }
            }
        }
    }
        ...
        for (int i_5 = max(i_4, 1); i_5 < PB_N+1; i_5++) {
            for (int i_6 = 0; i_6 < PB_M; i_6++) {
                for (int i_7 = 0; i_7 < PB_M; i_7++) {
                    C[i_6][i_7][i_4][0] = H[i_5-1][i_4][i_6+2][0] * 2;
                }
            }
        }
    }
    for (int i_8 = 2; i_8 < PB_N-2; i_8++) {
        for (int i_9 = 2; i_9 < PB_M-2; i_9++) {
            for (int j_0 = 2; j_0 < PB_M; j_0++) {
                for (int j_1 = 2; j_1 < min(-j_0+PB_L, PB_M-2); j_1++) {
                    C[i_9][j_0][j_1][0] = I[i_9][j_1+j_0][i_8][0] * I[j_0-2][j_1][i_8][i_9] + H[j_0][i_9-2][i_8][j_0] + C[i_9-1][j_0-2][j_1+2][0] - C[i_9+2][j_0-1][j_1][0] * C[i_9][j_0][j_1-2][0] - 4;
                }
            }
        }
        D[i_8] = J[i_8-2] * K[i_8] - K[i_8] - L[i_8] * D[i_8+2] + D[i_8-1] + D[i_8+1] + 4;
    }
#pragma endscop
...
init_array(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4426332325_04(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L)));
