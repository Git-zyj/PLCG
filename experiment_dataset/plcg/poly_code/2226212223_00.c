...
void kernel_2226212223_00(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P+2; i_0++) {
        for (int i_1 = 2; i_1 < min(PB_P, i_0); i_1++) {
            B[i_0][i_0-2] = C[i_1] - B[i_1][i_1-2] + B[i_1+2][i_1] * 1;
            B[i_0][i_0-2] = D[i_1+2][i_0-2] + 4;
        }
    }
#pragma endscop
...
kernel_2226212223_00(xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
