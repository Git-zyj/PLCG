...
void kernel_3236112321_02(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_0 = 1; i_0 < PB_P-2; i_0++) {
        ...
        for (int i_2 = 2; i_2 < i_0; i_2++) {
            for (int i_3 = 1; i_3 < PB_P; i_3++) {
                B[i_0][i_2][0] = C[i_2][i_3][i_0+2] - C[i_2-2][i_3][i_0-1] + B[i_0][i_3-1][0] + B[i_0+1][i_2][0] - B[i_0][i_2-2][0] + 5;
            }
        }
    }
#pragma endscop
...
kernel_3236112321_02(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
