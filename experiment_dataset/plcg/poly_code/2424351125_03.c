...
void kernel_2424351125_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        A[i_0] = E[i_0+1] + F[i_0] + F[i_0] - E[i_0] * F[i_0] - F[i_0-1] - C[i_0] * 1;
        for (int i_1 = i_0; i_1 < PB_M; i_1++) {
            B[i_1][i_0] = G[i_1][i_0] + G[i_1][i_0+1] + H[i_0][i_1] * B[i_1-2][i_0] - C[i_0-2] + 3;
        }
        C[i_0] = I[i_0-1] * I[i_0] + I[i_0] - E[i_0] - E[i_0] * 1;
    }
    for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
        A[i_2+1] = F[i_2] - E[i_2] + I[i_2] - F[i_2] - I[i_2-1] - I[i_2+1] - 3;
    }
#pragma endscop
...
kernel_2424351125_03(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
