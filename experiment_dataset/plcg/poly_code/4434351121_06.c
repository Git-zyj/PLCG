        ...
        for (int i_1 = 1; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 1; i_2 < PB_L; i_2++) {
                for (int i_3 = i_1; i_3 < PB_M; i_3++) {
                    A[i_0][i_0][i_2][i_3-1] = E[i_2][i_3][i_1][i_0] * F[i_3][i_3][i_2] - G[i_3][i_1][i_3-1][i_0][i_2] * E[i_2-1][i_3+1][i_0][i_2-1] + H[i_2-1][i_1-1][0] * A[i_1+2][i_1+2][i_2][i_3-1] * A[i_0][i_0][i_2][i_3] * 2;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_M; i_4++) {
            B[i_4-1][i_0] = I[i_4][i_0-1] + 1;
        }
    }
    for (int i_5 = 1; i_5 < PB_M-1; i_5++) {
        C[i_5] = J[i_5+1] + K[i_5] + L[i_5-1] - L[i_5] + K[i_5] * J[i_5] * D[i_5] - 2;
        D[i_5] = K[i_5+1] - K[i_5] - J[i_5-1] + L[1] * K[i_5+1] * C[i_5] - 1;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4434351121_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L));
