        ...
        for (int i_1 = 2; i_1 < min(min(-i_0+PB_L-2, i_0), PB_M-1); i_1++) {
            for (int i_2 = 1; i_2 < PB_M; i_2++) {
                for (int i_3 = i_2; i_3 < PB_M-1; i_3++) {
                    B[i_1][i_2-1][i_3][i_3+2] = C[i_3][i_3-1][1] * D[i_3+1][i_2][1][i_0+1] * E[i_3+1][i_2][i_1+1][i_1+i_0+2] + F[i_1-2][i_2][i_0][i_3] * D[i_1][i_0+2][i_3][i_2] * D[i_3+1][i_2-1][i_0][i_1] * F[i_3-1][i_0][i_1][i_1-1] + 5;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M; i_4++) {
        for (int i_5 = 2; i_5 < PB_P; i_5++) {
            for (int i_6 = 2; i_6 < PB_Q-2; i_6++) {
                for (int i_7 = max(i_4, 2); i_7 < -i_6+PB_M; i_7++) {
                    B[i_4][i_7-2][i_6][i_6+2] = F[i_7+1][i_6-1][i_4][i_5] - D[i_7+i_6][i_5][i_6][i_4+1] + G[i_6][i_5-2][i_7] * B[i_4][i_7-2][i_6-1][i_6+1] * B[i_6-2][i_5-2][i_7][i_7+2] * 1;
                }
            }
        }
    }
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4222352225_04(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G)));
