...
void kernel_4236252325_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg)){
        ...
        for (int i_1 = i_0; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 2; i_2 < min(PB_Q-2, -i_0+PB_P+2); i_2++) {
                for (int i_3 = 2; i_3 < PB_L-2; i_3++) {
                    A[i_0][i_1][i_2][i_3] = C[i_1+2][i_0][i_3][i_2+2] * D[i_3][i_2][i_0][i_1] * E[i_1-2][i_3-2][i_2+i_0-2] - C[i_2-2][i_3][i_0][i_1] * C[i_1][i_3+2][i_0][i_2] + A[i_3-2][i_1][i_2+2][i_0-1] + A[i_0][i_1][i_2-1][i_3] + A[i_2+1][i_1][i_3][i_0] + 3;
                }
            }
        }
    }
    for (int i_4 = 4; i_4 < PB_M; i_4++) {
        B[i_4-2] = F[i_4-1] + G[i_4] * G[i_4] - G[i_4] - B[i_4-4] + B[i_4-1] - 3;
    }
#pragma endscop
...
kernel_4236252325_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
