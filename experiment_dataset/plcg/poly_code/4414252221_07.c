...
void kernel_4414252221_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,int wb,DATA_TYPE POLYBENCH_5D(B,xB,yB,zB,vB,wB,xb,yb,zb,vb,wb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        A[i_0] = E[i_0+2] * F[i_0+2] - E[i_0-2] - 3;
        for (int i_1 = i_0; i_1 < PB_P-2; i_1++) {
            for (int i_2 = 2; i_2 < min(-i_1+PB_L, PB_M-2); i_2++) {
                for (int i_3 = 2; i_3 < min(PB_M-2, -i_1+PB_Q); i_3++) {
                    B[i_0-1][i_3][i_1][i_1-2][i_2] = G[i_0][i_2-1][i_3-2][i_3+i_1] - G[i_3+i_2][i_0][i_0][i_1+1] - H[i_2+2][i_0-2][i_3][i_2-2] * H[i_2+2][i_3+1][i_1][i_0] * I[i_2][i_3][i_1] * H[i_2+1][i_1][i_0][i_0+1] * J[i_3][i_1-2][i_2+i_1] + I[i_3][i_2-2][i_1] + B[i_3-1][i_0][i_1+2][i_1][i_2] - B[i_0-1][i_3][i_2+1][i_2-1][i_1] + B[i_0-1][i_3+1][i_1][i_1-2][i_2-2] + B[i_0-1][i_3+2][i_1][i_1-2][i_2+2] * 3;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M; i_4++) {
        for (int i_5 = 0; i_5 < PB_N-2; i_5++) {
            for (int i_6 = 1; i_6 < i_5; i_6++) {
                C[i_6][i_5][i_4] = J[i_5+2][i_6][i_4] * I[i_6-1][i_4+1][i_4-1] - K[i_6-1][i_5] + C[i_6+1][i_5][i_4] * 3;
            }
        }
        for (int i_7 = i_4; i_7 < PB_P-1; i_7++) {
            for (int i_8 = 2; i_8 < -i_4+PB_M; i_8++) {
                D[i_4-1][i_7][i_8+1] = I[i_4][i_8][i_7] - I[i_8+i_4][i_8-1][0] - I[i_8][i_7][i_4] - D[i_4-1][i_8-2][i_7+1] * 5;
            }
        }
    }
#pragma endscop
