        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = max(2, i_0); i_2 < -i_1+PB_M; i_2++) {
                for (int i_3 = 0; i_3 < PB_Q-1; i_3++) {
                    A[i_2+i_1][i_2-2][i_0][i_3+1] = A[i_2+i_1-1][i_2-2][i_0][i_3+1] * A[i_2+i_1][i_2-2][i_0-1][i_3] - 6;
                }
            }
        }
        B[i_0] = 3;
        for (int i_4 = 1; i_4 < i_0; i_4++) {
            for (int i_5 = 0; i_5 < i_0; i_5++) {
                for (int i_6 = 0; i_6 < PB_M; i_6++) {
                    C[i_0][i_4][i_6][0] = C[i_4][i_5+2][i_6][0] + C[i_0+2][i_6][i_4-1][0] + 3;
                }
            }
        }
    }
        ...
        for (int i_8 = max(1, i_7); i_8 < PB_Q; i_8++) {
            for (int i_9 = 0; i_9 < min(PB_P-1, i_7); i_9++) {
                for (int j_0 = 0; j_0 < PB_P; j_0++) {
                    D[i_8][i_7][i_9+1][j_0] = E[j_0][i_8-1][j_0][i_8] - 4;
                }
            }
        }
    }
...
kernel_4426112123_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
