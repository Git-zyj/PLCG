...
void kernel_3214311223_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
    ...
    for (int i_2 = 0; i_2 < PB_L; i_2++) {
        for (int i_3 = 0; i_3 < PB_L-1; i_3++) {
            for (int i_4 = 2; i_4 < PB_L; i_4++) {
                A[i_3+1][i_4] = A[i_4][i_3] - A[i_4-2][i_3] + 1;
            }
        }
    }
#pragma endscop
...
kernel_3214311223_00(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
