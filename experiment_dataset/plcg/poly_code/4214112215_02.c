...
void kernel_4214112215_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < PB_N; i_1++) {
            for (int i_2 = max(2, i_1); i_2 < PB_P; i_2++) {
                for (int i_3 = 0; i_3 < min(PB_P, i_1); i_3++) {
                    A[i_1][i_0][i_2-2][i_2] = C[i_0][i_3][i_2+2][i_1] - 3;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_P-2; i_4++) {
        for (int i_5 = 3; i_5 < PB_M; i_5++) {
            for (int i_6 = max(i_4, 3); i_6 < PB_P-1; i_6++) {
                A[i_4][i_5][i_6-1][i_6+1] = D[i_6][i_4+2][i_5] - A[i_4][i_5-1][i_6-3][i_6-1] * A[i_4-1][i_6-1][i_5-3][i_5-1] + 3;
            }
        }
    }
#pragma endscop
...
kernel_4214112215_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
