...
void kernel_4326331225_08(int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 0; i_1 < PB_Q-2; i_1++) {
            for (int i_2 = i_1; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 2; i_3 < min(-i_1+PB_M, i_1); i_3++) {
                    C[i_2+1][i_0+1][i_3-2][i_1+2] = D[i_2][i_3][i_0][i_1] * E[i_3][i_0][i_3+i_1][i_2] + E[i_3][i_1][i_3][i_0] + 2;
                }
            }
        }
        for (int i_4 = 1; i_4 < min(-i_0+PB_L, i_0); i_4++) {
            for (int i_5 = 0; i_5 < PB_P-3; i_5++) {
                B[i_4-1][i_0-1][i_5+1] = F[i_0+1][i_4][i_5] + G[i_5+i_4][i_0-1] * B[i_4][i_0-3][i_5+3] - B[i_4-1][i_0-2][i_5+1] * 6;
            }
            for (int i_6 = 0; i_6 < PB_Q-2; i_6++) {
                for (int i_7 = 1; i_7 < PB_P-2; i_7++) {
                    C[i_4+1][i_0][i_7][i_6] = H[i_6][i_7+1][i_0][i_6][i_4+1] * E[i_7][i_6][i_4+i_0][i_0+1] + I[i_7-1][i_6+1][i_4+i_0][i_7+i_4] * F[i_6][i_4+1][0] + C[i_4+1][i_0][i_7+1][i_6] * C[i_4+1][i_0][i_7+2][i_6+2] - 3;
                }
            }
        }
    }
...
init_array(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4326331225_08(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I)));
