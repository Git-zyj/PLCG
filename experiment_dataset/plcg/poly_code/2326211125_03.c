...
void kernel_2326211125_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
kernel_2326211125_03(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
