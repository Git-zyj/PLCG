...
void kernel_4312352311_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        A[i_0] = D[i_0] + E[i_0] - A[i_0-1] + A[i_0+1] - 3;
        for (int i_1 = 1; i_1 < PB_L-2; i_1++) {
            C[i_1][i_0][i_0] = F[i_0][i_1] * F[i_1][i_0] - E[1] + G[i_0][i_1+1] + A[i_1-1] * A[i_1] + A[i_0+1] - 4;
            for (int i_2 = 2; i_2 < PB_N-2; i_2++) {
                C[i_0][i_2][i_2] = H[i_2-2][i_1][i_0] - I[i_2-1][i_2] * J[i_1][i_0][i_0] - J[i_2][i_1][i_1+2] - H[i_1][i_0+2][i_0] + K[i_1][i_0][i_2] + K[i_2+2][i_0-2][i_1] - C[i_0][i_2-1][i_2-1] - 6;
            }
        }
    }
#pragma endscop
...
kernel_4312352311_04(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
