        ...
        for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 1; i_2 < PB_M-2; i_2++) {
                for (int i_3 = 2; i_3 < PB_M-2; i_3++) {
                    A[i_1][i_0][i_2][i_3] = D[i_2+2][i_0][i_1] * E[i_1+2][i_3-2][i_3-2][i_0] - E[i_3][i_0][i_1][0] * A[i_3][i_0-1][i_1][i_2] + A[i_1+1][i_0][i_2-1][i_3] - A[i_1-2][i_0+1][i_2][i_3] * A[i_3+2][i_0+2][i_2][i_1+2] + 6;
                }
            }
        }
        for (int i_4 = 0; i_4 < PB_M-2; i_4++) {
            B[i_4][i_0+1] = F[i_4+2][i_0+1] * F[i_4][i_0+1] - B[i_4][i_0-1] - 2;
        }
    }
    for (int i_5 = 2; i_5 < PB_L-2; i_5++) {
        for (int i_6 = 2; i_6 < PB_L-2; i_6++) {
            C[i_5][i_6] = F[i_5-2][i_6] * G[i_6+2][0] * H[0] + F[i_6][i_5+2] * C[i_5][i_6-2] - C[i_6+1][i_5] + C[i_5+1][i_6-1] - 2;
        }
    }
#pragma endscop
...
kernel_4324232321_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
