...
void kernel_3326312213_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
    ...
    for (int i_2 = 1; i_2 < PB_M-2; i_2++) {
        ...
        for (int i_3 = i_2; i_3 < PB_L; i_3++) {
            for (int i_4 = 1; i_4 < PB_P-2; i_4++) {
                C[i_3][i_2][i_4+2] = F[i_4-1][i_2+2][0] + A[i_2] + 4;
            }
        }
    }
#pragma endscop
...
kernel_3326312213_03(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
