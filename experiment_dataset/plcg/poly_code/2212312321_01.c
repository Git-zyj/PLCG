...
void kernel_2212312321_01(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-2; i_0++) {
        B[i_0+2] = B[i_0+1] - B[i_0] - 2;
...
kernel_2212312321_01(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
