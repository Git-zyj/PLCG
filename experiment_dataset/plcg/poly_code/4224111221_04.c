...
void kernel_4224111221_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 2; i_3 < PB_L; i_3++) {
                    A[i_1-1][i_2+1][i_3] = A[i_2-1][i_1][i_3-2] + 2;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_L-3; i_4++) {
        for (int i_5 = 0; i_5 < -i_4+PB_L-2; i_5++) {
            for (int i_6 = 0; i_6 < min(i_5, -i_4+PB_L-3); i_6++) {
                for (int i_7 = i_4; i_7 < PB_Q-1; i_7++) {
                    B[i_6+i_4+1][i_5][i_5][i_7+1] = C[i_6+i_5+1][i_7+i_6][i_4+1][0] * B[i_5+i_4+2][i_7][i_7][i_6+3] - B[i_6+i_4+3][i_5][i_5][i_7+1] + 1;
                }
            }
        }
    }
...
kernel_4224111221_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
