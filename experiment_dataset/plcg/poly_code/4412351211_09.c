...
void kernel_4412351211_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl)){
        ...
        for (int i_1 = 1; i_1 < PB_P; i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_M-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_P; i_3++) {
                    A[i_3+i_2-1][i_0][i_3][i_1-1] = E[i_2][i_3-1][i_1][i_0] - E[i_0][i_3-1][i_3][i_1] - E[i_2][i_3][i_1][i_2] + F[i_3][i_1+1][i_2] - G[i_3][i_2+1][i_1] - H[i_2][i_0+1][i_3][i_2] - A[i_3+i_2][i_0][i_3+1][i_1-1] - B[i_2-1][i_1][i_2-1] * 5;
                }
                B[i_0][i_1][i_0] = I[i_2][i_1] - F[i_1][i_2][i_1-1] * F[i_2+i_0+1][i_1+1][i_1] + G[i_2][i_1+1][i_0] - 6;
            }
        }
        for (int i_4 = 1; i_4 < -i_0+PB_P; i_4++) {
            for (int i_5 = 1; i_5 < -i_0+PB_M+2; i_5++) {
                for (int i_6 = 0; i_6 < min(PB_P, -i_5+PB_L); i_6++) {
                    A[i_5+i_0-2][i_6][i_5-1][i_4-1] = F[i_6+i_5-1][i_4+i_0-1][i_6+i_5] * E[i_6][i_4+i_0][i_5][i_0] + 3;
                }
            }
            D[i_4] = J[i_0] - K[i_0] + L[i_0+1][0] - I[i_4+i_0][i_4] + L[i_0][i_4] * B[i_0-1][i_4-1][i_0-1] + D[i_4+1] + D[i_4-1] + D[i_4-1] + 1;
        }
    }
#pragma endscop
...
kernel_4412351211_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L));
