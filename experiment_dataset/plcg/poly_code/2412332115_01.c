...
void kernel_2412332115_01(int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-2; i_0++) {
        D[i_0+1] = E[0] + E[i_0] + F[i_0] + B[i_0-1] - 6;
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            B[i_0-1] = G[i_1][i_0+2] + H[i_1][i_0] - I[i_1+1][i_0] + 5;
        }
        D[i_0] = F[i_0+1] + E[i_0+2] + 5;
        D[i_0+1] = J[0] + H[i_0][2] - 2;
    }
#pragma endscop
...
kernel_2412332115_01(xd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
