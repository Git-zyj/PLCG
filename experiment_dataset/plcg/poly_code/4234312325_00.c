...
void kernel_4234312325_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            for (int i_2 = 3; i_2 < PB_L; i_2++) {
                for (int i_3 = 2; i_3 < i_1; i_3++) {
                    A[i_3-2][i_1-1][i_2] = C[i_3][i_0][0] + A[i_2-3][i_1-1][i_3] + 4;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_L; i_4++) {
        for (int i_5 = max(i_4, 1); i_5 < PB_L; i_5++) {
            for (int i_6 = 2; i_6 < PB_L; i_6++) {
                B[i_5][i_6] = B[i_6-1][i_5] * B[i_5][i_6-2] * B[i_5-1][i_6] + B[i_5-1][i_6-1] * 6;
            }
        }
    }
#pragma endscop
...
kernel_4234312325_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
