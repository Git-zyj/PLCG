...
void kernel_2214211313_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 0; i_1 < PB_M-1; i_1++) {
            B[i_0] = B[i_1+1] + B[i_1] * 1;
        }
...
kernel_2214211313_09(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
