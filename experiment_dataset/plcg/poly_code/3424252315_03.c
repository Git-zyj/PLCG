...
void kernel_3424252315_03(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        B[i_0+2][i_0] = E[i_0-2] + E[i_0] - F[i_0] - F[i_0-1] - B[i_0+2][i_0] * 6;
        for (int i_1 = i_0; i_1 < min(-i_0+PB_M, PB_N); i_1++) {
            B[i_0+2][i_0] = G[i_1+i_0][i_1+i_0+2] * H[i_1][i_0][i_0] + G[i_1-1][i_0-2] - 5;
            B[i_0+1][i_0-1] = E[i_0] + I[i_1][i_0] - I[i_1][i_0] + G[i_0][i_1+i_0] - B[i_0+2][i_0] * 6;
        }
    }
    for (int i_2 = 1; i_2 < PB_M-3; i_2++) {
        B[i_2+3][i_2+1] = E[i_2] + F[i_2+1] + E[i_2] - E[i_2-1] * E[i_2] - F[i_2+1] - F[i_2] * F[i_2] - B[i_2+1][i_2-1] - 3;
    }
#pragma endscop
...
init_array(xb,yb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_3424252315_03(xb,yb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xb,yb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I)));
