        ...
        for (int i_6 = 1; i_6 < i_5; i_6++) {
            for (int i_7 = 1; i_7 < PB_L; i_7++) {
                for (int i_8 = 0; i_8 < PB_M-1; i_8++) {
                    B[i_5+1][i_6][i_5+1] = I[i_8][i_5+1][i_7][0] - I[i_8+1][i_8+1][i_5][i_6-1] - G[i_7-1][i_5][i_6-1][i_8] + 1;
                }
            }
        }
    }
...
kernel_4322231123_01(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
