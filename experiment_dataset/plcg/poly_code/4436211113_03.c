...
void kernel_4436211113_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve)){
        ...
        for (int i_4 = 0; i_4 < PB_M; i_4++) {
            for (int i_5 = 0; i_5 < -i_3+PB_Q+1; i_5++) {
                for (int i_6 = 0; i_6 < min(i_4, PB_L); i_6++) {
                    C[i_4][i_6][i_3-2][i_5+i_3-1] = 5;
                }
            }
        }
        for (int i_7 = 1; i_7 < PB_L; i_7++) {
            for (int i_8 = 0; i_8 < min(-i_3+PB_M+1, PB_L); i_8++) {
                for (int i_9 = 0; i_9 < min(-i_3+PB_Q, -i_7+PB_Q); i_9++) {
                    C[i_7][i_8][i_3-1][i_9+i_3] = E[i_8+i_3-1][0][i_9+i_7][i_7] - C[i_7-1][i_8][i_3-1][i_9+i_3] - 1;
                }
            }
        }
    }
...
kernel_4436211113_03(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
