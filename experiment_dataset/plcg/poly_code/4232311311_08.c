...
void kernel_4232311311_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
    ...
    for (int i_3 = 0; i_3 < PB_Q-1; i_3++) {
        for (int i_4 = 0; i_4 < min(-i_3+PB_Q-1, PB_M-2); i_4++) {
            for (int i_5 = 1; i_5 < -i_3+PB_Q-1; i_5++) {
                for (int i_6 = i_5; i_6 < min(-i_5+PB_Q, -i_3+PB_Q); i_6++) {
                    B[i_4+1][i_6+1][i_5+i_3][i_6+i_3] = C[i_5+i_3][i_6+i_4+1][i_6+i_5][i_4] * A[i_4][i_5-1][i_6] - B[i_5][i_6+1][i_4+i_3+1][i_6+i_4] - B[i_4][i_3+1][i_6+i_5][i_6+i_3] * B[i_4+1][i_6+1][i_5+i_3+1][i_6+i_3] * B[i_4+2][i_6+1][i_5+i_3][i_6+i_3] * 4;
                }
            }
        }
    }
...
kernel_4232311311_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
