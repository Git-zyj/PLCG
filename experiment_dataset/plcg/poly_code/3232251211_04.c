    ...
    for (int i_3 = 1; i_3 < PB_P; i_3++) {
        for (int i_4 = 0; i_4 < PB_P; i_4++) {
            for (int i_5 = 0; i_5 < min(-i_3+PB_M+1, PB_M-1); i_5++) {
                B[i_5][i_4+1][0] = D[i_5+1][i_5][i_4] - C[i_5+i_3-1][i_3+1][i_4] * D[i_5][i_4][i_3] * B[i_5][i_4+2][0] + 1;
            }
        }
    }
#pragma endscop
...
kernel_3232251211_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
