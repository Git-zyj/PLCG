...
void kernel_3326311211_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P; i_0++) {
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < min(i_0, -i_1+PB_M+1); i_2++) {
                A[i_2][i_1-1][0] = D[i_2+i_1-1][i_0-1][i_0] + A[i_2+1][i_1-1][0] + A[i_2+1][i_1-2][0] - 4;
            }
        }
    }
    ...
    for (int i_6 = 0; i_6 < PB_P-2; i_6++) {
        for (int i_7 = max(i_6, 1); i_7 < PB_L; i_7++) {
            for (int i_8 = 0; i_8 < PB_L-1; i_8++) {
                C[i_8][i_7][i_6+1] = C[i_7][i_8+1][i_6+1] - C[i_8][i_7-1][i_6+1] + C[i_7][i_8][i_6+2] * 2;
            }
        }
    }
#pragma endscop
...
kernel_3326311211_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
