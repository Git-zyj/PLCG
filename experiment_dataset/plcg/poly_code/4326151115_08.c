...
void kernel_4326151115_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg)){
        ...
        for (int i_1 = 1; i_1 < min(i_0, -i_0+PB_N); i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_L; i_2++) {
                for (int i_3 = 0; i_3 < -i_1+PB_M-1; i_3++) {
                    A[i_3+i_1+1][i_2+i_0][i_3][i_0] = D[i_2][i_1+1][i_3][i_2+i_0] - D[i_3][i_2][i_1][i_0-1] + D[i_1][i_1-1][i_3+1][i_2] - D[i_3+1][i_0][i_2+1][i_2+1] * E[i_3][i_1][i_2] + 3;
                }
            }
            B[i_1+i_0] = F[i_0+1][i_0] * F[i_1][i_0+1] - F[i_0+1][i_0+1] * G[i_1-1] - B[i_1+i_0] * B[i_1+i_0-1] - 2;
        }
    }
        ...
        for (int i_5 = 0; i_5 < PB_M-2; i_5++) {
            for (int i_6 = 1; i_6 < min(i_5, -i_4+PB_L); i_6++) {
                for (int i_7 = 0; i_7 < -i_5+PB_M-2; i_7++) {
                    A[i_7+i_5+2][i_6+i_4][i_5][i_6] = D[i_7][i_6-1][i_5][i_4+1] * D[i_4][i_6][i_7][i_5] - D[i_5][i_6-1][i_4][i_4] - D[i_4][i_7][i_5][i_6-1] - 2;
                }
            }
        }
    }
...
kernel_4326151115_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
