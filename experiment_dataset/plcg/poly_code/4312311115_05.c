...
void kernel_4312311115_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf)){
...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < PB_M; i_1++) {
            for (int i_2 = 1; i_2 < PB_L; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_0+PB_M, i_1); i_3++) {
                    A[i_0][i_0+1][i_2][i_3-1] = D[i_3][i_0][i_2+1][i_0-1] + E[0][i_3+i_0][i_2] * A[i_0-1][i_0][i_2-1][i_3-1] - 1;
                }
            }
        }
    ...
    for (int i_7 = 0; i_7 < PB_L-1; i_7++) {
        for (int i_8 = 1; i_8 < PB_L; i_8++) {
            C[i_8][i_7][i_8] = F[i_8][i_7] * C[i_8-1][i_7+1][i_8-1] - 6;
        }
    }
#pragma endscop
...
kernel_4312311115_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
