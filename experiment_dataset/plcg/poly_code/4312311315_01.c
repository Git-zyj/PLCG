...
void kernel_4312311315_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf)){
        ...
        for (int i_2 = 1; i_2 < PB_N-1; i_2++) {
            for (int i_3 = i_1; i_3 < min(-i_1+PB_M, PB_N-1); i_3++) {
                for (int i_4 = 0; i_4 < PB_N; i_4++) {
                    C[i_2+1][i_1][i_3][i_4] = E[i_4][i_3+i_1][i_2-1][0] - F[i_4][i_2][i_1][i_3] - C[i_3+1][i_1+1][i_4][i_2] - C[i_1+2][i_4][i_3][i_2-1] - 3;
                }
            }
        }
    }
...
kernel_4312311315_01(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
