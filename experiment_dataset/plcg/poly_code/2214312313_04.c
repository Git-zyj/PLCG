...
void kernel_2214312313_04(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        B[i_0] = C[i_0] * B[i_0] - B[i_0+1] + B[i_0-1] - 5;
...
kernel_2214312313_04(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
