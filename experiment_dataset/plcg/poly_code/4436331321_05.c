    ...
    for (int i_0 = 0; i_0 < PB_N-2; i_0++) {
        ...
        for (int i_1 = max(2, i_0); i_1 < PB_Q-1; i_1++) {
            for (int i_2 = 2; i_2 < PB_Q; i_2++) {
                B[i_0][i_2][i_2] = G[i_2][i_1] * H[i_1][i_2][i_0] + G[i_2][i_1] + C[i_2][i_0][i_1-1][i_1] * 4;
                C[i_1][i_0][i_2-1][i_2] = I[i_1-1][i_2][i_0] - I[i_1+1][i_2-1][i_0+1] + B[i_2-2][i_1][i_1] + B[i_0+2][i_2-1][i_2-1] + B[i_1][i_2][i_2] + B[i_0][i_2][i_2] + 3;
            }
            for (int i_3 = 2; i_3 < min(PB_Q-1, -i_0+PB_L); i_3++) {
                for (int i_4 = 2; i_4 < min(-i_0+PB_L, -i_1+PB_L); i_4++) {
                    D[i_3][i_3][i_4+i_1][i_1+1] = J[i_4][i_1][i_0][i_3] * J[i_3-1][i_0][i_4][i_1] * K[i_0+1][i_3][i_1][i_4-1] + L[i_1][i_3][i_4][i_0+1] * D[i_3-2][i_3-2][i_4+i_1][i_1+1] + D[i_3-2][i_3-2][i_4+i_0][i_0+1] - D[i_3-1][i_3-1][i_4+i_1-2][i_1-1] + D[i_4-2][i_4-2][i_3+i_0][i_3+1] + 3;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,vl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4436331321_05(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,vl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,zl,vl,POLYBENCH_ARRAY(L)));
