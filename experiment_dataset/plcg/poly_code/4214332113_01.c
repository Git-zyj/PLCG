        ...
        for (int i_1 = 2; i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = i_1; i_2 < PB_P-2; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_M; i_3++) {
                    A[i_3+i_0][i_1][i_2+2][i_1-2] = C[i_1+i_0][i_2][i_3][2] * D[i_2][i_3][i_3+i_1][i_0-1] * A[i_3+i_0-1][i_1][i_2+2][i_1-2] - 6;
                }
            }
        }
        B[i_0] = E[i_0-2] + F[i_0] * E[i_0] - E[i_0] - B[i_0+1] + 4;
    }
#pragma endscop
...
kernel_4214332113_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F));
