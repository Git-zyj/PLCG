...
void kernel_4412252315_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 0; i_1 < PB_M-3; i_1++) {
            A[i_1+2] = E[i_0+1] - F[i_0][i_1] + A[i_1+3] - A[i_1+1] * 6;
        }
    }
        ...
        for (int i_3 = i_2; i_3 < PB_M; i_3++) {
            for (int i_4 = 2; i_4 < PB_M; i_4++) {
                for (int i_5 = 1; i_5 < -i_3+PB_Q; i_5++) {
                    B[i_5][i_3][i_2+1][i_2] = G[i_3][i_4+1][i_2][i_5-1] + H[i_3-2][i_2][i_5+i_3][i_4-2] * H[i_2][i_3][i_4][i_5] + G[i_4][i_2][i_3][i_5] - I[i_3][i_5-1][i_4] + B[i_5][i_3][i_2+2][i_2+1] + B[i_5+1][i_3][i_2+1][i_2] * 4;
                }
            }
        }
        for (int i_6 = 1; i_6 < min(-i_2+PB_P-1, i_2); i_6++) {
            for (int i_7 = 1; i_7 < PB_N-2; i_7++) {
                C[i_2+1][i_6][i_7] = J[i_2][i_7+2][i_6+i_2+1] - I[i_7+2][i_6][i_2] * I[i_7+2][i_2][i_6] + K[i_7+i_6][i_7] - I[i_7][i_6-1][2] - K[i_7][i_7] * C[i_6][i_7-1][i_2] * C[i_2+1][i_6-1][i_7] + C[i_2+1][i_6][i_7-1] - 4;
            }
        }
        A[i_2+2] = E[i_2-1] + L[i_2] - K[i_2-2][i_2+2] - L[i_2] - L[i_2] * L[i_2+2] + L[i_2] + A[i_2+3] * A[i_2+2] * 3;
    }
#pragma endscop
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4412252315_09(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L)));
