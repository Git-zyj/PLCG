...
void kernel_4426352215_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M-2; i_0++) {
        A[i_0-2] = E[i_0] * E[i_0-2] + E[i_0] + F[i_0+2] + E[i_0+2] + A[i_0-3] + A[i_0-1] + 2;
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_M; i_2++) {
                for (int i_3 = i_0; i_3 < PB_Q-2; i_3++) {
                    C[i_3][i_2+i_1][i_0][i_2] = G[i_0][i_2][i_1][i_3] * H[i_1][i_0-2][i_3-1][i_2+i_1] + H[i_1-2][i_3-1][i_3+2][i_2] + 2;
                }
            }
        }
        for (int i_4 = i_0; i_4 < PB_M-1; i_4++) {
            for (int i_5 = i_0; i_5 < -i_4+PB_M-1; i_5++) {
                for (int i_6 = 1; i_6 < -i_0+PB_M-2; i_6++) {
                    C[i_6][i_5+i_4][i_0][i_4] = H[i_6][i_0][i_5+2][i_4-1] + H[i_6+i_0+2][i_0][i_4][i_5-1] + I[i_4-1][i_0-1][i_0][i_5+i_4] - C[i_6-1][i_5+i_4+1][i_0][i_4+1] + 1;
                }
            }
        }
    }
    for (int i_7 = 1; i_7 < PB_M; i_7++) {
        for (int i_8 = 2; i_8 < i_7; i_8++) {
            for (int i_9 = 2; i_9 < i_7; i_9++) {
                for (int j_0 = max(i_9, 2); j_0 < -i_8+PB_M; j_0++) {
                    C[i_9][j_0+i_8][i_7][j_0] = J[j_0-2][i_9][i_7] + G[j_0][j_0][i_8][i_9] * H[i_9-2][j_0-1][i_8-2][i_7] + H[j_0][i_9][i_7-1][i_8-1] * K[i_8][j_0-2][i_9+1] * J[i_7][i_9][j_0+i_8] + 6;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4426352215_00(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K)));
