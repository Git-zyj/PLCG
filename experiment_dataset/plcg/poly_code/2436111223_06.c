...
void kernel_2436111223_06(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-2; i_0++) {
        C[i_0] = E[0] + 4;
        for (int i_1 = 1; i_1 < PB_L-2; i_1++) {
            B[i_0][i_1] = B[i_0+1][i_1-1] - B[i_0+2][i_1] + B[i_0+1][i_1+2] - B[i_0][i_1-1] - 1;
        }
    }
...
kernel_2436111223_06(xc,POLYBENCH_ARRAY(C), xb,yb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E));
