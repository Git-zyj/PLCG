...
void kernel_3316212313_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        ...
        for (int i_3 = 1; i_3 < PB_M+1; i_3++) {
            C[i_0][i_3+1] = C[i_3-1][i_0+1] + C[i_0][i_3+2] * 4;
        }
    }
#pragma endscop
...
kernel_3316212313_05(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
