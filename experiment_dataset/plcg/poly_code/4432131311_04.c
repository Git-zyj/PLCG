        ...
        for (int i_4 = 0; i_4 < PB_P; i_4++) {
            for (int i_5 = 0; i_5 < PB_L-1; i_5++) {
                for (int i_6 = 0; i_6 < PB_M; i_6++) {
                    D[i_3][i_6][i_5+1][i_4] = G[i_6][i_5+1][i_4] * 1;
                }
            }
        }
    }
...
kernel_4432131311_04(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
