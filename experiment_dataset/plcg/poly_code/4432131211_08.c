...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_Q; i_1++) {
        for (int i_2 = 1; i_2 < PB_L-1; i_2++) {
            B[i_2] = F[i_2+1][i_1] * B[i_1-1] - B[i_2-1] - 2;
        }
    }
        ...
        for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
            for (int i_5 = 1; i_5 < min(-i_3+PB_M, PB_P); i_5++) {
                for (int i_6 = 0; i_6 < PB_L; i_6++) {
                    D[i_5][i_4][i_5] = G[i_5][i_4+1][i_6] + H[i_4-1][i_5][i_6][i_5] - H[i_4][i_6+1][i_4][i_5-1] + H[i_5+i_3][i_4][i_6][1] - 1;
                }
            }
        }
        for (int i_7 = 0; i_7 < i_3; i_7++) {
            for (int i_8 = 1; i_8 < PB_L-1; i_8++) {
                D[i_8][i_3][i_8] = H[i_8][i_7][i_3][1] + G[i_8][i_3][i_7] * G[i_7][i_8+1][i_3] + F[i_8][i_7+1] - F[i_8][1] * D[i_7][i_8-1][i_7] + 5;
            }
        }
    }
#pragma endscop
...
kernel_4432131211_08(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
