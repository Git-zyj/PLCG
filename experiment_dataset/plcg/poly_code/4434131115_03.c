...
void kernel_4434131115_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
        ...
        for (int i_1 = 0; i_1 < PB_Q; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_Q; i_2++) {
                for (int i_3 = 1; i_3 < PB_L; i_3++) {
                    A[i_3][i_0+1][i_2+i_1][i_2] = E[i_2][i_0][i_1][i_3+1] - F[i_2][i_2-1][0] + E[i_2][i_0][i_3-1][i_1] + 1;
                }
            }
        }
        for (int i_4 = 1; i_4 < -i_0+PB_L; i_4++) {
            B[i_0][i_4] = G[i_4-1][i_4+i_0] * G[i_0][i_4] + G[i_0-1][i_4-1] + G[i_4+i_0][0] * G[i_4][i_0] + 2;
            B[i_4][i_0] = G[i_0][i_4] * B[i_0][i_4] + B[i_4][i_0] + 4;
        }
    }
        ...
        for (int i_6 = i_5; i_6 < PB_L-1; i_6++) {
            for (int i_7 = 0; i_7 < PB_L; i_7++) {
                for (int i_8 = 0; i_8 < -i_6+PB_Q-1; i_8++) {
                    A[i_7][i_5+1][i_8+i_6+1][i_8] = F[i_7][i_6+1][i_8] - 1;
                }
            }
        }
    }
...
kernel_4434131115_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
