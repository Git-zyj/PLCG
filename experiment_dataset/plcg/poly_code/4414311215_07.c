    ...
    for (int i_0 = 0; i_0 < PB_P; i_0++) {
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < i_1; i_2++) {
                B[i_0][i_2] = F[i_1][i_2][i_0] * B[i_2][i_1-1] - 4;
            }
        }
    }
    for (int i_3 = 0; i_3 < PB_N; i_3++) {
        for (int i_4 = 0; i_4 < PB_N; i_4++) {
            B[i_3][i_4] = G[i_3][i_4] - D[i_4] - D[i_4+1] + 5;
        }
        D[i_3] = G[i_3][i_3] + 1;
    }
#pragma endscop
...
kernel_4414311215_07(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
