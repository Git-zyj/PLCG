...
void kernel_4322212313_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 2; i_1 < PB_P-1; i_1++) {
            for (int i_2 = 2; i_2 < PB_M-2; i_2++) {
                for (int i_3 = 3; i_3 < PB_M-1; i_3++) {
                    A[i_2+1][i_3-2][i_1] = A[i_2+2][i_3-3][i_1] - A[i_3][i_1-2][i_2+1] + A[i_3+1][i_2-2][i_1+1] + 6;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 0; i_5 < -i_4+PB_P+2; i_5++) {
            for (int i_6 = 0; i_6 < -i_4+PB_M-1; i_6++) {
                B[i_6+i_4][i_4][i_5] = B[i_6+i_4+1][i_4][i_5] + B[i_6+i_4+1][i_4+1][i_5] * 5;
            }
            for (int i_7 = max(2, i_5); i_7 < PB_L; i_7++) {
                C[i_5][i_4+1][i_7] = D[i_7-2][i_4][i_5+i_4-2] - C[i_5][i_4+1][i_7-1] - C[i_7-1][i_4+1][i_5] + C[i_5][i_4+2][i_7] - 2;
            }
        }
    }
#pragma endscop
...
kernel_4322212313_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
