...
void kernel_4214211313_07(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
        ...
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < PB_L; i_2++) {
                for (int i_3 = 0; i_3 < PB_L-1; i_3++) {
                    A[i_3][i_1][0] = A[i_1][i_0+1][0] + A[i_0][i_3+1][0] * 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_Q-1; i_4++) {
        for (int i_5 = 1; i_5 < PB_P-2; i_5++) {
            for (int i_6 = 3; i_6 < -i_4+PB_Q; i_6++) {
                for (int i_7 = i_5; i_7 < min(min(-i_5+PB_Q+1, -i_4+PB_Q-1), -i_6+PB_Q); i_7++) {
                    B[i_4+1][i_5+1][i_6+i_4][i_7+i_6-1] = C[i_7+i_6][i_5+1][i_4][i_6] * B[i_4+1][i_6][i_7+i_4][i_7+i_5-1] + B[i_4+1][i_5+2][i_6+i_4][i_7+i_6] + B[i_4+1][i_5+1][i_7+i_4+1][i_7+i_6] - B[i_4+1][i_5][i_6+i_4-1][i_7+i_6-3] + 1;
                }
            }
        }
    }
...
kernel_4214211313_07(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
