...
void kernel_4214332125_02(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        for (int i_1 = 2; i_1 < PB_L; i_1++) {
            for (int i_2 = 2; i_2 < min(min(-i_1+PB_M, i_0), -i_0+PB_P); i_2++) {
                for (int i_3 = max(2, i_0); i_3 < PB_P; i_3++) {
                    B[i_1-1][i_1][i_2][i_3] = C[i_2][i_0][i_3][i_1-2] * C[i_2+i_1][i_0][i_1][i_3+1] - D[i_1][i_3-2][i_2+i_0][i_0] * C[i_0][i_2-2][i_1][i_3] - 2;
                }
                B[i_0-1][i_0][i_2][i_1] = E[i_1][i_0-1][i_0] - E[i_0][i_2][0] + B[i_0-1][i_0][i_2+1][i_1-1] + 3;
            }
        }
    }
#pragma endscop
...
kernel_4214332125_02(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
