...
void kernel_3226311225_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        ...
        for (int i_2 = i_0; i_2 < min(-i_0+PB_M, PB_L); i_2++) {
            B[i_2] = C[i_2+i_0][0] - B[i_2+2] + B[i_2+1] * 3;
        }
    }
#pragma endscop
...
kernel_3226311225_00(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
