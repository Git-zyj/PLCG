    ...
    for (int i_3 = 1; i_3 < PB_Q-1; i_3++) {
        for (int i_4 = i_3; i_4 < PB_M-1; i_4++) {
            for (int i_5 = 1; i_5 < min(-i_4+PB_P, PB_M-1); i_5++) {
                B[i_5-1][i_4+1][i_5-1] = C[i_5+1][i_3][i_4-1] + E[i_5][i_3][i_4] - C[i_4+1][i_3-1][i_5-1] * E[i_4][i_3][i_5+i_4] * A[i_4][i_5][i_3+1] - 1;
            }
        }
    }
#pragma endscop
...
kernel_3224231125_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
