...
void kernel_4324332325_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg)){
        ...
        for (int i_1 = 3; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 3; i_2 < PB_M; i_2++) {
                for (int i_3 = 0; i_3 < min(PB_M-2, -i_1+PB_Q); i_3++) {
                    A[i_0][i_3+2][i_2-1][i_1] = D[i_1][i_3][i_0][i_2+2] + D[i_3][i_0+1][i_1-1][i_2] + E[i_1-2][i_2][i_0][i_3+1] - E[i_3+2][i_1+2][i_0-2][i_2+1] + A[i_0][i_3+2][i_2-3][i_1] * A[i_2][i_0+2][i_1-3][i_3] - C[i_2][i_0-3][i_1][i_3+i_1] * 3;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M; i_4++) {
        B[i_4] = F[i_4] * G[i_4-1] * B[i_4-1] - B[i_4-2] * 2;
        for (int i_5 = i_4; i_5 < PB_P; i_5++) {
            for (int i_6 = 0; i_6 < PB_Q-3; i_6++) {
                for (int i_7 = 0; i_7 < -i_6+PB_Q-3; i_7++) {
                    C[i_4][i_5-1][i_7][i_7+i_6] = E[i_7][i_4][i_5][i_6+2] + C[i_4-1][i_5-1][i_7+1][i_7+i_6+3] * C[i_4][i_5][i_7][i_7+i_6] + 1;
                }
            }
        }
    }
...
kernel_4324332325_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
