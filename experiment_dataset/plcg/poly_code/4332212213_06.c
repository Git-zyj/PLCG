...
void kernel_4332212213_06(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
...
#pragma scop
        ...
        for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
            for (int i_6 = 1; i_6 < PB_N-1; i_6++) {
                for (int i_7 = 3; i_7 < PB_Q+2; i_7++) {
                    B[i_6][i_5][i_4][i_7-2] = B[i_6-1][i_5][i_4][i_7-3] * B[i_6][i_5][i_4-1][i_7-2] + B[i_6+1][i_5+1][i_4+1][i_7-2] * 5;
                }
            }
        }
    }
    for (int i_8 = 2; i_8 < PB_L; i_8++) {
        for (int i_9 = 2; i_9 < PB_P; i_9++) {
            for (int j_0 = 0; j_0 < min(-i_9+PB_L, -i_8+PB_L+1); j_0++) {
                C[i_8-2][j_0+i_9][i_8] = D[j_0+i_9][i_8][i_9] * C[i_9-2][j_0+i_8-1][i_9] - 4;
            }
        }
    }
#pragma endscop
...
kernel_4332212213_06(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
