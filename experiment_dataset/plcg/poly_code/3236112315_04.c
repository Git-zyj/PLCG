...
void kernel_3236112315_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        A[i_0] = A[i_0-1] * A[i_0+1] * 6;
        for (int i_1 = PB_M-1 - 1; i_1 >= i_0; i_1--) {
            A[i_1] = C[0] * C[i_1] - A[i_1+1] * 6;
        }
    }
#pragma endscop
...
kernel_3236112315_04(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
