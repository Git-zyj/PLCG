...
void kernel_2332152225_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N-2; i_0++) {
        B[i_0+2] = D[i_0] + D[i_0-2] + D[i_0] * D[i_0] + D[i_0] * D[i_0+2] - B[i_0+2] - 1;
        B[i_0+2] = D[i_0+2] - D[i_0-2] + D[i_0] + D[i_0] + D[i_0] + B[i_0] + 3;
    }
    for (int i_1 = 2; i_1 < PB_N-3; i_1++) {
        B[i_1+3] = D[i_1] - D[i_1-2] + D[i_1-1] - D[i_1+1] + 5;
    }
#pragma endscop
...
kernel_2332152225_06(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
