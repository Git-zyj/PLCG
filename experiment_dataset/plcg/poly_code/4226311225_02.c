...
void kernel_4226311225_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
        ...
        for (int i_1 = i_0; i_1 < PB_M; i_1++) {
            for (int i_2 = 1; i_2 < i_0; i_2++) {
                for (int i_3 = 0; i_3 < PB_L-2; i_3++) {
                    A[i_2-1][i_1][i_3] = A[i_2-1][i_1][i_3+2] * 4;
                }
            }
        }
        B[i_0] = C[i_0+1] + B[i_0+1] - B[i_0+2] * B[i_0-1] - 5;
    }
#pragma endscop
...
kernel_4226311225_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
