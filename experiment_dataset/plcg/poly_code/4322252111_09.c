...
void kernel_4322252111_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,int wg,DATA_TYPE POLYBENCH_5D(G,xG,yG,zG,vG,wG,xg,yg,zg,vg,wg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk)){
        ...
        for (int i_1 = 2; i_1 < PB_M; i_1++) {
            for (int i_2 = 0; i_2 < min(i_0, -i_1+PB_Q); i_2++) {
                for (int i_3 = 2; i_3 < -i_0+PB_Q; i_3++) {
                    A[0][i_1][i_2+i_1][i_3-2] = D[i_3][i_1][i_2] + E[i_3][i_2][i_1][i_2] * F[i_2][i_1][i_0-1] * G[i_3][i_2][i_1-2][0][i_0] + E[i_3][i_2][i_1][0] - H[i_2][i_3-1][i_1][i_3] + E[i_3][i_1][i_3+i_0][i_2] * E[i_3+i_2][i_0-2][i_1+1][i_2+i_1-2] * A[0][i_1+1][i_2+i_1][i_0-3] - 4;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M-3; i_4++) {
        B[i_4+2] = I[i_4] * I[i_4] - I[i_4] - B[i_4+3] - 2;
        for (int i_5 = 0; i_5 < PB_M; i_5++) {
            C[i_4][i_5] = J[i_4+2][0] + K[i_5] * C[i_4+1][i_5] - 4;
        }
    }
#pragma endscop
...
kernel_4322252111_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K));
