...
void kernel_4424232315_09(int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg)){
        ...
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < -i_1+PB_M+1; i_3++) {
                    D[i_3+i_1-1][i_2][i_0-1][i_1] = E[i_2+i_0+1][i_1][i_3][i_3+i_1][i_0] - 6;
                }
            }
            for (int i_4 = 1; i_4 < PB_L; i_4++) {
                B[i_0][i_4][2] = B[i_4-1][i_1][2] + B[i_0][i_1+1][2] + 4;
            }
        }
    }
    for (int i_5 = 1; i_5 < PB_M-1; i_5++) {
        C[i_5] = F[i_5] + F[i_5] + F[i_5-1] + F[i_5-1] - F[i_5] * C[i_5+1] + C[i_5-1] + C[i_5-1] - 4;
    }
        ...
        for (int i_7 = 2; i_7 < i_6; i_7++) {
            for (int i_8 = 1; i_8 < -i_7+PB_M+1; i_8++) {
                for (int i_9 = 1; i_9 < min(-i_8+PB_M, -i_7+PB_Q); i_9++) {
                    D[i_9+i_8-1][i_7-1][i_6][i_9] = G[i_8][i_9][i_6][i_7] * G[i_7][i_6-1][i_8][i_9+i_7] + G[i_9][i_6][i_7-2][i_8] + D[i_9+i_8][i_7-2][i_6][i_9] * D[i_8+i_7-2][i_9][i_6][i_7] + D[i_8+i_7-1][i_9-1][i_6-1][i_7] - 2;
                }
            }
        }
    }
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4424232315_09(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G)));
