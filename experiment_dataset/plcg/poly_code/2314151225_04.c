...
void kernel_2314151225_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-2; i_0++) {
        A[i_0] = D[i_0-1] - D[i_0-1] * D[i_0-1] * D[i_0] - D[i_0] * D[i_0] + D[i_0] + D[i_0] - A[i_0+1] + A[i_0+2] * 4;
    }
    for (int i_1 = 1; i_1 < PB_L+1; i_1++) {
        B[i_1-1] = D[1] - D[i_1-1] + D[i_1] - D[i_1] + D[i_1-1] * D[i_1] - D[i_1] * A[i_1] + 5;
...
kernel_2314151225_04(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
