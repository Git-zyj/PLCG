        ...
        for (int i_3 = i_2; i_3 < -i_2+PB_M; i_3++) {
            for (int i_4 = 2; i_4 < PB_P; i_4++) {
                for (int i_5 = 2; i_5 < PB_L; i_5++) {
                    C[i_2][i_3][i_4][i_5] = G[i_5-2][i_3-1][i_4-2] - H[i_3+i_2][i_5][i_3][i_4+1] + I[i_4][i_2-2][i_3][i_3-1] * C[i_2][i_4][i_5-1][i_3+1] - 2;
                }
            }
        }
    }
...
kernel_4314232123_09(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
