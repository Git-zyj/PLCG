...
void kernel_4332331323_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,int wg,DATA_TYPE POLYBENCH_5D(G,xG,yG,zG,vG,wG,xg,yg,zg,vg,wg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_L+1; i_1++) {
            for (int i_2 = 1; i_2 < min(min(PB_L-1, -i_1+PB_P), -i_0+PB_P); i_2++) {
                for (int i_3 = i_1; i_3 < PB_M-1; i_3++) {
                    A[i_0+1][i_2-1][i_0][i_3+i_1-1] = D[i_2+1][i_1+i_0-1][i_3][i_0-1] + E[i_0+1][i_3+1][i_2][i_2+i_1] - F[i_2][i_0-1][i_1][i_3] - G[i_3+1][i_2+i_0][i_1-1][i_0-1][0] * H[i_2][i_1][i_3] - A[i_0+2][i_2+1][i_0+1][i_3+i_1-1] + 5;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < -i_4+PB_L; i_5++) {
            for (int i_6 = 1; i_6 < -i_5+PB_P+1; i_6++) {
                for (int i_7 = 1; i_7 < -i_5+PB_M+1; i_7++) {
                    A[i_4+1][i_7-1][i_4][i_6+i_5-1] = I[i_6][i_7+i_5-1][i_5+i_4] * F[i_5][i_4-1][i_7][i_6-1] + 4;
                }
            }
        }
        for (int i_8 = 0; i_8 < PB_M-2; i_8++) {
            for (int i_9 = 0; i_9 < PB_M-1; i_9++) {
                C[i_4+1][i_8][i_9] = C[i_4+3][i_8][i_9] * C[i_4+2][i_8+2][i_9+1] + C[i_4+2][i_8][i_9] + C[i_4+1][i_9][i_8+1] - C[i_4][i_8+1][i_9] + 6;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4332331323_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
