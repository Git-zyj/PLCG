...
void kernel_4234212213_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N-1; i_0++) {
        for (int i_1 = 3; i_1 < -i_0+PB_P; i_1++) {
            for (int i_2 = 3; i_2 < -i_0+PB_N; i_2++) {
                for (int i_3 = 3; i_3 < min(-i_0+PB_N-1, -i_2+PB_N-2); i_3++) {
                    A[i_3+i_0+1][i_2-2][i_3-2][i_1+i_0] = A[i_3+i_2+2][i_1-3][i_3-1][i_2+i_0] + A[i_2+i_0][i_3-2][i_0-2][i_2+i_1-1] + A[i_3+i_0][i_2-3][i_3-3][i_1+i_0] + 1;
                }
            }
        }
    }
...
kernel_4234212213_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
