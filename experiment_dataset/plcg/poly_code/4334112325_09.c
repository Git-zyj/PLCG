...
void kernel_4334112325_09(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
        ...
        for (int i_1 = 0; i_1 < min(-i_0+PB_M, i_0); i_1++) {
            for (int i_2 = 0; i_2 < i_1; i_2++) {
                for (int i_3 = 0; i_3 < PB_Q; i_3++) {
                    A[i_1+i_0][i_3+i_2][i_3] = A[i_3+i_2][i_1+i_0-1][i_0] - A[i_3+i_1][i_2+i_0-2][i_0] + 1;
                }
            }
        }
    }
    for (int i_4 = 5; i_4 < PB_P-2; i_4++) {
        for (int i_5 = 1; i_5 < -i_4+PB_P-2; i_5++) {
            for (int i_6 = 0; i_6 < -i_4+PB_M-1; i_6++) {
                B[i_6+i_4-1][i_5][i_5+i_4] = D[i_5][i_4+1][i_6+1] + E[i_4+1][i_5] - B[i_6+i_4+1][i_5+2][i_5+i_4+2] + B[i_6+i_4-2][i_5][i_6+i_5-1] + B[i_6+i_4-5][i_5][i_5+i_4-2] * 1;
            }
        }
    }
    for (int i_7 = 0; i_7 < PB_M-2; i_7++) {
        for (int i_8 = i_7; i_8 < PB_L-1; i_8++) {
            for (int i_9 = 2; i_9 < i_7; i_9++) {
                C[i_7][i_8][i_9] = D[i_9][i_8][i_7] - C[i_7+2][i_8+1][i_9] * C[i_7+1][i_8+1][i_9] * C[i_9+2][i_8][i_7] - C[i_7][i_8][i_9-2] - 6;
            }
        }
    }
#pragma endscop
...
kernel_4334112325_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
