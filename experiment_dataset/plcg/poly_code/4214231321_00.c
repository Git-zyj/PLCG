...
void kernel_4214231321_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_M-2; i_1++) {
            for (int i_2 = 2; i_2 < -i_0+PB_Q; i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_L; i_3++) {
                    A[i_1+i_0+1][i_3+i_0-1][i_3][i_2] = C[i_1+1][i_2+1][i_0][i_3] + C[i_2][i_3][i_2-1][i_1] * D[i_1-1][i_3+i_0-1][i_2+1] * A[i_1+i_0+2][i_3+i_0][i_3][i_2] + A[i_2+i_1+1][i_3+i_2-2][i_3-1][i_0+1] + 1;
                }
                for (int i_4 = 0; i_4 < -i_0+PB_L+1; i_4++) {
                    A[i_1+i_0+1][i_4+i_0-1][i_4][i_2] = C[i_4][i_1][i_0-1][i_2+i_0] - C[i_4][i_0][i_1][i_2-1] + A[i_1+i_0][i_4+i_0-1][i_4][i_2-2] * 2;
                }
            }
        }
    }
...
kernel_4214231321_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
