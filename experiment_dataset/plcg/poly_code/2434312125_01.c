...
#pragma scop
    ...
    for (int i_1 = 3; i_1 < PB_Q; i_1++) {
        ...
        for (int i_2 = 1; i_2 < PB_Q-2; i_2++) {
            C[i_2-1][i_1][i_2+2] = G[i_2][2] - C[i_1-3][i_2+2][i_1] * 5;
        }
    }
...
kernel_2434312125_01(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
