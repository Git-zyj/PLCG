...
void kernel_3326211325_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_N; i_0++) {
        ...
        B[i_0] = D[i_0] + A[i_0] + A[i_0-2] + A[i_0-1] * A[i_0+1] - 2;
    }
...
kernel_3326211325_05(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
