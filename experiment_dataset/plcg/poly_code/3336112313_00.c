...
void kernel_3336112313_00(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 3; i_1 < PB_N+1; i_1++) {
        C[i_1-1] = D[i_1-2] - C[i_1-2] - C[i_1-3] + 2;
        C[i_1-2] = D[1] - D[i_1-2] - C[i_1-1] + 2;
    }
#pragma endscop
...
kernel_3336112313_00(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
