...
void kernel_3314212213_03(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        ...
        C[i_0-1] = C[i_0-1] + C[i_0] * 5;
    }
    for (int i_2 = 1; i_2 < PB_M; i_2++) {
        C[i_2-1] = D[i_2] - C[i_2] + 1;
    }
#pragma endscop
...
kernel_3314212213_03(xa,ya,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
