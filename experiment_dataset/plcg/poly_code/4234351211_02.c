        ...
        for (int i_1 = 1; i_1 < min(-i_0+PB_Q, PB_M-1); i_1++) {
            for (int i_2 = 1; i_2 < min(i_0, -i_0+PB_M+1); i_2++) {
                for (int i_3 = 0; i_3 < min(PB_M, -i_0+PB_P); i_3++) {
                    A[i_1][i_3][i_2+i_0][i_0] = C[i_2+i_0-1][i_1][i_3][i_2+1] - D[i_3][i_2-1][i_0][i_1+i_0] - C[i_2-1][i_0+1][i_1][i_3] + C[i_1+1][i_2-1][i_0-1][1] * E[i_2-1][i_3+i_0][i_1-1][i_2] + F[i_3][i_2][i_0] + A[i_1][i_3][i_2+i_0-1][i_0] + 1;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        B[i_4] = G[i_4-1] + G[i_4+1] - H[i_4+1] + H[i_4] * B[i_4+1] + B[i_4-1] - B[i_4+1] * 6;
    }
#pragma endscop
...
kernel_4234351211_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
