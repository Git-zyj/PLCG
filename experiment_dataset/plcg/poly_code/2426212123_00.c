...
void kernel_2426212123_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 4; i_0 < PB_L; i_0++) {
        A[i_0-2] = A[i_0-4] + A[i_0-1] - A[i_0] + 2;
    }
    ...
    for (int i_3 = 0; i_3 < PB_M; i_3++) {
        ...
        for (int i_4 = 2; i_4 < min(-i_3+PB_P, i_3); i_4++) {
            D[i_3][i_4+i_3] = E[i_3][i_4-2] - F[2] - 2;
        }
    }
#pragma endscop
...
kernel_2426212123_00(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F));
