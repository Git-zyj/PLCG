...
void kernel_4316212315_05(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
        ...
        for (int i_1 = i_0; i_1 < PB_M; i_1++) {
            for (int i_2 = i_0; i_2 < -i_0+PB_L; i_2++) {
                for (int i_3 = 2; i_3 < PB_L; i_3++) {
                    B[i_1-1][i_1][i_0][i_3-2] = D[i_2][i_0][i_3][i_0-1] * D[i_2][i_2+i_0][i_1-1][i_1] * 3;
                }
            }
        }
        for (int i_4 = max(2, i_0); i_4 < PB_M; i_4++) {
            for (int i_5 = 2; i_5 < min(i_4, PB_P+1); i_5++) {
                for (int i_6 = 2; i_6 < PB_M-1; i_6++) {
                    B[i_4-1][i_4][i_0][i_6-2] = B[i_4-2][i_4-1][i_0-1][i_5-1] + B[i_4-1][i_4][i_0][i_6-1] - B[i_6][i_6+1][i_0-1][i_5-2] - 4;
                }
            }
        }
    }
        ...
        for (int i_8 = 3; i_8 < -i_7+PB_P; i_8++) {
            for (int i_9 = 0; i_9 < PB_M; i_9++) {
                for (int j_0 = 1; j_0 < i_9; j_0++) {
                    B[j_0-1][j_0][i_7][i_8-3] = E[i_9][i_8+i_7][i_8+2] * 1;
                }
            }
        }
    }
...
kernel_4316212315_05(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
