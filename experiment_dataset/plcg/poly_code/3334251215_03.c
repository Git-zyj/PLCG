...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
        B[i_1] = D[i_1] * D[i_1] * D[i_1] + D[i_1] + E[i_1+1] - D[i_1] * E[i_1] - D[i_1] * E[i_1] + D[i_1] * D[i_1] * B[i_1+1] + B[i_1-1] + 1;
        for (int i_2 = 0; i_2 < min(-i_1+PB_L-1, i_1); i_2++) {
            for (int i_3 = 1; i_3 < PB_L; i_3++) {
                C[i_1+1][i_2][i_3] = F[i_3][i_1-1][i_3] - G[i_3-1][i_1-1][i_2+i_1+1] - G[i_1][i_3][i_2] * H[i_2][i_1] - C[i_3][i_2][i_1] * C[i_2][i_1][i_3] + 1;
            }
        }
    }
#pragma endscop
...
kernel_3334251215_03(xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
