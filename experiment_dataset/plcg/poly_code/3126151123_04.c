...
void kernel_3126151123_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        A[0] = B[i_0] + B[i_0] + B[i_0] + B[i_0] + B[0] + A[0] * 3;
    }
#pragma endscop
...
kernel_3126151123_04(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
