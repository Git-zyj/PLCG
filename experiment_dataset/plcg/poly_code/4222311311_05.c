...
void kernel_4222311311_05(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_1+PB_L, -i_0+PB_L-1); i_2++) {
                A[i_2+i_1][i_0] = A[i_2+i_0][i_1] + A[i_2+i_0+1][i_1] - 3;
            }
        }
        for (int i_3 = i_0; i_3 < min(-i_0+PB_P-2, PB_L-1); i_3++) {
            B[i_0][i_3+i_0] = C[i_0][i_3+1] + B[i_0][i_3+i_0-1] * B[i_0][i_3+i_0+1] - B[i_0+1][i_3+i_0+2] - B[i_0+1][i_3+i_0+1] + 2;
        }
    }
#pragma endscop
...
kernel_4222311311_05(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
