...
void kernel_4414252323_05(int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj)){
        ...
        for (int i_1 = 2; i_1 < PB_M-4; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 0; i_3 < PB_P-1; i_3++) {
                    D[i_1+4][i_2+1][i_3] = E[i_2][i_3][i_1+1][i_0] - F[i_1-2][i_3+1][i_2] - 1;
                }
            }
        }
        for (int i_4 = 2; i_4 < -i_0+PB_L-1; i_4++) {
            B[i_4][i_4] = G[i_4+i_0+1][1] * H[i_4][i_0] * H[i_4+1][i_0-1] * G[i_4][i_0] + G[i_0][i_4+1] * B[i_4-2][i_4-2] * C[i_4+1] - 6;
        }
    }
    for (int i_5 = 1; i_5 < PB_M-3; i_5++) {
        C[i_5] = I[i_5] * I[i_5] * I[i_5] * I[i_5] - I[i_5-1] - C[i_5-1] * 5;
        for (int i_6 = 2; i_6 < PB_L-3; i_6++) {
            for (int i_7 = 1; i_7 < PB_M-1; i_7++) {
                D[i_5+2][i_6+1][i_7] = J[i_6][i_5][i_7] - F[i_7][i_5][i_6] * F[i_7][i_5][i_6] * F[i_6-2][i_7][i_6] + F[i_6+1][i_5][i_6-2] * D[i_5+3][i_6+1][i_7] * D[i_5+2][i_6+2][i_7] - D[i_5][i_7-1][i_6-1] + D[i_5+2][i_6+3][i_7] * D[i_7+1][i_6+1][i_5] * 1;
            }
        }
    }
#pragma endscop
...
init_array(xd,yd,zd,POLYBENCH_ARRAY(D), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4414252323_05(xd,yd,zd,POLYBENCH_ARRAY(D), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xd,yd,zd,POLYBENCH_ARRAY(D), xb,yb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J)));
