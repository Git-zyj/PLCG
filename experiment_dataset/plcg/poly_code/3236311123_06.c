...
void kernel_3236311123_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
    ...
    for (int i_3 = 4; i_3 < PB_P; i_3++) {
        for (int i_4 = i_3; i_4 < PB_L+1; i_4++) {
            for (int i_5 = 2; i_5 < min(-i_3+PB_P, PB_L+1); i_5++) {
                B[i_5-1][i_4-1][i_5+i_3-1] = C[i_5-1][i_4] - B[i_5-1][i_4-1][i_5+i_3] - B[i_5-2][i_4-1][i_5+i_3-4] - 2;
            }
        }
    }
#pragma endscop
...
kernel_3236311123_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
