...
void kernel_4226212115_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        for (int i_1 = i_0; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_M-2; i_2++) {
                for (int i_3 = i_1; i_3 < min(-i_2+PB_M+1, -i_0+PB_M+1); i_3++) {
                    A[i_3+i_0-2][i_2+2][i_2+1][i_3] = A[i_3+i_0-1][i_2+2][i_2+1][i_0] * A[i_3+i_2-1][i_1+1][i_1][i_3] + 3;
                }
            }
        }
        for (int i_4 = 0; i_4 < min(i_0, PB_M-1); i_4++) {
            for (int i_5 = 1; i_5 < min(-i_0+PB_L, -i_4+PB_M); i_5++) {
                B[i_5+i_4][i_5-1] = C[i_4+1][i_5+i_0][i_0] + 1;
            }
        }
    }
#pragma endscop
...
kernel_4226212115_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
