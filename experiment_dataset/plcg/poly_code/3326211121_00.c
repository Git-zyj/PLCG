...
void kernel_3326211121_00(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_2 = 1; i_2 < PB_M; i_2++) {
        ...
        for (int i_4 = 1; i_4 < min(i_2, PB_M-1); i_4++) {
            for (int i_5 = 0; i_5 < PB_L; i_5++) {
                C[i_4+1][i_2+1][i_5] = D[i_2-1][i_5][i_4-1] * C[i_4-1][i_2+1][i_5] * 3;
            }
        }
    }
#pragma endscop
...
kernel_3326211121_00(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
