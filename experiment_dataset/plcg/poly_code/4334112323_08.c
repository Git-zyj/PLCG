...
void kernel_4334112323_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_M; i_0++) {
        A[i_0] = D[i_0] + D[i_0-2] * 4;
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < PB_L; i_2++) {
                C[i_1][i_2][i_0-2][i_0-3] = 5;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_L; i_3++) {
        for (int i_4 = 3; i_4 < PB_L-2; i_4++) {
            for (int i_5 = 0; i_5 < PB_L-2; i_5++) {
                C[i_3][i_5][i_4][i_4-1] = C[i_5][i_3][i_4-2][i_4-3] + C[i_3][i_5+1][i_4-2][i_4-3] * C[i_3-1][i_4+1][i_5+2][i_5+1] * C[i_4-1][i_5][i_3][i_3-1] - C[i_3][i_5][i_4+2][i_4+1] + 3;
            }
        }
    }
#pragma endscop
...
kernel_4334112323_08(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
