...
void kernel_3226312123_01(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        for (int i_1 = 0; i_1 < min(-i_0+PB_M-1, PB_L); i_1++) {
            for (int i_2 = max(1, i_1); i_2 < min(-i_0+PB_M+1, PB_L+1); i_2++) {
                B[i_2+i_0-1][i_2-1][i_1][i_0+1] = C[i_2+2][i_0][i_1] - D[i_2][i_1][i_0] + 6;
            }
            for (int i_3 = 0; i_3 < i_1; i_3++) {
                B[i_3+i_0][i_3][i_1][i_0+1] = B[i_1+i_0+1][i_1][i_3][i_0+2] - 1;
            }
        }
    }
#pragma endscop
...
kernel_3226312123_01(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
