...
void kernel_3224112313_06(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        for (int i_1 = 1; i_1 < -i_0+PB_L; i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_L; i_2++) {
                B[i_2+i_1][i_2] = B[i_2+i_1][i_1] + B[i_2+i_1-1][i_1-1] - 1;
            }
            B[i_1+i_0][i_0] = C[i_1][i_0] - B[i_1+i_0-1][i_0-1] * 4;
        }
    }
#pragma endscop
...
kernel_3224112313_06(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
