...
void kernel_3322132123_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf)){
    ...
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        ...
        for (int i_1 = 0; i_1 < PB_N; i_1++) {
            for (int i_2 = 2; i_2 < min(PB_N-2, -i_1+PB_N); i_2++) {
                C[i_0] = E[i_2+2][i_0-2][i_1] * E[i_2-2][i_0][0] * E[i_2+i_1][i_0][i_2+2] * 4;
            }
        }
        for (int i_3 = 0; i_3 < i_0; i_3++) {
            C[i_3] = F[i_3+2][i_0+2] * F[i_0][i_3] - A[i_3] - 4;
        }
    }
#pragma endscop
...
kernel_3322132123_04(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
