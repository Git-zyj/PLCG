...
void kernel_3216312313_02(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_P; i_1++) {
            B[i_0-1][i_1-1] = C[i_0][i_1+2] * B[i_0+1][i_1-1] - B[i_0][i_1] + B[i_0][i_1-1] + 5;
            B[i_0][i_1-1] = 4;
        }
    }
#pragma endscop
...
kernel_3216312313_02(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
