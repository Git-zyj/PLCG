...
void kernel_2222131121_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            B[i_0] = C[i_1] - D[i_1][i_0] + D[i_0][i_1] + B[i_1] - 5;
        }
        B[i_0] = D[i_0-1][i_0+1] - D[i_0+1][0] + C[0] * 5;
    }
#pragma endscop
...
kernel_2222131121_05(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
