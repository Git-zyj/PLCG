...
void kernel_2424352211_05(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            A[i_0][i_1] = E[i_1][i_0+1] - F[i_1+2] * E[i_1][i_0+1] - G[i_1][i_0-1] * H[i_1][i_0+1] + A[i_0][i_1+1] - A[i_0][i_1-1] - 1;
        }
        B[i_0] = I[i_0] - J[i_0] + J[i_0-2] - B[i_0+1] + 3;
    }
    for (int i_2 = 2; i_2 < PB_L; i_2++) {
        B[i_2-1] = F[i_2] + I[i_2] * J[i_2] - I[i_2] * J[i_2] - I[i_2-2] + B[i_2] * 1;
        for (int i_3 = 0; i_3 < PB_L; i_3++) {
            D[i_2][i_3] = H[i_3][i_3] * E[i_2-1][1] * H[i_3][i_2-2] - B[i_3] * D[i_2][i_3+1] - 3;
        }
    }
#pragma endscop
...
kernel_2424352211_05(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
