...
void kernel_3324152115_02(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        B[i_0+1] = D[i_0] - D[i_0] - D[i_0] - 2;
    }
    for (int i_1 = 2; i_1 < PB_M-1; i_1++) {
        B[i_1] = D[0] - D[i_1] - D[i_1] + D[i_1] * D[i_1] + D[i_1] + B[i_1+1] * 3;
        B[i_1] = D[i_1] * D[i_1+2] + D[i_1] + D[i_1-2] * D[i_1] * D[i_1] + 4;
    }
#pragma endscop
...
kernel_3324152115_02(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
