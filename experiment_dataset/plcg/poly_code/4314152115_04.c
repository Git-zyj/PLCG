...
void kernel_4314152115_04(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
        ...
        for (int i_1 = 0; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 2; i_2 < -i_0+PB_L; i_2++) {
                for (int i_3 = 2; i_3 < i_0; i_3++) {
                    B[i_2-2][i_3][i_1] = D[i_0][i_1][i_3][i_3+i_2] * D[i_2-1][i_3][i_1][i_0+1] + D[i_3][i_0+1][i_2][i_1] + D[i_3-2][i_0][i_1+1][i_1] * D[i_1+2][i_2+i_0][i_3][i_0+1] * E[0][i_1][i_2] - F[i_2][i_1][i_3][i_0+2][i_0] - 2;
                }
            }
        }
        for (int i_4 = 3; i_4 < i_0; i_4++) {
            for (int i_5 = 1; i_5 < PB_L; i_5++) {
                B[i_4-2][i_5][i_0] = E[i_5][i_0+2][i_4] + E[i_5][i_0-2][i_4] - E[i_4][i_0][i_5] - B[i_4-3][i_5-1][i_0-1] * 4;
            }
        }
    }
    for (int i_6 = 1; i_6 < PB_L-1; i_6++) {
        for (int i_7 = 2; i_7 < PB_L-1; i_7++) {
            for (int i_8 = 1; i_8 < -i_6+PB_L; i_8++) {
                B[i_8-1][i_7+1][i_6] = G[i_7-1][i_8] + E[i_7][i_8+i_6][i_7] - E[i_7-2][i_6+1][i_7+1] + E[i_7][i_6][i_6-1] + 5;
            }
        }
    }
#pragma endscop
...
init_array(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4314152115_04(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G)));
