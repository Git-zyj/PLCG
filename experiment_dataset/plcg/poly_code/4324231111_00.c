        ...
        for (int i_1 = 2; i_1 < PB_P-1; i_1++) {
            for (int i_2 = 0; i_2 < i_0; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_P; i_3++) {
                    A[i_0][i_3][i_2+1][i_3] = D[i_3][i_0][i_1+1][i_2] - E[i_2][i_1][i_3][i_0+1] - E[i_2][i_0][i_0+1][i_1+1] * E[i_2][i_1][i_3+i_0][i_2] * A[i_0][i_3][i_2][i_3] * A[i_0][i_3][i_2+2][i_3] + 6;
                }
            }
            for (int i_4 = 0; i_4 < -i_1+PB_M-1; i_4++) {
                B[i_0][i_0][i_1-1][i_4] = F[i_4+i_1+1][i_1] + G[i_0][i_4][i_1] + B[i_0][i_0][i_1-2][i_4] + 3;
            }
        }
        for (int i_5 = 0; i_5 < min(PB_P, -i_0+PB_L); i_5++) {
            for (int i_6 = max(1, i_5); i_6 < PB_P; i_6++) {
                C[i_0][i_6][i_5][i_5] = G[i_5+1][i_6][i_6] * H[i_6][i_0][i_5] * F[i_6-1][i_5+i_0] - 2;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4324231111_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H)));
