...
void kernel_3212212311_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 0; i_1 < -i_0+PB_L; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_M-1; i_2++) {
                A[i_2+i_0][i_1+i_0][i_2+i_1+2] = A[i_2+i_0+1][i_1+i_0][i_2+i_1+3] * A[i_2+i_0+1][i_1+i_0][i_2+i_1+1] + A[i_2+i_0-1][i_1+i_0][i_2+i_1+3] + 5;
            }
        }
    }
    for (int i_3 = 2; i_3 < PB_L; i_3++) {
        B[i_3-1] = C[i_3][0] - B[i_3] - B[i_3-2] + 1;
    }
#pragma endscop
...
kernel_3212212311_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
