...
void kernel_4222332115_01(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
        ...
        for (int i_1 = 0; i_1 < min(PB_L, i_0); i_1++) {
            for (int i_2 = 0; i_2 < min(-i_1+PB_L, PB_L-2); i_2++) {
                for (int i_3 = i_1; i_3 < PB_L; i_3++) {
                    B[i_3][i_2+i_1][i_0][i_1] = C[i_1][i_3+i_2][i_0][i_0] + D[i_1+2][i_2+2][i_0-1][i_3] - 2;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 0; i_5 < PB_L-2; i_5++) {
            for (int i_6 = 0; i_6 < min(-i_4+PB_M, -i_5+PB_L-2); i_6++) {
                for (int i_7 = 1; i_7 < min(PB_L, -i_5+PB_N); i_7++) {
                    B[i_4][i_6+i_5][i_7][i_5] = E[i_7+i_5][i_6+i_4][i_7-1][0] * F[i_4+2][i_7][i_6+1] * D[i_6][i_4+2][i_7][i_5] - B[i_4][i_6+i_5+2][i_7][i_5+1] * 4;
                }
            }
        }
    }
...
kernel_4222332115_01(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
