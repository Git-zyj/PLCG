...
void kernel_4234212111_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-2; i_0++) {
        for (int i_1 = i_0; i_1 < PB_L; i_1++) {
            for (int i_2 = 2; i_2 < PB_L-1; i_2++) {
                A[i_0][i_1][0] = C[i_1][i_0+2][i_2-2] - A[i_0][i_2+1][0] + 4;
            }
        }
    }
        ...
        for (int i_4 = 0; i_4 < PB_L; i_4++) {
            for (int i_5 = 0; i_5 < i_3; i_5++) {
                for (int i_6 = 0; i_6 < i_4; i_6++) {
                    A[i_5+1][i_4][0] = C[i_6+1][i_3][i_5] - 6;
                }
            }
        }
    }
...
kernel_4234212111_05(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C));
