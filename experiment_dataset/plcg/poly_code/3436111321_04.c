    ...
    for (int i_7 = 0; i_7 < PB_L; i_7++) {
        for (int i_8 = 0; i_8 < PB_P-2; i_8++) {
            for (int i_9 = 1; i_9 < min(i_7, PB_L-2); i_9++) {
                D[i_9][i_8][i_9] = D[i_9][i_8+1][i_9] + D[i_9-1][i_8][i_9-1] * D[i_9][i_8+2][i_9] - D[i_9+2][i_8+1][i_9+2] + 4;
            }
        }
    }
#pragma endscop
...
kernel_3436111321_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
