...
void kernel_4436251121_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,int wg,DATA_TYPE POLYBENCH_5D(G,xG,yG,zG,vG,wG,xg,yg,zg,vg,wg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk)){
...
#pragma scop
        ...
        for (int i_1 = i_0; i_1 < min(-i_0+PB_Q, PB_P-2); i_1++) {
            for (int i_2 = i_0; i_2 < PB_M; i_2++) {
                for (int i_3 = 1; i_3 < -i_2+PB_M; i_3++) {
                    A[i_0][i_1][i_2-1][i_3+1] = E[i_3][i_2][i_0][i_1] - E[i_3+1][i_0][i_2-1][i_1] - F[i_1][i_3+i_2][i_0][0] + E[i_3+1][i_0+1][i_1][i_2] - F[i_1+1][i_2-1][i_1][i_3-1] + F[i_2+1][i_3-1][i_1-1][i_1+i_0] + E[i_3][i_0][i_2][i_1] * B[i_3][i_2][i_1+2][i_0-1] - 5;
                }
            }
        }
    }
        ...
        for (int i_5 = max(i_4, 1); i_5 < PB_M; i_5++) {
            for (int i_6 = i_4; i_6 < PB_N; i_6++) {
                for (int i_7 = 1; i_7 < PB_M; i_7++) {
                    B[i_4][i_5][i_6][i_7-1] = F[i_6][i_7][i_4][i_5] + F[i_6][i_7][i_4][i_6] - G[i_5-1][i_7][i_6][i_4][i_5] + 5;
                }
            }
        }
        for (int i_8 = 1; i_8 < i_4; i_8++) {
            for (int i_9 = 1; i_9 < min(-i_4+PB_L-1, PB_M-1); i_9++) {
                for (int j_0 = max(0, -i_8+1); j_0 < min(i_4, -i_8+PB_L+1); j_0++) {
                    C[i_9][i_8][j_0][i_8] = H[i_9+i_4+1][j_0+1][i_8] * F[i_8][i_9][j_0][i_4] + H[i_8-1][i_9+1][1] + I[i_9+1][i_4][i_9+1] - H[i_4][j_0+i_8-1][i_9] + I[i_9-1][i_8][i_8+1] + 3;
                }
            }
        }
    }
    for (int j_1 = 1; j_1 < PB_L; j_1++) {
        for (int j_2 = 0; j_2 < -j_1+PB_M+1; j_2++) {
            D[j_2] = J[j_2+1][j_2] * J[j_1][j_2] - K[j_2+j_1-1] + 4;
        }
    }
#pragma endscop
...
kernel_4436251121_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K));
