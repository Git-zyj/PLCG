...
void kernel_3326211211_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
    ...
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 1; i_1 < min(i_0, PB_M-1); i_1++) {
            for (int i_2 = 0; i_2 < min(min(-i_0+PB_P+1, PB_L), -i_1+PB_P); i_2++) {
                A[i_2][i_0+1][i_2+i_1] = D[i_1+1][i_2][i_0-1] + A[i_2][i_1+2][i_2+i_0-1] * C[i_1-1][i_2][i_0-1] - 3;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
        B[i_3] = E[i_3] - B[i_3-1] + B[i_3+1] + 2;
        for (int i_4 = 1; i_4 < i_3; i_4++) {
            for (int i_5 = 1; i_5 < PB_P-1; i_5++) {
                C[i_4][i_3][i_5] = C[i_4][i_3-1][i_5+1] + C[i_4-1][i_3][i_5-1] + 5;
            }
        }
    }
#pragma endscop
...
kernel_3326211211_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
