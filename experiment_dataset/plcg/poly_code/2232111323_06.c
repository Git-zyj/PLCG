...
void kernel_2232111323_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        B[i_0] = B[i_0] - 4;
        for (int i_1 = 1; i_1 < PB_M-2; i_1++) {
            B[i_0] = C[i_1][i_0] * C[i_1][i_0] * B[i_1+2] + B[i_1-1] + 1;
        }
    }
#pragma endscop
...
kernel_2232111323_06(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
