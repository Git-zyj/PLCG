        ...
        for (int i_1 = 2; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_P; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_1+PB_Q+2, PB_M-2); i_3++) {
                    A[i_1+1][i_2][i_3] = D[i_3+2][i_2+i_1][i_3][i_0] * D[i_1-1][i_2][i_3+i_1-2][i_0] * 5;
                }
            }
        }
        B[i_0] = E[i_0-2] - B[i_0-2] * B[i_0+2] * 6;
    }
    for (int i_4 = 2; i_4 < PB_N-2; i_4++) {
        for (int i_5 = 2; i_5 < PB_M-2; i_5++) {
            C[i_5][i_4] = E[i_4] * F[i_5][0] + F[i_4+2][i_5] + F[i_5][i_4-2] + C[i_5+2][i_4] + C[i_4-2][i_5] * C[i_5][i_4-1] - C[i_5-2][i_4] * C[i_5-1][i_4+1] + 2;
        }
    }
#pragma endscop
...
kernel_4312132321_07(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
