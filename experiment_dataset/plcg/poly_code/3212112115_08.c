...
void kernel_3212112115_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_0 = 3; i_0 < PB_L+3; i_0++) {
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            for (int i_2 = 2; i_2 < PB_L+2; i_2++) {
                A[i_1-1][i_2-2][i_0] = 5;
                A[i_1-1][i_0-3][i_2] = C[i_0][i_2][i_1] - A[i_1-1][i_2-2][i_0-1] * 4;
            }
        }
    }
#pragma endscop
...
kernel_3212112115_08(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C));
