...
void kernel_4316112311_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd)){
        ...
        for (int i_2 = 1; i_2 < -i_1+PB_M+1; i_2++) {
            for (int i_3 = 1; i_3 < min(i_1, -i_2+PB_M); i_3++) {
                for (int i_4 = 0; i_4 < min(-i_3+PB_M, i_2); i_4++) {
                    B[i_3+i_2][0][i_4] = D[i_1][i_3][i_4][i_3+i_2] + B[i_3+i_2-1][0][i_4] * B[i_2+i_1-1][0][i_3-1] + B[i_4+i_3][0][i_2-1] * 6;
                }
            }
        }
        for (int i_5 = max(3, i_1); i_5 < PB_L+1; i_5++) {
            C[i_5-2] = C[i_5-1] + C[i_5-3] + C[i_5-3] - 4;
        }
    }
#pragma endscop
...
kernel_4316112311_04(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D));
