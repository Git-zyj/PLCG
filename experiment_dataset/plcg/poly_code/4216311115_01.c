...
void kernel_4216311115_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = i_0; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_L; i_2++) {
                for (int i_3 = 0; i_3 < PB_M; i_3++) {
                    A[i_1][i_0+1][i_2+i_1] = 3;
                }
            }
        }
        for (int i_4 = 0; i_4 < min(-i_0+PB_M-2, i_0); i_4++) {
            for (int i_5 = 0; i_5 < PB_L-1; i_5++) {
                B[i_4+i_0+1][i_5+1][i_0+1] = C[i_0+1][i_5+1][i_4+1] * B[i_4+i_0+2][i_5+1][i_0+1] - 2;
            }
        }
    }
#pragma endscop
...
kernel_4216311115_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
