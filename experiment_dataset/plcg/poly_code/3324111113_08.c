...
void kernel_3324111113_08(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
kernel_3324111113_08(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
