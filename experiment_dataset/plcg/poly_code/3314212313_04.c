...
void kernel_3314212313_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_3 = 1; i_3 < PB_L; i_3++) {
        for (int i_4 = 0; i_4 < PB_L; i_4++) {
            for (int i_5 = 0; i_5 < min(-i_3+PB_M, PB_Q-3); i_5++) {
                B[i_3][i_4][i_5+2] = D[i_5+i_3][i_5][i_4] * B[i_3][i_4][i_5+3] - B[i_4][i_5+1][i_3+2] + B[i_3][i_5][i_4+1] * 6;
            }
        }
        for (int i_6 = 1; i_6 < PB_L; i_6++) {
            for (int i_7 = 1; i_7 < PB_L-1; i_7++) {
                C[i_3][i_7][i_6] = D[i_7][i_3][0] * C[i_3-1][i_7-1][i_6+1] - C[i_3][i_7+1][i_6] * C[i_3][i_6-1][i_7] - C[i_3+1][i_6][i_7+1] * 6;
            }
        }
    }
#pragma endscop
...
kernel_3314212313_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
