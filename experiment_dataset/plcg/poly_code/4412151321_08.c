...
void kernel_4412151321_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
        ...
        for (int i_1 = 1; i_1 < PB_N-1; i_1++) {
            for (int i_2 = 2; i_2 < -i_1+PB_P-1; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_0+PB_L, -i_1+PB_P); i_3++) {
                    A[i_0-1][i_3][i_2][i_2] = E[i_0][i_3][i_1][0] - E[i_3][i_2-1][i_3+i_1][i_0] * E[i_2-1][i_0][i_1][i_3] * E[i_3+1][i_0][i_2+i_1+1][i_1] - E[i_1+1][i_3+i_0][0][i_2] * E[i_1][i_3-1][i_0][i_2] * A[i_0-1][i_3][i_2-2][i_2-2] + A[i_0+1][i_3][i_2][i_2] + B[i_3][i_0+3] - 2;
                }
            }
            for (int i_4 = 0; i_4 < i_1; i_4++) {
                B[i_4][i_1+1] = F[i_4][i_1] - G[i_1+1][i_0][i_4] * E[i_0][i_1+1][i_4+1][i_1-1] + G[i_1+1][i_4][i_1] + F[i_4][i_1] * C[i_1][i_1] - D[i_1][0] + 2;
            }
            C[i_0][i_0] = F[i_1+1][i_0] + F[i_1][i_0] + F[i_1+1][i_0] * C[i_0-2][i_0-2] - C[i_0+2][i_0+2] * C[i_0+1][i_0+1] * D[i_0][0] - 5;
        }
    }
    for (int i_5 = 1; i_5 < PB_M-2; i_5++) {
        for (int i_6 = 0; i_6 < PB_M; i_6++) {
            D[i_5][0] = F[i_5-1][i_5] + F[i_5-1][i_6] + F[i_6][i_5] + B[i_5][i_6+1] + C[i_6][i_6] + D[i_5+2][0] - 3;
        }
    }
#pragma endscop
...
kernel_4412151321_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
