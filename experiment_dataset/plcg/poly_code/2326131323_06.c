...
void kernel_2326131323_06(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_N; i_1++) {
        B[i_1] = D[i_1] - D[i_1] - B[i_1+2] - B[i_1-1] - B[i_1-2] - 4;
    }
    for (int i_2 = 2; i_2 < PB_N; i_2++) {
        B[i_2-2] = D[i_2-1] * D[i_2] - D[i_2] + D[i_2-1] - 4;
    }
#pragma endscop
...
kernel_2326131323_06(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
