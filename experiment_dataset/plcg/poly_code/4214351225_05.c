        ...
        for (int i_1 = 2; i_1 < PB_P-1; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_L, -i_1+PB_P); i_2++) {
                for (int i_3 = 0; i_3 < PB_Q-1; i_3++) {
                    A[i_0][i_1][0][i_2] = C[i_2+i_0][i_3][i_0][i_1+1] + D[i_1][i_3+1][i_2+i_0][i_2+1] + D[i_3][i_2+i_0][i_1][i_3+1] + E[i_3][i_0][i_2+i_1][i_1] + D[i_3][i_0][i_2][i_1+1] - C[i_1-1][i_2-1][i_1+1][i_0-1] * A[i_0-1][i_1-2][0][i_2] * 4;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M-2; i_4++) {
        B[i_4] = F[i_4] + G[i_4] * G[i_4] + B[i_4+1] - B[i_4+2] + 4;
    }
#pragma endscop
...
kernel_4214351225_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
