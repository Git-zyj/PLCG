...
void kernel_4214211315_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
        ...
        for (int i_1 = 0; i_1 < PB_N-2; i_1++) {
            ...
            for (int i_2 = 1; i_2 < PB_N-2; i_2++) {
                for (int i_3 = 1; i_3 < PB_N; i_3++) {
                    B[i_1+1][i_2][i_3-1] = B[i_2][i_1][i_3-1] * B[i_1][i_2+1][i_3] * B[i_1+2][i_3][i_2-1] - B[i_2+2][i_3][i_1] - 6;
                }
            }
        }
    }
...
kernel_4214211315_04(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
