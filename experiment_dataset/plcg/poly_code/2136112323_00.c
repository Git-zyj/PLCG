...
void kernel_2136112323_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 4; i_0 < PB_N-2; i_0++) {
        for (int i_1 = 0; i_1 < -i_0+PB_N-2; i_1++) {
            A[i_1+i_0][i_0-2][i_1] = B[i_1][i_0][i_0] * A[i_1+i_0-2][i_0-4][i_1] - A[i_1+i_0+2][i_0][i_1] - A[i_1+i_0-1][i_0-3][i_1] + 4;
        }
    }
#pragma endscop
...
kernel_2136112323_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B));
