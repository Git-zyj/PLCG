...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_P; i_1++) {
        for (int i_2 = 1; i_2 < -i_1+PB_M-2; i_2++) {
            B[i_2+i_1][i_2+i_1] = F[i_2-1][i_1] + E[i_1-1] - G[i_2][i_1] * A[i_2-1] - B[i_2+i_1+2][i_2+i_1+2] - B[i_2+i_1+1][i_2+i_1+1] - B[i_2+i_1+1][i_2+i_1+1] - 6;
        }
    }
    for (int i_3 = 0; i_3 < PB_M-2; i_3++) {
        for (int i_4 = i_3; i_4 < -i_3+PB_M-2; i_4++) {
            B[i_4+i_3+2][i_4+i_3+2] = G[i_4][i_3] * H[i_4][i_3] * H[i_4][i_3] * 4;
        }
    }
#pragma endscop
...
kernel_2322331225_03(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
