...
static void print_array(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl),int xm,DATA_TYPE POLYBENCH_1D(M,xM,xm),int xn,DATA_TYPE POLYBENCH_1D(N,xN,xn),int xo,int yo,int zo,DATA_TYPE POLYBENCH_3D(O,xO,yO,zO,xo,yo,zo))
{
int i_0, i_1, i_2, i_3;
...
void kernel_4412352215_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl),int xm,DATA_TYPE POLYBENCH_1D(M,xM,xm),int xn,DATA_TYPE POLYBENCH_1D(N,xN,xn),int xo,int yo,int zo,DATA_TYPE POLYBENCH_3D(O,xO,yO,zO,xo,yo,zo)){
        ...
        for (int i_1 = 2; i_1 < -i_0+PB_P-1; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_L, -i_1+PB_N); i_2++) {
                for (int i_3 = 2; i_3 < PB_L-2; i_3++) {
                    A[i_0-1][i_0+2][i_3-1][i_2] = E[i_2+i_1][i_0][i_3][i_1-1] * F[i_3][i_1-1][i_2] - G[i_1][i_0][i_3][i_2] + H[i_0][i_2-1][i_1][i_3] * H[i_3+2][i_2+i_0][i_1][2] - I[i_2][i_3-2][i_1] - A[i_3-1][i_3+2][i_1-2][i_2+1] - A[i_0-2][i_0+1][i_3-1][i_2] + A[i_0][i_0+3][i_3-1][i_2] * 4;
                }
            }
            B[i_1] = J[i_0-2] * K[i_1][i_0] + L[i_0+2][i_1-2] - L[i_1][i_1+i_0+1] * K[i_1+2][i_0+1] - 4;
        }
    }
    for (int i_4 = 2; i_4 < PB_L-1; i_4++) {
        B[i_4-1] = M[i_4] * N[i_4] * M[i_4] + J[i_4] * 5;
        for (int i_5 = 2; i_5 < PB_P; i_5++) {
            for (int i_6 = 1; i_6 < PB_L; i_6++) {
                for (int i_7 = 0; i_7 < PB_N; i_7++) {
                    A[i_4-2][i_4+1][i_6-1][i_7] = H[i_6][i_4][i_7][i_5] - E[i_6][i_7][i_5-2][i_4] - G[i_7][i_6][i_4][i_5] * H[i_4-2][i_6][i_7][i_5-1] + O[i_6][i_5-1][i_6] * 2;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), xm,POLYBENCH_ARRAY(M), xn,POLYBENCH_ARRAY(N), xo,yo,zo,POLYBENCH_ARRAY(O), INIT_SEED);
kernel_4412352215_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), xm,POLYBENCH_ARRAY(M), xn,POLYBENCH_ARRAY(N), xo,yo,zo,POLYBENCH_ARRAY(O));
