...
void kernel_2322112325_05(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_L-4; i_1++) {
        C[i_1+1] = 1;
        C[i_1+2] = C[i_1+4] - C[i_1+1] - C[i_1] * 4;
    }
#pragma endscop
...
kernel_2322112325_05(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
