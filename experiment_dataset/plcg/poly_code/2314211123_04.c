...
void kernel_2314211123_04(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-3; i_0++) {
        ...
        C[i_0+3] = D[i_0-1] + D[i_0] * 6;
    }
    for (int i_2 = 1; i_2 < PB_M-2; i_2++) {
        C[i_2+1] = D[i_2-1] - C[i_2+2] * 6;
    }
#pragma endscop
...
kernel_2314211123_04(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
