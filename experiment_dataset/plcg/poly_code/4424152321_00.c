...
void kernel_4424152321_00(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
        ...
        for (int i_1 = 0; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < PB_P-1; i_3++) {
                    B[i_2+i_1+1][i_0-3][i_3+1][i_0-2] = E[i_3][i_0+2][i_2][1] * E[i_3][i_0][i_1][i_1] * E[i_2][i_0][i_3][i_1] + E[i_1][i_0][i_3][i_3+i_2] - 1;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-2; i_4++) {
        for (int i_5 = 2; i_5 < min(i_4, -i_4+PB_M-2); i_5++) {
            for (int i_6 = i_4; i_6 < PB_M-2; i_6++) {
                for (int i_7 = 1; i_7 < min(-i_4+PB_M+1, -i_6+PB_M-2); i_7++) {
                    B[i_7+i_6][i_5-1][i_4][i_5] = F[i_5+1][i_7][i_6+1][i_7][i_4] * E[i_6][i_7][i_4-1][i_5-1] + E[i_6][i_4][i_7-1][i_5] + E[i_6-2][i_7][i_4+1][i_5] * E[i_7][i_6][i_5][i_4] * E[i_6][i_5][i_7][0] - E[i_4][i_5+1][i_7+i_6][i_4] + E[i_6-2][i_5+i_4][i_7-1][i_4-2] * B[i_5+i_4+2][i_7-1][i_6-1][i_7] - B[i_7+i_6+2][i_5-1][i_4-2][i_5] + B[i_7+i_4-1][i_5-2][i_6-2][i_5-1] - B[i_7+i_6-2][i_5-1][i_4-1][i_5] * 6;
                }
            }
        }
        for (int i_8 = 1; i_8 < PB_L-2; i_8++) {
            C[i_4-1][i_8+2] = G[i_8][i_4] - G[i_8-1][i_4-1] + G[i_8-1][i_4] - G[i_8-1][i_4-1] * C[i_4-2][i_8] - 6;
        }
        for (int i_9 = 2; i_9 < PB_M; i_9++) {
            for (int j_0 = i_9; j_0 < -i_9+PB_M; j_0++) {
                for (int j_1 = i_4; j_1 < PB_N-2; j_1++) {
                    D[i_9-2][i_4][j_0][j_1] = E[j_1][i_4][i_9][j_0] * H[j_1+2][j_0+2][0] * B[j_0+i_9][j_1-1][i_4-2][j_1] + D[i_9-1][i_4][j_0][j_1] * D[i_9-2][i_4][j_0][j_1-2] * 1;
                }
            }
        }
    }
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4424152321_00(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H)));
