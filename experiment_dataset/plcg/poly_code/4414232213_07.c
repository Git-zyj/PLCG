        ...
        for (int i_1 = 1; i_1 < PB_P-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < PB_M; i_3++) {
                    A[i_0][i_3][i_1][i_2] = A[i_0][i_3][i_2][i_1-1] * 6;
                }
                for (int i_4 = 1; i_4 < PB_L-3; i_4++) {
                    B[i_2][i_4+2][i_1][i_4] = E[i_1][i_4][i_0][i_2] - F[i_2][0][i_0][i_1] - F[i_4][i_2][i_1][i_0-1] * E[i_4-1][i_2+2][i_1][0] - F[i_4][i_2+1][i_0][i_1] * B[i_2][i_4+1][i_1][i_4-1] * B[i_2][i_4+2][i_1+1][i_4] + B[i_0][i_4+3][i_2][i_4+1] - 3;
                }
            }
        }
    }
    for (int i_5 = 1; i_5 < PB_M-2; i_5++) {
        D[i_5-1] = G[i_5] + G[i_5] + G[i_5+2] - 2;
        D[i_5] = G[i_5] * H[i_5] - H[i_5] + G[i_5] * D[i_5+1] - 1;
    }
#pragma endscop
...
kernel_4414232213_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
