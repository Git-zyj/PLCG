...
void kernel_4234331315_00(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
        ...
        for (int i_1 = 1; i_1 < PB_Q-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_P; i_2++) {
                for (int i_3 = 0; i_3 < PB_Q-1; i_3++) {
                    B[i_3+1][i_0-1][i_2][i_1+1] = C[i_1][i_3][i_0-1][i_2] - D[i_1-1][i_2][i_3][1] + B[i_1][i_2][i_3+1][i_0] * 5;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < PB_Q-1; i_5++) {
            for (int i_6 = 0; i_6 < PB_L-1; i_6++) {
                for (int i_7 = 0; i_7 < PB_Q-2; i_7++) {
                    B[i_6+1][i_4][i_5+1][i_7+1] = C[i_4+1][i_6][i_7][i_5] + E[i_5][i_6][i_7+1] + C[i_6][i_7][i_4][i_5] * B[i_6+1][i_4-1][i_5+1][i_7+1] - B[i_6+1][i_4][i_5+1][i_7+2] - 5;
                }
            }
        }
    }
...
kernel_4234331315_00(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
