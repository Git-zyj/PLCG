...
void kernel_2414352323_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_P; i_0++) {
        for (int i_1 = 0; i_1 < -i_0+PB_N; i_1++) {
            A[i_0][i_0-2] = E[i_1+i_0-2] - F[i_0][i_1] + G[i_1][i_0] - G[i_1][i_0] + G[i_1+i_0][i_0-2] * F[i_1+2][i_0] + H[i_1][i_0] - F[i_1][i_1+i_0] + A[i_0+2][i_0] * A[i_0+1][i_0-1] - A[i_0-1][i_0-3] - 5;
        }
    }
    for (int i_2 = 2; i_2 < PB_P; i_2++) {
        C[i_2+1][i_2] = E[0] * I[i_2-2] * I[i_2+2] * C[i_2+1][i_2] - 6;
        for (int i_3 = i_2; i_3 < PB_M-1; i_3++) {
            C[i_2+1][i_2] = I[i_3+1] - G[i_2][i_3] - 5;
        }
        for (int i_4 = 0; i_4 < -i_2+PB_N; i_4++) {
            D[i_4+i_2][i_2+2] = H[i_4][i_2] + H[i_4][i_2] * H[i_2-2][i_4+1] * J[1] * D[i_4+i_2-1][i_2+1] - D[i_4+i_2-1][i_2+2] + D[i_4+i_2-2][i_2+2] + D[i_4+i_2-1][i_4+1] + 2;
        }
    }
#pragma endscop
...
init_array(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_2414352323_04(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J)));
