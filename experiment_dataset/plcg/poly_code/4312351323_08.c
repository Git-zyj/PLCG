        ...
        for (int i_4 = 0; i_4 < -i_3+PB_L; i_4++) {
            for (int i_5 = 1; i_5 < -i_3+PB_L; i_5++) {
                for (int i_6 = 0; i_6 < PB_Q; i_6++) {
                    A[i_4][i_5-1][i_4] = E[i_5+i_4][i_3-1][i_6][i_5] + E[i_3-1][i_5+1][i_6][i_4] + 6;
                }
                A[i_4][i_5][i_4] = F[i_5][i_3][i_3+1] + G[i_4][i_4+i_3] * F[i_5+1][i_3][i_4] - H[i_3][i_5] * F[i_5][i_3][i_4] - F[i_3+1][i_5+1][i_3] - I[i_5][i_3][i_4] + D[i_5][i_3][i_4] * F[i_4+1][i_5+i_3][0] + 5;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4312351323_08(xa,ya,za,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
