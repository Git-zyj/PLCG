...
void kernel_4314252313_06(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 3; i_0 < PB_L; i_0++) {
        for (int i_1 = i_0; i_1 < -i_0+PB_L; i_1++) {
            A[i_0-2][i_1] = D[i_1][i_0-1] * E[i_1+1][i_1][i_0] * D[i_0][i_1-2] + D[i_0+2][i_1-1] + A[i_0-1][i_1] * 6;
            A[i_0-3][i_1] = F[i_1+1][i_0] * F[i_1-1][i_0-2] * F[i_0][i_1+2] - D[i_1][i_0] - F[i_1-2][i_0] + D[i_1+2][i_1+i_0] - A[i_0-2][i_1-1] * A[i_0-2][i_1+1] + 3;
        }
        for (int i_2 = i_0; i_2 < PB_M-1; i_2++) {
            C[i_0][i_2][0] = F[i_0][i_2] + F[i_2][i_0] * D[i_0][i_2] - C[i_0][i_2+1][0] + C[i_2-1][i_0][0] + C[i_2][i_0-1][0] * 4;
        }
    }
#pragma endscop
...
kernel_4314252313_06(xa,ya,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
