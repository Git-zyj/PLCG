...
void kernel_4224151125_03(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd)){
        ...
        for (int i_1 = 1; i_1 < min(i_0, -i_0+PB_M-3); i_1++) {
            for (int i_2 = 1; i_2 < PB_Q; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_0+PB_M, -i_2+PB_M+1); i_3++) {
                    B[i_1+i_0][i_2-1][i_3][i_2] = C[i_1][i_3][i_2] + D[i_0][i_3][i_1][i_2-1] - D[i_1-1][i_3+i_2-1][i_0][i_3] * D[i_1][i_3][i_0][i_1-1] + C[i_3+i_0][i_1][i_2] + B[i_1+i_0+3][i_2-1][i_3][i_2] + 6;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        for (int i_5 = 1; i_5 < min(i_4, -i_4+PB_M); i_5++) {
            for (int i_6 = 1; i_6 < PB_L-1; i_6++) {
                for (int i_7 = i_6; i_7 < -i_4+PB_M-1; i_7++) {
                    B[i_5+i_4][i_6-1][i_7][i_6] = D[i_5][i_7][i_6+1][i_5] + D[i_7][i_6][i_4][i_7-1] + D[i_5][i_7+i_4+1][i_6][i_6-1] + D[i_7+i_5-1][i_4][i_6-1][i_7] + D[i_5][i_4-1][i_7][i_6-1] * 5;
                }
            }
        }
    }
...
kernel_4224151125_03(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D));
