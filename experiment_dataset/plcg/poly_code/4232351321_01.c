    ...
    for (int i_3 = 1; i_3 < PB_P; i_3++) {
        for (int i_4 = 0; i_4 < min(-i_3+PB_N, PB_P-2); i_4++) {
            for (int i_5 = 1; i_5 < min(PB_P, -i_4+PB_N-1); i_5++) {
                B[i_3+1][i_4][i_5-1] = E[i_4][i_3-1][0] + E[i_5+i_4+1][i_3+1][i_4] + D[i_3][i_5][i_4] - D[i_4][i_5][i_4] * E[i_4+i_3][i_5][0] + B[i_5+1][i_4+2][i_3] + B[i_3+2][i_4][i_5-1] + 5;
            }
        }
    }
#pragma endscop
...
kernel_4232351321_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
