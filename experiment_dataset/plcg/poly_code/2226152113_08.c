...
void kernel_2226152113_08(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N-2; i_0++) {
        A[i_0-1] = C[i_0+1] - C[i_0+1] + C[i_0-2] + C[i_0] - 3;
        B[i_0] = C[i_0+2] + C[i_0] + C[2] * C[i_0] * C[i_0] * B[i_0-1] * 2;
    }
#pragma endscop
...
kernel_2226152113_08(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
