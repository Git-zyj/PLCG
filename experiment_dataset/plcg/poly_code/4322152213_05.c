        ...
        for (int i_1 = 2; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < i_1; i_2++) {
                for (int i_3 = 1; i_3 < PB_L; i_3++) {
                    B[i_2][i_3][i_0+2][i_1-1] = D[i_1][i_3][i_0-1][i_0] + D[i_3][i_0+2][i_1-2][i_2] * E[i_2-1][i_1][i_3][i_3][i_0] - C[i_3+1][i_0-1] * C[i_3-1][i_2-1] - 2;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < PB_L-2; i_5++) {
            for (int i_6 = i_5; i_6 < -i_5+PB_M; i_6++) {
                for (int i_7 = i_5; i_7 < -i_4+PB_P; i_7++) {
                    B[i_6][i_7][i_4+2][i_5-1] = D[i_6+i_5][i_4-1][i_7][i_6] * D[i_6][i_4][i_7][i_5] - D[i_5][i_6-1][i_7+i_4][i_4-2] - F[i_6+1][i_7][0] - B[i_6-1][i_4][i_5+2][i_7-1] + 5;
                }
            }
        }
        for (int i_8 = 0; i_8 < PB_L; i_8++) {
            for (int i_9 = 2; i_9 < min(-i_8+PB_L, -i_4+PB_L); i_9++) {
                C[i_8][i_9-1] = F[i_9][i_4][2] + F[i_9+i_8][i_4][i_4-2] - G[i_9][i_9+i_8] * G[i_4][i_8] - D[i_8][i_9][i_4-2][i_8] + F[i_8][i_9+i_4][i_4] + C[i_8][i_9-2] - 2;
            }
        }
    }
#pragma endscop
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4322152213_05(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G)));
