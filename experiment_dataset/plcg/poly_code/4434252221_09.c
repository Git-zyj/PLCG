...
void kernel_4434252221_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk)){
        ...
        for (int i_1 = 0; i_1 < min(i_0, -i_0+PB_P); i_1++) {
            for (int i_2 = 0; i_2 < PB_M; i_2++) {
                for (int i_3 = 2; i_3 < PB_M; i_3++) {
                    A[i_0-1][i_3][i_2][i_1] = E[i_1][i_2][i_3] + F[i_3][i_1][i_0][i_2] - F[i_3][i_1][i_1+i_0][i_2+1] * F[i_2][i_3-2][i_0][i_1+1] - A[i_0-2][i_3][i_2][i_1] - 5;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_P-2; i_4++) {
        for (int i_5 = 4; i_5 < -i_4+PB_P-2; i_5++) {
            for (int i_6 = 0; i_6 < PB_M-2; i_6++) {
                B[i_4-2][i_6][0] = G[i_5][i_4] * E[i_6+2][i_4][i_5] * H[i_6][i_5+i_4+2] + E[i_5][i_4][i_6] - B[i_4][i_6][0] + B[i_5-4][i_4+1][0] - B[i_4-1][i_6][0] - 6;
            }
        }
    }
    for (int i_7 = PB_M-2 - 1; i_7 >= 4; i_7--) {
        C[i_7+1] = I[i_7-1] - J[i_7] - J[i_7] * I[i_7] + J[i_7] + I[i_7] * C[i_7+2] - 1;
        for (int i_8 = 2; i_8 < PB_P-2; i_8++) {
            for (int i_9 = 2; i_9 < PB_M; i_9++) {
                B[i_7-4][i_8][0] = K[i_7][i_9][i_8] * H[i_9][i_8] + K[i_9][i_8+2][i_7-2] - K[i_9-2][i_8][i_7] - E[i_7][i_8-1][0] + K[i_8-2][i_7-2][i_9] + 3;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4434252221_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K)));
