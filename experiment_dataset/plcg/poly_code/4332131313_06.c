...
void kernel_4332131313_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf)){
        ...
        for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_M, PB_L-1); i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_L; i_3++) {
                    A[i_3][i_1][i_2-1][i_2-1] = D[i_3][i_3+i_0][i_1-1][i_2+1] - D[i_2+i_0][i_3][i_1][0] - D[i_3][i_2+1][i_1][i_0] * A[i_3][i_1+1][i_2-1][i_2-1] - A[i_3][i_1][i_2][i_2] * A[i_3+1][i_1][i_2-1][i_2-1] + 1;
                }
            }
            for (int i_4 = 0; i_4 < PB_M; i_4++) {
                C[i_0-1][i_0-1][i_1+1] = E[i_1][i_4][i_0] - E[i_0][i_4][i_1] * 1;
            }
        }
    }
    for (int i_5 = 1; i_5 < PB_L; i_5++) {
        for (int i_6 = 0; i_6 < PB_L-1; i_6++) {
            for (int i_7 = 1; i_7 < -i_5+PB_L; i_7++) {
                C[i_7][i_7][i_6+1] = E[i_7-1][i_5-1][i_6] + F[i_5+1][i_6+1] * F[i_6][i_7+i_5] - C[i_7][i_7][i_6] + C[i_7+1][i_7+1][i_6+1] + 3;
            }
        }
    }
#pragma endscop
...
kernel_4332131313_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
