...
void kernel_3326352123_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        for (int i_1 = 2; i_1 < PB_L; i_1++) {
            A[i_1-1] = D[i_0][i_1] + E[i_1+1] - D[i_0+1][i_1-2] + 3;
        }
        A[i_0+1] = F[i_0] + A[i_0] - 1;
        for (int i_2 = 2; i_2 < min(-i_0+PB_L, i_0); i_2++) {
            A[i_2-1] = G[i_2-2][i_2+i_0] - G[i_2][i_0-2] + H[i_2][i_0] + D[i_2+i_0][0] + G[i_2][i_0] * G[i_2][i_0-2] - I[i_2][i_0][i_0+2] * E[i_2] - D[i_0][0] + 2;
        }
    }
#pragma endscop
...
kernel_3326352123_04(xa,POLYBENCH_ARRAY(A), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
