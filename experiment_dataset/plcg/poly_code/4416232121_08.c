...
void kernel_4416232121_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_P-1; i_0++) {
        for (int i_1 = i_0; i_1 < PB_N; i_1++) {
            ...
            for (int i_3 = i_0; i_3 < min(PB_P-2, -i_1+PB_N); i_3++) {
                B[i_1][i_3+2][i_0-2] = E[i_3][i_0][i_1] - E[i_3+i_1-1][i_0][2] + E[i_3+i_1][i_0+1][i_0] * F[i_3][i_1-2][i_0] * 6;
            }
        }
        for (int i_4 = 2; i_4 < -i_0+PB_L; i_4++) {
            for (int i_5 = 1; i_5 < i_4; i_5++) {
                C[i_0][i_4-1][i_5] = G[i_5][2] - F[i_4+i_0][i_5][i_4] * F[i_5][i_4+i_0][i_5] + F[i_5][i_4-2][i_0] * C[i_4+2][i_5-1][i_0+1] * 3;
            }
        }
    }
    for (int i_6 = 2; i_6 < PB_L; i_6++) {
        for (int i_7 = 0; i_7 < min(i_6, -i_6+PB_N+2); i_7++) {
            for (int i_8 = 2; i_8 < PB_P; i_8++) {
                for (int i_9 = 0; i_9 < PB_P; i_9++) {
                    D[i_7+i_6-2][i_9+i_7][i_8-2][i_9] = H[i_8+1][i_9][i_6][i_7+1] - E[i_7][i_9][i_6] + F[i_6][i_7][i_8] + 5;
                }
            }
        }
    }
...
kernel_4416232121_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
