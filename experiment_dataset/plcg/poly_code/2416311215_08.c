...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
        for (int i_2 = 1; i_2 < PB_M; i_2++) {
            C[i_1][i_2] = F[i_2][i_1] * G[i_1][i_2+1] - H[i_1+1][i_2-1] - C[i_1-1][i_2] - C[i_1][i_2-1] - 5;
        }
        D[i_1] = D[i_1-1] - 2;
    }
#pragma endscop
...
kernel_2416311215_08(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
