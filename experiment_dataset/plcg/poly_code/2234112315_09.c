...
void kernel_2234112315_09(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        for (int i_1 = 1; i_1 < PB_M-1; i_1++) {
            B[i_1+1][i_0-1] = C[i_1-1][i_0+2] + 5;
        }
        for (int i_2 = 0; i_2 < PB_M-2; i_2++) {
            B[i_2+1][i_0-1] = C[i_2][i_0] + B[i_2+2][i_0-1] - B[i_2][i_0] - B[i_2+2][i_0-2] - 6;
        }
    }
#pragma endscop
...
kernel_2234112315_09(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
