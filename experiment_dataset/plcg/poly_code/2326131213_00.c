...
void kernel_2326131213_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        A[i_0] = D[i_0] + D[i_0] + D[i_0-1] + D[i_0] * A[i_0+1] + 3;
    }
    for (int i_1 = 2; i_1 < PB_N; i_1++) {
        B[i_1-1] = D[i_1] - D[i_1+1] + D[i_1+1] - B[i_1-2] + B[i_1] * 2;
    }
...
kernel_2326131213_00(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
