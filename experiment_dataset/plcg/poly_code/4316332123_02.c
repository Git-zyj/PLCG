...
void kernel_4316332123_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        A[i_0] = D[i_0] - E[i_0] + E[0] * 6;
    }
    for (int i_1 = 0; i_1 < PB_M-1; i_1++) {
        A[i_1] = F[i_1] * E[i_1] - 6;
        for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
            C[i_1][i_2] = G[i_2][i_1+1] + F[i_1] * H[0][i_2-1] + E[i_2+1] * C[i_2+2][i_1] * 6;
        }
    }
#pragma endscop
...
kernel_4316332123_02(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
