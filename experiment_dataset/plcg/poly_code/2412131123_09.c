...
void kernel_2412131123_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
...
#pragma scop
    for (int i_0 = 0; i_0 < PB_P-2; i_0++) {
        ...
        for (int i_1 = i_0 - 1; i_1 >= 2; i_1--) {
            C[i_1+1][i_0][i_1+1] = F[i_0][i_1][i_0+1] + G[i_1][i_0] + G[i_0][i_1+1] * E[i_0+1] * C[i_0+2][i_1-2][i_0+2] - 3;
        }
        D[i_0] = E[i_0] + E[i_0] + E[i_0] * E[i_0+1] - E[0] - 1;
    }
#pragma endscop
...
kernel_2412131123_09(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
