...
void kernel_4212132225_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        B[i_0] = C[i_0] - C[i_0] - C[i_0] + C[i_0+1] + B[i_0] - B[i_0-1] * 4;
        B[i_0] = C[i_0] - C[i_0] - 3;
    }
#pragma endscop
...
kernel_4212132225_03(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
