...
void kernel_4226132325_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 2; i_1 < PB_M-5; i_1++) {
            for (int i_2 = 2; i_2 < -i_1+PB_M-5; i_2++) {
                for (int i_3 = 1; i_3 < i_2; i_3++) {
                    A[i_3+i_2+1][i_0+1][i_3] = C[i_3-1][i_1][i_2-2] - D[i_1][i_0+2][i_2-1][i_3+2] * A[i_2+i_1+5][i_0-1][i_1+2] - A[i_3+i_0][i_2+1][i_3-1] - A[i_3+i_1-1][i_2+2][i_1-2] + A[i_2+i_0][i_3+1][i_0] - 5;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_Q-2; i_4++) {
        for (int i_5 = 0; i_5 < min(i_4, -i_4+PB_Q-2); i_5++) {
            for (int i_6 = 0; i_6 < -i_4+PB_Q-1; i_6++) {
                B[i_4][i_5][i_6+i_4] = C[i_6+i_5][i_4][i_4] + C[i_6+i_4+2][i_5][i_4] + E[i_4][i_5] * B[i_5+1][i_6][i_5+i_4+2] + B[i_4][i_5][i_6+i_4+1] + 1;
            }
        }
    }
#pragma endscop
...
kernel_4226132325_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
