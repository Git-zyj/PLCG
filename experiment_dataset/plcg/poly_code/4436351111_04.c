...
void kernel_4436351111_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj)){
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = max(1, i_1); i_2 < PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_1+PB_M, -i_2+PB_M-1); i_3++) {
                    A[i_1][i_0][i_2-1][i_3+1] = E[i_0][i_3][i_1][i_0] + E[i_3+i_1][i_0][i_2][i_2] - E[i_3+i_2+1][i_1+1][i_0][i_2] * F[i_0+1][i_3][i_1-1] * E[i_1+1][i_3][i_2][i_0] * G[i_3][i_1][i_2] - 2;
                }
            }
        }
    }
        ...
        for (int i_5 = i_4; i_5 < -i_4+PB_L; i_5++) {
            for (int i_6 = 0; i_6 < PB_N-1; i_6++) {
                for (int i_7 = 0; i_7 < -i_6+PB_N-1; i_7++) {
                    B[i_4][i_5][i_6][i_7] = H[i_7][i_6][i_4][i_5+1] * I[i_7+i_6+1][i_5+i_4][i_6] + J[i_4+1][i_7][i_5][i_6] + 5;
                }
            }
            for (int i_8 = 0; i_8 < PB_N; i_8++) {
                D[i_4][i_5][i_5][i_8] = G[i_5][i_8+1][i_8] * I[i_8][i_5][i_4] - D[i_8][i_5][i_5][i_4+1] - 6;
                for (int i_9 = 1; i_9 < -i_5+PB_M+1; i_9++) {
                    D[i_9][i_5][i_5][i_4] = J[i_5+1][i_8][i_4][i_9-1] * H[i_9+i_5-1][i_4][i_4][i_8] - H[i_8][i_9][i_4-1][i_4] + H[i_9][i_4][i_8][i_5] * E[i_9-1][i_5][i_4][i_8] + E[i_9][i_5+i_4-1][i_8][i_5] * H[i_9][i_5+i_4][i_8][i_5] * H[i_4-1][0][i_9][i_8+1] * B[i_5][i_4][i_9][i_8] - 1;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4436351111_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J)));
