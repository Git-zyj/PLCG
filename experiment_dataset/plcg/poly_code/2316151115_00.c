...
void kernel_2316151115_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_N-1 - 1; i_0 >= 1; i_0--) {
        B[i_0] = D[i_0-1] - D[i_0] * D[0] * D[i_0] - D[i_0] - D[i_0-1] + D[i_0] + 3;
        B[i_0-1] = D[i_0] + D[i_0] + D[i_0+1] * D[i_0] * 3;
        B[i_0-1] = D[i_0] - D[i_0] - D[i_0-1] - D[i_0] + B[i_0-1] * 5;
    }
#pragma endscop
...
kernel_2316151115_00(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
