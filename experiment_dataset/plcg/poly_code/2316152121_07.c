...
void kernel_2316152121_07(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            A[i_0][i_0] = D[i_1][i_1][i_0] - E[i_0+2][i_1] + E[i_0][i_1-1] - E[i_1][i_0] + E[i_1][i_1] - E[i_1][i_0] + 3;
            B[i_0][i_1] = F[i_1] + E[i_1][i_0-2] + E[i_1-2][i_0] * 4;
        }
        for (int i_2 = 0; i_2 < -i_0+PB_M; i_2++) {
            C[i_2][i_2+i_0] = E[i_2][i_0] + F[0] + E[i_2][0] - E[i_2+i_0][0] + F[1] * E[i_2][i_2+i_0] + B[i_0][i_2] + 4;
        }
    }
#pragma endscop
...
kernel_2316152121_07(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F));
