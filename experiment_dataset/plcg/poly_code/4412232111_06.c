    ...
    for (int i_4 = 1; i_4 < PB_P-2; i_4++) {
        for (int i_5 = 0; i_5 < min(PB_P-2, -i_4+PB_L); i_5++) {
            for (int i_6 = 1; i_6 < PB_M; i_6++) {
                for (int i_7 = 0; i_7 < min(i_4, -i_4+PB_P-2); i_7++) {
                    C[i_5][i_6][i_7+1][i_7] = H[i_6][i_7][i_5][i_4+2] * I[i_5+i_4][i_7+i_4+2][i_6] - H[i_5][i_6-1][i_4+1][i_7] + H[i_6][i_4-1][i_5+2][i_7+2] + 4;
                }
            }
        }
        for (int i_8 = 0; i_8 < PB_M; i_8++) {
            for (int i_9 = i_4; i_9 < PB_M-1; i_9++) {
                for (int j_0 = 2; j_0 < PB_M; j_0++) {
                    D[i_4][i_8][i_9][i_4] = J[j_0][i_8][i_4-1] + G[i_9+1][i_8][j_0-2][0] * G[i_8][j_0][i_4][j_0] * D[i_9-1][i_8][j_0][i_9-1] * D[i_8][j_0-1][i_9][i_8] - 4;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4412232111_06(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J)));
