...
void kernel_4214152215_05(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < min(i_0, PB_L-2); i_1++) {
            for (int i_2 = 2; i_2 < -i_1+PB_L-2; i_2++) {
                B[i_0][i_1][i_2+i_1+2][i_2] = C[i_0-2][i_2+i_1][i_2-2] - C[i_2][i_0-1][i_1] + 6;
            }
        }
        for (int i_3 = i_0; i_3 < PB_L-2; i_3++) {
            for (int i_4 = 1; i_4 < min(-i_0+PB_L, -i_3+PB_L-2); i_4++) {
                for (int i_5 = 0; i_5 < min(-i_3+PB_Q-1, -i_4+PB_L-3); i_5++) {
                    B[i_0][i_3][i_4+i_3+2][i_4] = D[i_3][i_5+i_4][i_0][i_5+2] + C[i_4][i_4+i_3-2][i_4] * D[i_4][i_5+i_3][i_0][i_4+2] * C[i_5+i_3][i_3+1][i_0] - D[i_3+1][i_4+i_0][i_5+2][0] + D[i_5][i_4][i_0-2][i_5+i_3+1] - D[i_5+i_4-1][i_0][i_3][i_4] + B[i_0][i_3-1][i_4+i_3][i_4-1] + B[i_3][i_5+1][i_5+i_4+3][i_4] * 5;
                }
            }
        }
    }
...
kernel_4214152215_05(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D));
