...
void kernel_2316251115_02(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        C[i_0-1] = D[i_0+1][i_0-1] * E[i_0+1] + F[i_0] + F[i_0] * F[0] * 1;
        for (int i_1 = 1; i_1 < -i_0+PB_L-1; i_1++) {
            C[i_0] = D[i_1][i_0+1] - G[i_1+1][i_0] * G[i_0][i_1-1] + E[i_1] * H[i_1][i_1+i_0+1][i_0+1] - C[i_0] - 5;
        }
        C[i_0] = F[0] - F[i_0+1] - E[i_0] * E[i_0] + 3;
    }
#pragma endscop
...
kernel_2316251115_02(xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H));
