...
void kernel_4224112125_02(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_4 = 1; i_4 < PB_P; i_4++) {
        for (int i_5 = 0; i_5 < min(PB_N-2, -i_4+PB_L); i_5++) {
            for (int i_6 = 1; i_6 < PB_P; i_6++) {
                B[i_6-1][i_5+i_4][0] = C[i_5+2][i_6] + D[i_6][i_6-1][i_4] - B[i_4-1][i_6+i_5][0] * 2;
            }
        }
    }
#pragma endscop
...
kernel_4224112125_02(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
