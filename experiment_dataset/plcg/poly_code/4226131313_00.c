...
void kernel_4226131313_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 1; i_1 < min(-i_0+PB_P+1, PB_P-1); i_1++) {
            for (int i_2 = i_0; i_2 < -i_0+PB_L-1; i_2++) {
                A[i_0][i_1][i_2-1] = C[i_1+i_0][i_2][i_1+i_0-1][i_0-1] * D[i_2][i_1] - D[i_1-1][i_2+i_0+1] * A[i_0][i_1-1][i_2-1] - A[i_0][i_1+1][i_2-1] + 4;
            }
        }
        for (int i_3 = i_0; i_3 < min(-i_0+PB_N-1, PB_L); i_3++) {
            B[i_3+i_0][i_0] = D[i_0][i_3] - D[i_3][i_0] * B[i_3+i_0+1][i_0+1] + B[i_3+i_0][i_0-1] - B[i_3+i_0][i_0+1] + B[i_3+i_0-1][i_0] - 4;
        }
    }
#pragma endscop
...
kernel_4226131313_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
