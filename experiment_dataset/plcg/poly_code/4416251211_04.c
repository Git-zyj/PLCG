...
void kernel_4416251211_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,int vj,int wj,DATA_TYPE POLYBENCH_5D(J,xJ,yJ,zJ,vJ,wJ,xj,yj,zj,vj,wj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk)){
        ...
        for (int i_1 = i_0; i_1 < -i_0+PB_P+1; i_1++) {
            for (int i_2 = 0; i_2 < PB_L; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_2+PB_L, i_2); i_3++) {
                    A[i_1+i_0][i_2][i_3][i_1+i_0] = E[i_3+i_2][i_1+i_0-1][i_3][i_1] * E[i_0][i_1-1][i_3-1][i_2+1] - 2;
                }
            }
        }
        for (int i_4 = 1; i_4 < -i_0+PB_L-1; i_4++) {
            B[i_0][i_4+1] = F[i_4][i_0] - G[i_4][i_4] - H[i_4-1] - F[i_4][i_0] - H[i_0] * G[i_0][i_4+i_0+1] + B[i_0][i_4] - 1;
        }
    }
    for (int i_5 = 1; i_5 < PB_L-1; i_5++) {
        for (int i_6 = 2; i_6 < -i_5+PB_L-1; i_6++) {
            C[i_6-1][i_5] = G[i_6+1][i_6] - G[i_6+1][i_5] * H[i_6] + F[i_5][i_6] - G[i_5][i_6+i_5+1] - C[i_6-2][i_5-1] + C[i_6-2][i_5] * C[i_5][i_6] * 5;
        }
        for (int i_7 = i_5; i_7 < -i_5+PB_L-1; i_7++) {
            for (int i_8 = 1; i_8 < PB_P; i_8++) {
                for (int i_9 = i_5; i_9 < PB_P-1; i_9++) {
                    D[i_7+1][i_5][i_8][i_9] = I[i_8][i_7][i_9-1][i_5] + J[i_9][i_5][i_8][i_7-1][0] - K[i_9-1][i_5][i_8] * E[i_7+i_5+1][i_9+1][i_8][i_7] * I[i_8-1][i_9][i_5][i_7] - D[i_8+1][i_7+1][i_5][i_9] * 3;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,wj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4416251211_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,wj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
