...
void kernel_3212152313_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        for (int i_1 = i_0; i_1 < PB_L; i_1++) {
            for (int i_2 = 3; i_2 < -i_0+PB_L-2; i_2++) {
                A[i_0][i_1][i_2-2] = C[i_0][i_1][i_2] - C[i_1][i_2+i_0+2][i_2-1] + D[i_2][i_1] + C[i_1][2][i_2] - C[i_1+2][i_2][i_0] * A[i_0+1][i_1][i_2-2] - A[i_0][i_1][i_2-3] - A[i_0][i_1][i_2-1] * 2;
            }
        }
        for (int i_3 = 2; i_3 < min(-i_0+PB_M-1, PB_P-1); i_3++) {
            for (int i_4 = 2; i_4 < PB_L-1; i_4++) {
                B[i_3+i_0][i_0][i_4-1][i_4-1] = C[i_3][i_4+1][i_0] + D[i_4][i_0-2] - C[i_4+2][i_0][i_3+1] * C[i_4+1][i_0][i_3-2] - B[i_3+i_0-1][i_0][i_4-1][i_4-1] - B[i_3+i_0+1][i_0+1][i_4-2][i_4-2] - B[i_3+i_0][i_0][i_4][i_4] + 2;
            }
        }
    }
#pragma endscop
...
kernel_3212152313_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
