...
void kernel_4432132315_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
...
#pragma scop
    ...
    for (int i_1 = 3; i_1 < PB_P; i_1++) {
        for (int i_2 = 2; i_2 < -i_1+PB_P; i_2++) {
            C[i_2+1][i_2+i_1-1] = F[i_2][i_1] - G[i_1][i_2+1][i_2+i_1] - 6;
            C[i_2+1][i_2+i_1-2] = F[i_2-2][i_1] + F[i_2][i_1] * F[i_1][i_1] * F[i_2][i_1] - C[i_2][i_2+i_1-3] * C[i_2+1][i_2+i_1-3] * 6;
        }
    }
        ...
        for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
            for (int i_5 = 1; i_5 < PB_Q; i_5++) {
                for (int i_6 = 2; i_6 < i_3; i_6++) {
                    D[i_4][i_6][i_5-1][i_3] = H[i_5][i_5][i_4+1][i_3] - H[i_4][i_5][i_6][i_3-1] - H[i_4+1][i_6-2][i_5][i_3] * D[i_5-1][i_6-1][i_4-1][i_3+1] * D[i_4][i_6][i_5-1][i_3-1] * D[i_4][i_6-1][i_3-1][i_5] - 1;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4432132315_07(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H)));
