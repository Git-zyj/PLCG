...
void kernel_3326212115_01(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_M; i_1++) {
        B[i_1-1] = D[i_1-2] * D[i_1-2] - B[i_1-2] - 2;
        B[i_1] = 5;
    }
#pragma endscop
...
kernel_3326212115_01(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
