...
void kernel_3222212215_08(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_2 = 0; i_2 < PB_M-3; i_2++) {
        for (int i_3 = max(1, i_2); i_3 < PB_L-3; i_3++) {
            for (int i_4 = 0; i_4 < PB_L-3; i_4++) {
                B[i_2+2][i_3+2][i_4] = C[i_2][i_3][i_4+2] * D[i_3][i_2][i_3] * A[i_3+3][i_4] - B[i_2+1][i_3+1][i_4] - B[i_2+3][i_3+3][i_4+1] + B[i_2+1][i_4+3][i_3-1] + 5;
            }
        }
    }
#pragma endscop
...
kernel_3222212215_08(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
