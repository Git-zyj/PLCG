...
void kernel_2312131223_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        A[i_0+1] = D[i_0] + D[i_0] - D[i_0] + A[i_0+2] + A[i_0] + B[i_0-1] + 3;
        B[i_0] = D[i_0-1] + D[i_0] * D[i_0] - D[i_0] - D[i_0] - B[i_0-2] + 2;
    }
...
kernel_2312131223_09(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
