...
void kernel_2424252223_03(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        B[i_0-2] = E[i_0] * E[i_0] * E[i_0+1] * 4;
    }
    for (int i_1 = 2; i_1 < PB_M-2; i_1++) {
        B[i_1] = F[i_1] * B[i_1-1] - B[i_1+1] - B[i_1+2] - B[i_1-2] - B[i_1-1] + 5;
    }
    for (int i_2 = 1; i_2 < PB_N-2; i_2++) {
        for (int i_3 = max(2, i_2); i_3 < min(PB_M, -i_2+PB_L-1); i_3++) {
            C[i_3+i_2][i_3+i_2] = G[i_3][i_2] + G[i_3-2][i_2] * H[i_3][i_2] + H[i_2][i_2] + F[i_3] - G[i_3-1][i_2+1] * C[i_3+i_2+1][i_3+i_2+1] + 3;
        }
        D[i_2-1] = E[i_2] - E[i_2] + E[i_2] * F[0] - E[i_2] * F[i_2-1] - E[i_2] * F[i_2+2] + 1;
    }
#pragma endscop
...
kernel_2424252223_03(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
