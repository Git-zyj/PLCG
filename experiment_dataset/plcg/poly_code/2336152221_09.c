...
void kernel_2336152221_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        A[i_0+2] = D[i_0+2] - D[i_0+2] * D[i_0] * D[i_0] - C[i_0-2] + C[i_0] - 4;
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            A[i_1+2] = E[i_1][i_0] - E[i_0][i_1] - D[i_1-2] * E[i_1-2][i_0] + E[i_1][i_0] * 2;
        }
    }
    for (int i_2 = 1; i_2 < PB_N-2; i_2++) {
        for (int i_3 = max(2, i_2); i_3 < min(PB_M, -i_2+PB_N-1); i_3++) {
            C[i_3] = E[i_3+i_2+1][i_3+2] - E[i_3][i_2+2] + D[i_3] - E[i_2-1][i_3] * E[i_3+i_2][i_3] - C[i_3-2] + 2;
        }
    }
#pragma endscop
...
kernel_2336152221_09(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
