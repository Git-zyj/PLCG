...
void kernel_3424212311_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
    ...
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        ...
        for (int i_1 = i_0; i_1 < PB_P; i_1++) {
            for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
                B[i_0+1][i_2][i_1+2] = F[i_2][i_0-2][i_1] * B[i_0+2][i_2-1][i_1+2] * B[i_0][i_2+1][i_1+2] - 4;
            }
        }
        for (int i_3 = 1; i_3 < min(PB_M+1, -i_0+PB_L); i_3++) {
            for (int i_4 = i_3; i_4 < PB_M-2; i_4++) {
                C[i_0][i_3+i_0][i_4+2] = F[i_3+2][i_4][i_3] * G[i_4-1][i_3] - B[i_0+1][i_3-1][i_4+2] + B[i_4+2][i_0+1][i_3+3] * C[i_0-1][i_3+i_0-1][i_4+2] + 2;
            }
        }
    }
...
kernel_3424212311_06(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
