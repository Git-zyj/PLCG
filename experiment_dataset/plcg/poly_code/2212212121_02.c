...
void kernel_2212212121_02(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 0; i_1 < min(PB_N, -i_0+PB_M-2); i_1++) {
            B[i_1][i_0] = B[i_1][i_0-2] - 4;
            B[i_1][i_0-2] = C[i_1+i_0+2][i_1+i_0+2] + 3;
        }
    }
#pragma endscop
...
kernel_2212212121_02(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
