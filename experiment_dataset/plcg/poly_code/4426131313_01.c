...
void kernel_4426131313_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,int wi,DATA_TYPE POLYBENCH_5D(I,xI,yI,zI,vI,wI,xi,yi,zi,vi,wi)){
    ...
    for (int i_2 = 2; i_2 < PB_L-1; i_2++) {
        for (int i_3 = 2; i_3 < PB_L+1; i_3++) {
            for (int i_4 = 1; i_4 < PB_N-2; i_4++) {
                A[i_4] = F[i_4][i_3-1] * G[i_4][i_2][i_3-1] * G[i_4+1][i_2][i_3] - 6;
                for (int i_5 = 1; i_5 < min(-i_2+PB_L, -i_4+PB_N); i_5++) {
                    D[i_4+1][i_2-1][i_3-1][i_5] = H[i_5-1][i_2][i_3][i_4] - I[i_3][i_2][i_4+1][i_5+i_2][i_3] + I[i_3][i_5][i_4][i_5+i_2][0] + H[i_5+i_4][i_2-1][i_3][i_2+1] - H[i_5][i_2-1][i_3-1][i_4-1] * D[i_4+2][i_2-2][i_3-1][i_5] * D[i_4+1][i_2-1][i_3-2][i_5] * D[i_4+2][i_2][i_3-1][i_5] + D[i_4+2][i_2-1][i_3-2][i_5] + D[i_4+1][i_2-1][i_3-1][i_5+1] + 5;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,wi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4426131313_01(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,wi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,wi,POLYBENCH_ARRAY(I)));
