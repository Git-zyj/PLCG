...
void kernel_3224211111_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        ...
        for (int i_3 = i_0; i_3 < -i_0+PB_P+2; i_3++) {
            for (int i_4 = 0; i_4 < min(-i_0+PB_P+1, -i_3+PB_N); i_4++) {
                B[i_4][i_4+i_0-1] = C[i_4+i_3][i_0][i_3-1] - B[i_0][i_3+i_0-2] * 6;
            }
        }
    }
#pragma endscop
...
kernel_3224211111_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
