...
void kernel_4234131313_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < PB_L; i_2++) {
                for (int i_3 = 1; i_3 < PB_L-1; i_3++) {
                    A[i_2][i_0][i_3][0] = C[i_2][i_1+1][i_0+1][i_3] * C[i_0-1][i_3][i_0][i_2] * A[i_2-1][i_0][i_3][0] * A[i_2+1][i_0+1][i_3-1][0] * A[i_2][i_0][i_3+1][0] * 5;
                }
            }
        }
        for (int i_4 = 0; i_4 < PB_L; i_4++) {
            for (int i_5 = 1; i_5 < min(i_4, -i_4+PB_L); i_5++) {
                A[i_4][i_0+1][i_5-1][0] = D[i_0][i_5+i_4][i_5] - D[i_5-1][i_0][i_4] + D[i_5][i_0][i_4] * D[i_5-1][i_5-1][i_0] - 2;
            }
        }
    }
#pragma endscop
...
kernel_4234131313_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
