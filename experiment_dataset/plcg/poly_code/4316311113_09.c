...
void kernel_4316311113_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
...
#pragma scop
        ...
        for (int i_1 = max(1, i_0); i_1 < PB_L-1; i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_L-1; i_2++) {
                for (int i_3 = 0; i_3 < min(i_0, -i_0+PB_L-1); i_3++) {
                    A[i_0][i_2+i_1+1][i_3][i_0] = A[i_1-1][i_3+i_0+1][i_2][i_1-1] - 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_P; i_4++) {
        for (int i_5 = 0; i_5 < -i_4+PB_M; i_5++) {
            B[i_5+i_4][i_4] = B[i_5+i_4][i_4-1] * 5;
        }
        for (int i_6 = 0; i_6 < min(i_4, PB_Q-1); i_6++) {
            C[i_6][i_4][i_6+1] = D[i_6][i_4] - 6;
        }
    }
#pragma endscop
...
kernel_4316311113_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
