...
void kernel_4332112123_00(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_M+1; i_1++) {
            for (int i_2 = 1; i_2 < PB_P; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_P; i_3++) {
                    B[i_1+i_0-1][i_2+1][i_2][i_3] = D[i_3][i_2][i_1][i_3+i_0] * 4;
                }
                for (int i_4 = 0; i_4 < -i_1+PB_M+1; i_4++) {
                    B[i_4+i_1-1][i_0+1][i_0][i_2-1] = B[i_1+i_0-1][i_2+1][i_2][i_4] * 5;
                }
            }
        }
    }
        ...
        for (int i_6 = 0; i_6 < PB_P; i_6++) {
            for (int i_7 = 0; i_7 < PB_L; i_7++) {
                for (int i_8 = 0; i_8 < min(PB_P, -i_5+PB_L); i_8++) {
                    C[i_5][i_8][i_8] = D[i_6+1][i_7][i_8+i_5][i_6] + 6;
                }
            }
        }
    }
...
kernel_4332112123_00(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D));
