...
void kernel_4334252123_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        A[i_0] = D[i_0-2] + D[i_0] - D[i_0-2] - D[i_0+2] * D[i_0] - D[i_0] - 1;
    }
    for (int i_1 = 2; i_1 < PB_M; i_1++) {
        B[i_1-2] = E[i_1] - E[i_1] * D[i_1] + D[i_1] * 6;
    }
    for (int i_2 = 0; i_2 < PB_P-1; i_2++) {
        for (int i_3 = 1; i_3 < i_2; i_3++) {
            for (int i_4 = 1; i_4 < PB_N; i_4++) {
                C[i_2][i_3+1][i_4] = F[i_3][i_2][i_2] * F[i_4-1][i_2][i_2+1] - G[i_4][i_3+1][i_2][i_2] - F[i_3][i_2][i_4] - C[i_2+2][i_3+1][i_4] * C[i_2][i_3-1][i_4] * 6;
            }
        }
    }
#pragma endscop
...
kernel_4334252123_07(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G));
