...
void kernel_4412252221_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        A[i_0] = E[i_0] + E[i_0] - F[i_0] - A[i_0-1] + 4;
        for (int i_1 = 1; i_1 < min(-i_0+PB_N, PB_L-2); i_1++) {
            D[i_1+i_0-1][i_1+1] = G[i_0][i_1+2] + G[i_0-2][0] - G[i_1][i_0+1] + G[i_1-1][i_0+1] + H[i_0+2][i_1+i_0] + E[i_1] - G[i_1][i_0] - G[i_0][i_1] * 6;
            for (int i_2 = 0; i_2 < min(-i_1+PB_M, PB_L); i_2++) {
                D[i_2+i_1-1][i_1+1] = I[i_2][i_2][i_0] + G[i_2+i_1][i_0-1] - I[i_1][i_2][i_0-2] - 6;
            }
        }
    }
    for (int i_3 = 3; i_3 < PB_P+2; i_3++) {
        for (int i_4 = 1; i_4 < min(-i_3+PB_M+1, PB_L-1); i_4++) {
            D[i_4+i_3-1][i_3+1] = H[i_4+1][i_3+2] + I[i_4][i_4+1][i_3-2] + H[i_3][i_4-1] - D[i_4+i_3-3][i_3] - D[i_4+i_3-3][i_3-1] + 6;
        }
    }
#pragma endscop
...
kernel_4412252221_04(xa,POLYBENCH_ARRAY(A), xd,yd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
