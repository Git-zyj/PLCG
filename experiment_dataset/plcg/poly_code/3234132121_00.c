...
void kernel_3234132121_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-3; i_0++) {
        A[i_0+2] = C[i_0] * C[i_0+1] + A[i_0+3] * 2;
    }
    for (int i_1 = 1; i_1 < PB_L-2; i_1++) {
        A[i_1+2] = C[i_1] + C[i_1] - C[i_1-1] + C[i_1-1] * 1;
    }
#pragma endscop
...
kernel_3234132121_00(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
