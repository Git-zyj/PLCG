...
void kernel_4424151113_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg)){
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < min(-i_0+PB_M, -i_1+PB_M); i_2++) {
                for (int i_3 = 1; i_3 < PB_N; i_3++) {
                    A[i_2+i_0][i_1][i_3-1][i_2] = E[i_3][i_2][i_0+1][i_2+i_1] * E[i_1][i_0][i_3][i_2] - E[i_0+1][i_2-1][i_1-1][i_3] + E[i_2][i_1][i_3][i_0] - F[i_3][i_0][i_1-1] - 1;
                }
            }
        }
        for (int i_4 = 2; i_4 < -i_0+PB_M; i_4++) {
            B[i_0][i_4] = G[i_0+1][i_4-1] + G[i_4][i_0-1] - G[i_4-1][i_0+1] * G[i_4][i_0] + G[i_4-1][i_0-1] + G[i_4+i_0][i_0-1] + G[0][i_0-1] * B[i_0-1][i_4] * B[i_0][i_4+1] - 5;
            for (int i_5 = 0; i_5 < i_4; i_5++) {
                for (int i_6 = 1; i_6 < PB_N; i_6++) {
                    A[i_6+i_4-2][i_5][i_0-2][i_6-1] = F[i_5][i_6][i_4] * E[i_6][i_4-1][i_0][i_5] * E[i_5][i_6][i_6][1] - 4;
                }
            }
        }
        for (int i_7 = 1; i_7 < PB_M-1; i_7++) {
            for (int i_8 = 2; i_8 < -i_0+PB_N; i_8++) {
                for (int i_9 = 1; i_9 < -i_0+PB_M; i_9++) {
                    A[i_9+i_0][i_7-1][i_8-2][i_9] = E[i_0][i_0][i_7+1][i_9] + E[i_9-1][i_8+i_0][i_7][i_7] * E[i_0+1][i_8][i_8-1][i_7] - E[i_8][i_9-1][i_0-1][0] * 4;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4424151113_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G)));
