...
void kernel_4216111325_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
        ...
        for (int i_1 = 1; i_1 < min(-i_0+PB_L, PB_M-2); i_1++) {
            for (int i_2 = 0; i_2 < i_1; i_2++) {
                for (int i_3 = 0; i_3 < min(PB_Q-1, -i_1+PB_P); i_3++) {
                    A[i_0][i_2+i_1][i_3][i_2+1] = A[i_2][i_1+i_0][i_3][i_0+2] - A[i_2+1][i_3+i_1][i_0][i_3+1] * A[i_0][i_2+i_1-1][i_3][i_2+1] + 3;
                }
            }
            B[i_1] = C[i_1][i_1+i_0] * B[i_1+2] - B[i_1-1] * 3;
        }
    }
#pragma endscop
...
kernel_4216111325_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
