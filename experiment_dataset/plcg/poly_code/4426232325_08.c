...
void kernel_4426232325_08(int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        C[i_0+1][i_0+1] = E[i_0] - E[i_0] * E[i_0] - F[0] * 6;
        B[i_0] = F[i_0+1] * B[i_0+2] + B[i_0-2] * 5;
    }
    for (int i_1 = 0; i_1 < PB_M-2; i_1++) {
        for (int i_2 = 1; i_2 < i_1; i_2++) {
            C[i_1][i_1] = F[i_2-1] + G[i_1][i_2-1] * C[i_2+1][i_2+1] * C[i_1+2][i_1+2] * 1;
        }
    }
    for (int i_3 = 1; i_3 < PB_M-2; i_3++) {
        for (int i_4 = i_3; i_4 < -i_3+PB_M; i_4++) {
            C[i_3+2][i_3+2] = H[i_4+i_3][i_3] - E[i_4] + I[i_4+i_3][i_3-1][i_4-1] + G[i_3][2] - G[i_3][i_4] + C[i_3][i_3] * 5;
        }
    }
#pragma endscop
...
kernel_4426232325_08(xc,yc,POLYBENCH_ARRAY(C), xb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
