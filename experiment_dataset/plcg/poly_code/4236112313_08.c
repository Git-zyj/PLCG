...
void kernel_4236112313_08(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M+2; i_0++) {
        for (int i_1 = 0; i_1 < min(i_0, -i_0+PB_M+2); i_1++) {
            for (int i_2 = i_0; i_2 < PB_L-1; i_2++) {
                B[i_1+i_0-2][i_2+1][i_0-2] = C[i_1][i_2-2] - 4;
            }
        }
    }
    for (int i_3 = 0; i_3 < PB_M; i_3++) {
        for (int i_4 = max(1, i_3); i_4 < PB_M; i_4++) {
            for (int i_5 = 0; i_5 < PB_L-2; i_5++) {
                for (int i_6 = 1; i_6 < min(min(-i_3+PB_M, -i_4+PB_M), i_3); i_6++) {
                    B[i_6+i_4-1][i_5+1][i_4-1] = D[i_6+i_3][i_5][i_6-1] + B[i_6+i_4][i_5][i_4] + B[i_6+i_4-1][i_5+2][i_6-1] - B[i_6+i_4-1][i_5][i_4-1] * 4;
                }
            }
        }
    }
...
kernel_4236112313_08(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
