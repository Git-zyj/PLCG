...
void kernel_2124111213_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N+1; i_0++) {
        for (int i_1 = PB_M - 1; i_1 >= 2; i_1--) {
            A[i_0-1] = B[i_1] + A[i_1-2] * A[i_1] - 5;
        }
    }
#pragma endscop
...
kernel_2124111213_07(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
