...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_M-2; i_1++) {
        B[i_1] = D[i_1+2] + E[i_1] + F[i_1] + E[i_1] * B[i_1-1] + B[i_1+1] + 6;
    }
    for (int i_2 = 1; i_2 < PB_M; i_2++) {
        for (int i_3 = 0; i_3 < PB_M; i_3++) {
            for (int i_4 = max(2, i_2); i_4 < -i_2+PB_M; i_4++) {
                C[i_3][i_2+1][i_4] = G[i_4][i_2][0] + H[i_3][i_4-2] * I[i_4][i_2-1][i_3] - I[i_4][i_2][i_3] + G[i_4+i_2][i_3][0] - C[i_3][i_2+2][i_4] * 1;
            }
        }
    }
#pragma endscop
...
kernel_3324332113_07(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
