...
void kernel_4312112123_00(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
        ...
        for (int i_1 = 1; i_1 < PB_P-1; i_1++) {
            for (int i_2 = 2; i_2 < min(-i_1+PB_M, i_0); i_2++) {
                ...
                for (int i_3 = 0; i_3 < PB_P-1; i_3++) {
                    A[i_2-2][i_3+1][i_1] = D[i_2+i_1][i_0][i_3+1][i_3] + A[i_1-1][i_2+1][i_3+2] * 6;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < -i_4+PB_P; i_5++) {
            for (int i_6 = 0; i_6 < PB_L; i_6++) {
                for (int i_7 = 0; i_7 < PB_L; i_7++) {
                    C[i_4-2][i_6][i_7][i_5] = E[i_6][i_5+i_4][i_7][i_6][i_5-1] * F[i_4-1][i_5][i_6] + 1;
                }
            }
        }
    }
...
kernel_4312112123_00(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
