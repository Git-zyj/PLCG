...
void kernel_4126112123_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb)){
        ...
        for (int i_1 = 0; i_1 < -i_0+PB_N-3; i_1++) {
            for (int i_2 = 0; i_2 < i_1; i_2++) {
                for (int i_3 = 0; i_3 < -i_0+PB_N-2; i_3++) {
                    A[i_3+i_0+2][i_1][i_2] = B[i_2][i_0][i_1] + A[i_1+i_0+3][i_3][i_2] + 1;
                }
            }
        }
    }
...
kernel_4126112123_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B));
