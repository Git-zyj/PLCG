...
void kernel_2324212125_04(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
kernel_2324212125_04(xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D));
