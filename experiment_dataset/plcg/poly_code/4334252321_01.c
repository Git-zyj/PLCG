...
void kernel_4334252321_01(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
        ...
        for (int i_1 = 1; i_1 < min(-i_0+PB_M+1, PB_M-1); i_1++) {
            for (int i_2 = 0; i_2 < i_1; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_2+PB_L, -i_1+PB_M-1); i_3++) {
                    A[i_3+i_1][i_2][i_2+2][i_0] = D[i_1][i_3][0][i_0] - D[i_3][i_2][i_1][0] - E[i_1+i_0-1][i_3+i_2][i_2][i_3] - A[i_3+i_1][i_2][i_2+2][i_0-1] * A[i_3+i_1+1][i_2][i_2+2][i_0+2] * A[i_3+i_1-1][i_2][i_2+2][i_0] - 2;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L; i_4++) {
        for (int i_5 = 2; i_5 < min(PB_L-4, -i_4+PB_M); i_5++) {
            for (int i_6 = 0; i_6 < -i_5+PB_L-4; i_6++) {
                B[i_4][i_6+i_5+2][i_5+1] = F[i_6+1][i_6+i_5] * G[i_6+i_5][i_4-2] * D[i_6][i_5][i_4-1][i_6] - H[i_5][i_6][0] - H[i_5+i_4][i_4][i_6] * G[i_6+1][i_5+i_4] * B[i_4][i_6+i_5+4][i_5+1] - B[i_4][i_6+i_5+4][i_5+3] * 1;
            }
            for (int i_7 = 0; i_7 < min(-i_5+PB_L-3, -i_4+PB_L); i_7++) {
                B[i_4-1][i_7+i_5+3][i_7+2] = F[i_7][i_5] - I[i_5-1][i_7+i_4-1][i_7+1] * I[i_5-2][i_4-1][i_7] - I[i_4][i_7+i_5][i_7] + H[i_5][i_7+i_4][i_7+i_4-2] * 5;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4334252321_01(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
