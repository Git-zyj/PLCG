...
void kernel_4234111113_02(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_0 = 0; i_0 < PB_N-1; i_0++) {
        for (int i_1 = max(1, i_0); i_1 < PB_N; i_1++) {
            ...
            for (int i_4 = i_1; i_4 < PB_N; i_4++) {
                B[i_0+1][i_1][i_4] = C[i_1][i_4] - D[i_4][i_0][i_1] - B[i_0+1][i_1-1][i_4] + 6;
            }
        }
    }
#pragma endscop
...
kernel_4234111113_02(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
