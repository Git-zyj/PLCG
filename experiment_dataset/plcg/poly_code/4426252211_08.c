...
void kernel_4426252211_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,int wd,DATA_TYPE POLYBENCH_5D(D,xD,yD,zD,vD,wD,xd,yd,zd,vd,wd),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl)){
        ...
        for (int i_1 = i_0; i_1 < -i_0+PB_P; i_1++) {
            for (int i_2 = i_1; i_2 < -i_0+PB_P; i_2++) {
                for (int i_3 = 1; i_3 < PB_M; i_3++) {
                    A[i_3-1][i_1+i_0][i_2][i_1] = E[i_1][i_3][i_2-1][i_1+2][i_0-2] * F[i_3][i_2][i_0][i_1] - G[i_1][i_2+i_0][i_0-2][i_3+2] - F[i_3][i_0][i_1+i_0][i_2+1] - F[i_1][i_3-1][i_0-1][i_2] + F[i_3][i_1-2][i_2][i_0] * A[i_2-1][i_1+i_0-1][i_3][i_1-1] * A[i_2-2][i_1+i_0-1][i_3-1][i_1] * 3;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L-2; i_4++) {
        B[i_4] = H[i_4-2] * H[i_4] + I[i_4+2] * B[i_4+1] * 4;
        for (int i_5 = 2; i_5 < -i_4+PB_P; i_5++) {
            for (int i_6 = 2; i_6 < PB_M-3; i_6++) {
                C[i_5+2][i_6-2] = J[i_6][i_5][i_4] * F[2][i_6][i_5+i_4][i_6] - J[i_5][i_6][i_4+2] + K[i_5-2][i_6] - J[i_5+1][i_4][0] - L[i_6+i_5][i_4][i_5] + C[i_6+3][i_5-2] - 2;
                for (int i_7 = 2; i_7 < PB_Q-3; i_7++) {
                    D[i_7-2][i_4+1][i_6+1][i_4-2][i_5+2] = F[i_7][i_6][i_4][i_5+1] - G[i_5][i_7][i_4][i_6] + G[i_5-2][i_6][i_6][i_4] * C[i_5+2][i_6-2] - D[i_4-2][i_6+1][i_5+1][i_6-2][i_7+3] * 1;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,wd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4426252211_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,wd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,zj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L));
