...
void kernel_4316211321_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
...
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-3; i_0++) {
        ...
        A[i_0][i_0-1] = A[i_0][i_0-1] * A[i_0-1][i_0-2] + A[i_0+1][i_0] * 2;
        for (int i_2 = 0; i_2 < min(i_0, -i_0+PB_L-3); i_2++) {
            C[i_0][i_2+i_0+1] = E[i_2][i_0] * C[i_0][i_2+i_0+2] - C[i_0][i_2+i_0+3] + C[i_0+2][i_2+i_0+2] - 2;
        }
    }
#pragma endscop
...
kernel_4316211321_04(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
