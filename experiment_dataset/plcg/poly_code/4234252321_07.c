        ...
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < i_1; i_2++) {
                for (int i_3 = max(2, i_1); i_3 < PB_L-2; i_3++) {
                    A[i_0][i_1][0][i_3] = C[i_3-2][i_2][i_3][i_1] * D[i_3][i_2][i_0-2][i_1] + D[i_1][0][i_3+1][i_2] - C[i_3][i_2][i_0+2][i_1+1] - A[i_0][i_1][0][i_3-2] - A[i_1][i_3+2][0][i_2] - A[i_2][i_3-2][0][i_1] * 5;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-2; i_4++) {
        B[i_4] = E[i_4+1] * E[i_4+2] + E[i_4-1] * F[i_4][i_4] + E[i_4+1] - B[i_4-2] - B[i_4+1] + 5;
    }
#pragma endscop
...
kernel_4234252321_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
