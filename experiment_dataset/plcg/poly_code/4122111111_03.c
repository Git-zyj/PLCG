...
void kernel_4122111111_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 0; i_1 < min(PB_M, -i_0+PB_L-2); i_1++) {
            A[i_1+i_0] = B[i_1][i_0+1] - A[i_1+i_0+2] - 1;
        }
    }
#pragma endscop
...
kernel_4122111111_03(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B));
