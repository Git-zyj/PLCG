    ...
    for (int i_0 = 1; i_0 < PB_P; i_0++) {
        for (int i_1 = i_0; i_1 < PB_Q; i_1++) {
            for (int i_2 = 2; i_2 < min(-i_1+PB_L, i_1); i_2++) {
                A[i_0+1][i_1-1][i_2] = C[i_2+i_1][i_0-1][0] + D[i_0+1][i_1][i_2] - A[i_1+2][i_0-1][i_2] + A[i_1+1][i_2-2][i_0] * 6;
            }
        }
    }
...
kernel_3236211215_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
