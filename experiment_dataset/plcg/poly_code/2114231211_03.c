...
void kernel_2114231211_03(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        for (int i_1 = 0; i_1 < PB_P-1; i_1++) {
            A[i_0][i_1] = B[i_1+1] * B[i_1] + B[i_0-1] * A[i_0][i_1+1] * A[i_0-1][i_1] - 4;
        }
    }
#pragma endscop
...
kernel_2114231211_03(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
