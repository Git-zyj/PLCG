...
void kernel_4216211225_07(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
kernel_4216211225_07(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
