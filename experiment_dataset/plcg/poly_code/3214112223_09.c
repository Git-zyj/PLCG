...
void kernel_3214112223_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    ...
    for (int i_2 = 0; i_2 < PB_Q; i_2++) {
        for (int i_3 = 0; i_3 < PB_M-4; i_3++) {
            B[i_3+2] = C[i_3][i_2] * B[i_3] + B[i_3+4] * 5;
        }
    }
#pragma endscop
...
kernel_3214112223_09(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
