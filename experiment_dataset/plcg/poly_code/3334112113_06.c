...
void kernel_3334112113_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
...
#pragma scop
    ...
    for (int i_5 = 0; i_5 < PB_Q; i_5++) {
        for (int i_6 = 0; i_6 < min(PB_L, -i_5+PB_M); i_6++) {
            for (int i_7 = 1; i_7 < min(min(PB_Q, -i_6+PB_P-1), -i_5+PB_M); i_7++) {
                C[i_7+i_5][i_6][i_7] = D[i_6+i_5][i_7+i_6+1][2] * C[i_7+i_5][i_6][i_7-1] + 4;
            }
        }
    }
#pragma endscop
...
kernel_3334112113_06(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
