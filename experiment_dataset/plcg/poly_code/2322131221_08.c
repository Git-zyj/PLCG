...
void kernel_2322131221_08(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        C[i_0] = D[i_0+1] * D[i_0-1] + 5;
        C[i_0+2] = D[i_0-1] * D[0] - D[i_0] * D[i_0-1] * 6;
    }
    for (int i_1 = 2; i_1 < PB_M; i_1++) {
        C[i_1] = D[i_1-1] - D[i_1] - C[i_1+2] - C[i_1-2] - 5;
    }
#pragma endscop
...
kernel_2322131221_08(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
