...
void kernel_4314332211_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi)){
...
#pragma scop
    ...
    for (int i_1 = 3; i_1 < PB_M-2; i_1++) {
        for (int i_2 = 2; i_2 < PB_M-2; i_2++) {
            B[i_2-2][i_1-2] = F[i_1][i_2] * G[i_2][i_1+2] - B[i_2-2][i_1-3] * B[i_2-1][i_1-2] - 5;
            for (int i_3 = 2; i_3 < -i_2+PB_L; i_3++) {
                for (int i_4 = 0; i_4 < -i_2+PB_M; i_4++) {
                    C[i_1-1][i_4+2][i_3+i_2-1][i_3-1] = H[i_2+2][i_1][i_3][0] * H[i_3][i_2+1][i_4+2][i_1-1] * I[i_4+i_2][i_1][i_3+2][0] - I[i_2][i_1][i_4+2][i_3+2] + C[i_1-2][i_4+2][i_3+i_2-1][i_3-2] + C[i_1-1][i_4+2][i_3+i_2][i_2-1] * 3;
                }
            }
        }
    }
...
kernel_4314332211_04(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,vi,POLYBENCH_ARRAY(I));
