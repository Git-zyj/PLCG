        ...
        for (int i_2 = 0; i_2 < PB_M-2; i_2++) {
            for (int i_3 = 2; i_3 < min(-i_2+PB_Q, PB_M-2); i_3++) {
                for (int i_4 = 2; i_4 < i_1; i_4++) {
                    C[i_2][i_1][i_3][i_4] = F[i_1][i_4+1][i_3][i_2][i_3+i_2] - G[i_3][i_2][i_4][i_1] - H[i_2][i_3+2][i_4-2][i_1] + I[i_1-2][i_2][i_3] - H[i_4][i_1][i_3-1][i_2] - C[i_2][i_1][i_3-2][i_4-1] + C[i_2][i_1][i_3-2][i_4+2] * C[i_2+2][i_1+2][i_3][i_4] - 4;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4324332223_07(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
