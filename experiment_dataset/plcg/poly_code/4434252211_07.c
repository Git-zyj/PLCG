...
void kernel_4434252211_07(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_Q; i_0++) {
        for (int i_1 = 1; i_1 < min(PB_Q, -i_0+PB_L); i_1++) {
            for (int i_2 = 0; i_2 < PB_Q; i_2++) {
                A[i_2][i_0+2][i_1+i_0][0] = E[i_0][i_2+i_1][i_1+2][i_2] - F[i_2][i_1+i_0][0] + G[i_1-1][i_2] - A[i_0][i_2+2][i_2+i_1-1][0] - A[i_0][i_2+1][i_2+i_1-1][0] - 1;
            }
        }
    }
    for (int i_3 = 2; i_3 < PB_N+2; i_3++) {
        for (int i_4 = 0; i_4 < min(-i_3+PB_L, PB_Q); i_4++) {
            for (int i_5 = 2; i_5 < i_4; i_5++) {
                B[i_5][i_3+1][i_4+i_3][i_4+2] = E[i_4][i_3+1][i_5-2][i_4+2] - H[i_5][i_4] + I[i_3][i_5][i_4] - F[i_3+1][i_4][i_5] * F[i_4+i_3][i_4+i_3][i_5] - B[i_5][i_3+2][i_4+i_3][i_4+1] - B[i_5][i_3][i_4+i_3][i_4+3] * 3;
            }
        }
        C[i_3] = J[i_3-2] - K[i_3-2] * J[i_3+1] - H[i_3][0] - J[i_3-2] * C[i_3+1] + C[i_3-1] - 1;
        for (int i_6 = 2; i_6 < min(PB_N, i_3); i_6++) {
            D[i_6] = K[i_6] - H[i_6-2][i_3] - G[i_6][i_3+2] * H[i_3][i_3-1] * H[i_6+2][i_3+1] * C[i_6+1] - C[i_3] + 1;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4434252211_07(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K));
