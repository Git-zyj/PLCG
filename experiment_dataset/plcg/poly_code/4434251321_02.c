...
void kernel_4434251321_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,int zk,int vk,int wk,DATA_TYPE POLYBENCH_5D(K,xK,yK,zK,vK,wK,xk,yk,zk,vk,wk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        A[i_0] = E[i_0] - F[i_0] - F[i_0] + E[i_0] - A[i_0-2] - A[i_0-1] * 5;
        for (int i_1 = 1; i_1 < min(i_0, PB_L-1); i_1++) {
            for (int i_2 = 3; i_2 < PB_P; i_2++) {
                for (int i_3 = 0; i_3 < PB_P-1; i_3++) {
                    B[i_0-1][i_1][i_2][i_1-1] = G[i_2-1][i_0-1][i_1-1][i_3+1] * H[i_1+1][i_2][i_3][i_1] * H[i_1][i_2-1][i_0][i_3] * I[i_3][i_0][i_1] + B[i_2-3][i_1][i_3+1][i_1-1] - 5;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L; i_4++) {
        for (int i_5 = 0; i_5 < -i_4+PB_L+1; i_5++) {
            for (int i_6 = 1; i_6 < PB_L; i_6++) {
                C[i_4][i_5][i_6] = J[i_6][i_4-1] + I[i_6][i_5+i_4-1][i_4-1] * J[i_6][i_5+1] - I[i_6+i_5][i_4][i_4] - I[i_6][i_4][i_5+1] + C[i_6][i_5+1][i_4+1] - C[i_6][i_5][i_4-1] + C[i_4][i_5][i_6-1] + 3;
            }
        }
        for (int i_7 = 1; i_7 < -i_4+PB_P+1; i_7++) {
            for (int i_8 = 1; i_8 < PB_L; i_8++) {
                for (int i_9 = 2; i_9 < min(min(i_7, -i_8+PB_Q), PB_L-2); i_9++) {
                    D[i_7][i_8][i_9][i_4] = G[i_8][i_9][i_7][i_4-1] * K[i_8-1][i_7][i_9][i_7+i_4-1][i_8] + H[i_9-1][i_8][i_4][i_7] - H[i_8+i_7-1][i_9+i_8][i_4+1][i_7] + G[i_9+1][0][i_7-1][i_4] + G[i_8][0][i_4][i_4-1] - L[i_8][i_7-1][i_4] + D[i_7-1][i_9][i_8-1][i_4] - D[i_7-1][i_8-1][i_9+2][i_4-2] - D[i_4][i_8][i_9-2][i_7] * 4;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,wk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4434251321_02(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,wk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,wk,POLYBENCH_ARRAY(K), xl,yl,zl,POLYBENCH_ARRAY(L)));
