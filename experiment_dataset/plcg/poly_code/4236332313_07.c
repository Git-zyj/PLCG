...
void kernel_4236332313_07(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
        ...
        for (int i_1 = 0; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_0+PB_M, i_0); i_2++) {
                for (int i_3 = 1; i_3 < PB_M-2; i_3++) {
                    B[i_1][i_0+2][i_3-1][i_2] = C[i_1+2][i_2][i_3+1][i_0] * D[i_2+i_0][i_1][i_3+1][i_1] * C[i_3+2][i_0][i_1+2][i_2] + 2;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < PB_N-1; i_5++) {
            for (int i_6 = i_5; i_6 < min(-i_5+PB_Q, PB_L-1); i_6++) {
                for (int i_7 = 0; i_7 < PB_M; i_7++) {
                    B[i_6][i_5+1][i_7][i_4] = C[i_7][i_4-1][i_4][i_6+i_5] - E[i_7][i_6+1][i_6] + B[i_7][i_5][i_6][i_4+1] + B[i_6][i_5][i_7][i_4] + B[i_6+1][i_7+1][i_5-1][i_4] * 6;
                }
            }
        }
    }
...
kernel_4236332313_07(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
