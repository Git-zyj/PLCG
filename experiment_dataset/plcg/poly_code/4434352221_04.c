...
void kernel_4434352221_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,int zk,int vk,DATA_TYPE POLYBENCH_4D(K,xK,yK,zK,vK,xk,yk,zk,vk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-2; i_0++) {
        A[i_0] = E[i_0+2] * F[i_0] + F[i_0] + F[i_0] - F[i_0-1] + A[i_0+2] + 6;
    }
    for (int i_1 = 2; i_1 < PB_P-2; i_1++) {
        for (int i_2 = 6; i_2 < min(-i_1+PB_Q+2, i_1); i_2++) {
            for (int i_3 = 2; i_3 < min(-i_2+PB_Q+3, -i_1+PB_Q); i_3++) {
                for (int i_4 = max(-i_2+6, 2); i_4 < PB_P-1; i_4++) {
                    B[i_4][i_3][i_4][i_2+i_1-2] = G[i_2][i_4+i_3-2][i_1] + H[i_3][i_2][i_4][i_1] * I[i_4][i_2][i_2] + J[i_2][i_4+1][i_3+i_1][i_1] * K[i_1][i_4-1][i_3][0] - B[i_4-2][i_1][i_4-2][i_3+i_2-3] + B[i_1][i_3][i_1][i_4+i_2-6] - 2;
                }
            }
            for (int i_5 = 0; i_5 < -i_2+PB_L; i_5++) {
                for (int i_6 = 0; i_6 < PB_P-2; i_6++) {
                    C[i_5][i_6][i_1-2][i_2] = H[i_2][i_6+2][i_1][i_6+1] + H[i_1][i_6+i_5][i_1][2] - J[i_5+i_2][i_6+2][i_1][i_1] + H[i_5+i_2-2][i_6+2][i_1][i_5] - G[i_5+i_2][i_6][i_1+2] * 2;
                }
            }
        }
        for (int i_7 = 1; i_7 < PB_N; i_7++) {
            A[i_7] = E[i_7] + F[i_1+2] * L[i_7][i_1] + A[i_7-1] * 4;
        }
    }
#pragma endscop
...
init_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4434352221_04(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,zj,vj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L)));
