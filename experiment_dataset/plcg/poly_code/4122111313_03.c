...
void kernel_4122111313_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb)){
        ...
        for (int i_1 = 1; i_1 < PB_N; i_1++) {
            for (int i_2 = 0; i_2 < PB_P; i_2++) {
                for (int i_3 = 1; i_3 < PB_P; i_3++) {
                    A[i_1-1][i_3][0] = B[i_1][i_3-1][i_2] - A[i_1][i_3][0] * A[i_1-1][i_2+1][0] - A[i_1-1][i_3+1][0] - 1;
                }
            }
        }
    }
...
kernel_4122111313_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B));
