        ...
        for (int i_1 = 0; i_1 < -i_0+PB_P-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
                for (int i_3 = 0; i_3 < PB_Q; i_3++) {
                    A[i_2][i_1+i_0+1][i_1][i_3] = C[i_1][i_2+1][i_1][i_0] * D[i_2][i_2][i_3][i_1] * 3;
                }
            }
        }
        B[i_0] = E[i_0-1] - E[i_0] + E[i_0+2] + B[i_0+2] + B[i_0+1] * B[i_0-2] * B[i_0-1] * B[i_0-1] * 4;
    }
#pragma endscop
...
kernel_4214232321_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
