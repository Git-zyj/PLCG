...
void kernel_4226311223_02(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
    ...
    for (int i_3 = 0; i_3 < PB_M-1; i_3++) {
        for (int i_4 = 2; i_4 < PB_M; i_4++) {
            for (int i_5 = 2; i_5 < i_4; i_5++) {
                B[i_4][i_5][i_5] = C[i_3+1][i_4+1] + A[i_4-2][i_5+1] - B[i_4][i_5-2][i_5-2] + B[i_4][i_5-1][i_5-1] - B[i_4][i_5+2][i_5+2] - 5;
            }
        }
    }
#pragma endscop
...
kernel_4226311223_02(xa,ya,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
