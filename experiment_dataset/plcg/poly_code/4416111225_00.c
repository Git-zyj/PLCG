...
void kernel_4416111225_00(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = 2; i_2 < i_1; i_2++) {
                for (int i_3 = 0; i_3 < i_2; i_3++) {
                    A[i_3][i_1][i_2-1][i_0-1] = A[i_3+1][i_1-1][i_0-1][i_2-2] * D[i_1+i_0][i_0][i_2-1][i_2+1] * 5;
                }
            }
            B[i_1] = E[i_1+1][i_0] + B[i_1+1] - 3;
        }
    }
        ...
        for (int i_5 = 0; i_5 < -i_4+PB_M; i_5++) {
            for (int i_6 = i_4; i_6 < PB_Q+1; i_6++) {
                for (int i_7 = 1; i_7 < PB_Q-3; i_7++) {
                    D[i_5+i_4][i_5][i_7-1][i_7+1] = A[i_4][i_7][i_6-1][i_5] + D[i_5+i_4][i_5][i_7+1][i_7+3] - 6;
                }
            }
        }
    }
...
kernel_4416111225_00(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F));
