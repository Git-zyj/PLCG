...
void kernel_4432252311_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        A[i_0-2] = E[i_0-1] + F[i_0] * E[i_0] - A[i_0-1] + 5;
        B[i_0] = F[i_0] * F[i_0] - F[i_0] - E[i_0-1] - F[i_0] - A[i_0-1] - B[i_0+1] + 4;
    }
    for (int i_1 = 1; i_1 < PB_N-1; i_1++) {
        C[i_1] = F[i_1] * E[i_1] - E[i_1] + E[i_1] * E[i_1-1] + C[i_1+1] * C[i_1-1] * C[i_1-1] + 5;
        for (int i_2 = 1; i_2 < -i_1+PB_Q-2; i_2++) {
            for (int i_3 = 2; i_3 < -i_1+PB_M; i_3++) {
                for (int i_4 = 1; i_4 < -i_3+PB_Q; i_4++) {
                    D[i_3+i_2][1][i_4+i_3][i_2] = G[i_4-1][i_1][i_3-2][i_1] + H[i_4-1][i_4][i_2][i_1+2] * G[i_4][i_3][i_1][i_2] - H[i_4][i_1][i_2+1][i_3] + D[i_3+i_2][1][i_4+i_3-1][i_2] - D[i_3+i_2-1][1][i_4+i_3-1][i_2] + D[i_3+i_1][1][i_2+i_1+2][i_3-1] + 4;
                }
            }
        }
    }
...
init_array(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4432252311_01(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H)));
