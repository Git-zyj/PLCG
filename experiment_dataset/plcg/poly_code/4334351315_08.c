...
#pragma scop
        ...
        for (int i_1 = 3; i_1 < -i_0+PB_Q; i_1++) {
            for (int i_2 = max(2, i_0); i_2 < -i_0+PB_L; i_2++) {
                for (int i_3 = 2; i_3 < -i_2+PB_M; i_3++) {
                    A[i_2+i_1-1][i_0][i_3][i_2-1] = D[i_3+i_2][i_2][i_0-1][i_1+i_0] * E[i_3][i_2+i_0][i_1] - A[i_3+i_2-2][i_1][i_0][i_3-2] * A[i_2+i_1-1][i_0+1][i_3][i_2-1] * A[i_2+i_1-3][i_0-1][i_3][i_2-2] - 5;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 1; i_5 < min(i_4, -i_4+PB_L-1); i_5++) {
            C[i_5+1] = F[i_4+1][i_5+1] * G[i_5][i_4+1] - F[i_5+i_4][i_5] + H[i_5][i_4+1] - F[i_5][i_4] * F[i_5-1][i_4] - F[i_5][i_4] * G[i_5-1][i_4+1] + F[i_5][i_4+1] * G[i_5+i_4-1][i_5+i_4+1] - C[i_5] + C[i_5+1] * 1;
        }
    }
    for (int i_6 = 1; i_6 < PB_M-1; i_6++) {
        C[i_6] = I[i_6+1] + G[i_6][i_6-1] + J[i_6] * C[i_6-1] - 1;
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4334351315_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J)));
