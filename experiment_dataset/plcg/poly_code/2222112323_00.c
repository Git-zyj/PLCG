...
void kernel_2222112323_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        B[i_0+1] = C[2] + B[i_0+1] - 4;
    }
...
kernel_2222112323_00(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
