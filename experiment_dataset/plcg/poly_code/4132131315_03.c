...
void kernel_4132131315_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_P; i_0++) {
        for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
            A[0] = B[i_1][i_0] - B[i_1+1][i_0] + B[i_1-1][i_0] + A[0] * A[0] * A[0] + 3;
        }
    }
#pragma endscop
...
kernel_4132131315_03(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B));
