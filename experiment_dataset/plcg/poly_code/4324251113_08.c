...
void kernel_4324251113_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_M; i_2++) {
                for (int i_3 = 1; i_3 < PB_M; i_3++) {
                    A[i_2][i_3+1][i_3][i_0-1] = D[i_3][i_0][i_2+i_1-1][i_0] - D[i_3][i_1+i_0][i_3+i_2][i_1] * E[i_2+i_0][i_3][i_3-1][i_1] + F[i_2+i_1][i_0][i_3] + D[i_2-1][i_1-1][i_0][0] * A[i_2][i_3+1][i_3][i_0] - 5;
                }
            }
            C[i_0][i_1-1] = G[i_1][i_0] * H[i_0][i_1] * G[i_1][i_0] * H[i_1-1][i_0] * H[i_1][i_0] - I[i_1-1] - 2;
        }
        for (int i_4 = 0; i_4 < -i_0+PB_M+1; i_4++) {
            C[i_0][i_4] = H[i_4][i_4] - G[i_4][i_0+1] * H[i_4][i_0] * H[i_4+i_0-1][0] + C[i_0][i_4+1] * 6;
        }
    }
#pragma endscop
...
kernel_4324251113_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
