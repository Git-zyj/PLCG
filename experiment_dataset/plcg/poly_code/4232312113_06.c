...
void kernel_4232312113_06(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
    ...
    for (int i_1 = 0; i_1 < PB_L; i_1++) {
        for (int i_2 = 0; i_2 < PB_N; i_2++) {
            for (int i_3 = max(1, i_1); i_3 < PB_N; i_3++) {
                for (int i_4 = 0; i_4 < min(-i_3+PB_N, i_1); i_4++) {
                    B[i_4+i_3][i_3-1][i_1] = 1;
                }
            }
        }
    }
...
kernel_4232312113_06(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
