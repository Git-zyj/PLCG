...
void kernel_4412251111_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj)){
...
#pragma scop
        ...
        for (int i_1 = 1; i_1 < -i_0+PB_L; i_1++) {
            for (int i_2 = 0; i_2 < min(PB_L, -i_0+PB_P); i_2++) {
                for (int i_3 = 0; i_3 < min(PB_L-1, -i_0+PB_P-1); i_3++) {
                    A[i_3][i_0][0][i_1-1] = E[i_3+1][i_2][i_0-1][i_0] - E[i_2][i_3+i_0][i_1+i_0][i_1-1] * E[i_1][i_0][i_3+1][i_2+i_0] * E[i_1+1][i_2][i_3][i_3+i_0+1] + E[i_0-1][i_1-1][i_2][0] - F[i_3+i_2][i_1][i_0-1] - E[i_2][i_3][i_1+i_0][i_2] * 6;
                }
            }
        }
    ...
    for (int i_6 = 0; i_6 < PB_L-1; i_6++) {
        C[i_6] = G[i_6+1][i_6] * H[i_6] * I[i_6+1] * H[i_6+1] * H[i_6+1] + C[i_6+1] * 5;
        for (int i_7 = 1; i_7 < PB_L; i_7++) {
            D[i_7][i_6] = J[i_6][i_6] - G[i_6][i_7] - G[i_7][0] - G[i_6][i_7] * G[i_7][0] - J[i_6+1][i_7] * G[i_7-1][i_6+1] - D[i_7+1][i_6] + 3;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4412251111_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J)));
