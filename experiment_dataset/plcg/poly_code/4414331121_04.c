...
void kernel_4414331121_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,DATA_TYPE POLYBENCH_3D(J,xJ,yJ,zJ,xj,yj,zj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl)){
        ...
        for (int i_1 = i_0; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 2; i_2 < -i_0+PB_L; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_0+PB_Q+1, -i_1+PB_Q); i_3++) {
                    A[i_0+1][i_1][i_2][i_3+i_1] = E[i_3-1][i_2-1][i_1][i_0] - F[i_3][i_2+i_0][i_1] + G[i_3][i_1][i_2+i_0][i_0] * A[i_1+1][i_0][i_2-2][i_3+i_0-1] - 5;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < PB_L; i_5++) {
            for (int i_6 = 1; i_6 < PB_N-1; i_6++) {
                for (int i_7 = 1; i_7 < min(-i_5+PB_L, -i_4+PB_Q); i_7++) {
                    B[i_6+1][i_4][i_7+i_5][i_5] = H[i_4][i_7][i_6-1][i_5-1][i_4+1] - F[i_6][i_4][i_5] - I[i_5][i_5][i_6][i_7+i_4] - I[i_7][i_5][i_6+1][i_4] - J[i_7-1][i_7][i_6-1] + 2;
                }
                C[i_5][i_6] = J[i_6+1][i_5][i_4] + K[i_6][i_5] * L[i_6][i_4-1][i_5] - 3;
                D[i_5][i_4][i_5-1] = J[i_6][i_4+1][i_5] + 1;
            }
        }
    }
#pragma endscop
