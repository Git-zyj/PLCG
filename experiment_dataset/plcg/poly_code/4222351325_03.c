...
#pragma scop
        ...
        for (int i_1 = 0; i_1 < PB_P-2; i_1++) {
            for (int i_2 = 2; i_2 < PB_Q-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_M+1; i_3++) {
                    A[i_0+1][i_3][i_1][i_1] = C[i_2][i_1][i_3] * D[i_0-1][i_3-1][i_1][i_2+1] * A[i_0+1][i_2][i_1+2][i_1+2] * A[i_0+1][i_3-1][i_1][i_1] - A[i_3-1][i_2-2][i_1][i_1] - 6;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        for (int i_5 = i_4; i_5 < min(PB_M, -i_4+PB_L); i_5++) {
            for (int i_6 = 0; i_6 < min(min(-i_4+PB_L, -i_5+PB_N), PB_M-1); i_6++) {
                A[i_6+1][i_4+1][i_5][i_5] = E[i_5][i_6+1][i_4-1] + E[0][i_6][i_5+i_4] - C[i_6][i_5][i_4] * E[i_5][i_6+1][i_4+1] * C[i_6+i_4][i_5][i_5] - C[i_6+i_5][i_4][i_5] * F[i_6+i_5][i_4+1] - C[i_4][i_5][i_5-1] - 3;
            }
        }
    }
#pragma endscop
...
kernel_4222351325_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F));
