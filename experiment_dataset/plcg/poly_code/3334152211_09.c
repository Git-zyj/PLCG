...
void kernel_3334152211_09(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P-2; i_0++) {
        for (int i_1 = 2; i_1 < min(-i_0+PB_M-2, i_0); i_1++) {
            A[i_0+1][i_1] = D[i_1] - E[i_1][i_0+2] - E[i_1][i_1] - E[i_1-2][i_0+1] - E[i_1+2][i_0+2] * A[i_0+2][i_1+1] - A[i_0+1][i_1+1] + 6;
            A[i_0+1][i_1] = E[i_1+1][i_0-2] + D[i_1] + E[i_0][i_1] * E[i_1+i_0+2][i_1] + E[i_0][i_1] + 6;
        }
    }
    for (int i_2 = 0; i_2 < PB_P; i_2++) {
        for (int i_3 = i_2; i_3 < min(-i_2+PB_L, PB_P); i_3++) {
            C[i_2][i_3+i_2] = D[i_2] + D[i_2+2] + E[i_3][i_2] + D[i_3+i_2] * A[i_2+1][i_3] + 3;
        }
    }
#pragma endscop
...
kernel_3334152211_09(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
