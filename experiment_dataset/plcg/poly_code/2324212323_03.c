...
void kernel_2324212323_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
...
#pragma scop
    ...
    for (int i_1 = 0; i_1 < PB_M; i_1++) {
        for (int i_2 = 2; i_2 < PB_N+1; i_2++) {
            B[i_1] = D[i_1][i_2] * A[i_2-1] - B[i_2-2] + B[i_2-1] * 6;
        }
    }
    for (int i_3 = 2; i_3 < PB_M; i_3++) {
        for (int i_4 = 0; i_4 < PB_M-4; i_4++) {
            C[i_4+2][i_3] = D[i_4][i_3-2] - C[i_4+1][i_3] * C[i_4+3][i_3] * C[i_4+1][i_3-2] - C[i_4+4][i_3-2] * 2;
        }
    }
#pragma endscop
...
kernel_2324212323_03(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
