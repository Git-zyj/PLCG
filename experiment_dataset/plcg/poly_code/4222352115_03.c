        ...
        for (int i_1 = 1; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 0; i_2 < min(i_0, -i_1+PB_L); i_2++) {
                for (int i_3 = 1; i_3 < PB_L; i_3++) {
                    A[i_0][i_1][i_2][i_3-1] = C[i_3-1][i_1+2][i_2][i_0] - D[i_2+i_1][i_3+2][i_1-1][i_0+2] * C[i_2][i_3][i_1][i_0] * 4;
                }
            }
        }
        B[i_0] = E[i_0-1] * F[i_0] * G[i_0] - E[i_0] * G[i_0+1] - E[i_0-1] - B[i_0+1] - 2;
    }
#pragma endscop
...
kernel_4222352115_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G));
