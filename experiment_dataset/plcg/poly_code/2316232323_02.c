...
void kernel_2316232323_02(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N; i_0++) {
        B[i_0] = D[i_0] - D[i_0-1] * E[i_0] - 2;
    }
    for (int i_1 = 2; i_1 < PB_L-2; i_1++) {
        B[i_1] = D[i_1] + B[i_1+2] - C[i_1][i_1-1] - 3;
        for (int i_2 = i_1; i_2 < min(-i_1+PB_M-2, PB_L-1); i_2++) {
            C[i_1][i_1-1] = F[i_2+i_1+2][i_2+1] + G[i_1][i_2][0] + F[i_2][i_1-2] - B[i_1] - B[i_1-1] - C[i_1+2][i_1+1] - 2;
        }
    }
#pragma endscop
...
kernel_2316232323_02(xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
