...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_N-1; i_1++) {
        for (int i_2 = 0; i_2 < PB_M; i_2++) {
            B[i_1][i_2] = F[i_2][i_1+1] * G[i_2][i_1] - F[i_2][1] - F[i_1][i_2] + 5;
        }
        A[i_1-1] = F[i_1+1][i_1] * 1;
        for (int i_3 = i_1; i_3 < -i_1+PB_P-1; i_3++) {
            for (int i_4 = 1; i_4 < min(-i_3+PB_M, PB_M-2); i_4++) {
                D[i_4+1][i_3+i_1][i_3] = H[i_3-1][i_4-1][i_3] * H[i_1][i_4][i_3] * H[i_1][i_4-1][i_3+i_1+1] + I[i_1+1][i_4+i_3][i_3] * D[i_4+2][i_3+i_1][i_3] - 2;
            }
        }
    }
#pragma endscop
...
kernel_4412231111_09(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
