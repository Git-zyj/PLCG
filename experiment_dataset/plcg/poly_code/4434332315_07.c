...
void kernel_4434332315_07(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
        ...
        for (int i_1 = i_0; i_1 < min(-i_0+PB_N+1, PB_P); i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_Q; i_2++) {
                for (int i_3 = 2; i_3 < PB_P-2; i_3++) {
                    B[i_0][i_3-1][i_1-1][i_2+1] = E[i_0+1][i_2][i_1][i_2+1] * F[i_1][i_2][i_3-2][i_1-1] - G[i_1][i_2+1][i_3-2][i_3] * E[i_1+i_0-1][i_2][i_3+2][i_2+i_1] * 4;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
            for (int i_6 = 2; i_6 < PB_P-1; i_6++) {
                for (int i_7 = 1; i_7 < min(-i_5+PB_M-1, i_5); i_7++) {
                    B[i_5][i_4-1][i_6][i_7] = E[i_7+1][i_6-2][i_4][i_5] * G[i_7+i_5+1][i_6-1][i_4][i_6-2] * B[i_5][i_4][i_6][i_7] + B[i_5][i_4-1][i_6][i_7-1] - B[i_5][i_4-1][i_6+1][i_7] + B[i_5][i_4-2][i_6][i_7-1] * 4;
                }
            }
        }
    }
    for (int i_8 = 1; i_8 < PB_N-2; i_8++) {
        C[i_8] = H[i_8] + H[i_8+2] - C[i_8-1] + 2;
    }
    for (int i_9 = 0; i_9 < PB_L; i_9++) {
        for (int j_0 = 0; j_0 < PB_L; j_0++) {
            for (int j_1 = 0; j_1 < min(-i_9+PB_M, PB_L); j_1++) {
                for (int j_2 = 1; j_2 < PB_P-1; j_2++) {
                    B[i_9+1][j_0][j_2+1][j_1] = E[j_0][j_1][j_2][i_9] * G[j_1+i_9][i_9][j_0][j_2-1] + 5;
                }
            }
        }
    }
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4434332315_07(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H)));
