...
void kernel_4412351213_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_N+1; i_1++) {
            for (int i_2 = 1; i_2 < PB_P; i_2++) {
                for (int i_3 = 1; i_3 < min(min(-i_2+PB_Q, i_0), -i_0+PB_P); i_3++) {
                    A[i_3][i_2-1][i_0+1][i_3] = E[i_2-1][i_3-1][i_0-1][i_0-1] - E[i_1-1][i_3+1][i_3+i_0][i_2] - F[i_3][i_0+1][i_2-1] + G[i_3][i_0-1][i_1-1][i_3+i_2] * F[i_3+1][i_3][i_0] - A[i_3-1][i_2-1][i_0+1][i_3-1] + 6;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_P-2; i_4++) {
        for (int i_5 = 1; i_5 < PB_P-1; i_5++) {
            for (int i_6 = i_4; i_6 < PB_L; i_6++) {
                A[i_6][i_5-1][i_4+1][i_6] = H[i_6-1][i_5][i_4] * H[i_5][i_4-1][i_4] * F[i_6][i_4][i_5] + H[i_5][0][i_4+1] * I[i_4][i_6][i_5-1] + F[0][i_6-1][i_5+1] + H[i_5-1][i_4-1][i_6] - 6;
            }
        }
        for (int i_7 = 0; i_7 < PB_L-1; i_7++) {
            for (int i_8 = 0; i_8 < min(PB_P-2, -i_7+PB_M); i_8++) {
                C[i_7+1][i_7][i_8+1] = J[i_8][i_7] + F[i_7][i_8][i_4] - J[i_8][i_7+1] * H[i_8+i_7][i_4][i_7] + G[i_8][i_7][i_4+1][1] + J[i_8][i_7+1] * C[i_7+2][i_7+1][i_4+1] + C[i_7+2][i_7+1][i_8+2] * 6;
            }
            for (int i_9 = 0; i_9 < PB_M; i_9++) {
                C[i_7+1][i_7][i_4+2] = I[i_9][i_4][i_7] * I[i_9][i_7][i_4] * 5;
            }
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4412351213_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J)));
