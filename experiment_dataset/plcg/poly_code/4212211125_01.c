...
void kernel_4212211125_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        ...
        for (int i_4 = 2; i_4 < PB_L-1; i_4++) {
            for (int i_5 = 2; i_5 < min(-i_0+PB_M, -i_4+PB_L+1); i_5++) {
                A[i_5+i_0-2][i_4-2][i_5-2] = C[i_5+i_4-1][i_0][i_4-1] * D[i_4][i_5][0] + A[i_5+i_0][i_4+1][i_5] * 6;
            }
        }
    }
#pragma endscop
...
kernel_4212211125_01(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
