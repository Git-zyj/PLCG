...
void kernel_3312212313_01(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            C[i_1] = D[i_1-1] - C[i_0-1] * 1;
        }
...
kernel_3312212313_01(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
