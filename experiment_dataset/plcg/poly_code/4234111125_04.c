...
void kernel_4234111125_04(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_Q; i_0++) {
        for (int i_1 = i_0; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < PB_M; i_2++) {
                B[i_2][i_1][i_0] = C[i_2][i_1] - C[i_2][i_1] * 1;
            }
        }
    }
        ...
        for (int i_4 = 2; i_4 < PB_M; i_4++) {
            for (int i_5 = 0; i_5 < PB_Q; i_5++) {
                for (int i_6 = 0; i_6 < PB_L; i_6++) {
                    B[i_4][i_6][i_5] = B[i_4-2][i_6][i_5] + 6;
                }
            }
        }
    }
...
kernel_4234111125_04(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
