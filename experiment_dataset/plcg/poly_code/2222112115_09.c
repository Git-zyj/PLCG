...
void kernel_2222112115_09(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            A[i_1][i_1] = C[i_0-2][i_1] - A[i_1-1][i_1-1] + 5;
        }
        for (int i_2 = 2; i_2 < PB_L+2; i_2++) {
            A[i_0+1][i_0+1] = C[i_0][i_2-2] + 5;
        }
    }
#pragma endscop
...
kernel_2222112115_09(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C));
