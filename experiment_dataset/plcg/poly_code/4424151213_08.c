...
void kernel_4424151213_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L+1; i_0++) {
        for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 1; i_2 < i_1; i_2++) {
                A[i_0-1][i_1][i_2] = E[i_1-1][i_2-1][i_1] * E[i_0][i_1+1][i_2] * F[i_2-1][i_1][i_0-1][i_1-1] * A[i_0-1][i_1+1][i_2-1] - A[i_0-1][i_1-1][i_2-1] + 6;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_L-1; i_3++) {
        for (int i_4 = 1; i_4 < PB_L; i_4++) {
            B[i_3+1][i_4-1] = G[i_4][i_3] - G[i_4-1][i_3+1] * G[i_3][i_4] * B[i_3][i_4-1] + 5;
            for (int i_5 = i_4; i_5 < PB_L; i_5++) {
                for (int i_6 = 2; i_6 < -i_4+PB_N+1; i_6++) {
                    C[i_3-1][i_5-1][i_5][i_4-1] = F[i_6][i_4][i_3+1][i_5] - F[i_6+i_4-1][i_5+1][i_3][1] * E[i_5][i_3][i_4] + C[i_5][i_6-2][i_6-1][i_4-1] + C[i_3-1][i_5-1][i_5][i_6-2] + 3;
                }
            }
        }
    }
    for (int i_7 = 1; i_7 < PB_L-1; i_7++) {
        for (int i_8 = 0; i_8 < min(-i_7+PB_M, PB_L-1); i_8++) {
            D[i_7][i_8] = G[i_8][i_7] + G[i_8+i_7][i_8+1] * G[i_8][i_7] - H[i_7] - G[i_8+i_7-1][i_7] + G[i_8][i_7+1] - G[i_7+1][i_8] * G[i_8][i_7+1] * D[i_7-1][i_8] * D[i_7][i_8+1] - 6;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4424151213_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H)));
