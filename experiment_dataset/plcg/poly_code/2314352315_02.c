...
void kernel_2314352315_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_N; i_0++) {
        A[i_0] = D[i_0] - E[i_0-2] - E[i_0] + E[i_0+1] * A[i_0-1] * 4;
        for (int i_1 = i_0; i_1 < PB_P-1; i_1++) {
            B[i_1][i_0] = E[i_1-1] - F[i_1-1][i_0] - G[i_0][i_1] + G[i_0-1][i_1] * D[i_1-2] + A[i_1] + 5;
            A[i_0] = H[i_1][i_0] + I[i_0][i_1+1][i_1+1] - F[i_0+2][i_1] * H[i_0][i_0] * E[i_1] * A[i_0] * B[i_1+1][i_0-1] - B[i_1][i_0] + 6;
        }
    }
#pragma endscop
...
kernel_2314352315_02(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
