...
void kernel_4312352213_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
        ...
        for (int i_1 = max(2, i_0); i_1 < PB_P-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_Q; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_2+PB_Q, -i_1+PB_Q); i_3++) {
                    A[i_3][i_2][i_0][i_1+1] = D[i_1][i_3][i_2][i_0-1] + E[i_2][i_0][i_1+1][i_3+1] + E[i_1-2][i_0][i_0+1][i_3+i_2] * D[i_3+i_1][i_2][i_0+2][i_0] + F[i_3][i_2][i_0][i_1] * D[i_3][i_0][i_3+i_1][i_2] * 3;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_Q-1; i_4++) {
        B[i_4] = G[i_4] - G[i_4] + G[i_4] - H[i_4] * I[i_4] * B[i_4+1] + B[i_4-1] + 6;
        for (int i_5 = 1; i_5 < PB_L-1; i_5++) {
            for (int i_6 = 0; i_6 < min(i_4, PB_N-2); i_6++) {
                for (int i_7 = 0; i_7 < min(min(-i_6+PB_L, -i_4+PB_P), -i_5+PB_L-1); i_7++) {
                    C[i_4][i_7][i_6][i_5] = E[i_5][i_7+i_6][i_4][i_4-2] + F[i_6+2][i_7+i_5+1][i_4+1][i_6+1] + E[i_5-1][i_7][i_7+1][i_6+1] + D[i_5][i_7+i_4][i_6][i_7] * C[i_4][i_7][i_6+1][i_5] * C[i_4][i_5-1][i_6][i_7] * 5;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4312352213_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I)));
