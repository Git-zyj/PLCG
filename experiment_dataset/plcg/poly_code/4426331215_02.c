...
void kernel_4426331215_02(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi)){
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < PB_Q-2; i_2++) {
                for (int i_3 = max(1, i_1); i_3 < -i_1+PB_M-1; i_3++) {
                    A[i_2][i_1][i_3-1][i_2+1] = E[i_3-1][i_2][i_0][i_2-1] + F[i_3-1][i_0][i_3+i_1+1][0] * A[i_2+1][i_1-1][i_3-1][i_2+2] - 3;
                }
            }
        }
        for (int i_4 = max(1, i_0); i_4 < PB_L; i_4++) {
            B[i_4-1][i_0] = G[i_4-1][i_0] + G[i_0+1][i_4] - B[i_4][i_0] - B[i_4][i_0+1] + 5;
        }
    }
    for (int i_5 = 2; i_5 < PB_P-1; i_5++) {
        for (int i_6 = 0; i_6 < PB_M-1; i_6++) {
            for (int i_7 = 0; i_7 < min(-i_6+PB_M, PB_P-1); i_7++) {
                for (int i_8 = 0; i_8 < min(i_6, -i_6+PB_M-1); i_8++) {
                    A[i_7][i_8][i_5-2][i_7+1] = H[i_8][i_6][i_5+1][i_7+1] - E[i_7][i_5][i_6][i_5] - F[i_7+i_6][i_5][i_7][0] - F[i_7][i_8+1][i_6+1][i_7] - H[i_8+i_6+1][i_8][i_5][i_6] - H[i_5][i_8][i_6][i_5] - 3;
                }
            }
        }
        for (int i_9 = 1; i_9 < i_5; i_9++) {
            B[i_9-1][i_5] = I[i_5][i_9] + 1;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4426331215_02(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I)));
