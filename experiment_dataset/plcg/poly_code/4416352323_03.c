...
void kernel_4416352323_03(int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,int zk,int vk,int wk,DATA_TYPE POLYBENCH_5D(K,xK,yK,zK,vK,wK,xk,yk,zk,vk,wk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        for (int i_1 = i_0; i_1 < PB_M-2; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-2; i_2++) {
                for (int i_3 = i_1; i_3 < min(-i_1+PB_M-2, -i_2+PB_M); i_3++) {
                    D[i_3][i_1][i_2+2][i_0] = E[i_1-1][i_2][i_3-2][i_0] * F[i_3+i_2][i_0+2][i_1][i_0-2][i_2+1] + G[i_2][i_0-2][i_1-2][i_2] + E[i_0][i_3+i_1+2][i_2][i_1+1] * 6;
                }
            }
        }
        B[i_0-1] = H[i_0] * H[i_0] - H[i_0] * I[i_0] - B[i_0] * B[i_0-2] - 6;
    }
    for (int i_4 = 1; i_4 < PB_M-2; i_4++) {
        C[i_4] = J[i_4+2] * I[i_4] * I[i_4+2] * I[i_4] - C[i_4+2] * 5;
        for (int i_5 = 2; i_5 < i_4; i_5++) {
            for (int i_6 = 2; i_6 < -i_4+PB_M; i_6++) {
                for (int i_7 = 1; i_7 < min(i_4, -i_5+PB_L); i_7++) {
                    D[i_6][i_7][i_4][i_5] = K[i_6][i_4][i_7][i_5][i_5] - G[i_4+1][i_7][i_6-2][i_7] - E[i_6+i_4][i_5][i_7+i_5][0] * G[i_7][i_6][i_5][i_4] * G[i_7][i_5+2][i_6-2][i_4] + D[i_7][i_6+1][i_4][i_5-2] * D[i_6+1][i_7][i_4][i_5] * D[i_6][i_7][i_4-1][i_5] * D[i_7-1][i_4][i_6][i_5] * 3;
                }
            }
        }
    }
...
init_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,wk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4416352323_03(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,wk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xd,yd,zd,vd,POLYBENCH_ARRAY(D), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,wk,POLYBENCH_ARRAY(K)));
