...
void kernel_3424231313_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        A[i_0] = E[i_0+1] + F[i_0] + G[i_0+1][i_0-1] + A[i_0+1] + 1;
    }
    for (int i_1 = 1; i_1 < PB_M; i_1++) {
        for (int i_2 = 1; i_2 < -i_1+PB_M; i_2++) {
            C[i_2+i_1-1][i_1] = G[i_2][i_1-1] * G[i_1][i_2+1] + G[i_2][i_1-1] - G[i_2][i_2+1] + H[i_1][i_2-1] + A[i_1-1] - 4;
            C[i_2+i_1][i_2+1] = I[i_2][i_2][i_1] + H[i_2+i_1][0] + A[i_2+1] - C[i_2+i_1-1][i_2] - C[i_2+i_1][i_2+2] * 2;
        }
    }
...
kernel_3424231313_02(xa,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
