...
void kernel_4312112323_07(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 2; i_1 < PB_M-1; i_1++) {
            A[i_1] = A[i_1-1] + A[i_1+1] + A[i_1-2] * 5;
    ...
    for (int i_3 = 2; i_3 < PB_M-1; i_3++) {
        C[i_3] = D[i_3+1] + C[i_3-2] * C[i_3+1] - 5;
    }
#pragma endscop
...
kernel_4312112323_07(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
