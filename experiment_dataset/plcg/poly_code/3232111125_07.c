...
void kernel_3232111125_07(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
    ...
    for (int i_2 = 0; i_2 < PB_L; i_2++) {
        for (int i_3 = 3; i_3 < PB_L+1; i_3++) {
            for (int i_4 = i_3; i_4 < -i_3+PB_L+1; i_4++) {
                A[i_4-1][i_4+i_3-1] = C[i_4+i_3][i_2] - A[i_3-3][i_4+i_3-2] + 2;
            }
        }
    }
#pragma endscop
...
kernel_3232111125_07(xa,ya,POLYBENCH_ARRAY(A), xc,yc,POLYBENCH_ARRAY(C));
