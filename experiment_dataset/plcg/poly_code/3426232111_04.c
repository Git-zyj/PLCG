...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_L; i_1++) {
        B[i_1] = E[i_1] + F[0][i_1-1] + E[i_1] * 2;
    }
    for (int i_2 = 2; i_2 < PB_M; i_2++) {
        for (int i_3 = 1; i_3 < min(PB_L, -i_2+PB_M+2); i_3++) {
            C[i_3][i_2] = G[i_3][i_2] + G[i_3+i_2-2][i_2-1] + G[i_3+1][i_2] - C[i_3-1][i_2] + C[i_3][i_2-1] - 6;
        }
        for (int i_4 = 0; i_4 < PB_N-2; i_4++) {
            for (int i_5 = 0; i_5 < min(-i_2+PB_Q, PB_L); i_5++) {
                C[i_5][i_2] = H[i_4][i_5][i_5+i_2] + F[i_5][i_4] + I[i_4+2][i_2][i_4] - 1;
            }
        }
    }
#pragma endscop
...
kernel_3426232111_04(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
