...
void kernel_4332352315_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,int wh,DATA_TYPE POLYBENCH_5D(H,xH,yH,zH,vH,wH,xh,yh,zh,vh,wh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        for (int i_1 = 2; i_1 < PB_Q-2; i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_P; i_2++) {
                for (int i_3 = 3; i_3 < min(-i_0+PB_Q, -i_1+PB_Q); i_3++) {
                    A[i_3-2][i_1][i_2][0] = D[i_2+2][i_0][i_3-1] + E[i_1][i_2+i_0][i_3+i_0][i_2] + F[i_1][i_2+2][i_0][0] + G[i_1-2][i_2][i_3+i_1][1] + E[i_2][i_1-2][i_0-2][i_1] - H[i_3+i_2][i_0][i_3+i_1-1][i_0][i_1-1] * E[i_0][i_2][i_1+2][i_1] + A[i_3-1][i_1][i_2][0] + A[i_3-3][i_1][i_2][0] + A[i_3-2][i_2][i_1+1][0] - A[i_3-1][i_0][i_2-1][0] - 5;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_M-2; i_4++) {
        B[i_4+1] = I[i_4] + I[i_4] + J[i_4] + I[i_4] * I[i_4] * I[i_4] + B[i_4+2] * B[i_4] - B[i_4] * 2;
    }
    for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
        for (int i_6 = 0; i_6 < min(-i_5+PB_P, PB_P-1); i_6++) {
            for (int i_7 = 0; i_7 < PB_M-2; i_7++) {
                for (int i_8 = 2; i_8 < min(PB_Q, -i_7+PB_M); i_8++) {
                    C[i_5][i_6][i_7][i_8] = E[i_7+2][i_8-2][i_6+1][i_5] - E[i_8+i_7][i_6+i_5][i_7][i_5] * C[i_5][i_6+1][i_7+1][i_8] - C[i_5+1][i_6][i_8][i_7] - 1;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4332352315_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,wh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
