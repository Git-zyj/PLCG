...
void kernel_4222211225_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_N-3 - 1; i_0 >= 0; i_0--) {
        A[i_0+1] = C[i_0] + A[i_0] + A[i_0+3] * 6;
        A[i_0+1] = C[i_0] * 5;
    }
#pragma endscop
...
kernel_4222211225_01(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
