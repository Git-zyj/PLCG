...
void kernel_4226132213_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 1; i_1 < -i_0+PB_Q-2; i_1++) {
            for (int i_2 = 2; i_2 < PB_Q; i_2++) {
                for (int i_3 = i_2; i_3 < min(-i_2+PB_L+2, PB_M-1); i_3++) {
                    A[i_1][i_0][i_1][i_3] = C[i_3+1][i_2-1][i_1+i_0+2][0] - C[i_3][i_0][i_1][i_2] * C[i_0+2][i_3+i_2-2][i_1+i_0][0] - A[i_1-1][i_0][i_1-1][i_3] + A[i_1][i_0+1][i_1][i_3] + 3;
                }
            }
        }
    }
    for (int i_4 = 0; i_4 < PB_L-1; i_4++) {
        for (int i_5 = max(i_4, 2); i_5 < PB_Q-1; i_5++) {
            for (int i_6 = 0; i_6 < min(i_5, -i_5+PB_M+1); i_6++) {
                A[i_6][i_4][i_6][i_5+1] = D[i_6+i_5-1][i_4+1][1] + D[i_6][i_4][i_5-2] - 5;
            }
        }
    }
#pragma endscop
...
kernel_4226132213_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
