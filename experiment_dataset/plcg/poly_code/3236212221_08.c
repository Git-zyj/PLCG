...
void kernel_3236212221_08(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_1 = 3; i_1 < PB_L-1; i_1++) {
        B[i_1-1] = C[i_1] + B[i_1+1] - B[i_1-3] - 6;
    }
#pragma endscop
...
kernel_3236212221_08(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
