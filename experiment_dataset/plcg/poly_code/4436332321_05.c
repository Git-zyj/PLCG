...
#endif
static void init_array(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,int zk,int vk,int wk,DATA_TYPE POLYBENCH_5D(K,xK,yK,zK,vK,wK,xk,yk,zk,vk,wk),int xl,int yl,int zl,int vl,DATA_TYPE POLYBENCH_4D(L,xL,yL,zL,vL,xl,yl,zl,vl),int seed)
{
srand(seed);
...
void kernel_4436332321_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,int zi,int vi,DATA_TYPE POLYBENCH_4D(I,xI,yI,zI,vI,xi,yi,zi,vi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,int zk,int vk,int wk,DATA_TYPE POLYBENCH_5D(K,xK,yK,zK,vK,wK,xk,yk,zk,vk,wk),int xl,int yl,int zl,int vl,DATA_TYPE POLYBENCH_4D(L,xL,yL,zL,vL,xl,yl,zl,vl)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_L; i_1++) {
        for (int i_2 = 1; i_2 < min(PB_L-1, i_1); i_2++) {
            for (int i_3 = 0; i_3 < min(min(i_1, -i_2+PB_L), PB_L-2); i_3++) {
                B[i_1][i_2][i_1] = E[i_3+i_2][i_1][i_1] + F[i_2-1][i_3+2][i_1] * E[i_2][i_2][0] * B[i_1][i_2-1][i_1] * B[i_3][i_2+1][i_3] - B[i_2+1][i_3][i_2+1] + B[i_1][i_3+1][i_1] - B[i_1][i_2+1][i_1] - 6;
            }
        }
        for (int i_4 = 4; i_4 < -i_1+PB_M; i_4++) {
            C[i_4-2][i_4+i_1] = G[i_4-1] + H[i_4][i_1] * C[i_4-4][i_4+i_1-1] * 3;
        }
    }
        ...
        for (int i_6 = 4; i_6 < min(-i_5+PB_L, i_5); i_6++) {
            for (int i_7 = 0; i_7 < min(-i_6+PB_P-2, PB_M-2); i_7++) {
                for (int i_8 = 0; i_8 < -i_6+PB_N; i_8++) {
                    D[i_6][i_6-2][i_8][i_7] = I[i_6+i_5][i_7][i_8][i_8] + J[i_8][i_5+2][i_5][i_7+i_6+2] + K[i_8+i_6][i_5][i_7+2][i_7][i_6] * L[i_7][i_8+1][i_6][i_5] - L[i_7][i_8][i_5][i_6-2] + D[i_6-1][i_6-3][i_8][i_7] + D[i_6-2][i_6-4][i_5][i_8] - 1;
                }
            }
        }
    }
