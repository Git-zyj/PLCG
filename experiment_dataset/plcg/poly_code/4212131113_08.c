        ...
        for (int i_1 = 2; i_1 < PB_P; i_1++) {
            for (int i_2 = 1; i_2 < PB_M; i_2++) {
                for (int i_3 = i_0; i_3 < PB_M-1; i_3++) {
                    A[i_0+1][i_1][i_3-1] = C[i_2][i_1][i_3] - D[i_3][i_0-1][i_3-1][i_2-1] + A[i_3+1][i_2][i_1-2] + 2;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_Q-1; i_4++) {
            for (int i_5 = 1; i_5 < PB_L; i_5++) {
                B[i_0][i_5][i_5] = C[i_0][i_5][i_4+1] + E[i_5][i_4] * C[i_4][i_5-1][i_0] - A[i_0+2][i_4-1][i_5-1] * 6;
            }
        }
    }
#pragma endscop
...
kernel_4212131113_08(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
