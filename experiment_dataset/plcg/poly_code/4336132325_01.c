...
void kernel_4336132325_01(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,DATA_TYPE POLYBENCH_3D(E,xE,yE,zE,xe,ye,ze)){
        ...
        for (int i_1 = 1; i_1 < min(PB_Q-2, i_0); i_1++) {
            for (int i_2 = 2; i_2 < PB_P-2; i_2++) {
                for (int i_3 = 1; i_3 < -i_1+PB_L+1; i_3++) {
                    B[i_2-2][i_0-2][i_3-1][i_0-2] = D[i_1][i_2+2][i_3][i_1] - D[i_2][i_0][i_1][1] + E[i_2][i_3+i_1-1][i_1+2] - D[i_1][i_2][i_3][i_0-1] * 3;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < i_4; i_5++) {
            for (int i_6 = 1; i_6 < -i_5+PB_L; i_6++) {
                for (int i_7 = 3; i_7 < PB_L-1; i_7++) {
                    B[i_4][i_5][i_6-1][i_5] = D[i_6+i_5][i_4+1][i_7+1][i_7] - B[i_4][i_6-1][i_7-3][i_6-1] + B[i_4][i_5][i_6+1][i_5] + B[i_4][i_7+1][i_6-1][i_7+1] + 4;
                }
            }
        }
        for (int i_8 = 0; i_8 < PB_M-1; i_8++) {
            for (int i_9 = max(i_4, 2); i_9 < PB_Q; i_9++) {
                B[i_8+1][i_4][i_9-1][i_4] = E[i_9][i_4][i_8] - E[i_8][i_9-2][0] * 1;
            }
        }
    }
#pragma endscop
...
kernel_4336132325_01(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
