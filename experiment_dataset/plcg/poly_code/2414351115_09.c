...
void kernel_2414351115_09(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = i_0; i_1 < -i_0+PB_L-1; i_1++) {
            B[i_1] = E[i_1+1] - F[i_1+1][i_0] * G[i_1][i_0] * H[i_1+i_0+1][i_1] - G[i_1][i_1+i_0] - G[i_0-1][i_1-1] - F[i_1+i_0][i_0+1] * 1;
        }
    }
    for (int i_2 = 1; i_2 < PB_L; i_2++) {
        B[i_2] = I[i_2-1] * E[i_2] + E[i_2] * 3;
        for (int i_3 = 1; i_3 < -i_2+PB_L; i_3++) {
            B[i_3-1] = F[i_2-1][i_3] - H[i_3-1][i_2] - H[i_3+i_2][1] * 2;
            B[i_3+1] = H[i_3][i_3] * G[i_2][i_3] - I[i_3] + J[i_3-1] * G[i_2][i_3+i_2] - B[i_3] * 3;
        }
    }
#pragma endscop
...
kernel_2414351115_09(xb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
