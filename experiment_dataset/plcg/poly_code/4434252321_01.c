...
void kernel_4434252321_01(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk),int xl,int yl,int zl,DATA_TYPE POLYBENCH_3D(L,xL,yL,zL,xl,yl,zl)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        A[i_0][i_0] = E[i_0] + F[i_0] + F[i_0] - E[i_0] * A[i_0-2][i_0-2] + A[i_0+2][i_0+2] * 3;
        for (int i_1 = i_0; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 2; i_2 < -i_0+PB_M-1; i_2++) {
                for (int i_3 = 1; i_3 < min(min(-i_1+PB_M, -i_0+PB_L), i_2); i_3++) {
                    B[i_2+i_0][i_1+1][i_3-1][i_0+2] = G[i_3][i_2-2][i_1+2][i_2] + H[i_2][i_0-2][i_3][i_1] - I[i_3-1][i_2-1][i_1] - H[i_2+2][i_3+i_0][i_1][i_1-2] + H[i_3+i_1][i_0][i_2][i_1-2] - B[i_2+i_0+1][i_1-1][i_3-1][i_0+2] - 1;
                }
            }
        }
        for (int i_4 = 2; i_4 < -i_0+PB_M-1; i_4++) {
            C[i_4+i_0][i_0] = J[i_0][0] * K[i_0][i_0] * I[i_4+1][i_0+1][i_4] * J[i_0+1][i_0] + K[i_4-2][i_0] - K[i_4+i_0][i_4-2] + A[i_0+1][i_0+1] * C[i_4+i_0-1][i_0-1] + C[i_4+i_0+1][i_0] * 3;
        }
    }
    for (int i_5 = 0; i_5 < PB_M-1; i_5++) {
        for (int i_6 = 2; i_6 < min(PB_N-2, -i_5+PB_M-1); i_6++) {
            D[i_6][i_5+1] = J[i_6][i_5] * L[i_6+i_5+1][i_6+2][2] + J[i_5][i_6] - K[i_5+1][i_6] * D[i_6+2][i_5+1] * D[i_6-1][i_5+1] - D[i_6-2][i_5+1] - D[i_6+1][i_5+1] - 2;
        }
    }
#pragma endscop
