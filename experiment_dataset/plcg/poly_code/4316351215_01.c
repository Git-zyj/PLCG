...
void kernel_4316351215_01(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        for (int i_1 = max(1, i_0); i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = max(2, i_0); i_2 < min(-i_1+PB_P, PB_M-1); i_2++) {
                for (int i_3 = 1; i_3 < i_0; i_3++) {
                    B[i_0+1][1][i_1][i_2-2] = D[i_2+1][i_0][i_1][i_3] + D[i_3-1][i_1+i_0][i_2][i_0] - E[i_1][i_3][i_0][i_2][0] - D[i_2][i_3+1][i_1-1][i_2+i_1] * 4;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < -i_4+PB_P-1; i_5++) {
            for (int i_6 = 1; i_6 < PB_L-1; i_6++) {
                for (int i_7 = 1; i_7 < PB_L; i_7++) {
                    B[i_4][1][i_5][i_7-1] = D[i_5+1][i_4][i_7-1][i_7] * F[i_5][i_7][i_5] * G[i_4][i_6+1][i_7][i_6+i_5] - H[i_6-1][i_7][i_5+i_4+1][i_5+i_4] + G[i_5][i_6][i_7][i_5+i_4-1] + B[i_4][1][i_7][i_6] - B[i_4][1][i_6+1][i_7-1] - 2;
                }
            }
        }
        for (int i_8 = 1; i_8 < i_4; i_8++) {
            for (int i_9 = 1; i_9 < min(i_8, -i_8+PB_N+1); i_9++) {
                B[i_4-1][1][i_8][i_9] = F[i_9-1][i_4-1][i_4-1] + I[i_9+i_8-1][i_4-1] * J[i_9-1][i_8] + K[i_8][i_9][i_4] + 6;
            }
        }
    }
#pragma endscop
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4316351215_01(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,POLYBENCH_ARRAY(K)));
