...
void kernel_4432331313_05(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,int yk,DATA_TYPE POLYBENCH_2D(K,xK,yK,xk,yk)){
        ...
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_M; i_2++) {
                for (int i_3 = 1; i_3 < PB_L; i_3++) {
                    A[i_0][i_3][i_2+i_0][i_3-1] = E[i_3-1][i_1][i_0+1][i_2+1] + F[i_2][i_1][i_3][i_0][0] * A[i_2][i_1][i_2+i_0-1][i_1-1] - A[i_0-1][i_3][i_2+i_0-1][i_3-1] - 2;
                }
            }
        }
    }
        ...
        for (int i_5 = 1; i_5 < PB_L; i_5++) {
            for (int i_6 = 1; i_6 < min(PB_L, -i_4+PB_Q); i_6++) {
                for (int i_7 = 0; i_7 < min(PB_P-2, -i_4+PB_P); i_7++) {
                    B[i_6][i_5][i_7+1][i_4] = G[i_5][i_7][i_6][0] - H[i_5][i_6][i_7+i_4][0] - G[i_7][i_4][i_6][i_6+i_4] + B[i_6][i_5-1][i_7+1][i_4] + B[i_6][i_5][i_7+1][i_4+1] - B[i_7][i_6][i_5][i_4+1] * B[i_6-1][i_4][i_7+2][i_5-1] * 6;
                }
            }
        }
    }
    for (int i_8 = 1; i_8 < PB_L; i_8++) {
        C[i_8] = I[i_8] - J[i_8] * I[i_8] * C[i_8-1] - 5;
        for (int i_9 = 1; i_9 < min(-i_8+PB_M, PB_L); i_9++) {
            C[i_9] = I[i_9] - J[i_9+i_8] * K[i_8][i_9] + C[i_9-1] + C[i_8-1] * 2;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K), INIT_SEED);
kernel_4432331313_05(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,yk,POLYBENCH_ARRAY(K));
