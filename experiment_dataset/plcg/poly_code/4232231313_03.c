...
void kernel_4232231313_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf)){
        ...
        for (int i_1 = 0; i_1 < PB_M; i_1++) {
            for (int i_2 = 1; i_2 < min(PB_M-1, -i_1+PB_Q); i_2++) {
                for (int i_3 = 1; i_3 < PB_L-1; i_3++) {
                    A[i_0][i_2][i_2][i_3] = C[i_1][i_3-1][i_2] * D[i_2+1][i_0][i_0][i_2+i_1] - A[i_0][i_2-1][i_2-1][i_3] + A[i_1][i_2+1][i_2+1][i_3+1] - A[i_2][i_3+1][i_3+1][i_0] * 2;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < -i_4+PB_P; i_5++) {
            for (int i_6 = 0; i_6 < PB_M; i_6++) {
                for (int i_7 = 0; i_7 < -i_5+PB_Q; i_7++) {
                    A[i_7][i_5][i_5][i_4] = E[i_6][i_7][i_5+i_4][i_7+i_5] + F[i_6][i_5][i_4-1] + D[i_5][i_7][i_6][i_4] + 6;
                }
            }
        }
    }
...
kernel_4232231313_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F));
