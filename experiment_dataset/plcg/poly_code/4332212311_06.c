...
void kernel_4332212311_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 0; i_1 < PB_M; i_1++) {
            for (int i_2 = 0; i_2 < i_0; i_2++) {
                A[i_1][i_0+1][i_2] = A[i_1][i_0+2][i_2] + 4;
            }
        }
        for (int i_3 = max(1, i_0); i_3 < PB_M-2; i_3++) {
            for (int i_4 = 1; i_4 < -i_3+PB_M-1; i_4++) {
                B[i_4+i_3][i_0][i_3] = D[i_3][i_0][i_0] * A[i_4-1][i_0+1][i_3-1] - A[i_4][i_3+2][i_0] + B[i_4+i_3+1][i_0][i_3+1] - B[i_4+i_3+1][i_0][i_3] + 1;
            }
        }
    }
        ...
        for (int i_6 = 0; i_6 < -i_5+PB_M-1; i_6++) {
            for (int i_7 = 0; i_7 < PB_M; i_7++) {
                for (int i_8 = 0; i_8 < min(-i_7+PB_M, PB_L-1); i_8++) {
                    C[i_6+i_5][i_8][i_5+2][i_8] = B[i_8+i_7][i_6][i_7+1] + C[i_6+i_5+1][i_8+1][i_5+2][i_8+1] * C[i_6+i_5-1][i_8+1][i_5+1][i_8+1] - 1;
                }
            }
        }
    }
...
kernel_4332212311_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
