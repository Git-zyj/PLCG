...
void kernel_4434251115_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        A[i_0] = E[i_0] - E[i_0+1] - E[i_0+1] * E[i_0] + 6;
        for (int i_1 = 1; i_1 < min(-i_0+PB_M, i_0); i_1++) {
            B[i_0][i_1] = F[i_1+1][i_0] + G[i_1][i_0-1] - H[i_1] - G[i_1+i_0][i_1+1] - F[i_1-1][i_0] - B[i_0+1][i_1] + 3;
        }
    }
    for (int i_2 = 1; i_2 < PB_L-1; i_2++) {
        for (int i_3 = 1; i_3 < -i_2+PB_M; i_3++) {
            A[i_3] = F[i_3+i_2][i_2-1] - G[i_3][i_2] - F[i_3-1][i_2-1] - G[i_3+1][i_2] * G[i_3-1][i_2] * G[i_3][i_2-1] - G[i_3][i_2] + G[i_3+1][i_2] * 6;
        }
        for (int i_4 = 0; i_4 < PB_L; i_4++) {
            for (int i_5 = 1; i_5 < -i_4+PB_M; i_5++) {
                B[i_5-1][i_4] = I[i_5+i_4][i_2][i_4] - I[i_5][i_2-1][i_2+1] * 4;
            }
        }
    }
#pragma endscop
...
kernel_4434251115_01(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
