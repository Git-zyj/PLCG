...
void kernel_4324151125_06(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = i_0; i_2 < -i_0+PB_L; i_2++) {
                B[i_2][i_1+1] = D[i_1][i_2+i_0][i_1] * D[i_2+i_0][i_1][i_2+1] * D[i_2][i_0][i_1] - D[i_0+1][i_2][i_1-1] * 4;
            }
        }
        for (int i_3 = -i_0+PB_L - 1; i_3 >= i_0; i_3--) {
            B[i_3][i_0+1] = E[i_3+i_0][0] * E[i_3+i_0][i_3] - D[i_3][i_3+i_0][0] * E[i_3+1][i_0] - E[i_3][i_0-1] * E[i_3][i_3] + 3;
            for (int i_4 = i_0; i_4 < -i_3+PB_P; i_4++) {
                C[i_0][i_4+i_3][0] = D[i_4][i_3][i_0] * D[i_4][i_0][i_3] + D[i_3][1][i_0-1] * D[i_4][i_3][i_0] - D[i_3][i_0][i_4-1] - B[i_4][i_3+1] + B[i_3-1][i_0+1] + 2;
            }
        }
    }
#pragma endscop
...
kernel_4324151125_06(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
