...
void kernel_2212112323_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        for (int i_1 = 1; i_1 < -i_0+PB_M; i_1++) {
            A[i_1][i_0-1][i_0] = C[i_1+i_0][i_0][i_1] + A[i_0-2][i_1-1][i_1] + A[i_1-1][i_0-1][i_0] - A[i_1+2][i_0-1][i_0] * 2;
        }
    }
...
kernel_2212112323_03(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C));
