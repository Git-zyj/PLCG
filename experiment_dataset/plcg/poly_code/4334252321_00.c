...
void kernel_4334252321_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,int vi,int wi,DATA_TYPE POLYBENCH_5D(I,xI,yI,zI,vI,wI,xi,yi,zi,vi,wi),int xj,int yj,int zj,int vj,DATA_TYPE POLYBENCH_4D(J,xJ,yJ,zJ,vJ,xj,yj,zj,vj),int xk,int yk,int zk,DATA_TYPE POLYBENCH_3D(K,xK,yK,zK,xk,yk,zk)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 0; i_1 < -i_0+PB_L; i_1++) {
            A[i_0][i_1] = D[i_0][i_1] - D[i_0][i_1+i_0] + E[i_1] - D[i_0+2][i_1+2] - F[i_1][i_0] * G[i_1][i_0][i_0] - D[i_1][i_0] + F[i_0][i_1] + A[i_0][i_1+1] * A[i_0-1][i_1] + 4;
        }
        for (int i_2 = 2; i_2 < min(PB_P-2, i_0); i_2++) {
            for (int i_3 = 0; i_3 < PB_M-2; i_3++) {
                for (int i_4 = 2; i_4 < -i_2+PB_M-1; i_4++) {
                    B[i_4][i_3+2][i_0+1][i_2] = H[i_3][i_4-2][i_2-2][i_3] * G[i_2][i_3][i_0-2] - I[i_4+i_2+1][i_3][i_0][i_0][i_4] + J[i_0][i_3+1][i_2][i_0] * B[i_4][i_0][i_3+1][i_2-2] + B[i_0][i_3+2][i_4+1][i_2+2] * B[i_0][i_4+1][i_3][i_2] - B[i_4-2][i_3+1][i_2-1][i_0] - 1;
                }
            }
        }
    }
    for (int i_5 = 0; i_5 < PB_M-2; i_5++) {
        for (int i_6 = max(2, i_5); i_6 < -i_5+PB_M; i_6++) {
            for (int i_7 = 0; i_7 < -i_5+PB_M-2; i_7++) {
                C[i_6][i_7+i_5] = J[i_6][i_7][i_5][i_6] - G[i_6][i_7][i_5] - K[i_6-2][i_7+i_5][i_6+i_5] + C[i_7+1][i_6+i_5] - C[i_6][i_7+i_5+2] + C[i_6-1][i_7+i_5+1] * 4;
            }
        }
    }
#pragma endscop
