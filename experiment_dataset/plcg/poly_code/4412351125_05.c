...
void kernel_4412351125_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl)){
        ...
        for (int i_1 = 1; i_1 < min(-i_0+PB_P+1, i_0); i_1++) {
            for (int i_2 = 0; i_2 < PB_P-1; i_2++) {
                for (int i_3 = 1; i_3 < min(-i_0+PB_P, -i_2+PB_M); i_3++) {
                    A[i_0-1][i_2+1][i_1+1] = E[i_0][i_2][i_0][i_1] - F[i_2][i_3][i_1-1][i_1-1] + E[i_3+1][i_2][i_3+i_0][i_1+i_0] - E[i_3+i_2][i_2][i_2+1][i_0-1] - G[i_2+i_1][i_0][i_1+i_0-1][i_3] * A[i_3-1][i_1+2][i_2+3] + 2;
                }
            }
        }
        for (int i_4 = i_0; i_4 < -i_0+PB_M; i_4++) {
            B[i_4] = H[i_4+i_0][i_4] - H[i_4][i_0-1] + I[i_4+i_0][i_0+1] * J[i_4-1][i_4+i_0] + H[i_4][i_0] * H[i_4+i_0][i_0] - 1;
        }
    }
    for (int i_5 = 1; i_5 < PB_M-1; i_5++) {
        B[i_5-1] = K[i_5+1] - L[i_5] * L[i_5] - K[i_5] + K[i_5] - 2;
        for (int i_6 = i_5; i_6 < PB_M; i_6++) {
            for (int i_7 = 0; i_7 < i_5; i_7++) {
                for (int i_8 = 1; i_8 < -i_7+PB_P; i_8++) {
                    A[i_8-1][i_5][i_6+1] = G[i_6][i_5][i_8+i_7][0] + 4;
                }
            }
        }
    }
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4412351125_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L)));
