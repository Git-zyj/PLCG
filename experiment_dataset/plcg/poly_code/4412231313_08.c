...
void kernel_4412231313_08(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = i_0; i_1 < -i_0+PB_M+1; i_1++) {
            A[i_0+1][i_1] = E[i_1+i_0-1][i_1] * E[i_1][i_0] - F[i_1][0] + B[i_0] * 6;
        }
    ...
    for (int i_2 = 1; i_2 < PB_Q-1; i_2++) {
        for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
            for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
                C[i_2][i_4][i_3+1] = H[i_3][i_4-1][0] * H[i_3][i_4+1][i_2] - I[i_4+1][i_2][i_3-1] + A[i_3+1][i_4] * A[i_4+2][i_3] - A[i_4+1][i_3+1] + A[i_3+1][i_4+1] * 6;
                D[i_4][i_3][i_2] = H[i_3][i_4][i_2+1] - I[i_4+1][i_3][i_2] - C[i_2][i_4][i_3] + D[i_2][i_3][i_4-1] * D[i_2-1][i_3][i_4-1] * 4;
            }
        }
    }
#pragma endscop
...
kernel_4412231313_08(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
