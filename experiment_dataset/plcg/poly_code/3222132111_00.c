...
void kernel_3222132111_00(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_0 = 2; i_0 < PB_P; i_0++) {
        for (int i_1 = 1; i_1 < min(PB_P, -i_0+PB_L-1); i_1++) {
            for (int i_2 = 0; i_2 < min(min(PB_P, -i_0+PB_L), -i_1+PB_P); i_2++) {
                B[i_1+1][i_2+i_0][i_1+i_0+1] = C[i_1-1][i_2][i_1+i_0-2] + C[i_0+1][i_2+i_1][i_0] * 5;
            }
        }
        for (int i_3 = i_0; i_3 < min(-i_0+PB_L, PB_P-1); i_3++) {
            for (int i_4 = 1; i_4 < -i_3+PB_P-1; i_4++) {
                B[i_4][i_3+i_0][i_4+i_3] = C[i_3][i_4+1][i_0] - C[i_0][i_4+i_3+1][0] * C[i_4][i_0][i_3] + C[i_0+1][i_4][i_3+1] - B[i_4-1][i_3+i_0][i_4+i_3-1] - 4;
            }
        }
    }
#pragma endscop
...
kernel_3222132111_00(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
