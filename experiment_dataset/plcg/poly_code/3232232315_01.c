...
void kernel_3232232315_01(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
    ...
    for (int i_0 = 2; i_0 < PB_N; i_0++) {
        for (int i_1 = 2; i_1 < min(-i_0+PB_L, PB_M-1); i_1++) {
            for (int i_2 = 2; i_2 < min(min(PB_N+2, -i_0+PB_L), -i_1+PB_L); i_2++) {
                A[i_1+i_0][i_2-1][i_2+1] = C[i_0][i_2+2][i_1-2] - D[i_0][i_1][i_2] - D[i_2-2][i_1][i_0+1] + D[i_2-2][i_1+1][i_0] + A[i_2+i_1][i_0][i_0+2] + A[i_2+i_0][i_1][i_1+2] * A[i_2+i_1][i_0-1][i_0+1] - 3;
            }
        }
        for (int i_3 = 0; i_3 < i_0; i_3++) {
            for (int i_4 = 0; i_4 < -i_0+PB_P; i_4++) {
                B[i_3][i_0][i_4+i_0-1] = C[i_3][i_0][1] - B[i_3][i_0-1][i_4+i_0-2] - B[i_3][i_4][i_4+i_0] * 6;
            }
        }
    }
#pragma endscop
...
kernel_3232232315_01(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
