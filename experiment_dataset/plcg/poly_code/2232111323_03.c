...
void kernel_2232111323_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N-3; i_0++) {
        A[i_0+1] = A[i_0+2] + A[i_0+3] - A[i_0] * 6;
    }
...
kernel_2232111323_03(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
