...
void kernel_3314251215_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        A[i_0-1] = D[i_0] + D[i_0] + D[i_0] + E[i_0] - E[i_0] - D[i_0] * A[i_0-2] * B[i_0] * 3;
        for (int i_1 = 0; i_1 < PB_N-1; i_1++) {
            B[i_1] = F[i_1][i_0] - G[i_1][i_0+1] - E[i_0] - A[i_0] + B[i_1+1] - 3;
        }
        for (int i_2 = 0; i_2 < -i_0+PB_P-1; i_2++) {
            for (int i_3 = 0; i_3 < PB_L-1; i_3++) {
                B[i_2+1] = H[0][i_3][i_0] - I[i_3][i_0+1][i_2] * I[i_2+1][i_3+1][i_0] + I[i_3][i_2+i_0-1][i_2+i_0+1] + I[i_2][i_0-1][i_0] - 6;
            }
        }
    }
#pragma endscop
...
kernel_3314251215_05(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
