...
void kernel_3432332223_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-1; i_0++) {
        A[i_0] = E[i_0] - F[i_0] + F[i_0+1] - B[i_0] * 3;
        B[i_0] = G[0][i_0] + E[i_0-2] * E[i_0] + A[i_0+1] + A[i_0] - B[i_0+2] * 5;
    }
    for (int i_1 = 2; i_1 < PB_M-1; i_1++) {
        A[i_1] = H[i_1-2] + 3;
        A[i_1+1] = H[i_1] * H[i_1] - I[i_1-1][i_1] + 3;
    }
#pragma endscop
...
kernel_3432332223_05(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
