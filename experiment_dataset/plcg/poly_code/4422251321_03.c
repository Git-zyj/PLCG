...
void kernel_4422251321_03(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,DATA_TYPE POLYBENCH_1D(H,xH,xh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj)){
        ...
        for (int i_1 = 1; i_1 < PB_P-1; i_1++) {
            for (int i_2 = 0; i_2 < min(PB_M-2, -i_1+PB_Q); i_2++) {
                for (int i_3 = 0; i_3 < -i_1+PB_P+1; i_3++) {
                    A[i_2+1][i_1][1] = E[i_3][i_1][i_0][i_2+i_1] * F[i_1-1][i_3][i_1][i_0] * F[i_1][i_2][i_3+i_1-1][i_0] * A[i_2+2][i_1][1] - A[i_2+1][i_1+1][1] - 3;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_M-1; i_4++) {
        B[i_4] = G[0] + G[i_4] + H[i_4] + H[i_4-1] + B[i_4-2] * B[i_4+1] * 2;
    }
    for (int i_5 = 1; i_5 < PB_P-2; i_5++) {
        for (int i_6 = 1; i_6 < min(-i_5+PB_L, PB_L-2); i_6++) {
            D[i_6][i_5] = I[i_6][i_5] * J[i_5-1][i_6-1] * H[i_6] * J[i_6+i_5][0] * J[i_6][i_5] - I[i_6][i_5] - D[i_6+2][i_5] + 3;
            D[i_6][i_5] = I[i_6][i_5] * J[i_5][0] - I[i_6][i_5+1] * G[i_6] - H[i_6] - I[i_6][i_5] - I[i_6-1][i_5] - B[i_6] * D[i_6][i_5+2] * 4;
        }
    }
#pragma endscop
...
init_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4422251321_03(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J)));
