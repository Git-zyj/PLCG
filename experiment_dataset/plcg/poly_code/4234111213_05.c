...
void kernel_4234111213_05(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc)){
        ...
        for (int i_4 = 0; i_4 < PB_Q; i_4++) {
            for (int i_5 = i_4; i_5 < -i_3+PB_Q; i_5++) {
                for (int i_6 = 2; i_6 < min(-i_3+PB_M, PB_L); i_6++) {
                    B[i_5][i_4][i_3][i_6-1] = C[i_6+i_3][i_5][i_4][i_4] + C[i_4][i_3-1][i_6][i_5+i_3] + B[i_5][i_4][i_3+1][i_6-2] - B[i_6][i_5][i_3][i_4] - B[i_5+1][i_4][i_3-1][i_6-1] * 3;
                }
            }
        }
    }
...
kernel_4234111213_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C));
