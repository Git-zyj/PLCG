...
void kernel_4336312123_06(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = i_0; i_1 < PB_L; i_1++) {
            for (int i_2 = 2; i_2 < i_1; i_2++) {
                for (int i_3 = 1; i_3 < i_2; i_3++) {
                    B[i_2-2][i_1][i_0][i_3] = D[i_1][i_3-1][i_2] * 5;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < i_4; i_5++) {
            for (int i_6 = 0; i_6 < PB_L-1; i_6++) {
                for (int i_7 = 0; i_7 < PB_L; i_7++) {
                    B[i_5][i_7][i_6][i_4-2] = B[i_5][i_7][i_6][i_4-4] - B[i_5][i_7][i_6+1][i_4-2] * 2;
                }
            }
        }
        for (int i_8 = 0; i_8 < PB_L-2; i_8++) {
            for (int i_9 = 0; i_9 < PB_L; i_9++) {
                C[i_4][i_9][i_8+2] = D[i_9][i_4][i_8] + 2;
            }
        }
    }
#pragma endscop
...
kernel_4336312123_06(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
