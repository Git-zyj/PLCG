...
void kernel_2426252125_05(int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        D[i_0][i_0] = E[i_0] * F[i_0] * E[i_0-1] - F[i_0-2] + F[i_0+1] * F[i_0] * E[i_0] - 1;
        for (int i_1 = i_0; i_1 < PB_M; i_1++) {
            B[i_0+2][i_1+1] = G[i_1][i_1] + G[i_0+1][i_0+1] - F[i_1] + H[i_1-1][i_0] + H[i_1][i_1] * 4;
        }
    }
    for (int i_2 = 2; i_2 < PB_M-2; i_2++) {
        for (int i_3 = i_2; i_3 < PB_M; i_3++) {
            D[i_2-2][i_2-2] = G[i_2-2][i_2+2] - H[i_3][i_2] - E[i_2] * E[i_3] * 1;
            D[i_2][i_2] = H[i_2+2][i_2] + D[i_2-2][i_2-2] + 2;
        }
    }
#pragma endscop
...
kernel_2426252125_05(xd,yd,POLYBENCH_ARRAY(D), xb,yb,POLYBENCH_ARRAY(B), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
