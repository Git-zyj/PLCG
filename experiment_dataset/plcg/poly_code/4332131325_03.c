...
void kernel_4332131325_03(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
        ...
        for (int i_1 = 3; i_1 < -i_0+PB_P-1; i_1++) {
            for (int i_2 = 1; i_2 < PB_P-1; i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_P-1; i_3++) {
                    A[0][i_3][i_0][i_2+1] = D[i_3][i_1+i_0+1][i_2][i_2+1] - D[i_2][i_0][i_3-1][i_1] - D[i_3-1][i_1+1][i_0][i_2] - D[i_1][i_3-1][i_1][i_0] - E[i_2][i_1][i_1][i_3+i_0+1][1] * D[i_2-1][i_0][i_1-1][i_1+1] * A[0][i_3][i_0+1][i_1+1] - A[0][i_3+1][i_0][i_2+1] + 4;
                }
            }
            B[i_0-1] = F[i_1-1][i_0-1] - B[i_0+1] - B[i_1-2] + B[i_1-3] + B[i_1] + 4;
        }
    }
    for (int i_4 = 0; i_4 < PB_N; i_4++) {
        for (int i_5 = 1; i_5 < PB_N; i_5++) {
            for (int i_6 = 0; i_6 < min(i_5, PB_M-2); i_6++) {
                for (int i_7 = 0; i_7 < min(PB_P-1, -i_5+PB_P+1); i_7++) {
                    A[0][i_6+2][i_4][i_7+1] = G[i_6][i_7+i_5-1][i_6] + 5;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), INIT_SEED);
kernel_4332131325_03(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G)));
