...
void kernel_3336312211_08(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 0; i_1 < PB_L; i_1++) {
            for (int i_2 = i_1; i_2 < -i_0+PB_M-1; i_2++) {
                A[i_2+i_0][i_1][i_2+2] = A[i_2+i_0+1][i_1][i_2+2] + A[i_2+i_0+1][i_1][i_2+3] * 1;
            }
        }
        for (int i_3 = max(1, i_0); i_3 < PB_Q+1; i_3++) {
            for (int i_4 = 1; i_4 < -i_0+PB_M; i_4++) {
                A[i_4+i_0][i_3][i_0+2] = D[i_0][i_4-1][i_3-1] + 5;
            }
        }
    }
    for (int i_5 = 0; i_5 < PB_N; i_5++) {
        for (int i_6 = max(3, i_5); i_6 < PB_M+2; i_6++) {
            for (int i_7 = 2; i_7 < PB_L+2; i_7++) {
                C[i_5][i_6-2][i_7-2] = C[i_5][i_6-3][i_7-2] * 5;
            }
        }
    }
#pragma endscop
...
kernel_3336312211_08(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
