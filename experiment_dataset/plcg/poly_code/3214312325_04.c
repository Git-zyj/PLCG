...
void kernel_3214312325_04(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 4; i_0 < PB_N; i_0++) {
        A[i_0-2] = C[i_0] + 6;
        A[i_0-2] = A[i_0-2] * A[i_0-4] - A[i_0-3] * 6;
    }
#pragma endscop
...
kernel_3214312325_04(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
