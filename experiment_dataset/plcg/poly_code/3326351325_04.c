...
#pragma scop
    ...
    for (int i_1 = 2; i_1 < PB_M-1; i_1++) {
        A[i_1-2] = F[i_1] - D[i_1] * E[i_1+1] * F[i_1-1] * F[i_1] * D[i_1] - E[i_1] + E[i_1] - A[i_1] + 6;
    }
    for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
        for (int i_3 = 2; i_3 < PB_M-1; i_3++) {
            for (int i_4 = 2; i_4 < min(-i_3+PB_L, i_3); i_4++) {
                C[i_2][i_3][i_4-1] = G[i_2][i_4][i_3] - G[i_2+1][i_4][i_3] * H[i_4+i_3-1][i_2][0] + I[i_2-1][i_3+1][i_4+i_3] + I[i_2+1][i_3][i_4-1] * C[i_2-1][i_3][i_4-1] + C[i_2][i_3-2][i_4-2] * C[i_2][i_3][i_4+1] - C[i_2][i_3-2][i_4+1] + 1;
            }
        }
    }
#pragma endscop
...
kernel_3326351325_04(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
