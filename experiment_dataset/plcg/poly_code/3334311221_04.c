...
void kernel_3334311221_04(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = i_0; i_1 < PB_M; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_0+PB_M, -i_1+PB_M); i_2++) {
                A[i_2+i_1][i_2] = D[i_2+i_0][1] + 2;
            }
        }
    }
    for (int i_3 = 2; i_3 < PB_N-2; i_3++) {
        ...
        for (int i_4 = 2; i_4 < -i_3+PB_L-3; i_4++) {
            for (int i_5 = 0; i_5 < i_3; i_5++) {
                C[i_3][i_4+i_3][i_4-1] = C[i_3-1][i_4+i_3-1][i_4-1] * C[i_3+2][i_4+i_3+3][i_4] - C[i_3][i_4+i_3-1][i_4-2] - 2;
            }
        }
    }
#pragma endscop
...
kernel_3334311221_04(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
