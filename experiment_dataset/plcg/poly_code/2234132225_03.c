...
void kernel_2234132225_03(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 0; i_0 < PB_N; i_0++) {
        for (int i_1 = 0; i_1 < PB_M; i_1++) {
            A[i_1] = C[i_1] - A[i_1+2] * A[i_1+1] * 3;
        }
    }
    for (int i_2 = 2; i_2 < PB_M; i_2++) {
        A[i_2] = C[i_2] + C[i_2-2] * C[i_2] - C[i_2] + C[i_2] - 4;
    }
#pragma endscop
...
kernel_2234132225_03(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
