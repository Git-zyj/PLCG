...
void kernel_3224211323_04(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    ...
    for (int i_3 = 3; i_3 < PB_L-1; i_3++) {
        for (int i_4 = 0; i_4 < -i_3+PB_L-1; i_4++) {
            B[i_3-1][i_4+i_3-1] = C[i_3][i_4+1] * C[i_3+1][i_4] - B[i_3-2][i_4+i_3-3] * B[i_3-1][i_4+i_3+1] * B[i_3+1][i_4+i_3+1] - 1;
        }
    }
#pragma endscop
...
kernel_3224211323_04(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
