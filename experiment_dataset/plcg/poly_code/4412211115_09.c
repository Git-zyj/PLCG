...
void kernel_4412211115_09(int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf)){
        ...
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_L; i_2++) {
                for (int i_3 = 1; i_3 < -i_1+PB_M; i_3++) {
                    C[i_0][i_2+i_1][i_3][i_3-1] = E[i_3+i_1][i_0][i_2-1][i_1-1] * 1;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < PB_L; i_5++) {
            for (int i_6 = 1; i_6 < min(-i_5+PB_L, -i_4+PB_P); i_6++) {
                for (int i_7 = 1; i_7 < PB_L; i_7++) {
                    C[i_4-1][i_6+i_5][i_7][i_7-1] = E[i_5][i_6-1][i_4][i_7] + 1;
                    C[i_4-1][i_6+i_5][i_7][i_7-1] = F[i_5][i_7][i_7][i_6+i_4] * 4;
                }
                for (int i_8 = 1; i_8 < PB_L; i_8++) {
                    D[i_8-1][i_8][i_6][0] = D[i_8][i_8+1][i_6][0] + 5;
                }
            }
        }
    }
...
init_array(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), INIT_SEED);
kernel_4412211115_09(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F));
polybench_prevent_dce(print_array(xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F)));
