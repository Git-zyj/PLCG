...
void kernel_2412251221_05(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        A[i_0] = E[i_0] + F[i_0] * E[i_0] + E[i_0-1] - E[i_0] + B[i_0] - 5;
        B[i_0] = F[1] + F[0] - G[i_0-1][i_0] - 4;
        for (int i_1 = 3; i_1 < min(-i_0+PB_M, PB_Q-1); i_1++) {
            C[i_1][i_0-1][i_1-1] = E[i_1-1] - H[i_1][i_1] * E[i_0] + H[i_1+i_0][i_1-1] * H[i_1][i_0+1] - B[i_1] * C[i_1+2][i_0-1][i_1+1] * C[i_1-2][i_0-1][i_1-3] - C[i_1][i_0+1][i_1-1] + C[i_1][i_0-2][i_1-1] - 6;
        }
    }
    for (int i_2 = 1; i_2 < PB_M; i_2++) {
        D[i_2] = F[i_2] - E[i_2-1] + F[i_2] * F[i_2] * A[i_2] - 6;
    }
#pragma endscop
...
kernel_2412251221_05(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H));
