...
void kernel_4222212313_04(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_4 = 0; i_4 < PB_P-3; i_4++) {
        for (int i_5 = 2; i_5 < -i_4+PB_L; i_5++) {
            for (int i_6 = 1; i_6 < PB_M; i_6++) {
                B[i_5-1][i_6][i_4+2] = C[i_6][i_5+i_4][i_4] + B[i_5-1][i_6-1][i_4+2] * B[i_5-2][i_6][i_4+3] * B[i_5-2][i_6-1][i_4+3] - 1;
            }
        }
    }
#pragma endscop
...
kernel_4222212313_04(xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
