...
void kernel_4436351315_06(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,int yl,DATA_TYPE POLYBENCH_2D(L,xL,yL,xl,yl)){
        ...
        for (int i_1 = 1; i_1 < min(-i_0+PB_Q+1, PB_L); i_1++) {
            for (int i_2 = 1; i_2 < min(min(-i_0+PB_P, i_0), PB_L-1); i_2++) {
                for (int i_3 = 1; i_3 < -i_0+PB_L; i_3++) {
                    B[i_0][i_1][i_3+i_2][i_3] = E[i_3+i_0][i_1][i_2+1][i_1] + F[i_1][i_2+1][i_3][i_0][i_2] + G[i_2-1][i_0][i_3-1][i_1] - H[i_2-1][i_0][i_3][i_1] - G[i_1][i_2+i_0][i_3][i_1+i_0-1] + G[i_0][i_2][i_3][i_1+1] + H[i_2+1][i_1-1][i_3][i_2] + E[i_1][i_0][i_2][i_3+1] + 1;
                }
            }
        }
    }
        ...
        for (int i_5 = i_4; i_5 < PB_L; i_5++) {
            for (int i_6 = 1; i_6 < -i_4+PB_P-1; i_6++) {
                for (int i_7 = 0; i_7 < -i_4+PB_P-1; i_7++) {
                    B[i_5][i_6][i_7+i_4][i_7] = E[i_6-1][i_7][i_5][i_4] * H[i_7+i_6-1][i_7][i_5-1][i_4-1] * G[i_6][i_6][i_4][i_5] + G[i_5][i_4][i_4][i_6-1] + B[i_5][i_6-1][i_7+i_4][i_7] * B[i_5-1][i_7][i_6+i_4+1][i_6] - B[i_5-1][i_6][i_7+i_4+1][i_7] - B[i_5][i_6][i_7+i_4+1][i_7+1] * 4;
                }
            }
        }
    }
    for (int i_8 = 1; i_8 < PB_L-1; i_8++) {
        C[i_8] = I[i_8] * J[i_8+1] + C[i_8-1] + 4;
        C[i_8] = K[i_8] + L[i_8][i_8+1] * J[i_8-1] * J[i_8] * C[i_8] * 6;
    }
#pragma endscop
...
init_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L), INIT_SEED);
kernel_4436351315_06(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L));
polybench_prevent_dce(print_array(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,yl,POLYBENCH_ARRAY(L)));
