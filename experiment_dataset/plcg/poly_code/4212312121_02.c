...
void kernel_4212312121_02(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_4 = 0; i_4 < PB_L; i_4++) {
        for (int i_5 = 2; i_5 < PB_L-2; i_5++) {
            for (int i_6 = 2; i_6 < -i_4+PB_L; i_6++) {
                B[i_4][i_5][i_6] = C[i_5][i_6+i_4][i_5] * B[i_6][i_4][i_5-2] + B[i_6-2][i_5+2][i_4] - 4;
            }
        }
    }
#pragma endscop
...
kernel_4212312121_02(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
