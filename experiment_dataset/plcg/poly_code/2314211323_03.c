...
void kernel_2314211323_03(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd)){
...
kernel_2314211323_03(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D));
