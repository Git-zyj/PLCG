        ...
        for (int i_1 = 2; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 2; i_2 < PB_Q-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_M-2; i_3++) {
                    A[i_1-2][i_0][i_3] = E[i_3+2][i_0+1][i_2+1][i_1-2] * F[i_3][i_1][i_2-2] - A[i_1-2][i_0][i_3-1] + A[i_2-2][i_1+1][i_0] * 2;
                }
            }
            for (int i_4 = 0; i_4 < min(-i_0+PB_M, -i_1+PB_Q); i_4++) {
                for (int i_5 = 0; i_5 < i_1; i_5++) {
                    A[i_1-2][i_5+1][i_0-1] = E[i_4][i_1][i_5][i_4] - G[i_5][i_0+2][i_1][i_4+i_0] - G[i_4+i_0][i_1][i_5][i_5] - H[i_1][i_0][i_5][i_4+i_1][i_5] + 2;
                }
            }
        }
        C[i_0] = I[i_0] + J[0] - C[i_0-1] + C[i_0+1] + C[i_0+1] - 6;
    }
    for (int i_6 = 0; i_6 < PB_L; i_6++) {
        for (int i_7 = max(i_6, 1); i_7 < PB_L-1; i_7++) {
            D[i_7][i_7] = K[i_6+1][i_7+1] + L[i_7][i_6] - K[i_6][i_7] - C[i_7-1] - D[i_7+1][i_7+1] * D[i_7-1][i_7-1] * D[i_7+1][i_7+1] + 6;
        }
    }
#pragma endscop
