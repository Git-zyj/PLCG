...
void kernel_4426251111_08(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,DATA_TYPE POLYBENCH_1D(G,xG,xg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
        ...
        for (int i_1 = 0; i_1 < i_0; i_1++) {
            for (int i_2 = 0; i_2 < min(-i_0+PB_Q, -i_1+PB_P); i_2++) {
                for (int i_3 = 0; i_3 < min(PB_Q-1, -i_0+PB_L); i_3++) {
                    A[i_2][i_1][i_0][i_3] = E[i_2][i_3][i_1][i_0] * E[i_1+1][i_3][i_2+i_0][i_0+1] + E[i_3+i_0][i_2+i_1][i_0-1][i_3+1] * 4;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
        B[i_4] = F[i_4] + F[i_4] + F[i_4] * G[i_4+1] * F[i_4] - G[i_4-1] - F[i_4-1] - F[i_4] - B[i_4+1] * 2;
    }
    for (int i_5 = 1; i_5 < PB_Q-1; i_5++) {
        for (int i_6 = 1; i_6 < PB_M-1; i_6++) {
            for (int i_7 = i_5; i_7 < -i_6+PB_Q; i_7++) {
                for (int i_8 = 0; i_8 < min(-i_5+PB_P, -i_6+PB_Q+1); i_8++) {
                    C[i_5][i_7][i_8+i_6-1][i_6+1] = H[i_6][i_8][i_8][i_5-1] + E[i_7][i_8+i_5][i_6][i_5] - E[i_7][i_5-1][i_8+i_6-1][i_7] * C[i_5-1][i_7][i_8+i_6-1][i_6] * 6;
                }
                for (int i_9 = i_5; i_9 < min(-i_6+PB_P, PB_M-1); i_9++) {
                    D[i_6+1][i_5][i_7-1][i_6-1] = E[i_7-1][i_7+1][i_9][i_6+1] + E[i_9+1][i_5][i_7+i_6][i_7+1] - H[0][i_7][i_9+i_6][i_5+1] - E[i_7][i_9+1][i_5][i_6] - H[i_9][i_6][i_7][i_6+1] * A[i_9+1][i_6][i_5][i_7] + 4;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4426251111_08(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H)));
