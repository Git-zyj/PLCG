...
void kernel_3214311113_09(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
kernel_3214311113_09(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
