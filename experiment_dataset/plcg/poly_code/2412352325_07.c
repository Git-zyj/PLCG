...
void kernel_2412352325_07(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P+2; i_0++) {
        for (int i_1 = 1; i_1 < min(-i_0+PB_M, i_0); i_1++) {
            B[i_0][i_0-2] = E[i_1-1][i_0] - F[i_1+i_0] * E[i_1][i_0-1] + E[i_1+i_0][i_0] - 6;
        }
    }
    for (int i_2 = 4; i_2 < PB_N; i_2++) {
        B[i_2][i_2-2] = F[i_2] * F[i_2+1] + G[i_2][0] * B[i_2-1][i_2-3] + 2;
        B[i_2-2][i_2-4] = H[i_2-1][i_2+2] * F[i_2] + B[i_2][i_2-2] - 2;
        B[i_2+2][i_2] = I[i_2] * F[i_2+1] + F[i_2] + F[i_2+1] - F[i_2] - J[i_2] + I[i_2-1] - J[i_2-2] * H[i_2][i_2+2] * B[i_2+1][i_2-1] * 5;
    }
#pragma endscop
...
kernel_2412352325_07(xb,yb,POLYBENCH_ARRAY(B), xe,ye,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J));
