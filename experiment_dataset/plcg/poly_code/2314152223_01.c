...
void kernel_2314152223_01(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_P-2; i_0++) {
        for (int i_1 = 2; i_1 < min(-i_0+PB_L, i_0); i_1++) {
            B[i_1] = D[i_0+2][i_0+1] - D[i_1][i_0] + D[i_1][i_0] + D[i_1][i_1] + D[i_1][i_0] + D[i_1][i_0-2] + B[i_1] - 5;
            B[i_1] = D[i_0+2][i_1+2] * D[i_1+i_0][i_0+2] - D[i_0][i_1+1] - B[i_1-2] + 3;
        }
    }
    for (int i_2 = 2; i_2 < PB_P-1; i_2++) {
        for (int i_3 = 0; i_3 < -i_2+PB_P-1; i_3++) {
            C[i_3+1] = D[i_3+1][i_2-2] - D[i_3+i_2][i_2] - D[i_3][i_3+i_2+1] + D[i_3][i_3+i_2] + C[i_3+2] + 1;
        }
    }
#pragma endscop
...
kernel_2314152223_01(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
