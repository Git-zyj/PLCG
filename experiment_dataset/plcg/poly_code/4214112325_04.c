...
void kernel_4214112325_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
        ...
        for (int i_1 = 2; i_1 < PB_N; i_1++) {
            for (int i_2 = 2; i_2 < PB_N-2; i_2++) {
                for (int i_3 = 0; i_3 < PB_L; i_3++) {
                    A[i_1][i_2][i_3] = A[i_1][i_2+2][i_3] * A[i_1-1][i_3][i_2-2] * A[i_1-1][i_2][i_3] * 6;
                }
                A[i_1][i_0][i_2] = C[i_2+2][i_1][i_0-1] * C[i_2][i_1-2][i_0+1] * 4;
            }
        }
    }
#pragma endscop
...
kernel_4214112325_04(xa,ya,za,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C));
