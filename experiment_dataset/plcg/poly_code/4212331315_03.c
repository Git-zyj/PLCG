...
void kernel_4212331315_03(int xb,int yb,int zb,int vb,DATA_TYPE POLYBENCH_4D(B,xB,yB,zB,vB,xb,yb,zb,vb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,int we,DATA_TYPE POLYBENCH_5D(E,xE,yE,zE,vE,wE,xe,ye,ze,ve,we)){
        ...
        for (int i_1 = 0; i_1 < PB_P-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_P-1; i_2++) {
                for (int i_3 = 0; i_3 < min(-i_1+PB_P, PB_M-2); i_3++) {
                    B[i_2+1][i_3][i_3][i_0+1] = C[i_1][i_3][i_0-1][i_2+1] + D[i_3+1][i_2][i_1+1][i_0] - D[1][i_2][i_3+i_1][i_0+1] * B[i_3+2][i_0][i_0][i_1+1] - 1;
                }
            }
        }
    }
        ...
        for (int i_5 = 0; i_5 < PB_L; i_5++) {
            for (int i_6 = 1; i_6 < PB_M-1; i_6++) {
                for (int i_7 = 0; i_7 < min(-i_6+PB_L, PB_M-2); i_7++) {
                    B[i_6+1][i_4][i_4][i_5+1] = C[i_5][i_7+i_6][i_4][i_4] + C[i_5][i_7][i_4][i_6-1] + E[i_6][i_4][0][i_7][i_4] - B[i_7+1][i_4+1][i_4+1][i_5+1] * B[i_7+2][i_4+1][i_4+1][i_6+2] - 1;
                }
            }
        }
    }
...
kernel_4212331315_03(xb,yb,zb,vb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,we,POLYBENCH_ARRAY(E));
