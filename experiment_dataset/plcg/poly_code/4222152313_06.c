...
void kernel_4222152313_06(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_Q; i_0++) {
        for (int i_1 = 2; i_1 < PB_P; i_1++) {
            for (int i_2 = 2; i_2 < min(-i_1+PB_P+2, PB_Q-2); i_2++) {
                for (int i_3 = 2; i_3 < PB_P-2; i_3++) {
                    A[i_0][i_2-2][i_2][i_3+1] = C[i_3-1][i_2][i_1][i_2] - C[i_0][i_1][i_3-1][2] + C[i_0][i_2][i_1][i_3] + C[i_2][i_3-1][i_1-2][i_0] * C[i_0][i_3-2][i_2+i_1-2][i_2+2] - D[i_3-2][i_0][i_2] + A[i_0][i_2-1][i_2+1][i_3+2] + A[i_0][i_2-1][i_2+1][i_3+1] - A[i_0-1][i_2-2][i_2][i_3+1] - 1;
                }
            }
        }
        for (int i_4 = 3; i_4 < PB_Q; i_4++) {
            for (int i_5 = 0; i_5 < PB_Q-2; i_5++) {
                for (int i_6 = 2; i_6 < min(-i_0+PB_L, PB_P-1); i_6++) {
                    A[i_0-1][i_4-3][i_4-1][i_6+1] = C[i_6-2][i_5][i_0-2][i_5+2] + C[i_5][i_6+i_0][i_6][i_4] + C[i_4][i_0][i_6][i_0] + C[i_4][i_4][i_5][1] + 5;
                }
            }
        }
    }
...
kernel_4222152313_06(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
