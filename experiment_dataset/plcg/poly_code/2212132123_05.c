...
void kernel_2212132123_05(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        B[0] = C[i_0-2] + C[i_0] - 4;
        B[0] = C[i_0-1] * C[0] * C[i_0] + B[0] + 6;
    }
#pragma endscop
...
kernel_2212132123_05(xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
