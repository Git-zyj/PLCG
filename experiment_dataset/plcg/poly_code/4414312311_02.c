...
void kernel_4414312311_02(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve)){
...
#pragma scop
    ...
    for (int i_2 = 2; i_2 < PB_Q-2; i_2++) {
        for (int i_3 = 3; i_3 < -i_2+PB_L+1; i_3++) {
            for (int i_4 = 0; i_4 < min(min(-i_3+PB_L, -i_2+PB_P-1), i_3); i_4++) {
                B[i_3-2][i_4+i_3][i_4+i_2] = E[i_4+1][i_2][i_3][i_2+1] - B[i_3-2][i_4+i_3][i_4+i_2-1] - B[i_3-3][i_3+i_2-1][i_4+i_2] * B[i_3-2][i_4+i_3][i_4+i_2+1] * B[i_3-2][i_4+i_3-1][i_4+i_2-1] + 6;
            }
            C[i_3][i_2-1] = C[i_3][i_2-2] * C[i_3][i_2] - C[i_3+1][i_2-1] + C[i_3-1][i_2-2] * 6;
        }
        for (int i_5 = 1; i_5 < i_2; i_5++) {
            for (int i_6 = i_2; i_6 < PB_Q-2; i_6++) {
                for (int i_7 = 0; i_7 < PB_P; i_7++) {
                    D[i_5][i_7][i_2+2][i_6] = D[i_2][i_7][i_6+2][i_5-1] * 4;
                }
            }
        }
    }
...
kernel_4414312311_02(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
