...
void kernel_4422332321_09(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,int wf,DATA_TYPE POLYBENCH_5D(F,xF,yF,zF,vF,wF,xf,yf,zf,vf,wf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,int yj,DATA_TYPE POLYBENCH_2D(J,xJ,yJ,xj,yj),int xk,int yk,int zk,int vk,DATA_TYPE POLYBENCH_4D(K,xK,yK,zK,vK,xk,yk,zk,vk)){
        ...
        for (int i_1 = 1; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 2; i_2 < -i_0+PB_M-2; i_2++) {
                for (int i_3 = 2; i_3 < -i_0+PB_L-2; i_3++) {
                    A[i_1][i_2][i_3] = E[i_2+i_0+2][i_0][i_3-2][i_1+2] * F[i_2-2][i_0][i_3-1][i_1-1][i_0] * G[i_2][i_3-1][i_3][i_0] + E[i_1][i_2+2][i_3+i_0+2][0] + E[i_3+1][i_1+2][i_2][2] * A[i_2][i_3-2][i_1+2] - A[i_2+2][i_0][i_3] * 5;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L-3; i_4++) {
        for (int i_5 = 2; i_5 < PB_L; i_5++) {
            for (int i_6 = 0; i_6 < PB_L; i_6++) {
                B[i_4+2][i_5][i_5] = H[i_6][i_4+1][i_4+2] * B[i_4+2][i_5-1][i_5-1] + B[i_4+1][i_5][i_5] * B[i_4+4][i_5-2][i_5-2] + B[i_4+3][i_6][i_6] - 2;
            }
        }
        for (int i_7 = 0; i_7 < PB_L-1; i_7++) {
            for (int i_8 = 0; i_8 < -i_4+PB_L-1; i_8++) {
                C[i_8+2][i_4][i_8+i_4] = I[i_8][i_7][i_4] - J[i_8][i_7+1] + K[i_7][i_8][i_4][i_7] + C[i_8+3][i_4-2][i_8+i_4-1] + C[i_8+2][i_4-1][i_8+i_4-1] * C[i_8+1][i_4][i_8+i_4-1] * C[i_8+3][i_4][i_8+i_4+1] * 4;
            }
        }
        for (int i_9 = 0; i_9 < PB_L; i_9++) {
            for (int j_0 = 0; j_0 < i_4; j_0++) {
                D[i_4+2][i_4][j_0] = H[j_0][i_4][i_9] - I[i_9][i_4][j_0+1] - I[i_9][j_0][i_4] + D[i_4+3][i_4+1][j_0] + D[i_4][i_4-2][j_0+2] + 2;
            }
        }
    }
#pragma endscop
...
kernel_4422332321_09(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,wf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), xk,yk,zk,vk,POLYBENCH_ARRAY(K));
