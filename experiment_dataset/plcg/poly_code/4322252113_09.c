        ...
        for (int i_2 = 3; i_2 < PB_Q-2; i_2++) {
            for (int i_3 = 0; i_3 < min(i_1, -i_2+PB_Q-2); i_3++) {
                for (int i_4 = 1; i_4 < -i_1+PB_L; i_4++) {
                    C[i_2-3][i_4][i_3] = F[i_3][i_1][i_4-1][i_4] * F[i_4+i_3][i_1-1][i_4][i_3+i_2+2] * F[i_3][i_3][i_4-1][i_1] * G[i_3+2][i_4+i_1][i_2][1][i_4] - 6;
                }
            }
        }
        for (int i_5 = 1; i_5 < PB_L-2; i_5++) {
            for (int i_6 = 2; i_6 < PB_L; i_6++) {
                C[i_1-2][i_5][i_6] = H[i_6][i_1][i_5-1] - H[i_1][i_6][i_1+2] + I[i_1][i_6][i_6-2] - I[i_6][i_1][i_5+2] + J[i_6-2][i_5] + C[i_1-2][i_5+1][i_6+1] * 5;
            }
        }
    }
#pragma endscop
...
init_array(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J), INIT_SEED);
kernel_4322252113_09(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J));
polybench_prevent_dce(print_array(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,wg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,yj,POLYBENCH_ARRAY(J)));
