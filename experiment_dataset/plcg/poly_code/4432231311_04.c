...
void kernel_4432231311_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xf,int yf,int zf,DATA_TYPE POLYBENCH_3D(F,xF,yF,zF,xf,yf,zf),int xg,int yg,int zg,int vg,DATA_TYPE POLYBENCH_4D(G,xG,yG,zG,vG,xg,yg,zg,vg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh)){
        ...
        for (int i_1 = 1; i_1 < min(-i_0+PB_P-2, PB_M-2); i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_P-1; i_2++) {
                for (int i_3 = 1; i_3 < PB_M-2; i_3++) {
                    A[i_1-1][i_0][i_1][i_3-1] = C[i_1+2][i_2+i_0+1][i_3-1][i_3+1] + D[i_3+2][i_2][i_1+i_0+2][i_2+1] * 5;
                }
            }
        }
        for (int i_4 = 1; i_4 < PB_M-1; i_4++) {
            B[i_4+1] = E[i_0][i_4] * F[i_4-1][i_0][i_4-1] - F[i_0][i_4][1] - B[i_4] - 4;
        }
    }
        ...
        for (int i_6 = 1; i_6 < PB_M-2; i_6++) {
            for (int i_7 = 0; i_7 < -i_5+PB_P-1; i_7++) {
                for (int i_8 = 1; i_8 < PB_M; i_8++) {
                    C[i_6+1][i_7+i_5+1][i_8-1][i_8+1] = F[i_8][i_6-1][i_7] - G[i_8][i_5-1][i_6-1][i_7] - A[i_5-1][i_6][i_5][i_8-1] - C[i_6+2][i_7+i_5+1][i_8-1][i_8+1] + 1;
                }
            }
        }
        for (int i_9 = 1; i_9 < -i_5+PB_P-1; i_9++) {
            for (int j_0 = 1; j_0 < PB_P-2; j_0++) {
                for (int j_1 = 0; j_1 < min(min(i_5, -i_9+PB_P-2), -i_5+PB_P-1); j_1++) {
                    D[j_1+1][j_0][i_9+i_5+1][j_0+1] = G[j_1][j_0][i_5][i_9] * H[j_1][j_0+i_9-1][i_5][i_5] * G[j_1][j_0][i_5][i_9] * G[j_1][j_0][i_5-1][i_9-1] * C[j_1+1][i_9+i_5][j_0-1][j_0+1] * D[j_1+1][j_0][i_9+i_5][j_0+1] * D[i_9+1][j_0+1][j_1+i_5+1][j_0+2] - D[i_5+2][j_0][j_1+i_9+2][j_0+1] * 3;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), INIT_SEED);
kernel_4432231311_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E), xf,yf,zf,POLYBENCH_ARRAY(F), xg,yg,zg,vg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H)));
