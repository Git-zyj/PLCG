...
void kernel_4224231221_07(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye)){
        ...
        for (int i_1 = 3; i_1 < PB_L; i_1++) {
            for (int i_2 = max(3, i_0); i_2 < PB_L-2; i_2++) {
                for (int i_3 = 1; i_3 < PB_L-1; i_3++) {
                    A[i_2][i_0-1][i_3-1] = A[i_1][i_2][i_3-1] + A[i_3+1][i_2-3][i_1-3] + A[i_2+2][i_3-1][i_1-2] - 1;
                }
            }
        }
    }
    for (int i_4 = 1; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 1; i_5 < -i_4+PB_L-1; i_5++) {
            for (int i_6 = 0; i_6 < PB_L-1; i_6++) {
                B[i_4-1][i_6+1][i_6+1] = C[i_6+i_5-1][i_4][i_5] + D[i_6][i_4][1] + C[i_6+i_5][i_4][i_5+i_4] * C[i_5][i_4][i_6] + D[i_6+i_5][i_6][i_4-1] * E[i_6][i_5+i_4+1] - 1;
            }
        }
    }
#pragma endscop
...
kernel_4224231221_07(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,POLYBENCH_ARRAY(E));
