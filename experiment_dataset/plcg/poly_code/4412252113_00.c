...
#pragma scop
    ...
    for (int i_2 = 2; i_2 < PB_M-1; i_2++) {
        for (int i_3 = 2; i_3 < min(-i_2+PB_M+2, PB_M-2); i_3++) {
            C[i_3] = H[i_3][i_2] * F[i_3+i_2] * 1;
            C[i_3] = H[i_2+1][i_3-1] * G[i_3][i_2-1] + I[i_3-2][i_2][i_2-2] + H[i_2][i_3] * G[i_3+2][i_2] + H[i_3-1][i_2] * G[i_3][i_2] * G[i_3][i_3+i_2-2] + C[i_2] - 3;
        }
    }
#pragma endscop
...
kernel_4412252113_00(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
