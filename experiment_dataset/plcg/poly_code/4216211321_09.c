...
void kernel_4216211321_09(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc)){
    ...
    for (int i_3 = 0; i_3 < PB_M; i_3++) {
        for (int i_4 = max(1, i_3); i_4 < min(-i_3+PB_M, PB_M-1); i_4++) {
            for (int i_5 = i_4; i_5 < -i_4+PB_M-1; i_5++) {
                B[i_4+i_3][i_5] = C[i_5+i_4][i_3][i_4+i_3] - B[i_5+i_4][i_3] - B[i_5+i_4-1][i_3] * B[i_5+i_4+1][i_3+2] + 4;
            }
        }
    }
#pragma endscop
...
kernel_4216211321_09(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C));
