...
void kernel_4224152221_04(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 4; i_1 < PB_N+2; i_1++) {
            for (int i_2 = i_0; i_2 < PB_N+1; i_2++) {
                for (int i_3 = 2; i_3 < min(-i_0+PB_L, i_1); i_3++) {
                    A[i_1-2][i_2][i_3-2] = C[i_1-2][i_2-2][i_3+i_0][i_0] + A[i_2-2][i_3][i_1-4] * A[i_2-1][i_3][i_0-2] * A[i_1-2][i_2][i_3] + 3;
                }
            }
        }
    }
        ...
        for (int i_5 = 2; i_5 < -i_4+PB_N; i_5++) {
            for (int i_6 = 2; i_6 < PB_N; i_6++) {
                for (int i_7 = 2; i_7 < i_5; i_7++) {
                    B[i_6][i_4][i_5] = C[i_4][i_7+1][i_6+1][i_5-2] + C[i_5+i_4][i_7-2][i_5-2][i_6] * C[i_5][i_4-2][i_7][0] + D[i_6][i_4][i_5] + D[i_6][i_7][i_5-1] - C[i_7][i_6][i_4-1][i_6] + C[i_6][i_4][i_7+i_5-2][0] * C[i_5][i_6][i_7][i_4] + D[i_4][i_7+i_5][i_6] - B[i_5][i_4][i_6-2] * 2;
                }
            }
        }
    }
...
kernel_4224152221_04(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
