...
void kernel_4426352311_04(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg),int xh,int yh,int zh,int vh,DATA_TYPE POLYBENCH_4D(H,xH,yH,zH,vH,xh,yh,zh,vh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi),int xj,DATA_TYPE POLYBENCH_1D(J,xJ,xj),int xk,DATA_TYPE POLYBENCH_1D(K,xK,xk),int xl,DATA_TYPE POLYBENCH_1D(L,xL,xl),int xm,int ym,DATA_TYPE POLYBENCH_2D(M,xM,yM,xm,ym),int xn,int yn,int zn,int vn,int wn,DATA_TYPE POLYBENCH_5D(N,xN,yN,zN,vN,wN,xn,yn,zn,vn,wn)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_M-3; i_0++) {
        for (int i_1 = i_0; i_1 < min(-i_0+PB_P+1, PB_L-1); i_1++) {
            for (int i_2 = 2; i_2 < min(-i_0+PB_Q, PB_M-1); i_2++) {
                for (int i_3 = 2; i_3 < PB_L; i_3++) {
                    A[i_2][i_0][i_2][i_3] = E[i_1-2][i_3][i_2][i_0] - F[i_2][i_3][i_0][i_1] + G[i_2-2][i_3][i_1] - H[i_3-2][i_1+i_0-1][i_2-1][i_2+i_0] + I[i_2-2][i_1][i_3] * A[i_3][i_1+1][i_3][i_2-1] * A[i_2][i_0][i_2][i_3-1] * A[i_2][i_3][i_2][i_0+1] - A[i_2+1][i_0][i_2+1][i_3] + 6;
                }
            }
        }
        B[i_0+2] = J[0] + J[i_0-2] - K[i_0] - L[i_0] - K[i_0] + K[i_0+2] - L[i_0] * M[i_0-1][i_0] * J[i_0] * B[i_0+3] + B[i_0+1] + B[i_0+3] + 5;
    }
    for (int i_4 = 2; i_4 < PB_M-2; i_4++) {
        C[i_4+2] = K[i_4] * C[i_4+1] + 5;
        for (int i_5 = 1; i_5 < PB_L; i_5++) {
            for (int i_6 = 1; i_6 < min(min(min(i_4, -i_5+PB_L), PB_L-2), -i_4+PB_L); i_6++) {
                for (int i_7 = 0; i_7 < -i_6+PB_L; i_7++) {
                    D[i_4+1][i_6+i_5][i_6][i_7+1] = H[i_5][i_4-2][i_7][i_6+2] - G[i_7][i_5][i_6+2] * N[i_7+i_6][i_4][i_6+i_5+1][i_4-1][i_7+i_6-1] + H[i_7+i_6][i_6+1][i_7][i_5] * D[i_4+1][i_6+i_5-1][i_6][i_7+1] * D[i_5][i_6+i_4][i_4][i_7+1] + 3;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M), xn,yn,zn,vn,wn,POLYBENCH_ARRAY(N), INIT_SEED);
kernel_4426352311_04(xa,ya,za,va,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G), xh,yh,zh,vh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), xj,POLYBENCH_ARRAY(J), xk,POLYBENCH_ARRAY(K), xl,POLYBENCH_ARRAY(L), xm,ym,POLYBENCH_ARRAY(M), xn,yn,zn,vn,wn,POLYBENCH_ARRAY(N));
