...
void kernel_3234112123_06(int xa,int ya,int za,DATA_TYPE POLYBENCH_3D(A,xA,yA,zA,xa,ya,za),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = PB_M-2 - 1; i_0 >= 2; i_0--) {
        for (int i_1 = max(3, i_0); i_1 < PB_M-2; i_1++) {
            A[i_1+2][i_0-2][i_0] = A[i_0+2][i_1-3][i_1-1] * B[i_1+2] * 3;
        }
        B[i_0] = C[i_0] * 1;
    }
#pragma endscop
...
kernel_3234112123_06(xa,ya,za,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
