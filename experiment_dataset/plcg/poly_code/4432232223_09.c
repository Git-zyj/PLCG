...
void kernel_4432232223_09(int xa,int ya,int za,int va,DATA_TYPE POLYBENCH_4D(A,xA,yA,zA,vA,xa,ya,za,va),int xc,int yc,int zc,int vc,DATA_TYPE POLYBENCH_4D(C,xC,yC,zC,vC,xc,yc,zc,vc),int xd,int yd,int zd,int vd,DATA_TYPE POLYBENCH_4D(D,xD,yD,zD,vD,xd,yd,zd,vd),int xe,int ye,int ze,int ve,DATA_TYPE POLYBENCH_4D(E,xE,yE,zE,vE,xe,ye,ze,ve),int xf,int yf,int zf,int vf,DATA_TYPE POLYBENCH_4D(F,xF,yF,zF,vF,xf,yf,zf,vf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,int zh,DATA_TYPE POLYBENCH_3D(H,xH,yH,zH,xh,yh,zh),int xi,int yi,int zi,DATA_TYPE POLYBENCH_3D(I,xI,yI,zI,xi,yi,zi)){
        ...
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            for (int i_2 = 0; i_2 < PB_M; i_2++) {
                for (int i_3 = 2; i_3 < PB_M-2; i_3++) {
                    A[i_0][i_2][i_0][i_3-1] = E[i_2][i_0][i_3+1][i_1] + E[i_3+2][i_2][i_3-2][i_1] * F[i_1][i_0][i_1-1][i_2] - F[i_2][i_3-1][i_1][i_0] * A[i_2][i_0+1][i_2][i_3] - 2;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L-2; i_4++) {
        for (int i_5 = 2; i_5 < PB_M; i_5++) {
            for (int i_6 = 0; i_6 < min(-i_5+PB_P, i_4); i_6++) {
                A[i_5-2][i_6][i_5-2][i_4-1] = G[i_6+i_5][i_4] * H[i_5][i_6][i_4] - H[i_6+1][i_4+2][i_5-1] * H[i_6][i_5][i_5] * H[i_5][i_4-1][0] + 2;
            }
        }
        for (int i_7 = 0; i_7 < PB_M; i_7++) {
            for (int i_8 = 0; i_8 < i_7; i_8++) {
                for (int i_9 = 0; i_9 < min(min(-i_7+PB_P, -i_8+PB_P), PB_M-1); i_9++) {
                    C[i_4-2][i_7][i_9+i_8][i_9] = F[i_7][i_4][i_8+1][i_9+i_7] - E[i_9+1][i_7][i_4-2][i_8+1] * 2;
                }
            }
        }
        for (int j_0 = 0; j_0 < min(PB_M-4, -i_4+PB_Q); j_0++) {
            for (int j_1 = 2; j_1 < PB_P-1; j_1++) {
                for (int j_2 = 1; j_2 < j_1; j_2++) {
                    D[j_0+2][j_2][j_1][j_1-2] = I[j_2][j_0+i_4][j_1] + D[j_0+2][j_2-1][j_1+1][j_1-1] - D[j_0+4][i_4+1][j_1][j_1-2] - D[j_0+2][j_2][j_1+1][j_1-1] * 4;
                }
            }
        }
    }
...
init_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I), INIT_SEED);
kernel_4432232223_09(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I));
polybench_prevent_dce(print_array(xa,ya,za,va,POLYBENCH_ARRAY(A), xc,yc,zc,vc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E), xf,yf,zf,vf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,zh,POLYBENCH_ARRAY(H), xi,yi,zi,POLYBENCH_ARRAY(I)));
