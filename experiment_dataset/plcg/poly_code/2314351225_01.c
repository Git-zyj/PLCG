...
void kernel_2314351225_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,int yi,DATA_TYPE POLYBENCH_2D(I,xI,yI,xi,yi)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-3; i_0++) {
        A[i_0+1] = D[1] - E[i_0+1] * F[i_0-1] - F[i_0] + A[i_0+3] - 1;
    }
    for (int i_1 = 2; i_1 < PB_L-2; i_1++) {
        for (int i_2 = -i_1+PB_L-2 - 1; i_2 >= 2; i_2--) {
            C[i_2][i_2+i_1][i_1-1] = G[i_1-1][i_2] + H[i_2][i_1] + G[i_2+1][i_1] * E[i_2-1] + H[i_2][i_1] * 5;
            C[i_1][i_2+i_1][i_2-1] = H[i_2][i_1+1] - I[i_2+i_1][i_2] - G[i_2][i_1+1] + H[i_2][i_1] - G[i_2+i_1][i_1] - C[i_1][i_2+i_1-1][i_2-2] + C[i_2][i_2+i_1-1][i_1-2] * C[i_1+2][i_2+i_1+2][i_2-1] - 3;
        }
    }
#pragma endscop
...
kernel_2314351225_01(xa,POLYBENCH_ARRAY(A), xc,yc,zc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,POLYBENCH_ARRAY(F), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,yi,POLYBENCH_ARRAY(I));
