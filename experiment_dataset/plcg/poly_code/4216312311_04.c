...
void kernel_4216312311_04(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
        ...
        for (int i_1 = 1; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 0; i_2 < -i_1+PB_L-2; i_2++) {
                for (int i_3 = 1; i_3 < -i_2+PB_L-3; i_3++) {
                    B[i_3-1][i_2+i_1+2] = B[i_1-1][i_3+i_2+3] + 5;
                }
            }
        }
    }
    for (int i_4 = 2; i_4 < PB_L-1; i_4++) {
        for (int i_5 = 0; i_5 < -i_4+PB_L-1; i_5++) {
            for (int i_6 = 0; i_6 < -i_5+PB_L-2; i_6++) {
                B[i_4-1][i_6+i_5+2] = C[i_6][i_5][i_4-1] + D[i_5][i_6][i_4-2] + B[i_4][i_6+i_5+2] + B[i_6][i_5+i_4+1] - 4;
            }
        }
    }
#pragma endscop
...
kernel_4216312311_04(xb,yb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
