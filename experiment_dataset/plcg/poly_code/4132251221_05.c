        ...
        for (int i_1 = 1; i_1 < -i_0+PB_L; i_1++) {
            for (int i_2 = 2; i_2 < PB_L-1; i_2++) {
                for (int i_3 = 1; i_3 < i_1; i_3++) {
                    A[i_0][i_3][i_3-1] = B[i_1][i_1+i_0][i_2+1] - C[i_2][i_1][i_0] + D[i_1-1][i_2-1][i_0][i_3] + D[i_3][i_2][i_2][i_1] + E[i_1][i_0][i_2-1][i_0] + A[i_1][i_2-1][i_2-2] - A[i_2+1][i_3][i_3-1] * 3;
                }
            }
        }
    }
...
kernel_4132251221_05(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,vd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
