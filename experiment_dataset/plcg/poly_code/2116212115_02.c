...
void kernel_2116212115_02(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
...
kernel_2116212115_02(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
