    ...
    for (int i_2 = 1; i_2 < PB_M-1; i_2++) {
        ...
        for (int i_3 = 0; i_3 < i_2; i_3++) {
            for (int i_4 = 1; i_4 < min(-i_2+PB_M+1, PB_M-1); i_4++) {
                D[i_4][i_2+1][1] = G[i_4+i_2-1][i_4-1][i_3] - D[i_4+1][i_2+2][1] + D[i_3][i_2][1] - D[i_4][i_2+2][1] + 2;
            }
        }
    }
#pragma endscop
...
kernel_3426211211_00(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B), xd,yd,zd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
