...
void kernel_2214211213_04(int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_P; i_0++) {
        for (int i_1 = 1; i_1 < min(PB_L, i_0); i_1++) {
            B[i_0][i_1-1] = B[i_0][i_1] * B[i_0-1][i_1] - 4;
            B[i_0][i_1] = C[i_1][i_0] * 5;
        }
    }
#pragma endscop
...
kernel_2214211213_04(xb,yb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
