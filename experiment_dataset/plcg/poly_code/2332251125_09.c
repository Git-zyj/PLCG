...
void kernel_2332251125_09(int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,DATA_TYPE POLYBENCH_1D(D,xD,xd),int xe,DATA_TYPE POLYBENCH_1D(E,xE,xe)){
...
#pragma scop
    ...
    for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
        C[i_1+1] = E[i_1] + D[i_1-1] - E[i_1] - C[i_1-1] * 2;
        C[i_1-1] = E[i_1] * D[i_1] * D[i_1] * D[i_1] * E[0] * E[i_1] * E[i_1-1] * E[i_1+1] + D[i_1] - 5;
    }
#pragma endscop
...
kernel_2332251125_09(xc,POLYBENCH_ARRAY(C), xd,POLYBENCH_ARRAY(D), xe,POLYBENCH_ARRAY(E));
