...
/* Start of CLooG code */
for (t1=0;t1<=floord(_PB_TSTEPS,32);t1++) {
  for (t2=2*t1;t2<=min(floord(2*_PB_TSTEPS+_PB_N-1,32),floord(64*t1+_PB_N+61,32));t2++) {
    for (t3=max(ceild(32*t2-_PB_N-28,32),2*t1);t3<=min(min(floord(2*_PB_TSTEPS+_PB_N-1,32),floord(64*t1+_PB_N+61,32)),floord(32*t2+_PB_N+28,32));t3++) {
      for (t4=max(max(ceild(32*t2-_PB_N-28,32),ceild(32*t3-_PB_N-28,32)),2*t1);t4<=min(min(min(floord(2*_PB_TSTEPS+_PB_N-1,32),floord(64*t1+_PB_N+61,32)),floord(32*t2+_PB_N+28,32)),floord(32*t3+_PB_N+28,32));t4++) {
        if ((_PB_N == 121) && (t1 <= floord(t4-4,2)) && (t2 <= t4-1) && (t3 <= t4-1)) {
        ...
        if ((_PB_N == 121) && (t1 <= floord(t3-4,2)) && (t2 <= t3-1) && (t3 >= t4)) {
          for (t6=max(32*t2,32*t3-118);t6<=32*t2+31;t6++) {
            for (t8=max(32*t4,32*t3-118);t8<=min(32*t3,32*t4+31);t8++) {
        ...
        if ((_PB_N == 121) && (t1 <= floord(t2-4,2)) && (t2 >= max(t3,t4))) {
          for (t7=max(32*t3,32*t2-118);t7<=min(32*t2,32*t3+31);t7++) {
            for (t8=max(32*t4,32*t2-118);t8<=min(32*t2,32*t4+31);t8++) {
        ...
        if ((t2 == t3) && (t2 == t4)) {
          for (t5=max(max(1,ceild(32*t2-_PB_N+2,2)),32*t1);t5<=min(min(floord(32*t2-_PB_N+32,2),_PB_TSTEPS),32*t1+31);t5++) {
        ...
        if (t3 == t4) {
          for (t5=max(max(max(1,ceild(32*t2-_PB_N+33,2)),ceild(32*t3-_PB_N+2,2)),32*t1);t5<=min(min(min(floord(32*t3-_PB_N+32,2),_PB_TSTEPS),32*t1+31),16*t2-1);t5++) {
        ...
        if (t2 == t4) {
          for (t5=max(max(max(1,ceild(32*t2-_PB_N+2,2)),ceild(32*t3-_PB_N+33,2)),32*t1);t5<=min(min(min(floord(32*t2-_PB_N+32,2),_PB_TSTEPS),32*t1+31),16*t3-1);t5++) {
            for (t6=32*t2;t6<=2*t5+_PB_N-2;t6++) {
        ...
        for (t5=max(max(max(max(1,ceild(32*t2-_PB_N+33,2)),ceild(32*t3-_PB_N+33,2)),ceild(32*t4-_PB_N+2,2)),32*t1);t5<=min(min(min(min(floord(32*t4-_PB_N+32,2),_PB_TSTEPS),32*t1+31),16*t2-1),16*t3-1);t5++) {
          for (t6=32*t2;t6<=32*t2+31;t6++) {
            for (t7=32*t3;t7<=32*t3+31;t7++) {
        ...
        if (t2 == t3) {
          for (t5=max(max(max(1,ceild(32*t2-_PB_N+2,2)),ceild(32*t4-_PB_N+33,2)),32*t1);t5<=min(min(min(floord(32*t2-_PB_N+32,2),_PB_TSTEPS),32*t1+31),16*t4-1);t5++) {
            for (t6=32*t2;t6<=2*t5+_PB_N-2;t6++) {
              for (t7=32*t2;t7<=2*t5+_PB_N-2;t7++) {
        ...
        for (t5=max(max(max(max(1,ceild(32*t2-_PB_N+33,2)),ceild(32*t3-_PB_N+2,2)),ceild(32*t4-_PB_N+33,2)),32*t1);t5<=min(min(min(min(floord(32*t3-_PB_N+32,2),_PB_TSTEPS),32*t1+31),16*t2-1),16*t4-1);t5++) {
          for (t6=32*t2;t6<=32*t2+31;t6++) {
            for (t7=32*t3;t7<=2*t5+_PB_N-2;t7++) {
              for (t8=32*t4;t8<=32*t4+31;t8++) {
                B[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)] = SCALAR_VAL(0.125) * (A[(-2*t5+t6)+1][(-2*t5+t7)][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)] + A[(-2*t5+t6)-1][(-2*t5+t7)][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][(-2*t5+t7)+1][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)] + A[(-2*t5+t6)][(-2*t5+t7)-1][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)+1] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)] + A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)-1]) + A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)];;
        ...
        for (t5=max(max(max(max(1,ceild(32*t2-_PB_N+2,2)),ceild(32*t3-_PB_N+33,2)),ceild(32*t4-_PB_N+33,2)),32*t1);t5<=min(min(min(min(floord(32*t2-_PB_N+32,2),_PB_TSTEPS),32*t1+31),16*t3-1),16*t4-1);t5++) {
          for (t6=32*t2;t6<=2*t5+_PB_N-2;t6++) {
            for (t7=32*t3;t7<=32*t3+31;t7++) {
              for (t8=32*t4;t8<=32*t4+31;t8++) {
                B[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)] = SCALAR_VAL(0.125) * (A[(-2*t5+t6)+1][(-2*t5+t7)][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)] + A[(-2*t5+t6)-1][(-2*t5+t7)][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][(-2*t5+t7)+1][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)] + A[(-2*t5+t6)][(-2*t5+t7)-1][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)+1] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)] + A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)-1]) + A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)];;
        ...
        for (t5=max(max(max(max(1,ceild(32*t2-_PB_N+33,2)),ceild(32*t3-_PB_N+33,2)),ceild(32*t4-_PB_N+33,2)),32*t1);t5<=min(min(min(min(_PB_TSTEPS,32*t1+31),16*t2-1),16*t3-1),16*t4-1);t5++) {
          for (t6=32*t2;t6<=32*t2+31;t6++) {
            for (t7=32*t3;t7<=32*t3+31;t7++) {
              for (t8=32*t4;t8<=32*t4+31;t8++) {
                B[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)] = SCALAR_VAL(0.125) * (A[(-2*t5+t6)+1][(-2*t5+t7)][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)] + A[(-2*t5+t6)-1][(-2*t5+t7)][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][(-2*t5+t7)+1][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)] + A[(-2*t5+t6)][(-2*t5+t7)-1][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)+1] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)] + A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)-1]) + A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)];;
        ...
        if ((t2 == t3) && (t2 == t4)) {
          for (t5=max(1,16*t2);t5<=min(min(_PB_TSTEPS,32*t1+31),16*t2+14);t5++) {
        ...
        if (t2 == t4) {
          for (t5=max(max(1,ceild(32*t3-_PB_N+2,2)),16*t2);t5<=min(min(min(floord(32*t3-_PB_N+32,2),_PB_TSTEPS),32*t1+31),16*t2+14);t5++) {
            for (t7=32*t3;t7<=2*t5+_PB_N-2;t7++) {
              for (t8=2*t5+1;t8<=32*t2+31;t8++) {
                B[1][(-2*t5+t7)][(-2*t5+t8)] = SCALAR_VAL(0.125) * (A[1 +1][(-2*t5+t7)][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[1][(-2*t5+t7)][(-2*t5+t8)] + A[1 -1][(-2*t5+t7)][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[1][(-2*t5+t7)+1][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[1][(-2*t5+t7)][(-2*t5+t8)] + A[1][(-2*t5+t7)-1][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[1][(-2*t5+t7)][(-2*t5+t8)+1] - SCALAR_VAL(2.0) * A[1][(-2*t5+t7)][(-2*t5+t8)] + A[1][(-2*t5+t7)][(-2*t5+t8)-1]) + A[1][(-2*t5+t7)][(-2*t5+t8)];;
              }
        ...
        if (t3 >= t4+1) {
          for (t5=max(max(1,ceild(32*t3-_PB_N+2,2)),16*t2);t5<=min(min(min(min(floord(32*t3-_PB_N+32,2),_PB_TSTEPS),32*t1+31),16*t2+14),16*t4-1);t5++) {
            for (t7=32*t3;t7<=2*t5+_PB_N-2;t7++) {
              for (t8=32*t4;t8<=32*t4+31;t8++) {
                B[1][(-2*t5+t7)][(-2*t5+t8)] = SCALAR_VAL(0.125) * (A[1 +1][(-2*t5+t7)][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[1][(-2*t5+t7)][(-2*t5+t8)] + A[1 -1][(-2*t5+t7)][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[1][(-2*t5+t7)+1][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[1][(-2*t5+t7)][(-2*t5+t8)] + A[1][(-2*t5+t7)-1][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[1][(-2*t5+t7)][(-2*t5+t8)+1] - SCALAR_VAL(2.0) * A[1][(-2*t5+t7)][(-2*t5+t8)] + A[1][(-2*t5+t7)][(-2*t5+t8)-1]) + A[1][(-2*t5+t7)][(-2*t5+t8)];;
              }
        ...
        if (t2 == t4) {
          for (t5=max(max(1,ceild(32*t3-_PB_N+33,2)),16*t2);t5<=min(min(min(_PB_TSTEPS,32*t1+31),16*t2+14),16*t3-1);t5++) {
            for (t7=32*t3;t7<=32*t3+31;t7++) {
              for (t8=2*t5+1;t8<=32*t2+31;t8++) {
                B[1][(-2*t5+t7)][(-2*t5+t8)] = SCALAR_VAL(0.125) * (A[1 +1][(-2*t5+t7)][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[1][(-2*t5+t7)][(-2*t5+t8)] + A[1 -1][(-2*t5+t7)][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[1][(-2*t5+t7)+1][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[1][(-2*t5+t7)][(-2*t5+t8)] + A[1][(-2*t5+t7)-1][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[1][(-2*t5+t7)][(-2*t5+t8)+1] - SCALAR_VAL(2.0) * A[1][(-2*t5+t7)][(-2*t5+t8)] + A[1][(-2*t5+t7)][(-2*t5+t8)-1]) + A[1][(-2*t5+t7)][(-2*t5+t8)];;
              }
        ...
        if (t3 >= t4) {
          for (t5=max(max(1,ceild(32*t3-_PB_N+33,2)),16*t2);t5<=min(min(min(_PB_TSTEPS,32*t1+31),16*t2+14),16*t4-1);t5++) {
            for (t7=32*t3;t7<=32*t3+31;t7++) {
              for (t8=32*t4;t8<=32*t4+31;t8++) {
                B[1][(-2*t5+t7)][(-2*t5+t8)] = SCALAR_VAL(0.125) * (A[1 +1][(-2*t5+t7)][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[1][(-2*t5+t7)][(-2*t5+t8)] + A[1 -1][(-2*t5+t7)][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[1][(-2*t5+t7)+1][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[1][(-2*t5+t7)][(-2*t5+t8)] + A[1][(-2*t5+t7)-1][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[1][(-2*t5+t7)][(-2*t5+t8)+1] - SCALAR_VAL(2.0) * A[1][(-2*t5+t7)][(-2*t5+t8)] + A[1][(-2*t5+t7)][(-2*t5+t8)-1]) + A[1][(-2*t5+t7)][(-2*t5+t8)];;
              }
        ...
        if (t2 == t3) {
          for (t5=max(max(1,ceild(32*t4-_PB_N+2,2)),16*t2);t5<=min(min(min(floord(32*t4-_PB_N+32,2),_PB_TSTEPS),32*t1+31),16*t2+14);t5++) {
            for (t7=2*t5+1;t7<=32*t2+31;t7++) {
              for (t8=32*t4;t8<=2*t5+_PB_N-2;t8++) {
                B[1][(-2*t5+t7)][(-2*t5+t8)] = SCALAR_VAL(0.125) * (A[1 +1][(-2*t5+t7)][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[1][(-2*t5+t7)][(-2*t5+t8)] + A[1 -1][(-2*t5+t7)][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[1][(-2*t5+t7)+1][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[1][(-2*t5+t7)][(-2*t5+t8)] + A[1][(-2*t5+t7)-1][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[1][(-2*t5+t7)][(-2*t5+t8)+1] - SCALAR_VAL(2.0) * A[1][(-2*t5+t7)][(-2*t5+t8)] + A[1][(-2*t5+t7)][(-2*t5+t8)-1]) + A[1][(-2*t5+t7)][(-2*t5+t8)];;
              }
        ...
        if (t3 <= t4-1) {
          for (t5=max(max(1,ceild(32*t4-_PB_N+2,2)),16*t2);t5<=min(min(min(min(floord(32*t4-_PB_N+32,2),_PB_TSTEPS),32*t1+31),16*t2+14),16*t3-1);t5++) {
            for (t7=32*t3;t7<=32*t3+31;t7++) {
              for (t8=32*t4;t8<=2*t5+_PB_N-2;t8++) {
                B[1][(-2*t5+t7)][(-2*t5+t8)] = SCALAR_VAL(0.125) * (A[1 +1][(-2*t5+t7)][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[1][(-2*t5+t7)][(-2*t5+t8)] + A[1 -1][(-2*t5+t7)][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[1][(-2*t5+t7)+1][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[1][(-2*t5+t7)][(-2*t5+t8)] + A[1][(-2*t5+t7)-1][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[1][(-2*t5+t7)][(-2*t5+t8)+1] - SCALAR_VAL(2.0) * A[1][(-2*t5+t7)][(-2*t5+t8)] + A[1][(-2*t5+t7)][(-2*t5+t8)-1]) + A[1][(-2*t5+t7)][(-2*t5+t8)];;
              }
        ...
        if (t2 == t3) {
          for (t5=max(max(1,ceild(32*t4-_PB_N+33,2)),16*t2);t5<=min(min(min(_PB_TSTEPS,32*t1+31),16*t2+14),16*t4-1);t5++) {
            for (t7=2*t5+1;t7<=32*t2+31;t7++) {
              for (t8=32*t4;t8<=32*t4+31;t8++) {
                B[1][(-2*t5+t7)][(-2*t5+t8)] = SCALAR_VAL(0.125) * (A[1 +1][(-2*t5+t7)][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[1][(-2*t5+t7)][(-2*t5+t8)] + A[1 -1][(-2*t5+t7)][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[1][(-2*t5+t7)+1][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[1][(-2*t5+t7)][(-2*t5+t8)] + A[1][(-2*t5+t7)-1][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[1][(-2*t5+t7)][(-2*t5+t8)+1] - SCALAR_VAL(2.0) * A[1][(-2*t5+t7)][(-2*t5+t8)] + A[1][(-2*t5+t7)][(-2*t5+t8)-1]) + A[1][(-2*t5+t7)][(-2*t5+t8)];;
              }
        ...
        if (t3 <= t4-1) {
          for (t5=max(max(1,ceild(32*t4-_PB_N+33,2)),16*t2);t5<=min(min(min(_PB_TSTEPS,32*t1+31),16*t2+14),16*t3-1);t5++) {
            for (t7=32*t3;t7<=32*t3+31;t7++) {
              for (t8=32*t4;t8<=32*t4+31;t8++) {
                B[1][(-2*t5+t7)][(-2*t5+t8)] = SCALAR_VAL(0.125) * (A[1 +1][(-2*t5+t7)][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[1][(-2*t5+t7)][(-2*t5+t8)] + A[1 -1][(-2*t5+t7)][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[1][(-2*t5+t7)+1][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[1][(-2*t5+t7)][(-2*t5+t8)] + A[1][(-2*t5+t7)-1][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[1][(-2*t5+t7)][(-2*t5+t8)+1] - SCALAR_VAL(2.0) * A[1][(-2*t5+t7)][(-2*t5+t8)] + A[1][(-2*t5+t7)][(-2*t5+t8)-1]) + A[1][(-2*t5+t7)][(-2*t5+t8)];;
              }
        ...
        if (t3 == t4) {
          for (t5=max(max(1,ceild(32*t2-_PB_N+2,2)),16*t3);t5<=min(min(min(floord(32*t2-_PB_N+32,2),_PB_TSTEPS),32*t1+31),16*t3+14);t5++) {
            for (t6=32*t2;t6<=2*t5+_PB_N-2;t6++) {
        ...
        if (t3 == t4) {
          for (t5=max(max(1,ceild(32*t2-_PB_N+33,2)),16*t3);t5<=min(min(min(_PB_TSTEPS,32*t1+31),16*t2-1),16*t3+14);t5++) {
            for (t6=32*t2;t6<=32*t2+31;t6++) {
              for (t8=2*t5+1;t8<=32*t3+31;t8++) {
                B[(-2*t5+t6)][1][(-2*t5+t8)] = SCALAR_VAL(0.125) * (A[(-2*t5+t6)+1][1][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][1][(-2*t5+t8)] + A[(-2*t5+t6)-1][1][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][1 +1][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][1][(-2*t5+t8)] + A[(-2*t5+t6)][1 -1][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][1][(-2*t5+t8)+1] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][1][(-2*t5+t8)] + A[(-2*t5+t6)][1][(-2*t5+t8)-1]) + A[(-2*t5+t6)][1][(-2*t5+t8)];;
              }
        ...
        for (t5=max(max(max(1,ceild(32*t2-_PB_N+33,2)),ceild(32*t4-_PB_N+2,2)),16*t3);t5<=min(min(min(min(floord(32*t4-_PB_N+32,2),_PB_TSTEPS),32*t1+31),16*t2-1),16*t3+14);t5++) {
          for (t6=32*t2;t6<=32*t2+31;t6++) {
            for (t8=32*t4;t8<=2*t5+_PB_N-2;t8++) {
              B[(-2*t5+t6)][1][(-2*t5+t8)] = SCALAR_VAL(0.125) * (A[(-2*t5+t6)+1][1][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][1][(-2*t5+t8)] + A[(-2*t5+t6)-1][1][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][1 +1][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][1][(-2*t5+t8)] + A[(-2*t5+t6)][1 -1][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][1][(-2*t5+t8)+1] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][1][(-2*t5+t8)] + A[(-2*t5+t6)][1][(-2*t5+t8)-1]) + A[(-2*t5+t6)][1][(-2*t5+t8)];;
            }
        ...
        for (t5=max(max(max(1,ceild(32*t2-_PB_N+2,2)),ceild(32*t4-_PB_N+33,2)),16*t3);t5<=min(min(min(min(floord(32*t2-_PB_N+32,2),_PB_TSTEPS),32*t1+31),16*t3+14),16*t4-1);t5++) {
          for (t6=32*t2;t6<=2*t5+_PB_N-2;t6++) {
            for (t8=32*t4;t8<=32*t4+31;t8++) {
              B[(-2*t5+t6)][1][(-2*t5+t8)] = SCALAR_VAL(0.125) * (A[(-2*t5+t6)+1][1][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][1][(-2*t5+t8)] + A[(-2*t5+t6)-1][1][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][1 +1][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][1][(-2*t5+t8)] + A[(-2*t5+t6)][1 -1][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][1][(-2*t5+t8)+1] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][1][(-2*t5+t8)] + A[(-2*t5+t6)][1][(-2*t5+t8)-1]) + A[(-2*t5+t6)][1][(-2*t5+t8)];;
            }
        ...
        for (t5=max(max(max(1,ceild(32*t2-_PB_N+33,2)),ceild(32*t4-_PB_N+33,2)),16*t3);t5<=min(min(min(min(_PB_TSTEPS,32*t1+31),16*t2-1),16*t3+14),16*t4-1);t5++) {
          for (t6=32*t2;t6<=32*t2+31;t6++) {
            for (t8=32*t4;t8<=32*t4+31;t8++) {
              B[(-2*t5+t6)][1][(-2*t5+t8)] = SCALAR_VAL(0.125) * (A[(-2*t5+t6)+1][1][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][1][(-2*t5+t8)] + A[(-2*t5+t6)-1][1][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][1 +1][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][1][(-2*t5+t8)] + A[(-2*t5+t6)][1 -1][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][1][(-2*t5+t8)+1] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][1][(-2*t5+t8)] + A[(-2*t5+t6)][1][(-2*t5+t8)-1]) + A[(-2*t5+t6)][1][(-2*t5+t8)];;
            }
        ...
        if (t2 == t3) {
          for (t5=max(max(1,ceild(32*t2-_PB_N+2,2)),16*t4);t5<=min(min(min(floord(32*t2-_PB_N+32,2),_PB_TSTEPS),32*t1+31),16*t4+14);t5++) {
            for (t6=32*t2;t6<=2*t5+_PB_N-2;t6++) {
              for (t7=32*t2;t7<=2*t5+_PB_N-2;t7++) {
                B[(-2*t5+t6)][(-2*t5+t7)][1] = SCALAR_VAL(0.125) * (A[(-2*t5+t6)+1][(-2*t5+t7)][1] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][1] + A[(-2*t5+t6)-1][(-2*t5+t7)][1]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][(-2*t5+t7)+1][1] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][1] + A[(-2*t5+t6)][(-2*t5+t7)-1][1]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][(-2*t5+t7)][1 +1] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][1] + A[(-2*t5+t6)][(-2*t5+t7)][1 -1]) + A[(-2*t5+t6)][(-2*t5+t7)][1];;
        ...
        for (t5=max(max(max(1,ceild(32*t2-_PB_N+33,2)),ceild(32*t3-_PB_N+2,2)),16*t4);t5<=min(min(min(min(floord(32*t3-_PB_N+32,2),_PB_TSTEPS),32*t1+31),16*t2-1),16*t4+14);t5++) {
          for (t6=32*t2;t6<=32*t2+31;t6++) {
            for (t7=32*t3;t7<=2*t5+_PB_N-2;t7++) {
              B[(-2*t5+t6)][(-2*t5+t7)][1] = SCALAR_VAL(0.125) * (A[(-2*t5+t6)+1][(-2*t5+t7)][1] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][1] + A[(-2*t5+t6)-1][(-2*t5+t7)][1]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][(-2*t5+t7)+1][1] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][1] + A[(-2*t5+t6)][(-2*t5+t7)-1][1]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][(-2*t5+t7)][1 +1] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][1] + A[(-2*t5+t6)][(-2*t5+t7)][1 -1]) + A[(-2*t5+t6)][(-2*t5+t7)][1];;
              for (t8=2*t5+2;t8<=32*t4+31;t8++) {
        ...
        for (t5=max(max(max(1,ceild(32*t2-_PB_N+2,2)),ceild(32*t3-_PB_N+33,2)),16*t4);t5<=min(min(min(min(floord(32*t2-_PB_N+32,2),_PB_TSTEPS),32*t1+31),16*t3-1),16*t4+14);t5++) {
          for (t6=32*t2;t6<=2*t5+_PB_N-2;t6++) {
            for (t7=32*t3;t7<=32*t3+31;t7++) {
              B[(-2*t5+t6)][(-2*t5+t7)][1] = SCALAR_VAL(0.125) * (A[(-2*t5+t6)+1][(-2*t5+t7)][1] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][1] + A[(-2*t5+t6)-1][(-2*t5+t7)][1]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][(-2*t5+t7)+1][1] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][1] + A[(-2*t5+t6)][(-2*t5+t7)-1][1]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][(-2*t5+t7)][1 +1] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][1] + A[(-2*t5+t6)][(-2*t5+t7)][1 -1]) + A[(-2*t5+t6)][(-2*t5+t7)][1];;
              for (t8=2*t5+2;t8<=32*t4+31;t8++) {
        ...
        for (t5=max(max(max(1,ceild(32*t2-_PB_N+33,2)),ceild(32*t3-_PB_N+33,2)),16*t4);t5<=min(min(min(min(_PB_TSTEPS,32*t1+31),16*t2-1),16*t3-1),16*t4+14);t5++) {
          for (t6=32*t2;t6<=32*t2+31;t6++) {
            for (t7=32*t3;t7<=32*t3+31;t7++) {
              B[(-2*t5+t6)][(-2*t5+t7)][1] = SCALAR_VAL(0.125) * (A[(-2*t5+t6)+1][(-2*t5+t7)][1] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][1] + A[(-2*t5+t6)-1][(-2*t5+t7)][1]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][(-2*t5+t7)+1][1] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][1] + A[(-2*t5+t6)][(-2*t5+t7)-1][1]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][(-2*t5+t7)][1 +1] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][1] + A[(-2*t5+t6)][(-2*t5+t7)][1 -1]) + A[(-2*t5+t6)][(-2*t5+t7)][1];;
              for (t8=2*t5+2;t8<=32*t4+31;t8++) {
        ...
        if ((t1 >= ceild(t2-1,2)) && (t2 <= min(min(floord(_PB_TSTEPS-15,16),t3-1),t4-1))) {
        ...
        if ((t1 >= ceild(t3-1,2)) && (t2 >= t3) && (t3 <= min(floord(_PB_TSTEPS-15,16),t4-1))) {
        ...
        if ((t1 >= ceild(t4-1,2)) && (t2 >= t4) && (t3 >= t4) && (t4 <= floord(_PB_TSTEPS-15,16))) {
