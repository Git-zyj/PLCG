...
for (t2=-_PB_N+3;t2<=0;t2++) {
  table[-t2][(-t2+1)] = max_score(table[-t2][(-t2+1)], table[-t2][(-t2+1)-1]);;
  table[-t2][(-t2+1)] = max_score(table[-t2][(-t2+1)], table[-t2+1][(-t2+1)]);;
  table[-t2][(-t2+1)] = max_score(table[-t2][(-t2+1)], table[-t2+1][(-t2+1)-1]);;
  for (t4=-t2+2;t4<=_PB_N-1;t4++) {
    table[-t2][t4] = max_score(table[-t2][t4], table[-t2][t4-1]);;
    table[-t2][t4] = max_score(table[-t2][t4], table[-t2+1][t4]);;
    table[-t2][t4] = max_score(table[-t2][t4], table[-t2+1][t4-1]+match(seq[-t2], seq[t4]));;
    for (t6=-t2+1;t6<=t4-1;t6++) {
      table[-t2][t4] = max_score(table[-t2][t4], table[-t2][t6] + table[t6+1][t4]);;
    }
  }
}
/* End of CLooG code */
