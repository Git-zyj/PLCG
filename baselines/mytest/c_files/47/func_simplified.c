...
void test() {
    ...
    for (int i_0 = 1; i_0 < 24; i_0 += 3)
    {
        ...
        var_22 ^= (((-1LL) ? -1 : (134184960U)));
        arr_9 [i_0] [i_0] = (((arr_2 [i_0 + 1] [i_0 + 1]) != (1989473949761753875LL)));
    }
    ...
    for (int i_3 = 0; i_3 < 11; i_3 += 1)
    {
        ...
        {
            {
                arr_15 [i_4] [i_4] [8LL] = (arr_6 [7] [i_4]);
                /* LoopNest 3 */
                for (int i_5 = 0; i_5 < 11; i_5 += 3)
                {
                    for (unsigned int i_6 = 0; i_6 < 11; i_6 += 4)
                    {
                        ...
                        {
                            {
                                arr_22 [i_3] [2] [i_4] [i_6] [i_7] = ((~(((((-106 ? (134184960U) : var_4))) ? var_5 : (-1LL)))));
                                var_24 = (min(var_24, ((min(var_15, var_2)))));
                                arr_23 [i_4] [9LL] = (var_1 || 0);
                                arr_24 [i_3] [i_4] [i_4] [i_6] [i_6] [i_7] [i_7 + 1] = (arr_21 [i_3] [1] [i_3] [i_5] [i_6] [i_7 + 1]);
                            }
                        }
                    }
                }
                arr_25 [i_3] [i_4] [5] = ((max((arr_5 [i_3] [i_3] [i_3]), var_13)) * ((var_1 ? ((var_15 ? (arr_11 [6U]) : var_6)) : (var_4 / var_1))));
            }
        }
    }
    var_25 = var_5;
    var_26 = (min(var_26, (((var_13 != ((min(var_9, (((3783563247U) ? var_2 : var_1))))))))));
    #pragma endscop
}
