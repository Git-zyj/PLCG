...
Seed: 97
Invocation: ../scripts/yarpgen --std=c --emit-align-attr=none --inp-as-args=none --emit-pragmas=none --expl-loop-param=true --seed=97 -o /data/zyj/loop_generator/baselines/yarpgen/mytest/c_files/97
*/
#include "init.h"
#define max(a,b) \
    ({ __typeof__ (a) _a = (a); \
