    ...
    for (int i_0 = 1; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 2; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < PB_L-2; i_2++) {
                A[i_1-2][i_2][i_0+2] = C[i_0][i_2][i_1-2] + C[i_2+2][i_0-1][i_1] - C[i_1][i_2][i_0] * C[i_0][i_1+2][i_2] * D[i_2+1][i_1-2] + A[i_1-2][i_2][i_0+1] + 3;
            }
        }
        for (int i_3 = 0; i_3 < -i_0+PB_M-1; i_3++) {
            B[i_3][i_0] = E[i_3+i_0+1] - B[i_3+1][i_0-1] + B[i_3][i_0-1] * 3;
        }
    }
#pragma endscop
