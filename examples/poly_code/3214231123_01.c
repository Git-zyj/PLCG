    ...
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < min(PB_M-1, -i_1+PB_Q+1); i_2++) {
                A[i_0][i_1+1][i_2] = C[i_0][i_1-1][i_1] + C[i_1+1][i_0][i_0] - D[i_2][i_0][i_1] - C[i_1+1][i_0][i_2+i_1-1] - C[i_2+1][i_1-1][0] + A[i_0-1][i_1+1][i_2-1] + 5;
            }
            for (int i_3 = 0; i_3 < PB_P; i_3++) {
                B[i_0+1][i_3][i_3] = C[i_1][i_3][i_0+1] * 1;
            }
        }
    }
#pragma endscop
