...
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        for (int i_1 = 2; i_1 < min(i_0, PB_M-1); i_1++) {
            A[i_1][i_0-1] = C[i_0-1][i_1-2] + C[i_1+1][i_0-1] * B[i_1+1][i_1+2] * B[i_0][i_0+1] - 2;
        }
    }
    for (int i_2 = 1; i_2 < PB_M; i_2++) {
        for (int i_3 = 2; i_3 < i_2; i_3++) {
            B[i_2][i_2+1] = C[i_3][0] + C[i_2][i_3] * C[i_2-1][i_3-1] * C[i_3][i_2+2] + B[i_3-2][i_3-1] - B[i_2-1][i_2] - 3;
        }
    }
#pragma endscop
