    ...
    for (int i_0 = 1; i_0 < PB_P+1; i_0++) {
        for (int i_1 = 2; i_1 < PB_P-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_P; i_2++) {
                A[i_1-2][i_0][i_2] = C[i_1+2][i_0][1] - C[i_0][i_1][i_0-1] + D[i_2][i_1+1] * C[i_1][i_0-1][i_2] - 4;
            }
        }
    }
    for (int i_3 = 2; i_3 < PB_M+2; i_3++) {
        for (int i_4 = 2; i_4 < PB_M-1; i_4++) {
            for (int i_5 = 0; i_5 < PB_P; i_5++) {
                B[i_4-1][i_4-2][i_4+1] = E[i_3-2][i_5][i_4] * C[i_4][i_3][i_5] - B[i_4+1][i_4][i_4+3] * B[i_4][i_4-1][i_4+2] + 3;
            }
        }
    }
#pragma endscop
