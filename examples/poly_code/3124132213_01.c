...
#pragma scop
    for (int i_0 = 1; i_0 < PB_P; i_0++) {
        for (int i_1 = 2; i_1 < min(-i_0+PB_M+1, i_0); i_1++) {
            for (int i_2 = 0; i_2 < min(-i_0+PB_P, -i_1+PB_L); i_2++) {
                A[i_2+i_0][i_2+i_1][0] = B[1][i_1+1][i_2+i_0] - B[i_2+i_0][i_2][i_1] * B[i_2][i_1-2][i_0] - A[i_2+i_0][i_2+i_1-1][0] + A[i_1+i_0-1][i_2+i_1][0] - 3;
            }
        }
    }
#pragma endscop
