...
#pragma scop
    for (int i_0 = 0; i_0 < PB_Q; i_0++) {
        for (int i_1 = 1; i_1 < PB_Q; i_1++) {
            A[i_0][i_1] = C[i_0][i_1+1] * 1;
            for (int i_2 = 0; i_2 < min(min(PB_Q, -i_0+PB_P-1), -i_1+PB_P); i_2++) {
                B[i_0][i_2+i_1][i_2] = D[i_1][i_2][i_0] * B[i_1-1][i_2+i_0+1][i_0] * B[i_0+1][i_2+i_1-1][i_2] + 4;
            }
        }
    }
#pragma endscop
