    ...
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        for (int i_1 = 2; i_1 < -i_0+PB_L; i_1++) {
            for (int i_2 = 1; i_2 < -i_0+PB_L; i_2++) {
                A[i_2][i_1][i_1+i_0] = C[i_2][i_0-1][i_1] - D[i_0][i_1] - C[i_0-1][i_2][i_1] * A[i_2][i_1-2][i_1+i_0-2] + A[i_2-1][i_1][i_1+i_0-2] * A[i_1][i_2-1][i_2+i_0] - 6;
            }
        }
        for (int i_3 = 1; i_3 < PB_L; i_3++) {
            B[i_0][i_3] = D[i_0+1][i_3] - E[i_3+1] - B[i_0][i_3-1] + 3;
        }
    }
#pragma endscop
