    ...
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 0; i_1 < PB_Q; i_1++) {
            for (int i_2 = i_0; i_2 < PB_Q; i_2++) {
                A[i_2][i_0+1] = C[i_2][i_0-1][i_1] + D[0][i_0][i_1] * C[i_1][i_2-1][i_1] * D[i_1][i_2][i_2] + D[i_2-1][i_0+1][i_1] - 3;
            }
        }
        for (int i_3 = 0; i_3 < PB_L-1; i_3++) {
            for (int i_4 = 3; i_4 < i_0; i_4++) {
                B[i_0+1][i_4+1][i_4-1] = C[i_4][i_0][i_3+1] + B[i_0+1][i_4][i_4-2] + B[i_0+1][i_4-1][i_4-3] + 5;
            }
        }
    }
#pragma endscop
