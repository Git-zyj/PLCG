    ...
    for (int i_0 = 2; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 2; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < PB_M-2; i_2++) {
                A[i_2][i_0-1][i_1+1] = C[i_1+1][i_2][i_0] + D[i_1-2][i_0][i_1+1] + C[i_2+2][i_0+2][i_1] * C[i_2][i_0][i_1] * D[i_1-1][i_0][0] - A[i_2+1][i_1][i_0+1] - A[i_2-1][i_0-2][i_1+1] + A[i_1+2][i_0-1][i_2-1] + A[i_0+1][i_2][i_1+3] * 2;
            }
        }
        for (int i_3 = 2; i_3 < PB_L; i_3++) {
            for (int i_4 = 0; i_4 < i_3; i_4++) {
                B[i_0][i_4][i_3] = E[i_4][i_3-2][i_0][i_0-2] - 5;
            }
        }
    }
#pragma endscop
