...
#pragma scop
    for (int i_0 = 2; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < min(i_0, PB_L-3); i_1++) {
            A[i_0][i_1+2] = C[i_0-2][i_1] - A[i_0][i_1+3] - 6;
        }
    }
    for (int i_2 = 2; i_2 < PB_L+1; i_2++) {
        for (int i_3 = i_2; i_3 < PB_L-3; i_3++) {
            B[i_2+1][i_2-2] = C[i_3-1][i_2] + D[i_3] + C[i_3+2][i_2] - D[i_3+1] - C[i_3][i_2] - A[i_2][i_3+3] * B[i_2+2][i_2-1] - B[i_3+2][i_3-1] - 6;
        }
    }
#pragma endscop
