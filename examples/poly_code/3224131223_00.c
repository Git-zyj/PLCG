...
#pragma scop
    for (int i_0 = 2; i_0 < PB_L; i_0++) {
        for (int i_1 = 1; i_1 < min(i_0, PB_P); i_1++) {
            A[i_0][i_1] = C[i_0-1][i_0] * C[i_1+1][i_0] + C[i_1][1] + C[i_1-1][i_0] * A[i_0-2][i_1] + 3;
            for (int i_2 = 0; i_2 < PB_L; i_2++) {
                A[i_0][i_1] = D[i_2][i_0][i_1] - E[i_0][i_2][i_1][0] * A[i_1][i_0] * 2;
            }
        }
    }
#pragma endscop
