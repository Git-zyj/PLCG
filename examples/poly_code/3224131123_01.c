    ...
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        for (int i_1 = i_0; i_1 < PB_M-1; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_M; i_2++) {
                A[i_2+1][i_1] = C[0][i_1+1] * D[i_2+i_0][i_2][i_1] + 1;
            }
        }
        for (int i_3 = 1; i_3 < PB_L-2; i_3++) {
            for (int i_4 = i_0; i_4 < min(PB_M-1, -i_0+PB_P-2); i_4++) {
                B[i_0][i_3][i_4+i_0] = D[i_4+1][i_3][i_4] - D[i_4][i_0-1][i_3] - D[i_0-1][i_3][i_3] * D[i_3-1][i_0][0] + B[i_0][i_3+2][i_4+i_0-1] - B[i_0][i_3][i_4+i_0+2] + 1;
            }
        }
    }
#pragma endscop
