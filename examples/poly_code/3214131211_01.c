...
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 0; i_1 < PB_P; i_1++) {
            for (int i_2 = 1; i_2 < min(min(i_1, -i_0+PB_L-1), -i_1+PB_P); i_2++) {
                A[i_1][i_2][i_0] = C[i_2][i_0][i_1] * C[1][i_0-1][i_2+i_1] - C[i_2+i_1][i_2+i_0+1][i_0] * C[i_0+1][i_2-1][i_1] - A[i_1][i_0+1][i_2] - 4;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_P-1; i_3++) {
        B[i_3][i_3] = D[i_3] + B[i_3-1][i_3-1] + B[i_3+1][i_3+1] - B[i_3+1][i_3+1] * 1;
    }
#pragma endscop
