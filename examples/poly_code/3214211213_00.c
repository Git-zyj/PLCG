...
#pragma scop
    for (int i_0 = 0; i_0 < PB_P-1; i_0++) {
        for (int i_1 = 1; i_1 < min(-i_0+PB_P-1, i_0); i_1++) {
            for (int i_2 = 1; i_2 < min(min(-i_0+PB_Q, PB_M+1), -i_1+PB_Q-1); i_2++) {
                A[i_2-1][i_1+i_0][i_2+i_1] = C[i_1-1][i_2][i_0] - D[i_2-1][i_1+1] - 3;
                A[i_2-1][i_1+i_0+1][i_2+i_0] = A[i_2][i_1+i_0][i_2+i_1+1] - A[i_2-1][i_1+i_0+1][i_2+i_1+1] + 2;
            }
        }
    }
#pragma endscop
