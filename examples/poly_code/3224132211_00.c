...
#pragma scop
    for (int i_0 = 1; i_0 < PB_L; i_0++) {
        for (int i_1 = 0; i_1 < PB_N-1; i_1++) {
            A[i_1][i_0] = C[i_1][i_0] * C[i_0-1][i_1] - D[i_1] + A[i_1+1][i_0] - 3;
        }
    }
    for (int i_2 = 1; i_2 < PB_L-1; i_2++) {
        for (int i_3 = 0; i_3 < i_2; i_3++) {
            for (int i_4 = 1; i_4 < PB_M; i_4++) {
                B[i_2][i_3][i_4-1] = E[i_3][i_2][0] - C[i_4][i_3] * E[i_4][i_2+1][i_3] + B[i_2+1][i_3][i_4] + B[i_2-1][i_3][i_4-1] - B[i_2][i_3+1][i_4-1] * 6;
            }
        }
    }
#pragma endscop
