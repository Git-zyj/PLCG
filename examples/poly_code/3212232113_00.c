    ...
    for (int i_3 = 2; i_3 < PB_P-2; i_3++) {
        for (int i_4 = 3; i_4 < PB_P-1; i_4++) {
            for (int i_5 = 1; i_5 < PB_M; i_5++) {
                B[i_4][i_3+2][i_3-2] = D[i_3][i_5-1][i_5] - C[i_5-1][i_3][i_4-1] - D[i_5][i_3][0] + E[i_3][i_4-2][i_5][i_4] + B[i_3+1][i_4+1][i_4-3] - 5;
            }
        }
    }
#pragma endscop
...
kernel_3212232113_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D), xe,ye,ze,ve,POLYBENCH_ARRAY(E));
