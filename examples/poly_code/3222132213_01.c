...
#pragma scop
    for (int i_0 = 3; i_0 < PB_M+1; i_0++) {
        for (int i_1 = 0; i_1 < PB_N-1; i_1++) {
            A[i_0-2][0] = C[i_0] * D[i_1][i_0] + D[i_1+1][i_0] * A[i_0-3][0] * A[i_0-1][0] * A[i_0-1][0] + 4;
        }
    }
    for (int i_2 = 2; i_2 < PB_P-2; i_2++) {
        for (int i_3 = 2; i_3 < -i_2+PB_P-2; i_3++) {
            for (int i_4 = 2; i_4 < PB_P+2; i_4++) {
                B[i_4+i_3+1][i_2+1][i_4+i_3] = E[i_4][i_3+i_2+2][i_3+i_2-2] - E[i_3-2][i_4-2][i_2] + D[i_4+2][i_3] + B[i_4+i_3+1][i_2+2][i_4+i_3] * 6;
            }
        }
    }
#pragma endscop
