...
void kernel_2214131211_01(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,DATA_TYPE POLYBENCH_2D(C,xC,yC,xc,yc)){
...
#pragma scop
    ...
    for (int i_2 = 0; i_2 < PB_M-1; i_2++) {
        for (int i_3 = max(1, i_2); i_3 < PB_N; i_3++) {
            B[0] = C[i_3][i_2] - C[i_3-1][i_2] * C[i_3][i_2] * C[i_3-1][i_2] - A[i_2+1][i_3+1] - A[i_2][i_3] * A[i_3+1][i_2] - B[0] + 6;
        }
    }
#pragma endscop
...
kernel_2214131211_01(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,yc,POLYBENCH_ARRAY(C));
