...
#pragma scop
    for (int i_0 = 2; i_0 < PB_N+1; i_0++) {
        for (int i_1 = i_0; i_1 < -i_0+PB_N+1; i_1++) {
            A[i_1+i_0-2][i_0] = A[i_1+i_0-1][i_1+1] - A[i_1+i_0-1][i_0] + 6;
        }
        for (int i_2 = 2; i_2 < min(-i_0+PB_L, PB_N); i_2++) {
            for (int i_3 = 1; i_3 < min(-i_0+PB_N+1, i_0); i_3++) {
                A[i_3+i_0-1][i_3+1] = C[i_3][i_3][i_0] + D[i_3+2][i_2] + E[i_3][i_0][i_3+i_0+2] + E[i_2][i_3][i_0] * C[i_3+1][i_2-2][i_0] - E[i_3-1][i_0][i_2+i_0] + 4;
            }
        }
    }
#pragma endscop
