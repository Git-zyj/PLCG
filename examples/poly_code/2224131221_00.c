...
#pragma scop
    for (int i_0 = 0; i_0 < PB_M; i_0++) {
        for (int i_1 = 1; i_1 < min(PB_L+1, i_0); i_1++) {
            A[i_0][i_1-1] = C[i_1] + D[i_0][0] + D[i_0][i_1] + 4;
        }
    }
    for (int i_2 = 2; i_2 < PB_L-2; i_2++) {
        for (int i_3 = i_2; i_3 < PB_P-3; i_3++) {
            B[i_2][i_3+1] = D[i_3+1][i_2] - D[i_2][i_2] + C[i_3] * B[i_2][i_3+3] * B[i_2-2][i_3+1] - B[i_2+1][i_3+1] + B[i_2+2][i_3+1] * 1;
        }
    }
#pragma endscop
