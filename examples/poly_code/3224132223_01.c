    ...
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        for (int i_1 = i_0; i_1 < -i_0+PB_M; i_1++) {
            for (int i_2 = i_0; i_2 < min(-i_0+PB_M, -i_1+PB_M); i_2++) {
                A[i_2+i_0][i_1][0] = C[i_2+i_1][i_2][i_1-1] * C[i_1+i_0][i_1][i_2+i_0] + A[i_2+i_0-1][i_1][0] - 6;
            }
        }
    }
    for (int i_3 = 0; i_3 < PB_M; i_3++) {
        for (int i_4 = 2; i_4 < PB_M; i_4++) {
            for (int i_5 = 0; i_5 < min(min(-i_4+PB_M, -i_3+PB_M), PB_M-2); i_5++) {
                A[i_5+i_3][i_4+1][0] = D[i_5+2][i_4] * C[i_3][i_5+i_4][i_4] + C[i_3][i_5+2][i_5] + C[i_5+i_4-2][i_3][i_4] + A[i_5+i_4][i_3][0] * 6;
            }
        }
    }
#pragma endscop
