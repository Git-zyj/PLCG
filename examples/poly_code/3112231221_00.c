...
#pragma scop
    for (int i_0 = 0; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 0; i_1 < min(-i_0+PB_L-2, PB_M-1); i_1++) {
            for (int i_2 = 1; i_2 < min(min(-i_1+PB_M, -i_0+PB_L-2), PB_M); i_2++) {
                A[i_0][i_1][i_2+i_0] = B[i_1+1][i_2][i_0] - B[i_2+i_1][i_0][0] + B[i_2-1][i_0][i_1] * A[i_0+1][i_2][i_1+i_0+2] + A[i_0+2][i_1][i_2+i_0+2] + 2;
            }
        }
    }
#pragma endscop
