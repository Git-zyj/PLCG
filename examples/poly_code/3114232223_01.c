...
#pragma scop
    for (int i_0 = 0; i_0 < PB_P; i_0++) {
        for (int i_1 = max(2, i_0); i_1 < min(-i_0+PB_L, PB_P); i_1++) {
            for (int i_2 = 2; i_2 < min(min(-i_1+PB_N, -i_0+PB_N), PB_P); i_2++) {
                A[i_1][i_2][0] = B[i_2+i_0][i_1][2] * C[i_1+i_0][1][i_2-2] * D[i_2+i_1][0] + A[i_1-2][i_2][0] + A[i_1][i_2-1][0] - 1;
            }
        }
    }
#pragma endscop
