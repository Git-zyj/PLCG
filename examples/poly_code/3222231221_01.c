    ...
    for (int i_0 = 0; i_0 < PB_P; i_0++) {
        for (int i_1 = 3; i_1 < min(i_0, PB_P-1); i_1++) {
            for (int i_2 = 3; i_2 < -i_1+PB_Q-1; i_2++) {
                A[i_0][i_2+i_1][i_2-1] = C[i_1][i_0][i_1+1] + D[i_2][i_1+1][i_0][0] - A[i_0][i_2+i_1+1][i_2-1] + A[i_0][i_2+i_1-3][i_2-3] - 6;
            }
        }
        for (int i_3 = 1; i_3 < min(i_0, PB_P-1); i_3++) {
            for (int i_4 = max(1, i_3); i_4 < PB_P; i_4++) {
                B[i_4-1][i_3-1][i_4-1] = E[i_0][i_4] + C[i_3][i_0][i_3] * F[i_4][i_4][i_3+1] - B[i_4-1][i_3][i_4-1] + B[i_3+1][i_4-1][i_3+1] + 2;
            }
        }
    }
#pragma endscop
