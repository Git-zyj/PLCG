...
#pragma scop
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 1; i_1 < i_0; i_1++) {
            for (int i_2 = 1; i_2 < min(min(-i_0+PB_L, -i_1+PB_L), i_0); i_2++) {
                A[i_0][i_1][i_2+i_1] = C[i_2][i_0][i_1] - C[i_0][i_2-1][i_1-1] - A[i_0][i_1][i_2+i_1-1] * A[i_1+1][i_2][i_2+i_0] * 5;
            }
        }
        B[i_0][1] = D[i_0+1] + D[i_0-1] + D[i_0-1] + B[i_0+1][1] * 6;
    }
#pragma endscop
