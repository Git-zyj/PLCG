...
#pragma scop
    for (int i_0 = 2; i_0 < PB_M+1; i_0++) {
        for (int i_1 = 1; i_1 < PB_M; i_1++) {
            for (int i_2 = 1; i_2 < min(i_1, PB_N); i_2++) {
                B[i_2][i_1-1][i_0-2] = C[i_1][i_2-1][i_0-1] + 6;
            }
        }
    }
    for (int i_3 = 2; i_3 < PB_M-1; i_3++) {
        for (int i_4 = i_3; i_4 < PB_N-2; i_4++) {
            for (int i_5 = 0; i_5 < min(min(-i_4+PB_M, -i_3+PB_M-1), PB_N); i_5++) {
                B[i_4][i_3][i_5] = C[i_3-1][i_5+i_4][i_4] + C[i_3-1][i_4][0] + C[i_5+i_3+1][i_4][0] - C[i_3][i_5+i_4][1] * B[i_5][i_4][i_3-2] + B[i_4+2][i_3+1][i_5] + 4;
            }
        }
    }
#pragma endscop
