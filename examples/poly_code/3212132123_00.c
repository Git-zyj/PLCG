...
void kernel_3212132123_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma scop
    ...
    for (int i_2 = 0; i_2 < PB_L-2; i_2++) {
        A[i_2+2] = C[i_2] + C[i_2] - C[i_2+2] - C[i_2] + C[i_2] - C[i_2] + 4;
    }
#pragma endscop
...
kernel_3212132123_00(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
