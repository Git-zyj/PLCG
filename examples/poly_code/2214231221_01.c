...
#pragma scop
    for (int i_0 = 1; i_0 < PB_M; i_0++) {
        for (int i_1 = 0; i_1 < -i_0+PB_M; i_1++) {
            A[i_1+i_0][i_1+i_0] = C[i_1][i_0+1] - D[i_1][i_0+1][i_1] - E[i_1][i_0] - F[i_1] * A[i_1+i_0-1][i_1+i_0-1] - 6;
        }
    }
    for (int i_2 = 0; i_2 < PB_M; i_2++) {
        for (int i_3 = 2; i_3 < -i_2+PB_M; i_3++) {
            B[i_3][i_2+1] = F[i_3] - E[i_3+i_2][i_2] - A[i_3+i_2][i_3+i_2] - B[i_3][i_2] - B[i_3-2][i_2+1] + 4;
        }
    }
#pragma endscop
