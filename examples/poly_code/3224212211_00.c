...
#pragma scop
    for (int i_0 = 0; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 1; i_1 < min(i_0, PB_Q); i_1++) {
            for (int i_2 = 1; i_2 < PB_L; i_2++) {
                A[i_0][i_1][i_2+1] = C[i_1][i_0][i_2] * A[i_0+1][i_1-1][i_2+1] + A[i_0][i_1][i_2+2] - B[i_0+1][i_2-1][i_1] - 1;
            }
        }
        for (int i_3 = 0; i_3 < PB_M; i_3++) {
            for (int i_4 = 0; i_4 < PB_Q; i_4++) {
                B[i_0+1][i_3][i_4] = D[i_3][i_0][i_4] - B[i_0][i_3][i_4] - 4;
            }
        }
    }
#pragma endscop
