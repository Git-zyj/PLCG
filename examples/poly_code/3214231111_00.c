...
#pragma scop
    for (int i_0 = 0; i_0 < PB_L; i_0++) {
        for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
            for (int i_2 = i_0; i_2 < min(PB_M-1, -i_1+PB_P); i_2++) {
                A[i_0][i_1+1][i_2+i_1] = C[i_2+1][i_1][1] - A[i_0+1][i_1][i_2+i_1-1] * 4;
            }
        }
        for (int i_3 = 0; i_3 < PB_L-1; i_3++) {
            for (int i_4 = 1; i_4 < -i_0+PB_L; i_4++) {
                B[i_0+1][i_3][i_4-1] = C[i_4-1][i_3+1][i_0] + D[i_4][i_0+1] * E[i_3][i_4+i_0][i_3+1] + E[i_4][i_0][i_3] * 3;
            }
        }
    }
#pragma endscop
