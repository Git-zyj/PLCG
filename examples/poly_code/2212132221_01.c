...
#pragma scop
    for (int i_0 = 1; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 2; i_1 < min(PB_N, -i_0+PB_M-2); i_1++) {
            A[i_1+i_0][i_0] = C[i_1] + D[i_0][i_1] + B[i_1+i_0+2][i_0] + 4;
            B[i_1+i_0+2][i_0] = D[i_1-2][i_0] + D[i_1+i_0+1][i_0] * C[i_1-1] * A[i_1+i_0][i_0] - A[i_1+i_0-1][i_0-1] * A[i_1+i_0+2][i_0+2] * 3;
        }
    }
#pragma endscop
