...
#pragma scop
    for (int i_0 = 1; i_0 < PB_N-1; i_0++) {
        for (int i_1 = 0; i_1 < min(i_0, -i_0+PB_N-1); i_1++) {
            A[i_1+i_0][i_1] = C[i_1][i_0] * C[i_1][i_0] - C[i_1+i_0+1][i_1+i_0] + A[i_1+i_0-1][i_1] - 3;
        }
    }
    for (int i_2 = 0; i_2 < PB_P; i_2++) {
        for (int i_3 = 1; i_3 < min(-i_2+PB_M-2, PB_P); i_3++) {
            A[i_3+i_2+2][i_3] = D[i_3-1][i_2] * D[i_2][i_3] - 4;
        }
    }
#pragma endscop
