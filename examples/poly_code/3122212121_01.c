...
void kernel_3122212121_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 2; i_0 < PB_L+2; i_0++) {
        for (int i_1 = min(PB_L-1, i_0) - 1; i_1 >= 0; i_1--) {
            A[i_1+1] = B[i_0-2] - A[i_1] - 4;
        }
    }
#pragma endscop
...
kernel_3122212121_01(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
