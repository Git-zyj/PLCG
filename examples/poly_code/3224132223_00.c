    ...
    for (int i_0 = 0; i_0 < PB_N-2; i_0++) {
        for (int i_1 = 2; i_1 < PB_L-2; i_1++) {
            for (int i_2 = 0; i_2 < PB_P-2; i_2++) {
                A[i_0+2][i_1+1][0] = C[i_2][i_0][i_1] - C[i_1][i_2][i_1] * C[i_1][i_2+2][i_0] + B[i_1-1][i_2] - 1;
            }
            B[i_1][i_0] = D[i_0][i_1] - D[i_1][i_0] + D[i_0+1][i_1] - B[i_1][i_0+1] + B[i_1-2][i_0] + B[i_1+2][i_0] + 1;
        }
    }
#pragma endscop
