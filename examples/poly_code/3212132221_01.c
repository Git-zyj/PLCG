    ...
    for (int i_0 = 1; i_0 < PB_M-1; i_0++) {
        for (int i_1 = 2; i_1 < -i_0+PB_M-1; i_1++) {
            for (int i_2 = 2; i_2 < -i_1+PB_M; i_2++) {
                A[i_1+i_0+1][i_2][i_0] = C[i_2-2][i_2][i_1-2] + C[i_2+i_1-1][i_0][i_0-1] + C[i_2-2][i_0-1][i_1] * C[i_0][i_2+i_1][0] * A[i_2+i_1][i_0][i_2] - A[i_1+i_0+1][i_2+2][i_0] + 3;
            }
        }
    }
    for (int i_3 = 0; i_3 < PB_M; i_3++) {
        for (int i_4 = i_3; i_4 < PB_M; i_4++) {
            for (int i_5 = 0; i_5 < min(PB_M, -i_3+PB_L); i_5++) {
                B[i_3][i_4][i_5] = C[i_4][i_5+i_3][1] - C[i_4][i_5][i_3] * B[i_5][i_4+1][i_3] * 1;
            }
        }
    }
#pragma endscop
