    ...
    for (int i_0 = 1; i_0 < PB_Q; i_0++) {
        for (int i_1 = 1; i_1 < PB_P-1; i_1++) {
            for (int i_2 = i_1; i_2 < PB_L-1; i_2++) {
                A[i_1][i_0][i_2+1] = C[i_2+1][i_1+1][i_0][i_0-1] + A[i_1-1][i_0][i_2] - 3;
            }
        }
    }
    for (int i_3 = 0; i_3 < PB_L-1; i_3++) {
        for (int i_4 = 1; i_4 < PB_P; i_4++) {
            for (int i_5 = i_3; i_5 < PB_Q-1; i_5++) {
                B[i_3][i_4][i_5] = D[i_3][i_4][0] - E[i_4-1][i_3] * D[i_4][i_3][i_5] + D[i_4][i_3][i_3+1] * D[i_4][i_3][i_5] - B[i_3][i_4][i_5+1] * 2;
            }
        }
    }
#pragma endscop
