    ...
    for (int i_0 = 1; i_0 < PB_L-2; i_0++) {
        for (int i_1 = 1; i_1 < PB_L-1; i_1++) {
            for (int i_2 = 0; i_2 < PB_L; i_2++) {
                A[i_2][i_1+1][i_0+1] = C[i_1+1][i_2+1][i_0] + C[i_1-1][i_2][i_0] - D[i_0][i_1][i_2] + C[i_2][i_1][i_0-1] + A[i_2][i_1+1][i_0+2] * A[i_2][i_1+1][i_0] - 2;
            }
        }
    }
    for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
        B[i_3] = E[i_3] * E[0] * B[i_3-1] * B[i_3+1] + 4;
    }
#pragma endscop
