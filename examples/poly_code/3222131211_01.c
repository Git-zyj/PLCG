    ...
    for (int i_0 = 1; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_N; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_M-1; i_2++) {
                A[i_0-1][i_2][i_1] = C[i_1-1][i_2][i_0] - C[i_1][i_2+i_0+1][i_0] - D[i_0][i_2][i_2+1][i_1] - A[i_0-1][i_2+1][i_1] + 2;
            }
        }
        for (int i_3 = 1; i_3 < PB_N+1; i_3++) {
            for (int i_4 = max(2, i_0); i_4 < PB_L; i_4++) {
                B[i_3-1][i_0][i_4-1] = C[i_3-1][i_4][i_0+1] + E[i_4][i_4] - B[i_3-1][i_0-1][i_4-2] + B[i_3][i_0][i_4] - B[i_3-1][i_0-1][i_4-1] + 3;
            }
        }
    }
#pragma endscop
