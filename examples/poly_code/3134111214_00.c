...
void kernel_3134111214_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i = 1; i < PB_L-1; i++) {
        A[i+1][i] = B[i] * A[i][i-1] * A[i+2][i+1] + 3;
    }
#pragma endscop
...
kernel_3134111214_00(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
