    ...
    for (int i_0 = 0; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            for (int i_2 = i_1; i_2 < PB_L; i_2++) {
                B[i_0][i_1-1][i_2+2] = C[i_0][i_1+1] + D[i_1][i_2][i_0] + 1;
            }
        }
        for (int i_3 = 2; i_3 < -i_0+PB_Q-1; i_3++) {
            for (int i_4 = i_3; i_4 < -i_3+PB_L; i_4++) {
                B[i_0][i_4-1][i_3] = D[i_4][i_0][i_3] + D[i_4+i_3][i_0+1][0] + D[i_4+i_3][i_4][i_3+i_0+1] + D[i_4][i_0+1][i_3+1] * B[i_0+1][i_3-1][i_4+2] + B[i_0][i_4][i_3-2] * 4;
            }
        }
    }
#pragma endscop
