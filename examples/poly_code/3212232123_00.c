...
#pragma scop
    for (int i_0 = 4; i_0 < PB_P+2; i_0++) {
        for (int i_1 = 0; i_1 < PB_M; i_1++) {
            A[i_1][i_0-2] = A[i_1][i_0-4] - 5;
        }
    }
    for (int i_2 = 1; i_2 < PB_L-2; i_2++) {
        for (int i_3 = 0; i_3 < PB_L; i_3++) {
            for (int i_4 = i_3; i_4 < PB_L-2; i_4++) {
                B[i_4][i_3][i_2+2] = C[i_3+2][i_4+1][i_3] + D[i_3][i_2][2] + D[i_4][i_2][i_3] + D[i_4][i_3+2][i_2-1] * C[i_3][i_4][i_2] * D[i_2][i_2][i_3] - B[i_2][i_3+1][i_4+2] - 2;
            }
        }
    }
#pragma endscop
