    ...
    for (int i_0 = 1; i_0 < PB_N; i_0++) {
        for (int i_1 = 1; i_1 < PB_N; i_1++) {
            for (int i_2 = 1; i_2 < -i_1+PB_N; i_2++) {
                A[i_1][i_0][i_2-1] = C[i_2+i_1][i_0][i_0] * C[i_0][i_2][i_1] - D[i_0-1][i_1-1][0] + E[i_1-1][i_0][i_2][i_2+i_1] - 3;
            }
        }
    }
    for (int i_3 = 0; i_3 < PB_Q-1; i_3++) {
        for (int i_4 = i_3; i_4 < PB_N-1; i_4++) {
            for (int i_5 = 0; i_5 < -i_4+PB_Q; i_5++) {
                B[i_4+1][i_5+1][i_5] = F[i_3][i_5+i_4][i_3+1][i_5+i_4] - G[i_4+1][i_4+1] * B[i_4+1][i_3+2][i_3+1] - 6;
            }
        }
    }
#pragma endscop
