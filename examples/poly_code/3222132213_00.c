    ...
    for (int i_0 = 2; i_0 < PB_M-2; i_0++) {
        for (int i_1 = 0; i_1 < -i_0+PB_N+1; i_1++) {
            for (int i_2 = 0; i_2 < -i_0+PB_N; i_2++) {
                A[i_2+i_0][i_0][i_1][i_2] = C[i_0][i_2][i_2] + C[i_2][i_0][i_1] + A[i_1+i_0-1][i_0-1][i_2][i_1] - 6;
            }
        }
        for (int i_3 = 1; i_3 < PB_M-1; i_3++) {
            B[i_0+2][i_3] = D[i_3+1] - E[i_0-2][i_0] - D[i_3] + E[i_3][i_0] - B[i_0+2][i_3-1] + B[i_0+2][i_3+1] - 3;
        }
    }
#pragma endscop
