    ...
    for (int i_0 = 2; i_0 < PB_L-1; i_0++) {
        for (int i_1 = 1; i_1 < PB_L; i_1++) {
            for (int i_2 = 0; i_2 < PB_L; i_2++) {
                A[i_2][i_0-1][i_1] = A[i_2][i_0-1][i_1-1] - A[i_2][i_0-2][i_1] + A[i_1][i_0][i_2] * A[i_2][i_1-1][i_0+1] + 5;
            }
        }
    }
    for (int i_3 = 0; i_3 < PB_L; i_3++) {
        for (int i_4 = 0; i_4 < PB_L; i_4++) {
            for (int i_5 = 2; i_5 < PB_L+2; i_5++) {
                B[i_3][i_5-2][i_4+1] = C[i_5-2][i_3][i_4] + D[i_5][i_4] - C[i_5][i_4][i_3+1] + C[i_5][i_3][i_4] - D[i_5][i_5] - C[i_5][i_3][i_4] + 2;
            }
        }
    }
#pragma endscop
