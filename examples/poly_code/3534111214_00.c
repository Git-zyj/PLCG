...
void kernel_3534111214_00(int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xf,int yf,DATA_TYPE POLYBENCH_2D(F,xF,yF,xf,yf),int xg,int yg,int zg,DATA_TYPE POLYBENCH_3D(G,xG,yG,zG,xg,yg,zg)){
...
kernel_3534111214_00(xe,ye,POLYBENCH_ARRAY(E), xb,yb,zb,POLYBENCH_ARRAY(B), xf,yf,POLYBENCH_ARRAY(F), xg,yg,zg,POLYBENCH_ARRAY(G));
