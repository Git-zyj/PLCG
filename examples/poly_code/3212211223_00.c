...
void kernel_3212211223_00(int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,int yc,int zc,DATA_TYPE POLYBENCH_3D(C,xC,yC,zC,xc,yc,zc),int xd,int yd,DATA_TYPE POLYBENCH_2D(D,xD,yD,xd,yd)){
polybench_start_instruments;
#pragma scop
    for (int i_0 = 1; i_0 < PB_N; i_0++) {
        B[i_0] = B[i_0] + 5;
        for (int i_1 = i_0; i_1 < -i_0+PB_M+1; i_1++) {
            B[i_1] = C[i_1][i_0][i_0] + D[i_1+i_0-1][i_1] + B[i_1-1] * 3;
        }
    }
#pragma endscop
...
kernel_3212211223_00(xb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D));
