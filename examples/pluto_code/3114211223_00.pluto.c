...
void kernel_3114211223_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
...
if (PB_M >= 3) {
  for (t1=2;t1<=PB_M-1;t1++) {
    A[t1][t1] = B[t1] * A[t1-1][t1-1] - A[t1-2][t1-2] + 1;;
  }
}
/* End of CLooG code */
...
kernel_3114211223_00(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
