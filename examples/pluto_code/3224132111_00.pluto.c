...
void kernel_3224132111_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc),int xd,int yd,int zd,DATA_TYPE POLYBENCH_3D(D,xD,yD,zD,xd,yd,zd)){
  ...
  for (t1=0;t1<=floord(PB_M-2,32);t1++) {
    if (PB_L <= -1) {
      for (t3=max(2,32*t1);t3<=min(PB_M-2,32*t1+31);t3++) {
        A[t3-1] = C[t3] + C[t3-2] + C[t3+2] - C[t3+2] + C[t3] + A[t3-2] - 4;;
      }
    }
    for (t2=0;t2<=floord(PB_L,32);t2++) {
      if ((PB_L >= 1) && (t2 == 0)) {
        for (t3=max(2,32*t1);t3<=min(PB_M-2,32*t1+31);t3++) {
          B[t3][0][t3] = D[0][0][t3] + B[t3+1][0][t3+1] + 5;;
          A[t3-1] = C[t3] + C[t3-2] + C[t3+2] - C[t3+2] + C[t3] + A[t3-2] - 4;;
          lbv=1;
          ubv=min(31,PB_L-1);
#pragma ivdep
#pragma vector always
          for (t5=lbv;t5<=ubv;t5++) {
            B[t3][t5][t3] = D[0][t5][t3] + B[t3+1][t5][t3+1] + 5;;
          }
...
#pragma vector always
            for (t5=lbv;t5<=ubv;t5++) {
              B[t3][t5][t3] = D[t4][t5][t3] + B[t3+1][t5][t3+1] + 5;;
              B[t3][t5][t3] = D[(t4+1)][t5][t3] + B[t3+1][t5][t3+1] + 5;;
              B[t3][t5][t3] = D[(t4+2)][t5][t3] + B[t3+1][t5][t3+1] + 5;;
              B[t3][t5][t3] = D[(t4+3)][t5][t3] + B[t3+1][t5][t3+1] + 5;;
              B[t3][t5][t3] = D[(t4+4)][t5][t3] + B[t3+1][t5][t3+1] + 5;;
              B[t3][t5][t3] = D[(t4+5)][t5][t3] + B[t3+1][t5][t3+1] + 5;;
              B[t3][t5][t3] = D[(t4+6)][t5][t3] + B[t3+1][t5][t3+1] + 5;;
              B[t3][t5][t3] = D[(t4+7)][t5][t3] + B[t3+1][t5][t3+1] + 5;;
            }
          }
          for (;t4<=t3-1;t4++) {
            lbv=0;
...
kernel_3224132111_00(xa,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C), xd,yd,zd,POLYBENCH_ARRAY(D));
