  ...
  for (t1=0;t1<=floord(PB_M-1,32);t1++) {
    if (PB_L <= -1) {
      for (t3=max(1,32*t1);t3<=(min(PB_M-1,32*t1+31))-7;t3+=8) {
        B[t3][t3] = D[t3+1] * B[t3-1][t3-1] + 6;;
        B[(t3+1)][(t3+1)] = D[(t3+1)+1] * B[(t3+1)-1][(t3+1)-1] + 6;;
        B[(t3+2)][(t3+2)] = D[(t3+2)+1] * B[(t3+2)-1][(t3+2)-1] + 6;;
        B[(t3+3)][(t3+3)] = D[(t3+3)+1] * B[(t3+3)-1][(t3+3)-1] + 6;;
        B[(t3+4)][(t3+4)] = D[(t3+4)+1] * B[(t3+4)-1][(t3+4)-1] + 6;;
        B[(t3+5)][(t3+5)] = D[(t3+5)+1] * B[(t3+5)-1][(t3+5)-1] + 6;;
        B[(t3+6)][(t3+6)] = D[(t3+6)+1] * B[(t3+6)-1][(t3+6)-1] + 6;;
        B[(t3+7)][(t3+7)] = D[(t3+7)+1] * B[(t3+7)-1][(t3+7)-1] + 6;;
      }
