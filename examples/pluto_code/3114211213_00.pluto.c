...
void kernel_3114211213_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
...
#pragma vector always
        for (t4=lbv;t4<=ubv;t4++) {
          A[t3][t4-1] = B[t3] - A[t3+1][t4-1] - A[t3-1][t4-1] + 6;;
        }
      }
    }
  }
...
kernel_3114211213_00(xa,ya,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
