...
#pragma omp parallel for private(lbv,ubv,t3,t4)
    for (t2=lbp;t2<=ubp;t2++) {
      for (t3=max(1,32*t1-32*t2);t3<=(min(PB_M-1,32*t1-32*t2+31))-7;t3+=8) {
        for (t4=max(2,32*t2);t4<=min(PB_M-1,32*t2+31);t4++) {
          A[t3-1][t4-2] = B[t4] * A[t3][t4-2] - A[t3-1][t4-1] - 3;;
          A[(t3+1)-1][t4-2] = B[t4] * A[(t3+1)][t4-2] - A[(t3+1)-1][t4-1] - 3;;
          A[(t3+2)-1][t4-2] = B[t4] * A[(t3+2)][t4-2] - A[(t3+2)-1][t4-1] - 3;;
          A[(t3+3)-1][t4-2] = B[t4] * A[(t3+3)][t4-2] - A[(t3+3)-1][t4-1] - 3;;
          A[(t3+4)-1][t4-2] = B[t4] * A[(t3+4)][t4-2] - A[(t3+4)-1][t4-1] - 3;;
          A[(t3+5)-1][t4-2] = B[t4] * A[(t3+5)][t4-2] - A[(t3+5)-1][t4-1] - 3;;
          A[(t3+6)-1][t4-2] = B[t4] * A[(t3+6)][t4-2] - A[(t3+6)-1][t4-1] - 3;;
          A[(t3+7)-1][t4-2] = B[t4] * A[(t3+7)][t4-2] - A[(t3+7)-1][t4-1] - 3;;
        }
      }
