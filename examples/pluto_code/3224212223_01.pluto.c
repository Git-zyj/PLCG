        ...
        for (t2=lbp;t2<=ubp;t2++) {
          for (t3=0;t3<=floord(PB_M-1,32);t3++) {
            for (t4=max(2,32*t2);t4<=min(PB_M+1,32*t2+31);t4++) {
              for (t5=max(2,32*t3);t5<=min(PB_M-1,32*t3+31);t5++) {
                for (t6=max(2,32*t1);t6<=min(PB_Q-1,32*t1+31);t6++) {
                  A[t5-2][t4+1][t6] = C[t4-2][t6-2][t5+1] * A[t5][t4+1][t6] + A[t5-2][t4+1][t6-1] * 6;;
                }
              }
            }
          }
