...
void kernel_2124211123_00(int xa,int ya,DATA_TYPE POLYBENCH_2D(A,xA,yA,xa,ya),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb)){
...
#pragma vector always
        for (t4=lbv;t4<=ubv;t4++) {
          A[t3-1][t4+1] = B[t4][t3] - A[t3+1][t4+1] * 2;;
        }
      }
    }
  }
...
kernel_2124211123_00(xa,ya,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B));
