...
if ((PB_M >= 0) && (PB_N >= max(0,ceild(-3*PB_M+6,2)))) {
  for (t1=0;t1<=min(floord(PB_N+PB_M-1,32),floord(4*PB_N+3*PB_M-6,96));t1++) {
    for (t2=max(max(0,ceild(32*t1-PB_N,32)),ceild(64*t1-2*PB_N-PB_M+2,32));t2<=min(floord(PB_M,32),floord(PB_N+3*PB_M-3,96));t2++) {
      ...
      if ((t1 == 0) && (t2 == 0)) {
        for (t3=0;t3<=min(1,PB_M-2);t3++) {
          for (t4=t3+1;t4<=min(31,PB_M-1);t4++) {
            B[t3+1] = D[t3][t4] + 3;;
          }
        }
      }
      if ((t1 == 0) && (t2 == 0)) {
        for (t3=2;t3<=min(min(30,PB_M-2),PB_N-1);t3++) {
          A[t3] = C[t3] * A[t3-2] + A[t3-1] * A[t3+2] + A[t3+1] - 5;;
          for (t4=t3+1;t4<=min(31,PB_M-1);t4++) {
            B[t3+1] = D[t3][t4] + 3;;
          }
        }
      ...
      if ((t1 == 0) && (t2 == 0)) {
        for (t3=max(2,PB_M-1);t3<=min(30,PB_N-1);t3++) {
          A[t3] = C[t3] * A[t3-2] + A[t3-1] * A[t3+2] + A[t3+1] - 5;;
        }
      }
      if ((t1 == 0) && (t2 == 0)) {
        for (t3=max(2,PB_N);t3<=min(30,PB_M-2);t3++) {
          for (t4=t3+1;t4<=min(31,PB_M-1);t4++) {
            B[t3+1] = D[t3][t4] + 3;;
          }
        }
