...
void kernel_3212211223_01(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
#pragma omp parallel for private(lbv,ubv,t3,t4,t5)
  for (t2=lbp;t2<=ubp;t2++) {
    for (t3=0;t3<=floord(PB_N-1,32);t3++) {
      for (t4=32*t3;t4<=(min(PB_N-1,32*t3+31))-7;t4+=8) {
        lbv=32*t2;
...
kernel_3212211223_01(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
