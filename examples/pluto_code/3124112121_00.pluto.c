...
#pragma vector always
          for (t5=lbv;t5<=ubv;t5++) {
            A[t5+2][t3][t5-2] = B[t3+1][t5][t4] - A[t5+2][t3-2][t5-2] * 4;;
            A[t5+2][t3][t5-2] = B[t3+1][t5][(t4+1)] - A[t5+2][t3-2][t5-2] * 4;;
            A[t5+2][t3][t5-2] = B[t3+1][t5][(t4+2)] - A[t5+2][t3-2][t5-2] * 4;;
            A[t5+2][t3][t5-2] = B[t3+1][t5][(t4+3)] - A[t5+2][t3-2][t5-2] * 4;;
            A[t5+2][t3][t5-2] = B[t3+1][t5][(t4+4)] - A[t5+2][t3-2][t5-2] * 4;;
            A[t5+2][t3][t5-2] = B[t3+1][t5][(t4+5)] - A[t5+2][t3-2][t5-2] * 4;;
            A[t5+2][t3][t5-2] = B[t3+1][t5][(t4+6)] - A[t5+2][t3-2][t5-2] * 4;;
            A[t5+2][t3][t5-2] = B[t3+1][t5][(t4+7)] - A[t5+2][t3-2][t5-2] * 4;;
          }
        }
        for (;t4<=PB_M-1;t4++) {
          lbv=max(2,32*t1);
