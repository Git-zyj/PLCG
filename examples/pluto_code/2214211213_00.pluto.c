...
void kernel_2214211213_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
polybench_start_instruments;
  int t1, t2, t3;
 int lb, ub, lbp, ubp, lb2, ub2;
 register int lbv, ubv;
/* Start of CLooG code */
for (t2=-PB_M+3;t2<=0;t2++) {
  A[-t2+1] = C[-t2] - A[-t2+2] - 4;;
}
for (t2=1;t2<=PB_N-2;t2++) {
  B[t2] = C[t2] + B[t2-1] * B[t2+1] + 3;;
}
/* End of CLooG code */
...
kernel_2214211213_00(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B), xc,POLYBENCH_ARRAY(C));
