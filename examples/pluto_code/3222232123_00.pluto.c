...
/* Start of CLooG code */
if (PB_P >= 1) {
  if ((PB_M >= 0) && (PB_P >= ceild(-3*PB_M+16,4))) {
    for (t1=0;t1<=floord(PB_P+2*PB_M-1,16);t1++) {
      lbp=max(max(0,ceild(32*t1-PB_P-PB_M,32)),ceild(32*t1-PB_P,48));
      ubp=min(min(min(floord(PB_P+3*PB_M-1,32),floord(64*t1+PB_P+PB_M+59,96)),floord(4*PB_P+13*PB_M-8,128)),t1);
#pragma omp parallel for private(lbv,ubv,t3,t4,t5)
      for (t2=lbp;t2<=ubp;t2++) {
        if ((PB_M <= 3) && (PB_P >= 4) && (t2 <= floord(PB_P-2,32))) {
          for (t3=max(1,32*t1-32*t2);t3<=min(PB_P,32*t1-32*t2+31);t3++) {
            for (t4=max(2,32*t2);t4<=min(PB_P-2,32*t2+31);t4++) {
              for (t5=0;t5<=PB_P-1;t5++) {
                A[t4-2][t3][t5] = C[t4+2][t3][1] - C[t3][t4][t3-1] + D[t5][t4+1] * C[t4][t3-1][t5] - 4;;
              }
            }
          }
        }
        if ((PB_M >= 4) && (PB_P >= 4) && (t1 == t2) && (t1 <= floord(PB_P-2,32))) {
          for (t4=max(2,32*t1);t4<=min(PB_P-2,32*t1+31);t4++) {
            for (t5=0;t5<=PB_P-1;t5++) {
              A[t4-2][1][t5] = C[t4+2][1][1] - C[1][t4][1 -1] + D[t5][t4+1] * C[t4][1 -1][t5] - 4;;
            }
          }
        }
        if ((PB_M >= 4) && (t2 <= floord(PB_P-2,32))) {
          for (t3=max(2,32*t1-32*t2);t3<=min(min(floord(32*t2-PB_M+1,2),PB_M+1),32*t1-32*t2+31);t3++) {
        ...
        if ((PB_M >= 4) && (PB_P <= 3)) {
          for (t3=max(max(2,ceild(32*t2-PB_M+2,2)),32*t1-32*t2);t3<=min(min(PB_M+1,16*t2+14),32*t1-32*t2+31);t3++) {
            for (t4=max(32*t2,2*t3+2);t4<=min(32*t2+31,2*t3+PB_M-2);t4++) {
              for (t5=0;t5<=PB_P-1;t5++) {
                B[(-2*t3+t4)-1][(-2*t3+t4)-2][(-2*t3+t4)+1] = E[t3-2][t5][(-2*t3+t4)] * C[(-2*t3+t4)][t3][t5] - B[(-2*t3+t4)+1][(-2*t3+t4)][(-2*t3+t4)+3] * B[(-2*t3+t4)][(-2*t3+t4)-1][(-2*t3+t4)+2] + 3;;
              }
            }
          }
        }
        if ((PB_P >= 4) && (t2 >= ceild(PB_P-1,32))) {
          for (t3=max(max(2,ceild(32*t2-PB_M+2,2)),32*t1-32*t2);t3<=min(min(PB_M+1,16*t2+14),32*t1-32*t2+31);t3++) {
            for (t4=max(32*t2,2*t3+2);t4<=min(32*t2+31,2*t3+PB_M-2);t4++) {
              for (t5=0;t5<=PB_P-1;t5++) {
                B[(-2*t3+t4)-1][(-2*t3+t4)-2][(-2*t3+t4)+1] = E[t3-2][t5][(-2*t3+t4)] * C[(-2*t3+t4)][t3][t5] - B[(-2*t3+t4)+1][(-2*t3+t4)][(-2*t3+t4)+3] * B[(-2*t3+t4)][(-2*t3+t4)-1][(-2*t3+t4)+2] + 3;;
        ...
        if ((PB_M >= 4) && (PB_P >= 4) && (t2 <= floord(PB_P-2,32))) {
          for (t3=max(max(2,ceild(32*t2-PB_M+2,2)),32*t1-32*t2);t3<=min(min(min(PB_P,PB_M+1),16*t2+14),32*t1-32*t2+31);t3++) {
            for (t4=max(2,32*t2);t4<=min(PB_P-2,2*t3+1);t4++) {
              for (t5=0;t5<=PB_P-1;t5++) {
                A[t4-2][t3][t5] = C[t4+2][t3][1] - C[t3][t4][t3-1] + D[t5][t4+1] * C[t4][t3-1][t5] - 4;;
              }
            }
            for (t4=max(32*t2,2*t3+2);t4<=min(min(PB_P-2,32*t2+31),2*t3+PB_M-2);t4++) {
              for (t5=0;t5<=PB_P-1;t5++) {
                A[t4-2][t3][t5] = C[t4+2][t3][1] - C[t3][t4][t3-1] + D[t5][t4+1] * C[t4][t3-1][t5] - 4;;
                B[(-2*t3+t4)-1][(-2*t3+t4)-2][(-2*t3+t4)+1] = E[t3-2][t5][(-2*t3+t4)] * C[(-2*t3+t4)][t3][t5] - B[(-2*t3+t4)+1][(-2*t3+t4)][(-2*t3+t4)+3] * B[(-2*t3+t4)][(-2*t3+t4)-1][(-2*t3+t4)+2] + 3;;
              }
            }
            for (t4=2*t3+PB_M-1;t4<=min(PB_P-2,32*t2+31);t4++) {
              for (t5=0;t5<=PB_P-1;t5++) {
                A[t4-2][t3][t5] = C[t4+2][t3][1] - C[t3][t4][t3-1] + D[t5][t4+1] * C[t4][t3-1][t5] - 4;;
              }
            }
            for (t4=max(PB_P-1,2*t3+2);t4<=min(32*t2+31,2*t3+PB_M-2);t4++) {
              for (t5=0;t5<=PB_P-1;t5++) {
                B[(-2*t3+t4)-1][(-2*t3+t4)-2][(-2*t3+t4)+1] = E[t3-2][t5][(-2*t3+t4)] * C[(-2*t3+t4)][t3][t5] - B[(-2*t3+t4)+1][(-2*t3+t4)][(-2*t3+t4)+3] * B[(-2*t3+t4)][(-2*t3+t4)-1][(-2*t3+t4)+2] + 3;;
              }
            }
        ...
        if ((PB_M >= 4) && (t2 <= floord(PB_P-2,32))) {
          for (t3=max(PB_M+2,32*t1-32*t2);t3<=min(min(PB_P,16*t2+14),32*t1-32*t2+31);t3++) {
            for (t4=max(2,32*t2);t4<=min(PB_P-2,32*t2+31);t4++) {
              for (t5=0;t5<=PB_P-1;t5++) {
                A[t4-2][t3][t5] = C[t4+2][t3][1] - C[t3][t4][t3-1] + D[t5][t4+1] * C[t4][t3-1][t5] - 4;;
              }
        ...
        if ((PB_M >= 4) && (t2 <= floord(PB_P-2,32))) {
          for (t3=max(32*t1-32*t2,16*t2+15);t3<=min(PB_P,32*t1-32*t2+31);t3++) {
            for (t4=max(2,32*t2);t4<=min(PB_P-2,32*t2+31);t4++) {
              for (t5=0;t5<=PB_P-1;t5++) {
                A[t4-2][t3][t5] = C[t4+2][t3][1] - C[t3][t4][t3-1] + D[t5][t4+1] * C[t4][t3-1][t5] - 4;;
              }
        ...
        if ((PB_P >= 4) && (t1 == 0) && (t2 == 0)) {
          for (t3=PB_P+1;t3<=min(14,PB_M+1);t3++) {
...
kernel_3222232123_00(xa,ya,za,POLYBENCH_ARRAY(A), xb,yb,zb,POLYBENCH_ARRAY(B), xc,yc,zc,POLYBENCH_ARRAY(C), xd,yd,POLYBENCH_ARRAY(D), xe,ye,ze,POLYBENCH_ARRAY(E));
