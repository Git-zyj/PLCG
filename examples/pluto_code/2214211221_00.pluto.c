...
void kernel_2214211221_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
/* Start of CLooG code */
if (PB_M >= 3) {
  for (t1=2;t1<=min(3,PB_M-3);t1++) {
    A[t1] = A[t1+2] + A[t1-2] + 3;;
  }
...
kernel_2214211221_00(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
