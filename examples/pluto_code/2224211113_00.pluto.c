...
#pragma vector always
      ...
      for (t3=max(1,32*t2);t3<=(min(PB_N-2,32*t2+31))-7;t3+=8) {
        lbv=32*t1;
        ubv=min(PB_M-1,32*t1+31);
#pragma ivdep
#pragma vector always
        for (t4=lbv;t4<=ubv;t4++) {
          B[t3+1][t4] = C[0] - 2;;
          B[(t3-1)+1][t4] = D[t4][t4] * B[(t3-1)+2][t4] * 5;;
          B[(t3+1)+1][t4] = C[0] - 2;;
          B[((t3+1)-1)+1][t4] = D[t4][t4] * B[((t3+1)-1)+2][t4] * 5;;
          B[(t3+2)+1][t4] = C[0] - 2;;
          B[((t3+2)-1)+1][t4] = D[t4][t4] * B[((t3+2)-1)+2][t4] * 5;;
          B[(t3+3)+1][t4] = C[0] - 2;;
          B[((t3+3)-1)+1][t4] = D[t4][t4] * B[((t3+3)-1)+2][t4] * 5;;
          B[(t3+4)+1][t4] = C[0] - 2;;
          B[((t3+4)-1)+1][t4] = D[t4][t4] * B[((t3+4)-1)+2][t4] * 5;;
          B[(t3+5)+1][t4] = C[0] - 2;;
          B[((t3+5)-1)+1][t4] = D[t4][t4] * B[((t3+5)-1)+2][t4] * 5;;
          B[(t3+6)+1][t4] = C[0] - 2;;
          B[((t3+6)-1)+1][t4] = D[t4][t4] * B[((t3+6)-1)+2][t4] * 5;;
          B[(t3+7)+1][t4] = C[0] - 2;;
          B[((t3+7)-1)+1][t4] = D[t4][t4] * B[((t3+7)-1)+2][t4] * 5;;
        }
      }
      for (;t3<=min(PB_N-2,32*t2+31);t3++) {
        lbv=32*t1;
        ubv=min(PB_M-1,32*t1+31);
#pragma ivdep
#pragma vector always
