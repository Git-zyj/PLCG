...
void kernel_2224112223_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
if (PB_M >= 1) {
  for (t1=2;t1<=PB_M-1;t1++) {
    A[t1] = C[t1] + C[t1] - A[t1-2] - A[t1-1] - 2;;
    A[(t1-2)] = 3;;
  }
...
kernel_2224112223_00(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
