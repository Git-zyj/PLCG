...
void kernel_31143112141_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i = 2; i < PB_M; i++)
        A[i-1] = A[i] * A[i-2] * B[i] * 6;
#pragma endscop
...
kernel_31143112141_00(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
