...
void kernel_31343112161_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb)){
polybench_start_instruments;
#pragma scop
    for (int i = 0; i < PB_M-2; i++)
        A[i+1] = A[i+2] - A[i] * B[i+1][1] + 2;
#pragma endscop
...
kernel_31343112161_00(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B));
