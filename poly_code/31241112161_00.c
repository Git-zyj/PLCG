...
void kernel_31241112161_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i = 0; i < PB_M-2; i++)
        A[i+1] = B[i] - A[i+2] * A[i] + 3;
#pragma endscop
...
kernel_31241112161_00(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
