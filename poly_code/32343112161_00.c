...
void kernel_32343112161_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xc,DATA_TYPE POLYBENCH_1D(C,xC,xc)){
...
kernel_32343112161_00(xa,POLYBENCH_ARRAY(A), xc,POLYBENCH_ARRAY(C));
