...
void kernel_31143112121_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,DATA_TYPE POLYBENCH_1D(B,xB,xb)){
polybench_start_instruments;
#pragma scop
    for (int i = 1; i < PB_M-1; i++) {
        A[i] = A[i+1] + A[i-1] + B[i] * 2;
    }
#pragma endscop
...
kernel_31143112121_00(xa,POLYBENCH_ARRAY(A), xb,POLYBENCH_ARRAY(B));
