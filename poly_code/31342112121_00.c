...
void kernel_31342112121_00(int xa,DATA_TYPE POLYBENCH_1D(A,xA,xa),int xb,int yb,DATA_TYPE POLYBENCH_2D(B,xB,yB,xb,yb)){
polybench_start_instruments;
#pragma scop
    for (int i = 0; i < PB_M-2; i++) {
        A[i+1] = A[i] - A[i+2] + B[i+1][i] + 6;
    }
#pragma endscop
...
kernel_31342112121_00(xa,POLYBENCH_ARRAY(A), xb,yb,POLYBENCH_ARRAY(B));
