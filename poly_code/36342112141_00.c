...
void kernel_36342112141_00(int xb,int yb,int zb,DATA_TYPE POLYBENCH_3D(B,xB,yB,zB,xb,yb,zb),int xf,DATA_TYPE POLYBENCH_1D(F,xF,xf),int xe,int ye,DATA_TYPE POLYBENCH_2D(E,xE,yE,xe,ye),int xg,int yg,DATA_TYPE POLYBENCH_2D(G,xG,yG,xg,yg),int xh,int yh,DATA_TYPE POLYBENCH_2D(H,xH,yH,xh,yh),int xi,DATA_TYPE POLYBENCH_1D(I,xI,xi)){
...
kernel_36342112141_00(xb,yb,zb,POLYBENCH_ARRAY(B), xf,POLYBENCH_ARRAY(F), xe,ye,POLYBENCH_ARRAY(E), xg,yg,POLYBENCH_ARRAY(G), xh,yh,POLYBENCH_ARRAY(H), xi,POLYBENCH_ARRAY(I));
